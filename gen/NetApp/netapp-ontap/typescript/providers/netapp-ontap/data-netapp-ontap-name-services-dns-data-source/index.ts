// https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/data-sources/name_services_dns_data_source
...
export interface DataNetappOntapNameServicesDnsDataSourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/data-sources/name_services_dns_data_source#cx_profile_name DataNetappOntapNameServicesDnsDataSource#cx_profile_name}
  */
  readonly cxProfileName: string;
  /**
  * IPInterface svm name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/data-sources/name_services_dns_data_source#svm_name DataNetappOntapNameServicesDnsDataSource#svm_name}
  */
  readonly svmName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/data-sources/name_services_dns_data_source netapp-ontap_name_services_dns_data_source}
*/
export class DataNetappOntapNameServicesDnsDataSource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetappOntapNameServicesDnsDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/data-sources/name_services_dns_data_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/data-sources/name_services_dns_data_source netapp-ontap_name_services_dns_data_source} Data Source
  *
  * @param scope The scope in which to define this construct
