// https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory
...
export interface DataNetappGcpActiveDirectoryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#ad_server DataNetappGcpActiveDirectory#ad_server}
  */
  readonly adServer?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#aes_encryption DataNetappGcpActiveDirectory#aes_encryption}
  */
  readonly aesEncryption?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#allow_local_nfs_users_with_ldap DataNetappGcpActiveDirectory#allow_local_nfs_users_with_ldap}
  */
  readonly allowLocalNfsUsersWithLdap?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#backup_operators DataNetappGcpActiveDirectory#backup_operators}
  */
  readonly backupOperators?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#connection_type DataNetappGcpActiveDirectory#connection_type}
  */
  readonly connectionType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#dns_server DataNetappGcpActiveDirectory#dns_server}
  */
  readonly dnsServer?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#domain DataNetappGcpActiveDirectory#domain}
  */
  readonly domain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#id DataNetappGcpActiveDirectory#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#kdc_ip DataNetappGcpActiveDirectory#kdc_ip}
  */
  readonly kdcIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#ldap_signing DataNetappGcpActiveDirectory#ldap_signing}
  */
  readonly ldapSigning?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#managed_ad DataNetappGcpActiveDirectory#managed_ad}
  */
  readonly managedAd?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#net_bios DataNetappGcpActiveDirectory#net_bios}
  */
  readonly netBios?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#organizational_unit DataNetappGcpActiveDirectory#organizational_unit}
  */
  readonly organizationalUnit?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#password DataNetappGcpActiveDirectory#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#region DataNetappGcpActiveDirectory#region}
  */
  readonly region: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#security_operators DataNetappGcpActiveDirectory#security_operators}
  */
  readonly securityOperators?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#site DataNetappGcpActiveDirectory#site}
  */
  readonly site?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#username DataNetappGcpActiveDirectory#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory netapp-gcp_active_directory}
*/
export class DataNetappGcpActiveDirectory extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataNetappGcpActiveDirectory resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataNetappGcpActiveDirectory to import
  * @param importFromId The id of the existing DataNetappGcpActiveDirectory that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataNetappGcpActiveDirectory to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-gcp/24.6.0/docs/data-sources/active_directory netapp-gcp_active_directory} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataNetappGcpActiveDirectoryConfig
  */
  public constructor(scope: Construct, id: string, config: DataNetappGcpActiveDirectoryConfig) {
    super(scope, id, {
  ...
  // net_bios - computed: false, optional: true, required: false
