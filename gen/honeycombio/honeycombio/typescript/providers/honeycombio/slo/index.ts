// https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/slo
...
export interface SloConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/slo#dataset Slo#dataset}
  */
  readonly dataset?: string;
  /**
  * The datasets the SLO is evaluated on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/slo#datasets Slo#datasets}
  */
  readonly datasets?: string[];
  /**
  * A description of the SLO's intent and context.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/slo#description Slo#description}
  */
  readonly description?: string;
  /**
  * The name of the SLO.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/slo#name Slo#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/slo#sli Slo#sli}
  */
  readonly sli: string;
  /**
  * A map of tags to assign to the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/slo#tags Slo#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The percentage of qualified events that you expect to succeed during the `time_period`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/slo#target_percentage Slo#target_percentage}
  */
  readonly targetPercentage: number;
  /**
  * The time period, in days, over which your SLO will be evaluated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/slo#time_period Slo#time_period}
  */
  readonly timePeriod: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/slo honeycombio_slo}
*/
export class Slo extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Slo that should be imported. Refer to the {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/slo#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/slo honeycombio_slo} Resource
  *
  * @param scope The scope in which to define this construct
