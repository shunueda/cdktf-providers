// https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/data-sources/columns
...
export interface DataHoneycombioColumnsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/data-sources/columns#dataset DataHoneycombioColumns#dataset}
  */
  readonly dataset: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/data-sources/columns#id DataHoneycombioColumns#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/data-sources/columns#starts_with DataHoneycombioColumns#starts_with}
  */
  readonly startsWith?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/data-sources/columns honeycombio_columns}
*/
export class DataHoneycombioColumns extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHoneycombioColumns that should be imported. Refer to the {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/data-sources/columns#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/data-sources/columns honeycombio_columns} Data Source
  *
  * @param scope The scope in which to define this construct
