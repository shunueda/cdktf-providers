// https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/data-sources/slo
...
export interface DataHoneycombioSloConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/data-sources/slo#dataset DataHoneycombioSlo#dataset}
  */
  readonly dataset?: string;
  /**
  * The ID of the SLO to fetch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/data-sources/slo#id DataHoneycombioSlo#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/data-sources/slo honeycombio_slo}
*/
export class DataHoneycombioSlo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHoneycombioSlo that should be imported. Refer to the {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/data-sources/slo#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/data-sources/slo honeycombio_slo} Data Source
  *
  * @param scope The scope in which to define this construct
