// https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/column
...
export interface ColumnConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/column#dataset Column#dataset}
  */
  readonly dataset: string;
  /**
  * The Column's description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/column#description Column#description}
  */
  readonly description?: string;
  /**
  * Whether the Column is hidden or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/column#hidden Column#hidden}
  */
  readonly hidden?: boolean | cdktf.IResolvable;
  /**
  * The name of the Column.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/column#name Column#name}
  */
  readonly name: string;
  /**
  * The Column's type. Valid values are `string`, `integer`, `float`, `boolean`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/column#type Column#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/column honeycombio_column}
*/
export class Column extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Column that should be imported. Refer to the {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/column#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.42.0/docs/resources/column honeycombio_column} Resource
  *
  * @param scope The scope in which to define this construct
