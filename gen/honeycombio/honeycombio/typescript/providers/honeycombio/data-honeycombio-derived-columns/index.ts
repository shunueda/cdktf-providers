// https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/derived_columns
...
export interface DataHoneycombioDerivedColumnsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/derived_columns#dataset DataHoneycombioDerivedColumns#dataset}
  */
  readonly dataset?: string;
  /**
  * Only return columns starting with the given value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/derived_columns#starts_with DataHoneycombioDerivedColumns#starts_with}
  */
  readonly startsWith?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/derived_columns honeycombio_derived_columns}
*/
export class DataHoneycombioDerivedColumns extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHoneycombioDerivedColumns that should be imported. Refer to the {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/derived_columns#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/derived_columns honeycombio_derived_columns} Data Source
  *
  * @param scope The scope in which to define this construct
