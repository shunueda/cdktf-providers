// https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/resources/pagerduty_recipient
...
export interface PagerdutyRecipientConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/resources/pagerduty_recipient#id PagerdutyRecipient#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/resources/pagerduty_recipient#integration_key PagerdutyRecipient#integration_key}
  */
  readonly integrationKey: string;
  /**
  * The name of the PagerDuty Integration to send the notification to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/resources/pagerduty_recipient#integration_name PagerdutyRecipient#integration_name}
  */
  readonly integrationName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/resources/pagerduty_recipient honeycombio_pagerduty_recipient}
*/
export class PagerdutyRecipient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PagerdutyRecipient that should be imported. Refer to the {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/resources/pagerduty_recipient#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/resources/pagerduty_recipient honeycombio_pagerduty_recipient} Resource
  *
  * @param scope The scope in which to define this construct
