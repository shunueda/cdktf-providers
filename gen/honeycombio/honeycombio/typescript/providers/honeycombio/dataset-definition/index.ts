// https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/resources/dataset_definition
...
export interface DatasetDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/resources/dataset_definition#column DatasetDefinition#column}
  */
  readonly column: string;
  /**
  * The dataset to set the Dataset Definition for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/resources/dataset_definition#dataset DatasetDefinition#dataset}
  */
  readonly dataset: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/resources/dataset_definition#id DatasetDefinition#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/resources/dataset_definition#name DatasetDefinition#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/resources/dataset_definition honeycombio_dataset_definition}
*/
export class DatasetDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatasetDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/resources/dataset_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.43.0/docs/resources/dataset_definition honeycombio_dataset_definition} Resource
  *
  * @param scope The scope in which to define this construct
