// https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/query_result
...
export interface DataHoneycombioQueryResultConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/query_result#dataset DataHoneycombioQueryResult#dataset}
  */
  readonly dataset?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/query_result#id DataHoneycombioQueryResult#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/query_result#query_json DataHoneycombioQueryResult#query_json}
  */
  readonly queryJson: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/query_result honeycombio_query_result}
*/
export class DataHoneycombioQueryResult extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHoneycombioQueryResult that should be imported. Refer to the {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/query_result#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/query_result honeycombio_query_result} Data Source
  *
  * @param scope The scope in which to define this construct
