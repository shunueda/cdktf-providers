// https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/dataset
...
export interface DataHoneycombioDatasetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/dataset#slug DataHoneycombioDataset#slug}
  */
  readonly slug: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/dataset honeycombio_dataset}
*/
export class DataHoneycombioDataset extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHoneycombioDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/dataset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/honeycombio/honeycombio/0.44.0/docs/data-sources/dataset honeycombio_dataset} Data Source
  *
  * @param scope The scope in which to define this construct
