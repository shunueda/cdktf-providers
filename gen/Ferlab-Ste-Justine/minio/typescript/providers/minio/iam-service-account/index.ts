// https://registry.terraform.io/providers/ferlab-ste-justine/minio/0.2.0/docs/resources/iam_service_account
...
export interface IamServiceAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ferlab-ste-justine/minio/0.2.0/docs/resources/iam_service_account#disable_user IamServiceAccount#disable_user}
  */
  readonly disableUser?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ferlab-ste-justine/minio/0.2.0/docs/resources/iam_service_account#id IamServiceAccount#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ferlab-ste-justine/minio/0.2.0/docs/resources/iam_service_account#target_user IamServiceAccount#target_user}
  */
  readonly targetUser: string;
  /**
  * rotate secret key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ferlab-ste-justine/minio/0.2.0/docs/resources/iam_service_account#update_secret IamServiceAccount#update_secret}
  */
  readonly updateSecret?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ferlab-ste-justine/minio/0.2.0/docs/resources/iam_service_account minio_iam_service_account}
*/
export class IamServiceAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/ferlab-ste-justine/minio/0.2.0/docs/resources/iam_service_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ferlab-ste-justine/minio/0.2.0/docs/resources/iam_service_account minio_iam_service_account} Resource
  *
  * @param scope The scope in which to define this construct
