// https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/secret
...
export interface SecretConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/secret#allow_on_pull_request Secret#allow_on_pull_request}
  */
  readonly allowOnPullRequest?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/secret#id Secret#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/secret#name Secret#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/secret#repository Secret#repository}
  */
  readonly repository: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/secret#value Secret#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/secret drone_secret}
*/
export class Secret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Secret that should be imported. Refer to the {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/secret drone_secret} Resource
  *
  * @param scope The scope in which to define this construct
