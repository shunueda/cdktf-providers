// https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/orgsecret
...
export interface OrgsecretConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/orgsecret#allow_on_pull_request Orgsecret#allow_on_pull_request}
  */
  readonly allowOnPullRequest?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/orgsecret#allow_push_on_pull_request Orgsecret#allow_push_on_pull_request}
  */
  readonly allowPushOnPullRequest?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/orgsecret#id Orgsecret#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/orgsecret#name Orgsecret#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/orgsecret#namespace Orgsecret#namespace}
  */
  readonly namespace: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/orgsecret#value Orgsecret#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/orgsecret drone_orgsecret}
*/
export class Orgsecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Orgsecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/orgsecret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lucretius/drone/0.2.5/docs/resources/orgsecret drone_orgsecret} Resource
  *
  * @param scope The scope in which to define this construct
