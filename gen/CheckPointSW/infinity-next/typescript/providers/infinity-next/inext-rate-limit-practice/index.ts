// https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.1/docs/resources/inext_rate_limit_practice
...
export interface InextRateLimitPracticeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.1/docs/resources/inext_rate_limit_practice#name InextRateLimitPractice#name}
  */
  readonly name: string;
  /**
  * The visibility of the resource, Shared or Local
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.1/docs/resources/inext_rate_limit_practice#visibility InextRateLimitPractice#visibility}
  */
  readonly visibility?: string;
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.1/docs/resources/inext_rate_limit_practice#rule InextRateLimitPractice#rule}
  */
...
export interface InextRateLimitPracticeRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.1/docs/resources/inext_rate_limit_practice#action InextRateLimitPractice#action}
  */
  readonly action?: string;
  /**
  * A general comment which describes the rate limit rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.1/docs/resources/inext_rate_limit_practice#comment InextRateLimitPractice#comment}
  */
  readonly comment?: string;
  /**
  * The actual number of requests to enable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.1/docs/resources/inext_rate_limit_practice#limit InextRateLimitPractice#limit}
  */
  readonly limit: number;
  /**
  * The time unit during which the rate limit is enfrorced. Must be one of: Minute, Second
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.1/docs/resources/inext_rate_limit_practice#scope InextRateLimitPractice#scope}
  */
  readonly scope: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.1/docs/resources/inext_rate_limit_practice#uri InextRateLimitPractice#uri}
  */
  readonly uri: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.1/docs/resources/inext_rate_limit_practice inext_rate_limit_practice}
*/
export class InextRateLimitPractice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InextRateLimitPractice that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.1/docs/resources/inext_rate_limit_practice#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.1/docs/resources/inext_rate_limit_practice inext_rate_limit_practice} Resource
  *
  * @param scope The scope in which to define this construct
