// https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_web_user_response
...
export interface InextWebUserResponseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_web_user_response#http_response_code InextWebUserResponse#http_response_code}
  */
  readonly httpResponseCode?: number;
  /**
  * The body of the message to be shown to the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_web_user_response#message_body InextWebUserResponse#message_body}
  */
  readonly messageBody?: string;
  /**
  * The title of the web page to be shown to the user sending the malicious traffic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_web_user_response#message_title InextWebUserResponse#message_title}
  */
  readonly messageTitle?: string;
  /**
  * The type of the web user response object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_web_user_response#mode InextWebUserResponse#mode}
  */
  readonly mode: string;
  /**
  * The name of the resource, also acts as its unique ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_web_user_response#name InextWebUserResponse#name}
  */
  readonly name: string;
  /**
  * The client will be redirected to the provided URL where you can provide any customized web page
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_web_user_response#redirect_url InextWebUserResponse#redirect_url}
  */
  readonly redirectUrl?: string;
  /**
  * The visibility of the web user response object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_web_user_response#visibility InextWebUserResponse#visibility}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_web_user_response#x_event_id InextWebUserResponse#x_event_id}
  */
  readonly xEventId?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_web_user_response inext_web_user_response}
*/
export class InextWebUserResponse extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InextWebUserResponse that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_web_user_response#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_web_user_response inext_web_user_response} Resource
  *
  * @param scope The scope in which to define this construct
