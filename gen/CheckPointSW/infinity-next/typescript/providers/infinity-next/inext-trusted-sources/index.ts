// https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_trusted_sources
...
export interface InextTrustedSourcesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_trusted_sources#min_num_of_sources InextTrustedSources#min_num_of_sources}
  */
  readonly minNumOfSources: number;
  /**
  * The name of the resource, also acts as its unique ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_trusted_sources#name InextTrustedSources#name}
  */
  readonly name: string;
  /**
  * The trusted sources identifier values
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_trusted_sources#sources_identifiers InextTrustedSources#sources_identifiers}
  */
  readonly sourcesIdentifiers?: string[];
  /**
  * The visibility of the resource - Shared or Local
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_trusted_sources#visibility InextTrustedSources#visibility}
  */
  readonly visibility?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_trusted_sources inext_trusted_sources}
*/
export class InextTrustedSources extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InextTrustedSources that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_trusted_sources#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.4.0/docs/resources/inext_trusted_sources inext_trusted_sources} Resource
  *
  * @param scope The scope in which to define this construct
