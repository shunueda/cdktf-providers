// https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.0/docs/resources/inext_kubernetes_profile
...
export interface InextKubernetesProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.0/docs/resources/inext_kubernetes_profile#additional_settings InextKubernetesProfile#additional_settings}
  */
  readonly additionalSettings?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.0/docs/resources/inext_kubernetes_profile#defined_applications_only InextKubernetesProfile#defined_applications_only}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.0/docs/resources/inext_kubernetes_profile#max_number_of_agents InextKubernetesProfile#max_number_of_agents}
  */
  readonly maxNumberOfAgents?: number;
  /**
  * The name of the resource, also acts as its unique ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.0/docs/resources/inext_kubernetes_profile#name InextKubernetesProfile#name}
  */
  readonly name: string;
  /**
  * The sub type of the profile (AppSec, AccessControl, Kong, Istio)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.0/docs/resources/inext_kubernetes_profile#profile_sub_type InextKubernetesProfile#profile_sub_type}
  */
  readonly profileSubType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.0/docs/resources/inext_kubernetes_profile inext_kubernetes_profile}
*/
export class InextKubernetesProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InextKubernetesProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.0/docs/resources/inext_kubernetes_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.3.0/docs/resources/inext_kubernetes_profile inext_kubernetes_profile} Resource
  *
  * @param scope The scope in which to define this construct
