// https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile
...
export interface InextEmbeddedProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile#additional_settings InextEmbeddedProfile#additional_settings}
  */
  readonly additionalSettings?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile#defined_applications_only InextEmbeddedProfile#defined_applications_only}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile#max_number_of_agents InextEmbeddedProfile#max_number_of_agents}
  */
  readonly maxNumberOfAgents?: number;
  /**
  * The name of the resource, also acts as its unique ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile#name InextEmbeddedProfile#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile#upgrade_mode InextEmbeddedProfile#upgrade_mode}
  */
  readonly upgradeMode?: string;
  /**
  * The days of the month of the upgrade time schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile#upgrade_time_days InextEmbeddedProfile#upgrade_time_days}
  */
  readonly upgradeTimeDays?: number[];
  /**
  * The duration of the upgrade in hours
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile#upgrade_time_duration InextEmbeddedProfile#upgrade_time_duration}
  */
  readonly upgradeTimeDuration?: number;
  /**
  * The hour of the upgrade time start, for example: 10:00 or 20:00
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile#upgrade_time_hour InextEmbeddedProfile#upgrade_time_hour}
  */
  readonly upgradeTimeHour?: string;
  /**
  * The schedule type in case upgrade mode is scheduled: DaysInWeek, DaysInMonth or Daily
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile#upgrade_time_schedule_type InextEmbeddedProfile#upgrade_time_schedule_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile#upgrade_time_week_days InextEmbeddedProfile#upgrade_time_week_days}
  */
  readonly upgradeTimeWeekDays?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile inext_embedded_profile}
*/
export class InextEmbeddedProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InextEmbeddedProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/infinity-next/1.2.0/docs/resources/inext_embedded_profile inext_embedded_profile} Resource
  *
  * @param scope The scope in which to define this construct
