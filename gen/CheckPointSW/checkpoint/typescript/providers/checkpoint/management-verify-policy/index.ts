// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_verify_policy
...
export interface ManagementVerifyPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_verify_policy#id ManagementVerifyPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_verify_policy#policy_package ManagementVerifyPolicy#policy_package}
  */
  readonly policyPackage: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_verify_policy checkpoint_management_verify_policy}
*/
export class ManagementVerifyPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagementVerifyPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_verify_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_verify_policy checkpoint_management_verify_policy} Resource
  *
  * @param scope The scope in which to define this construct
