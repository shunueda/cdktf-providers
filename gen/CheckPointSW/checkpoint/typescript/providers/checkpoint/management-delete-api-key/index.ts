...
export interface ManagementDeleteApiKeyConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class ManagementDeleteApiKey extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "checkpoint_management_delete_api_key";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "checkpoint_management_delete_api_key", importId: importFromId, provider });
      }
  ...
  * @param options ManagementDeleteApiKeyConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ManagementDeleteApiKeyConfig = {}) {
    super(scope, id, {
