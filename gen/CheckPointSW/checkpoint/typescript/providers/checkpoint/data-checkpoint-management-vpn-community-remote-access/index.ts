...
export class DataCheckpointManagementVpnCommunityRemoteAccess extends cdktf.TerraformDataSource {
  ...
  * @param options DataCheckpointManagementVpnCommunityRemoteAccessConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataCheckpointManagementVpnCommunityRemoteAccessConfig = {}) {
    super(scope, id, {
