...
export interface ManagementAddressRangeConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class ManagementAddressRange extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "checkpoint_management_address_range";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "checkpoint_management_address_range", importId: importFromId, provider });
      }
  ...
  * @param options ManagementAddressRangeConfig
  */
  public constructor(scope: Construct, id: string, config: ManagementAddressRangeConfig) {
    super(scope, id, {
