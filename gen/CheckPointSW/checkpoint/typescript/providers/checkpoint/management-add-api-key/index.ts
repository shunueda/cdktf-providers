// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_add_api_key
...
export interface ManagementAddApiKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_add_api_key#admin_name ManagementAddApiKey#admin_name}
  */
  readonly adminName?: string;
  /**
  * Administrator uid to generate API key for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_add_api_key#admin_uid ManagementAddApiKey#admin_uid}
  */
  readonly adminUid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_add_api_key#id ManagementAddApiKey#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_add_api_key checkpoint_management_add_api_key}
*/
export class ManagementAddApiKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagementAddApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_add_api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_add_api_key checkpoint_management_add_api_key} Resource
  *
  * @param scope The scope in which to define this construct
