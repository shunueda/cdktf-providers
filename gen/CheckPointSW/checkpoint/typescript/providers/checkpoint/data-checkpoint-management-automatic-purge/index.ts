// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/data-sources/management_automatic_purge
...
export interface DataCheckpointManagementAutomaticPurgeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/data-sources/management_automatic_purge#id DataCheckpointManagementAutomaticPurge#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/data-sources/management_automatic_purge checkpoint_management_automatic_purge}
*/
export class DataCheckpointManagementAutomaticPurge extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCheckpointManagementAutomaticPurge that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/data-sources/management_automatic_purge#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/data-sources/management_automatic_purge checkpoint_management_automatic_purge} Data Source
  *
  * @param scope The scope in which to define this construct
