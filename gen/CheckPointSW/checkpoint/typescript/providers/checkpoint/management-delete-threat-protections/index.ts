// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_delete_threat_protections
...
export interface ManagementDeleteThreatProtectionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_delete_threat_protections#id ManagementDeleteThreatProtections#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_delete_threat_protections#package_format ManagementDeleteThreatProtections#package_format}
  */
  readonly packageFormat?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_delete_threat_protections checkpoint_management_delete_threat_protections}
*/
export class ManagementDeleteThreatProtections extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagementDeleteThreatProtections that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_delete_threat_protections#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_delete_threat_protections checkpoint_management_delete_threat_protections} Resource
  *
  * @param scope The scope in which to define this construct
