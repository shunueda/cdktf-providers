// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/generic_api
...
export interface GenericApiConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/generic_api#api_command GenericApi#api_command}
  */
  readonly apiCommand: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/generic_api#id GenericApi#id}
  *
  ...
  * HTTP request method
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/generic_api#method GenericApi#method}
  */
  readonly method?: string;
  /**
  * Request payload in JSON format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/generic_api#payload GenericApi#payload}
  */
  readonly payload?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/generic_api checkpoint_generic_api}
*/
export class GenericApi extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GenericApi that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/generic_api#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/generic_api checkpoint_generic_api} Resource
  *
  * @param scope The scope in which to define this construct
