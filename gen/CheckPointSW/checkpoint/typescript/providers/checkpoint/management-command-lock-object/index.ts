...
export class ManagementCommandLockObject extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "checkpoint_management_command_lock_object";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "checkpoint_management_command_lock_object", importId: importFromId, provider });
      }
  ...
  * @param options ManagementCommandLockObjectConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ManagementCommandLockObjectConfig = {}) {
    super(scope, id, {
