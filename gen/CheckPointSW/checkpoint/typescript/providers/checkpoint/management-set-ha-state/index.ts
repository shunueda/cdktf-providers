// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_set_ha_state
...
export interface ManagementSetHaStateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_set_ha_state#id ManagementSetHaState#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_set_ha_state#new_state ManagementSetHaState#new_state}
  */
  readonly newState: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_set_ha_state checkpoint_management_set_ha_state}
*/
export class ManagementSetHaState extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagementSetHaState that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_set_ha_state#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_set_ha_state checkpoint_management_set_ha_state} Resource
  *
  * @param scope The scope in which to define this construct
