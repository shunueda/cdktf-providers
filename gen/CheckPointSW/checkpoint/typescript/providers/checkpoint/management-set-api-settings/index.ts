// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_set_api_settings
...
export interface ManagementSetApiSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_set_api_settings#accepted_api_calls_from ManagementSetApiSettings#accepted_api_calls_from}
  */
  readonly acceptedApiCallsFrom?: string;
  /**
  * MGMT API will start after server will start.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_set_api_settings#automatic_start ManagementSetApiSettings#automatic_start}
  */
  readonly automaticStart?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_set_api_settings#id ManagementSetApiSettings#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_set_api_settings checkpoint_management_set_api_settings}
*/
export class ManagementSetApiSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagementSetApiSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_set_api_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_set_api_settings checkpoint_management_set_api_settings} Resource
  *
  * @param scope The scope in which to define this construct
