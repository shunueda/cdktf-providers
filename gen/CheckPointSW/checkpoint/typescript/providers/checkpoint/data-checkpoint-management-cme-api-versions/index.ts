// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_cme_api_versions
...
export interface DataCheckpointManagementCmeApiVersionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_cme_api_versions#id DataCheckpointManagementCmeApiVersions#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_cme_api_versions checkpoint_management_cme_api_versions}
*/
export class DataCheckpointManagementCmeApiVersions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCheckpointManagementCmeApiVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_cme_api_versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_cme_api_versions checkpoint_management_cme_api_versions} Data Source
  *
  * @param scope The scope in which to define this construct
