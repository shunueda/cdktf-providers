...
export interface ManagementHttpsLayerConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class ManagementHttpsLayer extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "checkpoint_management_https_layer";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "checkpoint_management_https_layer", importId: importFromId, provider });
      }
  ...
  * @param options ManagementHttpsLayerConfig
  */
  public constructor(scope: Construct, id: string, config: ManagementHttpsLayerConfig) {
    super(scope, id, {
