// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_app_control_update_schedule
...
export interface DataCheckpointManagementAppControlUpdateScheduleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_app_control_update_schedule#id DataCheckpointManagementAppControlUpdateSchedule#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_app_control_update_schedule checkpoint_management_app_control_update_schedule}
*/
export class DataCheckpointManagementAppControlUpdateSchedule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCheckpointManagementAppControlUpdateSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_app_control_update_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_app_control_update_schedule checkpoint_management_app_control_update_schedule} Data Source
  *
  * @param scope The scope in which to define this construct
