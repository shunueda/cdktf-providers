// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/data-sources/management_threat_advanced_settings
...
export interface DataCheckpointManagementThreatAdvancedSettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/data-sources/management_threat_advanced_settings#id DataCheckpointManagementThreatAdvancedSettings#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/data-sources/management_threat_advanced_settings checkpoint_management_threat_advanced_settings}
*/
export class DataCheckpointManagementThreatAdvancedSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCheckpointManagementThreatAdvancedSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/data-sources/management_threat_advanced_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/data-sources/management_threat_advanced_settings checkpoint_management_threat_advanced_settings} Data Source
  *
  * @param scope The scope in which to define this construct
