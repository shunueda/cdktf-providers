// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_lsm_run_script
...
export interface ManagementLsmRunScriptConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_lsm_run_script#id ManagementLsmRunScript#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_lsm_run_script#script ManagementLsmRunScript#script}
  */
  readonly script?: string;
  /**
  * The entire content of the script encoded in Base64.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_lsm_run_script#script_base64 ManagementLsmRunScript#script_base64}
  */
  readonly scriptBase64?: string;
  /**
  * On what targets to execute this command. Targets may be identified by their name, or object unique identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_lsm_run_script#targets ManagementLsmRunScript#targets}
  */
  readonly targets: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_lsm_run_script checkpoint_management_lsm_run_script}
*/
export class ManagementLsmRunScript extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagementLsmRunScript that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_lsm_run_script#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.12.0/docs/resources/management_lsm_run_script checkpoint_management_lsm_run_script} Resource
  *
  * @param scope The scope in which to define this construct
