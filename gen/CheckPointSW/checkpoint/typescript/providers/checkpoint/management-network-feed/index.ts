...
export interface ManagementNetworkFeedConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function managementNetworkFeedCustomHeaderToTerraform(struct?: ManagementNetworkFeedCustomHeader | cdktf.IResolvable): any {
...
export function managementNetworkFeedCustomHeaderToHclTerraform(struct?: ManagementNetworkFeedCustomHeader | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ManagementNetworkFeedCustomHeaderOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ManagementNetworkFeedCustomHeader | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ManagementNetworkFeedCustomHeader | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ManagementNetworkFeedCustomHeaderList extends cdktf.ComplexList {
  public internalValue? : ManagementNetworkFeedCustomHeader[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ManagementNetworkFeedCustomHeaderOutputReference {
    return new ManagementNetworkFeedCustomHeaderOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ManagementNetworkFeed extends cdktf.TerraformResource {
  ...
  * @param options ManagementNetworkFeedConfig
  */
  public constructor(scope: Construct, id: string, config: ManagementNetworkFeedConfig) {
    super(scope, id, {
    ...
    this._dataColumn = config.dataColumn;
    this._domainsToProcess = config.domainsToProcess;
    this._feedFormat = config.feedFormat;
    ...
    this._jsonQuery = config.jsonQuery;
  ...
  // data_column - computed: false, optional: true, required: false
  private _dataColumn?: number; 
  public get dataColumn() {
    return this.getNumberAttribute('data_column');
  }
  public set dataColumn(value: number) {
    this._dataColumn = value;
  }
  public resetDataColumn() {
    this._dataColumn = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get dataColumnInput() {
  ...
  // feed_format - computed: false, optional: true, required: false
  private _feedFormat?: string; 
  public get feedFormat() {
    return this.getStringAttribute('feed_format');
  }
  public set feedFormat(value: string) {
    this._feedFormat = value;
  }
  public resetFeedFormat() {
    this._feedFormat = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get feedFormatInput() {
  ...
  // json_query - computed: false, optional: true, required: false
  private _jsonQuery?: string; 
  public get jsonQuery() {
    return this.getStringAttribute('json_query');
  }
  public set jsonQuery(value: string) {
    this._jsonQuery = value;
  }
  public resetJsonQuery() {
    this._jsonQuery = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get jsonQueryInput() {
  ...
  private _customHeader = new ManagementNetworkFeedCustomHeaderList(this, "custom_header", false);
  public get customHeader() {
    return this._customHeader;
  }
  public putCustomHeader(value: ManagementNetworkFeedCustomHeader[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      data_column: cdktf.numberToTerraform(this._dataColumn),
      domains_to_process: cdktf.listMapper(cdktf.stringToTerraform, false)(this._domainsToProcess),
      feed_format: cdktf.stringToTerraform(this._feedFormat),
      ...
      json_query: cdktf.stringToTerraform(this._jsonQuery),
      ...
      custom_header: cdktf.listMapper(managementNetworkFeedCustomHeaderToTerraform, true)(this._customHeader.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      data_column: {
        value: cdktf.numberToHclTerraform(this._dataColumn),
        isBlock: false,
        type: "simple",
      ...
      feed_format: {
        value: cdktf.stringToHclTerraform(this._feedFormat),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      json_query: {
        value: cdktf.stringToHclTerraform(this._jsonQuery),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      custom_header: {
        value: cdktf.listMapperHcl(managementNetworkFeedCustomHeaderToHclTerraform, true)(this._customHeader.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ManagementNetworkFeedCustomHeaderList",
      },
    };
