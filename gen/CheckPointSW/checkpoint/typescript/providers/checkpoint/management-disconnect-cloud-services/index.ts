...
export interface ManagementDisconnectCloudServicesConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class ManagementDisconnectCloudServices extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "checkpoint_management_disconnect_cloud_services";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "checkpoint_management_disconnect_cloud_services", importId: importFromId, provider });
      }
  ...
  * @param options ManagementDisconnectCloudServicesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ManagementDisconnectCloudServicesConfig = {}) {
    super(scope, id, {
