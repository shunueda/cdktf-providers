// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_test_sic_status
...
export interface ManagementTestSicStatusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_test_sic_status#id ManagementTestSicStatus#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_test_sic_status#name ManagementTestSicStatus#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_test_sic_status checkpoint_management_test_sic_status}
*/
export class ManagementTestSicStatus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagementTestSicStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_test_sic_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_test_sic_status checkpoint_management_test_sic_status} Resource
  *
  * @param scope The scope in which to define this construct
