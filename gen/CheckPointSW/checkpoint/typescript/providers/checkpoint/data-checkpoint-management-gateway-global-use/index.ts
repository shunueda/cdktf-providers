// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_gateway_global_use
...
export interface DataCheckpointManagementGatewayGlobalUseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_gateway_global_use#id DataCheckpointManagementGatewayGlobalUse#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_gateway_global_use#target DataCheckpointManagementGatewayGlobalUse#target}
  */
  readonly target: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_gateway_global_use checkpoint_management_gateway_global_use}
*/
export class DataCheckpointManagementGatewayGlobalUse extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCheckpointManagementGatewayGlobalUse that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_gateway_global_use#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/data-sources/management_gateway_global_use checkpoint_management_gateway_global_use} Data Source
  *
  * @param scope The scope in which to define this construct
