// https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_disconnect
...
export interface ManagementDisconnectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_disconnect#discard ManagementDisconnect#discard}
  */
  readonly discard?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_disconnect#id ManagementDisconnect#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_disconnect checkpoint_management_disconnect}
*/
export class ManagementDisconnect extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagementDisconnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_disconnect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkpointsw/checkpoint/2.11.0/docs/resources/management_disconnect checkpoint_management_disconnect} Resource
  *
  * @param scope The scope in which to define this construct
