...
export interface ManagementServiceTcpConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class ManagementServiceTcp extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "checkpoint_management_service_tcp";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "checkpoint_management_service_tcp", importId: importFromId, provider });
      }
  ...
  * @param options ManagementServiceTcpConfig
  */
  public constructor(scope: Construct, id: string, config: ManagementServiceTcpConfig) {
    super(scope, id, {
