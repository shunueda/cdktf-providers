// https://registry.terraform.io/providers/hetznercloud/hcloud/1.57.0/docs/data-sources/floating_ips
...
export interface DataHcloudFloatingIpsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hetznercloud/hcloud/1.57.0/docs/data-sources/floating_ips#id DataHcloudFloatingIps#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hetznercloud/hcloud/1.57.0/docs/data-sources/floating_ips#with_selector DataHcloudFloatingIps#with_selector}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hetznercloud/hcloud/1.57.0/docs/data-sources/floating_ips hcloud_floating_ips}
*/
export class DataHcloudFloatingIps extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcloudFloatingIps that should be imported. Refer to the {@link https://registry.terraform.io/providers/hetznercloud/hcloud/1.57.0/docs/data-sources/floating_ips#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hetznercloud/hcloud/1.57.0/docs/data-sources/floating_ips hcloud_floating_ips} Data Source
  *
  * @param scope The scope in which to define this construct
