// https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_ldap_group_policy_attachment
...
export interface IamLdapGroupPolicyAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_ldap_group_policy_attachment#group_dn IamLdapGroupPolicyAttachment#group_dn}
  */
  readonly groupDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_ldap_group_policy_attachment#id IamLdapGroupPolicyAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_ldap_group_policy_attachment#policy_name IamLdapGroupPolicyAttachment#policy_name}
  */
  readonly policyName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_ldap_group_policy_attachment minio_iam_ldap_group_policy_attachment}
*/
export class IamLdapGroupPolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamLdapGroupPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_ldap_group_policy_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_ldap_group_policy_attachment minio_iam_ldap_group_policy_attachment} Resource
  *
  * @param scope The scope in which to define this construct
