// https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/data-sources/iam_user
...
export interface DataMinioIamUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/data-sources/iam_user#id DataMinioIamUser#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/data-sources/iam_user#name DataMinioIamUser#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/data-sources/iam_user minio_iam_user}
*/
export class DataMinioIamUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMinioIamUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/data-sources/iam_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/data-sources/iam_user minio_iam_user} Data Source
  *
  * @param scope The scope in which to define this construct
