// https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/s3_bucket_retention
...
export interface S3BucketRetentionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/s3_bucket_retention#bucket S3BucketRetention#bucket}
  */
  readonly bucket: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/s3_bucket_retention#id S3BucketRetention#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/s3_bucket_retention#mode S3BucketRetention#mode}
  */
  readonly mode: string;
  /**
  * Time unit for the validity period. Valid values are DAYS or YEARS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/s3_bucket_retention#unit S3BucketRetention#unit}
  */
  readonly unit: string;
  /**
  * Duration for which objects should be retained under WORM lock, in the specified unit. Must be a positive integer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/s3_bucket_retention#validity_period S3BucketRetention#validity_period}
  */
  readonly validityPeriod: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/s3_bucket_retention minio_s3_bucket_retention}
*/
export class S3BucketRetention extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3BucketRetention that should be imported. Refer to the {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/s3_bucket_retention#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/s3_bucket_retention minio_s3_bucket_retention} Resource
  *
  * @param scope The scope in which to define this construct
