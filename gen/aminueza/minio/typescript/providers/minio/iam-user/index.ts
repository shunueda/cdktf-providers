// https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_user
...
export interface IamUserConfig extends cdktf.TerraformMetaArguments {
  ...
  * Disable user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_user#disable_user IamUser#disable_user}
  */
  readonly disableUser?: boolean | cdktf.IResolvable;
  /**
  * Delete user even if it has non-Terraform-managed IAM access keys
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_user#force_destroy IamUser#force_destroy}
  */
  readonly forceDestroy?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_user#id IamUser#id}
  *
  ...
  * Name of the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_user#name IamUser#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_user#secret IamUser#secret}
  */
  readonly secret?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_user#tags IamUser#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Rotate Minio User Secret Key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_user#update_secret IamUser#update_secret}
  */
  readonly updateSecret?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_user minio_iam_user}
*/
export class IamUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aminueza/minio/3.11.3/docs/resources/iam_user minio_iam_user} Resource
  *
  * @param scope The scope in which to define this construct
