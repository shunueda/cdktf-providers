// https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/iam_ldap_user_policy_attachment
...
export interface IamLdapUserPolicyAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/iam_ldap_user_policy_attachment#id IamLdapUserPolicyAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/iam_ldap_user_policy_attachment#policy_name IamLdapUserPolicyAttachment#policy_name}
  */
  readonly policyName: string;
  /**
  * The dn of user to attach policy to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/iam_ldap_user_policy_attachment#user_dn IamLdapUserPolicyAttachment#user_dn}
  */
  readonly userDn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/iam_ldap_user_policy_attachment minio_iam_ldap_user_policy_attachment}
*/
export class IamLdapUserPolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamLdapUserPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/iam_ldap_user_policy_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aminueza/minio/3.11.5/docs/resources/iam_ldap_user_policy_attachment minio_iam_ldap_user_policy_attachment} Resource
  *
  * @param scope The scope in which to define this construct
