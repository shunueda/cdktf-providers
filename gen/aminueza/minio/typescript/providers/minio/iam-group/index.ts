// https://registry.terraform.io/providers/aminueza/minio/3.12.0/docs/resources/iam_group
...
export interface IamGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Disable group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.12.0/docs/resources/iam_group#disable_group IamGroup#disable_group}
  */
  readonly disableGroup?: boolean | cdktf.IResolvable;
  /**
  * Delete group even if it has non-Terraform-managed members
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.12.0/docs/resources/iam_group#force_destroy IamGroup#force_destroy}
  */
  readonly forceDestroy?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.12.0/docs/resources/iam_group#id IamGroup#id}
  *
  ...
  * Name of the group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aminueza/minio/3.12.0/docs/resources/iam_group#name IamGroup#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aminueza/minio/3.12.0/docs/resources/iam_group minio_iam_group}
*/
export class IamGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aminueza/minio/3.12.0/docs/resources/iam_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aminueza/minio/3.12.0/docs/resources/iam_group minio_iam_group} Resource
  *
  * @param scope The scope in which to define this construct
