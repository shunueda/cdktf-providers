// https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/resources/dedicated_network_container
...
export interface DedicatedNetworkContainerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/resources/dedicated_network_container#cidr_notation DedicatedNetworkContainer#cidr_notation}
  */
  readonly cidrNotation: string;
  /**
  * The project ID for the network container
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/resources/dedicated_network_container#project_id DedicatedNetworkContainer#project_id}
  */
  readonly projectId?: string;
  /**
  * The region ID for the network container
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/resources/dedicated_network_container#region_id DedicatedNetworkContainer#region_id}
  */
  readonly regionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/resources/dedicated_network_container tidbcloud_dedicated_network_container}
*/
export class DedicatedNetworkContainer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DedicatedNetworkContainer that should be imported. Refer to the {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/resources/dedicated_network_container#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/resources/dedicated_network_container tidbcloud_dedicated_network_container} Resource
  *
  * @param scope The scope in which to define this construct
