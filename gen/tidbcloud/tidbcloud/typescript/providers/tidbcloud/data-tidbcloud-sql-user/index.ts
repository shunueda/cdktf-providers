// https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/data-sources/sql_user
...
export interface DataTidbcloudSqlUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/data-sources/sql_user#cluster_id DataTidbcloudSqlUser#cluster_id}
  */
  readonly clusterId: string;
  /**
  * The name of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/data-sources/sql_user#user_name DataTidbcloudSqlUser#user_name}
  */
  readonly userName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/data-sources/sql_user tidbcloud_sql_user}
*/
export class DataTidbcloudSqlUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTidbcloudSqlUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/data-sources/sql_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/data-sources/sql_user tidbcloud_sql_user} Data Source
  *
  * @param scope The scope in which to define this construct
