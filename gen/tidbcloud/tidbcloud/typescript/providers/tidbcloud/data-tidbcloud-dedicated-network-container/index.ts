// https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.5/docs/data-sources/dedicated_network_container
...
export interface DataTidbcloudDedicatedNetworkContainerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.5/docs/data-sources/dedicated_network_container#network_container_id DataTidbcloudDedicatedNetworkContainer#network_container_id}
  */
  readonly networkContainerId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.5/docs/data-sources/dedicated_network_container tidbcloud_dedicated_network_container}
*/
export class DataTidbcloudDedicatedNetworkContainer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTidbcloudDedicatedNetworkContainer that should be imported. Refer to the {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.5/docs/data-sources/dedicated_network_container#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.5/docs/data-sources/dedicated_network_container tidbcloud_dedicated_network_container} Data Source
  *
  * @param scope The scope in which to define this construct
