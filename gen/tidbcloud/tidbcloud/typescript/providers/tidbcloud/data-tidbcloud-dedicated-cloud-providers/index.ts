// https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/data-sources/dedicated_cloud_providers
...
export interface DataTidbcloudDedicatedCloudProvidersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/data-sources/dedicated_cloud_providers#project_id DataTidbcloudDedicatedCloudProviders#project_id}
  */
  readonly projectId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/data-sources/dedicated_cloud_providers tidbcloud_dedicated_cloud_providers}
*/
export class DataTidbcloudDedicatedCloudProviders extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTidbcloudDedicatedCloudProviders that should be imported. Refer to the {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/data-sources/dedicated_cloud_providers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tidbcloud/tidbcloud/0.4.6/docs/data-sources/dedicated_cloud_providers tidbcloud_dedicated_cloud_providers} Data Source
  *
  * @param scope The scope in which to define this construct
