// https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk
...
export interface IntegrationJiraServicedeskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk#api_email IntegrationJiraServicedesk#api_email}
  */
  readonly apiEmail: string;
  /**
  * API token for JIRA authentication
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk#api_token IntegrationJiraServicedesk#api_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk#contact_groups IntegrationJiraServicedesk#contact_groups}
  */
  readonly contactGroups?: string[];
  /**
  * Custom field ID for account name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk#custom_field_id_account_name IntegrationJiraServicedesk#custom_field_id_account_name}
  */
  readonly customFieldIdAccountName?: number;
  /**
  * Custom field ID for check name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk#custom_field_id_check_name IntegrationJiraServicedesk#custom_field_id_check_name}
  */
  readonly customFieldIdCheckName?: number;
  /**
  * Custom field ID for check URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk#custom_field_id_check_url IntegrationJiraServicedesk#custom_field_id_check_url}
  */
  readonly customFieldIdCheckUrl?: number;
  /**
  * Additional custom fields as JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk#custom_fields_json IntegrationJiraServicedesk#custom_fields_json}
  */
  readonly customFieldsJson?: string;
  /**
  * JIRA subdomain (e.g., 'mycompany' for mycompany.atlassian.net)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk#jira_subdomain IntegrationJiraServicedesk#jira_subdomain}
  */
  readonly jiraSubdomain: string;
  /**
  * Comma-separated list of labels to add to created issues
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk#labels IntegrationJiraServicedesk#labels}
  */
  readonly labels?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk#name IntegrationJiraServicedesk#name}
  */
  readonly name: string;
  /**
  * JIRA project key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk#project_key IntegrationJiraServicedesk#project_key}
  */
  readonly projectKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk uptime_integration_jira_servicedesk}
*/
export class IntegrationJiraServicedesk extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationJiraServicedesk that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_jira_servicedesk uptime_integration_jira_servicedesk} Resource
  *
  * @param scope The scope in which to define this construct
