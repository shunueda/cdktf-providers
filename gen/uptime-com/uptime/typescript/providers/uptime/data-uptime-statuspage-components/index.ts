// https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/data-sources/statuspage_components
...
export interface DataUptimeStatuspageComponentsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/data-sources/statuspage_components#statuspage_id DataUptimeStatuspageComponents#statuspage_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/data-sources/statuspage_components uptime_statuspage_components}
*/
export class DataUptimeStatuspageComponents extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataUptimeStatuspageComponents that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/data-sources/statuspage_components#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/data-sources/statuspage_components uptime_statuspage_components} Data Source
  *
  * @param scope The scope in which to define this construct
