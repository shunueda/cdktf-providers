// https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/scheduled_report
...
export interface ScheduledReportConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/scheduled_report#at_time ScheduledReport#at_time}
  */
  readonly atTime?: number;
  /**
  * Report file type, valid values are PDF(default) or XLS
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/scheduled_report#file_type ScheduledReport#file_type}
  */
  readonly fileType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/scheduled_report#is_enabled ScheduledReport#is_enabled}
  */
  readonly isEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/scheduled_report#name ScheduledReport#name}
  */
  readonly name: string;
  /**
  * Weekly reports will be sent on this day
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/scheduled_report#on_weekday ScheduledReport#on_weekday}
  */
  readonly onWeekday?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/scheduled_report#recipient_emails ScheduledReport#recipient_emails}
  */
  readonly recipientEmails?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/scheduled_report#recipient_users ScheduledReport#recipient_users}
  */
  readonly recipientUsers?: string[];
  /**
  * How often to deliver this report. Valid values are DAILY, WEEKLY, MONTHLY, QUARTERLY, YEARLY
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/scheduled_report#recurrence ScheduledReport#recurrence}
  */
  readonly recurrence?: string;
  /**
  * Select an SLA report to send on this schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/scheduled_report#sla_report ScheduledReport#sla_report}
  */
  readonly slaReport: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/scheduled_report uptime_scheduled_report}
*/
export class ScheduledReport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScheduledReport that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/scheduled_report#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/scheduled_report uptime_scheduled_report} Resource
  *
  * @param scope The scope in which to define this construct
