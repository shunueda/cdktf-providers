// https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/service_variable
...
export interface ServiceVariableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/service_variable#credential_id ServiceVariable#credential_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/service_variable#property_name ServiceVariable#property_name}
  */
  readonly propertyName: string;
  /**
  * The ID of the check/service this variable belongs to. Changing this forces recreation of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/service_variable#service_id ServiceVariable#service_id}
  */
  readonly serviceId: number;
  /**
  * The name of the variable as referenced in the check configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/service_variable#variable_name ServiceVariable#variable_name}
  */
  readonly variableName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/service_variable uptime_service_variable}
*/
export class ServiceVariable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/service_variable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/service_variable uptime_service_variable} Resource
  *
  * @param scope The scope in which to define this construct
