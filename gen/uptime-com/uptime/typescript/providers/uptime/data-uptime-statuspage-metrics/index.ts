// https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/data-sources/statuspage_metrics
...
export interface DataUptimeStatuspageMetricsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/data-sources/statuspage_metrics#statuspage_id DataUptimeStatuspageMetrics#statuspage_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/data-sources/statuspage_metrics uptime_statuspage_metrics}
*/
export class DataUptimeStatuspageMetrics extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataUptimeStatuspageMetrics that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/data-sources/statuspage_metrics#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/data-sources/statuspage_metrics uptime_statuspage_metrics} Data Source
  *
  * @param scope The scope in which to define this construct
