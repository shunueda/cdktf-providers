// https://registry.terraform.io/providers/uptime-com/uptime/2.17.1/docs/resources/statuspage_subscriber
...
export interface StatuspageSubscriberConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.17.1/docs/resources/statuspage_subscriber#force_validation_sms StatuspageSubscriber#force_validation_sms}
  */
  readonly forceValidationSms?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.17.1/docs/resources/statuspage_subscriber#statuspage_id StatuspageSubscriber#statuspage_id}
  */
  readonly statuspageId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.17.1/docs/resources/statuspage_subscriber#target StatuspageSubscriber#target}
  */
  readonly target?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.17.1/docs/resources/statuspage_subscriber#type StatuspageSubscriber#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.17.1/docs/resources/statuspage_subscriber uptime_statuspage_subscriber}
*/
export class StatuspageSubscriber extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StatuspageSubscriber that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.17.1/docs/resources/statuspage_subscriber#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.17.1/docs/resources/statuspage_subscriber uptime_statuspage_subscriber} Resource
  *
  * @param scope The scope in which to define this construct
