// https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/data-sources/contacts
...
/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/data-sources/contacts uptime_contacts}
*/
export class DataUptimeContacts extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataUptimeContacts that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/data-sources/contacts#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/data-sources/contacts uptime_contacts} Data Source
  *
  * @param scope The scope in which to define this construct
