// https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/statuspage_subscription_domain_block
...
export interface StatuspageSubscriptionDomainBlockConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/statuspage_subscription_domain_block#domain StatuspageSubscriptionDomainBlock#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/statuspage_subscription_domain_block#statuspage_id StatuspageSubscriptionDomainBlock#statuspage_id}
  */
  readonly statuspageId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/statuspage_subscription_domain_block uptime_statuspage_subscription_domain_block}
*/
export class StatuspageSubscriptionDomainBlock extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StatuspageSubscriptionDomainBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/statuspage_subscription_domain_block#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.1/docs/resources/statuspage_subscription_domain_block uptime_statuspage_subscription_domain_block} Resource
  *
  * @param scope The scope in which to define this construct
