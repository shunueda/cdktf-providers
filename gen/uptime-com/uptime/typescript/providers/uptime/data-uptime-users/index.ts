// https://registry.terraform.io/providers/uptime-com/uptime/2.17.1/docs/data-sources/users
...
/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.17.1/docs/data-sources/users uptime_users}
*/
export class DataUptimeUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataUptimeUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.17.1/docs/data-sources/users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.17.1/docs/data-sources/users uptime_users} Data Source
  *
  * @param scope The scope in which to define this construct
