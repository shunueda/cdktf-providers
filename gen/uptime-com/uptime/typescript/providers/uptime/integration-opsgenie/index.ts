// https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_opsgenie
...
export interface IntegrationOpsgenieConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_opsgenie#api_endpoint IntegrationOpsgenie#api_endpoint}
  */
  readonly apiEndpoint: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_opsgenie#api_key IntegrationOpsgenie#api_key}
  */
  readonly apiKey: string;
  /**
  * Automatically resolve incident once the check is back up.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_opsgenie#auto_resolve IntegrationOpsgenie#auto_resolve}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_opsgenie#contact_groups IntegrationOpsgenie#contact_groups}
  */
  readonly contactGroups?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_opsgenie#name IntegrationOpsgenie#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_opsgenie#tags IntegrationOpsgenie#tags}
  */
  readonly tags?: string;
  /**
  * A comma separated list of team names which will be responsible for the alert
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_opsgenie#teams IntegrationOpsgenie#teams}
  */
  readonly teams?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_opsgenie uptime_integration_opsgenie}
*/
export class IntegrationOpsgenie extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationOpsgenie that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_opsgenie#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_opsgenie uptime_integration_opsgenie} Resource
  *
  * @param scope The scope in which to define this construct
