// https://registry.terraform.io/providers/uptime-com/uptime/2.18.0/docs/resources/integration_status
...
export interface IntegrationStatusConfig extends cdktf.TerraformMetaArguments {
  ...
  * Status.io API ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.0/docs/resources/integration_status#api_id IntegrationStatus#api_id}
  */
  readonly apiId: string;
  /**
  * Status.io API key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.0/docs/resources/integration_status#api_key IntegrationStatus#api_key}
  */
  readonly apiKey: string;
  /**
  * Component ID to update
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.0/docs/resources/integration_status#component IntegrationStatus#component}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.0/docs/resources/integration_status#contact_groups IntegrationStatus#contact_groups}
  */
  readonly contactGroups?: string[];
  /**
  * Container ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.0/docs/resources/integration_status#container IntegrationStatus#container}
  */
  readonly container?: string;
  /**
  * Metric ID to update
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.0/docs/resources/integration_status#metric IntegrationStatus#metric}
  */
  readonly metric?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.0/docs/resources/integration_status#name IntegrationStatus#name}
  */
  readonly name: string;
  /**
  * Status.io status page ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.0/docs/resources/integration_status#statuspage_id IntegrationStatus#statuspage_id}
  */
  readonly statuspageId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.0/docs/resources/integration_status uptime_integration_status}
*/
export class IntegrationStatus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.0/docs/resources/integration_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.18.0/docs/resources/integration_status uptime_integration_status} Resource
  *
  * @param scope The scope in which to define this construct
