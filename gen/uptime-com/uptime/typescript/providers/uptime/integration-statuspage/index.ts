// https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_statuspage
...
export interface IntegrationStatuspageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_statuspage#api_key IntegrationStatuspage#api_key}
  */
  readonly apiKey: string;
  /**
  * Component ID to update
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_statuspage#component IntegrationStatuspage#component}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_statuspage#contact_groups IntegrationStatuspage#contact_groups}
  */
  readonly contactGroups?: string[];
  /**
  * Metric ID to update
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_statuspage#metric IntegrationStatuspage#metric}
  */
  readonly metric?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_statuspage#name IntegrationStatuspage#name}
  */
  readonly name: string;
  /**
  * Statuspage.io page ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_statuspage#page IntegrationStatuspage#page}
  */
  readonly page: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_statuspage uptime_integration_statuspage}
*/
export class IntegrationStatuspage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationStatuspage that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_statuspage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.21.0/docs/resources/integration_statuspage uptime_integration_statuspage} Resource
  *
  * @param scope The scope in which to define this construct
