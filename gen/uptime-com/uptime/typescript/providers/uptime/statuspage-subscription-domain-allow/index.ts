// https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_subscription_domain_allow
...
export interface StatuspageSubscriptionDomainAllowConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_subscription_domain_allow#domain StatuspageSubscriptionDomainAllow#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_subscription_domain_allow#statuspage_id StatuspageSubscriptionDomainAllow#statuspage_id}
  */
  readonly statuspageId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_subscription_domain_allow uptime_statuspage_subscription_domain_allow}
*/
export class StatuspageSubscriptionDomainAllow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StatuspageSubscriptionDomainAllow that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_subscription_domain_allow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_subscription_domain_allow uptime_statuspage_subscription_domain_allow} Resource
  *
  * @param scope The scope in which to define this construct
