// https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident
...
export interface StatuspageIncidentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#affected_components StatuspageIncident#affected_components}
  */
  readonly affectedComponents?: StatuspageIncidentAffectedComponents[] | cdktf.IResolvable;
  /**
  * When this incident ended in GMT
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#ends_at StatuspageIncident#ends_at}
  */
  readonly endsAt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#incident_type StatuspageIncident#incident_type}
  */
  readonly incidentType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#include_in_global_metrics StatuspageIncident#include_in_global_metrics}
  */
  readonly includeInGlobalMetrics?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#name StatuspageIncident#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#notify_subscribers StatuspageIncident#notify_subscribers}
  */
  readonly notifySubscribers?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#send_maintenance_start_notification StatuspageIncident#send_maintenance_start_notification}
  */
  readonly sendMaintenanceStartNotification?: boolean | cdktf.IResolvable;
  /**
  * When this incident occurred in GMT
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#starts_at StatuspageIncident#starts_at}
  */
  readonly startsAt: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#statuspage_id StatuspageIncident#statuspage_id}
  */
  readonly statuspageId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#update_component_status StatuspageIncident#update_component_status}
  */
  readonly updateComponentStatus?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#updates StatuspageIncident#updates}
  */
  readonly updates: StatuspageIncidentUpdates[] | cdktf.IResolvable;
}
export interface StatuspageIncidentAffectedComponents {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#component_id StatuspageIncident#component_id}
  */
  readonly componentId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#status StatuspageIncident#status}
  */
...
export interface StatuspageIncidentUpdates {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#description StatuspageIncident#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#incident_state StatuspageIncident#incident_state}
  */
  readonly incidentState?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#updated_at StatuspageIncident#updated_at}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident uptime_statuspage_incident}
*/
export class StatuspageIncident extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StatuspageIncident that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/statuspage_incident uptime_statuspage_incident} Resource
  *
  * @param scope The scope in which to define this construct
