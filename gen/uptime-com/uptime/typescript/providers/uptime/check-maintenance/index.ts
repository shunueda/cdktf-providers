// https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance
...
export interface CheckMaintenanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#check_id CheckMaintenance#check_id}
  */
  readonly checkId: number;
  /**
  * Whether to pause the check during scheduled maintenance windows
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#pause_on_scheduled_maintenance CheckMaintenance#pause_on_scheduled_maintenance}
  */
  readonly pauseOnScheduledMaintenance?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#schedule CheckMaintenance#schedule}
  */
  readonly schedule?: CheckMaintenanceSchedule[] | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#state CheckMaintenance#state}
  */
  readonly state?: string;
}
export interface CheckMaintenanceSchedule {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#from_time CheckMaintenance#from_time}
  */
  readonly fromTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#monthday CheckMaintenance#monthday}
  */
  readonly monthday?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#monthday_from CheckMaintenance#monthday_from}
  */
  readonly monthdayFrom?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#monthday_to CheckMaintenance#monthday_to}
  */
  readonly monthdayTo?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#once_end_date CheckMaintenance#once_end_date}
  */
  readonly onceEndDate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#once_start_date CheckMaintenance#once_start_date}
  */
  readonly onceStartDate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#to_time CheckMaintenance#to_time}
  */
  readonly toTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#type CheckMaintenance#type}
  */
  readonly type?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#weekdays CheckMaintenance#weekdays}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance uptime_check_maintenance}
*/
export class CheckMaintenance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CheckMaintenance that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs/resources/check_maintenance uptime_check_maintenance} Resource
  *
  * @param scope The scope in which to define this construct
