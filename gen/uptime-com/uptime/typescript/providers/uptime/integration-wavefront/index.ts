// https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_wavefront
...
export interface IntegrationWavefrontConfig extends cdktf.TerraformMetaArguments {
  ...
  * Wavefront API token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_wavefront#api_token IntegrationWavefront#api_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_wavefront#contact_groups IntegrationWavefront#contact_groups}
  */
  readonly contactGroups?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_wavefront#name IntegrationWavefront#name}
  */
  readonly name: string;
  /**
  * Wavefront instance URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_wavefront#wavefront_url IntegrationWavefront#wavefront_url}
  */
  readonly wavefrontUrl: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_wavefront uptime_integration_wavefront}
*/
export class IntegrationWavefront extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationWavefront that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_wavefront#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.20.0/docs/resources/integration_wavefront uptime_integration_wavefront} Resource
  *
  * @param scope The scope in which to define this construct
