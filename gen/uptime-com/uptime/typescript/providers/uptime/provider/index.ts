// https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs
...
export interface UptimeProviderConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs#endpoint UptimeProvider#endpoint}
  */
  readonly endpoint?: string;
  /**
  * The rate limit to use for API calls in requests per second, defaults to 0.5
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs#rate_limit UptimeProvider#rate_limit}
  */
  readonly rateLimit?: number;
  /**
  * Subaccount ID to use for API calls
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs#subaccount UptimeProvider#subaccount}
  */
  readonly subaccount?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs#token UptimeProvider#token}
  */
  readonly token?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs#trace UptimeProvider#trace}
  */
  readonly trace?: boolean | cdktf.IResolvable;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs#alias UptimeProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs uptime}
*/
export class UptimeProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing UptimeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.22.0/docs uptime} Resource
  *
  * @param scope The scope in which to define this construct
