// https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/entity_group
...
export interface EntityGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/entity_group#application_id EntityGroup#application_id}
  */
  readonly applicationId: string;
  /**
  * The description of the entity
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/entity_group#entity_description EntityGroup#entity_description}
  */
  readonly entityDescription: string;
  /**
  * The identity of the application entity of type environment group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/entity_group#entity_id EntityGroup#entity_id}
  */
  readonly entityId?: string;
  /**
  * The name of the entity
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/entity_group#entity_name EntityGroup#entity_name}
  */
  readonly entityName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/entity_group#id EntityGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/entity_group#parent_id EntityGroup#parent_id}
  */
  readonly parentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/entity_group britive_entity_group}
*/
export class EntityGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EntityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/entity_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/entity_group britive_entity_group} Resource
  *
  * @param scope The scope in which to define this construct
