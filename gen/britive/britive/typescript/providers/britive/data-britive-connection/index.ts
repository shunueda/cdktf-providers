// https://registry.terraform.io/providers/britive/britive/2.2.6/docs/data-sources/connection
...
export interface DataBritiveConnectionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/data-sources/connection#id DataBritiveConnection#id}
  *
  ...
  * Name of connection
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/data-sources/connection#name DataBritiveConnection#name}
  */
  readonly name: string;
  /**
  * Advanced Setting Type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/data-sources/connection#setting_type DataBritiveConnection#setting_type}
  */
  readonly settingType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/data-sources/connection britive_connection}
*/
export class DataBritiveConnection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBritiveConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/data-sources/connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/data-sources/connection britive_connection} Data Source
  *
  * @param scope The scope in which to define this construct
