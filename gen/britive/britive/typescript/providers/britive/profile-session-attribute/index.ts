// https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_session_attribute
...
export interface ProfileSessionAttributeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_session_attribute#app_name ProfileSessionAttribute#app_name}
  */
  readonly appName?: string;
  /**
  * The attribute name associate with the profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_session_attribute#attribute_name ProfileSessionAttribute#attribute_name}
  */
  readonly attributeName?: string;
  /**
  * The type of attribute associate with the profile, should be one of [Static, Identity]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_session_attribute#attribute_type ProfileSessionAttribute#attribute_type}
  */
  readonly attributeType?: string;
  /**
  * The attribute value associate with the profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_session_attribute#attribute_value ProfileSessionAttribute#attribute_value}
  */
  readonly attributeValue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_session_attribute#id ProfileSessionAttribute#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_session_attribute#mapping_name ProfileSessionAttribute#mapping_name}
  */
  readonly mappingName: string;
  /**
  * The identifier of the profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_session_attribute#profile_id ProfileSessionAttribute#profile_id}
  */
  readonly profileId: string;
  /**
  * The name of the profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_session_attribute#profile_name ProfileSessionAttribute#profile_name}
  */
  readonly profileName?: string;
  /**
  * The attribute transitive associate with the profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_session_attribute#transitive ProfileSessionAttribute#transitive}
  */
  readonly transitive?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_session_attribute britive_profile_session_attribute}
*/
export class ProfileSessionAttribute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProfileSessionAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_session_attribute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_session_attribute britive_profile_session_attribute} Resource
  *
  * @param scope The scope in which to define this construct
