// https://registry.terraform.io/providers/britive/britive/2.2.3/docs/data-sources/escalation_policy
...
export interface DataBritiveEscalationPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/data-sources/escalation_policy#id DataBritiveEscalationPolicy#id}
  *
  ...
  * Id of IM connection
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/data-sources/escalation_policy#im_connection_id DataBritiveEscalationPolicy#im_connection_id}
  */
  readonly imConnectionId: string;
  /**
  * Name of policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/data-sources/escalation_policy#name DataBritiveEscalationPolicy#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/data-sources/escalation_policy britive_escalation_policy}
*/
export class DataBritiveEscalationPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBritiveEscalationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/data-sources/escalation_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/data-sources/escalation_policy britive_escalation_policy} Data Source
  *
  * @param scope The scope in which to define this construct
