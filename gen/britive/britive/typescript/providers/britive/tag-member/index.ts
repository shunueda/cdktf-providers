// https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/tag_member
...
export interface TagMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/tag_member#id TagMember#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/tag_member#tag_id TagMember#tag_id}
  */
  readonly tagId: string;
  /**
  * The name of the Britive tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/tag_member#tag_name TagMember#tag_name}
  */
  readonly tagName?: string;
  /**
  * The username of the user added to the Britive tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/tag_member#username TagMember#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/tag_member britive_tag_member}
*/
export class TagMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/tag_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/tag_member britive_tag_member} Resource
  *
  * @param scope The scope in which to define this construct
