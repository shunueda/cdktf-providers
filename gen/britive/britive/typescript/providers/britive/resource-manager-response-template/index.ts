// https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_response_template
...
export interface ResourceManagerResponseTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_response_template#description ResourceManagerResponseTemplate#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_response_template#id ResourceManagerResponseTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_response_template#is_console_access_enabled ResourceManagerResponseTemplate#is_console_access_enabled}
  */
  readonly isConsoleAccessEnabled?: boolean | cdktf.IResolvable;
  /**
  * The name of the response template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_response_template#name ResourceManagerResponseTemplate#name}
  */
  readonly name: string;
  /**
  * Boolean flag to determine if the template is visible on the UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_response_template#show_on_ui ResourceManagerResponseTemplate#show_on_ui}
  */
  readonly showOnUi?: boolean | cdktf.IResolvable;
  /**
  * The template content with placeholders.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_response_template#template_data ResourceManagerResponseTemplate#template_data}
  */
  readonly templateData?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_response_template britive_resource_manager_response_template}
*/
export class ResourceManagerResponseTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourceManagerResponseTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_response_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_response_template britive_resource_manager_response_template} Resource
  *
  * @param scope The scope in which to define this construct
