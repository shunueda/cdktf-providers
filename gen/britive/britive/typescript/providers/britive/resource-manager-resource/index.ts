// https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_resource
...
export interface ResourceManagerResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_resource#description ResourceManagerResource#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_resource#id ResourceManagerResource#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_resource#name ResourceManagerResource#name}
  */
  readonly name: string;
  /**
  * The parameter values for the fields of the resource type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_resource#parameter_values ResourceManagerResource#parameter_values}
  */
  readonly parameterValues?: { [key: string]: string };
  /**
  * The resource labels associated with the server access resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_resource#resource_labels ResourceManagerResource#resource_labels}
  */
  readonly resourceLabels?: { [key: string]: string };
  /**
  * The resource type name associated with the server access resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_resource#resource_type ResourceManagerResource#resource_type}
  */
  readonly resourceType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_resource britive_resource_manager_resource}
*/
export class ResourceManagerResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourceManagerResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/resource_manager_resource britive_resource_manager_resource} Resource
  *
  * @param scope The scope in which to define this construct
