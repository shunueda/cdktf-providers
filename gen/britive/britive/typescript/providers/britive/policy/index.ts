// https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy
...
export interface PolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy#access_type Policy#access_type}
  */
  readonly accessType?: string;
  /**
  * Condition of the policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy#condition Policy#condition}
  */
  readonly condition?: string;
  /**
  * The description of the policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy#description Policy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy#id Policy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy#is_active Policy#is_active}
  */
  readonly isActive?: boolean | cdktf.IResolvable;
  /**
  * Is the policy a draft
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy#is_draft Policy#is_draft}
  */
  readonly isDraft?: boolean | cdktf.IResolvable;
  /**
  * Is the policy read only
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy#is_read_only Policy#is_read_only}
  */
  readonly isReadOnly?: boolean | cdktf.IResolvable;
  /**
  * Members of the policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy#members Policy#members}
  */
  readonly members?: string;
  /**
  * Name of the policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy#name Policy#name}
  */
  readonly name: string;
  /**
  * Permissions of the policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy#permissions Policy#permissions}
  */
  readonly permissions?: string;
  /**
  * Roles of the policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy#roles Policy#roles}
  */
  readonly roles?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy britive_policy}
*/
export class Policy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Policy that should be imported. Refer to the {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/policy britive_policy} Resource
  *
  * @param scope The scope in which to define this construct
