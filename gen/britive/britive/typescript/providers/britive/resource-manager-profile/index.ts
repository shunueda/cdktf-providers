// https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/resource_manager_profile
...
export interface ResourceManagerProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/resource_manager_profile#allow_impersonation ResourceManagerProfile#allow_impersonation}
  */
  readonly allowImpersonation?: boolean | cdktf.IResolvable;
  /**
  * Description of britive resource manager profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/resource_manager_profile#description ResourceManagerProfile#description}
  */
  readonly description?: string;
  /**
  * Expiration duration of resource manager profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/resource_manager_profile#expiration_duration ResourceManagerProfile#expiration_duration}
  */
  readonly expirationDuration: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/resource_manager_profile#id ResourceManagerProfile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/resource_manager_profile#name ResourceManagerProfile#name}
  */
  readonly name: string;
  /**
  * associations block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/resource_manager_profile#associations ResourceManagerProfile#associations}
  */
...
export interface ResourceManagerProfileAssociations {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/resource_manager_profile#label_key ResourceManagerProfile#label_key}
  */
  readonly labelKey: string;
  /**
  * Values of resource label for association
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/resource_manager_profile#values ResourceManagerProfile#values}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/resource_manager_profile britive_resource_manager_profile}
*/
export class ResourceManagerProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourceManagerProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/resource_manager_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs/resources/resource_manager_profile britive_resource_manager_profile} Resource
  *
  * @param scope The scope in which to define this construct
