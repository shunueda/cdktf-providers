// https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_additional_settings
...
export interface ProfileAdditionalSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_additional_settings#console_access ProfileAdditionalSettings#console_access}
  */
  readonly consoleAccess?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_additional_settings#id ProfileAdditionalSettings#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_additional_settings#profile_id ProfileAdditionalSettings#profile_id}
  */
  readonly profileId: string;
  /**
  * Provide the programmatic access for the profile, overriden if use_app_credential_type is set to true
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_additional_settings#programmatic_access ProfileAdditionalSettings#programmatic_access}
  */
  readonly programmaticAccess?: boolean | cdktf.IResolvable;
  /**
  * The project id for creating service accounts
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_additional_settings#project_id_for_service_account ProfileAdditionalSettings#project_id_for_service_account}
  */
  readonly projectIdForServiceAccount?: string;
  /**
  * Inherit the credential type settings from the application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_additional_settings#use_app_credential_type ProfileAdditionalSettings#use_app_credential_type}
  */
  readonly useAppCredentialType?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_additional_settings britive_profile_additional_settings}
*/
export class ProfileAdditionalSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProfileAdditionalSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_additional_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/britive/britive/2.2.3/docs/resources/profile_additional_settings britive_profile_additional_settings} Resource
  *
  * @param scope The scope in which to define this construct
