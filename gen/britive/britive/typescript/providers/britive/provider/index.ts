// https://registry.terraform.io/providers/britive/britive/2.2.6/docs
...
export interface BritiveProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs#config_path BritiveProvider#config_path}
  */
  readonly configPath?: string;
  /**
  * This is the Britive Tenant URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs#tenant BritiveProvider#tenant}
  */
  readonly tenant?: string;
  /**
  * This is the API Token to interact with your Britive API
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs#token BritiveProvider#token}
  */
  readonly token?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs#alias BritiveProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs britive}
*/
export class BritiveProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing BritiveProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/britive/britive/2.2.6/docs britive} Resource
  *
  * @param scope The scope in which to define this construct
