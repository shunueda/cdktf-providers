// https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/data_center_aws_account
...
export interface DataPolarisDataCenterAwsAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/data_center_aws_account#name DataPolarisDataCenterAwsAccount#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/data_center_aws_account polaris_data_center_aws_account}
*/
export class DataPolarisDataCenterAwsAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPolarisDataCenterAwsAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/data_center_aws_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/data_center_aws_account polaris_data_center_aws_account} Data Source
  *
  * @param scope The scope in which to define this construct
