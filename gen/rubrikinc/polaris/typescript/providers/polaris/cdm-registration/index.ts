// https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/cdm_registration
...
export interface CdmRegistrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/cdm_registration#admin_password CdmRegistration#admin_password}
  */
  readonly adminPassword: string;
  /**
  * Cluster name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/cdm_registration#cluster_name CdmRegistration#cluster_name}
  */
  readonly clusterName: string;
  /**
  * The IP address of the cluster node to connect to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/cdm_registration#cluster_node_ip_address CdmRegistration#cluster_node_ip_address}
  */
  readonly clusterNodeIpAddress: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/cdm_registration polaris_cdm_registration}
*/
export class CdmRegistration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdmRegistration that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/cdm_registration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/cdm_registration polaris_cdm_registration} Resource
  *
  * @param scope The scope in which to define this construct
