// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/role_template
...
export interface DataPolarisRoleTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  * Role template name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/role_template#name DataPolarisRoleTemplate#name}
  */
  readonly name?: string;
  /**
  * Role template ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/role_template#role_template_id DataPolarisRoleTemplate#role_template_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/role_template polaris_role_template}
*/
export class DataPolarisRoleTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPolarisRoleTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/role_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/role_template polaris_role_template} Data Source
  *
  * @param scope The scope in which to define this construct
