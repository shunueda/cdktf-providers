// https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs
...
export interface PolarisProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs#credentials PolarisProvider#credentials}
  */
  readonly credentials?: string;
  /**
  * Enable or disable the token cache. The token cache is enabled by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs#token_cache PolarisProvider#token_cache}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs#token_cache_dir PolarisProvider#token_cache_dir}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs#token_cache_secret PolarisProvider#token_cache_secret}
  */
  readonly tokenCacheSecret?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs#alias PolarisProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs polaris}
*/
export class PolarisProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing PolarisProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs polaris} Resource
  *
  * @param scope The scope in which to define this construct
