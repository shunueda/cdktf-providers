// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/azure_service_principal
...
export interface AzureServicePrincipalConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/azure_service_principal#app_id AzureServicePrincipal#app_id}
  */
  readonly appId?: string;
  /**
  * Azure app registration display name. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/azure_service_principal#app_name AzureServicePrincipal#app_name}
  */
  readonly appName?: string;
  /**
  * Azure app registration client secret. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/azure_service_principal#app_secret AzureServicePrincipal#app_secret}
  */
  readonly appSecret?: string;
  /**
  * Path to a custom service principal file. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/azure_service_principal#credentials AzureServicePrincipal#credentials}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/azure_service_principal#permissions AzureServicePrincipal#permissions}
  */
  readonly permissions?: string;
  /**
  * Permissions updated signal. **Deprecated:** use `permissions` instead.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/azure_service_principal#permissions_hash AzureServicePrincipal#permissions_hash}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/azure_service_principal#sdk_auth AzureServicePrincipal#sdk_auth}
  */
  readonly sdkAuth?: string;
  /**
  * Azure tenant primary domain. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/azure_service_principal#tenant_domain AzureServicePrincipal#tenant_domain}
  */
  readonly tenantDomain: string;
  /**
  * Azure tenant ID. Also known as the directory ID. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/azure_service_principal#tenant_id AzureServicePrincipal#tenant_id}
  */
  readonly tenantId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/azure_service_principal polaris_azure_service_principal}
*/
export class AzureServicePrincipal extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureServicePrincipal that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/azure_service_principal#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/azure_service_principal polaris_azure_service_principal} Resource
  *
  * @param scope The scope in which to define this construct
