// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap
...
export interface CdmBootstrapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#admin_email CdmBootstrap#admin_email}
  */
  readonly adminEmail: string;
  /**
  * Password for the admin account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#admin_password CdmBootstrap#admin_password}
  */
  readonly adminPassword: string;
  /**
  * Unique name to assign to the Rubrik cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#cluster_name CdmBootstrap#cluster_name}
  */
  readonly clusterName: string;
  /**
  * IP address of the cluster node to connect to. If not specified, a random node from the `cluster_nodes` map will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#cluster_node_ip_address CdmBootstrap#cluster_node_ip_address}
  */
  readonly clusterNodeIpAddress?: string;
  /**
  * The node name and IP formatted as a map.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#cluster_nodes CdmBootstrap#cluster_nodes}
  */
  readonly clusterNodes?: { [key: string]: string };
  /**
  * IPv4 addresses of DNS servers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#dns_name_servers CdmBootstrap#dns_name_servers}
  */
  readonly dnsNameServers: string[];
  /**
  * The search domain that the DNS Service will use to resolve hostnames that are not fully qualified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#dns_search_domain CdmBootstrap#dns_search_domain}
  */
  readonly dnsSearchDomain: string[];
  /**
  * Enable software data encryption at rest.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#enable_encryption CdmBootstrap#enable_encryption}
  */
  readonly enableEncryption?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#id CdmBootstrap#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#management_gateway CdmBootstrap#management_gateway}
  */
  readonly managementGateway: string;
  /**
  * Subnet mask assigned to the management network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#management_subnet_mask CdmBootstrap#management_subnet_mask}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#node_config CdmBootstrap#node_config}
  */
  readonly nodeConfig?: { [key: string]: string };
  /**
  * Symmetric key material for NTP server #1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#ntp_server1_key CdmBootstrap#ntp_server1_key}
  */
  readonly ntpServer1Key?: string;
  /**
  * Key id number for NTP server #1 (typically this is 0).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#ntp_server1_key_id CdmBootstrap#ntp_server1_key_id}
  */
  readonly ntpServer1KeyId?: number;
  /**
  * Symmetric key type for NTP server #1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#ntp_server1_key_type CdmBootstrap#ntp_server1_key_type}
  */
  readonly ntpServer1KeyType?: string;
  /**
  * Name or IP address for NTP server #1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#ntp_server1_name CdmBootstrap#ntp_server1_name}
  */
  readonly ntpServer1Name: string;
  /**
  * Symmetric key material for NTP server #2.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#ntp_server2_key CdmBootstrap#ntp_server2_key}
  */
  readonly ntpServer2Key?: string;
  /**
  * Key id number for NTP server #2 (typically this is 1).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#ntp_server2_key_id CdmBootstrap#ntp_server2_key_id}
  */
  readonly ntpServer2KeyId?: number;
  /**
  * Symmetric key type for NTP server #2.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#ntp_server2_key_type CdmBootstrap#ntp_server2_key_type}
  */
  readonly ntpServer2KeyType?: string;
  /**
  * Name or IP address for NTP server #2.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#ntp_server2_name CdmBootstrap#ntp_server2_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#timeout CdmBootstrap#timeout}
  */
  readonly timeout?: string;
  /**
  * Flag to determine if Terraform should wait for the bootstrap process to complete.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#wait_for_completion CdmBootstrap#wait_for_completion}
  */
  readonly waitForCompletion?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#timeouts CdmBootstrap#timeouts}
  */
  readonly timeouts?: CdmBootstrapTimeouts;
}
export interface CdmBootstrapTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#create CdmBootstrap#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#default CdmBootstrap#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#read CdmBootstrap#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap polaris_cdm_bootstrap}
*/
export class CdmBootstrap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdmBootstrap that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/cdm_bootstrap polaris_cdm_bootstrap} Resource
  *
  * @param scope The scope in which to define this construct
