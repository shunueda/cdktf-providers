// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws
...
export interface CdmBootstrapCcesAwsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#admin_email CdmBootstrapCcesAws#admin_email}
  */
  readonly adminEmail: string;
  /**
  * Password for the admin account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#admin_password CdmBootstrapCcesAws#admin_password}
  */
  readonly adminPassword: string;
  /**
  * AWS S3 bucket where CCES will store its data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#bucket_name CdmBootstrapCcesAws#bucket_name}
  */
  readonly bucketName: string;
  /**
  * Unique name to assign to the Rubrik cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#cluster_name CdmBootstrapCcesAws#cluster_name}
  */
  readonly clusterName: string;
  /**
  * IP address of the cluster node to connect to. If not specified, a random node from the `cluster_nodes` map will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#cluster_node_ip_address CdmBootstrapCcesAws#cluster_node_ip_address}
  */
  readonly clusterNodeIpAddress?: string;
  /**
  * The node name and IP address formatted as a map.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#cluster_nodes CdmBootstrapCcesAws#cluster_nodes}
  */
  readonly clusterNodes?: { [key: string]: string };
  /**
  * IPv4 addresses of DNS servers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#dns_name_servers CdmBootstrapCcesAws#dns_name_servers}
  */
  readonly dnsNameServers: string[];
  /**
  * The search domain that the DNS Service will use to resolve hostnames that are not fully qualified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#dns_search_domain CdmBootstrapCcesAws#dns_search_domain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#enable_encryption CdmBootstrapCcesAws#enable_encryption}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#enable_immutability CdmBootstrapCcesAws#enable_immutability}
  */
  readonly enableImmutability?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#id CdmBootstrapCcesAws#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#management_gateway CdmBootstrapCcesAws#management_gateway}
  */
  readonly managementGateway: string;
  /**
  * Subnet mask assigned to the management network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#management_subnet_mask CdmBootstrapCcesAws#management_subnet_mask}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#node_config CdmBootstrapCcesAws#node_config}
  */
  readonly nodeConfig?: { [key: string]: string };
  /**
  * Symmetric key material for NTP server #1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#ntp_server1_key CdmBootstrapCcesAws#ntp_server1_key}
  */
  readonly ntpServer1Key?: string;
  /**
  * Key id number for NTP server #1 (typically this is 0).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#ntp_server1_key_id CdmBootstrapCcesAws#ntp_server1_key_id}
  */
  readonly ntpServer1KeyId?: number;
  /**
  * Symmetric key type for NTP server #1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#ntp_server1_key_type CdmBootstrapCcesAws#ntp_server1_key_type}
  */
  readonly ntpServer1KeyType?: string;
  /**
  * Name or IP address for NTP server #1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#ntp_server1_name CdmBootstrapCcesAws#ntp_server1_name}
  */
  readonly ntpServer1Name: string;
  /**
  * Symmetric key material for NTP server #2.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#ntp_server2_key CdmBootstrapCcesAws#ntp_server2_key}
  */
  readonly ntpServer2Key?: string;
  /**
  * Key id number for NTP server #2 (typically this is 1).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#ntp_server2_key_id CdmBootstrapCcesAws#ntp_server2_key_id}
  */
  readonly ntpServer2KeyId?: number;
  /**
  * Symmetric key type for NTP server #2.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#ntp_server2_key_type CdmBootstrapCcesAws#ntp_server2_key_type}
  */
  readonly ntpServer2KeyType?: string;
  /**
  * Name or IP address for NTP server #2.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#ntp_server2_name CdmBootstrapCcesAws#ntp_server2_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#timeout CdmBootstrapCcesAws#timeout}
  */
  readonly timeout?: string;
  /**
  * Flag to determine if Terraform should wait for the bootstrap process to complete.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#wait_for_completion CdmBootstrapCcesAws#wait_for_completion}
  */
  readonly waitForCompletion?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#timeouts CdmBootstrapCcesAws#timeouts}
  */
  readonly timeouts?: CdmBootstrapCcesAwsTimeouts;
}
export interface CdmBootstrapCcesAwsTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#create CdmBootstrapCcesAws#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#default CdmBootstrapCcesAws#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#read CdmBootstrapCcesAws#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws polaris_cdm_bootstrap_cces_aws}
*/
export class CdmBootstrapCcesAws extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdmBootstrapCcesAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/cdm_bootstrap_cces_aws polaris_cdm_bootstrap_cces_aws} Resource
  *
  * @param scope The scope in which to define this construct
