// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/data-sources/role
...
export interface DataPolarisRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  * Role name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/data-sources/role#name DataPolarisRole#name}
  */
  readonly name?: string;
  /**
  * Role ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/data-sources/role#role_id DataPolarisRole#role_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/data-sources/role polaris_role}
*/
export class DataPolarisRole extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPolarisRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/data-sources/role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/data-sources/role polaris_role} Data Source
  *
  * @param scope The scope in which to define this construct
