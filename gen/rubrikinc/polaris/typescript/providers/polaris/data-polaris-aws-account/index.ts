// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/aws_account
...
export interface DataPolarisAwsAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  * AWS account ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/aws_account#account_id DataPolarisAwsAccount#account_id}
  */
  readonly accountId?: string;
  /**
  * RSC cloud account ID (UUID).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/aws_account#cloud_account_id DataPolarisAwsAccount#cloud_account_id}
  */
  readonly cloudAccountId?: string;
  /**
  * AWS account name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/aws_account#name DataPolarisAwsAccount#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/aws_account polaris_aws_account}
*/
export class DataPolarisAwsAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPolarisAwsAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/aws_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/aws_account polaris_aws_account} Data Source
  *
  * @param scope The scope in which to define this construct
