// https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/role_assignment
...
export interface RoleAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/role_assignment#role_id RoleAssignment#role_id}
  */
  readonly roleId?: string;
  /**
  * Role IDs (UUID).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/role_assignment#role_ids RoleAssignment#role_ids}
  */
  readonly roleIds?: string[];
  /**
  * SSO group ID. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/role_assignment#sso_group_id RoleAssignment#sso_group_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/role_assignment#user_email RoleAssignment#user_email}
  */
  readonly userEmail?: string;
  /**
  * User ID. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/role_assignment#user_id RoleAssignment#user_id}
  */
  readonly userId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/role_assignment polaris_role_assignment}
*/
export class RoleAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoleAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/role_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/role_assignment polaris_role_assignment} Resource
  *
  * @param scope The scope in which to define this construct
