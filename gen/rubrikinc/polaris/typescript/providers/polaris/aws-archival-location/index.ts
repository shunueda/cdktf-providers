// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_archival_location
...
export interface AwsArchivalLocationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_archival_location#account_id AwsArchivalLocation#account_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_archival_location#bucket_prefix AwsArchivalLocation#bucket_prefix}
  */
  readonly bucketPrefix: string;
  /**
  * AWS bucket tags. Each tag will be added to the bucket created by RSC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_archival_location#bucket_tags AwsArchivalLocation#bucket_tags}
  */
  readonly bucketTags?: { [key: string]: string };
  /**
  * AWS KMS master key alias/ID. Default value is `aws/s3`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_archival_location#kms_master_key AwsArchivalLocation#kms_master_key}
  */
  readonly kmsMasterKey?: string;
  /**
  * Name of the cloud native archival location.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_archival_location#name AwsArchivalLocation#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_archival_location#region AwsArchivalLocation#region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_archival_location#storage_class AwsArchivalLocation#storage_class}
  */
  readonly storageClass?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_archival_location polaris_aws_archival_location}
*/
export class AwsArchivalLocation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsArchivalLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_archival_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_archival_location polaris_aws_archival_location} Resource
  *
  * @param scope The scope in which to define this construct
