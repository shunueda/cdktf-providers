// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/azure_archival_location
...
export interface DataPolarisAzureArchivalLocationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/azure_archival_location#archival_location_id DataPolarisAzureArchivalLocation#archival_location_id}
  */
  readonly archivalLocationId?: string;
  /**
  * Cloud native archival location ID (UUID).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/azure_archival_location#id DataPolarisAzureArchivalLocation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/azure_archival_location#name DataPolarisAzureArchivalLocation#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/azure_archival_location polaris_azure_archival_location}
*/
export class DataPolarisAzureArchivalLocation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPolarisAzureArchivalLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/azure_archival_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/data-sources/azure_archival_location polaris_azure_archival_location} Data Source
  *
  * @param scope The scope in which to define this construct
