// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/sla_domain_assignment
...
export interface SlaDomainAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  * Object IDs (UUID).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/sla_domain_assignment#object_ids SlaDomainAssignment#object_ids}
  */
  readonly objectIds: string[];
  /**
  * SLA domain ID (UUID).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/sla_domain_assignment#sla_domain_id SlaDomainAssignment#sla_domain_id}
  */
  readonly slaDomainId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/sla_domain_assignment polaris_sla_domain_assignment}
*/
export class SlaDomainAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SlaDomainAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/sla_domain_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/resources/sla_domain_assignment polaris_sla_domain_assignment} Resource
  *
  * @param scope The scope in which to define this construct
