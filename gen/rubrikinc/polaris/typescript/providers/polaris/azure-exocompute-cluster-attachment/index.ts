// https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_exocompute_cluster_attachment
...
export interface AzureExocomputeClusterAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Azure AKS cluster name. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_exocompute_cluster_attachment#cluster_name AzureExocomputeClusterAttachment#cluster_name}
  */
  readonly clusterName: string;
  /**
  * RSC exocompute configuration ID (UUID). Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_exocompute_cluster_attachment#exocompute_id AzureExocomputeClusterAttachment#exocompute_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_exocompute_cluster_attachment#token_refresh AzureExocomputeClusterAttachment#token_refresh}
  */
  readonly tokenRefresh?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_exocompute_cluster_attachment polaris_azure_exocompute_cluster_attachment}
*/
export class AzureExocomputeClusterAttachment extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "polaris_azure_exocompute_cluster_attachment";
  ...
  * @param importFromId The id of the existing AzureExocomputeClusterAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_exocompute_cluster_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "polaris_azure_exocompute_cluster_attachment", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_exocompute_cluster_attachment polaris_azure_exocompute_cluster_attachment} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AzureExocomputeClusterAttachmentConfig
  */
  public constructor(scope: Construct, id: string, config: AzureExocomputeClusterAttachmentConfig) {
    super(scope, id, {
