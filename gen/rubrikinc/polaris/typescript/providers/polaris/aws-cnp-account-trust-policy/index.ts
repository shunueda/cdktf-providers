// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_cnp_account_trust_policy
...
export interface AwsCnpAccountTrustPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_cnp_account_trust_policy#account_id AwsCnpAccountTrustPolicy#account_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_cnp_account_trust_policy#external_id AwsCnpAccountTrustPolicy#external_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_cnp_account_trust_policy#features AwsCnpAccountTrustPolicy#features}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_cnp_account_trust_policy#role_key AwsCnpAccountTrustPolicy#role_key}
  */
  readonly roleKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_cnp_account_trust_policy polaris_aws_cnp_account_trust_policy}
*/
export class AwsCnpAccountTrustPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsCnpAccountTrustPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_cnp_account_trust_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_cnp_account_trust_policy polaris_aws_cnp_account_trust_policy} Resource
  *
  * @param scope The scope in which to define this construct
