// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_private_container_registry
...
export interface AwsPrivateContainerRegistryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_private_container_registry#account_id AwsPrivateContainerRegistry#account_id}
  */
  readonly accountId: string;
  /**
  * AWS account ID of the AWS account that will pull images from the RSC container registry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_private_container_registry#native_id AwsPrivateContainerRegistry#native_id}
  */
  readonly nativeId: string;
  /**
  * URL for customer provided private container registry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_private_container_registry#url AwsPrivateContainerRegistry#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_private_container_registry polaris_aws_private_container_registry}
*/
export class AwsPrivateContainerRegistry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsPrivateContainerRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_private_container_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_private_container_registry polaris_aws_private_container_registry} Resource
  *
  * @param scope The scope in which to define this construct
