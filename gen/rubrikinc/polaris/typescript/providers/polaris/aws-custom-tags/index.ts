// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_custom_tags
...
export interface AwsCustomTagsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_custom_tags#custom_tags AwsCustomTags#custom_tags}
  */
  readonly customTags: { [key: string]: string };
  /**
  * Should custom tags overwrite existing tags with the same keys. Default value is `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_custom_tags#override_resource_tags AwsCustomTags#override_resource_tags}
  */
  readonly overrideResourceTags?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_custom_tags polaris_aws_custom_tags}
*/
export class AwsCustomTags extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsCustomTags that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_custom_tags#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/aws_custom_tags polaris_aws_custom_tags} Resource
  *
  * @param scope The scope in which to define this construct
