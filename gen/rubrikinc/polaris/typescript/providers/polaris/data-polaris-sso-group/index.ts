// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/sso_group
...
export interface DataPolarisSsoGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * SSO group name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/sso_group#name DataPolarisSsoGroup#name}
  */
  readonly name?: string;
  /**
  * SSO group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/sso_group#sso_group_id DataPolarisSsoGroup#sso_group_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/sso_group polaris_sso_group}
*/
export class DataPolarisSsoGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPolarisSsoGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/sso_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/sso_group polaris_sso_group} Data Source
  *
  * @param scope The scope in which to define this construct
