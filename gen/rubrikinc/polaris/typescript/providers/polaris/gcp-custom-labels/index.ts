// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/gcp_custom_labels
...
export interface GcpCustomLabelsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/gcp_custom_labels#custom_labels GcpCustomLabels#custom_labels}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/gcp_custom_labels#override_resource_labels GcpCustomLabels#override_resource_labels}
  */
  readonly overrideResourceLabels?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/gcp_custom_labels polaris_gcp_custom_labels}
*/
export class GcpCustomLabels extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GcpCustomLabels that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/gcp_custom_labels#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/gcp_custom_labels polaris_gcp_custom_labels} Resource
  *
  * @param scope The scope in which to define this construct
