// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/aws_archival_location
...
export interface DataPolarisAwsArchivalLocationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/aws_archival_location#archival_location_id DataPolarisAwsArchivalLocation#archival_location_id}
  */
  readonly archivalLocationId?: string;
  /**
  * Cloud native archival location ID (UUID).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/aws_archival_location#id DataPolarisAwsArchivalLocation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/aws_archival_location#name DataPolarisAwsArchivalLocation#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/aws_archival_location polaris_aws_archival_location}
*/
export class DataPolarisAwsArchivalLocation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPolarisAwsArchivalLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/aws_archival_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/aws_archival_location polaris_aws_archival_location} Data Source
  *
  * @param scope The scope in which to define this construct
