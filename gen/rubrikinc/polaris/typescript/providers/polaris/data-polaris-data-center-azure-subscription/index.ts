// https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/data_center_azure_subscription
...
export interface DataPolarisDataCenterAzureSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/data_center_azure_subscription#name DataPolarisDataCenterAzureSubscription#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/data_center_azure_subscription polaris_data_center_azure_subscription}
*/
export class DataPolarisDataCenterAzureSubscription extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPolarisDataCenterAzureSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/data_center_azure_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/data_center_azure_subscription polaris_data_center_azure_subscription} Data Source
  *
  * @param scope The scope in which to define this construct
