// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/tag_rule
...
export interface DataPolarisTagRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  * Tag rule ID (UUID).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/tag_rule#id DataPolarisTagRule#id}
  *
  ...
  * Tag rule name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/tag_rule#name DataPolarisTagRule#name}
  */
  readonly name?: string;
  /**
  * If true, all tag values are matched.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/tag_rule#tag_all_values DataPolarisTagRule#tag_all_values}
  */
  readonly tagAllValues?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/tag_rule polaris_tag_rule}
*/
export class DataPolarisTagRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPolarisTagRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/tag_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.1/docs/data-sources/tag_rule polaris_tag_rule} Data Source
  *
  * @param scope The scope in which to define this construct
