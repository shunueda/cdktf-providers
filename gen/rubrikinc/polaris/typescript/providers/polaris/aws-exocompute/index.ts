// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/aws_exocompute
...
export interface AwsExocomputeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/aws_exocompute#account_id AwsExocompute#account_id}
  */
  readonly accountId: string;
  /**
  * AWS security group ID for the cluster. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/aws_exocompute#cluster_security_group_id AwsExocompute#cluster_security_group_id}
  */
  readonly clusterSecurityGroupId?: string;
  /**
  * Exocompute host cloud account ID. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/aws_exocompute#host_account_id AwsExocompute#host_account_id}
  */
  readonly hostAccountId?: string;
  /**
  * AWS security group ID for the nodes. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/aws_exocompute#node_security_group_id AwsExocompute#node_security_group_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/aws_exocompute#region AwsExocompute#region}
  */
  readonly region?: string;
  /**
  * AWS subnet IDs for the cluster subnets. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/aws_exocompute#subnets AwsExocompute#subnets}
  */
  readonly subnets?: string[];
  /**
  * AWS VPC ID for the cluster network. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/aws_exocompute#vpc_id AwsExocompute#vpc_id}
  */
  readonly vpcId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/aws_exocompute polaris_aws_exocompute}
*/
export class AwsExocompute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsExocompute that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/aws_exocompute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/aws_exocompute polaris_aws_exocompute} Resource
  *
  * @param scope The scope in which to define this construct
