// https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/deployment
...
/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/deployment polaris_deployment}
*/
export class DataPolarisDeployment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPolarisDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/data-sources/deployment polaris_deployment} Data Source
  *
  * @param scope The scope in which to define this construct
