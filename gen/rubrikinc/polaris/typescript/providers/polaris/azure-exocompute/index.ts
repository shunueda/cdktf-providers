// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/azure_exocompute
...
export interface AzureExocomputeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/azure_exocompute#cloud_account_id AzureExocompute#cloud_account_id}
  */
  readonly cloudAccountId?: string;
  /**
  * RSC cloud account ID of the shared exocompute host account. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/azure_exocompute#host_cloud_account_id AzureExocompute#host_cloud_account_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/azure_exocompute#pod_overlay_network_cidr AzureExocompute#pod_overlay_network_cidr}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/azure_exocompute#region AzureExocompute#region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/azure_exocompute#subnet AzureExocompute#subnet}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/azure_exocompute#subscription_id AzureExocompute#subscription_id}
  */
  readonly subscriptionId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/azure_exocompute polaris_azure_exocompute}
*/
export class AzureExocompute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureExocompute that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/azure_exocompute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.0/docs/resources/azure_exocompute polaris_azure_exocompute} Resource
  *
  * @param scope The scope in which to define this construct
