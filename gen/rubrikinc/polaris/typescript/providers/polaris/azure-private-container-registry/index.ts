// https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_private_container_registry
...
export interface AzurePrivateContainerRegistryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_private_container_registry#app_id AzurePrivateContainerRegistry#app_id}
  */
  readonly appId: string;
  /**
  * RSC cloud account ID (UUID). Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_private_container_registry#cloud_account_id AzurePrivateContainerRegistry#cloud_account_id}
  */
  readonly cloudAccountId: string;
  /**
  * URL for customer provided private container registry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_private_container_registry#url AzurePrivateContainerRegistry#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_private_container_registry polaris_azure_private_container_registry}
*/
export class AzurePrivateContainerRegistry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzurePrivateContainerRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_private_container_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.2.1/docs/resources/azure_private_container_registry polaris_azure_private_container_registry} Resource
  *
  * @param scope The scope in which to define this construct
