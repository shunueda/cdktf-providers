// https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/tag_rule
...
export interface TagRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/tag_rule#cloud_account_ids TagRule#cloud_account_ids}
  */
  readonly cloudAccountIds?: string[];
  /**
  * Tag rule name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/tag_rule#name TagRule#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/tag_rule#object_type TagRule#object_type}
  */
  readonly objectType: string;
  /**
  * If true, all tag values are matched. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/tag_rule#tag_all_values TagRule#tag_all_values}
  */
  readonly tagAllValues?: boolean | cdktf.IResolvable;
  /**
  * Tag key to match. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/tag_rule#tag_key TagRule#tag_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/tag_rule#tag_value TagRule#tag_value}
  */
  readonly tagValue?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/tag_rule polaris_tag_rule}
*/
export class TagRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/tag_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rubrikinc/polaris/1.3.2/docs/resources/tag_rule polaris_tag_rule} Resource
  *
  * @param scope The scope in which to define this construct
