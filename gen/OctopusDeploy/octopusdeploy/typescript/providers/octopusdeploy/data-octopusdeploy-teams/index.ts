// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/teams
...
export interface DataOctopusdeployTeamsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/teams#ids DataOctopusdeployTeams#ids}
  */
  readonly ids?: string[];
  /**
  * A filter to include system teams.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/teams#include_system DataOctopusdeployTeams#include_system}
  */
  readonly includeSystem?: boolean | cdktf.IResolvable;
  /**
  * A filter to search by the partial match of a name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/teams#partial_name DataOctopusdeployTeams#partial_name}
  */
  readonly partialName?: string;
  /**
  * A filter to specify the number of items to skip in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/teams#skip DataOctopusdeployTeams#skip}
  */
  readonly skip?: number;
  /**
  * A filter to search by a list of space IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/teams#spaces DataOctopusdeployTeams#spaces}
  */
  readonly spaces?: string[];
  /**
  * A filter to specify the number of items to take (or return) in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/teams#take DataOctopusdeployTeams#take}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/teams octopusdeploy_teams}
*/
export class DataOctopusdeployTeams extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOctopusdeployTeams that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/teams#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/teams octopusdeploy_teams} Data Source
  *
  * @param scope The scope in which to define this construct
