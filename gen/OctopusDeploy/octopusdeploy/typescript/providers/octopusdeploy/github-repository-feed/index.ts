// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/github_repository_feed
...
export interface GithubRepositoryFeedConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/github_repository_feed#download_attempts GithubRepositoryFeed#download_attempts}
  */
  readonly downloadAttempts?: number;
  /**
  * The number of seconds to apply as a linear back off between download attempts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/github_repository_feed#download_retry_backoff_seconds GithubRepositoryFeed#download_retry_backoff_seconds}
  */
  readonly downloadRetryBackoffSeconds?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/github_repository_feed#feed_uri GithubRepositoryFeed#feed_uri}
  */
  readonly feedUri: string;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/github_repository_feed#name GithubRepositoryFeed#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/github_repository_feed#package_acquisition_location_options GithubRepositoryFeed#package_acquisition_location_options}
  */
  readonly packageAcquisitionLocationOptions?: string[];
  /**
  * The password associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/github_repository_feed#password GithubRepositoryFeed#password}
  */
  readonly password?: string;
  /**
  * The space ID associated with this github repository feed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/github_repository_feed#space_id GithubRepositoryFeed#space_id}
  */
  readonly spaceId?: string;
  /**
  * The username associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/github_repository_feed#username GithubRepositoryFeed#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/github_repository_feed octopusdeploy_github_repository_feed}
*/
export class GithubRepositoryFeed extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GithubRepositoryFeed that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/github_repository_feed#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/github_repository_feed octopusdeploy_github_repository_feed} Resource
  *
  * @param scope The scope in which to define this construct
