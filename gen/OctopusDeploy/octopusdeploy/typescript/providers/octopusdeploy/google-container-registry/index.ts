// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry
...
export interface GoogleContainerRegistryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry#api_version GoogleContainerRegistry#api_version}
  */
  readonly apiVersion?: string;
  /**
  * The number of times a deployment should attempt to download a package from this feed before failing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry#download_attempts GoogleContainerRegistry#download_attempts}
  */
  readonly downloadAttempts?: number;
  /**
  * The number of seconds to apply as a linear back off between download attempts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry#download_retry_backoff_seconds GoogleContainerRegistry#download_retry_backoff_seconds}
  */
  readonly downloadRetryBackoffSeconds?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry#feed_uri GoogleContainerRegistry#feed_uri}
  */
  readonly feedUri: string;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry#name GoogleContainerRegistry#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry#oidc_authentication GoogleContainerRegistry#oidc_authentication}
  */
  readonly oidcAuthentication?: GoogleContainerRegistryOidcAuthentication;
  /**
  * The password associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry#password GoogleContainerRegistry#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry#registry_path GoogleContainerRegistry#registry_path}
  */
  readonly registryPath?: string;
  /**
  * The space ID associated with this Google container registry feed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry#space_id GoogleContainerRegistry#space_id}
  */
  readonly spaceId?: string;
  /**
  * The username associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry#username GoogleContainerRegistry#username}
  */
...
export interface GoogleContainerRegistryOidcAuthentication {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry#audience GoogleContainerRegistry#audience}
  */
  readonly audience?: string;
  /**
  * Keys to include in a deployment or runbook. Valid options are `space`, `feed`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry#subject_keys GoogleContainerRegistry#subject_keys}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry octopusdeploy_google_container_registry}
*/
export class GoogleContainerRegistry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleContainerRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/google_container_registry octopusdeploy_google_container_registry} Resource
  *
  * @param scope The scope in which to define this construct
