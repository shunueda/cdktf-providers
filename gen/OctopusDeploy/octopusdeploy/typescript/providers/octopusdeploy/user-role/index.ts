// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/user_role
...
export interface UserRoleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/user_role#can_be_deleted UserRole#can_be_deleted}
  */
  readonly canBeDeleted?: boolean | cdktf.IResolvable;
  /**
  * The description of this user role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/user_role#description UserRole#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/user_role#granted_space_permissions UserRole#granted_space_permissions}
  */
  readonly grantedSpacePermissions?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/user_role#granted_system_permissions UserRole#granted_system_permissions}
  */
  readonly grantedSystemPermissions?: string[];
  /**
  * The unique ID for this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/user_role#id UserRole#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/user_role#name UserRole#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/user_role#space_permission_descriptions UserRole#space_permission_descriptions}
  */
  readonly spacePermissionDescriptions?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/user_role#supported_restrictions UserRole#supported_restrictions}
  */
  readonly supportedRestrictions?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/user_role#system_permission_descriptions UserRole#system_permission_descriptions}
  */
  readonly systemPermissionDescriptions?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/user_role octopusdeploy_user_role}
*/
export class UserRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/user_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/user_role octopusdeploy_user_role} Resource
  *
  * @param scope The scope in which to define this construct
