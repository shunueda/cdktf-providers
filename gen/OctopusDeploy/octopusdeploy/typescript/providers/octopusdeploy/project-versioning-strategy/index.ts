// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/project_versioning_strategy
...
export interface ProjectVersioningStrategyAConfig extends cdktf.TerraformMetaArguments {
  ...
  * Donor Packages.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/project_versioning_strategy#donor_package ProjectVersioningStrategyA#donor_package}
  */
  readonly donorPackage?: ProjectVersioningStrategyDonorPackageA;
  /**
  * The associated donor package step ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/project_versioning_strategy#donor_package_step_id ProjectVersioningStrategyA#donor_package_step_id}
  */
  readonly donorPackageStepId?: string;
  /**
  * The associated project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/project_versioning_strategy#project_id ProjectVersioningStrategyA#project_id}
  */
  readonly projectId: string;
  /**
  * Space ID of the associated project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/project_versioning_strategy#space_id ProjectVersioningStrategyA#space_id}
  */
  readonly spaceId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/project_versioning_strategy#template ProjectVersioningStrategyA#template}
  */
...
export interface ProjectVersioningStrategyDonorPackageA {
  ...
  * Deployment action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/project_versioning_strategy#deployment_action ProjectVersioningStrategyA#deployment_action}
  */
  readonly deploymentAction: string;
  /**
  * Package reference.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/project_versioning_strategy#package_reference ProjectVersioningStrategyA#package_reference}
  */
...
export class ProjectVersioningStrategyDonorPackageAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // deployment_action - computed: true, optional: false, required: true
  ...
  // package_reference - computed: true, optional: false, required: true
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/project_versioning_strategy octopusdeploy_project_versioning_strategy}
*/
export class ProjectVersioningStrategyA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectVersioningStrategyA that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/project_versioning_strategy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/project_versioning_strategy octopusdeploy_project_versioning_strategy} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // donor_package - computed: true, optional: true, required: false
  ...
  // donor_package_step_id - computed: true, optional: true, required: false
