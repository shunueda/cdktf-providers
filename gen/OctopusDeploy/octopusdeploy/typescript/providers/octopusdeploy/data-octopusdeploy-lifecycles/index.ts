// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/data-sources/lifecycles
...
export interface DataOctopusdeployLifecyclesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/data-sources/lifecycles#ids DataOctopusdeployLifecycles#ids}
  */
  readonly ids?: string[];
  /**
  * A partial name to filter lifecycles by.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/data-sources/lifecycles#partial_name DataOctopusdeployLifecycles#partial_name}
  */
  readonly partialName?: string;
  /**
  * A filter to specify the number of items to skip in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/data-sources/lifecycles#skip DataOctopusdeployLifecycles#skip}
  */
  readonly skip?: number;
  /**
  * The space ID associated with this lifecycle.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/data-sources/lifecycles#space_id DataOctopusdeployLifecycles#space_id}
  */
  readonly spaceId?: string;
  /**
  * A filter to specify the number of items to take (or return) in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/data-sources/lifecycles#take DataOctopusdeployLifecycles#take}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/data-sources/lifecycles octopusdeploy_lifecycles}
*/
export class DataOctopusdeployLifecycles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOctopusdeployLifecycles that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/data-sources/lifecycles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/data-sources/lifecycles octopusdeploy_lifecycles} Data Source
  *
  * @param scope The scope in which to define this construct
