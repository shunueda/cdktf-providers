// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers
...
export interface DataOctopusdeployKubernetesAgentWorkersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers#health_statuses DataOctopusdeployKubernetesAgentWorkers#health_statuses}
  */
  readonly healthStatuses?: string[];
  /**
  * A filter to search by a list of IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers#ids DataOctopusdeployKubernetesAgentWorkers#ids}
  */
  readonly ids?: string[];
  /**
  * A filter to search by the disabled status of a resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers#is_disabled DataOctopusdeployKubernetesAgentWorkers#is_disabled}
  */
  readonly isDisabled?: boolean | cdktf.IResolvable;
  /**
  * A filter to search by name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers#name DataOctopusdeployKubernetesAgentWorkers#name}
  */
  readonly name?: string;
  /**
  * A filter to search by the partial match of a name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers#partial_name DataOctopusdeployKubernetesAgentWorkers#partial_name}
  */
  readonly partialName?: string;
  /**
  * A filter to search by a list of role IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers#roles DataOctopusdeployKubernetesAgentWorkers#roles}
  */
  readonly roles?: string[];
  /**
  * A list of shell names to match in the query and/or search
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers#shell_names DataOctopusdeployKubernetesAgentWorkers#shell_names}
  */
  readonly shellNames?: string[];
  /**
  * A filter to specify the number of items to skip in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers#skip DataOctopusdeployKubernetesAgentWorkers#skip}
  */
  readonly skip?: number;
  /**
  * The space ID associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers#space_id DataOctopusdeployKubernetesAgentWorkers#space_id}
  */
  readonly spaceId?: string;
  /**
  * A filter to specify the number of items to take (or return) in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers#take DataOctopusdeployKubernetesAgentWorkers#take}
  */
  readonly take?: number;
  /**
  * The thumbprint of the deployment target to match in the query and/or search
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers#thumbprint DataOctopusdeployKubernetesAgentWorkers#thumbprint}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers octopusdeploy_kubernetes_agent_workers}
*/
export class DataOctopusdeployKubernetesAgentWorkers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOctopusdeployKubernetesAgentWorkers that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/data-sources/kubernetes_agent_workers octopusdeploy_kubernetes_agent_workers} Data Source
  *
  * @param scope The scope in which to define this construct
