// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker
...
export interface SshConnectionWorkerConfig extends cdktf.TerraformMetaArguments {
  ...
  * Connection account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker#account_id SshConnectionWorker#account_id}
  */
  readonly accountId: string;
  /**
  * NET Core platform of self-contained version of Calamari
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker#dotnet_platform SshConnectionWorker#dotnet_platform}
  */
  readonly dotnetPlatform: string;
  /**
  * The host fingerprint to be verified
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker#fingerprint SshConnectionWorker#fingerprint}
  */
  readonly fingerprint: string;
  /**
  * The hostname or IP address of the deployment target to connect to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker#host SshConnectionWorker#host}
  */
  readonly host: string;
  /**
  * When disabled, worker will not be included in any deployments
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker#is_disabled SshConnectionWorker#is_disabled}
  */
  readonly isDisabled?: boolean | cdktf.IResolvable;
  /**
  * Select the machine policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker#machine_policy_id SshConnectionWorker#machine_policy_id}
  */
  readonly machinePolicyId: string;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker#name SshConnectionWorker#name}
  */
  readonly name: string;
  /**
  * The port number of the host to connect to (usually 22)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker#port SshConnectionWorker#port}
  */
  readonly port: number;
  /**
  * Specify the connection type for the Tentacle: direct(when not set) or via a proxy server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker#proxy_id SshConnectionWorker#proxy_id}
  */
  readonly proxyId?: string;
  /**
  * The space ID associated with this Listening tentacle worker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker#space_id SshConnectionWorker#space_id}
  */
  readonly spaceId?: string;
  /**
  * Select at least one worker pool for the worker
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker#worker_pool_ids SshConnectionWorker#worker_pool_ids}
  */
  readonly workerPoolIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker octopusdeploy_ssh_connection_worker}
*/
export class SshConnectionWorker extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SshConnectionWorker that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/ssh_connection_worker octopusdeploy_ssh_connection_worker} Resource
  *
  * @param scope The scope in which to define this construct
