// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/scoped_user_role
...
export interface ScopedUserRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/scoped_user_role#environment_ids ScopedUserRole#environment_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/scoped_user_role#project_group_ids ScopedUserRole#project_group_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/scoped_user_role#project_ids ScopedUserRole#project_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/scoped_user_role#space_id ScopedUserRole#space_id}
  */
  readonly spaceId?: string;
  /**
  * The team ID that this scoped user role belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/scoped_user_role#team_id ScopedUserRole#team_id}
  */
  readonly teamId: string;
  /**
  * A list of tenant IDs that scope the user role. If not provided, the user role applies to all tenants.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/scoped_user_role#tenant_ids ScopedUserRole#tenant_ids}
  */
  readonly tenantIds?: string[];
  /**
  * The user role ID that defines the permissions for this scoped user role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/scoped_user_role#user_role_id ScopedUserRole#user_role_id}
  */
  readonly userRoleId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/scoped_user_role octopusdeploy_scoped_user_role}
*/
export class ScopedUserRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScopedUserRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/scoped_user_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/scoped_user_role octopusdeploy_scoped_user_role} Resource
  *
  * @param scope The scope in which to define this construct
