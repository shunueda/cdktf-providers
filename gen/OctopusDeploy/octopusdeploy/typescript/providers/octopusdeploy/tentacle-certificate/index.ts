// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/tentacle_certificate
...
export interface TentacleCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/tentacle_certificate#dependencies TentacleCertificate#dependencies}
  */
  readonly dependencies?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/tentacle_certificate octopusdeploy_tentacle_certificate}
*/
export class TentacleCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TentacleCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/tentacle_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/tentacle_certificate octopusdeploy_tentacle_certificate} Resource
  *
  * @param scope The scope in which to define this construct
