// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/space_default_lifecycle_tentacle_retention_policy
...
export interface DataOctopusdeploySpaceDefaultLifecycleTentacleRetentionPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  * The ID of the space.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/space_default_lifecycle_tentacle_retention_policy#space_id DataOctopusdeploySpaceDefaultLifecycleTentacleRetentionPolicy#space_id}
  */
  readonly spaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/space_default_lifecycle_tentacle_retention_policy octopusdeploy_space_default_lifecycle_tentacle_retention_policy}
*/
export class DataOctopusdeploySpaceDefaultLifecycleTentacleRetentionPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOctopusdeploySpaceDefaultLifecycleTentacleRetentionPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/space_default_lifecycle_tentacle_retention_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/space_default_lifecycle_tentacle_retention_policy octopusdeploy_space_default_lifecycle_tentacle_retention_policy} Data Source
  *
  * @param scope The scope in which to define this construct
