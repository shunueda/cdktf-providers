// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account
...
export interface AwsOpenidConnectAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#account_test_subject_keys AwsOpenidConnectAccount#account_test_subject_keys}
  */
  readonly accountTestSubjectKeys?: string[];
  /**
  * Additional custom claims.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#custom_claims AwsOpenidConnectAccount#custom_claims}
  */
  readonly customClaims?: { [key: string]: string };
  /**
  * A user-friendly description of this AWS OIDC account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#description AwsOpenidConnectAccount#description}
  */
  readonly description?: string;
  /**
  * A list of environment IDs associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#environments AwsOpenidConnectAccount#environments}
  */
  readonly environments?: string[];
  /**
  * Keys to include in a deployment or runbook. Valid options are `space`, `environment`, `project`, `tenant`, `runbook`, `account`, `type`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#execution_subject_keys AwsOpenidConnectAccount#execution_subject_keys}
  */
  readonly executionSubjectKeys?: string[];
  /**
  * Keys to include in a health check. Valid options are `space`, `account`, `target`, `type`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#health_subject_keys AwsOpenidConnectAccount#health_subject_keys}
  */
  readonly healthSubjectKeys?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#id AwsOpenidConnectAccount#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#name AwsOpenidConnectAccount#name}
  */
  readonly name: string;
  /**
  * The Amazon Resource Name (ARN) of the role that the caller is assuming.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#role_arn AwsOpenidConnectAccount#role_arn}
  */
  readonly roleArn: string;
  /**
  * The duration, in seconds, of the role session.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#session_duration AwsOpenidConnectAccount#session_duration}
  */
  readonly sessionDuration?: number;
  /**
  * The space ID associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#space_id AwsOpenidConnectAccount#space_id}
  */
  readonly spaceId?: string;
  /**
  * A list of tenant tags associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#tenant_tags AwsOpenidConnectAccount#tenant_tags}
  */
  readonly tenantTags?: string[];
  /**
  * The tenanted deployment mode of the resource. Valid account types are `Untenanted`, `TenantedOrUntenanted`, or `Tenanted`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#tenanted_deployment_participation AwsOpenidConnectAccount#tenanted_deployment_participation}
  */
  readonly tenantedDeploymentParticipation?: string;
  /**
  * A list of tenant IDs associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#tenants AwsOpenidConnectAccount#tenants}
  */
  readonly tenants?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account octopusdeploy_aws_openid_connect_account}
*/
export class AwsOpenidConnectAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsOpenidConnectAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/aws_openid_connect_account octopusdeploy_aws_openid_connect_account} Resource
  *
  * @param scope The scope in which to define this construct
