// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users
...
export interface DataOctopusdeployUsersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#filter DataOctopusdeployUsers#filter}
  */
  readonly filter?: string;
  /**
  * A filter to search by a list of IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#ids DataOctopusdeployUsers#ids}
  */
  readonly ids?: string[];
  /**
  * A filter to specify the number of items to skip in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#skip DataOctopusdeployUsers#skip}
  */
  readonly skip?: number;
  /**
  * The space ID associated with this user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#space_id DataOctopusdeployUsers#space_id}
  */
  readonly spaceId?: string;
  /**
  * A filter to specify the number of items to take (or return) in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#take DataOctopusdeployUsers#take}
  */
...
export interface DataOctopusdeployUsersUsersIdentityClaim {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#is_identifying_claim DataOctopusdeployUsers#is_identifying_claim}
  */
  readonly isIdentifyingClaim?: boolean | cdktf.IResolvable;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#name DataOctopusdeployUsers#name}
  */
  readonly name: string;
  /**
  * The value of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#value DataOctopusdeployUsers#value}
  */
...
export interface DataOctopusdeployUsersUsers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#can_password_be_edited DataOctopusdeployUsers#can_password_be_edited}
  */
  readonly canPasswordBeEdited?: boolean | cdktf.IResolvable;
  /**
  * The display name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#display_name DataOctopusdeployUsers#display_name}
  */
  readonly displayName: string;
  /**
  * The email address of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#email_address DataOctopusdeployUsers#email_address}
  */
  readonly emailAddress?: string;
  /**
  * The identities associated with the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#identity DataOctopusdeployUsers#identity}
  */
  readonly identity?: DataOctopusdeployUsersUsersIdentity[] | cdktf.IResolvable;
  /**
  * Specifies whether or not the user is active.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#is_active DataOctopusdeployUsers#is_active}
  */
  readonly isActive?: boolean | cdktf.IResolvable;
  /**
  * Specifies whether or not the user is the requestor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#is_requestor DataOctopusdeployUsers#is_requestor}
  */
  readonly isRequestor?: boolean | cdktf.IResolvable;
  /**
  * Specifies whether or not the user is a service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#is_service DataOctopusdeployUsers#is_service}
  */
  readonly isService?: boolean | cdktf.IResolvable;
  /**
  * The username associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#username DataOctopusdeployUsers#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users octopusdeploy_users}
*/
export class DataOctopusdeployUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOctopusdeployUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/users octopusdeploy_users} Data Source
  *
  * @param scope The scope in which to define this construct
