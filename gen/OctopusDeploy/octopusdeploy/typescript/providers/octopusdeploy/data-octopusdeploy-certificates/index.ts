// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates
...
export interface DataOctopusdeployCertificatesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates#archived DataOctopusdeployCertificates#archived}
  */
  readonly archived?: string;
  /**
  * A filter to define the first result.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates#first_result DataOctopusdeployCertificates#first_result}
  */
  readonly firstResult?: string;
  /**
  * A filter to search by a list of IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates#ids DataOctopusdeployCertificates#ids}
  */
  readonly ids?: string[];
  /**
  * A filter used to order the search results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates#order_by DataOctopusdeployCertificates#order_by}
  */
  readonly orderBy?: string;
  /**
  * A filter to search by the partial match of a name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates#partial_name DataOctopusdeployCertificates#partial_name}
  */
  readonly partialName?: string;
  /**
  * A filter of terms used the search operation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates#search DataOctopusdeployCertificates#search}
  */
  readonly search?: string;
  /**
  * A filter to specify the number of items to skip in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates#skip DataOctopusdeployCertificates#skip}
  */
  readonly skip?: number;
  /**
  * The space ID associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates#space_id DataOctopusdeployCertificates#space_id}
  */
  readonly spaceId?: string;
  /**
  * A filter to specify the number of items to take (or return) in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates#take DataOctopusdeployCertificates#take}
  */
  readonly take?: number;
  /**
  * A filter to search by a tenant ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates#tenant DataOctopusdeployCertificates#tenant}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates octopusdeploy_certificates}
*/
export class DataOctopusdeployCertificates extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOctopusdeployCertificates that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/certificates octopusdeploy_certificates} Data Source
  *
  * @param scope The scope in which to define this construct
