// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables
...
export interface DataOctopusdeployVariablesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables#name DataOctopusdeployVariables#name}
  */
  readonly name: string;
  /**
  * Owner ID for the variable to find.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables#owner_id DataOctopusdeployVariables#owner_id}
  */
  readonly ownerId: string;
  /**
  * As variable names can appear more than once under different scopes, a VariableScope must also be provided
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables#scope DataOctopusdeployVariables#scope}
  */
  readonly scope: DataOctopusdeployVariablesScope[] | cdktf.IResolvable;
  /**
  * The space ID associated with this variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables#space_id DataOctopusdeployVariables#space_id}
  */
...
export interface DataOctopusdeployVariablesScope {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables#actions DataOctopusdeployVariables#actions}
  */
  readonly actions?: string[];
  /**
  * A list of channels that are scoped to this variable value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables#channels DataOctopusdeployVariables#channels}
  */
  readonly channels?: string[];
  /**
  * A list of environments that are scoped to this variable value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables#environments DataOctopusdeployVariables#environments}
  */
  readonly environments?: string[];
  /**
  * A list of machines that are scoped to this variable value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables#machines DataOctopusdeployVariables#machines}
  */
  readonly machines?: string[];
  /**
  * A list of processes that are scoped to this variable value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables#processes DataOctopusdeployVariables#processes}
  */
  readonly processes?: string[];
  /**
  * A list of roles that are scoped to this variable value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables#roles DataOctopusdeployVariables#roles}
  */
  readonly roles?: string[];
  /**
  * A list of tenant tags that are scoped to this variable value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables#tenant_tags DataOctopusdeployVariables#tenant_tags}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables octopusdeploy_variables}
*/
export class DataOctopusdeployVariables extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOctopusdeployVariables that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/data-sources/variables octopusdeploy_variables} Data Source
  *
  * @param scope The scope in which to define this construct
