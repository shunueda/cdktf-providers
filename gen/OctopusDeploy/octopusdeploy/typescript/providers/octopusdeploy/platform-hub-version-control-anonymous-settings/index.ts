// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/platform_hub_version_control_anonymous_settings
...
export interface PlatformHubVersionControlAnonymousSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/platform_hub_version_control_anonymous_settings#base_path PlatformHubVersionControlAnonymousSettings#base_path}
  */
  readonly basePath: string;
  /**
  * The default branch of the git repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/platform_hub_version_control_anonymous_settings#default_branch PlatformHubVersionControlAnonymousSettings#default_branch}
  */
  readonly defaultBranch: string;
  /**
  * The URL of the git repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/platform_hub_version_control_anonymous_settings#url PlatformHubVersionControlAnonymousSettings#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/platform_hub_version_control_anonymous_settings octopusdeploy_platform_hub_version_control_anonymous_settings}
*/
export class PlatformHubVersionControlAnonymousSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformHubVersionControlAnonymousSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/platform_hub_version_control_anonymous_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/platform_hub_version_control_anonymous_settings octopusdeploy_platform_hub_version_control_anonymous_settings} Resource
  *
  * @param scope The scope in which to define this construct
