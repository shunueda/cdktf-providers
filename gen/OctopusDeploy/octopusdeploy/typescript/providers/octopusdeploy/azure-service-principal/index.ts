// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal
...
export interface AzureServicePrincipalConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#application_id AzureServicePrincipal#application_id}
  */
  readonly applicationId: string;
  /**
  * The authentication endpoint URI for this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#authentication_endpoint AzureServicePrincipal#authentication_endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#azure_environment AzureServicePrincipal#azure_environment}
  */
  readonly azureEnvironment?: string;
  /**
  * The description of this Azure service principal account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#description AzureServicePrincipal#description}
  */
  readonly description?: string;
  /**
  * A list of environment IDs associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#environments AzureServicePrincipal#environments}
  */
  readonly environments?: string[];
  /**
  * The unique ID for this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#id AzureServicePrincipal#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#name AzureServicePrincipal#name}
  */
  readonly name: string;
  /**
  * The password associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#password AzureServicePrincipal#password}
  */
  readonly password: string;
  /**
  * The resource manager endpoint URI for this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#resource_manager_endpoint AzureServicePrincipal#resource_manager_endpoint}
  */
  readonly resourceManagerEndpoint?: string;
  /**
  * The space ID associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#space_id AzureServicePrincipal#space_id}
  */
  readonly spaceId?: string;
  /**
  * The subscription ID of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#subscription_id AzureServicePrincipal#subscription_id}
  */
  readonly subscriptionId: string;
  /**
  * The tenant ID of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#tenant_id AzureServicePrincipal#tenant_id}
  */
  readonly tenantId: string;
  /**
  * A list of tenant tags associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#tenant_tags AzureServicePrincipal#tenant_tags}
  */
  readonly tenantTags?: string[];
  /**
  * The tenanted deployment mode of the resource. Valid account types are `Untenanted`, `TenantedOrUntenanted`, or `Tenanted`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#tenanted_deployment_participation AzureServicePrincipal#tenanted_deployment_participation}
  */
  readonly tenantedDeploymentParticipation?: string;
  /**
  * A list of tenant IDs associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#tenants AzureServicePrincipal#tenants}
  */
  readonly tenants?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal octopusdeploy_azure_service_principal}
*/
export class AzureServicePrincipal extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureServicePrincipal that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/azure_service_principal octopusdeploy_azure_service_principal} Resource
  *
  * @param scope The scope in which to define this construct
