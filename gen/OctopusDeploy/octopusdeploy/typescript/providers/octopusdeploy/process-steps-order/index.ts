// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/process_steps_order
...
export interface ProcessStepsOrderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/process_steps_order#process_id ProcessStepsOrder#process_id}
  */
  readonly processId: string;
  /**
  * The space ID associated with this process_steps_order.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/process_steps_order#space_id ProcessStepsOrder#space_id}
  */
  readonly spaceId?: string;
  /**
  * Steps in the order of execution
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/process_steps_order#steps ProcessStepsOrder#steps}
  */
  readonly steps: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/process_steps_order octopusdeploy_process_steps_order}
*/
export class ProcessStepsOrder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProcessStepsOrder that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/process_steps_order#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/process_steps_order octopusdeploy_process_steps_order} Resource
  *
  * @param scope The scope in which to define this construct
