// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/artifactory_generic_feed
...
export interface ArtifactoryGenericFeedConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/artifactory_generic_feed#feed_uri ArtifactoryGenericFeed#feed_uri}
  */
  readonly feedUri: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/artifactory_generic_feed#layout_regex ArtifactoryGenericFeed#layout_regex}
  */
  readonly layoutRegex?: string;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/artifactory_generic_feed#name ArtifactoryGenericFeed#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/artifactory_generic_feed#package_acquisition_location_options ArtifactoryGenericFeed#package_acquisition_location_options}
  */
  readonly packageAcquisitionLocationOptions?: string[];
  /**
  * The password associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/artifactory_generic_feed#password ArtifactoryGenericFeed#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/artifactory_generic_feed#repository ArtifactoryGenericFeed#repository}
  */
  readonly repository: string;
  /**
  * The space ID associated with this artifactory generic feed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/artifactory_generic_feed#space_id ArtifactoryGenericFeed#space_id}
  */
  readonly spaceId?: string;
  /**
  * The username associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/artifactory_generic_feed#username ArtifactoryGenericFeed#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/artifactory_generic_feed octopusdeploy_artifactory_generic_feed}
*/
export class ArtifactoryGenericFeed extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ArtifactoryGenericFeed that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/artifactory_generic_feed#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/artifactory_generic_feed octopusdeploy_artifactory_generic_feed} Resource
  *
  * @param scope The scope in which to define this construct
