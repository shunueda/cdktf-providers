// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/space_default_lifecycle_tentacle_retention_policy
...
export interface SpaceDefaultLifecycleTentacleRetentionPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/space_default_lifecycle_tentacle_retention_policy#quantity_to_keep SpaceDefaultLifecycleTentacleRetentionPolicy#quantity_to_keep}
  */
  readonly quantityToKeep?: number;
  /**
  * The ID of the space.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/space_default_lifecycle_tentacle_retention_policy#space_id SpaceDefaultLifecycleTentacleRetentionPolicy#space_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/space_default_lifecycle_tentacle_retention_policy#strategy SpaceDefaultLifecycleTentacleRetentionPolicy#strategy}
  */
  readonly strategy: string;
  /**
  * The unit of quantity to keep. Valid Units are `Days` or `Items`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/space_default_lifecycle_tentacle_retention_policy#unit SpaceDefaultLifecycleTentacleRetentionPolicy#unit}
  */
  readonly unit?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/space_default_lifecycle_tentacle_retention_policy octopusdeploy_space_default_lifecycle_tentacle_retention_policy}
*/
export class SpaceDefaultLifecycleTentacleRetentionPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpaceDefaultLifecycleTentacleRetentionPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/space_default_lifecycle_tentacle_retention_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/space_default_lifecycle_tentacle_retention_policy octopusdeploy_space_default_lifecycle_tentacle_retention_policy} Resource
  *
  * @param scope The scope in which to define this construct
