// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/tag_sets
...
export interface DataOctopusdeployTagSetsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/tag_sets#ids DataOctopusdeployTagSets#ids}
  */
  readonly ids?: string[];
  /**
  * A filter to search by the partial match of a name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/tag_sets#partial_name DataOctopusdeployTagSets#partial_name}
  */
  readonly partialName?: string;
  /**
  * A filter to search by scopes. Valid values are `"Tenant"`, `"Environment"`, `"Project"`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/tag_sets#scopes DataOctopusdeployTagSets#scopes}
  */
  readonly scopes?: string[];
  /**
  * A filter to specify the number of items to skip in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/tag_sets#skip DataOctopusdeployTagSets#skip}
  */
  readonly skip?: number;
  /**
  * The space ID associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/tag_sets#space_id DataOctopusdeployTagSets#space_id}
  */
  readonly spaceId?: string;
  /**
  * A filter to specify the number of items to take (or return) in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/tag_sets#take DataOctopusdeployTagSets#take}
  */
  readonly take?: number;
}
export interface DataOctopusdeployTagSetsTagSetsTags {
}

export function dataOctopusdeployTagSetsTagSetsTagsToTerraform(struct?: DataOctopusdeployTagSetsTagSetsTags): any {
...
export function dataOctopusdeployTagSetsTagSetsTagsToHclTerraform(struct?: DataOctopusdeployTagSetsTagSetsTags): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOctopusdeployTagSetsTagSetsTagsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataOctopusdeployTagSetsTagSetsTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataOctopusdeployTagSetsTagSetsTags | undefined) {
    if (value === undefined) {
...
export class DataOctopusdeployTagSetsTagSetsTagsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataOctopusdeployTagSetsTagSetsTagsOutputReference {
    return new DataOctopusdeployTagSetsTagSetsTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/tag_sets octopusdeploy_tag_sets}
*/
export class DataOctopusdeployTagSets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOctopusdeployTagSets that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/tag_sets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/data-sources/tag_sets octopusdeploy_tag_sets} Data Source
  *
  * @param scope The scope in which to define this construct
