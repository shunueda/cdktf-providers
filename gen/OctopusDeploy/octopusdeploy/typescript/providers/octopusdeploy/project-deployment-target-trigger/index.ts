// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/project_deployment_target_trigger
...
export interface ProjectDeploymentTargetTriggerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/project_deployment_target_trigger#environment_ids ProjectDeploymentTargetTrigger#environment_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/project_deployment_target_trigger#event_categories ProjectDeploymentTargetTrigger#event_categories}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/project_deployment_target_trigger#event_groups ProjectDeploymentTargetTrigger#event_groups}
  */
  readonly eventGroups?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/project_deployment_target_trigger#id ProjectDeploymentTargetTrigger#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/project_deployment_target_trigger#name ProjectDeploymentTargetTrigger#name}
  */
  readonly name: string;
  /**
  * The ID of the project to attach the trigger.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/project_deployment_target_trigger#project_id ProjectDeploymentTargetTrigger#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/project_deployment_target_trigger#roles ProjectDeploymentTargetTrigger#roles}
  */
  readonly roles?: string[];
  /**
  * Enable to re-deploy to the deployment targets even if they are already up-to-date with the current deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/project_deployment_target_trigger#should_redeploy ProjectDeploymentTargetTrigger#should_redeploy}
  */
  readonly shouldRedeploy?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/project_deployment_target_trigger octopusdeploy_project_deployment_target_trigger}
*/
export class ProjectDeploymentTargetTrigger extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectDeploymentTargetTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/project_deployment_target_trigger#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/resources/project_deployment_target_trigger octopusdeploy_project_deployment_target_trigger} Resource
  *
  * @param scope The scope in which to define this construct
