// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel
...
export interface ChannelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#description Channel#description}
  */
  readonly description?: string;
  /**
  * The name template for ephemeral environments created from this channel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#ephemeral_environment_name_template Channel#ephemeral_environment_name_template}
  */
  readonly ephemeralEnvironmentNameTemplate?: string;
  /**
  * Indicates whether this is the default channel for the associated project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#is_default Channel#is_default}
  */
  readonly isDefault?: boolean | cdktf.IResolvable;
  /**
  * The lifecycle ID associated with this channel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#lifecycle_id Channel#lifecycle_id}
  */
  readonly lifecycleId?: string;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#name Channel#name}
  */
  readonly name: string;
  /**
  * The parent environment ID for ephemeral environments.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#parent_environment_id Channel#parent_environment_id}
  */
  readonly parentEnvironmentId?: string;
  /**
  * The project ID associated with this channel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#project_id Channel#project_id}
  */
  readonly projectId: string;
  /**
  * The space ID associated with this channel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#space_id Channel#space_id}
  */
  readonly spaceId?: string;
  /**
  * A set of tenant tags associated with this channel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#tenant_tags Channel#tenant_tags}
  */
  readonly tenantTags?: string[];
  /**
  * The type of channel. Valid values are `"Lifecycle"` or `"EphemeralEnvironment"`. Defaults to `"Lifecycle"`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#type Channel#type}
  */
  readonly type?: string;
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#rule Channel#rule}
  */
  readonly rule?: ChannelRule[] | cdktf.IResolvable;
}
export interface ChannelRuleActionPackage {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#deployment_action Channel#deployment_action}
  */
  readonly deploymentAction?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#package_reference Channel#package_reference}
  */
...
export interface ChannelRule {
  /**
  * The ID associated with this channel rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#id Channel#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#tag Channel#tag}
  */
  readonly tag?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#version_range Channel#version_range}
  */
  readonly versionRange?: string;
  /**
  * action_package block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#action_package Channel#action_package}
  */
...
export class ChannelRuleOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // action_package - computed: false, optional: true, required: false
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel octopusdeploy_channel}
*/
export class Channel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Channel that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/channel octopusdeploy_channel} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ChannelConfig) {
    ...
    this._ephemeralEnvironmentNameTemplate = config.ephemeralEnvironmentNameTemplate;
    this._isDefault = config.isDefault;
    this._lifecycleId = config.lifecycleId;
    this._name = config.name;
    this._parentEnvironmentId = config.parentEnvironmentId;
  ...
  // ephemeral_environment_name_template - computed: false, optional: true, required: false
  private _ephemeralEnvironmentNameTemplate?: string; 
  public get ephemeralEnvironmentNameTemplate() {
    return this.getStringAttribute('ephemeral_environment_name_template');
  }
  public set ephemeralEnvironmentNameTemplate(value: string) {
    this._ephemeralEnvironmentNameTemplate = value;
  }
  public resetEphemeralEnvironmentNameTemplate() {
    this._ephemeralEnvironmentNameTemplate = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get ephemeralEnvironmentNameTemplateInput() {
    return this._ephemeralEnvironmentNameTemplate;
  }
  ...
  // parent_environment_id - computed: false, optional: true, required: false
  private _parentEnvironmentId?: string; 
  public get parentEnvironmentId() {
    return this.getStringAttribute('parent_environment_id');
  }
  public set parentEnvironmentId(value: string) {
    this._parentEnvironmentId = value;
  }
  public resetParentEnvironmentId() {
    this._parentEnvironmentId = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get parentEnvironmentIdInput() {
    return this._parentEnvironmentId;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ephemeral_environment_name_template: cdktf.stringToTerraform(this._ephemeralEnvironmentNameTemplate),
      is_default: cdktf.booleanToTerraform(this._isDefault),
      lifecycle_id: cdktf.stringToTerraform(this._lifecycleId),
      name: cdktf.stringToTerraform(this._name),
      parent_environment_id: cdktf.stringToTerraform(this._parentEnvironmentId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ephemeral_environment_name_template: {
        value: cdktf.stringToHclTerraform(this._ephemeralEnvironmentNameTemplate),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      parent_environment_id: {
        value: cdktf.stringToHclTerraform(this._parentEnvironmentId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
