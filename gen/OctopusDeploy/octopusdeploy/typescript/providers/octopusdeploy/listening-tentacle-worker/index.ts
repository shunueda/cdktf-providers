// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/listening_tentacle_worker
...
export interface ListeningTentacleWorkerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/listening_tentacle_worker#is_disabled ListeningTentacleWorker#is_disabled}
  */
  readonly isDisabled?: boolean | cdktf.IResolvable;
  /**
  * Select the machine policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/listening_tentacle_worker#machine_policy_id ListeningTentacleWorker#machine_policy_id}
  */
  readonly machinePolicyId: string;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/listening_tentacle_worker#name ListeningTentacleWorker#name}
  */
  readonly name: string;
  /**
  * Specify the connection type for the Tentacle: direct(when not set) or via a proxy server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/listening_tentacle_worker#proxy_id ListeningTentacleWorker#proxy_id}
  */
  readonly proxyId?: string;
  /**
  * The space ID associated with this Listening tentacle worker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/listening_tentacle_worker#space_id ListeningTentacleWorker#space_id}
  */
  readonly spaceId?: string;
  /**
  * The X509 certificate thumbprint that securely identifies the Tentacle
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/listening_tentacle_worker#thumbprint ListeningTentacleWorker#thumbprint}
  */
  readonly thumbprint: string;
  /**
  * The network address at which the Tentacle can be reached
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/listening_tentacle_worker#uri ListeningTentacleWorker#uri}
  */
  readonly uri: string;
  /**
  * Select at least one worker pool for the worker
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/listening_tentacle_worker#worker_pool_ids ListeningTentacleWorker#worker_pool_ids}
  */
  readonly workerPoolIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/listening_tentacle_worker octopusdeploy_listening_tentacle_worker}
*/
export class ListeningTentacleWorker extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ListeningTentacleWorker that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/listening_tentacle_worker#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/listening_tentacle_worker octopusdeploy_listening_tentacle_worker} Resource
  *
  * @param scope The scope in which to define this construct
