// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants
...
export interface DataOctopusdeployTenantsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants#cloned_from_tenant_id DataOctopusdeployTenants#cloned_from_tenant_id}
  */
  readonly clonedFromTenantId?: string;
  /**
  * A filter to search by a list of IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants#ids DataOctopusdeployTenants#ids}
  */
  readonly ids?: string[];
  /**
  * A filter to search for cloned resources.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants#is_clone DataOctopusdeployTenants#is_clone}
  */
  readonly isClone?: boolean | cdktf.IResolvable;
  /**
  * A filter to search by the disabled status of a resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants#is_disabled DataOctopusdeployTenants#is_disabled}
  */
  readonly isDisabled?: boolean | cdktf.IResolvable;
  /**
  * A filter to search by name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants#name DataOctopusdeployTenants#name}
  */
  readonly name?: string;
  /**
  * A filter to search by a partial name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants#partial_name DataOctopusdeployTenants#partial_name}
  */
  readonly partialName?: string;
  /**
  * A filter to search by a project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants#project_id DataOctopusdeployTenants#project_id}
  */
  readonly projectId?: string;
  /**
  * A filter to specify the number of items to skip in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants#skip DataOctopusdeployTenants#skip}
  */
  readonly skip?: number;
  /**
  * The space ID associated with this tenants.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants#space_id DataOctopusdeployTenants#space_id}
  */
  readonly spaceId?: string;
  /**
  * A filter to search by a list of tags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants#tags DataOctopusdeployTenants#tags}
  */
  readonly tags?: string[];
  /**
  * A filter to specify the number of items to take (or return) in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants#take DataOctopusdeployTenants#take}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants octopusdeploy_tenants}
*/
export class DataOctopusdeployTenants extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOctopusdeployTenants that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.5.2/docs/data-sources/tenants octopusdeploy_tenants} Data Source
  *
  * @param scope The scope in which to define this construct
