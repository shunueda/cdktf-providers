// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/project_auto_create_release
...
export interface ProjectAutoCreateReleaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/project_auto_create_release#channel_id ProjectAutoCreateRelease#channel_id}
  */
  readonly channelId: string;
  /**
  * The ID of the deployment process to enforce dependency on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/project_auto_create_release#deployment_process_id ProjectAutoCreateRelease#deployment_process_id}
  */
  readonly deploymentProcessId: string;
  /**
  * The ID of the deployment step containing the package for release creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/project_auto_create_release#release_creation_package_step_id ProjectAutoCreateRelease#release_creation_package_step_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/project_auto_create_release#space_id ProjectAutoCreateRelease#space_id}
  */
  readonly spaceId?: string;
  /**
  * release_creation_package block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/project_auto_create_release#release_creation_package ProjectAutoCreateRelease#release_creation_package}
  */
...
export interface ProjectAutoCreateReleaseReleaseCreationPackage {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/project_auto_create_release#deployment_action ProjectAutoCreateRelease#deployment_action}
  */
  readonly deploymentAction: string;
  /**
  * The name of the package reference within the deployment action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/project_auto_create_release#package_reference ProjectAutoCreateRelease#package_reference}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/project_auto_create_release octopusdeploy_project_auto_create_release}
*/
export class ProjectAutoCreateRelease extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectAutoCreateRelease that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/project_auto_create_release#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.0/docs/resources/project_auto_create_release octopusdeploy_project_auto_create_release} Resource
  *
  * @param scope The scope in which to define this construct
