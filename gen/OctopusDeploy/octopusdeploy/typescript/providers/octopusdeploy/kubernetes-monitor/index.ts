// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/kubernetes_monitor
...
export interface KubernetesMonitorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/kubernetes_monitor#installation_id KubernetesMonitor#installation_id}
  */
  readonly installationId: string;
  /**
  * The ID of the Kubernetes Agent deployment target machine.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/kubernetes_monitor#machine_id KubernetesMonitor#machine_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/kubernetes_monitor#preserve_authentication_token KubernetesMonitor#preserve_authentication_token}
  */
  readonly preserveAuthenticationToken?: boolean | cdktf.IResolvable;
  /**
  * The space ID associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/kubernetes_monitor#space_id KubernetesMonitor#space_id}
  */
  readonly spaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/kubernetes_monitor octopusdeploy_kubernetes_monitor}
*/
export class KubernetesMonitor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/kubernetes_monitor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.4.0/docs/resources/kubernetes_monitor octopusdeploy_kubernetes_monitor} Resource
  *
  * @param scope The scope in which to define this construct
