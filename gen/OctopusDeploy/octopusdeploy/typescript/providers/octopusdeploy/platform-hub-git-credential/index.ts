// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/platform_hub_git_credential
...
export interface PlatformHubGitCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/platform_hub_git_credential#description PlatformHubGitCredential#description}
  */
  readonly description?: string;
  /**
  * The name of this Git Credential.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/platform_hub_git_credential#name PlatformHubGitCredential#name}
  */
  readonly name: string;
  /**
  * The password for the Git credential.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/platform_hub_git_credential#password PlatformHubGitCredential#password}
  */
  readonly password: string;
  /**
  * Sets the repository restrictions associated with the Git credential.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/platform_hub_git_credential#repository_restrictions PlatformHubGitCredential#repository_restrictions}
  */
  readonly repositoryRestrictions?: PlatformHubGitCredentialRepositoryRestrictions;
  /**
  * The username for the Git credential.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/platform_hub_git_credential#username PlatformHubGitCredential#username}
  */
...
export interface PlatformHubGitCredentialRepositoryRestrictions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/platform_hub_git_credential#allowed_repositories PlatformHubGitCredential#allowed_repositories}
  */
  readonly allowedRepositories: string[];
  /**
  * Whether repository restrictions are enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/platform_hub_git_credential#enabled PlatformHubGitCredential#enabled}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/platform_hub_git_credential octopusdeploy_platform_hub_git_credential}
*/
export class PlatformHubGitCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformHubGitCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/platform_hub_git_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/platform_hub_git_credential octopusdeploy_platform_hub_git_credential} Resource
  *
  * @param scope The scope in which to define this construct
