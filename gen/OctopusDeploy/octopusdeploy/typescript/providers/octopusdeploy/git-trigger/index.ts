// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger
...
export interface GitTriggerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger#channel_id GitTrigger#channel_id}
  */
  readonly channelId: string;
  /**
  * The description of this Git trigger..
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger#description GitTrigger#description}
  */
  readonly description?: string;
  /**
  * Disables the trigger from being run when set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger#is_disabled GitTrigger#is_disabled}
  */
  readonly isDisabled?: boolean | cdktf.IResolvable;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger#name GitTrigger#name}
  */
  readonly name: string;
  /**
  * The ID of the project to attach the trigger.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger#project_id GitTrigger#project_id}
  */
  readonly projectId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger#sources GitTrigger#sources}
  */
  readonly sources: GitTriggerSources[] | cdktf.IResolvable;
  /**
  * The space ID associated with this Git trigger.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger#space_id GitTrigger#space_id}
  */
...
export interface GitTriggerSources {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger#deployment_action_slug GitTrigger#deployment_action_slug}
  */
  readonly deploymentActionSlug: string;
  /**
  * The file paths to exclude.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger#exclude_file_paths GitTrigger#exclude_file_paths}
  */
  readonly excludeFilePaths: string[];
  /**
  * The git dependency name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger#git_dependency_name GitTrigger#git_dependency_name}
  */
  readonly gitDependencyName: string;
  /**
  * The file paths to include.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger#include_file_paths GitTrigger#include_file_paths}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger octopusdeploy_git_trigger}
*/
export class GitTrigger extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GitTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.7.1/docs/resources/git_trigger octopusdeploy_git_trigger} Resource
  *
  * @param scope The scope in which to define this construct
