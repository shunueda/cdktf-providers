// https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/parent_environment
...
export interface ParentEnvironmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/parent_environment#automatic_deprovisioning_rule ParentEnvironment#automatic_deprovisioning_rule}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/parent_environment#description ParentEnvironment#description}
  */
  readonly description?: string;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/parent_environment#name ParentEnvironment#name}
  */
  readonly name: string;
  /**
  * The human-readable unique identifier for the step.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/parent_environment#slug ParentEnvironment#slug}
  */
  readonly slug?: string;
  /**
  * The sort order of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/parent_environment#sort_order ParentEnvironment#sort_order}
  */
  readonly sortOrder?: number;
  /**
  * The space ID associated with this parent environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/parent_environment#space_id ParentEnvironment#space_id}
  */
  readonly spaceId: string;
  /**
  * Indicates whether guided failure mode is enabled for this parent environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/parent_environment#use_guided_failure ParentEnvironment#use_guided_failure}
  */
...
export interface ParentEnvironmentAutomaticDeprovisioningRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/parent_environment#days ParentEnvironment#days}
  */
  readonly days?: number;
  /**
  * Number of hours to wait before deprovisioning.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/parent_environment#hours ParentEnvironment#hours}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/parent_environment octopusdeploy_parent_environment}
*/
export class ParentEnvironment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ParentEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/parent_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploy/octopusdeploy/1.6.0/docs/resources/parent_environment octopusdeploy_parent_environment} Resource
  *
  * @param scope The scope in which to define this construct
