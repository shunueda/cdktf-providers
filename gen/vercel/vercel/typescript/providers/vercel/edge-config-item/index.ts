// https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/edge_config_item
...
export interface EdgeConfigItemConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/edge_config_item#edge_config_id EdgeConfigItem#edge_config_id}
  */
  readonly edgeConfigId: string;
  /**
  * The name of the key you want to add to or update within your Edge Config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/edge_config_item#key EdgeConfigItem#key}
  */
  readonly key: string;
  /**
  * The ID of the team the Edge Config should exist under. Required when configuring a team resource if a default team has not been set in the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/edge_config_item#team_id EdgeConfigItem#team_id}
  */
  readonly teamId?: string;
  /**
  * The value you want to assign to the key when using a string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/edge_config_item#value EdgeConfigItem#value}
  */
  readonly value?: string;
  /**
  * Structured JSON value to assign to the key (object/array/number/bool/null).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/edge_config_item#value_json EdgeConfigItem#value_json}
  */
  readonly valueJson?: { [key: string]: any };
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/edge_config_item vercel_edge_config_item}
*/
export class EdgeConfigItem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EdgeConfigItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/edge_config_item#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/edge_config_item vercel_edge_config_item} Resource
  *
  * @param scope The scope in which to define this construct
