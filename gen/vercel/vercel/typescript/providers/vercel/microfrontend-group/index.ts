// https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/microfrontend_group
...
export interface MicrofrontendGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/microfrontend_group#default_app MicrofrontendGroup#default_app}
  */
  readonly defaultApp: MicrofrontendGroupDefaultApp;
  /**
  * A human readable name for the microfrontends group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/microfrontend_group#name MicrofrontendGroup#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/microfrontend_group#team_id MicrofrontendGroup#team_id}
  */
...
export interface MicrofrontendGroupDefaultApp {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/microfrontend_group#default_route MicrofrontendGroup#default_route}
  */
  readonly defaultRoute?: string;
  /**
  * The ID of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/microfrontend_group#project_id MicrofrontendGroup#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/microfrontend_group vercel_microfrontend_group}
*/
export class MicrofrontendGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MicrofrontendGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/microfrontend_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/microfrontend_group vercel_microfrontend_group} Resource
  *
  * @param scope The scope in which to define this construct
