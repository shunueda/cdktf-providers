// https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/log_drain
...
export interface DataVercelLogDrainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/log_drain#endpoint DataVercelLogDrain#endpoint}
  */
  readonly endpoint: string;
  /**
  * The ID of the Log Drain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/log_drain#id DataVercelLogDrain#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/log_drain#team_id DataVercelLogDrain#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/log_drain vercel_log_drain}
*/
export class DataVercelLogDrain extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVercelLogDrain that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/log_drain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/log_drain vercel_log_drain} Data Source
  *
  * @param scope The scope in which to define this construct
