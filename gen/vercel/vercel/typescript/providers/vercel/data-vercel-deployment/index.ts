// https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/deployment
...
export interface DataVercelDeploymentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/deployment#id DataVercelDeployment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/deployment#team_id DataVercelDeployment#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/deployment vercel_deployment}
*/
export class DataVercelDeployment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVercelDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/deployment vercel_deployment} Data Source
  *
  * @param scope The scope in which to define this construct
