// https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/team_member
...
export interface DataVercelTeamMemberConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/team_member#team_id DataVercelTeamMember#team_id}
  */
  readonly teamId: string;
  /**
  * The ID of the existing Vercel Team Member.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/team_member#user_id DataVercelTeamMember#user_id}
  */
...
export interface DataVercelTeamMemberProjects {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/team_member#project_id DataVercelTeamMember#project_id}
  */
  readonly projectId: string;
  /**
  * The role that the user should have in the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/team_member#role DataVercelTeamMember#role}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/team_member vercel_team_member}
*/
export class DataVercelTeamMember extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVercelTeamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/team_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/team_member vercel_team_member} Data Source
  *
  * @param scope The scope in which to define this construct
