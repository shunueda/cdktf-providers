// https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/custom_environment
...
export interface CustomEnvironmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/custom_environment#branch_tracking CustomEnvironment#branch_tracking}
  */
  readonly branchTracking?: CustomEnvironmentBranchTracking;
  /**
  * A description of what the environment is.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/custom_environment#description CustomEnvironment#description}
  */
  readonly description?: string;
  /**
  * The name of the environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/custom_environment#name CustomEnvironment#name}
  */
  readonly name: string;
  /**
  * The ID of the existing Vercel Project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/custom_environment#project_id CustomEnvironment#project_id}
  */
  readonly projectId: string;
  /**
  * The team ID to add the project to. Required when configuring a team resource if a default team has not been set in the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/custom_environment#team_id CustomEnvironment#team_id}
  */
...
export interface CustomEnvironmentBranchTracking {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/custom_environment#pattern CustomEnvironment#pattern}
  */
  readonly pattern: string;
  /**
  * How a branch name should be matched against the pattern. Must be one of 'startsWith', 'endsWith' or 'equals'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/custom_environment#type CustomEnvironment#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/custom_environment vercel_custom_environment}
*/
export class CustomEnvironment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/custom_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/custom_environment vercel_custom_environment} Resource
  *
  * @param scope The scope in which to define this construct
