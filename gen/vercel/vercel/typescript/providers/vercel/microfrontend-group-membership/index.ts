// https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/microfrontend_group_membership
...
export interface MicrofrontendGroupMembershipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/microfrontend_group_membership#default_route MicrofrontendGroupMembership#default_route}
  */
  readonly defaultRoute?: string;
  /**
  * The ID of the microfrontend group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/microfrontend_group_membership#microfrontend_group_id MicrofrontendGroupMembership#microfrontend_group_id}
  */
  readonly microfrontendGroupId: string;
  /**
  * The ID of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/microfrontend_group_membership#project_id MicrofrontendGroupMembership#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/microfrontend_group_membership#route_observability_to_this_project MicrofrontendGroupMembership#route_observability_to_this_project}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/microfrontend_group_membership#team_id MicrofrontendGroupMembership#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/microfrontend_group_membership vercel_microfrontend_group_membership}
*/
export class MicrofrontendGroupMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MicrofrontendGroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/microfrontend_group_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/microfrontend_group_membership vercel_microfrontend_group_membership} Resource
  *
  * @param scope The scope in which to define this construct
