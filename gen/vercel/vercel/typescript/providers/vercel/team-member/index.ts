// https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/team_member
...
export interface TeamMemberConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/team_member#access_groups TeamMember#access_groups}
  */
  readonly accessGroups?: string[];
  /**
  * The email of the user to add to the team. Must specify one of user_id or email.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/team_member#email TeamMember#email}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/team_member#projects TeamMember#projects}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/team_member#role TeamMember#role}
  */
  readonly role: string;
  /**
  * The ID of the existing Vercel Team.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/team_member#team_id TeamMember#team_id}
  */
  readonly teamId: string;
  /**
  * The ID of the user to add to the team. Must specify one of user_id or email.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/team_member#user_id TeamMember#user_id}
  */
...
export interface TeamMemberProjects {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/team_member#project_id TeamMember#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/team_member vercel_team_member}
*/
export class TeamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/team_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/team_member vercel_team_member} Resource
  *
  * @param scope The scope in which to define this construct
