// https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/shared_environment_variable
...
export interface DataVercelSharedEnvironmentVariableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/shared_environment_variable#id DataVercelSharedEnvironmentVariable#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/shared_environment_variable#key DataVercelSharedEnvironmentVariable#key}
  */
  readonly key?: string;
  /**
  * The environments that the Environment Variable should be present on. Valid targets are either `production`, `preview`, or `development`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/shared_environment_variable#target DataVercelSharedEnvironmentVariable#target}
  */
  readonly target?: string[];
  /**
  * The ID of the Vercel team. Shared environment variables require a team.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/shared_environment_variable#team_id DataVercelSharedEnvironmentVariable#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/shared_environment_variable vercel_shared_environment_variable}
*/
export class DataVercelSharedEnvironmentVariable extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVercelSharedEnvironmentVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/shared_environment_variable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/data-sources/shared_environment_variable vercel_shared_environment_variable} Data Source
  *
  * @param scope The scope in which to define this construct
