// https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/custom_certificate
...
export interface CustomCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/custom_certificate#certificate CustomCertificate#certificate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/custom_certificate#certificate_authority_certificate CustomCertificate#certificate_authority_certificate}
  */
  readonly certificateAuthorityCertificate: string;
  /**
  * The private key of the Certificate. Should be in PEM format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/custom_certificate#private_key CustomCertificate#private_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/custom_certificate#team_id CustomCertificate#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/custom_certificate vercel_custom_certificate}
*/
export class CustomCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/custom_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/custom_certificate vercel_custom_certificate} Resource
  *
  * @param scope The scope in which to define this construct
