// https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/alias
...
export interface AliasConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/alias#alias Alias#alias}
  */
  readonly alias: string;
  /**
  * The id of the Deployment the Alias should be associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/alias#deployment_id Alias#deployment_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/alias#team_id Alias#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/alias vercel_alias}
*/
export class Alias extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Alias that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/alias vercel_alias} Resource
  *
  * @param scope The scope in which to define this construct
