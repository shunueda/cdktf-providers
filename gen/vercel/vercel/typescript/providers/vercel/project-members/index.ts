// https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_members
...
export interface ProjectMembersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_members#members ProjectMembers#members}
  */
  readonly members: ProjectMembersMembers[] | cdktf.IResolvable;
  /**
  * The ID of the existing Vercel Project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_members#project_id ProjectMembers#project_id}
  */
  readonly projectId: string;
  /**
  * The team ID to add the project to. Required when configuring a team resource if a default team has not been set in the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_members#team_id ProjectMembers#team_id}
  */
...
export interface ProjectMembersMembers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_members#email ProjectMembers#email}
  */
  readonly email?: string;
  /**
  * The role that the user should have in the project. One of 'ADMIN', 'PROJECT_DEVELOPER', or 'PROJECT_VIEWER'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_members#role ProjectMembers#role}
  */
  readonly role: string;
  /**
  * The ID of the user to add to the project. Exactly one of `user_id`, `email`, or `username` must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_members#user_id ProjectMembers#user_id}
  */
  readonly userId?: string;
  /**
  * The username of the user to add to the project. Exactly one of `user_id`, `email`, or `username` must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_members#username ProjectMembers#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_members vercel_project_members}
*/
export class ProjectMembers extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectMembers that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_members#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_members vercel_project_members} Resource
  *
  * @param scope The scope in which to define this construct
