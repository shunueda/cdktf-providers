// https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/access_group_project
...
export interface AccessGroupProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/access_group_project#access_group_id AccessGroupProject#access_group_id}
  */
  readonly accessGroupId: string;
  /**
  * The Project ID to assign to the access group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/access_group_project#project_id AccessGroupProject#project_id}
  */
  readonly projectId: string;
  /**
  * The project role to assign to the access group. Must be either `ADMIN`, `PROJECT_DEVELOPER`, or `PROJECT_VIEWER`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/access_group_project#role AccessGroupProject#role}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/access_group_project#team_id AccessGroupProject#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/access_group_project vercel_access_group_project}
*/
export class AccessGroupProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccessGroupProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/access_group_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/access_group_project vercel_access_group_project} Resource
  *
  * @param scope The scope in which to define this construct
