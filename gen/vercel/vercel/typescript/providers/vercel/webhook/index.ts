// https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/webhook
...
export interface WebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/webhook#endpoint Webhook#endpoint}
  */
  readonly endpoint: string;
  /**
  * A list of the events the webhook will listen to. At least one must be present.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/webhook#events Webhook#events}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/webhook#project_ids Webhook#project_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/webhook#team_id Webhook#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/webhook vercel_webhook}
*/
export class Webhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Webhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/resources/webhook vercel_webhook} Resource
  *
  * @param scope The scope in which to define this construct
