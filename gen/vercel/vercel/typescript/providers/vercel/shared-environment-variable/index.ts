// https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/shared_environment_variable
...
export interface SharedEnvironmentVariableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/shared_environment_variable#apply_to_all_custom_environments SharedEnvironmentVariable#apply_to_all_custom_environments}
  */
  readonly applyToAllCustomEnvironments?: boolean | cdktf.IResolvable;
  /**
  * A comment explaining what the environment variable is for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/shared_environment_variable#comment SharedEnvironmentVariable#comment}
  */
  readonly comment?: string;
  /**
  * The name of the Environment Variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/shared_environment_variable#key SharedEnvironmentVariable#key}
  */
  readonly key: string;
  /**
  * The ID of the Vercel project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/shared_environment_variable#project_ids SharedEnvironmentVariable#project_ids}
  */
  readonly projectIds: string[];
  /**
  * Whether the Environment Variable is sensitive or not. (May be affected by a [team-wide environment variable policy](https://vercel.com/docs/projects/environment-variables/sensitive-environment-variables#environment-variables-policy))
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/shared_environment_variable#sensitive SharedEnvironmentVariable#sensitive}
  */
  readonly sensitive?: boolean | cdktf.IResolvable;
  /**
  * The environments that the Environment Variable should be present on. Valid targets are either `production`, `preview`, or `development`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/shared_environment_variable#target SharedEnvironmentVariable#target}
  */
  readonly target?: string[];
  /**
  * The ID of the Vercel team. Shared environment variables require a team.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/shared_environment_variable#team_id SharedEnvironmentVariable#team_id}
  */
  readonly teamId?: string;
  /**
  * The value of the Environment Variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/shared_environment_variable#value SharedEnvironmentVariable#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/shared_environment_variable vercel_shared_environment_variable}
*/
export class SharedEnvironmentVariable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SharedEnvironmentVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/shared_environment_variable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/shared_environment_variable vercel_shared_environment_variable} Resource
  *
  * @param scope The scope in which to define this construct
