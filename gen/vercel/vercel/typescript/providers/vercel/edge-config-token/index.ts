// https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/edge_config_token
...
export interface EdgeConfigTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/edge_config_token#edge_config_id EdgeConfigToken#edge_config_id}
  */
  readonly edgeConfigId: string;
  /**
  * The label of the Edge Config Token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/edge_config_token#label EdgeConfigToken#label}
  */
  readonly label: string;
  /**
  * The ID of the team the Edge Config should exist under. Required when configuring a team resource if a default team has not been set in the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/edge_config_token#team_id EdgeConfigToken#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/edge_config_token vercel_edge_config_token}
*/
export class EdgeConfigToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EdgeConfigToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/edge_config_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/edge_config_token vercel_edge_config_token} Resource
  *
  * @param scope The scope in which to define this construct
