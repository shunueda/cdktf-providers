// https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/prebuilt_project
...
export interface DataVercelPrebuiltProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/prebuilt_project#path DataVercelPrebuiltProject#path}
  */
  readonly path: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/prebuilt_project vercel_prebuilt_project}
*/
export class DataVercelPrebuiltProject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVercelPrebuiltProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/prebuilt_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/prebuilt_project vercel_prebuilt_project} Data Source
  *
  * @param scope The scope in which to define this construct
