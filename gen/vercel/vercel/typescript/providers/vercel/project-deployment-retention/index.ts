// https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_deployment_retention
...
export interface ProjectDeploymentRetentionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_deployment_retention#expiration_canceled ProjectDeploymentRetention#expiration_canceled}
  */
  readonly expirationCanceled?: string;
  /**
  * The retention period for errored deployments. Should be one of '1d', '1w', '1m', '2m', '3m', '6m', '1y'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_deployment_retention#expiration_errored ProjectDeploymentRetention#expiration_errored}
  */
  readonly expirationErrored?: string;
  /**
  * The retention period for preview deployments. Should be one of '1d', '1w', '1m', '2m', '3m', '6m', '1y'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_deployment_retention#expiration_preview ProjectDeploymentRetention#expiration_preview}
  */
  readonly expirationPreview?: string;
  /**
  * The retention period for production deployments. Should be one of '1d', '1w', '1m', '2m', '3m', '6m', '1y'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_deployment_retention#expiration_production ProjectDeploymentRetention#expiration_production}
  */
  readonly expirationProduction?: string;
  /**
  * The ID of the Project for the retention policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_deployment_retention#project_id ProjectDeploymentRetention#project_id}
  */
  readonly projectId: string;
  /**
  * The ID of the Vercel team.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_deployment_retention#team_id ProjectDeploymentRetention#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_deployment_retention vercel_project_deployment_retention}
*/
export class ProjectDeploymentRetention extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectDeploymentRetention that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_deployment_retention#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/resources/project_deployment_retention vercel_project_deployment_retention} Resource
  *
  * @param scope The scope in which to define this construct
