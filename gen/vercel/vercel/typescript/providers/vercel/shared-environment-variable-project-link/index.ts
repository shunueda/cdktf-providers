// https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/shared_environment_variable_project_link
...
export interface SharedEnvironmentVariableProjectLinkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/shared_environment_variable_project_link#project_id SharedEnvironmentVariableProjectLink#project_id}
  */
  readonly projectId: string;
  /**
  * The ID of the shared environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/shared_environment_variable_project_link#shared_environment_variable_id SharedEnvironmentVariableProjectLink#shared_environment_variable_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/shared_environment_variable_project_link#team_id SharedEnvironmentVariableProjectLink#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/shared_environment_variable_project_link vercel_shared_environment_variable_project_link}
*/
export class SharedEnvironmentVariableProjectLink extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SharedEnvironmentVariableProjectLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/shared_environment_variable_project_link#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/shared_environment_variable_project_link vercel_shared_environment_variable_project_link} Resource
  *
  * @param scope The scope in which to define this construct
