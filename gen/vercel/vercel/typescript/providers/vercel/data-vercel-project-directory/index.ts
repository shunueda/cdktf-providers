// https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/project_directory
...
export interface DataVercelProjectDirectoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/project_directory#path DataVercelProjectDirectory#path}
  */
  readonly path: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/project_directory vercel_project_directory}
*/
export class DataVercelProjectDirectory extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVercelProjectDirectory that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/project_directory#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.0/docs/data-sources/project_directory vercel_project_directory} Data Source
  *
  * @param scope The scope in which to define this construct
