// https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/domain_config
...
export interface DataVercelDomainConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/domain_config#domain DataVercelDomainConfig#domain}
  */
  readonly domain: string;
  /**
  * The project ID or name associated with the domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/domain_config#project_id_or_name DataVercelDomainConfig#project_id_or_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/domain_config#team_id DataVercelDomainConfig#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/domain_config vercel_domain_config}
*/
export class DataVercelDomainConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVercelDomainConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/domain_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/domain_config vercel_domain_config} Data Source
  *
  * @param scope The scope in which to define this construct
