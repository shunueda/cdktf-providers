// https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/resources/project_rolling_release
...
export interface ProjectRollingReleaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/resources/project_rolling_release#advancement_type ProjectRollingRelease#advancement_type}
  */
  readonly advancementType: string;
  /**
  * The ID of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/resources/project_rolling_release#project_id ProjectRollingRelease#project_id}
  */
  readonly projectId: string;
  /**
  * The stages for the rolling release configuration. The last stage must have target_percentage = 100.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/resources/project_rolling_release#stages ProjectRollingRelease#stages}
  */
  readonly stages: ProjectRollingReleaseStages[] | cdktf.IResolvable;
  /**
  * The ID of the Vercel team.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/resources/project_rolling_release#team_id ProjectRollingRelease#team_id}
  */
...
export interface ProjectRollingReleaseStages {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/resources/project_rolling_release#duration ProjectRollingRelease#duration}
  */
  readonly duration?: number;
  /**
  * The percentage of traffic to route to this stage.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/resources/project_rolling_release#target_percentage ProjectRollingRelease#target_percentage}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/resources/project_rolling_release vercel_project_rolling_release}
*/
export class ProjectRollingRelease extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectRollingRelease that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/resources/project_rolling_release#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.1/docs/resources/project_rolling_release vercel_project_rolling_release} Resource
  *
  * @param scope The scope in which to define this construct
