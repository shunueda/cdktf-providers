// https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/project_deployment_retention
...
export interface DataVercelProjectDeploymentRetentionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/project_deployment_retention#project_id DataVercelProjectDeploymentRetention#project_id}
  */
  readonly projectId: string;
  /**
  * The ID of the Vercel team.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/project_deployment_retention#team_id DataVercelProjectDeploymentRetention#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/project_deployment_retention vercel_project_deployment_retention}
*/
export class DataVercelProjectDeploymentRetention extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVercelProjectDeploymentRetention that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/project_deployment_retention#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/data-sources/project_deployment_retention vercel_project_deployment_retention} Data Source
  *
  * @param scope The scope in which to define this construct
