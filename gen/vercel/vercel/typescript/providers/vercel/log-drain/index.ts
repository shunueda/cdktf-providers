// https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain
...
export interface LogDrainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain#delivery_format LogDrain#delivery_format}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain#endpoint LogDrain#endpoint}
  */
  readonly endpoint: string;
  /**
  * Logs from the selected environments will be forwarded to your webhook. At least one must be present.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain#environments LogDrain#environments}
  */
  readonly environments: string[];
  /**
  * Custom headers to include in requests to the log drain endpoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain#headers LogDrain#headers}
  */
  readonly headers?: { [key: string]: string };
  /**
  * A human-readable name for the log drain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain#name LogDrain#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain#project_ids LogDrain#project_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain#sampling_rate LogDrain#sampling_rate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain#secret LogDrain#secret}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain#sources LogDrain#sources}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain#team_id LogDrain#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain vercel_log_drain}
*/
export class LogDrain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogDrain that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.0.2/docs/resources/log_drain vercel_log_drain} Resource
  *
  * @param scope The scope in which to define this construct
