// https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/data-sources/custom_environment
...
export interface DataVercelCustomEnvironmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/data-sources/custom_environment#name DataVercelCustomEnvironment#name}
  */
  readonly name: string;
  /**
  * The ID of the existing Vercel Project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/data-sources/custom_environment#project_id DataVercelCustomEnvironment#project_id}
  */
  readonly projectId: string;
  /**
  * The team ID to add the project to. Required when configuring a team resource if a default team has not been set in the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/data-sources/custom_environment#team_id DataVercelCustomEnvironment#team_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/data-sources/custom_environment vercel_custom_environment}
*/
export class DataVercelCustomEnvironment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVercelCustomEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/data-sources/custom_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/data-sources/custom_environment vercel_custom_environment} Data Source
  *
  * @param scope The scope in which to define this construct
