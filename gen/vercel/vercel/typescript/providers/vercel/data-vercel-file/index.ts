// https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/data-sources/file
...
export interface DataVercelFileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/data-sources/file#path DataVercelFile#path}
  */
  readonly path: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/data-sources/file vercel_file}
*/
export class DataVercelFile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVercelFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/data-sources/file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.1.0/docs/data-sources/file vercel_file} Data Source
  *
  * @param scope The scope in which to define this construct
