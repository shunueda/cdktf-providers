// https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/data-sources/edge_config_token
...
export interface DataVercelEdgeConfigTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/data-sources/edge_config_token#edge_config_id DataVercelEdgeConfigToken#edge_config_id}
  */
  readonly edgeConfigId: string;
  /**
  * The ID of the team the Edge Config should exist under. Required when configuring a team resource if a default team has not been set in the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/data-sources/edge_config_token#team_id DataVercelEdgeConfigToken#team_id}
  */
  readonly teamId?: string;
  /**
  * A read access token used for authenticating against the Edge Config's endpoint for high volume, low-latency requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/data-sources/edge_config_token#token DataVercelEdgeConfigToken#token}
  */
  readonly token: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/data-sources/edge_config_token vercel_edge_config_token}
*/
export class DataVercelEdgeConfigToken extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVercelEdgeConfigToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/data-sources/edge_config_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/data-sources/edge_config_token vercel_edge_config_token} Data Source
  *
  * @param scope The scope in which to define this construct
