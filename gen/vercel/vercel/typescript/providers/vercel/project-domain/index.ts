// https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/project_domain
...
export interface ProjectDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/project_domain#custom_environment_id ProjectDomain#custom_environment_id}
  */
  readonly customEnvironmentId?: string;
  /**
  * The domain name to associate with the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/project_domain#domain ProjectDomain#domain}
  */
  readonly domain: string;
  /**
  * Git branch to link to the project domain. Deployments from this git branch will be assigned the domain name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/project_domain#git_branch ProjectDomain#git_branch}
  */
  readonly gitBranch?: string;
  /**
  * The project ID to add the deployment to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/project_domain#project_id ProjectDomain#project_id}
  */
  readonly projectId: string;
  /**
  * The domain name that serves as a target destination for redirects.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/project_domain#redirect ProjectDomain#redirect}
  */
  readonly redirect?: string;
  /**
  * The HTTP status code to use when serving as a redirect.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/project_domain#redirect_status_code ProjectDomain#redirect_status_code}
  */
  readonly redirectStatusCode?: number;
  /**
  * The ID of the team the project exists under. Required when configuring a team resource if a default team has not been set in the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/project_domain#team_id ProjectDomain#team_id}
  */
  readonly teamId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/project_domain vercel_project_domain}
*/
export class ProjectDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/project_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vercel/vercel/4.2.0/docs/resources/project_domain vercel_project_domain} Resource
  *
  * @param scope The scope in which to define this construct
