// https://registry.terraform.io/providers/heroku/heroku/5.3.2/docs/resources/pipeline_config_var
...
export interface PipelineConfigVarConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.2/docs/resources/pipeline_config_var#id PipelineConfigVar#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.2/docs/resources/pipeline_config_var#pipeline_id PipelineConfigVar#pipeline_id}
  */
  readonly pipelineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.2/docs/resources/pipeline_config_var#pipeline_stage PipelineConfigVar#pipeline_stage}
  */
  readonly pipelineStage: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.2/docs/resources/pipeline_config_var#sensitive_vars PipelineConfigVar#sensitive_vars}
  */
  readonly sensitiveVars?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.2/docs/resources/pipeline_config_var#vars PipelineConfigVar#vars}
  */
  readonly vars?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.2/docs/resources/pipeline_config_var heroku_pipeline_config_var}
*/
export class PipelineConfigVar extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PipelineConfigVar that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.2/docs/resources/pipeline_config_var#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.2/docs/resources/pipeline_config_var heroku_pipeline_config_var} Resource
  *
  * @param scope The scope in which to define this construct
