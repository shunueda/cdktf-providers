// https://registry.terraform.io/providers/bpg/proxmox/0.88.0/docs/resources/virtual_environment_hagroup
...
export interface VirtualEnvironmentHagroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.88.0/docs/resources/virtual_environment_hagroup#comment VirtualEnvironmentHagroup#comment}
  */
  readonly comment?: string;
  /**
  * The identifier of the High Availability group to manage.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.88.0/docs/resources/virtual_environment_hagroup#group VirtualEnvironmentHagroup#group}
  */
  readonly group: string;
  /**
  * A flag that indicates that failing back to a higher priority node is disabled for this HA group. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.88.0/docs/resources/virtual_environment_hagroup#no_failback VirtualEnvironmentHagroup#no_failback}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.88.0/docs/resources/virtual_environment_hagroup#nodes VirtualEnvironmentHagroup#nodes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.88.0/docs/resources/virtual_environment_hagroup#restricted VirtualEnvironmentHagroup#restricted}
  */
  readonly restricted?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bpg/proxmox/0.88.0/docs/resources/virtual_environment_hagroup proxmox_virtual_environment_hagroup}
*/
export class VirtualEnvironmentHagroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualEnvironmentHagroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/bpg/proxmox/0.88.0/docs/resources/virtual_environment_hagroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bpg/proxmox/0.88.0/docs/resources/virtual_environment_hagroup proxmox_virtual_environment_hagroup} Resource
  *
  * @param scope The scope in which to define this construct
