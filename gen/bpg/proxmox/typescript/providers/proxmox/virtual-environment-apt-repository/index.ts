// https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_apt_repository
...
export interface VirtualEnvironmentAptRepositoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_apt_repository#enabled VirtualEnvironmentAptRepository#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The absolute path of the source list file that contains this repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_apt_repository#file_path VirtualEnvironmentAptRepository#file_path}
  */
  readonly filePath: string;
  /**
  * The index within the defining source list file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_apt_repository#index VirtualEnvironmentAptRepository#index}
  */
  readonly index: number;
  /**
  * The name of the target Proxmox VE node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_apt_repository#node VirtualEnvironmentAptRepository#node}
  */
  readonly nodeAttribute: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_apt_repository proxmox_virtual_environment_apt_repository}
*/
export class VirtualEnvironmentAptRepository extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualEnvironmentAptRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_apt_repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_apt_repository proxmox_virtual_environment_apt_repository} Resource
  *
  * @param scope The scope in which to define this construct
