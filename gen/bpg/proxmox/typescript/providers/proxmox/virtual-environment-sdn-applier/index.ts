// https://registry.terraform.io/providers/bpg/proxmox/0.88.0/docs/resources/virtual_environment_sdn_applier
...
/**
* Represents a {@link https://registry.terraform.io/providers/bpg/proxmox/0.88.0/docs/resources/virtual_environment_sdn_applier proxmox_virtual_environment_sdn_applier}
*/
export class VirtualEnvironmentSdnApplier extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualEnvironmentSdnApplier that should be imported. Refer to the {@link https://registry.terraform.io/providers/bpg/proxmox/0.88.0/docs/resources/virtual_environment_sdn_applier#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bpg/proxmox/0.88.0/docs/resources/virtual_environment_sdn_applier proxmox_virtual_environment_sdn_applier} Resource
  *
  * @param scope The scope in which to define this construct
