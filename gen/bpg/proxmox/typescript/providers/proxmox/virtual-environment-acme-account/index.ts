// https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_acme_account
...
export interface VirtualEnvironmentAcmeAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_acme_account#contact VirtualEnvironmentAcmeAccount#contact}
  */
  readonly contact: string;
  /**
  * The URL of the ACME CA directory endpoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_acme_account#directory VirtualEnvironmentAcmeAccount#directory}
  */
  readonly directory?: string;
  /**
  * The HMAC key for External Account Binding.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_acme_account#eab_hmac_key VirtualEnvironmentAcmeAccount#eab_hmac_key}
  */
  readonly eabHmacKey?: string;
  /**
  * The Key Identifier for External Account Binding.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_acme_account#eab_kid VirtualEnvironmentAcmeAccount#eab_kid}
  */
  readonly eabKid?: string;
  /**
  * The ACME account config file name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_acme_account#name VirtualEnvironmentAcmeAccount#name}
  */
  readonly name?: string;
  /**
  * The URL of CA TermsOfService - setting this indicates agreement.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_acme_account#tos VirtualEnvironmentAcmeAccount#tos}
  */
  readonly tos?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_acme_account proxmox_virtual_environment_acme_account}
*/
export class VirtualEnvironmentAcmeAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualEnvironmentAcmeAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_acme_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/resources/virtual_environment_acme_account proxmox_virtual_environment_acme_account} Resource
  *
  * @param scope The scope in which to define this construct
