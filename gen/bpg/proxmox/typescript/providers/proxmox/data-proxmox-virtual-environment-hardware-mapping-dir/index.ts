// https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/data-sources/virtual_environment_hardware_mapping_dir
...
export interface DataProxmoxVirtualEnvironmentHardwareMappingDirConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/data-sources/virtual_environment_hardware_mapping_dir#name DataProxmoxVirtualEnvironmentHardwareMappingDir#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/data-sources/virtual_environment_hardware_mapping_dir proxmox_virtual_environment_hardware_mapping_dir}
*/
export class DataProxmoxVirtualEnvironmentHardwareMappingDir extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataProxmoxVirtualEnvironmentHardwareMappingDir that should be imported. Refer to the {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/data-sources/virtual_environment_hardware_mapping_dir#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bpg/proxmox/0.89.0/docs/data-sources/virtual_environment_hardware_mapping_dir proxmox_virtual_environment_hardware_mapping_dir} Data Source
  *
  * @param scope The scope in which to define this construct
