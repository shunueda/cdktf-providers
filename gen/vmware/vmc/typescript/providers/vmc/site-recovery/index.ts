...
export function siteRecoveryTimeoutsToTerraform(struct?: SiteRecoveryTimeouts | cdktf.IResolvable): any {
...
export function siteRecoveryTimeoutsToHclTerraform(struct?: SiteRecoveryTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SiteRecoveryTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SiteRecoveryTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SiteRecoveryTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SiteRecovery extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "vmc_site_recovery";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "vmc_site_recovery", importId: importFromId, provider });
      }
  ...
  * @param options SiteRecoveryConfig
  */
  public constructor(scope: Construct, id: string, config: SiteRecoveryConfig) {
    super(scope, id, {
    ...
    this._srmExtensionKeySuffix = config.srmExtensionKeySuffix;
  ...
  // draas_h5_url - computed: true, optional: false, required: false
  public get draasH5Url() {
    return this.getStringAttribute('draas_h5_url');
  }
  ...
  // site_recovery_state - computed: true, optional: false, required: false
  public get siteRecoveryState() {
    return this.getStringAttribute('site_recovery_state');
  }

  // srm_extension_key_suffix - computed: false, optional: true, required: false
  private _srmExtensionKeySuffix?: string; 
  public get srmExtensionKeySuffix() {
    return this.getStringAttribute('srm_extension_key_suffix');
  }
  public set srmExtensionKeySuffix(value: string) {
    this._srmExtensionKeySuffix = value;
  }
  public resetSrmExtensionKeySuffix() {
    this._srmExtensionKeySuffix = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get srmExtensionKeySuffixInput() {
    return this._srmExtensionKeySuffix;
  }

  // srm_node - computed: true, optional: false, required: false
  private _srmNode = new cdktf.StringMap(this, "srm_node");
  public get srmNode() {
    return this._srmNode;
  }
  ...
  // vr_node - computed: true, optional: false, required: false
  private _vrNode = new cdktf.StringMap(this, "vr_node");
  public get vrNode() {
    return this._vrNode;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts = new SiteRecoveryTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: SiteRecoveryTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      srm_extension_key_suffix: cdktf.stringToTerraform(this._srmExtensionKeySuffix),
      timeouts: siteRecoveryTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      srm_extension_key_suffix: {
        value: cdktf.stringToHclTerraform(this._srmExtensionKeySuffix),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      timeouts: {
        value: siteRecoveryTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "SiteRecoveryTimeouts",
      },
    };
