// https://registry.terraform.io/providers/vmware/vmc/1.15.5/docs/resources/public_ip
...
export interface PublicIpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vmc/1.15.5/docs/resources/public_ip#display_name PublicIp#display_name}
  */
  readonly displayName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vmc/1.15.5/docs/resources/public_ip#id PublicIp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vmc/1.15.5/docs/resources/public_ip#nsxt_reverse_proxy_url PublicIp#nsxt_reverse_proxy_url}
  */
  readonly nsxtReverseProxyUrl: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vmware/vmc/1.15.5/docs/resources/public_ip vmc_public_ip}
*/
export class PublicIp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PublicIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vmc/1.15.5/docs/resources/public_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/vmc/1.15.5/docs/resources/public_ip vmc_public_ip} Resource
  *
  * @param scope The scope in which to define this construct
