// https://registry.terraform.io/providers/vmware/vmc/1.15.6/docs/data-sources/sddc
...
export interface DataVmcSddcConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vmc/1.15.6/docs/data-sources/sddc#id DataVmcSddc#id}
  *
  ...
  * Sddc ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vmc/1.15.6/docs/data-sources/sddc#sddc_id DataVmcSddc#sddc_id}
  */
  readonly sddcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vmware/vmc/1.15.6/docs/data-sources/sddc vmc_sddc}
*/
export class DataVmcSddc extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVmcSddc that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vmc/1.15.6/docs/data-sources/sddc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/vmc/1.15.6/docs/data-sources/sddc vmc_sddc} Data Source
  *
  * @param scope The scope in which to define this construct
