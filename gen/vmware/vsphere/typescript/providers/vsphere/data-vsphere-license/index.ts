// https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/data-sources/license
...
export class DataVsphereLicense extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVsphereLicense that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/data-sources/license#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/data-sources/license vsphere_license} Data Source
  *
  * @param scope The scope in which to define this construct
