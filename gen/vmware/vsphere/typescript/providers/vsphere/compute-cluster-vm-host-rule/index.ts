// https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/resources/compute_cluster_vm_host_rule
...
export class ComputeClusterVmHostRule extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "vsphere_compute_cluster_vm_host_rule", importId: importFromId, provider });
      }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      affinity_host_group_name: {
        value: cdktf.stringToHclTerraform(this._affinityHostGroupName),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      anti_affinity_host_group_name: {
        value: cdktf.stringToHclTerraform(this._antiAffinityHostGroupName),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
