// https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/resources/host_virtual_switch
...
export class HostVirtualSwitch extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HostVirtualSwitch that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/resources/host_virtual_switch#import import section} in the documentation of this resource for the id to use
