// https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/data-sources/host_pci_device
...
export class DataVsphereHostPciDevice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVsphereHostPciDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/data-sources/host_pci_device#import import section} in the documentation of this resource for the id to use
