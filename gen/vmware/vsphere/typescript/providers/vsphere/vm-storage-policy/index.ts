// https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/resources/vm_storage_policy
...
export class VmStoragePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VmStoragePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/resources/vm_storage_policy#import import section} in the documentation of this resource for the id to use
