// https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/data-sources/host
...
export class DataVsphereHost extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVsphereHost that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/data-sources/host#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/data-sources/host vsphere_host} Data Source
  *
  * @param scope The scope in which to define this construct
