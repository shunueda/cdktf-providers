// https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user
...
export interface UserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#anonymous_user User#anonymous_user}
  */
  readonly anonymousUser?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#date_joined User#date_joined}
  */
  readonly dateJoined?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#default_tenant_ref User#default_tenant_ref}
  */
  readonly defaultTenantRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#email User#email}
  */
  readonly email?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#enable_config_warnings User#enable_config_warnings}
  */
  readonly enableConfigWarnings?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#full_name User#full_name}
  */
  readonly fullName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#id User#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#is_active User#is_active}
  */
  readonly isActive?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#is_internal_user User#is_internal_user}
  */
  readonly isInternalUser?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#is_staff User#is_staff}
  */
  readonly isStaff?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#is_superuser User#is_superuser}
  */
  readonly isSuperuser?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#local User#local}
  */
  readonly local?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#logged_in User#logged_in}
  */
  readonly loggedIn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#name User#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#password User#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#passwordless User#passwordless}
  */
  readonly passwordless?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#recovery_token User#recovery_token}
  */
  readonly recoveryToken?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#service_user User#service_user}
  */
  readonly serviceUser?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#token_expiration_date User#token_expiration_date}
  */
  readonly tokenExpirationDate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#ui_property User#ui_property}
  */
  readonly uiProperty?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#uid User#uid}
  */
  readonly uid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#unix_crypt_password User#unix_crypt_password}
  */
  readonly unixCryptPassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#user_profile_ref User#user_profile_ref}
  */
  readonly userProfileRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#username User#username}
  */
  readonly username?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#uuid User#uuid}
  */
  readonly uuid?: string;
  /**
  * access block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#access User#access}
  */
  readonly access?: UserAccess[] | cdktf.IResolvable;
}
export interface UserAccess {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#all_tenants User#all_tenants}
  */
  readonly allTenants?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#role_ref User#role_ref}
  */
  readonly roleRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#tenant_ref User#tenant_ref}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user avi_user}
*/
export class User extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing User that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/user avi_user} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: UserConfig) {
    ...
    this._enableConfigWarnings = config.enableConfigWarnings;
  ...
  // enable_config_warnings - computed: false, optional: true, required: false
  private _enableConfigWarnings?: string; 
  public get enableConfigWarnings() {
    return this.getStringAttribute('enable_config_warnings');
  }
  public set enableConfigWarnings(value: string) {
    this._enableConfigWarnings = value;
  }
  public resetEnableConfigWarnings() {
    this._enableConfigWarnings = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get enableConfigWarningsInput() {
    return this._enableConfigWarnings;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      enable_config_warnings: cdktf.stringToTerraform(this._enableConfigWarnings),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      enable_config_warnings: {
        value: cdktf.stringToHclTerraform(this._enableConfigWarnings),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
