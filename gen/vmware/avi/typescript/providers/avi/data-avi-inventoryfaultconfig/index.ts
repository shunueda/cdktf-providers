// https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/inventoryfaultconfig
...
export interface DataAviInventoryfaultconfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/inventoryfaultconfig#id DataAviInventoryfaultconfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/inventoryfaultconfig#name DataAviInventoryfaultconfig#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/inventoryfaultconfig#tenant_ref DataAviInventoryfaultconfig#tenant_ref}
  */
  readonly tenantRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/inventoryfaultconfig#uuid DataAviInventoryfaultconfig#uuid}
  */
...
export class DataAviInventoryfaultconfigControllerFaultsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // system_limits_faults - computed: true, optional: false, required: false
  public get systemLimitsFaults() {
    return this.getStringAttribute('system_limits_faults');
  }
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/inventoryfaultconfig avi_inventoryfaultconfig}
*/
export class DataAviInventoryfaultconfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAviInventoryfaultconfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/inventoryfaultconfig#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/inventoryfaultconfig avi_inventoryfaultconfig} Data Source
  *
  * @param scope The scope in which to define this construct
