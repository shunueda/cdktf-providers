// https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/data-sources/siteversion
...
export interface DataAviSiteversionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/data-sources/siteversion#id DataAviSiteversion#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/data-sources/siteversion#name DataAviSiteversion#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/data-sources/siteversion#tenant_ref DataAviSiteversion#tenant_ref}
  */
  readonly tenantRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/data-sources/siteversion#uuid DataAviSiteversion#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/data-sources/siteversion avi_siteversion}
*/
export class DataAviSiteversion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAviSiteversion that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/data-sources/siteversion#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/data-sources/siteversion avi_siteversion} Data Source
  *
  * @param scope The scope in which to define this construct
