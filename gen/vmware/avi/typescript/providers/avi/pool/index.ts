// https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/pool
...
export class Pool extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: PoolConfig) {
    ...
    this._gracefulDisableTimeoutSec = config.gracefulDisableTimeoutSec;
    this._gracefulHmDownDisableTimeout = config.gracefulHmDownDisableTimeout;
    this._gslbPoolType = config.gslbPoolType;
  ...
  // graceful_disable_timeout_sec - computed: false, optional: true, required: false
  private _gracefulDisableTimeoutSec?: string; 
  public get gracefulDisableTimeoutSec() {
    return this.getStringAttribute('graceful_disable_timeout_sec');
  }
  public set gracefulDisableTimeoutSec(value: string) {
    this._gracefulDisableTimeoutSec = value;
  }
  public resetGracefulDisableTimeoutSec() {
    this._gracefulDisableTimeoutSec = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get gracefulDisableTimeoutSecInput() {
    return this._gracefulDisableTimeoutSec;
  }
  ...
  // gslb_pool_type - computed: true, optional: true, required: false
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      graceful_disable_timeout_sec: cdktf.stringToTerraform(this._gracefulDisableTimeoutSec),
      graceful_hm_down_disable_timeout: cdktf.stringToTerraform(this._gracefulHmDownDisableTimeout),
      gslb_pool_type: cdktf.stringToTerraform(this._gslbPoolType),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      graceful_disable_timeout_sec: {
        value: cdktf.stringToHclTerraform(this._gracefulDisableTimeoutSec),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      gslb_pool_type: {
        value: cdktf.stringToHclTerraform(this._gslbPoolType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
