// https://registry.terraform.io/providers/vmware/avi/31.1.1/docs/data-sources/fileservice
...
export interface DataAviFileserviceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.1.1/docs/data-sources/fileservice#id DataAviFileservice#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.1.1/docs/data-sources/fileservice#local_file DataAviFileservice#local_file}
  */
  readonly localFile: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.1.1/docs/data-sources/fileservice#upload DataAviFileservice#upload}
  */
  readonly upload?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.1.1/docs/data-sources/fileservice#uri DataAviFileservice#uri}
  */
  readonly uri: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vmware/avi/31.1.1/docs/data-sources/fileservice avi_fileservice}
*/
export class DataAviFileservice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAviFileservice that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/avi/31.1.1/docs/data-sources/fileservice#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/avi/31.1.1/docs/data-sources/fileservice avi_fileservice} Data Source
  *
  * @param scope The scope in which to define this construct
