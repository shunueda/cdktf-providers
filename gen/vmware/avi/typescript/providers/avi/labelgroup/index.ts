// https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup
...
export interface LabelgroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup#id Labelgroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup#name Labelgroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup#uuid Labelgroup#uuid}
  */
  readonly uuid?: string;
  /**
  * configpb_attributes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup#configpb_attributes Labelgroup#configpb_attributes}
  */
  readonly configpbAttributes?: LabelgroupConfigpbAttributes[] | cdktf.IResolvable;
  /**
  * labels block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup#labels Labelgroup#labels}
  */
  readonly labels?: LabelgroupLabels[] | cdktf.IResolvable;
}
export interface LabelgroupConfigpbAttributes {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup#version Labelgroup#version}
  */
...
export interface LabelgroupLabelsMatchLabel {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup#key Labelgroup#key}
  */
  readonly key: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup#values Labelgroup#values}
  */
...
export interface LabelgroupLabels {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup#match_operation Labelgroup#match_operation}
  */
  readonly matchOperation?: string;
  /**
  * match_label block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup#match_label Labelgroup#match_label}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup avi_labelgroup}
*/
export class Labelgroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Labelgroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/avi/30.2.6/docs/resources/labelgroup avi_labelgroup} Resource
  *
  * @param scope The scope in which to define this construct
