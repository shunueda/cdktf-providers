// https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/botipreputationtypemapping
...
export interface DataAviBotipreputationtypemappingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/botipreputationtypemapping#id DataAviBotipreputationtypemapping#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/botipreputationtypemapping#name DataAviBotipreputationtypemapping#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/botipreputationtypemapping#tenant_ref DataAviBotipreputationtypemapping#tenant_ref}
  */
  readonly tenantRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/botipreputationtypemapping#uuid DataAviBotipreputationtypemapping#uuid}
  */
  readonly uuid?: string;
}
export interface DataAviBotipreputationtypemappingConfigpbAttributes {
}

export function dataAviBotipreputationtypemappingConfigpbAttributesToTerraform(struct?: DataAviBotipreputationtypemappingConfigpbAttributes): any {
...
export function dataAviBotipreputationtypemappingConfigpbAttributesToHclTerraform(struct?: DataAviBotipreputationtypemappingConfigpbAttributes): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAviBotipreputationtypemappingConfigpbAttributesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAviBotipreputationtypemappingConfigpbAttributes | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAviBotipreputationtypemappingConfigpbAttributes | undefined) {
    if (value === undefined) {
...
export class DataAviBotipreputationtypemappingConfigpbAttributesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAviBotipreputationtypemappingConfigpbAttributesOutputReference {
    return new DataAviBotipreputationtypemappingConfigpbAttributesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/botipreputationtypemapping avi_botipreputationtypemapping}
*/
export class DataAviBotipreputationtypemapping extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAviBotipreputationtypemapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/botipreputationtypemapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/botipreputationtypemapping avi_botipreputationtypemapping} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _configpbAttributes = new DataAviBotipreputationtypemappingConfigpbAttributesList(this, "configpb_attributes", true);
