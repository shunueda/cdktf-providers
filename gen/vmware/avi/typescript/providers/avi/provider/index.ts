// https://registry.terraform.io/providers/vmware/avi/30.2.5/docs
...
export interface AviProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs#avi_api_timeout AviProvider#avi_api_timeout}
  */
  readonly aviApiTimeout?: number;
  /**
  * Avi token for Avi Controller.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs#avi_authtoken AviProvider#avi_authtoken}
  */
  readonly aviAuthtoken?: string;
  /**
  * Avi Controller hostname or IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs#avi_controller AviProvider#avi_controller}
  */
  readonly aviController?: string;
  /**
  * Csp host for Avi Controller.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs#avi_csp_host AviProvider#avi_csp_host}
  */
  readonly aviCspHost?: string;
  /**
  * Csp token for Avi Controller.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs#avi_csp_token AviProvider#avi_csp_token}
  */
  readonly aviCspToken?: string;
  /**
  * Password for Avi Controller.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs#avi_password AviProvider#avi_password}
  */
  readonly aviPassword?: string;
  /**
  * Avi tenant for Avi Controller.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs#avi_tenant AviProvider#avi_tenant}
  */
  readonly aviTenant?: string;
  /**
  * Username for Avi Controller.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs#avi_username AviProvider#avi_username}
  */
  readonly aviUsername?: string;
  /**
  * Avi version for Avi Controller.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs#avi_version AviProvider#avi_version}
  */
  readonly aviVersion?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs#alias AviProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs avi}
*/
export class AviProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing AviProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs avi} Resource
  *
  * @param scope The scope in which to define this construct
