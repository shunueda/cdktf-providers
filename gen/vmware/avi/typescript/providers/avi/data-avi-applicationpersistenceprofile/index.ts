// https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/applicationpersistenceprofile
...
export interface DataAviApplicationpersistenceprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/applicationpersistenceprofile#id DataAviApplicationpersistenceprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/applicationpersistenceprofile#name DataAviApplicationpersistenceprofile#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/applicationpersistenceprofile#tenant_ref DataAviApplicationpersistenceprofile#tenant_ref}
  */
  readonly tenantRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/applicationpersistenceprofile#uuid DataAviApplicationpersistenceprofile#uuid}
  */
...
export interface DataAviApplicationpersistenceprofileDiameterAppPersistenceProfile {
}

export function dataAviApplicationpersistenceprofileDiameterAppPersistenceProfileToTerraform(struct?: DataAviApplicationpersistenceprofileDiameterAppPersistenceProfile): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAviApplicationpersistenceprofileDiameterAppPersistenceProfileToHclTerraform(struct?: DataAviApplicationpersistenceprofileDiameterAppPersistenceProfile): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAviApplicationpersistenceprofileDiameterAppPersistenceProfileOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAviApplicationpersistenceprofileDiameterAppPersistenceProfile | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAviApplicationpersistenceprofileDiameterAppPersistenceProfile | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  // avp_key_type - computed: true, optional: false, required: false
...
export class DataAviApplicationpersistenceprofileDiameterAppPersistenceProfileList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataAviApplicationpersistenceprofileDiameterAppPersistenceProfileOutputReference {
    return new DataAviApplicationpersistenceprofileDiameterAppPersistenceProfileOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/applicationpersistenceprofile avi_applicationpersistenceprofile}
*/
export class DataAviApplicationpersistenceprofile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAviApplicationpersistenceprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/applicationpersistenceprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/applicationpersistenceprofile avi_applicationpersistenceprofile} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // diameter_app_persistence_profile - computed: true, optional: false, required: false
  private _diameterAppPersistenceProfile = new DataAviApplicationpersistenceprofileDiameterAppPersistenceProfileList(this, "diameter_app_persistence_profile", true);
