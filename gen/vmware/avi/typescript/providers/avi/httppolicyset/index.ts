...
export interface HttppolicysetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#cloud_config_cksum Httppolicyset#cloud_config_cksum}
  */
  readonly cloudConfigCksum?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#created_by Httppolicyset#created_by}
  */
  readonly createdBy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#description Httppolicyset#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#geo_db_ref Httppolicyset#geo_db_ref}
  */
  readonly geoDbRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#id Httppolicyset#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#ip_reputation_db_ref Httppolicyset#ip_reputation_db_ref}
  */
  readonly ipReputationDbRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#is_internal_policy Httppolicyset#is_internal_policy}
  */
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#tenant_ref Httppolicyset#tenant_ref}
  */
  readonly tenantRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#uuid Httppolicyset#uuid}
  */
  readonly uuid?: string;
  /**
  * configpb_attributes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#configpb_attributes Httppolicyset#configpb_attributes}
  */
  readonly configpbAttributes?: HttppolicysetConfigpbAttributes[] | cdktf.IResolvable;
  /**
  * http_request_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#http_request_policy Httppolicyset#http_request_policy}
  */
  readonly httpRequestPolicy?: HttppolicysetHttpRequestPolicy[] | cdktf.IResolvable;
  /**
  * http_response_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#http_response_policy Httppolicyset#http_response_policy}
  */
  readonly httpResponsePolicy?: HttppolicysetHttpResponsePolicy[] | cdktf.IResolvable;
  /**
  * http_security_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#http_security_policy Httppolicyset#http_security_policy}
  */
  readonly httpSecurityPolicy?: HttppolicysetHttpSecurityPolicy[] | cdktf.IResolvable;
  /**
  * markers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#markers Httppolicyset#markers}
  */
  readonly markers?: HttppolicysetMarkers[] | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset avi_httppolicyset}
*/
export class Httppolicyset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Httppolicyset that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/httppolicyset avi_httppolicyset} Resource
  *
  * @param scope The scope in which to define this construct
