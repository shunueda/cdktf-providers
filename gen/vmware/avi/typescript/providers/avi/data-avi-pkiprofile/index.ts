// https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/pkiprofile
...
export interface DataAviPkiprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/pkiprofile#id DataAviPkiprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/pkiprofile#name DataAviPkiprofile#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/pkiprofile#tenant_ref DataAviPkiprofile#tenant_ref}
  */
  readonly tenantRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/pkiprofile#uuid DataAviPkiprofile#uuid}
  */
...
export interface DataAviPkiprofileCaCertsKeyParamsMldsaParams {
}

export function dataAviPkiprofileCaCertsKeyParamsMldsaParamsToTerraform(struct?: DataAviPkiprofileCaCertsKeyParamsMldsaParams): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAviPkiprofileCaCertsKeyParamsMldsaParamsToHclTerraform(struct?: DataAviPkiprofileCaCertsKeyParamsMldsaParams): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAviPkiprofileCaCertsKeyParamsMldsaParamsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAviPkiprofileCaCertsKeyParamsMldsaParams | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAviPkiprofileCaCertsKeyParamsMldsaParams | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAviPkiprofileCaCertsKeyParamsMldsaParamsList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataAviPkiprofileCaCertsKeyParamsMldsaParamsOutputReference {
    return new DataAviPkiprofileCaCertsKeyParamsMldsaParamsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAviPkiprofileCaCertsKeyParamsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _mldsaParams = new DataAviPkiprofileCaCertsKeyParamsMldsaParamsList(this, "mldsa_params", true);
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/pkiprofile avi_pkiprofile}
*/
export class DataAviPkiprofile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAviPkiprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/pkiprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/data-sources/pkiprofile avi_pkiprofile} Data Source
  *
  * @param scope The scope in which to define this construct
