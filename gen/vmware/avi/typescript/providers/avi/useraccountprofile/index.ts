// https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile
...
export interface UseraccountprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile#account_lock_timeout Useraccountprofile#account_lock_timeout}
  */
  readonly accountLockTimeout?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile#credentials_timeout_threshold Useraccountprofile#credentials_timeout_threshold}
  */
  readonly credentialsTimeoutThreshold?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile#id Useraccountprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile#login_failure_count_expiry_window Useraccountprofile#login_failure_count_expiry_window}
  */
  readonly loginFailureCountExpiryWindow?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile#max_concurrent_sessions Useraccountprofile#max_concurrent_sessions}
  */
  readonly maxConcurrentSessions?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile#max_login_failure_count Useraccountprofile#max_login_failure_count}
  */
  readonly maxLoginFailureCount?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile#max_password_history_count Useraccountprofile#max_password_history_count}
  */
  readonly maxPasswordHistoryCount?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile#name Useraccountprofile#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile#uuid Useraccountprofile#uuid}
  */
  readonly uuid?: string;
  /**
  * configpb_attributes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile#configpb_attributes Useraccountprofile#configpb_attributes}
  */
...
export interface UseraccountprofileConfigpbAttributes {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile#version Useraccountprofile#version}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile avi_useraccountprofile}
*/
export class Useraccountprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Useraccountprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/useraccountprofile avi_useraccountprofile} Resource
  *
  * @param scope The scope in which to define this construct
