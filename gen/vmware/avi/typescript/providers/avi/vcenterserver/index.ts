// https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver
...
export interface VcenterserverConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver#cloud_ref Vcenterserver#cloud_ref}
  */
  readonly cloudRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver#id Vcenterserver#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver#name Vcenterserver#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver#tenant_ref Vcenterserver#tenant_ref}
  */
  readonly tenantRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver#uuid Vcenterserver#uuid}
  */
  readonly uuid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver#vcenter_credentials_ref Vcenterserver#vcenter_credentials_ref}
  */
  readonly vcenterCredentialsRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver#vcenter_url Vcenterserver#vcenter_url}
  */
  readonly vcenterUrl?: string;
  /**
  * configpb_attributes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver#configpb_attributes Vcenterserver#configpb_attributes}
  */
  readonly configpbAttributes?: VcenterserverConfigpbAttributes[] | cdktf.IResolvable;
  /**
  * content_lib block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver#content_lib Vcenterserver#content_lib}
  */
  readonly contentLib?: VcenterserverContentLib[] | cdktf.IResolvable;
}
export interface VcenterserverConfigpbAttributes {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver#version Vcenterserver#version}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver avi_vcenterserver}
*/
export class Vcenterserver extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Vcenterserver that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/avi/30.2.5/docs/resources/vcenterserver avi_vcenterserver} Resource
  *
  * @param scope The scope in which to define this construct
