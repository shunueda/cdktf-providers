...
export interface ApplicationprofileConfigpbAttributes {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#version Applicationprofile#version}
  */
...
export interface ApplicationprofileDiameterServiceProfile {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#client_origin_host Applicationprofile#client_origin_host}
  */
  readonly clientOriginHost?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#client_origin_realm Applicationprofile#client_origin_realm}
  */
  readonly clientOriginRealm?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#host_ip_addr_rewrite Applicationprofile#host_ip_addr_rewrite}
  */
  readonly hostIpAddrRewrite?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#max_outstanding_req Applicationprofile#max_outstanding_req}
  */
  readonly maxOutstandingReq?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#req_timeout Applicationprofile#req_timeout}
  */
  readonly reqTimeout?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#server_origin_host Applicationprofile#server_origin_host}
  */
  readonly serverOriginHost?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#server_origin_realm Applicationprofile#server_origin_realm}
  */
  readonly serverOriginRealm?: string;
}

export function applicationprofileDiameterServiceProfileToTerraform(struct?: ApplicationprofileDiameterServiceProfile | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    client_origin_host: cdktf.stringToTerraform(struct!.clientOriginHost),
    client_origin_realm: cdktf.stringToTerraform(struct!.clientOriginRealm),
    host_ip_addr_rewrite: cdktf.stringToTerraform(struct!.hostIpAddrRewrite),
    max_outstanding_req: cdktf.stringToTerraform(struct!.maxOutstandingReq),
    req_timeout: cdktf.stringToTerraform(struct!.reqTimeout),
    server_origin_host: cdktf.stringToTerraform(struct!.serverOriginHost),
    server_origin_realm: cdktf.stringToTerraform(struct!.serverOriginRealm),
  }
}


export function applicationprofileDiameterServiceProfileToHclTerraform(struct?: ApplicationprofileDiameterServiceProfile | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    client_origin_host: {
      value: cdktf.stringToHclTerraform(struct!.clientOriginHost),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    client_origin_realm: {
      value: cdktf.stringToHclTerraform(struct!.clientOriginRealm),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    host_ip_addr_rewrite: {
      value: cdktf.stringToHclTerraform(struct!.hostIpAddrRewrite),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    max_outstanding_req: {
      value: cdktf.stringToHclTerraform(struct!.maxOutstandingReq),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    req_timeout: {
      value: cdktf.stringToHclTerraform(struct!.reqTimeout),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    server_origin_host: {
      value: cdktf.stringToHclTerraform(struct!.serverOriginHost),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    server_origin_realm: {
      value: cdktf.stringToHclTerraform(struct!.serverOriginRealm),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class ApplicationprofileDiameterServiceProfileOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ApplicationprofileDiameterServiceProfile | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._clientOriginHost !== undefined) {
      hasAnyValues = true;
      internalValueResult.clientOriginHost = this._clientOriginHost;
    }
    if (this._clientOriginRealm !== undefined) {
      hasAnyValues = true;
      internalValueResult.clientOriginRealm = this._clientOriginRealm;
    }
    if (this._hostIpAddrRewrite !== undefined) {
      hasAnyValues = true;
      internalValueResult.hostIpAddrRewrite = this._hostIpAddrRewrite;
    }
    if (this._maxOutstandingReq !== undefined) {
      hasAnyValues = true;
      internalValueResult.maxOutstandingReq = this._maxOutstandingReq;
    }
    if (this._reqTimeout !== undefined) {
      hasAnyValues = true;
      internalValueResult.reqTimeout = this._reqTimeout;
    }
    if (this._serverOriginHost !== undefined) {
      hasAnyValues = true;
      internalValueResult.serverOriginHost = this._serverOriginHost;
    }
    if (this._serverOriginRealm !== undefined) {
      hasAnyValues = true;
      internalValueResult.serverOriginRealm = this._serverOriginRealm;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ApplicationprofileDiameterServiceProfile | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._clientOriginHost = undefined;
      this._clientOriginRealm = undefined;
      this._hostIpAddrRewrite = undefined;
      this._maxOutstandingReq = undefined;
      this._reqTimeout = undefined;
      this._serverOriginHost = undefined;
      this._serverOriginRealm = undefined;
    }
    else if (cdktf.Tokenization.isResolvable(value)) {
      this.isEmptyObject = false;
      this.resolvableValue = value;
      ...
      this.isEmptyObject = Object.keys(value).length === 0;
      this.resolvableValue = undefined;
      this._clientOriginHost = value.clientOriginHost;
      this._clientOriginRealm = value.clientOriginRealm;
      this._hostIpAddrRewrite = value.hostIpAddrRewrite;
      this._maxOutstandingReq = value.maxOutstandingReq;
      this._reqTimeout = value.reqTimeout;
      this._serverOriginHost = value.serverOriginHost;
      this._serverOriginRealm = value.serverOriginRealm;
    }
  }

  // client_origin_host - computed: true, optional: true, required: false
  private _clientOriginHost?: string; 
  public get clientOriginHost() {
    return this.getStringAttribute('client_origin_host');
  }
  public set clientOriginHost(value: string) {
    this._clientOriginHost = value;
  }
  public resetClientOriginHost() {
    this._clientOriginHost = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get clientOriginHostInput() {
    return this._clientOriginHost;
  }

  // client_origin_realm - computed: true, optional: true, required: false
  private _clientOriginRealm?: string; 
  public get clientOriginRealm() {
    return this.getStringAttribute('client_origin_realm');
  }
  public set clientOriginRealm(value: string) {
    this._clientOriginRealm = value;
  }
  public resetClientOriginRealm() {
    this._clientOriginRealm = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get clientOriginRealmInput() {
    return this._clientOriginRealm;
  }

  // host_ip_addr_rewrite - computed: false, optional: true, required: false
  private _hostIpAddrRewrite?: string; 
  public get hostIpAddrRewrite() {
    return this.getStringAttribute('host_ip_addr_rewrite');
  }
  public set hostIpAddrRewrite(value: string) {
    this._hostIpAddrRewrite = value;
  }
  public resetHostIpAddrRewrite() {
    this._hostIpAddrRewrite = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get hostIpAddrRewriteInput() {
    return this._hostIpAddrRewrite;
  }

  // max_outstanding_req - computed: false, optional: true, required: false
  private _maxOutstandingReq?: string; 
  public get maxOutstandingReq() {
    return this.getStringAttribute('max_outstanding_req');
  }
  public set maxOutstandingReq(value: string) {
    this._maxOutstandingReq = value;
  }
  public resetMaxOutstandingReq() {
    this._maxOutstandingReq = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get maxOutstandingReqInput() {
    return this._maxOutstandingReq;
  }
  ...
  public set reqTimeout(value: string) {
  ...
  // server_origin_host - computed: true, optional: true, required: false
  private _serverOriginHost?: string; 
  public get serverOriginHost() {
    return this.getStringAttribute('server_origin_host');
  }
  public set serverOriginHost(value: string) {
    this._serverOriginHost = value;
  }
  public resetServerOriginHost() {
    this._serverOriginHost = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get serverOriginHostInput() {
    return this._serverOriginHost;
  }

  // server_origin_realm - computed: true, optional: true, required: false
  private _serverOriginRealm?: string; 
  public get serverOriginRealm() {
    return this.getStringAttribute('server_origin_realm');
  }
  public set serverOriginRealm(value: string) {
    this._serverOriginRealm = value;
  }
  public resetServerOriginRealm() {
    this._serverOriginRealm = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get serverOriginRealmInput() {
    return this._serverOriginRealm;
  }
}

export class ApplicationprofileDiameterServiceProfileList extends cdktf.ComplexList {
  public internalValue? : ApplicationprofileDiameterServiceProfile[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): ApplicationprofileDiameterServiceProfileOutputReference {
    return new ApplicationprofileDiameterServiceProfileOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface ApplicationprofileDnsServiceProfileDnsZones {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#admin_email Applicationprofile#admin_email}
  */
  readonly adminEmail?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#domain_name Applicationprofile#domain_name}
  */
  readonly domainName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#name_server Applicationprofile#name_server}
  */
...
export interface ApplicationprofileDnsServiceProfile {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#aaaa_empty_response Applicationprofile#aaaa_empty_response}
  */
  ...
  */
  readonly adminEmail?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#client_dns_tcp_request_timeout Applicationprofile#client_dns_tcp_request_timeout}
  */
  readonly clientDnsTcpRequestTimeout?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#close_tcp_connection_post_response Applicationprofile#close_tcp_connection_post_response}
  */
  readonly closeTcpConnectionPostResponse?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#dns_over_tcp_enabled Applicationprofile#dns_over_tcp_enabled}
  */
  readonly dnsOverTcpEnabled?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#domain_names Applicationprofile#domain_names}
  */
  readonly domainNames?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#ecs_stripping_enabled Applicationprofile#ecs_stripping_enabled}
  */
  readonly ecsStrippingEnabled?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#edns Applicationprofile#edns}
  */
  readonly edns?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#edns_client_subnet_prefix_len Applicationprofile#edns_client_subnet_prefix_len}
  */
  readonly ednsClientSubnetPrefixLen?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#error_response Applicationprofile#error_response}
  */
  ...
  */
  readonly nameServer?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#negative_caching_ttl Applicationprofile#negative_caching_ttl}
  */
  readonly negativeCachingTtl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#num_dns_ip Applicationprofile#num_dns_ip}
  */
  readonly numDnsIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#ttl Applicationprofile#ttl}
  */
  readonly ttl?: string;
  /**
  * dns_zones block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#dns_zones Applicationprofile#dns_zones}
  */
...
export interface ApplicationprofileDosRlProfileDosProfileThreshInfo {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#attack Applicationprofile#attack}
  */
  readonly attack: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#max_value Applicationprofile#max_value}
  */
  readonly maxValue: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#min_value Applicationprofile#min_value}
  */
...
export interface ApplicationprofileDosRlProfileDosProfile {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#thresh_period Applicationprofile#thresh_period}
  */
  readonly threshPeriod: string;
  /**
  * thresh_info block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#thresh_info Applicationprofile#thresh_info}
  */
...
export interface ApplicationprofileDosRlProfileRlProfileClientIpConnectionsRateLimitActionFile {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#content_type Applicationprofile#content_type}
  */
  readonly contentType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#file_content Applicationprofile#file_content}
  */
  readonly fileContent: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#file_length Applicationprofile#file_length}
  */
...
export interface ApplicationprofileDosRlProfileRlProfileClientIpConnectionsRateLimitActionRedirectHostTokens {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#end_index Applicationprofile#end_index}
  */
  readonly endIndex?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#start_index Applicationprofile#start_index}
  */
  readonly startIndex?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/applicationprofile#str_value Applicationprofile#str_value}
  */
