// https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig
...
export interface InventoryfaultconfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#id Inventoryfaultconfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#name Inventoryfaultconfig#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#tenant_ref Inventoryfaultconfig#tenant_ref}
  */
  readonly tenantRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#uuid Inventoryfaultconfig#uuid}
  */
  readonly uuid?: string;
  /**
  * configpb_attributes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#configpb_attributes Inventoryfaultconfig#configpb_attributes}
  */
  readonly configpbAttributes?: InventoryfaultconfigConfigpbAttributes[] | cdktf.IResolvable;
  /**
  * controller_faults block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#controller_faults Inventoryfaultconfig#controller_faults}
  */
  readonly controllerFaults?: InventoryfaultconfigControllerFaults[] | cdktf.IResolvable;
  /**
  * serviceengine_faults block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#serviceengine_faults Inventoryfaultconfig#serviceengine_faults}
  */
  readonly serviceengineFaults?: InventoryfaultconfigServiceengineFaults[] | cdktf.IResolvable;
  /**
  * virtualservice_faults block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#virtualservice_faults Inventoryfaultconfig#virtualservice_faults}
  */
...
export interface InventoryfaultconfigConfigpbAttributes {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#version Inventoryfaultconfig#version}
  */
...
export interface InventoryfaultconfigControllerFaults {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#backup_scheduler_faults Inventoryfaultconfig#backup_scheduler_faults}
  */
  readonly backupSchedulerFaults?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#cluster_faults Inventoryfaultconfig#cluster_faults}
  */
  readonly clusterFaults?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#deprecated_api_version_faults Inventoryfaultconfig#deprecated_api_version_faults}
  */
  readonly deprecatedApiVersionFaults?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#license_faults Inventoryfaultconfig#license_faults}
  */
  readonly licenseFaults?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#migration_faults Inventoryfaultconfig#migration_faults}
  */
  readonly migrationFaults?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#sslprofile_faults Inventoryfaultconfig#sslprofile_faults}
  */
  readonly sslprofileFaults?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#system_limits_faults Inventoryfaultconfig#system_limits_faults}
  */
  readonly systemLimitsFaults?: string;
}
...
export function inventoryfaultconfigControllerFaultsToTerraform(struct?: InventoryfaultconfigControllerFaults | cdktf.IResolvable): any {
  ...
  return {
    ...
    system_limits_faults: cdktf.stringToTerraform(struct!.systemLimitsFaults),
  }
}
...
export function inventoryfaultconfigControllerFaultsToHclTerraform(struct?: InventoryfaultconfigControllerFaults | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    system_limits_faults: {
      value: cdktf.stringToHclTerraform(struct!.systemLimitsFaults),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class InventoryfaultconfigControllerFaultsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): InventoryfaultconfigControllerFaults | cdktf.IResolvable | undefined {
    ...
    if (this._systemLimitsFaults !== undefined) {
      hasAnyValues = true;
      internalValueResult.systemLimitsFaults = this._systemLimitsFaults;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }
  ...
  public set internalValue(value: InventoryfaultconfigControllerFaults | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      ...
      this._systemLimitsFaults = undefined;
    }
    else if (cdktf.Tokenization.isResolvable(value)) {
      this.isEmptyObject = false;
      this.resolvableValue = value;
      ...
      this._systemLimitsFaults = value.systemLimitsFaults;
    }
  }
  ...
  // system_limits_faults - computed: false, optional: true, required: false
  private _systemLimitsFaults?: string; 
  public get systemLimitsFaults() {
    return this.getStringAttribute('system_limits_faults');
  }
  public set systemLimitsFaults(value: string) {
    this._systemLimitsFaults = value;
  }
  public resetSystemLimitsFaults() {
    this._systemLimitsFaults = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get systemLimitsFaultsInput() {
    return this._systemLimitsFaults;
  }
}
...
export interface InventoryfaultconfigServiceengineFaults {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#debug_faults Inventoryfaultconfig#debug_faults}
  */
...
export interface InventoryfaultconfigVirtualserviceFaults {
  ...
  */
  readonly debugFaults?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#pool_server_faults Inventoryfaultconfig#pool_server_faults}
  */
  readonly poolServerFaults?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#scaleout_faults Inventoryfaultconfig#scaleout_faults}
  */
  readonly scaleoutFaults?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#shared_vip_faults Inventoryfaultconfig#shared_vip_faults}
  */
  readonly sharedVipFaults?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#ssl_cert_expiry_faults Inventoryfaultconfig#ssl_cert_expiry_faults}
  */
  readonly sslCertExpiryFaults?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#ssl_cert_status_faults Inventoryfaultconfig#ssl_cert_status_faults}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig avi_inventoryfaultconfig}
*/
export class Inventoryfaultconfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Inventoryfaultconfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/avi/31.2.1/docs/resources/inventoryfaultconfig avi_inventoryfaultconfig} Resource
  *
  * @param scope The scope in which to define this construct
