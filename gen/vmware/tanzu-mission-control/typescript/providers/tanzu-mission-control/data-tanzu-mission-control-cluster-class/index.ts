// https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/cluster_class
...
export interface DataTanzuMissionControlClusterClassConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/cluster_class#id DataTanzuMissionControlClusterClass#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/cluster_class#management_cluster_name DataTanzuMissionControlClusterClass#management_cluster_name}
  */
  readonly managementClusterName: string;
  /**
  * Cluster class name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/cluster_class#name DataTanzuMissionControlClusterClass#name}
  */
  readonly name: string;
  /**
  * Cluster provisioner name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/cluster_class#provisioner_name DataTanzuMissionControlClusterClass#provisioner_name}
  */
  readonly provisionerName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/cluster_class tanzu-mission-control_cluster_class}
*/
export class DataTanzuMissionControlClusterClass extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTanzuMissionControlClusterClass that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/cluster_class#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/cluster_class tanzu-mission-control_cluster_class} Data Source
  *
  * @param scope The scope in which to define this construct
