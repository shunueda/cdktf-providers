// https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/inspections
...
export interface DataTanzuMissionControlInspectionsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cluster name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/inspections#cluster_name DataTanzuMissionControlInspections#cluster_name}
  */
  readonly clusterName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/inspections#id DataTanzuMissionControlInspections#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/inspections#management_cluster_name DataTanzuMissionControlInspections#management_cluster_name}
  */
  readonly managementClusterName: string;
  /**
  * Inspection name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/inspections#name DataTanzuMissionControlInspections#name}
  */
  readonly name?: string;
  /**
  * Cluster provisioner name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/inspections#provisioner_name DataTanzuMissionControlInspections#provisioner_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/inspections tanzu-mission-control_inspections}
*/
export class DataTanzuMissionControlInspections extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTanzuMissionControlInspections that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/inspections#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/tanzu-mission-control/1.4.10/docs/data-sources/inspections tanzu-mission-control_inspections} Data Source
  *
  * @param scope The scope in which to define this construct
