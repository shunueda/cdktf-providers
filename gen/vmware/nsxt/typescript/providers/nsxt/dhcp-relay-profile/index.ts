...
export interface DhcpRelayProfileConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function dhcpRelayProfileTagToTerraform(struct?: DhcpRelayProfileTag | cdktf.IResolvable): any {
...
export function dhcpRelayProfileTagToHclTerraform(struct?: DhcpRelayProfileTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DhcpRelayProfileTagOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DhcpRelayProfileTag | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DhcpRelayProfileTag | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DhcpRelayProfileTagList extends cdktf.ComplexList {
  public internalValue? : DhcpRelayProfileTag[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DhcpRelayProfileTagOutputReference {
    return new DhcpRelayProfileTagOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DhcpRelayProfile extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "nsxt_dhcp_relay_profile";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "nsxt_dhcp_relay_profile", importId: importFromId, provider });
      }
  ...
  * @param options DhcpRelayProfileConfig
  */
  public constructor(scope: Construct, id: string, config: DhcpRelayProfileConfig) {
    super(scope, id, {
  ...
  public get serverAddresses() {
    return cdktf.Fn.tolist(this.getListAttribute('server_addresses'));
  }
  ...
  // tag - computed: false, optional: true, required: false
  private _tag = new DhcpRelayProfileTagList(this, "tag", true);
  public get tag() {
    return this._tag;
  }
  public putTag(value: DhcpRelayProfileTag[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tag: cdktf.listMapper(dhcpRelayProfileTagToTerraform, true)(this._tag.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tag: {
        value: cdktf.listMapperHcl(dhcpRelayProfileTagToHclTerraform, true)(this._tag.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DhcpRelayProfileTagList",
      },
    };
