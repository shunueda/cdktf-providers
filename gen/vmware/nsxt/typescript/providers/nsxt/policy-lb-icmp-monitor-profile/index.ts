// https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile
...
export interface PolicyLbIcmpMonitorProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile#data_length PolicyLbIcmpMonitorProfile#data_length}
  */
  readonly dataLength?: number;
  /**
  * Description for this resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile#description PolicyLbIcmpMonitorProfile#description}
  */
  readonly description?: string;
  /**
  * Display name for this resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile#display_name PolicyLbIcmpMonitorProfile#display_name}
  */
  readonly displayName: string;
  /**
  * Number of consecutive checks that must fail before marking it down
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile#fall_count PolicyLbIcmpMonitorProfile#fall_count}
  */
  readonly fallCount?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile#id PolicyLbIcmpMonitorProfile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile#interval PolicyLbIcmpMonitorProfile#interval}
  */
  readonly interval?: number;
  /**
  * NSX ID for this resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile#nsx_id PolicyLbIcmpMonitorProfile#nsx_id}
  */
  readonly nsxId?: string;
  /**
  * Number of consecutive checks that must pass before marking it up
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile#rise_count PolicyLbIcmpMonitorProfile#rise_count}
  */
  readonly riseCount?: number;
  /**
  * Number of seconds the target has to respond to the monitor request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile#timeout PolicyLbIcmpMonitorProfile#timeout}
  */
  readonly timeout?: number;
  /**
  * tag block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile#tag PolicyLbIcmpMonitorProfile#tag}
  */
  readonly tag?: PolicyLbIcmpMonitorProfileTag[] | cdktf.IResolvable;
}
export interface PolicyLbIcmpMonitorProfileTag {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile#scope PolicyLbIcmpMonitorProfile#scope}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile nsxt_policy_lb_icmp_monitor_profile}
*/
export class PolicyLbIcmpMonitorProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyLbIcmpMonitorProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/policy_lb_icmp_monitor_profile nsxt_policy_lb_icmp_monitor_profile} Resource
  *
  * @param scope The scope in which to define this construct
