...
export interface PolicyComputeSubClusterConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function policyComputeSubClusterTagToTerraform(struct?: PolicyComputeSubClusterTag | cdktf.IResolvable): any {
...
export function policyComputeSubClusterTagToHclTerraform(struct?: PolicyComputeSubClusterTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PolicyComputeSubClusterTagOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PolicyComputeSubClusterTag | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: PolicyComputeSubClusterTag | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class PolicyComputeSubClusterTagList extends cdktf.ComplexList {
  public internalValue? : PolicyComputeSubClusterTag[] | cdktf.IResolvable
  ...
  */
  public get(index: number): PolicyComputeSubClusterTagOutputReference {
    return new PolicyComputeSubClusterTagOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class PolicyComputeSubCluster extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "nsxt_policy_compute_sub_cluster";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "nsxt_policy_compute_sub_cluster", importId: importFromId, provider });
      }
  ...
  * @param options PolicyComputeSubClusterConfig
  */
  public constructor(scope: Construct, id: string, config: PolicyComputeSubClusterConfig) {
    super(scope, id, {
    ...
    this._discoveredNodeIds = config.discoveredNodeIds;
  ...
  // discovered_node_ids - computed: true, optional: true, required: false
  private _discoveredNodeIds?: string[]; 
  public get discoveredNodeIds() {
    return this.getListAttribute('discovered_node_ids');
  }
  public set discoveredNodeIds(value: string[]) {
    this._discoveredNodeIds = value;
  }
  public resetDiscoveredNodeIds() {
    this._discoveredNodeIds = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get discoveredNodeIdsInput() {
    return this._discoveredNodeIds;
  }
  ...
  // tag - computed: false, optional: true, required: false
  private _tag = new PolicyComputeSubClusterTagList(this, "tag", true);
  public get tag() {
    return this._tag;
  }
  public putTag(value: PolicyComputeSubClusterTag[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      discovered_node_ids: cdktf.listMapper(cdktf.stringToTerraform, false)(this._discoveredNodeIds),
      ...
      tag: cdktf.listMapper(policyComputeSubClusterTagToTerraform, true)(this._tag.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      discovered_node_ids: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._discoveredNodeIds),
        isBlock: false,
        type: "list",
      ...
      tag: {
        value: cdktf.listMapperHcl(policyComputeSubClusterTagToHclTerraform, true)(this._tag.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "PolicyComputeSubClusterTagList",
      },
    };
