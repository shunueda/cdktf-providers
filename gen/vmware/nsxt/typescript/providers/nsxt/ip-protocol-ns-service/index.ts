...
export interface IpProtocolNsServiceConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function ipProtocolNsServiceTagToTerraform(struct?: IpProtocolNsServiceTag | cdktf.IResolvable): any {
...
export function ipProtocolNsServiceTagToHclTerraform(struct?: IpProtocolNsServiceTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IpProtocolNsServiceTagOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IpProtocolNsServiceTag | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: IpProtocolNsServiceTag | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class IpProtocolNsServiceTagList extends cdktf.ComplexList {
  public internalValue? : IpProtocolNsServiceTag[] | cdktf.IResolvable
  ...
  */
  public get(index: number): IpProtocolNsServiceTagOutputReference {
    return new IpProtocolNsServiceTagOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class IpProtocolNsService extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "nsxt_ip_protocol_ns_service";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "nsxt_ip_protocol_ns_service", importId: importFromId, provider });
      }
  ...
  * @param options IpProtocolNsServiceConfig
  */
  public constructor(scope: Construct, id: string, config: IpProtocolNsServiceConfig) {
    super(scope, id, {
  ...
  // tag - computed: false, optional: true, required: false
  private _tag = new IpProtocolNsServiceTagList(this, "tag", true);
  public get tag() {
    return this._tag;
  }
  public putTag(value: IpProtocolNsServiceTag[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tag: cdktf.listMapper(ipProtocolNsServiceTagToTerraform, true)(this._tag.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tag: {
        value: cdktf.listMapperHcl(ipProtocolNsServiceTagToHclTerraform, true)(this._tag.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "IpProtocolNsServiceTagList",
      },
    };
