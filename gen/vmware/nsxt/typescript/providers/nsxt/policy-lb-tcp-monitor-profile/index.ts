...
export interface PolicyLbTcpMonitorProfileConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function policyLbTcpMonitorProfileTagToTerraform(struct?: PolicyLbTcpMonitorProfileTag | cdktf.IResolvable): any {
...
export function policyLbTcpMonitorProfileTagToHclTerraform(struct?: PolicyLbTcpMonitorProfileTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PolicyLbTcpMonitorProfileTagOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PolicyLbTcpMonitorProfileTag | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: PolicyLbTcpMonitorProfileTag | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class PolicyLbTcpMonitorProfileTagList extends cdktf.ComplexList {
  public internalValue? : PolicyLbTcpMonitorProfileTag[] | cdktf.IResolvable
  ...
  */
  public get(index: number): PolicyLbTcpMonitorProfileTagOutputReference {
    return new PolicyLbTcpMonitorProfileTagOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class PolicyLbTcpMonitorProfile extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "nsxt_policy_lb_tcp_monitor_profile";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "nsxt_policy_lb_tcp_monitor_profile", importId: importFromId, provider });
      }
  ...
  * @param options PolicyLbTcpMonitorProfileConfig
  */
  public constructor(scope: Construct, id: string, config: PolicyLbTcpMonitorProfileConfig) {
    super(scope, id, {
  ...
  // tag - computed: false, optional: true, required: false
  private _tag = new PolicyLbTcpMonitorProfileTagList(this, "tag", true);
  public get tag() {
    return this._tag;
  }
  public putTag(value: PolicyLbTcpMonitorProfileTag[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tag: cdktf.listMapper(policyLbTcpMonitorProfileTagToTerraform, true)(this._tag.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tag: {
        value: cdktf.listMapperHcl(policyLbTcpMonitorProfileTagToHclTerraform, true)(this._tag.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "PolicyLbTcpMonitorProfileTagList",
      },
    };
