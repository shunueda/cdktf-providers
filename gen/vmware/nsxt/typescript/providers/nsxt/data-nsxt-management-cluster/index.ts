// https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/management_cluster
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/management_cluster nsxt_management_cluster}
*/
export class DataNsxtManagementCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNsxtManagementCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/management_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/management_cluster nsxt_management_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
