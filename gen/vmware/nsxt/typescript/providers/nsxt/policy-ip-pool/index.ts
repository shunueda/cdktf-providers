...
export interface PolicyIpPoolConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function policyIpPoolContextToTerraform(struct?: PolicyIpPoolContextOutputReference | PolicyIpPoolContext): any {
...
export function policyIpPoolContextToHclTerraform(struct?: PolicyIpPoolContextOutputReference | PolicyIpPoolContext): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PolicyIpPoolContextOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PolicyIpPoolContext | undefined {
  ...
  public set internalValue(value: PolicyIpPoolContext | undefined) {
    if (value === undefined) {
...
export function policyIpPoolTagToTerraform(struct?: PolicyIpPoolTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function policyIpPoolTagToHclTerraform(struct?: PolicyIpPoolTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PolicyIpPoolTagOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): PolicyIpPoolTag | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: PolicyIpPoolTag | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class PolicyIpPoolTagList extends cdktf.ComplexList {
  public internalValue? : PolicyIpPoolTag[] | cdktf.IResolvable
  ...
  */
  public get(index: number): PolicyIpPoolTagOutputReference {
    return new PolicyIpPoolTagOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class PolicyIpPool extends cdktf.TerraformResource {
  ...
  * @param options PolicyIpPoolConfig
  */
  public constructor(scope: Construct, id: string, config: PolicyIpPoolConfig) {
    super(scope, id, {
  ...
  private _context = new PolicyIpPoolContextOutputReference(this, "context");
  public get context() {
    return this._context;
  }
  public putContext(value: PolicyIpPoolContext) {
  ...
  // tag - computed: false, optional: true, required: false
  private _tag = new PolicyIpPoolTagList(this, "tag", true);
  public get tag() {
    return this._tag;
  }
  public putTag(value: PolicyIpPoolTag[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      context: policyIpPoolContextToTerraform(this._context.internalValue),
      tag: cdktf.listMapper(policyIpPoolTagToTerraform, true)(this._tag.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      context: {
        value: policyIpPoolContextToHclTerraform(this._context.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "PolicyIpPoolContextList",
      },
      tag: {
        value: cdktf.listMapperHcl(policyIpPoolTagToHclTerraform, true)(this._tag.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "PolicyIpPoolTagList",
      },
    };
