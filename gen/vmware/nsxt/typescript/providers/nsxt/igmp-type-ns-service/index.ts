...
export interface IgmpTypeNsServiceConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function igmpTypeNsServiceTagToTerraform(struct?: IgmpTypeNsServiceTag | cdktf.IResolvable): any {
...
export function igmpTypeNsServiceTagToHclTerraform(struct?: IgmpTypeNsServiceTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IgmpTypeNsServiceTagOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IgmpTypeNsServiceTag | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: IgmpTypeNsServiceTag | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class IgmpTypeNsServiceTagList extends cdktf.ComplexList {
  public internalValue? : IgmpTypeNsServiceTag[] | cdktf.IResolvable
  ...
  */
  public get(index: number): IgmpTypeNsServiceTagOutputReference {
    return new IgmpTypeNsServiceTagOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class IgmpTypeNsService extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "nsxt_igmp_type_ns_service";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "nsxt_igmp_type_ns_service", importId: importFromId, provider });
      }
  ...
  * @param options IgmpTypeNsServiceConfig = {}
  */
  public constructor(scope: Construct, id: string, config: IgmpTypeNsServiceConfig = {}) {
    super(scope, id, {
  ...
  // tag - computed: false, optional: true, required: false
  private _tag = new IgmpTypeNsServiceTagList(this, "tag", true);
  public get tag() {
    return this._tag;
  }
  public putTag(value: IgmpTypeNsServiceTag[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tag: cdktf.listMapper(igmpTypeNsServiceTagToTerraform, true)(this._tag.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tag: {
        value: cdktf.listMapperHcl(igmpTypeNsServiceTagToHclTerraform, true)(this._tag.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "IgmpTypeNsServiceTagList",
      },
    };
