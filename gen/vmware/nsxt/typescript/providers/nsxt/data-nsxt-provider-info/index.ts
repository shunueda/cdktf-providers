// https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/data-sources/provider_info
...
export interface DataNsxtProviderInfoConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/data-sources/provider_info#id DataNsxtProviderInfo#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/data-sources/provider_info nsxt_provider_info}
*/
export class DataNsxtProviderInfo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNsxtProviderInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/data-sources/provider_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/data-sources/provider_info nsxt_provider_info} Data Source
  *
  * @param scope The scope in which to define this construct
