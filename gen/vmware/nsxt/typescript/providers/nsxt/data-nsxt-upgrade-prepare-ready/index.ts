// https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/data-sources/upgrade_prepare_ready
...
export interface DataNsxtUpgradePrepareReadyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/data-sources/upgrade_prepare_ready#id DataNsxtUpgradePrepareReady#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/data-sources/upgrade_prepare_ready#upgrade_prepare_id DataNsxtUpgradePrepareReady#upgrade_prepare_id}
  */
  readonly upgradePrepareId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/data-sources/upgrade_prepare_ready nsxt_upgrade_prepare_ready}
*/
export class DataNsxtUpgradePrepareReady extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNsxtUpgradePrepareReady that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/data-sources/upgrade_prepare_ready#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/data-sources/upgrade_prepare_ready nsxt_upgrade_prepare_ready} Data Source
  *
  * @param scope The scope in which to define this construct
