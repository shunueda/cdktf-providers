...
export interface DataNsxtPolicyLbPersistenceProfileConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DataNsxtPolicyLbPersistenceProfile extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "nsxt_policy_lb_persistence_profile";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "nsxt_policy_lb_persistence_profile", importId: importFromId, provider });
      }
  ...
  * @param options DataNsxtPolicyLbPersistenceProfileConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataNsxtPolicyLbPersistenceProfileConfig = {}) {
    super(scope, id, {
