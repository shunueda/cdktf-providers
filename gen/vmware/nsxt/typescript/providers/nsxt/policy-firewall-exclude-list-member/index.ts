// https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_firewall_exclude_list_member
...
export interface PolicyFirewallExcludeListMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_firewall_exclude_list_member#id PolicyFirewallExcludeListMember#id}
  *
  ...
  * ExcludeList member
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_firewall_exclude_list_member#member PolicyFirewallExcludeListMember#member}
  */
  readonly member: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_firewall_exclude_list_member nsxt_policy_firewall_exclude_list_member}
*/
export class PolicyFirewallExcludeListMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyFirewallExcludeListMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_firewall_exclude_list_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_firewall_exclude_list_member nsxt_policy_firewall_exclude_list_member} Resource
  *
  * @param scope The scope in which to define this construct
