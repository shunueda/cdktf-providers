...
export interface DataNsxtPolicyIntrusionServiceProfileConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataNsxtPolicyIntrusionServiceProfileContext {
  /**
...
export function dataNsxtPolicyIntrusionServiceProfileContextToTerraform(struct?: DataNsxtPolicyIntrusionServiceProfileContextOutputReference | DataNsxtPolicyIntrusionServiceProfileContext): any {
...
export function dataNsxtPolicyIntrusionServiceProfileContextToHclTerraform(struct?: DataNsxtPolicyIntrusionServiceProfileContextOutputReference | DataNsxtPolicyIntrusionServiceProfileContext): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataNsxtPolicyIntrusionServiceProfileContextOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataNsxtPolicyIntrusionServiceProfileContext | undefined {
  ...
  public set internalValue(value: DataNsxtPolicyIntrusionServiceProfileContext | undefined) {
    if (value === undefined) {
...
export class DataNsxtPolicyIntrusionServiceProfile extends cdktf.TerraformDataSource {
  ...
  * @param options DataNsxtPolicyIntrusionServiceProfileConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataNsxtPolicyIntrusionServiceProfileConfig = {}) {
    super(scope, id, {
  ...
  private _context = new DataNsxtPolicyIntrusionServiceProfileContextOutputReference(this, "context");
  public get context() {
    return this._context;
  }
  public putContext(value: DataNsxtPolicyIntrusionServiceProfileContext) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      context: dataNsxtPolicyIntrusionServiceProfileContextToTerraform(this._context.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      context: {
        value: dataNsxtPolicyIntrusionServiceProfileContextToHclTerraform(this._context.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataNsxtPolicyIntrusionServiceProfileContextList",
      },
    };
