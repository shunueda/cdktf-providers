// https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/vm_tags
...
export interface VmTagsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/vm_tags#id VmTags#id}
  *
  ...
  * Instance id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/vm_tags#instance_id VmTags#instance_id}
  */
  readonly instanceId: string;
  /**
  * logical_port_tag block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/vm_tags#logical_port_tag VmTags#logical_port_tag}
  */
  readonly logicalPortTag?: VmTagsLogicalPortTag[] | cdktf.IResolvable;
  /**
  * tag block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/vm_tags#tag VmTags#tag}
  */
  readonly tag?: VmTagsTag[] | cdktf.IResolvable;
}
export interface VmTagsLogicalPortTag {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/vm_tags#scope VmTags#scope}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/vm_tags nsxt_vm_tags}
*/
export class VmTags extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VmTags that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/vm_tags#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/nsxt/3.11.0/docs/resources/vm_tags nsxt_vm_tags} Resource
  *
  * @param scope The scope in which to define this construct
