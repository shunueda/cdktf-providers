// https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/ns_services
...
export interface DataNsxtNsServicesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/ns_services#id DataNsxtNsServices#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/ns_services nsxt_ns_services}
*/
export class DataNsxtNsServices extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNsxtNsServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/ns_services#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/ns_services nsxt_ns_services} Data Source
  *
  * @param scope The scope in which to define this construct
