...
export interface DataNsxtVpcConnectivityProfileConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataNsxtVpcConnectivityProfileContext {
  /**
...
export function dataNsxtVpcConnectivityProfileContextToTerraform(struct?: DataNsxtVpcConnectivityProfileContextOutputReference | DataNsxtVpcConnectivityProfileContext): any {
...
export function dataNsxtVpcConnectivityProfileContextToHclTerraform(struct?: DataNsxtVpcConnectivityProfileContextOutputReference | DataNsxtVpcConnectivityProfileContext): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataNsxtVpcConnectivityProfileContextOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataNsxtVpcConnectivityProfileContext | undefined {
  ...
  public set internalValue(value: DataNsxtVpcConnectivityProfileContext | undefined) {
    if (value === undefined) {
...
export class DataNsxtVpcConnectivityProfile extends cdktf.TerraformDataSource {
  ...
  * @param options DataNsxtVpcConnectivityProfileConfig
  */
  public constructor(scope: Construct, id: string, config: DataNsxtVpcConnectivityProfileConfig) {
    super(scope, id, {
  ...
  private _context = new DataNsxtVpcConnectivityProfileContextOutputReference(this, "context");
  public get context() {
    return this._context;
  }
  public putContext(value: DataNsxtVpcConnectivityProfileContext) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      context: dataNsxtVpcConnectivityProfileContextToTerraform(this._context.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      context: {
        value: dataNsxtVpcConnectivityProfileContextToHclTerraform(this._context.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataNsxtVpcConnectivityProfileContextList",
      },
    };
