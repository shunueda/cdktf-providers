// https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_context_profile_custom_attribute
...
export interface PolicyContextProfileCustomAttributeConfig extends cdktf.TerraformMetaArguments {
  ...
  * Custom Attribute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_context_profile_custom_attribute#attribute PolicyContextProfileCustomAttribute#attribute}
  */
  readonly attribute: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_context_profile_custom_attribute#id PolicyContextProfileCustomAttribute#id}
  *
  ...
  * Key for attribute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_context_profile_custom_attribute#key PolicyContextProfileCustomAttribute#key}
  */
  readonly key: string;
  /**
  * context block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_context_profile_custom_attribute#context PolicyContextProfileCustomAttribute#context}
  */
...
export interface PolicyContextProfileCustomAttributeContext {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_context_profile_custom_attribute#project_id PolicyContextProfileCustomAttribute#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_context_profile_custom_attribute nsxt_policy_context_profile_custom_attribute}
*/
export class PolicyContextProfileCustomAttribute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyContextProfileCustomAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_context_profile_custom_attribute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/resources/policy_context_profile_custom_attribute nsxt_policy_context_profile_custom_attribute} Resource
  *
  * @param scope The scope in which to define this construct
