...
export interface LbClientSslProfileConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function lbClientSslProfileTagToTerraform(struct?: LbClientSslProfileTag | cdktf.IResolvable): any {
...
export function lbClientSslProfileTagToHclTerraform(struct?: LbClientSslProfileTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class LbClientSslProfileTagOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): LbClientSslProfileTag | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: LbClientSslProfileTag | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class LbClientSslProfileTagList extends cdktf.ComplexList {
  public internalValue? : LbClientSslProfileTag[] | cdktf.IResolvable
  ...
  */
  public get(index: number): LbClientSslProfileTagOutputReference {
    return new LbClientSslProfileTagOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class LbClientSslProfile extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "nsxt_lb_client_ssl_profile";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "nsxt_lb_client_ssl_profile", importId: importFromId, provider });
      }
  ...
  * @param options LbClientSslProfileConfig = {}
  */
  public constructor(scope: Construct, id: string, config: LbClientSslProfileConfig = {}) {
    super(scope, id, {
  ...
  // tag - computed: false, optional: true, required: false
  private _tag = new LbClientSslProfileTagList(this, "tag", true);
  public get tag() {
    return this._tag;
  }
  public putTag(value: LbClientSslProfileTag[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tag: cdktf.listMapper(lbClientSslProfileTagToTerraform, true)(this._tag.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tag: {
        value: cdktf.listMapperHcl(lbClientSslProfileTagToHclTerraform, true)(this._tag.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "LbClientSslProfileTagList",
      },
    };
