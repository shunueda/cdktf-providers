...
export interface PolicyLbFastUdpApplicationProfileConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function policyLbFastUdpApplicationProfileTagToTerraform(struct?: PolicyLbFastUdpApplicationProfileTag | cdktf.IResolvable): any {
...
export function policyLbFastUdpApplicationProfileTagToHclTerraform(struct?: PolicyLbFastUdpApplicationProfileTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PolicyLbFastUdpApplicationProfileTagOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PolicyLbFastUdpApplicationProfileTag | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: PolicyLbFastUdpApplicationProfileTag | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class PolicyLbFastUdpApplicationProfileTagList extends cdktf.ComplexList {
  public internalValue? : PolicyLbFastUdpApplicationProfileTag[] | cdktf.IResolvable
  ...
  */
  public get(index: number): PolicyLbFastUdpApplicationProfileTagOutputReference {
    return new PolicyLbFastUdpApplicationProfileTagOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class PolicyLbFastUdpApplicationProfile extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "nsxt_policy_lb_fast_udp_application_profile";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "nsxt_policy_lb_fast_udp_application_profile", importId: importFromId, provider });
      }
  ...
  * @param options PolicyLbFastUdpApplicationProfileConfig
  */
  public constructor(scope: Construct, id: string, config: PolicyLbFastUdpApplicationProfileConfig) {
    super(scope, id, {
    ...
    this._flowMirroringEnabled = config.flowMirroringEnabled;
    this._id = config.id;
  ...
  // flow_mirroring_enabled - computed: false, optional: true, required: false
  private _flowMirroringEnabled?: boolean | cdktf.IResolvable; 
  public get flowMirroringEnabled() {
    return this.getBooleanAttribute('flow_mirroring_enabled');
  }
  public set flowMirroringEnabled(value: boolean | cdktf.IResolvable) {
    this._flowMirroringEnabled = value;
  }
  public resetFlowMirroringEnabled() {
    this._flowMirroringEnabled = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get flowMirroringEnabledInput() {
    return this._flowMirroringEnabled;
  }
  ...
  // tag - computed: false, optional: true, required: false
  private _tag = new PolicyLbFastUdpApplicationProfileTagList(this, "tag", true);
  public get tag() {
    return this._tag;
  }
  public putTag(value: PolicyLbFastUdpApplicationProfileTag[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      flow_mirroring_enabled: cdktf.booleanToTerraform(this._flowMirroringEnabled),
      id: cdktf.stringToTerraform(this._id),
      idle_timeout: cdktf.numberToTerraform(this._idleTimeout),
      nsx_id: cdktf.stringToTerraform(this._nsxId),
      tag: cdktf.listMapper(policyLbFastUdpApplicationProfileTagToTerraform, true)(this._tag.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      flow_mirroring_enabled: {
        value: cdktf.booleanToHclTerraform(this._flowMirroringEnabled),
        isBlock: false,
        type: "simple",
      ...
      tag: {
        value: cdktf.listMapperHcl(policyLbFastUdpApplicationProfileTagToHclTerraform, true)(this._tag.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "PolicyLbFastUdpApplicationProfileTagList",
      },
    };
