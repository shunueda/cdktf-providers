// https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/discovered_node
...
export interface DataNsxtDiscoveredNodeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/discovered_node#compute_manager_state DataNsxtDiscoveredNode#compute_manager_state}
  */
  readonly computeManagerState?: string;
  /**
  * External id of the discovered node, ex. a mo-ref from VC
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/discovered_node#id DataNsxtDiscoveredNode#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/discovered_node#ip_address DataNsxtDiscoveredNode#ip_address}
  */
  readonly ipAddress?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/discovered_node nsxt_discovered_node}
*/
export class DataNsxtDiscoveredNode extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNsxtDiscoveredNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/discovered_node#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/nsxt/3.10.0/docs/data-sources/discovered_node nsxt_discovered_node} Data Source
  *
  * @param scope The scope in which to define this construct
