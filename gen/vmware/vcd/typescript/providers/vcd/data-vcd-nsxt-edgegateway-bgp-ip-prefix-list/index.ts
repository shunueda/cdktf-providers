// https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/data-sources/nsxt_edgegateway_bgp_ip_prefix_list
...
export interface DataVcdNsxtEdgegatewayBgpIpPrefixListConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefix {
}

export function dataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefixToTerraform(struct?: DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefix): any {
...
export function dataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefixToHclTerraform(struct?: DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefix): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefixOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefix | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefix | undefined) {
    if (value === undefined) {
  ...
  // greater_than_or_equal_to - computed: true, optional: false, required: false
  public get greaterThanOrEqualTo() {
    return this.getNumberAttribute('greater_than_or_equal_to');
  }

  // less_than_or_equal_to - computed: true, optional: false, required: false
...
export class DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefixList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefixOutputReference {
    return new DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefixOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class DataVcdNsxtEdgegatewayBgpIpPrefixList extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataVcdNsxtEdgegatewayBgpIpPrefixList resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataVcdNsxtEdgegatewayBgpIpPrefixList to import
  * @param importFromId The id of the existing DataVcdNsxtEdgegatewayBgpIpPrefixList that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/data-sources/nsxt_edgegateway_bgp_ip_prefix_list#import import section} in the documentation of this resource for the id to use
  ...
  * @param options DataVcdNsxtEdgegatewayBgpIpPrefixListConfig
  */
  public constructor(scope: Construct, id: string, config: DataVcdNsxtEdgegatewayBgpIpPrefixListConfig) {
    super(scope, id, {
  ...
  private _ipPrefix = new DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefixList(this, "ip_prefix", true);
  public get ipPrefix() {
