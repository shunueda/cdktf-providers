// https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/resources/independent_disk
...
export interface IndependentDiskConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly metadataEntry?: IndependentDiskMetadataEntry[] | cdktf.IResolvable;
}
...
export function independentDiskMetadataEntryToTerraform(struct?: IndependentDiskMetadataEntry | cdktf.IResolvable): any {
...
export function independentDiskMetadataEntryToHclTerraform(struct?: IndependentDiskMetadataEntry | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IndependentDiskMetadataEntryOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IndependentDiskMetadataEntry | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: IndependentDiskMetadataEntry | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class IndependentDiskMetadataEntryList extends cdktf.ComplexList {
  public internalValue? : IndependentDiskMetadataEntry[] | cdktf.IResolvable
  ...
  */
  public get(index: number): IndependentDiskMetadataEntryOutputReference {
    return new IndependentDiskMetadataEntryOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class IndependentDisk extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "vcd_independent_disk";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a IndependentDisk resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the IndependentDisk to import
  * @param importFromId The id of the existing IndependentDisk that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/resources/independent_disk#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IndependentDisk to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "vcd_independent_disk", importId: importFromId, provider });
      }
  ...
  * @param options IndependentDiskConfig
  */
  public constructor(scope: Construct, id: string, config: IndependentDiskConfig) {
    super(scope, id, {
    ...
    this._busSubType = config.busSubType;
  ...
  // attached_vm_ids - computed: true, optional: false, required: false
  public get attachedVmIds() {
    return cdktf.Fn.tolist(this.getListAttribute('attached_vm_ids'));
  }

  // bus_sub_type - computed: true, optional: true, required: false
  private _busSubType?: string; 
  public get busSubType() {
    return this.getStringAttribute('bus_sub_type');
  }
  public set busSubType(value: string) {
    this._busSubType = value;
  }
  public resetBusSubType() {
    this._busSubType = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get busSubTypeInput() {
    return this._busSubType;
  }
  ...
  private _metadataEntry = new IndependentDiskMetadataEntryList(this, "metadata_entry", true);
  public get metadataEntry() {
    return this._metadataEntry;
  }
  public putMetadataEntry(value: IndependentDiskMetadataEntry[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      bus_sub_type: cdktf.stringToTerraform(this._busSubType),
      ...
      metadata_entry: cdktf.listMapper(independentDiskMetadataEntryToTerraform, true)(this._metadataEntry.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      bus_sub_type: {
        value: cdktf.stringToHclTerraform(this._busSubType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      metadata_entry: {
        value: cdktf.listMapperHcl(independentDiskMetadataEntryToHclTerraform, true)(this._metadataEntry.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "IndependentDiskMetadataEntryList",
      },
    };
