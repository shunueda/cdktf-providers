// https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/resources/catalog_item
...
export interface CatalogItemConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly metadataEntry?: CatalogItemMetadataEntry[] | cdktf.IResolvable;
}
...
export function catalogItemMetadataEntryToTerraform(struct?: CatalogItemMetadataEntry | cdktf.IResolvable): any {
...
export function catalogItemMetadataEntryToHclTerraform(struct?: CatalogItemMetadataEntry | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CatalogItemMetadataEntryOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CatalogItemMetadataEntry | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: CatalogItemMetadataEntry | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class CatalogItemMetadataEntryList extends cdktf.ComplexList {
  public internalValue? : CatalogItemMetadataEntry[] | cdktf.IResolvable
  ...
  */
  public get(index: number): CatalogItemMetadataEntryOutputReference {
    return new CatalogItemMetadataEntryOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class CatalogItem extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a CatalogItem resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the CatalogItem to import
  * @param importFromId The id of the existing CatalogItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/resources/catalog_item#import import section} in the documentation of this resource for the id to use
  ...
  * @param options CatalogItemConfig
  */
  public constructor(scope: Construct, id: string, config: CatalogItemConfig) {
    super(scope, id, {
    ...
    this._catalogItemMetadata = config.catalogItemMetadata;
  ...
  // catalog_item_metadata - computed: true, optional: true, required: false
  private _catalogItemMetadata?: { [key: string]: string }; 
  public get catalogItemMetadata() {
    return this.getStringMapAttribute('catalog_item_metadata');
  }
  public set catalogItemMetadata(value: { [key: string]: string }) {
    this._catalogItemMetadata = value;
  }
  public resetCatalogItemMetadata() {
    this._catalogItemMetadata = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get catalogItemMetadataInput() {
  ...
  private _metadataEntry = new CatalogItemMetadataEntryList(this, "metadata_entry", true);
  public get metadataEntry() {
    return this._metadataEntry;
  }
  public putMetadataEntry(value: CatalogItemMetadataEntry[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      catalog_item_metadata: cdktf.hashMapper(cdktf.stringToTerraform)(this._catalogItemMetadata),
      ...
      metadata_entry: cdktf.listMapper(catalogItemMetadataEntryToTerraform, true)(this._metadataEntry.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      catalog_item_metadata: {
        value: cdktf.hashMapperHcl(cdktf.stringToHclTerraform)(this._catalogItemMetadata),
        isBlock: false,
        type: "map",
      ...
      metadata_entry: {
        value: cdktf.listMapperHcl(catalogItemMetadataEntryToHclTerraform, true)(this._metadataEntry.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "CatalogItemMetadataEntryList",
      },
    };
