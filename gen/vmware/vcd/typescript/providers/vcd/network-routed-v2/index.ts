// https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/resources/network_routed_v2
...
export interface NetworkRoutedV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Network description
  *
  ...
  */
  readonly metadataEntry?: NetworkRoutedV2MetadataEntry[] | cdktf.IResolvable;
  /**
  ...
  */
  readonly secondaryStaticIpPool?: NetworkRoutedV2SecondaryStaticIpPool[] | cdktf.IResolvable;
  /**
  ...
  */
  readonly staticIpPool?: NetworkRoutedV2StaticIpPool[] | cdktf.IResolvable;
}
...
export function networkRoutedV2MetadataEntryToTerraform(struct?: NetworkRoutedV2MetadataEntry | cdktf.IResolvable): any {
...
export function networkRoutedV2MetadataEntryToHclTerraform(struct?: NetworkRoutedV2MetadataEntry | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class NetworkRoutedV2MetadataEntryOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetworkRoutedV2MetadataEntry | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: NetworkRoutedV2MetadataEntry | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class NetworkRoutedV2MetadataEntryList extends cdktf.ComplexList {
  public internalValue? : NetworkRoutedV2MetadataEntry[] | cdktf.IResolvable
  ...
  */
  public get(index: number): NetworkRoutedV2MetadataEntryOutputReference {
    return new NetworkRoutedV2MetadataEntryOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function networkRoutedV2SecondaryStaticIpPoolToTerraform(struct?: NetworkRoutedV2SecondaryStaticIpPool | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function networkRoutedV2SecondaryStaticIpPoolToHclTerraform(struct?: NetworkRoutedV2SecondaryStaticIpPool | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class NetworkRoutedV2SecondaryStaticIpPoolOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): NetworkRoutedV2SecondaryStaticIpPool | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: NetworkRoutedV2SecondaryStaticIpPool | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class NetworkRoutedV2SecondaryStaticIpPoolList extends cdktf.ComplexList {
  public internalValue? : NetworkRoutedV2SecondaryStaticIpPool[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): NetworkRoutedV2SecondaryStaticIpPoolOutputReference {
    return new NetworkRoutedV2SecondaryStaticIpPoolOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function networkRoutedV2StaticIpPoolToTerraform(struct?: NetworkRoutedV2StaticIpPool | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function networkRoutedV2StaticIpPoolToHclTerraform(struct?: NetworkRoutedV2StaticIpPool | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class NetworkRoutedV2StaticIpPoolOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): NetworkRoutedV2StaticIpPool | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: NetworkRoutedV2StaticIpPool | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._endAddress = undefined;
...
export class NetworkRoutedV2StaticIpPoolList extends cdktf.ComplexList {
  public internalValue? : NetworkRoutedV2StaticIpPool[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): NetworkRoutedV2StaticIpPoolOutputReference {
    return new NetworkRoutedV2StaticIpPoolOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class NetworkRoutedV2 extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a NetworkRoutedV2 resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the NetworkRoutedV2 to import
  * @param importFromId The id of the existing NetworkRoutedV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/resources/network_routed_v2#import import section} in the documentation of this resource for the id to use
  ...
  * @param options NetworkRoutedV2Config
  */
  public constructor(scope: Construct, id: string, config: NetworkRoutedV2Config) {
    super(scope, id, {
  ...
  private _metadataEntry = new NetworkRoutedV2MetadataEntryList(this, "metadata_entry", true);
  public get metadataEntry() {
    return this._metadataEntry;
  }
  public putMetadataEntry(value: NetworkRoutedV2MetadataEntry[] | cdktf.IResolvable) {
  ...
  private _secondaryStaticIpPool = new NetworkRoutedV2SecondaryStaticIpPoolList(this, "secondary_static_ip_pool", true);
  public get secondaryStaticIpPool() {
    return this._secondaryStaticIpPool;
  }
  public putSecondaryStaticIpPool(value: NetworkRoutedV2SecondaryStaticIpPool[] | cdktf.IResolvable) {
  ...
  private _staticIpPool = new NetworkRoutedV2StaticIpPoolList(this, "static_ip_pool", true);
  public get staticIpPool() {
    return this._staticIpPool;
  }
  public putStaticIpPool(value: NetworkRoutedV2StaticIpPool[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      metadata_entry: cdktf.listMapper(networkRoutedV2MetadataEntryToTerraform, true)(this._metadataEntry.internalValue),
      secondary_static_ip_pool: cdktf.listMapper(networkRoutedV2SecondaryStaticIpPoolToTerraform, true)(this._secondaryStaticIpPool.internalValue),
      static_ip_pool: cdktf.listMapper(networkRoutedV2StaticIpPoolToTerraform, true)(this._staticIpPool.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      metadata_entry: {
        value: cdktf.listMapperHcl(networkRoutedV2MetadataEntryToHclTerraform, true)(this._metadataEntry.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "NetworkRoutedV2MetadataEntryList",
      },
      secondary_static_ip_pool: {
        value: cdktf.listMapperHcl(networkRoutedV2SecondaryStaticIpPoolToHclTerraform, true)(this._secondaryStaticIpPool.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "NetworkRoutedV2SecondaryStaticIpPoolList",
      },
      static_ip_pool: {
        value: cdktf.listMapperHcl(networkRoutedV2StaticIpPoolToHclTerraform, true)(this._staticIpPool.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "NetworkRoutedV2StaticIpPoolList",
      },
    };
