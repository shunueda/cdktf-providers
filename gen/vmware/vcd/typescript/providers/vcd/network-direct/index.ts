// https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/resources/network_direct
...
export interface NetworkDirectConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly metadataEntry?: NetworkDirectMetadataEntry[] | cdktf.IResolvable;
}
...
export function networkDirectMetadataEntryToTerraform(struct?: NetworkDirectMetadataEntry | cdktf.IResolvable): any {
...
export function networkDirectMetadataEntryToHclTerraform(struct?: NetworkDirectMetadataEntry | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class NetworkDirectMetadataEntryOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetworkDirectMetadataEntry | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: NetworkDirectMetadataEntry | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class NetworkDirectMetadataEntryList extends cdktf.ComplexList {
  public internalValue? : NetworkDirectMetadataEntry[] | cdktf.IResolvable
  ...
  */
  public get(index: number): NetworkDirectMetadataEntryOutputReference {
    return new NetworkDirectMetadataEntryOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class NetworkDirect extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a NetworkDirect resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the NetworkDirect to import
  * @param importFromId The id of the existing NetworkDirect that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/resources/network_direct#import import section} in the documentation of this resource for the id to use
  ...
  * @param options NetworkDirectConfig
  */
  public constructor(scope: Construct, id: string, config: NetworkDirectConfig) {
    super(scope, id, {
    ...
    this._externalNetwork = config.externalNetwork;
    this._id = config.id;
  ...
  private _metadataEntry = new NetworkDirectMetadataEntryList(this, "metadata_entry", true);
  public get metadataEntry() {
    return this._metadataEntry;
  }
  public putMetadataEntry(value: NetworkDirectMetadataEntry[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      external_network: cdktf.stringToTerraform(this._externalNetwork),
      ...
      metadata_entry: cdktf.listMapper(networkDirectMetadataEntryToTerraform, true)(this._metadataEntry.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      external_network: {
        value: cdktf.stringToHclTerraform(this._externalNetwork),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      metadata_entry: {
        value: cdktf.listMapperHcl(networkDirectMetadataEntryToHclTerraform, true)(this._metadataEntry.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "NetworkDirectMetadataEntryList",
      },
    };
