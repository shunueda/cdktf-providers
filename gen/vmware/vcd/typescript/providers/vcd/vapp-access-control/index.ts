// https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/resources/vapp_access_control
...
export interface VappAccessControlConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly sharedWith?: VappAccessControlSharedWith[] | cdktf.IResolvable;
}
...
export function vappAccessControlSharedWithToTerraform(struct?: VappAccessControlSharedWith | cdktf.IResolvable): any {
...
export function vappAccessControlSharedWithToHclTerraform(struct?: VappAccessControlSharedWith | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class VappAccessControlSharedWithOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): VappAccessControlSharedWith | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: VappAccessControlSharedWith | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class VappAccessControlSharedWithList extends cdktf.ComplexList {
  public internalValue? : VappAccessControlSharedWith[] | cdktf.IResolvable
  ...
  */
  public get(index: number): VappAccessControlSharedWithOutputReference {
    return new VappAccessControlSharedWithOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class VappAccessControl extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "vcd_vapp_access_control";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a VappAccessControl resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the VappAccessControl to import
  * @param importFromId The id of the existing VappAccessControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/resources/vapp_access_control#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the VappAccessControl to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "vcd_vapp_access_control", importId: importFromId, provider });
      }
  ...
  * @param options VappAccessControlConfig
  */
  public constructor(scope: Construct, id: string, config: VappAccessControlConfig) {
    super(scope, id, {
  ...
  private _sharedWith = new VappAccessControlSharedWithList(this, "shared_with", true);
  public get sharedWith() {
    return this._sharedWith;
  }
  public putSharedWith(value: VappAccessControlSharedWith[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      shared_with: cdktf.listMapper(vappAccessControlSharedWithToTerraform, true)(this._sharedWith.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      shared_with: {
        value: cdktf.listMapperHcl(vappAccessControlSharedWithToHclTerraform, true)(this._sharedWith.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "VappAccessControlSharedWithList",
      },
    };
