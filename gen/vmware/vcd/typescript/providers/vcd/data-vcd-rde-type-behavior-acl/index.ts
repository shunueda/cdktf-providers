// https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/data-sources/rde_type_behavior_acl
...
export interface DataVcdRdeTypeBehaviorAclConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class DataVcdRdeTypeBehaviorAcl extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataVcdRdeTypeBehaviorAcl resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataVcdRdeTypeBehaviorAcl to import
  * @param importFromId The id of the existing DataVcdRdeTypeBehaviorAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/data-sources/rde_type_behavior_acl#import import section} in the documentation of this resource for the id to use
  ...
  * @param options DataVcdRdeTypeBehaviorAclConfig
  */
  public constructor(scope: Construct, id: string, config: DataVcdRdeTypeBehaviorAclConfig) {
    super(scope, id, {
  ...
  // access_level_ids - computed: true, optional: false, required: false
