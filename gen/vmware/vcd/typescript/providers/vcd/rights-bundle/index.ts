// https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/resources/rights_bundle
...
export interface RightsBundleConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class RightsBundle extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "vcd_rights_bundle";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a RightsBundle resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the RightsBundle to import
  * @param importFromId The id of the existing RightsBundle that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.14.1/docs/resources/rights_bundle#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RightsBundle to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "vcd_rights_bundle", importId: importFromId, provider });
      }
  ...
  * @param options RightsBundleConfig
  */
  public constructor(scope: Construct, id: string, config: RightsBundleConfig) {
    super(scope, id, {
