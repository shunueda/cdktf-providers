// https://registry.terraform.io/providers/vmware/vcf/0.16.2/docs/resources/credentials_auto_rotate_policy
...
export interface CredentialsAutoRotatePolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcf/0.16.2/docs/resources/credentials_auto_rotate_policy#auto_rotate_days CredentialsAutoRotatePolicy#auto_rotate_days}
  */
  readonly autoRotateDays?: number;
  /**
  * Enable or disable the automatic credential rotation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcf/0.16.2/docs/resources/credentials_auto_rotate_policy#enable_auto_rotation CredentialsAutoRotatePolicy#enable_auto_rotation}
  */
  readonly enableAutoRotation: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcf/0.16.2/docs/resources/credentials_auto_rotate_policy#id CredentialsAutoRotatePolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcf/0.16.2/docs/resources/credentials_auto_rotate_policy#resource_id CredentialsAutoRotatePolicy#resource_id}
  */
  readonly resourceId?: string;
  /**
  * The name of the resource which credentials autorotate policy will be managed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcf/0.16.2/docs/resources/credentials_auto_rotate_policy#resource_name CredentialsAutoRotatePolicy#resource_name}
  */
  readonly resourceName?: string;
  /**
  * The type of the resource which credentials autorotate policy will be managed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcf/0.16.2/docs/resources/credentials_auto_rotate_policy#resource_type CredentialsAutoRotatePolicy#resource_type}
  */
  readonly resourceType: string;
  /**
  * The account name which autorotate policy will be managed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcf/0.16.2/docs/resources/credentials_auto_rotate_policy#user_name CredentialsAutoRotatePolicy#user_name}
  */
  readonly userName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vmware/vcf/0.16.2/docs/resources/credentials_auto_rotate_policy vcf_credentials_auto_rotate_policy}
*/
export class CredentialsAutoRotatePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CredentialsAutoRotatePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcf/0.16.2/docs/resources/credentials_auto_rotate_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/vcf/0.16.2/docs/resources/credentials_auto_rotate_policy vcf_credentials_auto_rotate_policy} Resource
  *
  * @param scope The scope in which to define this construct
