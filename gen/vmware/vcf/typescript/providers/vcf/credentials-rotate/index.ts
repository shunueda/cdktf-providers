...
export interface CredentialsRotateCredentials {
  /**
...
export function credentialsRotateCredentialsToTerraform(struct?: CredentialsRotateCredentials | cdktf.IResolvable): any {
...
export function credentialsRotateCredentialsToHclTerraform(struct?: CredentialsRotateCredentials | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CredentialsRotateCredentialsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CredentialsRotateCredentials | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: CredentialsRotateCredentials | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class CredentialsRotateCredentialsList extends cdktf.ComplexList {
  public internalValue? : CredentialsRotateCredentials[] | cdktf.IResolvable
  ...
  */
  public get(index: number): CredentialsRotateCredentialsOutputReference {
    return new CredentialsRotateCredentialsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class CredentialsRotate extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "vcf_credentials_rotate";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "vcf_credentials_rotate", importId: importFromId, provider });
      }
  ...
  * @param options CredentialsRotateConfig
  */
  public constructor(scope: Construct, id: string, config: CredentialsRotateConfig) {
    super(scope, id, {
  ...
  // last_rotate_time - computed: true, optional: false, required: false
  public get lastRotateTime() {
    return this.getStringAttribute('last_rotate_time');
  }
  ...
  private _credentials = new CredentialsRotateCredentialsList(this, "credentials", false);
  public get credentials() {
    return this._credentials;
  }
  public putCredentials(value: CredentialsRotateCredentials[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      credentials: cdktf.listMapper(credentialsRotateCredentialsToTerraform, true)(this._credentials.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      credentials: {
        value: cdktf.listMapperHcl(credentialsRotateCredentialsToHclTerraform, true)(this._credentials.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "CredentialsRotateCredentialsList",
      },
    };
