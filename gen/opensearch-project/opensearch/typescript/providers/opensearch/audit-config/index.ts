// https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config
...
export interface AuditConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#enabled AuditConfig#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#id AuditConfig#id}
  *
  ...
  * audit block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#audit AuditConfig#audit}
  */
  readonly audit?: AuditConfigAudit;
  /**
  * compliance block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#compliance AuditConfig#compliance}
  */
  readonly compliance?: AuditConfigCompliance;
}
export interface AuditConfigAudit {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#disabled_rest_categories AuditConfig#disabled_rest_categories}
  */
  readonly disabledRestCategories?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#disabled_transport_categories AuditConfig#disabled_transport_categories}
  */
  readonly disabledTransportCategories?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#enable_rest AuditConfig#enable_rest}
  */
  readonly enableRest?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#enable_transport AuditConfig#enable_transport}
  */
  readonly enableTransport?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#exclude_sensitive_headers AuditConfig#exclude_sensitive_headers}
  */
  readonly excludeSensitiveHeaders?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#ignore_requests AuditConfig#ignore_requests}
  */
  readonly ignoreRequests?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#ignore_users AuditConfig#ignore_users}
  */
  readonly ignoreUsers?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#log_request_body AuditConfig#log_request_body}
  */
  readonly logRequestBody?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#resolve_bulk_requests AuditConfig#resolve_bulk_requests}
  */
  readonly resolveBulkRequests?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#resolve_indices AuditConfig#resolve_indices}
  */
  readonly resolveIndices?: boolean | cdktf.IResolvable;
}

export function auditConfigAuditToTerraform(struct?: AuditConfigAuditOutputReference | AuditConfigAudit): any {
...
export function auditConfigAuditToHclTerraform(struct?: AuditConfigAuditOutputReference | AuditConfigAudit): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AuditConfigAuditOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AuditConfigAudit | undefined {
  ...
  public set internalValue(value: AuditConfigAudit | undefined) {
    if (value === undefined) {
...
export interface AuditConfigComplianceReadWatchedField {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#fields AuditConfig#fields}
  */
  readonly fields: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#index AuditConfig#index}
  */
  readonly index: string;
}

export function auditConfigComplianceReadWatchedFieldToTerraform(struct?: AuditConfigComplianceReadWatchedField | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function auditConfigComplianceReadWatchedFieldToHclTerraform(struct?: AuditConfigComplianceReadWatchedField | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AuditConfigComplianceReadWatchedFieldOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): AuditConfigComplianceReadWatchedField | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AuditConfigComplianceReadWatchedField | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class AuditConfigComplianceReadWatchedFieldList extends cdktf.ComplexList {
  public internalValue? : AuditConfigComplianceReadWatchedField[] | cdktf.IResolvable
  ...
  */
  public get(index: number): AuditConfigComplianceReadWatchedFieldOutputReference {
    return new AuditConfigComplianceReadWatchedFieldOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface AuditConfigCompliance {
  ...
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#external_config AuditConfig#external_config}
  */
  readonly externalConfig?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#internal_config AuditConfig#internal_config}
  */
  readonly internalConfig?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#read_ignore_users AuditConfig#read_ignore_users}
  */
  readonly readIgnoreUsers?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#read_metadata_only AuditConfig#read_metadata_only}
  */
  readonly readMetadataOnly?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#write_ignore_users AuditConfig#write_ignore_users}
  */
  readonly writeIgnoreUsers?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#write_log_diffs AuditConfig#write_log_diffs}
  */
  readonly writeLogDiffs?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#write_metadata_only AuditConfig#write_metadata_only}
  */
  readonly writeMetadataOnly?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#write_watched_indices AuditConfig#write_watched_indices}
  */
  readonly writeWatchedIndices?: string[];
  /**
  * read_watched_field block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#read_watched_field AuditConfig#read_watched_field}
  */
  readonly readWatchedField?: AuditConfigComplianceReadWatchedField[] | cdktf.IResolvable;
}

export function auditConfigComplianceToTerraform(struct?: AuditConfigComplianceOutputReference | AuditConfigCompliance): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    read_watched_field: cdktf.listMapper(auditConfigComplianceReadWatchedFieldToTerraform, true)(struct!.readWatchedField),
  }
}


export function auditConfigComplianceToHclTerraform(struct?: AuditConfigComplianceOutputReference | AuditConfigCompliance): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    read_watched_field: {
      value: cdktf.listMapperHcl(auditConfigComplianceReadWatchedFieldToHclTerraform, true)(struct!.readWatchedField),
      isBlock: true,
      type: "set",
      storageClassType: "AuditConfigComplianceReadWatchedFieldList",
    },
  };
...
export class AuditConfigComplianceOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): AuditConfigCompliance | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: AuditConfigCompliance | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _readWatchedField = new AuditConfigComplianceReadWatchedFieldList(this, "read_watched_field", true);
  public get readWatchedField() {
    return this._readWatchedField;
  }
  public putReadWatchedField(value: AuditConfigComplianceReadWatchedField[] | cdktf.IResolvable) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config opensearch_audit_config}
*/
export class AuditConfig extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "opensearch_audit_config";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a AuditConfig resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AuditConfig to import
  * @param importFromId The id of the existing AuditConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AuditConfig to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "opensearch_audit_config", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/audit_config opensearch_audit_config} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AuditConfigConfig
  */
  public constructor(scope: Construct, id: string, config: AuditConfigConfig) {
    super(scope, id, {
  ...
  private _audit = new AuditConfigAuditOutputReference(this, "audit");
  public get audit() {
    return this._audit;
  }
  public putAudit(value: AuditConfigAudit) {
  ...
  private _compliance = new AuditConfigComplianceOutputReference(this, "compliance");
  public get compliance() {
    return this._compliance;
  }
  public putCompliance(value: AuditConfigCompliance) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      audit: auditConfigAuditToTerraform(this._audit.internalValue),
      compliance: auditConfigComplianceToTerraform(this._compliance.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      audit: {
        value: auditConfigAuditToHclTerraform(this._audit.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AuditConfigAuditList",
      },
      compliance: {
        value: auditConfigComplianceToHclTerraform(this._compliance.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AuditConfigComplianceList",
      },
    };
