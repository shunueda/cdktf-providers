// https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index
...
export interface IndexConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#aliases Index#aliases}
  */
  readonly aliases?: string;
  /**
  * A JSON string describing the analyzers applied to the index.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#analysis_analyzer Index#analysis_analyzer}
  */
  readonly analysisAnalyzer?: string;
  /**
  * A JSON string describing the char_filters applied to the index.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#analysis_char_filter Index#analysis_char_filter}
  */
  readonly analysisCharFilter?: string;
  /**
  * A JSON string describing the filters applied to the index.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#analysis_filter Index#analysis_filter}
  */
  readonly analysisFilter?: string;
  /**
  * A JSON string describing the normalizers applied to the index.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#analysis_normalizer Index#analysis_normalizer}
  */
  readonly analysisNormalizer?: string;
  /**
  * A JSON string describing the tokenizers applied to the index.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#analysis_tokenizer Index#analysis_tokenizer}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#analyze_max_token_count Index#analyze_max_token_count}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#auto_expand_replicas Index#auto_expand_replicas}
  */
  readonly autoExpandReplicas?: string;
  /**
  * Set to `true` to disable index metadata reads and writes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#blocks_metadata Index#blocks_metadata}
  */
  readonly blocksMetadata?: boolean | cdktf.IResolvable;
  /**
  * Set to `true` to disable read operations against the index.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#blocks_read Index#blocks_read}
  */
  readonly blocksRead?: boolean | cdktf.IResolvable;
  /**
  * Set to `true` to make the index and index metadata read only, `false` to allow writes and metadata changes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#blocks_read_only Index#blocks_read_only}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#blocks_read_only_allow_delete Index#blocks_read_only_allow_delete}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#blocks_write Index#blocks_write}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#codec Index#codec}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#default_pipeline Index#default_pipeline}
  */
  readonly defaultPipeline?: string;
  /**
  * A boolean that indicates that the index should be deleted even if it contains documents.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#force_destroy Index#force_destroy}
  */
  readonly forceDestroy?: boolean | cdktf.IResolvable;
  /**
  * The length of time that a deleted document's version number remains available for further versioned operations.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#gc_deletes Index#gc_deletes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#highlight_max_analyzed_offset Index#highlight_max_analyzed_offset}
  */
  readonly highlightMaxAnalyzedOffset?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#id Index#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#include_type_name Index#include_type_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#index_knn Index#index_knn}
  */
  readonly indexKnn?: boolean | cdktf.IResolvable;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#index_knn_algo_param_ef_search Index#index_knn_algo_param_ef_search}
  */
  readonly indexKnnAlgoParamEfSearch?: string;
  /**
  * A JSON string describing the default index similarity config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#index_similarity_default Index#index_similarity_default}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#indexing_slowlog_level Index#indexing_slowlog_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#indexing_slowlog_source Index#indexing_slowlog_source}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#indexing_slowlog_threshold_index_debug Index#indexing_slowlog_threshold_index_debug}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#indexing_slowlog_threshold_index_info Index#indexing_slowlog_threshold_index_info}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#indexing_slowlog_threshold_index_trace Index#indexing_slowlog_threshold_index_trace}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#indexing_slowlog_threshold_index_warn Index#indexing_slowlog_threshold_index_warn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#load_fixed_bitset_filters_eagerly Index#load_fixed_bitset_filters_eagerly}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#mappings Index#mappings}
  */
  readonly mappings?: string;
  /**
  * The maximum number of `docvalue_fields` that are allowed in a query. A stringified number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#max_docvalue_fields_search Index#max_docvalue_fields_search}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#max_inner_result_window Index#max_inner_result_window}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#max_ngram_diff Index#max_ngram_diff}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#max_refresh_listeners Index#max_refresh_listeners}
  */
  readonly maxRefreshListeners?: string;
  /**
  * The maximum length of regex that can be used in Regexp Query. A stringified number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#max_regex_length Index#max_regex_length}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#max_rescore_window Index#max_rescore_window}
  */
  readonly maxRescoreWindow?: string;
  /**
  * The maximum value of `from + size` for searches to this index. A stringified number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#max_result_window Index#max_result_window}
  */
  readonly maxResultWindow?: string;
  /**
  * The maximum number of `script_fields` that are allowed in a query. A stringified number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#max_script_fields Index#max_script_fields}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#max_shingle_diff Index#max_shingle_diff}
  */
  readonly maxShingleDiff?: string;
  /**
  * The maximum number of terms that can be used in Terms Query. A stringified number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#max_terms_count Index#max_terms_count}
  */
  readonly maxTermsCount?: string;
  /**
  * Name of the index to create
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#name Index#name}
  */
  readonly name: string;
  /**
  * Number of shard replicas. A stringified number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#number_of_replicas Index#number_of_replicas}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#number_of_routing_shards Index#number_of_routing_shards}
  */
  readonly numberOfRoutingShards?: string;
  /**
  * Number of shards for the index. This can be set only on creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#number_of_shards Index#number_of_shards}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#refresh_interval Index#refresh_interval}
  */
  readonly refreshInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#rollover_alias Index#rollover_alias}
  */
  readonly rolloverAlias?: string;
  /**
  * Controls shard allocation for this index. It can be set to: `all` , `primaries` , `new_primaries` , `none`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#routing_allocation_enable Index#routing_allocation_enable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#routing_partition_size Index#routing_partition_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#routing_rebalance_enable Index#routing_rebalance_enable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#search_idle_after Index#search_idle_after}
  */
  readonly searchIdleAfter?: string;
  /**
  * Set which logging level to use for the search slow log, can be: `warn`, `info`, `debug`, `trace`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#search_slowlog_level Index#search_slowlog_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#search_slowlog_threshold_fetch_debug Index#search_slowlog_threshold_fetch_debug}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#search_slowlog_threshold_fetch_info Index#search_slowlog_threshold_fetch_info}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#search_slowlog_threshold_fetch_trace Index#search_slowlog_threshold_fetch_trace}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#search_slowlog_threshold_fetch_warn Index#search_slowlog_threshold_fetch_warn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#search_slowlog_threshold_query_debug Index#search_slowlog_threshold_query_debug}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#search_slowlog_threshold_query_info Index#search_slowlog_threshold_query_info}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#search_slowlog_threshold_query_trace Index#search_slowlog_threshold_query_trace}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#search_slowlog_threshold_query_warn Index#search_slowlog_threshold_query_warn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#shard_check_on_startup Index#shard_check_on_startup}
  */
  readonly shardCheckOnStartup?: string;
  /**
  * The field to sort shards in this index by.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#sort_field Index#sort_field}
  */
  readonly sortField?: string;
  /**
  * The direction to sort shards in. Accepts `asc`, `desc`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#sort_order Index#sort_order}
  */
  readonly sortOrder?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index opensearch_index}
*/
export class Index extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "opensearch_index";
  ...
  * @param importFromId The id of the existing Index that should be imported. Refer to the {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Index to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "opensearch_index", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/index opensearch_index} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: IndexConfig) {
    ...
    this._indexKnn = config.indexKnn;
    this._indexKnnAlgoParamEfSearch = config.indexKnnAlgoParamEfSearch;
  ...
  // index_knn - computed: false, optional: true, required: false
  private _indexKnn?: boolean | cdktf.IResolvable; 
  public get indexKnn() {
    return this.getBooleanAttribute('index_knn');
  }
  public set indexKnn(value: boolean | cdktf.IResolvable) {
    this._indexKnn = value;
  }
  public resetIndexKnn() {
    this._indexKnn = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get indexKnnInput() {
    return this._indexKnn;
  }

  // index_knn_algo_param_ef_search - computed: false, optional: true, required: false
  private _indexKnnAlgoParamEfSearch?: string; 
  public get indexKnnAlgoParamEfSearch() {
    return this.getStringAttribute('index_knn_algo_param_ef_search');
  }
  public set indexKnnAlgoParamEfSearch(value: string) {
    this._indexKnnAlgoParamEfSearch = value;
  }
  public resetIndexKnnAlgoParamEfSearch() {
    this._indexKnnAlgoParamEfSearch = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get indexKnnAlgoParamEfSearchInput() {
    return this._indexKnnAlgoParamEfSearch;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      index_knn: cdktf.booleanToTerraform(this._indexKnn),
      index_knn_algo_param_ef_search: cdktf.stringToTerraform(this._indexKnnAlgoParamEfSearch),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      index_knn: {
        value: cdktf.booleanToHclTerraform(this._indexKnn),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      index_knn_algo_param_ef_search: {
        value: cdktf.stringToHclTerraform(this._indexKnnAlgoParamEfSearch),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
