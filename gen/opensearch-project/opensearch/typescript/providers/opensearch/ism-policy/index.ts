// https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/ism_policy
...
export interface IsmPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  * The policy document.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/ism_policy#body IsmPolicy#body}
  */
  readonly body: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/ism_policy#id IsmPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/ism_policy#policy_id IsmPolicy#policy_id}
  */
  readonly policyId: string;
  /**
  * The primary term of the ISM policy version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/ism_policy#primary_term IsmPolicy#primary_term}
  */
  readonly primaryTerm?: number;
  /**
  * The sequence number of the ISM policy version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/ism_policy#seq_no IsmPolicy#seq_no}
  */
  readonly seqNo?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/ism_policy opensearch_ism_policy}
*/
export class IsmPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IsmPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/ism_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opensearch-project/opensearch/2.3.2/docs/resources/ism_policy opensearch_ism_policy} Resource
  *
  * @param scope The scope in which to define this construct
