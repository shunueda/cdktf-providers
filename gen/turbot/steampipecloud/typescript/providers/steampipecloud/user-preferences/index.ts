// https://registry.terraform.io/providers/turbot/steampipecloud/0.11.0/docs/resources/user_preferences
...
export interface UserPreferencesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/turbot/steampipecloud/0.11.0/docs/resources/user_preferences#communication_community_updates UserPreferences#communication_community_updates}
  */
  readonly communicationCommunityUpdates?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/turbot/steampipecloud/0.11.0/docs/resources/user_preferences#communication_product_updates UserPreferences#communication_product_updates}
  */
  readonly communicationProductUpdates?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/turbot/steampipecloud/0.11.0/docs/resources/user_preferences#communication_tips_and_tricks UserPreferences#communication_tips_and_tricks}
  */
  readonly communicationTipsAndTricks?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/turbot/steampipecloud/0.11.0/docs/resources/user_preferences#created_at UserPreferences#created_at}
  */
  readonly createdAt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/turbot/steampipecloud/0.11.0/docs/resources/user_preferences#id UserPreferences#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/turbot/steampipecloud/0.11.0/docs/resources/user_preferences#updated_at UserPreferences#updated_at}
  */
  readonly updatedAt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/turbot/steampipecloud/0.11.0/docs/resources/user_preferences#version_id UserPreferences#version_id}
  */
  readonly versionId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/turbot/steampipecloud/0.11.0/docs/resources/user_preferences steampipecloud_user_preferences}
*/
export class UserPreferences extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "steampipecloud_user_preferences";
  ...
  * @param importFromId The id of the existing UserPreferences that should be imported. Refer to the {@link https://registry.terraform.io/providers/turbot/steampipecloud/0.11.0/docs/resources/user_preferences#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the UserPreferences to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "steampipecloud_user_preferences", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/turbot/steampipecloud/0.11.0/docs/resources/user_preferences steampipecloud_user_preferences} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: UserPreferencesConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'steampipecloud_user_preferences',
