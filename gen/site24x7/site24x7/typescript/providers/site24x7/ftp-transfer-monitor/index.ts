// https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor
...
export interface FtpTransferMonitorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Action to be performed on monitor status changes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#actions FtpTransferMonitor#actions}
  */
  readonly actions?: { [key: string]: string };
  /**
  * To check download or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#check_download FtpTransferMonitor#check_download}
  */
  readonly checkDownload?: boolean | cdktf.IResolvable;
  /**
  * Interval at which your RESRAPI has to be monitored. Default value is 5 minute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#check_frequency FtpTransferMonitor#check_frequency}
  */
  readonly checkFrequency?: string;
  /**
  * To check upload or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#check_upload FtpTransferMonitor#check_upload}
  */
  readonly checkUpload?: boolean | cdktf.IResolvable;
  /**
  * Credential Profile to associate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#credential_profile_id FtpTransferMonitor#credential_profile_id}
  */
  readonly credentialProfileId?: string;
  /**
  * List of dependent resource IDs. Suppress alert when dependent monitor(s) is down.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#dependency_resource_ids FtpTransferMonitor#dependency_resource_ids}
  */
  readonly dependencyResourceIds?: string[];
  /**
  * Destination of the file path
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#destination FtpTransferMonitor#destination}
  */
  readonly destination?: string;
  /**
  * Name for the monitor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#display_name FtpTransferMonitor#display_name}
  */
  readonly displayName: string;
  /**
  * Registered domain name or ip addresss
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#host_name FtpTransferMonitor#host_name}
  */
  readonly hostName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#id FtpTransferMonitor#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#location_profile_id FtpTransferMonitor#location_profile_id}
  */
  readonly locationProfileId?: string;
  /**
  * Name of the location profile to be associated with the monitor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#location_profile_name FtpTransferMonitor#location_profile_name}
  */
  readonly locationProfileName?: string;
  /**
  * List of monitor groups to which the monitor has to be associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#monitor_groups FtpTransferMonitor#monitor_groups}
  */
  readonly monitorGroups?: string[];
  /**
  * Notification profile to be associated with the monitor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#notification_profile_id FtpTransferMonitor#notification_profile_id}
  */
  readonly notificationProfileId?: string;
  /**
  * Name of the notification profile to be associated with the monitor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#notification_profile_name FtpTransferMonitor#notification_profile_name}
  */
  readonly notificationProfileName?: string;
  /**
  * if user_group_ids is not choosen,	On-Call Schedule of your choice.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#on_call_schedule_id FtpTransferMonitor#on_call_schedule_id}
  */
  readonly onCallScheduleId?: string;
  /**
  * password to access the file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#password FtpTransferMonitor#password}
  */
  readonly password?: string;
  /**
  * To perform automation or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#perform_automation FtpTransferMonitor#perform_automation}
  */
  readonly performAutomation?: boolean | cdktf.IResolvable;
  /**
  * Who is Server Port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#port FtpTransferMonitor#port}
  */
  readonly port?: number;
  /**
  * HTTPS,SMTPS,POPS,IMAPS,FTPS or CUSTOM
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#protocol FtpTransferMonitor#protocol}
  */
  readonly protocol?: string;
  /**
  * List of tag IDs to be associated to the monitor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#tag_ids FtpTransferMonitor#tag_ids}
  */
  readonly tagIds?: string[];
  /**
  * List of tag names to be associated to the monitor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#tag_names FtpTransferMonitor#tag_names}
  */
  readonly tagNames?: string[];
  /**
  * List of Third Party Service IDs to be associated to the monitor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#third_party_service_ids FtpTransferMonitor#third_party_service_ids}
  */
  readonly thirdPartyServiceIds?: string[];
  /**
  * Threshold profile to be associated with the monitor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#threshold_profile_id FtpTransferMonitor#threshold_profile_id}
  */
  readonly thresholdProfileId?: string;
  /**
  * Timeout for connecting to website. Default value is 10. Range 1 - 45
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#timeout FtpTransferMonitor#timeout}
  */
  readonly timeout?: number;
  /**
  * List of user groups to be notified when the monitor is down
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#user_group_ids FtpTransferMonitor#user_group_ids}
  */
  readonly userGroupIds?: string[];
  /**
  * Name of the user groups to be associated with the monitor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#user_group_names FtpTransferMonitor#user_group_names}
  */
  readonly userGroupNames?: string[];
  /**
  * username to access the file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#user_name FtpTransferMonitor#user_name}
  */
  readonly userName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor site24x7_ftp_transfer_monitor}
*/
export class FtpTransferMonitor extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "site24x7_ftp_transfer_monitor";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a FtpTransferMonitor resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the FtpTransferMonitor to import
  * @param importFromId The id of the existing FtpTransferMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the FtpTransferMonitor to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "site24x7_ftp_transfer_monitor", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/site24x7/site24x7/2.0.3/docs/resources/ftp_transfer_monitor site24x7_ftp_transfer_monitor} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options FtpTransferMonitorConfig
  */
  public constructor(scope: Construct, id: string, config: FtpTransferMonitorConfig) {
    super(scope, id, {
      terraformResourceType: 'site24x7_ftp_transfer_monitor',
    ...
    this._checkDownload = config.checkDownload;
    this._checkFrequency = config.checkFrequency;
    this._checkUpload = config.checkUpload;
  ...
  // check_download - computed: false, optional: true, required: false
  private _checkDownload?: boolean | cdktf.IResolvable; 
  public get checkDownload() {
    return this.getBooleanAttribute('check_download');
  }
  public set checkDownload(value: boolean | cdktf.IResolvable) {
    this._checkDownload = value;
  }
  public resetCheckDownload() {
    this._checkDownload = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get checkDownloadInput() {
  ...
  // check_upload - computed: false, optional: true, required: false
  private _checkUpload?: boolean | cdktf.IResolvable; 
  public get checkUpload() {
    return this.getBooleanAttribute('check_upload');
  }
  public set checkUpload(value: boolean | cdktf.IResolvable) {
    this._checkUpload = value;
  }
  public resetCheckUpload() {
    this._checkUpload = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get checkUploadInput() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      check_download: cdktf.booleanToTerraform(this._checkDownload),
      check_frequency: cdktf.stringToTerraform(this._checkFrequency),
      check_upload: cdktf.booleanToTerraform(this._checkUpload),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      check_download: {
        value: cdktf.booleanToHclTerraform(this._checkDownload),
        isBlock: false,
        type: "simple",
      ...
      check_upload: {
        value: cdktf.booleanToHclTerraform(this._checkUpload),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
