// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_gcp
...
export interface CloudaccountGcpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_gcp#context CloudaccountGcp#context}
  */
  readonly context?: string;
  /**
  * The GCP credentials in JSON format. These credentials are required to authenticate and manage.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_gcp#gcp_json_credentials CloudaccountGcp#gcp_json_credentials}
  */
  readonly gcpJsonCredentials: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_gcp#id CloudaccountGcp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_gcp#name CloudaccountGcp#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_gcp spectrocloud_cloudaccount_gcp}
*/
export class CloudaccountGcp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudaccountGcp that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_gcp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_gcp spectrocloud_cloudaccount_gcp} Resource
  *
  * @param scope The scope in which to define this construct
