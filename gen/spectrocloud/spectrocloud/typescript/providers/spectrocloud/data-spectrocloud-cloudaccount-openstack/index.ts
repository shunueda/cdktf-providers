// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/cloudaccount_openstack
...
export interface DataSpectrocloudCloudaccountOpenstackConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/cloudaccount_openstack#context DataSpectrocloudCloudaccountOpenstack#context}
  */
  readonly context?: string;
  /**
  * The unique ID of the OpenStack cloud account. Either `id` or `name` must be provided, but not both.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/cloudaccount_openstack#id DataSpectrocloudCloudaccountOpenstack#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/cloudaccount_openstack#name DataSpectrocloudCloudaccountOpenstack#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/cloudaccount_openstack spectrocloud_cloudaccount_openstack}
*/
export class DataSpectrocloudCloudaccountOpenstack extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpectrocloudCloudaccountOpenstack that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/cloudaccount_openstack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/cloudaccount_openstack spectrocloud_cloudaccount_openstack} Data Source
  *
  * @param scope The scope in which to define this construct
