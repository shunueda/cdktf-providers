// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool
...
export interface PrivatecloudgatewayIppoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#gateway PrivatecloudgatewayIppool#gateway}
  */
  readonly gateway: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#id PrivatecloudgatewayIppool#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#ip_end_range PrivatecloudgatewayIppool#ip_end_range}
  */
  readonly ipEndRange?: string;
  /**
  * The start IP address of the IP pool. Required if `network_type` is `range`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#ip_start_range PrivatecloudgatewayIppool#ip_start_range}
  */
  readonly ipStartRange?: string;
  /**
  * The name of the IP pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#name PrivatecloudgatewayIppool#name}
  */
  readonly name: string;
  /**
  * The list of nameserver IP addresses for the IP pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#nameserver_addresses PrivatecloudgatewayIppool#nameserver_addresses}
  */
  readonly nameserverAddresses?: string[];
  /**
  * The list of nameserver search suffixes for the IP pool. For example, `example.org`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#nameserver_search_suffix PrivatecloudgatewayIppool#nameserver_search_suffix}
  */
  readonly nameserverSearchSuffix?: string[];
  /**
  * The type of network for the IP pool. Allowed values are: `range` and `subnet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#network_type PrivatecloudgatewayIppool#network_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#prefix PrivatecloudgatewayIppool#prefix}
  */
  readonly prefix: number;
  /**
  * The ID of the Private Cloud Gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#private_cloud_gateway_id PrivatecloudgatewayIppool#private_cloud_gateway_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#restrict_to_single_cluster PrivatecloudgatewayIppool#restrict_to_single_cluster}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#subnet_cidr PrivatecloudgatewayIppool#subnet_cidr}
  */
  readonly subnetCidr?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#timeouts PrivatecloudgatewayIppool#timeouts}
  */
  readonly timeouts?: PrivatecloudgatewayIppoolTimeouts;
}
export interface PrivatecloudgatewayIppoolTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#create PrivatecloudgatewayIppool#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#delete PrivatecloudgatewayIppool#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#update PrivatecloudgatewayIppool#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool spectrocloud_privatecloudgateway_ippool}
*/
export class PrivatecloudgatewayIppool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivatecloudgatewayIppool that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/privatecloudgateway_ippool spectrocloud_privatecloudgateway_ippool} Resource
  *
  * @param scope The scope in which to define this construct
