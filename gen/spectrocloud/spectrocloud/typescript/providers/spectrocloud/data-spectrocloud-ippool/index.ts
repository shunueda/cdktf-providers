// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/data-sources/ippool
...
export interface DataSpectrocloudIppoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/data-sources/ippool#id DataSpectrocloudIppool#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/data-sources/ippool#name DataSpectrocloudIppool#name}
  */
  readonly name: string;
  /**
  * The ID of the private cloud gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/data-sources/ippool#private_cloud_gateway_id DataSpectrocloudIppool#private_cloud_gateway_id}
  */
  readonly privateCloudGatewayId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/data-sources/ippool spectrocloud_ippool}
*/
export class DataSpectrocloudIppool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpectrocloudIppool that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/data-sources/ippool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/data-sources/ippool spectrocloud_ippool} Data Source
  *
  * @param scope The scope in which to define this construct
