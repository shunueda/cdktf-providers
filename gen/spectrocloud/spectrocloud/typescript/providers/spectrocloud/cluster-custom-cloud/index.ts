// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud
...
export interface ClusterCustomCloudConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#apply_setting ClusterCustomCloud#apply_setting}
  */
  readonly applySetting?: string;
  /**
  * The cloud provider name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#cloud ClusterCustomCloud#cloud}
  */
  readonly cloud: string;
  /**
  * The cloud account id to use for this cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#cloud_account_id ClusterCustomCloud#cloud_account_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#context ClusterCustomCloud#context}
  */
  readonly context?: string;
  /**
  * The description of the cluster. Default value is empty string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#description ClusterCustomCloud#description}
  */
  readonly description?: string;
  /**
  * If set to `true`, the cluster will be force deleted and user has to manually clean up the provisioned cloud resources.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#force_delete ClusterCustomCloud#force_delete}
  */
  readonly forceDelete?: boolean | cdktf.IResolvable;
  /**
  * Delay duration in minutes to before invoking cluster force delete. Default and minimum is 20.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#force_delete_delay ClusterCustomCloud#force_delete_delay}
  */
  readonly forceDeleteDelay?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#id ClusterCustomCloud#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#name ClusterCustomCloud#name}
  */
  readonly name: string;
  /**
  * Date and time after which to patch cluster `RFC3339: 2006-01-02T15:04:05Z07:00`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#os_patch_after ClusterCustomCloud#os_patch_after}
  */
  readonly osPatchAfter?: string;
  /**
  * Whether to apply OS patch on boot. Default is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#os_patch_on_boot ClusterCustomCloud#os_patch_on_boot}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#os_patch_schedule ClusterCustomCloud#os_patch_schedule}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#pause_agent_upgrades ClusterCustomCloud#pause_agent_upgrades}
  */
  readonly pauseAgentUpgrades?: string;
  /**
  * If `true`, the cluster will be created asynchronously. Default value is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#skip_completion ClusterCustomCloud#skip_completion}
  */
  readonly skipCompletion?: boolean | cdktf.IResolvable;
  /**
  * A list of tags to be applied to the cluster. Tags must be in the form of `key:value`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#tags ClusterCustomCloud#tags}
  */
  readonly tags?: string[];
  /**
  * backup_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#backup_policy ClusterCustomCloud#backup_policy}
  */
  readonly backupPolicy?: ClusterCustomCloudBackupPolicy;
  /**
  * cloud_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#cloud_config ClusterCustomCloud#cloud_config}
  */
  readonly cloudConfig: ClusterCustomCloudCloudConfig;
  /**
  * cluster_profile block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#cluster_profile ClusterCustomCloud#cluster_profile}
  */
  readonly clusterProfile?: ClusterCustomCloudClusterProfile[] | cdktf.IResolvable;
  /**
  * cluster_rbac_binding block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#cluster_rbac_binding ClusterCustomCloud#cluster_rbac_binding}
  */
  readonly clusterRbacBinding?: ClusterCustomCloudClusterRbacBinding[] | cdktf.IResolvable;
  /**
  * cluster_template block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#cluster_template ClusterCustomCloud#cluster_template}
  */
  readonly clusterTemplate?: ClusterCustomCloudClusterTemplate;
  /**
  * location_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#location_config ClusterCustomCloud#location_config}
  */
  readonly locationConfig?: ClusterCustomCloudLocationConfig[] | cdktf.IResolvable;
  /**
  * machine_pool block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#machine_pool ClusterCustomCloud#machine_pool}
  */
  readonly machinePool: ClusterCustomCloudMachinePool[] | cdktf.IResolvable;
  /**
  * namespaces block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#namespaces ClusterCustomCloud#namespaces}
  */
  readonly namespaces?: ClusterCustomCloudNamespaces[] | cdktf.IResolvable;
  /**
  * scan_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#scan_policy ClusterCustomCloud#scan_policy}
  */
  readonly scanPolicy?: ClusterCustomCloudScanPolicy;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#timeouts ClusterCustomCloud#timeouts}
  */
...
export interface ClusterCustomCloudBackupPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#backup_location_id ClusterCustomCloud#backup_location_id}
  */
  readonly backupLocationId: string;
  /**
  * The list of cluster UIDs to include in the backup. If `include_all_clusters` is set to `true`, then all clusters will be included.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#cluster_uids ClusterCustomCloud#cluster_uids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#expiry_in_hour ClusterCustomCloud#expiry_in_hour}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#include_all_clusters ClusterCustomCloud#include_all_clusters}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#include_cluster_resources ClusterCustomCloud#include_cluster_resources}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#include_cluster_resources_mode ClusterCustomCloud#include_cluster_resources_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#include_disks ClusterCustomCloud#include_disks}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#prefix ClusterCustomCloud#prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#schedule ClusterCustomCloud#schedule}
  */
...
export interface ClusterCustomCloudCloudConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#overrides ClusterCustomCloud#overrides}
  */
  readonly overrides?: { [key: string]: string };
  /**
  * The values of the cloud config. The values are specified in YAML format. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#values ClusterCustomCloud#values}
  */
...
export interface ClusterCustomCloudClusterProfilePackManifest {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#content ClusterCustomCloud#content}
  */
...
export interface ClusterCustomCloudClusterProfilePack {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#registry_name ClusterCustomCloud#registry_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#registry_uid ClusterCustomCloud#registry_uid}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#tag ClusterCustomCloud#tag}
  */
  readonly tag?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#type ClusterCustomCloud#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#uid ClusterCustomCloud#uid}
  */
  readonly uid?: string;
  /**
  ...
  * manifest block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#manifest ClusterCustomCloud#manifest}
  */
...
export interface ClusterCustomCloudClusterProfile {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#variables ClusterCustomCloud#variables}
  */
  readonly variables?: { [key: string]: string };
  /**
  * pack block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#pack ClusterCustomCloud#pack}
  */
...
export interface ClusterCustomCloudClusterRbacBindingSubjects {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#namespace ClusterCustomCloud#namespace}
  */
...
export interface ClusterCustomCloudClusterRbacBinding {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#role ClusterCustomCloud#role}
  */
  ...
  * subjects block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#subjects ClusterCustomCloud#subjects}
  */
...
export interface ClusterCustomCloudClusterTemplateClusterProfile {
  /**
...
export function clusterCustomCloudClusterTemplateClusterProfileToTerraform(struct?: ClusterCustomCloudClusterTemplateClusterProfile | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function clusterCustomCloudClusterTemplateClusterProfileToHclTerraform(struct?: ClusterCustomCloudClusterTemplateClusterProfile | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ClusterCustomCloudClusterTemplateClusterProfileOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ClusterCustomCloudClusterTemplateClusterProfile | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ClusterCustomCloudClusterTemplateClusterProfile | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._id = undefined;
...
export class ClusterCustomCloudClusterTemplateClusterProfileList extends cdktf.ComplexList {
  public internalValue? : ClusterCustomCloudClusterTemplateClusterProfile[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): ClusterCustomCloudClusterTemplateClusterProfileOutputReference {
    return new ClusterCustomCloudClusterTemplateClusterProfileOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface ClusterCustomCloudClusterTemplate {
  /**
  ...
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#cluster_profile ClusterCustomCloud#cluster_profile}
  */
  readonly clusterProfile?: ClusterCustomCloudClusterTemplateClusterProfile[] | cdktf.IResolvable;
}

export function clusterCustomCloudClusterTemplateToTerraform(struct?: ClusterCustomCloudClusterTemplateOutputReference | ClusterCustomCloudClusterTemplate): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    id: cdktf.stringToTerraform(struct!.id),
    cluster_profile: cdktf.listMapper(clusterCustomCloudClusterTemplateClusterProfileToTerraform, true)(struct!.clusterProfile),
  }
}


export function clusterCustomCloudClusterTemplateToHclTerraform(struct?: ClusterCustomCloudClusterTemplateOutputReference | ClusterCustomCloudClusterTemplate): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    cluster_profile: {
      value: cdktf.listMapperHcl(clusterCustomCloudClusterTemplateClusterProfileToHclTerraform, true)(struct!.clusterProfile),
      isBlock: true,
      type: "set",
      storageClassType: "ClusterCustomCloudClusterTemplateClusterProfileList",
    },
  };
...
export class ClusterCustomCloudClusterTemplateOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ClusterCustomCloudClusterTemplate | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._id !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: ClusterCustomCloudClusterTemplate | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._id = undefined;
  ...
  private _clusterProfile = new ClusterCustomCloudClusterTemplateClusterProfileList(this, "cluster_profile", true);
  public get clusterProfile() {
    return this._clusterProfile;
  }
  public putClusterProfile(value: ClusterCustomCloudClusterTemplateClusterProfile[] | cdktf.IResolvable) {
...
export interface ClusterCustomCloudLocationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#country_code ClusterCustomCloud#country_code}
  */
  readonly countryCode?: string;
  /**
  * The name of the country.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#country_name ClusterCustomCloud#country_name}
  */
  readonly countryName?: string;
  /**
  * The latitude coordinates value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#latitude ClusterCustomCloud#latitude}
  */
  readonly latitude: number;
  /**
  * The longitude coordinates value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#longitude ClusterCustomCloud#longitude}
  */
  readonly longitude: number;
  /**
  * The region code of where the cluster is located in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#region_code ClusterCustomCloud#region_code}
  */
  readonly regionCode?: string;
  /**
  * The name of the region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#region_name ClusterCustomCloud#region_name}
  */
...
export interface ClusterCustomCloudMachinePoolTaints {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#effect ClusterCustomCloud#effect}
  */
  readonly effect: string;
  /**
  * The key of the taint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#key ClusterCustomCloud#key}
  */
  readonly key: string;
  /**
  * The value of the taint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#value ClusterCustomCloud#value}
  */
...
export interface ClusterCustomCloudMachinePool {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#control_plane ClusterCustomCloud#control_plane}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#control_plane_as_worker ClusterCustomCloud#control_plane_as_worker}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#node_pool_config ClusterCustomCloud#node_pool_config}
  */
  ...
  * taints block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#taints ClusterCustomCloud#taints}
  */
...
export interface ClusterCustomCloudNamespaces {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#resource_allocation ClusterCustomCloud#resource_allocation}
  */
...
export interface ClusterCustomCloudScanPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#configuration_scan_schedule ClusterCustomCloud#configuration_scan_schedule}
  */
  readonly configurationScanSchedule: string;
  /**
  * The schedule for conformance scan.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#conformance_scan_schedule ClusterCustomCloud#conformance_scan_schedule}
  */
  readonly conformanceScanSchedule: string;
  /**
  * The schedule for penetration scan.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#penetration_scan_schedule ClusterCustomCloud#penetration_scan_schedule}
  */
...
export interface ClusterCustomCloudTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#create ClusterCustomCloud#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#delete ClusterCustomCloud#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#update ClusterCustomCloud#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud spectrocloud_cluster_custom_cloud}
*/
export class ClusterCustomCloud extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusterCustomCloud that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cluster_custom_cloud spectrocloud_cluster_custom_cloud} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _clusterTemplate = new ClusterCustomCloudClusterTemplateOutputReference(this, "cluster_template");
  public get clusterTemplate() {
    return this._clusterTemplate;
  }
  public putClusterTemplate(value: ClusterCustomCloudClusterTemplate) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      cluster_template: clusterCustomCloudClusterTemplateToTerraform(this._clusterTemplate.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      cluster_template: {
        value: clusterCustomCloudClusterTemplateToHclTerraform(this._clusterTemplate.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ClusterCustomCloudClusterTemplateList",
      },
      location_config: {
