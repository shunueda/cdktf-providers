// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting
...
export interface DeveloperSettingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting#cpu DeveloperSetting#cpu}
  */
  readonly cpu?: number;
  /**
  * If set to `true`, hides the system cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting#hide_system_cluster_group DeveloperSetting#hide_system_cluster_group}
  */
  readonly hideSystemClusterGroup?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting#id DeveloperSetting#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting#memory DeveloperSetting#memory}
  */
  readonly memory?: number;
  /**
  * Defines the storage capacity (in GiB) allocated to the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting#storage DeveloperSetting#storage}
  */
  readonly storage?: number;
  /**
  * Specifies the number of virtual clusters to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting#virtual_clusters_limit DeveloperSetting#virtual_clusters_limit}
  */
  readonly virtualClustersLimit?: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting#timeouts DeveloperSetting#timeouts}
  */
  readonly timeouts?: DeveloperSettingTimeouts;
}
export interface DeveloperSettingTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting#create DeveloperSetting#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting#delete DeveloperSetting#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting#update DeveloperSetting#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting spectrocloud_developer_setting}
*/
export class DeveloperSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeveloperSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/developer_setting spectrocloud_developer_setting} Resource
  *
  * @param scope The scope in which to define this construct
