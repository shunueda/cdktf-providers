// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm
...
export interface RegistryHelmConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#endpoint RegistryHelm#endpoint}
  */
  readonly endpoint: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#id RegistryHelm#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#is_private RegistryHelm#is_private}
  */
  readonly isPrivate: boolean | cdktf.IResolvable;
  /**
  * The name of the Helm registry. This must be unique
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#name RegistryHelm#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#wait_for_sync RegistryHelm#wait_for_sync}
  */
  readonly waitForSync?: boolean | cdktf.IResolvable;
  /**
  * credentials block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#credentials RegistryHelm#credentials}
  */
  readonly credentials: RegistryHelmCredentials;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#timeouts RegistryHelm#timeouts}
  */
...
export interface RegistryHelmCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#credential_type RegistryHelm#credential_type}
  */
  readonly credentialType: string;
  /**
  * The password for basic authentication. Required if 'credential_type' is set to 'basic'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#password RegistryHelm#password}
  */
  readonly password?: string;
  /**
  * The authentication token. Required if 'credential_type' is set to 'token'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#token RegistryHelm#token}
  */
  readonly token?: string;
  /**
  * The username for basic authentication. Required if 'credential_type' is set to 'basic'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#username RegistryHelm#username}
  */
...
export interface RegistryHelmTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#create RegistryHelm#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#delete RegistryHelm#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#update RegistryHelm#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm spectrocloud_registry_helm}
*/
export class RegistryHelm extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RegistryHelm that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.1/docs/resources/registry_helm spectrocloud_registry_helm} Resource
  *
  * @param scope The scope in which to define this construct
