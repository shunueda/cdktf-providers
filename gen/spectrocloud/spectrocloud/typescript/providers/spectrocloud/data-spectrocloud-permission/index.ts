// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/data-sources/permission
...
export interface DataSpectrocloudPermissionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/data-sources/permission#name DataSpectrocloudPermission#name}
  */
  readonly name: string;
  /**
  * Permission scope. Allowed permission levels are `project` or `tenant` or `resource` . Defaults to `project`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/data-sources/permission#scope DataSpectrocloudPermission#scope}
  */
  readonly scope?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/data-sources/permission spectrocloud_permission}
*/
export class DataSpectrocloudPermission extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpectrocloudPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/data-sources/permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/data-sources/permission spectrocloud_permission} Data Source
  *
  * @param scope The scope in which to define this construct
