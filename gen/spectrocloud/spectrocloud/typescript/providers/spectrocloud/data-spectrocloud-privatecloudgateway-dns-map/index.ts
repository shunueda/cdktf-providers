// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/data-sources/privatecloudgateway_dns_map
...
export interface DataSpectrocloudPrivatecloudgatewayDnsMapConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/data-sources/privatecloudgateway_dns_map#id DataSpectrocloudPrivatecloudgatewayDnsMap#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/data-sources/privatecloudgateway_dns_map#network DataSpectrocloudPrivatecloudgatewayDnsMap#network}
  */
  readonly network?: string;
  /**
  * The ID of the private cloud gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/data-sources/privatecloudgateway_dns_map#private_cloud_gateway_id DataSpectrocloudPrivatecloudgatewayDnsMap#private_cloud_gateway_id}
  */
  readonly privateCloudGatewayId: string;
  /**
  * The domain name used for DNS search queries within the private cloud.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/data-sources/privatecloudgateway_dns_map#search_domain_name DataSpectrocloudPrivatecloudgatewayDnsMap#search_domain_name}
  */
  readonly searchDomainName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/data-sources/privatecloudgateway_dns_map spectrocloud_privatecloudgateway_dns_map}
*/
export class DataSpectrocloudPrivatecloudgatewayDnsMap extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpectrocloudPrivatecloudgatewayDnsMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/data-sources/privatecloudgateway_dns_map#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/data-sources/privatecloudgateway_dns_map spectrocloud_privatecloudgateway_dns_map} Data Source
  *
  * @param scope The scope in which to define this construct
