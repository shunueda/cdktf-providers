// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/privatecloudgateway_dns_map
...
export interface PrivatecloudgatewayDnsMapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/privatecloudgateway_dns_map#data_center PrivatecloudgatewayDnsMap#data_center}
  */
  readonly dataCenter: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/privatecloudgateway_dns_map#id PrivatecloudgatewayDnsMap#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/privatecloudgateway_dns_map#network PrivatecloudgatewayDnsMap#network}
  */
  readonly network: string;
  /**
  * The ID of the Private Cloud Gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/privatecloudgateway_dns_map#private_cloud_gateway_id PrivatecloudgatewayDnsMap#private_cloud_gateway_id}
  */
  readonly privateCloudGatewayId: string;
  /**
  * The domain name used for DNS search queries within the private cloud.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/privatecloudgateway_dns_map#search_domain_name PrivatecloudgatewayDnsMap#search_domain_name}
  */
  readonly searchDomainName: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/privatecloudgateway_dns_map#timeouts PrivatecloudgatewayDnsMap#timeouts}
  */
  readonly timeouts?: PrivatecloudgatewayDnsMapTimeouts;
}
export interface PrivatecloudgatewayDnsMapTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/privatecloudgateway_dns_map#create PrivatecloudgatewayDnsMap#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/privatecloudgateway_dns_map#delete PrivatecloudgatewayDnsMap#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/privatecloudgateway_dns_map#update PrivatecloudgatewayDnsMap#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/privatecloudgateway_dns_map spectrocloud_privatecloudgateway_dns_map}
*/
export class PrivatecloudgatewayDnsMap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivatecloudgatewayDnsMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/privatecloudgateway_dns_map#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/privatecloudgateway_dns_map spectrocloud_privatecloudgateway_dns_map} Resource
  *
  * @param scope The scope in which to define this construct
