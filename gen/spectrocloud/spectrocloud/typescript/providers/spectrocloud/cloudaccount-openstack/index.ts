// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack
...
export interface CloudaccountOpenstackConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack#ca_certificate CloudaccountOpenstack#ca_certificate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack#context CloudaccountOpenstack#context}
  */
  readonly context?: string;
  /**
  * The default domain of the OpenStack cloud that is used to connect to the OpenStack cloud.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack#default_domain CloudaccountOpenstack#default_domain}
  */
  readonly defaultDomain: string;
  /**
  * The default project of the OpenStack cloud that is used to connect to the OpenStack cloud.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack#default_project CloudaccountOpenstack#default_project}
  */
  readonly defaultProject: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack#id CloudaccountOpenstack#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack#identity_endpoint CloudaccountOpenstack#identity_endpoint}
  */
  readonly identityEndpoint: string;
  /**
  * Name of the OpenStack cloud account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack#name CloudaccountOpenstack#name}
  */
  readonly name: string;
  /**
  * Whether to allow insecure connections to the OpenStack cloud. Default is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack#openstack_allow_insecure CloudaccountOpenstack#openstack_allow_insecure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack#openstack_password CloudaccountOpenstack#openstack_password}
  */
  readonly openstackPassword: string;
  /**
  * The username of the OpenStack cloud that is used to connect to the OpenStack cloud.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack#openstack_username CloudaccountOpenstack#openstack_username}
  */
  readonly openstackUsername: string;
  /**
  * The parent region of the OpenStack cloud that is used to connect to the OpenStack cloud.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack#parent_region CloudaccountOpenstack#parent_region}
  */
  readonly parentRegion: string;
  /**
  * ID of the private cloud gateway that is used to connect to the OpenStack cloud.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack#private_cloud_gateway_id CloudaccountOpenstack#private_cloud_gateway_id}
  */
  readonly privateCloudGatewayId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack spectrocloud_cloudaccount_openstack}
*/
export class CloudaccountOpenstack extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudaccountOpenstack that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.25.2/docs/resources/cloudaccount_openstack spectrocloud_cloudaccount_openstack} Resource
  *
  * @param scope The scope in which to define this construct
