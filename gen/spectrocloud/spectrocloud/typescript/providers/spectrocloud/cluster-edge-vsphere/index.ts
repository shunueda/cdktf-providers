// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere
...
export interface ClusterEdgeVsphereConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#cluster_meta_attribute ClusterEdgeVsphere#cluster_meta_attribute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#context ClusterEdgeVsphere#context}
  */
  readonly context?: string;
  /**
  * The description of the cluster. Default value is empty string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#description ClusterEdgeVsphere#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#edge_host_uid ClusterEdgeVsphere#edge_host_uid}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#force_delete ClusterEdgeVsphere#force_delete}
  */
  readonly forceDelete?: boolean | cdktf.IResolvable;
  /**
  * Delay duration in minutes to before invoking cluster force delete. Default and minimum is 20.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#force_delete_delay ClusterEdgeVsphere#force_delete_delay}
  */
  readonly forceDeleteDelay?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#id ClusterEdgeVsphere#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#name ClusterEdgeVsphere#name}
  */
  readonly name: string;
  /**
  * Date and time after which to patch cluster `RFC3339: 2006-01-02T15:04:05Z07:00`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#os_patch_after ClusterEdgeVsphere#os_patch_after}
  */
  readonly osPatchAfter?: string;
  /**
  * Whether to apply OS patch on boot. Default is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#os_patch_on_boot ClusterEdgeVsphere#os_patch_on_boot}
  */
  readonly osPatchOnBoot?: boolean | cdktf.IResolvable;
  /**
  * Cron schedule for OS patching. This must be in the form of `0 0 * * *`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#os_patch_schedule ClusterEdgeVsphere#os_patch_schedule}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#pause_agent_upgrades ClusterEdgeVsphere#pause_agent_upgrades}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#review_repave_state ClusterEdgeVsphere#review_repave_state}
  */
  readonly reviewRepaveState?: string;
  /**
  * If `true`, the cluster will be created asynchronously. Default value is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#skip_completion ClusterEdgeVsphere#skip_completion}
  */
  readonly skipCompletion?: boolean | cdktf.IResolvable;
  /**
  * A list of tags to be applied to the cluster. Tags must be in the form of `key:value`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#tags ClusterEdgeVsphere#tags}
  */
  readonly tags?: string[];
  /**
  * backup_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#backup_policy ClusterEdgeVsphere#backup_policy}
  */
  readonly backupPolicy?: ClusterEdgeVsphereBackupPolicy;
  /**
  * cloud_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#cloud_config ClusterEdgeVsphere#cloud_config}
  */
  readonly cloudConfig: ClusterEdgeVsphereCloudConfig;
  /**
  * cluster_profile block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#cluster_profile ClusterEdgeVsphere#cluster_profile}
  */
  readonly clusterProfile?: ClusterEdgeVsphereClusterProfile[] | cdktf.IResolvable;
  /**
  * cluster_rbac_binding block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#cluster_rbac_binding ClusterEdgeVsphere#cluster_rbac_binding}
  */
  readonly clusterRbacBinding?: ClusterEdgeVsphereClusterRbacBinding[] | cdktf.IResolvable;
  /**
  * cluster_template block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#cluster_template ClusterEdgeVsphere#cluster_template}
  */
  readonly clusterTemplate?: ClusterEdgeVsphereClusterTemplate;
  /**
  * host_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#host_config ClusterEdgeVsphere#host_config}
  */
  readonly hostConfig?: ClusterEdgeVsphereHostConfig[] | cdktf.IResolvable;
  /**
  * location_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#location_config ClusterEdgeVsphere#location_config}
  */
  readonly locationConfig?: ClusterEdgeVsphereLocationConfig[] | cdktf.IResolvable;
  /**
  * machine_pool block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#machine_pool ClusterEdgeVsphere#machine_pool}
  */
  readonly machinePool: ClusterEdgeVsphereMachinePool[] | cdktf.IResolvable;
  /**
  * namespaces block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#namespaces ClusterEdgeVsphere#namespaces}
  */
  readonly namespaces?: ClusterEdgeVsphereNamespaces[] | cdktf.IResolvable;
  /**
  * scan_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#scan_policy ClusterEdgeVsphere#scan_policy}
  */
  readonly scanPolicy?: ClusterEdgeVsphereScanPolicy;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#timeouts ClusterEdgeVsphere#timeouts}
  */
...
export interface ClusterEdgeVsphereBackupPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#backup_location_id ClusterEdgeVsphere#backup_location_id}
  */
  readonly backupLocationId: string;
  /**
  * The list of cluster UIDs to include in the backup. If `include_all_clusters` is set to `true`, then all clusters will be included.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#cluster_uids ClusterEdgeVsphere#cluster_uids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#expiry_in_hour ClusterEdgeVsphere#expiry_in_hour}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#include_all_clusters ClusterEdgeVsphere#include_all_clusters}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#include_cluster_resources ClusterEdgeVsphere#include_cluster_resources}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#include_cluster_resources_mode ClusterEdgeVsphere#include_cluster_resources_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#include_disks ClusterEdgeVsphere#include_disks}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#prefix ClusterEdgeVsphere#prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#schedule ClusterEdgeVsphere#schedule}
  */
...
export interface ClusterEdgeVsphereCloudConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#datacenter ClusterEdgeVsphere#datacenter}
  */
  readonly datacenter: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#folder ClusterEdgeVsphere#folder}
  */
  readonly folder: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#image_template_folder ClusterEdgeVsphere#image_template_folder}
  */
  readonly imageTemplateFolder?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#network_search_domain ClusterEdgeVsphere#network_search_domain}
  */
  readonly networkSearchDomain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#network_type ClusterEdgeVsphere#network_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#ssh_key ClusterEdgeVsphere#ssh_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#ssh_keys ClusterEdgeVsphere#ssh_keys}
  */
  readonly sshKeys?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#static_ip ClusterEdgeVsphere#static_ip}
  */
  readonly staticIp?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#vip ClusterEdgeVsphere#vip}
  */
  readonly vip: string;
}
...
export interface ClusterEdgeVsphereClusterProfilePackManifest {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#content ClusterEdgeVsphere#content}
  */
...
export interface ClusterEdgeVsphereClusterProfilePack {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#registry_name ClusterEdgeVsphere#registry_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#registry_uid ClusterEdgeVsphere#registry_uid}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#tag ClusterEdgeVsphere#tag}
  */
  readonly tag?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#type ClusterEdgeVsphere#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#uid ClusterEdgeVsphere#uid}
  */
  readonly uid?: string;
  /**
  * The values of the pack. The values are the configuration values of the pack. The values are specified in YAML format. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#values ClusterEdgeVsphere#values}
  */
  readonly values?: string;
  /**
  * manifest block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#manifest ClusterEdgeVsphere#manifest}
  */
...
export interface ClusterEdgeVsphereClusterProfile {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#variables ClusterEdgeVsphere#variables}
  */
  readonly variables?: { [key: string]: string };
  /**
  * pack block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#pack ClusterEdgeVsphere#pack}
  */
...
export interface ClusterEdgeVsphereClusterRbacBindingSubjects {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#namespace ClusterEdgeVsphere#namespace}
  */
...
export interface ClusterEdgeVsphereClusterRbacBinding {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#role ClusterEdgeVsphere#role}
  */
  ...
  * subjects block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#subjects ClusterEdgeVsphere#subjects}
  */
...
export interface ClusterEdgeVsphereClusterTemplateClusterProfile {
  /**
...
export function clusterEdgeVsphereClusterTemplateClusterProfileToTerraform(struct?: ClusterEdgeVsphereClusterTemplateClusterProfile | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function clusterEdgeVsphereClusterTemplateClusterProfileToHclTerraform(struct?: ClusterEdgeVsphereClusterTemplateClusterProfile | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ClusterEdgeVsphereClusterTemplateClusterProfileOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ClusterEdgeVsphereClusterTemplateClusterProfile | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ClusterEdgeVsphereClusterTemplateClusterProfile | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._id = undefined;
...
export class ClusterEdgeVsphereClusterTemplateClusterProfileList extends cdktf.ComplexList {
  public internalValue? : ClusterEdgeVsphereClusterTemplateClusterProfile[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): ClusterEdgeVsphereClusterTemplateClusterProfileOutputReference {
    return new ClusterEdgeVsphereClusterTemplateClusterProfileOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface ClusterEdgeVsphereClusterTemplate {
  /**
...
export function clusterEdgeVsphereClusterTemplateToTerraform(struct?: ClusterEdgeVsphereClusterTemplateOutputReference | ClusterEdgeVsphereClusterTemplate): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    id: cdktf.stringToTerraform(struct!.id),
    cluster_profile: cdktf.listMapper(clusterEdgeVsphereClusterTemplateClusterProfileToTerraform, true)(struct!.clusterProfile),
  }
}


export function clusterEdgeVsphereClusterTemplateToHclTerraform(struct?: ClusterEdgeVsphereClusterTemplateOutputReference | ClusterEdgeVsphereClusterTemplate): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    cluster_profile: {
      value: cdktf.listMapperHcl(clusterEdgeVsphereClusterTemplateClusterProfileToHclTerraform, true)(struct!.clusterProfile),
      isBlock: true,
      type: "set",
      storageClassType: "ClusterEdgeVsphereClusterTemplateClusterProfileList",
    },
  };
...
export class ClusterEdgeVsphereClusterTemplateOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ClusterEdgeVsphereClusterTemplate | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._id !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: ClusterEdgeVsphereClusterTemplate | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._id = undefined;
  ...
  private _clusterProfile = new ClusterEdgeVsphereClusterTemplateClusterProfileList(this, "cluster_profile", true);
  public get clusterProfile() {
    return this._clusterProfile;
  }
  public putClusterProfile(value: ClusterEdgeVsphereClusterTemplateClusterProfile[] | cdktf.IResolvable) {
...
export interface ClusterEdgeVsphereHostConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#external_traffic_policy ClusterEdgeVsphere#external_traffic_policy}
  */
  readonly externalTrafficPolicy?: string;
  /**
  * The type of endpoint for the cluster. Can be either 'Ingress' or 'LoadBalancer'. The default is 'Ingress'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#host_endpoint_type ClusterEdgeVsphere#host_endpoint_type}
  */
  readonly hostEndpointType?: string;
  /**
  * The host for the Ingress endpoint. Required if 'host_endpoint_type' is set to 'Ingress'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#ingress_host ClusterEdgeVsphere#ingress_host}
  */
  readonly ingressHost?: string;
  /**
  * The source ranges for the load balancer. Required if 'host_endpoint_type' is set to 'LoadBalancer'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#load_balancer_source_ranges ClusterEdgeVsphere#load_balancer_source_ranges}
  */
...
export interface ClusterEdgeVsphereLocationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#country_code ClusterEdgeVsphere#country_code}
  */
  readonly countryCode?: string;
  /**
  * The name of the country.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#country_name ClusterEdgeVsphere#country_name}
  */
  readonly countryName?: string;
  /**
  * The latitude coordinates value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#latitude ClusterEdgeVsphere#latitude}
  */
  readonly latitude: number;
  /**
  * The longitude coordinates value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#longitude ClusterEdgeVsphere#longitude}
  */
  readonly longitude: number;
  /**
  * The region code of where the cluster is located in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#region_code ClusterEdgeVsphere#region_code}
  */
  readonly regionCode?: string;
  /**
  * The name of the region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#region_name ClusterEdgeVsphere#region_name}
  */
...
export interface ClusterEdgeVsphereMachinePoolInstanceType {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#cpu ClusterEdgeVsphere#cpu}
  */
  readonly cpu: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#disk_size_gb ClusterEdgeVsphere#disk_size_gb}
  */
  readonly diskSizeGb: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#memory_mb ClusterEdgeVsphere#memory_mb}
  */
...
export interface ClusterEdgeVsphereMachinePoolNode {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#action ClusterEdgeVsphere#action}
  */
  readonly action: string;
  /**
  * The node_id of the node, For example `i-07f899a33dee624f7`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#node_id ClusterEdgeVsphere#node_id}
  */
...
export interface ClusterEdgeVsphereMachinePoolPlacement {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#cluster ClusterEdgeVsphere#cluster}
  */
  readonly cluster: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#datastore ClusterEdgeVsphere#datastore}
  */
  readonly datastore: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#network ClusterEdgeVsphere#network}
  */
  readonly network: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#resource_pool ClusterEdgeVsphere#resource_pool}
  */
  readonly resourcePool: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#static_ip_pool_id ClusterEdgeVsphere#static_ip_pool_id}
  */
...
export interface ClusterEdgeVsphereMachinePoolTaints {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#effect ClusterEdgeVsphere#effect}
  */
  readonly effect: string;
  /**
  * The key of the taint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#key ClusterEdgeVsphere#key}
  */
  readonly key: string;
  /**
  * The value of the taint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#value ClusterEdgeVsphere#value}
  */
...
export interface ClusterEdgeVsphereMachinePool {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#additional_labels ClusterEdgeVsphere#additional_labels}
  */
  readonly additionalLabels?: { [key: string]: string };
  /**
  * Whether this machine pool is a control plane. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#control_plane ClusterEdgeVsphere#control_plane}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#control_plane_as_worker ClusterEdgeVsphere#control_plane_as_worker}
  */
  readonly controlPlaneAsWorker?: boolean | cdktf.IResolvable;
  /**
  * Number of nodes in the machine pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#count ClusterEdgeVsphere#count}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#node_repave_interval ClusterEdgeVsphere#node_repave_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#update_strategy ClusterEdgeVsphere#update_strategy}
  */
  readonly updateStrategy?: string;
  /**
  * instance_type block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#instance_type ClusterEdgeVsphere#instance_type}
  */
  readonly instanceType: ClusterEdgeVsphereMachinePoolInstanceType;
  /**
  * node block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#node ClusterEdgeVsphere#node}
  */
  readonly nodeAttribute?: ClusterEdgeVsphereMachinePoolNode[] | cdktf.IResolvable;
  /**
  * placement block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#placement ClusterEdgeVsphere#placement}
  */
  readonly placement: ClusterEdgeVsphereMachinePoolPlacement[] | cdktf.IResolvable;
  /**
  * taints block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#taints ClusterEdgeVsphere#taints}
  */
...
export interface ClusterEdgeVsphereNamespaces {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#resource_allocation ClusterEdgeVsphere#resource_allocation}
  */
...
export interface ClusterEdgeVsphereScanPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#configuration_scan_schedule ClusterEdgeVsphere#configuration_scan_schedule}
  */
  readonly configurationScanSchedule: string;
  /**
  * The schedule for conformance scan.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#conformance_scan_schedule ClusterEdgeVsphere#conformance_scan_schedule}
  */
  readonly conformanceScanSchedule: string;
  /**
  * The schedule for penetration scan.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#penetration_scan_schedule ClusterEdgeVsphere#penetration_scan_schedule}
  */
...
export interface ClusterEdgeVsphereTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#create ClusterEdgeVsphere#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#delete ClusterEdgeVsphere#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#update ClusterEdgeVsphere#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere spectrocloud_cluster_edge_vsphere}
*/
export class ClusterEdgeVsphere extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusterEdgeVsphere that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/cluster_edge_vsphere spectrocloud_cluster_edge_vsphere} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _clusterTemplate = new ClusterEdgeVsphereClusterTemplateOutputReference(this, "cluster_template");
  public get clusterTemplate() {
    return this._clusterTemplate;
  }
  public putClusterTemplate(value: ClusterEdgeVsphereClusterTemplate) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      cluster_template: clusterEdgeVsphereClusterTemplateToTerraform(this._clusterTemplate.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      cluster_template: {
        value: clusterEdgeVsphereClusterTemplateToHclTerraform(this._clusterTemplate.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ClusterEdgeVsphereClusterTemplateList",
      },
      host_config: {
