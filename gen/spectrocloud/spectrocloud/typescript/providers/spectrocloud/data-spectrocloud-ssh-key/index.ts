// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/ssh_key
...
export interface DataSpectrocloudSshKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/ssh_key#context DataSpectrocloudSshKey#context}
  */
  readonly context?: string;
  /**
  * The Id of the SSH key resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/ssh_key#id DataSpectrocloudSshKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/ssh_key#name DataSpectrocloudSshKey#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/ssh_key spectrocloud_ssh_key}
*/
export class DataSpectrocloudSshKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpectrocloudSshKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/ssh_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/data-sources/ssh_key spectrocloud_ssh_key} Data Source
  *
  * @param scope The scope in which to define this construct
