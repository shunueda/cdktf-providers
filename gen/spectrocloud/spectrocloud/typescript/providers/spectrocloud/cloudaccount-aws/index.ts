// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws
...
export interface CloudaccountAwsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#arn CloudaccountAws#arn}
  */
  readonly arn?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#aws_access_key CloudaccountAws#aws_access_key}
  */
  readonly awsAccessKey?: string;
  /**
  * The AWS secret key used in conjunction with the access key for authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#aws_secret_key CloudaccountAws#aws_secret_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#aws_secured_access_key CloudaccountAws#aws_secured_access_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#context CloudaccountAws#context}
  */
  readonly context?: string;
  /**
  * An optional external ID that can be used for cross-account access in AWS. Used for STS credential type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#external_id CloudaccountAws#external_id}
  */
  readonly externalId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#id CloudaccountAws#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#name CloudaccountAws#name}
  */
  ...
  * Default is 'aws'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#partition CloudaccountAws#partition}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#permission_boundary_arn CloudaccountAws#permission_boundary_arn}
  */
  readonly permissionBoundaryArn?: string;
  /**
  * A set of ARNs for the IAM policies that should be associated with the cloud account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#policy_arns CloudaccountAws#policy_arns}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#private_cloud_gateway_id CloudaccountAws#private_cloud_gateway_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#role_arn CloudaccountAws#role_arn}
  */
  readonly roleArn?: string;
  /**
  * The type of AWS credentials to use. Can be `secret`, `sts`, or `pod-identity`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#type CloudaccountAws#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws spectrocloud_cloudaccount_aws}
*/
export class CloudaccountAws extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudaccountAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.2/docs/resources/cloudaccount_aws spectrocloud_cloudaccount_aws} Resource
  *
  * @param scope The scope in which to define this construct
