// https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance
...
export interface ApplianceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance#id Appliance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance#pairing_key Appliance#pairing_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance#remote_shell Appliance#remote_shell}
  */
  readonly remoteShell?: string;
  /**
  * A set of key-value pairs that can be used to organize and categorize the appliance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance#tags Appliance#tags}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance#temporary_shell_credentials Appliance#temporary_shell_credentials}
  */
  readonly temporaryShellCredentials?: string;
  /**
  * The unique identifier (UID) for the appliance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance#uid Appliance#uid}
  */
  readonly uid: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance#wait Appliance#wait}
  */
  readonly wait?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance#timeouts Appliance#timeouts}
  */
  readonly timeouts?: ApplianceTimeouts;
}
export interface ApplianceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance#create Appliance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance#delete Appliance#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance#update Appliance#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance spectrocloud_appliance}
*/
export class Appliance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Appliance that should be imported. Refer to the {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spectrocloud/spectrocloud/0.26.0/docs/resources/appliance spectrocloud_appliance} Resource
  *
  * @param scope The scope in which to define this construct
