// https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.3/docs/data-sources/flag_trigger
...
export class DataLaunchdarklyFlagTrigger extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLaunchdarklyFlagTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.3/docs/data-sources/flag_trigger#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.3/docs/data-sources/flag_trigger launchdarkly_flag_trigger} Data Source
  *
  * @param scope The scope in which to define this construct
