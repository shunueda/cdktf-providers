// https://registry.terraform.io/providers/rundeck/rundeck/1.0.0/docs/resources/system_runner
...
export interface SystemRunnerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rundeck/rundeck/1.0.0/docs/resources/system_runner#assigned_projects SystemRunner#assigned_projects}
  */
  readonly assignedProjects?: { [key: string]: string };
  /**
  * Description of the runner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rundeck/rundeck/1.0.0/docs/resources/system_runner#description SystemRunner#description}
  */
  readonly description: string;
  /**
  * Installation type of the runner (linux, windows, kubernetes, docker).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rundeck/rundeck/1.0.0/docs/resources/system_runner#installation_type SystemRunner#installation_type}
  */
  readonly installationType?: string;
  /**
  * Name of the runner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rundeck/rundeck/1.0.0/docs/resources/system_runner#name SystemRunner#name}
  */
  readonly name: string;
  /**
  * Map of projects where runner acts as node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rundeck/rundeck/1.0.0/docs/resources/system_runner#project_runner_as_node SystemRunner#project_runner_as_node}
  */
  readonly projectRunnerAsNode?: { [key: string]: (boolean | cdktf.IResolvable) };
  /**
  * Replica type of the runner (manual or ephemeral).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rundeck/rundeck/1.0.0/docs/resources/system_runner#replica_type SystemRunner#replica_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rundeck/rundeck/1.0.0/docs/resources/system_runner#tag_names SystemRunner#tag_names}
  */
  readonly tagNames?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rundeck/rundeck/1.0.0/docs/resources/system_runner rundeck_system_runner}
*/
export class SystemRunner extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemRunner that should be imported. Refer to the {@link https://registry.terraform.io/providers/rundeck/rundeck/1.0.0/docs/resources/system_runner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rundeck/rundeck/1.0.0/docs/resources/system_runner rundeck_system_runner} Resource
  *
  * @param scope The scope in which to define this construct
