// https://registry.terraform.io/providers/koyeb/koyeb/0.1.11/docs/data-sources/domain
...
export interface DataKoyebDomainConfig extends cdktf.TerraformMetaArguments {
  /**
  * The app name the domain is assigned to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/koyeb/koyeb/0.1.11/docs/data-sources/domain#app_name DataKoyebDomain#app_name}
  */
  readonly appName?: string;
  /**
  * The deployment group assigned to the domain
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/koyeb/koyeb/0.1.11/docs/data-sources/domain#deployment_group DataKoyebDomain#deployment_group}
  */
  readonly deploymentGroup?: string;
  /**
  * The CNAME record to point the domain to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/koyeb/koyeb/0.1.11/docs/data-sources/domain#intended_cname DataKoyebDomain#intended_cname}
  */
  readonly intendedCname?: string;
  /**
  * The status messages of the domain
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/koyeb/koyeb/0.1.11/docs/data-sources/domain#messages DataKoyebDomain#messages}
  */
  readonly messages?: string;
  /**
  * The domain name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/koyeb/koyeb/0.1.11/docs/data-sources/domain#name DataKoyebDomain#name}
  */
  readonly name: string;
  /**
  * The date and time of when the domain was last verified
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/koyeb/koyeb/0.1.11/docs/data-sources/domain#verified_at DataKoyebDomain#verified_at}
  */
  readonly verifiedAt?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/koyeb/koyeb/0.1.11/docs/data-sources/domain koyeb_domain}
*/
export class DataKoyebDomain extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataKoyebDomain resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataKoyebDomain to import
  * @param importFromId The id of the existing DataKoyebDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/koyeb/koyeb/0.1.11/docs/data-sources/domain#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataKoyebDomain to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/koyeb/koyeb/0.1.11/docs/data-sources/domain koyeb_domain} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataKoyebDomainConfig
  */
  public constructor(scope: Construct, id: string, config: DataKoyebDomainConfig) {
    super(scope, id, {
