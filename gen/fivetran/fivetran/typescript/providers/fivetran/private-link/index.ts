// https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/private_link
...
export interface PrivateLinkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/private_link#config_map PrivateLink#config_map}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/private_link#name PrivateLink#name}
  */
  readonly name: string;
  /**
  * Data processing location. This is where Fivetran will operate and run computation on data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/private_link#region PrivateLink#region}
  */
  readonly region: string;
  /**
  * Service type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/private_link#service PrivateLink#service}
  */
  readonly service: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/private_link fivetran_private_link}
*/
export class PrivateLink extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/private_link#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/private_link fivetran_private_link} Resource
  *
  * @param scope The scope in which to define this construct
