// https://registry.terraform.io/providers/fivetran/fivetran/1.9.13/docs
...
export interface FivetranProviderConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.13/docs#api_key FivetranProvider#api_key}
  */
  readonly apiKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.13/docs#api_secret FivetranProvider#api_secret}
  */
  readonly apiSecret?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.13/docs#api_url FivetranProvider#api_url}
  */
  readonly apiUrl?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.13/docs#alias FivetranProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.13/docs fivetran}
*/
export class FivetranProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing FivetranProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.13/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.13/docs fivetran} Resource
  *
  * @param scope The scope in which to define this construct
