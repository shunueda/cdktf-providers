// https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project
...
export interface TransformationProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project#group_id TransformationProject#group_id}
  */
  readonly groupId: string;
  /**
  * Specifies whether the setup tests should be run automatically. The default value is TRUE.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project#run_tests TransformationProject#run_tests}
  */
  readonly runTests?: boolean | cdktf.IResolvable;
  /**
  * Transformation project type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project#type TransformationProject#type}
  */
  readonly type: string;
  /**
  * project_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project#project_config TransformationProject#project_config}
  */
...
export interface TransformationProjectProjectConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project#dbt_version TransformationProject#dbt_version}
  */
  readonly dbtVersion?: string;
  /**
  * Default schema in destination. This production schema will contain your transformed data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project#default_schema TransformationProject#default_schema}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project#environment_vars TransformationProject#environment_vars}
  */
  readonly environmentVars?: string[];
  /**
  * Folder in Git repo with your transformation project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project#folder_path TransformationProject#folder_path}
  */
  readonly folderPath?: string;
  /**
  * Git branch
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project#git_branch TransformationProject#git_branch}
  */
  readonly gitBranch?: string;
  /**
  * Git remote URL with your transformation project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project#git_remote_url TransformationProject#git_remote_url}
  */
  readonly gitRemoteUrl?: string;
  /**
  * Target name to set or override the value from the deployment.yaml
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project#target_name TransformationProject#target_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project#threads TransformationProject#threads}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project fivetran_transformation_project}
*/
export class TransformationProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransformationProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/transformation_project fivetran_transformation_project} Resource
  *
  * @param scope The scope in which to define this construct
