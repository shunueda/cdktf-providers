// https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user_group_membership
...
export interface UserGroupMembershipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user_group_membership#user_id UserGroupMembership#user_id}
  */
  readonly userId: string;
  /**
  * group block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user_group_membership#group UserGroupMembership#group}
  */
...
export interface UserGroupMembershipGroup {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user_group_membership#group_id UserGroupMembership#group_id}
  */
  readonly groupId: string;
  /**
  * The user's role that links the user and the group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user_group_membership#role UserGroupMembership#role}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user_group_membership fivetran_user_group_membership}
*/
export class UserGroupMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserGroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user_group_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user_group_membership fivetran_user_group_membership} Resource
  *
  * @param scope The scope in which to define this construct
