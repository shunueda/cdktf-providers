// https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/webhooks
...
export interface DataFivetranWebhooksWebhooks {
  ...
  * The webhook ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/webhooks#id DataFivetranWebhooks#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/webhooks fivetran_webhooks}
*/
export class DataFivetranWebhooks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFivetranWebhooks that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/webhooks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/webhooks fivetran_webhooks} Data Source
  *
  * @param scope The scope in which to define this construct
