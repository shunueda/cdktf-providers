// https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/data-sources/destination
...
export interface DataFivetranDestinationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/data-sources/destination#id DataFivetranDestination#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/data-sources/destination fivetran_destination}
*/
export class DataFivetranDestination extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFivetranDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/data-sources/destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/data-sources/destination fivetran_destination} Data Source
  *
  * @param scope The scope in which to define this construct
