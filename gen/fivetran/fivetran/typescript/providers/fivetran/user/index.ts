// https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user
...
export interface UserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user#email User#email}
  */
  readonly email: string;
  /**
  * The last name of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user#family_name User#family_name}
  */
  readonly familyName: string;
  /**
  * The first name of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user#given_name User#given_name}
  */
  readonly givenName: string;
  /**
  * The field indicates whether the user has been invited to your account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user#invited User#invited}
  */
  readonly invited?: boolean | cdktf.IResolvable;
  /**
  * The phone number of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user#phone User#phone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user#picture User#picture}
  */
  readonly picture?: string;
  /**
  * The role that you would like to assign to the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user#role User#role}
  */
  readonly role?: string;
  /**
  * The field indicates whether the user has verified their email address in the account creation process.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user#verified User#verified}
  */
  readonly verified?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user fivetran_user}
*/
export class User extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing User that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/resources/user fivetran_user} Resource
  *
  * @param scope The scope in which to define this construct
