// https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/quickstart_package
...
export interface DataFivetranQuickstartPackageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/quickstart_package#id DataFivetranQuickstartPackage#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/quickstart_package fivetran_quickstart_package}
*/
export class DataFivetranQuickstartPackage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFivetranQuickstartPackage that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/quickstart_package#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/quickstart_package fivetran_quickstart_package} Data Source
  *
  * @param scope The scope in which to define this construct
