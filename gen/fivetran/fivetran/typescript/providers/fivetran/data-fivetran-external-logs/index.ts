// https://registry.terraform.io/providers/fivetran/fivetran/1.9.13/docs/data-sources/external_logs
...
export interface DataFivetranExternalLogsConfig extends cdktf.TerraformMetaArguments {
  ...
  * logs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.13/docs/data-sources/external_logs#logs DataFivetranExternalLogs#logs}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.13/docs/data-sources/external_logs fivetran_external_logs}
*/
export class DataFivetranExternalLogs extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFivetranExternalLogs that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.13/docs/data-sources/external_logs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.13/docs/data-sources/external_logs fivetran_external_logs} Data Source
  *
  * @param scope The scope in which to define this construct
