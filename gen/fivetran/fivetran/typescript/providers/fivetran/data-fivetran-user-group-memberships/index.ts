// https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/user_group_memberships
...
export interface DataFivetranUserGroupMembershipsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/user_group_memberships#user_id DataFivetranUserGroupMemberships#user_id}
  */
  readonly userId: string;
  /**
  * group block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/user_group_memberships#group DataFivetranUserGroupMemberships#group}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/user_group_memberships fivetran_user_group_memberships}
*/
export class DataFivetranUserGroupMemberships extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFivetranUserGroupMemberships that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/user_group_memberships#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/user_group_memberships fivetran_user_group_memberships} Data Source
  *
  * @param scope The scope in which to define this construct
