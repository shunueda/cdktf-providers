// https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/connector_schedule
...
export interface ConnectorScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/connector_schedule#connector_id ConnectorSchedule#connector_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/connector_schedule#connector_name ConnectorSchedule#connector_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/connector_schedule#daily_sync_time ConnectorSchedule#daily_sync_time}
  */
  readonly dailySyncTime?: string;
  /**
  * The unique identifier for the Group (Destination) within the Fivetran system.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/connector_schedule#group_id ConnectorSchedule#group_id}
  */
  readonly groupId?: string;
  /**
  * Specifies whether the connector should be paused after the free trial period has ended.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/connector_schedule#pause_after_trial ConnectorSchedule#pause_after_trial}
  */
  readonly pauseAfterTrial?: string;
  /**
  * Specifies whether the connector is paused.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/connector_schedule#paused ConnectorSchedule#paused}
  */
  readonly paused?: string;
  /**
  * The connector schedule configuration type. Supported values: auto, manual.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/connector_schedule#schedule_type ConnectorSchedule#schedule_type}
  */
  readonly scheduleType?: string;
  /**
  * The connector sync frequency in minutes. Supported values: 1, 5, 15, 30, 60, 120, 180, 360, 480, 720, 1440.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/connector_schedule#sync_frequency ConnectorSchedule#sync_frequency}
  */
  readonly syncFrequency?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/connector_schedule fivetran_connector_schedule}
*/
export class ConnectorSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectorSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/connector_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/connector_schedule fivetran_connector_schedule} Resource
  *
  * @param scope The scope in which to define this construct
