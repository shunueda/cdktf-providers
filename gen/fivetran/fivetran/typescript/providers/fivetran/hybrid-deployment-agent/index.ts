// https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/hybrid_deployment_agent
...
export interface HybridDeploymentAgentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/hybrid_deployment_agent#auth_type HybridDeploymentAgent#auth_type}
  */
  readonly authType: string;
  /**
  * Determines whether re-authentication needs to be performed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/hybrid_deployment_agent#authentication_counter HybridDeploymentAgent#authentication_counter}
  */
  readonly authenticationCounter?: number;
  /**
  * The unique name for the hybrid deployment agent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/hybrid_deployment_agent#display_name HybridDeploymentAgent#display_name}
  */
  readonly displayName: string;
  /**
  * Environment type. Possible values `DOCKER`,`PODMAN`,`KUBERNETES`,`SNOWPARK`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/hybrid_deployment_agent#env_type HybridDeploymentAgent#env_type}
  */
  readonly envType: string;
  /**
  * The unique identifier for the Group within the Fivetran system.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/hybrid_deployment_agent#group_id HybridDeploymentAgent#group_id}
  */
  readonly groupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/hybrid_deployment_agent fivetran_hybrid_deployment_agent}
*/
export class HybridDeploymentAgent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HybridDeploymentAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/hybrid_deployment_agent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/hybrid_deployment_agent fivetran_hybrid_deployment_agent} Resource
  *
  * @param scope The scope in which to define this construct
