// https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/connectors_metadata
...
export interface DataFivetranConnectorsMetadataConfig extends cdktf.TerraformMetaArguments {
  ...
  * sources block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/connectors_metadata#sources DataFivetranConnectorsMetadata#sources}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/connectors_metadata fivetran_connectors_metadata}
*/
export class DataFivetranConnectorsMetadata extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFivetranConnectorsMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/connectors_metadata#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/data-sources/connectors_metadata fivetran_connectors_metadata} Data Source
  *
  * @param scope The scope in which to define this construct
