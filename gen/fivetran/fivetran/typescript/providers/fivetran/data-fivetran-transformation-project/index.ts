// https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/transformation_project
...
export interface DataFivetranTransformationProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/transformation_project#id DataFivetranTransformationProject#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/transformation_project fivetran_transformation_project}
*/
export class DataFivetranTransformationProject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFivetranTransformationProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/transformation_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/transformation_project fivetran_transformation_project} Data Source
  *
  * @param scope The scope in which to define this construct
