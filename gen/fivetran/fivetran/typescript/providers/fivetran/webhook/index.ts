// https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/resources/webhook
...
export interface WebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/resources/webhook#active Webhook#active}
  */
  readonly active: boolean | cdktf.IResolvable;
  /**
  * The array of event types
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/resources/webhook#events Webhook#events}
  */
  readonly events: string[];
  /**
  * The group ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/resources/webhook#group_id Webhook#group_id}
  */
  readonly groupId?: string;
  /**
  * Specifies whether the setup tests should be run
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/resources/webhook#run_tests Webhook#run_tests}
  */
  readonly runTests?: boolean | cdktf.IResolvable;
  /**
  * The secret string used for payload signing and masked in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/resources/webhook#secret Webhook#secret}
  */
  readonly secret: string;
  /**
  * The webhook type (group, account)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/resources/webhook#type Webhook#type}
  */
  readonly type: string;
  /**
  * Your webhooks URL endpoint for your application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/resources/webhook#url Webhook#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/resources/webhook fivetran_webhook}
*/
export class Webhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Webhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/resources/webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.18/docs/resources/webhook fivetran_webhook} Resource
  *
  * @param scope The scope in which to define this construct
