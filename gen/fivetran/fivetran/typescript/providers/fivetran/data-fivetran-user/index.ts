// https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/user
...
export interface DataFivetranUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/user#id DataFivetranUser#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/user fivetran_user}
*/
export class DataFivetranUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFivetranUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/data-sources/user fivetran_user} Data Source
  *
  * @param scope The scope in which to define this construct
