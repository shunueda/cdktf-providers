// https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/user_connector_membership
...
export interface UserConnectorMembershipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/user_connector_membership#user_id UserConnectorMembership#user_id}
  */
  readonly userId: string;
  /**
  * connector block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/user_connector_membership#connector UserConnectorMembership#connector}
  */
...
export interface UserConnectorMembershipConnector {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/user_connector_membership#connector_id UserConnectorMembership#connector_id}
  */
  readonly connectorId: string;
  /**
  * The user's role that links the user and the connector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/user_connector_membership#role UserConnectorMembership#role}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/user_connector_membership fivetran_user_connector_membership}
*/
export class UserConnectorMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserConnectorMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/user_connector_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.16/docs/resources/user_connector_membership fivetran_user_connector_membership} Resource
  *
  * @param scope The scope in which to define this construct
