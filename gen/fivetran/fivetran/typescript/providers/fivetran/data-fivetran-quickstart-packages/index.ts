// https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/data-sources/quickstart_packages
...
export interface DataFivetranQuickstartPackagesConfig extends cdktf.TerraformMetaArguments {
  ...
  * packages block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/data-sources/quickstart_packages#packages DataFivetranQuickstartPackages#packages}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/data-sources/quickstart_packages fivetran_quickstart_packages}
*/
export class DataFivetranQuickstartPackages extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFivetranQuickstartPackages that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/data-sources/quickstart_packages#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.15/docs/data-sources/quickstart_packages fivetran_quickstart_packages} Data Source
  *
  * @param scope The scope in which to define this construct
