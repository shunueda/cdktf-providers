// https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/proxy_agent
...
export interface ProxyAgentConfig extends cdktf.TerraformMetaArguments {
  ...
  * Proxy agent name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/proxy_agent#display_name ProxyAgent#display_name}
  */
  readonly displayName: string;
  /**
  * Data processing location. This is where Fivetran will operate and run computation on data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/proxy_agent#group_region ProxyAgent#group_region}
  */
  readonly groupRegion: string;
  /**
  * Determines whether regenerarion secrets needs to be performed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/proxy_agent#regeneration_counter ProxyAgent#regeneration_counter}
  */
  readonly regenerationCounter?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/proxy_agent fivetran_proxy_agent}
*/
export class ProxyAgent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProxyAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/proxy_agent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.17/docs/resources/proxy_agent fivetran_proxy_agent} Resource
  *
  * @param scope The scope in which to define this construct
