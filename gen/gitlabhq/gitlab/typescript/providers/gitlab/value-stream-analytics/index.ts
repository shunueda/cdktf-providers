// https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.0/docs/resources/value_stream_analytics
...
export class ValueStreamAnalytics extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ValueStreamAnalytics that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.0/docs/resources/value_stream_analytics#import import section} in the documentation of this resource for the id to use
