// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token
...
export interface ProjectAccessTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token#access_level ProjectAccessToken#access_level}
  */
  readonly accessLevel?: string;
  /**
  * The description of the project access token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token#description ProjectAccessToken#description}
  */
  readonly description?: string;
  /**
  * When the token will expire, YYYY-MM-DD format. Is automatically set when `rotation_configuration` is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token#expires_at ProjectAccessToken#expires_at}
  */
  readonly expiresAt?: string;
  /**
  * The name of the project access token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token#name ProjectAccessToken#name}
  */
  readonly name: string;
  /**
  * The ID or full path of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token#project ProjectAccessToken#project}
  */
  readonly project: string;
  /**
  * The configuration for when to rotate a token automatically. Will not rotate a token until `terraform apply` is run.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token#rotation_configuration ProjectAccessToken#rotation_configuration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token#scopes ProjectAccessToken#scopes}
  */
  readonly scopes: string[];
  /**
  * Wether to validate if the expiration date is in the future.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token#validate_past_expiration_date ProjectAccessToken#validate_past_expiration_date}
  */
...
export interface ProjectAccessTokenRotationConfiguration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token#expiration_days ProjectAccessToken#expiration_days}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token#rotate_before_days ProjectAccessToken#rotate_before_days}
  */
  readonly rotateBeforeDays: number;
}

export function projectAccessTokenRotationConfigurationToTerraform(struct?: ProjectAccessTokenRotationConfiguration | cdktf.IResolvable): any {
...
export function projectAccessTokenRotationConfigurationToHclTerraform(struct?: ProjectAccessTokenRotationConfiguration | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ProjectAccessTokenRotationConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ProjectAccessTokenRotationConfiguration | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ProjectAccessTokenRotationConfiguration | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token gitlab_project_access_token}
*/
export class ProjectAccessToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectAccessToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_access_token gitlab_project_access_token} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _rotationConfiguration = new ProjectAccessTokenRotationConfigurationOutputReference(this, "rotation_configuration");
  public get rotationConfiguration() {
    return this._rotationConfiguration;
  }
  public putRotationConfiguration(value: ProjectAccessTokenRotationConfiguration) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rotation_configuration: projectAccessTokenRotationConfigurationToTerraform(this._rotationConfiguration.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rotation_configuration: {
        value: projectAccessTokenRotationConfigurationToHclTerraform(this._rotationConfiguration.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ProjectAccessTokenRotationConfiguration",
      },
      scopes: {
