// https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.0/docs/resources/system_hook
...
export class SystemHook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemHook that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.0/docs/resources/system_hook#import import section} in the documentation of this resource for the id to use
