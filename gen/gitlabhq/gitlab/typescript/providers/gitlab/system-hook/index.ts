// https://registry.terraform.io/providers/gitlabhq/gitlab/18.5.0/docs/resources/system_hook
...
export class SystemHook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemHook that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.5.0/docs/resources/system_hook#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SystemHook to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "gitlab_system_hook", importId: importFromId, provider });
      }
