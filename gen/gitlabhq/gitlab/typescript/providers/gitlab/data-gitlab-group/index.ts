// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group
...
export interface DataGitlabGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group#full_path DataGitlabGroup#full_path}
  */
  readonly fullPath?: string;
  /**
  * The ID of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group#group_id DataGitlabGroup#group_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group gitlab_group}
*/
export class DataGitlabGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group gitlab_group} Data Source
  *
  * @param scope The scope in which to define this construct
