// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scope
...
export interface ProjectJobTokenScopeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scope#project ProjectJobTokenScope#project}
  */
  readonly project: string;
  /**
  * The ID of the group that is in the CI/CD job token inbound allowlist.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scope#target_group_id ProjectJobTokenScope#target_group_id}
  */
  readonly targetGroupId?: number;
  /**
  * The ID of the project that is in the CI/CD job token inbound allowlist.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scope#target_project_id ProjectJobTokenScope#target_project_id}
  */
  readonly targetProjectId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scope gitlab_project_job_token_scope}
*/
export class ProjectJobTokenScope extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectJobTokenScope that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scope#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scope gitlab_project_job_token_scope} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _targetGroupId?: number; 
  public get targetGroupId() {
    return this.getNumberAttribute('target_group_id');
  }
  public set targetGroupId(value: number) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      target_group_id: cdktf.numberToTerraform(this._targetGroupId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      target_group_id: {
        value: cdktf.numberToHclTerraform(this._targetGroupId),
        isBlock: false,
        type: "simple",
