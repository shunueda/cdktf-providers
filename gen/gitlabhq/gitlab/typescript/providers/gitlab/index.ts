...
export * as dataGitlabGroupServiceAccountAccessTokens from './data-gitlab-group-service-account-access-tokens';
...
export * as dataGitlabProjectIssueLabelEvents from './data-gitlab-project-issue-label-events';
...
export * as dataGitlabProjectSecureFile from './data-gitlab-project-secure-file';
...
export * as dataGitlabSecurityPolicyDocument from './data-gitlab-security-policy-document';
