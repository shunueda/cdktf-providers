// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_dependency_proxy
...
export interface GroupDependencyProxyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_dependency_proxy#enabled GroupDependencyProxy#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The ID or URL-encoded path of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_dependency_proxy#group GroupDependencyProxy#group}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_dependency_proxy#identity GroupDependencyProxy#identity}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_dependency_proxy#secret GroupDependencyProxy#secret}
  */
  readonly secret?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_dependency_proxy gitlab_group_dependency_proxy}
*/
export class GroupDependencyProxy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupDependencyProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_dependency_proxy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_dependency_proxy gitlab_group_dependency_proxy} Resource
  *
  * @param scope The scope in which to define this construct
