// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/cluster_agents
...
export interface DataGitlabClusterAgentsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/cluster_agents#project DataGitlabClusterAgents#project}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/cluster_agents gitlab_cluster_agents}
*/
export class DataGitlabClusterAgents extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabClusterAgents that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/cluster_agents#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/cluster_agents gitlab_cluster_agents} Data Source
  *
  * @param scope The scope in which to define this construct
