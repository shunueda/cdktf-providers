// https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.1/docs/data-sources/compliance_framework
...
export class DataGitlabComplianceFramework extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabComplianceFramework that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.1/docs/data-sources/compliance_framework#import import section} in the documentation of this resource for the id to use
