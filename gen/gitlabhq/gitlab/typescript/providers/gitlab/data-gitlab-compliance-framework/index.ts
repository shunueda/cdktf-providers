// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/compliance_framework
...
export interface DataGitlabComplianceFrameworkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/compliance_framework#name DataGitlabComplianceFramework#name}
  */
  readonly name: string;
  /**
  * Full path of the namespace to where the compliance framework is.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/compliance_framework#namespace_path DataGitlabComplianceFramework#namespace_path}
  */
  readonly namespacePath: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/compliance_framework gitlab_compliance_framework}
*/
export class DataGitlabComplianceFramework extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabComplianceFramework that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/compliance_framework#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/compliance_framework gitlab_compliance_framework} Data Source
  *
  * @param scope The scope in which to define this construct
