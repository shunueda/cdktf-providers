// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project
...
export interface DataGitlabProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project#ci_default_git_depth DataGitlabProject#ci_default_git_depth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project#ci_id_token_sub_claim_components DataGitlabProject#ci_id_token_sub_claim_components}
  */
  readonly ciIdTokenSubClaimComponents?: string[];
  /**
  * The integer that uniquely identifies the project within the gitlab install.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project#id DataGitlabProject#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project#path_with_namespace DataGitlabProject#path_with_namespace}
  */
  readonly pathWithNamespace?: string;
  /**
  * If true, jobs can be viewed by non-project members.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project#public_builds DataGitlabProject#public_builds}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project gitlab_project}
*/
export class DataGitlabProject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project gitlab_project} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // merge_trains_skip_train_allowed - computed: true, optional: false, required: false
  public get mergeTrainsSkipTrainAllowed() {
    return this.getBooleanAttribute('merge_trains_skip_train_allowed');
  }
