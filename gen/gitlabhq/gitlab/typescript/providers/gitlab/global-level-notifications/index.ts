// https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.0/docs/resources/global_level_notifications
...
export class GlobalLevelNotifications extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlobalLevelNotifications that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.0/docs/resources/global_level_notifications#import import section} in the documentation of this resource for the id to use
