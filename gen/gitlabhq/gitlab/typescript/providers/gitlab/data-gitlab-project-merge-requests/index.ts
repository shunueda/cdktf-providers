// https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.1/docs/data-sources/project_merge_requests
...
export class DataGitlabProjectMergeRequests extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabProjectMergeRequests that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.1/docs/data-sources/project_merge_requests#import import section} in the documentation of this resource for the id to use
