// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_badge
...
export interface ProjectBadgeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_badge#id ProjectBadge#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_badge#image_url ProjectBadge#image_url}
  */
  readonly imageUrl: string;
  /**
  * The url linked with the badge.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_badge#link_url ProjectBadge#link_url}
  */
  readonly linkUrl: string;
  /**
  * The name of the badge.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_badge#name ProjectBadge#name}
  */
  readonly name?: string;
  /**
  * The id of the project to add the badge to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_badge#project ProjectBadge#project}
  */
  readonly project: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_badge gitlab_project_badge}
*/
export class ProjectBadge extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectBadge that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_badge#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_badge gitlab_project_badge} Resource
  *
  * @param scope The scope in which to define this construct
