// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner
...
export interface RunnerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner#access_level Runner#access_level}
  */
  readonly accessLevel?: string;
  /**
  * The runner's description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner#description Runner#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner#id Runner#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner#locked Runner#locked}
  */
  readonly locked?: boolean | cdktf.IResolvable;
  /**
  * Free-form maintenance notes for the runner (1024 characters).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner#maintenance_note Runner#maintenance_note}
  */
  readonly maintenanceNote?: string;
  /**
  * Maximum timeout set when this runner handles the job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner#maximum_timeout Runner#maximum_timeout}
  */
  readonly maximumTimeout?: number;
  /**
  * Whether the runner should ignore new jobs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner#paused Runner#paused}
  */
  readonly paused?: boolean | cdktf.IResolvable;
  /**
  * The registration token used to register the runner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner#registration_token Runner#registration_token}
  */
  readonly registrationToken: string;
  /**
  * Whether the runner should handle untagged jobs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner#run_untagged Runner#run_untagged}
  */
  readonly runUntagged?: boolean | cdktf.IResolvable;
  /**
  * List of runner’s tags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner#tag_list Runner#tag_list}
  */
  readonly tagList?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner gitlab_runner}
*/
export class Runner extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Runner that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/runner gitlab_runner} Resource
  *
  * @param scope The scope in which to define this construct
