// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file
...
export interface RepositoryFileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#author_email RepositoryFile#author_email}
  */
  readonly authorEmail?: string;
  /**
  * Name of the commit author.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#author_name RepositoryFile#author_name}
  */
  readonly authorName?: string;
  /**
  * Name of the branch to which to commit to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#branch RepositoryFile#branch}
  */
  readonly branch: string;
  /**
  * Commit message.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#commit_message RepositoryFile#commit_message}
  */
  readonly commitMessage?: string;
  /**
  * File content.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#content RepositoryFile#content}
  */
  readonly content: string;
  /**
  * Create commit message.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#create_commit_message RepositoryFile#create_commit_message}
  */
  readonly createCommitMessage?: string;
  /**
  * Delete Commit message.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#delete_commit_message RepositoryFile#delete_commit_message}
  */
  readonly deleteCommitMessage?: string;
  /**
  * The file content encoding. Valid values are: `base64`, `text`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#encoding RepositoryFile#encoding}
  */
  readonly encoding: string;
  /**
  * Enables or disables the execute flag on the file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#execute_filemode RepositoryFile#execute_filemode}
  */
  readonly executeFilemode?: boolean | cdktf.IResolvable;
  /**
  * The full path of the file. It must be relative to the root of the project without a leading slash `/` or `./`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#file_path RepositoryFile#file_path}
  */
  readonly filePath: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#id RepositoryFile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#overwrite_on_create RepositoryFile#overwrite_on_create}
  */
  readonly overwriteOnCreate?: boolean | cdktf.IResolvable;
  /**
  * The name or ID of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#project RepositoryFile#project}
  */
  readonly project: string;
  /**
  * Name of the branch to start the new commit from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#start_branch RepositoryFile#start_branch}
  */
  readonly startBranch?: string;
  /**
  * Update commit message.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#update_commit_message RepositoryFile#update_commit_message}
  */
  readonly updateCommitMessage?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#timeouts RepositoryFile#timeouts}
  */
  readonly timeouts?: RepositoryFileTimeouts;
}
export interface RepositoryFileTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#create RepositoryFile#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#delete RepositoryFile#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#update RepositoryFile#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file gitlab_repository_file}
*/
export class RepositoryFile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RepositoryFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/repository_file gitlab_repository_file} Resource
  *
  * @param scope The scope in which to define this construct
