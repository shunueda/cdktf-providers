// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project_approval_rules
...
export interface DataGitlabProjectApprovalRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project_approval_rules#project DataGitlabProjectApprovalRules#project}
  */
  readonly project: string;
  /**
  * approval_rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project_approval_rules#approval_rules DataGitlabProjectApprovalRules#approval_rules}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project_approval_rules gitlab_project_approval_rules}
*/
export class DataGitlabProjectApprovalRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabProjectApprovalRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project_approval_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project_approval_rules gitlab_project_approval_rules} Data Source
  *
  * @param scope The scope in which to define this construct
