// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project
...
export interface ProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#allow_merge_on_skipped_pipeline Project#allow_merge_on_skipped_pipeline}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#allow_pipeline_trigger_approve_deployment Project#allow_pipeline_trigger_approve_deployment}
  */
  readonly allowPipelineTriggerApproveDeployment?: boolean | cdktf.IResolvable;
  /**
  * Set the analytics access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#analytics_access_level Project#analytics_access_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#approvals_before_merge Project#approvals_before_merge}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#archive_on_destroy Project#archive_on_destroy}
  */
  readonly archiveOnDestroy?: boolean | cdktf.IResolvable;
  /**
  * Whether the project is in read-only mode (archived). Repositories can be archived/unarchived by toggling this parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#archived Project#archived}
  */
  readonly archived?: boolean | cdktf.IResolvable;
  /**
  * Auto-cancel pending pipelines. This isn’t a boolean, but enabled/disabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#auto_cancel_pending_pipelines Project#auto_cancel_pending_pipelines}
  */
  readonly autoCancelPendingPipelines?: string;
  /**
  * Auto Deploy strategy. Valid values are `continuous`, `manual`, `timed_incremental`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#auto_devops_deploy_strategy Project#auto_devops_deploy_strategy}
  */
  readonly autoDevopsDeployStrategy?: string;
  /**
  * Enable Auto DevOps for this project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#auto_devops_enabled Project#auto_devops_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#auto_duo_code_review_enabled Project#auto_duo_code_review_enabled}
  */
  readonly autoDuoCodeReviewEnabled?: boolean | cdktf.IResolvable;
  /**
  * Set whether auto-closing referenced issues on default branch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#autoclose_referenced_issues Project#autoclose_referenced_issues}
  */
  readonly autocloseReferencedIssues?: boolean | cdktf.IResolvable;
  /**
  * A local path to the avatar image to upload. **Note**: not available for imported resources.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#avatar Project#avatar}
  */
  readonly avatar?: string;
  /**
  * The hash of the avatar image. Use `filesha256("path/to/avatar.png")` whenever possible. **Note**: this is used to trigger an update of the avatar. If it's not given, but an avatar is given, the avatar will be updated each time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#avatar_hash Project#avatar_hash}
  */
  readonly avatarHash?: string;
  /**
  * Branches to fork (empty for all branches).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#branches Project#branches}
  */
  readonly branches?: string;
  /**
  * The Git strategy. Defaults to fetch. Valid values are `clone`, `fetch`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#build_git_strategy Project#build_git_strategy}
  */
  readonly buildGitStrategy?: string;
  /**
  * The maximum amount of time, in seconds, that a job can run.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#build_timeout Project#build_timeout}
  */
  readonly buildTimeout?: number;
  /**
  * Set the builds access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#builds_access_level Project#builds_access_level}
  */
  readonly buildsAccessLevel?: string;
  /**
  * Custom Path to CI config file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#ci_config_path Project#ci_config_path}
  */
  readonly ciConfigPath?: string;
  /**
  * Default number of revisions for shallow cloning.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#ci_default_git_depth Project#ci_default_git_depth}
  */
  readonly ciDefaultGitDepth?: number;
  /**
  * Pipelines older than the configured time are deleted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#ci_delete_pipelines_in_seconds Project#ci_delete_pipelines_in_seconds}
  */
  readonly ciDeletePipelinesInSeconds?: number;
  /**
  * When a new deployment job starts, skip older deployment jobs that are still pending.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#ci_forward_deployment_enabled Project#ci_forward_deployment_enabled}
  */
  readonly ciForwardDeploymentEnabled?: boolean | cdktf.IResolvable;
  /**
  * Allow job retries even if the deployment job is outdated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#ci_forward_deployment_rollback_allowed Project#ci_forward_deployment_rollback_allowed}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#ci_id_token_sub_claim_components Project#ci_id_token_sub_claim_components}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#ci_pipeline_variables_minimum_override_role Project#ci_pipeline_variables_minimum_override_role}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#ci_push_repository_for_job_token_allowed Project#ci_push_repository_for_job_token_allowed}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#ci_restrict_pipeline_cancellation_role Project#ci_restrict_pipeline_cancellation_role}
  */
  readonly ciRestrictPipelineCancellationRole?: string;
  /**
  * Use separate caches for protected branches.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#ci_separated_caches Project#ci_separated_caches}
  */
  readonly ciSeparatedCaches?: boolean | cdktf.IResolvable;
  /**
  * Set visibility of container registry, for this project. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#container_registry_access_level Project#container_registry_access_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#container_registry_enabled Project#container_registry_enabled}
  */
  readonly containerRegistryEnabled?: boolean | cdktf.IResolvable;
  /**
  * The default branch for the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#default_branch Project#default_branch}
  */
  readonly defaultBranch?: string;
  /**
  * A description of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#description Project#description}
  */
  readonly description?: string;
  /**
  * Enable email notifications.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#emails_enabled Project#emails_enabled}
  */
  readonly emailsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Set the environments access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#environments_access_level Project#environments_access_level}
  */
  readonly environmentsAccessLevel?: string;
  /**
  * The classification label for the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#external_authorization_classification_label Project#external_authorization_classification_label}
  */
  readonly externalAuthorizationClassificationLabel?: string;
  /**
  * Set the feature flags access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#feature_flags_access_level Project#feature_flags_access_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#forked_from_project_id Project#forked_from_project_id}
  */
  readonly forkedFromProjectId?: number;
  /**
  * Set the forking access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#forking_access_level Project#forking_access_level}
  */
  readonly forkingAccessLevel?: string;
  /**
  * Enable group runners for this project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#group_runners_enabled Project#group_runners_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#group_with_project_templates_id Project#group_with_project_templates_id}
  */
  readonly groupWithProjectTemplatesId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#id Project#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#import_url Project#import_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#import_url_password Project#import_url_password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#import_url_username Project#import_url_username}
  */
  readonly importUrlUsername?: string;
  /**
  * Set the infrastructure access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#infrastructure_access_level Project#infrastructure_access_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#initialize_with_readme Project#initialize_with_readme}
  */
  readonly initializeWithReadme?: boolean | cdktf.IResolvable;
  /**
  * Set the issues access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#issues_access_level Project#issues_access_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#issues_enabled Project#issues_enabled}
  */
  readonly issuesEnabled?: boolean | cdktf.IResolvable;
  /**
  * Sets the template for new issues in the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#issues_template Project#issues_template}
  */
  readonly issuesTemplate?: string;
  /**
  * Disable or enable the ability to keep the latest artifact for this project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#keep_latest_artifact Project#keep_latest_artifact}
  */
  readonly keepLatestArtifact?: boolean | cdktf.IResolvable;
  /**
  * Enable LFS for the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#lfs_enabled Project#lfs_enabled}
  */
  readonly lfsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Template used to create merge commit message in merge requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#merge_commit_template Project#merge_commit_template}
  */
  readonly mergeCommitTemplate?: string;
  /**
  * Set the merge method. Valid values are `merge`, `rebase_merge`, `ff`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#merge_method Project#merge_method}
  */
  readonly mergeMethod?: string;
  /**
  * Enable or disable merge pipelines.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#merge_pipelines_enabled Project#merge_pipelines_enabled}
  */
  readonly mergePipelinesEnabled?: boolean | cdktf.IResolvable;
  /**
  * Set the merge requests access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#merge_requests_access_level Project#merge_requests_access_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#merge_requests_enabled Project#merge_requests_enabled}
  */
  readonly mergeRequestsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Sets the template for new merge requests in the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#merge_requests_template Project#merge_requests_template}
  */
  readonly mergeRequestsTemplate?: string;
  /**
  * Enable or disable merge trains. Requires `merge_pipelines_enabled` to be set to `true` to take effect.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#merge_trains_enabled Project#merge_trains_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#merge_trains_skip_train_allowed Project#merge_trains_skip_train_allowed}
  */
  readonly mergeTrainsSkipTrainAllowed?: boolean | cdktf.IResolvable;
  /**
  * Enable project pull mirror.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#mirror Project#mirror}
  */
  readonly mirror?: boolean | cdktf.IResolvable;
  /**
  * Enable overwrite diverged branches for a mirrored project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#mirror_overwrites_diverged_branches Project#mirror_overwrites_diverged_branches}
  */
  readonly mirrorOverwritesDivergedBranches?: boolean | cdktf.IResolvable;
  /**
  * Enable trigger builds on pushes for a mirrored project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#mirror_trigger_builds Project#mirror_trigger_builds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#model_experiments_access_level Project#model_experiments_access_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#model_registry_access_level Project#model_registry_access_level}
  */
  readonly modelRegistryAccessLevel?: string;
  /**
  * Set the monitor access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#monitor_access_level Project#monitor_access_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#mr_default_target_self Project#mr_default_target_self}
  */
  readonly mrDefaultTargetSelf?: boolean | cdktf.IResolvable;
  /**
  * The name of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#name Project#name}
  */
  readonly name: string;
  /**
  * The namespace (group or user) of the project. Defaults to your user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#namespace_id Project#namespace_id}
  */
  readonly namespaceId?: number;
  /**
  * Set to true if you want allow merges only if all discussions are resolved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#only_allow_merge_if_all_discussions_are_resolved Project#only_allow_merge_if_all_discussions_are_resolved}
  */
  readonly onlyAllowMergeIfAllDiscussionsAreResolved?: boolean | cdktf.IResolvable;
  /**
  * Set to true if you want allow merges only if a pipeline succeeds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#only_allow_merge_if_pipeline_succeeds Project#only_allow_merge_if_pipeline_succeeds}
  */
  readonly onlyAllowMergeIfPipelineSucceeds?: boolean | cdktf.IResolvable;
  /**
  * Enable only mirror protected branches for a mirrored project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#only_mirror_protected_branches Project#only_mirror_protected_branches}
  */
  readonly onlyMirrorProtectedBranches?: boolean | cdktf.IResolvable;
  /**
  * Enable packages repository for the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#packages_enabled Project#packages_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#pages_access_level Project#pages_access_level}
  */
  readonly pagesAccessLevel?: string;
  /**
  * The path of the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#path Project#path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#permanently_delete_on_destroy Project#permanently_delete_on_destroy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#pipelines_enabled Project#pipelines_enabled}
  */
  readonly pipelinesEnabled?: boolean | cdktf.IResolvable;
  /**
  * Whether Secret Push Detection is enabled. Requires GitLab Ultimate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#pre_receive_secret_detection_enabled Project#pre_receive_secret_detection_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#prevent_merge_without_jira_issue Project#prevent_merge_without_jira_issue}
  */
  readonly preventMergeWithoutJiraIssue?: boolean | cdktf.IResolvable;
  /**
  * Show link to create/view merge request when pushing from the command line
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#printing_merge_request_link_enabled Project#printing_merge_request_link_enabled}
  */
  readonly printingMergeRequestLinkEnabled?: boolean | cdktf.IResolvable;
  /**
  * If true, jobs can be viewed by non-project members.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#public_builds Project#public_builds}
  */
  readonly publicBuilds?: boolean | cdktf.IResolvable;
  /**
  * If true, jobs can be viewed by non-project members.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#public_jobs Project#public_jobs}
  */
  readonly publicJobs?: boolean | cdktf.IResolvable;
  /**
  * Set the releases access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#releases_access_level Project#releases_access_level}
  */
  readonly releasesAccessLevel?: string;
  /**
  * Enable `Delete source branch` option by default for all new merge requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#remove_source_branch_after_merge Project#remove_source_branch_after_merge}
  */
  readonly removeSourceBranchAfterMerge?: boolean | cdktf.IResolvable;
  /**
  * Set the repository access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#repository_access_level Project#repository_access_level}
  */
  readonly repositoryAccessLevel?: string;
  /**
  * 	Which storage shard the repository is on. (administrator only)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#repository_storage Project#repository_storage}
  */
  readonly repositoryStorage?: string;
  /**
  * Allow users to request member access.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#request_access_enabled Project#request_access_enabled}
  */
  readonly requestAccessEnabled?: boolean | cdktf.IResolvable;
  /**
  * Set the requirements access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#requirements_access_level Project#requirements_access_level}
  */
  readonly requirementsAccessLevel?: string;
  /**
  * Automatically resolve merge request diffs discussions on lines changed with a push.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#resolve_outdated_diff_discussions Project#resolve_outdated_diff_discussions}
  */
  readonly resolveOutdatedDiffDiscussions?: boolean | cdktf.IResolvable;
  /**
  * The default resource group process mode for the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#resource_group_default_process_mode Project#resource_group_default_process_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#restrict_user_defined_variables Project#restrict_user_defined_variables}
  */
  readonly restrictUserDefinedVariables?: boolean | cdktf.IResolvable;
  /**
  * Set the security and compliance access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#security_and_compliance_access_level Project#security_and_compliance_access_level}
  */
  readonly securityAndComplianceAccessLevel?: string;
  /**
  * Enable shared runners for this project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#shared_runners_enabled Project#shared_runners_enabled}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#skip_wait_for_default_branch_protection Project#skip_wait_for_default_branch_protection}
  */
  readonly skipWaitForDefaultBranchProtection?: boolean | cdktf.IResolvable;
  /**
  * Set the snippets access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#snippets_access_level Project#snippets_access_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#snippets_enabled Project#snippets_enabled}
  */
  readonly snippetsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Template used to create squash commit message in merge requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#squash_commit_template Project#squash_commit_template}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#squash_option Project#squash_option}
  */
  readonly squashOption?: string;
  /**
  * The commit message used to apply merge request suggestions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#suggestion_commit_message Project#suggestion_commit_message}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#tags Project#tags}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#template_name Project#template_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#template_project_id Project#template_project_id}
  */
  readonly templateProjectId?: number;
  /**
  * The list of topics for the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#topics Project#topics}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#use_custom_template Project#use_custom_template}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#visibility_level Project#visibility_level}
  */
  readonly visibilityLevel?: string;
  /**
  * Set the wiki access level. Valid values are `disabled`, `private`, `enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#wiki_access_level Project#wiki_access_level}
  */
  readonly wikiAccessLevel?: string;
  /**
  * Enable wiki for the project. Use `wiki_access_level` instead. To be removed in 19.0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#wiki_enabled Project#wiki_enabled}
  */
  readonly wikiEnabled?: boolean | cdktf.IResolvable;
  /**
  * container_expiration_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#container_expiration_policy Project#container_expiration_policy}
  */
  readonly containerExpirationPolicy?: ProjectContainerExpirationPolicy;
  /**
  * push_rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#push_rules Project#push_rules}
  */
  readonly pushRules?: ProjectPushRules;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#timeouts Project#timeouts}
  */
...
export interface ProjectContainerExpirationPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#cadence Project#cadence}
  */
  readonly cadence?: string;
  /**
  * If true, the policy is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#enabled Project#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The number of images to keep.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#keep_n Project#keep_n}
  */
  readonly keepN?: number;
  /**
  * The regular expression to match image names to delete.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#name_regex_delete Project#name_regex_delete}
  */
  readonly nameRegexDelete?: string;
  /**
  * The regular expression to match image names to keep.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#name_regex_keep Project#name_regex_keep}
  */
  readonly nameRegexKeep?: string;
  /**
  * The number of days to keep images.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#older_than Project#older_than}
  */
...
export interface ProjectPushRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#author_email_regex Project#author_email_regex}
  */
  readonly authorEmailRegex?: string;
  /**
  * All branch names must match this regex, e.g. `(feature|hotfix)\/*`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#branch_name_regex Project#branch_name_regex}
  */
  readonly branchNameRegex?: string;
  /**
  * Users can only push commits to this repository that were committed with one of their own verified emails.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#commit_committer_check Project#commit_committer_check}
  */
  readonly commitCommitterCheck?: boolean | cdktf.IResolvable;
  /**
  * Users can only push commits to this repository if the commit author name is consistent with their GitLab account name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#commit_committer_name_check Project#commit_committer_name_check}
  */
  readonly commitCommitterNameCheck?: boolean | cdktf.IResolvable;
  /**
  * No commit message is allowed to match this regex, e.g. `ssh\:\/\/`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#commit_message_negative_regex Project#commit_message_negative_regex}
  */
  readonly commitMessageNegativeRegex?: string;
  /**
  * All commit messages must match this regex, e.g. `Fixed \d+\..*`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#commit_message_regex Project#commit_message_regex}
  */
  readonly commitMessageRegex?: string;
  /**
  * Deny deleting a tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#deny_delete_tag Project#deny_delete_tag}
  */
  readonly denyDeleteTag?: boolean | cdktf.IResolvable;
  /**
  * All committed filenames must not match this regex, e.g. `(jar|exe)$`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#file_name_regex Project#file_name_regex}
  */
  readonly fileNameRegex?: string;
  /**
  * Maximum file size (MB).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#max_file_size Project#max_file_size}
  */
  readonly maxFileSize?: number;
  /**
  * Restrict commits by author (email) to existing GitLab users.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#member_check Project#member_check}
  */
  readonly memberCheck?: boolean | cdktf.IResolvable;
  /**
  * GitLab will reject any files that are likely to contain secrets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#prevent_secrets Project#prevent_secrets}
  */
  readonly preventSecrets?: boolean | cdktf.IResolvable;
  /**
  * Reject commit when it’s not DCO certified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#reject_non_dco_commits Project#reject_non_dco_commits}
  */
  readonly rejectNonDcoCommits?: boolean | cdktf.IResolvable;
  /**
  * Reject commit when it’s not signed through GPG.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#reject_unsigned_commits Project#reject_unsigned_commits}
  */
...
export interface ProjectTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#create Project#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#delete Project#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project gitlab_project}
*/
export class Project extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Project that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project gitlab_project} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ProjectConfig) {
    ...
    this._mergeTrainsSkipTrainAllowed = config.mergeTrainsSkipTrainAllowed;
  ...
  // merge_trains_skip_train_allowed - computed: true, optional: true, required: false
  private _mergeTrainsSkipTrainAllowed?: boolean | cdktf.IResolvable; 
  public get mergeTrainsSkipTrainAllowed() {
    return this.getBooleanAttribute('merge_trains_skip_train_allowed');
  }
  public set mergeTrainsSkipTrainAllowed(value: boolean | cdktf.IResolvable) {
    this._mergeTrainsSkipTrainAllowed = value;
  }
  public resetMergeTrainsSkipTrainAllowed() {
    this._mergeTrainsSkipTrainAllowed = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get mergeTrainsSkipTrainAllowedInput() {
    return this._mergeTrainsSkipTrainAllowed;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      merge_trains_skip_train_allowed: cdktf.booleanToTerraform(this._mergeTrainsSkipTrainAllowed),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      merge_trains_skip_train_allowed: {
        value: cdktf.booleanToHclTerraform(this._mergeTrainsSkipTrainAllowed),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
