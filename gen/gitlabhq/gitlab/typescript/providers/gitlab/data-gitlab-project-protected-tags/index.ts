// https://registry.terraform.io/providers/gitlabhq/gitlab/18.5.0/docs/data-sources/project_protected_tags
...
export class DataGitlabProjectProtectedTags extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabProjectProtectedTags that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.5.0/docs/data-sources/project_protected_tags#import import section} in the documentation of this resource for the id to use
