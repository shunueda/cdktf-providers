// https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.0/docs/resources/user_gpgkey
...
export class UserGpgkey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserGpgkey that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.0/docs/resources/user_gpgkey#import import section} in the documentation of this resource for the id to use
