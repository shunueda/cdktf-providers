// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/member_role
...
export interface MemberRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/member_role#base_access_level MemberRole#base_access_level}
  */
  readonly baseAccessLevel: string;
  /**
  * Description for the member role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/member_role#description MemberRole#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/member_role#enabled_permissions MemberRole#enabled_permissions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/member_role#group_path MemberRole#group_path}
  */
  readonly groupPath?: string;
  /**
  * Name for the member role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/member_role#name MemberRole#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/member_role gitlab_member_role}
*/
export class MemberRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MemberRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/member_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/member_role gitlab_member_role} Resource
  *
  * @param scope The scope in which to define this construct
