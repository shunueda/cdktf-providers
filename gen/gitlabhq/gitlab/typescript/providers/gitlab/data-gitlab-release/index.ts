// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/release
...
export interface DataGitlabReleaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/release#project_id DataGitlabRelease#project_id}
  */
  readonly projectId: string;
  /**
  * The Git tag the release is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/release#tag_name DataGitlabRelease#tag_name}
  */
  readonly tagName: string;
  /**
  * assets block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/release#assets DataGitlabRelease#assets}
  */
...
export interface DataGitlabReleaseAssets {
  ...
  * links block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/release#links DataGitlabRelease#links}
  */
  readonly links?: DataGitlabReleaseAssetsLinks[] | cdktf.IResolvable;
  /**
  * sources block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/release#sources DataGitlabRelease#sources}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/release gitlab_release}
*/
export class DataGitlabRelease extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabRelease that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/release#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/release gitlab_release} Data Source
  *
  * @param scope The scope in which to define this construct
