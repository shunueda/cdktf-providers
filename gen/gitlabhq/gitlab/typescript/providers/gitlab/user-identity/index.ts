// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_identity
...
export interface UserIdentityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_identity#external_provider UserIdentity#external_provider}
  */
  readonly externalProvider: string;
  /**
  * A specific external authentication provider UID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_identity#external_uid UserIdentity#external_uid}
  */
  readonly externalUid: string;
  /**
  * The GitLab ID of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_identity#user_id UserIdentity#user_id}
  */
  readonly userId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_identity gitlab_user_identity}
*/
export class UserIdentity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_identity gitlab_user_identity} Resource
  *
  * @param scope The scope in which to define this construct
