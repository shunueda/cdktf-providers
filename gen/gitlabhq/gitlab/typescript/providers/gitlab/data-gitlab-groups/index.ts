// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/groups
...
export interface DataGitlabGroupsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/groups#order_by DataGitlabGroups#order_by}
  */
  readonly orderBy?: string;
  /**
  * Search groups by name or path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/groups#search DataGitlabGroups#search}
  */
  readonly search?: string;
  /**
  * Sort groups' list in asc or desc order. (Requires administrator privileges)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/groups#sort DataGitlabGroups#sort}
  */
  readonly sort?: string;
  /**
  * Limit to top level groups, excluding all subgroups.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/groups#top_level_only DataGitlabGroups#top_level_only}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/groups gitlab_groups}
*/
export class DataGitlabGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/groups gitlab_groups} Data Source
  *
  * @param scope The scope in which to define this construct
