// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_service_account
...
export interface GroupServiceAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_service_account#email GroupServiceAccount#email}
  */
  readonly email?: string;
  /**
  * The ID or URL-encoded path of the group that the service account is created in. Must be a top level group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_service_account#group GroupServiceAccount#group}
  */
  readonly group: string;
  /**
  * The name of the user. If not specified, the default Service account user name is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_service_account#name GroupServiceAccount#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_service_account#timeouts GroupServiceAccount#timeouts}
  */
  readonly timeouts?: GroupServiceAccountTimeouts;
  /**
  * The username of the user. If not specified, it’s automatically generated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_service_account#username GroupServiceAccount#username}
  */
...
export interface GroupServiceAccountTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_service_account#delete GroupServiceAccount#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_service_account gitlab_group_service_account}
*/
export class GroupServiceAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_service_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/group_service_account gitlab_group_service_account} Resource
  *
  * @param scope The scope in which to define this construct
