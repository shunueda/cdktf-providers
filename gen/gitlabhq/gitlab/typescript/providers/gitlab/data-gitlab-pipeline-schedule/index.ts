// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/pipeline_schedule
...
export interface DataGitlabPipelineScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  * The timezone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/pipeline_schedule#cron_timezone DataGitlabPipelineSchedule#cron_timezone}
  */
  readonly cronTimezone?: string;
  /**
  * The pipeline schedule id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/pipeline_schedule#pipeline_schedule_id DataGitlabPipelineSchedule#pipeline_schedule_id}
  */
  readonly pipelineScheduleId: number;
  /**
  * The name or id of the project to add the schedule to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/pipeline_schedule#project DataGitlabPipelineSchedule#project}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/pipeline_schedule gitlab_pipeline_schedule}
*/
export class DataGitlabPipelineSchedule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabPipelineSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/pipeline_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/pipeline_schedule gitlab_pipeline_schedule} Data Source
  *
  * @param scope The scope in which to define this construct
