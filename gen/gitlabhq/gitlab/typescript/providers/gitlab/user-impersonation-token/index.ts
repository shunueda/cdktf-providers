// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_impersonation_token
...
export interface UserImpersonationTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_impersonation_token#expires_at UserImpersonationToken#expires_at}
  */
  readonly expiresAt: string;
  /**
  * The name of the impersonation token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_impersonation_token#name UserImpersonationToken#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_impersonation_token#scopes UserImpersonationToken#scopes}
  */
  readonly scopes: string[];
  /**
  * The ID of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_impersonation_token#user_id UserImpersonationToken#user_id}
  */
  readonly userId: number;
  /**
  * Wether to validate if the expiration date is in the future.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_impersonation_token#validate_past_expiration_date UserImpersonationToken#validate_past_expiration_date}
  */
  readonly validatePastExpirationDate?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_impersonation_token gitlab_user_impersonation_token}
*/
export class UserImpersonationToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserImpersonationToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_impersonation_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/user_impersonation_token gitlab_user_impersonation_token} Resource
  *
  * @param scope The scope in which to define this construct
