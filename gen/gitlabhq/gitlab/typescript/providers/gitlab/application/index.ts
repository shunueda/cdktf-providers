// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/application
...
export interface ApplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/application#confidential Application#confidential}
  */
  readonly confidential?: boolean | cdktf.IResolvable;
  /**
  * Name of the application.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/application#name Application#name}
  */
  readonly name: string;
  /**
  * The URL gitlab should send the user to after authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/application#redirect_url Application#redirect_url}
  */
  ...
  * 					
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/application#scopes Application#scopes}
  */
  readonly scopes: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/application gitlab_application}
*/
export class Application extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Application that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/application gitlab_application} Resource
  *
  * @param scope The scope in which to define this construct
