// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/user
...
export interface DataGitlabUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/user#email DataGitlabUser#email}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/user#email_exact_match DataGitlabUser#email_exact_match}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/user#namespace_id DataGitlabUser#namespace_id}
  */
  readonly namespaceId?: number;
  /**
  * The ID of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/user#user_id DataGitlabUser#user_id}
  */
  readonly userId?: number;
  /**
  * The username of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/user#username DataGitlabUser#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/user gitlab_user}
*/
export class DataGitlabUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/user gitlab_user} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // email_exact_match - computed: false, optional: true, required: false
  private _emailExactMatch?: boolean | cdktf.IResolvable; 
  public get emailExactMatch() {
    return this.getBooleanAttribute('email_exact_match');
  }
  public set emailExactMatch(value: boolean | cdktf.IResolvable) {
    this._emailExactMatch = value;
  }
  public resetEmailExactMatch() {
    this._emailExactMatch = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get emailExactMatchInput() {
    return this._emailExactMatch;
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      email_exact_match: {
        value: cdktf.booleanToHclTerraform(this._emailExactMatch),
        isBlock: false,
        type: "simple",
