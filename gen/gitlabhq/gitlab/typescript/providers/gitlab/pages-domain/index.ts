// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/pages_domain
...
export interface PagesDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/pages_domain#auto_ssl_enabled PagesDomain#auto_ssl_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/pages_domain#certificate PagesDomain#certificate}
  */
  readonly certificate?: string;
  /**
  * The custom domain indicated by the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/pages_domain#domain PagesDomain#domain}
  */
  readonly domain: string;
  /**
  * Whether the certificate is expired.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/pages_domain#expired PagesDomain#expired}
  */
  readonly expired?: boolean | cdktf.IResolvable;
  /**
  * The certificate key in PEM format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/pages_domain#key PagesDomain#key}
  */
  readonly key?: string;
  /**
  * The ID or Namespace path of the project owned by the authenticated user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/pages_domain#project PagesDomain#project}
  */
  readonly project: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/pages_domain gitlab_pages_domain}
*/
export class PagesDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PagesDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/pages_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/pages_domain gitlab_pages_domain} Resource
  *
  * @param scope The scope in which to define this construct
