// https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.0/docs/data-sources/pipeline_schedules
...
export class DataGitlabPipelineSchedules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabPipelineSchedules that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.0/docs/data-sources/pipeline_schedules#import import section} in the documentation of this resource for the id to use
