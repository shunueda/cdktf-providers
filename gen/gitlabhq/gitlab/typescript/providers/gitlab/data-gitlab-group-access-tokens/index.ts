// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_access_tokens
...
export interface DataGitlabGroupAccessTokensConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_access_tokens#group DataGitlabGroupAccessTokens#group}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_access_tokens gitlab_group_access_tokens}
*/
export class DataGitlabGroupAccessTokens extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabGroupAccessTokens that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_access_tokens#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_access_tokens gitlab_group_access_tokens} Data Source
  *
  * @param scope The scope in which to define this construct
