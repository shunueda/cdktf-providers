// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment
...
export interface ProjectProtectedEnvironmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment#approval_rules ProjectProtectedEnvironment#approval_rules}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment#deploy_access_levels_attribute ProjectProtectedEnvironment#deploy_access_levels_attribute}
  */
  readonly deployAccessLevelsAttribute?: ProjectProtectedEnvironmentDeployAccessLevelsAttribute[] | cdktf.IResolvable;
  /**
  * The name of the environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment#environment ProjectProtectedEnvironment#environment}
  */
  readonly environment: string;
  /**
  * The ID or full path of the project which the protected environment is created against.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment#project ProjectProtectedEnvironment#project}
  */
  readonly project: string;
  /**
  * deploy_access_levels block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment#deploy_access_levels ProjectProtectedEnvironment#deploy_access_levels}
  */
...
export interface ProjectProtectedEnvironmentApprovalRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment#access_level ProjectProtectedEnvironment#access_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment#group_id ProjectProtectedEnvironment#group_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment#group_inheritance_type ProjectProtectedEnvironment#group_inheritance_type}
  */
  readonly groupInheritanceType?: number;
  /**
  * The number of approval required to allow deployment to this protected environment. This is mutually exclusive with user_id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment#required_approvals ProjectProtectedEnvironment#required_approvals}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment#user_id ProjectProtectedEnvironment#user_id}
  */
...
export function projectProtectedEnvironmentDeployAccessLevelsAttributeToTerraform(struct?: ProjectProtectedEnvironmentDeployAccessLevelsAttribute | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function projectProtectedEnvironmentDeployAccessLevelsAttributeToHclTerraform(struct?: ProjectProtectedEnvironmentDeployAccessLevelsAttribute | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ProjectProtectedEnvironmentDeployAccessLevelsAttributeOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ProjectProtectedEnvironmentDeployAccessLevelsAttribute | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ProjectProtectedEnvironmentDeployAccessLevelsAttribute | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._accessLevel = undefined;
...
export class ProjectProtectedEnvironmentDeployAccessLevelsAttributeList extends cdktf.ComplexList {
  public internalValue? : ProjectProtectedEnvironmentDeployAccessLevelsAttribute[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): ProjectProtectedEnvironmentDeployAccessLevelsAttributeOutputReference {
    return new ProjectProtectedEnvironmentDeployAccessLevelsAttributeOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment gitlab_project_protected_environment}
*/
export class ProjectProtectedEnvironment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectProtectedEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_protected_environment gitlab_project_protected_environment} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ProjectProtectedEnvironmentConfig) {
    ...
    this._deployAccessLevelsAttribute.internalValue = config.deployAccessLevelsAttribute;
  ...
  // deploy_access_levels_attribute - computed: false, optional: true, required: false
  private _deployAccessLevelsAttribute = new ProjectProtectedEnvironmentDeployAccessLevelsAttributeList(this, "deploy_access_levels_attribute", true);
  public get deployAccessLevelsAttribute() {
    return this._deployAccessLevelsAttribute;
  }
  public putDeployAccessLevelsAttribute(value: ProjectProtectedEnvironmentDeployAccessLevelsAttribute[] | cdktf.IResolvable) {
    this._deployAccessLevelsAttribute.internalValue = value;
  }
  public resetDeployAccessLevelsAttribute() {
    this._deployAccessLevelsAttribute.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get deployAccessLevelsAttributeInput() {
    return this._deployAccessLevelsAttribute.internalValue;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      deploy_access_levels_attribute: cdktf.listMapper(projectProtectedEnvironmentDeployAccessLevelsAttributeToTerraform, false)(this._deployAccessLevelsAttribute.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      deploy_access_levels_attribute: {
        value: cdktf.listMapperHcl(projectProtectedEnvironmentDeployAccessLevelsAttributeToHclTerraform, false)(this._deployAccessLevelsAttribute.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "ProjectProtectedEnvironmentDeployAccessLevelsAttributeList",
      },
      environment: {
