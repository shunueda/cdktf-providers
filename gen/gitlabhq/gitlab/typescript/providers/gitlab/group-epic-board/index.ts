// https://registry.terraform.io/providers/gitlabhq/gitlab/18.5.0/docs/resources/group_epic_board
...
export class GroupEpicBoard extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupEpicBoard that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.5.0/docs/resources/group_epic_board#import import section} in the documentation of this resource for the id to use
