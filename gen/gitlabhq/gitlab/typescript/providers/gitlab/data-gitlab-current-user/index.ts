// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/current_user
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/current_user gitlab_current_user}
*/
export class DataGitlabCurrentUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabCurrentUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/current_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/current_user gitlab_current_user} Data Source
  *
  * @param scope The scope in which to define this construct
