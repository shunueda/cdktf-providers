// https://registry.terraform.io/providers/gitlabhq/gitlab/18.5.0/docs/data-sources/current_user
...
export class DataGitlabCurrentUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabCurrentUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.5.0/docs/data-sources/current_user#import import section} in the documentation of this resource for the id to use
