// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/branch
...
export interface DataGitlabBranchConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/branch#name DataGitlabBranch#name}
  */
  readonly name: string;
  /**
  * The full path or id of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/branch#project DataGitlabBranch#project}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/branch gitlab_branch}
*/
export class DataGitlabBranch extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabBranch that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/branch#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/branch gitlab_branch} Data Source
  *
  * @param scope The scope in which to define this construct
