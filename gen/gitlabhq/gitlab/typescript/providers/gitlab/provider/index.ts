// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs
...
export interface GitlabProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#base_url GitlabProvider#base_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#cacert_file GitlabProvider#cacert_file}
  */
  readonly cacertFile?: string;
  /**
  * File path to client certificate when GitLab instance is behind company proxy. File must contain PEM encoded data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#client_cert GitlabProvider#client_cert}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#client_key GitlabProvider#client_key}
  */
  readonly clientKey?: string;
  /**
  * The path to the configuration file to use. It may be sourced from the `GITLAB_CONFIG_FILE` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#config_file GitlabProvider#config_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#context GitlabProvider#context}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#early_auth_check GitlabProvider#early_auth_check}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#enable_auto_ci_support GitlabProvider#enable_auto_ci_support}
  */
  readonly enableAutoCiSupport?: boolean | cdktf.IResolvable;
  /**
  * A map of headers to append to all API request to the GitLab instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#headers GitlabProvider#headers}
  */
  readonly headers?: { [key: string]: string };
  /**
  * When set to true this disables SSL verification of the connection to the GitLab instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#insecure GitlabProvider#insecure}
  */
  readonly insecure?: boolean | cdktf.IResolvable;
  /**
  * The number of retries to execute when receiving a 429 Rate Limit error. Each retry will exponentially back off.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#retries GitlabProvider#retries}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#token GitlabProvider#token}
  */
  readonly token?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#alias GitlabProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs gitlab}
*/
export class GitlabProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing GitlabProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs gitlab} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: GitlabProviderConfig = {}) {
    ...
    this._enableAutoCiSupport = config.enableAutoCiSupport;
  ...
  // enable_auto_ci_support - computed: false, optional: true, required: false
  private _enableAutoCiSupport?: boolean | cdktf.IResolvable; 
  public get enableAutoCiSupport() {
    return this._enableAutoCiSupport;
  }
  public set enableAutoCiSupport(value: boolean | cdktf.IResolvable | undefined) {
    this._enableAutoCiSupport = value;
  }
  public resetEnableAutoCiSupport() {
    this._enableAutoCiSupport = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get enableAutoCiSupportInput() {
    return this._enableAutoCiSupport;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      enable_auto_ci_support: cdktf.booleanToTerraform(this._enableAutoCiSupport),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      enable_auto_ci_support: {
        value: cdktf.booleanToHclTerraform(this._enableAutoCiSupport),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
