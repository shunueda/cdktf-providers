// https://registry.terraform.io/providers/gitlabhq/gitlab/18.5.0/docs
...
export class GitlabProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing GitlabProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.5.0/docs#import import section} in the documentation of this resource for the id to use
