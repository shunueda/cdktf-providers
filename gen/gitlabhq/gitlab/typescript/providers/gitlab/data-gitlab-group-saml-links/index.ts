// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_saml_links
...
export interface DataGitlabGroupSamlLinksConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_saml_links#group DataGitlabGroupSamlLinks#group}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_saml_links gitlab_group_saml_links}
*/
export class DataGitlabGroupSamlLinks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabGroupSamlLinks that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_saml_links#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_saml_links gitlab_group_saml_links} Data Source
  *
  * @param scope The scope in which to define this construct
