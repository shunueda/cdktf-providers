// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/instance_deploy_keys
...
export interface DataGitlabInstanceDeployKeysConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/instance_deploy_keys#public DataGitlabInstanceDeployKeys#public}
  */
...
export function dataGitlabInstanceDeployKeysDeployKeysProjectsWithWriteAccessToHclTerraform(struct?: DataGitlabInstanceDeployKeysDeployKeysProjectsWithWriteAccess): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataGitlabInstanceDeployKeysDeployKeysToHclTerraform(struct?: DataGitlabInstanceDeployKeysDeployKeys): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/instance_deploy_keys gitlab_instance_deploy_keys}
*/
export class DataGitlabInstanceDeployKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabInstanceDeployKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/instance_deploy_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/instance_deploy_keys gitlab_instance_deploy_keys} Data Source
  *
  * @param scope The scope in which to define this construct
