// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/member_role
...
export interface DataGitlabMemberRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/member_role#id DataGitlabMemberRole#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/member_role gitlab_member_role}
*/
export class DataGitlabMemberRole extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabMemberRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/member_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/member_role gitlab_member_role} Data Source
  *
  * @param scope The scope in which to define this construct
