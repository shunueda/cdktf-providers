// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/metadata
...
export class DataGitlabMetadataKasOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // external_k8s_proxy_url - computed: true, optional: false, required: false
  public get externalK8SProxyUrl() {
    return this.getStringAttribute('external_k8s_proxy_url');
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/metadata gitlab_metadata}
*/
export class DataGitlabMetadata extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/metadata#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/metadata gitlab_metadata} Data Source
  *
  * @param scope The scope in which to define this construct
