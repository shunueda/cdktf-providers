// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule
...
export interface ProjectApprovalRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule#applies_to_all_protected_branches ProjectApprovalRule#applies_to_all_protected_branches}
  */
  readonly appliesToAllProtectedBranches?: boolean | cdktf.IResolvable;
  /**
  * The number of approvals required for this rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule#approvals_required ProjectApprovalRule#approvals_required}
  */
  readonly approvalsRequired: number;
  /**
  * When this flag is set, the default `any_approver` rule will not be imported if present.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule#disable_importing_default_any_approver_rule_on_create ProjectApprovalRule#disable_importing_default_any_approver_rule_on_create}
  */
  readonly disableImportingDefaultAnyApproverRuleOnCreate?: boolean | cdktf.IResolvable;
  /**
  * A list of group IDs whose members can approve of the merge request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule#group_ids ProjectApprovalRule#group_ids}
  */
  readonly groupIds?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule#id ProjectApprovalRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule#name ProjectApprovalRule#name}
  */
  readonly name: string;
  /**
  * The name or id of the project to add the approval rules.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule#project ProjectApprovalRule#project}
  */
  readonly project: string;
  /**
  * A list of protected branch IDs (not branch names) for which the rule applies.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule#protected_branch_ids ProjectApprovalRule#protected_branch_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule#report_type ProjectApprovalRule#report_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule#rule_type ProjectApprovalRule#rule_type}
  */
  readonly ruleType?: string;
  /**
  * A list of specific User IDs to add to the list of approvers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule#user_ids ProjectApprovalRule#user_ids}
  */
  readonly userIds?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule gitlab_project_approval_rule}
*/
export class ProjectApprovalRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectApprovalRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_approval_rule gitlab_project_approval_rule} Resource
  *
  * @param scope The scope in which to define this construct
