// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scopes
...
export interface ProjectJobTokenScopesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scopes#enabled ProjectJobTokenScopes#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The ID or full path of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scopes#project ProjectJobTokenScopes#project}
  */
  readonly project?: string;
  /**
  * The ID of the project. Use `project` instead. To be removed in 19.0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scopes#project_id ProjectJobTokenScopes#project_id}
  */
  readonly projectId?: number;
  /**
  * A set of group IDs that are in the CI/CD job token inbound allowlist.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scopes#target_group_ids ProjectJobTokenScopes#target_group_ids}
  */
  readonly targetGroupIds?: number[];
  /**
  * A set of project IDs that are in the CI/CD job token inbound allowlist.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scopes#target_project_ids ProjectJobTokenScopes#target_project_ids}
  */
  readonly targetProjectIds?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scopes gitlab_project_job_token_scopes}
*/
export class ProjectJobTokenScopes extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectJobTokenScopes that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scopes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/project_job_token_scopes gitlab_project_job_token_scopes} Resource
  *
  * @param scope The scope in which to define this construct
