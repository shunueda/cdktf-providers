// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project_branches
...
export interface DataGitlabProjectBranchesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project_branches#project DataGitlabProjectBranches#project}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project_branches gitlab_project_branches}
*/
export class DataGitlabProjectBranches extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabProjectBranches that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project_branches#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/project_branches gitlab_project_branches} Data Source
  *
  * @param scope The scope in which to define this construct
