// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/cluster_agent_token
...
export interface ClusterAgentTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  * The ID of the agent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/cluster_agent_token#agent_id ClusterAgentToken#agent_id}
  */
  readonly agentId: number;
  /**
  * The Description for the agent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/cluster_agent_token#description ClusterAgentToken#description}
  */
  readonly description?: string;
  /**
  * The Name of the agent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/cluster_agent_token#name ClusterAgentToken#name}
  */
  readonly name: string;
  /**
  * ID or full path of the project maintained by the authenticated user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/cluster_agent_token#project ClusterAgentToken#project}
  */
  readonly project: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/cluster_agent_token gitlab_cluster_agent_token}
*/
export class ClusterAgentToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusterAgentToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/cluster_agent_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/resources/cluster_agent_token gitlab_cluster_agent_token} Resource
  *
  * @param scope The scope in which to define this construct
