// https://registry.terraform.io/providers/gitlabhq/gitlab/18.5.0/docs/data-sources/group_ids
...
export class DataGitlabGroupIds extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabGroupIds that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.5.0/docs/data-sources/group_ids#import import section} in the documentation of this resource for the id to use
