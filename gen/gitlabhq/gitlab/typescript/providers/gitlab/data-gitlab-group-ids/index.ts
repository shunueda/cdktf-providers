// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_ids
...
export interface DataGitlabGroupIdsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_ids#group DataGitlabGroupIds#group}
  */
  readonly group: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_ids gitlab_group_ids}
*/
export class DataGitlabGroupIds extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabGroupIds that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_ids#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/group_ids gitlab_group_ids} Data Source
  *
  * @param scope The scope in which to define this construct
