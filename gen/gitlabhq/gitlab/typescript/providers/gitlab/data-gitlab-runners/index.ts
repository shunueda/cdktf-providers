// https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.1/docs/data-sources/runners
...
export class DataGitlabRunners extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabRunners that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.6.1/docs/data-sources/runners#import import section} in the documentation of this resource for the id to use
