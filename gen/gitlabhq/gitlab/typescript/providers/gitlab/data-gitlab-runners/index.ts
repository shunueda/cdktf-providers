// https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/runners
...
export interface DataGitlabRunnersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/runners#paused DataGitlabRunners#paused}
  */
  readonly paused?: boolean | cdktf.IResolvable;
  /**
  * Filters for runners with the given status. Valid Values are `online`, `offline`, `stale`, and `never_contacted`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/runners#status DataGitlabRunners#status}
  */
  readonly status?: string;
  /**
  * Filters for runners with all of the given tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/runners#tag_list DataGitlabRunners#tag_list}
  */
  readonly tagList?: string[];
  /**
  * The type of runner to return. Valid values are `instance_type`, `group_type` and `project_type`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/runners#type DataGitlabRunners#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/runners gitlab_runners}
*/
export class DataGitlabRunners extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabRunners that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/runners#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.7.0/docs/data-sources/runners gitlab_runners} Data Source
  *
  * @param scope The scope in which to define this construct
