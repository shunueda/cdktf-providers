// https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/dlp_engines
...
export interface DlpEnginesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/dlp_engines#custom_dlp_engine DlpEngines#custom_dlp_engine}
  */
  readonly customDlpEngine?: boolean | cdktf.IResolvable;
  /**
  * The DLP engine's description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/dlp_engines#description DlpEngines#description}
  */
  readonly description?: string;
  /**
  * The boolean logical operator in which various DLP dictionaries are combined within a DLP engine's expression.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/dlp_engines#engine_expression DlpEngines#engine_expression}
  */
  readonly engineExpression?: string;
  /**
  * The DLP engine name as configured by the admin.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/dlp_engines#name DlpEngines#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/dlp_engines zia_dlp_engines}
*/
export class DlpEngines extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DlpEngines that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/dlp_engines#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/dlp_engines zia_dlp_engines} Resource
  *
  * @param scope The scope in which to define this construct
