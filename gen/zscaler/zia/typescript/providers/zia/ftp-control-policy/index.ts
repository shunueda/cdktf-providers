// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/ftp_control_policy
...
export interface FtpControlPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/ftp_control_policy#ftp_enabled FtpControlPolicy#ftp_enabled}
  */
  readonly ftpEnabled?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether to enable FTP over HTTP. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/ftp_control_policy#ftp_over_http_enabled FtpControlPolicy#ftp_over_http_enabled}
  */
  readonly ftpOverHttpEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/ftp_control_policy#id FtpControlPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/ftp_control_policy#url_categories FtpControlPolicy#url_categories}
  */
  readonly urlCategories?: string[];
  /**
  * Domains or URLs included for the FTP Control settings
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/ftp_control_policy#urls FtpControlPolicy#urls}
  */
  readonly urls?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/ftp_control_policy zia_ftp_control_policy}
*/
export class FtpControlPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FtpControlPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/ftp_control_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/ftp_control_policy zia_ftp_control_policy} Resource
  *
  * @param scope The scope in which to define this construct
