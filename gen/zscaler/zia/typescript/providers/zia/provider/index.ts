// https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs
...
export interface ZiaProviderConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#api_key ZiaProvider#api_key}
  */
  readonly apiKey?: string;
  /**
  * zpa client id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#client_id ZiaProvider#client_id}
  */
  readonly clientId?: string;
  /**
  * zpa client secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#client_secret ZiaProvider#client_secret}
  */
  readonly clientSecret?: string;
  /**
  * Alternate HTTP proxy of scheme://hostname or scheme://hostname:port format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#http_proxy ZiaProvider#http_proxy}
  */
  readonly httpProxy?: string;
  /**
  * maximum number of retries to attempt before erroring out.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#max_retries ZiaProvider#max_retries}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#parallelism ZiaProvider#parallelism}
  */
  readonly parallelism?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#password ZiaProvider#password}
  */
  readonly password?: string;
  /**
  * zpa private key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#private_key ZiaProvider#private_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#request_timeout ZiaProvider#request_timeout}
  */
  readonly requestTimeout?: number;
  /**
  * Zscaler Sandbox Cloud
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#sandbox_cloud ZiaProvider#sandbox_cloud}
  */
  readonly sandboxCloud?: string;
  /**
  * Zscaler Sandbox Token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#sandbox_token ZiaProvider#sandbox_token}
  */
  readonly sandboxToken?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#use_legacy_client ZiaProvider#use_legacy_client}
  */
  readonly useLegacyClient?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#username ZiaProvider#username}
  */
  readonly username?: string;
  /**
  * Zscaler Vanity Domain
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#vanity_domain ZiaProvider#vanity_domain}
  */
  readonly vanityDomain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#zia_cloud ZiaProvider#zia_cloud}
  */
  readonly ziaCloud?: string;
  /**
  * Zscaler Cloud Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#zscaler_cloud ZiaProvider#zscaler_cloud}
  */
  readonly zscalerCloud?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#alias ZiaProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs zia}
*/
export class ZiaProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ZiaProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs zia} Resource
  *
  * @param scope The scope in which to define this construct
