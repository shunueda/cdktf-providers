// https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/dlp_dictionaries
...
export interface DataZiaDlpDictionariesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/dlp_dictionaries#id DataZiaDlpDictionaries#id}
  *
  ...
  */
  readonly id?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/dlp_dictionaries#name DataZiaDlpDictionaries#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/dlp_dictionaries zia_dlp_dictionaries}
*/
export class DataZiaDlpDictionaries extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaDlpDictionaries that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/dlp_dictionaries#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/dlp_dictionaries zia_dlp_dictionaries} Data Source
  *
  * @param scope The scope in which to define this construct
