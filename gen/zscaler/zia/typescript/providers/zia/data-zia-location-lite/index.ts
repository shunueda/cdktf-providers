// https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/location_lite
...
export interface DataZiaLocationLiteConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/location_lite#id DataZiaLocationLite#id}
  *
  ...
  */
  readonly id?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/location_lite#name DataZiaLocationLite#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/location_lite zia_location_lite}
*/
export class DataZiaLocationLite extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaLocationLite that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/location_lite#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/location_lite zia_location_lite} Data Source
  *
  * @param scope The scope in which to define this construct
