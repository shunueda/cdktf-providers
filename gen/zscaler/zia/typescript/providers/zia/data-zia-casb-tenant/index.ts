// https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant
...
export interface DataZiaCasbTenantConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant#active_only DataZiaCasbTenant#active_only}
  */
  readonly activeOnly?: boolean | cdktf.IResolvable;
  /**
  * Filter tenants by application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant#app DataZiaCasbTenant#app}
  */
  readonly app?: string;
  /**
  * Filter tenants by application type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant#app_type DataZiaCasbTenant#app_type}
  */
  readonly appType?: string;
  /**
  * Filter tenants by supported features
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant#filter_by_feature DataZiaCasbTenant#filter_by_feature}
  */
  readonly filterByFeature?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant#id DataZiaCasbTenant#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant#include_bucket_ready_s3_tenants DataZiaCasbTenant#include_bucket_ready_s3_tenants}
  */
  readonly includeBucketReadyS3Tenants?: boolean | cdktf.IResolvable;
  /**
  * Include deleted tenants in the results
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant#include_deleted DataZiaCasbTenant#include_deleted}
  */
  readonly includeDeleted?: boolean | cdktf.IResolvable;
  /**
  * Return only tenants with scan config
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant#scan_config_tenants_only DataZiaCasbTenant#scan_config_tenants_only}
  */
  readonly scanConfigTenantsOnly?: boolean | cdktf.IResolvable;
  /**
  * SaaS Security API email label ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant#tenant_id DataZiaCasbTenant#tenant_id}
  */
  readonly tenantId?: number;
  /**
  * SaaS Security API email label name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant#tenant_name DataZiaCasbTenant#tenant_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant zia_casb_tenant}
*/
export class DataZiaCasbTenant extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaCasbTenant that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/casb_tenant zia_casb_tenant} Data Source
  *
  * @param scope The scope in which to define this construct
