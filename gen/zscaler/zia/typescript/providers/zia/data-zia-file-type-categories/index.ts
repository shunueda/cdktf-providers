// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/file_type_categories
...
export interface DataZiaFileTypeCategoriesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/file_type_categories#enums DataZiaFileTypeCategories#enums}
  */
  readonly enums?: string[];
  /**
  * A Boolean value specifying whether custom file types must be excluded from the list or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/file_type_categories#exclude_custom_file_types DataZiaFileTypeCategories#exclude_custom_file_types}
  */
  readonly excludeCustomFileTypes?: boolean | cdktf.IResolvable;
  /**
  * File type ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/file_type_categories#id DataZiaFileTypeCategories#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/file_type_categories#name DataZiaFileTypeCategories#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/file_type_categories zia_file_type_categories}
*/
export class DataZiaFileTypeCategories extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaFileTypeCategories that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/file_type_categories#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/file_type_categories zia_file_type_categories} Data Source
  *
  * @param scope The scope in which to define this construct
