// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/browser_control_policy
...
export interface DataZiaBrowserControlPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/browser_control_policy#id DataZiaBrowserControlPolicy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/browser_control_policy zia_browser_control_policy}
*/
export class DataZiaBrowserControlPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaBrowserControlPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/browser_control_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/browser_control_policy zia_browser_control_policy} Data Source
  *
  * @param scope The scope in which to define this construct
