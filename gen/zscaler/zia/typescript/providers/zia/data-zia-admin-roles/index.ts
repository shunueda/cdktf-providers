// https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/admin_roles
...
export interface DataZiaAdminRolesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Admin role Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/admin_roles#id DataZiaAdminRoles#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/admin_roles#name DataZiaAdminRoles#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/admin_roles zia_admin_roles}
*/
export class DataZiaAdminRoles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaAdminRoles that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/admin_roles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/admin_roles zia_admin_roles} Data Source
  *
  * @param scope The scope in which to define this construct
