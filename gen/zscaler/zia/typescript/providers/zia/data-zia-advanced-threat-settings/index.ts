// https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/advanced_threat_settings
...
export interface DataZiaAdvancedThreatSettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/advanced_threat_settings#id DataZiaAdvancedThreatSettings#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/advanced_threat_settings zia_advanced_threat_settings}
*/
export class DataZiaAdvancedThreatSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaAdvancedThreatSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/advanced_threat_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/advanced_threat_settings zia_advanced_threat_settings} Data Source
  *
  * @param scope The scope in which to define this construct
