// https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/resources/dlp_notification_templates
...
export interface DlpNotificationTemplatesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/resources/dlp_notification_templates#attach_content DlpNotificationTemplates#attach_content}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/resources/dlp_notification_templates#html_message DlpNotificationTemplates#html_message}
  */
  readonly htmlMessage: string;
  /**
  * The DLP notification template name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/resources/dlp_notification_templates#name DlpNotificationTemplates#name}
  */
  readonly name: string;
  /**
  * The template for the plain text UTF-8 message body that must be displayed in the DLP notification email
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/resources/dlp_notification_templates#plain_text_message DlpNotificationTemplates#plain_text_message}
  */
  readonly plainTextMessage: string;
  /**
  * The Subject line that is displayed within the DLP notification email
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/resources/dlp_notification_templates#subject DlpNotificationTemplates#subject}
  */
  readonly subject: string;
  /**
  * If set to true, TLS will be enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/resources/dlp_notification_templates#tls_enabled DlpNotificationTemplates#tls_enabled}
  */
  readonly tlsEnabled?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/resources/dlp_notification_templates zia_dlp_notification_templates}
*/
export class DlpNotificationTemplates extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DlpNotificationTemplates that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/resources/dlp_notification_templates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/resources/dlp_notification_templates zia_dlp_notification_templates} Resource
  *
  * @param scope The scope in which to define this construct
