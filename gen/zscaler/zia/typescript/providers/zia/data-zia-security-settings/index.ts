// https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/security_settings
...
export interface DataZiaSecuritySettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/security_settings#id DataZiaSecuritySettings#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/security_settings zia_security_settings}
*/
export class DataZiaSecuritySettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaSecuritySettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/security_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/security_settings zia_security_settings} Data Source
  *
  * @param scope The scope in which to define this construct
