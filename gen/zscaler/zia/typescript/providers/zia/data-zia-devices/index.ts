// https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/devices
...
export interface DataZiaDevicesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/devices#device_group_type DataZiaDevices#device_group_type}
  */
  readonly deviceGroupType?: string;
  /**
  * The device model.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/devices#device_model DataZiaDevices#device_model}
  */
  readonly deviceModel?: string;
  /**
  * The device owner's user name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/devices#hostname DataZiaDevices#hostname}
  */
  readonly hostname?: string;
  /**
  * The unique identifier for the device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/devices#id DataZiaDevices#id}
  *
  ...
  * The device name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/devices#name DataZiaDevices#name}
  */
  readonly name?: string;
  /**
  * The operating system (OS).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/devices#os_type DataZiaDevices#os_type}
  */
  readonly osType?: string;
  /**
  * The operating system version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/devices#os_version DataZiaDevices#os_version}
  */
  readonly osVersion?: string;
  /**
  * The device owner's user name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/devices#owner_name DataZiaDevices#owner_name}
  */
  readonly ownerName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/devices zia_devices}
*/
export class DataZiaDevices extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaDevices that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/devices#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/devices zia_devices} Data Source
  *
  * @param scope The scope in which to define this construct
