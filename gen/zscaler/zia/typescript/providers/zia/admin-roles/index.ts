// https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles
...
export interface AdminRolesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#admin_acct_access AdminRoles#admin_acct_access}
  */
  readonly adminAcctAccess?: string;
  /**
  * Alerting access permission
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#alerting_access AdminRoles#alerting_access}
  */
  readonly alertingAccess?: string;
  /**
  * Insights logs access permission.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#analysis_access AdminRoles#analysis_access}
  */
  readonly analysisAccess?: string;
  /**
  * Dashboard access permission.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#dashboard_access AdminRoles#dashboard_access}
  */
  readonly dashboardAccess?: string;
  /**
  * Device information access permission. When set to NONE, device information is obfuscated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#device_info_access AdminRoles#device_info_access}
  */
  readonly deviceInfoAccess?: string;
  /**
  * External feature access permission.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#ext_feature_permissions AdminRoles#ext_feature_permissions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#feature_permissions AdminRoles#feature_permissions}
  */
  readonly featurePermissions?: { [key: string]: string };
  /**
  * Indicates whether this is an auditor role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#is_auditor AdminRoles#is_auditor}
  */
  readonly isAuditor?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether or not this admin user is editable/deletable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#is_non_editable AdminRoles#is_non_editable}
  */
  readonly isNonEditable?: boolean | cdktf.IResolvable;
  /**
  * Log range limit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#logs_limit AdminRoles#logs_limit}
  */
  readonly logsLimit?: string;
  /**
  * Name of the admin role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#name AdminRoles#name}
  */
  readonly name?: string;
  /**
  * Request method for which the rule must be applied. If not set, rule will be applied to all methods
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#permissions AdminRoles#permissions}
  */
  readonly permissions?: string[];
  /**
  * Policy access permission.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#policy_access AdminRoles#policy_access}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#rank AdminRoles#rank}
  */
  readonly rank?: number;
  /**
  * Report access permission.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#report_access AdminRoles#report_access}
  */
  readonly reportAccess?: string;
  /**
  * Time duration allocated to the report dashboard. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#report_time_duration AdminRoles#report_time_duration}
  */
  readonly reportTimeDuration?: number;
  /**
  * The admin role type. ()This attribute is subject to change.)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#role_type AdminRoles#role_type}
  */
  readonly roleType?: string;
  /**
  * Username access permission. When set to NONE, the username will be obfuscated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#username_access AdminRoles#username_access}
  */
  readonly usernameAccess?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles zia_admin_roles}
*/
export class AdminRoles extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdminRoles that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/admin_roles zia_admin_roles} Resource
  *
  * @param scope The scope in which to define this construct
