// https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/dlp_notification_templates
...
export interface DataZiaDlpNotificationTemplatesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/dlp_notification_templates#id DataZiaDlpNotificationTemplates#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/dlp_notification_templates#name DataZiaDlpNotificationTemplates#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/dlp_notification_templates zia_dlp_notification_templates}
*/
export class DataZiaDlpNotificationTemplates extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaDlpNotificationTemplates that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/dlp_notification_templates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/dlp_notification_templates zia_dlp_notification_templates} Data Source
  *
  * @param scope The scope in which to define this construct
