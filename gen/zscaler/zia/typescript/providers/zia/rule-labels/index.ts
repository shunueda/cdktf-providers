// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/rule_labels
...
export interface RuleLabelsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/rule_labels#description RuleLabels#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/rule_labels#name RuleLabels#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/rule_labels zia_rule_labels}
*/
export class RuleLabels extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RuleLabels that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/rule_labels#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/rule_labels zia_rule_labels} Resource
  *
  * @param scope The scope in which to define this construct
