// https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/forwarding_control_proxies
...
export interface ForwardingControlProxiesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/forwarding_control_proxies#address ForwardingControlProxies#address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/forwarding_control_proxies#base64_encode_xau_header ForwardingControlProxies#base64_encode_xau_header}
  */
  readonly base64EncodeXauHeader?: boolean | cdktf.IResolvable;
  /**
  * Additional details about the Proxy gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/forwarding_control_proxies#description ForwardingControlProxies#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/forwarding_control_proxies#insert_xau_header ForwardingControlProxies#insert_xau_header}
  */
  readonly insertXauHeader?: boolean | cdktf.IResolvable;
  /**
  * The name of the Proxy gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/forwarding_control_proxies#name ForwardingControlProxies#name}
  */
  readonly name?: string;
  /**
  * The port number on which the third-party proxy service listens to the requests forwarded from Zscaler
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/forwarding_control_proxies#port ForwardingControlProxies#port}
  */
  readonly port?: number;
  /**
  * Gateway type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/forwarding_control_proxies#type ForwardingControlProxies#type}
  */
  readonly type?: string;
  /**
  * cert block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/forwarding_control_proxies#cert ForwardingControlProxies#cert}
  */
  readonly cert?: ForwardingControlProxiesCert[] | cdktf.IResolvable;
}
export interface ForwardingControlProxiesCert {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/forwarding_control_proxies#id ForwardingControlProxies#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/forwarding_control_proxies zia_forwarding_control_proxies}
*/
export class ForwardingControlProxies extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ForwardingControlProxies that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/forwarding_control_proxies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/forwarding_control_proxies zia_forwarding_control_proxies} Resource
  *
  * @param scope The scope in which to define this construct
