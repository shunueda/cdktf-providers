// https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/custom_file_types
...
export interface DataZiaCustomFileTypesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/custom_file_types#id DataZiaCustomFileTypes#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/custom_file_types#name DataZiaCustomFileTypes#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/custom_file_types zia_custom_file_types}
*/
export class DataZiaCustomFileTypes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaCustomFileTypes that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/custom_file_types#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/custom_file_types zia_custom_file_types} Data Source
  *
  * @param scope The scope in which to define this construct
