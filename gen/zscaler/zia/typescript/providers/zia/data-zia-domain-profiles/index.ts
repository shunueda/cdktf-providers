// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/domain_profiles
...
export interface DataZiaDomainProfilesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/domain_profiles#id DataZiaDomainProfiles#id}
  *
  ...
  * Domain profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/domain_profiles#profile_id DataZiaDomainProfiles#profile_id}
  */
  readonly profileId?: number;
  /**
  * Domain profile name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/domain_profiles#profile_name DataZiaDomainProfiles#profile_name}
  */
  readonly profileName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/domain_profiles zia_domain_profiles}
*/
export class DataZiaDomainProfiles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaDomainProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/domain_profiles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/domain_profiles zia_domain_profiles} Data Source
  *
  * @param scope The scope in which to define this construct
