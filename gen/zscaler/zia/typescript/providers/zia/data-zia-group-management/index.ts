// https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/group_management
...
export interface DataZiaGroupManagementConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/group_management#id DataZiaGroupManagement#id}
  *
  ...
  */
  readonly id?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/group_management#name DataZiaGroupManagement#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/group_management zia_group_management}
*/
export class DataZiaGroupManagement extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaGroupManagement that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/group_management#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/group_management zia_group_management} Data Source
  *
  * @param scope The scope in which to define this construct
