// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/security_settings
...
export interface SecuritySettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/security_settings#blacklist_urls SecuritySettings#blacklist_urls}
  */
  readonly blacklistUrls?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/security_settings#id SecuritySettings#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/security_settings#whitelist_urls SecuritySettings#whitelist_urls}
  */
  readonly whitelistUrls?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/security_settings zia_security_settings}
*/
export class SecuritySettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecuritySettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/security_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/security_settings zia_security_settings} Resource
  *
  * @param scope The scope in which to define this construct
