// https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node
...
export interface VirtualServiceEdgeNodeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#cluster_name VirtualServiceEdgeNode#cluster_name}
  */
  readonly clusterName?: string;
  /**
  * The IP address of the default gateway to the internet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#default_gateway VirtualServiceEdgeNode#default_gateway}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#deployment_mode VirtualServiceEdgeNode#deployment_mode}
  */
  readonly deploymentMode?: string;
  /**
  * A Boolean value that indicates whether or not a support tunnel for Zscaler Support is enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#establish_support_tunnel_enabled VirtualServiceEdgeNode#establish_support_tunnel_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#in_production VirtualServiceEdgeNode#in_production}
  */
  readonly inProduction?: boolean | cdktf.IResolvable;
  /**
  * The Virtual Service Edge cluster IP address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#ip_address VirtualServiceEdgeNode#ip_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#ip_sec_enabled VirtualServiceEdgeNode#ip_sec_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#load_balancer_ip_address VirtualServiceEdgeNode#load_balancer_ip_address}
  */
  readonly loadBalancerIpAddress?: string;
  /**
  * Name of the Virtual Service Edge node
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#name VirtualServiceEdgeNode#name}
  */
  readonly name?: string;
  /**
  * A Boolean value that indicates whether or not the On-Demand Support Tunnel is enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#on_demand_support_tunnel_enabled VirtualServiceEdgeNode#on_demand_support_tunnel_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#status VirtualServiceEdgeNode#status}
  */
  readonly status?: string;
  /**
  * The Virtual Service Edge cluster subnet mask
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#subnet_mask VirtualServiceEdgeNode#subnet_mask}
  */
  readonly subnetMask?: string;
  /**
  * The Virtual Service Edge cluster type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#type VirtualServiceEdgeNode#type}
  */
  readonly type?: string;
  /**
  * The Virtual Service Edge SKU type. Supported Values: SMALL, MEDIUM, LARGE
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#vzen_sku_type VirtualServiceEdgeNode#vzen_sku_type}
  */
  readonly vzenSkuType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node zia_virtual_service_edge_node}
*/
export class VirtualServiceEdgeNode extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualServiceEdgeNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/virtual_service_edge_node zia_virtual_service_edge_node} Resource
  *
  * @param scope The scope in which to define this construct
