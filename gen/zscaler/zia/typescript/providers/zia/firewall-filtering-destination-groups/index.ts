// https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_destination_groups
...
export interface FirewallFilteringDestinationGroupsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_destination_groups#addresses FirewallFilteringDestinationGroups#addresses}
  */
  readonly addresses?: string[];
  /**
  * Destination countries for which the rule is applicable. If not set, the rule is not restricted to specific destination countries.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_destination_groups#countries FirewallFilteringDestinationGroups#countries}
  */
  readonly countries?: string[];
  /**
  * Additional information about the destination IP group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_destination_groups#description FirewallFilteringDestinationGroups#description}
  */
  readonly description?: string;
  /**
  * List of URL categories for which rule must be applied
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_destination_groups#ip_categories FirewallFilteringDestinationGroups#ip_categories}
  */
  readonly ipCategories?: string[];
  /**
  * Destination IP group name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_destination_groups#name FirewallFilteringDestinationGroups#name}
  */
  readonly name: string;
  /**
  * Destination IP group type (i.e., the group can contain destination IP addresses or FQDNs)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_destination_groups#type FirewallFilteringDestinationGroups#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_destination_groups zia_firewall_filtering_destination_groups}
*/
export class FirewallFilteringDestinationGroups extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirewallFilteringDestinationGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_destination_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_destination_groups zia_firewall_filtering_destination_groups} Resource
  *
  * @param scope The scope in which to define this construct
