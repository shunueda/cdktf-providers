// https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/sandbox_file_submission
...
export interface SandboxFileSubmissionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/sandbox_file_submission#file_path SandboxFileSubmission#file_path}
  */
  readonly filePath: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/sandbox_file_submission#force SandboxFileSubmission#force}
  */
  readonly force?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/sandbox_file_submission#id SandboxFileSubmission#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/sandbox_file_submission#submission_method SandboxFileSubmission#submission_method}
  */
  readonly submissionMethod: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/sandbox_file_submission zia_sandbox_file_submission}
*/
export class SandboxFileSubmission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SandboxFileSubmission that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/sandbox_file_submission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/sandbox_file_submission zia_sandbox_file_submission} Resource
  *
  * @param scope The scope in which to define this construct
