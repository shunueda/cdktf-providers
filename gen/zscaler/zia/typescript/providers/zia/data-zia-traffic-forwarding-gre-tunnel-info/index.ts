// https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/traffic_forwarding_gre_tunnel_info
...
export interface DataZiaTrafficForwardingGreTunnelInfoConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/traffic_forwarding_gre_tunnel_info#gre_enabled DataZiaTrafficForwardingGreTunnelInfo#gre_enabled}
  */
  readonly greEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/traffic_forwarding_gre_tunnel_info#id DataZiaTrafficForwardingGreTunnelInfo#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/traffic_forwarding_gre_tunnel_info#ip_address DataZiaTrafficForwardingGreTunnelInfo#ip_address}
  */
  readonly ipAddress?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/traffic_forwarding_gre_tunnel_info zia_traffic_forwarding_gre_tunnel_info}
*/
export class DataZiaTrafficForwardingGreTunnelInfo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaTrafficForwardingGreTunnelInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/traffic_forwarding_gre_tunnel_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.3/docs/data-sources/traffic_forwarding_gre_tunnel_info zia_traffic_forwarding_gre_tunnel_info} Data Source
  *
  * @param scope The scope in which to define this construct
