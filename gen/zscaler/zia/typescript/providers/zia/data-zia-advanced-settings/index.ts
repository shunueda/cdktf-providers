// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/advanced_settings
...
export interface DataZiaAdvancedSettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/advanced_settings#id DataZiaAdvancedSettings#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/advanced_settings zia_advanced_settings}
*/
export class DataZiaAdvancedSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaAdvancedSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/advanced_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/advanced_settings zia_advanced_settings} Data Source
  *
  * @param scope The scope in which to define this construct
