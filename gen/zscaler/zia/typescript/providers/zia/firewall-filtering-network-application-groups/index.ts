// https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_network_application_groups
...
export interface FirewallFilteringNetworkApplicationGroupsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_network_application_groups#description FirewallFilteringNetworkApplicationGroups#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_network_application_groups#name FirewallFilteringNetworkApplicationGroups#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_network_application_groups#network_applications FirewallFilteringNetworkApplicationGroups#network_applications}
  */
  readonly networkApplications?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_network_application_groups zia_firewall_filtering_network_application_groups}
*/
export class FirewallFilteringNetworkApplicationGroups extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirewallFilteringNetworkApplicationGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_network_application_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/firewall_filtering_network_application_groups zia_firewall_filtering_network_application_groups} Resource
  *
  * @param scope The scope in which to define this construct
