// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/end_user_notification
...
export interface DataZiaEndUserNotificationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/end_user_notification#id DataZiaEndUserNotification#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/end_user_notification zia_end_user_notification}
*/
export class DataZiaEndUserNotification extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaEndUserNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/end_user_notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/end_user_notification zia_end_user_notification} Data Source
  *
  * @param scope The scope in which to define this construct
