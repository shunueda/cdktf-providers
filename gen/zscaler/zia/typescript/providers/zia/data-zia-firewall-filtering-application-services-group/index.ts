// https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/firewall_filtering_application_services_group
...
export interface DataZiaFirewallFilteringApplicationServicesGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/firewall_filtering_application_services_group#name DataZiaFirewallFilteringApplicationServicesGroup#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/firewall_filtering_application_services_group zia_firewall_filtering_application_services_group}
*/
export class DataZiaFirewallFilteringApplicationServicesGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaFirewallFilteringApplicationServicesGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/firewall_filtering_application_services_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/firewall_filtering_application_services_group zia_firewall_filtering_application_services_group} Data Source
  *
  * @param scope The scope in which to define this construct
