// https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/gre_internal_ip_range_list
...
export interface DataZiaGreInternalIpRangeListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/gre_internal_ip_range_list#id DataZiaGreInternalIpRangeList#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/gre_internal_ip_range_list#required_count DataZiaGreInternalIpRangeList#required_count}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/gre_internal_ip_range_list zia_gre_internal_ip_range_list}
*/
export class DataZiaGreInternalIpRangeList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaGreInternalIpRangeList that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/gre_internal_ip_range_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/gre_internal_ip_range_list zia_gre_internal_ip_range_list} Data Source
  *
  * @param scope The scope in which to define this construct
