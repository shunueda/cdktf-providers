// https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/traffic_forwarding_gre_tunnel
...
export interface DataZiaTrafficForwardingGreTunnelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/traffic_forwarding_gre_tunnel#id DataZiaTrafficForwardingGreTunnel#id}
  *
  ...
  */
  readonly id?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/traffic_forwarding_gre_tunnel#source_ip DataZiaTrafficForwardingGreTunnel#source_ip}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/traffic_forwarding_gre_tunnel zia_traffic_forwarding_gre_tunnel}
*/
export class DataZiaTrafficForwardingGreTunnel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaTrafficForwardingGreTunnel that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/traffic_forwarding_gre_tunnel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/traffic_forwarding_gre_tunnel zia_traffic_forwarding_gre_tunnel} Data Source
  *
  * @param scope The scope in which to define this construct
