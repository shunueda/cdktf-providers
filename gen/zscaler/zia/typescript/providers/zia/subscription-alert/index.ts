// https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/subscription_alert
...
export interface SubscriptionAlertConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/subscription_alert#comply_severities SubscriptionAlert#comply_severities}
  */
  readonly complySeverities?: string[];
  /**
  * Enables or disables the status of the alert subscription
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/subscription_alert#description SubscriptionAlert#description}
  */
  readonly description?: string;
  /**
  * The email address of the alert recipient
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/subscription_alert#email SubscriptionAlert#email}
  */
  readonly email?: string;
  /**
  * Lists the severity levels of the Patient 0, Secure Alert class, System Alerts class
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/subscription_alert#manage_severities SubscriptionAlert#manage_severities}
  */
  readonly manageSeverities?: string[];
  /**
  * Lists the severity levels of the Patient 0, Secure Alert class, System Alerts class
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/subscription_alert#pt0_severities SubscriptionAlert#pt0_severities}
  */
  readonly pt0Severities?: string[];
  /**
  * Lists the severity levels of the Patient 0, Secure Alert class, System Alerts class
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/subscription_alert#secure_severities SubscriptionAlert#secure_severities}
  */
  readonly secureSeverities?: string[];
  /**
  * Lists the severity levels of the Patient 0, Secure Alert class, System Alerts class
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/subscription_alert#system_severities SubscriptionAlert#system_severities}
  */
  readonly systemSeverities?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/subscription_alert zia_subscription_alert}
*/
export class SubscriptionAlert extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SubscriptionAlert that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/subscription_alert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/resources/subscription_alert zia_subscription_alert} Resource
  *
  * @param scope The scope in which to define this construct
