// https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/bandwidth_classes
...
export interface BandwidthClassesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/bandwidth_classes#name BandwidthClasses#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/bandwidth_classes#url_categories BandwidthClasses#url_categories}
  */
  readonly urlCategories?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/bandwidth_classes#urls BandwidthClasses#urls}
  */
  readonly urls?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/bandwidth_classes#web_applications BandwidthClasses#web_applications}
  */
  readonly webApplications?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/bandwidth_classes zia_bandwidth_classes}
*/
export class BandwidthClasses extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BandwidthClasses that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/bandwidth_classes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/resources/bandwidth_classes zia_bandwidth_classes} Resource
  *
  * @param scope The scope in which to define this construct
