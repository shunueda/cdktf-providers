// https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/sandbox_report
...
export interface DataZiaSandboxReportConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/sandbox_report#details DataZiaSandboxReport#details}
  */
  readonly details?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/sandbox_report#id DataZiaSandboxReport#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/sandbox_report#md5_hash DataZiaSandboxReport#md5_hash}
  */
  readonly md5Hash: string;
  /**
  * exploit block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/sandbox_report#exploit DataZiaSandboxReport#exploit}
  */
  readonly exploit?: DataZiaSandboxReportExploit[] | cdktf.IResolvable;
  /**
  * networking block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/sandbox_report#networking DataZiaSandboxReport#networking}
  */
  readonly networking?: DataZiaSandboxReportNetworking[] | cdktf.IResolvable;
  /**
  * persistence block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/sandbox_report#persistence DataZiaSandboxReport#persistence}
  */
  readonly persistence?: DataZiaSandboxReportPersistence[] | cdktf.IResolvable;
  /**
  * security_bypass block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/sandbox_report#security_bypass DataZiaSandboxReport#security_bypass}
  */
  readonly securityBypass?: DataZiaSandboxReportSecurityBypass[] | cdktf.IResolvable;
  /**
  * spyware block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/sandbox_report#spyware DataZiaSandboxReport#spyware}
  */
  readonly spyware?: DataZiaSandboxReportSpyware[] | cdktf.IResolvable;
  /**
  * stealth block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/sandbox_report#stealth DataZiaSandboxReport#stealth}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/sandbox_report zia_sandbox_report}
*/
export class DataZiaSandboxReport extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaSandboxReport that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/sandbox_report#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/sandbox_report zia_sandbox_report} Data Source
  *
  * @param scope The scope in which to define this construct
