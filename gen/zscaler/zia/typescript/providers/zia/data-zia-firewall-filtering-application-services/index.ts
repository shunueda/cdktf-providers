// https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/firewall_filtering_application_services
...
export interface DataZiaFirewallFilteringApplicationServicesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/firewall_filtering_application_services#name DataZiaFirewallFilteringApplicationServices#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/firewall_filtering_application_services zia_firewall_filtering_application_services}
*/
export class DataZiaFirewallFilteringApplicationServices extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaFirewallFilteringApplicationServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/firewall_filtering_application_services#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/firewall_filtering_application_services zia_firewall_filtering_application_services} Data Source
  *
  * @param scope The scope in which to define this construct
