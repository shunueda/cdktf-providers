// https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/casb_email_label
...
export interface DataZiaCasbEmailLabelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/casb_email_label#id DataZiaCasbEmailLabel#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/casb_email_label#name DataZiaCasbEmailLabel#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/casb_email_label zia_casb_email_label}
*/
export class DataZiaCasbEmailLabel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaCasbEmailLabel that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/casb_email_label#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/casb_email_label zia_casb_email_label} Data Source
  *
  * @param scope The scope in which to define this construct
