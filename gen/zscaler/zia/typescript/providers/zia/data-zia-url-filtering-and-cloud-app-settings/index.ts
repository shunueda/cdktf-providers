// https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/url_filtering_and_cloud_app_settings
...
export interface DataZiaUrlFilteringAndCloudAppSettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/url_filtering_and_cloud_app_settings#id DataZiaUrlFilteringAndCloudAppSettings#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/url_filtering_and_cloud_app_settings zia_url_filtering_and_cloud_app_settings}
*/
export class DataZiaUrlFilteringAndCloudAppSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaUrlFilteringAndCloudAppSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/url_filtering_and_cloud_app_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/url_filtering_and_cloud_app_settings zia_url_filtering_and_cloud_app_settings} Data Source
  *
  * @param scope The scope in which to define this construct
