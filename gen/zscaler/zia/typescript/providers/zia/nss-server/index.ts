// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/nss_server
...
export interface NssServerConfig extends cdktf.TerraformMetaArguments {
  ...
  * The ICAP server ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/nss_server#icap_svr_id NssServer#icap_svr_id}
  */
  readonly icapSvrId?: number;
  /**
  * The NSS server name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/nss_server#name NssServer#name}
  */
  readonly name: string;
  /**
  * Enables or disables the status of the NSS server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/nss_server#status NssServer#status}
  */
  readonly status?: string;
  /**
  * The type of the NSS Server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/nss_server#type NssServer#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/nss_server zia_nss_server}
*/
export class NssServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NssServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/nss_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/nss_server zia_nss_server} Resource
  *
  * @param scope The scope in which to define this construct
