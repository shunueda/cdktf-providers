// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/bandwidth_classes
...
export interface DataZiaBandwidthClassesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/bandwidth_classes#file_size DataZiaBandwidthClasses#file_size}
  */
  readonly fileSize?: string;
  /**
  * The unique identifier for the bandwidth class
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/bandwidth_classes#id DataZiaBandwidthClasses#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/bandwidth_classes#name DataZiaBandwidthClasses#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/bandwidth_classes zia_bandwidth_classes}
*/
export class DataZiaBandwidthClasses extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaBandwidthClasses that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/bandwidth_classes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/bandwidth_classes zia_bandwidth_classes} Data Source
  *
  * @param scope The scope in which to define this construct
