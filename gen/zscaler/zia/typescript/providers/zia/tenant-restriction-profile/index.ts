// https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile
...
export interface TenantRestrictionProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#allow_gcp_cloud_storage_read TenantRestrictionProfile#allow_gcp_cloud_storage_read}
  */
  readonly allowGcpCloudStorageRead?: boolean | cdktf.IResolvable;
  /**
  * Flag to allow Google consumers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#allow_google_consumers TenantRestrictionProfile#allow_google_consumers}
  */
  readonly allowGoogleConsumers?: boolean | cdktf.IResolvable;
  /**
  * Flag to allow Google visitors
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#allow_google_visitors TenantRestrictionProfile#allow_google_visitors}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#app_type TenantRestrictionProfile#app_type}
  */
  readonly appType?: string;
  /**
  * Additional information about the profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#description TenantRestrictionProfile#description}
  */
  readonly description?: string;
  /**
  * Tenant profile primary item data
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#item_data_primary TenantRestrictionProfile#item_data_primary}
  */
  readonly itemDataPrimary?: string[];
  /**
  * List of certifications to be included or excluded for the profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#item_data_secondary TenantRestrictionProfile#item_data_secondary}
  */
  ...
  * 				https://help.zscaler.com/zia/cloud-app-control-policy#/tenancyRestrictionProfile-get
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#item_type_primary TenantRestrictionProfile#item_type_primary}
  */
  ...
  * 				https://help.zscaler.com/zia/cloud-app-control-policy#/tenancyRestrictionProfile-get
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#item_type_secondary TenantRestrictionProfile#item_type_secondary}
  */
  ...
  * 				https://help.zscaler.com/zia/cloud-app-control-policy#/tenancyRestrictionProfile-get
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#item_value TenantRestrictionProfile#item_value}
  */
  readonly itemValue?: string[];
  /**
  * Flag to decide between v1 and v2 for tenant restriction on MSLOGINSERVICES
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#ms_login_services_tr_v2 TenantRestrictionProfile#ms_login_services_tr_v2}
  */
  readonly msLoginServicesTrV2?: boolean | cdktf.IResolvable;
  /**
  * The tenant restriction profile name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#name TenantRestrictionProfile#name}
  */
  readonly name: string;
  /**
  * Flag to restrict personal domains for Office 365
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#restrict_personal_o365_domains TenantRestrictionProfile#restrict_personal_o365_domains}
  */
  readonly restrictPersonalO365Domains?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#timeouts TenantRestrictionProfile#timeouts}
  */
  readonly timeouts?: TenantRestrictionProfileTimeouts;
}
export interface TenantRestrictionProfileTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#create TenantRestrictionProfile#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#update TenantRestrictionProfile#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile zia_tenant_restriction_profile}
*/
export class TenantRestrictionProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TenantRestrictionProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/tenant_restriction_profile zia_tenant_restriction_profile} Resource
  *
  * @param scope The scope in which to define this construct
