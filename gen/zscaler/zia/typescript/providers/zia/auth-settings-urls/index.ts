// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/auth_settings_urls
...
export interface AuthSettingsUrlsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/auth_settings_urls#id AuthSettingsUrls#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/auth_settings_urls#urls AuthSettingsUrls#urls}
  */
  readonly urls?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/auth_settings_urls zia_auth_settings_urls}
*/
export class AuthSettingsUrls extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthSettingsUrls that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/auth_settings_urls#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/auth_settings_urls zia_auth_settings_urls} Resource
  *
  * @param scope The scope in which to define this construct
