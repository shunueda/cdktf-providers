// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/tenant_restriction_profile
...
export interface DataZiaTenantRestrictionProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/tenant_restriction_profile#description DataZiaTenantRestrictionProfile#description}
  */
  readonly description?: string;
  /**
  * The unique identifier for the tenant restriction profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/tenant_restriction_profile#id DataZiaTenantRestrictionProfile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/tenant_restriction_profile#name DataZiaTenantRestrictionProfile#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/tenant_restriction_profile zia_tenant_restriction_profile}
*/
export class DataZiaTenantRestrictionProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaTenantRestrictionProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/tenant_restriction_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/tenant_restriction_profile zia_tenant_restriction_profile} Data Source
  *
  * @param scope The scope in which to define this construct
