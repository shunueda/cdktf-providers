// https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/dlp_edm_schema
...
export interface DataZiaDlpEdmSchemaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/dlp_edm_schema#id DataZiaDlpEdmSchema#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/dlp_edm_schema#project_name DataZiaDlpEdmSchema#project_name}
  */
  readonly projectName?: string;
  /**
  * The identifier (1-65519) for the EDM schema (i.e., EDM template) that is unique within the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/dlp_edm_schema#schema_id DataZiaDlpEdmSchema#schema_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/dlp_edm_schema zia_dlp_edm_schema}
*/
export class DataZiaDlpEdmSchema extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaDlpEdmSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/dlp_edm_schema#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/dlp_edm_schema zia_dlp_edm_schema} Data Source
  *
  * @param scope The scope in which to define this construct
