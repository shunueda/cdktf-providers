// https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/rule_labels
...
export interface DataZiaRuleLabelsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/rule_labels#id DataZiaRuleLabels#id}
  *
  ...
  * The rule label name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/rule_labels#name DataZiaRuleLabels#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/rule_labels zia_rule_labels}
*/
export class DataZiaRuleLabels extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaRuleLabels that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/rule_labels#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/data-sources/rule_labels zia_rule_labels} Data Source
  *
  * @param scope The scope in which to define this construct
