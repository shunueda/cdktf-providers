// https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/atp_security_exceptions
...
export interface AtpSecurityExceptionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/atp_security_exceptions#bypass_urls AtpSecurityExceptions#bypass_urls}
  */
  readonly bypassUrls?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/atp_security_exceptions#id AtpSecurityExceptions#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/atp_security_exceptions zia_atp_security_exceptions}
*/
export class AtpSecurityExceptions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AtpSecurityExceptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/atp_security_exceptions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/atp_security_exceptions zia_atp_security_exceptions} Resource
  *
  * @param scope The scope in which to define this construct
