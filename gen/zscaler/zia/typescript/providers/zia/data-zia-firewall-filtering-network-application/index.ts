// https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/firewall_filtering_network_application
...
export interface DataZiaFirewallFilteringNetworkApplicationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/firewall_filtering_network_application#id DataZiaFirewallFilteringNetworkApplication#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/firewall_filtering_network_application#locale DataZiaFirewallFilteringNetworkApplication#locale}
  */
  readonly locale?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/firewall_filtering_network_application zia_firewall_filtering_network_application}
*/
export class DataZiaFirewallFilteringNetworkApplication extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaFirewallFilteringNetworkApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/firewall_filtering_network_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/firewall_filtering_network_application zia_firewall_filtering_network_application} Data Source
  *
  * @param scope The scope in which to define this construct
