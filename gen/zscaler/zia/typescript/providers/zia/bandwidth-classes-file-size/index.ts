// https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/bandwidth_classes_file_size
...
export interface BandwidthClassesFileSizeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/bandwidth_classes_file_size#file_size BandwidthClassesFileSize#file_size}
  */
  readonly fileSize?: string;
  /**
  * Name of the bandwidth class
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/bandwidth_classes_file_size#name BandwidthClassesFileSize#name}
  */
  readonly name?: string;
  /**
  * The application type for which the bandwidth class is configured
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/bandwidth_classes_file_size#type BandwidthClassesFileSize#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/bandwidth_classes_file_size zia_bandwidth_classes_file_size}
*/
export class BandwidthClassesFileSize extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BandwidthClassesFileSize that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/bandwidth_classes_file_size#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/bandwidth_classes_file_size zia_bandwidth_classes_file_size} Resource
  *
  * @param scope The scope in which to define this construct
