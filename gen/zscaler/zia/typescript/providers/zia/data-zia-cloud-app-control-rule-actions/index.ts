// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/cloud_app_control_rule_actions
...
export interface DataZiaCloudAppControlRuleActionsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/cloud_app_control_rule_actions#cloud_apps DataZiaCloudAppControlRuleActions#cloud_apps}
  */
  readonly cloudApps: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/cloud_app_control_rule_actions#id DataZiaCloudAppControlRuleActions#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/cloud_app_control_rule_actions#type DataZiaCloudAppControlRuleActions#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/cloud_app_control_rule_actions zia_cloud_app_control_rule_actions}
*/
export class DataZiaCloudAppControlRuleActions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaCloudAppControlRuleActions that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/cloud_app_control_rule_actions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/data-sources/cloud_app_control_rule_actions zia_cloud_app_control_rule_actions} Data Source
  *
  * @param scope The scope in which to define this construct
