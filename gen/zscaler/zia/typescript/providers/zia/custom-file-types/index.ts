// https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/custom_file_types
...
export interface CustomFileTypesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/custom_file_types#description CustomFileTypes#description}
  */
  readonly description?: string;
  /**
  * The file type extension. The maximum extension length is 10 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/custom_file_types#extension CustomFileTypes#extension}
  */
  readonly extension?: string;
  /**
  * The name of the custom file type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/custom_file_types#name CustomFileTypes#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/custom_file_types zia_custom_file_types}
*/
export class CustomFileTypes extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomFileTypes that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/custom_file_types#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.0/docs/resources/custom_file_types zia_custom_file_types} Resource
  *
  * @param scope The scope in which to define this construct
