// https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/firewall_filtering_network_application_groups
...
export interface DataZiaFirewallFilteringNetworkApplicationGroupsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/firewall_filtering_network_application_groups#id DataZiaFirewallFilteringNetworkApplicationGroups#id}
  *
  ...
  */
  readonly id?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/firewall_filtering_network_application_groups#name DataZiaFirewallFilteringNetworkApplicationGroups#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/firewall_filtering_network_application_groups zia_firewall_filtering_network_application_groups}
*/
export class DataZiaFirewallFilteringNetworkApplicationGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaFirewallFilteringNetworkApplicationGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/firewall_filtering_network_application_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.5.3/docs/data-sources/firewall_filtering_network_application_groups zia_firewall_filtering_network_application_groups} Data Source
  *
  * @param scope The scope in which to define this construct
