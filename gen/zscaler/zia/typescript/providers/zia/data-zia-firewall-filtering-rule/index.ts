// https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/firewall_filtering_rule
...
export interface DataZiaFirewallFilteringRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/firewall_filtering_rule#id DataZiaFirewallFilteringRule#id}
  *
  ...
  */
  readonly id?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/firewall_filtering_rule#name DataZiaFirewallFilteringRule#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/firewall_filtering_rule zia_firewall_filtering_rule}
*/
export class DataZiaFirewallFilteringRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaFirewallFilteringRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/firewall_filtering_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/firewall_filtering_rule zia_firewall_filtering_rule} Data Source
  *
  * @param scope The scope in which to define this construct
