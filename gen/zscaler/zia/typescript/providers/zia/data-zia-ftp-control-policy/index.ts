// https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/ftp_control_policy
...
export interface DataZiaFtpControlPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/ftp_control_policy#id DataZiaFtpControlPolicy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/ftp_control_policy zia_ftp_control_policy}
*/
export class DataZiaFtpControlPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaFtpControlPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/ftp_control_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.4/docs/data-sources/ftp_control_policy zia_ftp_control_policy} Data Source
  *
  * @param scope The scope in which to define this construct
