// https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/bandwidth_classes_web_conferencing
...
export interface BandwidthClassesWebConferencingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/bandwidth_classes_web_conferencing#applications BandwidthClassesWebConferencing#applications}
  */
  readonly applications?: string[];
  /**
  * The bandwidth class name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/bandwidth_classes_web_conferencing#name BandwidthClassesWebConferencing#name}
  */
  readonly name?: string;
  /**
  * The bandwidth class type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/bandwidth_classes_web_conferencing#type BandwidthClassesWebConferencing#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/bandwidth_classes_web_conferencing zia_bandwidth_classes_web_conferencing}
*/
export class BandwidthClassesWebConferencing extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BandwidthClassesWebConferencing that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/bandwidth_classes_web_conferencing#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.2/docs/resources/bandwidth_classes_web_conferencing zia_bandwidth_classes_web_conferencing} Resource
  *
  * @param scope The scope in which to define this construct
