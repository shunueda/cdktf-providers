// https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules
...
export interface TrafficCaptureRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#action TrafficCaptureRules#action}
  */
  readonly action?: string;
  /**
  * If set to true, the default rule is applied
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#default_rule TrafficCaptureRules#default_rule}
  */
  readonly defaultRule?: boolean | cdktf.IResolvable;
  /**
  * Additional information about the rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#description TrafficCaptureRules#description}
  */
  readonly description?: string;
  /**
  * Destination addresses. Supports IPv4, FQDNs, or wildcard FQDNs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#dest_addresses TrafficCaptureRules#dest_addresses}
  */
  readonly destAddresses?: string[];
  /**
  * Destination countries for which the rule is applicable. If not set, the rule is not restricted to specific destination countries.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#dest_countries TrafficCaptureRules#dest_countries}
  */
  readonly destCountries?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#dest_ip_categories TrafficCaptureRules#dest_ip_categories}
  */
  readonly destIpCategories?: string[];
  /**
  * List of device trust levels for which the rule must be applied. This field is applicable for devices that are managed using Zscaler Client Connector. The trust levels are assigned to the devices based on your posture configurations in the Zscaler Client Connector Portal. If no value is set, this field is ignored during the policy evaluation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#device_trust_levels TrafficCaptureRules#device_trust_levels}
  */
  readonly deviceTrustLevels?: string[];
  /**
  * Name of the Firewall Filtering policy rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#name TrafficCaptureRules#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#nw_applications TrafficCaptureRules#nw_applications}
  */
  readonly nwApplications?: string[];
  /**
  * Rule order number. If omitted, the rule will be added to the end of the rule set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#order TrafficCaptureRules#order}
  */
  readonly order: number;
  /**
  * If set to true, a predefined rule is applied
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#predefined TrafficCaptureRules#predefined}
  */
  readonly predefined?: boolean | cdktf.IResolvable;
  /**
  * Admin rank of the Firewall Filtering policy rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#rank TrafficCaptureRules#rank}
  */
  readonly rank?: number;
  /**
  * Destination countries for which the rule is applicable. If not set, the rule is not restricted to specific destination countries.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#source_countries TrafficCaptureRules#source_countries}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#src_ips TrafficCaptureRules#src_ips}
  */
  readonly srcIps?: string[];
  /**
  * Determines whether the Firewall Filtering policy rule is enabled or disabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#state TrafficCaptureRules#state}
  */
  readonly state?: string;
  /**
  * The percentage of connections sampled for capturing each time the rule is triggered
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#txn_sampling TrafficCaptureRules#txn_sampling}
  */
  readonly txnSampling?: string;
  /**
  * The maximum size of traffic to capture per connection
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#txn_size_limit TrafficCaptureRules#txn_size_limit}
  */
  readonly txnSizeLimit?: string;
  /**
  * app_service_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#app_service_groups TrafficCaptureRules#app_service_groups}
  */
  readonly appServiceGroups?: TrafficCaptureRulesAppServiceGroups;
  /**
  * departments block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#departments TrafficCaptureRules#departments}
  */
  readonly departments?: TrafficCaptureRulesDepartments;
  /**
  * dest_ip_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#dest_ip_groups TrafficCaptureRules#dest_ip_groups}
  */
  readonly destIpGroups?: TrafficCaptureRulesDestIpGroups;
  /**
  * device_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#device_groups TrafficCaptureRules#device_groups}
  */
  readonly deviceGroups?: TrafficCaptureRulesDeviceGroups;
  /**
  * devices block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#devices TrafficCaptureRules#devices}
  */
  readonly devices?: TrafficCaptureRulesDevices;
  /**
  * groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#groups TrafficCaptureRules#groups}
  */
  readonly groups?: TrafficCaptureRulesGroups;
  /**
  * labels block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#labels TrafficCaptureRules#labels}
  */
  readonly labels?: TrafficCaptureRulesLabels;
  /**
  * location_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#location_groups TrafficCaptureRules#location_groups}
  */
  readonly locationGroups?: TrafficCaptureRulesLocationGroups;
  /**
  * locations block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#locations TrafficCaptureRules#locations}
  */
  readonly locations?: TrafficCaptureRulesLocations;
  /**
  * nw_application_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#nw_application_groups TrafficCaptureRules#nw_application_groups}
  */
  readonly nwApplicationGroups?: TrafficCaptureRulesNwApplicationGroups;
  /**
  * nw_service_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#nw_service_groups TrafficCaptureRules#nw_service_groups}
  */
  readonly nwServiceGroups?: TrafficCaptureRulesNwServiceGroups;
  /**
  * nw_services block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#nw_services TrafficCaptureRules#nw_services}
  */
  readonly nwServices?: TrafficCaptureRulesNwServices;
  /**
  * src_ip_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#src_ip_groups TrafficCaptureRules#src_ip_groups}
  */
  readonly srcIpGroups?: TrafficCaptureRulesSrcIpGroups;
  /**
  * time_windows block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#time_windows TrafficCaptureRules#time_windows}
  */
  readonly timeWindows?: TrafficCaptureRulesTimeWindows;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#timeouts TrafficCaptureRules#timeouts}
  */
  readonly timeouts?: TrafficCaptureRulesTimeouts;
  /**
  * users block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#users TrafficCaptureRules#users}
  */
  readonly users?: TrafficCaptureRulesUsers;
  /**
  * workload_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#workload_groups TrafficCaptureRules#workload_groups}
  */
...
export interface TrafficCaptureRulesAppServiceGroups {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#id TrafficCaptureRules#id}
  *
...
export interface TrafficCaptureRulesTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#create TrafficCaptureRules#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#update TrafficCaptureRules#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules zia_traffic_capture_rules}
*/
export class TrafficCaptureRules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrafficCaptureRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/resources/traffic_capture_rules zia_traffic_capture_rules} Resource
  *
  * @param scope The scope in which to define this construct
