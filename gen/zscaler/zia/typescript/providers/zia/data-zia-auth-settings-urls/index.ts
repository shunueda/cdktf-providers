// https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/auth_settings_urls
...
export interface DataZiaAuthSettingsUrlsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/auth_settings_urls#id DataZiaAuthSettingsUrls#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/auth_settings_urls zia_auth_settings_urls}
*/
export class DataZiaAuthSettingsUrls extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZiaAuthSettingsUrls that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/auth_settings_urls#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.6.5/docs/data-sources/auth_settings_urls zia_auth_settings_urls} Data Source
  *
  * @param scope The scope in which to define this construct
