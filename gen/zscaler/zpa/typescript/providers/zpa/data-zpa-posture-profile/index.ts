// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/posture_profile
...
export interface DataZpaPostureProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/posture_profile#id DataZpaPostureProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/posture_profile#name DataZpaPostureProfile#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/posture_profile#posture_udid DataZpaPostureProfile#posture_udid}
  */
  readonly postureUdid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/posture_profile zpa_posture_profile}
*/
export class DataZpaPostureProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaPostureProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/posture_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/posture_profile zpa_posture_profile} Data Source
  *
  * @param scope The scope in which to define this construct
