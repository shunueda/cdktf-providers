// https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/customer_version_profile
...
export interface DataZpaCustomerVersionProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/customer_version_profile#name DataZpaCustomerVersionProfile#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/customer_version_profile zpa_customer_version_profile}
*/
export class DataZpaCustomerVersionProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaCustomerVersionProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/customer_version_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/customer_version_profile zpa_customer_version_profile} Data Source
  *
  * @param scope The scope in which to define this construct
