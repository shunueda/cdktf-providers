// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/service_edge_assistant_schedule
...
export interface ServiceEdgeAssistantScheduleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/service_edge_assistant_schedule#customer_id ServiceEdgeAssistantSchedule#customer_id}
  */
  readonly customerId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/service_edge_assistant_schedule#delete_disabled ServiceEdgeAssistantSchedule#delete_disabled}
  */
  readonly deleteDisabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/service_edge_assistant_schedule#enabled ServiceEdgeAssistantSchedule#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/service_edge_assistant_schedule#frequency ServiceEdgeAssistantSchedule#frequency}
  */
  readonly frequency?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/service_edge_assistant_schedule#frequency_interval ServiceEdgeAssistantSchedule#frequency_interval}
  */
  readonly frequencyInterval?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/service_edge_assistant_schedule zpa_service_edge_assistant_schedule}
*/
export class ServiceEdgeAssistantSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceEdgeAssistantSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/service_edge_assistant_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/service_edge_assistant_schedule zpa_service_edge_assistant_schedule} Resource
  *
  * @param scope The scope in which to define this construct
