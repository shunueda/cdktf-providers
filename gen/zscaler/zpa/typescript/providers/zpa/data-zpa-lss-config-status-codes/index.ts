// https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/lss_config_status_codes
...
export interface DataZpaLssConfigStatusCodesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/lss_config_status_codes#id DataZpaLssConfigStatusCodes#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/lss_config_status_codes zpa_lss_config_status_codes}
*/
export class DataZpaLssConfigStatusCodes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaLssConfigStatusCodes that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/lss_config_status_codes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/lss_config_status_codes zpa_lss_config_status_codes} Data Source
  *
  * @param scope The scope in which to define this construct
