// https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller
...
export interface UserPortalControllerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller#certificate_id UserPortalController#certificate_id}
  */
  readonly certificateId?: string;
  /**
  * Description of the User Portal Controller
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller#description UserPortalController#description}
  */
  readonly description?: string;
  /**
  * Domain for the User Portal Controller
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller#domain UserPortalController#domain}
  */
  readonly domain?: string;
  /**
  * Whether this User Portal Controller is enabled or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller#enabled UserPortalController#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * External domain for the User Portal Controller
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller#ext_domain UserPortalController#ext_domain}
  */
  readonly extDomain?: string;
  /**
  * External domain name for the User Portal Controller
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller#ext_domain_name UserPortalController#ext_domain_name}
  */
  readonly extDomainName?: string;
  /**
  * External domain translation for the User Portal Controller
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller#ext_domain_translation UserPortalController#ext_domain_translation}
  */
  readonly extDomainTranslation?: string;
  /**
  * External label for the User Portal Controller
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller#ext_label UserPortalController#ext_label}
  */
  readonly extLabel?: string;
  /**
  * Microtenant ID for the User Portal Controller
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller#microtenant_id UserPortalController#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * Name of the User Portal Controller
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller#name UserPortalController#name}
  */
  readonly name: string;
  /**
  * User notification message for the User Portal Controller
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller#user_notification UserPortalController#user_notification}
  */
  readonly userNotification?: string;
  /**
  * Whether user notifications are enabled for the User Portal Controller
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller#user_notification_enabled UserPortalController#user_notification_enabled}
  */
  readonly userNotificationEnabled?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller zpa_user_portal_controller}
*/
export class UserPortalController extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserPortalController that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/resources/user_portal_controller zpa_user_portal_controller} Resource
  *
  * @param scope The scope in which to define this construct
