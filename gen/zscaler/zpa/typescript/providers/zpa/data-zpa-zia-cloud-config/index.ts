// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/zia_cloud_config
...
export interface DataZpaZiaCloudConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/zia_cloud_config#id DataZpaZiaCloudConfig#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/zia_cloud_config zpa_zia_cloud_config}
*/
export class DataZpaZiaCloudConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaZiaCloudConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/zia_cloud_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/zia_cloud_config zpa_zia_cloud_config} Data Source
  *
  * @param scope The scope in which to define this construct
