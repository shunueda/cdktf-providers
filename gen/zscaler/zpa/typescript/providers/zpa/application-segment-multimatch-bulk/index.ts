// https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/application_segment_multimatch_bulk
...
export interface ApplicationSegmentMultimatchBulkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/application_segment_multimatch_bulk#application_ids ApplicationSegmentMultimatchBulk#application_ids}
  */
  readonly applicationIds: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/application_segment_multimatch_bulk#id ApplicationSegmentMultimatchBulk#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/application_segment_multimatch_bulk#match_style ApplicationSegmentMultimatchBulk#match_style}
  */
  readonly matchStyle: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/application_segment_multimatch_bulk zpa_application_segment_multimatch_bulk}
*/
export class ApplicationSegmentMultimatchBulk extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationSegmentMultimatchBulk that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/application_segment_multimatch_bulk#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/application_segment_multimatch_bulk zpa_application_segment_multimatch_bulk} Resource
  *
  * @param scope The scope in which to define this construct
