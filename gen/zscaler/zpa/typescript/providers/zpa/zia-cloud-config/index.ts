// https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/zia_cloud_config
...
export interface ZiaCloudConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/zia_cloud_config#id ZiaCloudConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/zia_cloud_config#zia_cloud_domain ZiaCloudConfig#zia_cloud_domain}
  */
  readonly ziaCloudDomain: string;
  /**
  * ZIA cloud service API key (write-only, not returned by API)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/zia_cloud_config#zia_cloud_service_api_key ZiaCloudConfig#zia_cloud_service_api_key}
  */
  readonly ziaCloudServiceApiKey: string;
  /**
  * ZIA password (write-only, not returned by API)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/zia_cloud_config#zia_password ZiaCloudConfig#zia_password}
  */
  readonly ziaPassword: string;
  /**
  * ZIA sandbox API token (write-only, not returned by API)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/zia_cloud_config#zia_sandbox_api_token ZiaCloudConfig#zia_sandbox_api_token}
  */
  readonly ziaSandboxApiToken: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/zia_cloud_config#zia_username ZiaCloudConfig#zia_username}
  */
  readonly ziaUsername: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/zia_cloud_config zpa_zia_cloud_config}
*/
export class ZiaCloudConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZiaCloudConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/zia_cloud_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/zia_cloud_config zpa_zia_cloud_config} Resource
  *
  * @param scope The scope in which to define this construct
