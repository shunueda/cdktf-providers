// https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group
...
export interface AppConnectorGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#city_country AppConnectorGroup#city_country}
  */
  readonly cityCountry?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#country_code AppConnectorGroup#country_code}
  */
  readonly countryCode?: string;
  /**
  * Description of the App Connector Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#description AppConnectorGroup#description}
  */
  readonly description?: string;
  /**
  * Whether to enable IPv4 or IPv6, or both, for DNS resolution of all applications in the App Connector Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#dns_query_type AppConnectorGroup#dns_query_type}
  */
  readonly dnsQueryType?: string;
  /**
  * Whether this App Connector Group is enabled or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#enabled AppConnectorGroup#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Latitude of the App Connector Group. Integer or decimal. With values in the range of -90 to 90
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#latitude AppConnectorGroup#latitude}
  */
  readonly latitude: string;
  /**
  * Location of the App Connector Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#location AppConnectorGroup#location}
  */
  readonly location: string;
  /**
  * Longitude of the App Connector Group. Integer or decimal. With values in the range of -180 to 180
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#longitude AppConnectorGroup#longitude}
  */
  readonly longitude: string;
  /**
  * Whether or not the App Connector Group is configured for the Log Streaming Service (LSS)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#lss_app_connector_group AppConnectorGroup#lss_app_connector_group}
  */
  readonly lssAppConnectorGroup?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#microtenant_id AppConnectorGroup#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * Name of the App Connector Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#name AppConnectorGroup#name}
  */
  readonly name: string;
  /**
  * Whether the default version profile of the App Connector Group is applied or overridden. Supported values: true, false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#override_version_profile AppConnectorGroup#override_version_profile}
  */
  readonly overrideVersionProfile?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#pra_enabled AppConnectorGroup#pra_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#tcp_quick_ack_app AppConnectorGroup#tcp_quick_ack_app}
  */
  readonly tcpQuickAckApp?: boolean | cdktf.IResolvable;
  /**
  * Whether TCP Quick Acknowledgement is enabled or disabled for the application. The tcpQuickAckApp, tcpQuickAckAssistant, and tcpQuickAckReadAssistant fields must all share the same value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#tcp_quick_ack_assistant AppConnectorGroup#tcp_quick_ack_assistant}
  */
  readonly tcpQuickAckAssistant?: boolean | cdktf.IResolvable;
  /**
  * Whether TCP Quick Acknowledgement is enabled or disabled for the application. The tcpQuickAckApp, tcpQuickAckAssistant, and tcpQuickAckReadAssistant fields must all share the same value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#tcp_quick_ack_read_assistant AppConnectorGroup#tcp_quick_ack_read_assistant}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#upgrade_day AppConnectorGroup#upgrade_day}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#upgrade_time_in_secs AppConnectorGroup#upgrade_time_in_secs}
  */
  readonly upgradeTimeInSecs?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#use_in_dr_mode AppConnectorGroup#use_in_dr_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#version_profile_id AppConnectorGroup#version_profile_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#version_profile_name AppConnectorGroup#version_profile_name}
  */
  readonly versionProfileName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#waf_disabled AppConnectorGroup#waf_disabled}
  */
  readonly wafDisabled?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group zpa_app_connector_group}
*/
export class AppConnectorGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectorGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/app_connector_group zpa_app_connector_group} Resource
  *
  * @param scope The scope in which to define this construct
