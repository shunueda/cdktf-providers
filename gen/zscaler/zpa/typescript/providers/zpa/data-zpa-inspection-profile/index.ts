// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/inspection_profile
...
export interface DataZpaInspectionProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/inspection_profile#id DataZpaInspectionProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/inspection_profile#name DataZpaInspectionProfile#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/inspection_profile zpa_inspection_profile}
*/
export class DataZpaInspectionProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaInspectionProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/inspection_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/inspection_profile zpa_inspection_profile} Data Source
  *
  * @param scope The scope in which to define this construct
