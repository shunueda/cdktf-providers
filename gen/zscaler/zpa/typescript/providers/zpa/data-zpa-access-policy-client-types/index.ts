// https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/access_policy_client_types
...
export interface DataZpaAccessPolicyClientTypesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/access_policy_client_types#id DataZpaAccessPolicyClientTypes#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/access_policy_client_types zpa_access_policy_client_types}
*/
export class DataZpaAccessPolicyClientTypes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaAccessPolicyClientTypes that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/access_policy_client_types#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/access_policy_client_types zpa_access_policy_client_types} Data Source
  *
  * @param scope The scope in which to define this construct
