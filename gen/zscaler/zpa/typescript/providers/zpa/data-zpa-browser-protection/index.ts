// https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/browser_protection
...
export interface DataZpaBrowserProtectionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/browser_protection#name DataZpaBrowserProtection#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/browser_protection zpa_browser_protection}
*/
export class DataZpaBrowserProtection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaBrowserProtection that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/browser_protection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/browser_protection zpa_browser_protection} Data Source
  *
  * @param scope The scope in which to define this construct
