// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_segment_weightedlb_config
...
export interface ApplicationSegmentWeightedlbConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_segment_weightedlb_config#application_id ApplicationSegmentWeightedlbConfig#application_id}
  */
  readonly applicationId?: string;
  /**
  * Application segment name to manage. Either application_id or application_name must be provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_segment_weightedlb_config#application_name ApplicationSegmentWeightedlbConfig#application_name}
  */
  readonly applicationName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_segment_weightedlb_config#id ApplicationSegmentWeightedlbConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_segment_weightedlb_config#microtenant_id ApplicationSegmentWeightedlbConfig#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * Enable or disable weighted load balancing for the application segment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_segment_weightedlb_config#weighted_load_balancing ApplicationSegmentWeightedlbConfig#weighted_load_balancing}
  */
  readonly weightedLoadBalancing?: boolean | cdktf.IResolvable;
  /**
  * application_to_server_group_mappings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_segment_weightedlb_config#application_to_server_group_mappings ApplicationSegmentWeightedlbConfig#application_to_server_group_mappings}
  */
...
export interface ApplicationSegmentWeightedlbConfigApplicationToServerGroupMappings {
  ...
  * Server group name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_segment_weightedlb_config#name ApplicationSegmentWeightedlbConfig#name}
  */
  readonly name?: string;
  /**
  * Whether the server group is passive.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_segment_weightedlb_config#passive ApplicationSegmentWeightedlbConfig#passive}
  */
  readonly passive?: boolean | cdktf.IResolvable;
  /**
  * Assigned weight for the server group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_segment_weightedlb_config#weight ApplicationSegmentWeightedlbConfig#weight}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_segment_weightedlb_config zpa_application_segment_weightedlb_config}
*/
export class ApplicationSegmentWeightedlbConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationSegmentWeightedlbConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_segment_weightedlb_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_segment_weightedlb_config zpa_application_segment_weightedlb_config} Resource
  *
  * @param scope The scope in which to define this construct
