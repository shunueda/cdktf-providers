// https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/isolation_profile
...
export interface DataZpaIsolationProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/isolation_profile#id DataZpaIsolationProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/isolation_profile#name DataZpaIsolationProfile#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/isolation_profile zpa_isolation_profile}
*/
export class DataZpaIsolationProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaIsolationProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/isolation_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/isolation_profile zpa_isolation_profile} Data Source
  *
  * @param scope The scope in which to define this construct
