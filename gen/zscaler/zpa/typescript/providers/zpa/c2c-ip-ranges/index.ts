// https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges
...
export interface C2CIpRangesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges#country_code C2CIpRanges#country_code}
  */
  readonly countryCode?: string;
  /**
  * Description of the C2C IP Ranges
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges#description C2CIpRanges#description}
  */
  readonly description?: string;
  /**
  * Whether the C2C IP Ranges is enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges#enabled C2CIpRanges#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Beginning IP address of the range
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges#ip_range_begin C2CIpRanges#ip_range_begin}
  */
  readonly ipRangeBegin?: string;
  /**
  * Ending IP address of the range
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges#ip_range_end C2CIpRanges#ip_range_end}
  */
  readonly ipRangeEnd?: string;
  /**
  * Latitude in database for the C2C IP Ranges
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges#latitude_in_db C2CIpRanges#latitude_in_db}
  */
  readonly latitudeInDb?: string;
  /**
  * Location of the C2C IP Ranges
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges#location C2CIpRanges#location}
  */
  readonly location?: string;
  /**
  * Location hint for the C2C IP Ranges
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges#location_hint C2CIpRanges#location_hint}
  */
  readonly locationHint?: string;
  /**
  * Longitude in database for the C2C IP Ranges
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges#longitude_in_db C2CIpRanges#longitude_in_db}
  */
  readonly longitudeInDb?: string;
  /**
  * Name of the C2C IP Ranges
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges#name C2CIpRanges#name}
  */
  readonly name: string;
  /**
  * SCCM flag for the C2C IP Ranges
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges#sccm_flag C2CIpRanges#sccm_flag}
  */
  readonly sccmFlag?: boolean | cdktf.IResolvable;
  /**
  * Subnet CIDR for the C2C IP Ranges
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges#subnet_cidr C2CIpRanges#subnet_cidr}
  */
  readonly subnetCidr?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges zpa_c2c_ip_ranges}
*/
export class C2CIpRanges extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing C2CIpRanges that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/c2c_ip_ranges zpa_c2c_ip_ranges} Resource
  *
  * @param scope The scope in which to define this construct
