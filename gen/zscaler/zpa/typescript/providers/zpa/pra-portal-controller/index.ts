// https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller
...
export interface PraPortalControllerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#approval_reviewers PraPortalController#approval_reviewers}
  */
  readonly approvalReviewers?: string[];
  /**
  * The unique identifier of the certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#certificate_id PraPortalController#certificate_id}
  */
  readonly certificateId?: string;
  /**
  * The description of the privileged portal
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#description PraPortalController#description}
  */
  readonly description?: string;
  /**
  * The domain of the privileged portal
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#domain PraPortalController#domain}
  */
  readonly domain?: string;
  /**
  * Whether or not the privileged portal is enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#enabled PraPortalController#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#ext_domain PraPortalController#ext_domain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#ext_domain_name PraPortalController#ext_domain_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#ext_domain_translation PraPortalController#ext_domain_translation}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#ext_label PraPortalController#ext_label}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#microtenant_id PraPortalController#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * The name of the privileged portal
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#name PraPortalController#name}
  */
  readonly name?: string;
  /**
  * The notification message displayed in the banner of the privileged portallink, if enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#user_notification PraPortalController#user_notification}
  */
  readonly userNotification?: string;
  /**
  * Indicates if the Notification Banner is enabled (true) or disabled (false)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#user_notification_enabled PraPortalController#user_notification_enabled}
  */
  readonly userNotificationEnabled?: boolean | cdktf.IResolvable;
  /**
  * The unique identifier of the user portal.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#user_portal_gid PraPortalController#user_portal_gid}
  */
  readonly userPortalGid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller zpa_pra_portal_controller}
*/
export class PraPortalController extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PraPortalController that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/pra_portal_controller zpa_pra_portal_controller} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: PraPortalControllerConfig = {}) {
    ...
    this._approvalReviewers = config.approvalReviewers;
  ...
  // approval_reviewers - computed: false, optional: true, required: false
  private _approvalReviewers?: string[]; 
  public get approvalReviewers() {
    return cdktf.Fn.tolist(this.getListAttribute('approval_reviewers'));
  }
  public set approvalReviewers(value: string[]) {
    this._approvalReviewers = value;
  }
  public resetApprovalReviewers() {
    this._approvalReviewers = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get approvalReviewersInput() {
    return this._approvalReviewers;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      approval_reviewers: cdktf.listMapper(cdktf.stringToTerraform, false)(this._approvalReviewers),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      approval_reviewers: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._approvalReviewers),
        isBlock: false,
        type: "set",
