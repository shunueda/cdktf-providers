// https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/lss_config_controller
...
export interface DataZpaLssConfigControllerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/lss_config_controller#id DataZpaLssConfigController#id}
  *
  ...
  * config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/lss_config_controller#config DataZpaLssConfigController#config}
  */
...
export interface DataZpaLssConfigControllerConfigA {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/lss_config_controller#name DataZpaLssConfigController#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/lss_config_controller zpa_lss_config_controller}
*/
export class DataZpaLssConfigController extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaLssConfigController that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/lss_config_controller#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/lss_config_controller zpa_lss_config_controller} Data Source
  *
  * @param scope The scope in which to define this construct
