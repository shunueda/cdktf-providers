// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/cloud_browser_isolation_banner
...
export interface CloudBrowserIsolationBannerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/cloud_browser_isolation_banner#banner CloudBrowserIsolationBanner#banner}
  */
  readonly banner?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/cloud_browser_isolation_banner#logo CloudBrowserIsolationBanner#logo}
  */
  readonly logo?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/cloud_browser_isolation_banner#name CloudBrowserIsolationBanner#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/cloud_browser_isolation_banner#notification_text CloudBrowserIsolationBanner#notification_text}
  */
  readonly notificationText?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/cloud_browser_isolation_banner#notification_title CloudBrowserIsolationBanner#notification_title}
  */
  readonly notificationTitle?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/cloud_browser_isolation_banner#persist CloudBrowserIsolationBanner#persist}
  */
  readonly persist?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/cloud_browser_isolation_banner#primary_color CloudBrowserIsolationBanner#primary_color}
  */
  readonly primaryColor?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/cloud_browser_isolation_banner#text_color CloudBrowserIsolationBanner#text_color}
  */
  readonly textColor?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/cloud_browser_isolation_banner zpa_cloud_browser_isolation_banner}
*/
export class CloudBrowserIsolationBanner extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudBrowserIsolationBanner that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/cloud_browser_isolation_banner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/cloud_browser_isolation_banner zpa_cloud_browser_isolation_banner} Resource
  *
  * @param scope The scope in which to define this construct
