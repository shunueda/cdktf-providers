// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/c2c_ip_ranges
...
export interface DataZpaC2CIpRangesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/c2c_ip_ranges#id DataZpaC2CIpRanges#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/c2c_ip_ranges#name DataZpaC2CIpRanges#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/c2c_ip_ranges zpa_c2c_ip_ranges}
*/
export class DataZpaC2CIpRanges extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaC2CIpRanges that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/c2c_ip_ranges#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/c2c_ip_ranges zpa_c2c_ip_ranges} Data Source
  *
  * @param scope The scope in which to define this construct
