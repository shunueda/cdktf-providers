// https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/enrollment_cert
...
export interface DataZpaEnrollmentCertConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/enrollment_cert#id DataZpaEnrollmentCert#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/enrollment_cert#microtenant_id DataZpaEnrollmentCert#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/enrollment_cert#name DataZpaEnrollmentCert#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/enrollment_cert zpa_enrollment_cert}
*/
export class DataZpaEnrollmentCert extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaEnrollmentCert that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/enrollment_cert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/enrollment_cert zpa_enrollment_cert} Data Source
  *
  * @param scope The scope in which to define this construct
