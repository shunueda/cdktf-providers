// https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/application_segment_multimatch_bulk
...
export interface DataZpaApplicationSegmentMultimatchBulkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/application_segment_multimatch_bulk#domain_names DataZpaApplicationSegmentMultimatchBulk#domain_names}
  */
  readonly domainNames: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/application_segment_multimatch_bulk#id DataZpaApplicationSegmentMultimatchBulk#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/application_segment_multimatch_bulk zpa_application_segment_multimatch_bulk}
*/
export class DataZpaApplicationSegmentMultimatchBulk extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaApplicationSegmentMultimatchBulk that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/application_segment_multimatch_bulk#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/application_segment_multimatch_bulk zpa_application_segment_multimatch_bulk} Data Source
  *
  * @param scope The scope in which to define this construct
