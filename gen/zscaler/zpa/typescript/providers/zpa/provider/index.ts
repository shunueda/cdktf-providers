// https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs
...
export interface ZpaProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#backoff ZpaProvider#backoff}
  */
  readonly backoff?: boolean | cdktf.IResolvable;
  /**
  * zpa client id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#client_id ZpaProvider#client_id}
  */
  readonly clientId?: string;
  /**
  * zpa client secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#client_secret ZpaProvider#client_secret}
  */
  readonly clientSecret?: string;
  /**
  * zpa customer id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#customer_id ZpaProvider#customer_id}
  */
  readonly customerId?: string;
  /**
  * Alternate HTTP proxy of scheme://hostname or scheme://hostname:port format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#http_proxy ZpaProvider#http_proxy}
  */
  readonly httpProxy?: string;
  /**
  * maximum number of retries to attempt before erroring out.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#max_retries ZpaProvider#max_retries}
  */
  readonly maxRetries?: number;
  /**
  * maximum seconds to wait when rate limit is hit. We use exponential backoffs when backoff is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#max_wait_seconds ZpaProvider#max_wait_seconds}
  */
  readonly maxWaitSeconds?: number;
  /**
  * zpa microtenant ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#microtenant_id ZpaProvider#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * minimum seconds to wait when rate limit is hit. We use exponential backoffs when backoff is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#min_wait_seconds ZpaProvider#min_wait_seconds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#parallelism ZpaProvider#parallelism}
  */
  readonly parallelism?: number;
  /**
  * zpa private key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#private_key ZpaProvider#private_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#request_timeout ZpaProvider#request_timeout}
  */
  readonly requestTimeout?: number;
  /**
  * Enables interaction with the ZPA legacy API framework
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#use_legacy_client ZpaProvider#use_legacy_client}
  */
  readonly useLegacyClient?: boolean | cdktf.IResolvable;
  /**
  * Zscaler Vanity Domain
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#vanity_domain ZpaProvider#vanity_domain}
  */
  readonly vanityDomain?: string;
  /**
  * zpa client id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#zpa_client_id ZpaProvider#zpa_client_id}
  */
  readonly zpaClientId?: string;
  /**
  * zpa client secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#zpa_client_secret ZpaProvider#zpa_client_secret}
  */
  readonly zpaClientSecret?: string;
  /**
  * Cloud to use PRODUCTION, ZPATWO, BETA, GOV, GOVUS, PREVIEW, DEV, QA, QA2
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#zpa_cloud ZpaProvider#zpa_cloud}
  */
  readonly zpaCloud?: string;
  /**
  * zpa customer id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#zpa_customer_id ZpaProvider#zpa_customer_id}
  */
  readonly zpaCustomerId?: string;
  /**
  * Zscaler Cloud Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#zscaler_cloud ZpaProvider#zscaler_cloud}
  */
  readonly zscalerCloud?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#alias ZpaProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs zpa}
*/
export class ZpaProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ZpaProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs zpa} Resource
  *
  * @param scope The scope in which to define this construct
