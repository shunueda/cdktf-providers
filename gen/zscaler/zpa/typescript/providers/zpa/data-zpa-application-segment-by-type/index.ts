// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/application_segment_by_type
...
export interface DataZpaApplicationSegmentByTypeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/application_segment_by_type#application_type DataZpaApplicationSegmentByType#application_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/application_segment_by_type#microtenant_id DataZpaApplicationSegmentByType#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * The name of the Browser Access application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/application_segment_by_type#name DataZpaApplicationSegmentByType#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/application_segment_by_type zpa_application_segment_by_type}
*/
export class DataZpaApplicationSegmentByType extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaApplicationSegmentByType that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/application_segment_by_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/application_segment_by_type zpa_application_segment_by_type} Data Source
  *
  * @param scope The scope in which to define this construct
