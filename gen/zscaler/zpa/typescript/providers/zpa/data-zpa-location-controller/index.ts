// https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/location_controller
...
export interface DataZpaLocationControllerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/location_controller#name DataZpaLocationController#name}
  */
  readonly name: string;
  /**
  * Name of the extranet resource partner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/location_controller#zia_er_name DataZpaLocationController#zia_er_name}
  */
  readonly ziaErName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/location_controller zpa_location_controller}
*/
export class DataZpaLocationController extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaLocationController that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/location_controller#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/location_controller zpa_location_controller} Data Source
  *
  * @param scope The scope in which to define this construct
