// https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/private_cloud_group
...
export interface DataZpaPrivateCloudGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/private_cloud_group#id DataZpaPrivateCloudGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/private_cloud_group#microtenant_id DataZpaPrivateCloudGroup#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/private_cloud_group#name DataZpaPrivateCloudGroup#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/private_cloud_group zpa_private_cloud_group}
*/
export class DataZpaPrivateCloudGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaPrivateCloudGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/private_cloud_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/private_cloud_group zpa_private_cloud_group} Data Source
  *
  * @param scope The scope in which to define this construct
