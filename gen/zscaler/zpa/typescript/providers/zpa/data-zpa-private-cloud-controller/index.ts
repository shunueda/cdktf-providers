// https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/private_cloud_controller
...
export interface DataZpaPrivateCloudControllerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/private_cloud_controller#id DataZpaPrivateCloudController#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/private_cloud_controller#microtenant_id DataZpaPrivateCloudController#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/private_cloud_controller#name DataZpaPrivateCloudController#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/private_cloud_controller zpa_private_cloud_controller}
*/
export class DataZpaPrivateCloudController extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaPrivateCloudController that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/private_cloud_controller#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/private_cloud_controller zpa_private_cloud_controller} Data Source
  *
  * @param scope The scope in which to define this construct
