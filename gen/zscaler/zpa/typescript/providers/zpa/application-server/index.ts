// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_server
...
export interface ApplicationServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_server#address ApplicationServer#address}
  */
  readonly address: string;
  /**
  * This field defines the list of server groups IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_server#app_server_group_ids ApplicationServer#app_server_group_ids}
  */
  readonly appServerGroupIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_server#config_space ApplicationServer#config_space}
  */
  readonly configSpace?: string;
  /**
  * This field defines the description of the server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_server#description ApplicationServer#description}
  */
  readonly description?: string;
  /**
  * This field defines the status of the server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_server#enabled ApplicationServer#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_server#microtenant_id ApplicationServer#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * This field defines the name of the server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_server#name ApplicationServer#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_server zpa_application_server}
*/
export class ApplicationServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/application_server zpa_application_server} Resource
  *
  * @param scope The scope in which to define this construct
