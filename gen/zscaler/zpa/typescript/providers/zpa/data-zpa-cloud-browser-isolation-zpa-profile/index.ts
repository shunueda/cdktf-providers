// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/cloud_browser_isolation_zpa_profile
...
export interface DataZpaCloudBrowserIsolationZpaProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/cloud_browser_isolation_zpa_profile#name DataZpaCloudBrowserIsolationZpaProfile#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/cloud_browser_isolation_zpa_profile zpa_cloud_browser_isolation_zpa_profile}
*/
export class DataZpaCloudBrowserIsolationZpaProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaCloudBrowserIsolationZpaProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/cloud_browser_isolation_zpa_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/cloud_browser_isolation_zpa_profile zpa_cloud_browser_isolation_zpa_profile} Data Source
  *
  * @param scope The scope in which to define this construct
