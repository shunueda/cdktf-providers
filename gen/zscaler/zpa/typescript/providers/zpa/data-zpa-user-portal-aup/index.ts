// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/user_portal_aup
...
export interface DataZpaUserPortalAupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/user_portal_aup#aup DataZpaUserPortalAup#aup}
  */
  readonly aup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/user_portal_aup#id DataZpaUserPortalAup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/user_portal_aup#name DataZpaUserPortalAup#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/user_portal_aup zpa_user_portal_aup}
*/
export class DataZpaUserPortalAup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaUserPortalAup that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/user_portal_aup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/data-sources/user_portal_aup zpa_user_portal_aup} Data Source
  *
  * @param scope The scope in which to define this construct
