// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/app_connector_assistant_schedule
...
export interface AppConnectorAssistantScheduleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/app_connector_assistant_schedule#customer_id AppConnectorAssistantSchedule#customer_id}
  */
  readonly customerId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/app_connector_assistant_schedule#delete_disabled AppConnectorAssistantSchedule#delete_disabled}
  */
  readonly deleteDisabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/app_connector_assistant_schedule#enabled AppConnectorAssistantSchedule#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/app_connector_assistant_schedule#frequency AppConnectorAssistantSchedule#frequency}
  */
  readonly frequency?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/app_connector_assistant_schedule#frequency_interval AppConnectorAssistantSchedule#frequency_interval}
  */
  readonly frequencyInterval?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/app_connector_assistant_schedule zpa_app_connector_assistant_schedule}
*/
export class AppConnectorAssistantSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectorAssistantSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/app_connector_assistant_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/app_connector_assistant_schedule zpa_app_connector_assistant_schedule} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AppConnectorAssistantScheduleConfig = {}
  */
  public constructor(scope: Construct, id: string, config: AppConnectorAssistantScheduleConfig = {}) {
    super(scope, id, {
