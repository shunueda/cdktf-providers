// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/pra_credential_controller
...
export interface PraCredentialControllerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/pra_credential_controller#credential_type PraCredentialController#credential_type}
  */
  readonly credentialType?: string;
  /**
  * The description of the privileged credential
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/pra_credential_controller#description PraCredentialController#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/pra_credential_controller#microtenant_id PraCredentialController#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * The name of the privileged credential
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/pra_credential_controller#name PraCredentialController#name}
  */
  readonly name?: string;
  /**
  * The password that is used to protect the SSH private key. This field is optional
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/pra_credential_controller#passphrase PraCredentialController#passphrase}
  */
  readonly passphrase?: string;
  /**
  * The password associated with the username for the login you want to use for the privileged credential
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/pra_credential_controller#password PraCredentialController#password}
  */
  readonly password?: string;
  /**
  * The SSH private key associated with the username for the login you want to use for the privileged credential
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/pra_credential_controller#private_key PraCredentialController#private_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/pra_credential_controller#user_domain PraCredentialController#user_domain}
  */
  readonly userDomain?: string;
  /**
  *  The username for the login you want to use for the privileged credential
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/pra_credential_controller#username PraCredentialController#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/pra_credential_controller zpa_pra_credential_controller}
*/
export class PraCredentialController extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PraCredentialController that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/pra_credential_controller#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/pra_credential_controller zpa_pra_credential_controller} Resource
  *
  * @param scope The scope in which to define this construct
