// https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/managed_browser_profile
...
export interface DataZpaManagedBrowserProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/managed_browser_profile#id DataZpaManagedBrowserProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/managed_browser_profile#name DataZpaManagedBrowserProfile#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/managed_browser_profile zpa_managed_browser_profile}
*/
export class DataZpaManagedBrowserProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaManagedBrowserProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/managed_browser_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/managed_browser_profile zpa_managed_browser_profile} Data Source
  *
  * @param scope The scope in which to define this construct
