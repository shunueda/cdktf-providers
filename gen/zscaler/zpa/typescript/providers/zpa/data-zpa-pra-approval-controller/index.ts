// https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/pra_approval_controller
...
export interface DataZpaPraApprovalControllerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/pra_approval_controller#email_ids DataZpaPraApprovalController#email_ids}
  */
  readonly emailIds?: string[];
  /**
  * The unique identifier of the privileged approval
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/pra_approval_controller#id DataZpaPraApprovalController#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/pra_approval_controller zpa_pra_approval_controller}
*/
export class DataZpaPraApprovalController extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaPraApprovalController that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/pra_approval_controller#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/data-sources/pra_approval_controller zpa_pra_approval_controller} Data Source
  *
  * @param scope The scope in which to define this construct
