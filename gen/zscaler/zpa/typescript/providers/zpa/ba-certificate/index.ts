// https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/ba_certificate
...
export interface BaCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/ba_certificate#cert_blob BaCertificate#cert_blob}
  */
  readonly certBlob?: string;
  /**
  * The description of the certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/ba_certificate#description BaCertificate#description}
  */
  readonly description?: string;
  /**
  * The unique identifier of the Microtenant
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/ba_certificate#microtenant_id BaCertificate#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * The name of the certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/ba_certificate#name BaCertificate#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/ba_certificate zpa_ba_certificate}
*/
export class BaCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BaCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/ba_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/ba_certificate zpa_ba_certificate} Resource
  *
  * @param scope The scope in which to define this construct
