// https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/cloud_browser_isolation_banner
...
export interface DataZpaCloudBrowserIsolationBannerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/cloud_browser_isolation_banner#id DataZpaCloudBrowserIsolationBanner#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/cloud_browser_isolation_banner#name DataZpaCloudBrowserIsolationBanner#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/cloud_browser_isolation_banner zpa_cloud_browser_isolation_banner}
*/
export class DataZpaCloudBrowserIsolationBanner extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaCloudBrowserIsolationBanner that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/cloud_browser_isolation_banner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/cloud_browser_isolation_banner zpa_cloud_browser_isolation_banner} Data Source
  *
  * @param scope The scope in which to define this construct
