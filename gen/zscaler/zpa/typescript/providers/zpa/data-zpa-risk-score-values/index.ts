// https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/risk_score_values
...
export interface DataZpaRiskScoreValuesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/risk_score_values#exclude_unknown DataZpaRiskScoreValues#exclude_unknown}
  */
  readonly excludeUnknown?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/risk_score_values#id DataZpaRiskScoreValues#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/risk_score_values zpa_risk_score_values}
*/
export class DataZpaRiskScoreValues extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaRiskScoreValues that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/risk_score_values#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/risk_score_values zpa_risk_score_values} Data Source
  *
  * @param scope The scope in which to define this construct
