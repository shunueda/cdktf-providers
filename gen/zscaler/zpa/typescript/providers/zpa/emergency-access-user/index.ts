// https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/emergency_access_user
...
export interface EmergencyAccessUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/emergency_access_user#email_id EmergencyAccessUser#email_id}
  */
  readonly emailId?: string;
  /**
  * The first name of the emergency access user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/emergency_access_user#first_name EmergencyAccessUser#first_name}
  */
  readonly firstName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/emergency_access_user#id EmergencyAccessUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/emergency_access_user#last_name EmergencyAccessUser#last_name}
  */
  readonly lastName?: string;
  /**
  * The unique identifier of the emergency access user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/emergency_access_user#user_id EmergencyAccessUser#user_id}
  */
  readonly userId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/emergency_access_user zpa_emergency_access_user}
*/
export class EmergencyAccessUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmergencyAccessUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/emergency_access_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/resources/emergency_access_user zpa_emergency_access_user} Resource
  *
  * @param scope The scope in which to define this construct
