// https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group
...
export interface PrivateCloudGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#city_country PrivateCloudGroup#city_country}
  */
  readonly cityCountry?: string;
  /**
  * Country code of the Private Cloud Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#country_code PrivateCloudGroup#country_code}
  */
  readonly countryCode?: string;
  /**
  * Description of the Private Cloud Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#description PrivateCloudGroup#description}
  */
  readonly description?: string;
  /**
  * Whether this Private Cloud Group is enabled or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#enabled PrivateCloudGroup#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Whether the Private Cloud Group is public
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#is_public PrivateCloudGroup#is_public}
  */
  readonly isPublic?: string;
  /**
  * Latitude of the Private Cloud Group. Integer or decimal. With values in the range of -90 to 90
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#latitude PrivateCloudGroup#latitude}
  */
  readonly latitude?: string;
  /**
  * Location of the Private Cloud Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#location PrivateCloudGroup#location}
  */
  readonly location?: string;
  /**
  * Longitude of the Private Cloud Group. Integer or decimal. With values in the range of -180 to 180
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#longitude PrivateCloudGroup#longitude}
  */
  readonly longitude?: string;
  /**
  * Microtenant ID for the Private Cloud Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#microtenant_id PrivateCloudGroup#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * Name of the Private Cloud Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#name PrivateCloudGroup#name}
  */
  readonly name: string;
  /**
  * Whether the default version profile of the Private Cloud Group is applied or overridden
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#override_version_profile PrivateCloudGroup#override_version_profile}
  */
  readonly overrideVersionProfile?: boolean | cdktf.IResolvable;
  /**
  * Site ID for the Private Cloud Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#site_id PrivateCloudGroup#site_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#upgrade_day PrivateCloudGroup#upgrade_day}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#upgrade_time_in_secs PrivateCloudGroup#upgrade_time_in_secs}
  */
  readonly upgradeTimeInSecs?: string;
  /**
  * ID of the version profile for the Private Cloud Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#version_profile_id PrivateCloudGroup#version_profile_id}
  */
  readonly versionProfileId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group zpa_private_cloud_group}
*/
export class PrivateCloudGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateCloudGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.2/docs/resources/private_cloud_group zpa_private_cloud_group} Resource
  *
  * @param scope The scope in which to define this construct
