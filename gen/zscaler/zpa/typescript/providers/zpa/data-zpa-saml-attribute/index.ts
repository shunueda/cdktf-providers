// https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/saml_attribute
...
export interface DataZpaSamlAttributeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/saml_attribute#id DataZpaSamlAttribute#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/saml_attribute#idp_name DataZpaSamlAttribute#idp_name}
  */
  readonly idpName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/saml_attribute#name DataZpaSamlAttribute#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/saml_attribute zpa_saml_attribute}
*/
export class DataZpaSamlAttribute extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaSamlAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/saml_attribute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.5/docs/data-sources/saml_attribute zpa_saml_attribute} Data Source
  *
  * @param scope The scope in which to define this construct
