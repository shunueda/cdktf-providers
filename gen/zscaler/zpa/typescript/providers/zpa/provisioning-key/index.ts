// https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key
...
export interface ProvisioningKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#app_connector_group_id ProvisioningKey#app_connector_group_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#association_type ProvisioningKey#association_type}
  */
  readonly associationType: string;
  /**
  * Whether the provisioning key is enabled or not. Supported values: true, false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#enabled ProvisioningKey#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * ID of the enrollment certificate that can be used for this provisioning key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#enrollment_cert_id ProvisioningKey#enrollment_cert_id}
  */
  readonly enrollmentCertId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#id ProvisioningKey#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#ip_acl ProvisioningKey#ip_acl}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#max_usage ProvisioningKey#max_usage}
  */
  readonly maxUsage: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#microtenant_id ProvisioningKey#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * Name of the provisioning key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#name ProvisioningKey#name}
  */
  readonly name: string;
  /**
  * read only field. Ignored in PUT/POST calls.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#provisioning_key ProvisioningKey#provisioning_key}
  */
  readonly provisioningKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#ui_config ProvisioningKey#ui_config}
  */
  readonly uiConfig?: string;
  /**
  * The provisioning key utilization count.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#usage_count ProvisioningKey#usage_count}
  */
  readonly usageCount?: string;
  /**
  * ID of the existing App Connector or Service Edge Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#zcomponent_id ProvisioningKey#zcomponent_id}
  */
  readonly zcomponentId: string;
  /**
  * Read only property. Applicable only for GET calls, ignored in PUT/POST calls.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#zcomponent_name ProvisioningKey#zcomponent_name}
  */
  readonly zcomponentName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key zpa_provisioning_key}
*/
export class ProvisioningKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProvisioningKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.3/docs/resources/provisioning_key zpa_provisioning_key} Resource
  *
  * @param scope The scope in which to define this construct
