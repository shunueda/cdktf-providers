// https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/lss_config_client_types
...
export interface DataZpaLssConfigClientTypesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/lss_config_client_types#id DataZpaLssConfigClientTypes#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/lss_config_client_types zpa_lss_config_client_types}
*/
export class DataZpaLssConfigClientTypes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaLssConfigClientTypes that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/lss_config_client_types#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/lss_config_client_types zpa_lss_config_client_types} Data Source
  *
  * @param scope The scope in which to define this construct
