// https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/service_edge_assistant_schedule
...
export interface DataZpaServiceEdgeAssistantScheduleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/service_edge_assistant_schedule#customer_id DataZpaServiceEdgeAssistantSchedule#customer_id}
  */
  readonly customerId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/service_edge_assistant_schedule#id DataZpaServiceEdgeAssistantSchedule#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/service_edge_assistant_schedule zpa_service_edge_assistant_schedule}
*/
export class DataZpaServiceEdgeAssistantSchedule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaServiceEdgeAssistantSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/service_edge_assistant_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/service_edge_assistant_schedule zpa_service_edge_assistant_schedule} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataZpaServiceEdgeAssistantScheduleConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataZpaServiceEdgeAssistantScheduleConfig = {}) {
    super(scope, id, {
