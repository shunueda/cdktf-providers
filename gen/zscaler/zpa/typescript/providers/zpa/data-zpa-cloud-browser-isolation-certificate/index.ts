// https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/cloud_browser_isolation_certificate
...
export interface DataZpaCloudBrowserIsolationCertificateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/cloud_browser_isolation_certificate#id DataZpaCloudBrowserIsolationCertificate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/cloud_browser_isolation_certificate#name DataZpaCloudBrowserIsolationCertificate#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/cloud_browser_isolation_certificate zpa_cloud_browser_isolation_certificate}
*/
export class DataZpaCloudBrowserIsolationCertificate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaCloudBrowserIsolationCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/cloud_browser_isolation_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/cloud_browser_isolation_certificate zpa_cloud_browser_isolation_certificate} Data Source
  *
  * @param scope The scope in which to define this construct
