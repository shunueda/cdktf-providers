// https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/user_portal_controller
...
export interface DataZpaUserPortalControllerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/user_portal_controller#id DataZpaUserPortalController#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/user_portal_controller#microtenant_id DataZpaUserPortalController#microtenant_id}
  */
  readonly microtenantId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/user_portal_controller#name DataZpaUserPortalController#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/user_portal_controller zpa_user_portal_controller}
*/
export class DataZpaUserPortalController extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZpaUserPortalController that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/user_portal_controller#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zpa/4.3.4/docs/data-sources/user_portal_controller zpa_user_portal_controller} Data Source
  *
  * @param scope The scope in which to define this construct
