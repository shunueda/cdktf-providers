// https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/data-sources/file
...
export interface DataTemplateFileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/data-sources/file#filename DataTemplateFile#filename}
  */
  readonly filename?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/data-sources/file#id DataTemplateFile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/data-sources/file#template DataTemplateFile#template}
  */
  readonly template?: string;
  /**
  * variables to substitute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/data-sources/file#vars DataTemplateFile#vars}
  */
  readonly vars?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/data-sources/file template_file}
*/
export class DataTemplateFile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTemplateFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/data-sources/file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/data-sources/file template_file} Data Source
  *
  * @param scope The scope in which to define this construct
