// https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs
...
export interface TemplateProviderConfig {
  ...
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs#alias TemplateProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs template}
*/
export class TemplateProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing TemplateProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs template} Resource
  *
  * @param scope The scope in which to define this construct
