// https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/resources/cloudinit_config
...
export interface CloudinitConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/resources/cloudinit_config#base64_encode CloudinitConfig#base64_encode}
  */
  readonly base64Encode?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/resources/cloudinit_config#gzip CloudinitConfig#gzip}
  */
  readonly gzip?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/resources/cloudinit_config#id CloudinitConfig#id}
  *
  ...
  * part block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/resources/cloudinit_config#part CloudinitConfig#part}
  */
  readonly part: CloudinitConfigPart[] | cdktf.IResolvable;
}
export interface CloudinitConfigPart {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/resources/cloudinit_config#content CloudinitConfig#content}
  */
  readonly content: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/resources/cloudinit_config#content_type CloudinitConfig#content_type}
  */
  readonly contentType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/resources/cloudinit_config#filename CloudinitConfig#filename}
  */
  readonly filename?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/resources/cloudinit_config#merge_type CloudinitConfig#merge_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/resources/cloudinit_config template_cloudinit_config}
*/
export class CloudinitConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudinitConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/resources/cloudinit_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudposse/template/2.2.0/docs/resources/cloudinit_config template_cloudinit_config} Resource
  *
  * @param scope The scope in which to define this construct
