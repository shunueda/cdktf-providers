// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/data-sources/upgradable_versions
...
export interface DataCloudamqpUpgradableVersionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/data-sources/upgradable_versions#id DataCloudamqpUpgradableVersions#id}
  *
  ...
  * Instance identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/data-sources/upgradable_versions#instance_id DataCloudamqpUpgradableVersions#instance_id}
  */
  readonly instanceId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/data-sources/upgradable_versions cloudamqp_upgradable_versions}
*/
export class DataCloudamqpUpgradableVersions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudamqpUpgradableVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/data-sources/upgradable_versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/data-sources/upgradable_versions cloudamqp_upgradable_versions} Data Source
  *
  * @param scope The scope in which to define this construct
