// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs
...
export interface CloudamqpProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs#apikey CloudamqpProvider#apikey}
  */
  readonly apikey?: string;
  /**
  * Base URL to CloudAMQP Customer website
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs#baseurl CloudamqpProvider#baseurl}
  */
  readonly baseurl?: string;
  /**
  * Skips destroying backend resources on 'terraform destroy'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs#enable_faster_instance_destroy CloudamqpProvider#enable_faster_instance_destroy}
  */
  readonly enableFasterInstanceDestroy?: boolean | cdktf.IResolvable;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs#alias CloudamqpProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs cloudamqp}
*/
export class CloudamqpProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing CloudamqpProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs cloudamqp} Resource
  *
  * @param scope The scope in which to define this construct
