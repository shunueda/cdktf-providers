// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance
...
export interface InstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#id Instance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#keep_associated_vpc Instance#keep_associated_vpc}
  */
  readonly keepAssociatedVpc?: boolean | cdktf.IResolvable;
  /**
  * Name of the instance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#name Instance#name}
  */
  readonly name: string;
  /**
  * Set to true to not create default alarms
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#no_default_alarms Instance#no_default_alarms}
  */
  readonly noDefaultAlarms?: boolean | cdktf.IResolvable;
  /**
  * Number of nodes in cluster (plan must support it)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#nodes Instance#nodes}
  */
  readonly nodes?: number;
  /**
  * Name of the plan, see documentation for valid plans
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#plan Instance#plan}
  */
  readonly plan: string;
  /**
  * Preferred availability zone for the instance(s), one entry per node in the cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#preferred_az Instance#preferred_az}
  */
  readonly preferredAz?: string[];
  /**
  * Name of the region you want to create your instance in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#region Instance#region}
  */
  readonly region: string;
  /**
  * RabbitMQ version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#rmq_version Instance#rmq_version}
  */
  readonly rmqVersion?: string;
  /**
  * Tag the instances with optional tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#tags Instance#tags}
  */
  readonly tags?: string[];
  /**
  * The ID of the VPC to create your instance in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#vpc_id Instance#vpc_id}
  */
  readonly vpcId?: number;
  /**
  * Dedicated VPC subnet, shouldn't overlap with your current VPC's subnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#vpc_subnet Instance#vpc_subnet}
  */
  readonly vpcSubnet?: string;
  /**
  * copy_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#copy_settings Instance#copy_settings}
  */
...
export interface InstanceCopySettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#settings Instance#settings}
  */
  readonly settings: string[];
  /**
  * Instance identifier of the CloudAMQP instance to copy settings from
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#subscription_id Instance#subscription_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance cloudamqp_instance}
*/
export class Instance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Instance that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/instance cloudamqp_instance} Resource
  *
  * @param scope The scope in which to define this construct
