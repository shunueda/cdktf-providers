// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/privatelink_aws
...
export interface PrivatelinkAwsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/privatelink_aws#allowed_principals PrivatelinkAws#allowed_principals}
  */
  readonly allowedPrincipals: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/privatelink_aws#id PrivatelinkAws#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/privatelink_aws#instance_id PrivatelinkAws#instance_id}
  */
  readonly instanceId: number;
  /**
  * Configurable sleep in seconds between retries when enable PrivateLink
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/privatelink_aws#sleep PrivatelinkAws#sleep}
  */
  readonly sleep?: number;
  /**
  * Configurable timeout in seconds when enable PrivateLink
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/privatelink_aws#timeout PrivatelinkAws#timeout}
  */
  readonly timeout?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/privatelink_aws cloudamqp_privatelink_aws}
*/
export class PrivatelinkAws extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivatelinkAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/privatelink_aws#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/privatelink_aws cloudamqp_privatelink_aws} Resource
  *
  * @param scope The scope in which to define this construct
