// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/vpc_connect
...
export interface VpcConnectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/vpc_connect#allowed_principals VpcConnect#allowed_principals}
  */
  readonly allowedPrincipals?: string[];
  /**
  * List of allowed projects used by GCP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/vpc_connect#allowed_projects VpcConnect#allowed_projects}
  */
  readonly allowedProjects?: string[];
  /**
  * List of approved subscriptions used by Azure
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/vpc_connect#approved_subscriptions VpcConnect#approved_subscriptions}
  */
  readonly approvedSubscriptions?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/vpc_connect#id VpcConnect#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/vpc_connect#instance_id VpcConnect#instance_id}
  */
  readonly instanceId: number;
  /**
  * The region where the CloudAMQP instance is hosted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/vpc_connect#region VpcConnect#region}
  */
  readonly region: string;
  /**
  * Configurable sleep in seconds between retries when enable PrivateLink
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/vpc_connect#sleep VpcConnect#sleep}
  */
  readonly sleep?: number;
  /**
  * Configurable timeout in seconds when enable PrivateLink
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/vpc_connect#timeout VpcConnect#timeout}
  */
  readonly timeout?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/vpc_connect cloudamqp_vpc_connect}
*/
export class VpcConnect extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcConnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/vpc_connect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/vpc_connect cloudamqp_vpc_connect} Resource
  *
  * @param scope The scope in which to define this construct
