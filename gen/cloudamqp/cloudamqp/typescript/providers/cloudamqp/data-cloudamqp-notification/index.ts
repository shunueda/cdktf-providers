// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/data-sources/notification
...
export interface DataCloudamqpNotificationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/data-sources/notification#id DataCloudamqpNotification#id}
  *
  ...
  * Instance identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/data-sources/notification#instance_id DataCloudamqpNotification#instance_id}
  */
  readonly instanceId: number;
  /**
  * Optional display name of the recipient
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/data-sources/notification#name DataCloudamqpNotification#name}
  */
  readonly name?: string;
  /**
  * Optional key-value pair options parameters
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/data-sources/notification#options DataCloudamqpNotification#options}
  */
  readonly options?: { [key: string]: string };
  /**
  * Recipient identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/data-sources/notification#recipient_id DataCloudamqpNotification#recipient_id}
  */
  readonly recipientId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/data-sources/notification cloudamqp_notification}
*/
export class DataCloudamqpNotification extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudamqpNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/data-sources/notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/data-sources/notification cloudamqp_notification} Data Source
  *
  * @param scope The scope in which to define this construct
