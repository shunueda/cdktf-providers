// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/privatelink_azure
...
export interface PrivatelinkAzureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/privatelink_azure#approved_subscriptions PrivatelinkAzure#approved_subscriptions}
  */
  readonly approvedSubscriptions: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/privatelink_azure#id PrivatelinkAzure#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/privatelink_azure#instance_id PrivatelinkAzure#instance_id}
  */
  readonly instanceId: number;
  /**
  * Configurable sleep in seconds between retries when enable PrivateLink
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/privatelink_azure#sleep PrivatelinkAzure#sleep}
  */
  readonly sleep?: number;
  /**
  * Configurable timeout in seconds when enable PrivateLink
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/privatelink_azure#timeout PrivatelinkAzure#timeout}
  */
  readonly timeout?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/privatelink_azure cloudamqp_privatelink_azure}
*/
export class PrivatelinkAzure extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivatelinkAzure that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/privatelink_azure#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.3/docs/resources/privatelink_azure cloudamqp_privatelink_azure} Resource
  *
  * @param scope The scope in which to define this construct
