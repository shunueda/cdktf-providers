// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/maintenance_window
...
export interface MaintenanceWindowConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/maintenance_window#automatic_updates MaintenanceWindow#automatic_updates}
  */
  readonly automaticUpdates?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/maintenance_window#id MaintenanceWindow#id}
  *
  ...
  * Instance identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/maintenance_window#instance_id MaintenanceWindow#instance_id}
  */
  readonly instanceId: number;
  /**
  * Preferred day of the week when to run maintenance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/maintenance_window#preferred_day MaintenanceWindow#preferred_day}
  */
  readonly preferredDay?: string;
  /**
  * Preferred time (UTC) the day when to run maintenance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/maintenance_window#preferred_time MaintenanceWindow#preferred_time}
  */
  readonly preferredTime?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/maintenance_window cloudamqp_maintenance_window}
*/
export class MaintenanceWindow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MaintenanceWindow that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/maintenance_window#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/maintenance_window cloudamqp_maintenance_window} Resource
  *
  * @param scope The scope in which to define this construct
