// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm
...
export interface AlarmConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm#enabled Alarm#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm#id Alarm#id}
  *
  ...
  * Instance identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm#instance_id Alarm#instance_id}
  */
  readonly instanceId: number;
  /**
  * Message types (total, unacked, ready) of the queue to trigger the alarm
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm#message_type Alarm#message_type}
  */
  readonly messageType?: string;
  /**
  * Regex for which queues to check
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm#queue_regex Alarm#queue_regex}
  */
  readonly queueRegex?: string;
  /**
  * Identifiers for recipients to be notified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm#recipients Alarm#recipients}
  */
  readonly recipients: number[];
  /**
  * The reminder interval (in seconds) to resend the alarm if not resolved. Set to 0 for no reminders. The Default is 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm#reminder_interval Alarm#reminder_interval}
  */
  readonly reminderInterval?: number;
  /**
  * For how long (in seconds) the value_threshold should be active before trigger alarm
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm#time_threshold Alarm#time_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm#type Alarm#type}
  */
  readonly type: string;
  /**
  * Disk value threshold calculation. Fixed or percentage of disk space remaining
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm#value_calculation Alarm#value_calculation}
  */
  readonly valueCalculation?: string;
  /**
  * What value to trigger the alarm for
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm#value_threshold Alarm#value_threshold}
  */
  readonly valueThreshold?: number;
  /**
  * Regex for which vhost the queues are in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm#vhost_regex Alarm#vhost_regex}
  */
  readonly vhostRegex?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm cloudamqp_alarm}
*/
export class Alarm extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Alarm that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/alarm cloudamqp_alarm} Resource
  *
  * @param scope The scope in which to define this construct
