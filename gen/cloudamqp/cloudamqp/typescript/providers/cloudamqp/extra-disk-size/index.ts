// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/extra_disk_size
...
export interface ExtraDiskSizeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/extra_disk_size#allow_downtime ExtraDiskSize#allow_downtime}
  */
  readonly allowDowntime?: boolean | cdktf.IResolvable;
  /**
  * Extra disk size in GB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/extra_disk_size#extra_disk_size ExtraDiskSize#extra_disk_size}
  */
  readonly extraDiskSize: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/extra_disk_size#id ExtraDiskSize#id}
  *
  ...
  * Instance identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/extra_disk_size#instance_id ExtraDiskSize#instance_id}
  */
  readonly instanceId: number;
  /**
  * Configurable sleep time in seconds between retries for resizing the disk
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/extra_disk_size#sleep ExtraDiskSize#sleep}
  */
  readonly sleep?: number;
  /**
  * Configurable timeout time in seconds for resizing the disk
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/extra_disk_size#timeout ExtraDiskSize#timeout}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/extra_disk_size cloudamqp_extra_disk_size}
*/
export class ExtraDiskSize extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExtraDiskSize that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/extra_disk_size#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/extra_disk_size cloudamqp_extra_disk_size} Resource
  *
  * @param scope The scope in which to define this construct
