// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/data-sources/alarm
...
export interface DataCloudamqpAlarmConfig extends cdktf.TerraformMetaArguments {
  ...
  * Alarm identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/data-sources/alarm#alarm_id DataCloudamqpAlarm#alarm_id}
  */
  readonly alarmId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/data-sources/alarm#id DataCloudamqpAlarm#id}
  *
  ...
  * Instance identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/data-sources/alarm#instance_id DataCloudamqpAlarm#instance_id}
  */
  readonly instanceId: number;
  /**
  * Type of the alarm
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/data-sources/alarm#type DataCloudamqpAlarm#type}
  */
  readonly type?: string;
  /**
  * Disk value threshold calculation. Fixed or percentage of disk space remaining
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/data-sources/alarm#value_calculation DataCloudamqpAlarm#value_calculation}
  */
  readonly valueCalculation?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/data-sources/alarm cloudamqp_alarm}
*/
export class DataCloudamqpAlarm extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudamqpAlarm that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/data-sources/alarm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/data-sources/alarm cloudamqp_alarm} Data Source
  *
  * @param scope The scope in which to define this construct
