// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/resources/webhook
...
export interface WebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/resources/webhook#concurrency Webhook#concurrency}
  */
  readonly concurrency: number;
  /**
  * Instance identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/resources/webhook#instance_id Webhook#instance_id}
  */
  readonly instanceId: number;
  /**
  * The queue that should be forwarded, must be a durable queue!
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/resources/webhook#queue Webhook#queue}
  */
  readonly queue: string;
  /**
  * Configurable sleep time in seconds between retries for webhook
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/resources/webhook#sleep Webhook#sleep}
  */
  readonly sleep?: number;
  /**
  * Configurable timeout time in seconds for webhook
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/resources/webhook#timeout Webhook#timeout}
  */
  readonly timeout?: number;
  /**
  * The name of the virtual host
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/resources/webhook#vhost Webhook#vhost}
  */
  readonly vhost: string;
  /**
  * A POST request will be made for each message in the queue to this endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/resources/webhook#webhook_uri Webhook#webhook_uri}
  */
  readonly webhookUri: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/resources/webhook cloudamqp_webhook}
*/
export class Webhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Webhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/resources/webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.2/docs/resources/webhook cloudamqp_webhook} Resource
  *
  * @param scope The scope in which to define this construct
