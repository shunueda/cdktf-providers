// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/vpc_peering
...
export interface VpcPeeringConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/vpc_peering#id VpcPeering#id}
  *
  ...
  * Instance identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/vpc_peering#instance_id VpcPeering#instance_id}
  */
  readonly instanceId?: number;
  /**
  * VPC peering identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/vpc_peering#peering_id VpcPeering#peering_id}
  */
  readonly peeringId: string;
  /**
  * Configurable sleep time in seconds between retries for accepting or removing peering
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/vpc_peering#sleep VpcPeering#sleep}
  */
  readonly sleep?: number;
  /**
  * Configurable timeout time in seconds for accepting or removing peering
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/vpc_peering#timeout VpcPeering#timeout}
  */
  readonly timeout?: number;
  /**
  * VPC instance identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/vpc_peering#vpc_id VpcPeering#vpc_id}
  */
  readonly vpcId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/vpc_peering cloudamqp_vpc_peering}
*/
export class VpcPeering extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcPeering that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/vpc_peering#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.39.0/docs/resources/vpc_peering cloudamqp_vpc_peering} Resource
  *
  * @param scope The scope in which to define this construct
