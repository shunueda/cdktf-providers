// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration
...
export interface Oauth2ConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#additional_scopes_key Oauth2Configuration#additional_scopes_key}
  */
  readonly additionalScopesKey?: string[];
  /**
  * Audience
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#audience Oauth2Configuration#audience}
  */
  readonly audience?: string;
  /**
  * Instance identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#instance_id Oauth2Configuration#instance_id}
  */
  readonly instanceId: number;
  /**
  * Issuer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#issuer Oauth2Configuration#issuer}
  */
  readonly issuer: string;
  /**
  * Oauth client id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#oauth_client_id Oauth2Configuration#oauth_client_id}
  */
  readonly oauthClientId?: string;
  /**
  * Oauth scopes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#oauth_scopes Oauth2Configuration#oauth_scopes}
  */
  readonly oauthScopes?: string[];
  /**
  * Preferred username claims
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#preferred_username_claims Oauth2Configuration#preferred_username_claims}
  */
  readonly preferredUsernameClaims?: string[];
  /**
  * Resource server identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#resource_server_id Oauth2Configuration#resource_server_id}
  */
  readonly resourceServerId: string;
  /**
  * Scope aliases
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#scope_aliases Oauth2Configuration#scope_aliases}
  */
  readonly scopeAliases?: { [key: string]: string };
  /**
  * Scope prefix
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#scope_prefix Oauth2Configuration#scope_prefix}
  */
  readonly scopePrefix?: string;
  /**
  * Configurable sleep time in seconds between retries for OAuth2 configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#sleep Oauth2Configuration#sleep}
  */
  readonly sleep?: number;
  /**
  * Configurable timeout time in seconds for OAuth2 configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#timeout Oauth2Configuration#timeout}
  */
  readonly timeout?: number;
  /**
  * Verify aud
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#verify_aud Oauth2Configuration#verify_aud}
  */
  readonly verifyAud?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration cloudamqp_oauth2_configuration}
*/
export class Oauth2Configuration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Oauth2Configuration that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.41.0/docs/resources/oauth2_configuration cloudamqp_oauth2_configuration} Resource
  *
  * @param scope The scope in which to define this construct
