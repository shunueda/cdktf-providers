// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/data-sources/account
...
export interface DataCloudamqpAccountConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/data-sources/account#id DataCloudamqpAccount#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/data-sources/account cloudamqp_account}
*/
export class DataCloudamqpAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudamqpAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/data-sources/account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/data-sources/account cloudamqp_account} Data Source
  *
  * @param scope The scope in which to define this construct
