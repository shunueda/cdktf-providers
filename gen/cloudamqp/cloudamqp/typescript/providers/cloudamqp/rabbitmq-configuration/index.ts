// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration
...
export interface RabbitmqConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration#channel_max RabbitmqConfiguration#channel_max}
  */
  readonly channelMax?: number;
  /**
  * Set how the cluster should handle network partition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration#cluster_partition_handling RabbitmqConfiguration#cluster_partition_handling}
  */
  readonly clusterPartitionHandling?: string;
  /**
  * Set the maximum permissible number of connections, -1 means infinity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration#connection_max RabbitmqConfiguration#connection_max}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration#consumer_timeout RabbitmqConfiguration#consumer_timeout}
  */
  readonly consumerTimeout?: number;
  /**
  * Set the server AMQP 0-9-1 heartbeat timeout in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration#heartbeat RabbitmqConfiguration#heartbeat}
  */
  readonly heartbeat?: number;
  /**
  * Instance identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration#instance_id RabbitmqConfiguration#instance_id}
  */
  readonly instanceId: number;
  /**
  * Log level for the logger used for log integrations and the CloudAMQP Console log view.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration#log_exchange_level RabbitmqConfiguration#log_exchange_level}
  */
  readonly logExchangeLevel?: string;
  /**
  * The largest allowed message payload size in bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration#max_message_size RabbitmqConfiguration#max_message_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration#queue_index_embed_msgs_below RabbitmqConfiguration#queue_index_embed_msgs_below}
  */
  readonly queueIndexEmbedMsgsBelow?: number;
  /**
  * Configurable sleep time in seconds between retries for RabbitMQ configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration#sleep RabbitmqConfiguration#sleep}
  */
  readonly sleep?: number;
  /**
  * Configurable timeout time in seconds for RabbitMQ configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration#timeout RabbitmqConfiguration#timeout}
  */
  readonly timeout?: number;
  /**
  * When the server will enter memory based flow-control as relative to the maximum available memory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration#vm_memory_high_watermark RabbitmqConfiguration#vm_memory_high_watermark}
  */
  readonly vmMemoryHighWatermark?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration cloudamqp_rabbitmq_configuration}
*/
export class RabbitmqConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RabbitmqConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.38.1/docs/resources/rabbitmq_configuration cloudamqp_rabbitmq_configuration} Resource
  *
  * @param scope The scope in which to define this construct
