// https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/integration_aws_eventbridge
...
export interface IntegrationAwsEventbridgeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/integration_aws_eventbridge#aws_account_id IntegrationAwsEventbridge#aws_account_id}
  */
  readonly awsAccountId: string;
  /**
  * The AWS region where you the events to be sent to. (e.g. us-west-1, us-west-2, ..., etc.)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/integration_aws_eventbridge#aws_region IntegrationAwsEventbridge#aws_region}
  */
  readonly awsRegion: string;
  /**
  * Instance identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/integration_aws_eventbridge#instance_id IntegrationAwsEventbridge#instance_id}
  */
  readonly instanceId: number;
  /**
  * Number of messages to prefetch. Default set to 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/integration_aws_eventbridge#prefetch IntegrationAwsEventbridge#prefetch}
  */
  readonly prefetch?: number;
  /**
  * A (durable) queue on your RabbitMQ instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/integration_aws_eventbridge#queue IntegrationAwsEventbridge#queue}
  */
  readonly queue: string;
  /**
  * The VHost the queue resides in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/integration_aws_eventbridge#vhost IntegrationAwsEventbridge#vhost}
  */
  readonly vhost: string;
  /**
  * Include message headers in the event data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/integration_aws_eventbridge#with_headers IntegrationAwsEventbridge#with_headers}
  */
  readonly withHeaders: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/integration_aws_eventbridge cloudamqp_integration_aws_eventbridge}
*/
export class IntegrationAwsEventbridge extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationAwsEventbridge that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/integration_aws_eventbridge#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudamqp/cloudamqp/1.40.0/docs/resources/integration_aws_eventbridge cloudamqp_integration_aws_eventbridge} Resource
  *
  * @param scope The scope in which to define this construct
