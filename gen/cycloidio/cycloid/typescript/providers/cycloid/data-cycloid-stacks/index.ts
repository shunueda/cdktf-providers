// https://registry.terraform.io/providers/cycloidio/cycloid/0.0.23/docs/data-sources/stacks
...
export interface DataCycloidStacksConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cycloidio/cycloid/0.0.23/docs/data-sources/stacks#organization_canonical DataCycloidStacks#organization_canonical}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cycloidio/cycloid/0.0.23/docs/data-sources/stacks cycloid_stacks}
*/
export class DataCycloidStacks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCycloidStacks that should be imported. Refer to the {@link https://registry.terraform.io/providers/cycloidio/cycloid/0.0.23/docs/data-sources/stacks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cycloidio/cycloid/0.0.23/docs/data-sources/stacks cycloid_stacks} Data Source
  *
  * @param scope The scope in which to define this construct
