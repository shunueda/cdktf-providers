// https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/restore_protected_resource_v2
...
export interface RestoreProtectedResourceV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/restore_protected_resource_v2#cluster_ext_id RestoreProtectedResourceV2#cluster_ext_id}
  */
  readonly clusterExtId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/restore_protected_resource_v2#ext_id RestoreProtectedResourceV2#ext_id}
  */
  readonly extId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/restore_protected_resource_v2#id RestoreProtectedResourceV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/restore_protected_resource_v2#restore_time RestoreProtectedResourceV2#restore_time}
  */
  readonly restoreTime?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/restore_protected_resource_v2 nutanix_restore_protected_resource_v2}
*/
export class RestoreProtectedResourceV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RestoreProtectedResourceV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/restore_protected_resource_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/restore_protected_resource_v2 nutanix_restore_protected_resource_v2} Resource
  *
  * @param scope The scope in which to define this construct
