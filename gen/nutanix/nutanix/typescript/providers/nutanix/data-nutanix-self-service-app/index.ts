// https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/self_service_app
...
export interface DataNutanixSelfServiceAppConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/self_service_app#app_uuid DataNutanixSelfServiceApp#app_uuid}
  */
  readonly appUuid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/self_service_app#id DataNutanixSelfServiceApp#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/self_service_app nutanix_self_service_app}
*/
export class DataNutanixSelfServiceApp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixSelfServiceApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/self_service_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/self_service_app nutanix_self_service_app} Data Source
  *
  * @param scope The scope in which to define this construct
