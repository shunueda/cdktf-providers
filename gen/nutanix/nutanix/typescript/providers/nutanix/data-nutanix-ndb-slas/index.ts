// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/ndb_slas
...
export interface DataNutanixNdbSlasConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/ndb_slas#id DataNutanixNdbSlas#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/ndb_slas nutanix_ndb_slas}
*/
export class DataNutanixNdbSlas extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixNdbSlas that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/ndb_slas#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/ndb_slas nutanix_ndb_slas} Data Source
  *
  * @param scope The scope in which to define this construct
