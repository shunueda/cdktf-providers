// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/pc_unregistration_v2
...
export interface PcUnregistrationV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/pc_unregistration_v2#ext_id PcUnregistrationV2#ext_id}
  */
  readonly extId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/pc_unregistration_v2#id PcUnregistrationV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/pc_unregistration_v2#pc_ext_id PcUnregistrationV2#pc_ext_id}
  */
  readonly pcExtId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/pc_unregistration_v2 nutanix_pc_unregistration_v2}
*/
export class PcUnregistrationV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PcUnregistrationV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/pc_unregistration_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/pc_unregistration_v2 nutanix_pc_unregistration_v2} Resource
  *
  * @param scope The scope in which to define this construct
