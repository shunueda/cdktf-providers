// https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/lcm_config_v2
...
export interface DataNutanixLcmConfigV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/lcm_config_v2#id DataNutanixLcmConfigV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/lcm_config_v2#x_cluster_id DataNutanixLcmConfigV2#x_cluster_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/lcm_config_v2 nutanix_lcm_config_v2}
*/
export class DataNutanixLcmConfigV2 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixLcmConfigV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/lcm_config_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/lcm_config_v2 nutanix_lcm_config_v2} Data Source
  *
  * @param scope The scope in which to define this construct
