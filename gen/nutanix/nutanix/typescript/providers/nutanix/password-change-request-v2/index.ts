// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/password_change_request_v2
...
export interface PasswordChangeRequestV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/password_change_request_v2#current_password PasswordChangeRequestV2#current_password}
  */
  readonly currentPassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/password_change_request_v2#ext_id PasswordChangeRequestV2#ext_id}
  */
  readonly extId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/password_change_request_v2#id PasswordChangeRequestV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/password_change_request_v2#new_password PasswordChangeRequestV2#new_password}
  */
  readonly newPassword: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/password_change_request_v2 nutanix_password_change_request_v2}
*/
export class PasswordChangeRequestV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PasswordChangeRequestV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/password_change_request_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/password_change_request_v2 nutanix_password_change_request_v2} Resource
  *
  * @param scope The scope in which to define this construct
