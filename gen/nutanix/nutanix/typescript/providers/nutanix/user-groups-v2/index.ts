// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/user_groups_v2
...
export interface UserGroupsV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/user_groups_v2#distinguished_name UserGroupsV2#distinguished_name}
  */
  readonly distinguishedName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/user_groups_v2#ext_id UserGroupsV2#ext_id}
  */
  readonly extId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/user_groups_v2#group_type UserGroupsV2#group_type}
  */
  readonly groupType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/user_groups_v2#id UserGroupsV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/user_groups_v2#idp_id UserGroupsV2#idp_id}
  */
  readonly idpId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/user_groups_v2#name UserGroupsV2#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/user_groups_v2 nutanix_user_groups_v2}
*/
export class UserGroupsV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserGroupsV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/user_groups_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/user_groups_v2 nutanix_user_groups_v2} Resource
  *
  * @param scope The scope in which to define this construct
