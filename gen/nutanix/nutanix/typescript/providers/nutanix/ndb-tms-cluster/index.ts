// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ndb_tms_cluster
...
export interface NdbTmsClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ndb_tms_cluster#id NdbTmsCluster#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ndb_tms_cluster#nx_cluster_id NdbTmsCluster#nx_cluster_id}
  */
  readonly nxClusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ndb_tms_cluster#sla_id NdbTmsCluster#sla_id}
  */
  readonly slaId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ndb_tms_cluster#time_machine_id NdbTmsCluster#time_machine_id}
  */
  readonly timeMachineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ndb_tms_cluster#type NdbTmsCluster#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ndb_tms_cluster nutanix_ndb_tms_cluster}
*/
export class NdbTmsCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NdbTmsCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ndb_tms_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ndb_tms_cluster nutanix_ndb_tms_cluster} Resource
  *
  * @param scope The scope in which to define this construct
