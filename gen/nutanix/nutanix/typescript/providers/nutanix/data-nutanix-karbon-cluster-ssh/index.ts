// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_ssh
...
export interface DataNutanixKarbonClusterSshConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_ssh#id DataNutanixKarbonClusterSsh#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_ssh#karbon_cluster_id DataNutanixKarbonClusterSsh#karbon_cluster_id}
  */
  readonly karbonClusterId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_ssh#karbon_cluster_name DataNutanixKarbonClusterSsh#karbon_cluster_name}
  */
  readonly karbonClusterName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_ssh nutanix_karbon_cluster_ssh}
*/
export class DataNutanixKarbonClusterSsh extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixKarbonClusterSsh that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_ssh#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_ssh nutanix_karbon_cluster_ssh} Data Source
  *
  * @param scope The scope in which to define this construct
