// https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/foundation_image
...
export interface FoundationImageConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/foundation_image#filename FoundationImage#filename}
  */
  readonly filename: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/foundation_image#id FoundationImage#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/foundation_image#installer_type FoundationImage#installer_type}
  */
  readonly installerType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/foundation_image#source FoundationImage#source}
  */
  readonly source: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/foundation_image nutanix_foundation_image}
*/
export class FoundationImage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FoundationImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/foundation_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/foundation_image nutanix_foundation_image} Resource
  *
  * @param scope The scope in which to define this construct
