// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/volume_group_vm_v2
...
export interface VolumeGroupVmV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/volume_group_vm_v2#id VolumeGroupVmV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/volume_group_vm_v2#index VolumeGroupVmV2#index}
  */
  readonly index?: number;
  /**
  * A globally unique identifier of an instance that is suitable for external consumption. This Field is Required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/volume_group_vm_v2#vm_ext_id VolumeGroupVmV2#vm_ext_id}
  */
  readonly vmExtId: string;
  /**
  * The external identifier of the volume group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/volume_group_vm_v2#volume_group_ext_id VolumeGroupVmV2#volume_group_ext_id}
  */
  readonly volumeGroupExtId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/volume_group_vm_v2 nutanix_volume_group_vm_v2}
*/
export class VolumeGroupVmV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VolumeGroupVmV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/volume_group_vm_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/volume_group_vm_v2 nutanix_volume_group_vm_v2} Resource
  *
  * @param scope The scope in which to define this construct
