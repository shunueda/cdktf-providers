// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/clusters
...
export interface DataNutanixClustersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/clusters#id DataNutanixClusters#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/clusters nutanix_clusters}
*/
export class DataNutanixClusters extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/clusters nutanix_clusters} Data Source
  *
  * @param scope The scope in which to define this construct
