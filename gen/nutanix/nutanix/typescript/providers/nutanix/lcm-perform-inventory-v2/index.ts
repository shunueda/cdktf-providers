// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/lcm_perform_inventory_v2
...
export interface LcmPerformInventoryV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/lcm_perform_inventory_v2#id LcmPerformInventoryV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/lcm_perform_inventory_v2#x_cluster_id LcmPerformInventoryV2#x_cluster_id}
  */
  readonly xClusterId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/lcm_perform_inventory_v2 nutanix_lcm_perform_inventory_v2}
*/
export class LcmPerformInventoryV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LcmPerformInventoryV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/lcm_perform_inventory_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/lcm_perform_inventory_v2 nutanix_lcm_perform_inventory_v2} Resource
  *
  * @param scope The scope in which to define this construct
