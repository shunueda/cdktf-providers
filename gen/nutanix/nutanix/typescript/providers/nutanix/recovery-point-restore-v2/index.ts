// https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/recovery_point_restore_v2
...
export interface RecoveryPointRestoreV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/recovery_point_restore_v2#cluster_ext_id RecoveryPointRestoreV2#cluster_ext_id}
  */
  readonly clusterExtId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/recovery_point_restore_v2#ext_id RecoveryPointRestoreV2#ext_id}
  */
  readonly extId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/recovery_point_restore_v2#id RecoveryPointRestoreV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/recovery_point_restore_v2#vm_recovery_point_restore_overrides RecoveryPointRestoreV2#vm_recovery_point_restore_overrides}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/recovery_point_restore_v2#volume_group_recovery_point_restore_overrides RecoveryPointRestoreV2#volume_group_recovery_point_restore_overrides}
  */
...
export interface RecoveryPointRestoreV2VmRecoveryPointRestoreOverrides {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/recovery_point_restore_v2#vm_recovery_point_ext_id RecoveryPointRestoreV2#vm_recovery_point_ext_id}
  */
...
export interface RecoveryPointRestoreV2VolumeGroupRecoveryPointRestoreOverridesVolumeGroupOverrideSpec {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/recovery_point_restore_v2#name RecoveryPointRestoreV2#name}
  */
...
export interface RecoveryPointRestoreV2VolumeGroupRecoveryPointRestoreOverrides {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/recovery_point_restore_v2#volume_group_recovery_point_ext_id RecoveryPointRestoreV2#volume_group_recovery_point_ext_id}
  */
  readonly volumeGroupRecoveryPointExtId: string;
  /**
  * volume_group_override_spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/recovery_point_restore_v2#volume_group_override_spec RecoveryPointRestoreV2#volume_group_override_spec}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/recovery_point_restore_v2 nutanix_recovery_point_restore_v2}
*/
export class RecoveryPointRestoreV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RecoveryPointRestoreV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/recovery_point_restore_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/recovery_point_restore_v2 nutanix_recovery_point_restore_v2} Resource
  *
  * @param scope The scope in which to define this construct
