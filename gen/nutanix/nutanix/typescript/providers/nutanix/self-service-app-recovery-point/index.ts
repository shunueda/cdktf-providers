// https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/self_service_app_recovery_point
...
export interface SelfServiceAppRecoveryPointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/self_service_app_recovery_point#action_name SelfServiceAppRecoveryPoint#action_name}
  */
  readonly actionName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/self_service_app_recovery_point#app_name SelfServiceAppRecoveryPoint#app_name}
  */
  readonly appName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/self_service_app_recovery_point#app_uuid SelfServiceAppRecoveryPoint#app_uuid}
  */
  readonly appUuid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/self_service_app_recovery_point#id SelfServiceAppRecoveryPoint#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/self_service_app_recovery_point#recovery_point_name SelfServiceAppRecoveryPoint#recovery_point_name}
  */
  readonly recoveryPointName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/self_service_app_recovery_point nutanix_self_service_app_recovery_point}
*/
export class SelfServiceAppRecoveryPoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SelfServiceAppRecoveryPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/self_service_app_recovery_point#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/resources/self_service_app_recovery_point nutanix_self_service_app_recovery_point} Resource
  *
  * @param scope The scope in which to define this construct
