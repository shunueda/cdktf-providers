// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/foundation_discover_nodes
...
export interface DataNutanixFoundationDiscoverNodesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/foundation_discover_nodes#id DataNutanixFoundationDiscoverNodes#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/foundation_discover_nodes nutanix_foundation_discover_nodes}
*/
export class DataNutanixFoundationDiscoverNodes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixFoundationDiscoverNodes that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/foundation_discover_nodes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/foundation_discover_nodes nutanix_foundation_discover_nodes} Data Source
  *
  * @param scope The scope in which to define this construct
