// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/hosts
...
export interface DataNutanixHostsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/hosts#id DataNutanixHosts#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/hosts nutanix_hosts}
*/
export class DataNutanixHosts extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixHosts that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/hosts#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/hosts nutanix_hosts} Data Source
  *
  * @param scope The scope in which to define this construct
