// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_kubeconfig
...
export interface DataNutanixKarbonClusterKubeconfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_kubeconfig#id DataNutanixKarbonClusterKubeconfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_kubeconfig#karbon_cluster_id DataNutanixKarbonClusterKubeconfig#karbon_cluster_id}
  */
  readonly karbonClusterId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_kubeconfig#karbon_cluster_name DataNutanixKarbonClusterKubeconfig#karbon_cluster_name}
  */
  readonly karbonClusterName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_kubeconfig nutanix_karbon_cluster_kubeconfig}
*/
export class DataNutanixKarbonClusterKubeconfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixKarbonClusterKubeconfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_kubeconfig#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/karbon_cluster_kubeconfig nutanix_karbon_cluster_kubeconfig} Data Source
  *
  * @param scope The scope in which to define this construct
