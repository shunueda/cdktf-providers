// https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/foundation_central_api_keys
...
export interface DataNutanixFoundationCentralApiKeysConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/foundation_central_api_keys#id DataNutanixFoundationCentralApiKeys#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/foundation_central_api_keys#key_uuid DataNutanixFoundationCentralApiKeys#key_uuid}
  */
  readonly keyUuid: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/foundation_central_api_keys nutanix_foundation_central_api_keys}
*/
export class DataNutanixFoundationCentralApiKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixFoundationCentralApiKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/foundation_central_api_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/foundation_central_api_keys nutanix_foundation_central_api_keys} Data Source
  *
  * @param scope The scope in which to define this construct
