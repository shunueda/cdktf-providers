...
export interface DataNutanixFloatingIpV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/floating_ip_v2#ext_id DataNutanixFloatingIpV2#ext_id}
  */
  readonly extId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/floating_ip_v2#id DataNutanixFloatingIpV2#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/floating_ip_v2 nutanix_floating_ip_v2}
*/
export class DataNutanixFloatingIpV2 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixFloatingIpV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/floating_ip_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/floating_ip_v2 nutanix_floating_ip_v2} Data Source
  *
  * @param scope The scope in which to define this construct
