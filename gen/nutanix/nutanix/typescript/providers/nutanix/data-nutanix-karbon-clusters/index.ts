// https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/karbon_clusters
...
export interface DataNutanixKarbonClustersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/karbon_clusters#id DataNutanixKarbonClusters#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/karbon_clusters nutanix_karbon_clusters}
*/
export class DataNutanixKarbonClusters extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixKarbonClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/karbon_clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.3/docs/data-sources/karbon_clusters nutanix_karbon_clusters} Data Source
  *
  * @param scope The scope in which to define this construct
