// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/ndb_clusters
...
export interface DataNutanixNdbClustersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/ndb_clusters#id DataNutanixNdbClusters#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/ndb_clusters nutanix_ndb_clusters}
*/
export class DataNutanixNdbClusters extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixNdbClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/ndb_clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/ndb_clusters nutanix_ndb_clusters} Data Source
  *
  * @param scope The scope in which to define this construct
