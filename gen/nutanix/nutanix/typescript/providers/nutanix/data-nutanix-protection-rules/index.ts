// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/protection_rules
...
export interface DataNutanixProtectionRulesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/protection_rules#id DataNutanixProtectionRules#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/protection_rules nutanix_protection_rules}
*/
export class DataNutanixProtectionRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixProtectionRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/protection_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/data-sources/protection_rules nutanix_protection_rules} Data Source
  *
  * @param scope The scope in which to define this construct
