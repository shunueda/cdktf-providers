// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/recovery_point_replicate_v2
...
export interface RecoveryPointReplicateV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/recovery_point_replicate_v2#cluster_ext_id RecoveryPointReplicateV2#cluster_ext_id}
  */
  readonly clusterExtId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/recovery_point_replicate_v2#ext_id RecoveryPointReplicateV2#ext_id}
  */
  readonly extId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/recovery_point_replicate_v2#id RecoveryPointReplicateV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/recovery_point_replicate_v2#pc_ext_id RecoveryPointReplicateV2#pc_ext_id}
  */
  readonly pcExtId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/recovery_point_replicate_v2 nutanix_recovery_point_replicate_v2}
*/
export class RecoveryPointReplicateV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RecoveryPointReplicateV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/recovery_point_replicate_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/recovery_point_replicate_v2 nutanix_recovery_point_replicate_v2} Resource
  *
  * @param scope The scope in which to define this construct
