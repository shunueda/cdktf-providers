// https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ova_download_v2
...
export interface OvaDownloadV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ova_download_v2#id OvaDownloadV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ova_download_v2#ova_ext_id OvaDownloadV2#ova_ext_id}
  */
  readonly ovaExtId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ova_download_v2 nutanix_ova_download_v2}
*/
export class OvaDownloadV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OvaDownloadV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ova_download_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.4/docs/resources/ova_download_v2 nutanix_ova_download_v2} Resource
  *
  * @param scope The scope in which to define this construct
