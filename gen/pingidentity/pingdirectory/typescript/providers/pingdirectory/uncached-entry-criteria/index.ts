// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria
...
export interface UncachedEntryCriteriaConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria#access_time_threshold UncachedEntryCriteria#access_time_threshold}
  */
  readonly accessTimeThreshold?: string;
  /**
  * A description for this Uncached Entry Criteria
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria#description UncachedEntryCriteria#description}
  */
  readonly description?: string;
  /**
  * Indicates whether this Uncached Entry Criteria is enabled for use in the server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria#enabled UncachedEntryCriteria#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria#extension_argument UncachedEntryCriteria#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria#extension_class UncachedEntryCriteria#extension_class}
  */
  readonly extensionClass?: string;
  /**
  * Specifies the search filter that should be used to differentiate entries into cached and uncached sets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria#filter UncachedEntryCriteria#filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria#filter_identifies_uncached_entries UncachedEntryCriteria#filter_identifies_uncached_entries}
  */
  readonly filterIdentifiesUncachedEntries?: boolean | cdktf.IResolvable;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria#name UncachedEntryCriteria#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria#script_argument UncachedEntryCriteria#script_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria#script_class UncachedEntryCriteria#script_class}
  */
  readonly scriptClass?: string;
  /**
  * The type of Uncached Entry Criteria resource. Options are ['default', 'last-access-time', 'filter-based', 'groovy-scripted', 'third-party']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria#type UncachedEntryCriteria#type}
  */
  readonly type: string;
}
export interface UncachedEntryCriteriaRequiredActions {
}

export function uncachedEntryCriteriaRequiredActionsToTerraform(struct?: UncachedEntryCriteriaRequiredActions): any {
...
export function uncachedEntryCriteriaRequiredActionsToHclTerraform(struct?: UncachedEntryCriteriaRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class UncachedEntryCriteriaRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): UncachedEntryCriteriaRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: UncachedEntryCriteriaRequiredActions | undefined) {
    if (value === undefined) {
...
export class UncachedEntryCriteriaRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): UncachedEntryCriteriaRequiredActionsOutputReference {
    return new UncachedEntryCriteriaRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria pingdirectory_uncached_entry_criteria}
*/
export class UncachedEntryCriteria extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a UncachedEntryCriteria resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the UncachedEntryCriteria to import
  * @param importFromId The id of the existing UncachedEntryCriteria that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the UncachedEntryCriteria to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_entry_criteria pingdirectory_uncached_entry_criteria} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options UncachedEntryCriteriaConfig
  */
  public constructor(scope: Construct, id: string, config: UncachedEntryCriteriaConfig) {
    super(scope, id, {
  ...
  // access_time_threshold - computed: false, optional: true, required: false
  ...
  private _requiredActions = new UncachedEntryCriteriaRequiredActionsList(this, "required_actions", true);
