// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider
...
export interface KeyManagerProviderConfig extends cdktf.TerraformMetaArguments {
  /**
  * A description for this Key Manager Provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#description KeyManagerProvider#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#enable_key_manager_caching KeyManagerProvider#enable_key_manager_caching}
  */
  readonly enableKeyManagerCaching?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether the Key Manager Provider is enabled for use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#enabled KeyManagerProvider#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#extension_argument KeyManagerProvider#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#extension_class KeyManagerProvider#extension_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#key_store_file KeyManagerProvider#key_store_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#key_store_pin KeyManagerProvider#key_store_pin}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#key_store_pin_file KeyManagerProvider#key_store_pin_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#key_store_pin_passphrase_provider KeyManagerProvider#key_store_pin_passphrase_provider}
  */
  readonly keyStorePinPassphraseProvider?: string;
  /**
  * Specifies the format for the data in the key store file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#key_store_type KeyManagerProvider#key_store_type}
  */
  readonly keyStoreType?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#name KeyManagerProvider#name}
  */
  readonly name: string;
  /**
  * The key store type to use when obtaining an instance of a key store for interacting with a PKCS #11 token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#pkcs11_key_store_type KeyManagerProvider#pkcs11_key_store_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#pkcs11_max_cache_duration KeyManagerProvider#pkcs11_max_cache_duration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#pkcs11_provider_class KeyManagerProvider#pkcs11_provider_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#pkcs11_provider_configuration_file KeyManagerProvider#pkcs11_provider_configuration_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#private_key_pin KeyManagerProvider#private_key_pin}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#private_key_pin_file KeyManagerProvider#private_key_pin_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#private_key_pin_passphrase_provider KeyManagerProvider#private_key_pin_passphrase_provider}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#type KeyManagerProvider#type}
  */
  readonly type: string;
}
export interface KeyManagerProviderRequiredActions {
}

export function keyManagerProviderRequiredActionsToTerraform(struct?: KeyManagerProviderRequiredActions): any {
...
export function keyManagerProviderRequiredActionsToHclTerraform(struct?: KeyManagerProviderRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class KeyManagerProviderRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): KeyManagerProviderRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: KeyManagerProviderRequiredActions | undefined) {
    if (value === undefined) {
...
export class KeyManagerProviderRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): KeyManagerProviderRequiredActionsOutputReference {
    return new KeyManagerProviderRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider pingdirectory_key_manager_provider}
*/
export class KeyManagerProvider extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a KeyManagerProvider resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the KeyManagerProvider to import
  * @param importFromId The id of the existing KeyManagerProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the KeyManagerProvider to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/key_manager_provider pingdirectory_key_manager_provider} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options KeyManagerProviderConfig
  */
  public constructor(scope: Construct, id: string, config: KeyManagerProviderConfig) {
    super(scope, id, {
  ...
  // key_store_pin - computed: false, optional: true, required: false
  ...
  // key_store_pin_file - computed: false, optional: true, required: false
  ...
  // key_store_pin_passphrase_provider - computed: false, optional: true, required: false
  ...
  // pkcs11_provider_class - computed: false, optional: true, required: false
  ...
  // pkcs11_provider_configuration_file - computed: false, optional: true, required: false
  ...
  // private_key_pin - computed: false, optional: true, required: false
  ...
  // private_key_pin_file - computed: false, optional: true, required: false
  ...
  // private_key_pin_passphrase_provider - computed: false, optional: true, required: false
  ...
  private _requiredActions = new KeyManagerProviderRequiredActionsList(this, "required_actions", true);
