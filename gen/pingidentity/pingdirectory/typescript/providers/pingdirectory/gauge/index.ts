// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge
...
export interface GaugeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specifies the level at which alerts are sent for alarms raised by this Gauge.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#alert_level Gauge#alert_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#critical_exit_value Gauge#critical_exit_value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#critical_value Gauge#critical_value}
  */
  readonly criticalValue?: string;
  /**
  * A description for this Gauge
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#description Gauge#description}
  */
  readonly description?: string;
  /**
  * Indicates whether this Gauge is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#enabled Gauge#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Specifies resources to exclude from being monitored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#exclude_resource Gauge#exclude_resource}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#gauge_data_source Gauge#gauge_data_source}
  */
  readonly gaugeDataSource: string;
  /**
  * Specifies set of resources to be monitored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#include_resource Gauge#include_resource}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#major_exit_value Gauge#major_exit_value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#major_value Gauge#major_value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#minor_exit_value Gauge#minor_exit_value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#minor_value Gauge#minor_value}
  */
  readonly minorValue?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#name Gauge#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#override_severity Gauge#override_severity}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#samples_per_update_interval Gauge#samples_per_update_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#server_degraded_severity_level Gauge#server_degraded_severity_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#server_unavailable_severity_level Gauge#server_unavailable_severity_level}
  */
  readonly serverUnavailableSeverityLevel?: string;
  /**
  * The type of Gauge resource. Options are ['indicator', 'numeric']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#type Gauge#type}
  */
  readonly type: string;
  /**
  * The frequency with which this Gauge is updated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#update_interval Gauge#update_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#warning_exit_value Gauge#warning_exit_value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#warning_value Gauge#warning_value}
  */
  readonly warningValue?: string;
}
export interface GaugeRequiredActions {
}

export function gaugeRequiredActionsToTerraform(struct?: GaugeRequiredActions): any {
...
export function gaugeRequiredActionsToHclTerraform(struct?: GaugeRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GaugeRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GaugeRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GaugeRequiredActions | undefined) {
    if (value === undefined) {
...
export class GaugeRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GaugeRequiredActionsOutputReference {
    return new GaugeRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge pingdirectory_gauge}
*/
export class Gauge extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a Gauge resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the Gauge to import
  * @param importFromId The id of the existing Gauge that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Gauge to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge pingdirectory_gauge} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GaugeConfig
  */
  public constructor(scope: Construct, id: string, config: GaugeConfig) {
    super(scope, id, {
  ...
  // critical_exit_value - computed: false, optional: true, required: false
  ...
  // critical_value - computed: false, optional: true, required: false
  ...
  // gauge_data_source - computed: false, optional: false, required: true
  ...
  // major_exit_value - computed: false, optional: true, required: false
  ...
  // major_value - computed: false, optional: true, required: false
  ...
  // minor_exit_value - computed: false, optional: true, required: false
  ...
  // minor_value - computed: false, optional: true, required: false
  ...
  // override_severity - computed: false, optional: true, required: false
  ...
  private _requiredActions = new GaugeRequiredActionsList(this, "required_actions", true);
  ...
  // warning_exit_value - computed: false, optional: true, required: false
  ...
  // warning_value - computed: false, optional: true, required: false
