// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator
...
export interface PasswordGeneratorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Indicates whether to capitalize each word used in the generated password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#capitalize_words PasswordGenerator#capitalize_words}
  */
  readonly capitalizeWords?: boolean | cdktf.IResolvable;
  /**
  * A description for this Password Generator
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#description PasswordGenerator#description}
  */
  readonly description?: string;
  /**
  * The path to the dictionary file that will be used to obtain the words for use in generated passwords.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#dictionary_file PasswordGenerator#dictionary_file}
  */
  readonly dictionaryFile?: string;
  /**
  * Indicates whether the Password Generator is enabled for use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#enabled PasswordGenerator#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#extension_argument PasswordGenerator#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#extension_class PasswordGenerator#extension_class}
  */
  readonly extensionClass?: string;
  /**
  * The minimum number of characters that generated passwords will be required to have.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#minimum_password_characters PasswordGenerator#minimum_password_characters}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#minimum_password_words PasswordGenerator#minimum_password_words}
  */
  readonly minimumPasswordWords?: number;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#name PasswordGenerator#name}
  */
  readonly name: string;
  /**
  * Specifies one or more named character sets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#password_character_set PasswordGenerator#password_character_set}
  */
  readonly passwordCharacterSet?: string[];
  /**
  * Specifies the format to use for the generated password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#password_format PasswordGenerator#password_format}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#script_argument PasswordGenerator#script_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#script_class PasswordGenerator#script_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#type PasswordGenerator#type}
  */
  readonly type: string;
}
export interface PasswordGeneratorRequiredActions {
}

export function passwordGeneratorRequiredActionsToTerraform(struct?: PasswordGeneratorRequiredActions): any {
...
export function passwordGeneratorRequiredActionsToHclTerraform(struct?: PasswordGeneratorRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PasswordGeneratorRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PasswordGeneratorRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: PasswordGeneratorRequiredActions | undefined) {
    if (value === undefined) {
...
export class PasswordGeneratorRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): PasswordGeneratorRequiredActionsOutputReference {
    return new PasswordGeneratorRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator pingdirectory_password_generator}
*/
export class PasswordGenerator extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a PasswordGenerator resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the PasswordGenerator to import
  * @param importFromId The id of the existing PasswordGenerator that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the PasswordGenerator to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/password_generator pingdirectory_password_generator} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options PasswordGeneratorConfig
  */
  public constructor(scope: Construct, id: string, config: PasswordGeneratorConfig) {
    super(scope, id, {
  ...
  private _requiredActions = new PasswordGeneratorRequiredActionsList(this, "required_actions", true);
