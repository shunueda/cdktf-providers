// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints
...
export interface DefaultJsonFieldConstraintsConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#allow_empty_object DefaultJsonFieldConstraints#allow_empty_object}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#allow_null_value DefaultJsonFieldConstraints#allow_null_value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#allowed_value DefaultJsonFieldConstraints#allowed_value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#allowed_value_regular_expression DefaultJsonFieldConstraints#allowed_value_regular_expression}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#cache_mode DefaultJsonFieldConstraints#cache_mode}
  */
  readonly cacheMode?: string;
  /**
  * A description for this JSON Field Constraints
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#description DefaultJsonFieldConstraints#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#index_entry_limit DefaultJsonFieldConstraints#index_entry_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#index_values DefaultJsonFieldConstraints#index_values}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#is_array DefaultJsonFieldConstraints#is_array}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#is_required DefaultJsonFieldConstraints#is_required}
  */
  readonly isRequired?: boolean | cdktf.IResolvable;
  /**
  * Name of the parent JSON Attribute Constraints
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#json_attribute_constraints_name DefaultJsonFieldConstraints#json_attribute_constraints_name}
  */
  readonly jsonAttributeConstraintsName: string;
  /**
  * The full name of the JSON field to which these constraints apply.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#json_field DefaultJsonFieldConstraints#json_field}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#maximum_numeric_value DefaultJsonFieldConstraints#maximum_numeric_value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#maximum_value_count DefaultJsonFieldConstraints#maximum_value_count}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#maximum_value_length DefaultJsonFieldConstraints#maximum_value_length}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#minimum_numeric_value DefaultJsonFieldConstraints#minimum_numeric_value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#minimum_value_count DefaultJsonFieldConstraints#minimum_value_count}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#minimum_value_length DefaultJsonFieldConstraints#minimum_value_length}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#prime_index DefaultJsonFieldConstraints#prime_index}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#tokenize_values DefaultJsonFieldConstraints#tokenize_values}
  */
  readonly tokenizeValues?: boolean | cdktf.IResolvable;
  /**
  * The data type that will be required for values of the target field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#value_type DefaultJsonFieldConstraints#value_type}
  */
  readonly valueType?: string;
}
export interface DefaultJsonFieldConstraintsRequiredActions {
}

export function defaultJsonFieldConstraintsRequiredActionsToTerraform(struct?: DefaultJsonFieldConstraintsRequiredActions): any {
...
export function defaultJsonFieldConstraintsRequiredActionsToHclTerraform(struct?: DefaultJsonFieldConstraintsRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DefaultJsonFieldConstraintsRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DefaultJsonFieldConstraintsRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DefaultJsonFieldConstraintsRequiredActions | undefined) {
    if (value === undefined) {
...
export class DefaultJsonFieldConstraintsRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DefaultJsonFieldConstraintsRequiredActionsOutputReference {
    return new DefaultJsonFieldConstraintsRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints pingdirectory_default_json_field_constraints}
*/
export class DefaultJsonFieldConstraints extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingdirectory_default_json_field_constraints";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DefaultJsonFieldConstraints resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DefaultJsonFieldConstraints to import
  * @param importFromId The id of the existing DefaultJsonFieldConstraints that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DefaultJsonFieldConstraints to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingdirectory_default_json_field_constraints", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_json_field_constraints pingdirectory_default_json_field_constraints} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DefaultJsonFieldConstraintsConfig
  */
  public constructor(scope: Construct, id: string, config: DefaultJsonFieldConstraintsConfig) {
    super(scope, id, {
      terraformResourceType: 'pingdirectory_default_json_field_constraints',
  ...
  // maximum_numeric_value - computed: true, optional: true, required: false
  ...
  // maximum_value_count - computed: true, optional: true, required: false
  ...
  // maximum_value_length - computed: true, optional: true, required: false
  ...
  // minimum_numeric_value - computed: true, optional: true, required: false
  ...
  // minimum_value_count - computed: true, optional: true, required: false
  ...
  // minimum_value_length - computed: true, optional: true, required: false
  ...
  private _requiredActions = new DefaultJsonFieldConstraintsRequiredActionsList(this, "required_actions", true);
