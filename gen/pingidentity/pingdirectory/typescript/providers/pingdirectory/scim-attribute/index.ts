// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute
...
export interface ScimAttributeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specifies the suggested canonical type values for the attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute#canonical_value ScimAttribute#canonical_value}
  */
  readonly canonicalValue?: string[];
  /**
  * Specifies whether the attribute values are case sensitive.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute#case_exact ScimAttribute#case_exact}
  */
  readonly caseExact?: boolean | cdktf.IResolvable;
  /**
  * A description for this SCIM Attribute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute#description ScimAttribute#description}
  */
  readonly description?: string;
  /**
  * Specifies whether this attribute may have multiple values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute#multi_valued ScimAttribute#multi_valued}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute#mutability ScimAttribute#mutability}
  */
  readonly mutability?: string;
  /**
  * The name of the attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute#name ScimAttribute#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute#reference_type ScimAttribute#reference_type}
  */
  readonly referenceType?: string[];
  /**
  * Specifies whether this attribute is required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute#required ScimAttribute#required}
  */
  readonly required?: boolean | cdktf.IResolvable;
  /**
  * The type of SCIM Attribute resource. Options are ['scim-attribute']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute#resource_type ScimAttribute#resource_type}
  */
  readonly resourceType?: string;
  /**
  * Specifies the circumstances under which the values of the attribute are returned in response to a request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute#returned ScimAttribute#returned}
  */
  readonly returned?: string;
  /**
  * Name of the parent SCIM Schema
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute#scim_schema_name ScimAttribute#scim_schema_name}
  */
  readonly scimSchemaName: string;
  /**
  * Specifies the data type for this attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute#type ScimAttribute#type}
  */
  readonly type?: string;
}
export interface ScimAttributeRequiredActions {
}

export function scimAttributeRequiredActionsToTerraform(struct?: ScimAttributeRequiredActions): any {
...
export function scimAttributeRequiredActionsToHclTerraform(struct?: ScimAttributeRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ScimAttributeRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ScimAttributeRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ScimAttributeRequiredActions | undefined) {
    if (value === undefined) {
...
export class ScimAttributeRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): ScimAttributeRequiredActionsOutputReference {
    return new ScimAttributeRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute pingdirectory_scim_attribute}
*/
export class ScimAttribute extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a ScimAttribute resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ScimAttribute to import
  * @param importFromId The id of the existing ScimAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ScimAttribute to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_attribute pingdirectory_scim_attribute} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ScimAttributeConfig
  */
  public constructor(scope: Construct, id: string, config: ScimAttributeConfig) {
    super(scope, id, {
  ...
  private _requiredActions = new ScimAttributeRequiredActionsList(this, "required_actions", true);
