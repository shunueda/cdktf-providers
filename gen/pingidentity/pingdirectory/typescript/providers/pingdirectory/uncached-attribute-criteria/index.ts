// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria
...
export interface UncachedAttributeCriteriaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specifies the attribute types for attributes that may be written to the uncached-id2entry database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria#attribute_type UncachedAttributeCriteria#attribute_type}
  */
  readonly attributeType?: string[];
  /**
  * A description for this Uncached Attribute Criteria
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria#description UncachedAttributeCriteria#description}
  */
  readonly description?: string;
  /**
  * Indicates whether this Uncached Attribute Criteria is enabled for use in the server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria#enabled UncachedAttributeCriteria#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria#extension_argument UncachedAttributeCriteria#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria#extension_class UncachedAttributeCriteria#extension_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria#min_total_value_size UncachedAttributeCriteria#min_total_value_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria#min_value_count UncachedAttributeCriteria#min_value_count}
  */
  readonly minValueCount?: number;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria#name UncachedAttributeCriteria#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria#script_argument UncachedAttributeCriteria#script_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria#script_class UncachedAttributeCriteria#script_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria#type UncachedAttributeCriteria#type}
  */
  readonly type: string;
}
export interface UncachedAttributeCriteriaRequiredActions {
}

export function uncachedAttributeCriteriaRequiredActionsToTerraform(struct?: UncachedAttributeCriteriaRequiredActions): any {
...
export function uncachedAttributeCriteriaRequiredActionsToHclTerraform(struct?: UncachedAttributeCriteriaRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class UncachedAttributeCriteriaRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): UncachedAttributeCriteriaRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: UncachedAttributeCriteriaRequiredActions | undefined) {
    if (value === undefined) {
...
export class UncachedAttributeCriteriaRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): UncachedAttributeCriteriaRequiredActionsOutputReference {
    return new UncachedAttributeCriteriaRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria pingdirectory_uncached_attribute_criteria}
*/
export class UncachedAttributeCriteria extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a UncachedAttributeCriteria resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the UncachedAttributeCriteria to import
  * @param importFromId The id of the existing UncachedAttributeCriteria that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the UncachedAttributeCriteria to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/uncached_attribute_criteria pingdirectory_uncached_attribute_criteria} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options UncachedAttributeCriteriaConfig
  */
  public constructor(scope: Construct, id: string, config: UncachedAttributeCriteriaConfig) {
    super(scope, id, {
  ...
  private _requiredActions = new UncachedAttributeCriteriaRequiredActionsList(this, "required_actions", true);
