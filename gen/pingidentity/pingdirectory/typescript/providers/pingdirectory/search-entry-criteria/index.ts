// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria
...
export interface SearchEntryCriteriaConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#all_included_entry_control SearchEntryCriteria#all_included_entry_control}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#all_included_entry_filter SearchEntryCriteria#all_included_entry_filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#all_included_entry_group_dn SearchEntryCriteria#all_included_entry_group_dn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#all_included_search_entry_criteria SearchEntryCriteria#all_included_search_entry_criteria}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#any_included_entry_control SearchEntryCriteria#any_included_entry_control}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#any_included_entry_filter SearchEntryCriteria#any_included_entry_filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#any_included_entry_group_dn SearchEntryCriteria#any_included_entry_group_dn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#any_included_search_entry_criteria SearchEntryCriteria#any_included_search_entry_criteria}
  */
  readonly anyIncludedSearchEntryCriteria?: string[];
  /**
  * A description for this Search Entry Criteria
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#description SearchEntryCriteria#description}
  */
  readonly description?: string;
  /**
  * Specifies a base DN below which entries included in this Simple Search Entry Criteria may not exist.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#excluded_entry_base_dn SearchEntryCriteria#excluded_entry_base_dn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#extension_argument SearchEntryCriteria#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#extension_class SearchEntryCriteria#extension_class}
  */
  readonly extensionClass?: string;
  /**
  * Specifies a base DN below which entries included in this Simple Search Entry Criteria may exist.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#included_entry_base_dn SearchEntryCriteria#included_entry_base_dn}
  */
  readonly includedEntryBaseDn?: string[];
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#name SearchEntryCriteria#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#none_included_entry_control SearchEntryCriteria#none_included_entry_control}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#none_included_entry_filter SearchEntryCriteria#none_included_entry_filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#none_included_entry_group_dn SearchEntryCriteria#none_included_entry_group_dn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#none_included_search_entry_criteria SearchEntryCriteria#none_included_search_entry_criteria}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#not_all_included_entry_control SearchEntryCriteria#not_all_included_entry_control}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#not_all_included_entry_filter SearchEntryCriteria#not_all_included_entry_filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#not_all_included_entry_group_dn SearchEntryCriteria#not_all_included_entry_group_dn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#not_all_included_search_entry_criteria SearchEntryCriteria#not_all_included_search_entry_criteria}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#request_criteria SearchEntryCriteria#request_criteria}
  */
  readonly requestCriteria?: string;
  /**
  * The type of Search Entry Criteria resource. Options are ['simple', 'aggregate', 'third-party']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#type SearchEntryCriteria#type}
  */
  readonly type: string;
}
export interface SearchEntryCriteriaRequiredActions {
}

export function searchEntryCriteriaRequiredActionsToTerraform(struct?: SearchEntryCriteriaRequiredActions): any {
...
export function searchEntryCriteriaRequiredActionsToHclTerraform(struct?: SearchEntryCriteriaRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SearchEntryCriteriaRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SearchEntryCriteriaRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: SearchEntryCriteriaRequiredActions | undefined) {
    if (value === undefined) {
...
export class SearchEntryCriteriaRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): SearchEntryCriteriaRequiredActionsOutputReference {
    return new SearchEntryCriteriaRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria pingdirectory_search_entry_criteria}
*/
export class SearchEntryCriteria extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a SearchEntryCriteria resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the SearchEntryCriteria to import
  * @param importFromId The id of the existing SearchEntryCriteria that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SearchEntryCriteria to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_entry_criteria pingdirectory_search_entry_criteria} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options SearchEntryCriteriaConfig
  */
  public constructor(scope: Construct, id: string, config: SearchEntryCriteriaConfig) {
    super(scope, id, {
  ...
  private _requiredActions = new SearchEntryCriteriaRequiredActionsList(this, "required_actions", true);
