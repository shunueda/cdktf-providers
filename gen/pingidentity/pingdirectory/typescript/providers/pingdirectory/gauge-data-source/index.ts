// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source
...
export interface GaugeDataSourceConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#additional_text GaugeDataSource#additional_text}
  */
  readonly additionalText?: string;
  /**
  * Indicates whether a higher or lower value is a more severe condition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#data_orientation GaugeDataSource#data_orientation}
  */
  readonly dataOrientation?: string;
  /**
  * A description for this Gauge Data Source
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#description GaugeDataSource#description}
  */
  readonly description?: string;
  /**
  * An optional floating point value that can be used to scale the resulting value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#divide_value_by GaugeDataSource#divide_value_by}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#divide_value_by_attribute GaugeDataSource#divide_value_by_attribute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#divide_value_by_counter_attribute GaugeDataSource#divide_value_by_counter_attribute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#include_filter GaugeDataSource#include_filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#minimum_update_interval GaugeDataSource#minimum_update_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#monitor_attribute GaugeDataSource#monitor_attribute}
  */
  readonly monitorAttribute: string;
  /**
  * The object class name of the monitor entries to examine for generating gauge data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#monitor_objectclass GaugeDataSource#monitor_objectclass}
  */
  readonly monitorObjectclass: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#name GaugeDataSource#name}
  */
  readonly name: string;
  /**
  * Specifies the attribute whose value is used to identify the specific resource being monitored (e.g. device name).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#resource_attribute GaugeDataSource#resource_attribute}
  */
  readonly resourceAttribute?: string;
  /**
  * A string indicating the type of resource being monitored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#resource_type GaugeDataSource#resource_type}
  */
  readonly resourceType?: string;
  /**
  * Specifies the type of statistic to include in the output for the monitored attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#statistic_type GaugeDataSource#statistic_type}
  */
  readonly statisticType?: string;
  /**
  * The type of Gauge Data Source resource. Options are ['indicator', 'numeric']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#type GaugeDataSource#type}
  */
  readonly type: string;
}
export interface GaugeDataSourceRequiredActions {
}

export function gaugeDataSourceRequiredActionsToTerraform(struct?: GaugeDataSourceRequiredActions): any {
...
export function gaugeDataSourceRequiredActionsToHclTerraform(struct?: GaugeDataSourceRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GaugeDataSourceRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GaugeDataSourceRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GaugeDataSourceRequiredActions | undefined) {
    if (value === undefined) {
...
export class GaugeDataSourceRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GaugeDataSourceRequiredActionsOutputReference {
    return new GaugeDataSourceRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source pingdirectory_gauge_data_source}
*/
export class GaugeDataSource extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a GaugeDataSource resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the GaugeDataSource to import
  * @param importFromId The id of the existing GaugeDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GaugeDataSource to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/gauge_data_source pingdirectory_gauge_data_source} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GaugeDataSourceConfig
  */
  public constructor(scope: Construct, id: string, config: GaugeDataSourceConfig) {
    super(scope, id, {
  ...
  // additional_text - computed: false, optional: true, required: false
  ...
  // divide_value_by - computed: false, optional: true, required: false
  ...
  // divide_value_by_attribute - computed: false, optional: true, required: false
  ...
  // divide_value_by_counter_attribute - computed: false, optional: true, required: false
  ...
  // monitor_attribute - computed: false, optional: false, required: true
  ...
  // monitor_objectclass - computed: false, optional: false, required: true
  ...
  private _requiredActions = new GaugeDataSourceRequiredActionsList(this, "required_actions", true);
