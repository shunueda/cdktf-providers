// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper
...
export interface CertificateMapperConfig extends cdktf.TerraformMetaArguments {
  /**
  * A description for this Certificate Mapper
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#description CertificateMapper#description}
  */
  readonly description?: string;
  /**
  * Indicates whether the Certificate Mapper is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#enabled CertificateMapper#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#extension_argument CertificateMapper#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#extension_class CertificateMapper#extension_class}
  */
  readonly extensionClass?: string;
  /**
  * Specifies the name of the digest algorithm to compute the fingerprint of client certificates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#fingerprint_algorithm CertificateMapper#fingerprint_algorithm}
  */
  readonly fingerprintAlgorithm?: string;
  /**
  * Specifies the attribute in which to look for the fingerprint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#fingerprint_attribute CertificateMapper#fingerprint_attribute}
  */
  readonly fingerprintAttribute?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#name CertificateMapper#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#script_argument CertificateMapper#script_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#script_class CertificateMapper#script_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#subject_attribute CertificateMapper#subject_attribute}
  */
  readonly subjectAttribute?: string;
  /**
  * Specifies a mapping between certificate attributes and user attributes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#subject_attribute_mapping CertificateMapper#subject_attribute_mapping}
  */
  readonly subjectAttributeMapping?: string[];
  /**
  * The type of Certificate Mapper resource. Options are ['subject-equals-dn', 'subject-dn-to-user-attribute', 'groovy-scripted', 'subject-attribute-to-user-attribute', 'fingerprint', 'third-party']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#type CertificateMapper#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#user_base_dn CertificateMapper#user_base_dn}
  */
  readonly userBaseDn?: string[];
}
export interface CertificateMapperRequiredActions {
}

export function certificateMapperRequiredActionsToTerraform(struct?: CertificateMapperRequiredActions): any {
...
export function certificateMapperRequiredActionsToHclTerraform(struct?: CertificateMapperRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CertificateMapperRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CertificateMapperRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: CertificateMapperRequiredActions | undefined) {
    if (value === undefined) {
...
export class CertificateMapperRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): CertificateMapperRequiredActionsOutputReference {
    return new CertificateMapperRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper pingdirectory_certificate_mapper}
*/
export class CertificateMapper extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a CertificateMapper resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the CertificateMapper to import
  * @param importFromId The id of the existing CertificateMapper that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the CertificateMapper to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/certificate_mapper pingdirectory_certificate_mapper} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options CertificateMapperConfig
  */
  public constructor(scope: Construct, id: string, config: CertificateMapperConfig) {
    super(scope, id, {
  ...
  // fingerprint_algorithm - computed: false, optional: true, required: false
  ...
  private _requiredActions = new CertificateMapperRequiredActionsList(this, "required_actions", true);
