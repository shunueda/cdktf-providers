// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute
...
export interface DelegatedAdminAttributeConfig extends cdktf.TerraformMetaArguments {
  /**
  * The list of file types allowed to be uploaded. If no types are specified, then all types will be allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#allowed_mime_type DelegatedAdminAttribute#allowed_mime_type}
  */
  readonly allowedMimeType?: string[];
  /**
  * Specifies which attribute category this attribute belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#attribute_category DelegatedAdminAttribute#attribute_category}
  */
  readonly attributeCategory?: string;
  /**
  * Indicates how the attribute is presented to the user of the app.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#attribute_presentation DelegatedAdminAttribute#attribute_presentation}
  */
  readonly attributePresentation?: string;
  /**
  * Specifies the name or OID of the LDAP attribute type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#attribute_type DelegatedAdminAttribute#attribute_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#date_time_format DelegatedAdminAttribute#date_time_format}
  */
  readonly dateTimeFormat?: string;
  /**
  * A description for this Delegated Admin Attribute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#description DelegatedAdminAttribute#description}
  */
  readonly description?: string;
  /**
  * A human readable display name for this Delegated Admin Attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#display_name DelegatedAdminAttribute#display_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#display_order_index DelegatedAdminAttribute#display_order_index}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#include_in_summary DelegatedAdminAttribute#include_in_summary}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#multi_valued DelegatedAdminAttribute#multi_valued}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#mutability DelegatedAdminAttribute#mutability}
  */
  readonly mutability?: string;
  /**
  * For LDAP attributes with DN syntax, specifies what kind of resource is referenced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#reference_resource_type DelegatedAdminAttribute#reference_resource_type}
  */
  readonly referenceResourceType?: string;
  /**
  * Name of the parent REST Resource Type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#rest_resource_type_name DelegatedAdminAttribute#rest_resource_type_name}
  */
  readonly restResourceTypeName: string;
  /**
  * The type of Delegated Admin Attribute resource. Options are ['certificate', 'photo', 'generic']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#type DelegatedAdminAttribute#type}
  */
  readonly type: string;
}
export interface DelegatedAdminAttributeRequiredActions {
}

export function delegatedAdminAttributeRequiredActionsToTerraform(struct?: DelegatedAdminAttributeRequiredActions): any {
...
export function delegatedAdminAttributeRequiredActionsToHclTerraform(struct?: DelegatedAdminAttributeRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DelegatedAdminAttributeRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DelegatedAdminAttributeRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DelegatedAdminAttributeRequiredActions | undefined) {
    if (value === undefined) {
...
export class DelegatedAdminAttributeRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DelegatedAdminAttributeRequiredActionsOutputReference {
    return new DelegatedAdminAttributeRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute pingdirectory_delegated_admin_attribute}
*/
export class DelegatedAdminAttribute extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DelegatedAdminAttribute resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DelegatedAdminAttribute to import
  * @param importFromId The id of the existing DelegatedAdminAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DelegatedAdminAttribute to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/delegated_admin_attribute pingdirectory_delegated_admin_attribute} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DelegatedAdminAttributeConfig
  */
  public constructor(scope: Construct, id: string, config: DelegatedAdminAttributeConfig) {
    super(scope, id, {
  ...
  // attribute_category - computed: false, optional: true, required: false
  ...
  // attribute_presentation - computed: false, optional: true, required: false
  ...
  // reference_resource_type - computed: false, optional: true, required: false
  ...
  private _requiredActions = new DelegatedAdminAttributeRequiredActionsList(this, "required_actions", true);
