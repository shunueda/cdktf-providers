// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler
...
export interface ExtendedOperationHandlerConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#adjacent_intervals_to_check ExtendedOperationHandler#adjacent_intervals_to_check}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#allow_remotely_provided_certificates ExtendedOperationHandler#allow_remotely_provided_certificates}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#allowed_operation ExtendedOperationHandler#allowed_operation}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#connection_criteria ExtendedOperationHandler#connection_criteria}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#default_otp_delivery_mechanism ExtendedOperationHandler#default_otp_delivery_mechanism}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#default_single_use_token_validity_duration ExtendedOperationHandler#default_single_use_token_validity_duration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#default_token_delivery_mechanism ExtendedOperationHandler#default_token_delivery_mechanism}
  */
  readonly defaultTokenDeliveryMechanism?: string[];
  /**
  * A description for this Extended Operation Handler
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#description ExtendedOperationHandler#description}
  */
  readonly description?: string;
  /**
  * Indicates whether the Extended Operation Handler is enabled (that is, whether the types of extended operations are allowed in the server).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#enabled ExtendedOperationHandler#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#extension_argument ExtendedOperationHandler#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#extension_class ExtendedOperationHandler#extension_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#identity_mapper ExtendedOperationHandler#identity_mapper}
  */
  readonly identityMapper?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#name ExtendedOperationHandler#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#password_generator ExtendedOperationHandler#password_generator}
  */
  readonly passwordGenerator?: string;
  /**
  * The maximum length of time that a password reset token should be considered valid.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#password_reset_token_validity_duration ExtendedOperationHandler#password_reset_token_validity_duration}
  */
  readonly passwordResetTokenValidityDuration?: string;
  /**
  * Indicates whether to prevent clients from re-using TOTP passwords.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#prevent_totp_reuse ExtendedOperationHandler#prevent_totp_reuse}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#reject_insecure_requests ExtendedOperationHandler#reject_insecure_requests}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#request_criteria ExtendedOperationHandler#request_criteria}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#shared_secret_attribute_type ExtendedOperationHandler#shared_secret_attribute_type}
  */
  readonly sharedSecretAttributeType?: string;
  /**
  * The duration of the time interval used for TOTP processing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#time_interval_duration ExtendedOperationHandler#time_interval_duration}
  */
  readonly timeIntervalDuration?: string;
  /**
  * The type of Extended Operation Handler resource. Options are ['cancel', 'validate-totp-password', 'replace-certificate', 'get-connection-id', 'multi-update', 'notification-subscription', 'password-modify', 'custom', 'collect-support-data', 'export-reversible-passwords', 'batched-transactions', 'get-changelog-batch', 'get-supported-otp-delivery-mechanisms', 'verify-password', 'single-use-tokens', 'generate-password', 'who-am-i', 'start-tls', 'deliver-password-reset-token', 'password-policy-state', 'get-password-quality-requirements', 'deliver-otp', 'third-party']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#type ExtendedOperationHandler#type}
  */
  readonly type: string;
}
export interface ExtendedOperationHandlerRequiredActions {
}

export function extendedOperationHandlerRequiredActionsToTerraform(struct?: ExtendedOperationHandlerRequiredActions): any {
...
export function extendedOperationHandlerRequiredActionsToHclTerraform(struct?: ExtendedOperationHandlerRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ExtendedOperationHandlerRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ExtendedOperationHandlerRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ExtendedOperationHandlerRequiredActions | undefined) {
    if (value === undefined) {
...
export class ExtendedOperationHandlerRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): ExtendedOperationHandlerRequiredActionsOutputReference {
    return new ExtendedOperationHandlerRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler pingdirectory_extended_operation_handler}
*/
export class ExtendedOperationHandler extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a ExtendedOperationHandler resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ExtendedOperationHandler to import
  * @param importFromId The id of the existing ExtendedOperationHandler that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ExtendedOperationHandler to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/extended_operation_handler pingdirectory_extended_operation_handler} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ExtendedOperationHandlerConfig
  */
  public constructor(scope: Construct, id: string, config: ExtendedOperationHandlerConfig) {
    super(scope, id, {
  ...
  private _requiredActions = new ExtendedOperationHandlerRequiredActionsList(this, "required_actions", true);
