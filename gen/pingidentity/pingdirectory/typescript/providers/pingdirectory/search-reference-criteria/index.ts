// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria
...
export interface SearchReferenceCriteriaConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#all_included_reference_control SearchReferenceCriteria#all_included_reference_control}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#all_included_search_reference_criteria SearchReferenceCriteria#all_included_search_reference_criteria}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#any_included_reference_control SearchReferenceCriteria#any_included_reference_control}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#any_included_search_reference_criteria SearchReferenceCriteria#any_included_search_reference_criteria}
  */
  readonly anyIncludedSearchReferenceCriteria?: string[];
  /**
  * A description for this Search Reference Criteria
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#description SearchReferenceCriteria#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#extension_argument SearchReferenceCriteria#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#extension_class SearchReferenceCriteria#extension_class}
  */
  readonly extensionClass?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#name SearchReferenceCriteria#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#none_included_reference_control SearchReferenceCriteria#none_included_reference_control}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#none_included_search_reference_criteria SearchReferenceCriteria#none_included_search_reference_criteria}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#not_all_included_reference_control SearchReferenceCriteria#not_all_included_reference_control}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#not_all_included_search_reference_criteria SearchReferenceCriteria#not_all_included_search_reference_criteria}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#request_criteria SearchReferenceCriteria#request_criteria}
  */
  readonly requestCriteria?: string;
  /**
  * The type of Search Reference Criteria resource. Options are ['simple', 'aggregate', 'third-party']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#type SearchReferenceCriteria#type}
  */
  readonly type: string;
}
export interface SearchReferenceCriteriaRequiredActions {
}

export function searchReferenceCriteriaRequiredActionsToTerraform(struct?: SearchReferenceCriteriaRequiredActions): any {
...
export function searchReferenceCriteriaRequiredActionsToHclTerraform(struct?: SearchReferenceCriteriaRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SearchReferenceCriteriaRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SearchReferenceCriteriaRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: SearchReferenceCriteriaRequiredActions | undefined) {
    if (value === undefined) {
...
export class SearchReferenceCriteriaRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): SearchReferenceCriteriaRequiredActionsOutputReference {
    return new SearchReferenceCriteriaRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria pingdirectory_search_reference_criteria}
*/
export class SearchReferenceCriteria extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a SearchReferenceCriteria resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the SearchReferenceCriteria to import
  * @param importFromId The id of the existing SearchReferenceCriteria that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SearchReferenceCriteria to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/search_reference_criteria pingdirectory_search_reference_criteria} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options SearchReferenceCriteriaConfig
  */
  public constructor(scope: Construct, id: string, config: SearchReferenceCriteriaConfig) {
    super(scope, id, {
  ...
  private _requiredActions = new SearchReferenceCriteriaRequiredActionsList(this, "required_actions", true);
