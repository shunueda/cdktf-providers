// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener
...
export interface DefaultLogFileRotationListenerConfig extends cdktf.TerraformMetaArguments {
  /**
  * The external server with information to use when interacting with the AWS S3 service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#aws_external_server DefaultLogFileRotationListener#aws_external_server}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#compress_on_copy DefaultLogFileRotationListener#compress_on_copy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#copy_to_directory DefaultLogFileRotationListener#copy_to_directory}
  */
  readonly copyToDirectory?: string;
  /**
  * A description for this Log File Rotation Listener
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#description DefaultLogFileRotationListener#description}
  */
  readonly description?: string;
  /**
  * Indicates whether the Log File Rotation Listener is enabled for use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#enabled DefaultLogFileRotationListener#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#extension_argument DefaultLogFileRotationListener#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#extension_class DefaultLogFileRotationListener#extension_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#file_retention_pattern DefaultLogFileRotationListener#file_retention_pattern}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#maximum_concurrent_transfer_connections DefaultLogFileRotationListener#maximum_concurrent_transfer_connections}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#maximum_file_age_to_retain DefaultLogFileRotationListener#maximum_file_age_to_retain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#maximum_file_count_to_retain DefaultLogFileRotationListener#maximum_file_count_to_retain}
  */
  readonly maximumFileCountToRetain?: number;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#name DefaultLogFileRotationListener#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#output_directory DefaultLogFileRotationListener#output_directory}
  */
  readonly outputDirectory?: string;
  /**
  * The name of the S3 bucket into which rotated log files should be copied.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#s3_bucket_name DefaultLogFileRotationListener#s3_bucket_name}
  */
  readonly s3BucketName?: string;
  /**
  * The target throughput to attempt to achieve for data transfers to or from S3, in megabits per second.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#target_throughput_in_megabits_per_second DefaultLogFileRotationListener#target_throughput_in_megabits_per_second}
  */
  readonly targetThroughputInMegabitsPerSecond?: number;
}
export interface DefaultLogFileRotationListenerRequiredActions {
}

export function defaultLogFileRotationListenerRequiredActionsToTerraform(struct?: DefaultLogFileRotationListenerRequiredActions): any {
...
export function defaultLogFileRotationListenerRequiredActionsToHclTerraform(struct?: DefaultLogFileRotationListenerRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DefaultLogFileRotationListenerRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DefaultLogFileRotationListenerRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DefaultLogFileRotationListenerRequiredActions | undefined) {
    if (value === undefined) {
...
export class DefaultLogFileRotationListenerRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DefaultLogFileRotationListenerRequiredActionsOutputReference {
    return new DefaultLogFileRotationListenerRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener pingdirectory_default_log_file_rotation_listener}
*/
export class DefaultLogFileRotationListener extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingdirectory_default_log_file_rotation_listener";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DefaultLogFileRotationListener resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DefaultLogFileRotationListener to import
  * @param importFromId The id of the existing DefaultLogFileRotationListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DefaultLogFileRotationListener to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingdirectory_default_log_file_rotation_listener", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_log_file_rotation_listener pingdirectory_default_log_file_rotation_listener} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DefaultLogFileRotationListenerConfig
  */
  public constructor(scope: Construct, id: string, config: DefaultLogFileRotationListenerConfig) {
    super(scope, id, {
  ...
  // copy_to_directory - computed: true, optional: true, required: false
  ...
  // maximum_concurrent_transfer_connections - computed: true, optional: true, required: false
  ...
  // maximum_file_age_to_retain - computed: true, optional: true, required: false
  ...
  // maximum_file_count_to_retain - computed: true, optional: true, required: false
  ...
  private _requiredActions = new DefaultLogFileRotationListenerRequiredActionsList(this, "required_actions", true);
  ...
  // target_throughput_in_megabits_per_second - computed: true, optional: true, required: false
