// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider
...
export interface DefaultPassphraseProviderConfig extends cdktf.TerraformMetaArguments {
  /**
  * The external server with information to use when interacting with the AWS Secrets Manager.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#aws_external_server DefaultPassphraseProvider#aws_external_server}
  */
  readonly awsExternalServer?: string;
  /**
  * The mechanism used to authenticate to the Azure service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#azure_authentication_method DefaultPassphraseProvider#azure_authentication_method}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#conjur_external_server DefaultPassphraseProvider#conjur_external_server}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#conjur_secret_relative_path DefaultPassphraseProvider#conjur_secret_relative_path}
  */
  readonly conjurSecretRelativePath?: string;
  /**
  * A description for this Passphrase Provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#description DefaultPassphraseProvider#description}
  */
  readonly description?: string;
  /**
  * Indicates whether this Passphrase Provider is enabled for use in the server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#enabled DefaultPassphraseProvider#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The name of the environment variable that is expected to hold the passphrase.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#environment_variable DefaultPassphraseProvider#environment_variable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#extension_argument DefaultPassphraseProvider#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#extension_class DefaultPassphraseProvider#extension_class}
  */
  readonly extensionClass?: string;
  /**
  * A reference to an HTTP proxy server that should be used for requests sent to the Azure service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#http_proxy_external_server DefaultPassphraseProvider#http_proxy_external_server}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#key_vault_uri DefaultPassphraseProvider#key_vault_uri}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#max_cache_duration DefaultPassphraseProvider#max_cache_duration}
  */
  readonly maxCacheDuration?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#name DefaultPassphraseProvider#name}
  */
  readonly name: string;
  /**
  * The value to be stored in an obscured form.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#obscured_value DefaultPassphraseProvider#obscured_value}
  */
  readonly obscuredValue?: string;
  /**
  * The path to the file containing the passphrase.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#password_file DefaultPassphraseProvider#password_file}
  */
  readonly passwordFile?: string;
  /**
  * The name of the JSON field whose value is the passphrase that will be retrieved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#secret_field_name DefaultPassphraseProvider#secret_field_name}
  */
  readonly secretFieldName?: string;
  /**
  * The Amazon Resource Name (ARN) or the user-friendly name of the secret to be retrieved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#secret_id DefaultPassphraseProvider#secret_id}
  */
  readonly secretId?: string;
  /**
  * The name of the secret to retrieve.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#secret_name DefaultPassphraseProvider#secret_name}
  */
  readonly secretName?: string;
  /**
  * The unique identifier for the version of the secret to be retrieved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#secret_version_id DefaultPassphraseProvider#secret_version_id}
  */
  readonly secretVersionId?: string;
  /**
  * The staging label for the version of the secret to be retrieved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#secret_version_stage DefaultPassphraseProvider#secret_version_stage}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#vault_external_server DefaultPassphraseProvider#vault_external_server}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#vault_secret_field_name DefaultPassphraseProvider#vault_secret_field_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#vault_secret_path DefaultPassphraseProvider#vault_secret_path}
  */
  readonly vaultSecretPath?: string;
}
export interface DefaultPassphraseProviderRequiredActions {
}

export function defaultPassphraseProviderRequiredActionsToTerraform(struct?: DefaultPassphraseProviderRequiredActions): any {
...
export function defaultPassphraseProviderRequiredActionsToHclTerraform(struct?: DefaultPassphraseProviderRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DefaultPassphraseProviderRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DefaultPassphraseProviderRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DefaultPassphraseProviderRequiredActions | undefined) {
    if (value === undefined) {
...
export class DefaultPassphraseProviderRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DefaultPassphraseProviderRequiredActionsOutputReference {
    return new DefaultPassphraseProviderRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider pingdirectory_default_passphrase_provider}
*/
export class DefaultPassphraseProvider extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingdirectory_default_passphrase_provider";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DefaultPassphraseProvider resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DefaultPassphraseProvider to import
  * @param importFromId The id of the existing DefaultPassphraseProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DefaultPassphraseProvider to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingdirectory_default_passphrase_provider", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_passphrase_provider pingdirectory_default_passphrase_provider} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DefaultPassphraseProviderConfig
  */
  public constructor(scope: Construct, id: string, config: DefaultPassphraseProviderConfig) {
    super(scope, id, {
  ...
  // environment_variable - computed: true, optional: true, required: false
  ...
  private _requiredActions = new DefaultPassphraseProviderRequiredActionsList(this, "required_actions", true);
