// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism
...
export interface DefaultOtpDeliveryMechanismConfig extends cdktf.TerraformMetaArguments {
  /**
  * A description for this OTP Delivery Mechanism
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#description DefaultOtpDeliveryMechanism#description}
  */
  readonly description?: string;
  /**
  * The name or OID of the attribute that holds the email address to which the message should be sent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#email_address_attribute_type DefaultOtpDeliveryMechanism#email_address_attribute_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#email_address_json_field DefaultOtpDeliveryMechanism#email_address_json_field}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#email_address_json_object_filter DefaultOtpDeliveryMechanism#email_address_json_object_filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#enabled DefaultOtpDeliveryMechanism#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#extension_argument DefaultOtpDeliveryMechanism#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#extension_class DefaultOtpDeliveryMechanism#extension_class}
  */
  readonly extensionClass?: string;
  /**
  * A reference to an HTTP proxy server that should be used for requests sent to the Twilio service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#http_proxy_external_server DefaultOtpDeliveryMechanism#http_proxy_external_server}
  */
  readonly httpProxyExternalServer?: string;
  /**
  * The subject to use for the e-mail message.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#message_subject DefaultOtpDeliveryMechanism#message_subject}
  */
  readonly messageSubject?: string;
  /**
  * Any text that should appear in the message after the one-time password value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#message_text_after_otp DefaultOtpDeliveryMechanism#message_text_after_otp}
  */
  readonly messageTextAfterOtp?: string;
  /**
  * Any text that should appear in the message before the one-time password value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#message_text_before_otp DefaultOtpDeliveryMechanism#message_text_before_otp}
  */
  readonly messageTextBeforeOtp?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#name DefaultOtpDeliveryMechanism#name}
  */
  readonly name: string;
  /**
  * The name or OID of the attribute in the user's entry that holds the phone number to which the message should be sent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#phone_number_attribute_type DefaultOtpDeliveryMechanism#phone_number_attribute_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#phone_number_json_field DefaultOtpDeliveryMechanism#phone_number_json_field}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#phone_number_json_object_filter DefaultOtpDeliveryMechanism#phone_number_json_object_filter}
  */
  readonly phoneNumberJsonObjectFilter?: string;
  /**
  * The e-mail address to use as the sender for the one-time password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#sender_address DefaultOtpDeliveryMechanism#sender_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#sender_phone_number DefaultOtpDeliveryMechanism#sender_phone_number}
  */
  readonly senderPhoneNumber?: string[];
  /**
  * The unique identifier assigned to the Twilio account that will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#twilio_account_sid DefaultOtpDeliveryMechanism#twilio_account_sid}
  */
  readonly twilioAccountSid?: string;
  /**
  * The auth token for the Twilio account that will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#twilio_auth_token DefaultOtpDeliveryMechanism#twilio_auth_token}
  */
  readonly twilioAuthToken?: string;
  /**
  * The passphrase provider that may be used to obtain the auth token for the Twilio account that will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#twilio_auth_token_passphrase_provider DefaultOtpDeliveryMechanism#twilio_auth_token_passphrase_provider}
  */
  readonly twilioAuthTokenPassphraseProvider?: string;
}
export interface DefaultOtpDeliveryMechanismRequiredActions {
}

export function defaultOtpDeliveryMechanismRequiredActionsToTerraform(struct?: DefaultOtpDeliveryMechanismRequiredActions): any {
...
export function defaultOtpDeliveryMechanismRequiredActionsToHclTerraform(struct?: DefaultOtpDeliveryMechanismRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DefaultOtpDeliveryMechanismRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DefaultOtpDeliveryMechanismRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DefaultOtpDeliveryMechanismRequiredActions | undefined) {
    if (value === undefined) {
...
export class DefaultOtpDeliveryMechanismRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DefaultOtpDeliveryMechanismRequiredActionsOutputReference {
    return new DefaultOtpDeliveryMechanismRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism pingdirectory_default_otp_delivery_mechanism}
*/
export class DefaultOtpDeliveryMechanism extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingdirectory_default_otp_delivery_mechanism";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DefaultOtpDeliveryMechanism resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DefaultOtpDeliveryMechanism to import
  * @param importFromId The id of the existing DefaultOtpDeliveryMechanism that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DefaultOtpDeliveryMechanism to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingdirectory_default_otp_delivery_mechanism", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_otp_delivery_mechanism pingdirectory_default_otp_delivery_mechanism} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DefaultOtpDeliveryMechanismConfig
  */
  public constructor(scope: Construct, id: string, config: DefaultOtpDeliveryMechanismConfig) {
    super(scope, id, {
  ...
  // email_address_json_field - computed: true, optional: true, required: false
  ...
  // email_address_json_object_filter - computed: true, optional: true, required: false
  ...
  // message_text_after_otp - computed: true, optional: true, required: false
  ...
  // message_text_before_otp - computed: true, optional: true, required: false
  ...
  // phone_number_json_field - computed: true, optional: true, required: false
  ...
  // phone_number_json_object_filter - computed: true, optional: true, required: false
  ...
  private _requiredActions = new DefaultOtpDeliveryMechanismRequiredActionsList(this, "required_actions", true);
