// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator
...
export interface DefaultIdTokenValidatorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specifies an allow list of JWT signing algorithms that will be accepted by the OpenID Connect ID Token Validator.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#allowed_signing_algorithm DefaultIdTokenValidator#allowed_signing_algorithm}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#clock_skew_grace_period DefaultIdTokenValidator#clock_skew_grace_period}
  */
  readonly clockSkewGracePeriod?: string;
  /**
  * A description for this ID Token Validator
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#description DefaultIdTokenValidator#description}
  */
  readonly description?: string;
  /**
  * Indicates whether this ID Token Validator is enabled for use in the Directory Server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#enabled DefaultIdTokenValidator#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#evaluation_order_index DefaultIdTokenValidator#evaluation_order_index}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#identity_mapper DefaultIdTokenValidator#identity_mapper}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#issuer_url DefaultIdTokenValidator#issuer_url}
  */
  readonly issuerUrl?: string;
  /**
  * How often the ID Token Validator should refresh its cache of JWKS token signing keys.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#jwks_cache_duration DefaultIdTokenValidator#jwks_cache_duration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#jwks_endpoint_path DefaultIdTokenValidator#jwks_endpoint_path}
  */
  readonly jwksEndpointPath?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#name DefaultIdTokenValidator#name}
  */
  readonly name: string;
  /**
  * How often the PingOne ID Token Validator should refresh its stored cache of OpenID Connect-related metadata.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#openid_connect_metadata_cache_duration DefaultIdTokenValidator#openid_connect_metadata_cache_duration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#openid_connect_provider DefaultIdTokenValidator#openid_connect_provider}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#signing_certificate DefaultIdTokenValidator#signing_certificate}
  */
  readonly signingCertificate?: string[];
  /**
  * The name of the token claim that contains the subject; i.e., the authenticated user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#subject_claim_name DefaultIdTokenValidator#subject_claim_name}
  */
  readonly subjectClaimName?: string;
}
export interface DefaultIdTokenValidatorRequiredActions {
}

export function defaultIdTokenValidatorRequiredActionsToTerraform(struct?: DefaultIdTokenValidatorRequiredActions): any {
...
export function defaultIdTokenValidatorRequiredActionsToHclTerraform(struct?: DefaultIdTokenValidatorRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DefaultIdTokenValidatorRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DefaultIdTokenValidatorRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DefaultIdTokenValidatorRequiredActions | undefined) {
    if (value === undefined) {
...
export class DefaultIdTokenValidatorRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DefaultIdTokenValidatorRequiredActionsOutputReference {
    return new DefaultIdTokenValidatorRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator pingdirectory_default_id_token_validator}
*/
export class DefaultIdTokenValidator extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingdirectory_default_id_token_validator";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DefaultIdTokenValidator resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DefaultIdTokenValidator to import
  * @param importFromId The id of the existing DefaultIdTokenValidator that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DefaultIdTokenValidator to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingdirectory_default_id_token_validator", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_id_token_validator pingdirectory_default_id_token_validator} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DefaultIdTokenValidatorConfig
  */
  public constructor(scope: Construct, id: string, config: DefaultIdTokenValidatorConfig) {
    super(scope, id, {
      terraformResourceType: 'pingdirectory_default_id_token_validator',
  ...
  private _requiredActions = new DefaultIdTokenValidatorRequiredActionsList(this, "required_actions", true);
