// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_debug_target
...
export interface DefaultDebugTargetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specifies the debug message categories to be logged.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_debug_target#debug_category DefaultDebugTarget#debug_category}
  */
  readonly debugCategory?: string[];
  /**
  * Specifies the lowest severity level of debug messages to log.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_debug_target#debug_level DefaultDebugTarget#debug_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_debug_target#debug_scope DefaultDebugTarget#debug_scope}
  */
  readonly debugScope: string;
  /**
  * A description for this Debug Target
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_debug_target#description DefaultDebugTarget#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_debug_target#include_throwable_cause DefaultDebugTarget#include_throwable_cause}
  */
  readonly includeThrowableCause?: boolean | cdktf.IResolvable;
  /**
  * Name of the parent Log Publisher
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_debug_target#log_publisher_name DefaultDebugTarget#log_publisher_name}
  */
  readonly logPublisherName: string;
  /**
  * Specifies the property to indicate whether to include method arguments in debug messages.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_debug_target#omit_method_entry_arguments DefaultDebugTarget#omit_method_entry_arguments}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_debug_target#omit_method_return_value DefaultDebugTarget#omit_method_return_value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_debug_target#throwable_stack_frames DefaultDebugTarget#throwable_stack_frames}
  */
  readonly throwableStackFrames?: number;
}
export interface DefaultDebugTargetRequiredActions {
}

export function defaultDebugTargetRequiredActionsToTerraform(struct?: DefaultDebugTargetRequiredActions): any {
...
export function defaultDebugTargetRequiredActionsToHclTerraform(struct?: DefaultDebugTargetRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DefaultDebugTargetRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DefaultDebugTargetRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DefaultDebugTargetRequiredActions | undefined) {
    if (value === undefined) {
...
export class DefaultDebugTargetRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DefaultDebugTargetRequiredActionsOutputReference {
    return new DefaultDebugTargetRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_debug_target pingdirectory_default_debug_target}
*/
export class DefaultDebugTarget extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingdirectory_default_debug_target";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DefaultDebugTarget resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DefaultDebugTarget to import
  * @param importFromId The id of the existing DefaultDebugTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_debug_target#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DefaultDebugTarget to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingdirectory_default_debug_target", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_debug_target pingdirectory_default_debug_target} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DefaultDebugTargetConfig
  */
  public constructor(scope: Construct, id: string, config: DefaultDebugTargetConfig) {
    super(scope, id, {
      terraformResourceType: 'pingdirectory_default_debug_target',
  ...
  private _requiredActions = new DefaultDebugTargetRequiredActionsList(this, "required_actions", true);
