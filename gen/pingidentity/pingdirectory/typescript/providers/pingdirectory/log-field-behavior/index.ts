// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior
...
export interface LogFieldBehaviorConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#default_behavior LogFieldBehavior#default_behavior}
  */
  readonly defaultBehavior?: string;
  /**
  * A description for this Log Field Behavior
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#description LogFieldBehavior#description}
  */
  readonly description?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#name LogFieldBehavior#name}
  */
  readonly name: string;
  /**
  * The log fields that should be omitted entirely from log messages. Neither the field name nor value will be included.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#omit_field LogFieldBehavior#omit_field}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#omit_field_name LogFieldBehavior#omit_field_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#preserve_field LogFieldBehavior#preserve_field}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#preserve_field_name LogFieldBehavior#preserve_field_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#redact_entire_value_field LogFieldBehavior#redact_entire_value_field}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#redact_entire_value_field_name LogFieldBehavior#redact_entire_value_field_name}
  */
  readonly redactEntireValueFieldName?: string[];
  /**
  * The log fields whose values will include redacted components.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#redact_value_components_field LogFieldBehavior#redact_value_components_field}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#redact_value_components_field_name LogFieldBehavior#redact_value_components_field_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#tokenize_entire_value_field LogFieldBehavior#tokenize_entire_value_field}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#tokenize_entire_value_field_name LogFieldBehavior#tokenize_entire_value_field_name}
  */
  readonly tokenizeEntireValueFieldName?: string[];
  /**
  * The log fields whose values will include tokenized components.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#tokenize_value_components_field LogFieldBehavior#tokenize_value_components_field}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#tokenize_value_components_field_name LogFieldBehavior#tokenize_value_components_field_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#type LogFieldBehavior#type}
  */
  readonly type: string;
}
export interface LogFieldBehaviorRequiredActions {
}

export function logFieldBehaviorRequiredActionsToTerraform(struct?: LogFieldBehaviorRequiredActions): any {
...
export function logFieldBehaviorRequiredActionsToHclTerraform(struct?: LogFieldBehaviorRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class LogFieldBehaviorRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): LogFieldBehaviorRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: LogFieldBehaviorRequiredActions | undefined) {
    if (value === undefined) {
...
export class LogFieldBehaviorRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): LogFieldBehaviorRequiredActionsOutputReference {
    return new LogFieldBehaviorRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior pingdirectory_log_field_behavior}
*/
export class LogFieldBehavior extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a LogFieldBehavior resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the LogFieldBehavior to import
  * @param importFromId The id of the existing LogFieldBehavior that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the LogFieldBehavior to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/log_field_behavior pingdirectory_log_field_behavior} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options LogFieldBehaviorConfig
  */
  public constructor(scope: Construct, id: string, config: LogFieldBehaviorConfig) {
    super(scope, id, {
  ...
  private _requiredActions = new LogFieldBehaviorRequiredActionsList(this, "required_actions", true);
