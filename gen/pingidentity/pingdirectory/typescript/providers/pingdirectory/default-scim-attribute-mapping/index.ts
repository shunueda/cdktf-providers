// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_scim_attribute_mapping
...
export interface DefaultScimAttributeMappingConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_scim_attribute_mapping#authoritative DefaultScimAttributeMapping#authoritative}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_scim_attribute_mapping#correlated_ldap_data_view DefaultScimAttributeMapping#correlated_ldap_data_view}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_scim_attribute_mapping#ldap_attribute DefaultScimAttributeMapping#ldap_attribute}
  */
  readonly ldapAttribute?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_scim_attribute_mapping#name DefaultScimAttributeMapping#name}
  */
  readonly name: string;
  /**
  * Specifies whether the mapping is used to map from LDAP attribute to SCIM Resource Type attribute in a read operation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_scim_attribute_mapping#readable DefaultScimAttributeMapping#readable}
  */
  readonly readable?: boolean | cdktf.IResolvable;
  /**
  * The attribute path of SCIM Resource Type attributes to be mapped.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_scim_attribute_mapping#scim_resource_type_attribute DefaultScimAttributeMapping#scim_resource_type_attribute}
  */
  readonly scimResourceTypeAttribute?: string;
  /**
  * Name of the parent SCIM Resource Type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_scim_attribute_mapping#scim_resource_type_name DefaultScimAttributeMapping#scim_resource_type_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_scim_attribute_mapping#searchable DefaultScimAttributeMapping#searchable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_scim_attribute_mapping#writable DefaultScimAttributeMapping#writable}
  */
  readonly writable?: boolean | cdktf.IResolvable;
}
export interface DefaultScimAttributeMappingRequiredActions {
}

export function defaultScimAttributeMappingRequiredActionsToTerraform(struct?: DefaultScimAttributeMappingRequiredActions): any {
...
export function defaultScimAttributeMappingRequiredActionsToHclTerraform(struct?: DefaultScimAttributeMappingRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DefaultScimAttributeMappingRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DefaultScimAttributeMappingRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DefaultScimAttributeMappingRequiredActions | undefined) {
    if (value === undefined) {
...
export class DefaultScimAttributeMappingRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DefaultScimAttributeMappingRequiredActionsOutputReference {
    return new DefaultScimAttributeMappingRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_scim_attribute_mapping pingdirectory_default_scim_attribute_mapping}
*/
export class DefaultScimAttributeMapping extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingdirectory_default_scim_attribute_mapping";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DefaultScimAttributeMapping resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DefaultScimAttributeMapping to import
  * @param importFromId The id of the existing DefaultScimAttributeMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_scim_attribute_mapping#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DefaultScimAttributeMapping to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingdirectory_default_scim_attribute_mapping", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_scim_attribute_mapping pingdirectory_default_scim_attribute_mapping} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DefaultScimAttributeMappingConfig
  */
  public constructor(scope: Construct, id: string, config: DefaultScimAttributeMappingConfig) {
    super(scope, id, {
      terraformResourceType: 'pingdirectory_default_scim_attribute_mapping',
  ...
  // correlated_ldap_data_view - computed: true, optional: true, required: false
  ...
  // ldap_attribute - computed: true, optional: true, required: false
  ...
  public resetLdapAttribute() {
    this._ldapAttribute = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  private _requiredActions = new DefaultScimAttributeMappingRequiredActionsList(this, "required_actions", true);
  public get requiredActions() {
    return this._requiredActions;
  }

  // scim_resource_type_attribute - computed: true, optional: true, required: false
  ...
  public resetScimResourceTypeAttribute() {
    this._scimResourceTypeAttribute = undefined;
  }
  // Temporarily expose input value. Use with caution.
