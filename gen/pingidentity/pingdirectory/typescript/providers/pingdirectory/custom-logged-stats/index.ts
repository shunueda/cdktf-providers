// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats
...
export interface CustomLoggedStatsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specifies the attributes on the monitor entries that should be included in the output.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#attribute_to_log CustomLoggedStats#attribute_to_log}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#column_name CustomLoggedStats#column_name}
  */
  readonly columnName?: string[];
  /**
  * This provides a way to format the monitored attribute value in the output to control the precision for instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#decimal_format CustomLoggedStats#decimal_format}
  */
  readonly decimalFormat?: string;
  /**
  * A description for this Custom Logged Stats
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#description CustomLoggedStats#description}
  */
  readonly description?: string;
  /**
  * An optional floating point value that can be used to scale the resulting value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#divide_value_by CustomLoggedStats#divide_value_by}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#divide_value_by_attribute CustomLoggedStats#divide_value_by_attribute}
  */
  readonly divideValueByAttribute?: string;
  /**
  * Indicates whether the Custom Logged Stats object is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#enabled CustomLoggedStats#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * An optional prefix that is included in the header before the column name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#header_prefix CustomLoggedStats#header_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#header_prefix_attribute CustomLoggedStats#header_prefix_attribute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#include_filter CustomLoggedStats#include_filter}
  */
  readonly includeFilter?: string;
  /**
  * The objectclass name of the monitor entries to examine for generating these statistics.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#monitor_objectclass CustomLoggedStats#monitor_objectclass}
  */
  readonly monitorObjectclass: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#name CustomLoggedStats#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#non_zero_implies_not_idle CustomLoggedStats#non_zero_implies_not_idle}
  */
  readonly nonZeroImpliesNotIdle?: boolean | cdktf.IResolvable;
  /**
  * Name of the parent Plugin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#plugin_name CustomLoggedStats#plugin_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#regex_pattern CustomLoggedStats#regex_pattern}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#regex_replacement CustomLoggedStats#regex_replacement}
  */
  readonly regexReplacement?: string;
  /**
  * Specifies the type of statistic to include in the output for each monitored attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#statistic_type CustomLoggedStats#statistic_type}
  */
  readonly statisticType: string[];
  /**
  * The type of Custom Logged Stats resource. Options are ['custom-logged-stats']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#type CustomLoggedStats#type}
  */
  readonly type?: string;
}
export interface CustomLoggedStatsRequiredActions {
}

export function customLoggedStatsRequiredActionsToTerraform(struct?: CustomLoggedStatsRequiredActions): any {
...
export function customLoggedStatsRequiredActionsToHclTerraform(struct?: CustomLoggedStatsRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CustomLoggedStatsRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CustomLoggedStatsRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: CustomLoggedStatsRequiredActions | undefined) {
    if (value === undefined) {
...
export class CustomLoggedStatsRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): CustomLoggedStatsRequiredActionsOutputReference {
    return new CustomLoggedStatsRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats pingdirectory_custom_logged_stats}
*/
export class CustomLoggedStats extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a CustomLoggedStats resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the CustomLoggedStats to import
  * @param importFromId The id of the existing CustomLoggedStats that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the CustomLoggedStats to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/custom_logged_stats pingdirectory_custom_logged_stats} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options CustomLoggedStatsConfig
  */
  public constructor(scope: Construct, id: string, config: CustomLoggedStatsConfig) {
    super(scope, id, {
  ...
  // attribute_to_log - computed: false, optional: false, required: true
  ...
  // header_prefix_attribute - computed: false, optional: true, required: false
  ...
  // regex_replacement - computed: false, optional: true, required: false
  ...
  private _requiredActions = new CustomLoggedStatsRequiredActionsList(this, "required_actions", true);
  public get requiredActions() {
    return this._requiredActions;
  }

  // statistic_type - computed: false, optional: false, required: true
