// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor
...
export interface DefaultDataSecurityAuditorConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#account_expiration_warning_interval DefaultDataSecurityAuditor#account_expiration_warning_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#audit_backend DefaultDataSecurityAuditor#audit_backend}
  */
  readonly auditBackend?: string[];
  /**
  * Specifies the severity of events to include in the report.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#audit_severity DefaultDataSecurityAuditor#audit_severity}
  */
  readonly auditSeverity?: string;
  /**
  * Indicates whether the Data Security Auditor is enabled for use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#enabled DefaultDataSecurityAuditor#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#extension_argument DefaultDataSecurityAuditor#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#extension_class DefaultDataSecurityAuditor#extension_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#filter DefaultDataSecurityAuditor#filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#idle_account_error_interval DefaultDataSecurityAuditor#idle_account_error_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#idle_account_warning_interval DefaultDataSecurityAuditor#idle_account_warning_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#include_attribute DefaultDataSecurityAuditor#include_attribute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#include_privilege DefaultDataSecurityAuditor#include_privilege}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#maximum_idle_time DefaultDataSecurityAuditor#maximum_idle_time}
  */
  readonly maximumIdleTime?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#name DefaultDataSecurityAuditor#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#never_logged_in_account_error_interval DefaultDataSecurityAuditor#never_logged_in_account_error_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#never_logged_in_account_warning_interval DefaultDataSecurityAuditor#never_logged_in_account_warning_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#password_evaluation_age DefaultDataSecurityAuditor#password_evaluation_age}
  */
  readonly passwordEvaluationAge?: string;
  /**
  * Specifies the name of the detailed report file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#report_file DefaultDataSecurityAuditor#report_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#weak_crypt_encoding DefaultDataSecurityAuditor#weak_crypt_encoding}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#weak_password_storage_scheme DefaultDataSecurityAuditor#weak_password_storage_scheme}
  */
  readonly weakPasswordStorageScheme?: string[];
}
export interface DefaultDataSecurityAuditorRequiredActions {
}

export function defaultDataSecurityAuditorRequiredActionsToTerraform(struct?: DefaultDataSecurityAuditorRequiredActions): any {
...
export function defaultDataSecurityAuditorRequiredActionsToHclTerraform(struct?: DefaultDataSecurityAuditorRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DefaultDataSecurityAuditorRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DefaultDataSecurityAuditorRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DefaultDataSecurityAuditorRequiredActions | undefined) {
    if (value === undefined) {
...
export class DefaultDataSecurityAuditorRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DefaultDataSecurityAuditorRequiredActionsOutputReference {
    return new DefaultDataSecurityAuditorRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor pingdirectory_default_data_security_auditor}
*/
export class DefaultDataSecurityAuditor extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingdirectory_default_data_security_auditor";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DefaultDataSecurityAuditor resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DefaultDataSecurityAuditor to import
  * @param importFromId The id of the existing DefaultDataSecurityAuditor that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DefaultDataSecurityAuditor to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingdirectory_default_data_security_auditor", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_data_security_auditor pingdirectory_default_data_security_auditor} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DefaultDataSecurityAuditorConfig
  */
  public constructor(scope: Construct, id: string, config: DefaultDataSecurityAuditorConfig) {
    super(scope, id, {
      terraformResourceType: 'pingdirectory_default_data_security_auditor',
  ...
  // account_expiration_warning_interval - computed: true, optional: true, required: false
  ...
  // idle_account_error_interval - computed: true, optional: true, required: false
  ...
  // idle_account_warning_interval - computed: true, optional: true, required: false
  ...
  // maximum_idle_time - computed: true, optional: true, required: false
  ...
  // never_logged_in_account_error_interval - computed: true, optional: true, required: false
  ...
  // never_logged_in_account_warning_interval - computed: true, optional: true, required: false
  ...
  // password_evaluation_age - computed: true, optional: true, required: false
  ...
  private _requiredActions = new DefaultDataSecurityAuditorRequiredActionsList(this, "required_actions", true);
