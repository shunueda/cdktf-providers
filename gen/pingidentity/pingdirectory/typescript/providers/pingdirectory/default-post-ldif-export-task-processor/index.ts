// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor
...
export interface DefaultPostLdifExportTaskProcessorConfig extends cdktf.TerraformMetaArguments {
  /**
  * The external server with information to use when interacting with the AWS S3 service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor#aws_external_server DefaultPostLdifExportTaskProcessor#aws_external_server}
  */
  readonly awsExternalServer?: string;
  /**
  * A description for this Post LDIF Export Task Processor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor#description DefaultPostLdifExportTaskProcessor#description}
  */
  readonly description?: string;
  /**
  * Indicates whether the Post LDIF Export Task Processor is enabled for use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor#enabled DefaultPostLdifExportTaskProcessor#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor#extension_argument DefaultPostLdifExportTaskProcessor#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor#extension_class DefaultPostLdifExportTaskProcessor#extension_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor#file_retention_pattern DefaultPostLdifExportTaskProcessor#file_retention_pattern}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor#maximum_concurrent_transfer_connections DefaultPostLdifExportTaskProcessor#maximum_concurrent_transfer_connections}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor#maximum_file_age_to_retain DefaultPostLdifExportTaskProcessor#maximum_file_age_to_retain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor#maximum_file_count_to_retain DefaultPostLdifExportTaskProcessor#maximum_file_count_to_retain}
  */
  readonly maximumFileCountToRetain?: number;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor#name DefaultPostLdifExportTaskProcessor#name}
  */
  readonly name: string;
  /**
  * The name of the S3 bucket into which LDIF files should be copied.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor#s3_bucket_name DefaultPostLdifExportTaskProcessor#s3_bucket_name}
  */
  readonly s3BucketName?: string;
  /**
  * The target throughput to attempt to achieve for data transfers to or from S3, in megabits per second.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor#target_throughput_in_megabits_per_second DefaultPostLdifExportTaskProcessor#target_throughput_in_megabits_per_second}
  */
  readonly targetThroughputInMegabitsPerSecond?: number;
}
export interface DefaultPostLdifExportTaskProcessorRequiredActions {
}

export function defaultPostLdifExportTaskProcessorRequiredActionsToTerraform(struct?: DefaultPostLdifExportTaskProcessorRequiredActions): any {
...
export function defaultPostLdifExportTaskProcessorRequiredActionsToHclTerraform(struct?: DefaultPostLdifExportTaskProcessorRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DefaultPostLdifExportTaskProcessorRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DefaultPostLdifExportTaskProcessorRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DefaultPostLdifExportTaskProcessorRequiredActions | undefined) {
    if (value === undefined) {
...
export class DefaultPostLdifExportTaskProcessorRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DefaultPostLdifExportTaskProcessorRequiredActionsOutputReference {
    return new DefaultPostLdifExportTaskProcessorRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor pingdirectory_default_post_ldif_export_task_processor}
*/
export class DefaultPostLdifExportTaskProcessor extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingdirectory_default_post_ldif_export_task_processor";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DefaultPostLdifExportTaskProcessor resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DefaultPostLdifExportTaskProcessor to import
  * @param importFromId The id of the existing DefaultPostLdifExportTaskProcessor that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DefaultPostLdifExportTaskProcessor to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingdirectory_default_post_ldif_export_task_processor", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_post_ldif_export_task_processor pingdirectory_default_post_ldif_export_task_processor} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DefaultPostLdifExportTaskProcessorConfig
  */
  public constructor(scope: Construct, id: string, config: DefaultPostLdifExportTaskProcessorConfig) {
    super(scope, id, {
      terraformResourceType: 'pingdirectory_default_post_ldif_export_task_processor',
  ...
  private _requiredActions = new DefaultPostLdifExportTaskProcessorRequiredActionsList(this, "required_actions", true);
