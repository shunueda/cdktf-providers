// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index
...
export interface DefaultLocalDbIndexConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specifies the name of the attribute for which the index is to be maintained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index#attribute DefaultLocalDbIndex#attribute}
  */
  readonly attribute: string;
  /**
  * Name of the parent Backend
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index#backend_name DefaultLocalDbIndex#backend_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index#cache_mode DefaultLocalDbIndex#cache_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index#equality_index_filter DefaultLocalDbIndex#equality_index_filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index#index_entry_limit DefaultLocalDbIndex#index_entry_limit}
  */
  readonly indexEntryLimit?: number;
  /**
  * Specifies the type(s) of indexing that should be performed for the associated attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index#index_type DefaultLocalDbIndex#index_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index#maintain_equality_index_without_filter DefaultLocalDbIndex#maintain_equality_index_without_filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index#maintain_match_count_for_keys_exceeding_entry_limit DefaultLocalDbIndex#maintain_match_count_for_keys_exceeding_entry_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index#prime_index DefaultLocalDbIndex#prime_index}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index#prime_internal_nodes_only DefaultLocalDbIndex#prime_internal_nodes_only}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index#substring_index_entry_limit DefaultLocalDbIndex#substring_index_entry_limit}
  */
  readonly substringIndexEntryLimit?: number;
  /**
  * The length of substrings in a substring index.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index#substring_length DefaultLocalDbIndex#substring_length}
  */
  readonly substringLength?: number;
}
export interface DefaultLocalDbIndexRequiredActions {
}

export function defaultLocalDbIndexRequiredActionsToTerraform(struct?: DefaultLocalDbIndexRequiredActions): any {
...
export function defaultLocalDbIndexRequiredActionsToHclTerraform(struct?: DefaultLocalDbIndexRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DefaultLocalDbIndexRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DefaultLocalDbIndexRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DefaultLocalDbIndexRequiredActions | undefined) {
    if (value === undefined) {
...
export class DefaultLocalDbIndexRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DefaultLocalDbIndexRequiredActionsOutputReference {
    return new DefaultLocalDbIndexRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index pingdirectory_default_local_db_index}
*/
export class DefaultLocalDbIndex extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingdirectory_default_local_db_index";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DefaultLocalDbIndex resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DefaultLocalDbIndex to import
  * @param importFromId The id of the existing DefaultLocalDbIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DefaultLocalDbIndex to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingdirectory_default_local_db_index", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_local_db_index pingdirectory_default_local_db_index} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DefaultLocalDbIndexConfig
  */
  public constructor(scope: Construct, id: string, config: DefaultLocalDbIndexConfig) {
    super(scope, id, {
      terraformResourceType: 'pingdirectory_default_local_db_index',
  ...
  // index_type - computed: true, optional: true, required: false
  ...
  private _requiredActions = new DefaultLocalDbIndexRequiredActionsList(this, "required_actions", true);
  public get requiredActions() {
    return this._requiredActions;
  }

  // substring_index_entry_limit - computed: true, optional: true, required: false
