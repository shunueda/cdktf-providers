// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider
...
export interface TrustManagerProviderConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider#enable_trust_manager_caching TrustManagerProvider#enable_trust_manager_caching}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider#enabled TrustManagerProvider#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider#extension_argument TrustManagerProvider#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider#extension_class TrustManagerProvider#extension_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider#include_jvm_default_issuers TrustManagerProvider#include_jvm_default_issuers}
  */
  readonly includeJvmDefaultIssuers?: boolean | cdktf.IResolvable;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider#name TrustManagerProvider#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider#trust_store_file TrustManagerProvider#trust_store_file}
  */
  readonly trustStoreFile?: string;
  /**
  * Specifies the clear-text PIN needed to access the File Based Trust Manager Provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider#trust_store_pin TrustManagerProvider#trust_store_pin}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider#trust_store_pin_file TrustManagerProvider#trust_store_pin_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider#trust_store_pin_passphrase_provider TrustManagerProvider#trust_store_pin_passphrase_provider}
  */
  readonly trustStorePinPassphraseProvider?: string;
  /**
  * Specifies the format for the data in the trust store file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider#trust_store_type TrustManagerProvider#trust_store_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider#type TrustManagerProvider#type}
  */
  readonly type: string;
}
export interface TrustManagerProviderRequiredActions {
}

export function trustManagerProviderRequiredActionsToTerraform(struct?: TrustManagerProviderRequiredActions): any {
...
export function trustManagerProviderRequiredActionsToHclTerraform(struct?: TrustManagerProviderRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class TrustManagerProviderRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): TrustManagerProviderRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: TrustManagerProviderRequiredActions | undefined) {
    if (value === undefined) {
...
export class TrustManagerProviderRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): TrustManagerProviderRequiredActionsOutputReference {
    return new TrustManagerProviderRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider pingdirectory_trust_manager_provider}
*/
export class TrustManagerProvider extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a TrustManagerProvider resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TrustManagerProvider to import
  * @param importFromId The id of the existing TrustManagerProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TrustManagerProvider to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/trust_manager_provider pingdirectory_trust_manager_provider} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options TrustManagerProviderConfig
  */
  public constructor(scope: Construct, id: string, config: TrustManagerProviderConfig) {
    super(scope, id, {
  ...
  private _requiredActions = new TrustManagerProviderRequiredActionsList(this, "required_actions", true);
  ...
  // trust_store_pin_file - computed: false, optional: true, required: false
  ...
  // trust_store_pin_passphrase_provider - computed: false, optional: true, required: false
