// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider
...
export interface DefaultVelocityContextProviderConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#application_tool DefaultVelocityContextProvider#application_tool}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#enabled DefaultVelocityContextProvider#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The name of a view for which this Velocity Context Provider will not contribute content.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#excluded_view DefaultVelocityContextProvider#excluded_view}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#extension_argument DefaultVelocityContextProvider#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#extension_class DefaultVelocityContextProvider#extension_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#http_method DefaultVelocityContextProvider#http_method}
  */
  readonly httpMethod?: string[];
  /**
  * Name of the parent HTTP Servlet Extension
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#http_servlet_extension_name DefaultVelocityContextProvider#http_servlet_extension_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#included_view DefaultVelocityContextProvider#included_view}
  */
  readonly includedView?: string[];
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#name DefaultVelocityContextProvider#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#object_scope DefaultVelocityContextProvider#object_scope}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#request_tool DefaultVelocityContextProvider#request_tool}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#response_header DefaultVelocityContextProvider#response_header}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#session_tool DefaultVelocityContextProvider#session_tool}
  */
  readonly sessionTool?: string[];
}
export interface DefaultVelocityContextProviderRequiredActions {
}

export function defaultVelocityContextProviderRequiredActionsToTerraform(struct?: DefaultVelocityContextProviderRequiredActions): any {
...
export function defaultVelocityContextProviderRequiredActionsToHclTerraform(struct?: DefaultVelocityContextProviderRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DefaultVelocityContextProviderRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DefaultVelocityContextProviderRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DefaultVelocityContextProviderRequiredActions | undefined) {
    if (value === undefined) {
...
export class DefaultVelocityContextProviderRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DefaultVelocityContextProviderRequiredActionsOutputReference {
    return new DefaultVelocityContextProviderRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider pingdirectory_default_velocity_context_provider}
*/
export class DefaultVelocityContextProvider extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingdirectory_default_velocity_context_provider";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DefaultVelocityContextProvider resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DefaultVelocityContextProvider to import
  * @param importFromId The id of the existing DefaultVelocityContextProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DefaultVelocityContextProvider to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingdirectory_default_velocity_context_provider", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_velocity_context_provider pingdirectory_default_velocity_context_provider} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DefaultVelocityContextProviderConfig
  */
  public constructor(scope: Construct, id: string, config: DefaultVelocityContextProviderConfig) {
    super(scope, id, {
      terraformResourceType: 'pingdirectory_default_velocity_context_provider',
  ...
  private _requiredActions = new DefaultVelocityContextProviderRequiredActionsList(this, "required_actions", true);
