// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/result_code_map
...
export interface ResultCodeMapConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/result_code_map#bind_account_locked_result_code ResultCodeMap#bind_account_locked_result_code}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/result_code_map#bind_missing_password_result_code ResultCodeMap#bind_missing_password_result_code}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/result_code_map#bind_missing_user_result_code ResultCodeMap#bind_missing_user_result_code}
  */
  readonly bindMissingUserResultCode?: number;
  /**
  * A description for this Result Code Map
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/result_code_map#description ResultCodeMap#description}
  */
  readonly description?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/result_code_map#name ResultCodeMap#name}
  */
  readonly name: string;
  /**
  * Specifies the result code that should be returned if a generic error occurs within the server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/result_code_map#server_error_result_code ResultCodeMap#server_error_result_code}
  */
  readonly serverErrorResultCode?: number;
  /**
  * The type of Result Code Map resource. Options are ['result-code-map']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/result_code_map#type ResultCodeMap#type}
  */
  readonly type?: string;
}
export interface ResultCodeMapRequiredActions {
}

export function resultCodeMapRequiredActionsToTerraform(struct?: ResultCodeMapRequiredActions): any {
...
export function resultCodeMapRequiredActionsToHclTerraform(struct?: ResultCodeMapRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ResultCodeMapRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ResultCodeMapRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ResultCodeMapRequiredActions | undefined) {
    if (value === undefined) {
...
export class ResultCodeMapRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): ResultCodeMapRequiredActionsOutputReference {
    return new ResultCodeMapRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/result_code_map pingdirectory_result_code_map}
*/
export class ResultCodeMap extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a ResultCodeMap resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ResultCodeMap to import
  * @param importFromId The id of the existing ResultCodeMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/result_code_map#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ResultCodeMap to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/result_code_map pingdirectory_result_code_map} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ResultCodeMapConfig
  */
  public constructor(scope: Construct, id: string, config: ResultCodeMapConfig) {
    super(scope, id, {
  ...
  private _requiredActions = new ResultCodeMapRequiredActionsList(this, "required_actions", true);
