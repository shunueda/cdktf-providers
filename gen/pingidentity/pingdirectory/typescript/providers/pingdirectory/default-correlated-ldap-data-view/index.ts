// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view
...
export interface DefaultCorrelatedLdapDataViewConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specifies an auxiliary LDAP object class that should be exposed by this Correlated LDAP Data View.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view#auxiliary_ldap_objectclass DefaultCorrelatedLdapDataView#auxiliary_ldap_objectclass}
  */
  readonly auxiliaryLdapObjectclass?: string[];
  /**
  * Specifies the template to use for the DN when creating new entries.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view#create_dn_pattern DefaultCorrelatedLdapDataView#create_dn_pattern}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view#include_base_dn DefaultCorrelatedLdapDataView#include_base_dn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view#include_filter DefaultCorrelatedLdapDataView#include_filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view#include_operational_attribute DefaultCorrelatedLdapDataView#include_operational_attribute}
  */
  readonly includeOperationalAttribute?: string[];
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view#name DefaultCorrelatedLdapDataView#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view#primary_correlation_attribute DefaultCorrelatedLdapDataView#primary_correlation_attribute}
  */
  readonly primaryCorrelationAttribute?: string;
  /**
  * Name of the parent SCIM Resource Type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view#scim_resource_type_name DefaultCorrelatedLdapDataView#scim_resource_type_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view#secondary_correlation_attribute DefaultCorrelatedLdapDataView#secondary_correlation_attribute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view#structural_ldap_objectclass DefaultCorrelatedLdapDataView#structural_ldap_objectclass}
  */
  readonly structuralLdapObjectclass?: string;
}
export interface DefaultCorrelatedLdapDataViewRequiredActions {
}

export function defaultCorrelatedLdapDataViewRequiredActionsToTerraform(struct?: DefaultCorrelatedLdapDataViewRequiredActions): any {
...
export function defaultCorrelatedLdapDataViewRequiredActionsToHclTerraform(struct?: DefaultCorrelatedLdapDataViewRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DefaultCorrelatedLdapDataViewRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DefaultCorrelatedLdapDataViewRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DefaultCorrelatedLdapDataViewRequiredActions | undefined) {
    if (value === undefined) {
...
export class DefaultCorrelatedLdapDataViewRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DefaultCorrelatedLdapDataViewRequiredActionsOutputReference {
    return new DefaultCorrelatedLdapDataViewRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view pingdirectory_default_correlated_ldap_data_view}
*/
export class DefaultCorrelatedLdapDataView extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingdirectory_default_correlated_ldap_data_view";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DefaultCorrelatedLdapDataView resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DefaultCorrelatedLdapDataView to import
  * @param importFromId The id of the existing DefaultCorrelatedLdapDataView that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DefaultCorrelatedLdapDataView to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingdirectory_default_correlated_ldap_data_view", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/default_correlated_ldap_data_view pingdirectory_default_correlated_ldap_data_view} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DefaultCorrelatedLdapDataViewConfig
  */
  public constructor(scope: Construct, id: string, config: DefaultCorrelatedLdapDataViewConfig) {
    super(scope, id, {
      terraformResourceType: 'pingdirectory_default_correlated_ldap_data_view',
  ...
  private _requiredActions = new DefaultCorrelatedLdapDataViewRequiredActionsList(this, "required_actions", true);
