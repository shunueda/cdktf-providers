// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type
...
export interface ScimResourceTypeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specifies an auxiliary LDAP object class that should be exposed by this SCIM Resource Type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#auxiliary_ldap_objectclass ScimResourceType#auxiliary_ldap_objectclass}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#core_schema ScimResourceType#core_schema}
  */
  readonly coreSchema?: string;
  /**
  * Specifies the template to use for the DN when creating new entries.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#create_dn_pattern ScimResourceType#create_dn_pattern}
  */
  readonly createDnPattern?: string;
  /**
  * A description for this SCIM Resource Type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#description ScimResourceType#description}
  */
  readonly description?: string;
  /**
  * Indicates whether the SCIM Resource Type is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#enabled ScimResourceType#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#endpoint ScimResourceType#endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#id_attribute ScimResourceType#id_attribute}
  */
  readonly idAttribute?: string;
  /**
  * Specifies the base DN of the branch of the LDAP directory that can be accessed by this SCIM Resource Type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#include_base_dn ScimResourceType#include_base_dn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#include_filter ScimResourceType#include_filter}
  */
  readonly includeFilter?: string[];
  /**
  * Specifies the set of operational LDAP attributes to be provided by this SCIM Resource Type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#include_operational_attribute ScimResourceType#include_operational_attribute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#lookthrough_limit ScimResourceType#lookthrough_limit}
  */
  readonly lookthroughLimit?: number;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#name ScimResourceType#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#optional_schema_extension ScimResourceType#optional_schema_extension}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#required_schema_extension ScimResourceType#required_schema_extension}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#schema_checking_option ScimResourceType#schema_checking_option}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#structural_ldap_objectclass ScimResourceType#structural_ldap_objectclass}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#type ScimResourceType#type}
  */
  readonly type: string;
}
export interface ScimResourceTypeRequiredActions {
}

export function scimResourceTypeRequiredActionsToTerraform(struct?: ScimResourceTypeRequiredActions): any {
...
export function scimResourceTypeRequiredActionsToHclTerraform(struct?: ScimResourceTypeRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ScimResourceTypeRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ScimResourceTypeRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ScimResourceTypeRequiredActions | undefined) {
    if (value === undefined) {
...
export class ScimResourceTypeRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): ScimResourceTypeRequiredActionsOutputReference {
    return new ScimResourceTypeRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type pingdirectory_scim_resource_type}
*/
export class ScimResourceType extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a ScimResourceType resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ScimResourceType to import
  * @param importFromId The id of the existing ScimResourceType that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ScimResourceType to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/scim_resource_type pingdirectory_scim_resource_type} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ScimResourceTypeConfig
  */
  public constructor(scope: Construct, id: string, config: ScimResourceTypeConfig) {
    super(scope, id, {
  ...
  // core_schema - computed: false, optional: true, required: false
  ...
  // include_base_dn - computed: false, optional: true, required: false
  ...
  private _requiredActions = new ScimResourceTypeRequiredActionsList(this, "required_actions", true);
  ...
  // structural_ldap_objectclass - computed: false, optional: true, required: false
