// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/data-sources/root_dn_user
...
export interface DataPingdirectoryRootDnUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/data-sources/root_dn_user#name DataPingdirectoryRootDnUser#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/data-sources/root_dn_user pingdirectory_root_dn_user}
*/
export class DataPingdirectoryRootDnUser extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataPingdirectoryRootDnUser resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataPingdirectoryRootDnUser to import
  * @param importFromId The id of the existing DataPingdirectoryRootDnUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/data-sources/root_dn_user#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataPingdirectoryRootDnUser to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/data-sources/root_dn_user pingdirectory_root_dn_user} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataPingdirectoryRootDnUserConfig
  */
  public constructor(scope: Construct, id: string, config: DataPingdirectoryRootDnUserConfig) {
    super(scope, id, {
