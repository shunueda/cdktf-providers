// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler
...
export interface AlertHandlerConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#asynchronous AlertHandler#asynchronous}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#command AlertHandler#command}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#command_timeout AlertHandler#command_timeout}
  */
  readonly commandTimeout?: string;
  /**
  * Specifies the name of the community to which the traps will be sent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#community_name AlertHandler#community_name}
  */
  readonly communityName?: string;
  /**
  * A description for this Alert Handler
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#description AlertHandler#description}
  */
  readonly description?: string;
  /**
  * Specifies the names of the alert types that are disabled for this alert handler.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#disabled_alert_type AlertHandler#disabled_alert_type}
  */
  readonly disabledAlertType?: string[];
  /**
  * Indicates whether the Alert Handler is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#enabled AlertHandler#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#enabled_alert_severity AlertHandler#enabled_alert_severity}
  */
  readonly enabledAlertSeverity?: string[];
  /**
  * Specifies the names of the alert types that are enabled for this alert handler.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#enabled_alert_type AlertHandler#enabled_alert_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#extension_argument AlertHandler#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#extension_class AlertHandler#extension_class}
  */
  readonly extensionClass?: string;
  /**
  * A reference to an HTTP proxy server that should be used for requests sent to the Twilio service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#http_proxy_external_server AlertHandler#http_proxy_external_server}
  */
  readonly httpProxyExternalServer?: string;
  /**
  * Include monitor entries that match this filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#include_monitor_data_filter AlertHandler#include_monitor_data_filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#long_message_behavior AlertHandler#long_message_behavior}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#message_body AlertHandler#message_body}
  */
  readonly messageBody?: string;
  /**
  * Specifies the subject that should be used for email messages generated by this alert handler.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#message_subject AlertHandler#message_subject}
  */
  readonly messageSubject?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#name AlertHandler#name}
  */
  readonly name: string;
  /**
  * Specifies an email address to which the messages should be sent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#recipient_address AlertHandler#recipient_address}
  */
  readonly recipientAddress?: string[];
  /**
  * The phone number to which alert notifications should be delivered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#recipient_phone_number AlertHandler#recipient_phone_number}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#script_argument AlertHandler#script_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#script_class AlertHandler#script_class}
  */
  readonly scriptClass?: string;
  /**
  * Specifies the email address to use as the sender for messages generated by this alert handler.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#sender_address AlertHandler#sender_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#sender_phone_number AlertHandler#sender_phone_number}
  */
  readonly senderPhoneNumber?: string[];
  /**
  * Specifies the address of the SNMP agent to which traps will be sent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#server_host_name AlertHandler#server_host_name}
  */
  readonly serverHostName?: string;
  /**
  * Specifies the port number of the SNMP agent to which traps will be sent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#server_port AlertHandler#server_port}
  */
  readonly serverPort?: number;
  /**
  * The unique identifier assigned to the Twilio account that will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#twilio_account_sid AlertHandler#twilio_account_sid}
  */
  readonly twilioAccountSid?: string;
  /**
  * The auth token for the Twilio account that will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#twilio_auth_token AlertHandler#twilio_auth_token}
  */
  readonly twilioAuthToken?: string;
  /**
  * The passphrase provider that may be used to obtain the auth token for the Twilio account that will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#twilio_auth_token_passphrase_provider AlertHandler#twilio_auth_token_passphrase_provider}
  */
  readonly twilioAuthTokenPassphraseProvider?: string;
  /**
  * The type of Alert Handler resource. Options are ['output', 'smtp', 'jmx', 'groovy-scripted', 'custom', 'snmp', 'twilio', 'error-log', 'snmp-sub-agent', 'exec', 'third-party']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#type AlertHandler#type}
  */
  readonly type: string;
}
export interface AlertHandlerRequiredActions {
}

export function alertHandlerRequiredActionsToTerraform(struct?: AlertHandlerRequiredActions): any {
...
export function alertHandlerRequiredActionsToHclTerraform(struct?: AlertHandlerRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AlertHandlerRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AlertHandlerRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: AlertHandlerRequiredActions | undefined) {
    if (value === undefined) {
...
export class AlertHandlerRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): AlertHandlerRequiredActionsOutputReference {
    return new AlertHandlerRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler pingdirectory_alert_handler}
*/
export class AlertHandler extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a AlertHandler resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AlertHandler to import
  * @param importFromId The id of the existing AlertHandler that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AlertHandler to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/alert_handler pingdirectory_alert_handler} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AlertHandlerConfig
  */
  public constructor(scope: Construct, id: string, config: AlertHandlerConfig) {
    super(scope, id, {
  ...
  // include_monitor_data_filter - computed: false, optional: true, required: false
  ...
  private _requiredActions = new AlertHandlerRequiredActionsList(this, "required_actions", true);
