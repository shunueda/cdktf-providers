// https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper
...
export interface IdentityMapperConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#all_included_identity_mapper IdentityMapper#all_included_identity_mapper}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#any_included_identity_mapper IdentityMapper#any_included_identity_mapper}
  */
  readonly anyIncludedIdentityMapper?: string[];
  /**
  * A description for this Identity Mapper
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#description IdentityMapper#description}
  */
  readonly description?: string;
  /**
  * Indicates whether the Identity Mapper is enabled for use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#enabled IdentityMapper#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#extension_argument IdentityMapper#extension_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#extension_class IdentityMapper#extension_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#match_attribute IdentityMapper#match_attribute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#match_base_dn IdentityMapper#match_base_dn}
  */
  readonly matchBaseDn?: string[];
  /**
  * An optional filter that mapped users must match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#match_filter IdentityMapper#match_filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#match_pattern IdentityMapper#match_pattern}
  */
  readonly matchPattern?: string;
  /**
  * Name of this config object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#name IdentityMapper#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#replace_pattern IdentityMapper#replace_pattern}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#script_argument IdentityMapper#script_argument}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#script_class IdentityMapper#script_class}
  */
  readonly scriptClass?: string;
  /**
  * The type of Identity Mapper resource. Options are ['exact-match', 'groovy-scripted', 'dn', 'regular-expression', 'aggregate', 'third-party']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#type IdentityMapper#type}
  */
  readonly type: string;
}
export interface IdentityMapperRequiredActions {
}

export function identityMapperRequiredActionsToTerraform(struct?: IdentityMapperRequiredActions): any {
...
export function identityMapperRequiredActionsToHclTerraform(struct?: IdentityMapperRequiredActions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IdentityMapperRequiredActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IdentityMapperRequiredActions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: IdentityMapperRequiredActions | undefined) {
    if (value === undefined) {
...
export class IdentityMapperRequiredActionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): IdentityMapperRequiredActionsOutputReference {
    return new IdentityMapperRequiredActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper pingdirectory_identity_mapper}
*/
export class IdentityMapper extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a IdentityMapper resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the IdentityMapper to import
  * @param importFromId The id of the existing IdentityMapper that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IdentityMapper to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingdirectory/1.5.0/docs/resources/identity_mapper pingdirectory_identity_mapper} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IdentityMapperConfig
  */
  public constructor(scope: Construct, id: string, config: IdentityMapperConfig) {
    super(scope, id, {
  ...
  // match_filter - computed: false, optional: true, required: false
  ...
  // replace_pattern - computed: false, optional: true, required: false
  ...
  private _requiredActions = new IdentityMapperRequiredActionsList(this, "required_actions", true);
