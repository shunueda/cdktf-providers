// https://registry.terraform.io/providers/pingidentity/davinci/0.5.3/docs/data-sources/application
...
export interface DataDavinciApplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/davinci/0.5.3/docs/data-sources/application#application_id DataDavinciApplication#application_id}
  */
  readonly applicationId?: string;
  /**
  * The ID of the PingOne environment to create the DaVinci application. Must be a valid PingOne resource ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/davinci/0.5.3/docs/data-sources/application#environment_id DataDavinciApplication#environment_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/davinci/0.5.3/docs/data-sources/application#id DataDavinciApplication#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/davinci/0.5.3/docs/data-sources/application davinci_application}
*/
export class DataDavinciApplication extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDavinciApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/davinci/0.5.3/docs/data-sources/application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/davinci/0.5.3/docs/data-sources/application davinci_application} Data Source
  *
  * @param scope The scope in which to define this construct
