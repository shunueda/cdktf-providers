// https://registry.terraform.io/providers/pingidentity/pingone/1.14.0/docs/resources/application_role_assignment
...
export interface ApplicationRoleAssignmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * The ID of an application to assign an admin role to.  Must be a valid PingOne resource ID.  This field is immutable and will trigger a replace plan if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.14.0/docs/resources/application_role_assignment#application_id ApplicationRoleAssignment#application_id}
  */
  readonly applicationId: string;
  /**
  * The ID of the environment that contains the application to assign the admin role to.  Must be a valid PingOne resource ID.  This field is immutable and will trigger a replace plan if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.14.0/docs/resources/application_role_assignment#environment_id ApplicationRoleAssignment#environment_id}
  */
  readonly environmentId: string;
  /**
  * The ID of an admin role to assign to the application.  Must be a valid PingOne resource ID.  This field is immutable and will trigger a replace plan if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.14.0/docs/resources/application_role_assignment#role_id ApplicationRoleAssignment#role_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.14.0/docs/resources/application_role_assignment#scope_application_id ApplicationRoleAssignment#scope_application_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.14.0/docs/resources/application_role_assignment#scope_environment_id ApplicationRoleAssignment#scope_environment_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.14.0/docs/resources/application_role_assignment#scope_organization_id ApplicationRoleAssignment#scope_organization_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.14.0/docs/resources/application_role_assignment#scope_population_id ApplicationRoleAssignment#scope_population_id}
  */
  readonly scopePopulationId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.14.0/docs/resources/application_role_assignment pingone_application_role_assignment}
*/
export class ApplicationRoleAssignment extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingone_application_role_assignment";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a ApplicationRoleAssignment resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ApplicationRoleAssignment to import
  * @param importFromId The id of the existing ApplicationRoleAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.14.0/docs/resources/application_role_assignment#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ApplicationRoleAssignment to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingone_application_role_assignment", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.14.0/docs/resources/application_role_assignment pingone_application_role_assignment} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ApplicationRoleAssignmentConfig
  */
  public constructor(scope: Construct, id: string, config: ApplicationRoleAssignmentConfig) {
    super(scope, id, {
      terraformResourceType: 'pingone_application_role_assignment',
