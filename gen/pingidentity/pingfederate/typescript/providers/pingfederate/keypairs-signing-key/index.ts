// https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key
...
export interface KeypairsSigningKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#city KeypairsSigningKey#city}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#common_name KeypairsSigningKey#common_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#country KeypairsSigningKey#country}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#crypto_provider KeypairsSigningKey#crypto_provider}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#file_data KeypairsSigningKey#file_data}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#format KeypairsSigningKey#format}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#key_algorithm KeypairsSigningKey#key_algorithm}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#key_id KeypairsSigningKey#key_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#key_size KeypairsSigningKey#key_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#organization KeypairsSigningKey#organization}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#organization_unit KeypairsSigningKey#organization_unit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#password KeypairsSigningKey#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#signature_algorithm KeypairsSigningKey#signature_algorithm}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#state KeypairsSigningKey#state}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#subject_alternative_names KeypairsSigningKey#subject_alternative_names}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#valid_days KeypairsSigningKey#valid_days}
  */
  readonly validDays?: number;
}
export interface KeypairsSigningKeyRotationSettings {
}

export function keypairsSigningKeyRotationSettingsToTerraform(struct?: KeypairsSigningKeyRotationSettings): any {
...
export function keypairsSigningKeyRotationSettingsToHclTerraform(struct?: KeypairsSigningKeyRotationSettings): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class KeypairsSigningKeyRotationSettingsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): KeypairsSigningKeyRotationSettings | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: KeypairsSigningKeyRotationSettings | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key pingfederate_keypairs_signing_key}
*/
export class KeypairsSigningKey extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a KeypairsSigningKey resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the KeypairsSigningKey to import
  * @param importFromId The id of the existing KeypairsSigningKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the KeypairsSigningKey to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/keypairs_signing_key pingfederate_keypairs_signing_key} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options KeypairsSigningKeyConfig = {}
  */
  public constructor(scope: Construct, id: string, config: KeypairsSigningKeyConfig = {}) {
    super(scope, id, {
  ...
  private _rotationSettings = new KeypairsSigningKeyRotationSettingsOutputReference(this, "rotation_settings");
