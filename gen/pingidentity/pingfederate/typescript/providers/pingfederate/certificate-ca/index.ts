// https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/certificate_ca
...
export interface CertificateCaConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/certificate_ca#ca_id CertificateCa#ca_id}
  */
  readonly caId?: string;
  /**
  * Cryptographic Provider. This is only applicable if Hybrid HSM mode is true. This field is immutable and will trigger a replacement plan if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/certificate_ca#crypto_provider CertificateCa#crypto_provider}
  */
  readonly cryptoProvider?: string;
  /**
  * The certificate data in PEM format, base64-encoded. New line characters should be omitted or encoded in this value. This field is immutable and will trigger a replacement plan if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/certificate_ca#file_data CertificateCa#file_data}
  */
  readonly fileData: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/certificate_ca pingfederate_certificate_ca}
*/
export class CertificateCa extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a CertificateCa resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the CertificateCa to import
  * @param importFromId The id of the existing CertificateCa that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/certificate_ca#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the CertificateCa to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingfederate/1.6.2/docs/resources/certificate_ca pingfederate_certificate_ca} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options CertificateCaConfig
  */
  public constructor(scope: Construct, id: string, config: CertificateCaConfig) {
    super(scope, id, {
