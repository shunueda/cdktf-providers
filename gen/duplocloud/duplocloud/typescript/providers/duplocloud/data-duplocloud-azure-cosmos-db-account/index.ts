// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_cosmos_db_account
...
export interface DataDuplocloudAzureCosmosDbAccountConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_cosmos_db_account#id DataDuplocloudAzureCosmosDbAccount#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_cosmos_db_account#name DataDuplocloudAzureCosmosDbAccount#name}
  */
  readonly name: string;
  /**
  * The GUID of the tenant that the host will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_cosmos_db_account#tenant_id DataDuplocloudAzureCosmosDbAccount#tenant_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_cosmos_db_account duplocloud_azure_cosmos_db_account}
*/
export class DataDuplocloudAzureCosmosDbAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudAzureCosmosDbAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_cosmos_db_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_cosmos_db_account duplocloud_azure_cosmos_db_account} Data Source
  *
  * @param scope The scope in which to define this construct
