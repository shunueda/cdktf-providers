// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/plan_images
...
export interface DataDuplocloudPlanImagesAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/plan_images#id DataDuplocloudPlanImagesA#id}
  *
  ...
  * The plan ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/plan_images#plan_id DataDuplocloudPlanImagesA#plan_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/plan_images duplocloud_plan_images}
*/
export class DataDuplocloudPlanImagesA extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudPlanImagesA that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/plan_images#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/plan_images duplocloud_plan_images} Data Source
  *
  * @param scope The scope in which to define this construct
