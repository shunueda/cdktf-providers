// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/ecr_repository
...
export interface DataDuplocloudEcrRepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/ecr_repository#id DataDuplocloudEcrRepository#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/ecr_repository#name DataDuplocloudEcrRepository#name}
  */
  readonly name: string;
  /**
  * The GUID of the tenant in which to list the hosts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/ecr_repository#tenant_id DataDuplocloudEcrRepository#tenant_id}
  */
  readonly tenantId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/ecr_repository duplocloud_ecr_repository}
*/
export class DataDuplocloudEcrRepository extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudEcrRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/ecr_repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/ecr_repository duplocloud_ecr_repository} Data Source
  *
  * @param scope The scope in which to define this construct
