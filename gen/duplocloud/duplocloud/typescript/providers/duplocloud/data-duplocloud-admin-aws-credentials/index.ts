// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/admin_aws_credentials
...
export interface DataDuplocloudAdminAwsCredentialsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/admin_aws_credentials#id DataDuplocloudAdminAwsCredentials#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/admin_aws_credentials duplocloud_admin_aws_credentials}
*/
export class DataDuplocloudAdminAwsCredentials extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudAdminAwsCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/admin_aws_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/admin_aws_credentials duplocloud_admin_aws_credentials} Data Source
  *
  * @param scope The scope in which to define this construct
