// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue
...
export interface AwsBatchJobQueueConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue#compute_environments AwsBatchJobQueue#compute_environments}
  */
  readonly computeEnvironments: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue#id AwsBatchJobQueue#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue#name AwsBatchJobQueue#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue#priority AwsBatchJobQueue#priority}
  */
  readonly priority: number;
  /**
  * The ARN of the fair share scheduling policy. If this parameter is specified, the job queue uses a fair share scheduling policy. If this parameter isn't specified, the job queue uses a first in, first out (FIFO) scheduling policy. After a job queue is created, you can replace but can't remove the fair share scheduling policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue#scheduling_policy_arn AwsBatchJobQueue#scheduling_policy_arn}
  */
  readonly schedulingPolicyArn?: string;
  /**
  * The state of the job queue. Must be one of: `ENABLED` or `DISABLED`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue#state AwsBatchJobQueue#state}
  */
  readonly state: string;
  /**
  * Key-value map of resource tags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue#tags AwsBatchJobQueue#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The GUID of the tenant that the aws batch Job queue will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue#tenant_id AwsBatchJobQueue#tenant_id}
  */
  readonly tenantId: string;
  /**
  * Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue#wait_for_deployment AwsBatchJobQueue#wait_for_deployment}
  */
  readonly waitForDeployment?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue#timeouts AwsBatchJobQueue#timeouts}
  */
  readonly timeouts?: AwsBatchJobQueueTimeouts;
}
export interface AwsBatchJobQueueTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue#create AwsBatchJobQueue#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue#delete AwsBatchJobQueue#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue duplocloud_aws_batch_job_queue}
*/
export class AwsBatchJobQueue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsBatchJobQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_job_queue duplocloud_aws_batch_job_queue} Resource
  *
  * @param scope The scope in which to define this construct
