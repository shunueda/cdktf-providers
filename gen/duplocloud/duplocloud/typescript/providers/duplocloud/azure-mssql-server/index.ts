// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server
...
export interface AzureMssqlServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#administrator_login AzureMssqlServer#administrator_login}
  */
  readonly administratorLogin?: string;
  /**
  * The Password associated with the `administrator_login` for the MS sql Server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#administrator_login_password AzureMssqlServer#administrator_login_password}
  */
  readonly administratorLoginPassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#id AzureMssqlServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#minimum_tls_version AzureMssqlServer#minimum_tls_version}
  */
  readonly minimumTlsVersion?: string;
  /**
  * The name of the Microsoft SQL Server. This needs to be globally unique within Azure.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#name AzureMssqlServer#name}
  */
  readonly name: string;
  /**
  * Whether public network access is enabled or disabled for this server. Valid values are `Enabled` or `Disabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#public_network_access AzureMssqlServer#public_network_access}
  */
  readonly publicNetworkAccess?: string;
  /**
  * The GUID of the tenant that the azure mssql server will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#tenant_id AzureMssqlServer#tenant_id}
  */
  readonly tenantId: string;
  /**
  * The version for the new server. Valid values are: `2.0` (for v11 server) and `12.0` (for v12 server).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#version AzureMssqlServer#version}
  */
  readonly version: string;
  /**
  * Whether or not to wait until PostgreSQL Server instance to be ready, after creation. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#wait_until_ready AzureMssqlServer#wait_until_ready}
  */
  readonly waitUntilReady?: boolean | cdktf.IResolvable;
  /**
  * active_directory_administrator block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#active_directory_administrator AzureMssqlServer#active_directory_administrator}
  */
  readonly activeDirectoryAdministrator?: AzureMssqlServerActiveDirectoryAdministrator;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#timeouts AzureMssqlServer#timeouts}
  */
...
export interface AzureMssqlServerActiveDirectoryAdministrator {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#ad_authentication_only AzureMssqlServer#ad_authentication_only}
  */
  readonly adAuthenticationOnly?: boolean | cdktf.IResolvable;
  /**
  * Implicitly inferred. Valid value ActiveDirectory
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#administrator_type AzureMssqlServer#administrator_type}
  */
  readonly administratorType?: string;
  /**
  * The login name of the principal to set as the server administrator
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#login AzureMssqlServer#login}
  */
  readonly login: string;
  /**
  * The ID of the principal to set as the server administrator
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#object_id AzureMssqlServer#object_id}
  */
  readonly objectId: string;
  /**
  * Specify the type of the principal: `User`, `Group`, or `Application`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#principal_type AzureMssqlServer#principal_type}
  */
...
export interface AzureMssqlServerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#create AzureMssqlServer#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#delete AzureMssqlServer#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server duplocloud_azure_mssql_server}
*/
export class AzureMssqlServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureMssqlServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_server duplocloud_azure_mssql_server} Resource
  *
  * @param scope The scope in which to define this construct
