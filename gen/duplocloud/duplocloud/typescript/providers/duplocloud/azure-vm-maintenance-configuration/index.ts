// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration
...
export interface AzureVmMaintenanceConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#id AzureVmMaintenanceConfiguration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#tenant_id AzureVmMaintenanceConfiguration#tenant_id}
  */
  readonly tenantId: string;
  /**
  * The visibility of the Maintenance Configuration. The only allowable value is Custom. Defaults to `Custom`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#visiblity AzureVmMaintenanceConfiguration#visiblity}
  */
  readonly visiblity?: string;
  /**
  * The name of the virtual machine where maintenance configuration need to be configured.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#vm_name AzureVmMaintenanceConfiguration#vm_name}
  */
  readonly vmName: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#timeouts AzureVmMaintenanceConfiguration#timeouts}
  */
  readonly timeouts?: AzureVmMaintenanceConfigurationTimeouts;
  /**
  * window block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#window AzureVmMaintenanceConfiguration#window}
  */
  readonly window?: AzureVmMaintenanceConfigurationWindow;
}
export interface AzureVmMaintenanceConfigurationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#create AzureVmMaintenanceConfiguration#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#delete AzureVmMaintenanceConfiguration#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#update AzureVmMaintenanceConfiguration#update}
  */
...
export interface AzureVmMaintenanceConfigurationWindow {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#duration AzureVmMaintenanceConfiguration#duration}
  */
  readonly duration?: string;
  /**
  * Effective expiration date of the maintenance window in YYYY-MM-DD hh:mm format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#expiration_time AzureVmMaintenanceConfiguration#expiration_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#recur_every AzureVmMaintenanceConfiguration#recur_every}
  */
  readonly recurEvery?: string;
  /**
  * Effective start date of the maintenance window in YYYY-MM-DD HH:MM format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#start_time AzureVmMaintenanceConfiguration#start_time}
  */
  readonly startTime: string;
  /**
  * The timezone on which maintenance should be scheduled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#time_zone AzureVmMaintenanceConfiguration#time_zone}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration duplocloud_azure_vm_maintenance_configuration}
*/
export class AzureVmMaintenanceConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureVmMaintenanceConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_vm_maintenance_configuration duplocloud_azure_vm_maintenance_configuration} Resource
  *
  * @param scope The scope in which to define this construct
