// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint
...
export interface AzurePrivateEndpointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint#id AzurePrivateEndpoint#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint#name AzurePrivateEndpoint#name}
  */
  readonly name: string;
  /**
  * The ID of the Subnet from which Private IP Addresses will be allocated for this Private Endpoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint#subnet_id AzurePrivateEndpoint#subnet_id}
  */
  readonly subnetId: string;
  /**
  * The GUID of the tenant that the azure private endpoint will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint#tenant_id AzurePrivateEndpoint#tenant_id}
  */
  readonly tenantId: string;
  /**
  * private_link_service_connection block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint#private_link_service_connection AzurePrivateEndpoint#private_link_service_connection}
  */
  readonly privateLinkServiceConnection: AzurePrivateEndpointPrivateLinkServiceConnection[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint#timeouts AzurePrivateEndpoint#timeouts}
  */
  readonly timeouts?: AzurePrivateEndpointTimeouts;
}
export interface AzurePrivateEndpointPrivateLinkServiceConnection {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint#group_ids AzurePrivateEndpoint#group_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint#private_connection_resource_id AzurePrivateEndpoint#private_connection_resource_id}
  */
...
export interface AzurePrivateEndpointTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint#create AzurePrivateEndpoint#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint#delete AzurePrivateEndpoint#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint duplocloud_azure_private_endpoint}
*/
export class AzurePrivateEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzurePrivateEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_private_endpoint duplocloud_azure_private_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
