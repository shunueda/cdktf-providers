// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target
...
export interface AwsAppautoscalingTargetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target#id AwsAppautoscalingTarget#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target#max_capacity AwsAppautoscalingTarget#max_capacity}
  */
  readonly maxCapacity: number;
  /**
  * The min capacity of the scalable target.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target#min_capacity AwsAppautoscalingTarget#min_capacity}
  */
  readonly minCapacity: number;
  /**
  * Resource name associated with the scaling policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target#resource_id AwsAppautoscalingTarget#resource_id}
  */
  readonly resourceId: string;
  /**
  * The ARN of the IAM role that allows Application AutoScaling to modify your scalable target on your behalf.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target#role_arn AwsAppautoscalingTarget#role_arn}
  */
  readonly roleArn?: string;
  /**
  * The scalable dimension of the scalable target.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target#scalable_dimension AwsAppautoscalingTarget#scalable_dimension}
  */
  readonly scalableDimension: string;
  /**
  * The AWS service namespace of the scalable target.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target#service_namespace AwsAppautoscalingTarget#service_namespace}
  */
  readonly serviceNamespace: string;
  /**
  * The GUID of the tenant that the aws autoscaling target will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target#tenant_id AwsAppautoscalingTarget#tenant_id}
  */
  readonly tenantId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target#timeouts AwsAppautoscalingTarget#timeouts}
  */
  readonly timeouts?: AwsAppautoscalingTargetTimeouts;
}
export interface AwsAppautoscalingTargetTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target#create AwsAppautoscalingTarget#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target#delete AwsAppautoscalingTarget#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target duplocloud_aws_appautoscaling_target}
*/
export class AwsAppautoscalingTarget extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsAppautoscalingTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_appautoscaling_target duplocloud_aws_appautoscaling_target} Resource
  *
  * @param scope The scope in which to define this construct
