// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_key_vault_secret
...
export interface AzureKeyVaultSecretConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_key_vault_secret#id AzureKeyVaultSecret#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_key_vault_secret#key_vault_id AzureKeyVaultSecret#key_vault_id}
  */
  readonly keyVaultId?: string;
  /**
  * Specifies the name of the Key Vault Secret. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_key_vault_secret#name AzureKeyVaultSecret#name}
  */
  readonly name: string;
  /**
  * The GUID of the tenant that the key vault secret will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_key_vault_secret#tenant_id AzureKeyVaultSecret#tenant_id}
  */
  readonly tenantId: string;
  /**
  * Specifies the content type for the Key Vault Secret. Defaults to `duplo_container_env`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_key_vault_secret#type AzureKeyVaultSecret#type}
  */
  readonly type?: string;
  /**
  * Specifies the value of the Key vault secret.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_key_vault_secret#value AzureKeyVaultSecret#value}
  */
  readonly value: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_key_vault_secret#timeouts AzureKeyVaultSecret#timeouts}
  */
  readonly timeouts?: AzureKeyVaultSecretTimeouts;
}
export interface AzureKeyVaultSecretTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_key_vault_secret#create AzureKeyVaultSecret#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_key_vault_secret#delete AzureKeyVaultSecret#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_key_vault_secret duplocloud_azure_key_vault_secret}
*/
export class AzureKeyVaultSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureKeyVaultSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_key_vault_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_key_vault_secret duplocloud_azure_key_vault_secret} Resource
  *
  * @param scope The scope in which to define this construct
