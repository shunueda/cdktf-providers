// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy
...
export interface AwsBatchSchedulingPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#id AwsBatchSchedulingPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#name AwsBatchSchedulingPolicy#name}
  */
  readonly name: string;
  /**
  * Key-value map of resource tags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#tags AwsBatchSchedulingPolicy#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The GUID of the tenant that the aws batch scheduling policy will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#tenant_id AwsBatchSchedulingPolicy#tenant_id}
  */
  readonly tenantId: string;
  /**
  * fair_share_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#fair_share_policy AwsBatchSchedulingPolicy#fair_share_policy}
  */
  readonly fairSharePolicy?: AwsBatchSchedulingPolicyFairSharePolicy;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#timeouts AwsBatchSchedulingPolicy#timeouts}
  */
...
export interface AwsBatchSchedulingPolicyFairSharePolicyShareDistribution {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#share_identifier AwsBatchSchedulingPolicy#share_identifier}
  */
  readonly shareIdentifier: string;
  /**
  * The weight factor for the fair share identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#weight_factor AwsBatchSchedulingPolicy#weight_factor}
  */
...
export interface AwsBatchSchedulingPolicyFairSharePolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#compute_reservation AwsBatchSchedulingPolicy#compute_reservation}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#share_decay_seconds AwsBatchSchedulingPolicy#share_decay_seconds}
  */
  readonly shareDecaySeconds?: number;
  /**
  * share_distribution block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#share_distribution AwsBatchSchedulingPolicy#share_distribution}
  */
...
export interface AwsBatchSchedulingPolicyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#create AwsBatchSchedulingPolicy#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#delete AwsBatchSchedulingPolicy#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy duplocloud_aws_batch_scheduling_policy}
*/
export class AwsBatchSchedulingPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsBatchSchedulingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_batch_scheduling_policy duplocloud_aws_batch_scheduling_policy} Resource
  *
  * @param scope The scope in which to define this construct
