// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule
...
export interface AzureNetworkSecurityRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#access AzureNetworkSecurityRule#access}
  */
  readonly access: string;
  /**
  * CIDR or destination IP range or * to match any IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#destination_address_prefix AzureNetworkSecurityRule#destination_address_prefix}
  */
  readonly destinationAddressPrefix?: string;
  /**
  * Destination Port or Range. Integer or range between `0` and `65535` or `*` to match any.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#destination_port_range AzureNetworkSecurityRule#destination_port_range}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#destination_rule_type AzureNetworkSecurityRule#destination_rule_type}
  */
  readonly destinationRuleType: number;
  /**
  * The direction specifies if rule will be evaluated on incoming or outgoing traffic. Possible values are `Inbound` and `Outbound`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#direction AzureNetworkSecurityRule#direction}
  */
  readonly direction: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#id AzureNetworkSecurityRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#infra_name AzureNetworkSecurityRule#infra_name}
  */
  readonly infraName: string;
  /**
  * The name of the security group rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#name AzureNetworkSecurityRule#name}
  */
  readonly name: string;
  /**
  * The name of the Network Security Group that we want to attach the rule to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#network_security_group_name AzureNetworkSecurityRule#network_security_group_name}
  */
  readonly networkSecurityGroupName: string;
  /**
  * Specifies the priority of the rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#priority AzureNetworkSecurityRule#priority}
  */
  readonly priority: number;
  /**
  * Network protocol this rule applies to. Possible values include `tcp`, `udp`, `icmp`, `esp`, `ah` or `*` (which matches all).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#protocol AzureNetworkSecurityRule#protocol}
  */
  readonly protocol: string;
  /**
  * CIDR or source IP range or * to match any IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#source_address_prefix AzureNetworkSecurityRule#source_address_prefix}
  */
  readonly sourceAddressPrefix?: string;
  /**
  * Source Port or Range. Integer or range between `0` and `65535` or `*` to match any.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#source_port_range AzureNetworkSecurityRule#source_port_range}
  */
  readonly sourcePortRange?: string;
  /**
  * Type of the source security rule. Possible values include `0(IP Address)`, `1(Service Tag)`, `2(Application Security Group)`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#source_rule_type AzureNetworkSecurityRule#source_rule_type}
  */
  readonly sourceRuleType: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#timeouts AzureNetworkSecurityRule#timeouts}
  */
  readonly timeouts?: AzureNetworkSecurityRuleTimeouts;
}
export interface AzureNetworkSecurityRuleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#create AzureNetworkSecurityRule#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#delete AzureNetworkSecurityRule#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule duplocloud_azure_network_security_rule}
*/
export class AzureNetworkSecurityRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureNetworkSecurityRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_network_security_rule duplocloud_azure_network_security_rule} Resource
  *
  * @param scope The scope in which to define this construct
