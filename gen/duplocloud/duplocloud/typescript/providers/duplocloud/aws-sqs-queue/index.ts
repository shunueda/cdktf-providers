// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue
...
export interface AwsSqsQueueConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#content_based_deduplication AwsSqsQueue#content_based_deduplication}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#deduplication_scope AwsSqsQueue#deduplication_scope}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#delay_seconds AwsSqsQueue#delay_seconds}
  */
  readonly delaySeconds?: number;
  /**
  * Boolean designating a FIFO queue. If not set, it defaults to `false` making it standard.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#fifo_queue AwsSqsQueue#fifo_queue}
  */
  readonly fifoQueue?: boolean | cdktf.IResolvable;
  /**
  * Specifies whether the FIFO queue throughput quota applies to the entire queue or per message group. Valid values are `perQueue` (default) and `perMessageGroupId`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#fifo_throughput_limit AwsSqsQueue#fifo_throughput_limit}
  */
  readonly fifoThroughputLimit?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#id AwsSqsQueue#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#message_retention_seconds AwsSqsQueue#message_retention_seconds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#name AwsSqsQueue#name}
  */
  readonly name: string;
  /**
  * The time for which a ReceiveMessage call will wait for a message to arrive. An integer from 0 to 20 (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#receive_wait_time_seconds AwsSqsQueue#receive_wait_time_seconds}
  */
  readonly receiveWaitTimeSeconds?: number;
  /**
  * The GUID of the tenant that the SQS queue will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#tenant_id AwsSqsQueue#tenant_id}
  */
  readonly tenantId: string;
  /**
  * The visibility timeout for the queue. An integer from 0 to 43200 (12 hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#visibility_timeout_seconds AwsSqsQueue#visibility_timeout_seconds}
  */
  readonly visibilityTimeoutSeconds?: number;
  /**
  * dead_letter_queue_configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#dead_letter_queue_configuration AwsSqsQueue#dead_letter_queue_configuration}
  */
  readonly deadLetterQueueConfiguration?: AwsSqsQueueDeadLetterQueueConfiguration;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#timeouts AwsSqsQueue#timeouts}
  */
...
export interface AwsSqsQueueDeadLetterQueueConfiguration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#max_message_receive_attempts AwsSqsQueue#max_message_receive_attempts}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#target_sqs_dlq_name AwsSqsQueue#target_sqs_dlq_name}
  */
...
export interface AwsSqsQueueTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#create AwsSqsQueue#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#delete AwsSqsQueue#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue duplocloud_aws_sqs_queue}
*/
export class AwsSqsQueue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsSqsQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_sqs_queue duplocloud_aws_sqs_queue} Resource
  *
  * @param scope The scope in which to define this construct
