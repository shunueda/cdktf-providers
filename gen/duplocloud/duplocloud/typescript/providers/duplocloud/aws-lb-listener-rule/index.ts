// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule
...
export interface AwsLbListenerRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#id AwsLbListenerRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#listener_arn AwsLbListenerRule#listener_arn}
  */
  readonly listenerArn: string;
  /**
  * The priority for the rule between `1` and `50000`. Leaving it unset will automatically set the rule with next available priority after currently existing highest rule. A listener can't have multiple rules with the same priority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#priority AwsLbListenerRule#priority}
  */
  readonly priority?: number;
  /**
  * The GUID of the tenant that the aws lb listener rule will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#tenant_id AwsLbListenerRule#tenant_id}
  */
  readonly tenantId: string;
  /**
  * action block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#action AwsLbListenerRule#action}
  */
  readonly action: AwsLbListenerRuleAction[] | cdktf.IResolvable;
  /**
  * condition block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#condition AwsLbListenerRule#condition}
  */
  readonly condition: AwsLbListenerRuleCondition[] | cdktf.IResolvable;
  /**
  * tags block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#tags AwsLbListenerRule#tags}
  */
  readonly tags?: AwsLbListenerRuleTags[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#timeouts AwsLbListenerRule#timeouts}
  */
...
export interface AwsLbListenerRuleActionAuthenticateCognito {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#authentication_request_extra_params AwsLbListenerRule#authentication_request_extra_params}
  */
  readonly authenticationRequestExtraParams?: { [key: string]: string };
  /**
  * The behavior if the user is not authenticated. Valid values: `deny`, `allow` and `authenticate`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#on_unauthenticated_request AwsLbListenerRule#on_unauthenticated_request}
  */
  readonly onUnauthenticatedRequest?: string;
  /**
  * The set of user claims to be requested from the IdP. Defaults to `openid`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#scope AwsLbListenerRule#scope}
  */
  readonly scope?: string;
  /**
  * The name of the cookie used to maintain session information. Defaults to `AWSELBAuthSessionCookie`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#session_cookie_name AwsLbListenerRule#session_cookie_name}
  */
  readonly sessionCookieName?: string;
  /**
  * The maximum duration of the authentication session, in seconds. Defaults to `604800`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#session_timeout AwsLbListenerRule#session_timeout}
  */
  readonly sessionTimeout?: number;
  /**
  * The ARN of the Cognito user pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#user_pool_arn AwsLbListenerRule#user_pool_arn}
  */
  readonly userPoolArn: string;
  /**
  * The ID of the Cognito user pool client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#user_pool_client_id AwsLbListenerRule#user_pool_client_id}
  */
  readonly userPoolClientId: string;
  /**
  * The domain prefix or fully-qualified domain name of the Cognito user pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#user_pool_domain AwsLbListenerRule#user_pool_domain}
  */
...
export interface AwsLbListenerRuleActionAuthenticateOidc {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#authorization_endpoint AwsLbListenerRule#authorization_endpoint}
  */
  readonly authorizationEndpoint: string;
  /**
  * The OAuth 2.0 client identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#client_id AwsLbListenerRule#client_id}
  */
  readonly clientId: string;
  /**
  * The OAuth 2.0 client secret.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#client_secret AwsLbListenerRule#client_secret}
  */
  readonly clientSecret: string;
  /**
  * The OIDC issuer identifier of the IdP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#issuer AwsLbListenerRule#issuer}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#token_endpoint AwsLbListenerRule#token_endpoint}
  */
  readonly tokenEndpoint: string;
  /**
  * The user info endpoint of the IdP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#user_info_endpoint AwsLbListenerRule#user_info_endpoint}
  */
...
export interface AwsLbListenerRuleActionFixedResponse {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#content_type AwsLbListenerRule#content_type}
  */
  readonly contentType: string;
  /**
  * The message body.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#message_body AwsLbListenerRule#message_body}
  */
  readonly messageBody?: string;
  /**
  * The HTTP response code. Valid values are `2XX`, `4XX`, or `5XX`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#status_code AwsLbListenerRule#status_code}
  */
...
export interface AwsLbListenerRuleActionForwardStickiness {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#duration AwsLbListenerRule#duration}
  */
  readonly duration: number;
  /**
  * Indicates whether target group stickiness is enabled. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#enabled AwsLbListenerRule#enabled}
  */
...
export interface AwsLbListenerRuleActionForwardTargetGroup {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#arn AwsLbListenerRule#arn}
  */
  readonly arn: string;
  /**
  * The weight. The range is 0 to 999. Defaults to `1`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#weight AwsLbListenerRule#weight}
  */
...
export interface AwsLbListenerRuleActionForward {
  ...
  * stickiness block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#stickiness AwsLbListenerRule#stickiness}
  */
  readonly stickiness?: AwsLbListenerRuleActionForwardStickiness;
  /**
  * target_group block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#target_group AwsLbListenerRule#target_group}
  */
...
export interface AwsLbListenerRuleActionRedirect {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#host AwsLbListenerRule#host}
  */
  readonly host?: string;
  /**
  * The absolute path, starting with the leading "/". Defaults to `/#{path}`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#path AwsLbListenerRule#path}
  */
  readonly path?: string;
  /**
  * The port. Specify a value from `1` to `65535`. Defaults to `#{port}`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#port AwsLbListenerRule#port}
  */
  readonly port?: string;
  /**
  * The protocol. Valid values are `HTTP`, `HTTPS`, or `#{protocol}`. Defaults to `#{protocol}`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#protocol AwsLbListenerRule#protocol}
  */
  readonly protocol?: string;
  /**
  * The query parameters, URL-encoded when necessary. Defaults to `#{query}`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#query AwsLbListenerRule#query}
  */
...
export interface AwsLbListenerRuleAction {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#order AwsLbListenerRule#order}
  */
  readonly order?: number;
  /**
  * The ARN of the Target Group to which to route traffic. Specify only if `type` is `forward` and you want to route to a single target group. To route to one or more target groups, use a `forward` block instead.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#target_group_arn AwsLbListenerRule#target_group_arn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#type AwsLbListenerRule#type}
  */
  readonly type: string;
  /**
  * authenticate_cognito block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#authenticate_cognito AwsLbListenerRule#authenticate_cognito}
  */
  readonly authenticateCognito?: AwsLbListenerRuleActionAuthenticateCognito;
  /**
  * authenticate_oidc block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#authenticate_oidc AwsLbListenerRule#authenticate_oidc}
  */
  readonly authenticateOidc?: AwsLbListenerRuleActionAuthenticateOidc;
  /**
  * fixed_response block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#fixed_response AwsLbListenerRule#fixed_response}
  */
  readonly fixedResponse?: AwsLbListenerRuleActionFixedResponse;
  /**
  * forward block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#forward AwsLbListenerRule#forward}
  */
  readonly forward?: AwsLbListenerRuleActionForward;
  /**
  * redirect block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#redirect AwsLbListenerRule#redirect}
  */
...
export interface AwsLbListenerRuleConditionHostHeader {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#values AwsLbListenerRule#values}
  */
...
export interface AwsLbListenerRuleConditionHttpHeader {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#http_header_name AwsLbListenerRule#http_header_name}
  */
...
export interface AwsLbListenerRuleConditionQueryString {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#key AwsLbListenerRule#key}
  */
  readonly key?: string;
  /**
  * Query string value pattern to match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#value AwsLbListenerRule#value}
  */
...
export interface AwsLbListenerRuleCondition {
  ...
  * host_header block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#host_header AwsLbListenerRule#host_header}
  */
  readonly hostHeader?: AwsLbListenerRuleConditionHostHeader;
  /**
  * http_header block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#http_header AwsLbListenerRule#http_header}
  */
  readonly httpHeader?: AwsLbListenerRuleConditionHttpHeader;
  /**
  * http_request_method block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#http_request_method AwsLbListenerRule#http_request_method}
  */
  readonly httpRequestMethod?: AwsLbListenerRuleConditionHttpRequestMethod;
  /**
  * path_pattern block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#path_pattern AwsLbListenerRule#path_pattern}
  */
  readonly pathPattern?: AwsLbListenerRuleConditionPathPattern;
  /**
  * query_string block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#query_string AwsLbListenerRule#query_string}
  */
  readonly queryString?: AwsLbListenerRuleConditionQueryString[] | cdktf.IResolvable;
  /**
  * source_ip block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#source_ip AwsLbListenerRule#source_ip}
  */
...
export interface AwsLbListenerRuleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#create AwsLbListenerRule#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#delete AwsLbListenerRule#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule duplocloud_aws_lb_listener_rule}
*/
export class AwsLbListenerRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsLbListenerRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_lb_listener_rule duplocloud_aws_lb_listener_rule} Resource
  *
  * @param scope The scope in which to define this construct
