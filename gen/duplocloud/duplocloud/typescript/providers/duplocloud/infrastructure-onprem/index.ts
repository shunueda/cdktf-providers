// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem
...
export interface InfrastructureOnpremConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#account_id InfrastructureOnprem#account_id}
  */
  readonly accountId?: string;
  /**
  * Token to access cluster API's
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#api_token InfrastructureOnprem#api_token}
  */
  readonly apiToken: string;
  /**
  * The number of availability zones.  Must be one of: `2`, `3`, or `4`. This is applicable only for AWS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#azcount InfrastructureOnprem#azcount}
  */
  readonly azcount?: number;
  /**
  * Required to validate API server certificates and kubelet client certificates
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#cluster_certificate_authority_data InfrastructureOnprem#cluster_certificate_authority_data}
  */
  readonly clusterCertificateAuthorityData: string;
  /**
  * Endpoint URL of K8 cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#cluster_endpoint InfrastructureOnprem#cluster_endpoint}
  */
  readonly clusterEndpoint: string;
  /**
  * Name of the on premise k8 cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#cluster_name InfrastructureOnprem#cluster_name}
  */
  readonly clusterName: string;
  /**
  * Datacenter name of the onpremise cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#data_center InfrastructureOnprem#data_center}
  */
  readonly dataCenter: string;
  /**
  * Whether or not to provision a kubernetes cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#enable_k8_cluster InfrastructureOnprem#enable_k8_cluster}
  */
  readonly enableK8Cluster: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#id InfrastructureOnprem#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#infra_name InfrastructureOnprem#infra_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#region InfrastructureOnprem#region}
  */
  readonly region: string;
  /**
  * Type of on premise vendor <br>0 - Rancher<br>1 - Generic<br>2 - EKS<br>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#vendor InfrastructureOnprem#vendor}
  */
  readonly vendor: number;
  /**
  * custom_data block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#custom_data InfrastructureOnprem#custom_data}
  */
  readonly customData?: InfrastructureOnpremCustomData[] | cdktf.IResolvable;
  /**
  * eks_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#eks_config InfrastructureOnprem#eks_config}
  */
  readonly eksConfig?: InfrastructureOnpremEksConfig;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#timeouts InfrastructureOnprem#timeouts}
  */
  readonly timeouts?: InfrastructureOnpremTimeouts;
}
export interface InfrastructureOnpremCustomData {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#key InfrastructureOnprem#key}
  */
  readonly key: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#value InfrastructureOnprem#value}
  */
...
export interface InfrastructureOnpremEksConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#ingress_security_group_ids InfrastructureOnprem#ingress_security_group_ids}
  */
  readonly ingressSecurityGroupIds: string[];
  /**
  * The private subnets for the VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#private_subnets InfrastructureOnprem#private_subnets}
  */
  readonly privateSubnets: string[];
  /**
  * The public subnets for the VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#public_subnets InfrastructureOnprem#public_subnets}
  */
  readonly publicSubnets: string[];
  /**
  * The the ID of a Virtual Private Cloud
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#vpc_id InfrastructureOnprem#vpc_id}
  */
...
export interface InfrastructureOnpremTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#create InfrastructureOnprem#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#delete InfrastructureOnprem#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#update InfrastructureOnprem#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem duplocloud_infrastructure_onprem}
*/
export class InfrastructureOnprem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InfrastructureOnprem that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/infrastructure_onprem duplocloud_infrastructure_onprem} Resource
  *
  * @param scope The scope in which to define this construct
