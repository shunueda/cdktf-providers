...
export interface DataDuplocloudK8SCronJobConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/k8s_cron_job#allocation_tags DataDuplocloudK8SCronJob#allocation_tags}
  */
  readonly allocationTags?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/k8s_cron_job#id DataDuplocloudK8SCronJob#id}
  *
  ...
  * Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/k8s_cron_job#is_any_host_allowed DataDuplocloudK8SCronJob#is_any_host_allowed}
  */
  readonly isAnyHostAllowed?: boolean | cdktf.IResolvable;
  /**
  * The GUID of the tenant that the job will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/k8s_cron_job#tenant_id DataDuplocloudK8SCronJob#tenant_id}
  */
  readonly tenantId: string;
  /**
  * metadata block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/k8s_cron_job#metadata DataDuplocloudK8SCronJob#metadata}
  */
  readonly metadata: DataDuplocloudK8SCronJobMetadata;
}

/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/k8s_cron_job duplocloud_k8s_cron_job}
*/
export class DataDuplocloudK8SCronJob extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudK8SCronJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/k8s_cron_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/k8s_cron_job duplocloud_k8s_cron_job} Data Source
  *
  * @param scope The scope in which to define this construct
