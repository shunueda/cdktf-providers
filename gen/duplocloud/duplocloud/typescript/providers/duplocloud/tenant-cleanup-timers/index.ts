// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers
...
export interface TenantCleanupTimersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers#expiry_time TenantCleanupTimers#expiry_time}
  */
  readonly expiryTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers#id TenantCleanupTimers#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers#pause_time TenantCleanupTimers#pause_time}
  */
  readonly pauseTime?: string;
  /**
  * Whether to remove the expiry time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers#remove_expiry_time TenantCleanupTimers#remove_expiry_time}
  */
  readonly removeExpiryTime?: boolean | cdktf.IResolvable;
  /**
  * Whether to remove the pause time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers#remove_pause_time TenantCleanupTimers#remove_pause_time}
  */
  readonly removePauseTime?: boolean | cdktf.IResolvable;
  /**
  * The GUID of the tenant that the expiry will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers#tenant_id TenantCleanupTimers#tenant_id}
  */
  readonly tenantId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers#timeouts TenantCleanupTimers#timeouts}
  */
  readonly timeouts?: TenantCleanupTimersTimeouts;
}
export interface TenantCleanupTimersTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers#create TenantCleanupTimers#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers#delete TenantCleanupTimers#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers#update TenantCleanupTimers#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers duplocloud_tenant_cleanup_timers}
*/
export class TenantCleanupTimers extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TenantCleanupTimers that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/tenant_cleanup_timers duplocloud_tenant_cleanup_timers} Resource
  *
  * @param scope The scope in which to define this construct
