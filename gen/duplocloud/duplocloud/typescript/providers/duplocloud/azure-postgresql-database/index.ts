// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database
...
export interface AzurePostgresqlDatabaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#administrator_login AzurePostgresqlDatabase#administrator_login}
  */
  readonly administratorLogin?: string;
  /**
  * The Password associated with the `administrator_login` for the PostgreSQL Server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#administrator_login_password AzurePostgresqlDatabase#administrator_login_password}
  */
  readonly administratorLoginPassword?: string;
  /**
  * Backup retention days for the server, supported values are between `7` and `35` days.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#backup_retention_days AzurePostgresqlDatabase#backup_retention_days}
  */
  readonly backupRetentionDays?: number;
  /**
  * Turn Geo-redundant server backups on/off.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#geo_redundant_backup AzurePostgresqlDatabase#geo_redundant_backup}
  */
  readonly geoRedundantBackup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#id AzurePostgresqlDatabase#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#name AzurePostgresqlDatabase#name}
  */
  readonly name: string;
  /**
  * Specifies the SKU Name for this PostgreSQL Server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#sku_name AzurePostgresqlDatabase#sku_name}
  */
  readonly skuName: string;
  /**
  * Specifies if SSL should be enforced on connections.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#ssl_enforcement AzurePostgresqlDatabase#ssl_enforcement}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#storage_mb AzurePostgresqlDatabase#storage_mb}
  */
  readonly storageMb?: number;
  /**
  * The GUID of the tenant that the azure postgresql database will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#tenant_id AzurePostgresqlDatabase#tenant_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#version AzurePostgresqlDatabase#version}
  */
  readonly version: string;
  /**
  * Whether or not to wait until PostgreSQL Server instance to be ready, after creation. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#wait_until_ready AzurePostgresqlDatabase#wait_until_ready}
  */
  readonly waitUntilReady?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#timeouts AzurePostgresqlDatabase#timeouts}
  */
  readonly timeouts?: AzurePostgresqlDatabaseTimeouts;
}
export interface AzurePostgresqlDatabaseTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#create AzurePostgresqlDatabase#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#delete AzurePostgresqlDatabase#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database duplocloud_azure_postgresql_database}
*/
export class AzurePostgresqlDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzurePostgresqlDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_postgresql_database duplocloud_azure_postgresql_database} Resource
  *
  * @param scope The scope in which to define this construct
