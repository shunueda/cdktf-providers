// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs
...
export interface DuplocloudProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs#duplo_host DuplocloudProvider#duplo_host}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs#duplo_token DuplocloudProvider#duplo_token}
  */
  readonly duploToken?: string;
  /**
  * Timeout for HTTP requests in seconds. Defaults to `30`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs#http_timeout DuplocloudProvider#http_timeout}
  */
  readonly httpTimeout?: number;
  /**
  * Disable SSL certificate verification. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs#ssl_no_verify DuplocloudProvider#ssl_no_verify}
  */
  readonly sslNoVerify?: boolean | cdktf.IResolvable;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs#alias DuplocloudProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs duplocloud}
*/
export class DuplocloudProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing DuplocloudProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs duplocloud} Resource
  *
  * @param scope The scope in which to define this construct
