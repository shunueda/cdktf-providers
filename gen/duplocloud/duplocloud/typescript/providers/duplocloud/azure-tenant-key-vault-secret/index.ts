// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_tenant_key_vault_secret
...
export interface AzureTenantKeyVaultSecretConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_tenant_key_vault_secret#content_type AzureTenantKeyVaultSecret#content_type}
  */
  readonly contentType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_tenant_key_vault_secret#id AzureTenantKeyVaultSecret#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_tenant_key_vault_secret#name AzureTenantKeyVaultSecret#name}
  */
  readonly name: string;
  /**
  * The GUID of the DuploCloud tenant that the key vault secret will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_tenant_key_vault_secret#tenant_id AzureTenantKeyVaultSecret#tenant_id}
  */
  readonly tenantId: string;
  /**
  * Specifies the value of the Key Vault Secret. Changing this will create a new version of the Key Vault Secret.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_tenant_key_vault_secret#value AzureTenantKeyVaultSecret#value}
  */
  readonly value: string;
  /**
  * Name of the Key Vault where the Secret should be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_tenant_key_vault_secret#vault_name AzureTenantKeyVaultSecret#vault_name}
  */
  readonly vaultName: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_tenant_key_vault_secret#timeouts AzureTenantKeyVaultSecret#timeouts}
  */
  readonly timeouts?: AzureTenantKeyVaultSecretTimeouts;
}
export interface AzureTenantKeyVaultSecretTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_tenant_key_vault_secret#create AzureTenantKeyVaultSecret#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_tenant_key_vault_secret#delete AzureTenantKeyVaultSecret#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_tenant_key_vault_secret duplocloud_azure_tenant_key_vault_secret}
*/
export class AzureTenantKeyVaultSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureTenantKeyVaultSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_tenant_key_vault_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_tenant_key_vault_secret duplocloud_azure_tenant_key_vault_secret} Resource
  *
  * @param scope The scope in which to define this construct
