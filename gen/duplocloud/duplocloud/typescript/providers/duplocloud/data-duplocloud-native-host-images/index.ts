// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/native_host_images
...
export interface DataDuplocloudNativeHostImagesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/native_host_images#id DataDuplocloudNativeHostImages#id}
  *
  ...
  * The tenant ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/native_host_images#tenant_id DataDuplocloudNativeHostImages#tenant_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/native_host_images duplocloud_native_host_images}
*/
export class DataDuplocloudNativeHostImages extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudNativeHostImages that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/native_host_images#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/native_host_images duplocloud_native_host_images} Data Source
  *
  * @param scope The scope in which to define this construct
