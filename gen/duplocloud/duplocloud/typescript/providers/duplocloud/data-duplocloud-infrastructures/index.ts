// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/infrastructures
...
export interface DataDuplocloudInfrastructuresConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/infrastructures#id DataDuplocloudInfrastructures#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/infrastructures duplocloud_infrastructures}
*/
export class DataDuplocloudInfrastructures extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudInfrastructures that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/infrastructures#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/infrastructures duplocloud_infrastructures} Data Source
  *
  * @param scope The scope in which to define this construct
