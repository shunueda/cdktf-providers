// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition
...
export interface AwsBatchJobDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#container_properties AwsBatchJobDefinition#container_properties}
  */
  readonly containerProperties?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#id AwsBatchJobDefinition#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#name AwsBatchJobDefinition#name}
  */
  readonly name: string;
  /**
  * Specifies the parameter substitution placeholders to set in the job definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#parameters AwsBatchJobDefinition#parameters}
  */
  readonly parameters?: { [key: string]: string };
  /**
  * The platform capabilities required by the job definition. If no value is specified, it defaults to `EC2`. To run the job on Fargate resources, specify `FARGATE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#platform_capabilities AwsBatchJobDefinition#platform_capabilities}
  */
  readonly platformCapabilities?: string[];
  /**
  * Key-value map of resource tags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#tags AwsBatchJobDefinition#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The GUID of the tenant that the aws batch Job Definition will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#tenant_id AwsBatchJobDefinition#tenant_id}
  */
  readonly tenantId: string;
  /**
  * The `type` of job definition. Must be `container`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#type AwsBatchJobDefinition#type}
  */
  readonly type: string;
  /**
  * retry_strategy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#retry_strategy AwsBatchJobDefinition#retry_strategy}
  */
  readonly retryStrategy?: AwsBatchJobDefinitionRetryStrategy;
  /**
  * timeout block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#timeout AwsBatchJobDefinition#timeout}
  */
  readonly timeout?: AwsBatchJobDefinitionTimeout;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#timeouts AwsBatchJobDefinition#timeouts}
  */
...
export interface AwsBatchJobDefinitionRetryStrategyEvaluateOnExit {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#action AwsBatchJobDefinition#action}
  */
  readonly action: string;
  /**
  * A glob pattern to match against the decimal representation of the exit code returned for a job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#on_exit_code AwsBatchJobDefinition#on_exit_code}
  */
  readonly onExitCode?: string;
  /**
  * A glob pattern to match against the reason returned for a job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#on_reason AwsBatchJobDefinition#on_reason}
  */
  readonly onReason?: string;
  /**
  * A glob pattern to match against the status reason returned for a job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#on_status_reason AwsBatchJobDefinition#on_status_reason}
  */
...
export interface AwsBatchJobDefinitionRetryStrategy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#attempts AwsBatchJobDefinition#attempts}
  */
  readonly attempts?: number;
  /**
  * evaluate_on_exit block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#evaluate_on_exit AwsBatchJobDefinition#evaluate_on_exit}
  */
...
export interface AwsBatchJobDefinitionTimeout {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#attempt_duration_seconds AwsBatchJobDefinition#attempt_duration_seconds}
  */
...
export interface AwsBatchJobDefinitionTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#create AwsBatchJobDefinition#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#delete AwsBatchJobDefinition#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition duplocloud_aws_batch_job_definition}
*/
export class AwsBatchJobDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsBatchJobDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_batch_job_definition duplocloud_aws_batch_job_definition} Resource
  *
  * @param scope The scope in which to define this construct
