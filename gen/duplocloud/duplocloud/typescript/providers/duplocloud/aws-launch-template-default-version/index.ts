// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_launch_template_default_version
...
export interface AwsLaunchTemplateDefaultVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_launch_template_default_version#default_version AwsLaunchTemplateDefaultVersion#default_version}
  */
  readonly defaultVersion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_launch_template_default_version#id AwsLaunchTemplateDefaultVersion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_launch_template_default_version#name AwsLaunchTemplateDefaultVersion#name}
  */
  readonly name: string;
  /**
  * The GUID of the tenant that the launch template will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_launch_template_default_version#tenant_id AwsLaunchTemplateDefaultVersion#tenant_id}
  */
  readonly tenantId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_launch_template_default_version#timeouts AwsLaunchTemplateDefaultVersion#timeouts}
  */
  readonly timeouts?: AwsLaunchTemplateDefaultVersionTimeouts;
}
export interface AwsLaunchTemplateDefaultVersionTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_launch_template_default_version#create AwsLaunchTemplateDefaultVersion#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_launch_template_default_version#delete AwsLaunchTemplateDefaultVersion#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_launch_template_default_version#update AwsLaunchTemplateDefaultVersion#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_launch_template_default_version duplocloud_aws_launch_template_default_version}
*/
export class AwsLaunchTemplateDefaultVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsLaunchTemplateDefaultVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_launch_template_default_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_launch_template_default_version duplocloud_aws_launch_template_default_version} Resource
  *
  * @param scope The scope in which to define this construct
