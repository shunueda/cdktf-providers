// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents
...
export interface OtherAgentsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#id OtherAgents#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#name OtherAgents#name}
  */
  readonly name: string;
  /**
  * agent block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#agent OtherAgents#agent}
  */
  readonly agent: OtherAgentsAgent[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#timeouts OtherAgents#timeouts}
  */
  readonly timeouts?: OtherAgentsTimeouts;
}
export interface OtherAgentsAgent {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#agent_linux_package_path OtherAgents#agent_linux_package_path}
  */
  readonly agentLinuxPackagePath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#agent_name OtherAgents#agent_name}
  */
  readonly agentName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#agent_windows_package_path OtherAgents#agent_windows_package_path}
  */
  readonly agentWindowsPackagePath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#linux_agent_install_status_cmd OtherAgents#linux_agent_install_status_cmd}
  */
  readonly linuxAgentInstallStatusCmd?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#linux_agent_service_name OtherAgents#linux_agent_service_name}
  */
  readonly linuxAgentServiceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#linux_agent_uninstall_status_cmd OtherAgents#linux_agent_uninstall_status_cmd}
  */
  readonly linuxAgentUninstallStatusCmd?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#linux_install_cmd OtherAgents#linux_install_cmd}
  */
  readonly linuxInstallCmd?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#windows_agent_service_name OtherAgents#windows_agent_service_name}
  */
...
export interface OtherAgentsTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#create OtherAgents#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#delete OtherAgents#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents duplocloud_other_agents}
*/
export class OtherAgents extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OtherAgents that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/other_agents duplocloud_other_agents} Resource
  *
  * @param scope The scope in which to define this construct
