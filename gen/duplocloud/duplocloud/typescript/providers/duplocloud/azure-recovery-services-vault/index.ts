// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_recovery_services_vault
...
export interface AzureRecoveryServicesVaultConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_recovery_services_vault#id AzureRecoveryServicesVault#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_recovery_services_vault#infra_name AzureRecoveryServicesVault#infra_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_recovery_services_vault#name AzureRecoveryServicesVault#name}
  */
  readonly name: string;
  /**
  * The name of the resource group in which to create the Recovery Services Vault. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_recovery_services_vault#resource_group_name AzureRecoveryServicesVault#resource_group_name}
  */
  readonly resourceGroupName?: string;
  /**
  * Whether or not to wait until Recovery Services Vault to be ready, after creation. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_recovery_services_vault#wait_until_ready AzureRecoveryServicesVault#wait_until_ready}
  */
  readonly waitUntilReady?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_recovery_services_vault#timeouts AzureRecoveryServicesVault#timeouts}
  */
  readonly timeouts?: AzureRecoveryServicesVaultTimeouts;
}
export interface AzureRecoveryServicesVaultTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_recovery_services_vault#create AzureRecoveryServicesVault#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_recovery_services_vault#delete AzureRecoveryServicesVault#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_recovery_services_vault duplocloud_azure_recovery_services_vault}
*/
export class AzureRecoveryServicesVault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureRecoveryServicesVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_recovery_services_vault#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_recovery_services_vault duplocloud_azure_recovery_services_vault} Resource
  *
  * @param scope The scope in which to define this construct
