// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository
...
export interface K8HelmRepositoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#helm_provider K8HelmRepository#helm_provider}
  */
  readonly helmProvider?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#id K8HelmRepository#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#insecure K8HelmRepository#insecure}
  */
  readonly insecure?: boolean | cdktf.IResolvable;
  /**
  * The interval associated to helm repository Defaults to `5m0s`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#interval K8HelmRepository#interval}
  */
  readonly interval?: string;
  /**
  * The identifier name for the helm repository in duplocloud
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#name K8HelmRepository#name}
  */
  readonly name: string;
  /**
  * Pass credentials even to a different host than the one used in url
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#pass_credentials K8HelmRepository#pass_credentials}
  */
  readonly passCredentials?: boolean | cdktf.IResolvable;
  /**
  * Used to pause the reconciliation of the repository by the controller.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#suspend K8HelmRepository#suspend}
  */
  readonly suspend?: boolean | cdktf.IResolvable;
  /**
  * The GUID of the tenant that the storage bucket will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#tenant_id K8HelmRepository#tenant_id}
  */
  readonly tenantId: string;
  /**
  * The Helm repository type. Possible values are default for a Helm HTTP/S repository, or oci for an OCI Helm repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#type K8HelmRepository#type}
  */
  readonly type?: string;
  /**
  * The url of helm repository to be attached
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#url K8HelmRepository#url}
  */
  readonly url: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#timeouts K8HelmRepository#timeouts}
  */
  readonly timeouts?: K8HelmRepositoryTimeouts;
}
export interface K8HelmRepositoryTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#create K8HelmRepository#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#delete K8HelmRepository#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#update K8HelmRepository#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository duplocloud_k8_helm_repository}
*/
export class K8HelmRepository extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing K8HelmRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/k8_helm_repository duplocloud_k8_helm_repository} Resource
  *
  * @param scope The scope in which to define this construct
