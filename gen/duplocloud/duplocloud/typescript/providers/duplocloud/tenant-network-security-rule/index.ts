// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule
...
export interface TenantNetworkSecurityRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule#description TenantNetworkSecurityRule#description}
  */
  readonly description: string;
  /**
  * The start of a port range to allow traffic to. Defaults to `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule#from_port TenantNetworkSecurityRule#from_port}
  */
  readonly fromPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule#id TenantNetworkSecurityRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule#protocol TenantNetworkSecurityRule#protocol}
  */
  readonly protocol?: string;
  /**
  * The source CIDR block to allow traffic from. Only one of `source_tenant` or `source_address` may be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule#source_address TenantNetworkSecurityRule#source_address}
  */
  readonly sourceAddress?: string;
  /**
  * The source tenant name (*not* GUID) to allow traffic from. Only one of `source_tenant` or `source_address` may be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule#source_tenant TenantNetworkSecurityRule#source_tenant}
  */
  readonly sourceTenant?: string;
  /**
  * The GUID of the tenant that the network security rule will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule#tenant_id TenantNetworkSecurityRule#tenant_id}
  */
  readonly tenantId: string;
  /**
  * The end of a port range to allow traffic to. Defaults to `65535`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule#to_port TenantNetworkSecurityRule#to_port}
  */
  readonly toPort?: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule#timeouts TenantNetworkSecurityRule#timeouts}
  */
  readonly timeouts?: TenantNetworkSecurityRuleTimeouts;
}
export interface TenantNetworkSecurityRuleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule#create TenantNetworkSecurityRule#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule#delete TenantNetworkSecurityRule#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule#update TenantNetworkSecurityRule#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule duplocloud_tenant_network_security_rule}
*/
export class TenantNetworkSecurityRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TenantNetworkSecurityRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/tenant_network_security_rule duplocloud_tenant_network_security_rule} Resource
  *
  * @param scope The scope in which to define this construct
