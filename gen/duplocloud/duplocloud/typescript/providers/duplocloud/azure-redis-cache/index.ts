// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache
...
export interface AzureRedisCacheConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#capacity AzureRedisCache#capacity}
  */
  readonly capacity: number;
  /**
  * Enable the non-SSL port (6379) Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#enable_non_ssl_port AzureRedisCache#enable_non_ssl_port}
  */
  readonly enableNonSslPort?: boolean | cdktf.IResolvable;
  /**
  * The SKU family/pricing group to use. Valid values are `C` (for Basic/Standard SKU family) and `P` (for `Premium`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#family AzureRedisCache#family}
  */
  readonly family: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#id AzureRedisCache#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#minimum_tls_version AzureRedisCache#minimum_tls_version}
  */
  readonly minimumTlsVersion?: string;
  /**
  * The name of the Redis instance. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#name AzureRedisCache#name}
  */
  readonly name: string;
  /**
  * Redis version. Only major version needed. Valid values: `4`, `6`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#redis_version AzureRedisCache#redis_version}
  */
  readonly redisVersion?: string;
  /**
  * Only available when using the Premium SKU The number of Shards to create on the Redis Cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#shard_count AzureRedisCache#shard_count}
  */
  readonly shardCount?: number;
  /**
  * The SKU of Redis to use. Possible values are `Basic`, `Standard` and `Premium`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#sku_name AzureRedisCache#sku_name}
  */
  readonly skuName: string;
  /**
  * Only available when using the Premium SKU The ID of the Subnet within which the Redis Cache should be deployed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#subnet_id AzureRedisCache#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * The GUID of the tenant that the azure redis cache will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#tenant_id AzureRedisCache#tenant_id}
  */
  readonly tenantId: string;
  /**
  * Whether or not to wait until Redis cache instance to be ready, after creation. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#wait_until_ready AzureRedisCache#wait_until_ready}
  */
  readonly waitUntilReady?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#timeouts AzureRedisCache#timeouts}
  */
  readonly timeouts?: AzureRedisCacheTimeouts;
}
export interface AzureRedisCacheTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#create AzureRedisCache#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#delete AzureRedisCache#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache duplocloud_azure_redis_cache}
*/
export class AzureRedisCache extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureRedisCache that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_redis_cache duplocloud_azure_redis_cache} Resource
  *
  * @param scope The scope in which to define this construct
