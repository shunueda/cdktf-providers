// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance
...
export interface GcpSqlDatabaseInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#database_version GcpSqlDatabaseInstance#database_version}
  */
  readonly databaseVersion: string;
  /**
  * The size of data disk, in GB. Size of a running instance cannot be reduced but can be increased. The minimum value is 10GB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#disk_size GcpSqlDatabaseInstance#disk_size}
  */
  readonly diskSize?: number;
  /**
  * Edition for the database. Valid value ENTERPRISE, ENTERPRISE_PLUS Defaults to `ENTERPRISE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#edition GcpSqlDatabaseInstance#edition}
  */
  readonly edition?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#id GcpSqlDatabaseInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#labels GcpSqlDatabaseInstance#labels}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#name GcpSqlDatabaseInstance#name}
  */
  readonly name: string;
  /**
  * Flag to enable backup process on delete of database Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#need_backup GcpSqlDatabaseInstance#need_backup}
  */
  readonly needBackup?: boolean | cdktf.IResolvable;
  /**
  * Provide root password for specific database versions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#root_password GcpSqlDatabaseInstance#root_password}
  */
  readonly rootPassword?: string;
  /**
  * The GUID of the tenant that the sql database will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#tenant_id GcpSqlDatabaseInstance#tenant_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#tier GcpSqlDatabaseInstance#tier}
  */
  readonly tier: string;
  /**
  * Whether or not to wait until sql database instance to be ready, after creation. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#wait_until_ready GcpSqlDatabaseInstance#wait_until_ready}
  */
  readonly waitUntilReady?: boolean | cdktf.IResolvable;
  /**
  * database_flag block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#database_flag GcpSqlDatabaseInstance#database_flag}
  */
  readonly databaseFlag?: GcpSqlDatabaseInstanceDatabaseFlag[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#timeouts GcpSqlDatabaseInstance#timeouts}
  */
...
export interface GcpSqlDatabaseInstanceDatabaseFlag {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#value GcpSqlDatabaseInstance#value}
  */
...
export interface GcpSqlDatabaseInstanceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#create GcpSqlDatabaseInstance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#delete GcpSqlDatabaseInstance#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#update GcpSqlDatabaseInstance#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance duplocloud_gcp_sql_database_instance}
*/
export class GcpSqlDatabaseInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GcpSqlDatabaseInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/gcp_sql_database_instance duplocloud_gcp_sql_database_instance} Resource
  *
  * @param scope The scope in which to define this construct
