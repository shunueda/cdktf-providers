// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_datafactory
...
export interface AzureDatafactoryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_datafactory#id AzureDatafactory#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_datafactory#name AzureDatafactory#name}
  */
  readonly name: string;
  /**
  * Enable or disable public access to datafactory Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_datafactory#public_access AzureDatafactory#public_access}
  */
  readonly publicAccess?: boolean | cdktf.IResolvable;
  /**
  * The GUID of the tenant that the azure node pool will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_datafactory#tenant_id AzureDatafactory#tenant_id}
  */
  readonly tenantId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_datafactory#timeouts AzureDatafactory#timeouts}
  */
  readonly timeouts?: AzureDatafactoryTimeouts;
}
export interface AzureDatafactoryTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_datafactory#create AzureDatafactory#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_datafactory#delete AzureDatafactory#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_datafactory duplocloud_azure_datafactory}
*/
export class AzureDatafactory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureDatafactory that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_datafactory#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/azure_datafactory duplocloud_azure_datafactory} Resource
  *
  * @param scope The scope in which to define this construct
