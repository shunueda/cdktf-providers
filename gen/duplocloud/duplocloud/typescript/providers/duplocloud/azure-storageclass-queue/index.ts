// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_storageclass_queue
...
export interface AzureStorageclassQueueConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_storageclass_queue#id AzureStorageclassQueue#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_storageclass_queue#name AzureStorageclassQueue#name}
  */
  readonly name: string;
  /**
  * Specifies the storage class in which to create the queue. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_storageclass_queue#storage_account_name AzureStorageclassQueue#storage_account_name}
  */
  readonly storageAccountName: string;
  /**
  * The GUID of the tenant that the azure storage class queue will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_storageclass_queue#tenant_id AzureStorageclassQueue#tenant_id}
  */
  readonly tenantId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_storageclass_queue#timeouts AzureStorageclassQueue#timeouts}
  */
  readonly timeouts?: AzureStorageclassQueueTimeouts;
}
export interface AzureStorageclassQueueTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_storageclass_queue#create AzureStorageclassQueue#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_storageclass_queue#delete AzureStorageclassQueue#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_storageclass_queue duplocloud_azure_storageclass_queue}
*/
export class AzureStorageclassQueue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureStorageclassQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_storageclass_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_storageclass_queue duplocloud_azure_storageclass_queue} Resource
  *
  * @param scope The scope in which to define this construct
