// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/eks_credentials
...
export interface DataDuplocloudEksCredentialsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/eks_credentials#id DataDuplocloudEksCredentials#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/eks_credentials#plan_id DataDuplocloudEksCredentials#plan_id}
  */
  readonly planId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/eks_credentials duplocloud_eks_credentials}
*/
export class DataDuplocloudEksCredentials extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudEksCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/eks_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/eks_credentials duplocloud_eks_credentials} Data Source
  *
  * @param scope The scope in which to define this construct
