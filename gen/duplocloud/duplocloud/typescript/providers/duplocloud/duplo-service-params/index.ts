// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params
...
export interface DuploServiceParamsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#dns_prfx DuploServiceParams#dns_prfx}
  */
  readonly dnsPrfx?: string;
  /**
  * Whether or not to drop invalid HTTP headers received by the load balancer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#drop_invalid_headers DuploServiceParams#drop_invalid_headers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#enable_access_logs DuploServiceParams#enable_access_logs}
  */
  readonly enableAccessLogs?: boolean | cdktf.IResolvable;
  /**
  * Whether or not to enable http to https redirection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#http_to_https_redirect DuploServiceParams#http_to_https_redirect}
  */
  readonly httpToHttpsRedirect?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#id DuploServiceParams#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#idle_timeout DuploServiceParams#idle_timeout}
  */
  readonly idleTimeout?: number;
  /**
  * The name of the duplo service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#replication_controller_name DuploServiceParams#replication_controller_name}
  */
  readonly replicationControllerName: string;
  /**
  * The GUID of the tenant that hosts the duplo service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#tenant_id DuploServiceParams#tenant_id}
  */
  readonly tenantId: string;
  /**
  * The ARN of a web application firewall to associate this load balancer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#webaclid DuploServiceParams#webaclid}
  */
  readonly webaclid?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#timeouts DuploServiceParams#timeouts}
  */
  readonly timeouts?: DuploServiceParamsTimeouts;
}
export interface DuploServiceParamsTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#create DuploServiceParams#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#delete DuploServiceParams#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#update DuploServiceParams#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params duplocloud_duplo_service_params}
*/
export class DuploServiceParams extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DuploServiceParams that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/duplo_service_params duplocloud_duplo_service_params} Resource
  *
  * @param scope The scope in which to define this construct
