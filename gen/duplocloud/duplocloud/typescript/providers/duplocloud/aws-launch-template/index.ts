// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template
...
export interface AwsLaunchTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#ami AwsLaunchTemplate#ami}
  */
  readonly ami?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#id AwsLaunchTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#instance_type AwsLaunchTemplate#instance_type}
  */
  readonly instanceType: string;
  /**
  * The fullname of the asg group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#name AwsLaunchTemplate#name}
  */
  readonly name: string;
  /**
  * The GUID of the tenant that the launch template will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#tenant_id AwsLaunchTemplate#tenant_id}
  */
  readonly tenantId: string;
  /**
  * Any of the existing version of the launch template, if not provided, the latest version will be used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#version AwsLaunchTemplate#version}
  */
  readonly version?: string;
  /**
  * The version of the launch template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#version_description AwsLaunchTemplate#version_description}
  */
  readonly versionDescription?: string;
  /**
  * block_device_mapping block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#block_device_mapping AwsLaunchTemplate#block_device_mapping}
  */
  readonly blockDeviceMapping?: AwsLaunchTemplateBlockDeviceMapping[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#timeouts AwsLaunchTemplate#timeouts}
  */
...
export interface AwsLaunchTemplateBlockDeviceMappingEbs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#delete_on_termination AwsLaunchTemplate#delete_on_termination}
  */
  readonly deleteOnTermination?: boolean | cdktf.IResolvable;
  /**
  * Enables EBS encryption on the volume. Cannot be used with snapshot_id Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#encrypted AwsLaunchTemplate#encrypted}
  */
  readonly encrypted?: boolean | cdktf.IResolvable;
  /**
  * The amount of provisioned IOPS. This must be set with a volume_type of 'io1/io2/gp3'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#iops AwsLaunchTemplate#iops}
  */
  readonly iops?: number;
  /**
  * The ARN of the KMS Key to use when encrypting the volume (if encrypted is true).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#kms_key_id AwsLaunchTemplate#kms_key_id}
  */
  readonly kmsKeyId?: string;
  /**
  * The Snapshot ID to mount. Should not be used if encrypted is true
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#snapshot_id AwsLaunchTemplate#snapshot_id}
  */
  readonly snapshotId?: string;
  /**
  * The throughput to provision for a 'gp3' volume in MiB/s. Minumum value of 125 and maximum of 1000.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#throughput AwsLaunchTemplate#throughput}
  */
  readonly throughput?: number;
  /**
  * The volume initialization rate in MiB/s, with a minimum of 100 MiB/s and maximum of 300 MiB/s.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#volume_initialization_rate AwsLaunchTemplate#volume_initialization_rate}
  */
  ...
  * 									standard: 1 - 1024 GiB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#volume_size AwsLaunchTemplate#volume_size}
  */
  readonly volumeSize?: number;
  /**
  * The volume type. Can be one of standard, gp2, gp3, io1, io2, sc1 or st1
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#volume_type AwsLaunchTemplate#volume_type}
  */
...
export interface AwsLaunchTemplateBlockDeviceMapping {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#device_name AwsLaunchTemplate#device_name}
  */
  readonly deviceName: string;
  /**
  * Suppresses the specified device included in the AMI's block device mapping.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#no_device AwsLaunchTemplate#no_device}
  */
  readonly noDevice?: string;
  /**
  * The virtual device name (ephemeralN). Instance store volumes are numbered starting from 0. An instance type with 2 available instance store volumes can specify mappings for ephemeral0 and ephemeral1. The number of available instance store volumes depends on the instance type. After you connect to the instance, you must mount the volume.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#virtual_name AwsLaunchTemplate#virtual_name}
  */
  readonly virtualName?: string;
  /**
  * ebs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#ebs AwsLaunchTemplate#ebs}
  */
...
export interface AwsLaunchTemplateTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#create AwsLaunchTemplate#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#delete AwsLaunchTemplate#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#update AwsLaunchTemplate#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template duplocloud_aws_launch_template}
*/
export class AwsLaunchTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsLaunchTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/aws_launch_template duplocloud_aws_launch_template} Resource
  *
  * @param scope The scope in which to define this construct
