// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/plan_kms
...
export interface DataDuplocloudPlanKmsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/plan_kms#id DataDuplocloudPlanKms#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/plan_kms#kms_name DataDuplocloudPlanKms#kms_name}
  */
  readonly kmsName: string;
  /**
  * The ID of the plan to configure.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/plan_kms#plan_id DataDuplocloudPlanKms#plan_id}
  */
  readonly planId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/plan_kms duplocloud_plan_kms}
*/
export class DataDuplocloudPlanKms extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudPlanKms that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/plan_kms#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/plan_kms duplocloud_plan_kms} Data Source
  *
  * @param scope The scope in which to define this construct
