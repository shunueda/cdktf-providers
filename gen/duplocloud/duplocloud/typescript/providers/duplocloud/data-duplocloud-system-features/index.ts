// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/system_features
...
export interface DataDuplocloudSystemFeaturesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/system_features#id DataDuplocloudSystemFeatures#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/system_features duplocloud_system_features}
*/
export class DataDuplocloudSystemFeatures extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudSystemFeatures that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/system_features#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/system_features duplocloud_system_features} Data Source
  *
  * @param scope The scope in which to define this construct
