// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2
...
export interface GcpStorageBucketV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2#allow_public_access GcpStorageBucketV2#allow_public_access}
  */
  readonly allowPublicAccess?: boolean | cdktf.IResolvable;
  /**
  * Whether or not to enable versioning.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2#enable_versioning GcpStorageBucketV2#enable_versioning}
  */
  readonly enableVersioning?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2#id GcpStorageBucketV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2#labels GcpStorageBucketV2#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The location is to set region/multi region, applicable for gcp cloud.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2#location GcpStorageBucketV2#location}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2#name GcpStorageBucketV2#name}
  */
  readonly name: string;
  /**
  * The GUID of the tenant that the storage bucket will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2#tenant_id GcpStorageBucketV2#tenant_id}
  */
  readonly tenantId: string;
  /**
  * default_encryption block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2#default_encryption GcpStorageBucketV2#default_encryption}
  */
  readonly defaultEncryption?: GcpStorageBucketV2DefaultEncryption;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2#timeouts GcpStorageBucketV2#timeouts}
  */
...
export interface GcpStorageBucketV2DefaultEncryption {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2#method GcpStorageBucketV2#method}
  */
...
export interface GcpStorageBucketV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2#create GcpStorageBucketV2#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2#delete GcpStorageBucketV2#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2 duplocloud_gcp_storage_bucket_v2}
*/
export class GcpStorageBucketV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GcpStorageBucketV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/gcp_storage_bucket_v2 duplocloud_gcp_storage_bucket_v2} Resource
  *
  * @param scope The scope in which to define this construct
