...
export function tenantK8SResourceQuotaTimeoutsToTerraform(struct?: TenantK8SResourceQuotaTimeouts | cdktf.IResolvable): any {
...
export function tenantK8SResourceQuotaTimeoutsToHclTerraform(struct?: TenantK8SResourceQuotaTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class TenantK8SResourceQuotaTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): TenantK8SResourceQuotaTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: TenantK8SResourceQuotaTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class TenantK8SResourceQuota extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "duplocloud_tenant_k8s_resource_quota";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "duplocloud_tenant_k8s_resource_quota", importId: importFromId, provider });
      }
  ...
  * @param options TenantK8SResourceQuotaConfig
  */
  public constructor(scope: Construct, id: string, config: TenantK8SResourceQuotaConfig) {
    super(scope, id, {
    ...
    this._scopeSelector = config.scopeSelector;
  ...
  // resource_quota - computed: false, optional: false, required: true
  private _resourceQuota?: string; 
  public get resourceQuota() {
    return this.getStringAttribute('resource_quota');
  }
  public set resourceQuota(value: string) {
  ...
  private _scopeSelector?: string; 
  public get scopeSelector() {
    return this.getStringAttribute('scope_selector');
  }
  public set scopeSelector(value: string) {
  ...
  private _timeouts = new TenantK8SResourceQuotaTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: TenantK8SResourceQuotaTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      resource_quota: cdktf.stringToTerraform(this._resourceQuota),
      scope_selector: cdktf.stringToTerraform(this._scopeSelector),
      tenant_id: cdktf.stringToTerraform(this._tenantId),
      timeouts: tenantK8SResourceQuotaTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      resource_quota: {
        value: cdktf.stringToHclTerraform(this._resourceQuota),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      scope_selector: {
        value: cdktf.stringToHclTerraform(this._scopeSelector),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      timeouts: {
        value: tenantK8SResourceQuotaTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "TenantK8SResourceQuotaTimeouts",
      },
    };
