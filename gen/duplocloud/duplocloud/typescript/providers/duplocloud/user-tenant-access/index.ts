// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/user_tenant_access
...
export interface UserTenantAccessConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/user_tenant_access#id UserTenantAccess#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/user_tenant_access#is_readonly UserTenantAccess#is_readonly}
  */
  readonly isReadonly?: boolean | cdktf.IResolvable;
  /**
  * Tenant Id to which user need to get access
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/user_tenant_access#tenant_id UserTenantAccess#tenant_id}
  */
  readonly tenantId: string;
  /**
  * The unique user name or the email.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/user_tenant_access#username UserTenantAccess#username}
  */
  readonly username: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/user_tenant_access#timeouts UserTenantAccess#timeouts}
  */
  readonly timeouts?: UserTenantAccessTimeouts;
}
export interface UserTenantAccessTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/user_tenant_access#create UserTenantAccess#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/user_tenant_access#delete UserTenantAccess#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/user_tenant_access#update UserTenantAccess#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/user_tenant_access duplocloud_user_tenant_access}
*/
export class UserTenantAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserTenantAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/user_tenant_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/user_tenant_access duplocloud_user_tenant_access} Resource
  *
  * @param scope The scope in which to define this construct
