// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool
...
export interface AzureMssqlElasticpoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool#id AzureMssqlElasticpool#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool#max_size_gb AzureMssqlElasticpool#max_size_gb}
  */
  readonly maxSizeGb?: number;
  /**
  * The name of the MS SQL elastic pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool#name AzureMssqlElasticpool#name}
  */
  readonly name: string;
  /**
  * The name of the SQL Server on which to create the elastic pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool#server_name AzureMssqlElasticpool#server_name}
  */
  readonly serverName: string;
  /**
  * The GUID of the tenant that the azure mssql elastic pool will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool#tenant_id AzureMssqlElasticpool#tenant_id}
  */
  readonly tenantId: string;
  /**
  * sku block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool#sku AzureMssqlElasticpool#sku}
  */
  readonly sku?: AzureMssqlElasticpoolSku;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool#timeouts AzureMssqlElasticpool#timeouts}
  */
  readonly timeouts?: AzureMssqlElasticpoolTimeouts;
}
export interface AzureMssqlElasticpoolSku {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool#capacity AzureMssqlElasticpool#capacity}
  */
  ...
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool#tier AzureMssqlElasticpool#tier}
  */
...
export interface AzureMssqlElasticpoolTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool#create AzureMssqlElasticpool#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool#delete AzureMssqlElasticpool#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool duplocloud_azure_mssql_elasticpool}
*/
export class AzureMssqlElasticpool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureMssqlElasticpool that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mssql_elasticpool duplocloud_azure_mssql_elasticpool} Resource
  *
  * @param scope The scope in which to define this construct
