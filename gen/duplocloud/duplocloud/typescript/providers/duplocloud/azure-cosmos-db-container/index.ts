// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container
...
export interface AzureCosmosDbContainerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container#account_name AzureCosmosDbContainer#account_name}
  */
  readonly accountName: string;
  /**
  * The name for Cosmsos DB database in which container will be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container#database_name AzureCosmosDbContainer#database_name}
  */
  readonly databaseName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container#id AzureCosmosDbContainer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container#name AzureCosmosDbContainer#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container#namespace AzureCosmosDbContainer#namespace}
  */
  readonly namespace?: string;
  /**
  * The partition key for the Cosmos DB container. This is a required field for creating a Cosmos DB container.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container#partition_key_path AzureCosmosDbContainer#partition_key_path}
  */
  readonly partitionKeyPath: string;
  /**
  * The GUID of the tenant in which the Cosmos DB database will be created for specified account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container#tenant_id AzureCosmosDbContainer#tenant_id}
  */
  readonly tenantId: string;
  /**
  * Specifies the Cosmos DB account type. Defaults to `databaseAccounts/sqlDatabases/containers`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container#type AzureCosmosDbContainer#type}
  */
  readonly type?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container#timeouts AzureCosmosDbContainer#timeouts}
  */
  readonly timeouts?: AzureCosmosDbContainerTimeouts;
}
export interface AzureCosmosDbContainerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container#create AzureCosmosDbContainer#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container#delete AzureCosmosDbContainer#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container duplocloud_azure_cosmos_db_container}
*/
export class AzureCosmosDbContainer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureCosmosDbContainer that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/azure_cosmos_db_container duplocloud_azure_cosmos_db_container} Resource
  *
  * @param scope The scope in which to define this construct
