// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_availability_set
...
export interface DataDuplocloudAzureAvailabilitySetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_availability_set#id DataDuplocloudAzureAvailabilitySet#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_availability_set#name DataDuplocloudAzureAvailabilitySet#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_availability_set#tenant_id DataDuplocloudAzureAvailabilitySet#tenant_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_availability_set duplocloud_azure_availability_set}
*/
export class DataDuplocloudAzureAvailabilitySet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudAzureAvailabilitySet that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_availability_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/azure_availability_set duplocloud_azure_availability_set} Data Source
  *
  * @param scope The scope in which to define this construct
