// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance
...
export interface GcpRedisInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#auth_enabled GcpRedisInstance#auth_enabled}
  */
  readonly authEnabled?: boolean | cdktf.IResolvable;
  /**
  * User-provided name for the instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#display_name GcpRedisInstance#display_name}
  */
  readonly displayName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#id GcpRedisInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#labels GcpRedisInstance#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Redis memory size in GiB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#memory_size_gb GcpRedisInstance#memory_size_gb}
  */
  readonly memorySizeGb: number;
  /**
  * Short name of the Redis instance. Duplo adds a prefix; retrieve the full name from `fullname`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#name GcpRedisInstance#name}
  */
  readonly name: string;
  /**
  * Enable read replica mode (can only be set during instance creation).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#read_replicas_enabled GcpRedisInstance#read_replicas_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#redis_configs GcpRedisInstance#redis_configs}
  */
  readonly redisConfigs?: { [key: string]: string };
  /**
  * Version of Redis software. Defaults to the latest supported version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#redis_version GcpRedisInstance#redis_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#replica_count GcpRedisInstance#replica_count}
  */
  readonly replicaCount?: number;
  /**
  * GUID of the tenant the Redis instance will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#tenant_id GcpRedisInstance#tenant_id}
  */
  readonly tenantId: string;
  /**
  * Service tier. Must be one of ['BASIC', 'STANDARD_HA'].
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#tier GcpRedisInstance#tier}
  */
  readonly tier: string;
  /**
  * Enable TLS for the Redis instance. Defaults to disabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#transit_encryption_enabled GcpRedisInstance#transit_encryption_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#wait_until_ready GcpRedisInstance#wait_until_ready}
  */
  readonly waitUntilReady?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#timeouts GcpRedisInstance#timeouts}
  */
  readonly timeouts?: GcpRedisInstanceTimeouts;
}
export interface GcpRedisInstanceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#create GcpRedisInstance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#delete GcpRedisInstance#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#update GcpRedisInstance#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance duplocloud_gcp_redis_instance}
*/
export class GcpRedisInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GcpRedisInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/gcp_redis_instance duplocloud_gcp_redis_instance} Resource
  *
  * @param scope The scope in which to define this construct
