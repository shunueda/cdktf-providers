// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_rds_global_secondary
...
export interface AwsRdsGlobalSecondaryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_rds_global_secondary#cluster_identifier AwsRdsGlobalSecondary#cluster_identifier}
  */
  readonly clusterIdentifier: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_rds_global_secondary#id AwsRdsGlobalSecondary#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_rds_global_secondary#region AwsRdsGlobalSecondary#region}
  */
  readonly region: string;
  /**
  * The GUID of the tenant that the secondary RDS Global Database will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_rds_global_secondary#secondary_tenant_id AwsRdsGlobalSecondary#secondary_tenant_id}
  */
  readonly secondaryTenantId: string;
  /**
  * The GUID of the tenant that the RDS tag will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_rds_global_secondary#tenant_id AwsRdsGlobalSecondary#tenant_id}
  */
  readonly tenantId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_rds_global_secondary#timeouts AwsRdsGlobalSecondary#timeouts}
  */
  readonly timeouts?: AwsRdsGlobalSecondaryTimeouts;
}
export interface AwsRdsGlobalSecondaryTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_rds_global_secondary#create AwsRdsGlobalSecondary#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_rds_global_secondary#delete AwsRdsGlobalSecondary#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_rds_global_secondary duplocloud_aws_rds_global_secondary}
*/
export class AwsRdsGlobalSecondary extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsRdsGlobalSecondary that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_rds_global_secondary#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_rds_global_secondary duplocloud_aws_rds_global_secondary} Resource
  *
  * @param scope The scope in which to define this construct
