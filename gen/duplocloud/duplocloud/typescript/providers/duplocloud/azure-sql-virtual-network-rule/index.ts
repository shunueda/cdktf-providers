// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule
...
export interface AzureSqlVirtualNetworkRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule#id AzureSqlVirtualNetworkRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule#ignore_missing_vnet_service_endpoint AzureSqlVirtualNetworkRule#ignore_missing_vnet_service_endpoint}
  */
  readonly ignoreMissingVnetServiceEndpoint?: boolean | cdktf.IResolvable;
  /**
  * The name of the SQL virtual network rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule#name AzureSqlVirtualNetworkRule#name}
  */
  readonly name: string;
  /**
  * The name of the SQL Server to which this SQL virtual network rule will be applied to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule#server_name AzureSqlVirtualNetworkRule#server_name}
  */
  readonly serverName: string;
  /**
  * The ID of the subnet that the SQL server will be connected to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule#subnet_id AzureSqlVirtualNetworkRule#subnet_id}
  */
  readonly subnetId: string;
  /**
  * The GUID of the tenant that the sql virtual network rule will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule#tenant_id AzureSqlVirtualNetworkRule#tenant_id}
  */
  readonly tenantId: string;
  /**
  * Whether or not to wait until Redis cache instance to be ready, after creation. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule#wait_until_ready AzureSqlVirtualNetworkRule#wait_until_ready}
  */
  readonly waitUntilReady?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule#timeouts AzureSqlVirtualNetworkRule#timeouts}
  */
  readonly timeouts?: AzureSqlVirtualNetworkRuleTimeouts;
}
export interface AzureSqlVirtualNetworkRuleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule#create AzureSqlVirtualNetworkRule#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule#delete AzureSqlVirtualNetworkRule#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule duplocloud_azure_sql_virtual_network_rule}
*/
export class AzureSqlVirtualNetworkRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureSqlVirtualNetworkRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/azure_sql_virtual_network_rule duplocloud_azure_sql_virtual_network_rule} Resource
  *
  * @param scope The scope in which to define this construct
