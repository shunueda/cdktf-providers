// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh
...
export interface AsgInstanceRefreshConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#asg_name AsgInstanceRefresh#asg_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#auto_rollback AsgInstanceRefresh#auto_rollback}
  */
  readonly autoRollback?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#id AsgInstanceRefresh#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#instance_warmup AsgInstanceRefresh#instance_warmup}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#max_healthy_percentage AsgInstanceRefresh#max_healthy_percentage}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#min_healthy_percentage AsgInstanceRefresh#min_healthy_percentage}
  */
  readonly minHealthyPercentage?: number;
  /**
  * To identify instance refresh or invoke a instance refresh.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#refresh_identifier AsgInstanceRefresh#refresh_identifier}
  */
  readonly refreshIdentifier?: string;
  /**
  * The GUID of the tenant that the asg will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#tenant_id AsgInstanceRefresh#tenant_id}
  */
  readonly tenantId: string;
  /**
  * Launch template version to update
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#update_launch_template_version AsgInstanceRefresh#update_launch_template_version}
  */
  readonly updateLaunchTemplateVersion?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#timeouts AsgInstanceRefresh#timeouts}
  */
  readonly timeouts?: AsgInstanceRefreshTimeouts;
}
export interface AsgInstanceRefreshTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#create AsgInstanceRefresh#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#delete AsgInstanceRefresh#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#update AsgInstanceRefresh#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh duplocloud_asg_instance_refresh}
*/
export class AsgInstanceRefresh extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AsgInstanceRefresh that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/asg_instance_refresh duplocloud_asg_instance_refresh} Resource
  *
  * @param scope The scope in which to define this construct
