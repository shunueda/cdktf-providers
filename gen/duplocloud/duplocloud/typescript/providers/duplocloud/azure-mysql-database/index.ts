// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database
...
export interface AzureMysqlDatabaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#administrator_login AzureMysqlDatabase#administrator_login}
  */
  readonly administratorLogin?: string;
  /**
  * The Password associated with the `administrator_login` for the MySQL Server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#administrator_login_password AzureMysqlDatabase#administrator_login_password}
  */
  readonly administratorLoginPassword?: string;
  /**
  * Backup retention days for the server, supported values are between `7` and `35` days.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#backup_retention_days AzureMysqlDatabase#backup_retention_days}
  */
  readonly backupRetentionDays?: number;
  /**
  * Turn Geo-redundant server backups on/off.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#geo_redundant_backup AzureMysqlDatabase#geo_redundant_backup}
  */
  readonly geoRedundantBackup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#id AzureMysqlDatabase#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#name AzureMysqlDatabase#name}
  */
  readonly name: string;
  /**
  * Specifies the SKU Name for this MySQL Server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#sku_name AzureMysqlDatabase#sku_name}
  */
  readonly skuName: string;
  /**
  * Specifies if SSL should be enforced on connections.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#ssl_enforcement AzureMysqlDatabase#ssl_enforcement}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#storage_mb AzureMysqlDatabase#storage_mb}
  */
  readonly storageMb?: number;
  /**
  * The GUID of the tenant that the azure mysql database will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#tenant_id AzureMysqlDatabase#tenant_id}
  */
  readonly tenantId: string;
  /**
  * Specifies the version of MySQL to use. Valid values are `5.7`, or `8.0`. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#version AzureMysqlDatabase#version}
  */
  readonly version: string;
  /**
  * Whether or not to wait until MySql Server instance to be ready, after creation. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#wait_until_ready AzureMysqlDatabase#wait_until_ready}
  */
  readonly waitUntilReady?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#timeouts AzureMysqlDatabase#timeouts}
  */
  readonly timeouts?: AzureMysqlDatabaseTimeouts;
}
export interface AzureMysqlDatabaseTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#create AzureMysqlDatabase#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#delete AzureMysqlDatabase#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database duplocloud_azure_mysql_database}
*/
export class AzureMysqlDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureMysqlDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/resources/azure_mysql_database duplocloud_azure_mysql_database} Resource
  *
  * @param scope The scope in which to define this construct
