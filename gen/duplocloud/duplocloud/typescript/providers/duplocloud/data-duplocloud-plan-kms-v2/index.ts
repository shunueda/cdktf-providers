// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/plan_kms_v2
...
export interface DataDuplocloudPlanKmsV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/plan_kms_v2#name DataDuplocloudPlanKmsV2#name}
  */
  readonly name: string;
  /**
  * The plan ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/plan_kms_v2#plan_id DataDuplocloudPlanKmsV2#plan_id}
  */
  readonly planId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/plan_kms_v2 duplocloud_plan_kms_v2}
*/
export class DataDuplocloudPlanKmsV2 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudPlanKmsV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/plan_kms_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/data-sources/plan_kms_v2 duplocloud_plan_kms_v2} Data Source
  *
  * @param scope The scope in which to define this construct
