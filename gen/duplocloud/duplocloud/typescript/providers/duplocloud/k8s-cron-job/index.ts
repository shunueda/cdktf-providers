...
export interface K8SCronJobConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/k8s_cron_job#allocation_tags K8SCronJob#allocation_tags}
  */
  readonly allocationTags?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/k8s_cron_job#id K8SCronJob#id}
  *
  ...
  * Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/k8s_cron_job#is_any_host_allowed K8SCronJob#is_any_host_allowed}
  */
  readonly isAnyHostAllowed?: boolean | cdktf.IResolvable;
  /**
  * The GUID of the tenant that the job will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/k8s_cron_job#tenant_id K8SCronJob#tenant_id}
  */
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/k8s_cron_job#timeouts K8SCronJob#timeouts}
  */
  readonly timeouts?: K8SCronJobTimeouts;
}

/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/k8s_cron_job duplocloud_k8s_cron_job}
*/
export class K8SCronJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing K8SCronJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/k8s_cron_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.30/docs/resources/k8s_cron_job duplocloud_k8s_cron_job} Resource
  *
  * @param scope The scope in which to define this construct
