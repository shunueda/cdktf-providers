// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/duplo_services
...
export interface DataDuplocloudDuploServicesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/duplo_services#id DataDuplocloudDuploServices#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/duplo_services#tenant_id DataDuplocloudDuploServices#tenant_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/duplo_services duplocloud_duplo_services}
*/
export class DataDuplocloudDuploServices extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudDuploServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/duplo_services#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/data-sources/duplo_services duplocloud_duplo_services} Data Source
  *
  * @param scope The scope in which to define this construct
