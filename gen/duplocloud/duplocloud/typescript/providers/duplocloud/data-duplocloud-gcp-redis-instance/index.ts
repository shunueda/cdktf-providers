// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/gcp_redis_instance
...
export interface DataDuplocloudGcpRedisInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/gcp_redis_instance#id DataDuplocloudGcpRedisInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/gcp_redis_instance#name DataDuplocloudGcpRedisInstance#name}
  */
  readonly name: string;
  /**
  * The GUID of the tenant that the redis instance will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/gcp_redis_instance#tenant_id DataDuplocloudGcpRedisInstance#tenant_id}
  */
  readonly tenantId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/gcp_redis_instance duplocloud_gcp_redis_instance}
*/
export class DataDuplocloudGcpRedisInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudGcpRedisInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/gcp_redis_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/data-sources/gcp_redis_instance duplocloud_gcp_redis_instance} Data Source
  *
  * @param scope The scope in which to define this construct
