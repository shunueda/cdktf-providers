// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event
...
export interface AwsApigatewayEventConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#api_gateway_id AwsApigatewayEvent#api_gateway_id}
  */
  readonly apiGatewayId: string;
  /**
  * Specify if the method requires an API key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#api_key_required AwsApigatewayEvent#api_key_required}
  */
  readonly apiKeyRequired?: boolean | cdktf.IResolvable;
  /**
  * Type of authorization used for the method. (`NONE`, `CUSTOM`, `AWS_IAM`, `COGNITO_USER_POOLS`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#authorization_type AwsApigatewayEvent#authorization_type}
  */
  readonly authorizationType?: string;
  /**
  * Authorizer id to be used when the authorization is `CUSTOM` or `COGNITO_USER_POOLS`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#authorizer_id AwsApigatewayEvent#authorizer_id}
  */
  readonly authorizerId?: string;
  /**
  * How to handle request payload content type conversions. Supported values are `CONVERT_TO_BINARY` and `CONVERT_TO_TEXT`. If this property is not defined, the request payload will be passed through from the method request to integration request without modification, provided that the passthroughBehaviors is configured to support payload pass-through.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#content_handling AwsApigatewayEvent#content_handling}
  */
  readonly contentHandling?: string;
  /**
  * Enable handling of preflight requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#cors AwsApigatewayEvent#cors}
  */
  readonly cors?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#id AwsApigatewayEvent#id}
  *
  ...
  * HTTP Method.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#method AwsApigatewayEvent#method}
  */
  readonly method: string;
  /**
  * The path segment of API resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#path AwsApigatewayEvent#path}
  */
  readonly path: string;
  /**
  * The GUID of the tenant that the API gateway event will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#tenant_id AwsApigatewayEvent#tenant_id}
  */
  readonly tenantId: string;
  /**
  * integration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#integration AwsApigatewayEvent#integration}
  */
  readonly integration: AwsApigatewayEventIntegration;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#timeouts AwsApigatewayEvent#timeouts}
  */
...
export interface AwsApigatewayEventIntegration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#timeout AwsApigatewayEvent#timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#type AwsApigatewayEvent#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#uri AwsApigatewayEvent#uri}
  */
  readonly uri: string;
}
...
export interface AwsApigatewayEventTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#create AwsApigatewayEvent#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#delete AwsApigatewayEvent#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#update AwsApigatewayEvent#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event duplocloud_aws_apigateway_event}
*/
export class AwsApigatewayEvent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsApigatewayEvent that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.31/docs/resources/aws_apigateway_event duplocloud_aws_apigateway_event} Resource
  *
  * @param scope The scope in which to define this construct
