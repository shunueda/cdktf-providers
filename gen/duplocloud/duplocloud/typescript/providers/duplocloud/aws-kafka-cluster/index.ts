// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster
...
export interface AwsKafkaClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#configuration_arn AwsKafkaCluster#configuration_arn}
  */
  readonly configurationArn?: string;
  /**
  * An revision of a Kafka configuration to apply to the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#configuration_revision AwsKafkaCluster#configuration_revision}
  */
  readonly configurationRevision?: number;
  /**
  * Encryption setting for data in transit between clients and brokers. Valid values: `TLS`, `TLS_PLAINTEXT`, and `PLAINTEXT`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#encryption_in_transit AwsKafkaCluster#encryption_in_transit}
  */
  readonly encryptionInTransit?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#id AwsKafkaCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#instance_type AwsKafkaCluster#instance_type}
  */
  readonly instanceType: string;
  /**
  * The version of the Kafka cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#kafka_version AwsKafkaCluster#kafka_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#name AwsKafkaCluster#name}
  */
  readonly name: string;
  /**
  * The size of the Kafka storage, in gigabytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#storage_size AwsKafkaCluster#storage_size}
  */
  readonly storageSize: number;
  /**
  * The list of subnets that the cluster will be launched in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#subnets AwsKafkaCluster#subnets}
  */
  readonly subnets?: string[];
  /**
  * The GUID of the tenant that the Kafka cluster will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#tenant_id AwsKafkaCluster#tenant_id}
  */
  readonly tenantId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#timeouts AwsKafkaCluster#timeouts}
  */
  readonly timeouts?: AwsKafkaClusterTimeouts;
}
export interface AwsKafkaClusterTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#create AwsKafkaCluster#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#delete AwsKafkaCluster#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#update AwsKafkaCluster#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster duplocloud_aws_kafka_cluster}
*/
export class AwsKafkaCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsKafkaCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.29/docs/resources/aws_kafka_cluster duplocloud_aws_kafka_cluster} Resource
  *
  * @param scope The scope in which to define this construct
