// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/infrastructure
...
export interface DataDuplocloudInfrastructureConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/infrastructure#id DataDuplocloudInfrastructure#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/infrastructure#infra_name DataDuplocloudInfrastructure#infra_name}
  */
  readonly infraName?: string;
  /**
  * The ID of the tenant to look up the infrastructure for. Must be specified if `infra_name` is blank.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/infrastructure#tenant_id DataDuplocloudInfrastructure#tenant_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/infrastructure duplocloud_infrastructure}
*/
export class DataDuplocloudInfrastructure extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudInfrastructure that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/infrastructure#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.28/docs/data-sources/infrastructure duplocloud_infrastructure} Data Source
  *
  * @param scope The scope in which to define this construct
