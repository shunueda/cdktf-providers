// https://registry.terraform.io/providers/northwood-labs/corefunc/2.1.0/docs/data-sources/homedir_expand
...
export interface DataCorefuncHomedirExpandConfig extends cdktf.TerraformMetaArguments {
  ...
  * The path to expand.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/northwood-labs/corefunc/2.1.0/docs/data-sources/homedir_expand#path DataCorefuncHomedirExpand#path}
  */
  readonly path: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/northwood-labs/corefunc/2.1.0/docs/data-sources/homedir_expand corefunc_homedir_expand}
*/
export class DataCorefuncHomedirExpand extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCorefuncHomedirExpand that should be imported. Refer to the {@link https://registry.terraform.io/providers/northwood-labs/corefunc/2.1.0/docs/data-sources/homedir_expand#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/northwood-labs/corefunc/2.1.0/docs/data-sources/homedir_expand corefunc_homedir_expand} Data Source
  *
  * @param scope The scope in which to define this construct
