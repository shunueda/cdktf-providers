// https://registry.terraform.io/providers/northwood-labs/corefunc/2.2.1/docs/data-sources/url_decode
...
export interface DataCorefuncUrlDecodeConfig extends cdktf.TerraformMetaArguments {
  ...
  * An encoded URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/northwood-labs/corefunc/2.2.1/docs/data-sources/url_decode#encoded_url DataCorefuncUrlDecode#encoded_url}
  */
  readonly encodedUrl: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/northwood-labs/corefunc/2.2.1/docs/data-sources/url_decode corefunc_url_decode}
*/
export class DataCorefuncUrlDecode extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCorefuncUrlDecode that should be imported. Refer to the {@link https://registry.terraform.io/providers/northwood-labs/corefunc/2.2.1/docs/data-sources/url_decode#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/northwood-labs/corefunc/2.2.1/docs/data-sources/url_decode corefunc_url_decode} Data Source
  *
  * @param scope The scope in which to define this construct
