// https://registry.terraform.io/providers/northwood-labs/corefunc/2.2.1/docs/data-sources/runtime_numcpus
...
/**
* Represents a {@link https://registry.terraform.io/providers/northwood-labs/corefunc/2.2.1/docs/data-sources/runtime_numcpus corefunc_runtime_numcpus}
*/
export class DataCorefuncRuntimeNumcpus extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCorefuncRuntimeNumcpus that should be imported. Refer to the {@link https://registry.terraform.io/providers/northwood-labs/corefunc/2.2.1/docs/data-sources/runtime_numcpus#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/northwood-labs/corefunc/2.2.1/docs/data-sources/runtime_numcpus corefunc_runtime_numcpus} Data Source
  *
  * @param scope The scope in which to define this construct
