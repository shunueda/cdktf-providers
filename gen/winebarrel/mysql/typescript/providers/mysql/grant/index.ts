// https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant
...
export interface GrantConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant#database Grant#database}
  */
  readonly database: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant#grant Grant#grant}
  */
  readonly grant?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant#host Grant#host}
  */
  readonly host?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant#id Grant#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant#privileges Grant#privileges}
  */
  readonly privileges?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant#role Grant#role}
  */
  readonly role?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant#roles Grant#roles}
  */
  readonly roles?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant#table Grant#table}
  */
  readonly table?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant#tls_option Grant#tls_option}
  */
  readonly tlsOption?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant#user Grant#user}
  */
  readonly user?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant mysql_grant}
*/
export class Grant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Grant that should be imported. Refer to the {@link https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/winebarrel/mysql/1.10.6/docs/resources/grant mysql_grant} Resource
  *
  * @param scope The scope in which to define this construct
