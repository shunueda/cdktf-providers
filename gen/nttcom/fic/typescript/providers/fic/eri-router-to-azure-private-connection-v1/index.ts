// https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1
...
export interface EriRouterToAzurePrivateConnectionV1Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#bandwidth EriRouterToAzurePrivateConnectionV1#bandwidth}
  */
  readonly bandwidth: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#destination_interconnect EriRouterToAzurePrivateConnectionV1#destination_interconnect}
  */
  readonly destinationInterconnect: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#destination_qos_type EriRouterToAzurePrivateConnectionV1#destination_qos_type}
  */
  readonly destinationQosType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#destination_service_key EriRouterToAzurePrivateConnectionV1#destination_service_key}
  */
  readonly destinationServiceKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#id EriRouterToAzurePrivateConnectionV1#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#name EriRouterToAzurePrivateConnectionV1#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#primary_connected_network_address EriRouterToAzurePrivateConnectionV1#primary_connected_network_address}
  */
  readonly primaryConnectedNetworkAddress: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#secondary_connected_network_address EriRouterToAzurePrivateConnectionV1#secondary_connected_network_address}
  */
  readonly secondaryConnectedNetworkAddress: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#source_group_name EriRouterToAzurePrivateConnectionV1#source_group_name}
  */
  readonly sourceGroupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#source_route_filter_in EriRouterToAzurePrivateConnectionV1#source_route_filter_in}
  */
  readonly sourceRouteFilterIn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#source_route_filter_out EriRouterToAzurePrivateConnectionV1#source_route_filter_out}
  */
  readonly sourceRouteFilterOut: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#source_router_id EriRouterToAzurePrivateConnectionV1#source_router_id}
  */
  readonly sourceRouterId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#timeouts EriRouterToAzurePrivateConnectionV1#timeouts}
  */
  readonly timeouts?: EriRouterToAzurePrivateConnectionV1Timeouts;
}
export interface EriRouterToAzurePrivateConnectionV1Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#create EriRouterToAzurePrivateConnectionV1#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#delete EriRouterToAzurePrivateConnectionV1#delete}
  */
  readonly delete?: string;
}

export function eriRouterToAzurePrivateConnectionV1TimeoutsToTerraform(struct?: EriRouterToAzurePrivateConnectionV1Timeouts | cdktf.IResolvable): any {
...
export function eriRouterToAzurePrivateConnectionV1TimeoutsToHclTerraform(struct?: EriRouterToAzurePrivateConnectionV1Timeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class EriRouterToAzurePrivateConnectionV1TimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EriRouterToAzurePrivateConnectionV1Timeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: EriRouterToAzurePrivateConnectionV1Timeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1 fic_eri_router_to_azure_private_connection_v1}
*/
export class EriRouterToAzurePrivateConnectionV1 extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fic_eri_router_to_azure_private_connection_v1";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a EriRouterToAzurePrivateConnectionV1 resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the EriRouterToAzurePrivateConnectionV1 to import
  * @param importFromId The id of the existing EriRouterToAzurePrivateConnectionV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the EriRouterToAzurePrivateConnectionV1 to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fic_eri_router_to_azure_private_connection_v1", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_router_to_azure_private_connection_v1 fic_eri_router_to_azure_private_connection_v1} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options EriRouterToAzurePrivateConnectionV1Config
  */
  public constructor(scope: Construct, id: string, config: EriRouterToAzurePrivateConnectionV1Config) {
    super(scope, id, {
      terraformResourceType: 'fic_eri_router_to_azure_private_connection_v1',
  ...
  private _timeouts = new EriRouterToAzurePrivateConnectionV1TimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: EriRouterToAzurePrivateConnectionV1Timeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: eriRouterToAzurePrivateConnectionV1TimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: eriRouterToAzurePrivateConnectionV1TimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "EriRouterToAzurePrivateConnectionV1Timeouts",
      },
    };
