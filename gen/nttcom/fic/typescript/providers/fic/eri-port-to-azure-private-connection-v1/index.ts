// https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1
...
export interface EriPortToAzurePrivateConnectionV1Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#bandwidth EriPortToAzurePrivateConnectionV1#bandwidth}
  */
  readonly bandwidth: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#destination_interconnect EriPortToAzurePrivateConnectionV1#destination_interconnect}
  */
  readonly destinationInterconnect: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#destination_qos_type EriPortToAzurePrivateConnectionV1#destination_qos_type}
  */
  readonly destinationQosType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#destination_service_key EriPortToAzurePrivateConnectionV1#destination_service_key}
  */
  readonly destinationServiceKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#destination_shared_key EriPortToAzurePrivateConnectionV1#destination_shared_key}
  */
  readonly destinationSharedKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#id EriPortToAzurePrivateConnectionV1#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#name EriPortToAzurePrivateConnectionV1#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#primary_connected_network_address EriPortToAzurePrivateConnectionV1#primary_connected_network_address}
  */
  readonly primaryConnectedNetworkAddress: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#secondary_connected_network_address EriPortToAzurePrivateConnectionV1#secondary_connected_network_address}
  */
  readonly secondaryConnectedNetworkAddress: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#source_asn EriPortToAzurePrivateConnectionV1#source_asn}
  */
  readonly sourceAsn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#source_primary_port_id EriPortToAzurePrivateConnectionV1#source_primary_port_id}
  */
  readonly sourcePrimaryPortId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#source_primary_vlan EriPortToAzurePrivateConnectionV1#source_primary_vlan}
  */
  readonly sourcePrimaryVlan: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#source_secondary_port_id EriPortToAzurePrivateConnectionV1#source_secondary_port_id}
  */
  readonly sourceSecondaryPortId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#source_secondary_vlan EriPortToAzurePrivateConnectionV1#source_secondary_vlan}
  */
  readonly sourceSecondaryVlan: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#timeouts EriPortToAzurePrivateConnectionV1#timeouts}
  */
  readonly timeouts?: EriPortToAzurePrivateConnectionV1Timeouts;
}
export interface EriPortToAzurePrivateConnectionV1Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#create EriPortToAzurePrivateConnectionV1#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#delete EriPortToAzurePrivateConnectionV1#delete}
  */
  readonly delete?: string;
}

export function eriPortToAzurePrivateConnectionV1TimeoutsToTerraform(struct?: EriPortToAzurePrivateConnectionV1Timeouts | cdktf.IResolvable): any {
...
export function eriPortToAzurePrivateConnectionV1TimeoutsToHclTerraform(struct?: EriPortToAzurePrivateConnectionV1Timeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class EriPortToAzurePrivateConnectionV1TimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EriPortToAzurePrivateConnectionV1Timeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: EriPortToAzurePrivateConnectionV1Timeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1 fic_eri_port_to_azure_private_connection_v1}
*/
export class EriPortToAzurePrivateConnectionV1 extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fic_eri_port_to_azure_private_connection_v1";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a EriPortToAzurePrivateConnectionV1 resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the EriPortToAzurePrivateConnectionV1 to import
  * @param importFromId The id of the existing EriPortToAzurePrivateConnectionV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the EriPortToAzurePrivateConnectionV1 to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fic_eri_port_to_azure_private_connection_v1", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nttcom/fic/0.5.6/docs/resources/eri_port_to_azure_private_connection_v1 fic_eri_port_to_azure_private_connection_v1} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options EriPortToAzurePrivateConnectionV1Config
  */
  public constructor(scope: Construct, id: string, config: EriPortToAzurePrivateConnectionV1Config) {
    super(scope, id, {
      terraformResourceType: 'fic_eri_port_to_azure_private_connection_v1',
  ...
  private _timeouts = new EriPortToAzurePrivateConnectionV1TimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: EriPortToAzurePrivateConnectionV1Timeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: eriPortToAzurePrivateConnectionV1TimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: eriPortToAzurePrivateConnectionV1TimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "EriPortToAzurePrivateConnectionV1Timeouts",
      },
    };
