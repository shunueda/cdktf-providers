...
export interface DataOvirtAffinityGroupConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DataOvirtAffinityGroup extends cdktf.TerraformDataSource {
  ...
  * @param options DataOvirtAffinityGroupConfig
  */
  public constructor(scope: Construct, id: string, config: DataOvirtAffinityGroupConfig) {
    super(scope, id, {
