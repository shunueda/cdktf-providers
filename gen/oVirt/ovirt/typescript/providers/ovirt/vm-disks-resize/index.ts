// https://registry.terraform.io/providers/ovirt/ovirt/2.2.0/docs/resources/vm_disks_resize
...
export interface VmDisksResizeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovirt/ovirt/2.2.0/docs/resources/vm_disks_resize#id VmDisksResize#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovirt/ovirt/2.2.0/docs/resources/vm_disks_resize#size VmDisksResize#size}
  */
  readonly size: number;
  /**
  * Resize all disks in this VM to the specified size.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovirt/ovirt/2.2.0/docs/resources/vm_disks_resize#vm_id VmDisksResize#vm_id}
  */
  readonly vmId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovirt/ovirt/2.2.0/docs/resources/vm_disks_resize ovirt_vm_disks_resize}
*/
export class VmDisksResize extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VmDisksResize that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovirt/ovirt/2.2.0/docs/resources/vm_disks_resize#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovirt/ovirt/2.2.0/docs/resources/vm_disks_resize ovirt_vm_disks_resize} Resource
  *
  * @param scope The scope in which to define this construct
