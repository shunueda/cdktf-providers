// https://registry.terraform.io/providers/cloudflare/cloudflare/5.14.0/docs/resources/stream_watermark
...
export class StreamWatermarkA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamWatermarkA that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.14.0/docs/resources/stream_watermark#import import section} in the documentation of this resource for the id to use
