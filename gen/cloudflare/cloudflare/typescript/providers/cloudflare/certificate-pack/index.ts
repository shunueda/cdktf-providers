// https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/certificate_pack
...
export interface CertificatePackConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/certificate_pack#certificate_authority CertificatePack#certificate_authority}
  */
  readonly certificateAuthority: string;
  /**
  * Whether or not to add Cloudflare Branding for the order.  This will add a subdomain of sni.cloudflaressl.com as the Common Name if set to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/certificate_pack#cloudflare_branding CertificatePack#cloudflare_branding}
  */
  readonly cloudflareBranding?: boolean | cdktf.IResolvable;
  /**
  * Comma separated list of valid host names for the certificate packs. Must contain the zone apex, may not contain more than 50 hosts, and may not be empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/certificate_pack#hosts CertificatePack#hosts}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/certificate_pack#type CertificatePack#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/certificate_pack#validation_method CertificatePack#validation_method}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/certificate_pack#validity_days CertificatePack#validity_days}
  */
  readonly validityDays: number;
  /**
  * Identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/certificate_pack#zone_id CertificatePack#zone_id}
  */
...
export function certificatePackCertificatesGeoRestrictionsToTerraform(struct?: CertificatePackCertificatesGeoRestrictions): any {
...
export function certificatePackCertificatesGeoRestrictionsToHclTerraform(struct?: CertificatePackCertificatesGeoRestrictions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CertificatePackCertificatesGeoRestrictionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CertificatePackCertificatesGeoRestrictions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: CertificatePackCertificatesGeoRestrictions | undefined) {
    if (value === undefined) {
...
export function certificatePackCertificatesToTerraform(struct?: CertificatePackCertificates): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function certificatePackCertificatesToHclTerraform(struct?: CertificatePackCertificates): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CertificatePackCertificatesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CertificatePackCertificates | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: CertificatePackCertificates | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _geoRestrictions = new CertificatePackCertificatesGeoRestrictionsOutputReference(this, "geo_restrictions");
...
export class CertificatePackCertificatesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): CertificatePackCertificatesOutputReference {
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/certificate_pack cloudflare_certificate_pack}
*/
export class CertificatePack extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertificatePack that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/certificate_pack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/certificate_pack cloudflare_certificate_pack} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _certificates = new CertificatePackCertificatesList(this, "certificates", false);
