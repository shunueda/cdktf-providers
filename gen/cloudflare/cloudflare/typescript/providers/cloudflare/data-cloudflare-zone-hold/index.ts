// https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/zone_hold
...
export interface DataCloudflareZoneHoldConfig extends cdktf.TerraformMetaArguments {
  ...
  * Identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/zone_hold#zone_id DataCloudflareZoneHold#zone_id}
  */
  readonly zoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/zone_hold cloudflare_zone_hold}
*/
export class DataCloudflareZoneHold extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareZoneHold that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/zone_hold#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/zone_hold cloudflare_zone_hold} Data Source
  *
  * @param scope The scope in which to define this construct
