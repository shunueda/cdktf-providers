// https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/zone_setting
...
export interface DataCloudflareZoneSettingConfig extends cdktf.TerraformMetaArguments {
  ...
  * Setting name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/zone_setting#setting_id DataCloudflareZoneSetting#setting_id}
  */
  readonly settingId: string;
  /**
  * Identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/zone_setting#zone_id DataCloudflareZoneSetting#zone_id}
  */
  readonly zoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/zone_setting cloudflare_zone_setting}
*/
export class DataCloudflareZoneSetting extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareZoneSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/zone_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/zone_setting cloudflare_zone_setting} Data Source
  *
  * @param scope The scope in which to define this construct
