// https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate
...
export interface KeylessCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate#bundle_method KeylessCertificate#bundle_method}
  */
  readonly bundleMethod?: string;
  /**
  * The zone's SSL certificate or SSL certificate and intermediate(s).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate#certificate KeylessCertificate#certificate}
  */
  readonly certificate: string;
  /**
  * Whether or not the Keyless SSL is on or off.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate#enabled KeylessCertificate#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The keyless SSL name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate#host KeylessCertificate#host}
  */
  readonly host: string;
  /**
  * The keyless SSL name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate#name KeylessCertificate#name}
  */
  readonly name?: string;
  /**
  * The keyless SSL port used to communicate between Cloudflare and the client's Keyless SSL server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate#port KeylessCertificate#port}
  */
  readonly port?: number;
  /**
  * Configuration for using Keyless SSL through a Cloudflare Tunnel
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate#tunnel KeylessCertificate#tunnel}
  */
  readonly tunnel?: KeylessCertificateTunnel;
  /**
  * Identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate#zone_id KeylessCertificate#zone_id}
  */
...
export interface KeylessCertificateTunnel {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate#private_ip KeylessCertificate#private_ip}
  */
  readonly privateIp: string;
  /**
  * Cloudflare Tunnel Virtual Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate#vnet_id KeylessCertificate#vnet_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate cloudflare_keyless_certificate}
*/
export class KeylessCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KeylessCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/keyless_certificate cloudflare_keyless_certificate} Resource
  *
  * @param scope The scope in which to define this construct
