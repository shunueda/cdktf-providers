// https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/magic_transit_site
...
export interface MagicTransitSiteConfig extends cdktf.TerraformMetaArguments {
  ...
  * Identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/magic_transit_site#account_id MagicTransitSite#account_id}
  */
  readonly accountId: string;
  /**
  * Magic Connector identifier tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/magic_transit_site#connector_id MagicTransitSite#connector_id}
  */
  readonly connectorId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/magic_transit_site#description MagicTransitSite#description}
  */
  readonly description?: string;
  /**
  * Site high availability mode. If set to true, the site can have two connectors and runs in high availability mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/magic_transit_site#ha_mode MagicTransitSite#ha_mode}
  */
  readonly haMode?: boolean | cdktf.IResolvable;
  /**
  * Location of site in latitude and longitude.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/magic_transit_site#location MagicTransitSite#location}
  */
  readonly location?: MagicTransitSiteLocation;
  /**
  * The name of the site.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/magic_transit_site#name MagicTransitSite#name}
  */
  readonly name: string;
  /**
  * Magic Connector identifier tag. Used when high availability mode is on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/magic_transit_site#secondary_connector_id MagicTransitSite#secondary_connector_id}
  */
...
export interface MagicTransitSiteLocation {
  ...
  * Latitude
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/magic_transit_site#lat MagicTransitSite#lat}
  */
  readonly lat?: string;
  /**
  * Longitude
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/magic_transit_site#lon MagicTransitSite#lon}
  */
  readonly lon?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/magic_transit_site cloudflare_magic_transit_site}
*/
export class MagicTransitSite extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MagicTransitSite that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/magic_transit_site#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/magic_transit_site cloudflare_magic_transit_site} Resource
  *
  * @param scope The scope in which to define this construct
