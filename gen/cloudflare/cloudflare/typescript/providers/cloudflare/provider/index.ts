// https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs
...
export class CloudflareProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing CloudflareProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs cloudflare} Resource
  *
  * @param scope The scope in which to define this construct
