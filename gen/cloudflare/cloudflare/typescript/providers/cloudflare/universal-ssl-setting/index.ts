// https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/universal_ssl_setting
...
export interface UniversalSslSettingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/universal_ssl_setting#enabled UniversalSslSetting#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/universal_ssl_setting#zone_id UniversalSslSetting#zone_id}
  */
  readonly zoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/universal_ssl_setting cloudflare_universal_ssl_setting}
*/
export class UniversalSslSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UniversalSslSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/universal_ssl_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/universal_ssl_setting cloudflare_universal_ssl_setting} Resource
  *
  * @param scope The scope in which to define this construct
