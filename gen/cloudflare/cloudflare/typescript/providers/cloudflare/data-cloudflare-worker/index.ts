// https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/worker
...
export interface DataCloudflareWorkerConfig extends cdktf.TerraformMetaArguments {
  ...
  * Identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/worker#account_id DataCloudflareWorker#account_id}
  */
  readonly accountId: string;
  /**
  * Identifier for the Worker, which can be ID or name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/worker#worker_id DataCloudflareWorker#worker_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/worker cloudflare_worker}
*/
export class DataCloudflareWorker extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareWorker that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/worker#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/worker cloudflare_worker} Data Source
  *
  * @param scope The scope in which to define this construct
