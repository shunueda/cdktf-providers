// https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/stream_webhook
...
export interface StreamWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/stream_webhook#account_id StreamWebhook#account_id}
  */
  readonly accountId: string;
  /**
  * The URL where webhooks will be sent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/stream_webhook#notification_url StreamWebhook#notification_url}
  */
  readonly notificationUrl: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/stream_webhook cloudflare_stream_webhook}
*/
export class StreamWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/stream_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/stream_webhook cloudflare_stream_webhook} Resource
  *
  * @param scope The scope in which to define this construct
