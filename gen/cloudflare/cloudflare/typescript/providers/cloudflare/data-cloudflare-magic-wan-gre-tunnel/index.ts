// https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/magic_wan_gre_tunnel
...
export interface DataCloudflareMagicWanGreTunnelConfig extends cdktf.TerraformMetaArguments {
  ...
  * Identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/magic_wan_gre_tunnel#account_id DataCloudflareMagicWanGreTunnel#account_id}
  */
  readonly accountId: string;
  /**
  * Identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/magic_wan_gre_tunnel#gre_tunnel_id DataCloudflareMagicWanGreTunnel#gre_tunnel_id}
  */
...
export class DataCloudflareMagicWanGreTunnelGreTunnelBgpOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareMagicWanGreTunnelGreTunnelBgp | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareMagicWanGreTunnelGreTunnelBgp | undefined) {
    if (value === undefined) {
...
export class DataCloudflareMagicWanGreTunnelGreTunnelBgpStatusOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareMagicWanGreTunnelGreTunnelBgpStatus | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareMagicWanGreTunnelGreTunnelBgpStatus | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataCloudflareMagicWanGreTunnelGreTunnelOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _bgp = new DataCloudflareMagicWanGreTunnelGreTunnelBgpOutputReference(this, "bgp");
  public get bgp() {
    return this._bgp;
  }

  // bgp_status - computed: true, optional: false, required: false
  private _bgpStatus = new DataCloudflareMagicWanGreTunnelGreTunnelBgpStatusOutputReference(this, "bgp_status");
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/magic_wan_gre_tunnel cloudflare_magic_wan_gre_tunnel}
*/
export class DataCloudflareMagicWanGreTunnel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareMagicWanGreTunnel that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/magic_wan_gre_tunnel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/magic_wan_gre_tunnel cloudflare_magic_wan_gre_tunnel} Data Source
  *
  * @param scope The scope in which to define this construct
