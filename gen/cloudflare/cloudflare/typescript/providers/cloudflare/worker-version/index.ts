// https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version
...
export interface WorkerVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#account_id WorkerVersion#account_id}
  */
  readonly accountId: string;
  /**
  * Metadata about the version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#annotations WorkerVersion#annotations}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#assets WorkerVersion#assets}
  */
  readonly assets?: WorkerVersionAssets;
  /**
  * List of bindings attached to a Worker. You can find more about bindings on our docs: https://developers.cloudflare.com/workers/configuration/multipart-upload-metadata/#bindings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#bindings WorkerVersion#bindings}
  */
  readonly bindings?: WorkerVersionBindings[] | cdktf.IResolvable;
  /**
  * Date indicating targeted support in the Workers runtime. Backwards incompatible fixes to the runtime following this date will not affect this Worker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#compatibility_date WorkerVersion#compatibility_date}
  */
  readonly compatibilityDate?: string;
  /**
  * Flags that enable or disable certain features in the Workers runtime. Used to enable upcoming features or opt in or out of specific changes not included in a `compatibility_date`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#compatibility_flags WorkerVersion#compatibility_flags}
  */
  readonly compatibilityFlags?: string[];
  /**
  * Resource limits enforced at runtime.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#limits WorkerVersion#limits}
  */
  readonly limits?: WorkerVersionLimits;
  /**
  * The name of the main module in the `modules` array (e.g. the name of the module that exports a `fetch` handler).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#main_module WorkerVersion#main_module}
  */
  readonly mainModule?: string;
  /**
  * Migrations for Durable Objects associated with the version. Migrations are applied when the version is deployed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#migrations WorkerVersion#migrations}
  */
  ...
  * included as modules named `_headers` and `_redirects` with content type `text/plain`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#modules WorkerVersion#modules}
  */
  readonly modules?: WorkerVersionModules[] | cdktf.IResolvable;
  /**
  * Placement settings for the version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#placement WorkerVersion#placement}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#usage_model WorkerVersion#usage_model}
  */
  readonly usageModel?: string;
  /**
  * Identifier for the Worker, which can be ID or name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#worker_id WorkerVersion#worker_id}
  */
...
export interface WorkerVersionAnnotations {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#workers_message WorkerVersion#workers_message}
  */
  readonly workersMessage?: string;
  /**
  * User-provided identifier for the version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#workers_tag WorkerVersion#workers_tag}
  */
...
export interface WorkerVersionAssetsConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#html_handling WorkerVersion#html_handling}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#not_found_handling WorkerVersion#not_found_handling}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#run_worker_first WorkerVersion#run_worker_first}
  */
...
export interface WorkerVersionAssets {
  ...
  * Configuration for assets within a Worker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#config WorkerVersion#config}
  */
  readonly config?: WorkerVersionAssetsConfig;
  /**
  * Path to the directory containing asset files to upload.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#directory WorkerVersion#directory}
  */
  readonly directory?: string;
  /**
  * Token provided upon successful upload of all files from a registered manifest.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#jwt WorkerVersion#jwt}
  */
  readonly jwt?: string;
}
...
export interface WorkerVersionBindingsOutboundWorker {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#environment WorkerVersion#environment}
  */
  readonly environment?: string;
  /**
  * Name of the outbound worker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#service WorkerVersion#service}
  */
...
export interface WorkerVersionBindingsOutbound {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#params WorkerVersion#params}
  */
  readonly params?: string[];
  /**
  * Outbound worker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#worker WorkerVersion#worker}
  */
...
export interface WorkerVersionBindings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#algorithm WorkerVersion#algorithm}
  */
  readonly algorithm?: string;
  /**
  * List of allowed destination addresses.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#allowed_destination_addresses WorkerVersion#allowed_destination_addresses}
  */
  readonly allowedDestinationAddresses?: string[];
  /**
  * List of allowed sender addresses.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#allowed_sender_addresses WorkerVersion#allowed_sender_addresses}
  */
  readonly allowedSenderAddresses?: string[];
  /**
  * R2 bucket to bind to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#bucket_name WorkerVersion#bucket_name}
  */
  readonly bucketName?: string;
  /**
  * Identifier of the certificate to bind to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#certificate_id WorkerVersion#certificate_id}
  */
  readonly certificateId?: string;
  /**
  * The exported class name of the Durable Object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#class_name WorkerVersion#class_name}
  */
  readonly className?: string;
  /**
  * The name of the dataset to bind to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#dataset WorkerVersion#dataset}
  */
  readonly dataset?: string;
  /**
  * Destination address for the email.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#destination_address WorkerVersion#destination_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#format WorkerVersion#format}
  */
  readonly format?: string;
  /**
  * Identifier of the D1 database to bind to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#id WorkerVersion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#index_name WorkerVersion#index_name}
  */
  readonly indexName?: string;
  /**
  * JSON data to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#json WorkerVersion#json}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#jurisdiction WorkerVersion#jurisdiction}
  */
  readonly jurisdiction?: string;
  /**
  * Base64-encoded key data. Required if `format` is "raw", "pkcs8", or "spki".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#key_base64 WorkerVersion#key_base64}
  */
  readonly keyBase64?: string;
  /**
  * Key data in [JSON Web Key](https://developer.mozilla.org/en-US/docs/Web/API/SubtleCrypto/importKey#json_web_key) format. Required if `format` is "jwk".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#key_jwk WorkerVersion#key_jwk}
  */
  readonly keyJwk?: string;
  /**
  * A JavaScript variable name for the binding.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#name WorkerVersion#name}
  */
  readonly name: string;
  /**
  * The name of the dispatch namespace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#namespace WorkerVersion#namespace}
  */
  readonly namespace?: string;
  /**
  * Namespace identifier tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#namespace_id WorkerVersion#namespace_id}
  */
  readonly namespaceId?: string;
  /**
  * The old name of the inherited binding. If set, the binding will be renamed from `old_name` to `name` in the new version. If not set, the binding will keep the same name between versions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#old_name WorkerVersion#old_name}
  */
  readonly oldName?: string;
  /**
  * Outbound worker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#outbound WorkerVersion#outbound}
  */
  readonly outbound?: WorkerVersionBindingsOutbound;
  /**
  * The name of the file containing the data content. Only accepted for `service worker syntax` Workers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#part WorkerVersion#part}
  */
  readonly part?: string;
  /**
  * Name of the Pipeline to bind to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#pipeline WorkerVersion#pipeline}
  */
  readonly pipeline?: string;
  /**
  * Name of the Queue to bind to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#queue_name WorkerVersion#queue_name}
  */
  readonly queueName?: string;
  /**
  * The script where the Durable Object is defined, if it is external to this Worker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#script_name WorkerVersion#script_name}
  */
  readonly scriptName?: string;
  /**
  * Name of the secret in the store.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#secret_name WorkerVersion#secret_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#store_id WorkerVersion#store_id}
  */
  readonly storeId?: string;
  /**
  * The text value to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#text WorkerVersion#text}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#type WorkerVersion#type}
  */
  readonly type: string;
  /**
  * Allowed operations with the key. [Learn more](https://developer.mozilla.org/en-US/docs/Web/API/SubtleCrypto/importKey#keyUsages).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#usages WorkerVersion#usages}
  */
  readonly usages?: string[];
  /**
  * Identifier for the version to inherit the binding from, which can be the version ID or the literal "latest" to inherit from the latest version. Defaults to inheriting the binding from the latest version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#version_id WorkerVersion#version_id}
  */
  readonly versionId?: string;
  /**
  * Name of the Workflow to bind to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#workflow_name WorkerVersion#workflow_name}
  */
...
export interface WorkerVersionLimits {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#cpu_ms WorkerVersion#cpu_ms}
  */
...
export interface WorkerVersionMigrationsRenamedClasses {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#from WorkerVersion#from}
  */
  readonly from?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#to WorkerVersion#to}
  */
  readonly to?: string;
}
...
export interface WorkerVersionMigrationsStepsTransferredClasses {
  ...
  */
  readonly from?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#from_script WorkerVersion#from_script}
  */
...
export interface WorkerVersionMigrationsSteps {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#deleted_classes WorkerVersion#deleted_classes}
  */
  readonly deletedClasses?: string[];
  /**
  * A list of classes to create Durable Object namespaces from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#new_classes WorkerVersion#new_classes}
  */
  readonly newClasses?: string[];
  /**
  * A list of classes to create Durable Object namespaces with SQLite from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#new_sqlite_classes WorkerVersion#new_sqlite_classes}
  */
  readonly newSqliteClasses?: string[];
  /**
  * A list of classes with Durable Object namespaces that were renamed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#renamed_classes WorkerVersion#renamed_classes}
  */
  readonly renamedClasses?: WorkerVersionMigrationsStepsRenamedClasses[] | cdktf.IResolvable;
  /**
  * A list of transfers for Durable Object namespaces from a different Worker and class to a class defined in this Worker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#transferred_classes WorkerVersion#transferred_classes}
  */
...
export interface WorkerVersionMigrations {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#new_tag WorkerVersion#new_tag}
  */
  readonly newTag?: string;
  /**
  * Tag used to verify against the latest migration tag for this Worker. If they don't match, the upload is rejected.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#old_tag WorkerVersion#old_tag}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#steps WorkerVersion#steps}
  */
...
export interface WorkerVersionModules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#content_base64 WorkerVersion#content_base64}
  */
  readonly contentBase64?: string;
  /**
  * The file path of the module content.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#content_file WorkerVersion#content_file}
  */
  readonly contentFile?: string;
  /**
  * The content type of the module.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#content_type WorkerVersion#content_type}
  */
...
export interface WorkerVersionPlacement {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#mode WorkerVersion#mode}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version cloudflare_worker_version}
*/
export class WorkerVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkerVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/worker_version cloudflare_worker_version} Resource
  *
  * @param scope The scope in which to define this construct
