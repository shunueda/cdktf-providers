// https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/workers_script_subdomain
...
export interface WorkersScriptSubdomainConfig extends cdktf.TerraformMetaArguments {
  ...
  * Identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/workers_script_subdomain#account_id WorkersScriptSubdomain#account_id}
  */
  readonly accountId: string;
  /**
  * Whether the Worker should be available on the workers.dev subdomain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/workers_script_subdomain#enabled WorkersScriptSubdomain#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Whether the Worker's Preview URLs should be available on the workers.dev subdomain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/workers_script_subdomain#previews_enabled WorkersScriptSubdomain#previews_enabled}
  */
  readonly previewsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Name of the script, used in URLs and route configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/workers_script_subdomain#script_name WorkersScriptSubdomain#script_name}
  */
  readonly scriptName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/workers_script_subdomain cloudflare_workers_script_subdomain}
*/
export class WorkersScriptSubdomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkersScriptSubdomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/workers_script_subdomain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/workers_script_subdomain cloudflare_workers_script_subdomain} Resource
  *
  * @param scope The scope in which to define this construct
