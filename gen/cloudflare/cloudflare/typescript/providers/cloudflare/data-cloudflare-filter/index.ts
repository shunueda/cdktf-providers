// https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/filter
...
export interface DataCloudflareFilterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/filter#filter DataCloudflareFilter#filter}
  */
  readonly filter?: DataCloudflareFilterFilter;
  /**
  * The unique identifier of the filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/filter#filter_id DataCloudflareFilter#filter_id}
  */
  readonly filterId?: string;
  /**
  * Defines an identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/filter#zone_id DataCloudflareFilter#zone_id}
  */
...
export interface DataCloudflareFilterFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/filter#description DataCloudflareFilter#description}
  */
  readonly description?: string;
  /**
  * A case-insensitive string to find in the expression.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/filter#expression DataCloudflareFilter#expression}
  */
  readonly expression?: string;
  /**
  * The unique identifier of the filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/filter#id DataCloudflareFilter#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/filter#paused DataCloudflareFilter#paused}
  */
  readonly paused?: boolean | cdktf.IResolvable;
  /**
  * The filter ref (a short reference tag) to search for. Must be an exact match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/filter#ref DataCloudflareFilter#ref}
  */
  readonly ref?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/filter cloudflare_filter}
*/
export class DataCloudflareFilter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/data-sources/filter cloudflare_filter} Data Source
  *
  * @param scope The scope in which to define this construct
