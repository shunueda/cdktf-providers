// https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/zero_trust_dlp_entry
...
export interface ZeroTrustDlpEntryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/zero_trust_dlp_entry#account_id ZeroTrustDlpEntry#account_id}
  */
  readonly accountId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/zero_trust_dlp_entry#enabled ZeroTrustDlpEntry#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/zero_trust_dlp_entry#name ZeroTrustDlpEntry#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/zero_trust_dlp_entry#pattern ZeroTrustDlpEntry#pattern}
  */
  readonly pattern: ZeroTrustDlpEntryPattern;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/zero_trust_dlp_entry#profile_id ZeroTrustDlpEntry#profile_id}
  */
  readonly profileId?: string;
  /**
  * Available values: "custom", "predefined", "integration".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/zero_trust_dlp_entry#type ZeroTrustDlpEntry#type}
  */
...
export interface ZeroTrustDlpEntryPattern {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/zero_trust_dlp_entry#regex ZeroTrustDlpEntry#regex}
  */
  readonly regex: string;
  /**
  * Available values: "luhn".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/zero_trust_dlp_entry#validation ZeroTrustDlpEntry#validation}
  */
...
export function zeroTrustDlpEntryProfilesToTerraform(struct?: ZeroTrustDlpEntryProfiles): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function zeroTrustDlpEntryProfilesToHclTerraform(struct?: ZeroTrustDlpEntryProfiles): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ZeroTrustDlpEntryProfilesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ZeroTrustDlpEntryProfiles | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ZeroTrustDlpEntryProfiles | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class ZeroTrustDlpEntryProfilesList extends cdktf.ComplexList {
...
export function zeroTrustDlpEntryVariantToTerraform(struct?: ZeroTrustDlpEntryVariant): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function zeroTrustDlpEntryVariantToHclTerraform(struct?: ZeroTrustDlpEntryVariant): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ZeroTrustDlpEntryVariantOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ZeroTrustDlpEntryVariant | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ZeroTrustDlpEntryVariant | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/zero_trust_dlp_entry cloudflare_zero_trust_dlp_entry}
*/
export class ZeroTrustDlpEntry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustDlpEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/zero_trust_dlp_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.15.0/docs/resources/zero_trust_dlp_entry cloudflare_zero_trust_dlp_entry} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _profiles = new ZeroTrustDlpEntryProfilesList(this, "profiles", false);
  public get profiles() {
  ...
  private _variant = new ZeroTrustDlpEntryVariantOutputReference(this, "variant");
  public get variant() {
