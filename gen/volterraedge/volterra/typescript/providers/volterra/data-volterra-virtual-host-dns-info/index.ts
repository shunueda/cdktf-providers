...
export interface DataVolterraVirtualHostDnsInfoDnsInfo {
}

export function dataVolterraVirtualHostDnsInfoDnsInfoToTerraform(struct?: DataVolterraVirtualHostDnsInfoDnsInfo): any {
...
export function dataVolterraVirtualHostDnsInfoDnsInfoToHclTerraform(struct?: DataVolterraVirtualHostDnsInfoDnsInfo): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataVolterraVirtualHostDnsInfoDnsInfoOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataVolterraVirtualHostDnsInfoDnsInfo | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataVolterraVirtualHostDnsInfoDnsInfo | undefined) {
    if (value === undefined) {
...
export class DataVolterraVirtualHostDnsInfoDnsInfoList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataVolterraVirtualHostDnsInfoDnsInfoOutputReference {
    return new DataVolterraVirtualHostDnsInfoDnsInfoOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataVolterraVirtualHostDnsInfo extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "volterra_virtual_host_dns_info";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "volterra_virtual_host_dns_info", importId: importFromId, provider });
      }
  ...
  * @param options DataVolterraVirtualHostDnsInfoConfig
  */
  public constructor(scope: Construct, id: string, config: DataVolterraVirtualHostDnsInfoConfig) {
    super(scope, id, {
  ...
  private _dnsInfo = new DataVolterraVirtualHostDnsInfoDnsInfoList(this, "dns_info", true);
  public get dnsInfo() {
