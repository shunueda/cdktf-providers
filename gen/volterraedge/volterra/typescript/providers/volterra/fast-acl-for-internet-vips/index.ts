// https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/fast_acl_for_internet_vips
...
export interface FastAclForInternetVipsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/fast_acl_for_internet_vips#id FastAclForInternetVips#id}
  *
  ...
  * fast_acls block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/fast_acl_for_internet_vips#fast_acls FastAclForInternetVips#fast_acls}
  */
  readonly fastAcls: FastAclForInternetVipsFastAcls[] | cdktf.IResolvable;
}
export interface FastAclForInternetVipsFastAcls {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/fast_acl_for_internet_vips#name FastAclForInternetVips#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/fast_acl_for_internet_vips#tenant FastAclForInternetVips#tenant}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/fast_acl_for_internet_vips volterra_fast_acl_for_internet_vips}
*/
export class FastAclForInternetVips extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FastAclForInternetVips that should be imported. Refer to the {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/fast_acl_for_internet_vips#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/fast_acl_for_internet_vips volterra_fast_acl_for_internet_vips} Resource
  *
  * @param scope The scope in which to define this construct
