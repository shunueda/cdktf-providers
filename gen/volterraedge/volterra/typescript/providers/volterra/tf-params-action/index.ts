// https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tf_params_action
...
export interface TfParamsActionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tf_params_action#action TfParamsAction#action}
  */
  readonly action: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tf_params_action#id TfParamsAction#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tf_params_action#ignore_on_update TfParamsAction#ignore_on_update}
  */
  readonly ignoreOnUpdate?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tf_params_action#site_kind TfParamsAction#site_kind}
  */
  readonly siteKind: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tf_params_action#site_name TfParamsAction#site_name}
  */
  readonly siteName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tf_params_action#wait_for_action TfParamsAction#wait_for_action}
  */
  readonly waitForAction?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tf_params_action volterra_tf_params_action}
*/
export class TfParamsAction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TfParamsAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tf_params_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tf_params_action volterra_tf_params_action} Resource
  *
  * @param scope The scope in which to define this construct
