// https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpn_tunnels
...
export interface TgwVpnTunnelsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpn_tunnels#id TgwVpnTunnels#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpn_tunnels#name TgwVpnTunnels#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpn_tunnels#namespace TgwVpnTunnels#namespace}
  */
  readonly namespace: string;
  /**
  * vpn_tunnel_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpn_tunnels#vpn_tunnel_config TgwVpnTunnels#vpn_tunnel_config}
  */
  readonly vpnTunnelConfig: TgwVpnTunnelsVpnTunnelConfig[] | cdktf.IResolvable;
}
export interface TgwVpnTunnelsVpnTunnelConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpn_tunnels#node_id TgwVpnTunnels#node_id}
  */
  readonly nodeId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpn_tunnels#node_name TgwVpnTunnels#node_name}
  */
  readonly nodeName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpn_tunnels#tunnel_remote_ips TgwVpnTunnels#tunnel_remote_ips}
  */
  readonly tunnelRemoteIps: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpn_tunnels#type TgwVpnTunnels#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpn_tunnels volterra_tgw_vpn_tunnels}
*/
export class TgwVpnTunnels extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TgwVpnTunnels that should be imported. Refer to the {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpn_tunnels#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpn_tunnels volterra_tgw_vpn_tunnels} Resource
  *
  * @param scope The scope in which to define this construct
