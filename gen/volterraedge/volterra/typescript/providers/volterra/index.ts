...
export * as bigipIrule from './bigip-irule';
export * as bigipSite from './bigip-site';
export * as botInfrastructure from './bot-infrastructure';
...
export * as infraprotectAsn from './infraprotect-asn';
export * as infraprotectAsnPrefix from './infraprotect-asn-prefix';
export * as infraprotectFirewallRuleGroup from './infraprotect-firewall-rule-group';
export * as ipPrefixSet from './ip-prefix-set';
export * as irule from './irule';
...
export * as mobileBaseConfig from './mobile-base-config';
...
export * as nginxServiceDiscovery from './nginx-service-discovery';
export * as originPool from './origin-pool';
export * as policer from './policer';
export * as protectedApplication from './protected-application';
...
export * as reportConfig from './report-config';
...
export * as siteSegmentStaticRoutes from './site-segment-static-routes';
...
export * as unifiedPolicyGroup from './unified-policy-group';
