// https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/cloud_site_labels
...
export interface CloudSiteLabelsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/cloud_site_labels#id CloudSiteLabels#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/cloud_site_labels#ignore_on_delete CloudSiteLabels#ignore_on_delete}
  */
  readonly ignoreOnDelete?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/cloud_site_labels#labels CloudSiteLabels#labels}
  */
  readonly labels: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/cloud_site_labels#name CloudSiteLabels#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/cloud_site_labels#site_type CloudSiteLabels#site_type}
  */
  readonly siteType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/cloud_site_labels volterra_cloud_site_labels}
*/
export class CloudSiteLabels extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudSiteLabels that should be imported. Refer to the {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/cloud_site_labels#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/cloud_site_labels volterra_cloud_site_labels} Resource
  *
  * @param scope The scope in which to define this construct
