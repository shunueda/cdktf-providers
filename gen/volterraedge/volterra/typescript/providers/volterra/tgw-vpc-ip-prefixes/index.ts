// https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpc_ip_prefixes
...
export interface TgwVpcIpPrefixesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpc_ip_prefixes#id TgwVpcIpPrefixes#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpc_ip_prefixes#name TgwVpcIpPrefixes#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpc_ip_prefixes#namespace TgwVpcIpPrefixes#namespace}
  */
  readonly namespace: string;
  /**
  * vpc_ip_prefixes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpc_ip_prefixes#vpc_ip_prefixes TgwVpcIpPrefixes#vpc_ip_prefixes}
  */
...
export interface TgwVpcIpPrefixesVpcIpPrefixes {
  ...
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpc_ip_prefixes#value TgwVpcIpPrefixes#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpc_ip_prefixes volterra_tgw_vpc_ip_prefixes}
*/
export class TgwVpcIpPrefixes extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TgwVpcIpPrefixes that should be imported. Refer to the {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpc_ip_prefixes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/volterraedge/volterra/0.11.46/docs/resources/tgw_vpc_ip_prefixes volterra_tgw_vpc_ip_prefixes} Resource
  *
  * @param scope The scope in which to define this construct
