// https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/bandwidth_order_option
...
export interface DataServerscomBandwidthOrderOptionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/bandwidth_order_option#id DataServerscomBandwidthOrderOption#id}
  *
  ...
  */
  readonly id: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/bandwidth_order_option#location_id DataServerscomBandwidthOrderOption#location_id}
  */
  readonly locationId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/bandwidth_order_option#server_model_id DataServerscomBandwidthOrderOption#server_model_id}
  */
  readonly serverModelId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/bandwidth_order_option#uplink_model_id DataServerscomBandwidthOrderOption#uplink_model_id}
  */
  readonly uplinkModelId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/bandwidth_order_option serverscom_bandwidth_order_option}
*/
export class DataServerscomBandwidthOrderOption extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataServerscomBandwidthOrderOption that should be imported. Refer to the {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/bandwidth_order_option#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/bandwidth_order_option serverscom_bandwidth_order_option} Data Source
  *
  * @param scope The scope in which to define this construct
