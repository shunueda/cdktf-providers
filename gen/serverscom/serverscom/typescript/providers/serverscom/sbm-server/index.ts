// https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server
...
export interface SbmServerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#flavor SbmServer#flavor}
  */
  readonly flavor: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#hostname SbmServer#hostname}
  */
  readonly hostname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#id SbmServer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#labels SbmServer#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#location SbmServer#location}
  */
  readonly location: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#operating_system SbmServer#operating_system}
  */
  readonly operatingSystem: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#private_ipv4_address SbmServer#private_ipv4_address}
  */
  readonly privateIpv4Address?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#private_ipv4_network_id SbmServer#private_ipv4_network_id}
  */
  readonly privateIpv4NetworkId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#public_ipv4_address SbmServer#public_ipv4_address}
  */
  readonly publicIpv4Address?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#public_ipv4_network_id SbmServer#public_ipv4_network_id}
  */
  readonly publicIpv4NetworkId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#ssh_key_fingerprints SbmServer#ssh_key_fingerprints}
  */
  readonly sshKeyFingerprints?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#user_data SbmServer#user_data}
  */
  readonly userData?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#timeouts SbmServer#timeouts}
  */
  readonly timeouts?: SbmServerTimeouts;
}
export interface SbmServerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#create SbmServer#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#delete SbmServer#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server serverscom_sbm_server}
*/
export class SbmServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SbmServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/resources/sbm_server serverscom_sbm_server} Resource
  *
  * @param scope The scope in which to define this construct
