// https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/uplink_model_order_option
...
export interface DataServerscomUplinkModelOrderOptionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/uplink_model_order_option#id DataServerscomUplinkModelOrderOption#id}
  *
  ...
  */
  readonly id: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/uplink_model_order_option#location_id DataServerscomUplinkModelOrderOption#location_id}
  */
  readonly locationId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/uplink_model_order_option#server_model_id DataServerscomUplinkModelOrderOption#server_model_id}
  */
  readonly serverModelId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/uplink_model_order_option serverscom_uplink_model_order_option}
*/
export class DataServerscomUplinkModelOrderOption extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataServerscomUplinkModelOrderOption that should be imported. Refer to the {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/uplink_model_order_option#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/uplink_model_order_option serverscom_uplink_model_order_option} Data Source
  *
  * @param scope The scope in which to define this construct
