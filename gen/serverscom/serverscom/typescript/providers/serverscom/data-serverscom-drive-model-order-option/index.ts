// https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/drive_model_order_option
...
export interface DataServerscomDriveModelOrderOptionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/drive_model_order_option#id DataServerscomDriveModelOrderOption#id}
  *
  ...
  */
  readonly id: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/drive_model_order_option#location_id DataServerscomDriveModelOrderOption#location_id}
  */
  readonly locationId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/drive_model_order_option#server_model_id DataServerscomDriveModelOrderOption#server_model_id}
  */
  readonly serverModelId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/drive_model_order_option serverscom_drive_model_order_option}
*/
export class DataServerscomDriveModelOrderOption extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataServerscomDriveModelOrderOption that should be imported. Refer to the {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/drive_model_order_option#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/drive_model_order_option serverscom_drive_model_order_option} Data Source
  *
  * @param scope The scope in which to define this construct
