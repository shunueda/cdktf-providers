// https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/dedicated_server
...
export interface DataServerscomDedicatedServerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/dedicated_server#id DataServerscomDedicatedServer#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/dedicated_server serverscom_dedicated_server}
*/
export class DataServerscomDedicatedServer extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataServerscomDedicatedServer resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataServerscomDedicatedServer to import
  * @param importFromId The id of the existing DataServerscomDedicatedServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/dedicated_server#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataServerscomDedicatedServer to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/dedicated_server serverscom_dedicated_server} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataServerscomDedicatedServerConfig
  */
  public constructor(scope: Construct, id: string, config: DataServerscomDedicatedServerConfig) {
    super(scope, id, {
