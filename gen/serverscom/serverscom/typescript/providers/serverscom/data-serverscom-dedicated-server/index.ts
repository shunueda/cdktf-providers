// https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/dedicated_server
...
export interface DataServerscomDedicatedServerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/dedicated_server#id DataServerscomDedicatedServer#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/dedicated_server serverscom_dedicated_server}
*/
export class DataServerscomDedicatedServer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataServerscomDedicatedServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/dedicated_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/dedicated_server serverscom_dedicated_server} Data Source
  *
  * @param scope The scope in which to define this construct
