// https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/sbm_flavor_order_option
...
export interface DataServerscomSbmFlavorOrderOptionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/sbm_flavor_order_option#id DataServerscomSbmFlavorOrderOption#id}
  *
  ...
  */
  readonly id: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/sbm_flavor_order_option#location_id DataServerscomSbmFlavorOrderOption#location_id}
  */
  readonly locationId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/sbm_flavor_order_option serverscom_sbm_flavor_order_option}
*/
export class DataServerscomSbmFlavorOrderOption extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataServerscomSbmFlavorOrderOption that should be imported. Refer to the {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/sbm_flavor_order_option#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/sbm_flavor_order_option serverscom_sbm_flavor_order_option} Data Source
  *
  * @param scope The scope in which to define this construct
