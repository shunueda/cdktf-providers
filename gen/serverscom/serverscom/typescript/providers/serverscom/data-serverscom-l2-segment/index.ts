// https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/l2_segment
...
export interface DataServerscomL2SegmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/l2_segment#id DataServerscomL2Segment#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/l2_segment serverscom_l2_segment}
*/
export class DataServerscomL2Segment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataServerscomL2Segment that should be imported. Refer to the {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/l2_segment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.2/docs/data-sources/l2_segment serverscom_l2_segment} Data Source
  *
  * @param scope The scope in which to define this construct
