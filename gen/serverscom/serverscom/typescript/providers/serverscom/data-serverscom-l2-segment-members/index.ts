// https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/l2_segment_members
...
export interface DataServerscomL2SegmentMembersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/l2_segment_members#id DataServerscomL2SegmentMembers#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/l2_segment_members serverscom_l2_segment_members}
*/
export class DataServerscomL2SegmentMembers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataServerscomL2SegmentMembers that should be imported. Refer to the {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/l2_segment_members#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/serverscom/serverscom/0.5.3/docs/data-sources/l2_segment_members serverscom_l2_segment_members} Data Source
  *
  * @param scope The scope in which to define this construct
