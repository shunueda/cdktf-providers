// https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake
...
export interface DestinationSnowflakeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#apply_dynamic_table_script DestinationSnowflake#apply_dynamic_table_script}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#auto_qa_dedupe_table_mapping DestinationSnowflake#auto_qa_dedupe_table_mapping}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#auto_schema_creation DestinationSnowflake#auto_schema_creation}
  */
  ...
  * 	```
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#create_sql_data DestinationSnowflake#create_sql_data}
  */
  ...
  * 	```
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#create_sql_execute DestinationSnowflake#create_sql_execute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#hard_delete DestinationSnowflake#hard_delete}
  */
  readonly hardDelete?: boolean | cdktf.IResolvable;
  /**
  * `upsert` or `append` modes are available
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#ingestion_mode DestinationSnowflake#ingestion_mode}
  */
  readonly ingestionMode?: string;
  /**
  * Destination name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#name DestinationSnowflake#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#schema_evolution DestinationSnowflake#schema_evolution}
  */
  readonly schemaEvolution?: string;
  /**
  * The name of the Snowflake warehouse.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#sfwarehouse DestinationSnowflake#sfwarehouse}
  */
  readonly sfwarehouse?: string;
  /**
  * The name of the database that contains the table to insert rows into.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#snowflake_database_name DestinationSnowflake#snowflake_database_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#snowflake_private_key DestinationSnowflake#snowflake_private_key}
  */
  readonly snowflakePrivateKey: string;
  /**
  * If the value is not empty, this phrase is used to try to decrypt the private key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#snowflake_private_key_passphrase DestinationSnowflake#snowflake_private_key_passphrase}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#snowflake_role_name DestinationSnowflake#snowflake_role_name}
  */
  readonly snowflakeRoleName?: string;
  /**
  * The name of the schema that contains the table to insert rows into.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#snowflake_schema_name DestinationSnowflake#snowflake_schema_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#snowflake_url_name DestinationSnowflake#snowflake_url_name}
  */
  readonly snowflakeUrlName: string;
  /**
  * User login name for the Snowflake account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#snowflake_user_name DestinationSnowflake#snowflake_user_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#sql_table_name DestinationSnowflake#sql_table_name}
  */
  readonly sqlTableName?: string;
  /**
  * Specifies whether the connector should create Hybrid Tables (applies to `upsert` only)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#use_hybrid_tables DestinationSnowflake#use_hybrid_tables}
  */
  readonly useHybridTables?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake streamkap_destination_snowflake}
*/
export class DestinationSnowflake extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DestinationSnowflake that should be imported. Refer to the {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.17/docs/resources/destination_snowflake streamkap_destination_snowflake} Resource
  *
  * @param scope The scope in which to define this construct
