// https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.15/docs
...
export interface StreamkapProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.15/docs#client_id StreamkapProvider#client_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.15/docs#host StreamkapProvider#host}
  */
  readonly host?: string;
  /**
  * The Streamkap API secret. If not set, Streamkap will use environment variable `STREAMKAP_SECRET`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.15/docs#secret StreamkapProvider#secret}
  */
  readonly secret?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.15/docs#alias StreamkapProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.15/docs streamkap}
*/
export class StreamkapProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing StreamkapProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.15/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.15/docs streamkap} Resource
  *
  * @param scope The scope in which to define this construct
