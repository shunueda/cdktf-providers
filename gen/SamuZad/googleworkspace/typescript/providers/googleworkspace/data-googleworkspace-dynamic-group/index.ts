// https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.1/docs/data-sources/dynamic_group
...
export interface DataGoogleworkspaceDynamicGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.1/docs/data-sources/dynamic_group#email DataGoogleworkspaceDynamicGroup#email}
  */
  readonly email?: string;
  /**
  * The unique ID of a group. A group id can be used as a group request URI's groupKey.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.1/docs/data-sources/dynamic_group#id DataGoogleworkspaceDynamicGroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.1/docs/data-sources/dynamic_group googleworkspace_dynamic_group}
*/
export class DataGoogleworkspaceDynamicGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleworkspaceDynamicGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.1/docs/data-sources/dynamic_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.1/docs/data-sources/dynamic_group googleworkspace_dynamic_group} Data Source
  *
  * @param scope The scope in which to define this construct
