// https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.1/docs/data-sources/domain_alias
...
export interface DataGoogleworkspaceDomainAliasConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.1/docs/data-sources/domain_alias#domain_alias_name DataGoogleworkspaceDomainAlias#domain_alias_name}
  */
  readonly domainAliasName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.1/docs/data-sources/domain_alias googleworkspace_domain_alias}
*/
export class DataGoogleworkspaceDomainAlias extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleworkspaceDomainAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.1/docs/data-sources/domain_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.1/docs/data-sources/domain_alias googleworkspace_domain_alias} Data Source
  *
  * @param scope The scope in which to define this construct
