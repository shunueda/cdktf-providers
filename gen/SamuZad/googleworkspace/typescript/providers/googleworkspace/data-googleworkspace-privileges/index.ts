// https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.0/docs/data-sources/privileges
...
export interface DataGoogleworkspacePrivilegesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.0/docs/data-sources/privileges#id DataGoogleworkspacePrivileges#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.0/docs/data-sources/privileges googleworkspace_privileges}
*/
export class DataGoogleworkspacePrivileges extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleworkspacePrivileges that should be imported. Refer to the {@link https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.0/docs/data-sources/privileges#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samuzad/googleworkspace/0.11.0/docs/data-sources/privileges googleworkspace_privileges} Data Source
  *
  * @param scope The scope in which to define this construct
