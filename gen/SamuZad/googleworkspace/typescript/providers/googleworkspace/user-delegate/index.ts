...
export interface UserDelegateConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function userDelegateTimeoutsToTerraform(struct?: UserDelegateTimeouts | cdktf.IResolvable): any {
...
export function userDelegateTimeoutsToHclTerraform(struct?: UserDelegateTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class UserDelegateTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): UserDelegateTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: UserDelegateTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class UserDelegate extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "googleworkspace_user_delegate";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "googleworkspace_user_delegate", importId: importFromId, provider });
      }
  ...
  * @param options UserDelegateConfig
  */
  public constructor(scope: Construct, id: string, config: UserDelegateConfig) {
    super(scope, id, {
    ...
    this._delegateEmail = config.delegateEmail;
  ...
  // delegate_email - computed: false, optional: false, required: true
  private _delegateEmail?: string; 
  public get delegateEmail() {
    return this.getStringAttribute('delegate_email');
  }
  public set delegateEmail(value: string) {
    this._delegateEmail = value;
  }
  // Temporarily expose input value. Use with caution.
  public get delegateEmailInput() {
    return this._delegateEmail;
  }

  // delegate_verification_status - computed: true, optional: false, required: false
  public get delegateVerificationStatus() {
    return this.getStringAttribute('delegate_verification_status');
  }
  ...
  private _timeouts = new UserDelegateTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: UserDelegateTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      delegate_email: cdktf.stringToTerraform(this._delegateEmail),
      user_id: cdktf.stringToTerraform(this._userId),
      timeouts: userDelegateTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      delegate_email: {
        value: cdktf.stringToHclTerraform(this._delegateEmail),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      timeouts: {
        value: userDelegateTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "UserDelegateTimeouts",
      },
    };
