// https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens
...
export interface HecTokensConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens#_meta HecTokens#_meta}
  */
  readonly meta?: string;
  /**
  * Set of indexes allowed for events with this token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens#allowed_indexes HecTokens#allowed_indexes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens#default_index HecTokens#default_index}
  */
  readonly defaultIndex?: string;
  /**
  * Default source for events with this token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens#default_source HecTokens#default_source}
  */
  readonly defaultSource?: string;
  /**
  * Default sourcetype for events with this token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens#default_sourcetype HecTokens#default_sourcetype}
  */
  readonly defaultSourcetype?: string;
  /**
  * Input disabled indicator: false = Input Not disabled, true = Input disabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens#disabled HecTokens#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens#id HecTokens#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens#name HecTokens#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens#token HecTokens#token}
  */
  readonly token?: string;
  /**
  * Indexer acknowledgement for this token: false = disabled, true = enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens#use_ack HecTokens#use_ack}
  */
  readonly useAck?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens scp_hec_tokens}
*/
export class HecTokens extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HecTokens that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/hec_tokens scp_hec_tokens} Resource
  *
  * @param scope The scope in which to define this construct
