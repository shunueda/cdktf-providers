// https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/private_app
...
export interface PrivateAppConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/private_app#acs_legal_ack PrivateApp#acs_legal_ack}
  */
  readonly acsLegalAck: string;
  /**
  * The path to the private app file. The file must be a valid tar.gz archive.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/private_app#filename PrivateApp#filename}
  */
  readonly filename: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/private_app#id PrivateApp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/private_app#name PrivateApp#name}
  */
  readonly name: string;
  /**
  * Whether the private app has been pre-vetted using AppInspect.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/private_app#pre_vetted PrivateApp#pre_vetted}
  */
  readonly preVetted: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/private_app scp_private_app}
*/
export class PrivateApp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/private_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/private_app scp_private_app} Resource
  *
  * @param scope The scope in which to define this construct
