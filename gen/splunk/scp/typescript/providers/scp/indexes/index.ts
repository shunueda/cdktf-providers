// https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/indexes
...
export interface IndexesConfig extends cdktf.TerraformMetaArguments {
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/indexes#datatype Indexes#datatype}
  */
  readonly datatype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/indexes#id Indexes#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/indexes#max_data_size_mb Indexes#max_data_size_mb}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/indexes#name Indexes#name}
  */
  readonly name: string;
  /**
  * Number of days after which indexed data rolls to frozen. Defaults to 90 days.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/indexes#searchable_days Indexes#searchable_days}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/indexes#self_storage_bucket_path Indexes#self_storage_bucket_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/indexes#splunk_archival_retention_days Indexes#splunk_archival_retention_days}
  */
  readonly splunkArchivalRetentionDays?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/indexes scp_indexes}
*/
export class Indexes extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Indexes that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/indexes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk/scp/1.3.1/docs/resources/indexes scp_indexes} Resource
  *
  * @param scope The scope in which to define this construct
