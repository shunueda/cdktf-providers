// https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default
...
export interface OutputsTcpDefaultConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#default_group OutputsTcpDefault#default_group}
  */
  readonly defaultGroup?: string;
  /**
  * Disables default tcpout settings
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#disabled OutputsTcpDefault#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#drop_events_on_queue_full OutputsTcpDefault#drop_events_on_queue_full}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#heartbeat_frequency OutputsTcpDefault#heartbeat_frequency}
  */
  readonly heartbeatFrequency?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#id OutputsTcpDefault#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#index_and_forward OutputsTcpDefault#index_and_forward}
  */
  readonly indexAndForward?: boolean | cdktf.IResolvable;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#max_queue_size OutputsTcpDefault#max_queue_size}
  */
  readonly maxQueueSize?: string;
  /**
  * Configuration to be edited. The only valid value is tcpout
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#name OutputsTcpDefault#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#send_cooked_data OutputsTcpDefault#send_cooked_data}
  */
  readonly sendCookedData?: boolean | cdktf.IResolvable;
  /**
  * acl block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#acl OutputsTcpDefault#acl}
  */
  readonly acl?: OutputsTcpDefaultAcl;
}
export interface OutputsTcpDefaultAcl {
  /**
  * The app context for the resource. Required for updating saved search ACL properties. Allowed values are:The name of an app and system
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#app OutputsTcpDefault#app}
  */
  readonly app?: string;
  /**
  * Indicates if the active user can change permissions for this object. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#can_change_perms OutputsTcpDefault#can_change_perms}
  */
  readonly canChangePerms?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can change sharing to app level. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#can_share_app OutputsTcpDefault#can_share_app}
  */
  readonly canShareApp?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can change sharing to system level. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#can_share_global OutputsTcpDefault#can_share_global}
  */
  readonly canShareGlobal?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can change sharing to user level. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#can_share_user OutputsTcpDefault#can_share_user}
  */
  readonly canShareUser?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can edit this object. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#can_write OutputsTcpDefault#can_write}
  */
  readonly canWrite?: boolean | cdktf.IResolvable;
  /**
  * User name of resource owner. Defaults to the resource creator. Required for updating any knowledge object ACL properties.nobody = All users may access the resource, but write access to the resource might be restricted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#owner OutputsTcpDefault#owner}
  */
  readonly owner?: string;
  /**
  * Properties that indicate resource read permissions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#read OutputsTcpDefault#read}
  */
  readonly read?: string[];
  /**
  * Indicates whether an admin or user with sufficient permissions can delete the entity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#removable OutputsTcpDefault#removable}
  */
  readonly removable?: boolean | cdktf.IResolvable;
  /**
  * Indicates how the resource is shared. Required for updating any knowledge object ACL properties.app: Shared within a specific appglobal: (Default) Shared globally to all apps.user: Private to a user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#sharing OutputsTcpDefault#sharing}
  */
  readonly sharing?: string;
  /**
  * Properties that indicate resource write permissions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#write OutputsTcpDefault#write}
  */
  readonly write?: string[];
}

export function outputsTcpDefaultAclToTerraform(struct?: OutputsTcpDefaultAclOutputReference | OutputsTcpDefaultAcl): any {
...
export function outputsTcpDefaultAclToHclTerraform(struct?: OutputsTcpDefaultAclOutputReference | OutputsTcpDefaultAcl): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class OutputsTcpDefaultAclOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OutputsTcpDefaultAcl | undefined {
  ...
  public set internalValue(value: OutputsTcpDefaultAcl | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default splunk_outputs_tcp_default}
*/
export class OutputsTcpDefault extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "splunk_outputs_tcp_default";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a OutputsTcpDefault resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the OutputsTcpDefault to import
  * @param importFromId The id of the existing OutputsTcpDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the OutputsTcpDefault to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "splunk_outputs_tcp_default", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_default splunk_outputs_tcp_default} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options OutputsTcpDefaultConfig
  */
  public constructor(scope: Construct, id: string, config: OutputsTcpDefaultConfig) {
    super(scope, id, {
      terraformResourceType: 'splunk_outputs_tcp_default',
    ...
    this._id = config.id;
    this._indexAndForward = config.indexAndForward;
  ...
  // default_group - computed: true, optional: true, required: false
  ...
  // index_and_forward - computed: true, optional: true, required: false
  private _indexAndForward?: boolean | cdktf.IResolvable; 
  public get indexAndForward() {
    return this.getBooleanAttribute('index_and_forward');
  }
  public set indexAndForward(value: boolean | cdktf.IResolvable) {
    this._indexAndForward = value;
  }
  public resetIndexAndForward() {
    this._indexAndForward = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get indexAndForwardInput() {
    return this._indexAndForward;
  }
  ...
  private _acl = new OutputsTcpDefaultAclOutputReference(this, "acl");
  public get acl() {
    return this._acl;
  }
  public putAcl(value: OutputsTcpDefaultAcl) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      index_and_forward: cdktf.booleanToTerraform(this._indexAndForward),
      ...
      acl: outputsTcpDefaultAclToTerraform(this._acl.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      index_and_forward: {
        value: cdktf.booleanToHclTerraform(this._indexAndForward),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      acl: {
        value: outputsTcpDefaultAclToHclTerraform(this._acl.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OutputsTcpDefaultAclList",
      },
    };
