// https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw
...
export interface InputsTcpRawConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#connection_host InputsTcpRaw#connection_host}
  */
  readonly connectionHost?: string;
  /**
  * Indicates if input is disabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#disabled InputsTcpRaw#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Host from which the indexer gets data. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#host InputsTcpRaw#host}
  */
  readonly host?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#id InputsTcpRaw#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#index InputsTcpRaw#index}
  */
  readonly index?: string;
  /**
  * Required. The input port which receives raw data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#name InputsTcpRaw#name}
  */
  readonly name: string;
  /**
  * Valid values: (parsingQueue | indexQueue) Specifies where the input processor should deposit the events it reads. Defaults to parsingQueue.Set queue to parsingQueue to apply props.conf and other parsing rules to your data. Set queue to indexQueue to send your data directly into the index.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#queue InputsTcpRaw#queue}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#raw_tcp_done_timeout InputsTcpRaw#raw_tcp_done_timeout}
  */
  readonly rawTcpDoneTimeout?: number;
  /**
  * Allows for restricting this input to only accept data from the host specified here.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#restrict_to_host InputsTcpRaw#restrict_to_host}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#source InputsTcpRaw#source}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#sourcetype InputsTcpRaw#sourcetype}
  */
  readonly sourcetype?: string;
  /**
  * acl block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#acl InputsTcpRaw#acl}
  */
  readonly acl?: InputsTcpRawAcl;
}
export interface InputsTcpRawAcl {
  /**
  * The app context for the resource. Required for updating saved search ACL properties. Allowed values are:The name of an app and system
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#app InputsTcpRaw#app}
  */
  readonly app?: string;
  /**
  * Indicates if the active user can change permissions for this object. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#can_change_perms InputsTcpRaw#can_change_perms}
  */
  readonly canChangePerms?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can change sharing to app level. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#can_share_app InputsTcpRaw#can_share_app}
  */
  readonly canShareApp?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can change sharing to system level. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#can_share_global InputsTcpRaw#can_share_global}
  */
  readonly canShareGlobal?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can change sharing to user level. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#can_share_user InputsTcpRaw#can_share_user}
  */
  readonly canShareUser?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can edit this object. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#can_write InputsTcpRaw#can_write}
  */
  readonly canWrite?: boolean | cdktf.IResolvable;
  /**
  * User name of resource owner. Defaults to the resource creator. Required for updating any knowledge object ACL properties.nobody = All users may access the resource, but write access to the resource might be restricted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#owner InputsTcpRaw#owner}
  */
  readonly owner?: string;
  /**
  * Properties that indicate resource read permissions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#read InputsTcpRaw#read}
  */
  readonly read?: string[];
  /**
  * Indicates whether an admin or user with sufficient permissions can delete the entity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#removable InputsTcpRaw#removable}
  */
  readonly removable?: boolean | cdktf.IResolvable;
  /**
  * Indicates how the resource is shared. Required for updating any knowledge object ACL properties.app: Shared within a specific appglobal: (Default) Shared globally to all apps.user: Private to a user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#sharing InputsTcpRaw#sharing}
  */
  readonly sharing?: string;
  /**
  * Properties that indicate resource write permissions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#write InputsTcpRaw#write}
  */
  readonly write?: string[];
}

export function inputsTcpRawAclToTerraform(struct?: InputsTcpRawAclOutputReference | InputsTcpRawAcl): any {
...
export function inputsTcpRawAclToHclTerraform(struct?: InputsTcpRawAclOutputReference | InputsTcpRawAcl): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class InputsTcpRawAclOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): InputsTcpRawAcl | undefined {
  ...
  public set internalValue(value: InputsTcpRawAcl | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw splunk_inputs_tcp_raw}
*/
export class InputsTcpRaw extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "splunk_inputs_tcp_raw";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a InputsTcpRaw resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the InputsTcpRaw to import
  * @param importFromId The id of the existing InputsTcpRaw that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the InputsTcpRaw to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "splunk_inputs_tcp_raw", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/inputs_tcp_raw splunk_inputs_tcp_raw} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options InputsTcpRawConfig
  */
  public constructor(scope: Construct, id: string, config: InputsTcpRawConfig) {
    super(scope, id, {
    ...
    this._rawTcpDoneTimeout = config.rawTcpDoneTimeout;
  ...
  // raw_tcp_done_timeout - computed: true, optional: true, required: false
  private _rawTcpDoneTimeout?: number; 
  public get rawTcpDoneTimeout() {
    return this.getNumberAttribute('raw_tcp_done_timeout');
  }
  public set rawTcpDoneTimeout(value: number) {
    this._rawTcpDoneTimeout = value;
  }
  public resetRawTcpDoneTimeout() {
    this._rawTcpDoneTimeout = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get rawTcpDoneTimeoutInput() {
    return this._rawTcpDoneTimeout;
  }
  ...
  private _acl = new InputsTcpRawAclOutputReference(this, "acl");
  public get acl() {
    return this._acl;
  }
  public putAcl(value: InputsTcpRawAcl) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      raw_tcp_done_timeout: cdktf.numberToTerraform(this._rawTcpDoneTimeout),
      restrict_to_host: cdktf.stringToTerraform(this._restrictToHost),
      source: cdktf.stringToTerraform(this._source),
      sourcetype: cdktf.stringToTerraform(this._sourcetype),
      acl: inputsTcpRawAclToTerraform(this._acl.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      raw_tcp_done_timeout: {
        value: cdktf.numberToHclTerraform(this._rawTcpDoneTimeout),
        isBlock: false,
        type: "simple",
      ...
      acl: {
        value: inputsTcpRawAclToHclTerraform(this._acl.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "InputsTcpRawAclList",
      },
    };
