// https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views
...
export interface DataUiViewsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Dashboard XML definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#eai_data DataUiViews#eai_data}
  */
  readonly eaiData: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#id DataUiViews#id}
  *
  ...
  * Dashboard Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#name DataUiViews#name}
  */
  readonly name: string;
  /**
  * acl block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#acl DataUiViews#acl}
  */
  readonly acl?: DataUiViewsAcl;
}
export interface DataUiViewsAcl {
  /**
  * The app context for the resource. Required for updating saved search ACL properties. Allowed values are:The name of an app and system
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#app DataUiViews#app}
  */
  readonly app?: string;
  /**
  * Indicates if the active user can change permissions for this object. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#can_change_perms DataUiViews#can_change_perms}
  */
  readonly canChangePerms?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can change sharing to app level. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#can_share_app DataUiViews#can_share_app}
  */
  readonly canShareApp?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can change sharing to system level. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#can_share_global DataUiViews#can_share_global}
  */
  readonly canShareGlobal?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can change sharing to user level. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#can_share_user DataUiViews#can_share_user}
  */
  readonly canShareUser?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can edit this object. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#can_write DataUiViews#can_write}
  */
  readonly canWrite?: boolean | cdktf.IResolvable;
  /**
  * User name of resource owner. Defaults to the resource creator. Required for updating any knowledge object ACL properties.nobody = All users may access the resource, but write access to the resource might be restricted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#owner DataUiViews#owner}
  */
  readonly owner?: string;
  /**
  * Properties that indicate resource read permissions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#read DataUiViews#read}
  */
  readonly read?: string[];
  /**
  * Indicates whether an admin or user with sufficient permissions can delete the entity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#removable DataUiViews#removable}
  */
  readonly removable?: boolean | cdktf.IResolvable;
  /**
  * Indicates how the resource is shared. Required for updating any knowledge object ACL properties.app: Shared within a specific appglobal: (Default) Shared globally to all apps.user: Private to a user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#sharing DataUiViews#sharing}
  */
  readonly sharing?: string;
  /**
  * Properties that indicate resource write permissions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#write DataUiViews#write}
  */
  readonly write?: string[];
}

export function dataUiViewsAclToTerraform(struct?: DataUiViewsAclOutputReference | DataUiViewsAcl): any {
...
export function dataUiViewsAclToHclTerraform(struct?: DataUiViewsAclOutputReference | DataUiViewsAcl): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataUiViewsAclOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataUiViewsAcl | undefined {
  ...
  public set internalValue(value: DataUiViewsAcl | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views splunk_data_ui_views}
*/
export class DataUiViews extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "splunk_data_ui_views";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataUiViews resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataUiViews to import
  * @param importFromId The id of the existing DataUiViews that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataUiViews to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "splunk_data_ui_views", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/data_ui_views splunk_data_ui_views} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataUiViewsConfig
  */
  public constructor(scope: Construct, id: string, config: DataUiViewsConfig) {
    super(scope, id, {
  ...
  // eai_data - computed: false, optional: false, required: true
  private _eaiData?: string; 
  public get eaiData() {
    return this.getStringAttribute('eai_data');
  }
  public set eaiData(value: string) {
    this._eaiData = value;
  }
  // Temporarily expose input value. Use with caution.
  public get eaiDataInput() {
    return this._eaiData;
  }
  ...
  private _acl = new DataUiViewsAclOutputReference(this, "acl");
  public get acl() {
    return this._acl;
  }
  public putAcl(value: DataUiViewsAcl) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      eai_data: cdktf.stringToTerraform(this._eaiData),
      id: cdktf.stringToTerraform(this._id),
      name: cdktf.stringToTerraform(this._name),
      acl: dataUiViewsAclToTerraform(this._acl.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      eai_data: {
        value: cdktf.stringToHclTerraform(this._eaiData),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      acl: {
        value: dataUiViewsAclToHclTerraform(this._acl.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataUiViewsAclList",
      },
    };
