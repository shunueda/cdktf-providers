// https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog
...
export interface OutputsTcpSyslogConfig extends cdktf.TerraformMetaArguments {
  /**
  * Disables default tcpout settings
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#disabled OutputsTcpSyslog#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#id OutputsTcpSyslog#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#name OutputsTcpSyslog#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#priority OutputsTcpSyslog#priority}
  */
  readonly priority?: number;
  /**
  * host:port of the server where syslog data should be sent 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#server OutputsTcpSyslog#server}
  */
  readonly server?: string;
  /**
  * Specifies a rule for handling data in addition to that provided by the "syslog" sourcetype. By default, there is no value for syslogSourceType.This string is used as a substring match against the sourcetype key. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#syslog_sourcetype OutputsTcpSyslog#syslog_sourcetype}
  */
  readonly syslogSourcetype?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#timestamp_format OutputsTcpSyslog#timestamp_format}
  */
  readonly timestampFormat?: string;
  /**
  * Protocol to use to send syslog data. Valid values: (tcp | udp ). 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#type OutputsTcpSyslog#type}
  */
  readonly type?: string;
  /**
  * acl block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#acl OutputsTcpSyslog#acl}
  */
  readonly acl?: OutputsTcpSyslogAcl;
}
export interface OutputsTcpSyslogAcl {
  /**
  * The app context for the resource. Required for updating saved search ACL properties. Allowed values are:The name of an app and system
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#app OutputsTcpSyslog#app}
  */
  readonly app?: string;
  /**
  * Indicates if the active user can change permissions for this object. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#can_change_perms OutputsTcpSyslog#can_change_perms}
  */
  readonly canChangePerms?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can change sharing to app level. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#can_share_app OutputsTcpSyslog#can_share_app}
  */
  readonly canShareApp?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can change sharing to system level. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#can_share_global OutputsTcpSyslog#can_share_global}
  */
  readonly canShareGlobal?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can change sharing to user level. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#can_share_user OutputsTcpSyslog#can_share_user}
  */
  readonly canShareUser?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the active user can edit this object. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#can_write OutputsTcpSyslog#can_write}
  */
  readonly canWrite?: boolean | cdktf.IResolvable;
  /**
  * User name of resource owner. Defaults to the resource creator. Required for updating any knowledge object ACL properties.nobody = All users may access the resource, but write access to the resource might be restricted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#owner OutputsTcpSyslog#owner}
  */
  readonly owner?: string;
  /**
  * Properties that indicate resource read permissions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#read OutputsTcpSyslog#read}
  */
  readonly read?: string[];
  /**
  * Indicates whether an admin or user with sufficient permissions can delete the entity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#removable OutputsTcpSyslog#removable}
  */
  readonly removable?: boolean | cdktf.IResolvable;
  /**
  * Indicates how the resource is shared. Required for updating any knowledge object ACL properties.app: Shared within a specific appglobal: (Default) Shared globally to all apps.user: Private to a user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#sharing OutputsTcpSyslog#sharing}
  */
  readonly sharing?: string;
  /**
  * Properties that indicate resource write permissions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#write OutputsTcpSyslog#write}
  */
  readonly write?: string[];
}

export function outputsTcpSyslogAclToTerraform(struct?: OutputsTcpSyslogAclOutputReference | OutputsTcpSyslogAcl): any {
...
export function outputsTcpSyslogAclToHclTerraform(struct?: OutputsTcpSyslogAclOutputReference | OutputsTcpSyslogAcl): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class OutputsTcpSyslogAclOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OutputsTcpSyslogAcl | undefined {
  ...
  public set internalValue(value: OutputsTcpSyslogAcl | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog splunk_outputs_tcp_syslog}
*/
export class OutputsTcpSyslog extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "splunk_outputs_tcp_syslog";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a OutputsTcpSyslog resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the OutputsTcpSyslog to import
  * @param importFromId The id of the existing OutputsTcpSyslog that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the OutputsTcpSyslog to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "splunk_outputs_tcp_syslog", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk/splunk/1.4.32/docs/resources/outputs_tcp_syslog splunk_outputs_tcp_syslog} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options OutputsTcpSyslogConfig
  */
  public constructor(scope: Construct, id: string, config: OutputsTcpSyslogConfig) {
    super(scope, id, {
    ...
    this._syslogSourcetype = config.syslogSourcetype;
  ...
  // syslog_sourcetype - computed: true, optional: true, required: false
  private _syslogSourcetype?: string; 
  public get syslogSourcetype() {
    return this.getStringAttribute('syslog_sourcetype');
  }
  public set syslogSourcetype(value: string) {
    this._syslogSourcetype = value;
  }
  public resetSyslogSourcetype() {
    this._syslogSourcetype = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get syslogSourcetypeInput() {
    return this._syslogSourcetype;
  }
  ...
  private _acl = new OutputsTcpSyslogAclOutputReference(this, "acl");
  public get acl() {
    return this._acl;
  }
  public putAcl(value: OutputsTcpSyslogAcl) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      syslog_sourcetype: cdktf.stringToTerraform(this._syslogSourcetype),
      timestamp_format: cdktf.stringToTerraform(this._timestampFormat),
      type: cdktf.stringToTerraform(this._type),
      acl: outputsTcpSyslogAclToTerraform(this._acl.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      syslog_sourcetype: {
        value: cdktf.stringToHclTerraform(this._syslogSourcetype),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      acl: {
        value: outputsTcpSyslogAclToHclTerraform(this._acl.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OutputsTcpSyslogAclList",
      },
    };
