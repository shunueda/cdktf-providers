// https://registry.terraform.io/providers/segmentio/segment/1.6.1/docs/data-sources/destination
...
export interface DataSegmentDestinationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/segmentio/segment/1.6.1/docs/data-sources/destination#id DataSegmentDestination#id}
  *
...
export interface DataSegmentDestinationMetadataActions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/segmentio/segment/1.6.1/docs/data-sources/destination#default_trigger DataSegmentDestination#default_trigger}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/segmentio/segment/1.6.1/docs/data-sources/destination segment_destination}
*/
export class DataSegmentDestination extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSegmentDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/segmentio/segment/1.6.1/docs/data-sources/destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/segmentio/segment/1.6.1/docs/data-sources/destination segment_destination} Data Source
  *
  * @param scope The scope in which to define this construct
