// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/dis_checkpoint_v2
...
export interface DisCheckpointV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/dis_checkpoint_v2#app_name DisCheckpointV2#app_name}
  */
  readonly appName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/dis_checkpoint_v2#checkpoint_type DisCheckpointV2#checkpoint_type}
  */
  readonly checkpointType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/dis_checkpoint_v2#id DisCheckpointV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/dis_checkpoint_v2#metadata DisCheckpointV2#metadata}
  */
  readonly metadata?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/dis_checkpoint_v2#partition_id DisCheckpointV2#partition_id}
  */
  readonly partitionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/dis_checkpoint_v2#sequence_number DisCheckpointV2#sequence_number}
  */
  readonly sequenceNumber: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/dis_checkpoint_v2#stream_name DisCheckpointV2#stream_name}
  */
  readonly streamName: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/dis_checkpoint_v2#timeouts DisCheckpointV2#timeouts}
  */
  readonly timeouts?: DisCheckpointV2Timeouts;
}
export interface DisCheckpointV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/dis_checkpoint_v2#update DisCheckpointV2#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/dis_checkpoint_v2 opentelekomcloud_dis_checkpoint_v2}
*/
export class DisCheckpointV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DisCheckpointV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/dis_checkpoint_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/dis_checkpoint_v2 opentelekomcloud_dis_checkpoint_v2} Resource
  *
  * @param scope The scope in which to define this construct
