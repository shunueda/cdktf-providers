// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/data-sources/rds_major_versions_v3
...
export interface DataOpentelekomcloudRdsMajorVersionsV3Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/data-sources/rds_major_versions_v3#id DataOpentelekomcloudRdsMajorVersionsV3#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/data-sources/rds_major_versions_v3#instance_id DataOpentelekomcloudRdsMajorVersionsV3#instance_id}
  */
  readonly instanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/data-sources/rds_major_versions_v3 opentelekomcloud_rds_major_versions_v3}
*/
export class DataOpentelekomcloudRdsMajorVersionsV3 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpentelekomcloudRdsMajorVersionsV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/data-sources/rds_major_versions_v3#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/data-sources/rds_major_versions_v3 opentelekomcloud_rds_major_versions_v3} Data Source
  *
  * @param scope The scope in which to define this construct
