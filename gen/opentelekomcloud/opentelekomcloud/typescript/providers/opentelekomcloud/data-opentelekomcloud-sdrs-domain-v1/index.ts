// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/data-sources/sdrs_domain_v1
...
export interface DataOpentelekomcloudSdrsDomainV1Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/data-sources/sdrs_domain_v1#id DataOpentelekomcloudSdrsDomainV1#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/data-sources/sdrs_domain_v1#name DataOpentelekomcloudSdrsDomainV1#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/data-sources/sdrs_domain_v1 opentelekomcloud_sdrs_domain_v1}
*/
export class DataOpentelekomcloudSdrsDomainV1 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpentelekomcloudSdrsDomainV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/data-sources/sdrs_domain_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/data-sources/sdrs_domain_v1 opentelekomcloud_sdrs_domain_v1} Data Source
  *
  * @param scope The scope in which to define this construct
