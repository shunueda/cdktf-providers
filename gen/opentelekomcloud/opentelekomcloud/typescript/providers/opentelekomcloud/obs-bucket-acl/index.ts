// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/obs_bucket_acl
...
export interface ObsBucketAclConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/obs_bucket_acl#bucket ObsBucketAcl#bucket}
  */
  readonly bucket: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/obs_bucket_acl#id ObsBucketAcl#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/obs_bucket_acl#account_permission ObsBucketAcl#account_permission}
  */
  readonly accountPermission?: ObsBucketAclAccountPermission[] | cdktf.IResolvable;
  /**
  * log_delivery_user_permission block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/obs_bucket_acl#log_delivery_user_permission ObsBucketAcl#log_delivery_user_permission}
  */
  readonly logDeliveryUserPermission?: ObsBucketAclLogDeliveryUserPermission;
  /**
  * owner_permission block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/obs_bucket_acl#owner_permission ObsBucketAcl#owner_permission}
  */
  readonly ownerPermission?: ObsBucketAclOwnerPermission;
  /**
  * public_permission block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/obs_bucket_acl#public_permission ObsBucketAcl#public_permission}
  */
  readonly publicPermission?: ObsBucketAclPublicPermission;
}
export interface ObsBucketAclAccountPermission {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/obs_bucket_acl#access_to_acl ObsBucketAcl#access_to_acl}
  */
  readonly accessToAcl?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/obs_bucket_acl#access_to_bucket ObsBucketAcl#access_to_bucket}
  */
  readonly accessToBucket?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/obs_bucket_acl#account_id ObsBucketAcl#account_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/obs_bucket_acl opentelekomcloud_obs_bucket_acl}
*/
export class ObsBucketAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObsBucketAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/obs_bucket_acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.55/docs/resources/obs_bucket_acl opentelekomcloud_obs_bucket_acl} Resource
  *
  * @param scope The scope in which to define this construct
