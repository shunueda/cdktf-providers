// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.53/docs/resources/hss_host_group_v5
...
export class HssHostGroupV5 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HssHostGroupV5 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.53/docs/resources/hss_host_group_v5#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.53/docs/resources/hss_host_group_v5 opentelekomcloud_hss_host_group_v5} Resource
  *
  * @param scope The scope in which to define this construct
