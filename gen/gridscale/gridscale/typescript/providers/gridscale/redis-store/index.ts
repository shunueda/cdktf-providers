...
export function redisStoreListenPortToTerraform(struct?: RedisStoreListenPort): any {
...
export function redisStoreListenPortToHclTerraform(struct?: RedisStoreListenPort): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RedisStoreListenPortOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RedisStoreListenPort | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: RedisStoreListenPort | undefined) {
    if (value === undefined) {
...
export class RedisStoreListenPortList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): RedisStoreListenPortOutputReference {
    return new RedisStoreListenPortOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function redisStoreTimeoutsToTerraform(struct?: RedisStoreTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function redisStoreTimeoutsToHclTerraform(struct?: RedisStoreTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RedisStoreTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): RedisStoreTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: RedisStoreTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class RedisStore extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "gridscale_redis_store";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "gridscale_redis_store", importId: importFromId, provider });
      }
  ...
  * @param options RedisStoreConfig
  */
  public constructor(scope: Construct, id: string, config: RedisStoreConfig) {
    super(scope, id, {
  ...
  private _listenPort = new RedisStoreListenPortList(this, "listen_port", true);
  ...
  private _timeouts = new RedisStoreTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: RedisStoreTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: redisStoreTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: redisStoreTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "RedisStoreTimeouts",
      },
    };
