...
export interface DataGridscaleSnapshotscheduleSnapshot {
}

export function dataGridscaleSnapshotscheduleSnapshotToTerraform(struct?: DataGridscaleSnapshotscheduleSnapshot): any {
...
export function dataGridscaleSnapshotscheduleSnapshotToHclTerraform(struct?: DataGridscaleSnapshotscheduleSnapshot): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataGridscaleSnapshotscheduleSnapshotOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataGridscaleSnapshotscheduleSnapshot | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGridscaleSnapshotscheduleSnapshot | undefined) {
    if (value === undefined) {
...
export class DataGridscaleSnapshotscheduleSnapshotList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataGridscaleSnapshotscheduleSnapshotOutputReference {
    return new DataGridscaleSnapshotscheduleSnapshotOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGridscaleSnapshotschedule extends cdktf.TerraformDataSource {
  ...
  * @param options DataGridscaleSnapshotscheduleConfig
  */
  public constructor(scope: Construct, id: string, config: DataGridscaleSnapshotscheduleConfig) {
    super(scope, id, {
  ...
  // keep_snapshots - computed: true, optional: false, required: false
  ...
  private _snapshot = new DataGridscaleSnapshotscheduleSnapshotList(this, "snapshot", true);
  public get snapshot() {
