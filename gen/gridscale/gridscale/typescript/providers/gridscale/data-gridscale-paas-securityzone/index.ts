// https://registry.terraform.io/providers/gridscale/gridscale/2.3.0/docs/data-sources/paas_securityzone
...
export interface DataGridscalePaasSecurityzoneConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gridscale/gridscale/2.3.0/docs/data-sources/paas_securityzone#id DataGridscalePaasSecurityzone#id}
  *
  ...
  * ID of a resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gridscale/gridscale/2.3.0/docs/data-sources/paas_securityzone#resource_id DataGridscalePaasSecurityzone#resource_id}
  */
  readonly resourceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gridscale/gridscale/2.3.0/docs/data-sources/paas_securityzone gridscale_paas_securityzone}
*/
export class DataGridscalePaasSecurityzone extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGridscalePaasSecurityzone that should be imported. Refer to the {@link https://registry.terraform.io/providers/gridscale/gridscale/2.3.0/docs/data-sources/paas_securityzone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gridscale/gridscale/2.3.0/docs/data-sources/paas_securityzone gridscale_paas_securityzone} Data Source
  *
  * @param scope The scope in which to define this construct
