...
export function sqlserverListenPortToTerraform(struct?: SqlserverListenPort): any {
...
export function sqlserverListenPortToHclTerraform(struct?: SqlserverListenPort): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SqlserverListenPortOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SqlserverListenPort | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: SqlserverListenPort | undefined) {
    if (value === undefined) {
...
export class SqlserverListenPortList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): SqlserverListenPortOutputReference {
    return new SqlserverListenPortOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function sqlserverS3BackupToTerraform(struct?: SqlserverS3BackupOutputReference | SqlserverS3Backup): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    backup_access_key: cdktf.stringToTerraform(struct!.backupAccessKey),
    backup_bucket: cdktf.stringToTerraform(struct!.backupBucket),
    ...
    backup_server_url: cdktf.stringToTerraform(struct!.backupServerUrl),
  }
}


export function sqlserverS3BackupToHclTerraform(struct?: SqlserverS3BackupOutputReference | SqlserverS3Backup): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    backup_access_key: {
      value: cdktf.stringToHclTerraform(struct!.backupAccessKey),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    backup_bucket: {
      value: cdktf.stringToHclTerraform(struct!.backupBucket),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    ...
    backup_server_url: {
      value: cdktf.stringToHclTerraform(struct!.backupServerUrl),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class SqlserverS3BackupOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): SqlserverS3Backup | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._backupAccessKey !== undefined) {
      hasAnyValues = true;
      internalValueResult.backupAccessKey = this._backupAccessKey;
    }
    if (this._backupBucket !== undefined) {
      hasAnyValues = true;
      internalValueResult.backupBucket = this._backupBucket;
    }
    ...
    if (this._backupServerUrl !== undefined) {
      hasAnyValues = true;
      internalValueResult.backupServerUrl = this._backupServerUrl;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: SqlserverS3Backup | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._backupAccessKey = undefined;
      this._backupBucket = undefined;
      this._backupRetention = undefined;
      this._backupSecretKey = undefined;
      this._backupServerUrl = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._backupAccessKey = value.backupAccessKey;
      this._backupBucket = value.backupBucket;
      this._backupRetention = value.backupRetention;
      this._backupSecretKey = value.backupSecretKey;
      this._backupServerUrl = value.backupServerUrl;
    }
  }

  // backup_access_key - computed: false, optional: false, required: true
  private _backupAccessKey?: string; 
  public get backupAccessKey() {
    return this.getStringAttribute('backup_access_key');
  }
  public set backupAccessKey(value: string) {
    this._backupAccessKey = value;
  }
  // Temporarily expose input value. Use with caution.
  public get backupAccessKeyInput() {
    return this._backupAccessKey;
  }

  // backup_bucket - computed: false, optional: false, required: true
  private _backupBucket?: string; 
  public get backupBucket() {
    return this.getStringAttribute('backup_bucket');
  }
  public set backupBucket(value: string) {
    this._backupBucket = value;
  }
  // Temporarily expose input value. Use with caution.
  public get backupBucketInput() {
    return this._backupBucket;
  }
  ...
  // backup_secret_key - computed: false, optional: false, required: true
  ...
  // backup_server_url - computed: false, optional: true, required: false
  private _backupServerUrl?: string; 
  public get backupServerUrl() {
    return this.getStringAttribute('backup_server_url');
  }
  public set backupServerUrl(value: string) {
    this._backupServerUrl = value;
  }
  public resetBackupServerUrl() {
    this._backupServerUrl = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get backupServerUrlInput() {
    return this._backupServerUrl;
  }
}
...
export class Sqlserver extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "gridscale_sqlserver";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "gridscale_sqlserver", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: SqlserverConfig) {
    ...
    this._s3Backup.internalValue = config.s3Backup;
  ...
  private _listenPort = new SqlserverListenPortList(this, "listen_port", true);
  ...
  // s3_backup - computed: false, optional: true, required: false
  private _s3Backup = new SqlserverS3BackupOutputReference(this, "s3_backup");
  public get s3Backup() {
    return this._s3Backup;
  }
  public putS3Backup(value: SqlserverS3Backup) {
    this._s3Backup.internalValue = value;
  }
  public resetS3Backup() {
    this._s3Backup.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get s3BackupInput() {
    return this._s3Backup.internalValue;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      s3_backup: sqlserverS3BackupToTerraform(this._s3Backup.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      s3_backup: {
        value: sqlserverS3BackupToHclTerraform(this._s3Backup.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "SqlserverS3BackupList",
      },
      timeouts: {
