...
export function mysql80ListenPortToTerraform(struct?: Mysql80ListenPort): any {
...
export function mysql80ListenPortToHclTerraform(struct?: Mysql80ListenPort): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Mysql80ListenPortOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Mysql80ListenPort | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: Mysql80ListenPort | undefined) {
    if (value === undefined) {
...
export class Mysql80ListenPortList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): Mysql80ListenPortOutputReference {
    return new Mysql80ListenPortOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function mysql80TimeoutsToTerraform(struct?: Mysql80Timeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function mysql80TimeoutsToHclTerraform(struct?: Mysql80Timeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Mysql80TimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): Mysql80Timeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: Mysql80Timeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class Mysql80 extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "gridscale_mysql8_0";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "gridscale_mysql8_0", importId: importFromId, provider });
      }
  ...
  * @param options Mysql80Config
  */
  public constructor(scope: Construct, id: string, config: Mysql80Config) {
    super(scope, id, {
  ...
  private _listenPort = new Mysql80ListenPortList(this, "listen_port", true);
  ...
  private _timeouts = new Mysql80TimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: Mysql80Timeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: mysql80TimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: mysql80TimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "Mysql80Timeouts",
      },
    };
