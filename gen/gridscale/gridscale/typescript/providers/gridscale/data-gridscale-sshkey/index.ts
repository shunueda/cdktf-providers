// https://registry.terraform.io/providers/gridscale/gridscale/2.2.3/docs/data-sources/sshkey
...
export interface DataGridscaleSshkeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gridscale/gridscale/2.2.3/docs/data-sources/sshkey#id DataGridscaleSshkey#id}
  *
  ...
  * ID of a resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gridscale/gridscale/2.2.3/docs/data-sources/sshkey#resource_id DataGridscaleSshkey#resource_id}
  */
  readonly resourceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/gridscale/gridscale/2.2.3/docs/data-sources/sshkey gridscale_sshkey}
*/
export class DataGridscaleSshkey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGridscaleSshkey that should be imported. Refer to the {@link https://registry.terraform.io/providers/gridscale/gridscale/2.2.3/docs/data-sources/sshkey#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gridscale/gridscale/2.2.3/docs/data-sources/sshkey gridscale_sshkey} Data Source
  *
  * @param scope The scope in which to define this construct
