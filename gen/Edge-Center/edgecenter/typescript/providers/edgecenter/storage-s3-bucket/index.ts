// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/storage_s3_bucket
...
export interface StorageS3BucketConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/storage_s3_bucket#id StorageS3Bucket#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/storage_s3_bucket#name StorageS3Bucket#name}
  */
  readonly name: string;
  /**
  * An id of existing storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/storage_s3_bucket#storage_id StorageS3Bucket#storage_id}
  */
  readonly storageId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/storage_s3_bucket edgecenter_storage_s3_bucket}
*/
export class StorageS3Bucket extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageS3Bucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/storage_s3_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/storage_s3_bucket edgecenter_storage_s3_bucket} Resource
  *
  * @param scope The scope in which to define this construct
