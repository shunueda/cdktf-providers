// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/securitygroup
...
export interface DataEdgecenterSecuritygroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/securitygroup#id DataEdgecenterSecuritygroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/securitygroup#metadata_k DataEdgecenterSecuritygroup#metadata_k}
  */
  readonly metadataK?: string;
  /**
  * Filtration query opts, for example, {offset = "10", limit = "10"}
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/securitygroup#metadata_kv DataEdgecenterSecuritygroup#metadata_kv}
  */
  readonly metadataKv?: { [key: string]: string };
  /**
  * The name of the security group. Either 'id' or 'name' must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/securitygroup#name DataEdgecenterSecuritygroup#name}
  */
  readonly name?: string;
  /**
  * The uuid of the project. Either 'project_id' or 'project_name' must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/securitygroup#project_id DataEdgecenterSecuritygroup#project_id}
  */
  readonly projectId?: number;
  /**
  * The name of the project. Either 'project_id' or 'project_name' must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/securitygroup#project_name DataEdgecenterSecuritygroup#project_name}
  */
  readonly projectName?: string;
  /**
  * The uuid of the region. Either 'region_id' or 'region_name' must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/securitygroup#region_id DataEdgecenterSecuritygroup#region_id}
  */
  readonly regionId?: number;
  /**
  * The name of the region. Either 'region_id' or 'region_name' must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/securitygroup#region_name DataEdgecenterSecuritygroup#region_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/securitygroup edgecenter_securitygroup}
*/
export class DataEdgecenterSecuritygroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEdgecenterSecuritygroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/securitygroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/securitygroup edgecenter_securitygroup} Data Source
  *
  * @param scope The scope in which to define this construct
