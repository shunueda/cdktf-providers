// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/useractions_subscription_log
...
export interface DataEdgecenterUseractionsSubscriptionLogConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/useractions_subscription_log#id DataEdgecenterUseractionsSubscriptionLog#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/useractions_subscription_log edgecenter_useractions_subscription_log}
*/
export class DataEdgecenterUseractionsSubscriptionLog extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEdgecenterUseractionsSubscriptionLog that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/useractions_subscription_log#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/data-sources/useractions_subscription_log edgecenter_useractions_subscription_log} Data Source
  *
  * @param scope The scope in which to define this construct
