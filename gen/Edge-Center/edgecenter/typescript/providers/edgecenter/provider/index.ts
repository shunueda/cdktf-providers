// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs
...
export interface EdgecenterProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#api_endpoint EdgecenterProvider#api_endpoint}
  */
  readonly apiEndpoint?: string;
  /**
  * Region API
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#edgecenter_api EdgecenterProvider#edgecenter_api}
  */
  readonly edgecenterApi?: string;
  /**
  * CDN API (define only if you want to override CDN API endpoint)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#edgecenter_cdn_api EdgecenterProvider#edgecenter_cdn_api}
  */
  readonly edgecenterCdnApi?: string;
  /**
  * Region API (define only if you want to override Region API endpoint)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#edgecenter_cloud_api EdgecenterProvider#edgecenter_cloud_api}
  */
  readonly edgecenterCloudApi?: string;
  /**
  * DNS API (define only if you want to override DNS API endpoint)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#edgecenter_dns_api EdgecenterProvider#edgecenter_dns_api}
  */
  readonly edgecenterDnsApi?: string;
  /**
  * Platform URL is used for generate JWT
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#edgecenter_platform EdgecenterProvider#edgecenter_platform}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#edgecenter_platform_api EdgecenterProvider#edgecenter_platform_api}
  */
  readonly edgecenterPlatformApi?: string;
  /**
  * Protection API (define only if you want to override Protection API endpoint)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#edgecenter_protection_api EdgecenterProvider#edgecenter_protection_api}
  */
  readonly edgecenterProtectionApi?: string;
  /**
  * Storage API (define only if you want to override Storage API endpoint)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#edgecenter_storage_api EdgecenterProvider#edgecenter_storage_api}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#ignore_creds_auth_error EdgecenterProvider#ignore_creds_auth_error}
  */
  readonly ignoreCredsAuthError?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#password EdgecenterProvider#password}
  */
  readonly password?: string;
  /**
  * A permanent [API-token](https://support.edgecenter.ru/knowledge_base/item/257788)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#permanent_api_token EdgecenterProvider#permanent_api_token}
  */
  readonly permanentApiToken?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#user_name EdgecenterProvider#user_name}
  */
  readonly userName?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#alias EdgecenterProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs edgecenter}
*/
export class EdgecenterProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing EdgecenterProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs edgecenter} Resource
  *
  * @param scope The scope in which to define this construct
