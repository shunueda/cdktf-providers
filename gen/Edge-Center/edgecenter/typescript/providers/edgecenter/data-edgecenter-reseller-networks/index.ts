// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/data-sources/reseller_networks
...
export interface DataEdgecenterResellerNetworksConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/data-sources/reseller_networks#id DataEdgecenterResellerNetworks#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/data-sources/reseller_networks#metadata_k DataEdgecenterResellerNetworks#metadata_k}
  */
  readonly metadataK?: string[];
  /**
  * Filtration query opts, for example, {key = "value", key_1 = "value_1"}.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/data-sources/reseller_networks#metadata_kv DataEdgecenterResellerNetworks#metadata_kv}
  */
  readonly metadataKv?: { [key: string]: string };
  /**
  * Filter networks by the type of the network (vlan or vxlan).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/data-sources/reseller_networks#network_type DataEdgecenterResellerNetworks#network_type}
  */
  readonly networkType?: string;
  /**
  * Order networks by transmitted fields and directions (name.asc).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/data-sources/reseller_networks#order_by DataEdgecenterResellerNetworks#order_by}
  */
  readonly orderBy?: string;
  /**
  * Can be used to only show networks with the shared state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/data-sources/reseller_networks#shared DataEdgecenterResellerNetworks#shared}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/data-sources/reseller_networks edgecenter_reseller_networks}
*/
export class DataEdgecenterResellerNetworks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEdgecenterResellerNetworks that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/data-sources/reseller_networks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/data-sources/reseller_networks edgecenter_reseller_networks} Data Source
  *
  * @param scope The scope in which to define this construct
