// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/useractions_subscription_log
...
export interface UseractionsSubscriptionLogConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/useractions_subscription_log#auth_header_name UseractionsSubscriptionLog#auth_header_name}
  */
  readonly authHeaderName: string;
  /**
  * The value of the authorization header
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/useractions_subscription_log#auth_header_value UseractionsSubscriptionLog#auth_header_value}
  */
  readonly authHeaderValue: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/useractions_subscription_log#id UseractionsSubscriptionLog#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/useractions_subscription_log#url UseractionsSubscriptionLog#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/useractions_subscription_log edgecenter_useractions_subscription_log}
*/
export class UseractionsSubscriptionLog extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UseractionsSubscriptionLog that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/useractions_subscription_log#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/useractions_subscription_log edgecenter_useractions_subscription_log} Resource
  *
  * @param scope The scope in which to define this construct
