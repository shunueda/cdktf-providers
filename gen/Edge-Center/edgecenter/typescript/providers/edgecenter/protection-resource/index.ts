// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource
...
export interface ProtectionResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#active ProtectionResource#active}
  */
  readonly active?: boolean | cdktf.IResolvable;
  /**
  * List of countries to apply geoip_mode policy to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#geoip_list ProtectionResource#geoip_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#geoip_mode ProtectionResource#geoip_mode}
  */
  readonly geoipMode?: string;
  /**
  * Whether to use HTTP to make requests to the origin. If set to false (default), HTTPS is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#http_to_origin ProtectionResource#http_to_origin}
  */
  readonly httpToOrigin?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#id ProtectionResource#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#load_balancing_type ProtectionResource#load_balancing_type}
  */
  readonly loadBalancingType?: string;
  /**
  * Enable or disable Multiple origins feature.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#multiple_origins ProtectionResource#multiple_origins}
  */
  readonly multipleOrigins?: boolean | cdktf.IResolvable;
  /**
  * The DNS name of the DDoS protection resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#name ProtectionResource#name}
  */
  readonly name: string;
  /**
  * Enable or disable from HTTP to HTTPS
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#redirect_to_https ProtectionResource#redirect_to_https}
  */
  readonly redirectToHttps?: boolean | cdktf.IResolvable;
  /**
  * The list of supported TLS versions. Available value: `1`, `1.1`, `1.2`, `1.3`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#tls ProtectionResource#tls}
  */
  readonly tls: string[];
  /**
  * Enable or disable WAF.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#waf ProtectionResource#waf}
  */
  readonly waf?: boolean | cdktf.IResolvable;
  /**
  * Enable or disable Wildcard aliases feature.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#wildcard_aliases ProtectionResource#wildcard_aliases}
  */
  readonly wildcardAliases?: boolean | cdktf.IResolvable;
  /**
  * Enable or disable redirect from WWW to the primary domain option.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#www_redirect ProtectionResource#www_redirect}
  */
  readonly wwwRedirect?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource edgecenter_protection_resource}
*/
export class ProtectionResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProtectionResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.4/docs/resources/protection_resource edgecenter_protection_resource} Resource
  *
  * @param scope The scope in which to define this construct
