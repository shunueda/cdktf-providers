// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/resources/protection_resource_certificate
...
export interface ProtectionResourceCertificateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/resources/protection_resource_certificate#id ProtectionResourceCertificate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/resources/protection_resource_certificate#resource ProtectionResourceCertificate#resource}
  */
  readonly resource: string;
  /**
  * Public part of the SSL certificate. It is required add all chains. Each certificate chain should be separated by `\n`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/resources/protection_resource_certificate#ssl_crt ProtectionResourceCertificate#ssl_crt}
  */
  readonly sslCrt?: string;
  /**
  * Private key of the SSL certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/resources/protection_resource_certificate#ssl_key ProtectionResourceCertificate#ssl_key}
  */
  readonly sslKey?: string;
  /**
  * Select the SSL certificate type. Available values are `custom`, `le`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/resources/protection_resource_certificate#ssl_type ProtectionResourceCertificate#ssl_type}
  */
  readonly sslType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/resources/protection_resource_certificate edgecenter_protection_resource_certificate}
*/
export class ProtectionResourceCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProtectionResourceCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/resources/protection_resource_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.7/docs/resources/protection_resource_certificate edgecenter_protection_resource_certificate} Resource
  *
  * @param scope The scope in which to define this construct
