// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/cdn_shielding
...
export interface CdnShieldingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/cdn_shielding#id CdnShielding#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/cdn_shielding#resource_id CdnShielding#resource_id}
  */
  readonly resourceId: number;
  /**
  * Set the origin shielding location ID or disable the option using the null value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/cdn_shielding#shielding_pop CdnShielding#shielding_pop}
  */
  readonly shieldingPop: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/cdn_shielding edgecenter_cdn_shielding}
*/
export class CdnShielding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnShielding that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/cdn_shielding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/cdn_shielding edgecenter_cdn_shielding} Resource
  *
  * @param scope The scope in which to define this construct
