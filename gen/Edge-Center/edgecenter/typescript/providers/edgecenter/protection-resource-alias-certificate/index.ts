// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/protection_resource_alias_certificate
...
export interface ProtectionResourceAliasCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/protection_resource_alias_certificate#alias ProtectionResourceAliasCertificate#alias}
  */
  readonly alias: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/protection_resource_alias_certificate#id ProtectionResourceAliasCertificate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/protection_resource_alias_certificate#ssl_crt ProtectionResourceAliasCertificate#ssl_crt}
  */
  readonly sslCrt?: string;
  /**
  * Private key of the SSL certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/protection_resource_alias_certificate#ssl_key ProtectionResourceAliasCertificate#ssl_key}
  */
  readonly sslKey?: string;
  /**
  * Select the SSL certificate type. Available values are `custom`, `le`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/protection_resource_alias_certificate#ssl_type ProtectionResourceAliasCertificate#ssl_type}
  */
  readonly sslType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/protection_resource_alias_certificate edgecenter_protection_resource_alias_certificate}
*/
export class ProtectionResourceAliasCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProtectionResourceAliasCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/protection_resource_alias_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/resources/protection_resource_alias_certificate edgecenter_protection_resource_alias_certificate} Resource
  *
  * @param scope The scope in which to define this construct
