// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/resources/protection_resource_origin
...
export interface ProtectionResourceOriginConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/resources/protection_resource_origin#comment ProtectionResourceOrigin#comment}
  */
  readonly comment?: string;
  /**
  * Time (in seconds) after which the server is considered unreachable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/resources/protection_resource_origin#fail_timeout ProtectionResourceOrigin#fail_timeout}
  */
  readonly failTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/resources/protection_resource_origin#id ProtectionResourceOrigin#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/resources/protection_resource_origin#ip ProtectionResourceOrigin#ip}
  */
  readonly ip: string;
  /**
  * Max number of failed connection attempts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/resources/protection_resource_origin#max_fails ProtectionResourceOrigin#max_fails}
  */
  readonly maxFails?: number;
  /**
  * Operation mode for this origin. Available values are `primary`, `backup`, `down`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/resources/protection_resource_origin#mode ProtectionResourceOrigin#mode}
  */
  readonly mode?: string;
  /**
  * ID of the DDoS protection resource using this origin.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/resources/protection_resource_origin#resource ProtectionResourceOrigin#resource}
  */
  readonly resource: string;
  /**
  * Origin weight for request balancing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/resources/protection_resource_origin#weight ProtectionResourceOrigin#weight}
  */
  readonly weight?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/resources/protection_resource_origin edgecenter_protection_resource_origin}
*/
export class ProtectionResourceOrigin extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProtectionResourceOrigin that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/resources/protection_resource_origin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.5/docs/resources/protection_resource_origin edgecenter_protection_resource_origin} Resource
  *
  * @param scope The scope in which to define this construct
