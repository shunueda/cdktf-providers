// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/data-sources/useractions_subscription_amqp
...
export interface DataEdgecenterUseractionsSubscriptionAmqpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/data-sources/useractions_subscription_amqp#id DataEdgecenterUseractionsSubscriptionAmqp#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/data-sources/useractions_subscription_amqp edgecenter_useractions_subscription_amqp}
*/
export class DataEdgecenterUseractionsSubscriptionAmqp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEdgecenterUseractionsSubscriptionAmqp that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/data-sources/useractions_subscription_amqp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.6/docs/data-sources/useractions_subscription_amqp edgecenter_useractions_subscription_amqp} Data Source
  *
  * @param scope The scope in which to define this construct
