// https://registry.terraform.io/providers/nekottyo/jsonschema/0.1.1/docs
...
export interface JsonschemaProviderConfig {
  ...
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nekottyo/jsonschema/0.1.1/docs#alias JsonschemaProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nekottyo/jsonschema/0.1.1/docs jsonschema}
*/
export class JsonschemaProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing JsonschemaProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/nekottyo/jsonschema/0.1.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nekottyo/jsonschema/0.1.1/docs jsonschema} Resource
  *
  * @param scope The scope in which to define this construct
