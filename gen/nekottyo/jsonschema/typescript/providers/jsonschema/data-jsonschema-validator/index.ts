// https://registry.terraform.io/providers/nekottyo/jsonschema/0.1.1/docs/data-sources/validator
...
export interface DataJsonschemaValidatorConfig extends cdktf.TerraformMetaArguments {
  /**
  * body of a yaml or json file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nekottyo/jsonschema/0.1.1/docs/data-sources/validator#document DataJsonschemaValidator#document}
  */
  readonly document: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nekottyo/jsonschema/0.1.1/docs/data-sources/validator#id DataJsonschemaValidator#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * json schema to validate content by
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nekottyo/jsonschema/0.1.1/docs/data-sources/validator#schema DataJsonschemaValidator#schema}
  */
  readonly schema: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nekottyo/jsonschema/0.1.1/docs/data-sources/validator jsonschema_validator}
*/
export class DataJsonschemaValidator extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataJsonschemaValidator that should be imported. Refer to the {@link https://registry.terraform.io/providers/nekottyo/jsonschema/0.1.1/docs/data-sources/validator#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nekottyo/jsonschema/0.1.1/docs/data-sources/validator jsonschema_validator} Data Source
  *
  * @param scope The scope in which to define this construct
