// https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook
...
export interface RunbookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#allowed_entities Runbook#allowed_entities}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#allowed_resources_query Runbook#allowed_resources_query}
  */
  readonly allowedResourcesQuery?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#approvers Runbook#approvers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#cells Runbook#cells}
  */
  readonly cells?: string;
  /**
  * Enables slack notifications for approvals operations. (Requires workspace and channel.) Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#communication_approval_notifications Runbook#communication_approval_notifications}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#communication_channel Runbook#communication_channel}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#communication_cud_notifications Runbook#communication_cud_notifications}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#communication_execution_notifications Runbook#communication_execution_notifications}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#communication_workspace Runbook#communication_workspace}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#data Runbook#data}
  */
  readonly data?: string;
  /**
  * A user-friendly explanation of an object. Defaults to ``.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#description Runbook#description}
  */
  readonly description?: string;
  /**
  * List of users who can edit the object (with configure permission). Empty maps to all users.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#editors Runbook#editors}
  */
  readonly editors?: string[];
  /**
  * If the object is currently enabled or disabled. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#enabled Runbook#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#external_params Runbook#external_params}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#filter_resource_to_action Runbook#filter_resource_to_action}
  */
  readonly filterResourceToAction?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#id Runbook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#is_run_output_persisted Runbook#is_run_output_persisted}
  */
  readonly isRunOutputPersisted?: boolean | cdktf.IResolvable;
  /**
  * A list of strings by which notebooks can be grouped.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#labels Runbook#labels}
  */
  readonly labels?: string[];
  /**
  * The name/symbol for the object within Shoreline and the op language (must be unique, only alphanumeric/underscore).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#name Runbook#name}
  */
  readonly name: string;
  /**
  * Named variables to pass to an object (e.g. an Action). Defaults to ``.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#params Runbook#params}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#resource_query Runbook#resource_query}
  */
  readonly resourceQuery?: string;
  /**
  * A list of strings that contains the name of the secrets that are used in the runbook.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#secret_names Runbook#secret_names}
  */
  readonly secretNames?: string[];
  /**
  * Defaults to `60000`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#timeout_ms Runbook#timeout_ms}
  */
  readonly timeoutMs?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook shoreline_runbook}
*/
export class Runbook extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "shoreline_runbook";
  ...
  * @param importFromId The id of the existing Runbook that should be imported. Refer to the {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Runbook to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "shoreline_runbook", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/shorelinesoftware/shoreline/1.15.38/docs/resources/runbook shoreline_runbook} Resource
  *
  * @param scope The scope in which to define this construct
