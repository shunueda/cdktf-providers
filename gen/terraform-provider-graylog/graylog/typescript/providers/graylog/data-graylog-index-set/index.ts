// https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set
...
export interface DataGraylogIndexSetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#creation_date DataGraylogIndexSet#creation_date}
  */
  readonly creationDate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#default DataGraylogIndexSet#default}
  */
  readonly default?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#description DataGraylogIndexSet#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#field_type_refresh_interval DataGraylogIndexSet#field_type_refresh_interval}
  */
  readonly fieldTypeRefreshInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#id DataGraylogIndexSet#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#index_analyzer DataGraylogIndexSet#index_analyzer}
  */
  readonly indexAnalyzer?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#index_optimization_disabled DataGraylogIndexSet#index_optimization_disabled}
  */
  readonly indexOptimizationDisabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#index_optimization_max_num_segments DataGraylogIndexSet#index_optimization_max_num_segments}
  */
  readonly indexOptimizationMaxNumSegments?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#index_prefix DataGraylogIndexSet#index_prefix}
  */
  readonly indexPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#index_set_id DataGraylogIndexSet#index_set_id}
  */
  readonly indexSetId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#replicas DataGraylogIndexSet#replicas}
  */
  readonly replicas?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#retention_strategy DataGraylogIndexSet#retention_strategy}
  */
  readonly retentionStrategy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#retention_strategy_class DataGraylogIndexSet#retention_strategy_class}
  */
  readonly retentionStrategyClass?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#rotation_strategy DataGraylogIndexSet#rotation_strategy}
  */
  readonly rotationStrategy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#rotation_strategy_class DataGraylogIndexSet#rotation_strategy_class}
  */
  readonly rotationStrategyClass?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#shards DataGraylogIndexSet#shards}
  */
  readonly shards?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#title DataGraylogIndexSet#title}
  */
  readonly title?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#writable DataGraylogIndexSet#writable}
  */
  readonly writable?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set graylog_index_set}
*/
export class DataGraylogIndexSet extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataGraylogIndexSet resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataGraylogIndexSet to import
  * @param importFromId The id of the existing DataGraylogIndexSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataGraylogIndexSet to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-provider-graylog/graylog/1.0.4/docs/data-sources/index_set graylog_index_set} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataGraylogIndexSetConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataGraylogIndexSetConfig = {}) {
    super(scope, id, {
  ...
  // field_type_refresh_interval - computed: true, optional: true, required: false
  ...
  // index_analyzer - computed: true, optional: true, required: false
  ...
  public resetIndexAnalyzer() {
    this._indexAnalyzer = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  // index_optimization_disabled - computed: true, optional: true, required: false
  ...
  // index_optimization_max_num_segments - computed: true, optional: true, required: false
  ...
  public resetIndexOptimizationMaxNumSegments() {
    this._indexOptimizationMaxNumSegments = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  // index_prefix - computed: false, optional: true, required: false
  ...
  // index_set_id - computed: false, optional: true, required: false
  ...
  // retention_strategy - computed: true, optional: true, required: false
  ...
  // retention_strategy_class - computed: true, optional: true, required: false
  ...
  public resetRetentionStrategyClass() {
    this._retentionStrategyClass = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  // rotation_strategy - computed: true, optional: true, required: false
  ...
  public resetRotationStrategy() {
    this._rotationStrategy = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  // rotation_strategy_class - computed: true, optional: true, required: false
  ...
  public resetRotationStrategyClass() {
    this._rotationStrategyClass = undefined;
  }
  // Temporarily expose input value. Use with caution.
