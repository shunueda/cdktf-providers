// https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/virtual_network
...
export interface VirtualNetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/virtual_network#description VirtualNetwork#description}
  */
  readonly description: string;
  /**
  * The project (ID or Slug) to deploy the virtual network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/virtual_network#project VirtualNetwork#project}
  */
  readonly project?: string;
  /**
  * The site to deploy the virtual network (case-insensitive)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/virtual_network#site VirtualNetwork#site}
  */
  readonly site: string;
  /**
  * List of virtual network tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/virtual_network#tags VirtualNetwork#tags}
  */
  readonly tags?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/virtual_network latitudesh_virtual_network}
*/
export class VirtualNetwork extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/virtual_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/virtual_network latitudesh_virtual_network} Resource
  *
  * @param scope The scope in which to define this construct
