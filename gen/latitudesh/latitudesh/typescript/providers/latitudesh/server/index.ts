// https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server
...
export interface ServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#allow_reinstall Server#allow_reinstall}
  */
  readonly allowReinstall?: boolean | cdktf.IResolvable;
  /**
  * The server billing type (hourly, monthly, yearly). Defaults to monthly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#billing Server#billing}
  */
  readonly billing?: string;
  /**
  * The server hostname
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#hostname Server#hostname}
  */
  readonly hostname?: string;
  /**
  * URL where iPXE script is stored on, OR the iPXE script encoded in base64
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#ipxe Server#ipxe}
  */
  readonly ipxe?: string;
  /**
  * Whether the server is locked
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#locked Server#locked}
  */
  readonly locked?: boolean | cdktf.IResolvable;
  /**
  * The operating system for the new server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#operating_system Server#operating_system}
  */
  readonly operatingSystem: string;
  /**
  * The plan to choose server from
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#plan Server#plan}
  */
  readonly plan: string;
  /**
  * The project (ID or Slug) to deploy the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#project Server#project}
  */
  readonly project?: string;
  /**
  * RAID mode for the server (raid-0, raid-1)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#raid Server#raid}
  */
  readonly raid?: string;
  /**
  * The site to deploy the server (case-insensitive)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#site Server#site}
  */
  readonly site: string;
  /**
  * SSH Keys to set on the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#ssh_keys Server#ssh_keys}
  */
  readonly sshKeys?: string[];
  /**
  * List of server tag IDs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#tags Server#tags}
  */
  readonly tags?: string[];
  /**
  * User data ID to assign to the server (reference to latitudesh_user_data resource)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#user_data Server#user_data}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server latitudesh_server}
*/
export class Server extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Server that should be imported. Refer to the {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs/resources/server latitudesh_server} Resource
  *
  * @param scope The scope in which to define this construct
