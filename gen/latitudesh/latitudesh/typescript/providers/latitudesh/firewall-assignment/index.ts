// https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.4/docs/resources/firewall_assignment
...
export interface FirewallAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.4/docs/resources/firewall_assignment#firewall_id FirewallAssignment#firewall_id}
  */
  readonly firewallId?: string;
  /**
  * The ID of the server to assign the firewall to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.4/docs/resources/firewall_assignment#server_id FirewallAssignment#server_id}
  */
  readonly serverId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.4/docs/resources/firewall_assignment latitudesh_firewall_assignment}
*/
export class FirewallAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirewallAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.4/docs/resources/firewall_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.4/docs/resources/firewall_assignment latitudesh_firewall_assignment} Resource
  *
  * @param scope The scope in which to define this construct
