// https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs
...
export interface LatitudeshProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs#auth_token LatitudeshProvider#auth_token}
  */
  readonly authToken?: string;
  /**
  * The project ID to use for all resources. If not set, project must be defined in the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs#project LatitudeshProvider#project}
  */
  readonly project?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs#alias LatitudeshProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs latitudesh}
*/
export class LatitudeshProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing LatitudeshProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.9/docs latitudesh} Resource
  *
  * @param scope The scope in which to define this construct
