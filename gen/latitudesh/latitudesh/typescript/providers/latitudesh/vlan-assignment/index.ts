// https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.6/docs/resources/vlan_assignment
...
export interface VlanAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.6/docs/resources/vlan_assignment#server_id VlanAssignment#server_id}
  */
  readonly serverId: string;
  /**
  * The virtual network ID to assign the server to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.6/docs/resources/vlan_assignment#virtual_network_id VlanAssignment#virtual_network_id}
  */
  readonly virtualNetworkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.6/docs/resources/vlan_assignment latitudesh_vlan_assignment}
*/
export class VlanAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VlanAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.6/docs/resources/vlan_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.6/docs/resources/vlan_assignment latitudesh_vlan_assignment} Resource
  *
  * @param scope The scope in which to define this construct
