// https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.2/docs/resources/firewall
...
export interface FirewallConfig extends cdktf.TerraformMetaArguments {
  ...
  * The firewall name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.2/docs/resources/firewall#name Firewall#name}
  */
  readonly name: string;
  /**
  * The project id or slug. If not set, falls back to provider's project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.2/docs/resources/firewall#project Firewall#project}
  */
  readonly project?: string;
  /**
  * rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.2/docs/resources/firewall#rules Firewall#rules}
  */
...
export interface FirewallRules {
  ...
  * Source IP or range
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.2/docs/resources/firewall#from Firewall#from}
  */
  readonly from: string;
  /**
  * Port or port range
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.2/docs/resources/firewall#port Firewall#port}
  */
  readonly port: string;
  /**
  * Protocol (TCP, UDP, ICMP)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.2/docs/resources/firewall#protocol Firewall#protocol}
  */
  readonly protocol: string;
  /**
  * Destination IP or range
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.2/docs/resources/firewall#to Firewall#to}
  */
  readonly to: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.2/docs/resources/firewall latitudesh_firewall}
*/
export class Firewall extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Firewall that should be imported. Refer to the {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.2/docs/resources/firewall#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/latitudesh/latitudesh/2.8.2/docs/resources/firewall latitudesh_firewall} Resource
  *
  * @param scope The scope in which to define this construct
