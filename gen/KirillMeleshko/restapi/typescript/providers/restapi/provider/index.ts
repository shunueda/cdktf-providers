// https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs
...
export interface RestapiProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#cert_file RestapiProvider#cert_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#cert_string RestapiProvider#cert_string}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#copy_keys RestapiProvider#copy_keys}
  */
  readonly copyKeys?: string[];
  /**
  * Defaults to `POST`. The HTTP method used to CREATE objects of this type on the API server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#create_method RestapiProvider#create_method}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#create_returns_object RestapiProvider#create_returns_object}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#debug RestapiProvider#debug}
  */
  readonly debug?: boolean | cdktf.IResolvable;
  /**
  * Defaults to `DELETE`. The HTTP method used to DELETE objects of this type on the API server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#destroy_method RestapiProvider#destroy_method}
  */
  readonly destroyMethod?: string;
  /**
  * A map of header names and values to set on all outbound requests. This is useful if you want to use a script via the 'external' provider or provide a pre-approved token or change Content-Type from `application/json`. If `username` and `password` are set and Authorization is one of the headers defined here, the BASIC auth credentials take precedence.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#headers RestapiProvider#headers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#id_attribute RestapiProvider#id_attribute}
  */
  readonly idAttribute?: string;
  /**
  * When using https, this disables TLS verification of the host.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#insecure RestapiProvider#insecure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#key_file RestapiProvider#key_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#key_string RestapiProvider#key_string}
  */
  readonly keyString?: string;
  /**
  * When set, will use this password for BASIC auth to the API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#password RestapiProvider#password}
  */
  readonly password?: string;
  /**
  * Set this to limit the number of requests per second made to the API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#rate_limit RestapiProvider#rate_limit}
  */
  readonly rateLimit?: number;
  /**
  * Defaults to `GET`. The HTTP method used to READ objects of this type on the API server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#read_method RestapiProvider#read_method}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#test_path RestapiProvider#test_path}
  */
  readonly testPath?: string;
  /**
  * When set, will cause requests taking longer than this time (in seconds) to be aborted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#timeout RestapiProvider#timeout}
  */
  readonly timeout?: number;
  /**
  * Defaults to `PUT`. The HTTP method used to UPDATE objects of this type on the API server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#update_method RestapiProvider#update_method}
  */
  readonly updateMethod?: string;
  /**
  * URI of the REST API endpoint. This serves as the base of all requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#uri RestapiProvider#uri}
  */
  readonly uri: string;
  /**
  * Enable cookie jar to persist session.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#use_cookies RestapiProvider#use_cookies}
  */
  readonly useCookies?: boolean | cdktf.IResolvable;
  /**
  * When set, will use this username for BASIC auth to the API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#username RestapiProvider#username}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#write_returns_object RestapiProvider#write_returns_object}
  */
  readonly writeReturnsObject?: boolean | cdktf.IResolvable;
  /**
  * Trim the xssi prefix from response string, if present, before parsing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#xssi_prefix RestapiProvider#xssi_prefix}
  */
  readonly xssiPrefix?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#alias RestapiProvider#alias}
  */
  readonly alias?: string;
  /**
  * oauth_client_credentials block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#oauth_client_credentials RestapiProvider#oauth_client_credentials}
  */
...
export interface RestapiProviderOauthClientCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#endpoint_params RestapiProvider#endpoint_params}
  */
  readonly endpointParams?: { [key: string]: string[] } | cdktf.IResolvable;
  /**
  * client id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#oauth_client_id RestapiProvider#oauth_client_id}
  */
  readonly oauthClientId: string;
  /**
  * client secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#oauth_client_secret RestapiProvider#oauth_client_secret}
  */
  readonly oauthClientSecret: string;
  /**
  * scopes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#oauth_scopes RestapiProvider#oauth_scopes}
  */
  readonly oauthScopes?: string[];
  /**
  * oauth token endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#oauth_token_endpoint RestapiProvider#oauth_token_endpoint}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs restapi}
*/
export class RestapiProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing RestapiProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs restapi} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: RestapiProviderConfig) {
    super(scope, id, {
      ...
      terraformProviderSource: 'KirillMeleshko/restapi'
    });
