// https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object
...
export interface ObjectResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#create_method ObjectResource#create_method}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#create_path ObjectResource#create_path}
  */
  readonly createPath?: string;
  /**
  * Valid JSON object that this provider will manage with the API server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#data ObjectResource#data}
  */
  readonly data: string;
  /**
  * Whether to emit verbose debug output while working with the API object on the server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#debug ObjectResource#debug}
  */
  readonly debug?: boolean | cdktf.IResolvable;
  /**
  * Valid JSON object to pass during to destroy requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#destroy_data ObjectResource#destroy_data}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#destroy_method ObjectResource#destroy_method}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#destroy_path ObjectResource#destroy_path}
  */
  readonly destroyPath?: string;
  /**
  * Any changes to these values will result in recreating the resource instead of updating.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#force_new ObjectResource#force_new}
  */
  readonly forceNew?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#id ObjectResource#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#id_attribute ObjectResource#id_attribute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#object_id ObjectResource#object_id}
  */
  readonly objectId?: string;
  /**
  * The API path on top of the base URL set in the provider that represents objects of this type on the API server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#path ObjectResource#path}
  */
  readonly path: string;
  /**
  * Query string to be included in the path
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#query_string ObjectResource#query_string}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#read_method ObjectResource#read_method}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#read_path ObjectResource#read_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#read_search ObjectResource#read_search}
  */
  readonly readSearch?: { [key: string]: string };
  /**
  * Valid JSON object to pass during to update requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#update_data ObjectResource#update_data}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#update_method ObjectResource#update_method}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#update_path ObjectResource#update_path}
  */
  readonly updatePath?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object restapi_object}
*/
export class ObjectResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObjectResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kirillmeleshko/restapi/1.18.2/docs/resources/object restapi_object} Resource
  *
  * @param scope The scope in which to define this construct
