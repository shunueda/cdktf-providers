// https://registry.terraform.io/providers/spotinst/spotinst/1.230.0/docs/resources/elastigroup_aws_suspension
...
export class ElastigroupAwsSuspension extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElastigroupAwsSuspension that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.230.0/docs/resources/elastigroup_aws_suspension#import import section} in the documentation of this resource for the id to use
