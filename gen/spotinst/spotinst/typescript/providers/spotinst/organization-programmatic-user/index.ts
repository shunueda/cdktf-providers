// https://registry.terraform.io/providers/spotinst/spotinst/1.231.0/docs/resources/organization_programmatic_user
...
export class OrganizationProgrammaticUserPoliciesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // policy_account_ids - computed: false, optional: true, required: false
...
export class OrganizationProgrammaticUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationProgrammaticUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/spotinst/spotinst/1.231.0/docs/resources/organization_programmatic_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.231.0/docs/resources/organization_programmatic_user spotinst_organization_programmatic_user} Resource
  *
  * @param scope The scope in which to define this construct
