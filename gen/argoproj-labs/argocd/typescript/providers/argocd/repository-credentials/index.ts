// https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials
...
export interface RepositoryCredentialsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials#enable_oci RepositoryCredentials#enable_oci}
  */
  readonly enableOci?: boolean | cdktf.IResolvable;
  /**
  * GitHub API URL for GitHub app authentication
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials#githubapp_enterprise_base_url RepositoryCredentials#githubapp_enterprise_base_url}
  */
  readonly githubappEnterpriseBaseUrl?: string;
  /**
  * GitHub App ID of the app used to access the repo for GitHub app authentication
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials#githubapp_id RepositoryCredentials#githubapp_id}
  */
  readonly githubappId?: string;
  /**
  * ID of the installed GitHub App for GitHub app authentication
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials#githubapp_installation_id RepositoryCredentials#githubapp_installation_id}
  */
  readonly githubappInstallationId?: string;
  /**
  * Private key data (PEM) for authentication via GitHub app
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials#githubapp_private_key RepositoryCredentials#githubapp_private_key}
  */
  readonly githubappPrivateKey?: string;
  /**
  * Password for authenticating at the repo server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials#password RepositoryCredentials#password}
  */
  readonly password?: string;
  /**
  * Private key data for authenticating at the repo server using SSH (only Git repos)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials#ssh_private_key RepositoryCredentials#ssh_private_key}
  */
  readonly sshPrivateKey?: string;
  /**
  * TLS client cert data for authenticating at the repo server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials#tls_client_cert_data RepositoryCredentials#tls_client_cert_data}
  */
  readonly tlsClientCertData?: string;
  /**
  * TLS client cert key for authenticating at the repo server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials#tls_client_cert_key RepositoryCredentials#tls_client_cert_key}
  */
  readonly tlsClientCertKey?: string;
  /**
  * URL that these credentials match to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials#url RepositoryCredentials#url}
  */
  readonly url: string;
  /**
  * Username for authenticating at the repo server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials#username RepositoryCredentials#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials argocd_repository_credentials}
*/
export class RepositoryCredentials extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RepositoryCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.0/docs/resources/repository_credentials argocd_repository_credentials} Resource
  *
  * @param scope The scope in which to define this construct
