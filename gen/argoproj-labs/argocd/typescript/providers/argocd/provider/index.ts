// https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs
...
export interface ArgocdProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#auth_token ArgocdProvider#auth_token}
  */
  readonly authToken?: string;
  /**
  * Additional root CA certificates file to add to the client TLS connection pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#cert_file ArgocdProvider#cert_file}
  */
  readonly certFile?: string;
  /**
  * Client certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#client_cert_file ArgocdProvider#client_cert_file}
  */
  readonly clientCertFile?: string;
  /**
  * Client certificate key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#client_cert_key ArgocdProvider#client_cert_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#config_path ArgocdProvider#config_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#context ArgocdProvider#context}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#core ArgocdProvider#core}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#grpc_web ArgocdProvider#grpc_web}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#grpc_web_root_path ArgocdProvider#grpc_web_root_path}
  */
  readonly grpcWebRootPath?: string;
  /**
  * Additional headers to add to each request to the ArgoCD server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#headers ArgocdProvider#headers}
  */
  readonly headers?: string[];
  /**
  * Whether to skip TLS server certificate. Can be set through the `ARGOCD_INSECURE` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#insecure ArgocdProvider#insecure}
  */
  readonly insecure?: boolean | cdktf.IResolvable;
  /**
  * Authentication password. Can be set through the `ARGOCD_AUTH_PASSWORD` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#password ArgocdProvider#password}
  */
  readonly password?: string;
  /**
  * Whether to initiate an unencrypted connection to ArgoCD server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#plain_text ArgocdProvider#plain_text}
  */
  readonly plainText?: boolean | cdktf.IResolvable;
  /**
  * Connect to a random argocd-server port using port forwarding.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#port_forward ArgocdProvider#port_forward}
  */
  readonly portForward?: boolean | cdktf.IResolvable;
  /**
  * Namespace name which should be used for port forwarding.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#port_forward_with_namespace ArgocdProvider#port_forward_with_namespace}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#server_addr ArgocdProvider#server_addr}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#use_local_config ArgocdProvider#use_local_config}
  */
  readonly useLocalConfig?: boolean | cdktf.IResolvable;
  /**
  * User-Agent request header override.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#user_agent ArgocdProvider#user_agent}
  */
  readonly userAgent?: string;
  /**
  * Authentication username. Can be set through the `ARGOCD_AUTH_USERNAME` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#username ArgocdProvider#username}
  */
  readonly username?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#alias ArgocdProvider#alias}
  */
  readonly alias?: string;
  /**
  * kubernetes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#kubernetes ArgocdProvider#kubernetes}
  */
...
export interface ArgocdProviderKubernetesExec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#api_version ArgocdProvider#api_version}
  */
  readonly apiVersion: string;
  /**
  * Map of environment variables to set when executing the plugin.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#args ArgocdProvider#args}
  */
  readonly args?: string[];
  /**
  * Command to execute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#command ArgocdProvider#command}
  */
  readonly command: string;
  /**
  * List of arguments to pass when executing the plugin.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#env ArgocdProvider#env}
  */
...
export interface ArgocdProviderKubernetes {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#client_certificate ArgocdProvider#client_certificate}
  */
  readonly clientCertificate?: string;
  /**
  * PEM-encoded client certificate key for TLS authentication. Can be sourced from `KUBE_CLIENT_KEY_DATA`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#client_key ArgocdProvider#client_key}
  */
  readonly clientKey?: string;
  /**
  * PEM-encoded root certificates bundle for TLS authentication. Can be sourced from `KUBE_CLUSTER_CA_CERT_DATA`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#cluster_ca_certificate ArgocdProvider#cluster_ca_certificate}
  */
  readonly clusterCaCertificate?: string;
  /**
  * Context to choose from the config file. Can be sourced from `KUBE_CTX`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#config_context ArgocdProvider#config_context}
  */
  readonly configContext?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#config_context_auth_info ArgocdProvider#config_context_auth_info}
  */
  readonly configContextAuthInfo?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#config_context_cluster ArgocdProvider#config_context_cluster}
  */
  readonly configContextCluster?: string;
  /**
  * The hostname (in form of URI) of the Kubernetes API. Can be sourced from `KUBE_HOST`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#host ArgocdProvider#host}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#token ArgocdProvider#token}
  */
  ...
  * exec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#exec ArgocdProvider#exec}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs argocd}
*/
export class ArgocdProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ArgocdProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs argocd} Resource
  *
  * @param scope The scope in which to define this construct
