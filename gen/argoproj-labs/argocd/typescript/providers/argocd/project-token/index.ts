// https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/project_token
...
export interface ProjectTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/project_token#description ProjectToken#description}
  */
  readonly description?: string;
  /**
  * Duration before the token will expire. Valid time units are `ns`, `us` (or `µs`), `ms`, `s`, `m`, `h`. E.g. `12h`, `7d`. Default: No expiration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/project_token#expires_in ProjectToken#expires_in}
  */
  readonly expiresIn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/project_token#id ProjectToken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/project_token#project ProjectToken#project}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/project_token#renew_after ProjectToken#renew_after}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/project_token#renew_before ProjectToken#renew_before}
  */
  readonly renewBefore?: string;
  /**
  * The name of the role in the project associated with the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/project_token#role ProjectToken#role}
  */
  readonly role: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/project_token argocd_project_token}
*/
export class ProjectToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/project_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/project_token argocd_project_token} Resource
  *
  * @param scope The scope in which to define this construct
