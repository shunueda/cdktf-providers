...
export interface ApplicationSetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/application_set#id ApplicationSet#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/application_set argocd_application_set}
*/
export class ApplicationSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/application_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/argoproj-labs/argocd/7.12.1/docs/resources/application_set argocd_application_set} Resource
  *
  * @param scope The scope in which to define this construct
