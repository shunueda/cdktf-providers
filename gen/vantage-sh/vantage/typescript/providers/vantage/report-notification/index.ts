// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/report_notification
...
export interface ReportNotificationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/report_notification#change ReportNotification#change}
  */
  readonly change: string;
  /**
  * Token for the cost report to be used in the notification
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/report_notification#cost_report_token ReportNotification#cost_report_token}
  */
  readonly costReportToken: string;
  /**
  * The frequency at which the ReportNotification is sent. One of daily/weekly/monthly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/report_notification#frequency ReportNotification#frequency}
  */
  readonly frequency: string;
  /**
  * Title of the report notification
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/report_notification#title ReportNotification#title}
  */
  readonly title: string;
  /**
  * Tokens for the users to be notified
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/report_notification#user_tokens ReportNotification#user_tokens}
  */
  readonly userTokens: string[];
  /**
  * Token for the workspace the report notification is added toe notification
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/report_notification#workspace_token ReportNotification#workspace_token}
  */
  readonly workspaceToken?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/report_notification vantage_report_notification}
*/
export class ReportNotification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ReportNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/report_notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/report_notification vantage_report_notification} Resource
  *
  * @param scope The scope in which to define this construct
