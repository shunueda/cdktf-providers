// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.70/docs/data-sources/teams
...
/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.70/docs/data-sources/teams vantage_teams}
*/
export class DataVantageTeams extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVantageTeams that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.70/docs/data-sources/teams#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.70/docs/data-sources/teams vantage_teams} Data Source
  *
  * @param scope The scope in which to define this construct
