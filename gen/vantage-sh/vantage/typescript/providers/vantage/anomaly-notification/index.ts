// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/anomaly_notification
...
export interface AnomalyNotificationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/anomaly_notification#cost_report_token AnomalyNotification#cost_report_token}
  */
  readonly costReportToken: string;
  /**
  * The Slack/MS Teams channels that receive the notification.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/anomaly_notification#recipient_channels AnomalyNotification#recipient_channels}
  */
  readonly recipientChannels?: string[];
  /**
  * The threshold amount that must be met for the notification to fire.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/anomaly_notification#threshold AnomalyNotification#threshold}
  */
  readonly threshold?: number;
  /**
  * The tokens of the Users that receive the notification.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/anomaly_notification#user_tokens AnomalyNotification#user_tokens}
  */
  readonly userTokens?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/anomaly_notification vantage_anomaly_notification}
*/
export class AnomalyNotification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AnomalyNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/anomaly_notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/anomaly_notification vantage_anomaly_notification} Resource
  *
  * @param scope The scope in which to define this construct
