// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/network_flow_report
...
export interface NetworkFlowReportConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/network_flow_report#date_interval NetworkFlowReport#date_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/network_flow_report#end_date NetworkFlowReport#end_date}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/network_flow_report#filter NetworkFlowReport#filter}
  */
  readonly filter?: string;
  /**
  * The flow direction of the NetworkFlowReport.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/network_flow_report#flow_direction NetworkFlowReport#flow_direction}
  */
  readonly flowDirection?: string;
  /**
  * The dimension by which the logs in the report are sorted. Defaults to costs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/network_flow_report#flow_weight NetworkFlowReport#flow_weight}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/network_flow_report#groupings NetworkFlowReport#groupings}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/network_flow_report#start_date NetworkFlowReport#start_date}
  */
  readonly startDate?: string;
  /**
  * The title of the NetworkFlowReport.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/network_flow_report#title NetworkFlowReport#title}
  */
  readonly title: string;
  /**
  * The Workspace in which the NetworkFlowReport will be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/network_flow_report#workspace_token NetworkFlowReport#workspace_token}
  */
  readonly workspaceToken: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/network_flow_report vantage_network_flow_report}
*/
export class NetworkFlowReport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkFlowReport that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/network_flow_report#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/network_flow_report vantage_network_flow_report} Resource
  *
  * @param scope The scope in which to define this construct
