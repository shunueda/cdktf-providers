// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/saved_filter
...
export interface SavedFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/saved_filter#filter SavedFilter#filter}
  */
  readonly filter?: string;
  /**
  * Title of the Saved Filter
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/saved_filter#title SavedFilter#title}
  */
  readonly title: string;
  /**
  * Workspace token to add the saved filter into.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/saved_filter#workspace_token SavedFilter#workspace_token}
  */
  readonly workspaceToken: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/saved_filter vantage_saved_filter}
*/
export class SavedFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SavedFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/saved_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/saved_filter vantage_saved_filter} Resource
  *
  * @param scope The scope in which to define this construct
