// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/kubernetes_efficiency_report
...
export interface KubernetesEfficiencyReportConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/kubernetes_efficiency_report#aggregated_by KubernetesEfficiencyReport#aggregated_by}
  */
  readonly aggregatedBy?: string;
  /**
  * The date bucket of the KubernetesEfficiencyReport.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/kubernetes_efficiency_report#date_bucket KubernetesEfficiencyReport#date_bucket}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/kubernetes_efficiency_report#date_interval KubernetesEfficiencyReport#date_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/kubernetes_efficiency_report#end_date KubernetesEfficiencyReport#end_date}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/kubernetes_efficiency_report#filter KubernetesEfficiencyReport#filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/kubernetes_efficiency_report#groupings KubernetesEfficiencyReport#groupings}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/kubernetes_efficiency_report#start_date KubernetesEfficiencyReport#start_date}
  */
  readonly startDate?: string;
  /**
  * The title of the KubernetesEfficiencyReport.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/kubernetes_efficiency_report#title KubernetesEfficiencyReport#title}
  */
  readonly title: string;
  /**
  * The Workspace in which the KubernetesEfficiencyReport will be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/kubernetes_efficiency_report#workspace_token KubernetesEfficiencyReport#workspace_token}
  */
  readonly workspaceToken: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/kubernetes_efficiency_report vantage_kubernetes_efficiency_report}
*/
export class KubernetesEfficiencyReport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesEfficiencyReport that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/kubernetes_efficiency_report#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/kubernetes_efficiency_report vantage_kubernetes_efficiency_report} Resource
  *
  * @param scope The scope in which to define this construct
