// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/data-sources/saved_filters
...
/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/data-sources/saved_filters vantage_saved_filters}
*/
export class DataVantageSavedFilters extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVantageSavedFilters that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/data-sources/saved_filters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/data-sources/saved_filters vantage_saved_filters} Data Source
  *
  * @param scope The scope in which to define this construct
