// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/resource_report_columns
...
export interface DataVantageResourceReportColumnsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/resource_report_columns#resource_type DataVantageResourceReportColumns#resource_type}
  */
  readonly resourceType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/resource_report_columns vantage_resource_report_columns}
*/
export class DataVantageResourceReportColumns extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVantageResourceReportColumns that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/resource_report_columns#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/resource_report_columns vantage_resource_report_columns} Data Source
  *
  * @param scope The scope in which to define this construct
