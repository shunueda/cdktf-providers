// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/resource_report
...
export interface ResourceReportConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/resource_report#columns ResourceReport#columns}
  */
  readonly columns?: string[];
  /**
  * The VQL filter for the ResourceReport.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/resource_report#filter ResourceReport#filter}
  */
  readonly filter?: string;
  /**
  * The title of the ResourceReport.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/resource_report#title ResourceReport#title}
  */
  readonly title?: string;
  /**
  * The token of the Workspace to add the ResourceReport to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/resource_report#workspace_token ResourceReport#workspace_token}
  */
  readonly workspaceToken: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/resource_report vantage_resource_report}
*/
export class ResourceReport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourceReport that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/resource_report#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.68/docs/resources/resource_report vantage_resource_report} Resource
  *
  * @param scope The scope in which to define this construct
