// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/cost_alerts
...
/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/cost_alerts vantage_cost_alerts}
*/
export class DataVantageCostAlerts extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVantageCostAlerts that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/cost_alerts#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/cost_alerts vantage_cost_alerts} Data Source
  *
  * @param scope The scope in which to define this construct
