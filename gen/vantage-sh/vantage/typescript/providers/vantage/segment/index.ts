// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/segment
...
export interface SegmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/segment#description Segment#description}
  */
  readonly description?: string;
  /**
  * The filter query language to apply to the Segment. Additional documentation available at https://docs.vantage.sh/vql.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/segment#filter Segment#filter}
  */
  readonly filter?: string;
  /**
  * The token of the parent Segment this new Segment belongs to. Determines the Workspace the segment is assigned to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/segment#parent_segment_token Segment#parent_segment_token}
  */
  readonly parentSegmentToken?: string;
  /**
  * The priority of the Segment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/segment#priority Segment#priority}
  */
  readonly priority?: number;
  /**
  * The title of the Segment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/segment#title Segment#title}
  */
  readonly title: string;
  /**
  * Whether or not to track unallocated resources in this Segment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/segment#track_unallocated Segment#track_unallocated}
  */
  readonly trackUnallocated?: boolean | cdktf.IResolvable;
  /**
  * Workspace token to add the segment to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/segment#workspace_token Segment#workspace_token}
  */
  readonly workspaceToken?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/segment vantage_segment}
*/
export class Segment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Segment that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/segment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/segment vantage_segment} Resource
  *
  * @param scope The scope in which to define this construct
