// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/network_flow_reports
...
/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/network_flow_reports vantage_network_flow_reports}
*/
export class DataVantageNetworkFlowReports extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVantageNetworkFlowReports that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/network_flow_reports#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/network_flow_reports vantage_network_flow_reports} Data Source
  *
  * @param scope The scope in which to define this construct
