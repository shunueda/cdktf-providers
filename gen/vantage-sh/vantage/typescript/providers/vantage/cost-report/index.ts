// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report
...
export interface CostReportConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#chart_type CostReport#chart_type}
  */
  readonly chartType?: string;
  /**
  * Date bin to apply to the Cost Report.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#date_bin CostReport#date_bin}
  */
  readonly dateBin?: string;
  /**
  * Date interval to apply to the Cost Report.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#date_interval CostReport#date_interval}
  */
  readonly dateInterval?: string;
  /**
  * End date to apply to the Cost Report.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#end_date CostReport#end_date}
  */
  readonly endDate?: string;
  /**
  * Filter query to apply to the Cost Report
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#filter CostReport#filter}
  */
  readonly filter?: string;
  /**
  * Token of the folder this Cost Report resides in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#folder_token CostReport#folder_token}
  */
  readonly folderToken?: string;
  /**
  * Grouping aggregations applied to the filtered data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#groupings CostReport#groupings}
  */
  readonly groupings?: string;
  /**
  * End date to apply to the Cost Report.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#previous_period_end_date CostReport#previous_period_end_date}
  */
  readonly previousPeriodEndDate?: string;
  /**
  * Start date to apply to the Cost Report.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#previous_period_start_date CostReport#previous_period_start_date}
  */
  readonly previousPeriodStartDate?: string;
  /**
  * Saved filter tokens to be applied to the Cost Report.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#saved_filter_tokens CostReport#saved_filter_tokens}
  */
  readonly savedFilterTokens?: string[];
  /**
  * Start date to apply to the Cost Report.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#start_date CostReport#start_date}
  */
  readonly startDate?: string;
  /**
  * Title of the Cost Report
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#title CostReport#title}
  */
  readonly title: string;
  /**
  * Workspace token to add the Cost Report to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#workspace_token CostReport#workspace_token}
  */
  readonly workspaceToken?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report vantage_cost_report}
*/
export class CostReport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CostReport that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/resources/cost_report vantage_cost_report} Resource
  *
  * @param scope The scope in which to define this construct
