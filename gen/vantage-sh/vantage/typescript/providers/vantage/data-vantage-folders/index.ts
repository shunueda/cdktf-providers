// https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/folders
...
/**
* Represents a {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/folders vantage_folders}
*/
export class DataVantageFolders extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVantageFolders that should be imported. Refer to the {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/folders#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vantage-sh/vantage/0.1.71/docs/data-sources/folders vantage_folders} Data Source
  *
  * @param scope The scope in which to define this construct
