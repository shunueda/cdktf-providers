// https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/vpc_peering
...
export interface DataDigitaloceanVpcPeeringConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/vpc_peering#id DataDigitaloceanVpcPeering#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/vpc_peering#name DataDigitaloceanVpcPeering#name}
  */
  readonly name?: string;
  /**
  * The list of VPCs to be peered
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/vpc_peering#vpc_ids DataDigitaloceanVpcPeering#vpc_ids}
  */
  readonly vpcIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/vpc_peering digitalocean_vpc_peering}
*/
export class DataDigitaloceanVpcPeering extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDigitaloceanVpcPeering that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/vpc_peering#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/vpc_peering digitalocean_vpc_peering} Data Source
  *
  * @param scope The scope in which to define this construct
