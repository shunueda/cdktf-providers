// https://registry.terraform.io/providers/digitalocean/digitalocean/2.70.0/docs
...
export class DigitaloceanProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing DigitaloceanProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.70.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.70.0/docs digitalocean} Resource
  *
  * @param scope The scope in which to define this construct
