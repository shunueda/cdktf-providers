// https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_agent_route
...
export interface GenaiAgentRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_agent_route#child_agent_uuid GenaiAgentRoute#child_agent_uuid}
  */
  readonly childAgentUuid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_agent_route#id GenaiAgentRoute#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_agent_route#if_case GenaiAgentRoute#if_case}
  */
  readonly ifCase?: string;
  /**
  * The UUID of the parent agent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_agent_route#parent_agent_uuid GenaiAgentRoute#parent_agent_uuid}
  */
  readonly parentAgentUuid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_agent_route#rollback GenaiAgentRoute#rollback}
  */
  readonly rollback?: boolean | cdktf.IResolvable;
  /**
  * A name for the route.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_agent_route#route_name GenaiAgentRoute#route_name}
  */
  readonly routeName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_agent_route digitalocean_genai_agent_route}
*/
export class GenaiAgentRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GenaiAgentRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_agent_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_agent_route digitalocean_genai_agent_route} Resource
  *
  * @param scope The scope in which to define this construct
