// https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/volume
...
export interface DataDigitaloceanVolumeConfig extends cdktf.TerraformMetaArguments {
  ...
  * volume description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/volume#description DataDigitaloceanVolume#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/volume#id DataDigitaloceanVolume#id}
  *
  ...
  * name of the volume
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/volume#name DataDigitaloceanVolume#name}
  */
  readonly name: string;
  /**
  * the region that the volume is provisioned in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/volume#region DataDigitaloceanVolume#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/volume digitalocean_volume}
*/
export class DataDigitaloceanVolume extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDigitaloceanVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/volume#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/volume digitalocean_volume} Data Source
  *
  * @param scope The scope in which to define this construct
