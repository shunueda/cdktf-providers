// https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/certificate
...
export interface DataDigitaloceanCertificateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/certificate#id DataDigitaloceanCertificate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/certificate#name DataDigitaloceanCertificate#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/certificate digitalocean_certificate}
*/
export class DataDigitaloceanCertificate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDigitaloceanCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/certificate digitalocean_certificate} Data Source
  *
  * @param scope The scope in which to define this construct
