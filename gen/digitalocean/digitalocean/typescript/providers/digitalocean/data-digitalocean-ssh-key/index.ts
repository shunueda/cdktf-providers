// https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/ssh_key
...
export interface DataDigitaloceanSshKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  * name of the ssh key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/ssh_key#name DataDigitaloceanSshKey#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/ssh_key digitalocean_ssh_key}
*/
export class DataDigitaloceanSshKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDigitaloceanSshKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/ssh_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/ssh_key digitalocean_ssh_key} Data Source
  *
  * @param scope The scope in which to define this construct
