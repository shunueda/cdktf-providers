...
export interface DataDigitaloceanAppConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/app#app_id DataDigitaloceanApp#app_id}
  */
  ...
  * dedicated_ips block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/app#dedicated_ips DataDigitaloceanApp#dedicated_ips}
  */
  readonly dedicatedIps?: DataDigitaloceanAppDedicatedIps[] | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/app digitalocean_app}
*/
export class DataDigitaloceanApp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDigitaloceanApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/data-sources/app digitalocean_app} Data Source
  *
  * @param scope The scope in which to define this construct
