// https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_function
...
export interface GenaiFunctionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_function#agent_id GenaiFunction#agent_id}
  */
  readonly agentId: string;
  /**
  * The region where the GenAI resource will be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_function#description GenaiFunction#description}
  */
  readonly description: string;
  /**
  * The model to use for the GenAI resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_function#faas_name GenaiFunction#faas_name}
  */
  readonly faasName?: string;
  /**
  * The current status of the GenAI resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_function#faas_namespace GenaiFunction#faas_namespace}
  */
  readonly faasNamespace: string;
  /**
  * The creation timestamp of the GenAI resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_function#function_name GenaiFunction#function_name}
  */
  readonly functionName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_function#id GenaiFunction#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_function#input_schema GenaiFunction#input_schema}
  */
  readonly inputSchema: string;
  /**
  * The output schema of the GenAI resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_function#output_schema GenaiFunction#output_schema}
  */
  readonly outputSchema?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_function digitalocean_genai_function}
*/
export class GenaiFunction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GenaiFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_function#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/genai_function digitalocean_genai_function} Resource
  *
  * @param scope The scope in which to define this construct
