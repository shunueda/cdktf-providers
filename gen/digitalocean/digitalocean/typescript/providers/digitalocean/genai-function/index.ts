// https://registry.terraform.io/providers/digitalocean/digitalocean/2.71.0/docs/resources/genai_function
...
export class GenaiFunction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GenaiFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.71.0/docs/resources/genai_function#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.71.0/docs/resources/genai_function digitalocean_genai_function} Resource
  *
  * @param scope The scope in which to define this construct
