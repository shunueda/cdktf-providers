// https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway
...
export interface VpcNatGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway#icmp_timeout_seconds VpcNatGateway#icmp_timeout_seconds}
  */
  readonly icmpTimeoutSeconds?: number;
  /**
  * Name of the VPC NAT Gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway#name VpcNatGateway#name}
  */
  readonly name: string;
  /**
  * ID of the project to which the VPC NAT Gateway will be assigned.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway#project_id VpcNatGateway#project_id}
  */
  readonly projectId?: string;
  /**
  * Region of the VPC NAT Gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway#region VpcNatGateway#region}
  */
  readonly region: string;
  /**
  * Size of the VPC NAT Gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway#size VpcNatGateway#size}
  */
  readonly size: number;
  /**
  * TCP connection timeout (in seconds)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway#tcp_timeout_seconds VpcNatGateway#tcp_timeout_seconds}
  */
  readonly tcpTimeoutSeconds?: number;
  /**
  * Type of the VPC NAT Gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway#type VpcNatGateway#type}
  */
  readonly type: string;
  /**
  * UDP connection timeout (in seconds)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway#udp_timeout_seconds VpcNatGateway#udp_timeout_seconds}
  */
  readonly udpTimeoutSeconds?: number;
  /**
  * vpcs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway#vpcs VpcNatGateway#vpcs}
  */
...
export interface VpcNatGatewayVpcs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway#default_gateway VpcNatGateway#default_gateway}
  */
  readonly defaultGateway?: boolean | cdktf.IResolvable;
  /**
  * ID of the ingress VPC
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway#vpc_uuid VpcNatGateway#vpc_uuid}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway digitalocean_vpc_nat_gateway}
*/
export class VpcNatGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcNatGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.72.0/docs/resources/vpc_nat_gateway digitalocean_vpc_nat_gateway} Resource
  *
  * @param scope The scope in which to define this construct
