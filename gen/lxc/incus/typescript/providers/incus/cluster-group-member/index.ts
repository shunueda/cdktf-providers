// https://registry.terraform.io/providers/lxc/incus/1.0.0/docs/resources/cluster_group_member
...
export interface ClusterGroupMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.0/docs/resources/cluster_group_member#cluster_group ClusterGroupMember#cluster_group}
  */
  readonly clusterGroup: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.0/docs/resources/cluster_group_member#member ClusterGroupMember#member}
  */
  readonly member: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.0/docs/resources/cluster_group_member#remote ClusterGroupMember#remote}
  */
  readonly remote?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/lxc/incus/1.0.0/docs/resources/cluster_group_member incus_cluster_group_member}
*/
export class ClusterGroupMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusterGroupMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/lxc/incus/1.0.0/docs/resources/cluster_group_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lxc/incus/1.0.0/docs/resources/cluster_group_member incus_cluster_group_member} Resource
  *
  * @param scope The scope in which to define this construct
