// https://registry.terraform.io/providers/lxc/incus/1.0.0/docs/data-sources/cluster
...
export interface DataIncusClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.0/docs/data-sources/cluster#remote DataIncusCluster#remote}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/lxc/incus/1.0.0/docs/data-sources/cluster incus_cluster}
*/
export class DataIncusCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIncusCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/lxc/incus/1.0.0/docs/data-sources/cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lxc/incus/1.0.0/docs/data-sources/cluster incus_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
