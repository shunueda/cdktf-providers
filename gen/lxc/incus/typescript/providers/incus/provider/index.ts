// https://registry.terraform.io/providers/lxc/incus/1.0.2/docs
...
export interface IncusProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#accept_remote_certificate IncusProvider#accept_remote_certificate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#config_dir IncusProvider#config_dir}
  */
  readonly configDir?: string;
  /**
  * The default remote to use when no other remote is defined in a resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#default_remote IncusProvider#default_remote}
  */
  readonly defaultRemote?: string;
  /**
  * Automatically generate the Incus client certificates if they don't exist.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#generate_client_certificates IncusProvider#generate_client_certificates}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#project IncusProvider#project}
  */
  readonly project?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#alias IncusProvider#alias}
  */
  readonly alias?: string;
  /**
  * remote block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#remote IncusProvider#remote}
  */
...
export interface IncusProviderRemote {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#address IncusProvider#address}
  */
  readonly address?: string;
  /**
  * Server authentication type, tls or oidc. ( Only for the `incus` protocol )
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#authentication_type IncusProvider#authentication_type}
  */
  readonly authenticationType?: string;
  /**
  * Name of the Incus remote.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#name IncusProvider#name}
  */
  readonly name: string;
  /**
  * Server protocol ( incus, oci or simplestreams )
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#protocol IncusProvider#protocol}
  */
  readonly protocol?: string;
  /**
  * Public image server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#public IncusProvider#public}
  */
  readonly public?: boolean | cdktf.IResolvable;
  /**
  * The trust token used for initial authentication with the Incus remote.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#token IncusProvider#token}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs incus}
*/
export class IncusProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing IncusProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lxc/incus/1.0.2/docs incus} Resource
  *
  * @param scope The scope in which to define this construct
