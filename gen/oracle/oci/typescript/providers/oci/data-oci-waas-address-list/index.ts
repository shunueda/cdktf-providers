// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/waas_address_list
...
export interface DataOciWaasAddressListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/waas_address_list#address_list_id DataOciWaasAddressList#address_list_id}
  */
  readonly addressListId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/waas_address_list oci_waas_address_list}
*/
export class DataOciWaasAddressList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciWaasAddressList that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/waas_address_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/waas_address_list oci_waas_address_list} Data Source
  *
  * @param scope The scope in which to define this construct
