// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_autonomous_patch
...
export interface DataOciDatabaseAutonomousPatchConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_autonomous_patch#autonomous_patch_id DataOciDatabaseAutonomousPatch#autonomous_patch_id}
  */
  readonly autonomousPatchId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_autonomous_patch#id DataOciDatabaseAutonomousPatch#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_autonomous_patch oci_database_autonomous_patch}
*/
export class DataOciDatabaseAutonomousPatch extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseAutonomousPatch that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_autonomous_patch#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_autonomous_patch oci_database_autonomous_patch} Data Source
  *
  * @param scope The scope in which to define this construct
