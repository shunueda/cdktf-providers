// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apm_apm_domain
...
export interface DataOciApmApmDomainConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apm_apm_domain#apm_domain_id DataOciApmApmDomain#apm_domain_id}
  */
  readonly apmDomainId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apm_apm_domain oci_apm_apm_domain}
*/
export class DataOciApmApmDomain extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciApmApmDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apm_apm_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apm_apm_domain oci_apm_apm_domain} Data Source
  *
  * @param scope The scope in which to define this construct
