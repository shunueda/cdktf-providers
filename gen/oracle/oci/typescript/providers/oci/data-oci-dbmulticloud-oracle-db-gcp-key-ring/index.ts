// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_gcp_key_ring
...
export interface DataOciDbmulticloudOracleDbGcpKeyRingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_gcp_key_ring#oracle_db_gcp_key_ring_id DataOciDbmulticloudOracleDbGcpKeyRing#oracle_db_gcp_key_ring_id}
  */
  readonly oracleDbGcpKeyRingId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_gcp_key_ring oci_dbmulticloud_oracle_db_gcp_key_ring}
*/
export class DataOciDbmulticloudOracleDbGcpKeyRing extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDbmulticloudOracleDbGcpKeyRing that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_gcp_key_ring#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_gcp_key_ring oci_dbmulticloud_oracle_db_gcp_key_ring} Data Source
  *
  * @param scope The scope in which to define this construct
