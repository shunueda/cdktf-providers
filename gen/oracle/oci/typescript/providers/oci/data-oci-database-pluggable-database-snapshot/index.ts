// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_pluggable_database_snapshot
...
export interface DataOciDatabasePluggableDatabaseSnapshotConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_pluggable_database_snapshot#pluggable_database_snapshot_id DataOciDatabasePluggableDatabaseSnapshot#pluggable_database_snapshot_id}
  */
  readonly pluggableDatabaseSnapshotId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_pluggable_database_snapshot oci_database_pluggable_database_snapshot}
*/
export class DataOciDatabasePluggableDatabaseSnapshot extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabasePluggableDatabaseSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_pluggable_database_snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_pluggable_database_snapshot oci_database_pluggable_database_snapshot} Data Source
  *
  * @param scope The scope in which to define this construct
