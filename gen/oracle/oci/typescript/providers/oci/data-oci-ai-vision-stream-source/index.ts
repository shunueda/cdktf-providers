// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_vision_stream_source
...
export interface DataOciAiVisionStreamSourceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_vision_stream_source#stream_source_id DataOciAiVisionStreamSource#stream_source_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_vision_stream_source oci_ai_vision_stream_source}
*/
export class DataOciAiVisionStreamSource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiVisionStreamSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_vision_stream_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_vision_stream_source oci_ai_vision_stream_source} Data Source
  *
  * @param scope The scope in which to define this construct
