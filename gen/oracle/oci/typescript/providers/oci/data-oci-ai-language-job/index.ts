// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_language_job
...
export interface DataOciAiLanguageJobConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_language_job#job_id DataOciAiLanguageJob#job_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_language_job oci_ai_language_job}
*/
export class DataOciAiLanguageJob extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiLanguageJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_language_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_language_job oci_ai_language_job} Data Source
  *
  * @param scope The scope in which to define this construct
