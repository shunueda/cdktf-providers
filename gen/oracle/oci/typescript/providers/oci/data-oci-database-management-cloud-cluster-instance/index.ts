// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/database_management_cloud_cluster_instance
...
export interface DataOciDatabaseManagementCloudClusterInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/database_management_cloud_cluster_instance#cloud_cluster_instance_id DataOciDatabaseManagementCloudClusterInstance#cloud_cluster_instance_id}
  */
  readonly cloudClusterInstanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/database_management_cloud_cluster_instance oci_database_management_cloud_cluster_instance}
*/
export class DataOciDatabaseManagementCloudClusterInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseManagementCloudClusterInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/database_management_cloud_cluster_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/database_management_cloud_cluster_instance oci_database_management_cloud_cluster_instance} Data Source
  *
  * @param scope The scope in which to define this construct
