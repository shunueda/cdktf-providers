// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/fleet_apps_management_provision
...
export interface DataOciFleetAppsManagementProvisionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/fleet_apps_management_provision#provision_id DataOciFleetAppsManagementProvision#provision_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/fleet_apps_management_provision oci_fleet_apps_management_provision}
*/
export class DataOciFleetAppsManagementProvision extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciFleetAppsManagementProvision that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/fleet_apps_management_provision#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/fleet_apps_management_provision oci_fleet_apps_management_provision} Data Source
  *
  * @param scope The scope in which to define this construct
