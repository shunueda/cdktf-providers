// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/resource_analytics_monitored_region
...
export interface DataOciResourceAnalyticsMonitoredRegionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/resource_analytics_monitored_region#monitored_region_id DataOciResourceAnalyticsMonitoredRegion#monitored_region_id}
  */
  readonly monitoredRegionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/resource_analytics_monitored_region oci_resource_analytics_monitored_region}
*/
export class DataOciResourceAnalyticsMonitoredRegion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciResourceAnalyticsMonitoredRegion that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/resource_analytics_monitored_region#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/resource_analytics_monitored_region oci_resource_analytics_monitored_region} Data Source
  *
  * @param scope The scope in which to define this construct
