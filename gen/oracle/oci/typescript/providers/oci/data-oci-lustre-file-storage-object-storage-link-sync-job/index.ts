// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/lustre_file_storage_object_storage_link_sync_job
...
export interface DataOciLustreFileStorageObjectStorageLinkSyncJobConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/lustre_file_storage_object_storage_link_sync_job#id DataOciLustreFileStorageObjectStorageLinkSyncJob#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/lustre_file_storage_object_storage_link_sync_job#object_storage_link_id DataOciLustreFileStorageObjectStorageLinkSyncJob#object_storage_link_id}
  */
  readonly objectStorageLinkId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/lustre_file_storage_object_storage_link_sync_job#sync_job_id DataOciLustreFileStorageObjectStorageLinkSyncJob#sync_job_id}
  */
  readonly syncJobId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/lustre_file_storage_object_storage_link_sync_job oci_lustre_file_storage_object_storage_link_sync_job}
*/
export class DataOciLustreFileStorageObjectStorageLinkSyncJob extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciLustreFileStorageObjectStorageLinkSyncJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/lustre_file_storage_object_storage_link_sync_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/lustre_file_storage_object_storage_link_sync_job oci_lustre_file_storage_object_storage_link_sync_job} Data Source
  *
  * @param scope The scope in which to define this construct
