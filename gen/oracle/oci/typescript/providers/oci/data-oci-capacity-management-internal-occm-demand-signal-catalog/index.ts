// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/capacity_management_internal_occm_demand_signal_catalog
...
export interface DataOciCapacityManagementInternalOccmDemandSignalCatalogConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/capacity_management_internal_occm_demand_signal_catalog#id DataOciCapacityManagementInternalOccmDemandSignalCatalog#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/capacity_management_internal_occm_demand_signal_catalog#occm_demand_signal_catalog_id DataOciCapacityManagementInternalOccmDemandSignalCatalog#occm_demand_signal_catalog_id}
  */
  readonly occmDemandSignalCatalogId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/capacity_management_internal_occm_demand_signal_catalog oci_capacity_management_internal_occm_demand_signal_catalog}
*/
export class DataOciCapacityManagementInternalOccmDemandSignalCatalog extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCapacityManagementInternalOccmDemandSignalCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/capacity_management_internal_occm_demand_signal_catalog#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/capacity_management_internal_occm_demand_signal_catalog oci_capacity_management_internal_occm_demand_signal_catalog} Data Source
  *
  * @param scope The scope in which to define this construct
