// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/waf_network_address_list
...
export interface DataOciWafNetworkAddressListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/waf_network_address_list#network_address_list_id DataOciWafNetworkAddressList#network_address_list_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/waf_network_address_list oci_waf_network_address_list}
*/
export class DataOciWafNetworkAddressList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciWafNetworkAddressList that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/waf_network_address_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/waf_network_address_list oci_waf_network_address_list} Data Source
  *
  * @param scope The scope in which to define this construct
