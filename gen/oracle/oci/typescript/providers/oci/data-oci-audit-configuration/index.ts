// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/audit_configuration
...
export interface DataOciAuditConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/audit_configuration#compartment_id DataOciAuditConfiguration#compartment_id}
  */
  readonly compartmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/audit_configuration oci_audit_configuration}
*/
export class DataOciAuditConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAuditConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/audit_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/audit_configuration oci_audit_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
