// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/golden_gate_database_registration
...
export interface DataOciGoldenGateDatabaseRegistrationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/golden_gate_database_registration#database_registration_id DataOciGoldenGateDatabaseRegistration#database_registration_id}
  */
  readonly databaseRegistrationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/golden_gate_database_registration oci_golden_gate_database_registration}
*/
export class DataOciGoldenGateDatabaseRegistration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciGoldenGateDatabaseRegistration that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/golden_gate_database_registration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/golden_gate_database_registration oci_golden_gate_database_registration} Data Source
  *
  * @param scope The scope in which to define this construct
