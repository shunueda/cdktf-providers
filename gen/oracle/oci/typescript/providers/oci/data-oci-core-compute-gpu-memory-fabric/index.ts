// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_gpu_memory_fabric
...
export interface DataOciCoreComputeGpuMemoryFabricConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_gpu_memory_fabric#compute_gpu_memory_fabric_id DataOciCoreComputeGpuMemoryFabric#compute_gpu_memory_fabric_id}
  */
  readonly computeGpuMemoryFabricId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_gpu_memory_fabric oci_core_compute_gpu_memory_fabric}
*/
export class DataOciCoreComputeGpuMemoryFabric extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreComputeGpuMemoryFabric that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_gpu_memory_fabric#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_gpu_memory_fabric oci_core_compute_gpu_memory_fabric} Data Source
  *
  * @param scope The scope in which to define this construct
