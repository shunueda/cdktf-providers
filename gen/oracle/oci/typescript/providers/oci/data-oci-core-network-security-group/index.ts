// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/core_network_security_group
...
export interface DataOciCoreNetworkSecurityGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/core_network_security_group#network_security_group_id DataOciCoreNetworkSecurityGroup#network_security_group_id}
  */
  readonly networkSecurityGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/core_network_security_group oci_core_network_security_group}
*/
export class DataOciCoreNetworkSecurityGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreNetworkSecurityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/core_network_security_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/core_network_security_group oci_core_network_security_group} Data Source
  *
  * @param scope The scope in which to define this construct
