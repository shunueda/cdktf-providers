// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/certificates_management_ca_bundle
...
export interface DataOciCertificatesManagementCaBundleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/certificates_management_ca_bundle#ca_bundle_id DataOciCertificatesManagementCaBundle#ca_bundle_id}
  */
  readonly caBundleId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/certificates_management_ca_bundle oci_certificates_management_ca_bundle}
*/
export class DataOciCertificatesManagementCaBundle extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCertificatesManagementCaBundle that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/certificates_management_ca_bundle#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/certificates_management_ca_bundle oci_certificates_management_ca_bundle} Data Source
  *
  * @param scope The scope in which to define this construct
