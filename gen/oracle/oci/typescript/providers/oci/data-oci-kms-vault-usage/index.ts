// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/kms_vault_usage
...
export interface DataOciKmsVaultUsageConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/kms_vault_usage#id DataOciKmsVaultUsage#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/kms_vault_usage#vault_id DataOciKmsVaultUsage#vault_id}
  */
  readonly vaultId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/kms_vault_usage oci_kms_vault_usage}
*/
export class DataOciKmsVaultUsage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciKmsVaultUsage that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/kms_vault_usage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/kms_vault_usage oci_kms_vault_usage} Data Source
  *
  * @param scope The scope in which to define this construct
