// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/artifacts_repository
...
export interface DataOciArtifactsRepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/artifacts_repository#repository_id DataOciArtifactsRepository#repository_id}
  */
  readonly repositoryId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/artifacts_repository oci_artifacts_repository}
*/
export class DataOciArtifactsRepository extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciArtifactsRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/artifacts_repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/artifacts_repository oci_artifacts_repository} Data Source
  *
  * @param scope The scope in which to define this construct
