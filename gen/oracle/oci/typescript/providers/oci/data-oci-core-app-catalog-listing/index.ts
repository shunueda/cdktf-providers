// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_app_catalog_listing
...
export interface DataOciCoreAppCatalogListingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_app_catalog_listing#id DataOciCoreAppCatalogListing#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_app_catalog_listing#listing_id DataOciCoreAppCatalogListing#listing_id}
  */
  readonly listingId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_app_catalog_listing oci_core_app_catalog_listing}
*/
export class DataOciCoreAppCatalogListing extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreAppCatalogListing that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_app_catalog_listing#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_app_catalog_listing oci_core_app_catalog_listing} Data Source
  *
  * @param scope The scope in which to define this construct
