// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_management_managed_my_sql_database_general_replication_information
...
export interface DataOciDatabaseManagementManagedMySqlDatabaseGeneralReplicationInformationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_management_managed_my_sql_database_general_replication_information#id DataOciDatabaseManagementManagedMySqlDatabaseGeneralReplicationInformation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_management_managed_my_sql_database_general_replication_information oci_database_management_managed_my_sql_database_general_replication_information}
*/
export class DataOciDatabaseManagementManagedMySqlDatabaseGeneralReplicationInformation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseManagementManagedMySqlDatabaseGeneralReplicationInformation that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_management_managed_my_sql_database_general_replication_information#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_management_managed_my_sql_database_general_replication_information oci_database_management_managed_my_sql_database_general_replication_information} Data Source
  *
  * @param scope The scope in which to define this construct
