// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_boot_volume_replica
...
export interface DataOciCoreBootVolumeReplicaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_boot_volume_replica#boot_volume_replica_id DataOciCoreBootVolumeReplica#boot_volume_replica_id}
  */
  readonly bootVolumeReplicaId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_boot_volume_replica#id DataOciCoreBootVolumeReplica#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_boot_volume_replica oci_core_boot_volume_replica}
*/
export class DataOciCoreBootVolumeReplica extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreBootVolumeReplica that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_boot_volume_replica#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_boot_volume_replica oci_core_boot_volume_replica} Data Source
  *
  * @param scope The scope in which to define this construct
