// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/devops_deploy_pipeline
...
export interface DataOciDevopsDeployPipelineConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/devops_deploy_pipeline#deploy_pipeline_id DataOciDevopsDeployPipeline#deploy_pipeline_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/devops_deploy_pipeline oci_devops_deploy_pipeline}
*/
export class DataOciDevopsDeployPipeline extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDevopsDeployPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/devops_deploy_pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/devops_deploy_pipeline oci_devops_deploy_pipeline} Data Source
  *
  * @param scope The scope in which to define this construct
