// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/identity_tag_default
...
export interface DataOciIdentityTagDefaultConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/identity_tag_default#tag_default_id DataOciIdentityTagDefault#tag_default_id}
  */
  readonly tagDefaultId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/identity_tag_default oci_identity_tag_default}
*/
export class DataOciIdentityTagDefault extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciIdentityTagDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/identity_tag_default#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/identity_tag_default oci_identity_tag_default} Data Source
  *
  * @param scope The scope in which to define this construct
