// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dbmulticloud_oracle_db_azure_vault_association
...
export interface DataOciDbmulticloudOracleDbAzureVaultAssociationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dbmulticloud_oracle_db_azure_vault_association#oracle_db_azure_vault_association_id DataOciDbmulticloudOracleDbAzureVaultAssociation#oracle_db_azure_vault_association_id}
  */
  readonly oracleDbAzureVaultAssociationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dbmulticloud_oracle_db_azure_vault_association oci_dbmulticloud_oracle_db_azure_vault_association}
*/
export class DataOciDbmulticloudOracleDbAzureVaultAssociation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDbmulticloudOracleDbAzureVaultAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dbmulticloud_oracle_db_azure_vault_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dbmulticloud_oracle_db_azure_vault_association oci_dbmulticloud_oracle_db_azure_vault_association} Data Source
  *
  * @param scope The scope in which to define this construct
