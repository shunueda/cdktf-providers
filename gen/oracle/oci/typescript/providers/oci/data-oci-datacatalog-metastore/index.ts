// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/datacatalog_metastore
...
export interface DataOciDatacatalogMetastoreConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/datacatalog_metastore#metastore_id DataOciDatacatalogMetastore#metastore_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/datacatalog_metastore oci_datacatalog_metastore}
*/
export class DataOciDatacatalogMetastore extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatacatalogMetastore that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/datacatalog_metastore#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/datacatalog_metastore oci_datacatalog_metastore} Data Source
  *
  * @param scope The scope in which to define this construct
