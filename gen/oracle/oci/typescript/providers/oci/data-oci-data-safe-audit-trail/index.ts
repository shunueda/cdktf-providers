// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/data_safe_audit_trail
...
export interface DataOciDataSafeAuditTrailConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/data_safe_audit_trail#audit_trail_id DataOciDataSafeAuditTrail#audit_trail_id}
  */
  readonly auditTrailId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/data_safe_audit_trail oci_data_safe_audit_trail}
*/
export class DataOciDataSafeAuditTrail extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeAuditTrail that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/data_safe_audit_trail#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/data_safe_audit_trail oci_data_safe_audit_trail} Data Source
  *
  * @param scope The scope in which to define this construct
