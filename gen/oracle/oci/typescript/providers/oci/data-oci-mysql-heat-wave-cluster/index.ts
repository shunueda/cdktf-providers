// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/mysql_heat_wave_cluster
...
export interface DataOciMysqlHeatWaveClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/mysql_heat_wave_cluster#db_system_id DataOciMysqlHeatWaveCluster#db_system_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/mysql_heat_wave_cluster oci_mysql_heat_wave_cluster}
*/
export class DataOciMysqlHeatWaveCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciMysqlHeatWaveCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/mysql_heat_wave_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/mysql_heat_wave_cluster oci_mysql_heat_wave_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
