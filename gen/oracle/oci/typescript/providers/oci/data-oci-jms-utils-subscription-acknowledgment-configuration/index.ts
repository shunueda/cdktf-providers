// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_utils_subscription_acknowledgment_configuration
...
export interface DataOciJmsUtilsSubscriptionAcknowledgmentConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_utils_subscription_acknowledgment_configuration#compartment_id DataOciJmsUtilsSubscriptionAcknowledgmentConfiguration#compartment_id}
  */
  readonly compartmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_utils_subscription_acknowledgment_configuration oci_jms_utils_subscription_acknowledgment_configuration}
*/
export class DataOciJmsUtilsSubscriptionAcknowledgmentConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciJmsUtilsSubscriptionAcknowledgmentConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_utils_subscription_acknowledgment_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_utils_subscription_acknowledgment_configuration oci_jms_utils_subscription_acknowledgment_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
