// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_document_model
...
export interface DataOciAiDocumentModelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_document_model#model_id DataOciAiDocumentModel#model_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_document_model oci_ai_document_model}
*/
export class DataOciAiDocumentModel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiDocumentModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_document_model#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_document_model oci_ai_document_model} Data Source
  *
  * @param scope The scope in which to define this construct
