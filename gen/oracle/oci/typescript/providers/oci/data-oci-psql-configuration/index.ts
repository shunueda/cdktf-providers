// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/psql_configuration
...
export interface DataOciPsqlConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/psql_configuration#configuration_id DataOciPsqlConfiguration#configuration_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/psql_configuration oci_psql_configuration}
*/
export class DataOciPsqlConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciPsqlConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/psql_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/psql_configuration oci_psql_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
