// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/jms_fleet_export_status
...
export interface DataOciJmsFleetExportStatusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/jms_fleet_export_status#fleet_id DataOciJmsFleetExportStatus#fleet_id}
  */
  readonly fleetId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/jms_fleet_export_status#id DataOciJmsFleetExportStatus#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/jms_fleet_export_status oci_jms_fleet_export_status}
*/
export class DataOciJmsFleetExportStatus extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciJmsFleetExportStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/jms_fleet_export_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/jms_fleet_export_status oci_jms_fleet_export_status} Data Source
  *
  * @param scope The scope in which to define this construct
