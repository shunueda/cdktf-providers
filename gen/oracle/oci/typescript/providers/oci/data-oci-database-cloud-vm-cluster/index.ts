// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_cloud_vm_cluster
...
export interface DataOciDatabaseCloudVmClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_cloud_vm_cluster#cloud_vm_cluster_id DataOciDatabaseCloudVmCluster#cloud_vm_cluster_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_cloud_vm_cluster oci_database_cloud_vm_cluster}
*/
export class DataOciDatabaseCloudVmCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseCloudVmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_cloud_vm_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_cloud_vm_cluster oci_database_cloud_vm_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
