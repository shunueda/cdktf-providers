// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/network_firewall_network_firewall_policy_url_list
...
export interface DataOciNetworkFirewallNetworkFirewallPolicyUrlListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/network_firewall_network_firewall_policy_url_list#name DataOciNetworkFirewallNetworkFirewallPolicyUrlList#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/network_firewall_network_firewall_policy_url_list#network_firewall_policy_id DataOciNetworkFirewallNetworkFirewallPolicyUrlList#network_firewall_policy_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/network_firewall_network_firewall_policy_url_list oci_network_firewall_network_firewall_policy_url_list}
*/
export class DataOciNetworkFirewallNetworkFirewallPolicyUrlList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciNetworkFirewallNetworkFirewallPolicyUrlList that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/network_firewall_network_firewall_policy_url_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/network_firewall_network_firewall_policy_url_list oci_network_firewall_network_firewall_policy_url_list} Data Source
  *
  * @param scope The scope in which to define this construct
