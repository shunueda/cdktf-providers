// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_management_cloud_asm_instance
...
export interface DataOciDatabaseManagementCloudAsmInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_management_cloud_asm_instance#cloud_asm_instance_id DataOciDatabaseManagementCloudAsmInstance#cloud_asm_instance_id}
  */
  readonly cloudAsmInstanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_management_cloud_asm_instance oci_database_management_cloud_asm_instance}
*/
export class DataOciDatabaseManagementCloudAsmInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseManagementCloudAsmInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_management_cloud_asm_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_management_cloud_asm_instance oci_database_management_cloud_asm_instance} Data Source
  *
  * @param scope The scope in which to define this construct
