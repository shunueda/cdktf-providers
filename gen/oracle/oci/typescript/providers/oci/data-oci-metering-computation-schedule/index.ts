// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/metering_computation_schedule
...
export interface DataOciMeteringComputationScheduleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/metering_computation_schedule#schedule_id DataOciMeteringComputationSchedule#schedule_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/metering_computation_schedule oci_metering_computation_schedule}
*/
export class DataOciMeteringComputationSchedule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciMeteringComputationSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/metering_computation_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/metering_computation_schedule oci_metering_computation_schedule} Data Source
  *
  * @param scope The scope in which to define this construct
