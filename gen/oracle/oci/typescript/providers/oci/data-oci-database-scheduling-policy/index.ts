// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduling_policy
...
export interface DataOciDatabaseSchedulingPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduling_policy#scheduling_policy_id DataOciDatabaseSchedulingPolicy#scheduling_policy_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduling_policy oci_database_scheduling_policy}
*/
export class DataOciDatabaseSchedulingPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseSchedulingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduling_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduling_policy oci_database_scheduling_policy} Data Source
  *
  * @param scope The scope in which to define this construct
