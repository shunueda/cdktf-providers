// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/license_manager_configuration
...
export interface DataOciLicenseManagerConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/license_manager_configuration#compartment_id DataOciLicenseManagerConfiguration#compartment_id}
  */
  readonly compartmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/license_manager_configuration oci_license_manager_configuration}
*/
export class DataOciLicenseManagerConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciLicenseManagerConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/license_manager_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/license_manager_configuration oci_license_manager_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
