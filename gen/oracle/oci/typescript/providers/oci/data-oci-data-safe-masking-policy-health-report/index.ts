// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/data_safe_masking_policy_health_report
...
export interface DataOciDataSafeMaskingPolicyHealthReportConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/data_safe_masking_policy_health_report#id DataOciDataSafeMaskingPolicyHealthReport#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/data_safe_masking_policy_health_report#masking_policy_health_report_id DataOciDataSafeMaskingPolicyHealthReport#masking_policy_health_report_id}
  */
  readonly maskingPolicyHealthReportId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/data_safe_masking_policy_health_report oci_data_safe_masking_policy_health_report}
*/
export class DataOciDataSafeMaskingPolicyHealthReport extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeMaskingPolicyHealthReport that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/data_safe_masking_policy_health_report#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/data_safe_masking_policy_health_report oci_data_safe_masking_policy_health_report} Data Source
  *
  * @param scope The scope in which to define this construct
