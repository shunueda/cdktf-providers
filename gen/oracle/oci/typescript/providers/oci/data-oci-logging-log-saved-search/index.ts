// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/logging_log_saved_search
...
export interface DataOciLoggingLogSavedSearchConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/logging_log_saved_search#log_saved_search_id DataOciLoggingLogSavedSearch#log_saved_search_id}
  */
  readonly logSavedSearchId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/logging_log_saved_search oci_logging_log_saved_search}
*/
export class DataOciLoggingLogSavedSearch extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciLoggingLogSavedSearch that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/logging_log_saved_search#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/logging_log_saved_search oci_logging_log_saved_search} Data Source
  *
  * @param scope The scope in which to define this construct
