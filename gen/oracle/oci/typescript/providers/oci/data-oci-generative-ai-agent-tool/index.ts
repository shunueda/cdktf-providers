// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/generative_ai_agent_tool
...
export interface DataOciGenerativeAiAgentToolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/generative_ai_agent_tool#tool_id DataOciGenerativeAiAgentTool#tool_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/generative_ai_agent_tool oci_generative_ai_agent_tool}
*/
export class DataOciGenerativeAiAgentTool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciGenerativeAiAgentTool that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/generative_ai_agent_tool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/generative_ai_agent_tool oci_generative_ai_agent_tool} Data Source
  *
  * @param scope The scope in which to define this construct
