// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/os_management_hub_event
...
export interface DataOciOsManagementHubEventConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/os_management_hub_event#event_id DataOciOsManagementHubEvent#event_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/os_management_hub_event oci_os_management_hub_event}
*/
export class DataOciOsManagementHubEvent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciOsManagementHubEvent that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/os_management_hub_event#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/os_management_hub_event oci_os_management_hub_event} Data Source
  *
  * @param scope The scope in which to define this construct
