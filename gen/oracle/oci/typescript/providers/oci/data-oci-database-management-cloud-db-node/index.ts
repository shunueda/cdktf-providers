// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_management_cloud_db_node
...
export interface DataOciDatabaseManagementCloudDbNodeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_management_cloud_db_node#cloud_db_node_id DataOciDatabaseManagementCloudDbNode#cloud_db_node_id}
  */
  readonly cloudDbNodeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_management_cloud_db_node oci_database_management_cloud_db_node}
*/
export class DataOciDatabaseManagementCloudDbNode extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseManagementCloudDbNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_management_cloud_db_node#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_management_cloud_db_node oci_database_management_cloud_db_node} Data Source
  *
  * @param scope The scope in which to define this construct
