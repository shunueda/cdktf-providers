// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/network_load_balancer_backend_set_health
...
export interface DataOciNetworkLoadBalancerBackendSetHealthConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/network_load_balancer_backend_set_health#backend_set_name DataOciNetworkLoadBalancerBackendSetHealth#backend_set_name}
  */
  readonly backendSetName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/network_load_balancer_backend_set_health#id DataOciNetworkLoadBalancerBackendSetHealth#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/network_load_balancer_backend_set_health#network_load_balancer_id DataOciNetworkLoadBalancerBackendSetHealth#network_load_balancer_id}
  */
  readonly networkLoadBalancerId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/network_load_balancer_backend_set_health oci_network_load_balancer_backend_set_health}
*/
export class DataOciNetworkLoadBalancerBackendSetHealth extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciNetworkLoadBalancerBackendSetHealth that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/network_load_balancer_backend_set_health#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/network_load_balancer_backend_set_health oci_network_load_balancer_backend_set_health} Data Source
  *
  * @param scope The scope in which to define this construct
