// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/database_vm_cluster_patch
...
export interface DataOciDatabaseVmClusterPatchConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/database_vm_cluster_patch#id DataOciDatabaseVmClusterPatch#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/database_vm_cluster_patch#patch_id DataOciDatabaseVmClusterPatch#patch_id}
  */
  readonly patchId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/database_vm_cluster_patch#vm_cluster_id DataOciDatabaseVmClusterPatch#vm_cluster_id}
  */
  readonly vmClusterId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/database_vm_cluster_patch oci_database_vm_cluster_patch}
*/
export class DataOciDatabaseVmClusterPatch extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseVmClusterPatch that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/database_vm_cluster_patch#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/database_vm_cluster_patch oci_database_vm_cluster_patch} Data Source
  *
  * @param scope The scope in which to define this construct
