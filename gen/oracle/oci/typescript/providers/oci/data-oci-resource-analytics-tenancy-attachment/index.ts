// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/resource_analytics_tenancy_attachment
...
export interface DataOciResourceAnalyticsTenancyAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/resource_analytics_tenancy_attachment#tenancy_attachment_id DataOciResourceAnalyticsTenancyAttachment#tenancy_attachment_id}
  */
  readonly tenancyAttachmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/resource_analytics_tenancy_attachment oci_resource_analytics_tenancy_attachment}
*/
export class DataOciResourceAnalyticsTenancyAttachment extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/resource_analytics_tenancy_attachment oci_resource_analytics_tenancy_attachment} Data Source
  *
  * @param scope The scope in which to define this construct
