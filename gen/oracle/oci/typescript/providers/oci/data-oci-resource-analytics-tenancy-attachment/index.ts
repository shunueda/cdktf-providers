// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/resource_analytics_tenancy_attachment
...
export interface DataOciResourceAnalyticsTenancyAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/resource_analytics_tenancy_attachment#tenancy_attachment_id DataOciResourceAnalyticsTenancyAttachment#tenancy_attachment_id}
  */
  readonly tenancyAttachmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/resource_analytics_tenancy_attachment oci_resource_analytics_tenancy_attachment}
*/
export class DataOciResourceAnalyticsTenancyAttachment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciResourceAnalyticsTenancyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/resource_analytics_tenancy_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/resource_analytics_tenancy_attachment oci_resource_analytics_tenancy_attachment} Data Source
  *
  * @param scope The scope in which to define this construct
