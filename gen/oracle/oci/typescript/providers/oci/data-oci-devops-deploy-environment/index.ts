// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/devops_deploy_environment
...
export interface DataOciDevopsDeployEnvironmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/devops_deploy_environment#deploy_environment_id DataOciDevopsDeployEnvironment#deploy_environment_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/devops_deploy_environment oci_devops_deploy_environment}
*/
export class DataOciDevopsDeployEnvironment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDevopsDeployEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/devops_deploy_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/devops_deploy_environment oci_devops_deploy_environment} Data Source
  *
  * @param scope The scope in which to define this construct
