// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_occm_demand_signal
...
export interface DataOciCapacityManagementOccmDemandSignalConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_occm_demand_signal#occm_demand_signal_id DataOciCapacityManagementOccmDemandSignal#occm_demand_signal_id}
  */
  readonly occmDemandSignalId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_occm_demand_signal oci_capacity_management_occm_demand_signal}
*/
export class DataOciCapacityManagementOccmDemandSignal extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCapacityManagementOccmDemandSignal that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_occm_demand_signal#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_occm_demand_signal oci_capacity_management_occm_demand_signal} Data Source
  *
  * @param scope The scope in which to define this construct
