// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/media_services_media_asset
...
export interface DataOciMediaServicesMediaAssetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/media_services_media_asset#media_asset_id DataOciMediaServicesMediaAsset#media_asset_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/media_services_media_asset oci_media_services_media_asset}
*/
export class DataOciMediaServicesMediaAsset extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciMediaServicesMediaAsset that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/media_services_media_asset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/media_services_media_asset oci_media_services_media_asset} Data Source
  *
  * @param scope The scope in which to define this construct
