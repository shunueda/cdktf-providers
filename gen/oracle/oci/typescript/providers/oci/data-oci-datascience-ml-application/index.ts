// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/datascience_ml_application
...
export interface DataOciDatascienceMlApplicationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/datascience_ml_application#ml_application_id DataOciDatascienceMlApplication#ml_application_id}
  */
  readonly mlApplicationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/datascience_ml_application oci_datascience_ml_application}
*/
export class DataOciDatascienceMlApplication extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatascienceMlApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/datascience_ml_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/datascience_ml_application oci_datascience_ml_application} Data Source
  *
  * @param scope The scope in which to define this construct
