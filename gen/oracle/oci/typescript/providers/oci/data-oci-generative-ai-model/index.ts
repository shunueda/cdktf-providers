// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/generative_ai_model
...
export interface DataOciGenerativeAiModelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/generative_ai_model#model_id DataOciGenerativeAiModel#model_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/generative_ai_model oci_generative_ai_model}
*/
export class DataOciGenerativeAiModel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciGenerativeAiModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/generative_ai_model#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/generative_ai_model oci_generative_ai_model} Data Source
  *
  * @param scope The scope in which to define this construct
