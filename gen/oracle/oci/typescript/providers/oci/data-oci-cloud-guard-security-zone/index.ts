// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/cloud_guard_security_zone
...
export interface DataOciCloudGuardSecurityZoneConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/cloud_guard_security_zone#security_zone_id DataOciCloudGuardSecurityZone#security_zone_id}
  */
  readonly securityZoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/cloud_guard_security_zone oci_cloud_guard_security_zone}
*/
export class DataOciCloudGuardSecurityZone extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCloudGuardSecurityZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/cloud_guard_security_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/cloud_guard_security_zone oci_cloud_guard_security_zone} Data Source
  *
  * @param scope The scope in which to define this construct
