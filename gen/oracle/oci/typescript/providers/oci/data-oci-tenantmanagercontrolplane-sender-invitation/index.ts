// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/tenantmanagercontrolplane_sender_invitation
...
export interface DataOciTenantmanagercontrolplaneSenderInvitationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/tenantmanagercontrolplane_sender_invitation#id DataOciTenantmanagercontrolplaneSenderInvitation#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/tenantmanagercontrolplane_sender_invitation#sender_invitation_id DataOciTenantmanagercontrolplaneSenderInvitation#sender_invitation_id}
  */
  readonly senderInvitationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/tenantmanagercontrolplane_sender_invitation oci_tenantmanagercontrolplane_sender_invitation}
*/
export class DataOciTenantmanagercontrolplaneSenderInvitation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciTenantmanagercontrolplaneSenderInvitation that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/tenantmanagercontrolplane_sender_invitation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/tenantmanagercontrolplane_sender_invitation oci_tenantmanagercontrolplane_sender_invitation} Data Source
  *
  * @param scope The scope in which to define this construct
