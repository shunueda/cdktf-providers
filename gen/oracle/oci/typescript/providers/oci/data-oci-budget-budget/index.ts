// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/budget_budget
...
export interface DataOciBudgetBudgetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/budget_budget#budget_id DataOciBudgetBudget#budget_id}
  */
  readonly budgetId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/budget_budget oci_budget_budget}
*/
export class DataOciBudgetBudget extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciBudgetBudget that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/budget_budget#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/budget_budget oci_budget_budget} Data Source
  *
  * @param scope The scope in which to define this construct
