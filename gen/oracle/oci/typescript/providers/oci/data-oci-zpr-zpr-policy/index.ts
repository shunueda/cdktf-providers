// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/zpr_zpr_policy
...
export interface DataOciZprZprPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/zpr_zpr_policy#zpr_policy_id DataOciZprZprPolicy#zpr_policy_id}
  */
  readonly zprPolicyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/zpr_zpr_policy oci_zpr_zpr_policy}
*/
export class DataOciZprZprPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciZprZprPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/zpr_zpr_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/zpr_zpr_policy oci_zpr_zpr_policy} Data Source
  *
  * @param scope The scope in which to define this construct
