// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/load_balancer_rule_set
...
export interface DataOciLoadBalancerRuleSetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/load_balancer_rule_set#load_balancer_id DataOciLoadBalancerRuleSet#load_balancer_id}
  */
  readonly loadBalancerId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/load_balancer_rule_set#name DataOciLoadBalancerRuleSet#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/load_balancer_rule_set oci_load_balancer_rule_set}
*/
export class DataOciLoadBalancerRuleSet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciLoadBalancerRuleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/load_balancer_rule_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/load_balancer_rule_set oci_load_balancer_rule_set} Data Source
  *
  * @param scope The scope in which to define this construct
