// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apm_traces_attribute_auto_activate_status
...
export interface DataOciApmTracesAttributeAutoActivateStatusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apm_traces_attribute_auto_activate_status#apm_domain_id DataOciApmTracesAttributeAutoActivateStatus#apm_domain_id}
  */
  readonly apmDomainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apm_traces_attribute_auto_activate_status#data_key_type DataOciApmTracesAttributeAutoActivateStatus#data_key_type}
  */
  readonly dataKeyType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apm_traces_attribute_auto_activate_status#id DataOciApmTracesAttributeAutoActivateStatus#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apm_traces_attribute_auto_activate_status oci_apm_traces_attribute_auto_activate_status}
*/
export class DataOciApmTracesAttributeAutoActivateStatus extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciApmTracesAttributeAutoActivateStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apm_traces_attribute_auto_activate_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apm_traces_attribute_auto_activate_status oci_apm_traces_attribute_auto_activate_status} Data Source
  *
  * @param scope The scope in which to define this construct
