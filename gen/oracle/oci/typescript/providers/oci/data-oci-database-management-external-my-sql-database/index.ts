// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_management_external_my_sql_database
...
export interface DataOciDatabaseManagementExternalMySqlDatabaseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_management_external_my_sql_database#external_my_sql_database_id DataOciDatabaseManagementExternalMySqlDatabase#external_my_sql_database_id}
  */
  readonly externalMySqlDatabaseId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_management_external_my_sql_database oci_database_management_external_my_sql_database}
*/
export class DataOciDatabaseManagementExternalMySqlDatabase extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseManagementExternalMySqlDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_management_external_my_sql_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_management_external_my_sql_database oci_database_management_external_my_sql_database} Data Source
  *
  * @param scope The scope in which to define this construct
