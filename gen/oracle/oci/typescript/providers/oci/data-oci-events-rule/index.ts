// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/events_rule
...
export interface DataOciEventsRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/events_rule#rule_id DataOciEventsRule#rule_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/events_rule oci_events_rule}
*/
export class DataOciEventsRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciEventsRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/events_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/events_rule oci_events_rule} Data Source
  *
  * @param scope The scope in which to define this construct
