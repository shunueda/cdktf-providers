// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/zpr_configuration
...
export interface DataOciZprConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/zpr_configuration#compartment_id DataOciZprConfiguration#compartment_id}
  */
  readonly compartmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/zpr_configuration oci_zpr_configuration}
*/
export class DataOciZprConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciZprConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/zpr_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/zpr_configuration oci_zpr_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
