// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_db_node_snapshot
...
export interface DataOciDatabaseDbNodeSnapshotConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_db_node_snapshot#dbnode_snapshot_id DataOciDatabaseDbNodeSnapshot#dbnode_snapshot_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_db_node_snapshot oci_database_db_node_snapshot}
*/
export class DataOciDatabaseDbNodeSnapshot extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseDbNodeSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_db_node_snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_db_node_snapshot oci_database_db_node_snapshot} Data Source
  *
  * @param scope The scope in which to define this construct
