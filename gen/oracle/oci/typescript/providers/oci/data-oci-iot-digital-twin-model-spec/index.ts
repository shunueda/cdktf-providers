// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/iot_digital_twin_model_spec
...
export interface DataOciIotDigitalTwinModelSpecConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/iot_digital_twin_model_spec#digital_twin_model_id DataOciIotDigitalTwinModelSpec#digital_twin_model_id}
  */
  readonly digitalTwinModelId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/iot_digital_twin_model_spec#id DataOciIotDigitalTwinModelSpec#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/iot_digital_twin_model_spec oci_iot_digital_twin_model_spec}
*/
export class DataOciIotDigitalTwinModelSpec extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciIotDigitalTwinModelSpec that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/iot_digital_twin_model_spec#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/iot_digital_twin_model_spec oci_iot_digital_twin_model_spec} Data Source
  *
  * @param scope The scope in which to define this construct
