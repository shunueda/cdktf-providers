// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/core_drg_route_table
...
export interface DataOciCoreDrgRouteTableConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/core_drg_route_table#drg_route_table_id DataOciCoreDrgRouteTable#drg_route_table_id}
  */
  readonly drgRouteTableId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/core_drg_route_table oci_core_drg_route_table}
*/
export class DataOciCoreDrgRouteTable extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreDrgRouteTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/core_drg_route_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/core_drg_route_table oci_core_drg_route_table} Data Source
  *
  * @param scope The scope in which to define this construct
