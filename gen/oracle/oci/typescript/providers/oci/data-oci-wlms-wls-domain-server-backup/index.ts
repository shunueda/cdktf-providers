// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/wlms_wls_domain_server_backup
...
export interface DataOciWlmsWlsDomainServerBackupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/wlms_wls_domain_server_backup#backup_id DataOciWlmsWlsDomainServerBackup#backup_id}
  */
  readonly backupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/wlms_wls_domain_server_backup#id DataOciWlmsWlsDomainServerBackup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/wlms_wls_domain_server_backup#server_id DataOciWlmsWlsDomainServerBackup#server_id}
  */
  readonly serverId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/wlms_wls_domain_server_backup#wls_domain_id DataOciWlmsWlsDomainServerBackup#wls_domain_id}
  */
  readonly wlsDomainId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/wlms_wls_domain_server_backup oci_wlms_wls_domain_server_backup}
*/
export class DataOciWlmsWlsDomainServerBackup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciWlmsWlsDomainServerBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/wlms_wls_domain_server_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/wlms_wls_domain_server_backup oci_wlms_wls_domain_server_backup} Data Source
  *
  * @param scope The scope in which to define this construct
