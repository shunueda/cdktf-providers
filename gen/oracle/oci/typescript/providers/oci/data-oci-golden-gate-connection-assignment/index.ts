// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_connection_assignment
...
export interface DataOciGoldenGateConnectionAssignmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_connection_assignment#connection_assignment_id DataOciGoldenGateConnectionAssignment#connection_assignment_id}
  */
  readonly connectionAssignmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_connection_assignment oci_golden_gate_connection_assignment}
*/
export class DataOciGoldenGateConnectionAssignment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciGoldenGateConnectionAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_connection_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_connection_assignment oci_golden_gate_connection_assignment} Data Source
  *
  * @param scope The scope in which to define this construct
