// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/jms_java_downloads_java_download_report_content
...
export interface DataOciJmsJavaDownloadsJavaDownloadReportContentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/jms_java_downloads_java_download_report_content#id DataOciJmsJavaDownloadsJavaDownloadReportContent#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/jms_java_downloads_java_download_report_content#java_download_report_id DataOciJmsJavaDownloadsJavaDownloadReportContent#java_download_report_id}
  */
  readonly javaDownloadReportId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/jms_java_downloads_java_download_report_content oci_jms_java_downloads_java_download_report_content}
*/
export class DataOciJmsJavaDownloadsJavaDownloadReportContent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciJmsJavaDownloadsJavaDownloadReportContent that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/jms_java_downloads_java_download_report_content#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/jms_java_downloads_java_download_report_content oci_jms_java_downloads_java_download_report_content} Data Source
  *
  * @param scope The scope in which to define this construct
