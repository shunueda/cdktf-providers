// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/opensearch_opensearch_cluster_pipeline
...
export interface DataOciOpensearchOpensearchClusterPipelineConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/opensearch_opensearch_cluster_pipeline#opensearch_cluster_pipeline_id DataOciOpensearchOpensearchClusterPipeline#opensearch_cluster_pipeline_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/opensearch_opensearch_cluster_pipeline oci_opensearch_opensearch_cluster_pipeline}
*/
export class DataOciOpensearchOpensearchClusterPipeline extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciOpensearchOpensearchClusterPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/opensearch_opensearch_cluster_pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/opensearch_opensearch_cluster_pipeline oci_opensearch_opensearch_cluster_pipeline} Data Source
  *
  * @param scope The scope in which to define this construct
