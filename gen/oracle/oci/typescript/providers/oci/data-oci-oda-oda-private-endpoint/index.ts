// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/oda_oda_private_endpoint
...
export interface DataOciOdaOdaPrivateEndpointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/oda_oda_private_endpoint#oda_private_endpoint_id DataOciOdaOdaPrivateEndpoint#oda_private_endpoint_id}
  */
  readonly odaPrivateEndpointId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/oda_oda_private_endpoint oci_oda_oda_private_endpoint}
*/
export class DataOciOdaOdaPrivateEndpoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciOdaOdaPrivateEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/oda_oda_private_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/oda_oda_private_endpoint oci_oda_oda_private_endpoint} Data Source
  *
  * @param scope The scope in which to define this construct
