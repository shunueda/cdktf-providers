// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/golden_gate_deployment_backup
...
export interface DataOciGoldenGateDeploymentBackupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/golden_gate_deployment_backup#deployment_backup_id DataOciGoldenGateDeploymentBackup#deployment_backup_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/golden_gate_deployment_backup oci_golden_gate_deployment_backup}
*/
export class DataOciGoldenGateDeploymentBackup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciGoldenGateDeploymentBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/golden_gate_deployment_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/golden_gate_deployment_backup oci_golden_gate_deployment_backup} Data Source
  *
  * @param scope The scope in which to define this construct
