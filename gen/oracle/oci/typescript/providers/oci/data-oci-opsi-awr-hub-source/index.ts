// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/opsi_awr_hub_source
...
export interface DataOciOpsiAwrHubSourceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/opsi_awr_hub_source#awr_hub_source_id DataOciOpsiAwrHubSource#awr_hub_source_id}
  */
  readonly awrHubSourceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/opsi_awr_hub_source oci_opsi_awr_hub_source}
*/
export class DataOciOpsiAwrHubSource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciOpsiAwrHubSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/opsi_awr_hub_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/opsi_awr_hub_source oci_opsi_awr_hub_source} Data Source
  *
  * @param scope The scope in which to define this construct
