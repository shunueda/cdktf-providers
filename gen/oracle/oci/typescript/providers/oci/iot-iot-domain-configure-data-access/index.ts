// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access
...
export interface IotIotDomainConfigureDataAccessConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access#db_allow_listed_identity_group_names IotIotDomainConfigureDataAccess#db_allow_listed_identity_group_names}
  */
  readonly dbAllowListedIdentityGroupNames?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access#db_allowed_identity_domain_host IotIotDomainConfigureDataAccess#db_allowed_identity_domain_host}
  */
  readonly dbAllowedIdentityDomainHost?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access#db_workspace_admin_initial_password IotIotDomainConfigureDataAccess#db_workspace_admin_initial_password}
  */
  readonly dbWorkspaceAdminInitialPassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access#id IotIotDomainConfigureDataAccess#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access#iot_domain_id IotIotDomainConfigureDataAccess#iot_domain_id}
  */
  readonly iotDomainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access#type IotIotDomainConfigureDataAccess#type}
  */
  readonly type: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access#timeouts IotIotDomainConfigureDataAccess#timeouts}
  */
  readonly timeouts?: IotIotDomainConfigureDataAccessTimeouts;
}
export interface IotIotDomainConfigureDataAccessTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access#create IotIotDomainConfigureDataAccess#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access#delete IotIotDomainConfigureDataAccess#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access#update IotIotDomainConfigureDataAccess#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access oci_iot_iot_domain_configure_data_access}
*/
export class IotIotDomainConfigureDataAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotIotDomainConfigureDataAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_configure_data_access oci_iot_iot_domain_configure_data_access} Resource
  *
  * @param scope The scope in which to define this construct
