// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/mysql_mysql_configuration
...
export interface DataOciMysqlMysqlConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/mysql_mysql_configuration#configuration_id DataOciMysqlMysqlConfiguration#configuration_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/mysql_mysql_configuration oci_mysql_mysql_configuration}
*/
export class DataOciMysqlMysqlConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciMysqlMysqlConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/mysql_mysql_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/mysql_mysql_configuration oci_mysql_mysql_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
