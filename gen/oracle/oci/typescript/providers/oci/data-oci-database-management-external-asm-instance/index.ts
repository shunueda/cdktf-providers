// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_management_external_asm_instance
...
export interface DataOciDatabaseManagementExternalAsmInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_management_external_asm_instance#external_asm_instance_id DataOciDatabaseManagementExternalAsmInstance#external_asm_instance_id}
  */
  readonly externalAsmInstanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_management_external_asm_instance oci_database_management_external_asm_instance}
*/
export class DataOciDatabaseManagementExternalAsmInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseManagementExternalAsmInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_management_external_asm_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_management_external_asm_instance oci_database_management_external_asm_instance} Data Source
  *
  * @param scope The scope in which to define this construct
