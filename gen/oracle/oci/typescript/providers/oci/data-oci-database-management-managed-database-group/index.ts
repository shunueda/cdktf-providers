// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_management_managed_database_group
...
export interface DataOciDatabaseManagementManagedDatabaseGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_management_managed_database_group#managed_database_group_id DataOciDatabaseManagementManagedDatabaseGroup#managed_database_group_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_management_managed_database_group oci_database_management_managed_database_group}
*/
export class DataOciDatabaseManagementManagedDatabaseGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseManagementManagedDatabaseGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_management_managed_database_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_management_managed_database_group oci_database_management_managed_database_group} Data Source
  *
  * @param scope The scope in which to define this construct
