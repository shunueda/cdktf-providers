// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_data_mask_rule
...
export interface DataOciCloudGuardDataMaskRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_data_mask_rule#data_mask_rule_id DataOciCloudGuardDataMaskRule#data_mask_rule_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_data_mask_rule oci_cloud_guard_data_mask_rule}
*/
export class DataOciCloudGuardDataMaskRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCloudGuardDataMaskRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_data_mask_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_data_mask_rule oci_cloud_guard_data_mask_rule} Data Source
  *
  * @param scope The scope in which to define this construct
