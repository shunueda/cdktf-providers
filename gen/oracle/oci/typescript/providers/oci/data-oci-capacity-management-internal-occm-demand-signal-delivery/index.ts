// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_internal_occm_demand_signal_delivery
...
export interface DataOciCapacityManagementInternalOccmDemandSignalDeliveryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_internal_occm_demand_signal_delivery#occm_demand_signal_delivery_id DataOciCapacityManagementInternalOccmDemandSignalDelivery#occm_demand_signal_delivery_id}
  */
  readonly occmDemandSignalDeliveryId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_internal_occm_demand_signal_delivery oci_capacity_management_internal_occm_demand_signal_delivery}
*/
export class DataOciCapacityManagementInternalOccmDemandSignalDelivery extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCapacityManagementInternalOccmDemandSignalDelivery that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_internal_occm_demand_signal_delivery#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_internal_occm_demand_signal_delivery oci_capacity_management_internal_occm_demand_signal_delivery} Data Source
  *
  * @param scope The scope in which to define this construct
