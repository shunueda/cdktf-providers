// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_language_model
...
export interface DataOciAiLanguageModelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_language_model#id DataOciAiLanguageModel#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_language_model oci_ai_language_model}
*/
export class DataOciAiLanguageModel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiLanguageModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_language_model#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_language_model oci_ai_language_model} Data Source
  *
  * @param scope The scope in which to define this construct
