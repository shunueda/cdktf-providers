// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_security_policy_report
...
export interface DataOciDataSafeSecurityPolicyReportConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_security_policy_report#id DataOciDataSafeSecurityPolicyReport#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_security_policy_report#security_policy_report_id DataOciDataSafeSecurityPolicyReport#security_policy_report_id}
  */
  readonly securityPolicyReportId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_security_policy_report oci_data_safe_security_policy_report}
*/
export class DataOciDataSafeSecurityPolicyReport extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeSecurityPolicyReport that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_security_policy_report#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_security_policy_report oci_data_safe_security_policy_report} Data Source
  *
  * @param scope The scope in which to define this construct
