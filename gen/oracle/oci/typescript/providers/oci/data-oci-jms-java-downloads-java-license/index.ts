// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_java_downloads_java_license
...
export interface DataOciJmsJavaDownloadsJavaLicenseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_java_downloads_java_license#id DataOciJmsJavaDownloadsJavaLicense#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_java_downloads_java_license#license_type DataOciJmsJavaDownloadsJavaLicense#license_type}
  */
  readonly licenseType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_java_downloads_java_license oci_jms_java_downloads_java_license}
*/
export class DataOciJmsJavaDownloadsJavaLicense extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciJmsJavaDownloadsJavaLicense that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_java_downloads_java_license#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_java_downloads_java_license oci_jms_java_downloads_java_license} Data Source
  *
  * @param scope The scope in which to define this construct
