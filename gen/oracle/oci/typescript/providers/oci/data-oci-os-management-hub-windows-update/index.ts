// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/os_management_hub_windows_update
...
export interface DataOciOsManagementHubWindowsUpdateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/os_management_hub_windows_update#id DataOciOsManagementHubWindowsUpdate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/os_management_hub_windows_update#windows_update_id DataOciOsManagementHubWindowsUpdate#windows_update_id}
  */
  readonly windowsUpdateId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/os_management_hub_windows_update oci_os_management_hub_windows_update}
*/
export class DataOciOsManagementHubWindowsUpdate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciOsManagementHubWindowsUpdate that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/os_management_hub_windows_update#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/os_management_hub_windows_update oci_os_management_hub_windows_update} Data Source
  *
  * @param scope The scope in which to define this construct
