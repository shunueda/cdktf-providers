// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_unified_audit_policy_definition
...
export interface DataOciDataSafeUnifiedAuditPolicyDefinitionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_unified_audit_policy_definition#unified_audit_policy_definition_id DataOciDataSafeUnifiedAuditPolicyDefinition#unified_audit_policy_definition_id}
  */
  readonly unifiedAuditPolicyDefinitionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_unified_audit_policy_definition oci_data_safe_unified_audit_policy_definition}
*/
export class DataOciDataSafeUnifiedAuditPolicyDefinition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeUnifiedAuditPolicyDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_unified_audit_policy_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_unified_audit_policy_definition oci_data_safe_unified_audit_policy_definition} Data Source
  *
  * @param scope The scope in which to define this construct
