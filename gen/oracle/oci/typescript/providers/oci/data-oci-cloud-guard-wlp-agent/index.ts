// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_wlp_agent
...
export interface DataOciCloudGuardWlpAgentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_wlp_agent#wlp_agent_id DataOciCloudGuardWlpAgent#wlp_agent_id}
  */
  readonly wlpAgentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_wlp_agent oci_cloud_guard_wlp_agent}
*/
export class DataOciCloudGuardWlpAgent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCloudGuardWlpAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_wlp_agent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_wlp_agent oci_cloud_guard_wlp_agent} Data Source
  *
  * @param scope The scope in which to define this construct
