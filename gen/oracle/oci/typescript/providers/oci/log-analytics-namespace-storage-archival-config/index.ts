// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/log_analytics_namespace_storage_archival_config
...
export interface LogAnalyticsNamespaceStorageArchivalConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/log_analytics_namespace_storage_archival_config#id LogAnalyticsNamespaceStorageArchivalConfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/log_analytics_namespace_storage_archival_config#namespace LogAnalyticsNamespaceStorageArchivalConfig#namespace}
  */
  readonly namespace: string;
  /**
  * archiving_configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/log_analytics_namespace_storage_archival_config#archiving_configuration LogAnalyticsNamespaceStorageArchivalConfig#archiving_configuration}
  */
  readonly archivingConfiguration: LogAnalyticsNamespaceStorageArchivalConfigArchivingConfiguration;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/log_analytics_namespace_storage_archival_config#timeouts LogAnalyticsNamespaceStorageArchivalConfig#timeouts}
  */
...
export interface LogAnalyticsNamespaceStorageArchivalConfigArchivingConfiguration {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/log_analytics_namespace_storage_archival_config#active_storage_duration LogAnalyticsNamespaceStorageArchivalConfig#active_storage_duration}
  */
  readonly activeStorageDuration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/log_analytics_namespace_storage_archival_config#archival_storage_duration LogAnalyticsNamespaceStorageArchivalConfig#archival_storage_duration}
  */
...
export interface LogAnalyticsNamespaceStorageArchivalConfigTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/log_analytics_namespace_storage_archival_config#create LogAnalyticsNamespaceStorageArchivalConfig#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/log_analytics_namespace_storage_archival_config#delete LogAnalyticsNamespaceStorageArchivalConfig#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/log_analytics_namespace_storage_archival_config#update LogAnalyticsNamespaceStorageArchivalConfig#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/log_analytics_namespace_storage_archival_config oci_log_analytics_namespace_storage_archival_config}
*/
export class LogAnalyticsNamespaceStorageArchivalConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogAnalyticsNamespaceStorageArchivalConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/log_analytics_namespace_storage_archival_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/log_analytics_namespace_storage_archival_config oci_log_analytics_namespace_storage_archival_config} Resource
  *
  * @param scope The scope in which to define this construct
