// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_maintenance_run
...
export interface DataOciDatabaseMaintenanceRunConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_maintenance_run#maintenance_run_id DataOciDatabaseMaintenanceRun#maintenance_run_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_maintenance_run oci_database_maintenance_run}
*/
export class DataOciDatabaseMaintenanceRun extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseMaintenanceRun that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_maintenance_run#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_maintenance_run oci_database_maintenance_run} Data Source
  *
  * @param scope The scope in which to define this construct
