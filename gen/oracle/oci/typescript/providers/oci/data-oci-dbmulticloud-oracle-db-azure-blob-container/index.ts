// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/dbmulticloud_oracle_db_azure_blob_container
...
export interface DataOciDbmulticloudOracleDbAzureBlobContainerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/dbmulticloud_oracle_db_azure_blob_container#oracle_db_azure_blob_container_id DataOciDbmulticloudOracleDbAzureBlobContainer#oracle_db_azure_blob_container_id}
  */
  readonly oracleDbAzureBlobContainerId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/dbmulticloud_oracle_db_azure_blob_container oci_dbmulticloud_oracle_db_azure_blob_container}
*/
export class DataOciDbmulticloudOracleDbAzureBlobContainer extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/dbmulticloud_oracle_db_azure_blob_container oci_dbmulticloud_oracle_db_azure_blob_container} Data Source
  *
  * @param scope The scope in which to define this construct
