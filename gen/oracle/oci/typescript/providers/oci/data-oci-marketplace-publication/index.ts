// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/marketplace_publication
...
export interface DataOciMarketplacePublicationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/marketplace_publication#publication_id DataOciMarketplacePublication#publication_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/marketplace_publication oci_marketplace_publication}
*/
export class DataOciMarketplacePublication extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciMarketplacePublication that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/marketplace_publication#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/marketplace_publication oci_marketplace_publication} Data Source
  *
  * @param scope The scope in which to define this construct
