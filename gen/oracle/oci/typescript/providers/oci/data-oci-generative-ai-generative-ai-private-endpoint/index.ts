// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/generative_ai_generative_ai_private_endpoint
...
export interface DataOciGenerativeAiGenerativeAiPrivateEndpointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/generative_ai_generative_ai_private_endpoint#generative_ai_private_endpoint_id DataOciGenerativeAiGenerativeAiPrivateEndpoint#generative_ai_private_endpoint_id}
  */
  readonly generativeAiPrivateEndpointId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/generative_ai_generative_ai_private_endpoint oci_generative_ai_generative_ai_private_endpoint}
*/
export class DataOciGenerativeAiGenerativeAiPrivateEndpoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciGenerativeAiGenerativeAiPrivateEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/generative_ai_generative_ai_private_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/generative_ai_generative_ai_private_endpoint oci_generative_ai_generative_ai_private_endpoint} Data Source
  *
  * @param scope The scope in which to define this construct
