// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/email_email_return_path
...
export interface DataOciEmailEmailReturnPathConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/email_email_return_path#email_return_path_id DataOciEmailEmailReturnPath#email_return_path_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/email_email_return_path oci_email_email_return_path}
*/
export class DataOciEmailEmailReturnPath extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciEmailEmailReturnPath that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/email_email_return_path#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/email_email_return_path oci_email_email_return_path} Data Source
  *
  * @param scope The scope in which to define this construct
