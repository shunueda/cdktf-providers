// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/data_safe_sensitive_type_group
...
export interface DataOciDataSafeSensitiveTypeGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/data_safe_sensitive_type_group#sensitive_type_group_id DataOciDataSafeSensitiveTypeGroup#sensitive_type_group_id}
  */
  readonly sensitiveTypeGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/data_safe_sensitive_type_group oci_data_safe_sensitive_type_group}
*/
export class DataOciDataSafeSensitiveTypeGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeSensitiveTypeGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/data_safe_sensitive_type_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/data_safe_sensitive_type_group oci_data_safe_sensitive_type_group} Data Source
  *
  * @param scope The scope in which to define this construct
