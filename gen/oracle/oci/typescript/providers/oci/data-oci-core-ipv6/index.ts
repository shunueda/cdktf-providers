// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_ipv6
...
export interface DataOciCoreIpv6Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_ipv6#ipv6id DataOciCoreIpv6#ipv6id}
  */
  readonly ipv6Id: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_ipv6 oci_core_ipv6}
*/
export class DataOciCoreIpv6 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreIpv6 that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_ipv6#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_ipv6 oci_core_ipv6} Data Source
  *
  * @param scope The scope in which to define this construct
