// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_tools_database_tools_identity
...
export interface DataOciDatabaseToolsDatabaseToolsIdentityConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_tools_database_tools_identity#database_tools_identity_id DataOciDatabaseToolsDatabaseToolsIdentity#database_tools_identity_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_tools_database_tools_identity oci_database_tools_database_tools_identity}
*/
export class DataOciDatabaseToolsDatabaseToolsIdentity extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseToolsDatabaseToolsIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_tools_database_tools_identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_tools_database_tools_identity oci_database_tools_database_tools_identity} Data Source
  *
  * @param scope The scope in which to define this construct
