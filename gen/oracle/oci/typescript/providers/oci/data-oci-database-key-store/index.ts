// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_key_store
...
export interface DataOciDatabaseKeyStoreConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_key_store#key_store_id DataOciDatabaseKeyStore#key_store_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_key_store oci_database_key_store}
*/
export class DataOciDatabaseKeyStore extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseKeyStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_key_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_key_store oci_database_key_store} Data Source
  *
  * @param scope The scope in which to define this construct
