// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_key_store
...
export interface DataOciDatabaseKeyStoreConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_key_store#key_store_id DataOciDatabaseKeyStore#key_store_id}
  */
...
export interface DataOciDatabaseKeyStoreAssociatedLongTermBackups {
}

export function dataOciDatabaseKeyStoreAssociatedLongTermBackupsToTerraform(struct?: DataOciDatabaseKeyStoreAssociatedLongTermBackups): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataOciDatabaseKeyStoreAssociatedLongTermBackupsToHclTerraform(struct?: DataOciDatabaseKeyStoreAssociatedLongTermBackups): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOciDatabaseKeyStoreAssociatedLongTermBackupsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataOciDatabaseKeyStoreAssociatedLongTermBackups | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataOciDatabaseKeyStoreAssociatedLongTermBackups | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataOciDatabaseKeyStoreAssociatedLongTermBackupsList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataOciDatabaseKeyStoreAssociatedLongTermBackupsOutputReference {
    return new DataOciDatabaseKeyStoreAssociatedLongTermBackupsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_key_store oci_database_key_store}
*/
export class DataOciDatabaseKeyStore extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseKeyStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_key_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_key_store oci_database_key_store} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _associatedLongTermBackups = new DataOciDatabaseKeyStoreAssociatedLongTermBackupsList(this, "associated_long_term_backups", false);
