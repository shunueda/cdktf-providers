// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/sch_connector_plugin
...
export interface DataOciSchConnectorPluginConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/sch_connector_plugin#connector_plugin_name DataOciSchConnectorPlugin#connector_plugin_name}
  */
  readonly connectorPluginName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/sch_connector_plugin#id DataOciSchConnectorPlugin#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/sch_connector_plugin oci_sch_connector_plugin}
*/
export class DataOciSchConnectorPlugin extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciSchConnectorPlugin that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/sch_connector_plugin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/sch_connector_plugin oci_sch_connector_plugin} Data Source
  *
  * @param scope The scope in which to define this construct
