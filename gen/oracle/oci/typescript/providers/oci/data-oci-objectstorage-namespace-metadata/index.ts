// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/objectstorage_namespace_metadata
...
export interface DataOciObjectstorageNamespaceMetadataConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/objectstorage_namespace_metadata#id DataOciObjectstorageNamespaceMetadata#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/objectstorage_namespace_metadata#namespace DataOciObjectstorageNamespaceMetadata#namespace}
  */
  readonly namespace: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/objectstorage_namespace_metadata oci_objectstorage_namespace_metadata}
*/
export class DataOciObjectstorageNamespaceMetadata extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciObjectstorageNamespaceMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/objectstorage_namespace_metadata#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/objectstorage_namespace_metadata oci_objectstorage_namespace_metadata} Data Source
  *
  * @param scope The scope in which to define this construct
