// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/desktops_desktop_pool
...
export interface DataOciDesktopsDesktopPoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/desktops_desktop_pool#desktop_pool_id DataOciDesktopsDesktopPool#desktop_pool_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/desktops_desktop_pool oci_desktops_desktop_pool}
*/
export class DataOciDesktopsDesktopPool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDesktopsDesktopPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/desktops_desktop_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/desktops_desktop_pool oci_desktops_desktop_pool} Data Source
  *
  * @param scope The scope in which to define this construct
