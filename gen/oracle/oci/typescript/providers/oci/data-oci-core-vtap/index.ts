// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_vtap
...
export interface DataOciCoreVtapConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_vtap#vtap_id DataOciCoreVtap#vtap_id}
  */
  readonly vtapId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_vtap oci_core_vtap}
*/
export class DataOciCoreVtap extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreVtap that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_vtap#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_vtap oci_core_vtap} Data Source
  *
  * @param scope The scope in which to define this construct
