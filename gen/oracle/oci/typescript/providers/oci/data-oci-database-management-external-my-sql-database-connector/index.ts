// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_management_external_my_sql_database_connector
...
export interface DataOciDatabaseManagementExternalMySqlDatabaseConnectorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_management_external_my_sql_database_connector#external_my_sql_database_connector_id DataOciDatabaseManagementExternalMySqlDatabaseConnector#external_my_sql_database_connector_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_management_external_my_sql_database_connector oci_database_management_external_my_sql_database_connector}
*/
export class DataOciDatabaseManagementExternalMySqlDatabaseConnector extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseManagementExternalMySqlDatabaseConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_management_external_my_sql_database_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_management_external_my_sql_database_connector oci_database_management_external_my_sql_database_connector} Data Source
  *
  * @param scope The scope in which to define this construct
