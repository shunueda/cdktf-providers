// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dbmulticloud_oracle_db_azure_blob_mount
...
export interface DataOciDbmulticloudOracleDbAzureBlobMountConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dbmulticloud_oracle_db_azure_blob_mount#oracle_db_azure_blob_mount_id DataOciDbmulticloudOracleDbAzureBlobMount#oracle_db_azure_blob_mount_id}
  */
  readonly oracleDbAzureBlobMountId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dbmulticloud_oracle_db_azure_blob_mount oci_dbmulticloud_oracle_db_azure_blob_mount}
*/
export class DataOciDbmulticloudOracleDbAzureBlobMount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDbmulticloudOracleDbAzureBlobMount that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dbmulticloud_oracle_db_azure_blob_mount#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dbmulticloud_oracle_db_azure_blob_mount oci_dbmulticloud_oracle_db_azure_blob_mount} Data Source
  *
  * @param scope The scope in which to define this construct
