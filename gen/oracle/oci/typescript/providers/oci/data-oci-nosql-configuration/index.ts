// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/nosql_configuration
...
export interface DataOciNosqlConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/nosql_configuration#compartment_id DataOciNosqlConfiguration#compartment_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/nosql_configuration oci_nosql_configuration}
*/
export class DataOciNosqlConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciNosqlConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/nosql_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/nosql_configuration oci_nosql_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
