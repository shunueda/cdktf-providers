// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/delegate_access_control_delegation_subscription
...
export interface DataOciDelegateAccessControlDelegationSubscriptionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/delegate_access_control_delegation_subscription#delegation_subscription_id DataOciDelegateAccessControlDelegationSubscription#delegation_subscription_id}
  */
  readonly delegationSubscriptionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/delegate_access_control_delegation_subscription oci_delegate_access_control_delegation_subscription}
*/
export class DataOciDelegateAccessControlDelegationSubscription extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDelegateAccessControlDelegationSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/delegate_access_control_delegation_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/delegate_access_control_delegation_subscription oci_delegate_access_control_delegation_subscription} Data Source
  *
  * @param scope The scope in which to define this construct
