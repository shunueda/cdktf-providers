// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_group_configure_data_access
...
export interface IotIotDomainGroupConfigureDataAccessConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_group_configure_data_access#db_allow_listed_vcn_ids IotIotDomainGroupConfigureDataAccess#db_allow_listed_vcn_ids}
  */
  readonly dbAllowListedVcnIds: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_group_configure_data_access#id IotIotDomainGroupConfigureDataAccess#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_group_configure_data_access#iot_domain_group_id IotIotDomainGroupConfigureDataAccess#iot_domain_group_id}
  */
  readonly iotDomainGroupId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_group_configure_data_access#timeouts IotIotDomainGroupConfigureDataAccess#timeouts}
  */
...
export interface IotIotDomainGroupConfigureDataAccessTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_group_configure_data_access#create IotIotDomainGroupConfigureDataAccess#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_group_configure_data_access#delete IotIotDomainGroupConfigureDataAccess#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_group_configure_data_access#update IotIotDomainGroupConfigureDataAccess#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_group_configure_data_access oci_iot_iot_domain_group_configure_data_access}
*/
export class IotIotDomainGroupConfigureDataAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotIotDomainGroupConfigureDataAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_group_configure_data_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/iot_iot_domain_group_configure_data_access oci_iot_iot_domain_group_configure_data_access} Resource
  *
  * @param scope The scope in which to define this construct
