// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/ai_vision_stream_job
...
export interface DataOciAiVisionStreamJobConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/ai_vision_stream_job#stream_job_id DataOciAiVisionStreamJob#stream_job_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/ai_vision_stream_job oci_ai_vision_stream_job}
*/
export class DataOciAiVisionStreamJob extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiVisionStreamJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/ai_vision_stream_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/ai_vision_stream_job oci_ai_vision_stream_job} Data Source
  *
  * @param scope The scope in which to define this construct
