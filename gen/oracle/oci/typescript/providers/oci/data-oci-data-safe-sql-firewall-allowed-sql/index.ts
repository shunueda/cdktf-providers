// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_sql_firewall_allowed_sql
...
export interface DataOciDataSafeSqlFirewallAllowedSqlConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_sql_firewall_allowed_sql#id DataOciDataSafeSqlFirewallAllowedSql#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_sql_firewall_allowed_sql#sql_firewall_allowed_sql_id DataOciDataSafeSqlFirewallAllowedSql#sql_firewall_allowed_sql_id}
  */
  readonly sqlFirewallAllowedSqlId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_sql_firewall_allowed_sql oci_data_safe_sql_firewall_allowed_sql}
*/
export class DataOciDataSafeSqlFirewallAllowedSql extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeSqlFirewallAllowedSql that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_sql_firewall_allowed_sql#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_sql_firewall_allowed_sql oci_data_safe_sql_firewall_allowed_sql} Data Source
  *
  * @param scope The scope in which to define this construct
