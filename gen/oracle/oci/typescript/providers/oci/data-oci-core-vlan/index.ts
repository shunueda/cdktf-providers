// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/core_vlan
...
export interface DataOciCoreVlanConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/core_vlan#vlan_id DataOciCoreVlan#vlan_id}
  */
  readonly vlanId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/core_vlan oci_core_vlan}
*/
export class DataOciCoreVlan extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreVlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/core_vlan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/core_vlan oci_core_vlan} Data Source
  *
  * @param scope The scope in which to define this construct
