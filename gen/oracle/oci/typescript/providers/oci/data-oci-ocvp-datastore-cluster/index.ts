// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ocvp_datastore_cluster
...
export interface DataOciOcvpDatastoreClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ocvp_datastore_cluster#datastore_cluster_id DataOciOcvpDatastoreCluster#datastore_cluster_id}
  */
  readonly datastoreClusterId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ocvp_datastore_cluster oci_ocvp_datastore_cluster}
*/
export class DataOciOcvpDatastoreCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciOcvpDatastoreCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ocvp_datastore_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ocvp_datastore_cluster oci_ocvp_datastore_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
