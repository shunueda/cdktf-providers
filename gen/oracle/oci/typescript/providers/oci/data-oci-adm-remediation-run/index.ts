// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/adm_remediation_run
...
export interface DataOciAdmRemediationRunConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/adm_remediation_run#remediation_run_id DataOciAdmRemediationRun#remediation_run_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/adm_remediation_run oci_adm_remediation_run}
*/
export class DataOciAdmRemediationRun extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAdmRemediationRun that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/adm_remediation_run#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/adm_remediation_run oci_adm_remediation_run} Data Source
  *
  * @param scope The scope in which to define this construct
