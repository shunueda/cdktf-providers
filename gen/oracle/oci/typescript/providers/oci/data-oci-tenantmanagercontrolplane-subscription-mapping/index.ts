// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/tenantmanagercontrolplane_subscription_mapping
...
export interface DataOciTenantmanagercontrolplaneSubscriptionMappingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/tenantmanagercontrolplane_subscription_mapping#subscription_mapping_id DataOciTenantmanagercontrolplaneSubscriptionMapping#subscription_mapping_id}
  */
  readonly subscriptionMappingId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/tenantmanagercontrolplane_subscription_mapping oci_tenantmanagercontrolplane_subscription_mapping}
*/
export class DataOciTenantmanagercontrolplaneSubscriptionMapping extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciTenantmanagercontrolplaneSubscriptionMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/tenantmanagercontrolplane_subscription_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/tenantmanagercontrolplane_subscription_mapping oci_tenantmanagercontrolplane_subscription_mapping} Data Source
  *
  * @param scope The scope in which to define this construct
