// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_db_node_console_history
...
export interface DataOciDatabaseDbNodeConsoleHistoryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_db_node_console_history#console_history_id DataOciDatabaseDbNodeConsoleHistory#console_history_id}
  */
  readonly consoleHistoryId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_db_node_console_history#db_node_id DataOciDatabaseDbNodeConsoleHistory#db_node_id}
  */
  readonly dbNodeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_db_node_console_history oci_database_db_node_console_history}
*/
export class DataOciDatabaseDbNodeConsoleHistory extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseDbNodeConsoleHistory that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_db_node_console_history#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/database_db_node_console_history oci_database_db_node_console_history} Data Source
  *
  * @param scope The scope in which to define this construct
