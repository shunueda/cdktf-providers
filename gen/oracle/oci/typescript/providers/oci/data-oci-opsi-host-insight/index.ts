// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/opsi_host_insight
...
export interface DataOciOpsiHostInsightConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/opsi_host_insight#host_insight_id DataOciOpsiHostInsight#host_insight_id}
  */
  readonly hostInsightId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/opsi_host_insight oci_opsi_host_insight}
*/
export class DataOciOpsiHostInsight extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciOpsiHostInsight that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/opsi_host_insight#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/opsi_host_insight oci_opsi_host_insight} Data Source
  *
  * @param scope The scope in which to define this construct
