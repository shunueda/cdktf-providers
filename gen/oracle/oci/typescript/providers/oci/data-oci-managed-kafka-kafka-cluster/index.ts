// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/managed_kafka_kafka_cluster
...
export interface DataOciManagedKafkaKafkaClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/managed_kafka_kafka_cluster#kafka_cluster_id DataOciManagedKafkaKafkaCluster#kafka_cluster_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/managed_kafka_kafka_cluster oci_managed_kafka_kafka_cluster}
*/
export class DataOciManagedKafkaKafkaCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciManagedKafkaKafkaCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/managed_kafka_kafka_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/managed_kafka_kafka_cluster oci_managed_kafka_kafka_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
