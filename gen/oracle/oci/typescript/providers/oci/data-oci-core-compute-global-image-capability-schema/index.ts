// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_global_image_capability_schema
...
export interface DataOciCoreComputeGlobalImageCapabilitySchemaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_global_image_capability_schema#compute_global_image_capability_schema_id DataOciCoreComputeGlobalImageCapabilitySchema#compute_global_image_capability_schema_id}
  */
  readonly computeGlobalImageCapabilitySchemaId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_global_image_capability_schema#id DataOciCoreComputeGlobalImageCapabilitySchema#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_global_image_capability_schema oci_core_compute_global_image_capability_schema}
*/
export class DataOciCoreComputeGlobalImageCapabilitySchema extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreComputeGlobalImageCapabilitySchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_global_image_capability_schema#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_global_image_capability_schema oci_core_compute_global_image_capability_schema} Data Source
  *
  * @param scope The scope in which to define this construct
