// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_cluster
...
export interface DataOciCoreComputeClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_cluster#compute_cluster_id DataOciCoreComputeCluster#compute_cluster_id}
  */
  readonly computeClusterId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_cluster oci_core_compute_cluster}
*/
export class DataOciCoreComputeCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreComputeCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_compute_cluster oci_core_compute_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
