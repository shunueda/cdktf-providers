// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/fleet_apps_management_property
...
export interface DataOciFleetAppsManagementPropertyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/fleet_apps_management_property#property_id DataOciFleetAppsManagementProperty#property_id}
  */
  readonly propertyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/fleet_apps_management_property oci_fleet_apps_management_property}
*/
export class DataOciFleetAppsManagementProperty extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciFleetAppsManagementProperty that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/fleet_apps_management_property#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/fleet_apps_management_property oci_fleet_apps_management_property} Data Source
  *
  * @param scope The scope in which to define this construct
