// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/apiaccesscontrol_privileged_api_control
...
export interface DataOciApiaccesscontrolPrivilegedApiControlConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/apiaccesscontrol_privileged_api_control#privileged_api_control_id DataOciApiaccesscontrolPrivilegedApiControl#privileged_api_control_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/apiaccesscontrol_privileged_api_control oci_apiaccesscontrol_privileged_api_control}
*/
export class DataOciApiaccesscontrolPrivilegedApiControl extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciApiaccesscontrolPrivilegedApiControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/apiaccesscontrol_privileged_api_control#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/apiaccesscontrol_privileged_api_control oci_apiaccesscontrol_privileged_api_control} Data Source
  *
  * @param scope The scope in which to define this construct
