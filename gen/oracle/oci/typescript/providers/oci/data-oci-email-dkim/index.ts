// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/email_dkim
...
export interface DataOciEmailDkimConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/email_dkim#dkim_id DataOciEmailDkim#dkim_id}
  */
  readonly dkimId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/email_dkim oci_email_dkim}
*/
export class DataOciEmailDkim extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciEmailDkim that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/email_dkim#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/email_dkim oci_email_dkim} Data Source
  *
  * @param scope The scope in which to define this construct
