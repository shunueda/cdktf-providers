// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/dbmulticloud_oracle_db_aws_key
...
export interface DataOciDbmulticloudOracleDbAwsKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/dbmulticloud_oracle_db_aws_key#oracle_db_aws_key_id DataOciDbmulticloudOracleDbAwsKey#oracle_db_aws_key_id}
  */
  readonly oracleDbAwsKeyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/dbmulticloud_oracle_db_aws_key oci_dbmulticloud_oracle_db_aws_key}
*/
export class DataOciDbmulticloudOracleDbAwsKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDbmulticloudOracleDbAwsKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/dbmulticloud_oracle_db_aws_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/dbmulticloud_oracle_db_aws_key oci_dbmulticloud_oracle_db_aws_key} Data Source
  *
  * @param scope The scope in which to define this construct
