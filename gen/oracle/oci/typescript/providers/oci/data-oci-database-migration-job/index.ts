// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_migration_job
...
export interface DataOciDatabaseMigrationJobConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_migration_job#job_id DataOciDatabaseMigrationJob#job_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_migration_job oci_database_migration_job}
*/
export class DataOciDatabaseMigrationJob extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseMigrationJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_migration_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_migration_job oci_database_migration_job} Data Source
  *
  * @param scope The scope in which to define this construct
