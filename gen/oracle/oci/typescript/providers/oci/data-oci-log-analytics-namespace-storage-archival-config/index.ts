// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/log_analytics_namespace_storage_archival_config
...
export interface DataOciLogAnalyticsNamespaceStorageArchivalConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/log_analytics_namespace_storage_archival_config#namespace DataOciLogAnalyticsNamespaceStorageArchivalConfig#namespace}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/log_analytics_namespace_storage_archival_config oci_log_analytics_namespace_storage_archival_config}
*/
export class DataOciLogAnalyticsNamespaceStorageArchivalConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciLogAnalyticsNamespaceStorageArchivalConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/log_analytics_namespace_storage_archival_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/log_analytics_namespace_storage_archival_config oci_log_analytics_namespace_storage_archival_config} Data Source
  *
  * @param scope The scope in which to define this construct
