// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_db_system_patches
...
export interface DataOciDatabaseDbSystemPatchesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_db_system_patches#db_system_id DataOciDatabaseDbSystemPatches#db_system_id}
  */
  readonly dbSystemId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_db_system_patches#id DataOciDatabaseDbSystemPatches#id}
  *
  ...
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_db_system_patches#filter DataOciDatabaseDbSystemPatches#filter}
  */
...
export function dataOciDatabaseDbSystemPatchesPatchesToHclTerraform(struct?: DataOciDatabaseDbSystemPatchesPatches): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface DataOciDatabaseDbSystemPatchesFilter {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_db_system_patches#name DataOciDatabaseDbSystemPatches#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_db_system_patches#regex DataOciDatabaseDbSystemPatches#regex}
  */
  readonly regex?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_db_system_patches#values DataOciDatabaseDbSystemPatches#values}
  */
...
export function dataOciDatabaseDbSystemPatchesFilterToHclTerraform(struct?: DataOciDatabaseDbSystemPatchesFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_db_system_patches oci_database_db_system_patches}
*/
export class DataOciDatabaseDbSystemPatches extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataOciDatabaseDbSystemPatches to import
  * @param importFromId The id of the existing DataOciDatabaseDbSystemPatches that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_db_system_patches#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataOciDatabaseDbSystemPatches to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "oci_database_db_system_patches", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_db_system_patches oci_database_db_system_patches} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktf.listMapperHcl(dataOciDatabaseDbSystemPatchesFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataOciDatabaseDbSystemPatchesFilterList",
      },
    };
