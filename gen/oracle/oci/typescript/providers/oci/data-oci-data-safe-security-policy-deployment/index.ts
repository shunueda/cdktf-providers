// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/data_safe_security_policy_deployment
...
export interface DataOciDataSafeSecurityPolicyDeploymentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/data_safe_security_policy_deployment#security_policy_deployment_id DataOciDataSafeSecurityPolicyDeployment#security_policy_deployment_id}
  */
  readonly securityPolicyDeploymentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/data_safe_security_policy_deployment oci_data_safe_security_policy_deployment}
*/
export class DataOciDataSafeSecurityPolicyDeployment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeSecurityPolicyDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/data_safe_security_policy_deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/data_safe_security_policy_deployment oci_data_safe_security_policy_deployment} Data Source
  *
  * @param scope The scope in which to define this construct
