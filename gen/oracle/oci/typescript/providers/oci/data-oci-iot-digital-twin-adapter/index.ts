// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/iot_digital_twin_adapter
...
export interface DataOciIotDigitalTwinAdapterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/iot_digital_twin_adapter#digital_twin_adapter_id DataOciIotDigitalTwinAdapter#digital_twin_adapter_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/iot_digital_twin_adapter oci_iot_digital_twin_adapter}
*/
export class DataOciIotDigitalTwinAdapter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciIotDigitalTwinAdapter that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/iot_digital_twin_adapter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/iot_digital_twin_adapter oci_iot_digital_twin_adapter} Data Source
  *
  * @param scope The scope in which to define this construct
