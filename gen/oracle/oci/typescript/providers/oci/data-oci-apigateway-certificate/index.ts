// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/apigateway_certificate
...
export interface DataOciApigatewayCertificateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/apigateway_certificate#certificate_id DataOciApigatewayCertificate#certificate_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/apigateway_certificate oci_apigateway_certificate}
*/
export class DataOciApigatewayCertificate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciApigatewayCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/apigateway_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/apigateway_certificate oci_apigateway_certificate} Data Source
  *
  * @param scope The scope in which to define this construct
