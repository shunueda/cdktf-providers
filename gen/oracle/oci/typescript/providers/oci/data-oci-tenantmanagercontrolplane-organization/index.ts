// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/tenantmanagercontrolplane_organization
...
export interface DataOciTenantmanagercontrolplaneOrganizationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/tenantmanagercontrolplane_organization#id DataOciTenantmanagercontrolplaneOrganization#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/tenantmanagercontrolplane_organization#organization_id DataOciTenantmanagercontrolplaneOrganization#organization_id}
  */
  readonly organizationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/tenantmanagercontrolplane_organization oci_tenantmanagercontrolplane_organization}
*/
export class DataOciTenantmanagercontrolplaneOrganization extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciTenantmanagercontrolplaneOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/tenantmanagercontrolplane_organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/tenantmanagercontrolplane_organization oci_tenantmanagercontrolplane_organization} Data Source
  *
  * @param scope The scope in which to define this construct
