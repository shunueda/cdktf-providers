// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduled_action
...
export interface DataOciDatabaseScheduledActionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduled_action#scheduled_action_id DataOciDatabaseScheduledAction#scheduled_action_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduled_action oci_database_scheduled_action}
*/
export class DataOciDatabaseScheduledAction extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseScheduledAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduled_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduled_action oci_database_scheduled_action} Data Source
  *
  * @param scope The scope in which to define this construct
