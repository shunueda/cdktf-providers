// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/golden_gate_connection_assignment
...
export interface GoldenGateConnectionAssignmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/golden_gate_connection_assignment#connection_id GoldenGateConnectionAssignment#connection_id}
  */
  readonly connectionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/golden_gate_connection_assignment#deployment_id GoldenGateConnectionAssignment#deployment_id}
  */
  readonly deploymentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/golden_gate_connection_assignment#id GoldenGateConnectionAssignment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/golden_gate_connection_assignment#is_lock_override GoldenGateConnectionAssignment#is_lock_override}
  */
  readonly isLockOverride?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/golden_gate_connection_assignment#timeouts GoldenGateConnectionAssignment#timeouts}
  */
  readonly timeouts?: GoldenGateConnectionAssignmentTimeouts;
}
export interface GoldenGateConnectionAssignmentTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/golden_gate_connection_assignment#create GoldenGateConnectionAssignment#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/golden_gate_connection_assignment#delete GoldenGateConnectionAssignment#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/golden_gate_connection_assignment#update GoldenGateConnectionAssignment#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/golden_gate_connection_assignment oci_golden_gate_connection_assignment}
*/
export class GoldenGateConnectionAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoldenGateConnectionAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/golden_gate_connection_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/golden_gate_connection_assignment oci_golden_gate_connection_assignment} Resource
  *
  * @param scope The scope in which to define this construct
