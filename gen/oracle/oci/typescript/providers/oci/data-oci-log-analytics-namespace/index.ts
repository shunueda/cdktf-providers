// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/log_analytics_namespace
...
export interface DataOciLogAnalyticsNamespaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/log_analytics_namespace#id DataOciLogAnalyticsNamespace#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/log_analytics_namespace#namespace DataOciLogAnalyticsNamespace#namespace}
  */
  readonly namespace: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/log_analytics_namespace oci_log_analytics_namespace}
*/
export class DataOciLogAnalyticsNamespace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciLogAnalyticsNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/log_analytics_namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/log_analytics_namespace oci_log_analytics_namespace} Data Source
  *
  * @param scope The scope in which to define this construct
