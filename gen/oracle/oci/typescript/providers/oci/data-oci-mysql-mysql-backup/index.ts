// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/mysql_mysql_backup
...
export interface DataOciMysqlMysqlBackupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/mysql_mysql_backup#backup_id DataOciMysqlMysqlBackup#backup_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/mysql_mysql_backup oci_mysql_mysql_backup}
*/
export class DataOciMysqlMysqlBackup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciMysqlMysqlBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/mysql_mysql_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/mysql_mysql_backup oci_mysql_mysql_backup} Data Source
  *
  * @param scope The scope in which to define this construct
