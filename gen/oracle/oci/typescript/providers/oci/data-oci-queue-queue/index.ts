// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/queue_queue
...
export interface DataOciQueueQueueConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/queue_queue#queue_id DataOciQueueQueue#queue_id}
  */
  readonly queueId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/queue_queue oci_queue_queue}
*/
export class DataOciQueueQueue extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciQueueQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/queue_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/queue_queue oci_queue_queue} Data Source
  *
  * @param scope The scope in which to define this construct
