// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/opsi_database_insight
...
export interface DataOciOpsiDatabaseInsightConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/opsi_database_insight#database_insight_id DataOciOpsiDatabaseInsight#database_insight_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/opsi_database_insight oci_opsi_database_insight}
*/
export class DataOciOpsiDatabaseInsight extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciOpsiDatabaseInsight that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/opsi_database_insight#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/opsi_database_insight oci_opsi_database_insight} Data Source
  *
  * @param scope The scope in which to define this construct
