// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/iot_iot_domain_group
...
export interface DataOciIotIotDomainGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/iot_iot_domain_group#iot_domain_group_id DataOciIotIotDomainGroup#iot_domain_group_id}
  */
  readonly iotDomainGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/iot_iot_domain_group oci_iot_iot_domain_group}
*/
export class DataOciIotIotDomainGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciIotIotDomainGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/iot_iot_domain_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/iot_iot_domain_group oci_iot_iot_domain_group} Data Source
  *
  * @param scope The scope in which to define this construct
