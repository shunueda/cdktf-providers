// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_letter_of_authority
...
export interface DataOciCoreLetterOfAuthorityConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_letter_of_authority#cross_connect_id DataOciCoreLetterOfAuthority#cross_connect_id}
  */
  readonly crossConnectId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_letter_of_authority#id DataOciCoreLetterOfAuthority#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_letter_of_authority oci_core_letter_of_authority}
*/
export class DataOciCoreLetterOfAuthority extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreLetterOfAuthority that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_letter_of_authority#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/core_letter_of_authority oci_core_letter_of_authority} Data Source
  *
  * @param scope The scope in which to define this construct
