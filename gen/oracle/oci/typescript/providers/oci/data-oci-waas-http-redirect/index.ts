// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/waas_http_redirect
...
export interface DataOciWaasHttpRedirectConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/waas_http_redirect#http_redirect_id DataOciWaasHttpRedirect#http_redirect_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/waas_http_redirect oci_waas_http_redirect}
*/
export class DataOciWaasHttpRedirect extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciWaasHttpRedirect that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/waas_http_redirect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/waas_http_redirect oci_waas_http_redirect} Data Source
  *
  * @param scope The scope in which to define this construct
