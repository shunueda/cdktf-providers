// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_security_recipe
...
export interface DataOciCloudGuardSecurityRecipeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_security_recipe#security_recipe_id DataOciCloudGuardSecurityRecipe#security_recipe_id}
  */
  readonly securityRecipeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_security_recipe oci_cloud_guard_security_recipe}
*/
export class DataOciCloudGuardSecurityRecipe extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCloudGuardSecurityRecipe that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_security_recipe#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/cloud_guard_security_recipe oci_cloud_guard_security_recipe} Data Source
  *
  * @param scope The scope in which to define this construct
