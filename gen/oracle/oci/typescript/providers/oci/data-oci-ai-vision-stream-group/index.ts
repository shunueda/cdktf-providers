// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_vision_stream_group
...
export interface DataOciAiVisionStreamGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_vision_stream_group#stream_group_id DataOciAiVisionStreamGroup#stream_group_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_vision_stream_group oci_ai_vision_stream_group}
*/
export class DataOciAiVisionStreamGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiVisionStreamGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_vision_stream_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/ai_vision_stream_group oci_ai_vision_stream_group} Data Source
  *
  * @param scope The scope in which to define this construct
