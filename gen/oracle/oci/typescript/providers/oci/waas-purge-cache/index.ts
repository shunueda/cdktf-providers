// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/waas_purge_cache
...
export interface WaasPurgeCacheConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/waas_purge_cache#id WaasPurgeCache#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/waas_purge_cache#resources WaasPurgeCache#resources}
  */
  readonly resources?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/waas_purge_cache#waas_policy_id WaasPurgeCache#waas_policy_id}
  */
  readonly waasPolicyId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/waas_purge_cache#timeouts WaasPurgeCache#timeouts}
  */
  readonly timeouts?: WaasPurgeCacheTimeouts;
}
export interface WaasPurgeCacheTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/waas_purge_cache#create WaasPurgeCache#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/waas_purge_cache#delete WaasPurgeCache#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/waas_purge_cache#update WaasPurgeCache#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/waas_purge_cache oci_waas_purge_cache}
*/
export class WaasPurgeCache extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WaasPurgeCache that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/waas_purge_cache#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/waas_purge_cache oci_waas_purge_cache} Resource
  *
  * @param scope The scope in which to define this construct
