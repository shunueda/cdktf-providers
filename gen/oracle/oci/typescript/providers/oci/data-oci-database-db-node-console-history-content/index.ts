// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_db_node_console_history_content
...
export interface DataOciDatabaseDbNodeConsoleHistoryContentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_db_node_console_history_content#console_history_id DataOciDatabaseDbNodeConsoleHistoryContent#console_history_id}
  */
  readonly consoleHistoryId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_db_node_console_history_content#db_node_id DataOciDatabaseDbNodeConsoleHistoryContent#db_node_id}
  */
  readonly dbNodeId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_db_node_console_history_content#id DataOciDatabaseDbNodeConsoleHistoryContent#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_db_node_console_history_content oci_database_db_node_console_history_content}
*/
export class DataOciDatabaseDbNodeConsoleHistoryContent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseDbNodeConsoleHistoryContent that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_db_node_console_history_content#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_db_node_console_history_content oci_database_db_node_console_history_content} Data Source
  *
  * @param scope The scope in which to define this construct
