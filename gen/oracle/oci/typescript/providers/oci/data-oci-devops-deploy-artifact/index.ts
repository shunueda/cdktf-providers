// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/devops_deploy_artifact
...
export interface DataOciDevopsDeployArtifactConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/devops_deploy_artifact#deploy_artifact_id DataOciDevopsDeployArtifact#deploy_artifact_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/devops_deploy_artifact oci_devops_deploy_artifact}
*/
export class DataOciDevopsDeployArtifact extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDevopsDeployArtifact that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/devops_deploy_artifact#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/devops_deploy_artifact oci_devops_deploy_artifact} Data Source
  *
  * @param scope The scope in which to define this construct
