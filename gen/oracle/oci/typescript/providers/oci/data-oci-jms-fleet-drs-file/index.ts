// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/jms_fleet_drs_file
...
export interface DataOciJmsFleetDrsFileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/jms_fleet_drs_file#drs_file_key DataOciJmsFleetDrsFile#drs_file_key}
  */
  readonly drsFileKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/jms_fleet_drs_file#fleet_id DataOciJmsFleetDrsFile#fleet_id}
  */
  readonly fleetId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/jms_fleet_drs_file#id DataOciJmsFleetDrsFile#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/jms_fleet_drs_file oci_jms_fleet_drs_file}
*/
export class DataOciJmsFleetDrsFile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciJmsFleetDrsFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/jms_fleet_drs_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/jms_fleet_drs_file oci_jms_fleet_drs_file} Data Source
  *
  * @param scope The scope in which to define this construct
