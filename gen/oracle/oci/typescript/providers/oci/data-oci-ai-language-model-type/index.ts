// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/ai_language_model_type
...
export interface DataOciAiLanguageModelTypeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/ai_language_model_type#id DataOciAiLanguageModelType#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/ai_language_model_type#model_type DataOciAiLanguageModelType#model_type}
  */
  readonly modelType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/ai_language_model_type oci_ai_language_model_type}
*/
export class DataOciAiLanguageModelType extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiLanguageModelType that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/ai_language_model_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/ai_language_model_type oci_ai_language_model_type} Data Source
  *
  * @param scope The scope in which to define this construct
