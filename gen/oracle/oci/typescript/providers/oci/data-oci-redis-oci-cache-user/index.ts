// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/redis_oci_cache_user
...
export interface DataOciRedisOciCacheUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/redis_oci_cache_user#oci_cache_user_id DataOciRedisOciCacheUser#oci_cache_user_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/redis_oci_cache_user oci_redis_oci_cache_user}
*/
export class DataOciRedisOciCacheUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciRedisOciCacheUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/redis_oci_cache_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/redis_oci_cache_user oci_redis_oci_cache_user} Data Source
  *
  * @param scope The scope in which to define this construct
