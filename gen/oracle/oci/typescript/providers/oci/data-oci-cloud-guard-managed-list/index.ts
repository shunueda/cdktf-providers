// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/cloud_guard_managed_list
...
export interface DataOciCloudGuardManagedListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/cloud_guard_managed_list#managed_list_id DataOciCloudGuardManagedList#managed_list_id}
  */
  readonly managedListId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/cloud_guard_managed_list oci_cloud_guard_managed_list}
*/
export class DataOciCloudGuardManagedList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCloudGuardManagedList that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/cloud_guard_managed_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/cloud_guard_managed_list oci_cloud_guard_managed_list} Data Source
  *
  * @param scope The scope in which to define this construct
