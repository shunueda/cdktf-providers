// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/tenantmanagercontrolplane_recipient_invitation
...
export interface DataOciTenantmanagercontrolplaneRecipientInvitationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/tenantmanagercontrolplane_recipient_invitation#id DataOciTenantmanagercontrolplaneRecipientInvitation#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/tenantmanagercontrolplane_recipient_invitation#recipient_invitation_id DataOciTenantmanagercontrolplaneRecipientInvitation#recipient_invitation_id}
  */
  readonly recipientInvitationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/tenantmanagercontrolplane_recipient_invitation oci_tenantmanagercontrolplane_recipient_invitation}
*/
export class DataOciTenantmanagercontrolplaneRecipientInvitation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciTenantmanagercontrolplaneRecipientInvitation that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/tenantmanagercontrolplane_recipient_invitation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/tenantmanagercontrolplane_recipient_invitation oci_tenantmanagercontrolplane_recipient_invitation} Data Source
  *
  * @param scope The scope in which to define this construct
