// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/dbmulticloud_oracle_db_azure_vault
...
export interface DataOciDbmulticloudOracleDbAzureVaultConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/dbmulticloud_oracle_db_azure_vault#oracle_db_azure_vault_id DataOciDbmulticloudOracleDbAzureVault#oracle_db_azure_vault_id}
  */
  readonly oracleDbAzureVaultId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/dbmulticloud_oracle_db_azure_vault oci_dbmulticloud_oracle_db_azure_vault}
*/
export class DataOciDbmulticloudOracleDbAzureVault extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDbmulticloudOracleDbAzureVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/dbmulticloud_oracle_db_azure_vault#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/dbmulticloud_oracle_db_azure_vault oci_dbmulticloud_oracle_db_azure_vault} Data Source
  *
  * @param scope The scope in which to define this construct
