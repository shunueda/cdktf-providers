// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/data_safe_attribute_set
...
export interface DataOciDataSafeAttributeSetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/data_safe_attribute_set#attribute_set_id DataOciDataSafeAttributeSet#attribute_set_id}
  */
  readonly attributeSetId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/data_safe_attribute_set oci_data_safe_attribute_set}
*/
export class DataOciDataSafeAttributeSet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeAttributeSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/data_safe_attribute_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/data_safe_attribute_set oci_data_safe_attribute_set} Data Source
  *
  * @param scope The scope in which to define this construct
