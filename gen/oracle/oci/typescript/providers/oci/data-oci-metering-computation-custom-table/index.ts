// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/metering_computation_custom_table
...
export interface DataOciMeteringComputationCustomTableConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/metering_computation_custom_table#custom_table_id DataOciMeteringComputationCustomTable#custom_table_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/metering_computation_custom_table oci_metering_computation_custom_table}
*/
export class DataOciMeteringComputationCustomTable extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciMeteringComputationCustomTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/metering_computation_custom_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/metering_computation_custom_table oci_metering_computation_custom_table} Data Source
  *
  * @param scope The scope in which to define this construct
