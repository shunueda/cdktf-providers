// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/containerengine_cluster_credential_rotation_status
...
export interface DataOciContainerengineClusterCredentialRotationStatusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/containerengine_cluster_credential_rotation_status#cluster_id DataOciContainerengineClusterCredentialRotationStatus#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/containerengine_cluster_credential_rotation_status#id DataOciContainerengineClusterCredentialRotationStatus#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/containerengine_cluster_credential_rotation_status oci_containerengine_cluster_credential_rotation_status}
*/
export class DataOciContainerengineClusterCredentialRotationStatus extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciContainerengineClusterCredentialRotationStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/containerengine_cluster_credential_rotation_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/containerengine_cluster_credential_rotation_status oci_containerengine_cluster_credential_rotation_status} Data Source
  *
  * @param scope The scope in which to define this construct
