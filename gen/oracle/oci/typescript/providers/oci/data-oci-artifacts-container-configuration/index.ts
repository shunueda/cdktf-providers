// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/artifacts_container_configuration
...
export interface DataOciArtifactsContainerConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/artifacts_container_configuration#compartment_id DataOciArtifactsContainerConfiguration#compartment_id}
  */
  readonly compartmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/artifacts_container_configuration oci_artifacts_container_configuration}
*/
export class DataOciArtifactsContainerConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciArtifactsContainerConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/artifacts_container_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/artifacts_container_configuration oci_artifacts_container_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
