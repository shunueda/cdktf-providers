// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/log_analytics_namespace_storage_enable_disable_archiving
...
export interface LogAnalyticsNamespaceStorageEnableDisableArchivingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/log_analytics_namespace_storage_enable_disable_archiving#enable_archiving_tenant LogAnalyticsNamespaceStorageEnableDisableArchiving#enable_archiving_tenant}
  */
  readonly enableArchivingTenant: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/log_analytics_namespace_storage_enable_disable_archiving#id LogAnalyticsNamespaceStorageEnableDisableArchiving#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/log_analytics_namespace_storage_enable_disable_archiving#namespace LogAnalyticsNamespaceStorageEnableDisableArchiving#namespace}
  */
  readonly namespace: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/log_analytics_namespace_storage_enable_disable_archiving#timeouts LogAnalyticsNamespaceStorageEnableDisableArchiving#timeouts}
  */
...
export interface LogAnalyticsNamespaceStorageEnableDisableArchivingTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/log_analytics_namespace_storage_enable_disable_archiving#create LogAnalyticsNamespaceStorageEnableDisableArchiving#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/log_analytics_namespace_storage_enable_disable_archiving#delete LogAnalyticsNamespaceStorageEnableDisableArchiving#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/log_analytics_namespace_storage_enable_disable_archiving#update LogAnalyticsNamespaceStorageEnableDisableArchiving#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/log_analytics_namespace_storage_enable_disable_archiving oci_log_analytics_namespace_storage_enable_disable_archiving}
*/
export class LogAnalyticsNamespaceStorageEnableDisableArchiving extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogAnalyticsNamespaceStorageEnableDisableArchiving that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/log_analytics_namespace_storage_enable_disable_archiving#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/log_analytics_namespace_storage_enable_disable_archiving oci_log_analytics_namespace_storage_enable_disable_archiving} Resource
  *
  * @param scope The scope in which to define this construct
