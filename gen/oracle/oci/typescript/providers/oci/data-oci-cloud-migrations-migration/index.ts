// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/cloud_migrations_migration
...
export interface DataOciCloudMigrationsMigrationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/cloud_migrations_migration#migration_id DataOciCloudMigrationsMigration#migration_id}
  */
  readonly migrationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/cloud_migrations_migration oci_cloud_migrations_migration}
*/
export class DataOciCloudMigrationsMigration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCloudMigrationsMigration that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/cloud_migrations_migration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/cloud_migrations_migration oci_cloud_migrations_migration} Data Source
  *
  * @param scope The scope in which to define this construct
