// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/resources/log_analytics_namespace_lookups_append_data_management
...
export interface LogAnalyticsNamespaceLookupsAppendDataManagementConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/resources/log_analytics_namespace_lookups_append_data_management#append_lookup_file LogAnalyticsNamespaceLookupsAppendDataManagement#append_lookup_file}
  */
  readonly appendLookupFile: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/resources/log_analytics_namespace_lookups_append_data_management#char_encoding LogAnalyticsNamespaceLookupsAppendDataManagement#char_encoding}
  */
  readonly charEncoding?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/resources/log_analytics_namespace_lookups_append_data_management#expect LogAnalyticsNamespaceLookupsAppendDataManagement#expect}
  */
  readonly expect?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/resources/log_analytics_namespace_lookups_append_data_management#id LogAnalyticsNamespaceLookupsAppendDataManagement#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/resources/log_analytics_namespace_lookups_append_data_management#is_force LogAnalyticsNamespaceLookupsAppendDataManagement#is_force}
  */
  readonly isForce?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/resources/log_analytics_namespace_lookups_append_data_management#lookup_name LogAnalyticsNamespaceLookupsAppendDataManagement#lookup_name}
  */
  readonly lookupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/resources/log_analytics_namespace_lookups_append_data_management#namespace LogAnalyticsNamespaceLookupsAppendDataManagement#namespace}
  */
  readonly namespace: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/resources/log_analytics_namespace_lookups_append_data_management#timeouts LogAnalyticsNamespaceLookupsAppendDataManagement#timeouts}
  */
...
export interface LogAnalyticsNamespaceLookupsAppendDataManagementTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/resources/log_analytics_namespace_lookups_append_data_management#create LogAnalyticsNamespaceLookupsAppendDataManagement#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/resources/log_analytics_namespace_lookups_append_data_management oci_log_analytics_namespace_lookups_append_data_management}
*/
export class LogAnalyticsNamespaceLookupsAppendDataManagement extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogAnalyticsNamespaceLookupsAppendDataManagement that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/resources/log_analytics_namespace_lookups_append_data_management#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/resources/log_analytics_namespace_lookups_append_data_management oci_log_analytics_namespace_lookups_append_data_management} Resource
  *
  * @param scope The scope in which to define this construct
