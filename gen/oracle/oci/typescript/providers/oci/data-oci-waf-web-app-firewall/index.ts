// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/waf_web_app_firewall
...
export interface DataOciWafWebAppFirewallConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/waf_web_app_firewall#web_app_firewall_id DataOciWafWebAppFirewall#web_app_firewall_id}
  */
  readonly webAppFirewallId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/waf_web_app_firewall oci_waf_web_app_firewall}
*/
export class DataOciWafWebAppFirewall extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciWafWebAppFirewall that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/waf_web_app_firewall#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/waf_web_app_firewall oci_waf_web_app_firewall} Data Source
  *
  * @param scope The scope in which to define this construct
