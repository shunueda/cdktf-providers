// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/psa_private_service_access
...
export interface DataOciPsaPrivateServiceAccessConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/psa_private_service_access#private_service_access_id DataOciPsaPrivateServiceAccess#private_service_access_id}
  */
  readonly privateServiceAccessId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/psa_private_service_access oci_psa_private_service_access}
*/
export class DataOciPsaPrivateServiceAccess extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciPsaPrivateServiceAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/psa_private_service_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/psa_private_service_access oci_psa_private_service_access} Data Source
  *
  * @param scope The scope in which to define this construct
