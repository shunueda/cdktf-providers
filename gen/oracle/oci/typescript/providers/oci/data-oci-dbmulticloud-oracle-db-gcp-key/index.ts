// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_gcp_key
...
export interface DataOciDbmulticloudOracleDbGcpKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_gcp_key#id DataOciDbmulticloudOracleDbGcpKey#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_gcp_key#oracle_db_gcp_key_id DataOciDbmulticloudOracleDbGcpKey#oracle_db_gcp_key_id}
  */
  readonly oracleDbGcpKeyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_gcp_key oci_dbmulticloud_oracle_db_gcp_key}
*/
export class DataOciDbmulticloudOracleDbGcpKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDbmulticloudOracleDbGcpKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_gcp_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_gcp_key oci_dbmulticloud_oracle_db_gcp_key} Data Source
  *
  * @param scope The scope in which to define this construct
