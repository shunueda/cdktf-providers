// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host
...
export interface OcvpEsxiHostConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#attach_datastore_cluster_ids OcvpEsxiHost#attach_datastore_cluster_ids}
  */
  readonly attachDatastoreClusterIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#billing_donor_host_id OcvpEsxiHost#billing_donor_host_id}
  */
  readonly billingDonorHostId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#capacity_reservation_id OcvpEsxiHost#capacity_reservation_id}
  */
  readonly capacityReservationId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#cluster_id OcvpEsxiHost#cluster_id}
  */
  readonly clusterId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#compute_availability_domain OcvpEsxiHost#compute_availability_domain}
  */
  readonly computeAvailabilityDomain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#current_sku OcvpEsxiHost#current_sku}
  */
  readonly currentSku?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#defined_tags OcvpEsxiHost#defined_tags}
  */
  readonly definedTags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#detach_datastore_cluster_ids OcvpEsxiHost#detach_datastore_cluster_ids}
  */
  readonly detachDatastoreClusterIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#display_name OcvpEsxiHost#display_name}
  */
  readonly displayName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#esxi_software_version OcvpEsxiHost#esxi_software_version}
  */
  readonly esxiSoftwareVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#failed_esxi_host_id OcvpEsxiHost#failed_esxi_host_id}
  */
  readonly failedEsxiHostId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#freeform_tags OcvpEsxiHost#freeform_tags}
  */
  readonly freeformTags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#host_ocpu_count OcvpEsxiHost#host_ocpu_count}
  */
  readonly hostOcpuCount?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#host_shape_name OcvpEsxiHost#host_shape_name}
  */
  readonly hostShapeName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#id OcvpEsxiHost#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#next_sku OcvpEsxiHost#next_sku}
  */
  readonly nextSku?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#non_upgraded_esxi_host_id OcvpEsxiHost#non_upgraded_esxi_host_id}
  */
  readonly nonUpgradedEsxiHostId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#sddc_id OcvpEsxiHost#sddc_id}
  */
  readonly sddcId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#system_tags OcvpEsxiHost#system_tags}
  */
  readonly systemTags?: { [key: string]: string };
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#timeouts OcvpEsxiHost#timeouts}
  */
  readonly timeouts?: OcvpEsxiHostTimeouts;
}
export interface OcvpEsxiHostDatastoreAttachments {
}

export function ocvpEsxiHostDatastoreAttachmentsToTerraform(struct?: OcvpEsxiHostDatastoreAttachments): any {
...
export function ocvpEsxiHostDatastoreAttachmentsToHclTerraform(struct?: OcvpEsxiHostDatastoreAttachments): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class OcvpEsxiHostDatastoreAttachmentsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OcvpEsxiHostDatastoreAttachments | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: OcvpEsxiHostDatastoreAttachments | undefined) {
    if (value === undefined) {
...
export class OcvpEsxiHostDatastoreAttachmentsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): OcvpEsxiHostDatastoreAttachmentsOutputReference {
    return new OcvpEsxiHostDatastoreAttachmentsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface OcvpEsxiHostTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#create OcvpEsxiHost#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host oci_ocvp_esxi_host}
*/
export class OcvpEsxiHost extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OcvpEsxiHost that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/ocvp_esxi_host oci_ocvp_esxi_host} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _datastoreAttachments = new OcvpEsxiHostDatastoreAttachmentsList(this, "datastore_attachments", false);
