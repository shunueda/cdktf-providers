// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_exadata_iorm_config
...
export interface DataOciDatabaseExadataIormConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_exadata_iorm_config#db_system_id DataOciDatabaseExadataIormConfig#db_system_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_exadata_iorm_config oci_database_exadata_iorm_config}
*/
export class DataOciDatabaseExadataIormConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseExadataIormConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_exadata_iorm_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/database_exadata_iorm_config oci_database_exadata_iorm_config} Data Source
  *
  * @param scope The scope in which to define this construct
