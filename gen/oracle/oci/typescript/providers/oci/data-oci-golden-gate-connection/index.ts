// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_connection
...
export interface DataOciGoldenGateConnectionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_connection#connection_id DataOciGoldenGateConnection#connection_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_connection oci_golden_gate_connection}
*/
export class DataOciGoldenGateConnection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciGoldenGateConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_connection oci_golden_gate_connection} Data Source
  *
  * @param scope The scope in which to define this construct
