// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/opsi_awr_hub
...
export interface DataOciOpsiAwrHubConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/opsi_awr_hub#awr_hub_id DataOciOpsiAwrHub#awr_hub_id}
  */
  readonly awrHubId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/opsi_awr_hub oci_opsi_awr_hub}
*/
export class DataOciOpsiAwrHub extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciOpsiAwrHub that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/opsi_awr_hub#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/opsi_awr_hub oci_opsi_awr_hub} Data Source
  *
  * @param scope The scope in which to define this construct
