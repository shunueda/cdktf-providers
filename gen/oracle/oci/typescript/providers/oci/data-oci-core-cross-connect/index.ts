// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_cross_connect
...
export interface DataOciCoreCrossConnectConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_cross_connect#cross_connect_id DataOciCoreCrossConnect#cross_connect_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_cross_connect oci_core_cross_connect}
*/
export class DataOciCoreCrossConnect extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreCrossConnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_cross_connect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_cross_connect oci_core_cross_connect} Data Source
  *
  * @param scope The scope in which to define this construct
