// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_document_processor_job
...
export interface DataOciAiDocumentProcessorJobConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_document_processor_job#processor_job_id DataOciAiDocumentProcessorJob#processor_job_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_document_processor_job oci_ai_document_processor_job}
*/
export class DataOciAiDocumentProcessorJob extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiDocumentProcessorJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_document_processor_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/ai_document_processor_job oci_ai_document_processor_job} Data Source
  *
  * @param scope The scope in which to define this construct
