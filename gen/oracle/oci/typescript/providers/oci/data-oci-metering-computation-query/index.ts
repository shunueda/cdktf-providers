// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/metering_computation_query
...
export interface DataOciMeteringComputationQueryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/metering_computation_query#query_id DataOciMeteringComputationQuery#query_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/metering_computation_query oci_metering_computation_query}
*/
export class DataOciMeteringComputationQuery extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciMeteringComputationQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/metering_computation_query#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/metering_computation_query oci_metering_computation_query} Data Source
  *
  * @param scope The scope in which to define this construct
