// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_aws_identity_connector
...
export interface DataOciDbmulticloudOracleDbAwsIdentityConnectorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_aws_identity_connector#oracle_db_aws_identity_connector_id DataOciDbmulticloudOracleDbAwsIdentityConnector#oracle_db_aws_identity_connector_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_aws_identity_connector oci_dbmulticloud_oracle_db_aws_identity_connector}
*/
export class DataOciDbmulticloudOracleDbAwsIdentityConnector extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDbmulticloudOracleDbAwsIdentityConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_aws_identity_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_oracle_db_aws_identity_connector oci_dbmulticloud_oracle_db_aws_identity_connector} Data Source
  *
  * @param scope The scope in which to define this construct
