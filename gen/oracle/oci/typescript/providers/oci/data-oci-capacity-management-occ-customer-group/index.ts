// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_occ_customer_group
...
export interface DataOciCapacityManagementOccCustomerGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_occ_customer_group#occ_customer_group_id DataOciCapacityManagementOccCustomerGroup#occ_customer_group_id}
  */
...
export function dataOciCapacityManagementOccCustomerGroupCustomersListStructToHclTerraform(struct?: DataOciCapacityManagementOccCustomerGroupCustomersListStruct): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_occ_customer_group oci_capacity_management_occ_customer_group}
*/
export class DataOciCapacityManagementOccCustomerGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCapacityManagementOccCustomerGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_occ_customer_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/capacity_management_occ_customer_group oci_capacity_management_occ_customer_group} Data Source
  *
  * @param scope The scope in which to define this construct
