// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/optimizer_enrollment_status
...
export interface OptimizerEnrollmentStatusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/optimizer_enrollment_status#enrollment_status_id OptimizerEnrollmentStatus#enrollment_status_id}
  */
  readonly enrollmentStatusId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/optimizer_enrollment_status#id OptimizerEnrollmentStatus#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/optimizer_enrollment_status#status OptimizerEnrollmentStatus#status}
  */
  readonly status: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/optimizer_enrollment_status#timeouts OptimizerEnrollmentStatus#timeouts}
  */
  readonly timeouts?: OptimizerEnrollmentStatusTimeouts;
}
export interface OptimizerEnrollmentStatusTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/optimizer_enrollment_status#create OptimizerEnrollmentStatus#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/optimizer_enrollment_status#delete OptimizerEnrollmentStatus#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/optimizer_enrollment_status#update OptimizerEnrollmentStatus#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/optimizer_enrollment_status oci_optimizer_enrollment_status}
*/
export class OptimizerEnrollmentStatus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OptimizerEnrollmentStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/optimizer_enrollment_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/resources/optimizer_enrollment_status oci_optimizer_enrollment_status} Resource
  *
  * @param scope The scope in which to define this construct
