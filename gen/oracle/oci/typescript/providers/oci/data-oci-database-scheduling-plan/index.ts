// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduling_plan
...
export interface DataOciDatabaseSchedulingPlanConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduling_plan#scheduling_plan_id DataOciDatabaseSchedulingPlan#scheduling_plan_id}
  */
  readonly schedulingPlanId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduling_plan oci_database_scheduling_plan}
*/
export class DataOciDatabaseSchedulingPlan extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseSchedulingPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduling_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/database_scheduling_plan oci_database_scheduling_plan} Data Source
  *
  * @param scope The scope in which to define this construct
