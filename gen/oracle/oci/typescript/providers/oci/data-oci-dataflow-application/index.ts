// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dataflow_application
...
export interface DataOciDataflowApplicationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dataflow_application#application_id DataOciDataflowApplication#application_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dataflow_application oci_dataflow_application}
*/
export class DataOciDataflowApplication extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataflowApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dataflow_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dataflow_application oci_dataflow_application} Data Source
  *
  * @param scope The scope in which to define this construct
