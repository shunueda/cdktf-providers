// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_pipeline
...
export interface DataOciGoldenGatePipelineConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_pipeline#pipeline_id DataOciGoldenGatePipeline#pipeline_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_pipeline oci_golden_gate_pipeline}
*/
export class DataOciGoldenGatePipeline extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciGoldenGatePipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/golden_gate_pipeline oci_golden_gate_pipeline} Data Source
  *
  * @param scope The scope in which to define this construct
