// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/network_firewall_network_firewall_policy
...
export interface DataOciNetworkFirewallNetworkFirewallPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/network_firewall_network_firewall_policy#network_firewall_policy_id DataOciNetworkFirewallNetworkFirewallPolicy#network_firewall_policy_id}
  */
  readonly networkFirewallPolicyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/network_firewall_network_firewall_policy oci_network_firewall_network_firewall_policy}
*/
export class DataOciNetworkFirewallNetworkFirewallPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciNetworkFirewallNetworkFirewallPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/network_firewall_network_firewall_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/network_firewall_network_firewall_policy oci_network_firewall_network_firewall_policy} Data Source
  *
  * @param scope The scope in which to define this construct
