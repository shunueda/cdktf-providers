// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dataflow_invoke_run
...
export interface DataOciDataflowInvokeRunConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dataflow_invoke_run#run_id DataOciDataflowInvokeRun#run_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dataflow_invoke_run oci_dataflow_invoke_run}
*/
export class DataOciDataflowInvokeRun extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataflowInvokeRun that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dataflow_invoke_run#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dataflow_invoke_run oci_dataflow_invoke_run} Data Source
  *
  * @param scope The scope in which to define this construct
