// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_block_volume_replica
...
export interface DataOciCoreBlockVolumeReplicaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_block_volume_replica#block_volume_replica_id DataOciCoreBlockVolumeReplica#block_volume_replica_id}
  */
  readonly blockVolumeReplicaId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_block_volume_replica#id DataOciCoreBlockVolumeReplica#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_block_volume_replica oci_core_block_volume_replica}
*/
export class DataOciCoreBlockVolumeReplica extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreBlockVolumeReplica that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_block_volume_replica#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_block_volume_replica oci_core_block_volume_replica} Data Source
  *
  * @param scope The scope in which to define this construct
