// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/adm_remediation_recipe
...
export interface DataOciAdmRemediationRecipeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/adm_remediation_recipe#remediation_recipe_id DataOciAdmRemediationRecipe#remediation_recipe_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/adm_remediation_recipe oci_adm_remediation_recipe}
*/
export class DataOciAdmRemediationRecipe extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAdmRemediationRecipe that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/adm_remediation_recipe#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/adm_remediation_recipe oci_adm_remediation_recipe} Data Source
  *
  * @param scope The scope in which to define this construct
