// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/data_safe_target_database_group_group_member
...
export interface DataOciDataSafeTargetDatabaseGroupGroupMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/data_safe_target_database_group_group_member#id DataOciDataSafeTargetDatabaseGroupGroupMember#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/data_safe_target_database_group_group_member#target_database_group_id DataOciDataSafeTargetDatabaseGroupGroupMember#target_database_group_id}
  */
  readonly targetDatabaseGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/data_safe_target_database_group_group_member#target_database_id DataOciDataSafeTargetDatabaseGroupGroupMember#target_database_id}
  */
  readonly targetDatabaseId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/data_safe_target_database_group_group_member oci_data_safe_target_database_group_group_member}
*/
export class DataOciDataSafeTargetDatabaseGroupGroupMember extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeTargetDatabaseGroupGroupMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/data_safe_target_database_group_group_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/data_safe_target_database_group_group_member oci_data_safe_target_database_group_group_member} Data Source
  *
  * @param scope The scope in which to define this construct
