// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/iot_digital_twin_relationship
...
export interface DataOciIotDigitalTwinRelationshipConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/iot_digital_twin_relationship#digital_twin_relationship_id DataOciIotDigitalTwinRelationship#digital_twin_relationship_id}
  */
  readonly digitalTwinRelationshipId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/iot_digital_twin_relationship oci_iot_digital_twin_relationship}
*/
export class DataOciIotDigitalTwinRelationship extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciIotDigitalTwinRelationship that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/iot_digital_twin_relationship#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/iot_digital_twin_relationship oci_iot_digital_twin_relationship} Data Source
  *
  * @param scope The scope in which to define this construct
