// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_fleet_agent_configuration
...
export interface DataOciJmsFleetAgentConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_fleet_agent_configuration#fleet_id DataOciJmsFleetAgentConfiguration#fleet_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_fleet_agent_configuration oci_jms_fleet_agent_configuration}
*/
export class DataOciJmsFleetAgentConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciJmsFleetAgentConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_fleet_agent_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/jms_fleet_agent_configuration oci_jms_fleet_agent_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
