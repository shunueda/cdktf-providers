// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/data_safe_discovery_job
...
export interface DataOciDataSafeDiscoveryJobConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/data_safe_discovery_job#discovery_job_id DataOciDataSafeDiscoveryJob#discovery_job_id}
  */
  readonly discoveryJobId: string;
}
export interface DataOciDataSafeDiscoveryJobTablesForDiscovery {
}

export function dataOciDataSafeDiscoveryJobTablesForDiscoveryToTerraform(struct?: DataOciDataSafeDiscoveryJobTablesForDiscovery): any {
...
export function dataOciDataSafeDiscoveryJobTablesForDiscoveryToHclTerraform(struct?: DataOciDataSafeDiscoveryJobTablesForDiscovery): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOciDataSafeDiscoveryJobTablesForDiscoveryOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataOciDataSafeDiscoveryJobTablesForDiscovery | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataOciDataSafeDiscoveryJobTablesForDiscovery | undefined) {
    if (value === undefined) {
...
export class DataOciDataSafeDiscoveryJobTablesForDiscoveryList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataOciDataSafeDiscoveryJobTablesForDiscoveryOutputReference {
    return new DataOciDataSafeDiscoveryJobTablesForDiscoveryOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/data_safe_discovery_job oci_data_safe_discovery_job}
*/
export class DataOciDataSafeDiscoveryJob extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeDiscoveryJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/data_safe_discovery_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/data_safe_discovery_job oci_data_safe_discovery_job} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _tablesForDiscovery = new DataOciDataSafeDiscoveryJobTablesForDiscoveryList(this, "tables_for_discovery", false);
