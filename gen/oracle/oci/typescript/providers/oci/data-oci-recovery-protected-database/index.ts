// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/recovery_protected_database
...
export interface DataOciRecoveryProtectedDatabaseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/recovery_protected_database#protected_database_id DataOciRecoveryProtectedDatabase#protected_database_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/recovery_protected_database oci_recovery_protected_database}
*/
export class DataOciRecoveryProtectedDatabase extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciRecoveryProtectedDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/recovery_protected_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/recovery_protected_database oci_recovery_protected_database} Data Source
  *
  * @param scope The scope in which to define this construct
