// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_compute_gpu_memory_cluster
...
export interface DataOciCoreComputeGpuMemoryClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_compute_gpu_memory_cluster#compute_gpu_memory_cluster_id DataOciCoreComputeGpuMemoryCluster#compute_gpu_memory_cluster_id}
  */
  readonly computeGpuMemoryClusterId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_compute_gpu_memory_cluster oci_core_compute_gpu_memory_cluster}
*/
export class DataOciCoreComputeGpuMemoryCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreComputeGpuMemoryCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_compute_gpu_memory_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/core_compute_gpu_memory_cluster oci_core_compute_gpu_memory_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
