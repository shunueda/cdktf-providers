// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/datascience_model_group_artifact
...
export interface DatascienceModelGroupArtifactConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/datascience_model_group_artifact#content_disposition DatascienceModelGroupArtifact#content_disposition}
  */
  readonly contentDisposition?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/datascience_model_group_artifact#content_length DatascienceModelGroupArtifact#content_length}
  */
  readonly contentLength: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/datascience_model_group_artifact#id DatascienceModelGroupArtifact#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/datascience_model_group_artifact#model_group_artifact DatascienceModelGroupArtifact#model_group_artifact}
  */
  readonly modelGroupArtifact: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/datascience_model_group_artifact#model_group_id DatascienceModelGroupArtifact#model_group_id}
  */
  readonly modelGroupId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/datascience_model_group_artifact#timeouts DatascienceModelGroupArtifact#timeouts}
  */
  readonly timeouts?: DatascienceModelGroupArtifactTimeouts;
}
export interface DatascienceModelGroupArtifactTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/datascience_model_group_artifact#create DatascienceModelGroupArtifact#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/datascience_model_group_artifact#delete DatascienceModelGroupArtifact#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/datascience_model_group_artifact#update DatascienceModelGroupArtifact#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/datascience_model_group_artifact oci_datascience_model_group_artifact}
*/
export class DatascienceModelGroupArtifact extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatascienceModelGroupArtifact that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/datascience_model_group_artifact#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/resources/datascience_model_group_artifact oci_datascience_model_group_artifact} Resource
  *
  * @param scope The scope in which to define this construct
