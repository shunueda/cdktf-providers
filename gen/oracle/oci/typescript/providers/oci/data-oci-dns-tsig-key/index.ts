// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dns_tsig_key
...
export interface DataOciDnsTsigKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dns_tsig_key#tsig_key_id DataOciDnsTsigKey#tsig_key_id}
  */
  readonly tsigKeyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dns_tsig_key oci_dns_tsig_key}
*/
export class DataOciDnsTsigKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDnsTsigKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dns_tsig_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/dns_tsig_key oci_dns_tsig_key} Data Source
  *
  * @param scope The scope in which to define this construct
