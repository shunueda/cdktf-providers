// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/cloud_guard_saved_query
...
export interface DataOciCloudGuardSavedQueryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/cloud_guard_saved_query#saved_query_id DataOciCloudGuardSavedQuery#saved_query_id}
  */
  readonly savedQueryId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/cloud_guard_saved_query oci_cloud_guard_saved_query}
*/
export class DataOciCloudGuardSavedQuery extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCloudGuardSavedQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/cloud_guard_saved_query#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/cloud_guard_saved_query oci_cloud_guard_saved_query} Data Source
  *
  * @param scope The scope in which to define this construct
