// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/bds_bds_instance_node_backup
...
export interface DataOciBdsBdsInstanceNodeBackupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/bds_bds_instance_node_backup#bds_instance_id DataOciBdsBdsInstanceNodeBackup#bds_instance_id}
  */
  readonly bdsInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/bds_bds_instance_node_backup#id DataOciBdsBdsInstanceNodeBackup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/bds_bds_instance_node_backup#node_backup_id DataOciBdsBdsInstanceNodeBackup#node_backup_id}
  */
  readonly nodeBackupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/bds_bds_instance_node_backup oci_bds_bds_instance_node_backup}
*/
export class DataOciBdsBdsInstanceNodeBackup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciBdsBdsInstanceNodeBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/bds_bds_instance_node_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/bds_bds_instance_node_backup oci_bds_bds_instance_node_backup} Data Source
  *
  * @param scope The scope in which to define this construct
