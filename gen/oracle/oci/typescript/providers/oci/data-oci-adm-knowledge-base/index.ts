// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/adm_knowledge_base
...
export interface DataOciAdmKnowledgeBaseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/adm_knowledge_base#knowledge_base_id DataOciAdmKnowledgeBase#knowledge_base_id}
  */
  readonly knowledgeBaseId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/adm_knowledge_base oci_adm_knowledge_base}
*/
export class DataOciAdmKnowledgeBase extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAdmKnowledgeBase that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/adm_knowledge_base#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/adm_knowledge_base oci_adm_knowledge_base} Data Source
  *
  * @param scope The scope in which to define this construct
