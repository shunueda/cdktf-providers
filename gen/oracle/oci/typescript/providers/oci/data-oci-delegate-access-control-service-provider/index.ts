// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/delegate_access_control_service_provider
...
export interface DataOciDelegateAccessControlServiceProviderConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/delegate_access_control_service_provider#id DataOciDelegateAccessControlServiceProvider#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/delegate_access_control_service_provider#service_provider_id DataOciDelegateAccessControlServiceProvider#service_provider_id}
  */
  readonly serviceProviderId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/delegate_access_control_service_provider oci_delegate_access_control_service_provider}
*/
export class DataOciDelegateAccessControlServiceProvider extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDelegateAccessControlServiceProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/delegate_access_control_service_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/delegate_access_control_service_provider oci_delegate_access_control_service_provider} Data Source
  *
  * @param scope The scope in which to define this construct
