// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/datascience_model_group_version_history
...
export interface DataOciDatascienceModelGroupVersionHistoryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/datascience_model_group_version_history#model_group_version_history_id DataOciDatascienceModelGroupVersionHistory#model_group_version_history_id}
  */
  readonly modelGroupVersionHistoryId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/datascience_model_group_version_history oci_datascience_model_group_version_history}
*/
export class DataOciDatascienceModelGroupVersionHistory extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatascienceModelGroupVersionHistory that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/datascience_model_group_version_history#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/datascience_model_group_version_history oci_datascience_model_group_version_history} Data Source
  *
  * @param scope The scope in which to define this construct
