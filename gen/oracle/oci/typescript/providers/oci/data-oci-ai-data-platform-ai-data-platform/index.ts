// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/ai_data_platform_ai_data_platform
...
export interface DataOciAiDataPlatformAiDataPlatformConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/ai_data_platform_ai_data_platform#ai_data_platform_id DataOciAiDataPlatformAiDataPlatform#ai_data_platform_id}
  */
  readonly aiDataPlatformId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/ai_data_platform_ai_data_platform oci_ai_data_platform_ai_data_platform}
*/
export class DataOciAiDataPlatformAiDataPlatform extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiDataPlatformAiDataPlatform that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/ai_data_platform_ai_data_platform#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/ai_data_platform_ai_data_platform oci_ai_data_platform_ai_data_platform} Data Source
  *
  * @param scope The scope in which to define this construct
