// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/wlms_managed_instance_server
...
export interface DataOciWlmsManagedInstanceServerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/wlms_managed_instance_server#id DataOciWlmsManagedInstanceServer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/wlms_managed_instance_server#managed_instance_id DataOciWlmsManagedInstanceServer#managed_instance_id}
  */
  readonly managedInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/wlms_managed_instance_server#server_id DataOciWlmsManagedInstanceServer#server_id}
  */
  readonly serverId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/wlms_managed_instance_server oci_wlms_managed_instance_server}
*/
export class DataOciWlmsManagedInstanceServer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciWlmsManagedInstanceServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/wlms_managed_instance_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/wlms_managed_instance_server oci_wlms_managed_instance_server} Data Source
  *
  * @param scope The scope in which to define this construct
