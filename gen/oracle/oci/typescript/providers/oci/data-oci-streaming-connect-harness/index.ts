// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/streaming_connect_harness
...
export interface DataOciStreamingConnectHarnessConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/streaming_connect_harness#connect_harness_id DataOciStreamingConnectHarness#connect_harness_id}
  */
  readonly connectHarnessId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/streaming_connect_harness oci_streaming_connect_harness}
*/
export class DataOciStreamingConnectHarness extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciStreamingConnectHarness that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/streaming_connect_harness#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/streaming_connect_harness oci_streaming_connect_harness} Data Source
  *
  * @param scope The scope in which to define this construct
