// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/identity_user
...
export interface DataOciIdentityUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/identity_user#user_id DataOciIdentityUser#user_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/identity_user oci_identity_user}
*/
export class DataOciIdentityUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciIdentityUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/identity_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/identity_user oci_identity_user} Data Source
  *
  * @param scope The scope in which to define this construct
