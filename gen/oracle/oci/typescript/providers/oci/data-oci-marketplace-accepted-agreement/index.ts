// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/marketplace_accepted_agreement
...
export interface DataOciMarketplaceAcceptedAgreementConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/marketplace_accepted_agreement#accepted_agreement_id DataOciMarketplaceAcceptedAgreement#accepted_agreement_id}
  */
  readonly acceptedAgreementId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/marketplace_accepted_agreement oci_marketplace_accepted_agreement}
*/
export class DataOciMarketplaceAcceptedAgreement extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciMarketplaceAcceptedAgreement that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/marketplace_accepted_agreement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/marketplace_accepted_agreement oci_marketplace_accepted_agreement} Data Source
  *
  * @param scope The scope in which to define this construct
