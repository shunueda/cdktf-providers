// https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/fleet_apps_management_compliance_policy
...
export interface DataOciFleetAppsManagementCompliancePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/fleet_apps_management_compliance_policy#compliance_policy_id DataOciFleetAppsManagementCompliancePolicy#compliance_policy_id}
  */
  readonly compliancePolicyId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/fleet_apps_management_compliance_policy#id DataOciFleetAppsManagementCompliancePolicy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/fleet_apps_management_compliance_policy oci_fleet_apps_management_compliance_policy}
*/
export class DataOciFleetAppsManagementCompliancePolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciFleetAppsManagementCompliancePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/fleet_apps_management_compliance_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.25.0/docs/data-sources/fleet_apps_management_compliance_policy oci_fleet_apps_management_compliance_policy} Data Source
  *
  * @param scope The scope in which to define this construct
