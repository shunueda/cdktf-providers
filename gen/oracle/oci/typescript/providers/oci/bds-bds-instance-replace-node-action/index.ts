// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/resources/bds_bds_instance_replace_node_action
...
export interface BdsBdsInstanceReplaceNodeActionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/resources/bds_bds_instance_replace_node_action#bds_instance_id BdsBdsInstanceReplaceNodeAction#bds_instance_id}
  */
  readonly bdsInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/resources/bds_bds_instance_replace_node_action#cluster_admin_password BdsBdsInstanceReplaceNodeAction#cluster_admin_password}
  */
  readonly clusterAdminPassword: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/resources/bds_bds_instance_replace_node_action#id BdsBdsInstanceReplaceNodeAction#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/resources/bds_bds_instance_replace_node_action#node_backup_id BdsBdsInstanceReplaceNodeAction#node_backup_id}
  */
  readonly nodeBackupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/resources/bds_bds_instance_replace_node_action#node_host_name BdsBdsInstanceReplaceNodeAction#node_host_name}
  */
  readonly nodeHostName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/resources/bds_bds_instance_replace_node_action#shape BdsBdsInstanceReplaceNodeAction#shape}
  */
  readonly shape?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/resources/bds_bds_instance_replace_node_action#timeouts BdsBdsInstanceReplaceNodeAction#timeouts}
  */
  readonly timeouts?: BdsBdsInstanceReplaceNodeActionTimeouts;
}
export interface BdsBdsInstanceReplaceNodeActionTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/resources/bds_bds_instance_replace_node_action#create BdsBdsInstanceReplaceNodeAction#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/resources/bds_bds_instance_replace_node_action oci_bds_bds_instance_replace_node_action}
*/
export class BdsBdsInstanceReplaceNodeAction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BdsBdsInstanceReplaceNodeAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/resources/bds_bds_instance_replace_node_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/resources/bds_bds_instance_replace_node_action oci_bds_bds_instance_replace_node_action} Resource
  *
  * @param scope The scope in which to define this construct
