// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/cloud_bridge_agent
...
export interface DataOciCloudBridgeAgentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/cloud_bridge_agent#agent_id DataOciCloudBridgeAgent#agent_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/cloud_bridge_agent oci_cloud_bridge_agent}
*/
export class DataOciCloudBridgeAgent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCloudBridgeAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/cloud_bridge_agent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/cloud_bridge_agent oci_cloud_bridge_agent} Data Source
  *
  * @param scope The scope in which to define this construct
