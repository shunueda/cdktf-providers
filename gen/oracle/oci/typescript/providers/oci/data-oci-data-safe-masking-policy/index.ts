// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_masking_policy
...
export interface DataOciDataSafeMaskingPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_masking_policy#masking_policy_id DataOciDataSafeMaskingPolicy#masking_policy_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_masking_policy oci_data_safe_masking_policy}
*/
export class DataOciDataSafeMaskingPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeMaskingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_masking_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_masking_policy oci_data_safe_masking_policy} Data Source
  *
  * @param scope The scope in which to define this construct
