// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_application_vip
...
export interface DataOciDatabaseApplicationVipConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_application_vip#application_vip_id DataOciDatabaseApplicationVip#application_vip_id}
  */
  readonly applicationVipId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_application_vip oci_database_application_vip}
*/
export class DataOciDatabaseApplicationVip extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseApplicationVip that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_application_vip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/database_application_vip oci_database_application_vip} Data Source
  *
  * @param scope The scope in which to define this construct
