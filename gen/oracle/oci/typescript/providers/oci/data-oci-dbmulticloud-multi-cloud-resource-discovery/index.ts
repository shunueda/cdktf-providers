// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_multi_cloud_resource_discovery
...
export interface DataOciDbmulticloudMultiCloudResourceDiscoveryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_multi_cloud_resource_discovery#multi_cloud_resource_discovery_id DataOciDbmulticloudMultiCloudResourceDiscovery#multi_cloud_resource_discovery_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_multi_cloud_resource_discovery oci_dbmulticloud_multi_cloud_resource_discovery}
*/
export class DataOciDbmulticloudMultiCloudResourceDiscovery extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDbmulticloudMultiCloudResourceDiscovery that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_multi_cloud_resource_discovery#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/dbmulticloud_multi_cloud_resource_discovery oci_dbmulticloud_multi_cloud_resource_discovery} Data Source
  *
  * @param scope The scope in which to define this construct
