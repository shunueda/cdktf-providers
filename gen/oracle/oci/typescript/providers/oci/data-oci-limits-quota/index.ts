// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/limits_quota
...
export interface DataOciLimitsQuotaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/limits_quota#quota_id DataOciLimitsQuota#quota_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/limits_quota oci_limits_quota}
*/
export class DataOciLimitsQuota extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciLimitsQuota that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/limits_quota#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/limits_quota oci_limits_quota} Data Source
  *
  * @param scope The scope in which to define this construct
