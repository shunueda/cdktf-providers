// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/mysql_channel
...
export interface DataOciMysqlChannelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/mysql_channel#channel_id DataOciMysqlChannel#channel_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/mysql_channel oci_mysql_channel}
*/
export class DataOciMysqlChannel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciMysqlChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/mysql_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/mysql_channel oci_mysql_channel} Data Source
  *
  * @param scope The scope in which to define this construct
