// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_compute_host_group
...
export interface DataOciCoreComputeHostGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_compute_host_group#compute_host_group_id DataOciCoreComputeHostGroup#compute_host_group_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_compute_host_group oci_core_compute_host_group}
*/
export class DataOciCoreComputeHostGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreComputeHostGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_compute_host_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/core_compute_host_group oci_core_compute_host_group} Data Source
  *
  * @param scope The scope in which to define this construct
