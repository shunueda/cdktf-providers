// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/kms_ekms_private_endpoint
...
export interface DataOciKmsEkmsPrivateEndpointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/kms_ekms_private_endpoint#ekms_private_endpoint_id DataOciKmsEkmsPrivateEndpoint#ekms_private_endpoint_id}
  */
  readonly ekmsPrivateEndpointId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/kms_ekms_private_endpoint oci_kms_ekms_private_endpoint}
*/
export class DataOciKmsEkmsPrivateEndpoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciKmsEkmsPrivateEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/kms_ekms_private_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/kms_ekms_private_endpoint oci_kms_ekms_private_endpoint} Data Source
  *
  * @param scope The scope in which to define this construct
