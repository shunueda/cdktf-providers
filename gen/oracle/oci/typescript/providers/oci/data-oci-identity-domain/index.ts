// https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/identity_domain
...
export interface DataOciIdentityDomainConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/identity_domain#domain_id DataOciIdentityDomain#domain_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/identity_domain oci_identity_domain}
*/
export class DataOciIdentityDomain extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciIdentityDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/identity_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.26.1/docs/data-sources/identity_domain oci_identity_domain} Data Source
  *
  * @param scope The scope in which to define this construct
