// https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_audit_archive_retrieval
...
export interface DataOciDataSafeAuditArchiveRetrievalConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_audit_archive_retrieval#audit_archive_retrieval_id DataOciDataSafeAuditArchiveRetrieval#audit_archive_retrieval_id}
  */
  readonly auditArchiveRetrievalId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_audit_archive_retrieval oci_data_safe_audit_archive_retrieval}
*/
export class DataOciDataSafeAuditArchiveRetrieval extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeAuditArchiveRetrieval that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_audit_archive_retrieval#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.28.0/docs/data-sources/data_safe_audit_archive_retrieval oci_data_safe_audit_archive_retrieval} Data Source
  *
  * @param scope The scope in which to define this construct
