// https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apigateway_gateways
...
export interface DataOciApigatewayGatewaysConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apigateway_gateways#certificate_id DataOciApigatewayGateways#certificate_id}
  */
  readonly certificateId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apigateway_gateways#compartment_id DataOciApigatewayGateways#compartment_id}
  */
  readonly compartmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apigateway_gateways#display_name DataOciApigatewayGateways#display_name}
  */
  readonly displayName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apigateway_gateways#id DataOciApigatewayGateways#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apigateway_gateways#state DataOciApigatewayGateways#state}
  */
  readonly state?: string;
  /**
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apigateway_gateways#filter DataOciApigatewayGateways#filter}
  */
...
export interface DataOciApigatewayGatewaysGatewayCollectionIpv4AddressConfiguration {
}

export function dataOciApigatewayGatewaysGatewayCollectionIpv4AddressConfigurationToTerraform(struct?: DataOciApigatewayGatewaysGatewayCollectionIpv4AddressConfiguration): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataOciApigatewayGatewaysGatewayCollectionIpv4AddressConfigurationToHclTerraform(struct?: DataOciApigatewayGatewaysGatewayCollectionIpv4AddressConfiguration): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOciApigatewayGatewaysGatewayCollectionIpv4AddressConfigurationOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataOciApigatewayGatewaysGatewayCollectionIpv4AddressConfiguration | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataOciApigatewayGatewaysGatewayCollectionIpv4AddressConfiguration | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataOciApigatewayGatewaysGatewayCollectionIpv4AddressConfigurationList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataOciApigatewayGatewaysGatewayCollectionIpv4AddressConfigurationOutputReference {
    return new DataOciApigatewayGatewaysGatewayCollectionIpv4AddressConfigurationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataOciApigatewayGatewaysGatewayCollectionIpv6AddressConfiguration {
}

export function dataOciApigatewayGatewaysGatewayCollectionIpv6AddressConfigurationToTerraform(struct?: DataOciApigatewayGatewaysGatewayCollectionIpv6AddressConfiguration): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataOciApigatewayGatewaysGatewayCollectionIpv6AddressConfigurationToHclTerraform(struct?: DataOciApigatewayGatewaysGatewayCollectionIpv6AddressConfiguration): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOciApigatewayGatewaysGatewayCollectionIpv6AddressConfigurationOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataOciApigatewayGatewaysGatewayCollectionIpv6AddressConfiguration | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataOciApigatewayGatewaysGatewayCollectionIpv6AddressConfiguration | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataOciApigatewayGatewaysGatewayCollectionIpv6AddressConfigurationList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataOciApigatewayGatewaysGatewayCollectionIpv6AddressConfigurationOutputReference {
    return new DataOciApigatewayGatewaysGatewayCollectionIpv6AddressConfigurationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataOciApigatewayGatewaysGatewayCollectionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _ipv4AddressConfiguration = new DataOciApigatewayGatewaysGatewayCollectionIpv4AddressConfigurationList(this, "ipv4address_configuration", false);
  ...
  private _ipv6AddressConfiguration = new DataOciApigatewayGatewaysGatewayCollectionIpv6AddressConfigurationList(this, "ipv6address_configuration", false);
...
export interface DataOciApigatewayGatewaysFilter {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apigateway_gateways#name DataOciApigatewayGateways#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apigateway_gateways#regex DataOciApigatewayGateways#regex}
  */
  readonly regex?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apigateway_gateways#values DataOciApigatewayGateways#values}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apigateway_gateways oci_apigateway_gateways}
*/
export class DataOciApigatewayGateways extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciApigatewayGateways that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apigateway_gateways#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.27.0/docs/data-sources/apigateway_gateways oci_apigateway_gateways} Data Source
  *
  * @param scope The scope in which to define this construct
