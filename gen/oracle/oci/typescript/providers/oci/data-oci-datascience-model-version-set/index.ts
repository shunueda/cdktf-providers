// https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/datascience_model_version_set
...
export interface DataOciDatascienceModelVersionSetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/datascience_model_version_set#model_version_set_id DataOciDatascienceModelVersionSet#model_version_set_id}
  */
  readonly modelVersionSetId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/datascience_model_version_set oci_datascience_model_version_set}
*/
export class DataOciDatascienceModelVersionSet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatascienceModelVersionSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/datascience_model_version_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.29.0/docs/data-sources/datascience_model_version_set oci_datascience_model_version_set} Data Source
  *
  * @param scope The scope in which to define this construct
