...
export interface ImportPeriodicClassListConvertConfig extends cdktf.TerraformMetaArguments {
  /**
  * Class List File
  *
...
export class ImportPeriodicClassListConvert extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_import_periodic_class_list_convert";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_import_periodic_class_list_convert", importId: importFromId, provider });
      }
  ...
  * @param options ImportPeriodicClassListConvertConfig
  */
  public constructor(scope: Construct, id: string, config: ImportPeriodicClassListConvertConfig) {
    super(scope, id, {
  ...
  // class_list_convert - computed: false, optional: false, required: true
