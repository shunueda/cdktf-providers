// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_icmp_type
...
export interface FlowspecIcmpTypeConfig extends cdktf.TerraformMetaArguments {
  ...
  * Flowspec_name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_icmp_type#flowspec_name FlowspecIcmpType#flowspec_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_icmp_type#icmp_type_attribute FlowspecIcmpType#icmp_type_attribute}
  */
  readonly icmpTypeAttribute: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_icmp_type#id FlowspecIcmpType#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_icmp_type#type FlowspecIcmpType#type}
  */
  readonly type: number;
  /**
  * Specify the ICMP Type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_icmp_type#type_end FlowspecIcmpType#type_end}
  */
  readonly typeEnd: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_icmp_type#uuid FlowspecIcmpType#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_icmp_type thunder_flowspec_icmp_type}
*/
export class FlowspecIcmpType extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FlowspecIcmpType that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_icmp_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_icmp_type thunder_flowspec_icmp_type} Resource
  *
  * @param scope The scope in which to define this construct
