// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_source_port
...
export interface FlowspecSourcePortConfig extends cdktf.TerraformMetaArguments {
  ...
  * Flowspec_name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_source_port#flowspec_name FlowspecSourcePort#flowspec_name}
  */
  readonly flowspecName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_source_port#id FlowspecSourcePort#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_source_port#port_attribute FlowspecSourcePort#port_attribute}
  */
  readonly portAttribute: string;
  /**
  * Specify the port number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_source_port#port_num FlowspecSourcePort#port_num}
  */
  readonly portNum: number;
  /**
  * Specify the port number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_source_port#port_num_end FlowspecSourcePort#port_num_end}
  */
  readonly portNumEnd: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_source_port#uuid FlowspecSourcePort#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_source_port thunder_flowspec_source_port}
*/
export class FlowspecSourcePort extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FlowspecSourcePort that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_source_port#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/flowspec_source_port thunder_flowspec_source_port} Resource
  *
  * @param scope The scope in which to define this construct
