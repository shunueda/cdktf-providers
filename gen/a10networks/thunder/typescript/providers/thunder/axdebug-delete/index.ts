// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/axdebug_delete
...
export interface AxdebugDeleteAConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/axdebug_delete#capture_file AxdebugDeleteA#capture_file}
  */
  readonly captureFile?: string;
  /**
  * Delete AXDebug config file (Specify target filename to change)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/axdebug_delete#config_file AxdebugDeleteA#config_file}
  */
  readonly configFile?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/axdebug_delete#id AxdebugDeleteA#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/axdebug_delete thunder_axdebug_delete}
*/
export class AxdebugDeleteA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AxdebugDeleteA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/axdebug_delete#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/axdebug_delete thunder_axdebug_delete} Resource
  *
  * @param scope The scope in which to define this construct
