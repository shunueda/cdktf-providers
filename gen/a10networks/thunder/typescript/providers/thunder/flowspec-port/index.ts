...
export class FlowspecPort extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_flowspec_port";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_flowspec_port", importId: importFromId, provider });
      }
  ...
  * @param options FlowspecPortConfig
  */
  public constructor(scope: Construct, id: string, config: FlowspecPortConfig) {
    super(scope, id, {
