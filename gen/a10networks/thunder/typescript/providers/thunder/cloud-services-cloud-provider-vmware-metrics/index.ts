...
export interface CloudServicesCloudProviderVmwareMetricsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class CloudServicesCloudProviderVmwareMetrics extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cloud_services_cloud_provider_vmware_metrics";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cloud_services_cloud_provider_vmware_metrics", importId: importFromId, provider });
      }
  ...
  * @param options CloudServicesCloudProviderVmwareMetricsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: CloudServicesCloudProviderVmwareMetricsConfig = {}) {
    super(scope, id, {
    ...
    this._vropsHost = config.vropsHost;
  }
  ...
  // vrops_host - computed: false, optional: true, required: false
  private _vropsHost?: string; 
  public get vropsHost() {
    return this.getStringAttribute('vrops_host');
  }
  public set vropsHost(value: string) {
    this._vropsHost = value;
  }
  public resetVropsHost() {
    this._vropsHost = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get vropsHostInput() {
    return this._vropsHost;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      vrops_host: cdktf.stringToTerraform(this._vropsHost),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      vrops_host: {
        value: cdktf.stringToHclTerraform(this._vropsHost),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
