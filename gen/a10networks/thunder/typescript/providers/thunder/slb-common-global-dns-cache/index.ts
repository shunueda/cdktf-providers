// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache
...
export interface SlbCommonGlobalDnsCacheAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#id SlbCommonGlobalDnsCacheA#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#uuid SlbCommonGlobalDnsCacheA#uuid}
  */
  readonly uuid?: string;
  /**
  * class_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#class_list SlbCommonGlobalDnsCacheA#class_list}
  */
  readonly classList?: SlbCommonGlobalDnsCacheClassListStructA;
}
export interface SlbCommonGlobalDnsCacheClassListLidListDnsA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#cache_action SlbCommonGlobalDnsCacheA#cache_action}
  */
  readonly cacheAction?: string;
  /**
  * Honor the server response TTL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#honor_server_response_ttl SlbCommonGlobalDnsCacheA#honor_server_response_ttl}
  */
  readonly honorServerResponseTtl?: number;
  /**
  * TTL for cache entry (TTL in seconds)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#ttl SlbCommonGlobalDnsCacheA#ttl}
  */
  readonly ttl?: number;
  /**
  * Weight for cache entry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#weight SlbCommonGlobalDnsCacheA#weight}
  */
...
export interface SlbCommonGlobalDnsCacheClassListLidListStructA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#conn_rate_limit SlbCommonGlobalDnsCacheA#conn_rate_limit}
  */
  readonly connRateLimit?: number;
  /**
  * Specify a limit ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#lidnum SlbCommonGlobalDnsCacheA#lidnum}
  */
  readonly lidnum: number;
  /**
  * Don't accept any new connection for certain time (Lockout duration in minutes)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#lockout SlbCommonGlobalDnsCacheA#lockout}
  */
  readonly lockout?: number;
  /**
  * Log a message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#log SlbCommonGlobalDnsCacheA#log}
  */
  readonly log?: number;
  /**
  * Log interval (minute, by default system will log every over limit instance)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#log_interval SlbCommonGlobalDnsCacheA#log_interval}
  */
  readonly logInterval?: number;
  /**
  * 'ignore': Ignore the limit and proceed; 'drop': Drop the query when it exceeds limit;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#over_limit_action SlbCommonGlobalDnsCacheA#over_limit_action}
  */
  readonly overLimitAction?: string;
  /**
  * Per (Number of 100ms)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#per SlbCommonGlobalDnsCacheA#per}
  */
  readonly per?: number;
  /**
  * Customized tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#user_tag SlbCommonGlobalDnsCacheA#user_tag}
  */
  ...
  * dns block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#dns SlbCommonGlobalDnsCacheA#dns}
  */
...
export interface SlbCommonGlobalDnsCacheClassListStructA {
  /**
  * Specify a class list name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#name SlbCommonGlobalDnsCacheA#name}
  */
  ...
  * lid_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#lid_list SlbCommonGlobalDnsCacheA#lid_list}
  */
  readonly lidList?: SlbCommonGlobalDnsCacheClassListLidListStructA[] | cdktf.IResolvable;
}

export function slbCommonGlobalDnsCacheClassListStructAToTerraform(struct?: SlbCommonGlobalDnsCacheClassListStructAOutputReference | SlbCommonGlobalDnsCacheClassListStructA): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    uuid: cdktf.stringToTerraform(struct!.uuid),
    lid_list: cdktf.listMapper(slbCommonGlobalDnsCacheClassListLidListStructAToTerraform, true)(struct!.lidList),
  }
}


export function slbCommonGlobalDnsCacheClassListStructAToHclTerraform(struct?: SlbCommonGlobalDnsCacheClassListStructAOutputReference | SlbCommonGlobalDnsCacheClassListStructA): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    lid_list: {
      value: cdktf.listMapperHcl(slbCommonGlobalDnsCacheClassListLidListStructAToHclTerraform, true)(struct!.lidList),
      isBlock: true,
      type: "list",
...
export class SlbCommonGlobalDnsCacheClassListStructAOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): SlbCommonGlobalDnsCacheClassListStructA | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: SlbCommonGlobalDnsCacheClassListStructA | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache thunder_slb_common_global_dns_cache}
*/
export class SlbCommonGlobalDnsCacheA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_common_global_dns_cache";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a SlbCommonGlobalDnsCacheA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the SlbCommonGlobalDnsCacheA to import
  * @param importFromId The id of the existing SlbCommonGlobalDnsCacheA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SlbCommonGlobalDnsCacheA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_common_global_dns_cache", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_global_dns_cache thunder_slb_common_global_dns_cache} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options SlbCommonGlobalDnsCacheAConfig = {}
  */
  public constructor(scope: Construct, id: string, config: SlbCommonGlobalDnsCacheAConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_slb_common_global_dns_cache',
  ...
  private _classList = new SlbCommonGlobalDnsCacheClassListStructAOutputReference(this, "class_list");
  public get classList() {
    return this._classList;
  }
  public putClassList(value: SlbCommonGlobalDnsCacheClassListStructA) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      class_list: slbCommonGlobalDnsCacheClassListStructAToTerraform(this._classList.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      class_list: {
        value: slbCommonGlobalDnsCacheClassListStructAToHclTerraform(this._classList.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "SlbCommonGlobalDnsCacheClassListStructAList",
      },
    };
