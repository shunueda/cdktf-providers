...
export interface DataThunderSlbSslCountersOperOper {
  /**
...
export function dataThunderSlbSslCountersOperOperToTerraform(struct?: DataThunderSlbSslCountersOperOperOutputReference | DataThunderSlbSslCountersOperOper): any {
  ...
  return {
    ...
    sni_automap_conn_closed: cdktf.numberToTerraform(struct!.sniAutomapConnClosed),
    sni_automap_failures: cdktf.numberToTerraform(struct!.sniAutomapFailures),
    sni_automap_max_active_conn: cdktf.numberToTerraform(struct!.sniAutomapMaxActiveConn),
    sni_automap_missing_cert: cdktf.numberToTerraform(struct!.sniAutomapMissingCert),
    sni_automap_successes: cdktf.numberToTerraform(struct!.sniAutomapSuccesses),
    sni_bypass_expired_cert: cdktf.numberToTerraform(struct!.sniBypassExpiredCert),
    sni_bypass_explicit_list: cdktf.numberToTerraform(struct!.sniBypassExplicitList),
    sni_bypass_missing_cert: cdktf.numberToTerraform(struct!.sniBypassMissingCert),
...
export function dataThunderSlbSslCountersOperOperToHclTerraform(struct?: DataThunderSlbSslCountersOperOperOutputReference | DataThunderSlbSslCountersOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    sni_automap_conn_closed: {
      value: cdktf.numberToHclTerraform(struct!.sniAutomapConnClosed),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    sni_automap_failures: {
      value: cdktf.numberToHclTerraform(struct!.sniAutomapFailures),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    sni_automap_max_active_conn: {
      value: cdktf.numberToHclTerraform(struct!.sniAutomapMaxActiveConn),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    sni_automap_missing_cert: {
      value: cdktf.numberToHclTerraform(struct!.sniAutomapMissingCert),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    sni_automap_successes: {
      value: cdktf.numberToHclTerraform(struct!.sniAutomapSuccesses),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    sni_bypass_expired_cert: {
      value: cdktf.numberToHclTerraform(struct!.sniBypassExpiredCert),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    sni_bypass_explicit_list: {
      value: cdktf.numberToHclTerraform(struct!.sniBypassExplicitList),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    sni_bypass_missing_cert: {
      value: cdktf.numberToHclTerraform(struct!.sniBypassMissingCert),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
...
export class DataThunderSlbSslCountersOperOperOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderSlbSslCountersOperOper | undefined {
    ...
    if (this._sniAutomapConnClosed !== undefined) {
      hasAnyValues = true;
      internalValueResult.sniAutomapConnClosed = this._sniAutomapConnClosed;
    }
    if (this._sniAutomapFailures !== undefined) {
      hasAnyValues = true;
      internalValueResult.sniAutomapFailures = this._sniAutomapFailures;
    }
    if (this._sniAutomapMaxActiveConn !== undefined) {
      hasAnyValues = true;
      internalValueResult.sniAutomapMaxActiveConn = this._sniAutomapMaxActiveConn;
    }
    if (this._sniAutomapMissingCert !== undefined) {
      hasAnyValues = true;
      internalValueResult.sniAutomapMissingCert = this._sniAutomapMissingCert;
    }
    if (this._sniAutomapSuccesses !== undefined) {
      hasAnyValues = true;
      internalValueResult.sniAutomapSuccesses = this._sniAutomapSuccesses;
    }
    if (this._sniBypassExpiredCert !== undefined) {
      hasAnyValues = true;
      internalValueResult.sniBypassExpiredCert = this._sniBypassExpiredCert;
    }
    if (this._sniBypassExplicitList !== undefined) {
      hasAnyValues = true;
      internalValueResult.sniBypassExplicitList = this._sniBypassExplicitList;
    }
    if (this._sniBypassMissingCert !== undefined) {
      hasAnyValues = true;
      internalValueResult.sniBypassMissingCert = this._sniBypassMissingCert;
    }
  ...
  public set internalValue(value: DataThunderSlbSslCountersOperOper | undefined) {
    if (value === undefined) {
      ...
      this._sniAutomapConnClosed = undefined;
      this._sniAutomapFailures = undefined;
      this._sniAutomapMaxActiveConn = undefined;
      this._sniAutomapMissingCert = undefined;
      this._sniAutomapSuccesses = undefined;
      ...
      this._sniAutomapConnClosed = value.sniAutomapConnClosed;
      this._sniAutomapFailures = value.sniAutomapFailures;
      this._sniAutomapMaxActiveConn = value.sniAutomapMaxActiveConn;
      this._sniAutomapMissingCert = value.sniAutomapMissingCert;
      this._sniAutomapSuccesses = value.sniAutomapSuccesses;
      this._sniBypassExpiredCert = value.sniBypassExpiredCert;
      this._sniBypassExplicitList = value.sniBypassExplicitList;
      this._sniBypassMissingCert = value.sniBypassMissingCert;
  ...
  // sni_automap_conn_closed - computed: false, optional: true, required: false
  private _sniAutomapConnClosed?: number; 
  public get sniAutomapConnClosed() {
    return this.getNumberAttribute('sni_automap_conn_closed');
  }
  public set sniAutomapConnClosed(value: number) {
    this._sniAutomapConnClosed = value;
  }
  public resetSniAutomapConnClosed() {
    this._sniAutomapConnClosed = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get sniAutomapConnClosedInput() {
    return this._sniAutomapConnClosed;
  }

  // sni_automap_failures - computed: false, optional: true, required: false
  private _sniAutomapFailures?: number; 
  public get sniAutomapFailures() {
    return this.getNumberAttribute('sni_automap_failures');
  }
  public set sniAutomapFailures(value: number) {
    this._sniAutomapFailures = value;
  }
  public resetSniAutomapFailures() {
    this._sniAutomapFailures = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get sniAutomapFailuresInput() {
    return this._sniAutomapFailures;
  }

  // sni_automap_max_active_conn - computed: false, optional: true, required: false
  private _sniAutomapMaxActiveConn?: number; 
  public get sniAutomapMaxActiveConn() {
    return this.getNumberAttribute('sni_automap_max_active_conn');
  }
  public set sniAutomapMaxActiveConn(value: number) {
    this._sniAutomapMaxActiveConn = value;
  }
  public resetSniAutomapMaxActiveConn() {
    this._sniAutomapMaxActiveConn = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get sniAutomapMaxActiveConnInput() {
    return this._sniAutomapMaxActiveConn;
  }

  // sni_automap_missing_cert - computed: false, optional: true, required: false
  private _sniAutomapMissingCert?: number; 
  public get sniAutomapMissingCert() {
    return this.getNumberAttribute('sni_automap_missing_cert');
  }
  public set sniAutomapMissingCert(value: number) {
    this._sniAutomapMissingCert = value;
  }
  public resetSniAutomapMissingCert() {
    this._sniAutomapMissingCert = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get sniAutomapMissingCertInput() {
    return this._sniAutomapMissingCert;
  }

  // sni_automap_successes - computed: false, optional: true, required: false
  private _sniAutomapSuccesses?: number; 
  public get sniAutomapSuccesses() {
    return this.getNumberAttribute('sni_automap_successes');
  }
  public set sniAutomapSuccesses(value: number) {
    this._sniAutomapSuccesses = value;
  }
  public resetSniAutomapSuccesses() {
    this._sniAutomapSuccesses = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get sniAutomapSuccessesInput() {
    return this._sniAutomapSuccesses;
  }
  ...
  private _sniBypassExplicitList?: number; 
  public get sniBypassExplicitList() {
    return this.getNumberAttribute('sni_bypass_explicit_list');
  }
  public set sniBypassExplicitList(value: number) {
...
export class DataThunderSlbSslCountersOper extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_ssl_counters_oper";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_ssl_counters_oper", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderSlbSslCountersOperConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderSlbSslCountersOperConfig = {}) {
    super(scope, id, {
  ...
  private _oper = new DataThunderSlbSslCountersOperOperOutputReference(this, "oper");
  public get oper() {
    return this._oper;
  }
  public putOper(value: DataThunderSlbSslCountersOperOper) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      oper: dataThunderSlbSslCountersOperOperToTerraform(this._oper.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      oper: {
        value: dataThunderSlbSslCountersOperOperToHclTerraform(this._oper.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderSlbSslCountersOperOperList",
      },
    };
