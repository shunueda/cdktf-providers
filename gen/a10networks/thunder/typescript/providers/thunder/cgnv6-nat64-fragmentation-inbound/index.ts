...
export interface Cgnv6Nat64FragmentationInboundConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class Cgnv6Nat64FragmentationInbound extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_nat64_fragmentation_inbound";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_nat64_fragmentation_inbound", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6Nat64FragmentationInboundConfig = {}
  */
  public constructor(scope: Construct, id: string, config: Cgnv6Nat64FragmentationInboundConfig = {}) {
    super(scope, id, {
