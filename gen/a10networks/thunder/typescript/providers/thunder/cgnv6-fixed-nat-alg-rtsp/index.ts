...
export interface Cgnv6FixedNatAlgRtspSamplingEnable {
  /**
...
export function cgnv6FixedNatAlgRtspSamplingEnableToTerraform(struct?: Cgnv6FixedNatAlgRtspSamplingEnable | cdktf.IResolvable): any {
...
export function cgnv6FixedNatAlgRtspSamplingEnableToHclTerraform(struct?: Cgnv6FixedNatAlgRtspSamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Cgnv6FixedNatAlgRtspSamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Cgnv6FixedNatAlgRtspSamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: Cgnv6FixedNatAlgRtspSamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class Cgnv6FixedNatAlgRtspSamplingEnableList extends cdktf.ComplexList {
  public internalValue? : Cgnv6FixedNatAlgRtspSamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): Cgnv6FixedNatAlgRtspSamplingEnableOutputReference {
    return new Cgnv6FixedNatAlgRtspSamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class Cgnv6FixedNatAlgRtsp extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_fixed_nat_alg_rtsp";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_fixed_nat_alg_rtsp", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6FixedNatAlgRtspConfig = {}
  */
  public constructor(scope: Construct, id: string, config: Cgnv6FixedNatAlgRtspConfig = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new Cgnv6FixedNatAlgRtspSamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: Cgnv6FixedNatAlgRtspSamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(cgnv6FixedNatAlgRtspSamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(cgnv6FixedNatAlgRtspSamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Cgnv6FixedNatAlgRtspSamplingEnableList",
      },
    };
