...
export interface Cgnv6LsnRuleListDomainIpSamplingEnableA {
  /**
...
export function cgnv6LsnRuleListDomainIpSamplingEnableAToTerraform(struct?: Cgnv6LsnRuleListDomainIpSamplingEnableA | cdktf.IResolvable): any {
...
export function cgnv6LsnRuleListDomainIpSamplingEnableAToHclTerraform(struct?: Cgnv6LsnRuleListDomainIpSamplingEnableA | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Cgnv6LsnRuleListDomainIpSamplingEnableAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Cgnv6LsnRuleListDomainIpSamplingEnableA | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: Cgnv6LsnRuleListDomainIpSamplingEnableA | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class Cgnv6LsnRuleListDomainIpSamplingEnableAList extends cdktf.ComplexList {
  public internalValue? : Cgnv6LsnRuleListDomainIpSamplingEnableA[] | cdktf.IResolvable
  ...
  */
  public get(index: number): Cgnv6LsnRuleListDomainIpSamplingEnableAOutputReference {
    return new Cgnv6LsnRuleListDomainIpSamplingEnableAOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class Cgnv6LsnRuleListDomainIpA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_lsn_rule_list_domain_ip";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_lsn_rule_list_domain_ip", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6LsnRuleListDomainIpAConfig
  */
  public constructor(scope: Construct, id: string, config: Cgnv6LsnRuleListDomainIpAConfig) {
    super(scope, id, {
  ...
  private _samplingEnable = new Cgnv6LsnRuleListDomainIpSamplingEnableAList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: Cgnv6LsnRuleListDomainIpSamplingEnableA[] | cdktf.IResolvable) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(cgnv6LsnRuleListDomainIpSamplingEnableAToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Cgnv6LsnRuleListDomainIpSamplingEnableAList",
      },
    };
