...
export interface DataThunderSystemDnsStatsStats {
  /**
...
export function dataThunderSystemDnsStatsStatsToTerraform(struct?: DataThunderSystemDnsStatsStatsOutputReference | DataThunderSystemDnsStatsStats): any {
...
export function dataThunderSystemDnsStatsStatsToHclTerraform(struct?: DataThunderSystemDnsStatsStatsOutputReference | DataThunderSystemDnsStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderSystemDnsStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderSystemDnsStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderSystemDnsStatsStats | undefined) {
    if (value === undefined) {
...
export class DataThunderSystemDnsStats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_system_dns_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_system_dns_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderSystemDnsStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderSystemDnsStatsConfig = {}) {
    super(scope, id, {
  ...
  private _stats = new DataThunderSystemDnsStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderSystemDnsStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderSystemDnsStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderSystemDnsStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderSystemDnsStatsStatsList",
      },
    };
