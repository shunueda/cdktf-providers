// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_alg_pptp_stats
...
export interface DataThunderCgnv6LsnAlgPptpStatsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_alg_pptp_stats#id DataThunderCgnv6LsnAlgPptpStats#id}
  *
  ...
  * stats block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_alg_pptp_stats#stats DataThunderCgnv6LsnAlgPptpStats#stats}
  */
...
export interface DataThunderCgnv6LsnAlgPptpStatsStats {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_alg_pptp_stats#call_reply_pns_call_id_mismatch DataThunderCgnv6LsnAlgPptpStats#call_reply_pns_call_id_mismatch}
  */
  readonly callReplyPnsCallIdMismatch?: number;
  /**
  * Call ID Mismatch on Call Request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_alg_pptp_stats#call_req_pns_call_id_mismatch DataThunderCgnv6LsnAlgPptpStats#call_req_pns_call_id_mismatch}
  */
  readonly callReqPnsCallIdMismatch?: number;
  /**
  * Calls Established
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_alg_pptp_stats#calls_established DataThunderCgnv6LsnAlgPptpStats#calls_established}
  */
  readonly callsEstablished?: number;
  /**
  * GRE Sessions Created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_alg_pptp_stats#gre_sessions_created DataThunderCgnv6LsnAlgPptpStats#gre_sessions_created}
  */
  readonly greSessionsCreated?: number;
  /**
  * GRE Sessions Freed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_alg_pptp_stats#gre_sessions_freed DataThunderCgnv6LsnAlgPptpStats#gre_sessions_freed}
  */
  readonly greSessionsFreed?: number;
  /**
  * Mismatched PNS Call ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_alg_pptp_stats#mismatched_pns_call_id DataThunderCgnv6LsnAlgPptpStats#mismatched_pns_call_id}
  */
  readonly mismatchedPnsCallId?: number;
  /**
  * No Matching GRE Session
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_alg_pptp_stats#no_gre_session_match DataThunderCgnv6LsnAlgPptpStats#no_gre_session_match}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_alg_pptp_stats thunder_cgnv6_lsn_alg_pptp_stats}
*/
export class DataThunderCgnv6LsnAlgPptpStats extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataThunderCgnv6LsnAlgPptpStats that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_alg_pptp_stats#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_alg_pptp_stats thunder_cgnv6_lsn_alg_pptp_stats} Data Source
  *
  * @param scope The scope in which to define this construct
