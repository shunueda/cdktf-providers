// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_lsn_alg_pptp_stats
...
export interface DataThunderCgnv6LsnAlgPptpStatsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_lsn_alg_pptp_stats#id DataThunderCgnv6LsnAlgPptpStats#id}
  *
  ...
  * stats block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_lsn_alg_pptp_stats#stats DataThunderCgnv6LsnAlgPptpStats#stats}
  */
  readonly stats?: DataThunderCgnv6LsnAlgPptpStatsStats;
}
export interface DataThunderCgnv6LsnAlgPptpStatsStats {
  /**
  * Call ID Mismatch on Call Reply
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_lsn_alg_pptp_stats#call_reply_pns_call_id_mismatch DataThunderCgnv6LsnAlgPptpStats#call_reply_pns_call_id_mismatch}
  */
  readonly callReplyPnsCallIdMismatch?: number;
  /**
  * Call ID Mismatch on Call Request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_lsn_alg_pptp_stats#call_req_pns_call_id_mismatch DataThunderCgnv6LsnAlgPptpStats#call_req_pns_call_id_mismatch}
  */
  readonly callReqPnsCallIdMismatch?: number;
  /**
  * Calls Established
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_lsn_alg_pptp_stats#calls_established DataThunderCgnv6LsnAlgPptpStats#calls_established}
  */
  readonly callsEstablished?: number;
  /**
  * GRE Sessions Created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_lsn_alg_pptp_stats#gre_sessions_created DataThunderCgnv6LsnAlgPptpStats#gre_sessions_created}
  */
  readonly greSessionsCreated?: number;
  /**
  * GRE Sessions Freed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_lsn_alg_pptp_stats#gre_sessions_freed DataThunderCgnv6LsnAlgPptpStats#gre_sessions_freed}
  */
  readonly greSessionsFreed?: number;
  /**
  * Mismatched PNS Call ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_lsn_alg_pptp_stats#mismatched_pns_call_id DataThunderCgnv6LsnAlgPptpStats#mismatched_pns_call_id}
  */
  readonly mismatchedPnsCallId?: number;
  /**
  * No Matching GRE Session
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_lsn_alg_pptp_stats#no_gre_session_match DataThunderCgnv6LsnAlgPptpStats#no_gre_session_match}
  */
  readonly noGreSessionMatch?: number;
}

export function dataThunderCgnv6LsnAlgPptpStatsStatsToTerraform(struct?: DataThunderCgnv6LsnAlgPptpStatsStatsOutputReference | DataThunderCgnv6LsnAlgPptpStatsStats): any {
...
export function dataThunderCgnv6LsnAlgPptpStatsStatsToHclTerraform(struct?: DataThunderCgnv6LsnAlgPptpStatsStatsOutputReference | DataThunderCgnv6LsnAlgPptpStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderCgnv6LsnAlgPptpStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderCgnv6LsnAlgPptpStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderCgnv6LsnAlgPptpStatsStats | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_lsn_alg_pptp_stats thunder_cgnv6_lsn_alg_pptp_stats}
*/
export class DataThunderCgnv6LsnAlgPptpStats extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_lsn_alg_pptp_stats";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataThunderCgnv6LsnAlgPptpStats resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataThunderCgnv6LsnAlgPptpStats to import
  * @param importFromId The id of the existing DataThunderCgnv6LsnAlgPptpStats that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_lsn_alg_pptp_stats#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataThunderCgnv6LsnAlgPptpStats to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_lsn_alg_pptp_stats", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_lsn_alg_pptp_stats thunder_cgnv6_lsn_alg_pptp_stats} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataThunderCgnv6LsnAlgPptpStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderCgnv6LsnAlgPptpStatsConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_cgnv6_lsn_alg_pptp_stats',
  ...
  private _stats = new DataThunderCgnv6LsnAlgPptpStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderCgnv6LsnAlgPptpStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderCgnv6LsnAlgPptpStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderCgnv6LsnAlgPptpStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderCgnv6LsnAlgPptpStatsStatsList",
      },
    };
