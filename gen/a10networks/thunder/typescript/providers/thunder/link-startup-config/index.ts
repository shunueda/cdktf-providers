// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/link_startup_config
...
export interface LinkStartupConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  * All-partitions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/link_startup_config#all_partitions LinkStartupConfig#all_partitions}
  */
  readonly allPartitions?: number;
  /**
  * Default startup-config
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/link_startup_config#default LinkStartupConfig#default}
  */
  readonly default?: number;
  /**
  * Local Configuration Profile Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/link_startup_config#file_name LinkStartupConfig#file_name}
  */
  readonly fileName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/link_startup_config#id LinkStartupConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/link_startup_config#primary LinkStartupConfig#primary}
  */
  readonly primary?: number;
  /**
  * Create link in secondary partition
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/link_startup_config#secondary LinkStartupConfig#secondary}
  */
  readonly secondary?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/link_startup_config thunder_link_startup_config}
*/
export class LinkStartupConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LinkStartupConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/link_startup_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/link_startup_config thunder_link_startup_config} Resource
  *
  * @param scope The scope in which to define this construct
