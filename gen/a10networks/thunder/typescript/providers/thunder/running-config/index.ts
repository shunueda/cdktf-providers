// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/running_config
...
export interface RunningConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  * Show aFleX scripts
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/running_config#aflex RunningConfig#aflex}
  */
  readonly aflex?: number;
  /**
  * Show class-list files
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/running_config#class_list RunningConfig#class_list}
  */
  readonly classList?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/running_config#id RunningConfig#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/running_config#uuid RunningConfig#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/running_config thunder_running_config}
*/
export class RunningConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RunningConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/running_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/running_config thunder_running_config} Resource
  *
  * @param scope The scope in which to define this construct
