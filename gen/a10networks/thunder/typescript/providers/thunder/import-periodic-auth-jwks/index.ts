...
export interface ImportPeriodicAuthJwksConfig extends cdktf.TerraformMetaArguments {
  /**
  * JSON web key
  *
...
export class ImportPeriodicAuthJwks extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_import_periodic_auth_jwks";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_import_periodic_auth_jwks", importId: importFromId, provider });
      }
  ...
  * @param options ImportPeriodicAuthJwksConfig
  */
  public constructor(scope: Construct, id: string, config: ImportPeriodicAuthJwksConfig) {
    super(scope, id, {
  ...
  // auth_jwks - computed: false, optional: false, required: true
