...
export interface DataThunderCgnv6FixedNatAlgRtspStatsStats {
  /**
...
export function dataThunderCgnv6FixedNatAlgRtspStatsStatsToTerraform(struct?: DataThunderCgnv6FixedNatAlgRtspStatsStatsOutputReference | DataThunderCgnv6FixedNatAlgRtspStatsStats): any {
...
export function dataThunderCgnv6FixedNatAlgRtspStatsStatsToHclTerraform(struct?: DataThunderCgnv6FixedNatAlgRtspStatsStatsOutputReference | DataThunderCgnv6FixedNatAlgRtspStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderCgnv6FixedNatAlgRtspStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderCgnv6FixedNatAlgRtspStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderCgnv6FixedNatAlgRtspStatsStats | undefined) {
    if (value === undefined) {
...
export class DataThunderCgnv6FixedNatAlgRtspStats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_fixed_nat_alg_rtsp_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_fixed_nat_alg_rtsp_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderCgnv6FixedNatAlgRtspStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderCgnv6FixedNatAlgRtspStatsConfig = {}) {
    super(scope, id, {
  ...
  private _stats = new DataThunderCgnv6FixedNatAlgRtspStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderCgnv6FixedNatAlgRtspStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderCgnv6FixedNatAlgRtspStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderCgnv6FixedNatAlgRtspStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderCgnv6FixedNatAlgRtspStatsStatsList",
      },
    };
