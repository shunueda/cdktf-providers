// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4
...
export interface EnableManagementServicePingAclV4Config extends cdktf.TerraformMetaArguments {
  ...
  * ACL id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#acl_id EnableManagementServicePingAclV4#acl_id}
  */
  readonly aclId: number;
  /**
  * All Data Interfaces
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#all_data_intf EnableManagementServicePingAclV4#all_data_intf}
  */
  readonly allDataIntf?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#id EnableManagementServicePingAclV4#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#management EnableManagementServicePingAclV4#management}
  */
  readonly management?: number;
  /**
  * Customized tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#user_tag EnableManagementServicePingAclV4#user_tag}
  */
  readonly userTag?: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#uuid EnableManagementServicePingAclV4#uuid}
  */
  readonly uuid?: string;
  /**
  * eth_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#eth_cfg EnableManagementServicePingAclV4#eth_cfg}
  */
  readonly ethCfg?: EnableManagementServicePingAclV4EthCfg[] | cdktf.IResolvable;
  /**
  * lif_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#lif_cfg EnableManagementServicePingAclV4#lif_cfg}
  */
  readonly lifCfg?: EnableManagementServicePingAclV4LifCfg;
  /**
  * tunnel_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#tunnel_cfg EnableManagementServicePingAclV4#tunnel_cfg}
  */
  readonly tunnelCfg?: EnableManagementServicePingAclV4TunnelCfg[] | cdktf.IResolvable;
  /**
  * ve_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#ve_cfg EnableManagementServicePingAclV4#ve_cfg}
  */
...
export interface EnableManagementServicePingAclV4EthCfg {
  ...
  * Ethernet port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#ethernet_end EnableManagementServicePingAclV4#ethernet_end}
  */
  readonly ethernetEnd?: number;
  /**
  * Ethernet port (Ethernet Interface number)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#ethernet_start EnableManagementServicePingAclV4#ethernet_start}
  */
...
export interface EnableManagementServicePingAclV4LifCfg {
  /**
  * Lif name (Lif interface name)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#lif EnableManagementServicePingAclV4#lif}
  */
  readonly lif?: string;
}

export function enableManagementServicePingAclV4LifCfgToTerraform(struct?: EnableManagementServicePingAclV4LifCfgOutputReference | EnableManagementServicePingAclV4LifCfg): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function enableManagementServicePingAclV4LifCfgToHclTerraform(struct?: EnableManagementServicePingAclV4LifCfgOutputReference | EnableManagementServicePingAclV4LifCfg): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class EnableManagementServicePingAclV4LifCfgOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): EnableManagementServicePingAclV4LifCfg | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: EnableManagementServicePingAclV4LifCfg | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._lif = undefined;
    }
...
export interface EnableManagementServicePingAclV4TunnelCfg {
  ...
  * tunnel port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#tunnel_end EnableManagementServicePingAclV4#tunnel_end}
  */
  readonly tunnelEnd?: number;
  /**
  * tunnel port (tunnel Interface number)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#tunnel_start EnableManagementServicePingAclV4#tunnel_start}
  */
...
export interface EnableManagementServicePingAclV4VeCfg {
  ...
  * VE port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#ve_end EnableManagementServicePingAclV4#ve_end}
  */
  readonly veEnd?: number;
  /**
  * VE port (VE Interface number)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#ve_start EnableManagementServicePingAclV4#ve_start}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4 thunder_enable_management_service_ping_acl_v4}
*/
export class EnableManagementServicePingAclV4 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnableManagementServicePingAclV4 that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_management_service_ping_acl_v4 thunder_enable_management_service_ping_acl_v4} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _lifCfg = new EnableManagementServicePingAclV4LifCfgOutputReference(this, "lif_cfg");
  public get lifCfg() {
    return this._lifCfg;
  }
  public putLifCfg(value: EnableManagementServicePingAclV4LifCfg) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      lif_cfg: enableManagementServicePingAclV4LifCfgToTerraform(this._lifCfg.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      lif_cfg: {
        value: enableManagementServicePingAclV4LifCfgToHclTerraform(this._lifCfg.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "EnableManagementServicePingAclV4LifCfgList",
      },
      tunnel_cfg: {
