// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_ip_server
...
export interface GslbSiteIpServerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_ip_server#id GslbSiteIpServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_ip_server#ip_server_name GslbSiteIpServer#ip_server_name}
  */
  readonly ipServerName: string;
  /**
  * SiteName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_ip_server#site_name GslbSiteIpServer#site_name}
  */
  readonly siteName: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_ip_server#uuid GslbSiteIpServer#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_ip_server thunder_gslb_site_ip_server}
*/
export class GslbSiteIpServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GslbSiteIpServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_ip_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_ip_server thunder_gslb_site_ip_server} Resource
  *
  * @param scope The scope in which to define this construct
