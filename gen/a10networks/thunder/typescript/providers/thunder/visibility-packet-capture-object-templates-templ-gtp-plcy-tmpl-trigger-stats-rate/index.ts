...
export interface VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsRateAConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsRateA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_visibility_packet_capture_object_templates_templ_gtp_plcy_tmpl_trigger_stats_rate";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_visibility_packet_capture_object_templates_templ_gtp_plcy_tmpl_trigger_stats_rate", importId: importFromId, provider });
      }
  ...
  * @param options VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsRateAConfig
  */
  public constructor(scope: Construct, id: string, config: VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsRateAConfig) {
    super(scope, id, {
