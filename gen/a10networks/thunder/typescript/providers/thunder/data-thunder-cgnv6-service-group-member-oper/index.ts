// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper
...
export interface DataThunderCgnv6ServiceGroupMemberOperConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#id DataThunderCgnv6ServiceGroupMemberOper#id}
  *
  ...
  * Member name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#name DataThunderCgnv6ServiceGroupMemberOper#name}
  */
  readonly name: string;
  /**
  * Port number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#port DataThunderCgnv6ServiceGroupMemberOper#port}
  */
  readonly port: number;
  /**
  * Service_group_name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#service_group_name DataThunderCgnv6ServiceGroupMemberOper#service_group_name}
  */
  readonly serviceGroupName: string;
  /**
  * oper block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#oper DataThunderCgnv6ServiceGroupMemberOper#oper}
  */
  readonly oper?: DataThunderCgnv6ServiceGroupMemberOperOper;
}
export interface DataThunderCgnv6ServiceGroupMemberOperOperAltListStruct {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#alt_curr_conn DataThunderCgnv6ServiceGroupMemberOper#alt_curr_conn}
  */
  readonly altCurrConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#alt_fwd_pkts DataThunderCgnv6ServiceGroupMemberOper#alt_fwd_pkts}
  */
  readonly altFwdPkts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#alt_name DataThunderCgnv6ServiceGroupMemberOper#alt_name}
  */
  readonly altName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#alt_peak_conn DataThunderCgnv6ServiceGroupMemberOper#alt_peak_conn}
  */
  readonly altPeakConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#alt_port DataThunderCgnv6ServiceGroupMemberOper#alt_port}
  */
  readonly altPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#alt_rev_pkts DataThunderCgnv6ServiceGroupMemberOper#alt_rev_pkts}
  */
  readonly altRevPkts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#alt_state DataThunderCgnv6ServiceGroupMemberOper#alt_state}
  */
  readonly altState?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#alt_total_conn DataThunderCgnv6ServiceGroupMemberOper#alt_total_conn}
  */
  readonly altTotalConn?: number;
}

export function dataThunderCgnv6ServiceGroupMemberOperOperAltListStructToTerraform(struct?: DataThunderCgnv6ServiceGroupMemberOperOperAltListStruct | cdktf.IResolvable): any {
...
export function dataThunderCgnv6ServiceGroupMemberOperOperAltListStructToHclTerraform(struct?: DataThunderCgnv6ServiceGroupMemberOperOperAltListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderCgnv6ServiceGroupMemberOperOperAltListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderCgnv6ServiceGroupMemberOperOperAltListStruct | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataThunderCgnv6ServiceGroupMemberOperOperAltListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataThunderCgnv6ServiceGroupMemberOperOperAltListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderCgnv6ServiceGroupMemberOperOperAltListStruct[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataThunderCgnv6ServiceGroupMemberOperOperAltListStructOutputReference {
    return new DataThunderCgnv6ServiceGroupMemberOperOperAltListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataThunderCgnv6ServiceGroupMemberOperOperDrsListStruct {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_curr_conn DataThunderCgnv6ServiceGroupMemberOper#drs_curr_conn}
  */
  readonly drsCurrConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_curr_req DataThunderCgnv6ServiceGroupMemberOper#drs_curr_req}
  */
  readonly drsCurrReq?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_frsp_time DataThunderCgnv6ServiceGroupMemberOper#drs_frsp_time}
  */
  readonly drsFrspTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_fwd_bts DataThunderCgnv6ServiceGroupMemberOper#drs_fwd_bts}
  */
  readonly drsFwdBts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_fwd_pkts DataThunderCgnv6ServiceGroupMemberOper#drs_fwd_pkts}
  */
  readonly drsFwdPkts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_hm_index DataThunderCgnv6ServiceGroupMemberOper#drs_hm_index}
  */
  readonly drsHmIndex?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_hm_key DataThunderCgnv6ServiceGroupMemberOper#drs_hm_key}
  */
  readonly drsHmKey?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_name DataThunderCgnv6ServiceGroupMemberOper#drs_name}
  */
  readonly drsName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_peak_conn DataThunderCgnv6ServiceGroupMemberOper#drs_peak_conn}
  */
  readonly drsPeakConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_pers_conn DataThunderCgnv6ServiceGroupMemberOper#drs_pers_conn}
  */
  readonly drsPersConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_port DataThunderCgnv6ServiceGroupMemberOper#drs_port}
  */
  readonly drsPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_priority DataThunderCgnv6ServiceGroupMemberOper#drs_priority}
  */
  readonly drsPriority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_rev_bts DataThunderCgnv6ServiceGroupMemberOper#drs_rev_bts}
  */
  readonly drsRevBts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_rev_pkts DataThunderCgnv6ServiceGroupMemberOper#drs_rev_pkts}
  */
  readonly drsRevPkts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_rsp_time DataThunderCgnv6ServiceGroupMemberOper#drs_rsp_time}
  */
  readonly drsRspTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_srsp_time DataThunderCgnv6ServiceGroupMemberOper#drs_srsp_time}
  */
  readonly drsSrspTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_state DataThunderCgnv6ServiceGroupMemberOper#drs_state}
  */
  readonly drsState?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_total_conn DataThunderCgnv6ServiceGroupMemberOper#drs_total_conn}
  */
  readonly drsTotalConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_total_req DataThunderCgnv6ServiceGroupMemberOper#drs_total_req}
  */
  readonly drsTotalReq?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_total_req_succ DataThunderCgnv6ServiceGroupMemberOper#drs_total_req_succ}
  */
  readonly drsTotalReqSucc?: number;
}

export function dataThunderCgnv6ServiceGroupMemberOperOperDrsListStructToTerraform(struct?: DataThunderCgnv6ServiceGroupMemberOperOperDrsListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataThunderCgnv6ServiceGroupMemberOperOperDrsListStructToHclTerraform(struct?: DataThunderCgnv6ServiceGroupMemberOperOperDrsListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderCgnv6ServiceGroupMemberOperOperDrsListStructOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataThunderCgnv6ServiceGroupMemberOperOperDrsListStruct | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataThunderCgnv6ServiceGroupMemberOperOperDrsListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataThunderCgnv6ServiceGroupMemberOperOperDrsListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderCgnv6ServiceGroupMemberOperOperDrsListStruct[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataThunderCgnv6ServiceGroupMemberOperOperDrsListStructOutputReference {
    return new DataThunderCgnv6ServiceGroupMemberOperOperDrsListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataThunderCgnv6ServiceGroupMemberOperOper {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#hm_index DataThunderCgnv6ServiceGroupMemberOper#hm_index}
  */
  readonly hmIndex?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#hm_key DataThunderCgnv6ServiceGroupMemberOper#hm_key}
  */
  readonly hmKey?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#state DataThunderCgnv6ServiceGroupMemberOper#state}
  */
  readonly state?: string;
  /**
  * alt_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#alt_list DataThunderCgnv6ServiceGroupMemberOper#alt_list}
  */
  readonly altList?: DataThunderCgnv6ServiceGroupMemberOperOperAltListStruct[] | cdktf.IResolvable;
  /**
  * drs_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#drs_list DataThunderCgnv6ServiceGroupMemberOper#drs_list}
  */
  readonly drsList?: DataThunderCgnv6ServiceGroupMemberOperOperDrsListStruct[] | cdktf.IResolvable;
}

export function dataThunderCgnv6ServiceGroupMemberOperOperToTerraform(struct?: DataThunderCgnv6ServiceGroupMemberOperOperOutputReference | DataThunderCgnv6ServiceGroupMemberOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    alt_list: cdktf.listMapper(dataThunderCgnv6ServiceGroupMemberOperOperAltListStructToTerraform, true)(struct!.altList),
    drs_list: cdktf.listMapper(dataThunderCgnv6ServiceGroupMemberOperOperDrsListStructToTerraform, true)(struct!.drsList),
  }
}


export function dataThunderCgnv6ServiceGroupMemberOperOperToHclTerraform(struct?: DataThunderCgnv6ServiceGroupMemberOperOperOutputReference | DataThunderCgnv6ServiceGroupMemberOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    alt_list: {
      value: cdktf.listMapperHcl(dataThunderCgnv6ServiceGroupMemberOperOperAltListStructToHclTerraform, true)(struct!.altList),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderCgnv6ServiceGroupMemberOperOperAltListStructList",
    },
    drs_list: {
      value: cdktf.listMapperHcl(dataThunderCgnv6ServiceGroupMemberOperOperDrsListStructToHclTerraform, true)(struct!.drsList),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderCgnv6ServiceGroupMemberOperOperDrsListStructList",
    },
  };
...
export class DataThunderCgnv6ServiceGroupMemberOperOperOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataThunderCgnv6ServiceGroupMemberOperOper | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataThunderCgnv6ServiceGroupMemberOperOper | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _altList = new DataThunderCgnv6ServiceGroupMemberOperOperAltListStructList(this, "alt_list", false);
  public get altList() {
    return this._altList;
  }
  public putAltList(value: DataThunderCgnv6ServiceGroupMemberOperOperAltListStruct[] | cdktf.IResolvable) {
  ...
  private _drsList = new DataThunderCgnv6ServiceGroupMemberOperOperDrsListStructList(this, "drs_list", false);
  public get drsList() {
    return this._drsList;
  }
  public putDrsList(value: DataThunderCgnv6ServiceGroupMemberOperOperDrsListStruct[] | cdktf.IResolvable) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper thunder_cgnv6_service_group_member_oper}
*/
export class DataThunderCgnv6ServiceGroupMemberOper extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_service_group_member_oper";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataThunderCgnv6ServiceGroupMemberOper resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataThunderCgnv6ServiceGroupMemberOper to import
  * @param importFromId The id of the existing DataThunderCgnv6ServiceGroupMemberOper that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataThunderCgnv6ServiceGroupMemberOper to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_service_group_member_oper", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/cgnv6_service_group_member_oper thunder_cgnv6_service_group_member_oper} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataThunderCgnv6ServiceGroupMemberOperConfig
  */
  public constructor(scope: Construct, id: string, config: DataThunderCgnv6ServiceGroupMemberOperConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_cgnv6_service_group_member_oper',
  ...
  private _oper = new DataThunderCgnv6ServiceGroupMemberOperOperOutputReference(this, "oper");
  public get oper() {
    return this._oper;
  }
  public putOper(value: DataThunderCgnv6ServiceGroupMemberOperOper) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      oper: dataThunderCgnv6ServiceGroupMemberOperOperToTerraform(this._oper.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      oper: {
        value: dataThunderCgnv6ServiceGroupMemberOperOperToHclTerraform(this._oper.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderCgnv6ServiceGroupMemberOperOperList",
      },
    };
