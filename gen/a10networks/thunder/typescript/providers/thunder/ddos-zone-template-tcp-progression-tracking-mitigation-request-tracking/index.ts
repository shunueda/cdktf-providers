// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking
...
export interface DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Set the maximum idle time before the first request (in unit of 100ms)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#first_request_max_time DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#first_request_max_time}
  */
  readonly firstRequestMaxTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#id DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#progression_tracking_req_action DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#progression_tracking_req_action}
  */
  readonly progressionTrackingReqAction?: string;
  /**
  * Configure action-list to take when progression tracking violation exceed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#progression_tracking_req_action_list_name DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#progression_tracking_req_action_list_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#progression_tracking_req_enabled DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#progression_tracking_req_enabled}
  */
  readonly progressionTrackingReqEnabled: string;
  /**
  * Set the maximum request length
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#request_length_max DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#request_length_max}
  */
  readonly requestLengthMax?: number;
  /**
  * Set the minimum request length
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#request_length_min DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#request_length_min}
  */
  readonly requestLengthMin?: number;
  /**
  * 'enable': Enable Request Response Model; 'disable': Disable Request Response Model;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#request_response_model DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#request_response_model}
  */
  readonly requestResponseModel?: string;
  /**
  * Set the maximum request to response time (in unit of 100ms)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#request_to_response_max_time DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#request_to_response_max_time}
  */
  readonly requestToResponseMaxTime?: number;
  /**
  * Set the maximum response length
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#response_length_max DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#response_length_max}
  */
  readonly responseLengthMax?: number;
  /**
  * Set the minimum response length
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#response_length_min DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#response_length_min}
  */
  readonly responseLengthMin?: number;
  /**
  * Set the maximum response to request time (in unit of 100ms)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#response_to_request_max_time DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#response_to_request_max_time}
  */
  readonly responseToRequestMaxTime?: number;
  /**
  * Tcp_name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#tcp_name DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#tcp_name}
  */
  readonly tcpName: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#uuid DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#uuid}
  */
  readonly uuid?: string;
  /**
  * Set the violation threshold
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#violation DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA#violation}
  */
  readonly violation?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking thunder_ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking}
*/
export class DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA to import
  * @param importFromId The id of the existing DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking thunder_ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingAConfig
  */
  public constructor(scope: Construct, id: string, config: DdosZoneTemplateTcpProgressionTrackingMitigationRequestTrackingAConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_ddos_zone_template_tcp_progression_tracking_mitigation_request_tracking',
