...
export interface Cgnv6LsnAlgPptpSamplingEnable {
  /**
...
export function cgnv6LsnAlgPptpSamplingEnableToTerraform(struct?: Cgnv6LsnAlgPptpSamplingEnable | cdktf.IResolvable): any {
...
export function cgnv6LsnAlgPptpSamplingEnableToHclTerraform(struct?: Cgnv6LsnAlgPptpSamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Cgnv6LsnAlgPptpSamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Cgnv6LsnAlgPptpSamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: Cgnv6LsnAlgPptpSamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class Cgnv6LsnAlgPptpSamplingEnableList extends cdktf.ComplexList {
  public internalValue? : Cgnv6LsnAlgPptpSamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): Cgnv6LsnAlgPptpSamplingEnableOutputReference {
    return new Cgnv6LsnAlgPptpSamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class Cgnv6LsnAlgPptp extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_lsn_alg_pptp";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_lsn_alg_pptp", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6LsnAlgPptpConfig = {}
  */
  public constructor(scope: Construct, id: string, config: Cgnv6LsnAlgPptpConfig = {}) {
    super(scope, id, {
    ...
    this._id = config.id;
    this._pptpValue = config.pptpValue;
  ...
  // pptp_value - computed: false, optional: true, required: false
  private _pptpValue?: string; 
  public get pptpValue() {
    return this.getStringAttribute('pptp_value');
  }
  public set pptpValue(value: string) {
    this._pptpValue = value;
  }
  public resetPptpValue() {
    this._pptpValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get pptpValueInput() {
    return this._pptpValue;
  }
  ...
  private _samplingEnable = new Cgnv6LsnAlgPptpSamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: Cgnv6LsnAlgPptpSamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      pptp_value: cdktf.stringToTerraform(this._pptpValue),
      uuid: cdktf.stringToTerraform(this._uuid),
      sampling_enable: cdktf.listMapper(cgnv6LsnAlgPptpSamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      pptp_value: {
        value: cdktf.stringToHclTerraform(this._pptpValue),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(cgnv6LsnAlgPptpSamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Cgnv6LsnAlgPptpSamplingEnableList",
      },
    };
