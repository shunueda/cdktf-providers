...
export interface AutomaticUpdateProxyServerAConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class AutomaticUpdateProxyServerA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_automatic_update_proxy_server";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_automatic_update_proxy_server", importId: importFromId, provider });
      }
  ...
  * @param options AutomaticUpdateProxyServerAConfig = {}
  */
  public constructor(scope: Construct, id: string, config: AutomaticUpdateProxyServerAConfig = {}) {
    super(scope, id, {
