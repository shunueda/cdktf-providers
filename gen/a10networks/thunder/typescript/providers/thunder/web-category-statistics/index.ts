...
export interface WebCategoryStatisticsSamplingEnableA {
  /**
...
export function webCategoryStatisticsSamplingEnableAToTerraform(struct?: WebCategoryStatisticsSamplingEnableA | cdktf.IResolvable): any {
...
export function webCategoryStatisticsSamplingEnableAToHclTerraform(struct?: WebCategoryStatisticsSamplingEnableA | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class WebCategoryStatisticsSamplingEnableAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): WebCategoryStatisticsSamplingEnableA | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: WebCategoryStatisticsSamplingEnableA | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class WebCategoryStatisticsSamplingEnableAList extends cdktf.ComplexList {
  public internalValue? : WebCategoryStatisticsSamplingEnableA[] | cdktf.IResolvable
  ...
  */
  public get(index: number): WebCategoryStatisticsSamplingEnableAOutputReference {
    return new WebCategoryStatisticsSamplingEnableAOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class WebCategoryStatisticsA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_web_category_statistics";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_web_category_statistics", importId: importFromId, provider });
      }
  ...
  * @param options WebCategoryStatisticsAConfig = {}
  */
  public constructor(scope: Construct, id: string, config: WebCategoryStatisticsAConfig = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new WebCategoryStatisticsSamplingEnableAList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: WebCategoryStatisticsSamplingEnableA[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(webCategoryStatisticsSamplingEnableAToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(webCategoryStatisticsSamplingEnableAToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "WebCategoryStatisticsSamplingEnableAList",
      },
    };
