...
export function dataThunderSystemTcpStatsOperOperTcpstatsCpuListStructToTerraform(struct?: DataThunderSystemTcpStatsOperOperTcpstatsCpuListStruct | cdktf.IResolvable): any {
...
export function dataThunderSystemTcpStatsOperOperTcpstatsCpuListStructToHclTerraform(struct?: DataThunderSystemTcpStatsOperOperTcpstatsCpuListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderSystemTcpStatsOperOperTcpstatsCpuListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderSystemTcpStatsOperOperTcpstatsCpuListStruct | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataThunderSystemTcpStatsOperOperTcpstatsCpuListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataThunderSystemTcpStatsOperOperTcpstatsCpuListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderSystemTcpStatsOperOperTcpstatsCpuListStruct[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataThunderSystemTcpStatsOperOperTcpstatsCpuListStructOutputReference {
    return new DataThunderSystemTcpStatsOperOperTcpstatsCpuListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function dataThunderSystemTcpStatsOperOperToTerraform(struct?: DataThunderSystemTcpStatsOperOperOutputReference | DataThunderSystemTcpStatsOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    tcpstats_cpu_list: cdktf.listMapper(dataThunderSystemTcpStatsOperOperTcpstatsCpuListStructToTerraform, true)(struct!.tcpstatsCpuList),
  }
}


export function dataThunderSystemTcpStatsOperOperToHclTerraform(struct?: DataThunderSystemTcpStatsOperOperOutputReference | DataThunderSystemTcpStatsOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    tcpstats_cpu_list: {
      value: cdktf.listMapperHcl(dataThunderSystemTcpStatsOperOperTcpstatsCpuListStructToHclTerraform, true)(struct!.tcpstatsCpuList),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderSystemTcpStatsOperOperTcpstatsCpuListStructList",
    },
  };
...
export class DataThunderSystemTcpStatsOperOperOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataThunderSystemTcpStatsOperOper | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    ...
    if (this._tcpstatsCpuList?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.tcpstatsCpuList = this._tcpstatsCpuList?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataThunderSystemTcpStatsOperOper | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._cpuCount = undefined;
      this._tcpstatsCpuList.internalValue = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._cpuCount = value.cpuCount;
      this._tcpstatsCpuList.internalValue = value.tcpstatsCpuList;
    }
  }
  ...
  // tcpstats_cpu_list - computed: false, optional: true, required: false
  private _tcpstatsCpuList = new DataThunderSystemTcpStatsOperOperTcpstatsCpuListStructList(this, "tcpstats_cpu_list", false);
  public get tcpstatsCpuList() {
    return this._tcpstatsCpuList;
  }
  public putTcpstatsCpuList(value: DataThunderSystemTcpStatsOperOperTcpstatsCpuListStruct[] | cdktf.IResolvable) {
    this._tcpstatsCpuList.internalValue = value;
  }
  public resetTcpstatsCpuList() {
    this._tcpstatsCpuList.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get tcpstatsCpuListInput() {
    return this._tcpstatsCpuList.internalValue;
  }
}
...
export class DataThunderSystemTcpStatsOper extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_system_tcp_stats_oper";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_system_tcp_stats_oper", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderSystemTcpStatsOperConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderSystemTcpStatsOperConfig = {}) {
    super(scope, id, {
  ...
  private _oper = new DataThunderSystemTcpStatsOperOperOutputReference(this, "oper");
  public get oper() {
    return this._oper;
  }
  public putOper(value: DataThunderSystemTcpStatsOperOper) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      oper: dataThunderSystemTcpStatsOperOperToTerraform(this._oper.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      oper: {
        value: dataThunderSystemTcpStatsOperOperToHclTerraform(this._oper.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderSystemTcpStatsOperOperList",
      },
    };
