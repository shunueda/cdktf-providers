...
export interface Cgnv6MapEncapsulationFragmentationInboundConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class Cgnv6MapEncapsulationFragmentationInbound extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_map_encapsulation_fragmentation_inbound";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_map_encapsulation_fragmentation_inbound", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6MapEncapsulationFragmentationInboundConfig = {}
  */
  public constructor(scope: Construct, id: string, config: Cgnv6MapEncapsulationFragmentationInboundConfig = {}) {
    super(scope, id, {
