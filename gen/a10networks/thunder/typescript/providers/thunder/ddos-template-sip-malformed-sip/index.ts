// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip
...
export interface DdosTemplateSipMalformedSipAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip#id DdosTemplateSipMalformedSipA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip#malformed_sip_call_id_max_length DdosTemplateSipMalformedSipA#malformed_sip_call_id_max_length}
  */
  readonly malformedSipCallIdMaxLength?: number;
  /**
  * 'enable-check': Enable malformed SIP parameters;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip#malformed_sip_check DdosTemplateSipMalformedSipA#malformed_sip_check}
  */
  readonly malformedSipCheck?: string;
  /**
  * Set the maximum header name length. Default value is 63
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip#malformed_sip_max_header_name_length DdosTemplateSipMalformedSipA#malformed_sip_max_header_name_length}
  */
  readonly malformedSipMaxHeaderNameLength?: number;
  /**
  * Set the maximum header value length. Default value is 32511
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip#malformed_sip_max_header_value_length DdosTemplateSipMalformedSipA#malformed_sip_max_header_value_length}
  */
  readonly malformedSipMaxHeaderValueLength?: number;
  /**
  * Set the maximum line size. Default value is 32511
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip#malformed_sip_max_line_size DdosTemplateSipMalformedSipA#malformed_sip_max_line_size}
  */
  readonly malformedSipMaxLineSize?: number;
  /**
  * Set the maximum uri size. Default value is 32511
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip#malformed_sip_max_uri_length DdosTemplateSipMalformedSipA#malformed_sip_max_uri_length}
  */
  readonly malformedSipMaxUriLength?: number;
  /**
  * Set the maxinum SDP content length. Default value is 32511
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip#malformed_sip_sdp_max_length DdosTemplateSipMalformedSipA#malformed_sip_sdp_max_length}
  */
  readonly malformedSipSdpMaxLength?: number;
  /**
  * SipTmplName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip#sip_tmpl_name DdosTemplateSipMalformedSipA#sip_tmpl_name}
  */
  readonly sipTmplName: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip#uuid DdosTemplateSipMalformedSipA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip thunder_ddos_template_sip_malformed_sip}
*/
export class DdosTemplateSipMalformedSipA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_template_sip_malformed_sip";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DdosTemplateSipMalformedSipA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DdosTemplateSipMalformedSipA to import
  * @param importFromId The id of the existing DdosTemplateSipMalformedSipA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DdosTemplateSipMalformedSipA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_template_sip_malformed_sip", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_template_sip_malformed_sip thunder_ddos_template_sip_malformed_sip} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DdosTemplateSipMalformedSipAConfig
  */
  public constructor(scope: Construct, id: string, config: DdosTemplateSipMalformedSipAConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_ddos_template_sip_malformed_sip',
