...
export interface DataThunderIpv6FragStatsStats {
  /**
  * Bad IP Length
  *
...
export function dataThunderIpv6FragStatsStatsToTerraform(struct?: DataThunderIpv6FragStatsStatsOutputReference | DataThunderIpv6FragStatsStats): any {
...
export function dataThunderIpv6FragStatsStatsToHclTerraform(struct?: DataThunderIpv6FragStatsStatsOutputReference | DataThunderIpv6FragStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderIpv6FragStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderIpv6FragStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderIpv6FragStatsStats | undefined) {
    if (value === undefined) {
...
export class DataThunderIpv6FragStats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ipv6_frag_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ipv6_frag_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderIpv6FragStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderIpv6FragStatsConfig = {}) {
    super(scope, id, {
  ...
  private _stats = new DataThunderIpv6FragStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderIpv6FragStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderIpv6FragStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderIpv6FragStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderIpv6FragStatsStatsList",
      },
    };
