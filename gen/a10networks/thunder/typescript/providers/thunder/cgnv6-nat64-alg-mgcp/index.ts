...
export class Cgnv6Nat64AlgMgcp extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_nat64_alg_mgcp";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_nat64_alg_mgcp", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6Nat64AlgMgcpConfig = {}
  */
  public constructor(scope: Construct, id: string, config: Cgnv6Nat64AlgMgcpConfig = {}) {
    super(scope, id, {
