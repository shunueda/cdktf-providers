// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_policy_capacity
...
export interface GslbPolicyCapacityAConfig extends cdktf.TerraformMetaArguments {
  ...
  * Enable capacity
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_policy_capacity#capacity_enable GslbPolicyCapacityA#capacity_enable}
  */
  readonly capacityEnable?: number;
  /**
  * Break when exceed threshold
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_policy_capacity#capacity_fail_break GslbPolicyCapacityA#capacity_fail_break}
  */
  readonly capacityFailBreak?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_policy_capacity#id GslbPolicyCapacityA#id}
  *
  ...
  * Policy_name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_policy_capacity#policy_name GslbPolicyCapacityA#policy_name}
  */
  readonly policyName: string;
  /**
  * Specify capacity threshold, default is 90
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_policy_capacity#threshold GslbPolicyCapacityA#threshold}
  */
  readonly threshold?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_policy_capacity#uuid GslbPolicyCapacityA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_policy_capacity thunder_gslb_policy_capacity}
*/
export class GslbPolicyCapacityA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GslbPolicyCapacityA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_policy_capacity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_policy_capacity thunder_gslb_policy_capacity} Resource
  *
  * @param scope The scope in which to define this construct
