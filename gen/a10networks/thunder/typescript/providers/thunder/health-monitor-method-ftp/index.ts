// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/health_monitor_method_ftp
...
export interface HealthMonitorMethodFtpAConfig extends cdktf.TerraformMetaArguments {
  ...
  * FTP type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/health_monitor_method_ftp#ftp HealthMonitorMethodFtpA#ftp}
  */
  readonly ftp?: number;
  /**
  * Specify the user password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/health_monitor_method_ftp#ftp_password HealthMonitorMethodFtpA#ftp_password}
  */
  readonly ftpPassword?: number;
  /**
  * Specify the user password, '' means empty password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/health_monitor_method_ftp#ftp_password_string HealthMonitorMethodFtpA#ftp_password_string}
  */
  readonly ftpPasswordString?: string;
  /**
  * Specify FTP port (Specify port number, default is 21)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/health_monitor_method_ftp#ftp_port HealthMonitorMethodFtpA#ftp_port}
  */
  readonly ftpPort?: number;
  /**
  * Specify the username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/health_monitor_method_ftp#ftp_username HealthMonitorMethodFtpA#ftp_username}
  */
  readonly ftpUsername?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/health_monitor_method_ftp#id HealthMonitorMethodFtpA#id}
  *
  ...
  * Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/health_monitor_method_ftp#name HealthMonitorMethodFtpA#name}
  */
  readonly name: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/health_monitor_method_ftp#uuid HealthMonitorMethodFtpA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/health_monitor_method_ftp thunder_health_monitor_method_ftp}
*/
export class HealthMonitorMethodFtpA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HealthMonitorMethodFtpA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/health_monitor_method_ftp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/health_monitor_method_ftp thunder_health_monitor_method_ftp} Resource
  *
  * @param scope The scope in which to define this construct
