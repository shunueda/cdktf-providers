// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces
...
export interface ScaleoutClusterLocalDeviceSessionSyncInterfacesAConfig extends cdktf.TerraformMetaArguments {
  /**
  * ClusterId
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces#cluster_id ScaleoutClusterLocalDeviceSessionSyncInterfacesA#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces#id ScaleoutClusterLocalDeviceSessionSyncInterfacesA#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces#uuid ScaleoutClusterLocalDeviceSessionSyncInterfacesA#uuid}
  */
  readonly uuid?: string;
  /**
  * eth_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces#eth_cfg ScaleoutClusterLocalDeviceSessionSyncInterfacesA#eth_cfg}
  */
  readonly ethCfg?: ScaleoutClusterLocalDeviceSessionSyncInterfacesEthCfgA[] | cdktf.IResolvable;
  /**
  * loopback_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces#loopback_cfg ScaleoutClusterLocalDeviceSessionSyncInterfacesA#loopback_cfg}
  */
  readonly loopbackCfg?: ScaleoutClusterLocalDeviceSessionSyncInterfacesLoopbackCfgA[] | cdktf.IResolvable;
  /**
  * trunk_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces#trunk_cfg ScaleoutClusterLocalDeviceSessionSyncInterfacesA#trunk_cfg}
  */
  readonly trunkCfg?: ScaleoutClusterLocalDeviceSessionSyncInterfacesTrunkCfgA[] | cdktf.IResolvable;
  /**
  * ve_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces#ve_cfg ScaleoutClusterLocalDeviceSessionSyncInterfacesA#ve_cfg}
  */
...
export interface ScaleoutClusterLocalDeviceSessionSyncInterfacesEthCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces#ethernet ScaleoutClusterLocalDeviceSessionSyncInterfacesA#ethernet}
  */
...
export interface ScaleoutClusterLocalDeviceSessionSyncInterfacesLoopbackCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces#loopback ScaleoutClusterLocalDeviceSessionSyncInterfacesA#loopback}
  */
...
export interface ScaleoutClusterLocalDeviceSessionSyncInterfacesTrunkCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces#trunk ScaleoutClusterLocalDeviceSessionSyncInterfacesA#trunk}
  */
...
export interface ScaleoutClusterLocalDeviceSessionSyncInterfacesVeCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces#ve ScaleoutClusterLocalDeviceSessionSyncInterfacesA#ve}
  */
  readonly ve?: number;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces thunder_scaleout_cluster_local_device_session_sync_interfaces}
*/
export class ScaleoutClusterLocalDeviceSessionSyncInterfacesA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_scaleout_cluster_local_device_session_sync_interfaces";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a ScaleoutClusterLocalDeviceSessionSyncInterfacesA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ScaleoutClusterLocalDeviceSessionSyncInterfacesA to import
  * @param importFromId The id of the existing ScaleoutClusterLocalDeviceSessionSyncInterfacesA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ScaleoutClusterLocalDeviceSessionSyncInterfacesA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_scaleout_cluster_local_device_session_sync_interfaces", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/scaleout_cluster_local_device_session_sync_interfaces thunder_scaleout_cluster_local_device_session_sync_interfaces} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ScaleoutClusterLocalDeviceSessionSyncInterfacesAConfig
  */
  public constructor(scope: Construct, id: string, config: ScaleoutClusterLocalDeviceSessionSyncInterfacesAConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_scaleout_cluster_local_device_session_sync_interfaces',
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      eth_cfg: cdktf.listMapper(scaleoutClusterLocalDeviceSessionSyncInterfacesEthCfgAToTerraform, true)(this._ethCfg.internalValue),
      loopback_cfg: cdktf.listMapper(scaleoutClusterLocalDeviceSessionSyncInterfacesLoopbackCfgAToTerraform, true)(this._loopbackCfg.internalValue),
      trunk_cfg: cdktf.listMapper(scaleoutClusterLocalDeviceSessionSyncInterfacesTrunkCfgAToTerraform, true)(this._trunkCfg.internalValue),
      ve_cfg: cdktf.listMapper(scaleoutClusterLocalDeviceSessionSyncInterfacesVeCfgAToTerraform, true)(this._veCfg.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      eth_cfg: {
        value: cdktf.listMapperHcl(scaleoutClusterLocalDeviceSessionSyncInterfacesEthCfgAToHclTerraform, true)(this._ethCfg.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ScaleoutClusterLocalDeviceSessionSyncInterfacesEthCfgAList",
      },
      loopback_cfg: {
        value: cdktf.listMapperHcl(scaleoutClusterLocalDeviceSessionSyncInterfacesLoopbackCfgAToHclTerraform, true)(this._loopbackCfg.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ScaleoutClusterLocalDeviceSessionSyncInterfacesLoopbackCfgAList",
      },
      trunk_cfg: {
        value: cdktf.listMapperHcl(scaleoutClusterLocalDeviceSessionSyncInterfacesTrunkCfgAToHclTerraform, true)(this._trunkCfg.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ScaleoutClusterLocalDeviceSessionSyncInterfacesTrunkCfgAList",
      },
      ve_cfg: {
        value: cdktf.listMapperHcl(scaleoutClusterLocalDeviceSessionSyncInterfacesVeCfgAToHclTerraform, true)(this._veCfg.internalValue),
        isBlock: true,
        type: "list",
