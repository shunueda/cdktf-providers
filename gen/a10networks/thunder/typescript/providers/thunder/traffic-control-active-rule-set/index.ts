...
export class TrafficControlActiveRuleSet extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_traffic_control_active_rule_set";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_traffic_control_active_rule_set", importId: importFromId, provider });
      }
  ...
  * @param options TrafficControlActiveRuleSetConfig = {}
  */
  public constructor(scope: Construct, id: string, config: TrafficControlActiveRuleSetConfig = {}) {
    super(scope, id, {
