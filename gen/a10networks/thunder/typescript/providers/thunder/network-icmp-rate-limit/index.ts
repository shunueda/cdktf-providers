// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_icmp_rate_limit
...
export interface NetworkIcmpRateLimitConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_icmp_rate_limit#icmp_lockup NetworkIcmpRateLimit#icmp_lockup}
  */
  readonly icmpLockup?: number;
  /**
  * Lockup period (second)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_icmp_rate_limit#icmp_lockup_period NetworkIcmpRateLimit#icmp_lockup_period}
  */
  readonly icmpLockupPeriod?: number;
  /**
  * Normal rate limit. If exceeds this limit, drop the ICMP packet that goes over the limit
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_icmp_rate_limit#icmp_normal_rate_limit NetworkIcmpRateLimit#icmp_normal_rate_limit}
  */
  readonly icmpNormalRateLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_icmp_rate_limit#id NetworkIcmpRateLimit#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_icmp_rate_limit#uuid NetworkIcmpRateLimit#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_icmp_rate_limit thunder_network_icmp_rate_limit}
*/
export class NetworkIcmpRateLimit extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkIcmpRateLimit that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_icmp_rate_limit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_icmp_rate_limit thunder_network_icmp_rate_limit} Resource
  *
  * @param scope The scope in which to define this construct
