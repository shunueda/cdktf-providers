...
export interface Cgnv6HttpAlgSamplingEnable {
  /**
...
export function cgnv6HttpAlgSamplingEnableToTerraform(struct?: Cgnv6HttpAlgSamplingEnable | cdktf.IResolvable): any {
...
export function cgnv6HttpAlgSamplingEnableToHclTerraform(struct?: Cgnv6HttpAlgSamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Cgnv6HttpAlgSamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Cgnv6HttpAlgSamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: Cgnv6HttpAlgSamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class Cgnv6HttpAlgSamplingEnableList extends cdktf.ComplexList {
  public internalValue? : Cgnv6HttpAlgSamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): Cgnv6HttpAlgSamplingEnableOutputReference {
    return new Cgnv6HttpAlgSamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class Cgnv6HttpAlg extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_http_alg";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_http_alg", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6HttpAlgConfig = {}
  */
  public constructor(scope: Construct, id: string, config: Cgnv6HttpAlgConfig = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new Cgnv6HttpAlgSamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: Cgnv6HttpAlgSamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(cgnv6HttpAlgSamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(cgnv6HttpAlgSamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Cgnv6HttpAlgSamplingEnableList",
      },
    };
