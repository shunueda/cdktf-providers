...
export class SlbTemplateDiameterOriginHostA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_template_diameter_origin_host";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_template_diameter_origin_host", importId: importFromId, provider });
      }
  ...
  * @param options SlbTemplateDiameterOriginHostAConfig
  */
  public constructor(scope: Construct, id: string, config: SlbTemplateDiameterOriginHostAConfig) {
    super(scope, id, {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      origin_host_name: {
        value: cdktf.stringToHclTerraform(this._originHostName),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
