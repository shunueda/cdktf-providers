...
export interface DataThunderCgnv6MapEncapsulationDomainStatsStats {
  /**
...
export function dataThunderCgnv6MapEncapsulationDomainStatsStatsToTerraform(struct?: DataThunderCgnv6MapEncapsulationDomainStatsStatsOutputReference | DataThunderCgnv6MapEncapsulationDomainStatsStats): any {
...
export function dataThunderCgnv6MapEncapsulationDomainStatsStatsToHclTerraform(struct?: DataThunderCgnv6MapEncapsulationDomainStatsStatsOutputReference | DataThunderCgnv6MapEncapsulationDomainStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderCgnv6MapEncapsulationDomainStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderCgnv6MapEncapsulationDomainStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderCgnv6MapEncapsulationDomainStatsStats | undefined) {
    if (value === undefined) {
...
export class DataThunderCgnv6MapEncapsulationDomainStats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_map_encapsulation_domain_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_map_encapsulation_domain_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderCgnv6MapEncapsulationDomainStatsConfig
  */
  public constructor(scope: Construct, id: string, config: DataThunderCgnv6MapEncapsulationDomainStatsConfig) {
    super(scope, id, {
  ...
  private _stats = new DataThunderCgnv6MapEncapsulationDomainStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderCgnv6MapEncapsulationDomainStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderCgnv6MapEncapsulationDomainStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderCgnv6MapEncapsulationDomainStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderCgnv6MapEncapsulationDomainStatsStatsList",
      },
    };
