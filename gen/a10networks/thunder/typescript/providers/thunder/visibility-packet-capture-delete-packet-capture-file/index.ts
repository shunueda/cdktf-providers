// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_delete_packet_capture_file
...
export interface VisibilityPacketCaptureDeletePacketCaptureFileAConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_delete_packet_capture_file#all VisibilityPacketCaptureDeletePacketCaptureFileA#all}
  */
  readonly all?: number;
  /**
  * Specify the name of the packet capture file to be deleted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_delete_packet_capture_file#file_name VisibilityPacketCaptureDeletePacketCaptureFileA#file_name}
  */
  readonly fileName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_delete_packet_capture_file#id VisibilityPacketCaptureDeletePacketCaptureFileA#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_delete_packet_capture_file thunder_visibility_packet_capture_delete_packet_capture_file}
*/
export class VisibilityPacketCaptureDeletePacketCaptureFileA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VisibilityPacketCaptureDeletePacketCaptureFileA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_delete_packet_capture_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_delete_packet_capture_file thunder_visibility_packet_capture_delete_packet_capture_file} Resource
  *
  * @param scope The scope in which to define this construct
