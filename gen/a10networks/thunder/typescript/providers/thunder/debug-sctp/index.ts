// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_sctp
...
export interface DebugSctpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_sctp#id DebugSctp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_sctp#level DebugSctp#level}
  */
  readonly level?: number;
  /**
  * Debug SCTP packet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_sctp#packet DebugSctp#packet}
  */
  readonly packet?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_sctp#uuid DebugSctp#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_sctp thunder_debug_sctp}
*/
export class DebugSctp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DebugSctp that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_sctp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_sctp thunder_debug_sctp} Resource
  *
  * @param scope The scope in which to define this construct
