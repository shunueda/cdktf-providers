// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats
...
export interface DataThunderFwHwAccelerateStatsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#id DataThunderFwHwAccelerateStats#id}
  *
  ...
  * stats block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#stats DataThunderFwHwAccelerateStats#stats}
  */
  readonly stats?: DataThunderFwHwAccelerateStatsStats;
}
export interface DataThunderFwHwAccelerateStatsStats {
  /**
  * HW Entries Aged Out
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_age_out DataThunderFwHwAccelerateStats#entry_age_out}
  */
  readonly entryAgeOut?: number;
  /**
  * HW Entries Aged Out - idle timeout
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_age_out_idle DataThunderFwHwAccelerateStats#entry_age_out_idle}
  */
  readonly entryAgeOutIdle?: number;
  /**
  * HW Entries Aged Out - invalid dst
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_age_out_invalid_dst DataThunderFwHwAccelerateStats#entry_age_out_invalid_dst}
  */
  readonly entryAgeOutInvalidDst?: number;
  /**
  * HW Entries Aged Out - TCP FIN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_age_out_tcp_fin DataThunderFwHwAccelerateStats#entry_age_out_tcp_fin}
  */
  readonly entryAgeOutTcpFin?: number;
  /**
  * HW Entries Aged Out - TCP RST
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_age_out_tcp_rst DataThunderFwHwAccelerateStats#entry_age_out_tcp_rst}
  */
  readonly entryAgeOutTcpRst?: number;
  /**
  * HW Entries Count
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_counter DataThunderFwHwAccelerateStats#entry_counter}
  */
  readonly entryCounter?: number;
  /**
  * HW Entries Created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_create DataThunderFwHwAccelerateStats#entry_create}
  */
  readonly entryCreate?: number;
  /**
  * HW Entry Creation Failed - max entries exceeded
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_create_fail_max_entry DataThunderFwHwAccelerateStats#entry_create_fail_max_entry}
  */
  readonly entryCreateFailMaxEntry?: number;
  /**
  * HW Entry Creation Failed - server down
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_create_fail_server_down DataThunderFwHwAccelerateStats#entry_create_fail_server_down}
  */
  readonly entryCreateFailServerDown?: number;
  /**
  * HW Entry Creation Failed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_create_failure DataThunderFwHwAccelerateStats#entry_create_failure}
  */
  readonly entryCreateFailure?: number;
  /**
  * HW Entries Force HW Invalidate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_force_hw_invalidate DataThunderFwHwAccelerateStats#entry_force_hw_invalidate}
  */
  readonly entryForceHwInvalidate?: number;
  /**
  * HW Entries Freed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_free DataThunderFwHwAccelerateStats#entry_free}
  */
  readonly entryFree?: number;
  /**
  * HW Entry Freed - no matched conn
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_free_no_conn DataThunderFwHwAccelerateStats#entry_free_no_conn}
  */
  readonly entryFreeNoConn?: number;
  /**
  * HW Entry Freed - no HW prog
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_free_no_hw_prog DataThunderFwHwAccelerateStats#entry_free_no_hw_prog}
  */
  readonly entryFreeNoHwProg?: number;
  /**
  * HW Entry Freed - no software entry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_free_no_sw_entry DataThunderFwHwAccelerateStats#entry_free_no_sw_entry}
  */
  readonly entryFreeNoSwEntry?: number;
  /**
  * HW Entries Freed - opposite tuple entry aged-out
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_free_opp_entry DataThunderFwHwAccelerateStats#entry_free_opp_entry}
  */
  readonly entryFreeOppEntry?: number;
  /**
  * HW Entries Invalidate due to server down
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#entry_invalidate_server_down DataThunderFwHwAccelerateStats#entry_invalidate_server_down}
  */
  readonly entryInvalidateServerDown?: number;
  /**
  * TCAM Flow Count
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#tcam_counter DataThunderFwHwAccelerateStats#tcam_counter}
  */
  readonly tcamCounter?: number;
  /**
  * TCAM Flows Created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#tcam_create DataThunderFwHwAccelerateStats#tcam_create}
  */
  readonly tcamCreate?: number;
  /**
  * TCAM Flows Freed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#tcam_free DataThunderFwHwAccelerateStats#tcam_free}
  */
  readonly tcamFree?: number;
}

export function dataThunderFwHwAccelerateStatsStatsToTerraform(struct?: DataThunderFwHwAccelerateStatsStatsOutputReference | DataThunderFwHwAccelerateStatsStats): any {
...
export function dataThunderFwHwAccelerateStatsStatsToHclTerraform(struct?: DataThunderFwHwAccelerateStatsStatsOutputReference | DataThunderFwHwAccelerateStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderFwHwAccelerateStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderFwHwAccelerateStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderFwHwAccelerateStatsStats | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats thunder_fw_hw_accelerate_stats}
*/
export class DataThunderFwHwAccelerateStats extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_fw_hw_accelerate_stats";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataThunderFwHwAccelerateStats resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataThunderFwHwAccelerateStats to import
  * @param importFromId The id of the existing DataThunderFwHwAccelerateStats that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataThunderFwHwAccelerateStats to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_fw_hw_accelerate_stats", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_hw_accelerate_stats thunder_fw_hw_accelerate_stats} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataThunderFwHwAccelerateStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderFwHwAccelerateStatsConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_fw_hw_accelerate_stats',
  ...
  private _stats = new DataThunderFwHwAccelerateStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderFwHwAccelerateStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderFwHwAccelerateStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderFwHwAccelerateStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderFwHwAccelerateStatsStatsList",
      },
    };
