// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_enable_traps_vcs
...
export interface SnmpServerEnableTrapsVcsAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_enable_traps_vcs#id SnmpServerEnableTrapsVcsA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_enable_traps_vcs#state_change SnmpServerEnableTrapsVcsA#state_change}
  */
  readonly stateChange?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_enable_traps_vcs#uuid SnmpServerEnableTrapsVcsA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_enable_traps_vcs thunder_snmp_server_enable_traps_vcs}
*/
export class SnmpServerEnableTrapsVcsA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnmpServerEnableTrapsVcsA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_enable_traps_vcs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_enable_traps_vcs thunder_snmp_server_enable_traps_vcs} Resource
  *
  * @param scope The scope in which to define this construct
