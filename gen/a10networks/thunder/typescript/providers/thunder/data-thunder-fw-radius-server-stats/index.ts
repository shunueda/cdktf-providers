// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats
...
export interface DataThunderFwRadiusServerStatsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#id DataThunderFwRadiusServerStats#id}
  *
  ...
  * stats block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#stats DataThunderFwRadiusServerStats#stats}
  */
  readonly stats?: DataThunderFwRadiusServerStatsStats;
}
export interface DataThunderFwRadiusServerStatsStats {
  /**
  * Custom attribute Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#custom_received DataThunderFwRadiusServerStats#custom_received}
  */
  readonly customReceived?: number;
  /**
  * HA Standby Dropped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#ha_standby_dropped DataThunderFwRadiusServerStats#ha_standby_dropped}
  */
  readonly haStandbyDropped?: number;
  /**
  * IMEI Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#imei_received DataThunderFwRadiusServerStats#imei_received}
  */
  readonly imeiReceived?: number;
  /**
  * IMSI Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#imsi_received DataThunderFwRadiusServerStats#imsi_received}
  */
  readonly imsiReceived?: number;
  /**
  * Radius Request has Invalid Key Field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#invalid_key DataThunderFwRadiusServerStats#invalid_key}
  */
  readonly invalidKey?: number;
  /**
  * Framed IPV6 Prefix Length Mismatch
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#ipv6_prefix_length_mismatch DataThunderFwRadiusServerStats#ipv6_prefix_length_mismatch}
  */
  readonly ipv6PrefixLengthMismatch?: number;
  /**
  * MSISDN Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#msisdn_received DataThunderFwRadiusServerStats#msisdn_received}
  */
  readonly msisdnReceived?: number;
  /**
  * RADIUS Request Dropped (Malformed Packet)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#radius_request_dropped DataThunderFwRadiusServerStats#radius_request_dropped}
  */
  readonly radiusRequestDropped?: number;
  /**
  * RADIUS Request Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#radius_request_received DataThunderFwRadiusServerStats#radius_request_received}
  */
  readonly radiusRequestReceived?: number;
  /**
  * RADIUS Request Dropped (Table Full)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#radius_table_full DataThunderFwRadiusServerStats#radius_table_full}
  */
  readonly radiusTableFull?: number;
  /**
  * RADIUS Request Bad Secret Dropped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#request_bad_secret_dropped DataThunderFwRadiusServerStats#request_bad_secret_dropped}
  */
  readonly requestBadSecretDropped?: number;
  /**
  * RADIUS Request Table Full Dropped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#request_ignored DataThunderFwRadiusServerStats#request_ignored}
  */
  readonly requestIgnored?: number;
  /**
  * RADIUS Request Malformed Dropped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#request_malformed_dropped DataThunderFwRadiusServerStats#request_malformed_dropped}
  */
  readonly requestMalformedDropped?: number;
  /**
  * RADIUS Request No Key Attribute Dropped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#request_no_key_vap_dropped DataThunderFwRadiusServerStats#request_no_key_vap_dropped}
  */
  readonly requestNoKeyVapDropped?: number;
  /**
  * RADIUS Secret Not Configured Dropped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#secret_not_configured_dropped DataThunderFwRadiusServerStats#secret_not_configured_dropped}
  */
  readonly secretNotConfiguredDropped?: number;
  /**
  * RADIUS SMP Created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#smp_created DataThunderFwRadiusServerStats#smp_created}
  */
  readonly smpCreated?: number;
  /**
  * RADIUS SMP Deleted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#smp_deleted DataThunderFwRadiusServerStats#smp_deleted}
  */
  readonly smpDeleted?: number;
}

export function dataThunderFwRadiusServerStatsStatsToTerraform(struct?: DataThunderFwRadiusServerStatsStatsOutputReference | DataThunderFwRadiusServerStatsStats): any {
...
export function dataThunderFwRadiusServerStatsStatsToHclTerraform(struct?: DataThunderFwRadiusServerStatsStatsOutputReference | DataThunderFwRadiusServerStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderFwRadiusServerStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderFwRadiusServerStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderFwRadiusServerStatsStats | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats thunder_fw_radius_server_stats}
*/
export class DataThunderFwRadiusServerStats extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_fw_radius_server_stats";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataThunderFwRadiusServerStats resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataThunderFwRadiusServerStats to import
  * @param importFromId The id of the existing DataThunderFwRadiusServerStats that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataThunderFwRadiusServerStats to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_fw_radius_server_stats", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_stats thunder_fw_radius_server_stats} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataThunderFwRadiusServerStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderFwRadiusServerStatsConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_fw_radius_server_stats',
  ...
  private _stats = new DataThunderFwRadiusServerStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderFwRadiusServerStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderFwRadiusServerStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderFwRadiusServerStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderFwRadiusServerStatsStatsList",
      },
    };
