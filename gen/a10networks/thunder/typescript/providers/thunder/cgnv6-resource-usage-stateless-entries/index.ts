// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_resource_usage_stateless_entries
...
export interface Cgnv6ResourceUsageStatelessEntriesAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_resource_usage_stateless_entries#id Cgnv6ResourceUsageStatelessEntriesA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_resource_usage_stateless_entries#l4_session_count Cgnv6ResourceUsageStatelessEntriesA#l4_session_count}
  */
  readonly l4SessionCount?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_resource_usage_stateless_entries#uuid Cgnv6ResourceUsageStatelessEntriesA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_resource_usage_stateless_entries thunder_cgnv6_resource_usage_stateless_entries}
*/
export class Cgnv6ResourceUsageStatelessEntriesA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cgnv6ResourceUsageStatelessEntriesA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_resource_usage_stateless_entries#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_resource_usage_stateless_entries thunder_cgnv6_resource_usage_stateless_entries} Resource
  *
  * @param scope The scope in which to define this construct
