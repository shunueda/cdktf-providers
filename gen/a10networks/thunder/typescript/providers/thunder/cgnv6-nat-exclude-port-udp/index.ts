...
export interface Cgnv6NatExcludePortUdpPortListStruct {
  /**
...
export function cgnv6NatExcludePortUdpPortListStructToTerraform(struct?: Cgnv6NatExcludePortUdpPortListStruct | cdktf.IResolvable): any {
...
export function cgnv6NatExcludePortUdpPortListStructToHclTerraform(struct?: Cgnv6NatExcludePortUdpPortListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Cgnv6NatExcludePortUdpPortListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Cgnv6NatExcludePortUdpPortListStruct | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: Cgnv6NatExcludePortUdpPortListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class Cgnv6NatExcludePortUdpPortListStructList extends cdktf.ComplexList {
  public internalValue? : Cgnv6NatExcludePortUdpPortListStruct[] | cdktf.IResolvable
  ...
  */
  public get(index: number): Cgnv6NatExcludePortUdpPortListStructOutputReference {
    return new Cgnv6NatExcludePortUdpPortListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class Cgnv6NatExcludePortUdp extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_nat_exclude_port_udp";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_nat_exclude_port_udp", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6NatExcludePortUdpConfig = {}
  */
  public constructor(scope: Construct, id: string, config: Cgnv6NatExcludePortUdpConfig = {}) {
    super(scope, id, {
  ...
  private _portList = new Cgnv6NatExcludePortUdpPortListStructList(this, "port_list", false);
  public get portList() {
    return this._portList;
  }
  public putPortList(value: Cgnv6NatExcludePortUdpPortListStruct[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      port_list: cdktf.listMapper(cgnv6NatExcludePortUdpPortListStructToTerraform, true)(this._portList.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      port_list: {
        value: cdktf.listMapperHcl(cgnv6NatExcludePortUdpPortListStructToHclTerraform, true)(this._portList.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Cgnv6NatExcludePortUdpPortListStructList",
      },
    };
