// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper
...
export interface DataThunderFwRadiusServerOperConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#id DataThunderFwRadiusServerOper#id}
  *
  ...
  * oper block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#oper DataThunderFwRadiusServerOper#oper}
  */
  readonly oper?: DataThunderFwRadiusServerOperOper;
}
export interface DataThunderFwRadiusServerOperOperRadiusTableEntriesListStruct {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#custom1_attr_value DataThunderFwRadiusServerOper#custom1_attr_value}
  */
  readonly custom1AttrValue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#custom2_attr_value DataThunderFwRadiusServerOper#custom2_attr_value}
  */
  readonly custom2AttrValue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#custom3_attr_value DataThunderFwRadiusServerOper#custom3_attr_value}
  */
  readonly custom3AttrValue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#custom4_attr_value DataThunderFwRadiusServerOper#custom4_attr_value}
  */
  readonly custom4AttrValue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#custom5_attr_value DataThunderFwRadiusServerOper#custom5_attr_value}
  */
  readonly custom5AttrValue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#custom6_attr_value DataThunderFwRadiusServerOper#custom6_attr_value}
  */
  readonly custom6AttrValue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#imei DataThunderFwRadiusServerOper#imei}
  */
  readonly imei?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#imsi DataThunderFwRadiusServerOper#imsi}
  */
  readonly imsi?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#inside_ip DataThunderFwRadiusServerOper#inside_ip}
  */
  readonly insideIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#inside_ipv6 DataThunderFwRadiusServerOper#inside_ipv6}
  */
  readonly insideIpv6?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#is_obsolete DataThunderFwRadiusServerOper#is_obsolete}
  */
  readonly isObsolete?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#msisdn DataThunderFwRadiusServerOper#msisdn}
  */
  readonly msisdn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#prefix_len DataThunderFwRadiusServerOper#prefix_len}
  */
  readonly prefixLen?: number;
}

export function dataThunderFwRadiusServerOperOperRadiusTableEntriesListStructToTerraform(struct?: DataThunderFwRadiusServerOperOperRadiusTableEntriesListStruct | cdktf.IResolvable): any {
...
export function dataThunderFwRadiusServerOperOperRadiusTableEntriesListStructToHclTerraform(struct?: DataThunderFwRadiusServerOperOperRadiusTableEntriesListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderFwRadiusServerOperOperRadiusTableEntriesListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderFwRadiusServerOperOperRadiusTableEntriesListStruct | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataThunderFwRadiusServerOperOperRadiusTableEntriesListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataThunderFwRadiusServerOperOperRadiusTableEntriesListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderFwRadiusServerOperOperRadiusTableEntriesListStruct[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataThunderFwRadiusServerOperOperRadiusTableEntriesListStructOutputReference {
    return new DataThunderFwRadiusServerOperOperRadiusTableEntriesListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataThunderFwRadiusServerOperOper {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#case_insensitive DataThunderFwRadiusServerOper#case_insensitive}
  */
  readonly caseInsensitive?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#custom_attr_name DataThunderFwRadiusServerOper#custom_attr_name}
  */
  readonly customAttrName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#custom_attr_value DataThunderFwRadiusServerOper#custom_attr_value}
  */
  readonly customAttrValue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#starts_with DataThunderFwRadiusServerOper#starts_with}
  */
  readonly startsWith?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#total_entries DataThunderFwRadiusServerOper#total_entries}
  */
  readonly totalEntries?: number;
  /**
  * radius_table_entries_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#radius_table_entries_list DataThunderFwRadiusServerOper#radius_table_entries_list}
  */
  readonly radiusTableEntriesList?: DataThunderFwRadiusServerOperOperRadiusTableEntriesListStruct[] | cdktf.IResolvable;
}

export function dataThunderFwRadiusServerOperOperToTerraform(struct?: DataThunderFwRadiusServerOperOperOutputReference | DataThunderFwRadiusServerOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    radius_table_entries_list: cdktf.listMapper(dataThunderFwRadiusServerOperOperRadiusTableEntriesListStructToTerraform, true)(struct!.radiusTableEntriesList),
  }
}


export function dataThunderFwRadiusServerOperOperToHclTerraform(struct?: DataThunderFwRadiusServerOperOperOutputReference | DataThunderFwRadiusServerOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    radius_table_entries_list: {
      value: cdktf.listMapperHcl(dataThunderFwRadiusServerOperOperRadiusTableEntriesListStructToHclTerraform, true)(struct!.radiusTableEntriesList),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderFwRadiusServerOperOperRadiusTableEntriesListStructList",
    },
  };
...
export class DataThunderFwRadiusServerOperOperOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataThunderFwRadiusServerOperOper | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataThunderFwRadiusServerOperOper | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _radiusTableEntriesList = new DataThunderFwRadiusServerOperOperRadiusTableEntriesListStructList(this, "radius_table_entries_list", false);
  public get radiusTableEntriesList() {
    return this._radiusTableEntriesList;
  }
  public putRadiusTableEntriesList(value: DataThunderFwRadiusServerOperOperRadiusTableEntriesListStruct[] | cdktf.IResolvable) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper thunder_fw_radius_server_oper}
*/
export class DataThunderFwRadiusServerOper extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_fw_radius_server_oper";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataThunderFwRadiusServerOper resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataThunderFwRadiusServerOper to import
  * @param importFromId The id of the existing DataThunderFwRadiusServerOper that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataThunderFwRadiusServerOper to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_fw_radius_server_oper", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_radius_server_oper thunder_fw_radius_server_oper} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataThunderFwRadiusServerOperConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderFwRadiusServerOperConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_fw_radius_server_oper',
  ...
  private _oper = new DataThunderFwRadiusServerOperOperOutputReference(this, "oper");
  public get oper() {
    return this._oper;
  }
  public putOper(value: DataThunderFwRadiusServerOperOper) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      oper: dataThunderFwRadiusServerOperOperToTerraform(this._oper.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      oper: {
        value: dataThunderFwRadiusServerOperOperToHclTerraform(this._oper.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderFwRadiusServerOperOperList",
      },
    };
