// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vpn_ipsec_ipsec_gateway
...
export interface VpnIpsecIpsecGatewayAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vpn_ipsec_ipsec_gateway#id VpnIpsecIpsecGatewayA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vpn_ipsec_ipsec_gateway#ike_gateway VpnIpsecIpsecGatewayA#ike_gateway}
  */
  readonly ikeGateway?: string;
  /**
  * Ipsec_name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vpn_ipsec_ipsec_gateway#ipsec_name VpnIpsecIpsecGatewayA#ipsec_name}
  */
  readonly ipsecName: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vpn_ipsec_ipsec_gateway#uuid VpnIpsecIpsecGatewayA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vpn_ipsec_ipsec_gateway thunder_vpn_ipsec_ipsec_gateway}
*/
export class VpnIpsecIpsecGatewayA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnIpsecIpsecGatewayA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vpn_ipsec_ipsec_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vpn_ipsec_ipsec_gateway thunder_vpn_ipsec_ipsec_gateway} Resource
  *
  * @param scope The scope in which to define this construct
