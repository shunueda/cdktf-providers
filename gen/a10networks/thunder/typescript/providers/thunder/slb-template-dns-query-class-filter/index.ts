// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/slb_template_dns_query_class_filter
...
export interface SlbTemplateDnsQueryClassFilterAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/slb_template_dns_query_class_filter#id SlbTemplateDnsQueryClassFilterA#id}
  *
  ...
  * Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/slb_template_dns_query_class_filter#name SlbTemplateDnsQueryClassFilterA#name}
  */
  readonly name: string;
  /**
  * 'allow': Allow only certain DNS query classes; 'deny': Deny only certain DNS query classes;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/slb_template_dns_query_class_filter#query_class_action SlbTemplateDnsQueryClassFilterA#query_class_action}
  */
  readonly queryClassAction: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/slb_template_dns_query_class_filter#uuid SlbTemplateDnsQueryClassFilterA#uuid}
  */
  readonly uuid?: string;
  /**
  * query_class block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/slb_template_dns_query_class_filter#query_class SlbTemplateDnsQueryClassFilterA#query_class}
  */
...
export interface SlbTemplateDnsQueryClassFilterQueryClassA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/slb_template_dns_query_class_filter#num_query_class SlbTemplateDnsQueryClassFilterA#num_query_class}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/slb_template_dns_query_class_filter#str_query_class SlbTemplateDnsQueryClassFilterA#str_query_class}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/slb_template_dns_query_class_filter thunder_slb_template_dns_query_class_filter}
*/
export class SlbTemplateDnsQueryClassFilterA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SlbTemplateDnsQueryClassFilterA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/slb_template_dns_query_class_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/slb_template_dns_query_class_filter thunder_slb_template_dns_query_class_filter} Resource
  *
  * @param scope The scope in which to define this construct
