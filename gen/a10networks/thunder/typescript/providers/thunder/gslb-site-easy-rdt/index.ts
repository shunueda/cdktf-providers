...
export interface GslbSiteEasyRdtAConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GslbSiteEasyRdtA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_gslb_site_easy_rdt";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_gslb_site_easy_rdt", importId: importFromId, provider });
      }
  ...
  * @param options GslbSiteEasyRdtAConfig
  */
  public constructor(scope: Construct, id: string, config: GslbSiteEasyRdtAConfig) {
    super(scope, id, {
