// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_management_index
...
export interface SnmpServerManagementIndexConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_management_index#id SnmpServerManagementIndex#id}
  *
  ...
  * index number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_management_index#mgmt_index SnmpServerManagementIndex#mgmt_index}
  */
  readonly mgmtIndex?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_management_index#uuid SnmpServerManagementIndex#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_management_index thunder_snmp_server_management_index}
*/
export class SnmpServerManagementIndex extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnmpServerManagementIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_management_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/snmp_server_management_index thunder_snmp_server_management_index} Resource
  *
  * @param scope The scope in which to define this construct
