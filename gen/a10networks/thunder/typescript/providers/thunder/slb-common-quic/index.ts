// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic
...
export interface SlbCommonQuicAConfig extends cdktf.TerraformMetaArguments {
  ...
  * Length of CID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic#cid_len SlbCommonQuicA#cid_len}
  */
  readonly cidLen?: number;
  /**
  * Offset for Encoded CPU
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic#cpu_offset SlbCommonQuicA#cpu_offset}
  */
  readonly cpuOffset?: number;
  /**
  * Enable CID Hashing
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic#enable_hash SlbCommonQuicA#enable_hash}
  */
  readonly enableHash?: number;
  /**
  * Enable CID Signature Validation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic#enable_signature SlbCommonQuicA#enable_signature}
  */
  readonly enableSignature?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic#id SlbCommonQuicA#id}
  *
  ...
  * Offset for QUIC-LB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic#quic_lb_offset SlbCommonQuicA#quic_lb_offset}
  */
  readonly quicLbOffset?: number;
  /**
  * Set CID Signature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic#signature SlbCommonQuicA#signature}
  */
  readonly signature?: string;
  /**
  * Offset for CID Signature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic#signature_len SlbCommonQuicA#signature_len}
  */
  readonly signatureLen?: number;
  /**
  * Offset for CID Signature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic#signature_offset SlbCommonQuicA#signature_offset}
  */
  readonly signatureOffset?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic#uuid SlbCommonQuicA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic thunder_slb_common_quic}
*/
export class SlbCommonQuicA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SlbCommonQuicA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_common_quic thunder_slb_common_quic} Resource
  *
  * @param scope The scope in which to define this construct
