// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_tftp
...
export interface Cgnv6Nat64AlgTftpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_tftp#id Cgnv6Nat64AlgTftp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_tftp#tftp_enable Cgnv6Nat64AlgTftp#tftp_enable}
  */
  readonly tftpEnable?: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_tftp#uuid Cgnv6Nat64AlgTftp#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_tftp thunder_cgnv6_nat64_alg_tftp}
*/
export class Cgnv6Nat64AlgTftp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cgnv6Nat64AlgTftp that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_tftp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_tftp thunder_cgnv6_nat64_alg_tftp} Resource
  *
  * @param scope The scope in which to define this construct
