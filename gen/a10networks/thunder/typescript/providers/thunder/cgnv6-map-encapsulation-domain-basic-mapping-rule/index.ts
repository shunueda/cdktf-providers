...
export interface Cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructA {
  /**
  * Length of Embedded Address (EA) bits
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_map_encapsulation_domain_basic_mapping_rule#ea_length Cgnv6MapEncapsulationDomainBasicMappingRuleA#ea_length}
...
export function cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructAToTerraform(struct?: Cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructA | cdktf.IResolvable): any {
...
export function cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructAToHclTerraform(struct?: Cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructA | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructA | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: Cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructA | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class Cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructAList extends cdktf.ComplexList {
  public internalValue? : Cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructA[] | cdktf.IResolvable
  ...
  */
  public get(index: number): Cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructAOutputReference {
    return new Cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructAOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class Cgnv6MapEncapsulationDomainBasicMappingRuleA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_map_encapsulation_domain_basic_mapping_rule";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_map_encapsulation_domain_basic_mapping_rule", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6MapEncapsulationDomainBasicMappingRuleAConfig
  */
  public constructor(scope: Construct, id: string, config: Cgnv6MapEncapsulationDomainBasicMappingRuleAConfig) {
    super(scope, id, {
  ...
  private _prefixRuleList = new Cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructAList(this, "prefix_rule_list", false);
  public get prefixRuleList() {
    return this._prefixRuleList;
  }
  public putPrefixRuleList(value: Cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructA[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      prefix_rule_list: cdktf.listMapper(cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructAToTerraform, true)(this._prefixRuleList.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      prefix_rule_list: {
        value: cdktf.listMapperHcl(cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructAToHclTerraform, true)(this._prefixRuleList.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Cgnv6MapEncapsulationDomainBasicMappingRulePrefixRuleListStructAList",
      },
    };
