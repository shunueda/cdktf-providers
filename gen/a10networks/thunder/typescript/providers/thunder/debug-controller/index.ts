// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller
...
export interface DebugControllerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Dump per-request in anomaly cases only
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#anomaly DebugController#anomaly}
  */
  readonly anomaly?: number;
  /**
  * Application service id (virtual-server_port_protocol)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#app_svc_id DebugController#app_svc_id}
  */
  readonly appSvcId?: string;
  /**
  * Debug logs for controller (error)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#error DebugController#error}
  */
  readonly error?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#id DebugController#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#logd_audit_export DebugController#logd_audit_export}
  */
  readonly logdAuditExport?: number;
  /**
  * Debug logs for controller (logd-syslog-export)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#logd_syslog_export DebugController#logd_syslog_export}
  */
  readonly logdSyslogExport?: number;
  /**
  * Debug logs for controller (metrics)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#metrics DebugController#metrics}
  */
  readonly metrics?: number;
  /**
  * UUID of the object to filter
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#object_uuid DebugController#object_uuid}
  */
  readonly objectUuid?: string;
  /**
  * Debug logs for controller (per-connection)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#per_connection DebugController#per_connection}
  */
  readonly perConnection?: number;
  /**
  * Debug logs for controller (per-request)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#per_request DebugController#per_request}
  */
  readonly perRequest?: number;
  /**
  * Debug logs for controller (registration)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#registration DebugController#registration}
  */
  readonly registration?: number;
  /**
  * URI of the object to filter
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#uri DebugController#uri}
  */
  readonly uri?: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#uuid DebugController#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller thunder_debug_controller}
*/
export class DebugController extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_debug_controller";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DebugController resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DebugController to import
  * @param importFromId The id of the existing DebugController that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DebugController to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_debug_controller", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_controller thunder_debug_controller} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DebugControllerConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DebugControllerConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_debug_controller',
