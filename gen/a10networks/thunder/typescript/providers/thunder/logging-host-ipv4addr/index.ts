// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_ipv4addr
...
export interface LoggingHostIpv4AddrConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_ipv4addr#host_ipv4 LoggingHostIpv4Addr#host_ipv4}
  */
  readonly hostIpv4: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_ipv4addr#id LoggingHostIpv4Addr#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_ipv4addr#over_tls LoggingHostIpv4Addr#over_tls}
  */
  readonly overTls?: number;
  /**
  * Set remote syslog port number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_ipv4addr#port LoggingHostIpv4Addr#port}
  */
  readonly port?: number;
  /**
  * Use TCP as transport protocol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_ipv4addr#tcp LoggingHostIpv4Addr#tcp}
  */
  readonly tcp?: number;
  /**
  * Use management port for connections
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_ipv4addr#use_mgmt_port LoggingHostIpv4Addr#use_mgmt_port}
  */
  readonly useMgmtPort?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_ipv4addr#uuid LoggingHostIpv4Addr#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_ipv4addr thunder_logging_host_ipv4addr}
*/
export class LoggingHostIpv4Addr extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingHostIpv4Addr that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_ipv4addr#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_ipv4addr thunder_logging_host_ipv4addr} Resource
  *
  * @param scope The scope in which to define this construct
