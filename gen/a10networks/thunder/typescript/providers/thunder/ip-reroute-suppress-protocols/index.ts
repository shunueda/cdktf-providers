...
export class IpRerouteSuppressProtocolsA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ip_reroute_suppress_protocols";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ip_reroute_suppress_protocols", importId: importFromId, provider });
      }
  ...
  * @param options IpRerouteSuppressProtocolsAConfig = {}
  */
  public constructor(scope: Construct, id: string, config: IpRerouteSuppressProtocolsAConfig = {}) {
    super(scope, id, {
