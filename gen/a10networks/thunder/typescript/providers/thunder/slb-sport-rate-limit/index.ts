...
export interface SlbSportRateLimitSamplingEnable {
  /**
...
export function slbSportRateLimitSamplingEnableToTerraform(struct?: SlbSportRateLimitSamplingEnable | cdktf.IResolvable): any {
...
export function slbSportRateLimitSamplingEnableToHclTerraform(struct?: SlbSportRateLimitSamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SlbSportRateLimitSamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SlbSportRateLimitSamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SlbSportRateLimitSamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SlbSportRateLimitSamplingEnableList extends cdktf.ComplexList {
  public internalValue? : SlbSportRateLimitSamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): SlbSportRateLimitSamplingEnableOutputReference {
    return new SlbSportRateLimitSamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class SlbSportRateLimit extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_sport_rate_limit";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_sport_rate_limit", importId: importFromId, provider });
      }
  ...
  * @param options SlbSportRateLimitConfig = {}
  */
  public constructor(scope: Construct, id: string, config: SlbSportRateLimitConfig = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new SlbSportRateLimitSamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: SlbSportRateLimitSamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(slbSportRateLimitSamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(slbSportRateLimitSamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "SlbSportRateLimitSamplingEnableList",
      },
    };
