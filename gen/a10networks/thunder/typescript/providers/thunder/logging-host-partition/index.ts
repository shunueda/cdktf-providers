// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_partition
...
export interface LoggingHostPartitionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_partition#id LoggingHostPartition#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_partition#partition_name LoggingHostPartition#partition_name}
  */
  readonly partitionName?: string;
  /**
  * Select shared partition
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_partition#shared LoggingHostPartition#shared}
  */
  readonly shared?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_partition#uuid LoggingHostPartition#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_partition thunder_logging_host_partition}
*/
export class LoggingHostPartition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingHostPartition that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_partition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_host_partition thunder_logging_host_partition} Resource
  *
  * @param scope The scope in which to define this construct
