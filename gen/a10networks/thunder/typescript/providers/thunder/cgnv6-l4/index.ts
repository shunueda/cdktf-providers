...
export interface Cgnv6L4SamplingEnable {
  /**
...
export function cgnv6L4SamplingEnableToTerraform(struct?: Cgnv6L4SamplingEnable | cdktf.IResolvable): any {
...
export function cgnv6L4SamplingEnableToHclTerraform(struct?: Cgnv6L4SamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Cgnv6L4SamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Cgnv6L4SamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: Cgnv6L4SamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class Cgnv6L4SamplingEnableList extends cdktf.ComplexList {
  public internalValue? : Cgnv6L4SamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): Cgnv6L4SamplingEnableOutputReference {
    return new Cgnv6L4SamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class Cgnv6L4 extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_l4";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_l4", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6L4Config = {}
  */
  public constructor(scope: Construct, id: string, config: Cgnv6L4Config = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new Cgnv6L4SamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: Cgnv6L4SamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(cgnv6L4SamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(cgnv6L4SamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Cgnv6L4SamplingEnableList",
      },
    };
