...
export interface SlbCrlSrcipSamplingEnable {
  /**
...
export function slbCrlSrcipSamplingEnableToTerraform(struct?: SlbCrlSrcipSamplingEnable | cdktf.IResolvable): any {
...
export function slbCrlSrcipSamplingEnableToHclTerraform(struct?: SlbCrlSrcipSamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SlbCrlSrcipSamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SlbCrlSrcipSamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SlbCrlSrcipSamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SlbCrlSrcipSamplingEnableList extends cdktf.ComplexList {
  public internalValue? : SlbCrlSrcipSamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): SlbCrlSrcipSamplingEnableOutputReference {
    return new SlbCrlSrcipSamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class SlbCrlSrcip extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_crl_srcip";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_crl_srcip", importId: importFromId, provider });
      }
  ...
  * @param options SlbCrlSrcipConfig = {}
  */
  public constructor(scope: Construct, id: string, config: SlbCrlSrcipConfig = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new SlbCrlSrcipSamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: SlbCrlSrcipSamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(slbCrlSrcipSamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(slbCrlSrcipSamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "SlbCrlSrcipSamplingEnableList",
      },
    };
