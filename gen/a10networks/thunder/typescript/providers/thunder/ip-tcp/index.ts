// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ip_tcp
...
export interface IpTcpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ip_tcp#id IpTcp#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ip_tcp#uuid IpTcp#uuid}
  */
  readonly uuid?: string;
  /**
  * syn_cookie block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ip_tcp#syn_cookie IpTcp#syn_cookie}
  */
...
export interface IpTcpSynCookie {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ip_tcp#sack_enable IpTcp#sack_enable}
  */
  readonly sackEnable?: number;
  /**
  * SYN cookie expire threshold (seconds (default is 4))
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ip_tcp#threshold IpTcp#threshold}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ip_tcp thunder_ip_tcp}
*/
export class IpTcp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpTcp that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ip_tcp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ip_tcp thunder_ip_tcp} Resource
  *
  * @param scope The scope in which to define this construct
