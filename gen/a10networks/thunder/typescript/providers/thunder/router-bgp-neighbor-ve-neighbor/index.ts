// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_neighbor_ve_neighbor
...
export interface RouterBgpNeighborVeNeighborConfig extends cdktf.TerraformMetaArguments {
  ...
  * AsNumber
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_neighbor_ve_neighbor#as_number RouterBgpNeighborVeNeighbor#as_number}
  */
  readonly asNumber: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_neighbor_ve_neighbor#id RouterBgpNeighborVeNeighbor#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_neighbor_ve_neighbor#peer_group_name RouterBgpNeighborVeNeighbor#peer_group_name}
  */
  readonly peerGroupName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_neighbor_ve_neighbor#unnumbered RouterBgpNeighborVeNeighbor#unnumbered}
  */
  readonly unnumbered?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_neighbor_ve_neighbor#uuid RouterBgpNeighborVeNeighbor#uuid}
  */
  readonly uuid?: string;
  /**
  * Virtual ethernet interface number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_neighbor_ve_neighbor#ve RouterBgpNeighborVeNeighbor#ve}
  */
  readonly ve: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_neighbor_ve_neighbor thunder_router_bgp_neighbor_ve_neighbor}
*/
export class RouterBgpNeighborVeNeighbor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RouterBgpNeighborVeNeighbor that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_neighbor_ve_neighbor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_neighbor_ve_neighbor thunder_router_bgp_neighbor_ve_neighbor} Resource
  *
  * @param scope The scope in which to define this construct
