// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix
...
export interface RouterRipDistributeListPrefixAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix#id RouterRipDistributeListPrefixA#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix#uuid RouterRipDistributeListPrefixA#uuid}
  */
  readonly uuid?: string;
  /**
  * prefix_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix#prefix_cfg RouterRipDistributeListPrefixA#prefix_cfg}
  */
...
export interface RouterRipDistributeListPrefixPrefixCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix#ethernet RouterRipDistributeListPrefixA#ethernet}
  */
  readonly ethernet?: number;
  /**
  * Loopback interface (Port number)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix#loopback RouterRipDistributeListPrefixA#loopback}
  */
  readonly loopback?: number;
  /**
  * Filter prefixes in routing updates (Name of a prefix list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix#prefix_list RouterRipDistributeListPrefixA#prefix_list}
  */
  readonly prefixList?: string;
  /**
  * 'in': Filter incoming routing updates; 'out': Filter outgoing routing updates;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix#prefix_list_direction RouterRipDistributeListPrefixA#prefix_list_direction}
  */
  readonly prefixListDirection?: string;
  /**
  * Trunk interface (Trunk interface number)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix#trunk RouterRipDistributeListPrefixA#trunk}
  */
  readonly trunk?: number;
  /**
  * Tunnel interface (Tunnel interface number)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix#tunnel RouterRipDistributeListPrefixA#tunnel}
  */
  readonly tunnel?: number;
  /**
  * Virtual ethernet interface (Virtual ethernet interface number)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix#ve RouterRipDistributeListPrefixA#ve}
  */
  readonly ve?: number;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix thunder_router_rip_distribute_list_prefix}
*/
export class RouterRipDistributeListPrefixA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_router_rip_distribute_list_prefix";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a RouterRipDistributeListPrefixA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the RouterRipDistributeListPrefixA to import
  * @param importFromId The id of the existing RouterRipDistributeListPrefixA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RouterRipDistributeListPrefixA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_router_rip_distribute_list_prefix", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_rip_distribute_list_prefix thunder_router_rip_distribute_list_prefix} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options RouterRipDistributeListPrefixAConfig = {}
  */
  public constructor(scope: Construct, id: string, config: RouterRipDistributeListPrefixAConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_router_rip_distribute_list_prefix',
    ...
    this._prefixCfg.internalValue = config.prefixCfg;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      prefix_cfg: cdktf.listMapper(routerRipDistributeListPrefixPrefixCfgAToTerraform, true)(this._prefixCfg.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      prefix_cfg: {
        value: cdktf.listMapperHcl(routerRipDistributeListPrefixPrefixCfgAToHclTerraform, true)(this._prefixCfg.internalValue),
        isBlock: true,
        type: "list",
