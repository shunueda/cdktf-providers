...
export interface FileAuthJwksLocalConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class FileAuthJwksLocal extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_file_auth_jwks_local";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_file_auth_jwks_local", importId: importFromId, provider });
      }
  ...
  * @param options FileAuthJwksLocalConfig = {}
  */
  public constructor(scope: Construct, id: string, config: FileAuthJwksLocalConfig = {}) {
    super(scope, id, {
