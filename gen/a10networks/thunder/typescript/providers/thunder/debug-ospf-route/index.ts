// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_route
...
export interface DebugOspfRouteAConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_route#ase DebugOspfRouteA#ase}
  */
  readonly ase?: number;
  /**
  * Inter-Area route calculation information
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_route#ia DebugOspfRouteA#ia}
  */
  readonly ia?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_route#id DebugOspfRouteA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_route#install DebugOspfRouteA#install}
  */
  readonly install?: number;
  /**
  * SPF calculation information
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_route#spf DebugOspfRouteA#spf}
  */
  readonly spf?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_route#uuid DebugOspfRouteA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_route thunder_debug_ospf_route}
*/
export class DebugOspfRouteA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DebugOspfRouteA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_route thunder_debug_ospf_route} Resource
  *
  * @param scope The scope in which to define this construct
