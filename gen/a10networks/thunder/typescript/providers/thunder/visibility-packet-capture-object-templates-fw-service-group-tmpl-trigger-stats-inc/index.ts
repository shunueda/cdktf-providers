// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/visibility_packet_capture_object_templates_fw_service_group_tmpl_trigger_stats_inc
...
export interface VisibilityPacketCaptureObjectTemplatesFwServiceGroupTmplTriggerStatsIncAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/visibility_packet_capture_object_templates_fw_service_group_tmpl_trigger_stats_inc#id VisibilityPacketCaptureObjectTemplatesFwServiceGroupTmplTriggerStatsIncA#id}
  *
  ...
  * Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/visibility_packet_capture_object_templates_fw_service_group_tmpl_trigger_stats_inc#name VisibilityPacketCaptureObjectTemplatesFwServiceGroupTmplTriggerStatsIncA#name}
  */
  readonly name: string;
  /**
  * Enable automatic packet-capture for Service selection fail reset
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/visibility_packet_capture_object_templates_fw_service_group_tmpl_trigger_stats_inc#server_selection_fail_reset VisibilityPacketCaptureObjectTemplatesFwServiceGroupTmplTriggerStatsIncA#server_selection_fail_reset}
  */
  readonly serverSelectionFailReset?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/visibility_packet_capture_object_templates_fw_service_group_tmpl_trigger_stats_inc#uuid VisibilityPacketCaptureObjectTemplatesFwServiceGroupTmplTriggerStatsIncA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/visibility_packet_capture_object_templates_fw_service_group_tmpl_trigger_stats_inc thunder_visibility_packet_capture_object_templates_fw_service_group_tmpl_trigger_stats_inc}
*/
export class VisibilityPacketCaptureObjectTemplatesFwServiceGroupTmplTriggerStatsIncA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VisibilityPacketCaptureObjectTemplatesFwServiceGroupTmplTriggerStatsIncA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/visibility_packet_capture_object_templates_fw_service_group_tmpl_trigger_stats_inc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/visibility_packet_capture_object_templates_fw_service_group_tmpl_trigger_stats_inc thunder_visibility_packet_capture_object_templates_fw_service_group_tmpl_trigger_stats_inc} Resource
  *
  * @param scope The scope in which to define this construct
