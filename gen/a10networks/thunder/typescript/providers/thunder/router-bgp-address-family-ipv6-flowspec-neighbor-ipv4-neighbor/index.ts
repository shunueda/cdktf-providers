...
export interface RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapLists {
  /**
  * 'in': in; 'out': out;
  *
...
export function routerBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapListsToTerraform(struct?: RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapLists | cdktf.IResolvable): any {
...
export function routerBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapListsToHclTerraform(struct?: RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapLists | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapListsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapLists | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapLists | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapListsList extends cdktf.ComplexList {
  public internalValue? : RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapLists[] | cdktf.IResolvable
  ...
  */
  public get(index: number): RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapListsOutputReference {
    return new RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapListsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4Neighbor extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_router_bgp_address_family_ipv6_flowspec_neighbor_ipv4_neighbor";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_router_bgp_address_family_ipv6_flowspec_neighbor_ipv4_neighbor", importId: importFromId, provider });
      }
  ...
  * @param options RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborConfig
  */
  public constructor(scope: Construct, id: string, config: RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborConfig) {
    super(scope, id, {
  ...
  private _neighborRouteMapLists = new RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapListsList(this, "neighbor_route_map_lists", false);
  public get neighborRouteMapLists() {
    return this._neighborRouteMapLists;
  }
  public putNeighborRouteMapLists(value: RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapLists[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      neighbor_route_map_lists: cdktf.listMapper(routerBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapListsToTerraform, true)(this._neighborRouteMapLists.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      neighbor_route_map_lists: {
        value: cdktf.listMapperHcl(routerBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapListsToHclTerraform, true)(this._neighborRouteMapLists.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "RouterBgpAddressFamilyIpv6FlowspecNeighborIpv4NeighborNeighborRouteMapListsList",
      },
    };
