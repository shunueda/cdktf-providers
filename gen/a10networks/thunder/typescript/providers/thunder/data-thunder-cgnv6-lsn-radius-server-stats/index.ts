// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats
...
export interface DataThunderCgnv6LsnRadiusServerStatsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#id DataThunderCgnv6LsnRadiusServerStats#id}
  *
  ...
  * stats block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#stats DataThunderCgnv6LsnRadiusServerStats#stats}
  */
  readonly stats?: DataThunderCgnv6LsnRadiusServerStatsStats;
}
export interface DataThunderCgnv6LsnRadiusServerStatsStats {
  /**
  * Custom attribute Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#custom_received DataThunderCgnv6LsnRadiusServerStats#custom_received}
  */
  readonly customReceived?: number;
  /**
  * HA Standby Dropped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#ha_standby_dropped DataThunderCgnv6LsnRadiusServerStats#ha_standby_dropped}
  */
  readonly haStandbyDropped?: number;
  /**
  * IMEI Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#imei_received DataThunderCgnv6LsnRadiusServerStats#imei_received}
  */
  readonly imeiReceived?: number;
  /**
  * IMSI Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#imsi_received DataThunderCgnv6LsnRadiusServerStats#imsi_received}
  */
  readonly imsiReceived?: number;
  /**
  * Radius Request has Invalid Key Field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#invalid_key DataThunderCgnv6LsnRadiusServerStats#invalid_key}
  */
  readonly invalidKey?: number;
  /**
  * Framed IPV6 Prefix Length Mismatch
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#ipv6_prefix_length_mismatch DataThunderCgnv6LsnRadiusServerStats#ipv6_prefix_length_mismatch}
  */
  readonly ipv6PrefixLengthMismatch?: number;
  /**
  * MSISDN Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#msisdn_received DataThunderCgnv6LsnRadiusServerStats#msisdn_received}
  */
  readonly msisdnReceived?: number;
  /**
  * RADIUS Request Dropped (Malformed Packet)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#radius_request_dropped DataThunderCgnv6LsnRadiusServerStats#radius_request_dropped}
  */
  readonly radiusRequestDropped?: number;
  /**
  * RADIUS Request Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#radius_request_received DataThunderCgnv6LsnRadiusServerStats#radius_request_received}
  */
  readonly radiusRequestReceived?: number;
  /**
  * RADIUS Request Dropped (Table Full)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#radius_table_full DataThunderCgnv6LsnRadiusServerStats#radius_table_full}
  */
  readonly radiusTableFull?: number;
  /**
  * RADIUS Request Bad Secret Dropped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#request_bad_secret_dropped DataThunderCgnv6LsnRadiusServerStats#request_bad_secret_dropped}
  */
  readonly requestBadSecretDropped?: number;
  /**
  * RADIUS Request Ignored
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#request_ignored DataThunderCgnv6LsnRadiusServerStats#request_ignored}
  */
  readonly requestIgnored?: number;
  /**
  * RADIUS Request Malformed Dropped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#request_malformed_dropped DataThunderCgnv6LsnRadiusServerStats#request_malformed_dropped}
  */
  readonly requestMalformedDropped?: number;
  /**
  * RADIUS Request No Key Attribute Dropped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#request_no_key_vap_dropped DataThunderCgnv6LsnRadiusServerStats#request_no_key_vap_dropped}
  */
  readonly requestNoKeyVapDropped?: number;
  /**
  * RADIUS Secret Not Configured Dropped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#secret_not_configured_dropped DataThunderCgnv6LsnRadiusServerStats#secret_not_configured_dropped}
  */
  readonly secretNotConfiguredDropped?: number;
  /**
  * RADIUS SMP Created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#smp_created DataThunderCgnv6LsnRadiusServerStats#smp_created}
  */
  readonly smpCreated?: number;
  /**
  * RADIUS SMP Deleted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#smp_deleted DataThunderCgnv6LsnRadiusServerStats#smp_deleted}
  */
  readonly smpDeleted?: number;
}

export function dataThunderCgnv6LsnRadiusServerStatsStatsToTerraform(struct?: DataThunderCgnv6LsnRadiusServerStatsStatsOutputReference | DataThunderCgnv6LsnRadiusServerStatsStats): any {
  ...
  return {
    ...
    smp_created: cdktf.numberToTerraform(struct!.smpCreated),
    smp_deleted: cdktf.numberToTerraform(struct!.smpDeleted),
  }
}


export function dataThunderCgnv6LsnRadiusServerStatsStatsToHclTerraform(struct?: DataThunderCgnv6LsnRadiusServerStatsStatsOutputReference | DataThunderCgnv6LsnRadiusServerStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    smp_created: {
      value: cdktf.numberToHclTerraform(struct!.smpCreated),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    smp_deleted: {
      value: cdktf.numberToHclTerraform(struct!.smpDeleted),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
...
export class DataThunderCgnv6LsnRadiusServerStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderCgnv6LsnRadiusServerStatsStats | undefined {
    ...
    if (this._smpCreated !== undefined) {
      hasAnyValues = true;
      internalValueResult.smpCreated = this._smpCreated;
    }
    if (this._smpDeleted !== undefined) {
      hasAnyValues = true;
      internalValueResult.smpDeleted = this._smpDeleted;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataThunderCgnv6LsnRadiusServerStatsStats | undefined) {
    if (value === undefined) {
      ...
      this._smpCreated = undefined;
      this._smpDeleted = undefined;
    }
    else {
      ...
      this._smpCreated = value.smpCreated;
      this._smpDeleted = value.smpDeleted;
    }
  }
  ...
  // smp_created - computed: false, optional: true, required: false
  private _smpCreated?: number; 
  public get smpCreated() {
    return this.getNumberAttribute('smp_created');
  }
  public set smpCreated(value: number) {
    this._smpCreated = value;
  }
  public resetSmpCreated() {
    this._smpCreated = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get smpCreatedInput() {
    return this._smpCreated;
  }

  // smp_deleted - computed: false, optional: true, required: false
  private _smpDeleted?: number; 
  public get smpDeleted() {
    return this.getNumberAttribute('smp_deleted');
  }
  public set smpDeleted(value: number) {
    this._smpDeleted = value;
  }
  public resetSmpDeleted() {
    this._smpDeleted = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get smpDeletedInput() {
    return this._smpDeleted;
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats thunder_cgnv6_lsn_radius_server_stats}
*/
export class DataThunderCgnv6LsnRadiusServerStats extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_lsn_radius_server_stats";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataThunderCgnv6LsnRadiusServerStats resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataThunderCgnv6LsnRadiusServerStats to import
  * @param importFromId The id of the existing DataThunderCgnv6LsnRadiusServerStats that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataThunderCgnv6LsnRadiusServerStats to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_lsn_radius_server_stats", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/cgnv6_lsn_radius_server_stats thunder_cgnv6_lsn_radius_server_stats} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataThunderCgnv6LsnRadiusServerStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderCgnv6LsnRadiusServerStatsConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_cgnv6_lsn_radius_server_stats',
  ...
  private _stats = new DataThunderCgnv6LsnRadiusServerStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderCgnv6LsnRadiusServerStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderCgnv6LsnRadiusServerStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderCgnv6LsnRadiusServerStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderCgnv6LsnRadiusServerStatsStatsList",
      },
    };
