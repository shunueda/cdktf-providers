...
export function systemPbslbSamplingEnableAToTerraform(struct?: SystemPbslbSamplingEnableA | cdktf.IResolvable): any {
...
export function systemPbslbSamplingEnableAToHclTerraform(struct?: SystemPbslbSamplingEnableA | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SystemPbslbSamplingEnableAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SystemPbslbSamplingEnableA | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SystemPbslbSamplingEnableA | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SystemPbslbSamplingEnableAList extends cdktf.ComplexList {
  public internalValue? : SystemPbslbSamplingEnableA[] | cdktf.IResolvable
  ...
  */
  public get(index: number): SystemPbslbSamplingEnableAOutputReference {
    return new SystemPbslbSamplingEnableAOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class SystemPbslbA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_system_pbslb";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_system_pbslb", importId: importFromId, provider });
      }
  ...
  * @param options SystemPbslbAConfig = {}
  */
  public constructor(scope: Construct, id: string, config: SystemPbslbAConfig = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new SystemPbslbSamplingEnableAList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: SystemPbslbSamplingEnableA[] | cdktf.IResolvable) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(systemPbslbSamplingEnableAToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "SystemPbslbSamplingEnableAList",
      },
    };
