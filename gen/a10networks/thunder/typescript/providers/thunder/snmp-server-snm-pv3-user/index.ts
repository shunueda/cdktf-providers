...
export interface SnmpServerSnmPv3UserConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class SnmpServerSnmPv3User extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_snmp_server_SNMPv3_user";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_snmp_server_SNMPv3_user", importId: importFromId, provider });
      }
  ...
  * @param options SnmpServerSnmPv3UserConfig
  */
  public constructor(scope: Construct, id: string, config: SnmpServerSnmPv3UserConfig) {
    super(scope, id, {
