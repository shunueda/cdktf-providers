...
export interface VisibilityPacketCaptureObjectTemplatesInterfaceTunnelTmplTriggerStatsSeverityAConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_object_templates_interface_tunnel_tmpl_trigger_stats_severity#drop VisibilityPacketCaptureObjectTemplatesInterfaceTunnelTmplTriggerStatsSeverityA#drop}
  */
  readonly drop?: number;
  /**
  * Enable packet capture on all alert drop counters (Default disabled)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_object_templates_interface_tunnel_tmpl_trigger_stats_severity#drop_alert VisibilityPacketCaptureObjectTemplatesInterfaceTunnelTmplTriggerStatsSeverityA#drop_alert}
  */
  readonly dropAlert?: number;
  /**
  * Enable packet capture on all critical drop counters (Default disabled)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_object_templates_interface_tunnel_tmpl_trigger_stats_severity#drop_critical VisibilityPacketCaptureObjectTemplatesInterfaceTunnelTmplTriggerStatsSeverityA#drop_critical}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_object_templates_interface_tunnel_tmpl_trigger_stats_severity#error VisibilityPacketCaptureObjectTemplatesInterfaceTunnelTmplTriggerStatsSeverityA#error}
  */
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_object_templates_interface_tunnel_tmpl_trigger_stats_severity#id VisibilityPacketCaptureObjectTemplatesInterfaceTunnelTmplTriggerStatsSeverityA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_object_templates_interface_tunnel_tmpl_trigger_stats_severity#interface_tunnel_tmpl_name VisibilityPacketCaptureObjectTemplatesInterfaceTunnelTmplTriggerStatsSeverityA#interface_tunnel_tmpl_name}
  */
  readonly interfaceTunnelTmplName: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_object_templates_interface_tunnel_tmpl_trigger_stats_severity#uuid VisibilityPacketCaptureObjectTemplatesInterfaceTunnelTmplTriggerStatsSeverityA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_object_templates_interface_tunnel_tmpl_trigger_stats_severity thunder_visibility_packet_capture_object_templates_interface_tunnel_tmpl_trigger_stats_severity}
*/
export class VisibilityPacketCaptureObjectTemplatesInterfaceTunnelTmplTriggerStatsSeverityA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VisibilityPacketCaptureObjectTemplatesInterfaceTunnelTmplTriggerStatsSeverityA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_object_templates_interface_tunnel_tmpl_trigger_stats_severity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_object_templates_interface_tunnel_tmpl_trigger_stats_severity thunder_visibility_packet_capture_object_templates_interface_tunnel_tmpl_trigger_stats_severity} Resource
  *
  * @param scope The scope in which to define this construct
