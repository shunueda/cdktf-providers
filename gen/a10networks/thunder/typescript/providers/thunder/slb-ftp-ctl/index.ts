...
export interface SlbFtpCtlSamplingEnable {
  /**
...
export function slbFtpCtlSamplingEnableToTerraform(struct?: SlbFtpCtlSamplingEnable | cdktf.IResolvable): any {
...
export function slbFtpCtlSamplingEnableToHclTerraform(struct?: SlbFtpCtlSamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SlbFtpCtlSamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SlbFtpCtlSamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SlbFtpCtlSamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SlbFtpCtlSamplingEnableList extends cdktf.ComplexList {
  public internalValue? : SlbFtpCtlSamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): SlbFtpCtlSamplingEnableOutputReference {
    return new SlbFtpCtlSamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class SlbFtpCtl extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_ftp_ctl";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_ftp_ctl", importId: importFromId, provider });
      }
  ...
  * @param options SlbFtpCtlConfig = {}
  */
  public constructor(scope: Construct, id: string, config: SlbFtpCtlConfig = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new SlbFtpCtlSamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: SlbFtpCtlSamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(slbFtpCtlSamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(slbFtpCtlSamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "SlbFtpCtlSamplingEnableList",
      },
    };
