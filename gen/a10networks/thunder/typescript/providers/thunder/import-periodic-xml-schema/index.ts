// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_xml_schema
...
export interface ImportPeriodicXmlSchemaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_xml_schema#id ImportPeriodicXmlSchema#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_xml_schema#period ImportPeriodicXmlSchema#period}
  */
  readonly period?: number;
  /**
  * profile name for remote url
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_xml_schema#remote_file ImportPeriodicXmlSchema#remote_file}
  */
  readonly remoteFile?: string;
  /**
  * Use management port as source port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_xml_schema#use_mgmt_port ImportPeriodicXmlSchema#use_mgmt_port}
  */
  readonly useMgmtPort?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_xml_schema#uuid ImportPeriodicXmlSchema#uuid}
  */
  readonly uuid?: string;
  /**
  * XML-Schema File
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_xml_schema#xml_schema ImportPeriodicXmlSchema#xml_schema}
  */
  readonly xmlSchema: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_xml_schema thunder_import_periodic_xml_schema}
*/
export class ImportPeriodicXmlSchema extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImportPeriodicXmlSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_xml_schema#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_xml_schema thunder_import_periodic_xml_schema} Resource
  *
  * @param scope The scope in which to define this construct
