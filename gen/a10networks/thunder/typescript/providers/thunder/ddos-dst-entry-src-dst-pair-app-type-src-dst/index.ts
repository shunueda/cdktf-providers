...
export interface DdosDstEntrySrcDstPairAppTypeSrcDstConfig extends cdktf.TerraformMetaArguments {
  /**
  * DstEntryName
  *
...
export interface DdosDstEntrySrcDstPairAppTypeSrcDstTemplate {
  /**
  * DDOS dns template
  *
...
export function ddosDstEntrySrcDstPairAppTypeSrcDstTemplateToTerraform(struct?: DdosDstEntrySrcDstPairAppTypeSrcDstTemplateOutputReference | DdosDstEntrySrcDstPairAppTypeSrcDstTemplate): any {
...
export function ddosDstEntrySrcDstPairAppTypeSrcDstTemplateToHclTerraform(struct?: DdosDstEntrySrcDstPairAppTypeSrcDstTemplateOutputReference | DdosDstEntrySrcDstPairAppTypeSrcDstTemplate): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DdosDstEntrySrcDstPairAppTypeSrcDstTemplateOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DdosDstEntrySrcDstPairAppTypeSrcDstTemplate | undefined {
  ...
  public set internalValue(value: DdosDstEntrySrcDstPairAppTypeSrcDstTemplate | undefined) {
    if (value === undefined) {
...
export class DdosDstEntrySrcDstPairAppTypeSrcDst extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_dst_entry_src_dst_pair_app_type_src_dst";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_dst_entry_src_dst_pair_app_type_src_dst", importId: importFromId, provider });
      }
  ...
  * @param options DdosDstEntrySrcDstPairAppTypeSrcDstConfig
  */
  public constructor(scope: Construct, id: string, config: DdosDstEntrySrcDstPairAppTypeSrcDstConfig) {
    super(scope, id, {
  ...
  private _template = new DdosDstEntrySrcDstPairAppTypeSrcDstTemplateOutputReference(this, "template");
  public get template() {
    return this._template;
  }
  public putTemplate(value: DdosDstEntrySrcDstPairAppTypeSrcDstTemplate) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      template: ddosDstEntrySrcDstPairAppTypeSrcDstTemplateToTerraform(this._template.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      template: {
        value: ddosDstEntrySrcDstPairAppTypeSrcDstTemplateToHclTerraform(this._template.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DdosDstEntrySrcDstPairAppTypeSrcDstTemplateList",
      },
    };
