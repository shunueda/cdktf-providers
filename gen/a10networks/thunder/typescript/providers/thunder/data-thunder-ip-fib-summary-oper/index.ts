...
export function dataThunderIpFibSummaryOperOperToTerraform(struct?: DataThunderIpFibSummaryOperOperOutputReference | DataThunderIpFibSummaryOperOper): any {
...
export function dataThunderIpFibSummaryOperOperToHclTerraform(struct?: DataThunderIpFibSummaryOperOperOutputReference | DataThunderIpFibSummaryOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderIpFibSummaryOperOperOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderIpFibSummaryOperOper | undefined {
  ...
  public set internalValue(value: DataThunderIpFibSummaryOperOper | undefined) {
    if (value === undefined) {
...
export class DataThunderIpFibSummaryOper extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ip_fib_summary_oper";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ip_fib_summary_oper", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderIpFibSummaryOperConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderIpFibSummaryOperConfig = {}) {
    super(scope, id, {
  ...
  private _oper = new DataThunderIpFibSummaryOperOperOutputReference(this, "oper");
  public get oper() {
    return this._oper;
  }
  public putOper(value: DataThunderIpFibSummaryOperOper) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      oper: dataThunderIpFibSummaryOperOperToTerraform(this._oper.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      oper: {
        value: dataThunderIpFibSummaryOperOperToHclTerraform(this._oper.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderIpFibSummaryOperOperList",
      },
    };
