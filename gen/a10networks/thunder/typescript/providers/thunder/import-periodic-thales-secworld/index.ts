...
export class ImportPeriodicThalesSecworld extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_import_periodic_thales_secworld";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_import_periodic_thales_secworld", importId: importFromId, provider });
      }
  ...
  * @param options ImportPeriodicThalesSecworldConfig
  */
  public constructor(scope: Construct, id: string, config: ImportPeriodicThalesSecworldConfig) {
    super(scope, id, {
  ...
  // thales_secworld - computed: false, optional: false, required: true
