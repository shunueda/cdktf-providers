// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip
...
export interface InterfaceVeIpRipAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#id InterfaceVeIpRipA#id}
  *
  ...
  * Ifnum
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#ifnum InterfaceVeIpRipA#ifnum}
  */
  readonly ifnum: string;
  /**
  * Enable receiving packet through the specified interface
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#receive_packet InterfaceVeIpRipA#receive_packet}
  */
  readonly receivePacket?: number;
  /**
  * Enable sending packets through the specified interface
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#send_packet InterfaceVeIpRipA#send_packet}
  */
  readonly sendPacket?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#uuid InterfaceVeIpRipA#uuid}
  */
  readonly uuid?: string;
  /**
  * authentication block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#authentication InterfaceVeIpRipA#authentication}
  */
  readonly authentication?: InterfaceVeIpRipAuthenticationA;
  /**
  * receive_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#receive_cfg InterfaceVeIpRipA#receive_cfg}
  */
  readonly receiveCfg?: InterfaceVeIpRipReceiveCfgA;
  /**
  * send_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#send_cfg InterfaceVeIpRipA#send_cfg}
  */
  readonly sendCfg?: InterfaceVeIpRipSendCfgA;
  /**
  * split_horizon_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#split_horizon_cfg InterfaceVeIpRipA#split_horizon_cfg}
  */
...
export interface InterfaceVeIpRipAuthenticationKeyChainA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#key_chain InterfaceVeIpRipA#key_chain}
  */
...
export interface InterfaceVeIpRipAuthenticationModeA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#mode InterfaceVeIpRipA#mode}
  */
...
export interface InterfaceVeIpRipAuthenticationStrA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#string InterfaceVeIpRipA#string}
  */
...
export interface InterfaceVeIpRipAuthenticationA {
  ...
  * str block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#str InterfaceVeIpRipA#str}
  */
...
export interface InterfaceVeIpRipReceiveCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#receive InterfaceVeIpRipA#receive}
  */
  readonly receive?: number;
  /**
  * '1': RIP version 1; '2': RIP version 2; '1-2': RIP version 1 & 2;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#version InterfaceVeIpRipA#version}
  */
...
export interface InterfaceVeIpRipSendCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#send InterfaceVeIpRipA#send}
  */
...
export interface InterfaceVeIpRipSplitHorizonCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#state InterfaceVeIpRipA#state}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip thunder_interface_ve_ip_rip}
*/
export class InterfaceVeIpRipA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_interface_ve_ip_rip";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a InterfaceVeIpRipA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the InterfaceVeIpRipA to import
  * @param importFromId The id of the existing InterfaceVeIpRipA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the InterfaceVeIpRipA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_interface_ve_ip_rip", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_ve_ip_rip thunder_interface_ve_ip_rip} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options InterfaceVeIpRipAConfig
  */
  public constructor(scope: Construct, id: string, config: InterfaceVeIpRipAConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_interface_ve_ip_rip',
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      authentication: interfaceVeIpRipAuthenticationAToTerraform(this._authentication.internalValue),
      receive_cfg: interfaceVeIpRipReceiveCfgAToTerraform(this._receiveCfg.internalValue),
      send_cfg: interfaceVeIpRipSendCfgAToTerraform(this._sendCfg.internalValue),
      split_horizon_cfg: interfaceVeIpRipSplitHorizonCfgAToTerraform(this._splitHorizonCfg.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      authentication: {
        value: interfaceVeIpRipAuthenticationAToHclTerraform(this._authentication.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "InterfaceVeIpRipAuthenticationAList",
      },
      receive_cfg: {
        value: interfaceVeIpRipReceiveCfgAToHclTerraform(this._receiveCfg.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "InterfaceVeIpRipReceiveCfgAList",
      },
      send_cfg: {
        value: interfaceVeIpRipSendCfgAToHclTerraform(this._sendCfg.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "InterfaceVeIpRipSendCfgAList",
      },
      split_horizon_cfg: {
        value: interfaceVeIpRipSplitHorizonCfgAToHclTerraform(this._splitHorizonCfg.internalValue),
        isBlock: true,
        type: "list",
