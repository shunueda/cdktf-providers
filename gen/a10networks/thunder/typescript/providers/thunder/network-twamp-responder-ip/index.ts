// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_twamp_responder_ip
...
export interface NetworkTwampResponderIpAConfig extends cdktf.TerraformMetaArguments {
  ...
  * ACL id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_twamp_responder_ip#acl_id NetworkTwampResponderIpA#acl_id}
  */
  readonly aclId?: number;
  /**
  * Apply a named access list (Access List name)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_twamp_responder_ip#acl_name NetworkTwampResponderIpA#acl_name}
  */
  readonly aclName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_twamp_responder_ip#id NetworkTwampResponderIpA#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_twamp_responder_ip#uuid NetworkTwampResponderIpA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_twamp_responder_ip thunder_network_twamp_responder_ip}
*/
export class NetworkTwampResponderIpA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkTwampResponderIpA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_twamp_responder_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_twamp_responder_ip thunder_network_twamp_responder_ip} Resource
  *
  * @param scope The scope in which to define this construct
