// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/chassis_infra
...
export interface ChassisInfraConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/chassis_infra#debug_disable ChassisInfra#debug_disable}
  */
  readonly debugDisable?: number;
  /**
  * Enable chassis infrastruture debugging
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/chassis_infra#debug_enable ChassisInfra#debug_enable}
  */
  readonly debugEnable?: number;
  /**
  * Show chassis infrastruture debugging status
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/chassis_infra#debug_status ChassisInfra#debug_status}
  */
  readonly debugStatus?: number;
  /**
  * Give Chassis filesystem info( USED BY TAC ONLY )
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/chassis_infra#detailed ChassisInfra#detailed}
  */
  readonly detailed?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/chassis_infra#id ChassisInfra#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/chassis_infra#sys_sync ChassisInfra#sys_sync}
  */
  readonly sysSync?: number;
  /**
  * Validate chassis filesytem synchronization status (For A10 TAC Use Only)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/chassis_infra#system_sync_verify ChassisInfra#system_sync_verify}
  */
  readonly systemSyncVerify?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/chassis_infra thunder_chassis_infra}
*/
export class ChassisInfra extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChassisInfra that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/chassis_infra#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/chassis_infra thunder_chassis_infra} Resource
  *
  * @param scope The scope in which to define this construct
