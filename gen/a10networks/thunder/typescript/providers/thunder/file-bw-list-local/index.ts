...
export interface FileBwListLocalConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class FileBwListLocal extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_file_bw_list_local";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_file_bw_list_local", importId: importFromId, provider });
      }
  ...
  * @param options FileBwListLocalConfig = {}
  */
  public constructor(scope: Construct, id: string, config: FileBwListLocalConfig = {}) {
    super(scope, id, {
