// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global
...
export interface FwGlobalConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#alg_processing FwGlobal#alg_processing}
  */
  readonly algProcessing?: string;
  /**
  * Allow TCP non-syn packets to trigger session creation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#allow_non_syn_session_create FwGlobal#allow_non_syn_session_create}
  */
  readonly allowNonSynSessionCreate?: number;
  /**
  * Disable exporting application protocol/category statistics to Harmony Controller
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#disable_application_metrics FwGlobal#disable_application_metrics}
  */
  readonly disableApplicationMetrics?: number;
  /**
  * disable create sessions for non TCP/UDP/ICMP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#disable_ip_fw_sessions FwGlobal#disable_ip_fw_sessions}
  */
  readonly disableIpFwSessions?: number;
  /**
  * disable logs with undetermined rules
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#disable_undetermined_rule_logs FwGlobal#disable_undetermined_rule_logs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#dsr_mode_support FwGlobal#dsr_mode_support}
  */
  readonly dsrModeSupport?: string;
  /**
  * 'disable': Disable extended matching;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#extended_matching FwGlobal#extended_matching}
  */
  readonly extendedMatching?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#id FwGlobal#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#inbound_refresh FwGlobal#inbound_refresh}
  */
  readonly inboundRefresh?: string;
  /**
  * 'enable': enable; 'disable': disable;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#inbound_refresh_full_cone FwGlobal#inbound_refresh_full_cone}
  */
  readonly inboundRefreshFullCone?: string;
  /**
  * STUN timeout (default: 2 minutes)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#listen_on_port_timeout FwGlobal#listen_on_port_timeout}
  */
  readonly listenOnPortTimeout?: number;
  /**
  * 'enable': Enable; 'disable': Disable;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#natip_ddos_protection FwGlobal#natip_ddos_protection}
  */
  readonly natipDdosProtection?: string;
  /**
  * 'forward': Forward; 'next-service-mode': Service to be applied chosen based on configuration;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#permit_default_action FwGlobal#permit_default_action}
  */
  readonly permitDefaultAction?: string;
  /**
  * Use the user's source MAC for the next hop rather than the routing table (default: off)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#respond_to_user_mac FwGlobal#respond_to_user_mac}
  */
  readonly respondToUserMac?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#uuid FwGlobal#uuid}
  */
  readonly uuid?: string;
  /**
  * disable_app_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#disable_app_list FwGlobal#disable_app_list}
  */
  readonly disableAppList?: FwGlobalDisableAppListStruct[] | cdktf.IResolvable;
  /**
  * sampling_enable block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#sampling_enable FwGlobal#sampling_enable}
  */
...
export interface FwGlobalDisableAppListStruct {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#disable_application_category FwGlobal#disable_application_category}
  */
  readonly disableApplicationCategory?: string;
  /**
  * Disable specific application protocol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#disable_application_protocol FwGlobal#disable_application_protocol}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global thunder_fw_global}
*/
export class FwGlobal extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FwGlobal that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/fw_global thunder_fw_global} Resource
  *
  * @param scope The scope in which to define this construct
