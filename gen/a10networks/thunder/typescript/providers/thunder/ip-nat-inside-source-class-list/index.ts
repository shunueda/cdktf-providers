...
export class IpNatInsideSourceClassList extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ip_nat_inside_source_class_list";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ip_nat_inside_source_class_list", importId: importFromId, provider });
      }
  ...
  * @param options IpNatInsideSourceClassListConfig = {}
  */
  public constructor(scope: Construct, id: string, config: IpNatInsideSourceClassListConfig = {}) {
    super(scope, id, {
