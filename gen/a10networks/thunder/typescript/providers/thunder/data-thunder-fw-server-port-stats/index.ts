...
export interface DataThunderFwServerPortStatsStats {
  /**
  * Current connections
  *
...
export function dataThunderFwServerPortStatsStatsToTerraform(struct?: DataThunderFwServerPortStatsStatsOutputReference | DataThunderFwServerPortStatsStats): any {
...
export function dataThunderFwServerPortStatsStatsToHclTerraform(struct?: DataThunderFwServerPortStatsStatsOutputReference | DataThunderFwServerPortStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderFwServerPortStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderFwServerPortStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderFwServerPortStatsStats | undefined) {
    if (value === undefined) {
...
export class DataThunderFwServerPortStats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_fw_server_port_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_fw_server_port_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderFwServerPortStatsConfig
  */
  public constructor(scope: Construct, id: string, config: DataThunderFwServerPortStatsConfig) {
    super(scope, id, {
  ...
  public putStats(value: DataThunderFwServerPortStatsStats) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderFwServerPortStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderFwServerPortStatsStatsList",
      },
    };
