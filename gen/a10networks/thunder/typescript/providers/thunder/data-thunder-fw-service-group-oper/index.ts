// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper
...
export interface DataThunderFwServiceGroupOperConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#id DataThunderFwServiceGroupOper#id}
  *
  ...
  * FW Service Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#name DataThunderFwServiceGroupOper#name}
  */
  readonly name: string;
  /**
  * member_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#member_list DataThunderFwServiceGroupOper#member_list}
  */
  readonly memberList?: DataThunderFwServiceGroupOperMemberListStruct[] | cdktf.IResolvable;
  /**
  * oper block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#oper DataThunderFwServiceGroupOper#oper}
  */
  readonly oper?: DataThunderFwServiceGroupOperOper;
}
export interface DataThunderFwServiceGroupOperMemberListOperAltListStruct {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#alt_curr_conn DataThunderFwServiceGroupOper#alt_curr_conn}
  */
  readonly altCurrConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#alt_fwd_pkts DataThunderFwServiceGroupOper#alt_fwd_pkts}
  */
  readonly altFwdPkts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#alt_name DataThunderFwServiceGroupOper#alt_name}
  */
  readonly altName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#alt_peak_conn DataThunderFwServiceGroupOper#alt_peak_conn}
  */
  readonly altPeakConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#alt_port DataThunderFwServiceGroupOper#alt_port}
  */
  readonly altPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#alt_rev_pkts DataThunderFwServiceGroupOper#alt_rev_pkts}
  */
  readonly altRevPkts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#alt_state DataThunderFwServiceGroupOper#alt_state}
  */
  readonly altState?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#alt_total_conn DataThunderFwServiceGroupOper#alt_total_conn}
  */
  readonly altTotalConn?: number;
}

export function dataThunderFwServiceGroupOperMemberListOperAltListStructToTerraform(struct?: DataThunderFwServiceGroupOperMemberListOperAltListStruct | cdktf.IResolvable): any {
...
export function dataThunderFwServiceGroupOperMemberListOperAltListStructToHclTerraform(struct?: DataThunderFwServiceGroupOperMemberListOperAltListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderFwServiceGroupOperMemberListOperAltListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderFwServiceGroupOperMemberListOperAltListStruct | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataThunderFwServiceGroupOperMemberListOperAltListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataThunderFwServiceGroupOperMemberListOperAltListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderFwServiceGroupOperMemberListOperAltListStruct[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataThunderFwServiceGroupOperMemberListOperAltListStructOutputReference {
    return new DataThunderFwServiceGroupOperMemberListOperAltListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataThunderFwServiceGroupOperMemberListOperDrsListStruct {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_curr_conn DataThunderFwServiceGroupOper#drs_curr_conn}
  */
  readonly drsCurrConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_curr_req DataThunderFwServiceGroupOper#drs_curr_req}
  */
  readonly drsCurrReq?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_frsp_time DataThunderFwServiceGroupOper#drs_frsp_time}
  */
  readonly drsFrspTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_fwd_bts DataThunderFwServiceGroupOper#drs_fwd_bts}
  */
  readonly drsFwdBts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_fwd_pkts DataThunderFwServiceGroupOper#drs_fwd_pkts}
  */
  readonly drsFwdPkts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_hm_index DataThunderFwServiceGroupOper#drs_hm_index}
  */
  readonly drsHmIndex?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_hm_key DataThunderFwServiceGroupOper#drs_hm_key}
  */
  readonly drsHmKey?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_name DataThunderFwServiceGroupOper#drs_name}
  */
  readonly drsName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_peak_conn DataThunderFwServiceGroupOper#drs_peak_conn}
  */
  readonly drsPeakConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_pers_conn DataThunderFwServiceGroupOper#drs_pers_conn}
  */
  readonly drsPersConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_port DataThunderFwServiceGroupOper#drs_port}
  */
  readonly drsPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_priority DataThunderFwServiceGroupOper#drs_priority}
  */
  readonly drsPriority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_rev_bts DataThunderFwServiceGroupOper#drs_rev_bts}
  */
  readonly drsRevBts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_rev_pkts DataThunderFwServiceGroupOper#drs_rev_pkts}
  */
  readonly drsRevPkts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_rsp_time DataThunderFwServiceGroupOper#drs_rsp_time}
  */
  readonly drsRspTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_srsp_time DataThunderFwServiceGroupOper#drs_srsp_time}
  */
  readonly drsSrspTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_state DataThunderFwServiceGroupOper#drs_state}
  */
  readonly drsState?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_total_conn DataThunderFwServiceGroupOper#drs_total_conn}
  */
  readonly drsTotalConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_total_req DataThunderFwServiceGroupOper#drs_total_req}
  */
  readonly drsTotalReq?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_total_req_succ DataThunderFwServiceGroupOper#drs_total_req_succ}
  */
  readonly drsTotalReqSucc?: number;
}

export function dataThunderFwServiceGroupOperMemberListOperDrsListStructToTerraform(struct?: DataThunderFwServiceGroupOperMemberListOperDrsListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataThunderFwServiceGroupOperMemberListOperDrsListStructToHclTerraform(struct?: DataThunderFwServiceGroupOperMemberListOperDrsListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderFwServiceGroupOperMemberListOperDrsListStructOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataThunderFwServiceGroupOperMemberListOperDrsListStruct | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataThunderFwServiceGroupOperMemberListOperDrsListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataThunderFwServiceGroupOperMemberListOperDrsListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderFwServiceGroupOperMemberListOperDrsListStruct[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataThunderFwServiceGroupOperMemberListOperDrsListStructOutputReference {
    return new DataThunderFwServiceGroupOperMemberListOperDrsListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataThunderFwServiceGroupOperMemberListOper {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#hm_index DataThunderFwServiceGroupOper#hm_index}
  */
  readonly hmIndex?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#hm_key DataThunderFwServiceGroupOper#hm_key}
  */
  readonly hmKey?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#state DataThunderFwServiceGroupOper#state}
  */
  readonly state?: string;
  /**
  * alt_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#alt_list DataThunderFwServiceGroupOper#alt_list}
  */
  readonly altList?: DataThunderFwServiceGroupOperMemberListOperAltListStruct[] | cdktf.IResolvable;
  /**
  * drs_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#drs_list DataThunderFwServiceGroupOper#drs_list}
  */
  readonly drsList?: DataThunderFwServiceGroupOperMemberListOperDrsListStruct[] | cdktf.IResolvable;
}

export function dataThunderFwServiceGroupOperMemberListOperToTerraform(struct?: DataThunderFwServiceGroupOperMemberListOperOutputReference | DataThunderFwServiceGroupOperMemberListOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    alt_list: cdktf.listMapper(dataThunderFwServiceGroupOperMemberListOperAltListStructToTerraform, true)(struct!.altList),
    drs_list: cdktf.listMapper(dataThunderFwServiceGroupOperMemberListOperDrsListStructToTerraform, true)(struct!.drsList),
  }
}


export function dataThunderFwServiceGroupOperMemberListOperToHclTerraform(struct?: DataThunderFwServiceGroupOperMemberListOperOutputReference | DataThunderFwServiceGroupOperMemberListOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    alt_list: {
      value: cdktf.listMapperHcl(dataThunderFwServiceGroupOperMemberListOperAltListStructToHclTerraform, true)(struct!.altList),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderFwServiceGroupOperMemberListOperAltListStructList",
    },
    drs_list: {
      value: cdktf.listMapperHcl(dataThunderFwServiceGroupOperMemberListOperDrsListStructToHclTerraform, true)(struct!.drsList),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderFwServiceGroupOperMemberListOperDrsListStructList",
    },
  };
...
export class DataThunderFwServiceGroupOperMemberListOperOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataThunderFwServiceGroupOperMemberListOper | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataThunderFwServiceGroupOperMemberListOper | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _altList = new DataThunderFwServiceGroupOperMemberListOperAltListStructList(this, "alt_list", false);
  public get altList() {
    return this._altList;
  }
  public putAltList(value: DataThunderFwServiceGroupOperMemberListOperAltListStruct[] | cdktf.IResolvable) {
  ...
  private _drsList = new DataThunderFwServiceGroupOperMemberListOperDrsListStructList(this, "drs_list", false);
  public get drsList() {
    return this._drsList;
  }
  public putDrsList(value: DataThunderFwServiceGroupOperMemberListOperDrsListStruct[] | cdktf.IResolvable) {
...
export interface DataThunderFwServiceGroupOperMemberListStruct {
  /**
  * Member name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#name DataThunderFwServiceGroupOper#name}
  ...
  * Port number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#port DataThunderFwServiceGroupOper#port}
  */
  ...
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#oper DataThunderFwServiceGroupOper#oper}
  */
  readonly oper?: DataThunderFwServiceGroupOperMemberListOper;
}

export function dataThunderFwServiceGroupOperMemberListStructToTerraform(struct?: DataThunderFwServiceGroupOperMemberListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    oper: dataThunderFwServiceGroupOperMemberListOperToTerraform(struct!.oper),
  }
}


export function dataThunderFwServiceGroupOperMemberListStructToHclTerraform(struct?: DataThunderFwServiceGroupOperMemberListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    oper: {
      value: dataThunderFwServiceGroupOperMemberListOperToHclTerraform(struct!.oper),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderFwServiceGroupOperMemberListOperList",
    },
  };
...
export class DataThunderFwServiceGroupOperMemberListStructOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataThunderFwServiceGroupOperMemberListStruct | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataThunderFwServiceGroupOperMemberListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _oper = new DataThunderFwServiceGroupOperMemberListOperOutputReference(this, "oper");
  public get oper() {
    return this._oper;
  }
  public putOper(value: DataThunderFwServiceGroupOperMemberListOper) {
...
export class DataThunderFwServiceGroupOperMemberListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderFwServiceGroupOperMemberListStruct[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataThunderFwServiceGroupOperMemberListStructOutputReference {
    return new DataThunderFwServiceGroupOperMemberListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataThunderFwServiceGroupOperOperSgmListStruct {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#sgm_name DataThunderFwServiceGroupOper#sgm_name}
  */
  readonly sgmName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#sgm_port DataThunderFwServiceGroupOper#sgm_port}
  */
  readonly sgmPort?: number;
}

export function dataThunderFwServiceGroupOperOperSgmListStructToTerraform(struct?: DataThunderFwServiceGroupOperOperSgmListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataThunderFwServiceGroupOperOperSgmListStructToHclTerraform(struct?: DataThunderFwServiceGroupOperOperSgmListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderFwServiceGroupOperOperSgmListStructOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataThunderFwServiceGroupOperOperSgmListStruct | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataThunderFwServiceGroupOperOperSgmListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataThunderFwServiceGroupOperOperSgmListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderFwServiceGroupOperOperSgmListStruct[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataThunderFwServiceGroupOperOperSgmListStructOutputReference {
    return new DataThunderFwServiceGroupOperOperSgmListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataThunderFwServiceGroupOperOper {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#filter DataThunderFwServiceGroupOper#filter}
  */
  readonly filter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#hm_dsr_enable_all_vip DataThunderFwServiceGroupOper#hm_dsr_enable_all_vip}
  */
  readonly hmDsrEnableAllVip?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#pri_affinity_priority DataThunderFwServiceGroupOper#pri_affinity_priority}
  */
  readonly priAffinityPriority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#servers_disable DataThunderFwServiceGroupOper#servers_disable}
  */
  readonly serversDisable?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#servers_down DataThunderFwServiceGroupOper#servers_down}
  */
  readonly serversDown?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#servers_total DataThunderFwServiceGroupOper#servers_total}
  */
  readonly serversTotal?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#servers_up DataThunderFwServiceGroupOper#servers_up}
  */
  ...
  */
  readonly state?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#stateless_current_rate DataThunderFwServiceGroupOper#stateless_current_rate}
  */
  readonly statelessCurrentRate?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#stateless_current_usage DataThunderFwServiceGroupOper#stateless_current_usage}
  */
  readonly statelessCurrentUsage?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#stateless_state DataThunderFwServiceGroupOper#stateless_state}
  */
  readonly statelessState?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#stateless_type DataThunderFwServiceGroupOper#stateless_type}
  */
  readonly statelessType?: number;
  /**
  * sgm_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#sgm_list DataThunderFwServiceGroupOper#sgm_list}
  */
  readonly sgmList?: DataThunderFwServiceGroupOperOperSgmListStruct[] | cdktf.IResolvable;
}

export function dataThunderFwServiceGroupOperOperToTerraform(struct?: DataThunderFwServiceGroupOperOperOutputReference | DataThunderFwServiceGroupOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    sgm_list: cdktf.listMapper(dataThunderFwServiceGroupOperOperSgmListStructToTerraform, true)(struct!.sgmList),
  }
}


export function dataThunderFwServiceGroupOperOperToHclTerraform(struct?: DataThunderFwServiceGroupOperOperOutputReference | DataThunderFwServiceGroupOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    sgm_list: {
      value: cdktf.listMapperHcl(dataThunderFwServiceGroupOperOperSgmListStructToHclTerraform, true)(struct!.sgmList),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderFwServiceGroupOperOperSgmListStructList",
    },
  };
...
export class DataThunderFwServiceGroupOperOperOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataThunderFwServiceGroupOperOper | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataThunderFwServiceGroupOperOper | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _sgmList = new DataThunderFwServiceGroupOperOperSgmListStructList(this, "sgm_list", false);
  public get sgmList() {
    return this._sgmList;
  }
  public putSgmList(value: DataThunderFwServiceGroupOperOperSgmListStruct[] | cdktf.IResolvable) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper thunder_fw_service_group_oper}
*/
export class DataThunderFwServiceGroupOper extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_fw_service_group_oper";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataThunderFwServiceGroupOper resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataThunderFwServiceGroupOper to import
  * @param importFromId The id of the existing DataThunderFwServiceGroupOper that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataThunderFwServiceGroupOper to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_fw_service_group_oper", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/data-sources/fw_service_group_oper thunder_fw_service_group_oper} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataThunderFwServiceGroupOperConfig
  */
  public constructor(scope: Construct, id: string, config: DataThunderFwServiceGroupOperConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_fw_service_group_oper',
  ...
  private _memberList = new DataThunderFwServiceGroupOperMemberListStructList(this, "member_list", false);
  public get memberList() {
    return this._memberList;
  }
  public putMemberList(value: DataThunderFwServiceGroupOperMemberListStruct[] | cdktf.IResolvable) {
  ...
  // oper - computed: false, optional: true, required: false
  private _oper = new DataThunderFwServiceGroupOperOperOutputReference(this, "oper");
  public get oper() {
    return this._oper;
  }
  public putOper(value: DataThunderFwServiceGroupOperOper) {
    this._oper.internalValue = value;
  }
  public resetOper() {
    this._oper.internalValue = undefined;
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      member_list: cdktf.listMapper(dataThunderFwServiceGroupOperMemberListStructToTerraform, true)(this._memberList.internalValue),
      oper: dataThunderFwServiceGroupOperOperToTerraform(this._oper.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      member_list: {
        value: cdktf.listMapperHcl(dataThunderFwServiceGroupOperMemberListStructToHclTerraform, true)(this._memberList.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderFwServiceGroupOperMemberListStructList",
      },
      oper: {
        value: dataThunderFwServiceGroupOperOperToHclTerraform(this._oper.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderFwServiceGroupOperOperList",
      },
    };
