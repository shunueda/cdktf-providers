// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_sip
...
export interface Cgnv6Nat64AlgSipConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_sip#id Cgnv6Nat64AlgSip#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_sip#sip_enable Cgnv6Nat64AlgSip#sip_enable}
  */
  readonly sipEnable?: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_sip#uuid Cgnv6Nat64AlgSip#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_sip thunder_cgnv6_nat64_alg_sip}
*/
export class Cgnv6Nat64AlgSip extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cgnv6Nat64AlgSip that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_sip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_nat64_alg_sip thunder_cgnv6_nat64_alg_sip} Resource
  *
  * @param scope The scope in which to define this construct
