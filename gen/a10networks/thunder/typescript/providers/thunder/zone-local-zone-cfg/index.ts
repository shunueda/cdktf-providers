...
export class ZoneLocalZoneCfgA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_zone_local_zone_cfg";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_zone_local_zone_cfg", importId: importFromId, provider });
      }
  ...
  * @param options ZoneLocalZoneCfgAConfig
  */
  public constructor(scope: Construct, id: string, config: ZoneLocalZoneCfgAConfig) {
    super(scope, id, {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      local_type: {
        value: cdktf.numberToHclTerraform(this._localType),
        isBlock: false,
        type: "simple",
