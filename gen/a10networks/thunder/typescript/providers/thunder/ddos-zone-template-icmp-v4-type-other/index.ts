// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other
...
export interface DdosZoneTemplateIcmpV4TypeOtherAConfig extends cdktf.TerraformMetaArguments {
  /**
  * IcmpTmplName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#icmp_tmpl_name DdosZoneTemplateIcmpV4TypeOtherA#icmp_tmpl_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#icmp_type_other_action DdosZoneTemplateIcmpV4TypeOtherA#icmp_type_other_action}
  */
  readonly icmpTypeOtherAction?: string;
  /**
  * Configure action-list to take for wildcard ICMP match
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#icmp_type_other_action_list_name DdosZoneTemplateIcmpV4TypeOtherA#icmp_type_other_action_list_name}
  */
  readonly icmpTypeOtherActionListName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#id DdosZoneTemplateIcmpV4TypeOtherA#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#uuid DdosZoneTemplateIcmpV4TypeOtherA#uuid}
  */
  readonly uuid?: string;
  /**
  * dst block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#dst DdosZoneTemplateIcmpV4TypeOtherA#dst}
  */
  readonly dst?: DdosZoneTemplateIcmpV4TypeOtherDstA;
  /**
  * src block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#src DdosZoneTemplateIcmpV4TypeOtherA#src}
  */
  readonly src?: DdosZoneTemplateIcmpV4TypeOtherSrcA;
}
export interface DdosZoneTemplateIcmpV4TypeOtherDstA {
  /**
  * Specify the whole dst rate for wildcard ICMP type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#dst_type_other_rate DdosZoneTemplateIcmpV4TypeOtherA#dst_type_other_rate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#dst_type_other_rate_action DdosZoneTemplateIcmpV4TypeOtherA#dst_type_other_rate_action}
  */
  readonly dstTypeOtherRateAction?: string;
  /**
  * Configure action-list to take for rate exceed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#dst_type_other_rate_action_list_name DdosZoneTemplateIcmpV4TypeOtherA#dst_type_other_rate_action_list_name}
  */
  readonly dstTypeOtherRateActionListName?: string;
}

export function ddosZoneTemplateIcmpV4TypeOtherDstAToTerraform(struct?: DdosZoneTemplateIcmpV4TypeOtherDstAOutputReference | DdosZoneTemplateIcmpV4TypeOtherDstA): any {
...
export function ddosZoneTemplateIcmpV4TypeOtherDstAToHclTerraform(struct?: DdosZoneTemplateIcmpV4TypeOtherDstAOutputReference | DdosZoneTemplateIcmpV4TypeOtherDstA): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DdosZoneTemplateIcmpV4TypeOtherDstAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DdosZoneTemplateIcmpV4TypeOtherDstA | undefined {
  ...
  public set internalValue(value: DdosZoneTemplateIcmpV4TypeOtherDstA | undefined) {
    if (value === undefined) {
...
export interface DdosZoneTemplateIcmpV4TypeOtherSrcA {
  /**
  * Specify the whole src rate for wildcard ICMP type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#src_type_other_rate DdosZoneTemplateIcmpV4TypeOtherA#src_type_other_rate}
  */
  readonly srcTypeOtherRate?: number;
  /**
  * 'drop': Drop packets for rate exceed (Default); 'blacklist-src': Blacklist-src for rate exceed; 'ignore': Do nothing for rate exceed;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#src_type_other_rate_action DdosZoneTemplateIcmpV4TypeOtherA#src_type_other_rate_action}
  */
  readonly srcTypeOtherRateAction?: string;
  /**
  * Configure action-list to take for rate exceed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#src_type_other_rate_action_list_name DdosZoneTemplateIcmpV4TypeOtherA#src_type_other_rate_action_list_name}
  */
  readonly srcTypeOtherRateActionListName?: string;
}

export function ddosZoneTemplateIcmpV4TypeOtherSrcAToTerraform(struct?: DdosZoneTemplateIcmpV4TypeOtherSrcAOutputReference | DdosZoneTemplateIcmpV4TypeOtherSrcA): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function ddosZoneTemplateIcmpV4TypeOtherSrcAToHclTerraform(struct?: DdosZoneTemplateIcmpV4TypeOtherSrcAOutputReference | DdosZoneTemplateIcmpV4TypeOtherSrcA): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DdosZoneTemplateIcmpV4TypeOtherSrcAOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DdosZoneTemplateIcmpV4TypeOtherSrcA | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DdosZoneTemplateIcmpV4TypeOtherSrcA | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other thunder_ddos_zone_template_icmp_v4_type_other}
*/
export class DdosZoneTemplateIcmpV4TypeOtherA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_zone_template_icmp_v4_type_other";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DdosZoneTemplateIcmpV4TypeOtherA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DdosZoneTemplateIcmpV4TypeOtherA to import
  * @param importFromId The id of the existing DdosZoneTemplateIcmpV4TypeOtherA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DdosZoneTemplateIcmpV4TypeOtherA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_zone_template_icmp_v4_type_other", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_icmp_v4_type_other thunder_ddos_zone_template_icmp_v4_type_other} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DdosZoneTemplateIcmpV4TypeOtherAConfig
  */
  public constructor(scope: Construct, id: string, config: DdosZoneTemplateIcmpV4TypeOtherAConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_ddos_zone_template_icmp_v4_type_other',
  ...
  private _dst = new DdosZoneTemplateIcmpV4TypeOtherDstAOutputReference(this, "dst");
  public get dst() {
    return this._dst;
  }
  public putDst(value: DdosZoneTemplateIcmpV4TypeOtherDstA) {
  ...
  private _src = new DdosZoneTemplateIcmpV4TypeOtherSrcAOutputReference(this, "src");
  public get src() {
    return this._src;
  }
  public putSrc(value: DdosZoneTemplateIcmpV4TypeOtherSrcA) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      dst: ddosZoneTemplateIcmpV4TypeOtherDstAToTerraform(this._dst.internalValue),
      src: ddosZoneTemplateIcmpV4TypeOtherSrcAToTerraform(this._src.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      dst: {
        value: ddosZoneTemplateIcmpV4TypeOtherDstAToHclTerraform(this._dst.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DdosZoneTemplateIcmpV4TypeOtherDstAList",
      },
      src: {
        value: ddosZoneTemplateIcmpV4TypeOtherSrcAToHclTerraform(this._src.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DdosZoneTemplateIcmpV4TypeOtherSrcAList",
      },
    };
