// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_tap
...
export interface DdosTapConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_tap#id DdosTap#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_tap#uuid DdosTap#uuid}
  */
  readonly uuid?: string;
  /**
  * ethernet_start_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_tap#ethernet_start_cfg DdosTap#ethernet_start_cfg}
  */
  readonly ethernetStartCfg?: DdosTapEthernetStartCfg[] | cdktf.IResolvable;
}
export interface DdosTapEthernetStartCfg {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_tap#ethernet_end DdosTap#ethernet_end}
  */
  readonly ethernetEnd?: number;
  /**
  * Traffic receive from the ethernet port will be dropped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_tap#ethernet_start DdosTap#ethernet_start}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_tap thunder_ddos_tap}
*/
export class DdosTap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DdosTap that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_tap#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_tap thunder_ddos_tap} Resource
  *
  * @param scope The scope in which to define this construct
