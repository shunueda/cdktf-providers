...
export interface DataThunderSlbDns64StatsStats {
  /**
  * Translated
  *
...
export function dataThunderSlbDns64StatsStatsToTerraform(struct?: DataThunderSlbDns64StatsStatsOutputReference | DataThunderSlbDns64StatsStats): any {
...
export function dataThunderSlbDns64StatsStatsToHclTerraform(struct?: DataThunderSlbDns64StatsStatsOutputReference | DataThunderSlbDns64StatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderSlbDns64StatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderSlbDns64StatsStats | undefined {
  ...
  public set internalValue(value: DataThunderSlbDns64StatsStats | undefined) {
    if (value === undefined) {
...
export class DataThunderSlbDns64Stats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_dns64_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_dns64_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderSlbDns64StatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderSlbDns64StatsConfig = {}) {
    super(scope, id, {
  ...
  private _stats = new DataThunderSlbDns64StatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderSlbDns64StatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderSlbDns64StatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderSlbDns64StatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderSlbDns64StatsStatsList",
      },
    };
