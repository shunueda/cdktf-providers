...
export interface DataThunderCgnv6FixedNatHwAccelerateStatsStats {
  /**
  * HW Entries Aged Out
  *
...
export function dataThunderCgnv6FixedNatHwAccelerateStatsStatsToTerraform(struct?: DataThunderCgnv6FixedNatHwAccelerateStatsStatsOutputReference | DataThunderCgnv6FixedNatHwAccelerateStatsStats): any {
...
export function dataThunderCgnv6FixedNatHwAccelerateStatsStatsToHclTerraform(struct?: DataThunderCgnv6FixedNatHwAccelerateStatsStatsOutputReference | DataThunderCgnv6FixedNatHwAccelerateStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderCgnv6FixedNatHwAccelerateStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderCgnv6FixedNatHwAccelerateStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderCgnv6FixedNatHwAccelerateStatsStats | undefined) {
    if (value === undefined) {
...
export class DataThunderCgnv6FixedNatHwAccelerateStats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_fixed_nat_hw_accelerate_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_fixed_nat_hw_accelerate_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderCgnv6FixedNatHwAccelerateStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderCgnv6FixedNatHwAccelerateStatsConfig = {}) {
    super(scope, id, {
  ...
  private _stats = new DataThunderCgnv6FixedNatHwAccelerateStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderCgnv6FixedNatHwAccelerateStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderCgnv6FixedNatHwAccelerateStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderCgnv6FixedNatHwAccelerateStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderCgnv6FixedNatHwAccelerateStatsStatsList",
      },
    };
