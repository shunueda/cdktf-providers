// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv4_internet_host_list
...
export interface SystemIpThreatListIpv4InternetHostListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv4_internet_host_list#id SystemIpThreatListIpv4InternetHostList#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv4_internet_host_list#uuid SystemIpThreatListIpv4InternetHostList#uuid}
  */
  readonly uuid?: string;
  /**
  * Bind exception-list (class-list name)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv4_internet_host_list#white_list SystemIpThreatListIpv4InternetHostList#white_list}
  */
  readonly whiteList?: string;
  /**
  * class_list_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv4_internet_host_list#class_list_cfg SystemIpThreatListIpv4InternetHostList#class_list_cfg}
  */
...
export interface SystemIpThreatListIpv4InternetHostListClassListCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv4_internet_host_list#class_list SystemIpThreatListIpv4InternetHostList#class_list}
  */
  readonly classList?: string;
  /**
  * Bind ip-threat-action Template (ip-threat-action Template number)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv4_internet_host_list#ip_threat_action_tmpl SystemIpThreatListIpv4InternetHostList#ip_threat_action_tmpl}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv4_internet_host_list thunder_system_ip_threat_list_ipv4_internet_host_list}
*/
export class SystemIpThreatListIpv4InternetHostList extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_system_ip_threat_list_ipv4_internet_host_list";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a SystemIpThreatListIpv4InternetHostList resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the SystemIpThreatListIpv4InternetHostList to import
  * @param importFromId The id of the existing SystemIpThreatListIpv4InternetHostList that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv4_internet_host_list#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SystemIpThreatListIpv4InternetHostList to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_system_ip_threat_list_ipv4_internet_host_list", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv4_internet_host_list thunder_system_ip_threat_list_ipv4_internet_host_list} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options SystemIpThreatListIpv4InternetHostListConfig = {}
  */
  public constructor(scope: Construct, id: string, config: SystemIpThreatListIpv4InternetHostListConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_system_ip_threat_list_ipv4_internet_host_list',
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      class_list_cfg: cdktf.listMapper(systemIpThreatListIpv4InternetHostListClassListCfgAToTerraform, true)(this._classListCfg.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      class_list_cfg: {
        value: cdktf.listMapperHcl(systemIpThreatListIpv4InternetHostListClassListCfgAToHclTerraform, true)(this._classListCfg.internalValue),
        isBlock: true,
        type: "list",
