...
export interface RouterOspfDefaultInformationAConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class RouterOspfDefaultInformationA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_router_ospf_default_information";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_router_ospf_default_information", importId: importFromId, provider });
      }
  ...
  * @param options RouterOspfDefaultInformationAConfig
  */
  public constructor(scope: Construct, id: string, config: RouterOspfDefaultInformationAConfig) {
    super(scope, id, {
