// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats
...
export interface DataThunderSlbDnsCacheStatsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#id DataThunderSlbDnsCacheStats#id}
  *
  ...
  * stats block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#stats DataThunderSlbDnsCacheStats#stats}
  */
  readonly stats?: DataThunderSlbDnsCacheStatsStats;
}
export interface DataThunderSlbDnsCacheStatsStats {
  /**
  * Total aged out
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#ageout DataThunderSlbDnsCacheStats#ageout}
  */
  readonly ageout?: number;
  /**
  * Total aged for lower weight
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#ageout_weight DataThunderSlbDnsCacheStats#ageout_weight}
  */
  readonly ageoutWeight?: number;
  /**
  * Response with multiple answers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#answer_r DataThunderSlbDnsCacheStats#answer_r}
  */
  readonly answerR?: number;
  /**
  * Bad Answer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#bad_answer DataThunderSlbDnsCacheStats#bad_answer}
  */
  readonly badAnswer?: number;
  /**
  * Query not passed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#bad_q DataThunderSlbDnsCacheStats#bad_q}
  */
  readonly badQ?: number;
  /**
  * Response not passed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#bad_r DataThunderSlbDnsCacheStats#bad_r}
  */
  readonly badR?: number;
  /**
  * Current allocate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#current_allocate DataThunderSlbDnsCacheStats#current_allocate}
  */
  readonly currentAllocate?: number;
  /**
  * Current data allocate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#current_data_allocate DataThunderSlbDnsCacheStats#current_data_allocate}
  */
  readonly currentDataAllocate?: number;
  /**
  * Query encoded
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#encode_q DataThunderSlbDnsCacheStats#encode_q}
  */
  readonly encodeQ?: number;
  /**
  * Response encoded
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#encode_r DataThunderSlbDnsCacheStats#encode_r}
  */
  readonly encodeR?: number;
  /**
  * Total cache hit
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#hit DataThunderSlbDnsCacheStats#hit}
  */
  readonly hit?: number;
  /**
  * Cache hit rate per second
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#hit_rate_per_sec DataThunderSlbDnsCacheStats#hit_rate_per_sec}
  */
  readonly hitRatePerSec?: number;
  /**
  * Query with multiple questions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#multiple_q DataThunderSlbDnsCacheStats#multiple_q}
  */
  readonly multipleQ?: number;
  /**
  * Response with multiple questions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#multiple_r DataThunderSlbDnsCacheStats#multiple_r}
  */
  readonly multipleR?: number;
  /**
  * Query exceed cache size
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#oversize_q DataThunderSlbDnsCacheStats#oversize_q}
  */
  readonly oversizeQ?: number;
  /**
  * Response exceed cache size
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#oversize_r DataThunderSlbDnsCacheStats#oversize_r}
  */
  readonly oversizeR?: number;
  /**
  * Cache Queries-per-second
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#qps DataThunderSlbDnsCacheStats#qps}
  */
  readonly qps?: number;
  /**
  * Resolver task queue full
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#resolver_queue_full DataThunderSlbDnsCacheStats#resolver_queue_full}
  */
  readonly resolverQueueFull?: number;
  /**
  * Total allocated
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#total_alloc DataThunderSlbDnsCacheStats#total_alloc}
  */
  readonly totalAlloc?: number;
  /**
  * Total freed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#total_freed DataThunderSlbDnsCacheStats#total_freed}
  */
  readonly totalFreed?: number;
  /**
  * Total stats log sent
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#total_log DataThunderSlbDnsCacheStats#total_log}
  */
  readonly totalLog?: number;
  /**
  * Total query
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#total_q DataThunderSlbDnsCacheStats#total_q}
  */
  readonly totalQ?: number;
  /**
  * Total server response
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#total_r DataThunderSlbDnsCacheStats#total_r}
  */
  readonly totalR?: number;
  /**
  * Response with Truncation bit set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#truncated_r DataThunderSlbDnsCacheStats#truncated_r}
  */
  readonly truncatedR?: number;
  /**
  * Response with short TTL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#ttl_r DataThunderSlbDnsCacheStats#ttl_r}
  */
  readonly ttlR?: number;
}

export function dataThunderSlbDnsCacheStatsStatsToTerraform(struct?: DataThunderSlbDnsCacheStatsStatsOutputReference | DataThunderSlbDnsCacheStatsStats): any {
...
export function dataThunderSlbDnsCacheStatsStatsToHclTerraform(struct?: DataThunderSlbDnsCacheStatsStatsOutputReference | DataThunderSlbDnsCacheStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderSlbDnsCacheStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderSlbDnsCacheStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderSlbDnsCacheStatsStats | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats thunder_slb_dns_cache_stats}
*/
export class DataThunderSlbDnsCacheStats extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_dns_cache_stats";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataThunderSlbDnsCacheStats resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataThunderSlbDnsCacheStats to import
  * @param importFromId The id of the existing DataThunderSlbDnsCacheStats that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataThunderSlbDnsCacheStats to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_dns_cache_stats", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_dns_cache_stats thunder_slb_dns_cache_stats} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataThunderSlbDnsCacheStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderSlbDnsCacheStatsConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_slb_dns_cache_stats',
  ...
  private _stats = new DataThunderSlbDnsCacheStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderSlbDnsCacheStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderSlbDnsCacheStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderSlbDnsCacheStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderSlbDnsCacheStatsStatsList",
      },
    };
