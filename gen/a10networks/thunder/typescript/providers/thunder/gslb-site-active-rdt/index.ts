// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt
...
export interface GslbSiteActiveRdtAConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt#aging_time GslbSiteActiveRdtA#aging_time}
  */
  readonly agingTime?: number;
  /**
  * Bind RDT to geo-location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt#bind_geoloc GslbSiteActiveRdtA#bind_geoloc}
  */
  readonly bindGeoloc?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt#id GslbSiteActiveRdtA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt#ignore_count GslbSiteActiveRdtA#ignore_count}
  */
  readonly ignoreCount?: number;
  /**
  * Client IPv6 subnet mask, default is 128
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt#ipv6_mask GslbSiteActiveRdtA#ipv6_mask}
  */
  readonly ipv6Mask?: number;
  /**
  * Limit of valid RDT, default is 16383 (Limit, unit: millisecond)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt#limit GslbSiteActiveRdtA#limit}
  */
  readonly limit?: number;
  /**
  * Client IP subnet mask, default is 32
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt#mask GslbSiteActiveRdtA#mask}
  */
  readonly mask?: string;
  /**
  * Enable overlap for geo-location to do longest match
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt#overlap GslbSiteActiveRdtA#overlap}
  */
  readonly overlap?: number;
  /**
  * Factor of RDT Range, default is 25 (Range Factor of Smooth RDT)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt#range_factor GslbSiteActiveRdtA#range_factor}
  */
  readonly rangeFactor?: number;
  /**
  * SiteName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt#site_name GslbSiteActiveRdtA#site_name}
  */
  readonly siteName: string;
  /**
  * Factor of Smooth RDT, default is 10
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt#smooth_factor GslbSiteActiveRdtA#smooth_factor}
  */
  readonly smoothFactor?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt#uuid GslbSiteActiveRdtA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt thunder_gslb_site_active_rdt}
*/
export class GslbSiteActiveRdtA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GslbSiteActiveRdtA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/gslb_site_active_rdt thunder_gslb_site_active_rdt} Resource
  *
  * @param scope The scope in which to define this construct
