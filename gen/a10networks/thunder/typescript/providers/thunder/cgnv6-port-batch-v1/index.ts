// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_port_batch_v1
...
export interface Cgnv6PortBatchV1Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_port_batch_v1#enable_port_batch_v1 Cgnv6PortBatchV1#enable_port_batch_v1}
  */
  readonly enablePortBatchV1?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_port_batch_v1#id Cgnv6PortBatchV1#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_port_batch_v1#uuid Cgnv6PortBatchV1#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_port_batch_v1 thunder_cgnv6_port_batch_v1}
*/
export class Cgnv6PortBatchV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cgnv6PortBatchV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_port_batch_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_port_batch_v1 thunder_cgnv6_port_batch_v1} Resource
  *
  * @param scope The scope in which to define this construct
