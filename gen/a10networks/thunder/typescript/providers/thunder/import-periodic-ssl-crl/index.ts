// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_crl
...
export interface ImportPeriodicSslCrlConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_crl#id ImportPeriodicSslCrl#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_crl#period ImportPeriodicSslCrl#period}
  */
  readonly period?: number;
  /**
  * profile name for remote url
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_crl#remote_file ImportPeriodicSslCrl#remote_file}
  */
  readonly remoteFile?: string;
  /**
  * SSL Crl File
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_crl#ssl_crl ImportPeriodicSslCrl#ssl_crl}
  */
  readonly sslCrl: string;
  /**
  * Use management port as source port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_crl#use_mgmt_port ImportPeriodicSslCrl#use_mgmt_port}
  */
  readonly useMgmtPort?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_crl#uuid ImportPeriodicSslCrl#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_crl thunder_import_periodic_ssl_crl}
*/
export class ImportPeriodicSslCrl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImportPeriodicSslCrl that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_crl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_crl thunder_import_periodic_ssl_crl} Resource
  *
  * @param scope The scope in which to define this construct
