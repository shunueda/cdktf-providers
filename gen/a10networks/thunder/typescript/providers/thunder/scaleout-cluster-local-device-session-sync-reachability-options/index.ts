...
export interface ScaleoutClusterLocalDeviceSessionSyncReachabilityOptionsAConfig extends cdktf.TerraformMetaArguments {
  /**
  * ClusterId
  *
...
export class ScaleoutClusterLocalDeviceSessionSyncReachabilityOptionsA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_scaleout_cluster_local_device_session_sync_reachability_options";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_scaleout_cluster_local_device_session_sync_reachability_options", importId: importFromId, provider });
      }
  ...
  * @param options ScaleoutClusterLocalDeviceSessionSyncReachabilityOptionsAConfig
  */
  public constructor(scope: Construct, id: string, config: ScaleoutClusterLocalDeviceSessionSyncReachabilityOptionsAConfig) {
    super(scope, id, {
