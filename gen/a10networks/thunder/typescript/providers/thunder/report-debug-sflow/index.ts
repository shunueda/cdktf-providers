// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/report_debug_sflow
...
export interface ReportDebugSflowAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/report_debug_sflow#id ReportDebugSflowA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/report_debug_sflow#parser ReportDebugSflowA#parser}
  */
  readonly parser?: number;
  /**
  * Specify stats-oid to dump raw packets, 0 to disable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/report_debug_sflow#stats_oid ReportDebugSflowA#stats_oid}
  */
  readonly statsOid?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/report_debug_sflow thunder_report_debug_sflow}
*/
export class ReportDebugSflowA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ReportDebugSflowA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/report_debug_sflow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/report_debug_sflow thunder_report_debug_sflow} Resource
  *
  * @param scope The scope in which to define this construct
