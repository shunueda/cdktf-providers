...
export interface SystemViewMemoryViewSamplingEnable {
  /**
...
export function systemViewMemoryViewSamplingEnableToTerraform(struct?: SystemViewMemoryViewSamplingEnable | cdktf.IResolvable): any {
...
export function systemViewMemoryViewSamplingEnableToHclTerraform(struct?: SystemViewMemoryViewSamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SystemViewMemoryViewSamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SystemViewMemoryViewSamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SystemViewMemoryViewSamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SystemViewMemoryViewSamplingEnableList extends cdktf.ComplexList {
  public internalValue? : SystemViewMemoryViewSamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): SystemViewMemoryViewSamplingEnableOutputReference {
    return new SystemViewMemoryViewSamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class SystemViewMemoryView extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_system_view_memory_view";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_system_view_memory_view", importId: importFromId, provider });
      }
  ...
  * @param options SystemViewMemoryViewConfig = {}
  */
  public constructor(scope: Construct, id: string, config: SystemViewMemoryViewConfig = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new SystemViewMemoryViewSamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: SystemViewMemoryViewSamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(systemViewMemoryViewSamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(systemViewMemoryViewSamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "SystemViewMemoryViewSamplingEnableList",
      },
    };
