// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper
...
export interface DataThunderSlbServiceGroupMemberOperConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#id DataThunderSlbServiceGroupMemberOper#id}
  *
  ...
  * Member name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#name DataThunderSlbServiceGroupMemberOper#name}
  */
  readonly name: string;
  /**
  * Port number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#port DataThunderSlbServiceGroupMemberOper#port}
  */
  readonly port: number;
  /**
  * Service_group_name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#service_group_name DataThunderSlbServiceGroupMemberOper#service_group_name}
  */
  readonly serviceGroupName: string;
  /**
  * oper block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#oper DataThunderSlbServiceGroupMemberOper#oper}
  */
  readonly oper?: DataThunderSlbServiceGroupMemberOperOper;
}
export interface DataThunderSlbServiceGroupMemberOperOperAltListStruct {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#alt_curr_conn DataThunderSlbServiceGroupMemberOper#alt_curr_conn}
  */
  readonly altCurrConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#alt_fwd_pkts DataThunderSlbServiceGroupMemberOper#alt_fwd_pkts}
  */
  readonly altFwdPkts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#alt_name DataThunderSlbServiceGroupMemberOper#alt_name}
  */
  readonly altName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#alt_peak_conn DataThunderSlbServiceGroupMemberOper#alt_peak_conn}
  */
  readonly altPeakConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#alt_port DataThunderSlbServiceGroupMemberOper#alt_port}
  */
  readonly altPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#alt_rev_pkts DataThunderSlbServiceGroupMemberOper#alt_rev_pkts}
  */
  readonly altRevPkts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#alt_state DataThunderSlbServiceGroupMemberOper#alt_state}
  */
  readonly altState?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#alt_total_conn DataThunderSlbServiceGroupMemberOper#alt_total_conn}
  */
  readonly altTotalConn?: number;
}

export function dataThunderSlbServiceGroupMemberOperOperAltListStructToTerraform(struct?: DataThunderSlbServiceGroupMemberOperOperAltListStruct | cdktf.IResolvable): any {
...
export function dataThunderSlbServiceGroupMemberOperOperAltListStructToHclTerraform(struct?: DataThunderSlbServiceGroupMemberOperOperAltListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderSlbServiceGroupMemberOperOperAltListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderSlbServiceGroupMemberOperOperAltListStruct | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataThunderSlbServiceGroupMemberOperOperAltListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataThunderSlbServiceGroupMemberOperOperAltListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderSlbServiceGroupMemberOperOperAltListStruct[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataThunderSlbServiceGroupMemberOperOperAltListStructOutputReference {
    return new DataThunderSlbServiceGroupMemberOperOperAltListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataThunderSlbServiceGroupMemberOperOperDrsListStruct {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_curr_conn DataThunderSlbServiceGroupMemberOper#drs_curr_conn}
  */
  readonly drsCurrConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_curr_req DataThunderSlbServiceGroupMemberOper#drs_curr_req}
  */
  readonly drsCurrReq?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_frsp_time DataThunderSlbServiceGroupMemberOper#drs_frsp_time}
  */
  readonly drsFrspTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_fwd_bts DataThunderSlbServiceGroupMemberOper#drs_fwd_bts}
  */
  readonly drsFwdBts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_fwd_pkts DataThunderSlbServiceGroupMemberOper#drs_fwd_pkts}
  */
  readonly drsFwdPkts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_hm_index DataThunderSlbServiceGroupMemberOper#drs_hm_index}
  */
  readonly drsHmIndex?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_hm_key DataThunderSlbServiceGroupMemberOper#drs_hm_key}
  */
  readonly drsHmKey?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_name DataThunderSlbServiceGroupMemberOper#drs_name}
  */
  readonly drsName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_peak_conn DataThunderSlbServiceGroupMemberOper#drs_peak_conn}
  */
  readonly drsPeakConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_pers_conn DataThunderSlbServiceGroupMemberOper#drs_pers_conn}
  */
  readonly drsPersConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_port DataThunderSlbServiceGroupMemberOper#drs_port}
  */
  readonly drsPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_priority DataThunderSlbServiceGroupMemberOper#drs_priority}
  */
  readonly drsPriority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_rev_bts DataThunderSlbServiceGroupMemberOper#drs_rev_bts}
  */
  readonly drsRevBts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_rev_pkts DataThunderSlbServiceGroupMemberOper#drs_rev_pkts}
  */
  readonly drsRevPkts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_rsp_time DataThunderSlbServiceGroupMemberOper#drs_rsp_time}
  */
  readonly drsRspTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_srsp_time DataThunderSlbServiceGroupMemberOper#drs_srsp_time}
  */
  readonly drsSrspTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_state DataThunderSlbServiceGroupMemberOper#drs_state}
  */
  readonly drsState?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_total_conn DataThunderSlbServiceGroupMemberOper#drs_total_conn}
  */
  readonly drsTotalConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_total_req DataThunderSlbServiceGroupMemberOper#drs_total_req}
  */
  readonly drsTotalReq?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_total_req_succ DataThunderSlbServiceGroupMemberOper#drs_total_req_succ}
  */
  readonly drsTotalReqSucc?: number;
}

export function dataThunderSlbServiceGroupMemberOperOperDrsListStructToTerraform(struct?: DataThunderSlbServiceGroupMemberOperOperDrsListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataThunderSlbServiceGroupMemberOperOperDrsListStructToHclTerraform(struct?: DataThunderSlbServiceGroupMemberOperOperDrsListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderSlbServiceGroupMemberOperOperDrsListStructOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataThunderSlbServiceGroupMemberOperOperDrsListStruct | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataThunderSlbServiceGroupMemberOperOperDrsListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataThunderSlbServiceGroupMemberOperOperDrsListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderSlbServiceGroupMemberOperOperDrsListStruct[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataThunderSlbServiceGroupMemberOperOperDrsListStructOutputReference {
    return new DataThunderSlbServiceGroupMemberOperOperDrsListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataThunderSlbServiceGroupMemberOperOper {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#hm_index DataThunderSlbServiceGroupMemberOper#hm_index}
  */
  readonly hmIndex?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#hm_key DataThunderSlbServiceGroupMemberOper#hm_key}
  */
  readonly hmKey?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#state DataThunderSlbServiceGroupMemberOper#state}
  */
  readonly state?: string;
  /**
  * alt_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#alt_list DataThunderSlbServiceGroupMemberOper#alt_list}
  */
  readonly altList?: DataThunderSlbServiceGroupMemberOperOperAltListStruct[] | cdktf.IResolvable;
  /**
  * drs_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#drs_list DataThunderSlbServiceGroupMemberOper#drs_list}
  */
  readonly drsList?: DataThunderSlbServiceGroupMemberOperOperDrsListStruct[] | cdktf.IResolvable;
}

export function dataThunderSlbServiceGroupMemberOperOperToTerraform(struct?: DataThunderSlbServiceGroupMemberOperOperOutputReference | DataThunderSlbServiceGroupMemberOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    alt_list: cdktf.listMapper(dataThunderSlbServiceGroupMemberOperOperAltListStructToTerraform, true)(struct!.altList),
    drs_list: cdktf.listMapper(dataThunderSlbServiceGroupMemberOperOperDrsListStructToTerraform, true)(struct!.drsList),
  }
}


export function dataThunderSlbServiceGroupMemberOperOperToHclTerraform(struct?: DataThunderSlbServiceGroupMemberOperOperOutputReference | DataThunderSlbServiceGroupMemberOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    alt_list: {
      value: cdktf.listMapperHcl(dataThunderSlbServiceGroupMemberOperOperAltListStructToHclTerraform, true)(struct!.altList),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderSlbServiceGroupMemberOperOperAltListStructList",
    },
    drs_list: {
      value: cdktf.listMapperHcl(dataThunderSlbServiceGroupMemberOperOperDrsListStructToHclTerraform, true)(struct!.drsList),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderSlbServiceGroupMemberOperOperDrsListStructList",
    },
  };
...
export class DataThunderSlbServiceGroupMemberOperOperOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataThunderSlbServiceGroupMemberOperOper | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataThunderSlbServiceGroupMemberOperOper | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _altList = new DataThunderSlbServiceGroupMemberOperOperAltListStructList(this, "alt_list", false);
  public get altList() {
    return this._altList;
  }
  public putAltList(value: DataThunderSlbServiceGroupMemberOperOperAltListStruct[] | cdktf.IResolvable) {
  ...
  private _drsList = new DataThunderSlbServiceGroupMemberOperOperDrsListStructList(this, "drs_list", false);
  public get drsList() {
    return this._drsList;
  }
  public putDrsList(value: DataThunderSlbServiceGroupMemberOperOperDrsListStruct[] | cdktf.IResolvable) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper thunder_slb_service_group_member_oper}
*/
export class DataThunderSlbServiceGroupMemberOper extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_service_group_member_oper";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataThunderSlbServiceGroupMemberOper resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataThunderSlbServiceGroupMemberOper to import
  * @param importFromId The id of the existing DataThunderSlbServiceGroupMemberOper that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataThunderSlbServiceGroupMemberOper to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_service_group_member_oper", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/slb_service_group_member_oper thunder_slb_service_group_member_oper} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataThunderSlbServiceGroupMemberOperConfig
  */
  public constructor(scope: Construct, id: string, config: DataThunderSlbServiceGroupMemberOperConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_slb_service_group_member_oper',
  ...
  private _oper = new DataThunderSlbServiceGroupMemberOperOperOutputReference(this, "oper");
  public get oper() {
    return this._oper;
  }
  public putOper(value: DataThunderSlbServiceGroupMemberOperOper) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      oper: dataThunderSlbServiceGroupMemberOperOperToTerraform(this._oper.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      oper: {
        value: dataThunderSlbServiceGroupMemberOperOperToHclTerraform(this._oper.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderSlbServiceGroupMemberOperOperList",
      },
    };
