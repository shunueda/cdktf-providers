...
export interface FwServerPortConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface FwServerPortSamplingEnable {
  /**
...
export function fwServerPortSamplingEnableToTerraform(struct?: FwServerPortSamplingEnable | cdktf.IResolvable): any {
...
export function fwServerPortSamplingEnableToHclTerraform(struct?: FwServerPortSamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class FwServerPortSamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): FwServerPortSamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: FwServerPortSamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class FwServerPortSamplingEnableList extends cdktf.ComplexList {
  public internalValue? : FwServerPortSamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): FwServerPortSamplingEnableOutputReference {
    return new FwServerPortSamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class FwServerPort extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_fw_server_port";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_fw_server_port", importId: importFromId, provider });
      }
  ...
  * @param options FwServerPortConfig
  */
  public constructor(scope: Construct, id: string, config: FwServerPortConfig) {
    super(scope, id, {
  ...
  private _samplingEnable = new FwServerPortSamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: FwServerPortSamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(fwServerPortSamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "FwServerPortSamplingEnableList",
      },
    };
