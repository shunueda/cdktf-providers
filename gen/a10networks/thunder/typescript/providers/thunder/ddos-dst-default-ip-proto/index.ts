...
export interface DdosDstDefaultIpProtoConfig extends cdktf.TerraformMetaArguments {
  /**
  * DefaultAddressType
  *
...
export interface DdosDstDefaultIpProtoTemplate {
  /**
  * DDOS other template
  *
...
export function ddosDstDefaultIpProtoTemplateToTerraform(struct?: DdosDstDefaultIpProtoTemplateOutputReference | DdosDstDefaultIpProtoTemplate): any {
...
export function ddosDstDefaultIpProtoTemplateToHclTerraform(struct?: DdosDstDefaultIpProtoTemplateOutputReference | DdosDstDefaultIpProtoTemplate): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DdosDstDefaultIpProtoTemplateOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DdosDstDefaultIpProtoTemplate | undefined {
  ...
  public set internalValue(value: DdosDstDefaultIpProtoTemplate | undefined) {
    if (value === undefined) {
...
export class DdosDstDefaultIpProto extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_dst_default_ip_proto";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_dst_default_ip_proto", importId: importFromId, provider });
      }
  ...
  * @param options DdosDstDefaultIpProtoConfig
  */
  public constructor(scope: Construct, id: string, config: DdosDstDefaultIpProtoConfig) {
    super(scope, id, {
  ...
  private _template = new DdosDstDefaultIpProtoTemplateOutputReference(this, "template");
  public get template() {
    return this._template;
  }
  public putTemplate(value: DdosDstDefaultIpProtoTemplate) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      template: ddosDstDefaultIpProtoTemplateToTerraform(this._template.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      template: {
        value: ddosDstDefaultIpProtoTemplateToHclTerraform(this._template.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DdosDstDefaultIpProtoTemplateList",
      },
    };
