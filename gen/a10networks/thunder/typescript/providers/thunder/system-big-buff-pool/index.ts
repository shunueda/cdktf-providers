// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/system_big_buff_pool
...
export interface SystemBigBuffPoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/system_big_buff_pool#big_buff_pool SystemBigBuffPool#big_buff_pool}
  */
  readonly bigBuffPool?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/system_big_buff_pool#id SystemBigBuffPool#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/system_big_buff_pool thunder_system_big_buff_pool}
*/
export class SystemBigBuffPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemBigBuffPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/system_big_buff_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/system_big_buff_pool thunder_system_big_buff_pool} Resource
  *
  * @param scope The scope in which to define this construct
