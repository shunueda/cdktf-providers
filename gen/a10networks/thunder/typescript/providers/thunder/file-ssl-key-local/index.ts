// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/file_ssl_key_local
...
export interface FileSslKeyLocalConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/file_ssl_key_local#action FileSslKeyLocal#action}
  */
  readonly action?: string;
  /**
  * destination file name for copy and rename action
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/file_ssl_key_local#dst_file FileSslKeyLocal#dst_file}
  */
  readonly dstFile?: string;
  /**
  * ssl key local file name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/file_ssl_key_local#file FileSslKeyLocal#file}
  */
  readonly file?: string;
  /**
  * full path of the uploaded file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/file_ssl_key_local#file_handle FileSslKeyLocal#file_handle}
  */
  readonly fileHandle?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/file_ssl_key_local#id FileSslKeyLocal#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/file_ssl_key_local#secured FileSslKeyLocal#secured}
  */
  readonly secured?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/file_ssl_key_local#uuid FileSslKeyLocal#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/file_ssl_key_local thunder_file_ssl_key_local}
*/
export class FileSslKeyLocal extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FileSslKeyLocal that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/file_ssl_key_local#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/file_ssl_key_local thunder_file_ssl_key_local} Resource
  *
  * @param scope The scope in which to define this construct
