// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_dnskey
...
export interface DnssecDnskeyAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_dnskey#id DnssecDnskeyA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_dnskey#key_delete DnssecDnskeyA#key_delete}
  */
  readonly keyDelete?: number;
  /**
  * DNS zone name of the child zone
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_dnskey#zone_name DnssecDnskeyA#zone_name}
  */
  readonly zoneName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_dnskey thunder_dnssec_dnskey}
*/
export class DnssecDnskeyA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnssecDnskeyA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_dnskey#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_dnskey thunder_dnssec_dnskey} Resource
  *
  * @param scope The scope in which to define this construct
