// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_lsa
...
export interface DebugOspfLsaAConfig extends cdktf.TerraformMetaArguments {
  ...
  * LSA Flooding
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_lsa#flooding DebugOspfLsaA#flooding}
  */
  readonly flooding?: number;
  /**
  * LSA Generation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_lsa#gererate DebugOspfLsaA#gererate}
  */
  readonly gererate?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_lsa#id DebugOspfLsaA#id}
  *
  ...
  * LSA Installation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_lsa#install DebugOspfLsaA#install}
  */
  readonly install?: number;
  /**
  * LSA MaxAge processing
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_lsa#maxage DebugOspfLsaA#maxage}
  */
  readonly maxage?: number;
  /**
  * LSA Refreshment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_lsa#refresh DebugOspfLsaA#refresh}
  */
  readonly refresh?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_lsa#uuid DebugOspfLsaA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_lsa thunder_debug_ospf_lsa}
*/
export class DebugOspfLsaA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DebugOspfLsaA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_lsa#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_lsa thunder_debug_ospf_lsa} Resource
  *
  * @param scope The scope in which to define this construct
