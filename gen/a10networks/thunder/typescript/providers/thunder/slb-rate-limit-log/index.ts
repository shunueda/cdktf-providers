...
export interface SlbRateLimitLogSamplingEnable {
  /**
...
export function slbRateLimitLogSamplingEnableToTerraform(struct?: SlbRateLimitLogSamplingEnable | cdktf.IResolvable): any {
...
export function slbRateLimitLogSamplingEnableToHclTerraform(struct?: SlbRateLimitLogSamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SlbRateLimitLogSamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SlbRateLimitLogSamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SlbRateLimitLogSamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SlbRateLimitLogSamplingEnableList extends cdktf.ComplexList {
  public internalValue? : SlbRateLimitLogSamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): SlbRateLimitLogSamplingEnableOutputReference {
    return new SlbRateLimitLogSamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class SlbRateLimitLog extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_rate_limit_log";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_rate_limit_log", importId: importFromId, provider });
      }
  ...
  * @param options SlbRateLimitLogConfig = {}
  */
  public constructor(scope: Construct, id: string, config: SlbRateLimitLogConfig = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new SlbRateLimitLogSamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: SlbRateLimitLogSamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(slbRateLimitLogSamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(slbRateLimitLogSamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "SlbRateLimitLogSamplingEnableList",
      },
    };
