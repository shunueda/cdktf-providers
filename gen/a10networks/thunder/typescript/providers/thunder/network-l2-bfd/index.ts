// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_l2_bfd
...
export interface NetworkL2BfdConfig extends cdktf.TerraformMetaArguments {
  /**
  * Ethernet payload type for L2BFD packets, help-val 16 bit hex value, default is hex 88B6
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_l2_bfd#ether_type NetworkL2Bfd#ether_type}
  */
  readonly etherType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_l2_bfd#id NetworkL2Bfd#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_l2_bfd#multiplier NetworkL2Bfd#multiplier}
  */
  readonly multiplier?: number;
  /**
  * Minimum receive interval capability (Milliseconds (default: 800))
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_l2_bfd#rx_interval NetworkL2Bfd#rx_interval}
  */
  readonly rxInterval?: number;
  /**
  * Transmit interval between BFD packets (Milliseconds (default: 800))
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_l2_bfd#tx_interval NetworkL2Bfd#tx_interval}
  */
  readonly txInterval?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_l2_bfd#uuid NetworkL2Bfd#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_l2_bfd thunder_network_l2_bfd}
*/
export class NetworkL2Bfd extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkL2Bfd that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_l2_bfd#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_l2_bfd thunder_network_l2_bfd} Resource
  *
  * @param scope The scope in which to define this construct
