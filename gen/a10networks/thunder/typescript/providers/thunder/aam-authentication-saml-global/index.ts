...
export interface AamAuthenticationSamlGlobalSamplingEnable {
  /**
...
export function aamAuthenticationSamlGlobalSamplingEnableToTerraform(struct?: AamAuthenticationSamlGlobalSamplingEnable | cdktf.IResolvable): any {
...
export function aamAuthenticationSamlGlobalSamplingEnableToHclTerraform(struct?: AamAuthenticationSamlGlobalSamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AamAuthenticationSamlGlobalSamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AamAuthenticationSamlGlobalSamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AamAuthenticationSamlGlobalSamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class AamAuthenticationSamlGlobalSamplingEnableList extends cdktf.ComplexList {
  public internalValue? : AamAuthenticationSamlGlobalSamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): AamAuthenticationSamlGlobalSamplingEnableOutputReference {
    return new AamAuthenticationSamlGlobalSamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class AamAuthenticationSamlGlobal extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_aam_authentication_saml_global";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_aam_authentication_saml_global", importId: importFromId, provider });
      }
  ...
  * @param options AamAuthenticationSamlGlobalConfig = {}
  */
  public constructor(scope: Construct, id: string, config: AamAuthenticationSamlGlobalConfig = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new AamAuthenticationSamlGlobalSamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: AamAuthenticationSamlGlobalSamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(aamAuthenticationSamlGlobalSamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(aamAuthenticationSamlGlobalSamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AamAuthenticationSamlGlobalSamplingEnableList",
      },
    };
