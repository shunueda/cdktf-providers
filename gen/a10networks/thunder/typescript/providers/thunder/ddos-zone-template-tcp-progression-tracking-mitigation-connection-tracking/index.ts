// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking
...
export interface DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Set the maximum duration time (in unit of 100ms, up to 24 hours)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#conn_duration_max DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#conn_duration_max}
  */
  readonly connDurationMax?: number;
  /**
  * Set the minimum duration time (in unit of 100ms, up to 24 hours)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#conn_duration_min DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#conn_duration_min}
  */
  readonly connDurationMin?: number;
  /**
  * Set the maximum total received byte
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#conn_rcvd_max DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#conn_rcvd_max}
  */
  readonly connRcvdMax?: number;
  /**
  * Set the minimum total received byte
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#conn_rcvd_min DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#conn_rcvd_min}
  */
  readonly connRcvdMin?: number;
  /**
  * Set the maximum received to sent ratio (in unit of milli-, 0.001)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#conn_rcvd_sent_ratio_max DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#conn_rcvd_sent_ratio_max}
  */
  readonly connRcvdSentRatioMax?: number;
  /**
  * Set the minimum received to sent ratio (in unit of milli-, 0.001)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#conn_rcvd_sent_ratio_min DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#conn_rcvd_sent_ratio_min}
  */
  readonly connRcvdSentRatioMin?: number;
  /**
  * Set the maximum total sent byte
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#conn_sent_max DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#conn_sent_max}
  */
  readonly connSentMax?: number;
  /**
  * Set the minimum total sent byte
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#conn_sent_min DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#conn_sent_min}
  */
  readonly connSentMin?: number;
  /**
  * Set the violation threshold
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#conn_violation DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#conn_violation}
  */
  readonly connViolation?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#id DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#progression_tracking_conn_action DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#progression_tracking_conn_action}
  */
  readonly progressionTrackingConnAction?: string;
  /**
  * Configure action-list to take when progression tracking violation exceed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#progression_tracking_conn_action_list_name DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#progression_tracking_conn_action_list_name}
  */
  readonly progressionTrackingConnActionListName?: string;
  /**
  * 'enable-check': Enable General Progression Tracking per Connection;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#progression_tracking_conn_enabled DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#progression_tracking_conn_enabled}
  */
  readonly progressionTrackingConnEnabled: string;
  /**
  * Tcp_name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#tcp_name DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#tcp_name}
  */
  readonly tcpName: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#uuid DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking thunder_ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking}
*/
export class DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA to import
  * @param importFromId The id of the existing DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking thunder_ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingAConfig
  */
  public constructor(scope: Construct, id: string, config: DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTrackingAConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking',
