// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/backup_system
...
export interface BackupSystemConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/backup_system#encrypt BackupSystem#encrypt}
  */
  readonly encrypt?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/backup_system#id BackupSystem#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/backup_system#password BackupSystem#password}
  */
  readonly password?: string;
  /**
  * profile name for remote url
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/backup_system#remote_file BackupSystem#remote_file}
  */
  readonly remoteFile?: string;
  /**
  * Save backup store information
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/backup_system#store_name BackupSystem#store_name}
  */
  readonly storeName?: string;
  /**
  * Use management port as source port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/backup_system#use_mgmt_port BackupSystem#use_mgmt_port}
  */
  readonly useMgmtPort?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/backup_system thunder_backup_system}
*/
export class BackupSystem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/backup_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/backup_system thunder_backup_system} Resource
  *
  * @param scope The scope in which to define this construct
