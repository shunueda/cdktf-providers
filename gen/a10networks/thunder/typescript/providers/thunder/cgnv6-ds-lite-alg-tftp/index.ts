// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_ds_lite_alg_tftp
...
export interface Cgnv6DsLiteAlgTftpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_ds_lite_alg_tftp#id Cgnv6DsLiteAlgTftp#id}
  *
  ...
  * 'enable': Enable ALG;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_ds_lite_alg_tftp#tftp_enable Cgnv6DsLiteAlgTftp#tftp_enable}
  */
  readonly tftpEnable?: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_ds_lite_alg_tftp#uuid Cgnv6DsLiteAlgTftp#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_ds_lite_alg_tftp thunder_cgnv6_ds_lite_alg_tftp}
*/
export class Cgnv6DsLiteAlgTftp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cgnv6DsLiteAlgTftp that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_ds_lite_alg_tftp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/cgnv6_ds_lite_alg_tftp thunder_cgnv6_ds_lite_alg_tftp} Resource
  *
  * @param scope The scope in which to define this construct
