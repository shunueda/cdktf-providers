...
export interface GslbSecureAttributesConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GslbSecureAttributes extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_gslb_secure_attributes";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_gslb_secure_attributes", importId: importFromId, provider });
      }
  ...
  * @param options GslbSecureAttributesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: GslbSecureAttributesConfig = {}) {
    super(scope, id, {
    ...
    this._gslbCert = config.gslbCert;
    this._gslbKey = config.gslbKey;
    this._id = config.id;
  ...
  // gslb_cert - computed: false, optional: true, required: false
  private _gslbCert?: string; 
  public get gslbCert() {
    return this.getStringAttribute('gslb_cert');
  }
  public set gslbCert(value: string) {
    this._gslbCert = value;
  }
  public resetGslbCert() {
    this._gslbCert = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get gslbCertInput() {
    return this._gslbCert;
  }

  // gslb_key - computed: false, optional: true, required: false
  private _gslbKey?: string; 
  public get gslbKey() {
    return this.getStringAttribute('gslb_key');
  }
  public set gslbKey(value: string) {
    this._gslbKey = value;
  }
  public resetGslbKey() {
    this._gslbKey = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get gslbKeyInput() {
    return this._gslbKey;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      gslb_cert: cdktf.stringToTerraform(this._gslbCert),
      gslb_key: cdktf.stringToTerraform(this._gslbKey),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      gslb_cert: {
        value: cdktf.stringToHclTerraform(this._gslbCert),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      gslb_key: {
        value: cdktf.stringToHclTerraform(this._gslbKey),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
