// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_disable_partition_name
...
export interface LoggingDisablePartitionNameConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_disable_partition_name#disable_partition_name LoggingDisablePartitionName#disable_partition_name}
  */
  readonly disablePartitionName?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_disable_partition_name#id LoggingDisablePartitionName#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_disable_partition_name#uuid LoggingDisablePartitionName#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_disable_partition_name thunder_logging_disable_partition_name}
*/
export class LoggingDisablePartitionName extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingDisablePartitionName that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_disable_partition_name#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_disable_partition_name thunder_logging_disable_partition_name} Resource
  *
  * @param scope The scope in which to define this construct
