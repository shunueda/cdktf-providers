...
export function dataThunderInterfaceLifStatsStatsToTerraform(struct?: DataThunderInterfaceLifStatsStatsOutputReference | DataThunderInterfaceLifStatsStats): any {
  ...
  return {
    ...
    dropped_rx_pkts_gre_key: cdktf.numberToTerraform(struct!.droppedRxPktsGreKey),
...
export function dataThunderInterfaceLifStatsStatsToHclTerraform(struct?: DataThunderInterfaceLifStatsStatsOutputReference | DataThunderInterfaceLifStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    dropped_rx_pkts_gre_key: {
      value: cdktf.numberToHclTerraform(struct!.droppedRxPktsGreKey),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
...
export class DataThunderInterfaceLifStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderInterfaceLifStatsStats | undefined {
    ...
    if (this._droppedRxPktsGreKey !== undefined) {
      hasAnyValues = true;
      internalValueResult.droppedRxPktsGreKey = this._droppedRxPktsGreKey;
    }
  ...
  public set internalValue(value: DataThunderInterfaceLifStatsStats | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._droppedDisRxPkts = undefined;
      this._droppedDisTxPkts = undefined;
      this._droppedRxPkts = undefined;
      this._droppedRxPktsGreKey = undefined;
      ...
      this._droppedRxPktsGreKey = value.droppedRxPktsGreKey;
  ...
  // dropped_rx_pkts_gre_key - computed: false, optional: true, required: false
  private _droppedRxPktsGreKey?: number; 
  public get droppedRxPktsGreKey() {
    return this.getNumberAttribute('dropped_rx_pkts_gre_key');
  }
  public set droppedRxPktsGreKey(value: number) {
    this._droppedRxPktsGreKey = value;
  }
  public resetDroppedRxPktsGreKey() {
    this._droppedRxPktsGreKey = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get droppedRxPktsGreKeyInput() {
    return this._droppedRxPktsGreKey;
  }
...
export class DataThunderInterfaceLifStats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_interface_lif_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_interface_lif_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderInterfaceLifStatsConfig
  */
  public constructor(scope: Construct, id: string, config: DataThunderInterfaceLifStatsConfig) {
    super(scope, id, {
  ...
  private _stats = new DataThunderInterfaceLifStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderInterfaceLifStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderInterfaceLifStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderInterfaceLifStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderInterfaceLifStatsStatsList",
      },
    };
