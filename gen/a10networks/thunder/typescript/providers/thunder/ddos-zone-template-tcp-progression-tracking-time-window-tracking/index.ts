// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking
...
export interface DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#id DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA#id}
  *
  ...
  * Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#name DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA#name}
  */
  readonly name: string;
  /**
  * 'enable-check': Enable Progression Tracking per Time Window;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#progression_tracking_win_enabled DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA#progression_tracking_win_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#progression_tracking_windows_action DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA#progression_tracking_windows_action}
  */
  readonly progressionTrackingWindowsAction?: string;
  /**
  * Configure action-list to take when progression tracking violation exceed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#progression_tracking_windows_action_list_name DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA#progression_tracking_windows_action_list_name}
  */
  readonly progressionTrackingWindowsActionListName?: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#uuid DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA#uuid}
  */
  readonly uuid?: string;
  /**
  * Set the maximum total received byte
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#window_rcvd_max DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA#window_rcvd_max}
  */
  readonly windowRcvdMax?: number;
  /**
  * Set the minimum total received byte
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#window_rcvd_min DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA#window_rcvd_min}
  */
  readonly windowRcvdMin?: number;
  /**
  * Set the maximum received to sent ratio (in unit of 0.1% [1:1000])
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#window_rcvd_sent_ratio_max DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA#window_rcvd_sent_ratio_max}
  */
  readonly windowRcvdSentRatioMax?: number;
  /**
  * Set the minimum received to sent ratio (in unit of 0.1% [1:1000])
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#window_rcvd_sent_ratio_min DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA#window_rcvd_sent_ratio_min}
  */
  readonly windowRcvdSentRatioMin?: number;
  /**
  * Set the maximum total sent byte
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#window_sent_max DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA#window_sent_max}
  */
  readonly windowSentMax?: number;
  /**
  * Set the minimum total sent byte
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#window_sent_min DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA#window_sent_min}
  */
  readonly windowSentMin?: number;
  /**
  * Set the violation threshold
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#window_violation DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA#window_violation}
  */
  readonly windowViolation?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking thunder_ddos_zone_template_tcp_progression_tracking_time_window_tracking}
*/
export class DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_zone_template_tcp_progression_tracking_time_window_tracking";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA to import
  * @param importFromId The id of the existing DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_zone_template_tcp_progression_tracking_time_window_tracking", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_tcp_progression_tracking_time_window_tracking thunder_ddos_zone_template_tcp_progression_tracking_time_window_tracking} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingAConfig
  */
  public constructor(scope: Construct, id: string, config: DdosZoneTemplateTcpProgressionTrackingTimeWindowTrackingAConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_ddos_zone_template_tcp_progression_tracking_time_window_tracking',
