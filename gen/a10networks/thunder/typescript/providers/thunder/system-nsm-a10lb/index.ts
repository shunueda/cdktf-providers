...
export class SystemNsmA10LbA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_system_nsm_a10lb";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_system_nsm_a10lb", importId: importFromId, provider });
      }
  ...
  * @param options SystemNsmA10LbAConfig = {}
  */
  public constructor(scope: Construct, id: string, config: SystemNsmA10LbAConfig = {}) {
    super(scope, id, {
