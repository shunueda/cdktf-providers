...
export interface VisibilityPacketCaptureObjectTemplatesImapVportTmplTriggerStatsSeverityAConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class VisibilityPacketCaptureObjectTemplatesImapVportTmplTriggerStatsSeverityA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_visibility_packet_capture_object_templates_imap_vport_tmpl_trigger_stats_severity";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_visibility_packet_capture_object_templates_imap_vport_tmpl_trigger_stats_severity", importId: importFromId, provider });
      }
  ...
  * @param options VisibilityPacketCaptureObjectTemplatesImapVportTmplTriggerStatsSeverityAConfig
  */
  public constructor(scope: Construct, id: string, config: VisibilityPacketCaptureObjectTemplatesImapVportTmplTriggerStatsSeverityAConfig) {
    super(scope, id, {
