// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats
...
export interface DataThunderDdosDetectionAgentStatsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specify name for the agent
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#agent_name DataThunderDdosDetectionAgentStats#agent_name}
  */
  readonly agentName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#id DataThunderDdosDetectionAgentStats#id}
  *
  ...
  * stats block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#stats DataThunderDdosDetectionAgentStats#stats}
  */
  readonly stats?: DataThunderDdosDetectionAgentStatsStats;
}
export interface DataThunderDdosDetectionAgentStatsStats {
  /**
  * Detection Message Enqueue Failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#flow_detection_msgq_full DataThunderDdosDetectionAgentStats#flow_detection_msgq_full}
  */
  readonly flowDetectionMsgqFull?: number;
  /**
  * DDoS Destination Entry Lookup Failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#flow_dst_entry_miss DataThunderDdosDetectionAgentStats#flow_dst_entry_miss}
  */
  readonly flowDstEntryMiss?: number;
  /**
  * DDoS Destination Service Lookup Failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#flow_ip_proto_or_port_miss DataThunderDdosDetectionAgentStats#flow_ip_proto_or_port_miss}
  */
  readonly flowIpProtoOrPortMiss?: number;
  /**
  * DDoS Destination Network-object Entry Lookup Failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#flow_network_entry_miss DataThunderDdosDetectionAgentStats#flow_network_entry_miss}
  */
  readonly flowNetworkEntryMiss?: number;
  /**
  * Netflow Flow Samples Processing Disabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_disabled DataThunderDdosDetectionAgentStats#netflow_disabled}
  */
  readonly netflowDisabled?: number;
  /**
  * Netflow ICMP Samples Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_icmp_sample_received DataThunderDdosDetectionAgentStats#netflow_icmp_sample_received}
  */
  readonly netflowIcmpSampleReceived?: number;
  /**
  * Netflow OTHER Samples Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_other_sample_received DataThunderDdosDetectionAgentStats#netflow_other_sample_received}
  */
  readonly netflowOtherSampleReceived?: number;
  /**
  * Netflow Data Record Copy Fail, Local MEM size error
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_record_copy_oom_error DataThunderDdosDetectionAgentStats#netflow_record_copy_oom_error}
  */
  readonly netflowRecordCopyOomError?: number;
  /**
  * Netflow Data Record Reduced Size Invalid
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_record_rse_invalid DataThunderDdosDetectionAgentStats#netflow_record_rse_invalid}
  */
  readonly netflowRecordRseInvalid?: number;
  /**
  * Netflow Sample Flow Duration Error
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_sample_flow_dur_error DataThunderDdosDetectionAgentStats#netflow_sample_flow_dur_error}
  */
  readonly netflowSampleFlowDurError?: number;
  /**
  * Netflow TCP Samples Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_tcp_sample_received DataThunderDdosDetectionAgentStats#netflow_tcp_sample_received}
  */
  readonly netflowTcpSampleReceived?: number;
  /**
  * Netflow UDP Samples received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_udp_sample_received DataThunderDdosDetectionAgentStats#netflow_udp_sample_received}
  */
  readonly netflowUdpSampleReceived?: number;
  /**
  * Netflow v10 Sample Max records Error
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v10_max_records_exceed DataThunderDdosDetectionAgentStats#netflow_v10_max_records_exceed}
  */
  readonly netflowV10MaxRecordsExceed?: number;
  /**
  * Netflow v10 Packets Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v10_packets_received DataThunderDdosDetectionAgentStats#netflow_v10_packets_received}
  */
  readonly netflowV10PacketsReceived?: number;
  /**
  * Netflow v10 Sample Records Bad Length
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v10_sample_records_bad_len DataThunderDdosDetectionAgentStats#netflow_v10_sample_records_bad_len}
  */
  readonly netflowV10SampleRecordsBadLen?: number;
  /**
  * Netflow v10 Samples Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v10_samples_received DataThunderDdosDetectionAgentStats#netflow_v10_samples_received}
  */
  readonly netflowV10SamplesReceived?: number;
  /**
  * Netflow v10 Samples Procssed For Detection
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v10_samples_sent_for_detection DataThunderDdosDetectionAgentStats#netflow_v10_samples_sent_for_detection}
  */
  readonly netflowV10SamplesSentForDetection?: number;
  /**
  * Netflow v5 Sample Max Records Error
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v5_max_records_exceed DataThunderDdosDetectionAgentStats#netflow_v5_max_records_exceed}
  */
  readonly netflowV5MaxRecordsExceed?: number;
  /**
  * Netflow v5 Packets Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v5_packets_received DataThunderDdosDetectionAgentStats#netflow_v5_packets_received}
  */
  readonly netflowV5PacketsReceived?: number;
  /**
  * Netflow v5 Sample Records Bad Length
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v5_sample_records_bad_len DataThunderDdosDetectionAgentStats#netflow_v5_sample_records_bad_len}
  */
  readonly netflowV5SampleRecordsBadLen?: number;
  /**
  * Netflow v5 Samples Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v5_samples_received DataThunderDdosDetectionAgentStats#netflow_v5_samples_received}
  */
  readonly netflowV5SamplesReceived?: number;
  /**
  * Netflow v5 Samples Processed For Detection
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v5_samples_sent_for_detection DataThunderDdosDetectionAgentStats#netflow_v5_samples_sent_for_detection}
  */
  readonly netflowV5SamplesSentForDetection?: number;
  /**
  * Netflow v9 Sample Max Records Error
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v9_max_records_exceed DataThunderDdosDetectionAgentStats#netflow_v9_max_records_exceed}
  */
  readonly netflowV9MaxRecordsExceed?: number;
  /**
  * Netflow v9 Packets Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v9_packets_received DataThunderDdosDetectionAgentStats#netflow_v9_packets_received}
  */
  readonly netflowV9PacketsReceived?: number;
  /**
  * Netflow v9 Sample Flowset Bad Padding
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v9_sample_flowset_bad_padding DataThunderDdosDetectionAgentStats#netflow_v9_sample_flowset_bad_padding}
  */
  readonly netflowV9SampleFlowsetBadPadding?: number;
  /**
  * Netflow v9 Sample Records Bad Length
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v9_sample_records_bad_len DataThunderDdosDetectionAgentStats#netflow_v9_sample_records_bad_len}
  */
  readonly netflowV9SampleRecordsBadLen?: number;
  /**
  * Netflow v9 Samples Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v9_samples_received DataThunderDdosDetectionAgentStats#netflow_v9_samples_received}
  */
  readonly netflowV9SamplesReceived?: number;
  /**
  * Netflow v9 Samples Processed For Detection
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v9_samples_sent_for_detection DataThunderDdosDetectionAgentStats#netflow_v9_samples_sent_for_detection}
  */
  readonly netflowV9SamplesSentForDetection?: number;
  /**
  * Netflow v9 Template Not Found
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#netflow_v9_template_not_found DataThunderDdosDetectionAgentStats#netflow_v9_template_not_found}
  */
  readonly netflowV9TemplateNotFound?: number;
  /**
  * sFlow Packet Samples Processing Disabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#sflow_disabled DataThunderDdosDetectionAgentStats#sflow_disabled}
  */
  readonly sflowDisabled?: number;
  /**
  * sFlow Packets Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#sflow_packets_received DataThunderDdosDetectionAgentStats#sflow_packets_received}
  */
  readonly sflowPacketsReceived?: number;
  /**
  * sFlow Sample IPv6 Record Header Parse Failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#sflow_sample_ipv6_hdr_parse_fail DataThunderDdosDetectionAgentStats#sflow_sample_ipv6_hdr_parse_fail}
  */
  readonly sflowSampleIpv6HdrParseFail?: number;
  /**
  * sFlow Sample Records Bad Length
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#sflow_sample_record_bad_len DataThunderDdosDetectionAgentStats#sflow_sample_record_bad_len}
  */
  readonly sflowSampleRecordBadLen?: number;
  /**
  * sFlow Sample Records Unknown Layer-2
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#sflow_sample_record_invalid_layer2 DataThunderDdosDetectionAgentStats#sflow_sample_record_invalid_layer2}
  */
  readonly sflowSampleRecordInvalidLayer2?: number;
  /**
  * sFlow Samples Bad Length
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#sflow_samples_bad_len DataThunderDdosDetectionAgentStats#sflow_samples_bad_len}
  */
  readonly sflowSamplesBadLen?: number;
  /**
  * sFlow Samples Non-standard
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#sflow_samples_non_std DataThunderDdosDetectionAgentStats#sflow_samples_non_std}
  */
  readonly sflowSamplesNonStd?: number;
  /**
  * sFlow Samples Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#sflow_samples_received DataThunderDdosDetectionAgentStats#sflow_samples_received}
  */
  readonly sflowSamplesReceived?: number;
  /**
  * sFlow Samples Processed For Detection
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#sflow_samples_sent_for_detection DataThunderDdosDetectionAgentStats#sflow_samples_sent_for_detection}
  */
  readonly sflowSamplesSentForDetection?: number;
  /**
  * sFlow Samples Skipped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#sflow_samples_skipped DataThunderDdosDetectionAgentStats#sflow_samples_skipped}
  */
  readonly sflowSamplesSkipped?: number;
  /**
  * Extend Bytes Received of DDoS Destination Entry Miss
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#xflow_dst_entry_miss_extend_byte_rcv DataThunderDdosDetectionAgentStats#xflow_dst_entry_miss_extend_byte_rcv}
  */
  readonly xflowDstEntryMissExtendByteRcv?: number;
  /**
  * Extend Packets Received of DDoS Destination Entry Miss
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#xflow_dst_entry_miss_extend_pkt_rcv DataThunderDdosDetectionAgentStats#xflow_dst_entry_miss_extend_pkt_rcv}
  */
  readonly xflowDstEntryMissExtendPktRcv?: number;
  /**
  * Extend Bytes Received of DDoS Destination Service Miss
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#xflow_dst_svc_miss_extend_byte_rcv DataThunderDdosDetectionAgentStats#xflow_dst_svc_miss_extend_byte_rcv}
  */
  readonly xflowDstSvcMissExtendByteRcv?: number;
  /**
  * Extend Packets Received of DDoS Destination Service Miss
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#xflow_dst_svc_miss_extend_pkt_rcv DataThunderDdosDetectionAgentStats#xflow_dst_svc_miss_extend_pkt_rcv}
  */
  readonly xflowDstSvcMissExtendPktRcv?: number;
  /**
  * XFlow Sample Extend Bytes Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#xflow_extend_byte_rcv DataThunderDdosDetectionAgentStats#xflow_extend_byte_rcv}
  */
  readonly xflowExtendByteRcv?: number;
  /**
  * XFlow Sample Extend Packets Received
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#xflow_extend_pkt_rcv DataThunderDdosDetectionAgentStats#xflow_extend_pkt_rcv}
  */
  readonly xflowExtendPktRcv?: number;
}

export function dataThunderDdosDetectionAgentStatsStatsToTerraform(struct?: DataThunderDdosDetectionAgentStatsStatsOutputReference | DataThunderDdosDetectionAgentStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    flow_detection_msgq_full: cdktf.numberToTerraform(struct!.flowDetectionMsgqFull),
    flow_dst_entry_miss: cdktf.numberToTerraform(struct!.flowDstEntryMiss),
    flow_ip_proto_or_port_miss: cdktf.numberToTerraform(struct!.flowIpProtoOrPortMiss),
    flow_network_entry_miss: cdktf.numberToTerraform(struct!.flowNetworkEntryMiss),
    ...
    netflow_v9_sample_flowset_bad_padding: cdktf.numberToTerraform(struct!.netflowV9SampleFlowsetBadPadding),
    ...
    netflow_v9_template_not_found: cdktf.numberToTerraform(struct!.netflowV9TemplateNotFound),
    ...
    xflow_dst_entry_miss_extend_byte_rcv: cdktf.numberToTerraform(struct!.xflowDstEntryMissExtendByteRcv),
    xflow_dst_entry_miss_extend_pkt_rcv: cdktf.numberToTerraform(struct!.xflowDstEntryMissExtendPktRcv),
    xflow_dst_svc_miss_extend_byte_rcv: cdktf.numberToTerraform(struct!.xflowDstSvcMissExtendByteRcv),
    xflow_dst_svc_miss_extend_pkt_rcv: cdktf.numberToTerraform(struct!.xflowDstSvcMissExtendPktRcv),
    xflow_extend_byte_rcv: cdktf.numberToTerraform(struct!.xflowExtendByteRcv),
    xflow_extend_pkt_rcv: cdktf.numberToTerraform(struct!.xflowExtendPktRcv),
  }
}


export function dataThunderDdosDetectionAgentStatsStatsToHclTerraform(struct?: DataThunderDdosDetectionAgentStatsStatsOutputReference | DataThunderDdosDetectionAgentStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    flow_detection_msgq_full: {
      value: cdktf.numberToHclTerraform(struct!.flowDetectionMsgqFull),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    flow_dst_entry_miss: {
      value: cdktf.numberToHclTerraform(struct!.flowDstEntryMiss),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    flow_ip_proto_or_port_miss: {
      value: cdktf.numberToHclTerraform(struct!.flowIpProtoOrPortMiss),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    flow_network_entry_miss: {
      value: cdktf.numberToHclTerraform(struct!.flowNetworkEntryMiss),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    ...
    netflow_v9_sample_flowset_bad_padding: {
      value: cdktf.numberToHclTerraform(struct!.netflowV9SampleFlowsetBadPadding),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    ...
    netflow_v9_template_not_found: {
      value: cdktf.numberToHclTerraform(struct!.netflowV9TemplateNotFound),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    ...
    xflow_dst_entry_miss_extend_byte_rcv: {
      value: cdktf.numberToHclTerraform(struct!.xflowDstEntryMissExtendByteRcv),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    xflow_dst_entry_miss_extend_pkt_rcv: {
      value: cdktf.numberToHclTerraform(struct!.xflowDstEntryMissExtendPktRcv),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    xflow_dst_svc_miss_extend_byte_rcv: {
      value: cdktf.numberToHclTerraform(struct!.xflowDstSvcMissExtendByteRcv),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    xflow_dst_svc_miss_extend_pkt_rcv: {
      value: cdktf.numberToHclTerraform(struct!.xflowDstSvcMissExtendPktRcv),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    xflow_extend_byte_rcv: {
      value: cdktf.numberToHclTerraform(struct!.xflowExtendByteRcv),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    xflow_extend_pkt_rcv: {
      value: cdktf.numberToHclTerraform(struct!.xflowExtendPktRcv),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
...
export class DataThunderDdosDetectionAgentStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderDdosDetectionAgentStatsStats | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._flowDetectionMsgqFull !== undefined) {
      hasAnyValues = true;
      internalValueResult.flowDetectionMsgqFull = this._flowDetectionMsgqFull;
    }
    if (this._flowDstEntryMiss !== undefined) {
      hasAnyValues = true;
      internalValueResult.flowDstEntryMiss = this._flowDstEntryMiss;
    }
    if (this._flowIpProtoOrPortMiss !== undefined) {
      hasAnyValues = true;
      internalValueResult.flowIpProtoOrPortMiss = this._flowIpProtoOrPortMiss;
    }
    if (this._flowNetworkEntryMiss !== undefined) {
      hasAnyValues = true;
      internalValueResult.flowNetworkEntryMiss = this._flowNetworkEntryMiss;
    }
    ...
    if (this._netflowV9SampleFlowsetBadPadding !== undefined) {
      hasAnyValues = true;
      internalValueResult.netflowV9SampleFlowsetBadPadding = this._netflowV9SampleFlowsetBadPadding;
    }
    ...
    if (this._netflowV9TemplateNotFound !== undefined) {
      hasAnyValues = true;
      internalValueResult.netflowV9TemplateNotFound = this._netflowV9TemplateNotFound;
    }
    ...
    if (this._xflowDstEntryMissExtendByteRcv !== undefined) {
      hasAnyValues = true;
      internalValueResult.xflowDstEntryMissExtendByteRcv = this._xflowDstEntryMissExtendByteRcv;
    }
    if (this._xflowDstEntryMissExtendPktRcv !== undefined) {
      hasAnyValues = true;
      internalValueResult.xflowDstEntryMissExtendPktRcv = this._xflowDstEntryMissExtendPktRcv;
    }
    if (this._xflowDstSvcMissExtendByteRcv !== undefined) {
      hasAnyValues = true;
      internalValueResult.xflowDstSvcMissExtendByteRcv = this._xflowDstSvcMissExtendByteRcv;
    }
    if (this._xflowDstSvcMissExtendPktRcv !== undefined) {
      hasAnyValues = true;
      internalValueResult.xflowDstSvcMissExtendPktRcv = this._xflowDstSvcMissExtendPktRcv;
    }
    if (this._xflowExtendByteRcv !== undefined) {
      hasAnyValues = true;
      internalValueResult.xflowExtendByteRcv = this._xflowExtendByteRcv;
    }
    if (this._xflowExtendPktRcv !== undefined) {
      hasAnyValues = true;
      internalValueResult.xflowExtendPktRcv = this._xflowExtendPktRcv;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataThunderDdosDetectionAgentStatsStats | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._flowDetectionMsgqFull = undefined;
      this._flowDstEntryMiss = undefined;
      this._flowIpProtoOrPortMiss = undefined;
      this._flowNetworkEntryMiss = undefined;
      ...
      this._netflowV9SampleFlowsetBadPadding = undefined;
      ...
      this._netflowV9TemplateNotFound = undefined;
      ...
      this._xflowDstEntryMissExtendByteRcv = undefined;
      this._xflowDstEntryMissExtendPktRcv = undefined;
      this._xflowDstSvcMissExtendByteRcv = undefined;
      this._xflowDstSvcMissExtendPktRcv = undefined;
      this._xflowExtendByteRcv = undefined;
      this._xflowExtendPktRcv = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._flowDetectionMsgqFull = value.flowDetectionMsgqFull;
      this._flowDstEntryMiss = value.flowDstEntryMiss;
      this._flowIpProtoOrPortMiss = value.flowIpProtoOrPortMiss;
      this._flowNetworkEntryMiss = value.flowNetworkEntryMiss;
      ...
      this._netflowV9SampleFlowsetBadPadding = value.netflowV9SampleFlowsetBadPadding;
      ...
      this._netflowV9TemplateNotFound = value.netflowV9TemplateNotFound;
      ...
      this._xflowDstEntryMissExtendByteRcv = value.xflowDstEntryMissExtendByteRcv;
      this._xflowDstEntryMissExtendPktRcv = value.xflowDstEntryMissExtendPktRcv;
      this._xflowDstSvcMissExtendByteRcv = value.xflowDstSvcMissExtendByteRcv;
      this._xflowDstSvcMissExtendPktRcv = value.xflowDstSvcMissExtendPktRcv;
      this._xflowExtendByteRcv = value.xflowExtendByteRcv;
      this._xflowExtendPktRcv = value.xflowExtendPktRcv;
    }
  }

  // flow_detection_msgq_full - computed: false, optional: true, required: false
  private _flowDetectionMsgqFull?: number; 
  public get flowDetectionMsgqFull() {
    return this.getNumberAttribute('flow_detection_msgq_full');
  }
  public set flowDetectionMsgqFull(value: number) {
    this._flowDetectionMsgqFull = value;
  }
  public resetFlowDetectionMsgqFull() {
    this._flowDetectionMsgqFull = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get flowDetectionMsgqFullInput() {
    return this._flowDetectionMsgqFull;
  }

  // flow_dst_entry_miss - computed: false, optional: true, required: false
  private _flowDstEntryMiss?: number; 
  public get flowDstEntryMiss() {
    return this.getNumberAttribute('flow_dst_entry_miss');
  }
  public set flowDstEntryMiss(value: number) {
    this._flowDstEntryMiss = value;
  }
  public resetFlowDstEntryMiss() {
    this._flowDstEntryMiss = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get flowDstEntryMissInput() {
    return this._flowDstEntryMiss;
  }

  // flow_ip_proto_or_port_miss - computed: false, optional: true, required: false
  private _flowIpProtoOrPortMiss?: number; 
  public get flowIpProtoOrPortMiss() {
    return this.getNumberAttribute('flow_ip_proto_or_port_miss');
  }
  public set flowIpProtoOrPortMiss(value: number) {
    this._flowIpProtoOrPortMiss = value;
  }
  public resetFlowIpProtoOrPortMiss() {
    this._flowIpProtoOrPortMiss = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get flowIpProtoOrPortMissInput() {
    return this._flowIpProtoOrPortMiss;
  }

  // flow_network_entry_miss - computed: false, optional: true, required: false
  private _flowNetworkEntryMiss?: number; 
  public get flowNetworkEntryMiss() {
    return this.getNumberAttribute('flow_network_entry_miss');
  }
  public set flowNetworkEntryMiss(value: number) {
    this._flowNetworkEntryMiss = value;
  }
  public resetFlowNetworkEntryMiss() {
    this._flowNetworkEntryMiss = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get flowNetworkEntryMissInput() {
    return this._flowNetworkEntryMiss;
  }
  ...
  // netflow_v9_sample_flowset_bad_padding - computed: false, optional: true, required: false
  private _netflowV9SampleFlowsetBadPadding?: number; 
  public get netflowV9SampleFlowsetBadPadding() {
    return this.getNumberAttribute('netflow_v9_sample_flowset_bad_padding');
  }
  public set netflowV9SampleFlowsetBadPadding(value: number) {
    this._netflowV9SampleFlowsetBadPadding = value;
  }
  public resetNetflowV9SampleFlowsetBadPadding() {
    this._netflowV9SampleFlowsetBadPadding = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get netflowV9SampleFlowsetBadPaddingInput() {
    return this._netflowV9SampleFlowsetBadPadding;
  }
  ...
  // netflow_v9_template_not_found - computed: false, optional: true, required: false
  private _netflowV9TemplateNotFound?: number; 
  public get netflowV9TemplateNotFound() {
    return this.getNumberAttribute('netflow_v9_template_not_found');
  }
  public set netflowV9TemplateNotFound(value: number) {
    this._netflowV9TemplateNotFound = value;
  }
  public resetNetflowV9TemplateNotFound() {
    this._netflowV9TemplateNotFound = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get netflowV9TemplateNotFoundInput() {
    return this._netflowV9TemplateNotFound;
  }
  ...
  // xflow_dst_entry_miss_extend_byte_rcv - computed: false, optional: true, required: false
  private _xflowDstEntryMissExtendByteRcv?: number; 
  public get xflowDstEntryMissExtendByteRcv() {
    return this.getNumberAttribute('xflow_dst_entry_miss_extend_byte_rcv');
  }
  public set xflowDstEntryMissExtendByteRcv(value: number) {
    this._xflowDstEntryMissExtendByteRcv = value;
  }
  public resetXflowDstEntryMissExtendByteRcv() {
    this._xflowDstEntryMissExtendByteRcv = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get xflowDstEntryMissExtendByteRcvInput() {
    return this._xflowDstEntryMissExtendByteRcv;
  }

  // xflow_dst_entry_miss_extend_pkt_rcv - computed: false, optional: true, required: false
  private _xflowDstEntryMissExtendPktRcv?: number; 
  public get xflowDstEntryMissExtendPktRcv() {
    return this.getNumberAttribute('xflow_dst_entry_miss_extend_pkt_rcv');
  }
  public set xflowDstEntryMissExtendPktRcv(value: number) {
    this._xflowDstEntryMissExtendPktRcv = value;
  }
  public resetXflowDstEntryMissExtendPktRcv() {
    this._xflowDstEntryMissExtendPktRcv = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get xflowDstEntryMissExtendPktRcvInput() {
    return this._xflowDstEntryMissExtendPktRcv;
  }

  // xflow_dst_svc_miss_extend_byte_rcv - computed: false, optional: true, required: false
  private _xflowDstSvcMissExtendByteRcv?: number; 
  public get xflowDstSvcMissExtendByteRcv() {
    return this.getNumberAttribute('xflow_dst_svc_miss_extend_byte_rcv');
  }
  public set xflowDstSvcMissExtendByteRcv(value: number) {
    this._xflowDstSvcMissExtendByteRcv = value;
  }
  public resetXflowDstSvcMissExtendByteRcv() {
    this._xflowDstSvcMissExtendByteRcv = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get xflowDstSvcMissExtendByteRcvInput() {
    return this._xflowDstSvcMissExtendByteRcv;
  }

  // xflow_dst_svc_miss_extend_pkt_rcv - computed: false, optional: true, required: false
  private _xflowDstSvcMissExtendPktRcv?: number; 
  public get xflowDstSvcMissExtendPktRcv() {
    return this.getNumberAttribute('xflow_dst_svc_miss_extend_pkt_rcv');
  }
  public set xflowDstSvcMissExtendPktRcv(value: number) {
    this._xflowDstSvcMissExtendPktRcv = value;
  }
  public resetXflowDstSvcMissExtendPktRcv() {
    this._xflowDstSvcMissExtendPktRcv = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get xflowDstSvcMissExtendPktRcvInput() {
    return this._xflowDstSvcMissExtendPktRcv;
  }

  // xflow_extend_byte_rcv - computed: false, optional: true, required: false
  private _xflowExtendByteRcv?: number; 
  public get xflowExtendByteRcv() {
    return this.getNumberAttribute('xflow_extend_byte_rcv');
  }
  public set xflowExtendByteRcv(value: number) {
    this._xflowExtendByteRcv = value;
  }
  public resetXflowExtendByteRcv() {
    this._xflowExtendByteRcv = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get xflowExtendByteRcvInput() {
    return this._xflowExtendByteRcv;
  }

  // xflow_extend_pkt_rcv - computed: false, optional: true, required: false
  private _xflowExtendPktRcv?: number; 
  public get xflowExtendPktRcv() {
    return this.getNumberAttribute('xflow_extend_pkt_rcv');
  }
  public set xflowExtendPktRcv(value: number) {
    this._xflowExtendPktRcv = value;
  }
  public resetXflowExtendPktRcv() {
    this._xflowExtendPktRcv = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get xflowExtendPktRcvInput() {
    return this._xflowExtendPktRcv;
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats thunder_ddos_detection_agent_stats}
*/
export class DataThunderDdosDetectionAgentStats extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_detection_agent_stats";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataThunderDdosDetectionAgentStats resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataThunderDdosDetectionAgentStats to import
  * @param importFromId The id of the existing DataThunderDdosDetectionAgentStats that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataThunderDdosDetectionAgentStats to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_detection_agent_stats", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/ddos_detection_agent_stats thunder_ddos_detection_agent_stats} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataThunderDdosDetectionAgentStatsConfig
  */
  public constructor(scope: Construct, id: string, config: DataThunderDdosDetectionAgentStatsConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_ddos_detection_agent_stats',
  ...
  private _stats = new DataThunderDdosDetectionAgentStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderDdosDetectionAgentStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderDdosDetectionAgentStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderDdosDetectionAgentStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderDdosDetectionAgentStatsStatsList",
      },
    };
