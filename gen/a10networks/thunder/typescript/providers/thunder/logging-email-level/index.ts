// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_email_level
...
export interface LoggingEmailLevelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_email_level#email_levelname LoggingEmailLevel#email_levelname}
  */
  readonly emailLevelname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_email_level#id LoggingEmailLevel#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_email_level#uuid LoggingEmailLevel#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_email_level thunder_logging_email_level}
*/
export class LoggingEmailLevel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingEmailLevel that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_email_level#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_email_level thunder_logging_email_level} Resource
  *
  * @param scope The scope in which to define this construct
