...
export function dataThunderHarmonyControllerTunnelStatsOperOperToTerraform(struct?: DataThunderHarmonyControllerTunnelStatsOperOperOutputReference | DataThunderHarmonyControllerTunnelStatsOperOper): any {
...
export function dataThunderHarmonyControllerTunnelStatsOperOperToHclTerraform(struct?: DataThunderHarmonyControllerTunnelStatsOperOperOutputReference | DataThunderHarmonyControllerTunnelStatsOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderHarmonyControllerTunnelStatsOperOperOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderHarmonyControllerTunnelStatsOperOper | undefined {
  ...
  public set internalValue(value: DataThunderHarmonyControllerTunnelStatsOperOper | undefined) {
    if (value === undefined) {
...
export class DataThunderHarmonyControllerTunnelStatsOper extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_harmony_controller_tunnel_stats_oper";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_harmony_controller_tunnel_stats_oper", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderHarmonyControllerTunnelStatsOperConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderHarmonyControllerTunnelStatsOperConfig = {}) {
    super(scope, id, {
  ...
  private _oper = new DataThunderHarmonyControllerTunnelStatsOperOperOutputReference(this, "oper");
  public get oper() {
    return this._oper;
  }
  public putOper(value: DataThunderHarmonyControllerTunnelStatsOperOper) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      oper: dataThunderHarmonyControllerTunnelStatsOperOperToTerraform(this._oper.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      oper: {
        value: dataThunderHarmonyControllerTunnelStatsOperOperToHclTerraform(this._oper.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderHarmonyControllerTunnelStatsOperOperList",
      },
    };
