...
export interface DataThunderAamAuthenticationSamlServiceProviderStatsStats {
  /**
...
export function dataThunderAamAuthenticationSamlServiceProviderStatsStatsToTerraform(struct?: DataThunderAamAuthenticationSamlServiceProviderStatsStatsOutputReference | DataThunderAamAuthenticationSamlServiceProviderStatsStats): any {
...
export function dataThunderAamAuthenticationSamlServiceProviderStatsStatsToHclTerraform(struct?: DataThunderAamAuthenticationSamlServiceProviderStatsStatsOutputReference | DataThunderAamAuthenticationSamlServiceProviderStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderAamAuthenticationSamlServiceProviderStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderAamAuthenticationSamlServiceProviderStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderAamAuthenticationSamlServiceProviderStatsStats | undefined) {
    if (value === undefined) {
...
export class DataThunderAamAuthenticationSamlServiceProviderStats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_aam_authentication_saml_service_provider_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_aam_authentication_saml_service_provider_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderAamAuthenticationSamlServiceProviderStatsConfig
  */
  public constructor(scope: Construct, id: string, config: DataThunderAamAuthenticationSamlServiceProviderStatsConfig) {
    super(scope, id, {
  ...
  private _stats = new DataThunderAamAuthenticationSamlServiceProviderStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderAamAuthenticationSamlServiceProviderStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderAamAuthenticationSamlServiceProviderStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderAamAuthenticationSamlServiceProviderStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderAamAuthenticationSamlServiceProviderStatsStatsList",
      },
    };
