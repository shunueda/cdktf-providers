...
export interface DataThunderSlbPerfStatsStats {
  /**
  * FW Connections/sec
  *
...
export function dataThunderSlbPerfStatsStatsToTerraform(struct?: DataThunderSlbPerfStatsStatsOutputReference | DataThunderSlbPerfStatsStats): any {
  ...
  return {
    ...
    l7_proxy_conns_per_sec: cdktf.numberToTerraform(struct!.l7ProxyConnsPerSec),
    l7_proxy_trans_per_sec: cdktf.numberToTerraform(struct!.l7ProxyTransPerSec),
...
export function dataThunderSlbPerfStatsStatsToHclTerraform(struct?: DataThunderSlbPerfStatsStatsOutputReference | DataThunderSlbPerfStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    l7_proxy_conns_per_sec: {
      value: cdktf.numberToHclTerraform(struct!.l7ProxyConnsPerSec),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    l7_proxy_trans_per_sec: {
      value: cdktf.numberToHclTerraform(struct!.l7ProxyTransPerSec),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
...
export class DataThunderSlbPerfStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderSlbPerfStatsStats | undefined {
    ...
    if (this._l7ProxyConnsPerSec !== undefined) {
      hasAnyValues = true;
      internalValueResult.l7ProxyConnsPerSec = this._l7ProxyConnsPerSec;
    }
    if (this._l7ProxyTransPerSec !== undefined) {
      hasAnyValues = true;
      internalValueResult.l7ProxyTransPerSec = this._l7ProxyTransPerSec;
    }
  ...
  public set internalValue(value: DataThunderSlbPerfStatsStats | undefined) {
    if (value === undefined) {
      ...
      this._l7ProxyConnsPerSec = undefined;
      this._l7ProxyTransPerSec = undefined;
      ...
      this._l7ProxyConnsPerSec = value.l7ProxyConnsPerSec;
      this._l7ProxyTransPerSec = value.l7ProxyTransPerSec;
  ...
  // l7_proxy_conns_per_sec - computed: false, optional: true, required: false
  private _l7ProxyConnsPerSec?: number; 
  public get l7ProxyConnsPerSec() {
    return this.getNumberAttribute('l7_proxy_conns_per_sec');
  }
  public set l7ProxyConnsPerSec(value: number) {
    this._l7ProxyConnsPerSec = value;
  }
  public resetL7ProxyConnsPerSec() {
    this._l7ProxyConnsPerSec = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get l7ProxyConnsPerSecInput() {
    return this._l7ProxyConnsPerSec;
  }

  // l7_proxy_trans_per_sec - computed: false, optional: true, required: false
  private _l7ProxyTransPerSec?: number; 
  public get l7ProxyTransPerSec() {
    return this.getNumberAttribute('l7_proxy_trans_per_sec');
  }
  public set l7ProxyTransPerSec(value: number) {
    this._l7ProxyTransPerSec = value;
  }
  public resetL7ProxyTransPerSec() {
    this._l7ProxyTransPerSec = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get l7ProxyTransPerSecInput() {
    return this._l7ProxyTransPerSec;
  }
...
export class DataThunderSlbPerfStats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_perf_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_perf_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderSlbPerfStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderSlbPerfStatsConfig = {}) {
    super(scope, id, {
  ...
  private _stats = new DataThunderSlbPerfStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderSlbPerfStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderSlbPerfStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderSlbPerfStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderSlbPerfStatsStatsList",
      },
    };
