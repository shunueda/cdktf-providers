// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/snmp_server_enable_traps_gslb
...
export interface SnmpServerEnableTrapsGslbAConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/snmp_server_enable_traps_gslb#all SnmpServerEnableTrapsGslbA#all}
  */
  readonly all?: number;
  /**
  * Enable GSLB group related traps
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/snmp_server_enable_traps_gslb#group SnmpServerEnableTrapsGslbA#group}
  */
  readonly group?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/snmp_server_enable_traps_gslb#id SnmpServerEnableTrapsGslbA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/snmp_server_enable_traps_gslb#service_ip SnmpServerEnableTrapsGslbA#service_ip}
  */
  readonly serviceIp?: number;
  /**
  * Enable GSLB site related traps
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/snmp_server_enable_traps_gslb#site SnmpServerEnableTrapsGslbA#site}
  */
  readonly site?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/snmp_server_enable_traps_gslb#uuid SnmpServerEnableTrapsGslbA#uuid}
  */
  readonly uuid?: string;
  /**
  * Enable GSLB zone related traps
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/snmp_server_enable_traps_gslb#zone SnmpServerEnableTrapsGslbA#zone}
  */
  readonly zone?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/snmp_server_enable_traps_gslb thunder_snmp_server_enable_traps_gslb}
*/
export class SnmpServerEnableTrapsGslbA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnmpServerEnableTrapsGslbA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/snmp_server_enable_traps_gslb#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/snmp_server_enable_traps_gslb thunder_snmp_server_enable_traps_gslb} Resource
  *
  * @param scope The scope in which to define this construct
