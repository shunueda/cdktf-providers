// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_port_range_port_ind
...
export interface DdosDstZonePortRangePortIndAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_port_range_port_ind#id DdosDstZonePortRangePortIndA#id}
  *
  ...
  * PortRangeEnd
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_port_range_port_ind#port_range_end DdosDstZonePortRangePortIndA#port_range_end}
  */
  readonly portRangeEnd: string;
  /**
  * PortRangeStart
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_port_range_port_ind#port_range_start DdosDstZonePortRangePortIndA#port_range_start}
  */
  readonly portRangeStart: string;
  /**
  * Protocol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_port_range_port_ind#protocol DdosDstZonePortRangePortIndA#protocol}
  */
  readonly protocol: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_port_range_port_ind#uuid DdosDstZonePortRangePortIndA#uuid}
  */
  readonly uuid?: string;
  /**
  * ZoneName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_port_range_port_ind#zone_name DdosDstZonePortRangePortIndA#zone_name}
  */
  readonly zoneName: string;
  /**
  * sampling_enable block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_port_range_port_ind#sampling_enable DdosDstZonePortRangePortIndA#sampling_enable}
  */
  readonly samplingEnable?: DdosDstZonePortRangePortIndSamplingEnableA[] | cdktf.IResolvable;
}
export interface DdosDstZonePortRangePortIndSamplingEnableA {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_port_range_port_ind#counters1 DdosDstZonePortRangePortIndA#counters1}
  */
  readonly counters1?: string;
}

export function ddosDstZonePortRangePortIndSamplingEnableAToTerraform(struct?: DdosDstZonePortRangePortIndSamplingEnableA | cdktf.IResolvable): any {
...
export function ddosDstZonePortRangePortIndSamplingEnableAToHclTerraform(struct?: DdosDstZonePortRangePortIndSamplingEnableA | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DdosDstZonePortRangePortIndSamplingEnableAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DdosDstZonePortRangePortIndSamplingEnableA | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DdosDstZonePortRangePortIndSamplingEnableA | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DdosDstZonePortRangePortIndSamplingEnableAList extends cdktf.ComplexList {
  public internalValue? : DdosDstZonePortRangePortIndSamplingEnableA[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DdosDstZonePortRangePortIndSamplingEnableAOutputReference {
    return new DdosDstZonePortRangePortIndSamplingEnableAOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_port_range_port_ind thunder_ddos_dst_zone_port_range_port_ind}
*/
export class DdosDstZonePortRangePortIndA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_dst_zone_port_range_port_ind";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DdosDstZonePortRangePortIndA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DdosDstZonePortRangePortIndA to import
  * @param importFromId The id of the existing DdosDstZonePortRangePortIndA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_port_range_port_ind#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DdosDstZonePortRangePortIndA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_dst_zone_port_range_port_ind", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_port_range_port_ind thunder_ddos_dst_zone_port_range_port_ind} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DdosDstZonePortRangePortIndAConfig
  */
  public constructor(scope: Construct, id: string, config: DdosDstZonePortRangePortIndAConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_ddos_dst_zone_port_range_port_ind',
  ...
  private _samplingEnable = new DdosDstZonePortRangePortIndSamplingEnableAList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: DdosDstZonePortRangePortIndSamplingEnableA[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(ddosDstZonePortRangePortIndSamplingEnableAToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(ddosDstZonePortRangePortIndSamplingEnableAToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DdosDstZonePortRangePortIndSamplingEnableAList",
      },
    };
