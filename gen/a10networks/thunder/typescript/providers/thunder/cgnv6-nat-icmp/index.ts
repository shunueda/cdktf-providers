...
export interface Cgnv6NatIcmpConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class Cgnv6NatIcmp extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_nat_icmp";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_nat_icmp", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6NatIcmpConfig = {}
  */
  public constructor(scope: Construct, id: string, config: Cgnv6NatIcmpConfig = {}) {
    super(scope, id, {
