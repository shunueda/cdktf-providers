// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking
...
export interface DdosTemplateTcpProgressionTrackingConnectionTrackingAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Set the maximum duration time (in unit of 100ms, up to 24 hours)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#conn_duration_max DdosTemplateTcpProgressionTrackingConnectionTrackingA#conn_duration_max}
  */
  readonly connDurationMax?: number;
  /**
  * Set the minimum duration time (in unit of 100ms, up to 24 hours)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#conn_duration_min DdosTemplateTcpProgressionTrackingConnectionTrackingA#conn_duration_min}
  */
  readonly connDurationMin?: number;
  /**
  * Set the maximum total received byte
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#conn_rcvd_max DdosTemplateTcpProgressionTrackingConnectionTrackingA#conn_rcvd_max}
  */
  readonly connRcvdMax?: number;
  /**
  * Set the minimum total received byte
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#conn_rcvd_min DdosTemplateTcpProgressionTrackingConnectionTrackingA#conn_rcvd_min}
  */
  readonly connRcvdMin?: number;
  /**
  * Set the maximum received to sent ratio (in unit of 0.1% [1:1000])
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#conn_rcvd_sent_ratio_max DdosTemplateTcpProgressionTrackingConnectionTrackingA#conn_rcvd_sent_ratio_max}
  */
  readonly connRcvdSentRatioMax?: number;
  /**
  * Set the minimum received to sent ratio (in unit of 0.1% [1:1000])
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#conn_rcvd_sent_ratio_min DdosTemplateTcpProgressionTrackingConnectionTrackingA#conn_rcvd_sent_ratio_min}
  */
  readonly connRcvdSentRatioMin?: number;
  /**
  * Set the maximum total sent byte
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#conn_sent_max DdosTemplateTcpProgressionTrackingConnectionTrackingA#conn_sent_max}
  */
  readonly connSentMax?: number;
  /**
  * Set the minimum total sent byte
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#conn_sent_min DdosTemplateTcpProgressionTrackingConnectionTrackingA#conn_sent_min}
  */
  readonly connSentMin?: number;
  /**
  * Set the violation threshold
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#conn_violation DdosTemplateTcpProgressionTrackingConnectionTrackingA#conn_violation}
  */
  readonly connViolation?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#id DdosTemplateTcpProgressionTrackingConnectionTrackingA#id}
  *
  ...
  * Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#name DdosTemplateTcpProgressionTrackingConnectionTrackingA#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#progression_tracking_conn_action DdosTemplateTcpProgressionTrackingConnectionTrackingA#progression_tracking_conn_action}
  */
  readonly progressionTrackingConnAction?: string;
  /**
  * Configure action-list to take when progression tracking violation exceed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#progression_tracking_conn_action_list_name DdosTemplateTcpProgressionTrackingConnectionTrackingA#progression_tracking_conn_action_list_name}
  */
  readonly progressionTrackingConnActionListName?: string;
  /**
  * 'enable-check': Enable General Progression Tracking per Connection;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#progression_tracking_conn_enabled DdosTemplateTcpProgressionTrackingConnectionTrackingA#progression_tracking_conn_enabled}
  */
  readonly progressionTrackingConnEnabled: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#uuid DdosTemplateTcpProgressionTrackingConnectionTrackingA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking thunder_ddos_template_tcp_progression_tracking_connection_tracking}
*/
export class DdosTemplateTcpProgressionTrackingConnectionTrackingA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_template_tcp_progression_tracking_connection_tracking";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DdosTemplateTcpProgressionTrackingConnectionTrackingA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DdosTemplateTcpProgressionTrackingConnectionTrackingA to import
  * @param importFromId The id of the existing DdosTemplateTcpProgressionTrackingConnectionTrackingA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DdosTemplateTcpProgressionTrackingConnectionTrackingA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_template_tcp_progression_tracking_connection_tracking", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_template_tcp_progression_tracking_connection_tracking thunder_ddos_template_tcp_progression_tracking_connection_tracking} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DdosTemplateTcpProgressionTrackingConnectionTrackingAConfig
  */
  public constructor(scope: Construct, id: string, config: DdosTemplateTcpProgressionTrackingConnectionTrackingAConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_ddos_template_tcp_progression_tracking_connection_tracking',
