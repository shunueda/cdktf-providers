...
export class Cgnv6NatPoolGroupMember extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_nat_pool_group_member";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_nat_pool_group_member", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6NatPoolGroupMemberConfig
  */
  public constructor(scope: Construct, id: string, config: Cgnv6NatPoolGroupMemberConfig) {
    super(scope, id, {
