// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix
...
export interface RouterIpv6RipDistributeListPrefixAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix#id RouterIpv6RipDistributeListPrefixA#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix#uuid RouterIpv6RipDistributeListPrefixA#uuid}
  */
  readonly uuid?: string;
  /**
  * prefix_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix#prefix_cfg RouterIpv6RipDistributeListPrefixA#prefix_cfg}
  */
...
export interface RouterIpv6RipDistributeListPrefixPrefixCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix#ethernet RouterIpv6RipDistributeListPrefixA#ethernet}
  */
  readonly ethernet?: number;
  /**
  * Loopback interface (Port number)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix#loopback RouterIpv6RipDistributeListPrefixA#loopback}
  */
  readonly loopback?: number;
  /**
  * Filter prefixes in routing updates (Name of a prefix list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix#prefix_list RouterIpv6RipDistributeListPrefixA#prefix_list}
  */
  readonly prefixList?: string;
  /**
  * 'in': Filter incoming routing updates; 'out': Filter outgoing routing updates;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix#prefix_list_direction RouterIpv6RipDistributeListPrefixA#prefix_list_direction}
  */
  readonly prefixListDirection?: string;
  /**
  * Trunk interface (Trunk interface number)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix#trunk RouterIpv6RipDistributeListPrefixA#trunk}
  */
  readonly trunk?: number;
  /**
  * Tunnel interface (Tunnel interface number)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix#tunnel RouterIpv6RipDistributeListPrefixA#tunnel}
  */
  readonly tunnel?: number;
  /**
  * Virtual ethernet interface (Virtual ethernet interface number)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix#ve RouterIpv6RipDistributeListPrefixA#ve}
  */
  readonly ve?: number;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix thunder_router_ipv6_rip_distribute_list_prefix}
*/
export class RouterIpv6RipDistributeListPrefixA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_router_ipv6_rip_distribute_list_prefix";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a RouterIpv6RipDistributeListPrefixA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the RouterIpv6RipDistributeListPrefixA to import
  * @param importFromId The id of the existing RouterIpv6RipDistributeListPrefixA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RouterIpv6RipDistributeListPrefixA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_router_ipv6_rip_distribute_list_prefix", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/router_ipv6_rip_distribute_list_prefix thunder_router_ipv6_rip_distribute_list_prefix} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options RouterIpv6RipDistributeListPrefixAConfig = {}
  */
  public constructor(scope: Construct, id: string, config: RouterIpv6RipDistributeListPrefixAConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_router_ipv6_rip_distribute_list_prefix',
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      prefix_cfg: cdktf.listMapper(routerIpv6RipDistributeListPrefixPrefixCfgAToTerraform, true)(this._prefixCfg.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      prefix_cfg: {
        value: cdktf.listMapperHcl(routerIpv6RipDistributeListPrefixPrefixCfgAToHclTerraform, true)(this._prefixCfg.internalValue),
        isBlock: true,
        type: "list",
