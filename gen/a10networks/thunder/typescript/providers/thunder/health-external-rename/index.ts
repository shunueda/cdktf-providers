// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/health_external_rename
...
export interface HealthExternalRenameConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/health_external_rename#dst_file HealthExternalRename#dst_file}
  */
  readonly dstFile?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/health_external_rename#id HealthExternalRename#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/health_external_rename#src_file HealthExternalRename#src_file}
  */
  readonly srcFile?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/health_external_rename thunder_health_external_rename}
*/
export class HealthExternalRename extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HealthExternalRename that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/health_external_rename#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/health_external_rename thunder_health_external_rename} Resource
  *
  * @param scope The scope in which to define this construct
