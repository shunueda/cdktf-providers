...
export interface VisibilityPacketCaptureObjectTemplatesFwServiceGroupMemTmplTriggerStatsSeverityAConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class VisibilityPacketCaptureObjectTemplatesFwServiceGroupMemTmplTriggerStatsSeverityA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_visibility_packet_capture_object_templates_fw_service_group_mem_tmpl_trigger_stats_severity";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_visibility_packet_capture_object_templates_fw_service_group_mem_tmpl_trigger_stats_severity", importId: importFromId, provider });
      }
  ...
  * @param options VisibilityPacketCaptureObjectTemplatesFwServiceGroupMemTmplTriggerStatsSeverityAConfig
  */
  public constructor(scope: Construct, id: string, config: VisibilityPacketCaptureObjectTemplatesFwServiceGroupMemTmplTriggerStatsSeverityAConfig) {
    super(scope, id, {
