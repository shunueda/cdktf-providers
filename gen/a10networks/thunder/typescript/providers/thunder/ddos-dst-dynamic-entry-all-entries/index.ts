// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_dynamic_entry_all_entries
...
export interface DdosDstDynamicEntryAllEntriesAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_dynamic_entry_all_entries#id DdosDstDynamicEntryAllEntriesA#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_dynamic_entry_all_entries#uuid DdosDstDynamicEntryAllEntriesA#uuid}
  */
  readonly uuid?: string;
  /**
  * sampling_enable block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_dynamic_entry_all_entries#sampling_enable DdosDstDynamicEntryAllEntriesA#sampling_enable}
  */
  readonly samplingEnable?: DdosDstDynamicEntryAllEntriesSamplingEnableA[] | cdktf.IResolvable;
}
export interface DdosDstDynamicEntryAllEntriesSamplingEnableA {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_dynamic_entry_all_entries#counters1 DdosDstDynamicEntryAllEntriesA#counters1}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_dynamic_entry_all_entries#counters2 DdosDstDynamicEntryAllEntriesA#counters2}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_dynamic_entry_all_entries#counters3 DdosDstDynamicEntryAllEntriesA#counters3}
  */
  readonly counters3?: string;
}

export function ddosDstDynamicEntryAllEntriesSamplingEnableAToTerraform(struct?: DdosDstDynamicEntryAllEntriesSamplingEnableA | cdktf.IResolvable): any {
...
export function ddosDstDynamicEntryAllEntriesSamplingEnableAToHclTerraform(struct?: DdosDstDynamicEntryAllEntriesSamplingEnableA | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DdosDstDynamicEntryAllEntriesSamplingEnableAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DdosDstDynamicEntryAllEntriesSamplingEnableA | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DdosDstDynamicEntryAllEntriesSamplingEnableA | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DdosDstDynamicEntryAllEntriesSamplingEnableAList extends cdktf.ComplexList {
  public internalValue? : DdosDstDynamicEntryAllEntriesSamplingEnableA[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DdosDstDynamicEntryAllEntriesSamplingEnableAOutputReference {
    return new DdosDstDynamicEntryAllEntriesSamplingEnableAOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_dynamic_entry_all_entries thunder_ddos_dst_dynamic_entry_all_entries}
*/
export class DdosDstDynamicEntryAllEntriesA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_dst_dynamic_entry_all_entries";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DdosDstDynamicEntryAllEntriesA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DdosDstDynamicEntryAllEntriesA to import
  * @param importFromId The id of the existing DdosDstDynamicEntryAllEntriesA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_dynamic_entry_all_entries#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DdosDstDynamicEntryAllEntriesA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_dst_dynamic_entry_all_entries", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_dynamic_entry_all_entries thunder_ddos_dst_dynamic_entry_all_entries} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DdosDstDynamicEntryAllEntriesAConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DdosDstDynamicEntryAllEntriesAConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_ddos_dst_dynamic_entry_all_entries',
  ...
  private _samplingEnable = new DdosDstDynamicEntryAllEntriesSamplingEnableAList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: DdosDstDynamicEntryAllEntriesSamplingEnableA[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(ddosDstDynamicEntryAllEntriesSamplingEnableAToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(ddosDstDynamicEntryAllEntriesSamplingEnableAToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DdosDstDynamicEntryAllEntriesSamplingEnableAList",
      },
    };
