...
export interface IpAppProtocolPortTcpPassthroughConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class IpAppProtocolPortTcpPassthrough extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ip_app_protocol_port_tcp_passthrough";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ip_app_protocol_port_tcp_passthrough", importId: importFromId, provider });
      }
  ...
  * @param options IpAppProtocolPortTcpPassthroughConfig = {}
  */
  public constructor(scope: Construct, id: string, config: IpAppProtocolPortTcpPassthroughConfig = {}) {
    super(scope, id, {
