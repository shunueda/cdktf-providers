...
export class DebugDnsRrl extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_debug_dns_rrl";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_debug_dns_rrl", importId: importFromId, provider });
      }
  ...
  * @param options DebugDnsRrlConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DebugDnsRrlConfig = {}) {
    super(scope, id, {
