...
export interface DebugOspfPacketAConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DebugOspfPacketA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_debug_ospf_packet";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_debug_ospf_packet", importId: importFromId, provider });
      }
  ...
  * @param options DebugOspfPacketAConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DebugOspfPacketAConfig = {}) {
    super(scope, id, {
