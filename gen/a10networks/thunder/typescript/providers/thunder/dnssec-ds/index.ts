// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_ds
...
export interface DnssecDsAConfig extends cdktf.TerraformMetaArguments {
  ...
  * Delete the DS file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_ds#ds_delete DnssecDsA#ds_delete}
  */
  readonly dsDelete?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_ds#id DnssecDsA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_ds#zone_name DnssecDsA#zone_name}
  */
  readonly zoneName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_ds thunder_dnssec_ds}
*/
export class DnssecDsA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnssecDsA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_ds#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/dnssec_ds thunder_dnssec_ds} Resource
  *
  * @param scope The scope in which to define this construct
