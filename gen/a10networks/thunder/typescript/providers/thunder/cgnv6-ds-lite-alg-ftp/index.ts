// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_ftp
...
export interface Cgnv6DsLiteAlgFtpConfig extends cdktf.TerraformMetaArguments {
  ...
  * 'disable': Disable ALG;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_ftp#ftp_enable Cgnv6DsLiteAlgFtp#ftp_enable}
  */
  readonly ftpEnable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_ftp#id Cgnv6DsLiteAlgFtp#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_ftp#uuid Cgnv6DsLiteAlgFtp#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_ftp thunder_cgnv6_ds_lite_alg_ftp}
*/
export class Cgnv6DsLiteAlgFtp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cgnv6DsLiteAlgFtp that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_ftp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_ftp thunder_cgnv6_ds_lite_alg_ftp} Resource
  *
  * @param scope The scope in which to define this construct
