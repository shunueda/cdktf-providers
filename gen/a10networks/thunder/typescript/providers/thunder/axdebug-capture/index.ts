// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/axdebug_capture
...
export interface AxdebugCaptureAConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/axdebug_capture#brief AxdebugCaptureA#brief}
  */
  readonly brief?: number;
  /**
  * Only for current-slot of chassis
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/axdebug_capture#current_slot AxdebugCaptureA#current_slot}
  */
  readonly currentSlot?: number;
  /**
  * Include packet payload
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/axdebug_capture#detail AxdebugCaptureA#detail}
  */
  readonly detail?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/axdebug_capture#id AxdebugCaptureA#id}
  *
  ...
  * Non-stop execution
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/axdebug_capture#no_stop AxdebugCaptureA#no_stop}
  */
  readonly noStop?: number;
  /**
  * Save packets into file (Specify filename to save packets)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/axdebug_capture#save AxdebugCaptureA#save}
  */
  readonly save?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/axdebug_capture thunder_axdebug_capture}
*/
export class AxdebugCaptureA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AxdebugCaptureA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/axdebug_capture#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/axdebug_capture thunder_axdebug_capture} Resource
  *
  * @param scope The scope in which to define this construct
