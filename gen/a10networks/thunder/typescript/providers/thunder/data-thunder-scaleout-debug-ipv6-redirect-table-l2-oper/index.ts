...
export function dataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6ToTerraform(struct?: DataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6 | cdktf.IResolvable): any {
  ...
  return {
    ...
    ipv6_addr_str: cdktf.stringToTerraform(struct!.ipv6AddrStr),
...
export function dataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6ToHclTerraform(struct?: DataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6 | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    ipv6_addr_str: {
      value: cdktf.stringToHclTerraform(struct!.ipv6AddrStr),
      isBlock: false,
      type: "simple",
...
export class DataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6OutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6 | cdktf.IResolvable | undefined {
    ...
    if (this._ipv6AddrStr !== undefined) {
      hasAnyValues = true;
      internalValueResult.ipv6AddrStr = this._ipv6AddrStr;
    }
  ...
  public set internalValue(value: DataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6 | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._intfNum = undefined;
      this._ipv6AddrStr = undefined;
      ...
      this._ipv6AddrStr = value.ipv6AddrStr;
  ...
  // ipv6_addr_str - computed: false, optional: true, required: false
  private _ipv6AddrStr?: string; 
  public get ipv6AddrStr() {
    return this.getStringAttribute('ipv6_addr_str');
  }
  public set ipv6AddrStr(value: string) {
    this._ipv6AddrStr = value;
  }
  public resetIpv6AddrStr() {
    this._ipv6AddrStr = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get ipv6AddrStrInput() {
    return this._ipv6AddrStr;
  }
...
export class DataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6List extends cdktf.ComplexList {
  public internalValue? : DataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6OutputReference {
    return new DataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6OutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function dataThunderScaleoutDebugIpv6RedirectTableL2OperOperToTerraform(struct?: DataThunderScaleoutDebugIpv6RedirectTableL2OperOperOutputReference | DataThunderScaleoutDebugIpv6RedirectTableL2OperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    redirect_info_list_v6: cdktf.listMapper(dataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6ToTerraform, true)(struct!.redirectInfoListV6),
  }
}


export function dataThunderScaleoutDebugIpv6RedirectTableL2OperOperToHclTerraform(struct?: DataThunderScaleoutDebugIpv6RedirectTableL2OperOperOutputReference | DataThunderScaleoutDebugIpv6RedirectTableL2OperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    redirect_info_list_v6: {
      value: cdktf.listMapperHcl(dataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6ToHclTerraform, true)(struct!.redirectInfoListV6),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6List",
    },
  };
...
export class DataThunderScaleoutDebugIpv6RedirectTableL2OperOperOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataThunderScaleoutDebugIpv6RedirectTableL2OperOper | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    ...
    if (this._redirectInfoListV6?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.redirectInfoListV6 = this._redirectInfoListV6?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataThunderScaleoutDebugIpv6RedirectTableL2OperOper | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      ...
      this._ve = undefined;
      this._redirectInfoListV6.internalValue = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      ...
      this._ve = value.ve;
      this._redirectInfoListV6.internalValue = value.redirectInfoListV6;
    }
  }
  ...
  // redirect_info_list_v6 - computed: false, optional: true, required: false
  private _redirectInfoListV6 = new DataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6List(this, "redirect_info_list_v6", false);
  public get redirectInfoListV6() {
    return this._redirectInfoListV6;
  }
  public putRedirectInfoListV6(value: DataThunderScaleoutDebugIpv6RedirectTableL2OperOperRedirectInfoListV6[] | cdktf.IResolvable) {
    this._redirectInfoListV6.internalValue = value;
  }
  public resetRedirectInfoListV6() {
    this._redirectInfoListV6.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get redirectInfoListV6Input() {
    return this._redirectInfoListV6.internalValue;
  }
}
...
export class DataThunderScaleoutDebugIpv6RedirectTableL2Oper extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_scaleout_debug_ipv6_redirect_table_l2_oper";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_scaleout_debug_ipv6_redirect_table_l2_oper", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderScaleoutDebugIpv6RedirectTableL2OperConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderScaleoutDebugIpv6RedirectTableL2OperConfig = {}) {
    super(scope, id, {
  ...
  private _oper = new DataThunderScaleoutDebugIpv6RedirectTableL2OperOperOutputReference(this, "oper");
  public get oper() {
    return this._oper;
  }
  public putOper(value: DataThunderScaleoutDebugIpv6RedirectTableL2OperOper) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      oper: dataThunderScaleoutDebugIpv6RedirectTableL2OperOperToTerraform(this._oper.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      oper: {
        value: dataThunderScaleoutDebugIpv6RedirectTableL2OperOperToHclTerraform(this._oper.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderScaleoutDebugIpv6RedirectTableL2OperOperList",
      },
    };
