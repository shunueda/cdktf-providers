// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter
...
export interface DdosZoneTemplateIcmpV6FilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter#byte_offset_filter DdosZoneTemplateIcmpV6Filter#byte_offset_filter}
  */
  readonly byteOffsetFilter?: string;
  /**
  * 'drop': Drop packets (Default); 'ignore': Take no action; 'blacklist-src': Blacklist-src;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter#icmp_filter_action DdosZoneTemplateIcmpV6Filter#icmp_filter_action}
  */
  readonly icmpFilterAction?: string;
  /**
  * list to take
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter#icmp_filter_action_list_name DdosZoneTemplateIcmpV6Filter#icmp_filter_action_list_name}
  */
  readonly icmpFilterActionListName?: string;
  /**
  * Inverse the result of matching
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter#icmp_filter_inverse_match DdosZoneTemplateIcmpV6Filter#icmp_filter_inverse_match}
  */
  readonly icmpFilterInverseMatch?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter#icmp_filter_name DdosZoneTemplateIcmpV6Filter#icmp_filter_name}
  */
  readonly icmpFilterName: string;
  /**
  * Regex Expression
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter#icmp_filter_regex DdosZoneTemplateIcmpV6Filter#icmp_filter_regex}
  */
  readonly icmpFilterRegex?: string;
  /**
  * sequence number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter#icmp_filter_seq DdosZoneTemplateIcmpV6Filter#icmp_filter_seq}
  */
  readonly icmpFilterSeq?: number;
  /**
  * IcmpTmplName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter#icmp_tmpl_name DdosZoneTemplateIcmpV6Filter#icmp_tmpl_name}
  */
  readonly icmpTmplName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter#id DdosZoneTemplateIcmpV6Filter#id}
  *
  ...
  * Customized tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter#user_tag DdosZoneTemplateIcmpV6Filter#user_tag}
  */
  readonly userTag?: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter#uuid DdosZoneTemplateIcmpV6Filter#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter thunder_ddos_zone_template_icmp_v6_filter}
*/
export class DdosZoneTemplateIcmpV6Filter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DdosZoneTemplateIcmpV6Filter that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/ddos_zone_template_icmp_v6_filter thunder_ddos_zone_template_icmp_v6_filter} Resource
  *
  * @param scope The scope in which to define this construct
