// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_ip_proto_proto_number_port_ind
...
export interface DdosDstZoneIpProtoProtoNumberPortIndAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_ip_proto_proto_number_port_ind#id DdosDstZoneIpProtoProtoNumberPortIndA#id}
  *
  ...
  * ProtocolNum
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_ip_proto_proto_number_port_ind#protocol_num DdosDstZoneIpProtoProtoNumberPortIndA#protocol_num}
  */
  readonly protocolNum: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_ip_proto_proto_number_port_ind#uuid DdosDstZoneIpProtoProtoNumberPortIndA#uuid}
  */
  readonly uuid?: string;
  /**
  * ZoneName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_ip_proto_proto_number_port_ind#zone_name DdosDstZoneIpProtoProtoNumberPortIndA#zone_name}
  */
  readonly zoneName: string;
  /**
  * sampling_enable block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_ip_proto_proto_number_port_ind#sampling_enable DdosDstZoneIpProtoProtoNumberPortIndA#sampling_enable}
  */
  readonly samplingEnable?: DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableA[] | cdktf.IResolvable;
}
export interface DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableA {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_ip_proto_proto_number_port_ind#counters1 DdosDstZoneIpProtoProtoNumberPortIndA#counters1}
  */
  readonly counters1?: string;
}

export function ddosDstZoneIpProtoProtoNumberPortIndSamplingEnableAToTerraform(struct?: DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableA | cdktf.IResolvable): any {
...
export function ddosDstZoneIpProtoProtoNumberPortIndSamplingEnableAToHclTerraform(struct?: DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableA | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableA | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableA | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableAList extends cdktf.ComplexList {
  public internalValue? : DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableA[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableAOutputReference {
    return new DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableAOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_ip_proto_proto_number_port_ind thunder_ddos_dst_zone_ip_proto_proto_number_port_ind}
*/
export class DdosDstZoneIpProtoProtoNumberPortIndA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_dst_zone_ip_proto_proto_number_port_ind";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DdosDstZoneIpProtoProtoNumberPortIndA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DdosDstZoneIpProtoProtoNumberPortIndA to import
  * @param importFromId The id of the existing DdosDstZoneIpProtoProtoNumberPortIndA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_ip_proto_proto_number_port_ind#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DdosDstZoneIpProtoProtoNumberPortIndA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_dst_zone_ip_proto_proto_number_port_ind", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_dst_zone_ip_proto_proto_number_port_ind thunder_ddos_dst_zone_ip_proto_proto_number_port_ind} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DdosDstZoneIpProtoProtoNumberPortIndAConfig
  */
  public constructor(scope: Construct, id: string, config: DdosDstZoneIpProtoProtoNumberPortIndAConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_ddos_dst_zone_ip_proto_proto_number_port_ind',
  ...
  private _samplingEnable = new DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableAList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableA[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(ddosDstZoneIpProtoProtoNumberPortIndSamplingEnableAToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(ddosDstZoneIpProtoProtoNumberPortIndSamplingEnableAToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DdosDstZoneIpProtoProtoNumberPortIndSamplingEnableAList",
      },
    };
