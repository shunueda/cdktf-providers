...
export interface FileAflexLocalConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class FileAflexLocal extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_file_aflex_local";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_file_aflex_local", importId: importFromId, provider });
      }
  ...
  * @param options FileAflexLocalConfig = {}
  */
  public constructor(scope: Construct, id: string, config: FileAflexLocalConfig = {}) {
    super(scope, id, {
  ...
  // skip_backup - computed: false, optional: true, required: false
  private _skipBackup?: number; 
  public get skipBackup() {
    return this.getNumberAttribute('skip_backup');
  }
  public set skipBackup(value: number) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      skip_backup: cdktf.numberToTerraform(this._skipBackup),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      skip_backup: {
        value: cdktf.numberToHclTerraform(this._skipBackup),
        isBlock: false,
        type: "simple",
