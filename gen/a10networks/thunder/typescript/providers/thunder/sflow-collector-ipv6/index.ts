...
export interface SflowCollectorIpv6Config extends cdktf.TerraformMetaArguments {
  /**
...
export interface SflowCollectorIpv6CustomizedSetting {
  /**
...
export function sflowCollectorIpv6CustomizedSettingToTerraform(struct?: SflowCollectorIpv6CustomizedSettingOutputReference | SflowCollectorIpv6CustomizedSetting): any {
...
export function sflowCollectorIpv6CustomizedSettingToHclTerraform(struct?: SflowCollectorIpv6CustomizedSettingOutputReference | SflowCollectorIpv6CustomizedSetting): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SflowCollectorIpv6CustomizedSettingOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SflowCollectorIpv6CustomizedSetting | undefined {
  ...
  public set internalValue(value: SflowCollectorIpv6CustomizedSetting | undefined) {
    if (value === undefined) {
...
export class SflowCollectorIpv6 extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_sflow_collector_ipv6";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_sflow_collector_ipv6", importId: importFromId, provider });
      }
  ...
  * @param options SflowCollectorIpv6Config
  */
  public constructor(scope: Construct, id: string, config: SflowCollectorIpv6Config) {
    super(scope, id, {
  ...
  private _customizedSetting = new SflowCollectorIpv6CustomizedSettingOutputReference(this, "customized_setting");
  public get customizedSetting() {
    return this._customizedSetting;
  }
  public putCustomizedSetting(value: SflowCollectorIpv6CustomizedSetting) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      customized_setting: sflowCollectorIpv6CustomizedSettingToTerraform(this._customizedSetting.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      customized_setting: {
        value: sflowCollectorIpv6CustomizedSettingToHclTerraform(this._customizedSetting.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "SflowCollectorIpv6CustomizedSettingList",
      },
    };
