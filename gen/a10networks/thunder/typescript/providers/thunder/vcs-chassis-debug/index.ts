// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug
...
export interface VcsChassisDebugConfig extends cdktf.TerraformMetaArguments {
  /**
  * Daemon component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#daemon VcsChassisDebug#daemon}
  */
  readonly daemon?: number;
  /**
  * Daemon message component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#daemon_msg VcsChassisDebug#daemon_msg}
  */
  readonly daemonMsg?: number;
  /**
  * Election component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#election VcsChassisDebug#election}
  */
  readonly election?: number;
  /**
  * Election pdu component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#election_pdu VcsChassisDebug#election_pdu}
  */
  readonly electionPdu?: number;
  /**
  * Encoder component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#encoder VcsChassisDebug#encoder}
  */
  readonly encoder?: number;
  /**
  * Handler component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#handler VcsChassisDebug#handler}
  */
  readonly handler?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#id VcsChassisDebug#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#info VcsChassisDebug#info}
  */
  readonly info?: number;
  /**
  * Lib component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#lib VcsChassisDebug#lib}
  */
  readonly lib?: number;
  /**
  * Net component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#net VcsChassisDebug#net}
  */
  readonly net?: number;
  /**
  * SSL component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#ssl VcsChassisDebug#ssl}
  */
  readonly ssl?: number;
  /**
  * Utility component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#util VcsChassisDebug#util}
  */
  readonly util?: number;
  /**
  * vBlade component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#vblade VcsChassisDebug#vblade}
  */
  readonly vblade?: number;
  /**
  * vBlade Message component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#vblade_msg VcsChassisDebug#vblade_msg}
  */
  readonly vbladeMsg?: number;
  /**
  * vMaster component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#vmaster VcsChassisDebug#vmaster}
  */
  readonly vmaster?: number;
  /**
  * vMaster Message component
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#vmaster_msg VcsChassisDebug#vmaster_msg}
  */
  readonly vmasterMsg?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug thunder_vcs_chassis_debug}
*/
export class VcsChassisDebug extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_vcs_chassis_debug";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a VcsChassisDebug resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the VcsChassisDebug to import
  * @param importFromId The id of the existing VcsChassisDebug that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the VcsChassisDebug to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_vcs_chassis_debug", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/vcs_chassis_debug thunder_vcs_chassis_debug} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options VcsChassisDebugConfig = {}
  */
  public constructor(scope: Construct, id: string, config: VcsChassisDebugConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_vcs_chassis_debug',
