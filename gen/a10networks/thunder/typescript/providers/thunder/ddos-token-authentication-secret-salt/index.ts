// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_token_authentication_secret_salt
...
export interface DdosTokenAuthenticationSecretSaltConfig extends cdktf.TerraformMetaArguments {
  ...
  * Current salt value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_token_authentication_secret_salt#current_salt DdosTokenAuthenticationSecretSalt#current_salt}
  */
  readonly currentSalt?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_token_authentication_secret_salt#id DdosTokenAuthenticationSecretSalt#id}
  *
  ...
  * Previous salt value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_token_authentication_secret_salt#previous_salt DdosTokenAuthenticationSecretSalt#previous_salt}
  */
  readonly previousSalt?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_token_authentication_secret_salt#uuid DdosTokenAuthenticationSecretSalt#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_token_authentication_secret_salt thunder_ddos_token_authentication_secret_salt}
*/
export class DdosTokenAuthenticationSecretSalt extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DdosTokenAuthenticationSecretSalt that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_token_authentication_secret_salt#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_token_authentication_secret_salt thunder_ddos_token_authentication_secret_salt} Resource
  *
  * @param scope The scope in which to define this construct
