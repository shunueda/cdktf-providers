// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_pptp
...
export interface Cgnv6DsLiteAlgPptpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_pptp#id Cgnv6DsLiteAlgPptp#id}
  *
  ...
  * 'enable': Enable ALG;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_pptp#pptp_enable Cgnv6DsLiteAlgPptp#pptp_enable}
  */
  readonly pptpEnable?: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_pptp#uuid Cgnv6DsLiteAlgPptp#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_pptp thunder_cgnv6_ds_lite_alg_pptp}
*/
export class Cgnv6DsLiteAlgPptp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cgnv6DsLiteAlgPptp that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_pptp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_pptp thunder_cgnv6_ds_lite_alg_pptp} Resource
  *
  * @param scope The scope in which to define this construct
