// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_console
...
export interface LoggingConsoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_console#console_levelname LoggingConsole#console_levelname}
  */
  readonly consoleLevelname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_console#id LoggingConsole#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_console#uuid LoggingConsole#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_console thunder_logging_console}
*/
export class LoggingConsole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingConsole that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_console#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_console thunder_logging_console} Resource
  *
  * @param scope The scope in which to define this construct
