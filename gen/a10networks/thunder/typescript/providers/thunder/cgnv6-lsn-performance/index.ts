...
export interface Cgnv6LsnPerformanceSamplingEnable {
  /**
...
export function cgnv6LsnPerformanceSamplingEnableToTerraform(struct?: Cgnv6LsnPerformanceSamplingEnable | cdktf.IResolvable): any {
...
export function cgnv6LsnPerformanceSamplingEnableToHclTerraform(struct?: Cgnv6LsnPerformanceSamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Cgnv6LsnPerformanceSamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Cgnv6LsnPerformanceSamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: Cgnv6LsnPerformanceSamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class Cgnv6LsnPerformanceSamplingEnableList extends cdktf.ComplexList {
  public internalValue? : Cgnv6LsnPerformanceSamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): Cgnv6LsnPerformanceSamplingEnableOutputReference {
    return new Cgnv6LsnPerformanceSamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class Cgnv6LsnPerformance extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_lsn_performance";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_lsn_performance", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6LsnPerformanceConfig = {}
  */
  public constructor(scope: Construct, id: string, config: Cgnv6LsnPerformanceConfig = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new Cgnv6LsnPerformanceSamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: Cgnv6LsnPerformanceSamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(cgnv6LsnPerformanceSamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(cgnv6LsnPerformanceSamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Cgnv6LsnPerformanceSamplingEnableList",
      },
    };
