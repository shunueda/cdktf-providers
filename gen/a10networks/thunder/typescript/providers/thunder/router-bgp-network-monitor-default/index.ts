// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_network_monitor_default
...
export interface RouterBgpNetworkMonitorDefaultAConfig extends cdktf.TerraformMetaArguments {
  ...
  * AsNumber
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_network_monitor_default#as_number RouterBgpNetworkMonitorDefaultA#as_number}
  */
  readonly asNumber: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_network_monitor_default#id RouterBgpNetworkMonitorDefaultA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_network_monitor_default#network_monitor_default RouterBgpNetworkMonitorDefaultA#network_monitor_default}
  */
  readonly networkMonitorDefault?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_network_monitor_default#uuid RouterBgpNetworkMonitorDefaultA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_network_monitor_default thunder_router_bgp_network_monitor_default}
*/
export class RouterBgpNetworkMonitorDefaultA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RouterBgpNetworkMonitorDefaultA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_network_monitor_default#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/router_bgp_network_monitor_default thunder_router_bgp_network_monitor_default} Resource
  *
  * @param scope The scope in which to define this construct
