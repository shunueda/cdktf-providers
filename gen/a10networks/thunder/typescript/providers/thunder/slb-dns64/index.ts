...
export interface SlbDns64SamplingEnable {
  /**
...
export function slbDns64SamplingEnableToTerraform(struct?: SlbDns64SamplingEnable | cdktf.IResolvable): any {
...
export function slbDns64SamplingEnableToHclTerraform(struct?: SlbDns64SamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SlbDns64SamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SlbDns64SamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SlbDns64SamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SlbDns64SamplingEnableList extends cdktf.ComplexList {
  public internalValue? : SlbDns64SamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): SlbDns64SamplingEnableOutputReference {
    return new SlbDns64SamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class SlbDns64 extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_dns64";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_dns64", importId: importFromId, provider });
      }
  ...
  * @param options SlbDns64Config = {}
  */
  public constructor(scope: Construct, id: string, config: SlbDns64Config = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new SlbDns64SamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: SlbDns64SamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(slbDns64SamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(slbDns64SamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "SlbDns64SamplingEnableList",
      },
    };
