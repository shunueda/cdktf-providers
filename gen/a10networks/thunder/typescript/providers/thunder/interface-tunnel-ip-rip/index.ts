// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip
...
export interface InterfaceTunnelIpRipAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#id InterfaceTunnelIpRipA#id}
  *
  ...
  * Ifnum
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#ifnum InterfaceTunnelIpRipA#ifnum}
  */
  readonly ifnum: string;
  /**
  * Enable receiving packet through the specified interface
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#receive_packet InterfaceTunnelIpRipA#receive_packet}
  */
  readonly receivePacket?: number;
  /**
  * Enable sending packets through the specified interface
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#send_packet InterfaceTunnelIpRipA#send_packet}
  */
  readonly sendPacket?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#uuid InterfaceTunnelIpRipA#uuid}
  */
  readonly uuid?: string;
  /**
  * authentication block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#authentication InterfaceTunnelIpRipA#authentication}
  */
  readonly authentication?: InterfaceTunnelIpRipAuthenticationA;
  /**
  * receive_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#receive_cfg InterfaceTunnelIpRipA#receive_cfg}
  */
  readonly receiveCfg?: InterfaceTunnelIpRipReceiveCfgA;
  /**
  * send_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#send_cfg InterfaceTunnelIpRipA#send_cfg}
  */
  readonly sendCfg?: InterfaceTunnelIpRipSendCfgA;
  /**
  * split_horizon_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#split_horizon_cfg InterfaceTunnelIpRipA#split_horizon_cfg}
  */
...
export interface InterfaceTunnelIpRipAuthenticationKeyChainA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#key_chain InterfaceTunnelIpRipA#key_chain}
  */
...
export interface InterfaceTunnelIpRipAuthenticationModeA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#mode InterfaceTunnelIpRipA#mode}
  */
...
export interface InterfaceTunnelIpRipAuthenticationStrA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#string InterfaceTunnelIpRipA#string}
  */
...
export interface InterfaceTunnelIpRipAuthenticationA {
  ...
  * str block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#str InterfaceTunnelIpRipA#str}
  */
...
export interface InterfaceTunnelIpRipReceiveCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#receive InterfaceTunnelIpRipA#receive}
  */
  readonly receive?: number;
  /**
  * '2': RIP version 2;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#version InterfaceTunnelIpRipA#version}
  */
...
export interface InterfaceTunnelIpRipSendCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#send InterfaceTunnelIpRipA#send}
  */
...
export interface InterfaceTunnelIpRipSplitHorizonCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#state InterfaceTunnelIpRipA#state}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip thunder_interface_tunnel_ip_rip}
*/
export class InterfaceTunnelIpRipA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_interface_tunnel_ip_rip";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a InterfaceTunnelIpRipA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the InterfaceTunnelIpRipA to import
  * @param importFromId The id of the existing InterfaceTunnelIpRipA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the InterfaceTunnelIpRipA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_interface_tunnel_ip_rip", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/interface_tunnel_ip_rip thunder_interface_tunnel_ip_rip} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options InterfaceTunnelIpRipAConfig
  */
  public constructor(scope: Construct, id: string, config: InterfaceTunnelIpRipAConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_interface_tunnel_ip_rip',
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      authentication: interfaceTunnelIpRipAuthenticationAToTerraform(this._authentication.internalValue),
      receive_cfg: interfaceTunnelIpRipReceiveCfgAToTerraform(this._receiveCfg.internalValue),
      send_cfg: interfaceTunnelIpRipSendCfgAToTerraform(this._sendCfg.internalValue),
      split_horizon_cfg: interfaceTunnelIpRipSplitHorizonCfgAToTerraform(this._splitHorizonCfg.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      authentication: {
        value: interfaceTunnelIpRipAuthenticationAToHclTerraform(this._authentication.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "InterfaceTunnelIpRipAuthenticationAList",
      },
      receive_cfg: {
        value: interfaceTunnelIpRipReceiveCfgAToHclTerraform(this._receiveCfg.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "InterfaceTunnelIpRipReceiveCfgAList",
      },
      send_cfg: {
        value: interfaceTunnelIpRipSendCfgAToHclTerraform(this._sendCfg.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "InterfaceTunnelIpRipSendCfgAList",
      },
      split_horizon_cfg: {
        value: interfaceTunnelIpRipSplitHorizonCfgAToHclTerraform(this._splitHorizonCfg.internalValue),
        isBlock: true,
        type: "list",
