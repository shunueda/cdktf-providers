// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/partition_template
...
export interface PartitionTemplateAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/partition_template#id PartitionTemplateA#id}
  *
  ...
  * PartitionName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/partition_template#partition_name PartitionTemplateA#partition_name}
  */
  readonly partitionName: string;
  /**
  * Attach a resource accounting template (Name of the template)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/partition_template#resource_accounting PartitionTemplateA#resource_accounting}
  */
  readonly resourceAccounting?: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/partition_template#uuid PartitionTemplateA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/partition_template thunder_partition_template}
*/
export class PartitionTemplateA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PartitionTemplateA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/partition_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/partition_template thunder_partition_template} Resource
  *
  * @param scope The scope in which to define this construct
