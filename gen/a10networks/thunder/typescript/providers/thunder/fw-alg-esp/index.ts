...
export interface FwAlgEspAConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface FwAlgEspSamplingEnableA {
  /**
...
export function fwAlgEspSamplingEnableAToTerraform(struct?: FwAlgEspSamplingEnableA | cdktf.IResolvable): any {
...
export function fwAlgEspSamplingEnableAToHclTerraform(struct?: FwAlgEspSamplingEnableA | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class FwAlgEspSamplingEnableAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): FwAlgEspSamplingEnableA | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: FwAlgEspSamplingEnableA | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class FwAlgEspSamplingEnableAList extends cdktf.ComplexList {
  public internalValue? : FwAlgEspSamplingEnableA[] | cdktf.IResolvable
  ...
  */
  public get(index: number): FwAlgEspSamplingEnableAOutputReference {
    return new FwAlgEspSamplingEnableAOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class FwAlgEspA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_fw_alg_esp";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_fw_alg_esp", importId: importFromId, provider });
      }
  ...
  * @param options FwAlgEspAConfig = {}
  */
  public constructor(scope: Construct, id: string, config: FwAlgEspAConfig = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new FwAlgEspSamplingEnableAList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: FwAlgEspSamplingEnableA[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(fwAlgEspSamplingEnableAToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(fwAlgEspSamplingEnableAToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "FwAlgEspSamplingEnableAList",
      },
    };
