...
export interface TemplateCsvConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function templateCsvMultipleFieldsToTerraform(struct?: TemplateCsvMultipleFields | cdktf.IResolvable): any {
...
export function templateCsvMultipleFieldsToHclTerraform(struct?: TemplateCsvMultipleFields | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class TemplateCsvMultipleFieldsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): TemplateCsvMultipleFields | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: TemplateCsvMultipleFields | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class TemplateCsvMultipleFieldsList extends cdktf.ComplexList {
  public internalValue? : TemplateCsvMultipleFields[] | cdktf.IResolvable
  ...
  */
  public get(index: number): TemplateCsvMultipleFieldsOutputReference {
    return new TemplateCsvMultipleFieldsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class TemplateCsv extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_template_csv";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_template_csv", importId: importFromId, provider });
      }
  ...
  * @param options TemplateCsvConfig
  */
  public constructor(scope: Construct, id: string, config: TemplateCsvConfig) {
    super(scope, id, {
  ...
  private _multipleFields = new TemplateCsvMultipleFieldsList(this, "multiple_fields", false);
  public get multipleFields() {
    return this._multipleFields;
  }
  public putMultipleFields(value: TemplateCsvMultipleFields[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      multiple_fields: cdktf.listMapper(templateCsvMultipleFieldsToTerraform, true)(this._multipleFields.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      multiple_fields: {
        value: cdktf.listMapperHcl(templateCsvMultipleFieldsToHclTerraform, true)(this._multipleFields.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "TemplateCsvMultipleFieldsList",
      },
    };
