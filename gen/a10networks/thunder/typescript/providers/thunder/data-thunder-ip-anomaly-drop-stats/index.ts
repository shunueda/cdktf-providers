...
export interface DataThunderIpAnomalyDropStatsStats {
  /**
  * Bad IP Flags Drop
  *
...
export function dataThunderIpAnomalyDropStatsStatsToTerraform(struct?: DataThunderIpAnomalyDropStatsStatsOutputReference | DataThunderIpAnomalyDropStatsStats): any {
...
export function dataThunderIpAnomalyDropStatsStatsToHclTerraform(struct?: DataThunderIpAnomalyDropStatsStatsOutputReference | DataThunderIpAnomalyDropStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderIpAnomalyDropStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderIpAnomalyDropStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderIpAnomalyDropStatsStats | undefined) {
    if (value === undefined) {
...
export class DataThunderIpAnomalyDropStats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ip_anomaly_drop_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ip_anomaly_drop_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderIpAnomalyDropStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderIpAnomalyDropStatsConfig = {}) {
    super(scope, id, {
  ...
  private _stats = new DataThunderIpAnomalyDropStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderIpAnomalyDropStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderIpAnomalyDropStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderIpAnomalyDropStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderIpAnomalyDropStatsStatsList",
      },
    };
