// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/aam_authentication_saml_identity_provider
...
export interface AamAuthenticationSamlIdentityProviderConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/aam_authentication_saml_identity_provider#id AamAuthenticationSamlIdentityProvider#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/aam_authentication_saml_identity_provider#metadata AamAuthenticationSamlIdentityProvider#metadata}
  */
  readonly metadata?: string;
  /**
  * SAML authentication identity provider name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/aam_authentication_saml_identity_provider#name AamAuthenticationSamlIdentityProvider#name}
  */
  readonly name: string;
  /**
  * Specify URI metadata reload period (Specify URI metadata reload period in seconds, default is 28800)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/aam_authentication_saml_identity_provider#reload_interval AamAuthenticationSamlIdentityProvider#reload_interval}
  */
  readonly reloadInterval?: number;
  /**
  * Reload IdP's metadata immediately
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/aam_authentication_saml_identity_provider#reload_metadata AamAuthenticationSamlIdentityProvider#reload_metadata}
  */
  readonly reloadMetadata?: number;
  /**
  * Customized tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/aam_authentication_saml_identity_provider#user_tag AamAuthenticationSamlIdentityProvider#user_tag}
  */
  readonly userTag?: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/aam_authentication_saml_identity_provider#uuid AamAuthenticationSamlIdentityProvider#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/aam_authentication_saml_identity_provider thunder_aam_authentication_saml_identity_provider}
*/
export class AamAuthenticationSamlIdentityProvider extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AamAuthenticationSamlIdentityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/aam_authentication_saml_identity_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/aam_authentication_saml_identity_provider thunder_aam_authentication_saml_identity_provider} Resource
  *
  * @param scope The scope in which to define this construct
