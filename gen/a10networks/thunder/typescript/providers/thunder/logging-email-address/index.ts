// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_email_address
...
export interface LoggingEmailAddressConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_email_address#id LoggingEmailAddress#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_email_address#uuid LoggingEmailAddress#uuid}
  */
  readonly uuid?: string;
  /**
  * email_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_email_address#email_list LoggingEmailAddress#email_list}
  */
...
export interface LoggingEmailAddressEmailListStruct {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_email_address#email_address LoggingEmailAddress#email_address}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_email_address thunder_logging_email_address}
*/
export class LoggingEmailAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingEmailAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_email_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_email_address thunder_logging_email_address} Resource
  *
  * @param scope The scope in which to define this construct
