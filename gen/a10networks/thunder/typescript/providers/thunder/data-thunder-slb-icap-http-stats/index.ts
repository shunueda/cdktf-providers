...
export interface DataThunderSlbIcapHttpStatsStats {
  /**
  * Status code 100
  *
...
export function dataThunderSlbIcapHttpStatsStatsToTerraform(struct?: DataThunderSlbIcapHttpStatsStatsOutputReference | DataThunderSlbIcapHttpStatsStats): any {
...
export function dataThunderSlbIcapHttpStatsStatsToHclTerraform(struct?: DataThunderSlbIcapHttpStatsStatsOutputReference | DataThunderSlbIcapHttpStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderSlbIcapHttpStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderSlbIcapHttpStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderSlbIcapHttpStatsStats | undefined) {
    if (value === undefined) {
...
export class DataThunderSlbIcapHttpStats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_icap_http_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_icap_http_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderSlbIcapHttpStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderSlbIcapHttpStatsConfig = {}) {
    super(scope, id, {
  ...
  private _stats = new DataThunderSlbIcapHttpStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderSlbIcapHttpStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderSlbIcapHttpStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderSlbIcapHttpStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderSlbIcapHttpStatsStatsList",
      },
    };
