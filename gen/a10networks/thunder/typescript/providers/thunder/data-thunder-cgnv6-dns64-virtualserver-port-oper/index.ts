...
export function dataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStructToTerraform(struct?: DataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStruct | cdktf.IResolvable): any {
...
export function dataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStructToHclTerraform(struct?: DataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStruct | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStruct[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStructOutputReference {
    return new DataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function dataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStructToTerraform(struct?: DataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStructToHclTerraform(struct?: DataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStructOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStruct | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStruct[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStructOutputReference {
    return new DataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function dataThunderCgnv6Dns64VirtualserverPortOperOperToTerraform(struct?: DataThunderCgnv6Dns64VirtualserverPortOperOperOutputReference | DataThunderCgnv6Dns64VirtualserverPortOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    http_hits_list: cdktf.listMapper(dataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStructToTerraform, true)(struct!.httpHitsList),
    http_vport_cpu_list: cdktf.listMapper(dataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStructToTerraform, true)(struct!.httpVportCpuList),
  }
}


export function dataThunderCgnv6Dns64VirtualserverPortOperOperToHclTerraform(struct?: DataThunderCgnv6Dns64VirtualserverPortOperOperOutputReference | DataThunderCgnv6Dns64VirtualserverPortOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    http_hits_list: {
      value: cdktf.listMapperHcl(dataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStructToHclTerraform, true)(struct!.httpHitsList),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStructList",
    },
    http_vport_cpu_list: {
      value: cdktf.listMapperHcl(dataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStructToHclTerraform, true)(struct!.httpVportCpuList),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStructList",
    },
  };
...
export class DataThunderCgnv6Dns64VirtualserverPortOperOperOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataThunderCgnv6Dns64VirtualserverPortOperOper | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataThunderCgnv6Dns64VirtualserverPortOperOper | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _httpHitsList = new DataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStructList(this, "http_hits_list", false);
  public get httpHitsList() {
    return this._httpHitsList;
  }
  public putHttpHitsList(value: DataThunderCgnv6Dns64VirtualserverPortOperOperHttpHitsListStruct[] | cdktf.IResolvable) {
  ...
  private _httpVportCpuList = new DataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStructList(this, "http_vport_cpu_list", false);
  public get httpVportCpuList() {
    return this._httpVportCpuList;
  }
  public putHttpVportCpuList(value: DataThunderCgnv6Dns64VirtualserverPortOperOperHttpVportCpuListStruct[] | cdktf.IResolvable) {
...
export class DataThunderCgnv6Dns64VirtualserverPortOper extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_dns64_virtualserver_port_oper";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_dns64_virtualserver_port_oper", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderCgnv6Dns64VirtualserverPortOperConfig
  */
  public constructor(scope: Construct, id: string, config: DataThunderCgnv6Dns64VirtualserverPortOperConfig) {
    super(scope, id, {
  ...
  private _oper = new DataThunderCgnv6Dns64VirtualserverPortOperOperOutputReference(this, "oper");
  public get oper() {
    return this._oper;
  }
  public putOper(value: DataThunderCgnv6Dns64VirtualserverPortOperOper) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      oper: {
        value: dataThunderCgnv6Dns64VirtualserverPortOperOperToHclTerraform(this._oper.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderCgnv6Dns64VirtualserverPortOperOperList",
      },
    };
