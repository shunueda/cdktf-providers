// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd
...
export interface UpgradeHdConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd#device UpgradeHd#device}
  */
  readonly device?: number;
  /**
  * File URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd#file_url UpgradeHd#file_url}
  */
  readonly fileUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd#id UpgradeHd#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd#image UpgradeHd#image}
  */
  readonly image?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd#image_file UpgradeHd#image_file}
  */
  readonly imageFile?: string;
  /**
  * Use image from local VCS image repository (Specify an image name, format: aximage_XX_XX_XX_XX.tar.gz)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd#local UpgradeHd#local}
  */
  readonly local?: string;
  /**
  * reboot system after upgrade is done
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd#reboot_after_upgrade UpgradeHd#reboot_after_upgrade}
  */
  readonly rebootAfterUpgrade?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd#rollback UpgradeHd#rollback}
  */
  readonly rollback?: number;
  /**
  * Source ip address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd#source_ip_address UpgradeHd#source_ip_address}
  */
  readonly sourceIpAddress?: string;
  /**
  * in staggered upgrade mode
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd#staggered_upgrade_mode UpgradeHd#staggered_upgrade_mode}
  */
  readonly staggeredUpgradeMode?: number;
  /**
  * Use management port as source port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd#use_mgmt_port UpgradeHd#use_mgmt_port}
  */
  readonly useMgmtPort?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd thunder_upgrade_hd}
*/
export class UpgradeHd extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_upgrade_hd";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a UpgradeHd resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the UpgradeHd to import
  * @param importFromId The id of the existing UpgradeHd that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the UpgradeHd to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_upgrade_hd", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/upgrade_hd thunder_upgrade_hd} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options UpgradeHdConfig = {}
  */
  public constructor(scope: Construct, id: string, config: UpgradeHdConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_upgrade_hd',
  ...
  private _rollback?: number; 
  public get rollback() {
    return this.getNumberAttribute('rollback');
  }
  public set rollback(value: number) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rollback: cdktf.numberToTerraform(this._rollback),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rollback: {
        value: cdktf.numberToHclTerraform(this._rollback),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
