// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_nsm
...
export interface DebugOspfNsmAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_nsm#id DebugOspfNsmA#id}
  *
  ...
  * NSM interface
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_nsm#interface DebugOspfNsmA#interface}
  */
  readonly interface?: number;
  /**
  * NSM redistribute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_nsm#redistribute DebugOspfNsmA#redistribute}
  */
  readonly redistribute?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_nsm#uuid DebugOspfNsmA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_nsm thunder_debug_ospf_nsm}
*/
export class DebugOspfNsmA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DebugOspfNsmA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_nsm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/debug_ospf_nsm thunder_debug_ospf_nsm} Resource
  *
  * @param scope The scope in which to define this construct
