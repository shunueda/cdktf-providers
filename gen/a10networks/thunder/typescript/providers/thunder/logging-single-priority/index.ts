// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_single_priority
...
export interface LoggingSinglePriorityConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_single_priority#id LoggingSinglePriority#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_single_priority#levelname LoggingSinglePriority#levelname}
  */
  readonly levelname: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_single_priority#uuid LoggingSinglePriority#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_single_priority thunder_logging_single_priority}
*/
export class LoggingSinglePriority extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingSinglePriority that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_single_priority#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_single_priority thunder_logging_single_priority} Resource
  *
  * @param scope The scope in which to define this construct
