// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_bgp_advertisement
...
export interface EnableBgpAdvertisementConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_bgp_advertisement#enable_bgp_advertisement EnableBgpAdvertisement#enable_bgp_advertisement}
  */
  readonly enableBgpAdvertisement?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_bgp_advertisement#id EnableBgpAdvertisement#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_bgp_advertisement thunder_enable_bgp_advertisement}
*/
export class EnableBgpAdvertisement extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnableBgpAdvertisement that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_bgp_advertisement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/enable_bgp_advertisement thunder_enable_bgp_advertisement} Resource
  *
  * @param scope The scope in which to define this construct
