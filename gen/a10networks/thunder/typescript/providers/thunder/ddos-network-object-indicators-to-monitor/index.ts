// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor
...
export interface DdosNetworkObjectIndicatorsToMonitorAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#enable DdosNetworkObjectIndicatorsToMonitorA#enable}
  */
  readonly enable: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#id DdosNetworkObjectIndicatorsToMonitorA#id}
  *
  ...
  * Forward bit rate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#monitor_bit_rate DdosNetworkObjectIndicatorsToMonitorA#monitor_bit_rate}
  */
  readonly monitorBitRate?: number;
  /**
  * FIN packet rate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#monitor_fin_rate DdosNetworkObjectIndicatorsToMonitorA#monitor_fin_rate}
  */
  readonly monitorFinRate?: number;
  /**
  * Flow count
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#monitor_flow_count DdosNetworkObjectIndicatorsToMonitorA#monitor_flow_count}
  */
  readonly monitorFlowCount?: number;
  /**
  * ICMP packet rate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#monitor_icmp_pkt_rate DdosNetworkObjectIndicatorsToMonitorA#monitor_icmp_pkt_rate}
  */
  readonly monitorIcmpPktRate?: number;
  /**
  * Forward packet rate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#monitor_pkt_rate DdosNetworkObjectIndicatorsToMonitorA#monitor_pkt_rate}
  */
  readonly monitorPktRate?: number;
  /**
  * Reverse bit rate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#monitor_rev_bit_rate DdosNetworkObjectIndicatorsToMonitorA#monitor_rev_bit_rate}
  */
  readonly monitorRevBitRate?: number;
  /**
  * Reverse packet rate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#monitor_rev_pkt_rate DdosNetworkObjectIndicatorsToMonitorA#monitor_rev_pkt_rate}
  */
  readonly monitorRevPktRate?: number;
  /**
  * RST packet rate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#monitor_rst_rate DdosNetworkObjectIndicatorsToMonitorA#monitor_rst_rate}
  */
  readonly monitorRstRate?: number;
  /**
  * SYN packet rate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#monitor_syn_rate DdosNetworkObjectIndicatorsToMonitorA#monitor_syn_rate}
  */
  readonly monitorSynRate?: number;
  /**
  * TCP packet rate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#monitor_tcp_pkt_rate DdosNetworkObjectIndicatorsToMonitorA#monitor_tcp_pkt_rate}
  */
  readonly monitorTcpPktRate?: number;
  /**
  * UDP packet rate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#monitor_udp_pkt_rate DdosNetworkObjectIndicatorsToMonitorA#monitor_udp_pkt_rate}
  */
  readonly monitorUdpPktRate?: number;
  /**
  * Undiscovered forward packet rate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#monitor_undiscovered_pkt_rate DdosNetworkObjectIndicatorsToMonitorA#monitor_undiscovered_pkt_rate}
  */
  readonly monitorUndiscoveredPktRate?: number;
  /**
  * ObjectName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#object_name DdosNetworkObjectIndicatorsToMonitorA#object_name}
  */
  readonly objectName: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#uuid DdosNetworkObjectIndicatorsToMonitorA#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor thunder_ddos_network_object_indicators_to_monitor}
*/
export class DdosNetworkObjectIndicatorsToMonitorA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_network_object_indicators_to_monitor";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DdosNetworkObjectIndicatorsToMonitorA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DdosNetworkObjectIndicatorsToMonitorA to import
  * @param importFromId The id of the existing DdosNetworkObjectIndicatorsToMonitorA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DdosNetworkObjectIndicatorsToMonitorA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_network_object_indicators_to_monitor", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/ddos_network_object_indicators_to_monitor thunder_ddos_network_object_indicators_to_monitor} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DdosNetworkObjectIndicatorsToMonitorAConfig
  */
  public constructor(scope: Construct, id: string, config: DdosNetworkObjectIndicatorsToMonitorAConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_ddos_network_object_indicators_to_monitor',
