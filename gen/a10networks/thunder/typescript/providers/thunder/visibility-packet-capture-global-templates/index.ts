...
export interface VisibilityPacketCaptureGlobalTemplatesAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_global_templates#id VisibilityPacketCaptureGlobalTemplatesA#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_global_templates#uuid VisibilityPacketCaptureGlobalTemplatesA#uuid}
  */
  readonly uuid?: string;
  /**
  * activate block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_global_templates#activate VisibilityPacketCaptureGlobalTemplatesA#activate}
  */
  readonly activate?: VisibilityPacketCaptureGlobalTemplatesActivateA;
  /**
  * template_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_global_templates#template_list VisibilityPacketCaptureGlobalTemplatesA#template_list}
  */
  readonly templateList?: VisibilityPacketCaptureGlobalTemplatesTemplateListStructA[] | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_global_templates thunder_visibility_packet_capture_global_templates}
*/
export class VisibilityPacketCaptureGlobalTemplatesA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VisibilityPacketCaptureGlobalTemplatesA that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_global_templates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/visibility_packet_capture_global_templates thunder_visibility_packet_capture_global_templates} Resource
  *
  * @param scope The scope in which to define this construct
