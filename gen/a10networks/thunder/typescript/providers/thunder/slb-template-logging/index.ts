// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging
...
export interface SlbTemplateLoggingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#auto SlbTemplateLogging#auto}
  */
  readonly auto?: string;
  /**
  * Specify a format string for web logging (format string(less than 250 characters) for web logging)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#format SlbTemplateLogging#format}
  */
  readonly format?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#id SlbTemplateLogging#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#keep_end SlbTemplateLogging#keep_end}
  */
  readonly keepEnd?: number;
  /**
  * Number of unmasked characters at the beginning (default: 0)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#keep_start SlbTemplateLogging#keep_start}
  */
  readonly keepStart?: number;
  /**
  * 1 to enable local logging (1 to enable local logging, default 0)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#local_logging SlbTemplateLogging#local_logging}
  */
  readonly localLogging?: number;
  /**
  * Character to mask the matched pattern (default: X)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#mask SlbTemplateLogging#mask}
  */
  readonly mask?: string;
  /**
  * Logging Template Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#name SlbTemplateLogging#name}
  */
  readonly name: string;
  /**
  * Mask matched PCRE pattern in the log
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#pcre_mask SlbTemplateLogging#pcre_mask}
  */
  readonly pcreMask?: string;
  /**
  * Specify NAT pool or pool group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#pool SlbTemplateLogging#pool}
  */
  readonly pool?: string;
  /**
  * Specify NAT pool or pool group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#pool_shared SlbTemplateLogging#pool_shared}
  */
  readonly poolShared?: string;
  /**
  * Bind a Service Group to the logging template (Service Group Name)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#service_group SlbTemplateLogging#service_group}
  */
  readonly serviceGroup?: string;
  /**
  * Reference a NAT pool or pool group from shared partition
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#shared_partition_pool SlbTemplateLogging#shared_partition_pool}
  */
  readonly sharedPartitionPool?: number;
  /**
  * Reference a TCP Proxy template from shared partition
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#shared_partition_tcp_proxy_template SlbTemplateLogging#shared_partition_tcp_proxy_template}
  */
  readonly sharedPartitionTcpProxyTemplate?: number;
  /**
  * TCP Proxy Template Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#tcp_proxy SlbTemplateLogging#tcp_proxy}
  */
  readonly tcpProxy?: string;
  /**
  * TCP Proxy Template name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#template_tcp_proxy_shared SlbTemplateLogging#template_tcp_proxy_shared}
  */
  readonly templateTcpProxyShared?: string;
  /**
  * Customized tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#user_tag SlbTemplateLogging#user_tag}
  */
  readonly userTag?: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#uuid SlbTemplateLogging#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging thunder_slb_template_logging}
*/
export class SlbTemplateLogging extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SlbTemplateLogging that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_template_logging thunder_slb_template_logging} Resource
  *
  * @param scope The scope in which to define this construct
