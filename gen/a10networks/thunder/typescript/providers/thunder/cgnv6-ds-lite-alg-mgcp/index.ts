// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_mgcp
...
export interface Cgnv6DsLiteAlgMgcpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_mgcp#id Cgnv6DsLiteAlgMgcp#id}
  *
  ...
  * 'enable': Enable ALG;
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_mgcp#mgcp_enable Cgnv6DsLiteAlgMgcp#mgcp_enable}
  */
  readonly mgcpEnable?: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_mgcp#uuid Cgnv6DsLiteAlgMgcp#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_mgcp thunder_cgnv6_ds_lite_alg_mgcp}
*/
export class Cgnv6DsLiteAlgMgcp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cgnv6DsLiteAlgMgcp that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_mgcp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/cgnv6_ds_lite_alg_mgcp thunder_cgnv6_ds_lite_alg_mgcp} Resource
  *
  * @param scope The scope in which to define this construct
