// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_configure
...
export interface LoggingConfigureConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_configure#id LoggingConfigure#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_configure#line_feed_in_udp_syslog LoggingConfigure#line_feed_in_udp_syslog}
  */
  readonly lineFeedInUdpSyslog?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_configure#uuid LoggingConfigure#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_configure thunder_logging_configure}
*/
export class LoggingConfigure extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingConfigure that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_configure#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_configure thunder_logging_configure} Resource
  *
  * @param scope The scope in which to define this construct
