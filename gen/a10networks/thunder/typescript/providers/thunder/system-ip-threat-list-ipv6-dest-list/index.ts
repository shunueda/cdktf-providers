// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv6_dest_list
...
export interface SystemIpThreatListIpv6DestListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv6_dest_list#id SystemIpThreatListIpv6DestList#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv6_dest_list#uuid SystemIpThreatListIpv6DestList#uuid}
  */
  readonly uuid?: string;
  /**
  * class_list_cfg block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv6_dest_list#class_list_cfg SystemIpThreatListIpv6DestList#class_list_cfg}
  */
...
export interface SystemIpThreatListIpv6DestListClassListCfgA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv6_dest_list#class_list SystemIpThreatListIpv6DestList#class_list}
  */
  readonly classList?: string;
  /**
  * Bind ip-threat-action Template (ip-threat-action Template number)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv6_dest_list#ip_threat_action_tmpl SystemIpThreatListIpv6DestList#ip_threat_action_tmpl}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv6_dest_list thunder_system_ip_threat_list_ipv6_dest_list}
*/
export class SystemIpThreatListIpv6DestList extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_system_ip_threat_list_ipv6_dest_list";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a SystemIpThreatListIpv6DestList resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the SystemIpThreatListIpv6DestList to import
  * @param importFromId The id of the existing SystemIpThreatListIpv6DestList that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv6_dest_list#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SystemIpThreatListIpv6DestList to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_system_ip_threat_list_ipv6_dest_list", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/system_ip_threat_list_ipv6_dest_list thunder_system_ip_threat_list_ipv6_dest_list} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options SystemIpThreatListIpv6DestListConfig = {}
  */
  public constructor(scope: Construct, id: string, config: SystemIpThreatListIpv6DestListConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_system_ip_threat_list_ipv6_dest_list',
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      class_list_cfg: cdktf.listMapper(systemIpThreatListIpv6DestListClassListCfgAToTerraform, true)(this._classListCfg.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      class_list_cfg: {
        value: cdktf.listMapperHcl(systemIpThreatListIpv6DestListClassListCfgAToHclTerraform, true)(this._classListCfg.internalValue),
        isBlock: true,
        type: "list",
