...
export interface DdosSrcDefaultL4TypeConfig extends cdktf.TerraformMetaArguments {
  /**
  * DefaultAddressType
  *
...
export interface DdosSrcDefaultL4TypeTemplate {
  /**
  * DDOS OTHER template
  *
...
export function ddosSrcDefaultL4TypeTemplateToTerraform(struct?: DdosSrcDefaultL4TypeTemplateOutputReference | DdosSrcDefaultL4TypeTemplate): any {
...
export function ddosSrcDefaultL4TypeTemplateToHclTerraform(struct?: DdosSrcDefaultL4TypeTemplateOutputReference | DdosSrcDefaultL4TypeTemplate): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DdosSrcDefaultL4TypeTemplateOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DdosSrcDefaultL4TypeTemplate | undefined {
  ...
  public set internalValue(value: DdosSrcDefaultL4TypeTemplate | undefined) {
    if (value === undefined) {
...
export class DdosSrcDefaultL4Type extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_src_default_l4_type";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_src_default_l4_type", importId: importFromId, provider });
      }
  ...
  * @param options DdosSrcDefaultL4TypeConfig
  */
  public constructor(scope: Construct, id: string, config: DdosSrcDefaultL4TypeConfig) {
    super(scope, id, {
  ...
  private _template = new DdosSrcDefaultL4TypeTemplateOutputReference(this, "template");
  public get template() {
    return this._template;
  }
  public putTemplate(value: DdosSrcDefaultL4TypeTemplate) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      template: ddosSrcDefaultL4TypeTemplateToTerraform(this._template.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      template: {
        value: ddosSrcDefaultL4TypeTemplateToHclTerraform(this._template.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DdosSrcDefaultL4TypeTemplateList",
      },
    };
