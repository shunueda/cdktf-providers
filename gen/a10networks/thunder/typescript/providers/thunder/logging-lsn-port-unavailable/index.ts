// https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_lsn_port_unavailable
...
export interface LoggingLsnPortUnavailableConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_lsn_port_unavailable#id LoggingLsnPortUnavailable#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_lsn_port_unavailable#ip_based LoggingLsnPortUnavailable#ip_based}
  */
  readonly ipBased?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_lsn_port_unavailable#uuid LoggingLsnPortUnavailable#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_lsn_port_unavailable thunder_logging_lsn_port_unavailable}
*/
export class LoggingLsnPortUnavailable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingLsnPortUnavailable that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_lsn_port_unavailable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.4.2/docs/resources/logging_lsn_port_unavailable thunder_logging_lsn_port_unavailable} Resource
  *
  * @param scope The scope in which to define this construct
