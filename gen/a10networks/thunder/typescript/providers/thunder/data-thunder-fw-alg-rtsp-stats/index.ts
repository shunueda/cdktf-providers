...
export interface DataThunderFwAlgRtspStatsStats {
  /**
...
export function dataThunderFwAlgRtspStatsStatsToTerraform(struct?: DataThunderFwAlgRtspStatsStatsOutputReference | DataThunderFwAlgRtspStatsStats): any {
...
export function dataThunderFwAlgRtspStatsStatsToHclTerraform(struct?: DataThunderFwAlgRtspStatsStatsOutputReference | DataThunderFwAlgRtspStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderFwAlgRtspStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderFwAlgRtspStatsStats | undefined {
  ...
  public set internalValue(value: DataThunderFwAlgRtspStatsStats | undefined) {
    if (value === undefined) {
...
export class DataThunderFwAlgRtspStats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_fw_alg_rtsp_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_fw_alg_rtsp_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderFwAlgRtspStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderFwAlgRtspStatsConfig = {}) {
    super(scope, id, {
  ...
  private _stats = new DataThunderFwAlgRtspStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderFwAlgRtspStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderFwAlgRtspStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderFwAlgRtspStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderFwAlgRtspStatsStatsList",
      },
    };
