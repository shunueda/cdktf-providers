// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_syslog
...
export interface LoggingSyslogConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_syslog#id LoggingSyslog#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_syslog#syslog_levelname LoggingSyslog#syslog_levelname}
  */
  readonly syslogLevelname?: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_syslog#uuid LoggingSyslog#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_syslog thunder_logging_syslog}
*/
export class LoggingSyslog extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingSyslog that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_syslog#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/logging_syslog thunder_logging_syslog} Resource
  *
  * @param scope The scope in which to define this construct
