...
export interface ScaleoutAppsSkipMacOverwriteAConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class ScaleoutAppsSkipMacOverwriteA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_scaleout_apps_skip_mac_overwrite";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_scaleout_apps_skip_mac_overwrite", importId: importFromId, provider });
      }
  ...
  * @param options ScaleoutAppsSkipMacOverwriteAConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ScaleoutAppsSkipMacOverwriteAConfig = {}) {
    super(scope, id, {
