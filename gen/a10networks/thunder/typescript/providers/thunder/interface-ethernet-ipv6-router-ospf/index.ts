...
export class InterfaceEthernetIpv6RouterOspfA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_interface_ethernet_ipv6_router_ospf";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_interface_ethernet_ipv6_router_ospf", importId: importFromId, provider });
      }
  ...
  * @param options InterfaceEthernetIpv6RouterOspfAConfig
  */
  public constructor(scope: Construct, id: string, config: InterfaceEthernetIpv6RouterOspfAConfig) {
    super(scope, id, {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      area_list: cdktf.listMapper(interfaceEthernetIpv6RouterOspfAreaListStructAToTerraform, true)(this._areaList.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      area_list: {
        value: cdktf.listMapperHcl(interfaceEthernetIpv6RouterOspfAreaListStructAToHclTerraform, true)(this._areaList.internalValue),
        isBlock: true,
        type: "list",
