// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_key
...
export interface ImportPeriodicSslKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_key#id ImportPeriodicSslKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_key#period ImportPeriodicSslKey#period}
  */
  readonly period?: number;
  /**
  * profile name for remote url
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_key#remote_file ImportPeriodicSslKey#remote_file}
  */
  readonly remoteFile?: string;
  /**
  * Mark as non-exportable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_key#secured ImportPeriodicSslKey#secured}
  */
  readonly secured?: number;
  /**
  * SSL Key File(enter bulk when import an archive file)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_key#ssl_key ImportPeriodicSslKey#ssl_key}
  */
  readonly sslKey: string;
  /**
  * Use management port as source port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_key#use_mgmt_port ImportPeriodicSslKey#use_mgmt_port}
  */
  readonly useMgmtPort?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_key#uuid ImportPeriodicSslKey#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_key thunder_import_periodic_ssl_key}
*/
export class ImportPeriodicSslKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImportPeriodicSslKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/import_periodic_ssl_key thunder_import_periodic_ssl_key} Resource
  *
  * @param scope The scope in which to define this construct
