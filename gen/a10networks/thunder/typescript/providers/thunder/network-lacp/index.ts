// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_lacp
...
export interface NetworkLacpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_lacp#id NetworkLacp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_lacp#system_priority NetworkLacp#system_priority}
  */
  readonly systemPriority?: number;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_lacp#uuid NetworkLacp#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_lacp thunder_network_lacp}
*/
export class NetworkLacp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkLacp that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_lacp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/network_lacp thunder_network_lacp} Resource
  *
  * @param scope The scope in which to define this construct
