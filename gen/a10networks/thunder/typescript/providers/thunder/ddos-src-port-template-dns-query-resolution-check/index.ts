...
export interface DdosSrcPortTemplateDnsQueryResolutionCheckAConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DdosSrcPortTemplateDnsQueryResolutionCheckA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ddos_src_port_template_dns_query_resolution_check";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ddos_src_port_template_dns_query_resolution_check", importId: importFromId, provider });
      }
  ...
  * @param options DdosSrcPortTemplateDnsQueryResolutionCheckAConfig
  */
  public constructor(scope: Construct, id: string, config: DdosSrcPortTemplateDnsQueryResolutionCheckAConfig) {
    super(scope, id, {
