...
export interface Cgnv6FixedNatAlgMgcpSamplingEnable {
  /**
...
export function cgnv6FixedNatAlgMgcpSamplingEnableToTerraform(struct?: Cgnv6FixedNatAlgMgcpSamplingEnable | cdktf.IResolvable): any {
...
export function cgnv6FixedNatAlgMgcpSamplingEnableToHclTerraform(struct?: Cgnv6FixedNatAlgMgcpSamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Cgnv6FixedNatAlgMgcpSamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Cgnv6FixedNatAlgMgcpSamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: Cgnv6FixedNatAlgMgcpSamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class Cgnv6FixedNatAlgMgcpSamplingEnableList extends cdktf.ComplexList {
  public internalValue? : Cgnv6FixedNatAlgMgcpSamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): Cgnv6FixedNatAlgMgcpSamplingEnableOutputReference {
    return new Cgnv6FixedNatAlgMgcpSamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class Cgnv6FixedNatAlgMgcp extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_fixed_nat_alg_mgcp";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_fixed_nat_alg_mgcp", importId: importFromId, provider });
      }
  ...
  * @param options Cgnv6FixedNatAlgMgcpConfig = {}
  */
  public constructor(scope: Construct, id: string, config: Cgnv6FixedNatAlgMgcpConfig = {}) {
    super(scope, id, {
  ...
  private _samplingEnable = new Cgnv6FixedNatAlgMgcpSamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: Cgnv6FixedNatAlgMgcpSamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(cgnv6FixedNatAlgMgcpSamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(cgnv6FixedNatAlgMgcpSamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Cgnv6FixedNatAlgMgcpSamplingEnableList",
      },
    };
