...
export interface DataThunderCgnv6LsnGlobalStatsStats {
  /**
...
export function dataThunderCgnv6LsnGlobalStatsStatsToTerraform(struct?: DataThunderCgnv6LsnGlobalStatsStatsOutputReference | DataThunderCgnv6LsnGlobalStatsStats): any {
  ...
  return {
    ...
    mgcp_alg_port_pair_alloc_from_quota_partition_error: cdktf.numberToTerraform(struct!.mgcpAlgPortPairAllocFromQuotaPartitionError),
    nat_ip_max_tcp_ports_allocated: cdktf.numberToTerraform(struct!.natIpMaxTcpPortsAllocated),
    nat_ip_max_udp_ports_allocated: cdktf.numberToTerraform(struct!.natIpMaxUdpPortsAllocated),
...
export function dataThunderCgnv6LsnGlobalStatsStatsToHclTerraform(struct?: DataThunderCgnv6LsnGlobalStatsStatsOutputReference | DataThunderCgnv6LsnGlobalStatsStats): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    mgcp_alg_port_pair_alloc_from_quota_partition_error: {
      value: cdktf.numberToHclTerraform(struct!.mgcpAlgPortPairAllocFromQuotaPartitionError),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    nat_ip_max_tcp_ports_allocated: {
      value: cdktf.numberToHclTerraform(struct!.natIpMaxTcpPortsAllocated),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    nat_ip_max_udp_ports_allocated: {
      value: cdktf.numberToHclTerraform(struct!.natIpMaxUdpPortsAllocated),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    ...
    standby_class_list_drop: {
      value: cdktf.numberToHclTerraform(struct!.standbyClassListDrop),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
...
export class DataThunderCgnv6LsnGlobalStatsStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderCgnv6LsnGlobalStatsStats | undefined {
    ...
    if (this._mgcpAlgPortPairAllocFromQuotaPartitionError !== undefined) {
      hasAnyValues = true;
      internalValueResult.mgcpAlgPortPairAllocFromQuotaPartitionError = this._mgcpAlgPortPairAllocFromQuotaPartitionError;
    }
    if (this._natIpMaxTcpPortsAllocated !== undefined) {
      hasAnyValues = true;
      internalValueResult.natIpMaxTcpPortsAllocated = this._natIpMaxTcpPortsAllocated;
    }
    if (this._natIpMaxUdpPortsAllocated !== undefined) {
      hasAnyValues = true;
      internalValueResult.natIpMaxUdpPortsAllocated = this._natIpMaxUdpPortsAllocated;
    }
    ...
    if (this._standbyClassListDrop !== undefined) {
      hasAnyValues = true;
      internalValueResult.standbyClassListDrop = this._standbyClassListDrop;
    }
  ...
  public set internalValue(value: DataThunderCgnv6LsnGlobalStatsStats | undefined) {
    if (value === undefined) {
      ...
      this._mgcpAlgPortPairAllocFromQuotaPartitionError = undefined;
      this._natIpMaxTcpPortsAllocated = undefined;
      this._natIpMaxUdpPortsAllocated = undefined;
      ...
      this._mgcpAlgPortPairAllocFromQuotaPartitionError = value.mgcpAlgPortPairAllocFromQuotaPartitionError;
      this._natIpMaxTcpPortsAllocated = value.natIpMaxTcpPortsAllocated;
      this._natIpMaxUdpPortsAllocated = value.natIpMaxUdpPortsAllocated;
  ...
  // mgcp_alg_port_pair_alloc_from_quota_partition_error - computed: false, optional: true, required: false
  private _mgcpAlgPortPairAllocFromQuotaPartitionError?: number; 
  public get mgcpAlgPortPairAllocFromQuotaPartitionError() {
    return this.getNumberAttribute('mgcp_alg_port_pair_alloc_from_quota_partition_error');
  }
  public set mgcpAlgPortPairAllocFromQuotaPartitionError(value: number) {
    this._mgcpAlgPortPairAllocFromQuotaPartitionError = value;
  }
  public resetMgcpAlgPortPairAllocFromQuotaPartitionError() {
    this._mgcpAlgPortPairAllocFromQuotaPartitionError = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get mgcpAlgPortPairAllocFromQuotaPartitionErrorInput() {
    return this._mgcpAlgPortPairAllocFromQuotaPartitionError;
  }

  // nat_ip_max_tcp_ports_allocated - computed: false, optional: true, required: false
  private _natIpMaxTcpPortsAllocated?: number; 
  public get natIpMaxTcpPortsAllocated() {
    return this.getNumberAttribute('nat_ip_max_tcp_ports_allocated');
  }
  public set natIpMaxTcpPortsAllocated(value: number) {
    this._natIpMaxTcpPortsAllocated = value;
  }
  public resetNatIpMaxTcpPortsAllocated() {
    this._natIpMaxTcpPortsAllocated = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get natIpMaxTcpPortsAllocatedInput() {
    return this._natIpMaxTcpPortsAllocated;
  }

  // nat_ip_max_udp_ports_allocated - computed: false, optional: true, required: false
  private _natIpMaxUdpPortsAllocated?: number; 
  public get natIpMaxUdpPortsAllocated() {
    return this.getNumberAttribute('nat_ip_max_udp_ports_allocated');
  }
  public set natIpMaxUdpPortsAllocated(value: number) {
    this._natIpMaxUdpPortsAllocated = value;
  }
  public resetNatIpMaxUdpPortsAllocated() {
    this._natIpMaxUdpPortsAllocated = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get natIpMaxUdpPortsAllocatedInput() {
    return this._natIpMaxUdpPortsAllocated;
  }
  ...
  // standby_class_list_drop - computed: false, optional: true, required: false
  private _standbyClassListDrop?: number; 
  public get standbyClassListDrop() {
    return this.getNumberAttribute('standby_class_list_drop');
  }
  public set standbyClassListDrop(value: number) {
    this._standbyClassListDrop = value;
  }
  public resetStandbyClassListDrop() {
    this._standbyClassListDrop = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get standbyClassListDropInput() {
    return this._standbyClassListDrop;
  }
...
export class DataThunderCgnv6LsnGlobalStats extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_cgnv6_lsn_global_stats";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_cgnv6_lsn_global_stats", importId: importFromId, provider });
      }
  ...
  * @param options DataThunderCgnv6LsnGlobalStatsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataThunderCgnv6LsnGlobalStatsConfig = {}) {
    super(scope, id, {
  ...
  private _stats = new DataThunderCgnv6LsnGlobalStatsStatsOutputReference(this, "stats");
  public get stats() {
    return this._stats;
  }
  public putStats(value: DataThunderCgnv6LsnGlobalStatsStats) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stats: dataThunderCgnv6LsnGlobalStatsStatsToTerraform(this._stats.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stats: {
        value: dataThunderCgnv6LsnGlobalStatsStatsToHclTerraform(this._stats.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderCgnv6LsnGlobalStatsStatsList",
      },
    };
