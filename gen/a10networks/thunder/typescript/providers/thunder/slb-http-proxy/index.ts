// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_http_proxy
...
export interface SlbHttpProxyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_http_proxy#id SlbHttpProxy#id}
  *
  ...
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_http_proxy#uuid SlbHttpProxy#uuid}
  */
  readonly uuid?: string;
  /**
  * sampling_enable block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_http_proxy#sampling_enable SlbHttpProxy#sampling_enable}
  */
  readonly samplingEnable?: SlbHttpProxySamplingEnable[] | cdktf.IResolvable;
}
export interface SlbHttpProxySamplingEnable {
  /**
...
export function slbHttpProxySamplingEnableToHclTerraform(struct?: SlbHttpProxySamplingEnable | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SlbHttpProxySamplingEnableOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SlbHttpProxySamplingEnable | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SlbHttpProxySamplingEnable | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SlbHttpProxySamplingEnableList extends cdktf.ComplexList {
  public internalValue? : SlbHttpProxySamplingEnable[] | cdktf.IResolvable
  ...
  */
  public get(index: number): SlbHttpProxySamplingEnableOutputReference {
    return new SlbHttpProxySamplingEnableOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_http_proxy thunder_slb_http_proxy}
*/
export class SlbHttpProxy extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_slb_http_proxy";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a SlbHttpProxy resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the SlbHttpProxy to import
  * @param importFromId The id of the existing SlbHttpProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_http_proxy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SlbHttpProxy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_slb_http_proxy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/slb_http_proxy thunder_slb_http_proxy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options SlbHttpProxyConfig = {}
  */
  public constructor(scope: Construct, id: string, config: SlbHttpProxyConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'thunder_slb_http_proxy',
  ...
  private _samplingEnable = new SlbHttpProxySamplingEnableList(this, "sampling_enable", false);
  public get samplingEnable() {
    return this._samplingEnable;
  }
  public putSamplingEnable(value: SlbHttpProxySamplingEnable[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sampling_enable: cdktf.listMapper(slbHttpProxySamplingEnableToTerraform, true)(this._samplingEnable.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sampling_enable: {
        value: cdktf.listMapperHcl(slbHttpProxySamplingEnableToHclTerraform, true)(this._samplingEnable.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "SlbHttpProxySamplingEnableList",
      },
    };
