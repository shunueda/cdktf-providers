...
export interface IpExtcommunityListExpandedNumConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface IpExtcommunityListExpandedNumRulesListStruct {
  /**
...
export function ipExtcommunityListExpandedNumRulesListStructToTerraform(struct?: IpExtcommunityListExpandedNumRulesListStruct | cdktf.IResolvable): any {
...
export function ipExtcommunityListExpandedNumRulesListStructToHclTerraform(struct?: IpExtcommunityListExpandedNumRulesListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IpExtcommunityListExpandedNumRulesListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IpExtcommunityListExpandedNumRulesListStruct | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: IpExtcommunityListExpandedNumRulesListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class IpExtcommunityListExpandedNumRulesListStructList extends cdktf.ComplexList {
  public internalValue? : IpExtcommunityListExpandedNumRulesListStruct[] | cdktf.IResolvable
  ...
  */
  public get(index: number): IpExtcommunityListExpandedNumRulesListStructOutputReference {
    return new IpExtcommunityListExpandedNumRulesListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class IpExtcommunityListExpandedNum extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_ip_extcommunity_list_expanded_num";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_ip_extcommunity_list_expanded_num", importId: importFromId, provider });
      }
  ...
  * @param options IpExtcommunityListExpandedNumConfig
  */
  public constructor(scope: Construct, id: string, config: IpExtcommunityListExpandedNumConfig) {
    super(scope, id, {
  ...
  private _rulesList = new IpExtcommunityListExpandedNumRulesListStructList(this, "rules_list", false);
  public get rulesList() {
    return this._rulesList;
  }
  public putRulesList(value: IpExtcommunityListExpandedNumRulesListStruct[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rules_list: cdktf.listMapper(ipExtcommunityListExpandedNumRulesListStructToTerraform, true)(this._rulesList.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rules_list: {
        value: cdktf.listMapperHcl(ipExtcommunityListExpandedNumRulesListStructToHclTerraform, true)(this._rulesList.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "IpExtcommunityListExpandedNumRulesListStructList",
      },
    };
