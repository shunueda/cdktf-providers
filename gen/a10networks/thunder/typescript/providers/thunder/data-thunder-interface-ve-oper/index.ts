// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper
...
export interface DataThunderInterfaceVeOperConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#id DataThunderInterfaceVeOper#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ifnum DataThunderInterfaceVeOper#ifnum}
  */
  readonly ifnum: number;
  /**
  * oper block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#oper DataThunderInterfaceVeOper#oper}
  */
  readonly oper?: DataThunderInterfaceVeOperOper;
}
export interface DataThunderInterfaceVeOperOperIpv4ListStruct {
  /**
  * IP address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#addr DataThunderInterfaceVeOper#addr}
  */
  readonly addr?: string;
  /**
  * IP subnet mask
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#mask DataThunderInterfaceVeOper#mask}
  */
  readonly mask?: string;
}

export function dataThunderInterfaceVeOperOperIpv4ListStructToTerraform(struct?: DataThunderInterfaceVeOperOperIpv4ListStruct | cdktf.IResolvable): any {
...
export function dataThunderInterfaceVeOperOperIpv4ListStructToHclTerraform(struct?: DataThunderInterfaceVeOperOperIpv4ListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderInterfaceVeOperOperIpv4ListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataThunderInterfaceVeOperOperIpv4ListStruct | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataThunderInterfaceVeOperOperIpv4ListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataThunderInterfaceVeOperOperIpv4ListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderInterfaceVeOperOperIpv4ListStruct[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataThunderInterfaceVeOperOperIpv4ListStructOutputReference {
    return new DataThunderInterfaceVeOperOperIpv4ListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataThunderInterfaceVeOperOperIpv6ListStruct {
  /**
  * IP address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#addr DataThunderInterfaceVeOper#addr}
  */
  readonly addr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#is_anycast DataThunderInterfaceVeOper#is_anycast}
  */
  readonly isAnycast?: number;
  /**
  * IP subnet mask
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#prefix DataThunderInterfaceVeOper#prefix}
  */
  readonly prefix?: string;
}

export function dataThunderInterfaceVeOperOperIpv6ListStructToTerraform(struct?: DataThunderInterfaceVeOperOperIpv6ListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataThunderInterfaceVeOperOperIpv6ListStructToHclTerraform(struct?: DataThunderInterfaceVeOperOperIpv6ListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataThunderInterfaceVeOperOperIpv6ListStructOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataThunderInterfaceVeOperOperIpv6ListStruct | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataThunderInterfaceVeOperOperIpv6ListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._addr = undefined;
...
export class DataThunderInterfaceVeOperOperIpv6ListStructList extends cdktf.ComplexList {
  public internalValue? : DataThunderInterfaceVeOperOperIpv6ListStruct[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataThunderInterfaceVeOperOperIpv6ListStructOutputReference {
    return new DataThunderInterfaceVeOperOperIpv6ListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataThunderInterfaceVeOperOper {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#icmp6_rate_limit_current DataThunderInterfaceVeOper#icmp6_rate_limit_current}
  */
  readonly icmp6RateLimitCurrent?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#icmp6_rate_over_limit_drop DataThunderInterfaceVeOper#icmp6_rate_over_limit_drop}
  */
  readonly icmp6RateOverLimitDrop?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#icmp_rate_limit_current DataThunderInterfaceVeOper#icmp_rate_limit_current}
  */
  readonly icmpRateLimitCurrent?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#icmp_rate_over_limit_drop DataThunderInterfaceVeOper#icmp_rate_over_limit_drop}
  */
  readonly icmpRateOverLimitDrop?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#igmp_query_sent DataThunderInterfaceVeOper#igmp_query_sent}
  */
  readonly igmpQuerySent?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ip_unnumbered_enabled DataThunderInterfaceVeOper#ip_unnumbered_enabled}
  */
  readonly ipUnnumberedEnabled?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ip_unnumbered_mac_learned DataThunderInterfaceVeOper#ip_unnumbered_mac_learned}
  */
  readonly ipUnnumberedMacLearned?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ip_unnumbered_oper DataThunderInterfaceVeOper#ip_unnumbered_oper}
  */
  readonly ipUnnumberedOper?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ip_unnumbered_peer_lla DataThunderInterfaceVeOper#ip_unnumbered_peer_lla}
  */
  readonly ipUnnumberedPeerLla?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ipv4_addr_count DataThunderInterfaceVeOper#ipv4_addr_count}
  */
  readonly ipv4AddrCount?: number;
  /**
  * IP address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ipv4_address DataThunderInterfaceVeOper#ipv4_address}
  */
  readonly ipv4Address?: string;
  /**
  * IP subnet mask
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ipv4_netmask DataThunderInterfaceVeOper#ipv4_netmask}
  */
  readonly ipv4Netmask?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ipv6_addr_count DataThunderInterfaceVeOper#ipv6_addr_count}
  */
  readonly ipv6AddrCount?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ipv6_link_local DataThunderInterfaceVeOper#ipv6_link_local}
  */
  readonly ipv6LinkLocal?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ipv6_link_local_prefix DataThunderInterfaceVeOper#ipv6_link_local_prefix}
  */
  readonly ipv6LinkLocalPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ipv6_link_local_scope DataThunderInterfaceVeOper#ipv6_link_local_scope}
  */
  readonly ipv6LinkLocalScope?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ipv6_link_local_type DataThunderInterfaceVeOper#ipv6_link_local_type}
  */
  readonly ipv6LinkLocalType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#line_protocol DataThunderInterfaceVeOper#line_protocol}
  */
  readonly lineProtocol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#link_type DataThunderInterfaceVeOper#link_type}
  */
  readonly linkType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#mac DataThunderInterfaceVeOper#mac}
  */
  readonly mac?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#mtu DataThunderInterfaceVeOper#mtu}
  */
  readonly mtu?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#state DataThunderInterfaceVeOper#state}
  */
  readonly state?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#user_trunk_id DataThunderInterfaceVeOper#user_trunk_id}
  */
  readonly userTrunkId?: number;
  /**
  * ipv4_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ipv4_list DataThunderInterfaceVeOper#ipv4_list}
  */
  readonly ipv4List?: DataThunderInterfaceVeOperOperIpv4ListStruct[] | cdktf.IResolvable;
  /**
  * ipv6_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#ipv6_list DataThunderInterfaceVeOper#ipv6_list}
  */
  readonly ipv6List?: DataThunderInterfaceVeOperOperIpv6ListStruct[] | cdktf.IResolvable;
}

export function dataThunderInterfaceVeOperOperToTerraform(struct?: DataThunderInterfaceVeOperOperOutputReference | DataThunderInterfaceVeOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    user_trunk_id: cdktf.numberToTerraform(struct!.userTrunkId),
    ipv4_list: cdktf.listMapper(dataThunderInterfaceVeOperOperIpv4ListStructToTerraform, true)(struct!.ipv4List),
    ipv6_list: cdktf.listMapper(dataThunderInterfaceVeOperOperIpv6ListStructToTerraform, true)(struct!.ipv6List),
  }
}


export function dataThunderInterfaceVeOperOperToHclTerraform(struct?: DataThunderInterfaceVeOperOperOutputReference | DataThunderInterfaceVeOperOper): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    user_trunk_id: {
      value: cdktf.numberToHclTerraform(struct!.userTrunkId),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    ipv4_list: {
      value: cdktf.listMapperHcl(dataThunderInterfaceVeOperOperIpv4ListStructToHclTerraform, true)(struct!.ipv4List),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderInterfaceVeOperOperIpv4ListStructList",
    },
    ipv6_list: {
      value: cdktf.listMapperHcl(dataThunderInterfaceVeOperOperIpv6ListStructToHclTerraform, true)(struct!.ipv6List),
      isBlock: true,
      type: "list",
      storageClassType: "DataThunderInterfaceVeOperOperIpv6ListStructList",
    },
  };
...
export class DataThunderInterfaceVeOperOperOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataThunderInterfaceVeOperOper | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    ...
    if (this._userTrunkId !== undefined) {
      hasAnyValues = true;
      internalValueResult.userTrunkId = this._userTrunkId;
    }
  ...
  public set internalValue(value: DataThunderInterfaceVeOperOper | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      ...
      this._userTrunkId = value.userTrunkId;
  ...
  // user_trunk_id - computed: false, optional: true, required: false
  private _userTrunkId?: number; 
  public get userTrunkId() {
    return this.getNumberAttribute('user_trunk_id');
  }
  public set userTrunkId(value: number) {
    this._userTrunkId = value;
  }
  public resetUserTrunkId() {
    this._userTrunkId = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get userTrunkIdInput() {
    return this._userTrunkId;
  }

  // ipv4_list - computed: false, optional: true, required: false
  private _ipv4List = new DataThunderInterfaceVeOperOperIpv4ListStructList(this, "ipv4_list", false);
  public get ipv4List() {
    return this._ipv4List;
  }
  public putIpv4List(value: DataThunderInterfaceVeOperOperIpv4ListStruct[] | cdktf.IResolvable) {
  ...
  private _ipv6List = new DataThunderInterfaceVeOperOperIpv6ListStructList(this, "ipv6_list", false);
  public get ipv6List() {
    return this._ipv6List;
  }
  public putIpv6List(value: DataThunderInterfaceVeOperOperIpv6ListStruct[] | cdktf.IResolvable) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper thunder_interface_ve_oper}
*/
export class DataThunderInterfaceVeOper extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "thunder_interface_ve_oper";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataThunderInterfaceVeOper resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataThunderInterfaceVeOper to import
  * @param importFromId The id of the existing DataThunderInterfaceVeOper that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataThunderInterfaceVeOper to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "thunder_interface_ve_oper", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/data-sources/interface_ve_oper thunder_interface_ve_oper} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataThunderInterfaceVeOperConfig
  */
  public constructor(scope: Construct, id: string, config: DataThunderInterfaceVeOperConfig) {
    super(scope, id, {
      terraformResourceType: 'thunder_interface_ve_oper',
  ...
  private _oper = new DataThunderInterfaceVeOperOperOutputReference(this, "oper");
  public get oper() {
    return this._oper;
  }
  public putOper(value: DataThunderInterfaceVeOperOper) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      oper: dataThunderInterfaceVeOperOperToTerraform(this._oper.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      oper: {
        value: dataThunderInterfaceVeOperOperToHclTerraform(this._oper.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataThunderInterfaceVeOperOperList",
      },
    };
