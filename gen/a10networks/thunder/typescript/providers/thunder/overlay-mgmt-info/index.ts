// https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/overlay_mgmt_info
...
export interface OverlayMgmtInfoConfig extends cdktf.TerraformMetaArguments {
  ...
  * Application string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/overlay_mgmt_info#appstring OverlayMgmtInfo#appstring}
  */
  readonly appstring: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/overlay_mgmt_info#id OverlayMgmtInfo#id}
  *
  ...
  * Plugin string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/overlay_mgmt_info#plugin_name OverlayMgmtInfo#plugin_name}
  */
  readonly pluginName: string;
  /**
  * uuid of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/overlay_mgmt_info#uuid OverlayMgmtInfo#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/overlay_mgmt_info thunder_overlay_mgmt_info}
*/
export class OverlayMgmtInfo extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OverlayMgmtInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/overlay_mgmt_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/a10networks/thunder/1.5.0/docs/resources/overlay_mgmt_info thunder_overlay_mgmt_info} Resource
  *
  * @param scope The scope in which to define this construct
