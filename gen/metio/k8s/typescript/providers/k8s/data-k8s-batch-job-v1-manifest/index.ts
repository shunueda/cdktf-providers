...
export interface DataK8SBatchJobV1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/batch_job_v1_manifest#metadata DataK8SBatchJobV1Manifest#metadata}
  */
  readonly metadata: DataK8SBatchJobV1ManifestMetadata;
  /**
  * JobSpec describes how the job execution will look like.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/batch_job_v1_manifest#spec DataK8SBatchJobV1Manifest#spec}
  */
  readonly spec?: DataK8SBatchJobV1ManifestSpec;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/batch_job_v1_manifest k8s_batch_job_v1_manifest}
*/
export class DataK8SBatchJobV1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SBatchJobV1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/batch_job_v1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/batch_job_v1_manifest k8s_batch_job_v1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
