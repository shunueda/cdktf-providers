// https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest
...
export interface DataK8SLeaksignalComLeaksignalIstioV1ManifestConfig extends cdktf.TerraformMetaArguments {
  /**
  * Data that helps uniquely identify this object. See https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#metadata for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#metadata DataK8SLeaksignalComLeaksignalIstioV1Manifest#metadata}
  */
  readonly metadata: DataK8SLeaksignalComLeaksignalIstioV1ManifestMetadata;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#spec DataK8SLeaksignalComLeaksignalIstioV1Manifest#spec}
  */
  readonly spec?: DataK8SLeaksignalComLeaksignalIstioV1ManifestSpec;
}
export interface DataK8SLeaksignalComLeaksignalIstioV1ManifestMetadata {
  /**
  * Keys and values that can be used by external tooling to store and retrieve arbitrary metadata about this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#annotations DataK8SLeaksignalComLeaksignalIstioV1Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#labels DataK8SLeaksignalComLeaksignalIstioV1Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#name DataK8SLeaksignalComLeaksignalIstioV1Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#namespace DataK8SLeaksignalComLeaksignalIstioV1Manifest#namespace}
  */
  readonly namespace: string;
}

export function dataK8SLeaksignalComLeaksignalIstioV1ManifestMetadataToTerraform(struct?: DataK8SLeaksignalComLeaksignalIstioV1ManifestMetadata | cdktf.IResolvable): any {
...
export function dataK8SLeaksignalComLeaksignalIstioV1ManifestMetadataToHclTerraform(struct?: DataK8SLeaksignalComLeaksignalIstioV1ManifestMetadata | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SLeaksignalComLeaksignalIstioV1ManifestMetadataOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataK8SLeaksignalComLeaksignalIstioV1ManifestMetadata | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataK8SLeaksignalComLeaksignalIstioV1ManifestMetadata | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export interface DataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelector {
  /**
...
export function dataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelectorToTerraform(struct?: DataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelector | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelectorToHclTerraform(struct?: DataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelector | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelectorOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelector | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelector | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._labels = undefined;
...
export interface DataK8SLeaksignalComLeaksignalIstioV1ManifestSpec {
  /**
  * API Key from the LeakSignal Command dashboard. Alternatively, the deployment name from LeakAgent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#api_key DataK8SLeaksignalComLeaksignalIstioV1Manifest#api_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#ca_bundle DataK8SLeaksignalComLeaksignalIstioV1Manifest#ca_bundle}
  */
  readonly caBundle?: string;
  /**
  * If true (default), then certificates are installed in pods for outbound TLS interception.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#enable_client_interception DataK8SLeaksignalComLeaksignalIstioV1Manifest#enable_client_interception}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#enable_streaming DataK8SLeaksignalComLeaksignalIstioV1Manifest#enable_streaming}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#fail_open DataK8SLeaksignalComLeaksignalIstioV1Manifest#fail_open}
  */
  readonly failOpen?: boolean | cdktf.IResolvable;
  /**
  * Whether to use Google GRPC or Envoy GRPC for WASM deployments.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#grpc_mode DataK8SLeaksignalComLeaksignalIstioV1Manifest#grpc_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#istio_name DataK8SLeaksignalComLeaksignalIstioV1Manifest#istio_name}
  */
  readonly istioName?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#native DataK8SLeaksignalComLeaksignalIstioV1Manifest#native}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#native_proxy_memory_limit DataK8SLeaksignalComLeaksignalIstioV1Manifest#native_proxy_memory_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#native_repo DataK8SLeaksignalComLeaksignalIstioV1Manifest#native_repo}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#proxy_hash DataK8SLeaksignalComLeaksignalIstioV1Manifest#proxy_hash}
  */
  readonly proxyHash: string;
  /**
  * Prefix of binary to pull. Defaults to 's3/leakproxy'. For LeakAgent deployments, use 'proxy'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#proxy_prefix DataK8SLeaksignalComLeaksignalIstioV1Manifest#proxy_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#proxy_pull_location DataK8SLeaksignalComLeaksignalIstioV1Manifest#proxy_pull_location}
  */
  readonly proxyPullLocation?: string;
  /**
  * Version string for LeakSignal Proxy deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#proxy_version DataK8SLeaksignalComLeaksignalIstioV1Manifest#proxy_version}
  */
  readonly proxyVersion: string;
  /**
  * Detects pods that should have leaksignal deployed, but dont, and restarts them.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#refresh_pods_on_stale DataK8SLeaksignalComLeaksignalIstioV1Manifest#refresh_pods_on_stale}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#refresh_pods_on_update DataK8SLeaksignalComLeaksignalIstioV1Manifest#refresh_pods_on_update}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#tls DataK8SLeaksignalComLeaksignalIstioV1Manifest#tls}
  */
  readonly tls?: boolean | cdktf.IResolvable;
  /**
  * Hostname of upstream location to send metrics to. Default is 'ingestion.app.leaksignal.com'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#upstream_location DataK8SLeaksignalComLeaksignalIstioV1Manifest#upstream_location}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#upstream_port DataK8SLeaksignalComLeaksignalIstioV1Manifest#upstream_port}
  */
  readonly upstreamPort?: number;
  /**
  * Pod selector for workloads.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#workload_selector DataK8SLeaksignalComLeaksignalIstioV1Manifest#workload_selector}
  */
  readonly workloadSelector?: DataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelector;
}

export function dataK8SLeaksignalComLeaksignalIstioV1ManifestSpecToTerraform(struct?: DataK8SLeaksignalComLeaksignalIstioV1ManifestSpec | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    istio_name: cdktf.stringToTerraform(struct!.istioName),
    ...
    workload_selector: dataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelectorToTerraform(struct!.workloadSelector),
  }
}


export function dataK8SLeaksignalComLeaksignalIstioV1ManifestSpecToHclTerraform(struct?: DataK8SLeaksignalComLeaksignalIstioV1ManifestSpec | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    istio_name: {
      value: cdktf.stringToHclTerraform(struct!.istioName),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    ...
    workload_selector: {
      value: dataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelectorToHclTerraform(struct!.workloadSelector),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelector",
    },
  };
...
export class DataK8SLeaksignalComLeaksignalIstioV1ManifestSpecOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SLeaksignalComLeaksignalIstioV1ManifestSpec | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
    ...
    if (this._istioName !== undefined) {
      hasAnyValues = true;
      internalValueResult.istioName = this._istioName;
    }
  ...
  public set internalValue(value: DataK8SLeaksignalComLeaksignalIstioV1ManifestSpec | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      ...
      this._istioName = value.istioName;
  ...
  // istio_name - computed: false, optional: true, required: false
  private _istioName?: string; 
  public get istioName() {
    return this.getStringAttribute('istio_name');
  }
  public set istioName(value: string) {
    this._istioName = value;
  }
  public resetIstioName() {
    this._istioName = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get istioNameInput() {
    return this._istioName;
  }
  ...
  private _workloadSelector = new DataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelectorOutputReference(this, "workload_selector");
  public get workloadSelector() {
    return this._workloadSelector;
  }
  public putWorkloadSelector(value: DataK8SLeaksignalComLeaksignalIstioV1ManifestSpecWorkloadSelector) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest k8s_leaksignal_com_leaksignal_istio_v1_manifest}
*/
export class DataK8SLeaksignalComLeaksignalIstioV1Manifest extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "k8s_leaksignal_com_leaksignal_istio_v1_manifest";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataK8SLeaksignalComLeaksignalIstioV1Manifest resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataK8SLeaksignalComLeaksignalIstioV1Manifest to import
  * @param importFromId The id of the existing DataK8SLeaksignalComLeaksignalIstioV1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataK8SLeaksignalComLeaksignalIstioV1Manifest to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "k8s_leaksignal_com_leaksignal_istio_v1_manifest", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/leaksignal_com_leaksignal_istio_v1_manifest k8s_leaksignal_com_leaksignal_istio_v1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataK8SLeaksignalComLeaksignalIstioV1ManifestConfig
  */
  public constructor(scope: Construct, id: string, config: DataK8SLeaksignalComLeaksignalIstioV1ManifestConfig) {
    super(scope, id, {
      terraformResourceType: 'k8s_leaksignal_com_leaksignal_istio_v1_manifest',
  ...
  private _metadata = new DataK8SLeaksignalComLeaksignalIstioV1ManifestMetadataOutputReference(this, "metadata");
  public get metadata() {
    return this._metadata;
  }
  public putMetadata(value: DataK8SLeaksignalComLeaksignalIstioV1ManifestMetadata) {
  ...
  private _spec = new DataK8SLeaksignalComLeaksignalIstioV1ManifestSpecOutputReference(this, "spec");
  public get spec() {
    return this._spec;
  }
  public putSpec(value: DataK8SLeaksignalComLeaksignalIstioV1ManifestSpec) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      metadata: dataK8SLeaksignalComLeaksignalIstioV1ManifestMetadataToTerraform(this._metadata.internalValue),
      spec: dataK8SLeaksignalComLeaksignalIstioV1ManifestSpecToTerraform(this._spec.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      metadata: {
        value: dataK8SLeaksignalComLeaksignalIstioV1ManifestMetadataToHclTerraform(this._metadata.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataK8SLeaksignalComLeaksignalIstioV1ManifestMetadata",
      },
      spec: {
        value: dataK8SLeaksignalComLeaksignalIstioV1ManifestSpecToHclTerraform(this._spec.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataK8SLeaksignalComLeaksignalIstioV1ManifestSpec",
      },
    };
