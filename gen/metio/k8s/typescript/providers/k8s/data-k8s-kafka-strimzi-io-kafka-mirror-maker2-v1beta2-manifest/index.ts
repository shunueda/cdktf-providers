...
export interface DataK8SKafkaStrimziIoKafkaMirrorMaker2V1Beta2ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/kafka_strimzi_io_kafka_mirror_maker2_v1beta2_manifest#spec DataK8SKafkaStrimziIoKafkaMirrorMaker2V1Beta2Manifest#spec}
  */
  readonly spec?: DataK8SKafkaStrimziIoKafkaMirrorMaker2V1Beta2ManifestSpec;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/kafka_strimzi_io_kafka_mirror_maker2_v1beta2_manifest k8s_kafka_strimzi_io_kafka_mirror_maker2_v1beta2_manifest}
*/
export class DataK8SKafkaStrimziIoKafkaMirrorMaker2V1Beta2Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SKafkaStrimziIoKafkaMirrorMaker2V1Beta2Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/kafka_strimzi_io_kafka_mirror_maker2_v1beta2_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/kafka_strimzi_io_kafka_mirror_maker2_v1beta2_manifest k8s_kafka_strimzi_io_kafka_mirror_maker2_v1beta2_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
