// https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest
...
export interface DataK8SKafkaStrimziIoKafkaConnectorV1Beta2ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#metadata DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#metadata}
  */
  readonly metadata: DataK8SKafkaStrimziIoKafkaConnectorV1Beta2ManifestMetadata;
  /**
  * The specification of the Kafka Connector.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#spec DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#spec}
  */
...
export interface DataK8SKafkaStrimziIoKafkaConnectorV1Beta2ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#annotations DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#labels DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#name DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#namespace DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#namespace}
  */
...
export interface DataK8SKafkaStrimziIoKafkaConnectorV1Beta2ManifestSpecAutoRestart {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#enabled DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#max_restarts DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#max_restarts}
  */
...
export interface DataK8SKafkaStrimziIoKafkaConnectorV1Beta2ManifestSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#auto_restart DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#auto_restart}
  */
  readonly autoRestart?: DataK8SKafkaStrimziIoKafkaConnectorV1Beta2ManifestSpecAutoRestart;
  /**
  * The Class for the Kafka Connector.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#class DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#class}
  */
  readonly class?: string;
  /**
  * The Kafka Connector configuration. The following properties cannot be set: name, connector.class, tasks.max.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#config DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#config}
  */
  readonly config?: { [key: string]: string };
  /**
  * Whether the connector should be paused. Defaults to false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#pause DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#pause}
  */
  readonly pause?: boolean | cdktf.IResolvable;
  /**
  * The state the connector should be in. Defaults to running.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#state DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#state}
  */
  readonly state?: string;
  /**
  * The maximum number of tasks for the Kafka Connector.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#tasks_max DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest#tasks_max}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest k8s_kafka_strimzi_io_kafka_connector_v1beta2_manifest}
*/
export class DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SKafkaStrimziIoKafkaConnectorV1Beta2Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kafka_strimzi_io_kafka_connector_v1beta2_manifest k8s_kafka_strimzi_io_kafka_connector_v1beta2_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
