// https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest
...
export interface DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#metadata DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#spec DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest#spec}
  */
...
export interface DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#annotations DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#labels DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#name DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#namespace DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest#namespace}
  */
...
export interface DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1ManifestSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#bucket DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest#bucket}
  */
  readonly bucket: string;
  /**
  * ClusterName is the name of the Cluster this object belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#cluster_name DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest#cluster_name}
  */
  readonly clusterName: string;
  /**
  * DeletePolicy defines the policy used to identify images to be preserved beyond the lifecycle of associated cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#delete_policy DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest#delete_policy}
  */
  readonly deletePolicy?: string;
  /**
  * Cloud Object Storage image filename.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#object DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest#object}
  */
  readonly object: string;
  /**
  * Cloud Object Storage region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#region DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest#region}
  */
  readonly region: string;
  /**
  * ServiceInstanceID is the id of the power cloud instance where the image will get imported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#service_instance_id DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest#service_instance_id}
  */
  readonly serviceInstanceId: string;
  /**
  * Type of storage, storage pool with the most available space will be selected.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#storage_type DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest#storage_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest k8s_infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest}
*/
export class DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SInfrastructureClusterXK8SIoIbmPowerVsImageV1Beta1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest k8s_infrastructure_cluster_x_k8s_io_ibm_power_vs_image_v1beta1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
