...
export interface DataK8SKyvernoIoPolicyV1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kyverno_io_policy_v1_manifest#metadata DataK8SKyvernoIoPolicyV1Manifest#metadata}
  */
  readonly metadata: DataK8SKyvernoIoPolicyV1ManifestMetadata;
  /**
  * Spec defines policy behaviors and contains one or more rules.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kyverno_io_policy_v1_manifest#spec DataK8SKyvernoIoPolicyV1Manifest#spec}
  */
  readonly spec: DataK8SKyvernoIoPolicyV1ManifestSpec;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kyverno_io_policy_v1_manifest k8s_kyverno_io_policy_v1_manifest}
*/
export class DataK8SKyvernoIoPolicyV1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SKyvernoIoPolicyV1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kyverno_io_policy_v1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.11.24/docs/data-sources/kyverno_io_policy_v1_manifest k8s_kyverno_io_policy_v1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
