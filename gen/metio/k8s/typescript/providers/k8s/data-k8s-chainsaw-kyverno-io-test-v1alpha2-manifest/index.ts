...
export interface DataK8SChainsawKyvernoIoTestV1Alpha2ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/chainsaw_kyverno_io_test_v1alpha2_manifest#metadata DataK8SChainsawKyvernoIoTestV1Alpha2Manifest#metadata}
  */
  readonly metadata: DataK8SChainsawKyvernoIoTestV1Alpha2ManifestMetadata;
  /**
  * Test spec.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/chainsaw_kyverno_io_test_v1alpha2_manifest#spec DataK8SChainsawKyvernoIoTestV1Alpha2Manifest#spec}
  */
  readonly spec: DataK8SChainsawKyvernoIoTestV1Alpha2ManifestSpec;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/chainsaw_kyverno_io_test_v1alpha2_manifest k8s_chainsaw_kyverno_io_test_v1alpha2_manifest}
*/
export class DataK8SChainsawKyvernoIoTestV1Alpha2Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SChainsawKyvernoIoTestV1Alpha2Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/chainsaw_kyverno_io_test_v1alpha2_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/chainsaw_kyverno_io_test_v1alpha2_manifest k8s_chainsaw_kyverno_io_test_v1alpha2_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
