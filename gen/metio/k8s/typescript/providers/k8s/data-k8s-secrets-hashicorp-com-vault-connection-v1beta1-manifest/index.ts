// https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest
...
export interface DataK8SSecretsHashicorpComVaultConnectionV1Beta1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest#metadata DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest#spec DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest#spec}
  */
...
export interface DataK8SSecretsHashicorpComVaultConnectionV1Beta1ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest#annotations DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest#labels DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest#name DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest#namespace DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest#namespace}
  */
...
export interface DataK8SSecretsHashicorpComVaultConnectionV1Beta1ManifestSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest#address DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest#address}
  */
  readonly address: string;
  /**
  * CACertSecretRef is the name of a Kubernetes secret containing the trusted PEM encoded CA certificate chain as 'ca.crt'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest#ca_cert_secret_ref DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest#ca_cert_secret_ref}
  */
  readonly caCertSecretRef?: string;
  /**
  * Headers to be included in all Vault requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest#headers DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest#headers}
  */
  readonly headers?: { [key: string]: string };
  /**
  * SkipTLSVerify for TLS connections.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest#skip_tls_verify DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest#skip_tls_verify}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest#timeout DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest#timeout}
  */
  readonly timeout?: string;
  /**
  * TLSServerName to use as the SNI host for TLS connections.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest#tls_server_name DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest#tls_server_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest k8s_secrets_hashicorp_com_vault_connection_v1beta1_manifest}
*/
export class DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SSecretsHashicorpComVaultConnectionV1Beta1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/secrets_hashicorp_com_vault_connection_v1beta1_manifest k8s_secrets_hashicorp_com_vault_connection_v1beta1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
