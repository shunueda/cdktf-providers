// https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest
...
export interface DataK8SClustersClusternetIoManagedClusterV1Beta1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#metadata DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#metadata}
  */
  readonly metadata: DataK8SClustersClusternetIoManagedClusterV1Beta1ManifestMetadata;
  /**
  * ManagedClusterSpec defines the desired state of ManagedCluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#spec DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#spec}
  */
...
export interface DataK8SClustersClusternetIoManagedClusterV1Beta1ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#annotations DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#labels DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#name DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#namespace DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#namespace}
  */
...
export interface DataK8SClustersClusternetIoManagedClusterV1Beta1ManifestSpecTaints {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#effect DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#effect}
  */
  readonly effect: string;
  /**
  * Required. The taint key to be applied to a node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#key DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#key}
  */
  readonly key: string;
  /**
  * TimeAdded represents the time at which the taint was added. It is only written for NoExecute taints.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#time_added DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#time_added}
  */
  readonly timeAdded?: string;
  /**
  * The taint value corresponding to the taint key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#value DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#value}
  */
...
export interface DataK8SClustersClusternetIoManagedClusterV1Beta1ManifestSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#cluster_id DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#cluster_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#cluster_init_base_name DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#cluster_init_base_name}
  */
  readonly clusterInitBaseName?: string;
  /**
  * ClusterType denotes the type of the child cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#cluster_type DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#cluster_type}
  */
  readonly clusterType?: string;
  /**
  * SyncMode decides how to sync resources from parent cluster to child cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#sync_mode DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#sync_mode}
  */
  readonly syncMode: string;
  /**
  * Taints has the 'effect' on any resource that does not tolerate the Taint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#taints DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest#taints}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest k8s_clusters_clusternet_io_managed_cluster_v1beta1_manifest}
*/
export class DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SClustersClusternetIoManagedClusterV1Beta1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/clusters_clusternet_io_managed_cluster_v1beta1_manifest k8s_clusters_clusternet_io_managed_cluster_v1beta1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
