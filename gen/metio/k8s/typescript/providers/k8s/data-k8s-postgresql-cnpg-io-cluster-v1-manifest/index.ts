...
export interface DataK8SPostgresqlCnpgIoClusterV1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.8/docs/data-sources/postgresql_cnpg_io_cluster_v1_manifest#metadata DataK8SPostgresqlCnpgIoClusterV1Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.8/docs/data-sources/postgresql_cnpg_io_cluster_v1_manifest#spec DataK8SPostgresqlCnpgIoClusterV1Manifest#spec}
  */
  readonly spec: DataK8SPostgresqlCnpgIoClusterV1ManifestSpec;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.12.8/docs/data-sources/postgresql_cnpg_io_cluster_v1_manifest k8s_postgresql_cnpg_io_cluster_v1_manifest}
*/
export class DataK8SPostgresqlCnpgIoClusterV1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SPostgresqlCnpgIoClusterV1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.12.8/docs/data-sources/postgresql_cnpg_io_cluster_v1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.12.8/docs/data-sources/postgresql_cnpg_io_cluster_v1_manifest k8s_postgresql_cnpg_io_cluster_v1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
