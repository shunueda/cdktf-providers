// https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/metal3_io_preprovisioning_image_v1alpha1_manifest
...
export interface DataK8SMetal3IoPreprovisioningImageV1Alpha1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/metal3_io_preprovisioning_image_v1alpha1_manifest#metadata DataK8SMetal3IoPreprovisioningImageV1Alpha1Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/metal3_io_preprovisioning_image_v1alpha1_manifest#spec DataK8SMetal3IoPreprovisioningImageV1Alpha1Manifest#spec}
  */
...
export interface DataK8SMetal3IoPreprovisioningImageV1Alpha1ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/metal3_io_preprovisioning_image_v1alpha1_manifest#annotations DataK8SMetal3IoPreprovisioningImageV1Alpha1Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/metal3_io_preprovisioning_image_v1alpha1_manifest#labels DataK8SMetal3IoPreprovisioningImageV1Alpha1Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/metal3_io_preprovisioning_image_v1alpha1_manifest#name DataK8SMetal3IoPreprovisioningImageV1Alpha1Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/metal3_io_preprovisioning_image_v1alpha1_manifest#namespace DataK8SMetal3IoPreprovisioningImageV1Alpha1Manifest#namespace}
  */
...
export interface DataK8SMetal3IoPreprovisioningImageV1Alpha1ManifestSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/metal3_io_preprovisioning_image_v1alpha1_manifest#accept_formats DataK8SMetal3IoPreprovisioningImageV1Alpha1Manifest#accept_formats}
  */
  readonly acceptFormats?: string[];
  /**
  * architecture is the processor architecture for which to build the image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/metal3_io_preprovisioning_image_v1alpha1_manifest#architecture DataK8SMetal3IoPreprovisioningImageV1Alpha1Manifest#architecture}
  */
  readonly architecture?: string;
  /**
  * networkDataName is the name of a Secret in the local namespace that contains network data to build in to the image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/metal3_io_preprovisioning_image_v1alpha1_manifest#network_data_name DataK8SMetal3IoPreprovisioningImageV1Alpha1Manifest#network_data_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/metal3_io_preprovisioning_image_v1alpha1_manifest k8s_metal3_io_preprovisioning_image_v1alpha1_manifest}
*/
export class DataK8SMetal3IoPreprovisioningImageV1Alpha1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SMetal3IoPreprovisioningImageV1Alpha1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/metal3_io_preprovisioning_image_v1alpha1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.11.17/docs/data-sources/metal3_io_preprovisioning_image_v1alpha1_manifest k8s_metal3_io_preprovisioning_image_v1alpha1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
