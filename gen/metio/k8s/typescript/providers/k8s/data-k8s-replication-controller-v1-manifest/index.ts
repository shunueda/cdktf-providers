...
export interface DataK8SReplicationControllerV1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.3/docs/data-sources/replication_controller_v1_manifest#metadata DataK8SReplicationControllerV1Manifest#metadata}
  */
  readonly metadata: DataK8SReplicationControllerV1ManifestMetadata;
  /**
  * ReplicationControllerSpec is the specification of a replication controller.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.3/docs/data-sources/replication_controller_v1_manifest#spec DataK8SReplicationControllerV1Manifest#spec}
  */
  readonly spec?: DataK8SReplicationControllerV1ManifestSpec;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.11.3/docs/data-sources/replication_controller_v1_manifest k8s_replication_controller_v1_manifest}
*/
export class DataK8SReplicationControllerV1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SReplicationControllerV1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.11.3/docs/data-sources/replication_controller_v1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.11.3/docs/data-sources/replication_controller_v1_manifest k8s_replication_controller_v1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
