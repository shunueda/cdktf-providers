// https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest
...
export interface DataK8SAzureMicrosoftComMySqlUserV1Alpha2ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#metadata DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#spec DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#spec}
  */
...
export interface DataK8SAzureMicrosoftComMySqlUserV1Alpha2ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#annotations DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#labels DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#name DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#namespace DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#namespace}
  */
...
export interface DataK8SAzureMicrosoftComMySqlUserV1Alpha2ManifestSpec {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#admin_secret DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#admin_secret}
  */
  readonly adminSecret?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#admin_secret_key_vault DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#admin_secret_key_vault}
  */
  readonly adminSecretKeyVault?: string;
  /**
  * The database-level roles assigned to the user (keyed by database name).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#database_roles DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#database_roles}
  */
  readonly databaseRoles?: { [key: string]: string[] } | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#key_vault_to_store_secrets DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#key_vault_to_store_secrets}
  */
  readonly keyVaultToStoreSecrets?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#resource_group DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#resource_group}
  */
  readonly resourceGroup: string;
  /**
  * The server-level roles assigned ot the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#roles DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#roles}
  */
  readonly roles?: string[];
  /**
  * INSERT ADDITIONAL SPEC FIELDS - desired state of cluster Important: Run 'make' to regenerate code after modifying this file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#server DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#server}
  */
  readonly server: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#username DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest k8s_azure_microsoft_com_my_sql_user_v1alpha2_manifest}
*/
export class DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SAzureMicrosoftComMySqlUserV1Alpha2Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/azure_microsoft_com_my_sql_user_v1alpha2_manifest k8s_azure_microsoft_com_my_sql_user_v1alpha2_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
