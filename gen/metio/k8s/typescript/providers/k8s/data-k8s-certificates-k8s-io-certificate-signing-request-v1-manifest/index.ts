// https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest
...
export interface DataK8SCertificatesK8SIoCertificateSigningRequestV1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#metadata DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest#metadata}
  */
  readonly metadata: DataK8SCertificatesK8SIoCertificateSigningRequestV1ManifestMetadata;
  /**
  * CertificateSigningRequestSpec contains the certificate request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#spec DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest#spec}
  */
...
export interface DataK8SCertificatesK8SIoCertificateSigningRequestV1ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#annotations DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#labels DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#name DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest#name}
  */
...
export interface DataK8SCertificatesK8SIoCertificateSigningRequestV1ManifestSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#expiration_seconds DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest#expiration_seconds}
  */
  readonly expirationSeconds?: number;
  /**
  * extra contains extra attributes of the user that created the CertificateSigningRequest. Populated by the API server on creation and immutable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#extra DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest#extra}
  */
  readonly extra?: { [key: string]: string[] } | cdktf.IResolvable;
  /**
  * groups contains group membership of the user that created the CertificateSigningRequest. Populated by the API server on creation and immutable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#groups DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest#groups}
  */
  readonly groups?: string[];
  /**
  * request contains an x509 certificate signing request encoded in a 'CERTIFICATE REQUEST' PEM block. When serialized as JSON or YAML, the data is additionally base64-encoded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#request DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest#request}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#signer_name DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest#signer_name}
  */
  readonly signerName: string;
  /**
  * uid contains the uid of the user that created the CertificateSigningRequest. Populated by the API server on creation and immutable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#uid DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest#uid}
  */
  readonly uid?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#usages DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest#usages}
  */
  readonly usages?: string[];
  /**
  * username contains the name of the user that created the CertificateSigningRequest. Populated by the API server on creation and immutable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#username DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest k8s_certificates_k8s_io_certificate_signing_request_v1_manifest}
*/
export class DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SCertificatesK8SIoCertificateSigningRequestV1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/certificates_k8s_io_certificate_signing_request_v1_manifest k8s_certificates_k8s_io_certificate_signing_request_v1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
