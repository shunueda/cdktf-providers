...
export interface DataK8SDatabasesSpotahomeComRedisFailoverV1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.8/docs/data-sources/databases_spotahome_com_redis_failover_v1_manifest#metadata DataK8SDatabasesSpotahomeComRedisFailoverV1Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.8/docs/data-sources/databases_spotahome_com_redis_failover_v1_manifest#spec DataK8SDatabasesSpotahomeComRedisFailoverV1Manifest#spec}
  */
  readonly spec: DataK8SDatabasesSpotahomeComRedisFailoverV1ManifestSpec;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.12.8/docs/data-sources/databases_spotahome_com_redis_failover_v1_manifest k8s_databases_spotahome_com_redis_failover_v1_manifest}
*/
export class DataK8SDatabasesSpotahomeComRedisFailoverV1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SDatabasesSpotahomeComRedisFailoverV1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.12.8/docs/data-sources/databases_spotahome_com_redis_failover_v1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.12.8/docs/data-sources/databases_spotahome_com_redis_failover_v1_manifest k8s_databases_spotahome_com_redis_failover_v1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
