...
export interface DataK8SSonataflowOrgSonataFlowV1Alpha08ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.3/docs/data-sources/sonataflow_org_sonata_flow_v1alpha08_manifest#metadata DataK8SSonataflowOrgSonataFlowV1Alpha08Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.11.3/docs/data-sources/sonataflow_org_sonata_flow_v1alpha08_manifest#spec DataK8SSonataflowOrgSonataFlowV1Alpha08Manifest#spec}
  */
  readonly spec?: DataK8SSonataflowOrgSonataFlowV1Alpha08ManifestSpec;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.11.3/docs/data-sources/sonataflow_org_sonata_flow_v1alpha08_manifest k8s_sonataflow_org_sonata_flow_v1alpha08_manifest}
*/
export class DataK8SSonataflowOrgSonataFlowV1Alpha08Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SSonataflowOrgSonataFlowV1Alpha08Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.11.3/docs/data-sources/sonataflow_org_sonata_flow_v1alpha08_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.11.3/docs/data-sources/sonataflow_org_sonata_flow_v1alpha08_manifest k8s_sonataflow_org_sonata_flow_v1alpha08_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
