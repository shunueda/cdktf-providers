...
export interface DataK8SKubeviousIoWorkloadV1Alpha1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/kubevious_io_workload_v1alpha1_manifest#scale DataK8SKubeviousIoWorkloadV1Alpha1Manifest#scale}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/kubevious_io_workload_v1alpha1_manifest k8s_kubevious_io_workload_v1alpha1_manifest}
*/
export class DataK8SKubeviousIoWorkloadV1Alpha1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SKubeviousIoWorkloadV1Alpha1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/kubevious_io_workload_v1alpha1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.12.22/docs/data-sources/kubevious_io_workload_v1alpha1_manifest k8s_kubevious_io_workload_v1alpha1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
