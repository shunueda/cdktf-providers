...
export interface DataK8SGatewaySoloIoVirtualHostOptionV1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.15/docs/data-sources/gateway_solo_io_virtual_host_option_v1_manifest#metadata DataK8SGatewaySoloIoVirtualHostOptionV1Manifest#metadata}
  */
  readonly metadata: DataK8SGatewaySoloIoVirtualHostOptionV1ManifestMetadata;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.15/docs/data-sources/gateway_solo_io_virtual_host_option_v1_manifest#spec DataK8SGatewaySoloIoVirtualHostOptionV1Manifest#spec}
  */
  readonly spec?: DataK8SGatewaySoloIoVirtualHostOptionV1ManifestSpec;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.12.15/docs/data-sources/gateway_solo_io_virtual_host_option_v1_manifest k8s_gateway_solo_io_virtual_host_option_v1_manifest}
*/
export class DataK8SGatewaySoloIoVirtualHostOptionV1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SGatewaySoloIoVirtualHostOptionV1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.12.15/docs/data-sources/gateway_solo_io_virtual_host_option_v1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.12.15/docs/data-sources/gateway_solo_io_virtual_host_option_v1_manifest k8s_gateway_solo_io_virtual_host_option_v1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
