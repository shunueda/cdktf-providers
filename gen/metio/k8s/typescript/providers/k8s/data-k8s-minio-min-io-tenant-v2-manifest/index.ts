...
export interface DataK8SMinioMinIoTenantV2ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.15/docs/data-sources/minio_min_io_tenant_v2_manifest#metadata DataK8SMinioMinIoTenantV2Manifest#metadata}
  */
  readonly metadata: DataK8SMinioMinIoTenantV2ManifestMetadata;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.15/docs/data-sources/minio_min_io_tenant_v2_manifest#scheduler DataK8SMinioMinIoTenantV2Manifest#scheduler}
  */
  readonly scheduler?: DataK8SMinioMinIoTenantV2ManifestScheduler;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.12.15/docs/data-sources/minio_min_io_tenant_v2_manifest#spec DataK8SMinioMinIoTenantV2Manifest#spec}
  */
  readonly spec: DataK8SMinioMinIoTenantV2ManifestSpec;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.12.15/docs/data-sources/minio_min_io_tenant_v2_manifest k8s_minio_min_io_tenant_v2_manifest}
*/
export class DataK8SMinioMinIoTenantV2Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SMinioMinIoTenantV2Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.12.15/docs/data-sources/minio_min_io_tenant_v2_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.12.15/docs/data-sources/minio_min_io_tenant_v2_manifest k8s_minio_min_io_tenant_v2_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
