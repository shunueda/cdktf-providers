// https://registry.terraform.io/providers/metio/git/2025.11.14/docs/data-sources/remote
...
export interface DataGitRemoteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.14/docs/data-sources/remote#directory DataGitRemote#directory}
  */
  readonly directory: string;
  /**
  * The name of the remote to gather information about.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.14/docs/data-sources/remote#name DataGitRemote#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/git/2025.11.14/docs/data-sources/remote git_remote}
*/
export class DataGitRemote extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitRemote that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/git/2025.11.14/docs/data-sources/remote#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/git/2025.11.14/docs/data-sources/remote git_remote} Data Source
  *
  * @param scope The scope in which to define this construct
