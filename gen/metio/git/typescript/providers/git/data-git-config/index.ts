// https://registry.terraform.io/providers/metio/git/2025.11.14/docs/data-sources/config
...
export interface DataGitConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.14/docs/data-sources/config#directory DataGitConfig#directory}
  */
  readonly directory: string;
  /**
  * The configuration scope to read. Possible values are `local`, `global`, and `system`. Defaults to `global`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.14/docs/data-sources/config#scope DataGitConfig#scope}
  */
  readonly scope?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/git/2025.11.14/docs/data-sources/config git_config}
*/
export class DataGitConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/git/2025.11.14/docs/data-sources/config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/git/2025.11.14/docs/data-sources/config git_config} Data Source
  *
  * @param scope The scope in which to define this construct
