// https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/tag
...
export interface TagConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/tag#directory Tag#directory}
  */
  readonly directory: string;
  /**
  * The tag message to use. Note that by specifying a message, an annotated tag will be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/tag#message Tag#message}
  */
  readonly message?: string;
  /**
  * The name of the Git tag to add.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/tag#name Tag#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/tag#revision Tag#revision}
  */
  readonly revision?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/tag git_tag}
*/
export class Tag extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Tag that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/tag git_tag} Resource
  *
  * @param scope The scope in which to define this construct
