// https://registry.terraform.io/providers/metio/git/2025.11.28/docs/data-sources/repository
...
export interface DataGitRepositoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/data-sources/repository#directory DataGitRepository#directory}
  */
  readonly directory: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/data-sources/repository git_repository}
*/
export class DataGitRepository extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/data-sources/repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/data-sources/repository git_repository} Data Source
  *
  * @param scope The scope in which to define this construct
