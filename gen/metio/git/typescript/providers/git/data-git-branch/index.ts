// https://registry.terraform.io/providers/metio/git/2025.11.21/docs/data-sources/branch
...
export interface DataGitBranchConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/data-sources/branch#directory DataGitBranch#directory}
  */
  readonly directory: string;
  /**
  * The name of the Git branch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/data-sources/branch#name DataGitBranch#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/data-sources/branch git_branch}
*/
export class DataGitBranch extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitBranch that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/data-sources/branch#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/data-sources/branch git_branch} Data Source
  *
  * @param scope The scope in which to define this construct
