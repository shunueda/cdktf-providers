// https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/remote
...
export interface RemoteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/remote#directory Remote#directory}
  */
  readonly directory: string;
  /**
  * The name of the Git remote to manage.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/remote#name Remote#name}
  */
  readonly name: string;
  /**
  * The URLs of the Git remote to manage. The first URL will be a fetch/pull URL. All other URLs will be push only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/remote#urls Remote#urls}
  */
  readonly urls: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/remote git_remote}
*/
export class Remote extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Remote that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/remote#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/git/2025.11.21/docs/resources/remote git_remote} Resource
  *
  * @param scope The scope in which to define this construct
