// https://registry.terraform.io/providers/metio/git/2025.11.28/docs/resources/init
...
export interface InitConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/resources/init#bare Init#bare}
  */
  readonly bare?: boolean | cdktf.IResolvable;
  /**
  * The path to the local Git repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/resources/init#directory Init#directory}
  */
  readonly directory: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/resources/init git_init}
*/
export class Init extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Init that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/resources/init#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/resources/init git_init} Resource
  *
  * @param scope The scope in which to define this construct
