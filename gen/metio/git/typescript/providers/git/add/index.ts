// https://registry.terraform.io/providers/metio/git/2025.11.28/docs/resources/add
...
export interface AddConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/resources/add#add_paths Add#add_paths}
  */
  readonly addPaths: string[];
  /**
  * The path to the local Git repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/resources/add#directory Add#directory}
  */
  readonly directory: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/resources/add git_add}
*/
export class Add extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Add that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/resources/add#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/resources/add git_add} Resource
  *
  * @param scope The scope in which to define this construct
