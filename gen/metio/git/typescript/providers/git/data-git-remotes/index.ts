// https://registry.terraform.io/providers/metio/git/2025.12.12/docs/data-sources/remotes
...
export interface DataGitRemotesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.12.12/docs/data-sources/remotes#directory DataGitRemotes#directory}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/git/2025.12.12/docs/data-sources/remotes git_remotes}
*/
export class DataGitRemotes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitRemotes that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/git/2025.12.12/docs/data-sources/remotes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/git/2025.12.12/docs/data-sources/remotes git_remotes} Data Source
  *
  * @param scope The scope in which to define this construct
