// https://registry.terraform.io/providers/metio/git/2025.11.28/docs/data-sources/status
...
export interface DataGitStatusConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/data-sources/status#directory DataGitStatus#directory}
  */
  readonly directory: string;
  /**
  * The file to get status information about.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/data-sources/status#file DataGitStatus#file}
  */
  readonly file: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/data-sources/status git_status}
*/
export class DataGitStatus extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/data-sources/status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/git/2025.11.28/docs/data-sources/status git_status} Data Source
  *
  * @param scope The scope in which to define this construct
