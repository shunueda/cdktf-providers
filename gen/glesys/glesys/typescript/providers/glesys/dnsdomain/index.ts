// https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain
...
export interface DnsdomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain#createrecords Dnsdomain#createrecords}
  */
  readonly createrecords?: string;
  /**
  * Domain expire TTL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain#expire Dnsdomain#expire}
  */
  readonly expire?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain#id Dnsdomain#id}
  *
  ...
  * Domain minimum TTL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain#minimum Dnsdomain#minimum}
  */
  readonly minimum?: number;
  /**
  * Domain name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain#name Dnsdomain#name}
  */
  readonly name: string;
  /**
  * Domain primary nameserver
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain#primarynameserver Dnsdomain#primarynameserver}
  */
  readonly primarynameserver?: string;
  /**
  * Domain refresh TTL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain#refresh Dnsdomain#refresh}
  */
  readonly refresh?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain#responsibleperson Dnsdomain#responsibleperson}
  */
  readonly responsibleperson?: string;
  /**
  * Domain retry TTL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain#retry Dnsdomain#retry}
  */
  readonly retry?: number;
  /**
  * Domain default TTL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain#ttl Dnsdomain#ttl}
  */
  readonly ttl?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain glesys_dnsdomain}
*/
export class Dnsdomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Dnsdomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/glesys/glesys/0.16.0/docs/resources/dnsdomain glesys_dnsdomain} Resource
  *
  * @param scope The scope in which to define this construct
