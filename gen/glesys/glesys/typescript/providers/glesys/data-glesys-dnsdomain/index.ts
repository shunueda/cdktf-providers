// https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/data-sources/dnsdomain
...
export interface DataGlesysDnsdomainConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/data-sources/dnsdomain#id DataGlesysDnsdomain#id}
  *
  ...
  * name of the domain
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/data-sources/dnsdomain#name DataGlesysDnsdomain#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/data-sources/dnsdomain glesys_dnsdomain}
*/
export class DataGlesysDnsdomain extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGlesysDnsdomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/data-sources/dnsdomain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/data-sources/dnsdomain glesys_dnsdomain} Data Source
  *
  * @param scope The scope in which to define this construct
