// https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/resources/networkadapter
...
export interface NetworkadapterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/resources/networkadapter#adaptertype Networkadapter#adaptertype}
  */
  readonly adaptertype?: string;
  /**
  * adapter bandwidth
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/resources/networkadapter#bandwidth Networkadapter#bandwidth}
  */
  readonly bandwidth?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/resources/networkadapter#id Networkadapter#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/resources/networkadapter#name Networkadapter#name}
  */
  readonly name?: string;
  /**
  * Network ID to connect to. Defaults to `internet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/resources/networkadapter#networkid Networkadapter#networkid}
  */
  readonly networkid?: string;
  /**
  * Server ID to connect the adapter to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/resources/networkadapter#serverid Networkadapter#serverid}
  */
  readonly serverid: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/resources/networkadapter glesys_networkadapter}
*/
export class Networkadapter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Networkadapter that should be imported. Refer to the {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/resources/networkadapter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/glesys/glesys/0.15.0/docs/resources/networkadapter glesys_networkadapter} Resource
  *
  * @param scope The scope in which to define this construct
