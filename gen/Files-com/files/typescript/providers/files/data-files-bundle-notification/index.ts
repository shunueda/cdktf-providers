// https://registry.terraform.io/providers/files-com/files/0.1.397/docs/data-sources/bundle_notification
...
export interface DataFilesBundleNotificationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/data-sources/bundle_notification#id DataFilesBundleNotification#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/data-sources/bundle_notification files_bundle_notification}
*/
export class DataFilesBundleNotification extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesBundleNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/data-sources/bundle_notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/data-sources/bundle_notification files_bundle_notification} Data Source
  *
  * @param scope The scope in which to define this construct
