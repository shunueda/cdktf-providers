// https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/message_comment
...
export interface DataFilesMessageCommentConfig extends cdktf.TerraformMetaArguments {
  ...
  * Message Comment ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/message_comment#id DataFilesMessageComment#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/message_comment files_message_comment}
*/
export class DataFilesMessageComment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesMessageComment that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/message_comment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/message_comment files_message_comment} Data Source
  *
  * @param scope The scope in which to define this construct
