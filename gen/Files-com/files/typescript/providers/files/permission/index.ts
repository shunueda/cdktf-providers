// https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/permission
...
export interface PermissionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Group ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/permission#group_id Permission#group_id}
  */
  readonly groupId?: number;
  /**
  * Group name (if applicable)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/permission#group_name Permission#group_name}
  */
  readonly groupName?: string;
  /**
  * Partner ID (if applicable)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/permission#partner_id Permission#partner_id}
  */
  readonly partnerId?: number;
  /**
  * Path. This must be slash-delimited, but it must neither start nor end with a slash. Maximum of 5000 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/permission#path Permission#path}
  */
  readonly path: string;
  /**
  * Permission type.  See the table referenced in the documentation for an explanation of each permission.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/permission#permission Permission#permission}
  */
  readonly permission?: string;
  /**
  * Recursive: does this permission apply to subfolders?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/permission#recursive Permission#recursive}
  */
  readonly recursive?: boolean | cdktf.IResolvable;
  /**
  * Site ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/permission#site_id Permission#site_id}
  */
  readonly siteId?: number;
  /**
  * User ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/permission#user_id Permission#user_id}
  */
  readonly userId?: number;
  /**
  * Username (if applicable)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/permission#username Permission#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/permission files_permission}
*/
export class Permission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Permission that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/permission files_permission} Resource
  *
  * @param scope The scope in which to define this construct
