// https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sftp_host_key
...
export interface SftpHostKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sftp_host_key#name SftpHostKey#name}
  */
  readonly name?: string;
  /**
  * The private key data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sftp_host_key#private_key SftpHostKey#private_key}
  */
  readonly privateKey?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sftp_host_key files_sftp_host_key}
*/
export class SftpHostKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SftpHostKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sftp_host_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sftp_host_key files_sftp_host_key} Resource
  *
  * @param scope The scope in which to define this construct
