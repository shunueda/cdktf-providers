// https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/gpg_key
...
export interface DataFilesGpgKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  * Your GPG key ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/gpg_key#id DataFilesGpgKey#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/gpg_key files_gpg_key}
*/
export class DataFilesGpgKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesGpgKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/gpg_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/gpg_key files_gpg_key} Data Source
  *
  * @param scope The scope in which to define this construct
