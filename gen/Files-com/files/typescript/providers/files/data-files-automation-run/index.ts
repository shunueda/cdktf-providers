// https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/automation_run
...
export interface DataFilesAutomationRunConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/automation_run#id DataFilesAutomationRun#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/automation_run files_automation_run}
*/
export class DataFilesAutomationRun extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesAutomationRun that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/automation_run#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/automation_run files_automation_run} Data Source
  *
  * @param scope The scope in which to define this construct
