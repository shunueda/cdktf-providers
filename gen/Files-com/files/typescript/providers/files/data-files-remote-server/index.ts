// https://registry.terraform.io/providers/files-com/files/0.1.415/docs/data-sources/remote_server
...
export interface DataFilesRemoteServerConfig extends cdktf.TerraformMetaArguments {
  ...
  * Remote server ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/data-sources/remote_server#id DataFilesRemoteServer#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/data-sources/remote_server files_remote_server}
*/
export class DataFilesRemoteServer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesRemoteServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/data-sources/remote_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/data-sources/remote_server files_remote_server} Data Source
  *
  * @param scope The scope in which to define this construct
