// https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/public_key
...
export interface PublicKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/public_key#generate_algorithm PublicKey#generate_algorithm}
  */
  readonly generateAlgorithm?: string;
  /**
  * If true, generate a new SSH key pair. Can not be used with `public_key`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/public_key#generate_keypair PublicKey#generate_keypair}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/public_key#generate_length PublicKey#generate_length}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/public_key#generate_private_key_password PublicKey#generate_private_key_password}
  */
  readonly generatePrivateKeyPassword?: string;
  /**
  * Actual contents of SSH key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/public_key#public_key PublicKey#public_key}
  */
  readonly publicKey?: string;
  /**
  * Public key title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/public_key#title PublicKey#title}
  */
  readonly title: string;
  /**
  * User ID this public key is associated with
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/public_key#user_id PublicKey#user_id}
  */
  readonly userId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/public_key files_public_key}
*/
export class PublicKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PublicKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/public_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/public_key files_public_key} Resource
  *
  * @param scope The scope in which to define this construct
