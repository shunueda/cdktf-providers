// https://registry.terraform.io/providers/files-com/files/0.1.420/docs/data-sources/remote_mount_backend
...
export interface DataFilesRemoteMountBackendConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/data-sources/remote_mount_backend#id DataFilesRemoteMountBackend#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/data-sources/remote_mount_backend files_remote_mount_backend}
*/
export class DataFilesRemoteMountBackend extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesRemoteMountBackend that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/data-sources/remote_mount_backend#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/data-sources/remote_mount_backend files_remote_mount_backend} Data Source
  *
  * @param scope The scope in which to define this construct
