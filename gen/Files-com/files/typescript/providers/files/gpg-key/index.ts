// https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key
...
export interface GpgKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key#generate_email GpgKey#generate_email}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key#generate_expires_at GpgKey#generate_expires_at}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key#generate_full_name GpgKey#generate_full_name}
  */
  readonly generateFullName?: string;
  /**
  * If true, generate a new GPG key pair. Can not be used with `public_key`/`private_key`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key#generate_keypair GpgKey#generate_keypair}
  */
  readonly generateKeypair?: boolean | cdktf.IResolvable;
  /**
  * Your GPG key name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key#name GpgKey#name}
  */
  readonly name: string;
  /**
  * Partner ID who owns this GPG Key, if applicable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key#partner_id GpgKey#partner_id}
  */
  readonly partnerId?: number;
  /**
  * MD5 hash of your GPG private key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key#private_key GpgKey#private_key}
  */
  readonly privateKey?: string;
  /**
  * Your GPG private key password. Only required for password protected keys.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key#private_key_password GpgKey#private_key_password}
  */
  readonly privateKeyPassword?: string;
  /**
  * MD5 hash of your GPG public key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key#public_key GpgKey#public_key}
  */
  readonly publicKey?: string;
  /**
  * User ID who owns this GPG Key, if applicable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key#user_id GpgKey#user_id}
  */
  readonly userId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key files_gpg_key}
*/
export class GpgKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GpgKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/resources/gpg_key files_gpg_key} Resource
  *
  * @param scope The scope in which to define this construct
