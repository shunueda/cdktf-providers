// https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/api_key
...
export interface DataFilesApiKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  * API Key ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/api_key#id DataFilesApiKey#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/api_key files_api_key}
*/
export class DataFilesApiKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/api_key files_api_key} Data Source
  *
  * @param scope The scope in which to define this construct
