// https://registry.terraform.io/providers/files-com/files/0.1.383/docs/data-sources/sftp_host_key
...
export interface DataFilesSftpHostKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  * SFTP Host Key ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/data-sources/sftp_host_key#id DataFilesSftpHostKey#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/data-sources/sftp_host_key files_sftp_host_key}
*/
export class DataFilesSftpHostKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesSftpHostKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/data-sources/sftp_host_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/data-sources/sftp_host_key files_sftp_host_key} Data Source
  *
  * @param scope The scope in which to define this construct
