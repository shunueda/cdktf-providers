// https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/form_field_set
...
export interface DataFilesFormFieldSetConfig extends cdktf.TerraformMetaArguments {
  ...
  * Form field set id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/form_field_set#id DataFilesFormFieldSet#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/form_field_set files_form_field_set}
*/
export class DataFilesFormFieldSet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesFormFieldSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/form_field_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/form_field_set files_form_field_set} Data Source
  *
  * @param scope The scope in which to define this construct
