// https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/sync_run
...
export interface DataFilesSyncRunConfig extends cdktf.TerraformMetaArguments {
  ...
  * SyncRun ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/sync_run#id DataFilesSyncRun#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/sync_run files_sync_run}
*/
export class DataFilesSyncRun extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesSyncRun that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/sync_run#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/sync_run files_sync_run} Data Source
  *
  * @param scope The scope in which to define this construct
