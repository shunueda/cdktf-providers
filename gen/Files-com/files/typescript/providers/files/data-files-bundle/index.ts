// https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/bundle
...
export interface DataFilesBundleConfig extends cdktf.TerraformMetaArguments {
  ...
  * Bundle ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/bundle#id DataFilesBundle#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/bundle files_bundle}
*/
export class DataFilesBundle extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesBundle that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/bundle#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/bundle files_bundle} Data Source
  *
  * @param scope The scope in which to define this construct
