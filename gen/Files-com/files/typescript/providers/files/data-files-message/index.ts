// https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/message
...
export interface DataFilesMessageConfig extends cdktf.TerraformMetaArguments {
  ...
  * Message ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/message#id DataFilesMessage#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/message files_message}
*/
export class DataFilesMessage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesMessage that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/message#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/message files_message} Data Source
  *
  * @param scope The scope in which to define this construct
