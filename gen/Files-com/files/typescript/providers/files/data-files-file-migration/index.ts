// https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/file_migration
...
export interface DataFilesFileMigrationConfig extends cdktf.TerraformMetaArguments {
  ...
  * File migration ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/file_migration#id DataFilesFileMigration#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/file_migration files_file_migration}
*/
export class DataFilesFileMigration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesFileMigration that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/file_migration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/file_migration files_file_migration} Data Source
  *
  * @param scope The scope in which to define this construct
