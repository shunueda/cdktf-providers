// https://registry.terraform.io/providers/files-com/files/0.1.398/docs/data-sources/file_comment
...
export interface DataFilesFileCommentConfig extends cdktf.TerraformMetaArguments {
  ...
  * File Comment ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.398/docs/data-sources/file_comment#id DataFilesFileComment#id}
  *
  ...
  * File path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.398/docs/data-sources/file_comment#path DataFilesFileComment#path}
  */
  readonly path: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.398/docs/data-sources/file_comment files_file_comment}
*/
export class DataFilesFileComment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesFileComment that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.398/docs/data-sources/file_comment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.398/docs/data-sources/file_comment files_file_comment} Data Source
  *
  * @param scope The scope in which to define this construct
