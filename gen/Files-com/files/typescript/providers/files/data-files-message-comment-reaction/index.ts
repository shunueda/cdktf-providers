// https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/message_comment_reaction
...
export interface DataFilesMessageCommentReactionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Reaction ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/message_comment_reaction#id DataFilesMessageCommentReaction#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/message_comment_reaction files_message_comment_reaction}
*/
export class DataFilesMessageCommentReaction extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesMessageCommentReaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/message_comment_reaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/message_comment_reaction files_message_comment_reaction} Data Source
  *
  * @param scope The scope in which to define this construct
