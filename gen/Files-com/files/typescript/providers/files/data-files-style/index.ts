// https://registry.terraform.io/providers/files-com/files/0.1.377/docs/data-sources/style
...
export interface DataFilesStyleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/data-sources/style#path DataFilesStyle#path}
  */
  readonly path: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/data-sources/style files_style}
*/
export class DataFilesStyle extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesStyle that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/data-sources/style#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.377/docs/data-sources/style files_style} Data Source
  *
  * @param scope The scope in which to define this construct
