// https://registry.terraform.io/providers/files-com/files/0.1.392/docs/data-sources/partner
...
export interface DataFilesPartnerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/data-sources/partner#id DataFilesPartner#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/data-sources/partner files_partner}
*/
export class DataFilesPartner extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesPartner that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/data-sources/partner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/data-sources/partner files_partner} Data Source
  *
  * @param scope The scope in which to define this construct
