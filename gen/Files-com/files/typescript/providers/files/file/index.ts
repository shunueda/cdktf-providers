// https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/file
...
export interface FileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/file#custom_metadata File#custom_metadata}
  */
  readonly customMetadata?: { [key: string]: any };
  /**
  * File MD5 checksum.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/file#md5 File#md5}
  */
  readonly md5?: string;
  /**
  * File/Folder path. This must be slash-delimited, but it must neither start nor end with a slash. Maximum of 5000 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/file#path File#path}
  */
  readonly path: string;
  /**
  * Bookmark/priority color of file/folder
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/file#priority_color File#priority_color}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/file#provided_mtime File#provided_mtime}
  */
  readonly providedMtime?: string;
  /**
  * File/Folder size
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/file#size File#size}
  */
  readonly size?: number;
  /**
  * Path to a file that will be read and uploaded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/file#source File#source}
  */
  readonly source: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/file files_file}
*/
export class File extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing File that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/file files_file} Resource
  *
  * @param scope The scope in which to define this construct
