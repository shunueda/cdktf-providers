// https://registry.terraform.io/providers/files-com/files/0.1.392/docs/data-sources/automation
...
export interface DataFilesAutomationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Automation ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/data-sources/automation#id DataFilesAutomation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/data-sources/automation files_automation}
*/
export class DataFilesAutomation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesAutomation that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/data-sources/automation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/data-sources/automation files_automation} Data Source
  *
  * @param scope The scope in which to define this construct
