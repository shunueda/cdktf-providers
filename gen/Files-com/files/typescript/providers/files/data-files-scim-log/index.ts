// https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/scim_log
...
export interface DataFilesScimLogConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/scim_log#id DataFilesScimLog#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/scim_log files_scim_log}
*/
export class DataFilesScimLog extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesScimLog that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/scim_log#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/scim_log files_scim_log} Data Source
  *
  * @param scope The scope in which to define this construct
