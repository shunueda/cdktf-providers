// https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/request
...
export interface RequestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/request#destination Request#destination}
  */
  readonly destination: string;
  /**
  * A list of group IDs to request the file from. If sent as a string, it should be comma-delimited.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/request#group_ids Request#group_ids}
  */
  readonly groupIds?: string;
  /**
  * Folder path. This must be slash-delimited, but it must neither start nor end with a slash. Maximum of 5000 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/request#path Request#path}
  */
  readonly path: string;
  /**
  * A list of user IDs to request the file from. If sent as a string, it should be comma-delimited.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/request#user_ids Request#user_ids}
  */
  readonly userIds?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/request files_request}
*/
export class Request extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Request that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/request#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/request files_request} Resource
  *
  * @param scope The scope in which to define this construct
