// https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/permission
...
export interface DataFilesPermissionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Permission ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/permission#id DataFilesPermission#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/permission files_permission}
*/
export class DataFilesPermission extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/permission files_permission} Data Source
  *
  * @param scope The scope in which to define this construct
