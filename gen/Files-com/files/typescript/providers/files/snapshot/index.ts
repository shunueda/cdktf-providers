// https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/snapshot
...
export interface SnapshotConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/snapshot#expires_at Snapshot#expires_at}
  */
  readonly expiresAt?: string;
  /**
  * A name for the snapshot.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/snapshot#name Snapshot#name}
  */
  readonly name?: string;
  /**
  * An array of paths to add to the snapshot.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/snapshot#paths Snapshot#paths}
  */
  readonly paths?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/snapshot files_snapshot}
*/
export class Snapshot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Snapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/resources/snapshot files_snapshot} Resource
  *
  * @param scope The scope in which to define this construct
