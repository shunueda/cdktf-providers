// https://registry.terraform.io/providers/files-com/files/0.1.415/docs/data-sources/file
...
export interface DataFilesFileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/data-sources/file#path DataFilesFile#path}
  */
  readonly path: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/data-sources/file files_file}
*/
export class DataFilesFile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/data-sources/file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/data-sources/file files_file} Data Source
  *
  * @param scope The scope in which to define this construct
