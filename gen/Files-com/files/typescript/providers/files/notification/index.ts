// https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification
...
export interface NotificationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#group_id Notification#group_id}
  */
  readonly groupId?: number;
  /**
  * Custom message to include in notification emails
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#message Notification#message}
  */
  readonly message?: string;
  /**
  * Trigger on files copied to this path?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#notify_on_copy Notification#notify_on_copy}
  */
  readonly notifyOnCopy?: boolean | cdktf.IResolvable;
  /**
  * Trigger on files deleted in this path?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#notify_on_delete Notification#notify_on_delete}
  */
  readonly notifyOnDelete?: boolean | cdktf.IResolvable;
  /**
  * Trigger on files downloaded in this path?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#notify_on_download Notification#notify_on_download}
  */
  readonly notifyOnDownload?: boolean | cdktf.IResolvable;
  /**
  * Trigger on files moved to this path?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#notify_on_move Notification#notify_on_move}
  */
  readonly notifyOnMove?: boolean | cdktf.IResolvable;
  /**
  * Trigger on files created/uploaded/updated/changed in this path?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#notify_on_upload Notification#notify_on_upload}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#notify_user_actions Notification#notify_user_actions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#path Notification#path}
  */
  readonly path?: string;
  /**
  * Apply notification recursively?  This will enable notifications for each subfolder.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#recursive Notification#recursive}
  */
  readonly recursive?: boolean | cdktf.IResolvable;
  /**
  * The time interval that notifications are aggregated to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#send_interval Notification#send_interval}
  */
  readonly sendInterval?: string;
  /**
  * Notify when actions are performed by a share recipient?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#trigger_by_share_recipients Notification#trigger_by_share_recipients}
  */
  readonly triggerByShareRecipients?: boolean | cdktf.IResolvable;
  /**
  * Array of filenames (possibly with wildcards) to scope trigger
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#triggering_filenames Notification#triggering_filenames}
  */
  readonly triggeringFilenames?: string[];
  /**
  * If set, will only notify on actions made by a member of one of the specified groups
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#triggering_group_ids Notification#triggering_group_ids}
  */
  readonly triggeringGroupIds?: number[];
  /**
  * If set, will only notify on actions made one of the specified users
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#triggering_user_ids Notification#triggering_user_ids}
  */
  readonly triggeringUserIds?: number[];
  /**
  * Notification user ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#user_id Notification#user_id}
  */
  readonly userId?: number;
  /**
  * Notification username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#username Notification#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification files_notification}
*/
export class Notification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Notification that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/notification files_notification} Resource
  *
  * @param scope The scope in which to define this construct
