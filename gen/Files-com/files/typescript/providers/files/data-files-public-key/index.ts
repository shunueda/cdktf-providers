// https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/public_key
...
export interface DataFilesPublicKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  * Public key ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/public_key#id DataFilesPublicKey#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/public_key files_public_key}
*/
export class DataFilesPublicKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesPublicKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/public_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/public_key files_public_key} Data Source
  *
  * @param scope The scope in which to define this construct
