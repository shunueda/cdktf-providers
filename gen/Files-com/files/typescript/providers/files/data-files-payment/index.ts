// https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/payment
...
export interface DataFilesPaymentConfig extends cdktf.TerraformMetaArguments {
  ...
  * Line item Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/payment#id DataFilesPayment#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/payment files_payment}
*/
export class DataFilesPayment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesPayment that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/payment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/payment files_payment} Data Source
  *
  * @param scope The scope in which to define this construct
