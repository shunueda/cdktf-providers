// https://registry.terraform.io/providers/files-com/files/0.1.379/docs/resources/partner
...
export interface PartnerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/resources/partner#allow_bypassing_2fa_policies Partner#allow_bypassing_2fa_policies}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/resources/partner#allow_credential_changes Partner#allow_credential_changes}
  */
  readonly allowCredentialChanges?: boolean | cdktf.IResolvable;
  /**
  * Allow Partner Admins to provide GPG keys.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/resources/partner#allow_providing_gpg_keys Partner#allow_providing_gpg_keys}
  */
  readonly allowProvidingGpgKeys?: boolean | cdktf.IResolvable;
  /**
  * Allow Partner Admins to create users.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/resources/partner#allow_user_creation Partner#allow_user_creation}
  */
  readonly allowUserCreation?: boolean | cdktf.IResolvable;
  /**
  * The name of the Partner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/resources/partner#name Partner#name}
  */
  readonly name: string;
  /**
  * Notes about this Partner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/resources/partner#notes Partner#notes}
  */
  readonly notes?: string;
  /**
  * The root folder path for this Partner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/resources/partner#root_folder Partner#root_folder}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/resources/partner#tags Partner#tags}
  */
  readonly tags?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/resources/partner files_partner}
*/
export class Partner extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Partner that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/resources/partner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/resources/partner files_partner} Resource
  *
  * @param scope The scope in which to define this construct
