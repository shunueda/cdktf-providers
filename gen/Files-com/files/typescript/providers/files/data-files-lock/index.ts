// https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/lock
...
export interface DataFilesLockConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/lock#path DataFilesLock#path}
  */
  readonly path: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/lock files_lock}
*/
export class DataFilesLock extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesLock that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/lock#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/lock files_lock} Data Source
  *
  * @param scope The scope in which to define this construct
