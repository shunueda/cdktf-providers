// https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/behavior
...
export interface BehaviorConfig extends cdktf.TerraformMetaArguments {
  ...
  * Behavior type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/behavior#behavior Behavior#behavior}
  */
  readonly behavior: string;
  /**
  * Description for this behavior.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/behavior#description Behavior#description}
  */
  readonly description?: string;
  /**
  * If true, the parent folder's behavior will be disabled for this folder and its children.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/behavior#disable_parent_folder_behavior Behavior#disable_parent_folder_behavior}
  */
  readonly disableParentFolderBehavior?: boolean | cdktf.IResolvable;
  /**
  * Name for this behavior.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/behavior#name Behavior#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/behavior#path Behavior#path}
  */
  readonly path: string;
  /**
  * Is behavior recursive?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/behavior#recursive Behavior#recursive}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/behavior#value Behavior#value}
  */
  readonly value?: { [key: string]: any };
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/behavior files_behavior}
*/
export class Behavior extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Behavior that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/behavior#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/behavior files_behavior} Resource
  *
  * @param scope The scope in which to define this construct
