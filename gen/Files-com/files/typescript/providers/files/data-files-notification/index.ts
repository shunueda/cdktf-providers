// https://registry.terraform.io/providers/files-com/files/0.1.383/docs/data-sources/notification
...
export interface DataFilesNotificationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Notification ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/data-sources/notification#id DataFilesNotification#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/data-sources/notification files_notification}
*/
export class DataFilesNotification extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/data-sources/notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/data-sources/notification files_notification} Data Source
  *
  * @param scope The scope in which to define this construct
