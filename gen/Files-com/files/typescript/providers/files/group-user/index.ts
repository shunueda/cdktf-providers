// https://registry.terraform.io/providers/files-com/files/0.1.415/docs/resources/group_user
...
export interface GroupUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/resources/group_user#admin GroupUser#admin}
  */
  readonly admin?: boolean | cdktf.IResolvable;
  /**
  * Group ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/resources/group_user#group_id GroupUser#group_id}
  */
  readonly groupId: number;
  /**
  * User ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/resources/group_user#user_id GroupUser#user_id}
  */
  readonly userId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/resources/group_user files_group_user}
*/
export class GroupUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/resources/group_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/resources/group_user files_group_user} Resource
  *
  * @param scope The scope in which to define this construct
