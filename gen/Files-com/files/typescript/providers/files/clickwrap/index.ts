// https://registry.terraform.io/providers/files-com/files/0.1.397/docs/resources/clickwrap
...
export interface ClickwrapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/resources/clickwrap#body Clickwrap#body}
  */
  readonly body?: string;
  /**
  * Name of the Clickwrap agreement (used when selecting from multiple Clickwrap agreements.)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/resources/clickwrap#name Clickwrap#name}
  */
  readonly name?: string;
  /**
  * Use this Clickwrap for Bundles?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/resources/clickwrap#use_with_bundles Clickwrap#use_with_bundles}
  */
  readonly useWithBundles?: string;
  /**
  * Use this Clickwrap for Inboxes?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/resources/clickwrap#use_with_inboxes Clickwrap#use_with_inboxes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/resources/clickwrap#use_with_users Clickwrap#use_with_users}
  */
  readonly useWithUsers?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/resources/clickwrap files_clickwrap}
*/
export class Clickwrap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Clickwrap that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/resources/clickwrap#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/resources/clickwrap files_clickwrap} Resource
  *
  * @param scope The scope in which to define this construct
