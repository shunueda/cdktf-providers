// https://registry.terraform.io/providers/files-com/files/0.1.417/docs/data-sources/group_user
...
export interface DataFilesGroupUserConfig extends cdktf.TerraformMetaArguments {
  ...
  * Group ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.417/docs/data-sources/group_user#group_id DataFilesGroupUser#group_id}
  */
  readonly groupId: number;
  /**
  * User ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.417/docs/data-sources/group_user#user_id DataFilesGroupUser#user_id}
  */
  readonly userId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.417/docs/data-sources/group_user files_group_user}
*/
export class DataFilesGroupUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesGroupUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.417/docs/data-sources/group_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.417/docs/data-sources/group_user files_group_user} Data Source
  *
  * @param scope The scope in which to define this construct
