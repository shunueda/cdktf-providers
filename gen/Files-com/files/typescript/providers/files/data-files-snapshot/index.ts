// https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/snapshot
...
export interface DataFilesSnapshotConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/snapshot#id DataFilesSnapshot#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/snapshot files_snapshot}
*/
export class DataFilesSnapshot extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/snapshot files_snapshot} Data Source
  *
  * @param scope The scope in which to define this construct
