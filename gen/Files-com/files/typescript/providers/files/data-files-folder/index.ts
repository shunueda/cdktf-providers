// https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/folder
...
export interface DataFilesFolderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/folder#path DataFilesFolder#path}
  */
  readonly path: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/folder files_folder}
*/
export class DataFilesFolder extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesFolder that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/folder#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/folder files_folder} Data Source
  *
  * @param scope The scope in which to define this construct
