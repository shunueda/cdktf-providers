// https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/user_lifecycle_rule
...
export interface DataFilesUserLifecycleRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/user_lifecycle_rule#id DataFilesUserLifecycleRule#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/user_lifecycle_rule files_user_lifecycle_rule}
*/
export class DataFilesUserLifecycleRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesUserLifecycleRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/user_lifecycle_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/user_lifecycle_rule files_user_lifecycle_rule} Data Source
  *
  * @param scope The scope in which to define this construct
