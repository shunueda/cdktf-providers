// https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/history_export
...
export interface DataFilesHistoryExportConfig extends cdktf.TerraformMetaArguments {
  ...
  * History Export ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/history_export#id DataFilesHistoryExport#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/history_export files_history_export}
*/
export class DataFilesHistoryExport extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesHistoryExport that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/history_export#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/data-sources/history_export files_history_export} Data Source
  *
  * @param scope The scope in which to define this construct
