// https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle
...
export interface BundleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#clickwrap_id Bundle#clickwrap_id}
  */
  readonly clickwrapId?: number;
  /**
  * Bundle code.  This code forms the end part of the Public URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#code Bundle#code}
  */
  readonly code?: string;
  /**
  * If true, create a snapshot of this bundle's contents.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#create_snapshot Bundle#create_snapshot}
  */
  readonly createSnapshot?: boolean | cdktf.IResolvable;
  /**
  * Public description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#description Bundle#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#dont_separate_submissions_by_folder Bundle#dont_separate_submissions_by_folder}
  */
  readonly dontSeparateSubmissionsByFolder?: boolean | cdktf.IResolvable;
  /**
  * Bundle expiration date/time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#expires_at Bundle#expires_at}
  */
  readonly expiresAt?: string;
  /**
  * If true, finalize the snapshot of this bundle's contents. Note that `create_snapshot` must also be true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#finalize_snapshot Bundle#finalize_snapshot}
  */
  readonly finalizeSnapshot?: boolean | cdktf.IResolvable;
  /**
  * Id of Form Field Set to use with this bundle
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#form_field_set_id Bundle#form_field_set_id}
  */
  readonly formFieldSetId?: number;
  /**
  * ID of the associated inbox, if available.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#inbox_id Bundle#inbox_id}
  */
  readonly inboxId?: number;
  /**
  * Maximum number of times bundle can be accessed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#max_uses Bundle#max_uses}
  */
  readonly maxUses?: number;
  /**
  * Bundle internal note
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#note Bundle#note}
  */
  readonly note?: string;
  /**
  * Password for this bundle.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#password Bundle#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#path_template Bundle#path_template}
  */
  readonly pathTemplate?: string;
  /**
  * Timezone to use when rendering timestamps in path templates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#path_template_time_zone Bundle#path_template_time_zone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#paths Bundle#paths}
  */
  readonly paths: string[];
  /**
  * Permissions that apply to Folders in this Share Link.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#permissions Bundle#permissions}
  */
  readonly permissions?: string;
  /**
  * Show a registration page that captures the downloader's name and email address?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#require_registration Bundle#require_registration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#require_share_recipient Bundle#require_share_recipient}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#send_email_receipt_to_uploader Bundle#send_email_receipt_to_uploader}
  */
  readonly sendEmailReceiptToUploader?: boolean | cdktf.IResolvable;
  /**
  * BundleRegistrations can be saved without providing company?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#skip_company Bundle#skip_company}
  */
  readonly skipCompany?: boolean | cdktf.IResolvable;
  /**
  * BundleRegistrations can be saved without providing email?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#skip_email Bundle#skip_email}
  */
  readonly skipEmail?: boolean | cdktf.IResolvable;
  /**
  * BundleRegistrations can be saved without providing name?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#skip_name Bundle#skip_name}
  */
  readonly skipName?: boolean | cdktf.IResolvable;
  /**
  * ID of the snapshot containing this bundle's contents.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#snapshot_id Bundle#snapshot_id}
  */
  readonly snapshotId?: number;
  /**
  * Date when share will start to be accessible. If `nil` access granted right after create.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#start_access_on_date Bundle#start_access_on_date}
  */
  readonly startAccessOnDate?: string;
  /**
  * Bundle creator user ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#user_id Bundle#user_id}
  */
  readonly userId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle files_bundle}
*/
export class Bundle extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Bundle that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/resources/bundle files_bundle} Resource
  *
  * @param scope The scope in which to define this construct
