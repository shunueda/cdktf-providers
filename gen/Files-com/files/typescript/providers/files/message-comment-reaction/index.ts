// https://registry.terraform.io/providers/files-com/files/0.1.415/docs/resources/message_comment_reaction
...
export interface MessageCommentReactionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/resources/message_comment_reaction#emoji MessageCommentReaction#emoji}
  */
  readonly emoji: string;
  /**
  * User ID.  Provide a value of `0` to operate the current session's user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/resources/message_comment_reaction#user_id MessageCommentReaction#user_id}
  */
  readonly userId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/resources/message_comment_reaction files_message_comment_reaction}
*/
export class MessageCommentReaction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MessageCommentReaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/resources/message_comment_reaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.415/docs/resources/message_comment_reaction files_message_comment_reaction} Resource
  *
  * @param scope The scope in which to define this construct
