// https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner
...
export interface As2PartnerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner#additional_http_headers As2Partner#additional_http_headers}
  */
  readonly additionalHttpHeaders?: { [key: string]: any };
  /**
  * ID of the AS2 Station associated with this partner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner#as2_station_id As2Partner#as2_station_id}
  */
  readonly as2StationId: number;
  /**
  * Default mime type of the file attached to the encrypted message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner#default_mime_type As2Partner#default_mime_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner#enable_dedicated_ips As2Partner#enable_dedicated_ips}
  */
  readonly enableDedicatedIps?: boolean | cdktf.IResolvable;
  /**
  * Password to send to server for HTTP Authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner#http_auth_password As2Partner#http_auth_password}
  */
  readonly httpAuthPassword?: string;
  /**
  * Username to send to server for HTTP Authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner#http_auth_username As2Partner#http_auth_username}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner#mdn_validation_level As2Partner#mdn_validation_level}
  */
  readonly mdnValidationLevel?: string;
  /**
  * The partner's formal AS2 name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner#name As2Partner#name}
  */
  readonly name: string;
  /**
  * Public certificate used for message security.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner#public_certificate As2Partner#public_certificate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner#server_certificate As2Partner#server_certificate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner#signature_validation_level As2Partner#signature_validation_level}
  */
  readonly signatureValidationLevel?: string;
  /**
  * Public URI where we will send the AS2 messages (via HTTP/HTTPS).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner#uri As2Partner#uri}
  */
  readonly uri: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner files_as2_partner}
*/
export class As2Partner extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing As2Partner that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.383/docs/resources/as2_partner files_as2_partner} Resource
  *
  * @param scope The scope in which to define this construct
