// https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/group
...
export interface DataFilesGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Group ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/group#id DataFilesGroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/group files_group}
*/
export class DataFilesGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/group files_group} Data Source
  *
  * @param scope The scope in which to define this construct
