// https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync
...
export interface SyncConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#delete_empty_folders Sync#delete_empty_folders}
  */
  readonly deleteEmptyFolders?: boolean | cdktf.IResolvable;
  /**
  * Description for this sync job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#description Sync#description}
  */
  readonly description?: string;
  /**
  * Absolute destination path for the sync
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#dest_path Sync#dest_path}
  */
  readonly destPath?: string;
  /**
  * Remote server ID for the destination (if remote)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#dest_remote_server_id Sync#dest_remote_server_id}
  */
  readonly destRemoteServerId?: number;
  /**
  * Is this sync disabled?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#disabled Sync#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#holiday_region Sync#holiday_region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#interval Sync#interval}
  */
  readonly interval?: string;
  /**
  * Keep files after copying?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#keep_after_copy Sync#keep_after_copy}
  */
  readonly keepAfterCopy?: boolean | cdktf.IResolvable;
  /**
  * Name for this sync job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#name Sync#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#recurring_day Sync#recurring_day}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#schedule_days_of_week Sync#schedule_days_of_week}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#schedule_time_zone Sync#schedule_time_zone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#schedule_times_of_day Sync#schedule_times_of_day}
  */
  readonly scheduleTimesOfDay?: string[];
  /**
  * Absolute source path for the sync
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#src_path Sync#src_path}
  */
  readonly srcPath?: string;
  /**
  * Remote server ID for the source (if remote)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#src_remote_server_id Sync#src_remote_server_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#sync_interval_minutes Sync#sync_interval_minutes}
  */
  readonly syncIntervalMinutes?: number;
  /**
  * Trigger type: daily, custom_schedule, or manual
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#trigger Sync#trigger}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#trigger_file Sync#trigger_file}
  */
  readonly triggerFile?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync files_sync}
*/
export class Sync extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sync that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/sync files_sync} Resource
  *
  * @param scope The scope in which to define this construct
