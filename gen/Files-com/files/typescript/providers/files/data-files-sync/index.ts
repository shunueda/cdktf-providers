// https://registry.terraform.io/providers/files-com/files/0.1.412/docs/data-sources/sync
...
export interface DataFilesSyncConfig extends cdktf.TerraformMetaArguments {
  ...
  * Sync ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/data-sources/sync#id DataFilesSync#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/data-sources/sync files_sync}
*/
export class DataFilesSync extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesSync that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/data-sources/sync#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/data-sources/sync files_sync} Data Source
  *
  * @param scope The scope in which to define this construct
