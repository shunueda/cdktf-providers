// https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/user
...
export interface DataFilesUserConfig extends cdktf.TerraformMetaArguments {
  ...
  * User ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/user#id DataFilesUser#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/user files_user}
*/
export class DataFilesUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.379/docs/data-sources/user files_user} Data Source
  *
  * @param scope The scope in which to define this construct
