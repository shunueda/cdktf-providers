// https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/share_group
...
export interface DataFilesShareGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Share Group ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/share_group#id DataFilesShareGroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/share_group files_share_group}
*/
export class DataFilesShareGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesShareGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/share_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.391/docs/data-sources/share_group files_share_group} Data Source
  *
  * @param scope The scope in which to define this construct
