// https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/request
...
export interface DataFilesRequestConfig extends cdktf.TerraformMetaArguments {
  ...
  * Request ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/request#id DataFilesRequest#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/request files_request}
*/
export class DataFilesRequest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesRequest that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/request#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.375/docs/data-sources/request files_request} Data Source
  *
  * @param scope The scope in which to define this construct
