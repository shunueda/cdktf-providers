// https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/api_key
...
export interface ApiKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/api_key#aws_style_credentials ApiKey#aws_style_credentials}
  */
  readonly awsStyleCredentials?: boolean | cdktf.IResolvable;
  /**
  * User-supplied description of API key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/api_key#description ApiKey#description}
  */
  readonly description?: string;
  /**
  * API Key expiration date
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/api_key#expires_at ApiKey#expires_at}
  */
  readonly expiresAt?: string;
  /**
  * Internal name for the API Key.  For your use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/api_key#name ApiKey#name}
  */
  readonly name: string;
  /**
  * Folder path restriction for `office_integration` permission set API keys.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/api_key#path ApiKey#path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/api_key#permission_set ApiKey#permission_set}
  */
  readonly permissionSet?: string;
  /**
  * User ID for the owner of this API Key.  May be blank for Site-wide API Keys.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/api_key#user_id ApiKey#user_id}
  */
  readonly userId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/api_key files_api_key}
*/
export class ApiKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/api_key files_api_key} Resource
  *
  * @param scope The scope in which to define this construct
