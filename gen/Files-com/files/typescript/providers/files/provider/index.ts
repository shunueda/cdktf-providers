// https://registry.terraform.io/providers/files-com/files/0.1.411/docs
...
export interface FilesProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs#api_key FilesProvider#api_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs#endpoint_override FilesProvider#endpoint_override}
  */
  readonly endpointOverride?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs#environment FilesProvider#environment}
  */
  readonly environment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs#feature_flags FilesProvider#feature_flags}
  */
  readonly featureFlags?: string[];
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs#alias FilesProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs files}
*/
export class FilesProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing FilesProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs files} Resource
  *
  * @param scope The scope in which to define this construct
