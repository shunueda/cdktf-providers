// https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/as2_station
...
export interface As2StationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/as2_station#name As2Station#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/as2_station#private_key As2Station#private_key}
  */
  readonly privateKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/as2_station#private_key_password As2Station#private_key_password}
  */
  readonly privateKeyPassword?: string;
  /**
  * Public certificate used for message security.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/as2_station#public_certificate As2Station#public_certificate}
  */
  readonly publicCertificate: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/as2_station files_as2_station}
*/
export class As2Station extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing As2Station that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/as2_station#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/as2_station files_as2_station} Resource
  *
  * @param scope The scope in which to define this construct
