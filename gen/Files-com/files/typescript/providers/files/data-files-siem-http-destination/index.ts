// https://registry.terraform.io/providers/files-com/files/0.1.397/docs/data-sources/siem_http_destination
...
export interface DataFilesSiemHttpDestinationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/data-sources/siem_http_destination#id DataFilesSiemHttpDestination#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/data-sources/siem_http_destination files_siem_http_destination}
*/
export class DataFilesSiemHttpDestination extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesSiemHttpDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/data-sources/siem_http_destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.397/docs/data-sources/siem_http_destination files_siem_http_destination} Data Source
  *
  * @param scope The scope in which to define this construct
