// https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/sso_strategy
...
export interface DataFilesSsoStrategyConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/sso_strategy#id DataFilesSsoStrategy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/sso_strategy files_sso_strategy}
*/
export class DataFilesSsoStrategy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesSsoStrategy that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/sso_strategy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/sso_strategy files_sso_strategy} Data Source
  *
  * @param scope The scope in which to define this construct
