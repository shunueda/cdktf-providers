// https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/external_event
...
export interface DataFilesExternalEventConfig extends cdktf.TerraformMetaArguments {
  ...
  * Event ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/external_event#id DataFilesExternalEvent#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/external_event files_external_event}
*/
export class DataFilesExternalEvent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesExternalEvent that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/external_event#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/external_event files_external_event} Data Source
  *
  * @param scope The scope in which to define this construct
