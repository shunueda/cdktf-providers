// https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/message_reaction
...
export interface MessageReactionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/message_reaction#emoji MessageReaction#emoji}
  */
  readonly emoji: string;
  /**
  * User ID.  Provide a value of `0` to operate the current session's user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/message_reaction#user_id MessageReaction#user_id}
  */
  readonly userId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/message_reaction files_message_reaction}
*/
export class MessageReaction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MessageReaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/message_reaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/message_reaction files_message_reaction} Resource
  *
  * @param scope The scope in which to define this construct
