// https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/message_comment
...
export interface MessageCommentConfig extends cdktf.TerraformMetaArguments {
  ...
  * Comment body.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/message_comment#body MessageComment#body}
  */
  readonly body: string;
  /**
  * User ID.  Provide a value of `0` to operate the current session's user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/message_comment#user_id MessageComment#user_id}
  */
  readonly userId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/message_comment files_message_comment}
*/
export class MessageComment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MessageComment that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/message_comment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.420/docs/resources/message_comment files_message_comment} Resource
  *
  * @param scope The scope in which to define this construct
