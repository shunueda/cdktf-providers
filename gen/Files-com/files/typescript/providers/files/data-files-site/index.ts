// https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/site
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/site files_site}
*/
export class DataFilesSite extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesSite that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/site#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/data-sources/site files_site} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // email_footer_custom_text - computed: true, optional: false, required: false
