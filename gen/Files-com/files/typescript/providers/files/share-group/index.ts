// https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/share_group
...
export interface ShareGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/share_group#members ShareGroup#members}
  */
  readonly members: { [key: string]: any };
  /**
  * Name of the share group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/share_group#name ShareGroup#name}
  */
  readonly name: string;
  /**
  * Additional notes of the share group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/share_group#notes ShareGroup#notes}
  */
  readonly notes?: string;
  /**
  * Owner User ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/share_group#user_id ShareGroup#user_id}
  */
  readonly userId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/share_group files_share_group}
*/
export class ShareGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ShareGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/share_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.392/docs/resources/share_group files_share_group} Resource
  *
  * @param scope The scope in which to define this construct
