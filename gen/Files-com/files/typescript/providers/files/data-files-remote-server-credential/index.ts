// https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/remote_server_credential
...
export interface DataFilesRemoteServerCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/remote_server_credential#id DataFilesRemoteServerCredential#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/remote_server_credential files_remote_server_credential}
*/
export class DataFilesRemoteServerCredential extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesRemoteServerCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/remote_server_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.419/docs/data-sources/remote_server_credential files_remote_server_credential} Data Source
  *
  * @param scope The scope in which to define this construct
