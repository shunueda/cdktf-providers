// https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/child_site_management_policy
...
export interface DataFilesChildSiteManagementPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  * Policy ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/child_site_management_policy#id DataFilesChildSiteManagementPolicy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/child_site_management_policy files_child_site_management_policy}
*/
export class DataFilesChildSiteManagementPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesChildSiteManagementPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/child_site_management_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/data-sources/child_site_management_policy files_child_site_management_policy} Data Source
  *
  * @param scope The scope in which to define this construct
