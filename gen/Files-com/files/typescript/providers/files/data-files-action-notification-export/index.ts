// https://registry.terraform.io/providers/files-com/files/0.1.417/docs/data-sources/action_notification_export
...
export interface DataFilesActionNotificationExportConfig extends cdktf.TerraformMetaArguments {
  ...
  * History Export ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.417/docs/data-sources/action_notification_export#id DataFilesActionNotificationExport#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.417/docs/data-sources/action_notification_export files_action_notification_export}
*/
export class DataFilesActionNotificationExport extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesActionNotificationExport that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.417/docs/data-sources/action_notification_export#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.417/docs/data-sources/action_notification_export files_action_notification_export} Data Source
  *
  * @param scope The scope in which to define this construct
