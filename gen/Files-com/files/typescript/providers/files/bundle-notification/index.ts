// https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/bundle_notification
...
export interface BundleNotificationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/bundle_notification#bundle_id BundleNotification#bundle_id}
  */
  readonly bundleId: number;
  /**
  * Triggers bundle notification when a registration action occurs for it.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/bundle_notification#notify_on_registration BundleNotification#notify_on_registration}
  */
  readonly notifyOnRegistration?: boolean | cdktf.IResolvable;
  /**
  * Triggers bundle notification when a upload action occurs for it.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/bundle_notification#notify_on_upload BundleNotification#notify_on_upload}
  */
  readonly notifyOnUpload?: boolean | cdktf.IResolvable;
  /**
  * The id of the user to notify.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/bundle_notification#notify_user_id BundleNotification#notify_user_id}
  */
  readonly notifyUserId?: number;
  /**
  * User ID.  Provide a value of `0` to operate the current session's user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/bundle_notification#user_id BundleNotification#user_id}
  */
  readonly userId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/bundle_notification files_bundle_notification}
*/
export class BundleNotification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BundleNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/bundle_notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.412/docs/resources/bundle_notification files_bundle_notification} Resource
  *
  * @param scope The scope in which to define this construct
