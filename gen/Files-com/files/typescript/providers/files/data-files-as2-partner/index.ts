// https://registry.terraform.io/providers/files-com/files/0.1.411/docs/data-sources/as2_partner
...
export interface DataFilesAs2PartnerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/data-sources/as2_partner#id DataFilesAs2Partner#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/data-sources/as2_partner files_as2_partner}
*/
export class DataFilesAs2Partner extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesAs2Partner that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/data-sources/as2_partner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.411/docs/data-sources/as2_partner files_as2_partner} Data Source
  *
  * @param scope The scope in which to define this construct
