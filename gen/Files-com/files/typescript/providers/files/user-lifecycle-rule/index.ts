// https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule
...
export interface UserLifecycleRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule#action UserLifecycleRule#action}
  */
  readonly action?: string;
  /**
  * User authentication method for which the rule will apply.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule#authentication_method UserLifecycleRule#authentication_method}
  */
  readonly authenticationMethod?: string;
  /**
  * Array of Group IDs to which the rule applies. If empty or not set, the rule applies to all users.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule#group_ids UserLifecycleRule#group_ids}
  */
  readonly groupIds?: number[];
  /**
  * Number of days of inactivity before the rule applies
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule#inactivity_days UserLifecycleRule#inactivity_days}
  */
  readonly inactivityDays?: number;
  /**
  * If true, the rule will apply to folder admins.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule#include_folder_admins UserLifecycleRule#include_folder_admins}
  */
  readonly includeFolderAdmins?: boolean | cdktf.IResolvable;
  /**
  * If true, the rule will apply to site admins.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule#include_site_admins UserLifecycleRule#include_site_admins}
  */
  readonly includeSiteAdmins?: boolean | cdktf.IResolvable;
  /**
  * User Lifecycle Rule name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule#name UserLifecycleRule#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule#partner_tag UserLifecycleRule#partner_tag}
  */
  readonly partnerTag?: string;
  /**
  * State of the users to apply the rule to (inactive or disabled)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule#user_state UserLifecycleRule#user_state}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule#user_tag UserLifecycleRule#user_tag}
  */
  readonly userTag?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule files_user_lifecycle_rule}
*/
export class UserLifecycleRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserLifecycleRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.394/docs/resources/user_lifecycle_rule files_user_lifecycle_rule} Resource
  *
  * @param scope The scope in which to define this construct
