// https://registry.terraform.io/providers/files-com/files/0.1.388/docs/resources/lock
...
export interface LockConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/resources/lock#allow_access_by_any_user Lock#allow_access_by_any_user}
  */
  readonly allowAccessByAnyUser?: boolean | cdktf.IResolvable;
  /**
  * Is lock exclusive?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/resources/lock#exclusive Lock#exclusive}
  */
  readonly exclusive?: boolean | cdktf.IResolvable;
  /**
  * Path. This must be slash-delimited, but it must neither start nor end with a slash. Maximum of 5000 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/resources/lock#path Lock#path}
  */
  readonly path: string;
  /**
  * Does lock apply to subfolders?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/resources/lock#recursive Lock#recursive}
  */
  readonly recursive?: boolean | cdktf.IResolvable;
  /**
  * Lock timeout in seconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/resources/lock#timeout Lock#timeout}
  */
  readonly timeout?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/resources/lock files_lock}
*/
export class Lock extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lock that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/resources/lock#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.388/docs/resources/lock files_lock} Resource
  *
  * @param scope The scope in which to define this construct
