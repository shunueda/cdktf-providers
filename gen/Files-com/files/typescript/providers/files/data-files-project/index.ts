// https://registry.terraform.io/providers/files-com/files/0.1.409/docs/data-sources/project
...
export interface DataFilesProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  * Project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.409/docs/data-sources/project#id DataFilesProject#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.409/docs/data-sources/project files_project}
*/
export class DataFilesProject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.409/docs/data-sources/project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.409/docs/data-sources/project files_project} Data Source
  *
  * @param scope The scope in which to define this construct
