// https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend
...
export interface RemoteMountBackendConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#canary_file_path RemoteMountBackend#canary_file_path}
  */
  readonly canaryFilePath: string;
  /**
  * True if this backend is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#enabled RemoteMountBackend#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Number of consecutive failures before considering the backend unhealthy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#fall RemoteMountBackend#fall}
  */
  readonly fall?: number;
  /**
  * True if health checks are enabled for this backend.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#health_check_enabled RemoteMountBackend#health_check_enabled}
  */
  readonly healthCheckEnabled?: boolean | cdktf.IResolvable;
  /**
  * Type of health check to perform.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#health_check_type RemoteMountBackend#health_check_type}
  */
  readonly healthCheckType?: string;
  /**
  * Interval in seconds between health checks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#interval RemoteMountBackend#interval}
  */
  readonly interval?: number;
  /**
  * Minimum free CPU percentage required for this backend to be considered healthy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#min_free_cpu RemoteMountBackend#min_free_cpu}
  */
  readonly minFreeCpu?: string;
  /**
  * Minimum free memory percentage required for this backend to be considered healthy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#min_free_mem RemoteMountBackend#min_free_mem}
  */
  readonly minFreeMem?: string;
  /**
  * Priority of this backend.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#priority RemoteMountBackend#priority}
  */
  readonly priority?: number;
  /**
  * Path on the remote server to treat as the root of this mount.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#remote_path RemoteMountBackend#remote_path}
  */
  readonly remotePath?: string;
  /**
  * The remote server that this backend is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#remote_server_id RemoteMountBackend#remote_server_id}
  */
  readonly remoteServerId: number;
  /**
  * The mount ID of the Remote Server Mount that this backend is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#remote_server_mount_id RemoteMountBackend#remote_server_mount_id}
  */
  readonly remoteServerMountId: number;
  /**
  * Number of consecutive successes before considering the backend healthy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#rise RemoteMountBackend#rise}
  */
  readonly rise?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend files_remote_mount_backend}
*/
export class RemoteMountBackend extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RemoteMountBackend that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.403/docs/resources/remote_mount_backend files_remote_mount_backend} Resource
  *
  * @param scope The scope in which to define this construct
