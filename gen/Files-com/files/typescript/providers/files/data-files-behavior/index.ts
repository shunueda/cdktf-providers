// https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/behavior
...
export interface DataFilesBehaviorConfig extends cdktf.TerraformMetaArguments {
  ...
  * Folder behavior ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/behavior#id DataFilesBehavior#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/behavior files_behavior}
*/
export class DataFilesBehavior extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesBehavior that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/behavior#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.401/docs/data-sources/behavior files_behavior} Data Source
  *
  * @param scope The scope in which to define this construct
