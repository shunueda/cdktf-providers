// https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/folder
...
export interface FolderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/folder#custom_metadata Folder#custom_metadata}
  */
  readonly customMetadata?: { [key: string]: any };
  /**
  * Create parent directories if they do not exist?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/folder#mkdir_parents Folder#mkdir_parents}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/folder#path Folder#path}
  */
  readonly path: string;
  /**
  * Bookmark/priority color of file/folder
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/folder#priority_color Folder#priority_color}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/folder#provided_mtime Folder#provided_mtime}
  */
  readonly providedMtime?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/folder files_folder}
*/
export class Folder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Folder that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/folder#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.395/docs/resources/folder files_folder} Resource
  *
  * @param scope The scope in which to define this construct
