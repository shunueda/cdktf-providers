// https://registry.terraform.io/providers/vmware-tanzu/carvel/0.11.0/docs/data-sources/ytt
...
export interface DataCarvelYttConfig extends cdktf.TerraformMetaArguments {
  /**
  * Configuration YAML
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware-tanzu/carvel/0.11.0/docs/data-sources/ytt#config_yaml DataCarvelYtt#config_yaml}
  */
  readonly configYaml?: string;
  /**
  * Enable debug logging
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware-tanzu/carvel/0.11.0/docs/data-sources/ytt#debug_logs DataCarvelYtt#debug_logs}
  */
  readonly debugLogs?: boolean | cdktf.IResolvable;
  /**
  * Files
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware-tanzu/carvel/0.11.0/docs/data-sources/ytt#files DataCarvelYtt#files}
  */
  readonly files?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware-tanzu/carvel/0.11.0/docs/data-sources/ytt#id DataCarvelYtt#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware-tanzu/carvel/0.11.0/docs/data-sources/ytt#ignore_unknown_comments DataCarvelYtt#ignore_unknown_comments}
  */
  readonly ignoreUnknownComments?: boolean | cdktf.IResolvable;
  /**
  * Data values as strings
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware-tanzu/carvel/0.11.0/docs/data-sources/ytt#values DataCarvelYtt#values}
  */
  readonly values?: { [key: string]: string };
  /**
  * Data values as YAML
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware-tanzu/carvel/0.11.0/docs/data-sources/ytt#values_yaml DataCarvelYtt#values_yaml}
  */
  readonly valuesYaml?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/vmware-tanzu/carvel/0.11.0/docs/data-sources/ytt carvel_ytt}
*/
export class DataCarvelYtt extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataCarvelYtt resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataCarvelYtt to import
  * @param importFromId The id of the existing DataCarvelYtt that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware-tanzu/carvel/0.11.0/docs/data-sources/ytt#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataCarvelYtt to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware-tanzu/carvel/0.11.0/docs/data-sources/ytt carvel_ytt} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataCarvelYttConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataCarvelYttConfig = {}) {
    super(scope, id, {
