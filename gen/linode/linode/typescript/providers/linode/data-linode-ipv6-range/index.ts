// https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/ipv6_range
...
export interface DataLinodeIpv6RangeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/ipv6_range#range DataLinodeIpv6Range#range}
  */
  readonly range: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/ipv6_range linode_ipv6_range}
*/
export class DataLinodeIpv6Range extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeIpv6Range that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/ipv6_range#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/ipv6_range linode_ipv6_range} Data Source
  *
  * @param scope The scope in which to define this construct
