...
export function dataLinodeObjectStorageQuotasQuotasToTerraform(struct?: DataLinodeObjectStorageQuotasQuotas | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataLinodeObjectStorageQuotasQuotasToHclTerraform(struct?: DataLinodeObjectStorageQuotasQuotas | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataLinodeObjectStorageQuotasQuotasOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataLinodeObjectStorageQuotasQuotas | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataLinodeObjectStorageQuotasQuotas | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataLinodeObjectStorageQuotas extends cdktf.TerraformDataSource {
  ...
  */
  ...
  public putQuotas(value: DataLinodeObjectStorageQuotasQuotas[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      quotas: cdktf.listMapper(dataLinodeObjectStorageQuotasQuotasToTerraform, true)(this._quotas.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      quotas: {
        value: cdktf.listMapperHcl(dataLinodeObjectStorageQuotasQuotasToHclTerraform, true)(this._quotas.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataLinodeObjectStorageQuotasQuotasList",
      },
    };
