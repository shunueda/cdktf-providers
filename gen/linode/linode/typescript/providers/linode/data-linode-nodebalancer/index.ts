// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/nodebalancer
...
export interface DataLinodeNodebalancerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/nodebalancer#id DataLinodeNodebalancer#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/nodebalancer linode_nodebalancer}
*/
export class DataLinodeNodebalancer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeNodebalancer that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/nodebalancer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/nodebalancer linode_nodebalancer} Data Source
  *
  * @param scope The scope in which to define this construct
