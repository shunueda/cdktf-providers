// https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql
...
export interface DatabasePostgresqlConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#allow_list DatabasePostgresql#allow_list}
  */
  readonly allowList?: string[];
  /**
  * The number of Linode Instance nodes deployed to the Managed Database. Defaults to 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#cluster_size DatabasePostgresql#cluster_size}
  */
  readonly clusterSize?: number;
  /**
  * Whether the Managed Databases is encrypted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#encrypted DatabasePostgresql#encrypted}
  */
  readonly encrypted?: boolean | cdktf.IResolvable;
  /**
  * The Managed Database engine in engine/version format. (e.g. mysql/8.0.30)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#engine_id DatabasePostgresql#engine_id}
  */
  readonly engineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#id DatabasePostgresql#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#label DatabasePostgresql#label}
  */
  readonly label: string;
  /**
  * The region to use for the Managed Database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#region DatabasePostgresql#region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#replication_commit_type DatabasePostgresql#replication_commit_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#replication_type DatabasePostgresql#replication_type}
  */
  readonly replicationType?: string;
  /**
  * Whether to require SSL credentials to establish a connection to the Managed Database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#ssl_connection DatabasePostgresql#ssl_connection}
  */
  readonly sslConnection?: boolean | cdktf.IResolvable;
  /**
  * The Linode Instance type used by the Managed Database for its nodes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#type DatabasePostgresql#type}
  */
  readonly type: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#timeouts DatabasePostgresql#timeouts}
  */
  readonly timeouts?: DatabasePostgresqlTimeouts;
  /**
  * updates block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#updates DatabasePostgresql#updates}
  */
  readonly updates?: DatabasePostgresqlUpdates;
}
export interface DatabasePostgresqlTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#create DatabasePostgresql#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#delete DatabasePostgresql#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#update DatabasePostgresql#update}
  */
...
export interface DatabasePostgresqlUpdates {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#day_of_week DatabasePostgresql#day_of_week}
  */
  readonly dayOfWeek: string;
  /**
  * The maximum maintenance window time in hours.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#duration DatabasePostgresql#duration}
  */
  readonly duration: number;
  /**
  * Whether maintenance occurs on a weekly or monthly basis.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#frequency DatabasePostgresql#frequency}
  */
  readonly frequency: string;
  /**
  * The hour to begin maintenance based in UTC time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#hour_of_day DatabasePostgresql#hour_of_day}
  */
  readonly hourOfDay: number;
  /**
  * The week of the month to perform monthly frequency updates. Required for monthly frequency updates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#week_of_month DatabasePostgresql#week_of_month}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql linode_database_postgresql}
*/
export class DatabasePostgresql extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabasePostgresql that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/database_postgresql linode_database_postgresql} Resource
  *
  * @param scope The scope in which to define this construct
