// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_device
...
export interface FirewallDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_device#entity_id FirewallDevice#entity_id}
  */
  readonly entityId: number;
  /**
  * The type of the entity to create a Firewall device for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_device#entity_type FirewallDevice#entity_type}
  */
  readonly entityType?: string;
  /**
  * The ID of the Firewall to access.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_device#firewall_id FirewallDevice#firewall_id}
  */
  readonly firewallId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_device linode_firewall_device}
*/
export class FirewallDevice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirewallDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_device linode_firewall_device} Resource
  *
  * @param scope The scope in which to define this construct
