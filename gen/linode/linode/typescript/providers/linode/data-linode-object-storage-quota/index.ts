// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/object_storage_quota
...
export interface DataLinodeObjectStorageQuotaConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/object_storage_quota#quota_id DataLinodeObjectStorageQuota#quota_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/object_storage_quota linode_object_storage_quota}
*/
export class DataLinodeObjectStorageQuota extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeObjectStorageQuota that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/object_storage_quota#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/object_storage_quota linode_object_storage_quota} Data Source
  *
  * @param scope The scope in which to define this construct
