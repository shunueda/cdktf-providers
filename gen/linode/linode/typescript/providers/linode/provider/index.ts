// https://registry.terraform.io/providers/linode/linode/3.7.0/docs
...
export interface LinodeProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#api_ca_path LinodeProvider#api_ca_path}
  */
  readonly apiCaPath?: string;
  /**
  * The version of Linode API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#api_version LinodeProvider#api_version}
  */
  readonly apiVersion?: string;
  /**
  * The path to the Linode config file to use. (default `~/.config/linode`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#config_path LinodeProvider#config_path}
  */
  readonly configPath?: string;
  /**
  * The Linode config profile to use. (default `default`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#config_profile LinodeProvider#config_profile}
  */
  readonly configProfile?: string;
  /**
  * Disable the internal caching system that backs certain Linode API requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#disable_internal_cache LinodeProvider#disable_internal_cache}
  */
  readonly disableInternalCache?: boolean | cdktf.IResolvable;
  /**
  * The rate in milliseconds to poll for events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#event_poll_ms LinodeProvider#event_poll_ms}
  */
  readonly eventPollMs?: number;
  /**
  * The rate in milliseconds to poll for LKE events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#lke_event_poll_ms LinodeProvider#lke_event_poll_ms}
  */
  readonly lkeEventPollMs?: number;
  /**
  * The rate in milliseconds to poll for an LKE node to be ready.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#lke_node_ready_poll_ms LinodeProvider#lke_node_ready_poll_ms}
  */
  readonly lkeNodeReadyPollMs?: number;
  /**
  * Maximum delay in milliseconds before retrying a request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#max_retry_delay_ms LinodeProvider#max_retry_delay_ms}
  */
  readonly maxRetryDelayMs?: number;
  /**
  * Minimum delay in milliseconds before retrying a request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#min_retry_delay_ms LinodeProvider#min_retry_delay_ms}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#obj_access_key LinodeProvider#obj_access_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#obj_bucket_force_delete LinodeProvider#obj_bucket_force_delete}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#obj_secret_key LinodeProvider#obj_secret_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#obj_use_temp_keys LinodeProvider#obj_use_temp_keys}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#skip_implicit_reboots LinodeProvider#skip_implicit_reboots}
  */
  readonly skipImplicitReboots?: boolean | cdktf.IResolvable;
  /**
  * Skip waiting for a linode_instance resource to finish deleting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#skip_instance_delete_poll LinodeProvider#skip_instance_delete_poll}
  */
  readonly skipInstanceDeletePoll?: boolean | cdktf.IResolvable;
  /**
  * Skip waiting for a linode_instance resource to be running.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#skip_instance_ready_poll LinodeProvider#skip_instance_ready_poll}
  */
  readonly skipInstanceReadyPoll?: boolean | cdktf.IResolvable;
  /**
  * The token that allows you access to your Linode account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#token LinodeProvider#token}
  */
  readonly token?: string;
  /**
  * An HTTP User-Agent Prefix to prepend in API requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#ua_prefix LinodeProvider#ua_prefix}
  */
  readonly uaPrefix?: string;
  /**
  * The HTTP(S) API address of the Linode API to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#url LinodeProvider#url}
  */
  readonly url?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#alias LinodeProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs linode}
*/
export class LinodeProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing LinodeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs linode} Resource
  *
  * @param scope The scope in which to define this construct
