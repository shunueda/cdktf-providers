// https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_access_controls
...
export interface DatabaseAccessControlsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_access_controls#allow_list DatabaseAccessControls#allow_list}
  */
  readonly allowList: string[];
  /**
  * The ID of the database to manage the allow list for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_access_controls#database_id DatabaseAccessControls#database_id}
  */
  readonly databaseId: number;
  /**
  * The type of the  database to manage the allow list for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_access_controls#database_type DatabaseAccessControls#database_type}
  */
  readonly databaseType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_access_controls#id DatabaseAccessControls#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_access_controls linode_database_access_controls}
*/
export class DatabaseAccessControls extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseAccessControls that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_access_controls#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_access_controls linode_database_access_controls} Resource
  *
  * @param scope The scope in which to define this construct
