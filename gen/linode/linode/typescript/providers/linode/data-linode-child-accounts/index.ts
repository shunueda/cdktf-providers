// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/child_accounts
...
export interface DataLinodeChildAccountsConfig extends cdktf.TerraformMetaArguments {
  ...
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/child_accounts#filter DataLinodeChildAccounts#filter}
  */
...
export interface DataLinodeChildAccountsFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/child_accounts#match_by DataLinodeChildAccounts#match_by}
  */
  readonly matchBy?: string;
  /**
  * The name of the attribute to filter on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/child_accounts#name DataLinodeChildAccounts#name}
  */
  readonly name: string;
  /**
  * The value(s) to be used in the filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/child_accounts#values DataLinodeChildAccounts#values}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/child_accounts linode_child_accounts}
*/
export class DataLinodeChildAccounts extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeChildAccounts that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/child_accounts#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/child_accounts linode_child_accounts} Data Source
  *
  * @param scope The scope in which to define this construct
