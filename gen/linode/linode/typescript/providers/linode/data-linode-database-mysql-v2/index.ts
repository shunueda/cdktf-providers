// https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/database_mysql_v2
...
export interface DataLinodeDatabaseMysqlV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/database_mysql_v2#id DataLinodeDatabaseMysqlV2#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/database_mysql_v2 linode_database_mysql_v2}
*/
export class DataLinodeDatabaseMysqlV2 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeDatabaseMysqlV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/database_mysql_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/database_mysql_v2 linode_database_mysql_v2} Data Source
  *
  * @param scope The scope in which to define this construct
