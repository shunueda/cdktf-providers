// https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/networking_ip
...
export interface NetworkingIpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/networking_ip#linode_id NetworkingIp#linode_id}
  */
  readonly linodeId?: number;
  /**
  * Whether the IPv4 address is public or private.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/networking_ip#public NetworkingIp#public}
  */
  readonly public?: boolean | cdktf.IResolvable;
  /**
  * The region for the reserved IPv4 address. Required when reserved is true and linode_id is not set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/networking_ip#region NetworkingIp#region}
  */
  readonly region?: string;
  /**
  * Whether the IPv4 address should be reserved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/networking_ip#reserved NetworkingIp#reserved}
  */
  readonly reserved?: boolean | cdktf.IResolvable;
  /**
  * The type of IP address (ipv4).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/networking_ip#type NetworkingIp#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/networking_ip linode_networking_ip}
*/
export class NetworkingIp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkingIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/networking_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/networking_ip linode_networking_ip} Resource
  *
  * @param scope The scope in which to define this construct
