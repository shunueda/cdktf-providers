// https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql
...
export interface DatabaseMysqlConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#allow_list DatabaseMysql#allow_list}
  */
  readonly allowList?: string[];
  /**
  * The number of Linode Instance nodes deployed to the Managed Database. Defaults to 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#cluster_size DatabaseMysql#cluster_size}
  */
  readonly clusterSize?: number;
  /**
  * Whether the Managed Databases is encrypted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#encrypted DatabaseMysql#encrypted}
  */
  readonly encrypted?: boolean | cdktf.IResolvable;
  /**
  * The Managed Database engine in engine/version format. (e.g. mysql/8.0.30)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#engine_id DatabaseMysql#engine_id}
  */
  readonly engineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#id DatabaseMysql#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#label DatabaseMysql#label}
  */
  readonly label: string;
  /**
  * The region to use for the Managed Database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#region DatabaseMysql#region}
  */
  readonly region: string;
  /**
  * The replication method used for the Managed Database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#replication_type DatabaseMysql#replication_type}
  */
  readonly replicationType?: string;
  /**
  * Whether to require SSL credentials to establish a connection to the Managed Database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#ssl_connection DatabaseMysql#ssl_connection}
  */
  readonly sslConnection?: boolean | cdktf.IResolvable;
  /**
  * The Linode Instance type used by the Managed Database for its nodes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#type DatabaseMysql#type}
  */
  readonly type: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#timeouts DatabaseMysql#timeouts}
  */
  readonly timeouts?: DatabaseMysqlTimeouts;
  /**
  * updates block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#updates DatabaseMysql#updates}
  */
  readonly updates?: DatabaseMysqlUpdates;
}
export interface DatabaseMysqlTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#create DatabaseMysql#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#delete DatabaseMysql#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#update DatabaseMysql#update}
  */
...
export interface DatabaseMysqlUpdates {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#day_of_week DatabaseMysql#day_of_week}
  */
  readonly dayOfWeek: string;
  /**
  * The maximum maintenance window time in hours.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#duration DatabaseMysql#duration}
  */
  readonly duration: number;
  /**
  * Whether maintenance occurs on a weekly or monthly basis.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#frequency DatabaseMysql#frequency}
  */
  readonly frequency: string;
  /**
  * The hour to begin maintenance based in UTC time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#hour_of_day DatabaseMysql#hour_of_day}
  */
  readonly hourOfDay: number;
  /**
  * The week of the month to perform monthly frequency updates. Required for monthly frequency updates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#week_of_month DatabaseMysql#week_of_month}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql linode_database_mysql}
*/
export class DatabaseMysql extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseMysql that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/database_mysql linode_database_mysql} Resource
  *
  * @param scope The scope in which to define this construct
