// https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/vpc
...
export interface VpcConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/vpc#description Vpc#description}
  */
  readonly description?: string;
  /**
  * The IPv6 configuration of this VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/vpc#ipv6 Vpc#ipv6}
  */
  readonly ipv6?: VpcIpv6[] | cdktf.IResolvable;
  /**
  * The label of the VPC. Only contains ascii letters, digits and dashes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/vpc#label Vpc#label}
  */
  readonly label: string;
  /**
  * The region of the VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/vpc#region Vpc#region}
  */
...
export interface VpcIpv6 {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/vpc#allocation_class Vpc#allocation_class}
  */
  readonly allocationClass?: string;
  /**
  * The IPv6 range assigned to this VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/vpc#range Vpc#range}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/vpc linode_vpc}
*/
export class Vpc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Vpc that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/vpc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/vpc linode_vpc} Resource
  *
  * @param scope The scope in which to define this construct
