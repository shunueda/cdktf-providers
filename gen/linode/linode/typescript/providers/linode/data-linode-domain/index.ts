// https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/domain
...
export interface DataLinodeDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/domain#domain DataLinodeDomain#domain}
  */
  readonly domain?: string;
  /**
  * The Domain's unique ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/domain#id DataLinodeDomain#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/domain linode_domain}
*/
export class DataLinodeDomain extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/domain linode_domain} Data Source
  *
  * @param scope The scope in which to define this construct
