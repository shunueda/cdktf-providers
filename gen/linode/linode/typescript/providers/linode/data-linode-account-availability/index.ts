// https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/account_availability
...
export interface DataLinodeAccountAvailabilityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/account_availability#region DataLinodeAccountAvailability#region}
  */
  readonly region: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/account_availability linode_account_availability}
*/
export class DataLinodeAccountAvailability extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeAccountAvailability that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/account_availability#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/account_availability linode_account_availability} Data Source
  *
  * @param scope The scope in which to define this construct
