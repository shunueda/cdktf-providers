// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/producer_image_share_group
...
export interface DataLinodeProducerImageShareGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/producer_image_share_group#id DataLinodeProducerImageShareGroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/producer_image_share_group linode_producer_image_share_group}
*/
export class DataLinodeProducerImageShareGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeProducerImageShareGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/producer_image_share_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/producer_image_share_group linode_producer_image_share_group} Data Source
  *
  * @param scope The scope in which to define this construct
