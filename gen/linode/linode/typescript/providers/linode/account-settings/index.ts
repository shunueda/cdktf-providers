// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/account_settings
...
export interface AccountSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/account_settings#backups_enabled AccountSettings#backups_enabled}
  */
  readonly backupsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Type of interfaces for new Linode instances.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/account_settings#interfaces_for_new_linodes AccountSettings#interfaces_for_new_linodes}
  */
  readonly interfacesForNewLinodes?: string;
  /**
  * The Longview Pro tier you are currently subscribed to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/account_settings#longview_subscription AccountSettings#longview_subscription}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/account_settings#maintenance_policy AccountSettings#maintenance_policy}
  */
  readonly maintenancePolicy?: string;
  /**
  * Enables network helper across all users by default for new Linodes and Linode Configs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/account_settings#network_helper AccountSettings#network_helper}
  */
  readonly networkHelper?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/account_settings linode_account_settings}
*/
export class AccountSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/account_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/account_settings linode_account_settings} Resource
  *
  * @param scope The scope in which to define this construct
