// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/account_settings
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/account_settings linode_account_settings}
*/
export class DataLinodeAccountSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeAccountSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/account_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/account_settings linode_account_settings} Data Source
  *
  * @param scope The scope in which to define this construct
