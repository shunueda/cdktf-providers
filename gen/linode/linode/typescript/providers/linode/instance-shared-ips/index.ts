// https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/instance_shared_ips
...
export interface InstanceSharedIpsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/instance_shared_ips#addresses InstanceSharedIps#addresses}
  */
  readonly addresses: string[];
  /**
  * The ID of the Linode to share these IP addresses with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/instance_shared_ips#linode_id InstanceSharedIps#linode_id}
  */
  readonly linodeId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/instance_shared_ips linode_instance_shared_ips}
*/
export class InstanceSharedIps extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InstanceSharedIps that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/instance_shared_ips#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/instance_shared_ips linode_instance_shared_ips} Resource
  *
  * @param scope The scope in which to define this construct
