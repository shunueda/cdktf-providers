// https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/database_mysql
...
export interface DataLinodeDatabaseMysqlConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/database_mysql#database_id DataLinodeDatabaseMysql#database_id}
  */
  readonly databaseId?: number;
  /**
  * Unique identifier for this DataSource. The ID of the MySQL database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/database_mysql#id DataLinodeDatabaseMysql#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/database_mysql linode_database_mysql}
*/
export class DataLinodeDatabaseMysql extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeDatabaseMysql that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/database_mysql#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/database_mysql linode_database_mysql} Data Source
  *
  * @param scope The scope in which to define this construct
