// https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/volume
...
export interface DataLinodeVolumeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/volume#id DataLinodeVolume#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/volume linode_volume}
*/
export class DataLinodeVolume extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/volume#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/volume linode_volume} Data Source
  *
  * @param scope The scope in which to define this construct
