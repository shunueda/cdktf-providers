// https://registry.terraform.io/providers/linode/linode/3.5.1/docs/data-sources/nodebalancer_vpc
...
export interface DataLinodeNodebalancerVpcConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/data-sources/nodebalancer_vpc#id DataLinodeNodebalancerVpc#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/data-sources/nodebalancer_vpc#nodebalancer_id DataLinodeNodebalancerVpc#nodebalancer_id}
  */
  readonly nodebalancerId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/data-sources/nodebalancer_vpc linode_nodebalancer_vpc}
*/
export class DataLinodeNodebalancerVpc extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeNodebalancerVpc that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/data-sources/nodebalancer_vpc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/data-sources/nodebalancer_vpc linode_nodebalancer_vpc} Data Source
  *
  * @param scope The scope in which to define this construct
