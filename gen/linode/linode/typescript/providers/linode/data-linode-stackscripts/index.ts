// https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/stackscripts
...
export interface DataLinodeStackscriptsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/stackscripts#latest DataLinodeStackscripts#latest}
  */
  readonly latest?: boolean | cdktf.IResolvable;
  /**
  * The order in which results should be returned.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/stackscripts#order DataLinodeStackscripts#order}
  */
  readonly order?: string;
  /**
  * The attribute to order the results by.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/stackscripts#order_by DataLinodeStackscripts#order_by}
  */
  readonly orderBy?: string;
  /**
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/stackscripts#filter DataLinodeStackscripts#filter}
  */
...
export interface DataLinodeStackscriptsStackscripts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/stackscripts#id DataLinodeStackscripts#id}
  *
...
export function dataLinodeStackscriptsStackscriptsToTerraform(struct?: DataLinodeStackscriptsStackscripts): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataLinodeStackscriptsStackscriptsToHclTerraform(struct?: DataLinodeStackscriptsStackscripts): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataLinodeStackscriptsStackscriptsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataLinodeStackscriptsStackscripts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataLinodeStackscriptsStackscripts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._id = undefined;
    }
...
export interface DataLinodeStackscriptsFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/stackscripts#match_by DataLinodeStackscripts#match_by}
  */
  readonly matchBy?: string;
  /**
  * The name of the attribute to filter on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/stackscripts#name DataLinodeStackscripts#name}
  */
  readonly name: string;
  /**
  * The value(s) to be used in the filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/stackscripts#values DataLinodeStackscripts#values}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/stackscripts linode_stackscripts}
*/
export class DataLinodeStackscripts extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeStackscripts that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/stackscripts#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/stackscripts linode_stackscripts} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // stackscripts - computed: true, optional: false, required: false
