// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/nodebalancer_node
...
export interface DataLinodeNodebalancerNodeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/nodebalancer_node#config_id DataLinodeNodebalancerNode#config_id}
  */
  readonly configId: number;
  /**
  * The ID of the NodeBalancer node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/nodebalancer_node#id DataLinodeNodebalancerNode#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/nodebalancer_node#nodebalancer_id DataLinodeNodebalancerNode#nodebalancer_id}
  */
  readonly nodebalancerId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/nodebalancer_node linode_nodebalancer_node}
*/
export class DataLinodeNodebalancerNode extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeNodebalancerNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/nodebalancer_node#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/nodebalancer_node linode_nodebalancer_node} Data Source
  *
  * @param scope The scope in which to define this construct
