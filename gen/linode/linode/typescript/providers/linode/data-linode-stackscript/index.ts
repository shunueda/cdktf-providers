// https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/stackscript
...
export interface DataLinodeStackscriptConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/stackscript#id DataLinodeStackscript#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/stackscript linode_stackscript}
*/
export class DataLinodeStackscript extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeStackscript that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/stackscript#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/stackscript linode_stackscript} Data Source
  *
  * @param scope The scope in which to define this construct
