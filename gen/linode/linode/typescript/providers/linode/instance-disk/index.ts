// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk
...
export interface InstanceDiskAConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#authorized_keys InstanceDiskA#authorized_keys}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#authorized_users InstanceDiskA#authorized_users}
  */
  readonly authorizedUsers?: string[];
  /**
  * The filesystem of this disk.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#filesystem InstanceDiskA#filesystem}
  */
  readonly filesystem?: string;
  /**
  * An Image ID to deploy the Linode Disk from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#image InstanceDiskA#image}
  */
  readonly image?: string;
  /**
  * The Disk;s label is for display purposes only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#label InstanceDiskA#label}
  */
  readonly label: string;
  /**
  * The ID of the Linode to assign this disk to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#linode_id InstanceDiskA#linode_id}
  */
  readonly linodeId: number;
  /**
  * This sets the root user's password on a newly-created Linode Disk when deploying from an Image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#root_pass InstanceDiskA#root_pass}
  */
  readonly rootPass?: string;
  /**
  * The ID of the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#size InstanceDiskA#size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#stackscript_data InstanceDiskA#stackscript_data}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#stackscript_id InstanceDiskA#stackscript_id}
  */
  readonly stackscriptId?: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#timeouts InstanceDiskA#timeouts}
  */
...
export interface InstanceDiskTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#create InstanceDiskA#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#delete InstanceDiskA#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#update InstanceDiskA#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk linode_instance_disk}
*/
export class InstanceDiskA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InstanceDiskA that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/instance_disk linode_instance_disk} Resource
  *
  * @param scope The scope in which to define this construct
