// https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/placement_group_assignment
...
export interface PlacementGroupAssignmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/placement_group_assignment#compliant_only PlacementGroupAssignment#compliant_only}
  */
  readonly compliantOnly?: boolean | cdktf.IResolvable;
  /**
  * A set of Linode IDs to assign to the Placement Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/placement_group_assignment#linode_id PlacementGroupAssignment#linode_id}
  */
  readonly linodeId: number;
  /**
  * The ID of the Placement Group for this assignment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/placement_group_assignment#placement_group_id PlacementGroupAssignment#placement_group_id}
  */
  readonly placementGroupId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/placement_group_assignment linode_placement_group_assignment}
*/
export class PlacementGroupAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlacementGroupAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/placement_group_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/resources/placement_group_assignment linode_placement_group_assignment} Resource
  *
  * @param scope The scope in which to define this construct
