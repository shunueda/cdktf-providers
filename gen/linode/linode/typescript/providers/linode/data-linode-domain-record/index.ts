// https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/domain_record
...
export interface DataLinodeDomainRecordConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/domain_record#domain_id DataLinodeDomainRecord#domain_id}
  */
  readonly domainId: number;
  /**
  * The unique ID assigned to this domain record.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/domain_record#id DataLinodeDomainRecord#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/domain_record#name DataLinodeDomainRecord#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/domain_record linode_domain_record}
*/
export class DataLinodeDomainRecord extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeDomainRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/domain_record#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/domain_record linode_domain_record} Data Source
  *
  * @param scope The scope in which to define this construct
