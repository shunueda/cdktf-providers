// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/account_login
...
export interface DataLinodeAccountLoginConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/account_login#id DataLinodeAccountLogin#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/account_login linode_account_login}
*/
export class DataLinodeAccountLogin extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeAccountLogin that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/account_login#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/account_login linode_account_login} Data Source
  *
  * @param scope The scope in which to define this construct
