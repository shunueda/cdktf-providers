// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/account
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/account linode_account}
*/
export class DataLinodeAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/account linode_account} Data Source
  *
  * @param scope The scope in which to define this construct
