// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_settings
...
export interface FirewallSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_settings#default_firewall_ids FirewallSettings#default_firewall_ids}
  */
...
export interface FirewallSettingsDefaultFirewallIds {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_settings#linode FirewallSettings#linode}
  */
  readonly linode?: number;
  /**
  * The NodeBalancer's default firewall.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_settings#nodebalancer FirewallSettings#nodebalancer}
  */
  readonly nodebalancer?: number;
  /**
  * The public interface's default firewall.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_settings#public_interface FirewallSettings#public_interface}
  */
  readonly publicInterface?: number;
  /**
  * The VPC interface's default firewall.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_settings#vpc_interface FirewallSettings#vpc_interface}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_settings linode_firewall_settings}
*/
export class FirewallSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirewallSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/resources/firewall_settings linode_firewall_settings} Resource
  *
  * @param scope The scope in which to define this construct
