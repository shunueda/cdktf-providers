// https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/object_storage_bucket
...
export interface DataLinodeObjectStorageBucketConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/object_storage_bucket#cluster DataLinodeObjectStorageBucket#cluster}
  */
  readonly cluster?: string;
  /**
  * The name of this bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/object_storage_bucket#label DataLinodeObjectStorageBucket#label}
  */
  readonly label: string;
  /**
  * The ID of the region this bucket is in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/object_storage_bucket#region DataLinodeObjectStorageBucket#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/object_storage_bucket linode_object_storage_bucket}
*/
export class DataLinodeObjectStorageBucket extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeObjectStorageBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/object_storage_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/object_storage_bucket linode_object_storage_bucket} Data Source
  *
  * @param scope The scope in which to define this construct
