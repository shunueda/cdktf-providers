// https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/instance_backups
...
export interface DataLinodeInstanceBackupsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/instance_backups#linode_id DataLinodeInstanceBackups#linode_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/instance_backups linode_instance_backups}
*/
export class DataLinodeInstanceBackups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeInstanceBackups that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/instance_backups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/data-sources/instance_backups linode_instance_backups} Data Source
  *
  * @param scope The scope in which to define this construct
