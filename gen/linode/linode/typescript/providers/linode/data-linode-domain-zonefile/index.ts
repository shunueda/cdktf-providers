// https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/domain_zonefile
...
export interface DataLinodeDomainZonefileConfig extends cdktf.TerraformMetaArguments {
  ...
  * The domain's ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/domain_zonefile#domain_id DataLinodeDomainZonefile#domain_id}
  */
  readonly domainId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/domain_zonefile linode_domain_zonefile}
*/
export class DataLinodeDomainZonefile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeDomainZonefile that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/domain_zonefile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/domain_zonefile linode_domain_zonefile} Data Source
  *
  * @param scope The scope in which to define this construct
