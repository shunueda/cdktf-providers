// https://registry.terraform.io/providers/linode/linode/3.5.1/docs/data-sources/nodebalancer_config
...
export interface DataLinodeNodebalancerConfigAConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/data-sources/nodebalancer_config#id DataLinodeNodebalancerConfigA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/data-sources/nodebalancer_config#nodebalancer_id DataLinodeNodebalancerConfigA#nodebalancer_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/data-sources/nodebalancer_config linode_nodebalancer_config}
*/
export class DataLinodeNodebalancerConfigA extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeNodebalancerConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/data-sources/nodebalancer_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/data-sources/nodebalancer_config linode_nodebalancer_config} Data Source
  *
  * @param scope The scope in which to define this construct
