// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/networking_ip
...
export interface DataLinodeNetworkingIpConfig extends cdktf.TerraformMetaArguments {
  ...
  * The IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/networking_ip#address DataLinodeNetworkingIp#address}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/networking_ip linode_networking_ip}
*/
export class DataLinodeNetworkingIp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeNetworkingIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/networking_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/networking_ip linode_networking_ip} Data Source
  *
  * @param scope The scope in which to define this construct
