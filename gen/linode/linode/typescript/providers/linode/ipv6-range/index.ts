// https://registry.terraform.io/providers/linode/linode/3.6.0/docs/resources/ipv6_range
...
export interface Ipv6RangeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/resources/ipv6_range#linode_id Ipv6Range#linode_id}
  */
  readonly linodeId?: number;
  /**
  * The prefix length of the IPv6 range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/resources/ipv6_range#prefix_length Ipv6Range#prefix_length}
  */
  readonly prefixLength: number;
  /**
  * The IPv6 SLAAC address to assign this range to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/resources/ipv6_range#route_target Ipv6Range#route_target}
  */
  readonly routeTarget?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/resources/ipv6_range linode_ipv6_range}
*/
export class Ipv6Range extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ipv6Range that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/resources/ipv6_range#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.6.0/docs/resources/ipv6_range linode_ipv6_range} Resource
  *
  * @param scope The scope in which to define this construct
