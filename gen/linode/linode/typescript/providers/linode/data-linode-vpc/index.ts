// https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/vpc
...
export interface DataLinodeVpcConfig extends cdktf.TerraformMetaArguments {
  ...
  * The id of the VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/vpc#id DataLinodeVpc#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/vpc linode_vpc}
*/
export class DataLinodeVpc extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeVpc that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/vpc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.7.0/docs/data-sources/vpc linode_vpc} Data Source
  *
  * @param scope The scope in which to define this construct
