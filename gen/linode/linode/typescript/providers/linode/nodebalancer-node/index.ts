// https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/nodebalancer_node
...
export interface NodebalancerNodeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/nodebalancer_node#address NodebalancerNode#address}
  */
  readonly address: string;
  /**
  * The ID of the NodeBalancerConfig to access.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/nodebalancer_node#config_id NodebalancerNode#config_id}
  */
  readonly configId: number;
  /**
  * The label for this node. This is for display purposes only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/nodebalancer_node#label NodebalancerNode#label}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/nodebalancer_node#mode NodebalancerNode#mode}
  */
  readonly mode?: string;
  /**
  * The ID of the NodeBalancer to access.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/nodebalancer_node#nodebalancer_id NodebalancerNode#nodebalancer_id}
  */
  readonly nodebalancerId: number;
  /**
  * The ID of the VPC subnet for this node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/nodebalancer_node#subnet_id NodebalancerNode#subnet_id}
  */
  readonly subnetId?: number;
  /**
  * Used when picking a backend to serve a request and is not pinned to a single backend yet. Nodes with a higher weight will receive more traffic. (1-255)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/nodebalancer_node#weight NodebalancerNode#weight}
  */
  readonly weight?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/nodebalancer_node linode_nodebalancer_node}
*/
export class NodebalancerNode extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NodebalancerNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/nodebalancer_node#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/nodebalancer_node linode_nodebalancer_node} Resource
  *
  * @param scope The scope in which to define this construct
