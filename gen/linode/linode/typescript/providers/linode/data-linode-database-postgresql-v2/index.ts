// https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/database_postgresql_v2
...
export interface DataLinodeDatabasePostgresqlV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/database_postgresql_v2#id DataLinodeDatabasePostgresqlV2#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/database_postgresql_v2 linode_database_postgresql_v2}
*/
export class DataLinodeDatabasePostgresqlV2 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeDatabasePostgresqlV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/database_postgresql_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/database_postgresql_v2 linode_database_postgresql_v2} Data Source
  *
  * @param scope The scope in which to define this construct
