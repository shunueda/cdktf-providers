// https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/sshkey
...
export interface SshkeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/sshkey#label Sshkey#label}
  */
  readonly label: string;
  /**
  * The public SSH Key, which is used to authenticate to the root user of the Linodes you deploy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/sshkey#ssh_key Sshkey#ssh_key}
  */
  readonly sshKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/sshkey linode_sshkey}
*/
export class Sshkey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sshkey that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/sshkey#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.1/docs/resources/sshkey linode_sshkey} Resource
  *
  * @param scope The scope in which to define this construct
