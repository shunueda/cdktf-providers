// https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/lke_version
...
export interface DataLinodeLkeVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/lke_version#id DataLinodeLkeVersion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/lke_version#tier DataLinodeLkeVersion#tier}
  */
  readonly tier?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/lke_version linode_lke_version}
*/
export class DataLinodeLkeVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeLkeVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/lke_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/lke_version linode_lke_version} Data Source
  *
  * @param scope The scope in which to define this construct
