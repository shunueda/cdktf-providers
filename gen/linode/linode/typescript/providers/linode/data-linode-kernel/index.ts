// https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/kernel
...
export interface DataLinodeKernelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/kernel#id DataLinodeKernel#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/kernel linode_kernel}
*/
export class DataLinodeKernel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLinodeKernel that should be imported. Refer to the {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/kernel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/linode/linode/3.5.0/docs/data-sources/kernel linode_kernel} Data Source
  *
  * @param scope The scope in which to define this construct
