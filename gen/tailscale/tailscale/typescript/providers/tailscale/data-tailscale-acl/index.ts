// https://registry.terraform.io/providers/tailscale/tailscale/0.24.0/docs/data-sources/acl
...
export interface DataTailscaleAclConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.24.0/docs/data-sources/acl#id DataTailscaleAcl#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.24.0/docs/data-sources/acl tailscale_acl}
*/
export class DataTailscaleAcl extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTailscaleAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.24.0/docs/data-sources/acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.24.0/docs/data-sources/acl tailscale_acl} Data Source
  *
  * @param scope The scope in which to define this construct
