// https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/dbaas_replica
...
export interface DataMgcDbaasReplicaConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the replica
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/dbaas_replica#id DataMgcDbaasReplica#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/dbaas_replica mgc_dbaas_replica}
*/
export class DataMgcDbaasReplica extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcDbaasReplica that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/dbaas_replica#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/dbaas_replica mgc_dbaas_replica} Data Source
  *
  * @param scope The scope in which to define this construct
