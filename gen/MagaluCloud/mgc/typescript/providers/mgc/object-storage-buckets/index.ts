// https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets
...
export interface ObjectStorageBucketsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets#bucket ObjectStorageBuckets#bucket}
  */
  readonly bucket: string;
  /**
  * CORS configuration for the bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets#cors ObjectStorageBuckets#cors}
  */
  readonly cors?: ObjectStorageBucketsCors;
  /**
  * Enable object lock for this bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets#lock ObjectStorageBuckets#lock}
  */
  readonly lock?: boolean | cdktf.IResolvable;
  /**
  * Bucket policy document as a JSON string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets#policy ObjectStorageBuckets#policy}
  */
  readonly policy?: string;
  /**
  * Enable versioning for this bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets#versioning ObjectStorageBuckets#versioning}
  */
...
export interface ObjectStorageBucketsCors {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets#allowed_headers ObjectStorageBuckets#allowed_headers}
  */
  readonly allowedHeaders?: string[];
  /**
  * Allowed HTTP methods for CORS requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets#allowed_methods ObjectStorageBuckets#allowed_methods}
  */
  readonly allowedMethods: string[];
  /**
  * Allowed origins for CORS requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets#allowed_origins ObjectStorageBuckets#allowed_origins}
  */
  readonly allowedOrigins: string[];
  /**
  * Headers exposed to the browser for CORS requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets#expose_headers ObjectStorageBuckets#expose_headers}
  */
  readonly exposeHeaders?: string[];
  /**
  * Maximum age in seconds for CORS preflight cache.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets#max_age_seconds ObjectStorageBuckets#max_age_seconds}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets mgc_object_storage_buckets}
*/
export class ObjectStorageBuckets extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObjectStorageBuckets that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/object_storage_buckets mgc_object_storage_buckets} Resource
  *
  * @param scope The scope in which to define this construct
