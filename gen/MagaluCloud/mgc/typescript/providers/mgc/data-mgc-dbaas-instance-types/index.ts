// https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/dbaas_instance_types
...
export interface DataMgcDbaasInstanceTypesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/dbaas_instance_types#status DataMgcDbaasInstanceTypes#status}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/dbaas_instance_types mgc_dbaas_instance_types}
*/
export class DataMgcDbaasInstanceTypes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcDbaasInstanceTypes that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/dbaas_instance_types#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/dbaas_instance_types mgc_dbaas_instance_types} Data Source
  *
  * @param scope The scope in which to define this construct
