// https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/kubernetes_cluster_kubeconfig
...
export interface DataMgcKubernetesClusterKubeconfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/kubernetes_cluster_kubeconfig#cluster_id DataMgcKubernetesClusterKubeconfig#cluster_id}
  */
  readonly clusterId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/kubernetes_cluster_kubeconfig mgc_kubernetes_cluster_kubeconfig}
*/
export class DataMgcKubernetesClusterKubeconfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcKubernetesClusterKubeconfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/kubernetes_cluster_kubeconfig#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/kubernetes_cluster_kubeconfig mgc_kubernetes_cluster_kubeconfig} Data Source
  *
  * @param scope The scope in which to define this construct
