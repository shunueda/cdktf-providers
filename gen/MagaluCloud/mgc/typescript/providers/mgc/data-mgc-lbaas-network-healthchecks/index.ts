// https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/lbaas_network_healthchecks
...
export interface DataMgcLbaasNetworkHealthchecksConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/lbaas_network_healthchecks#lb_id DataMgcLbaasNetworkHealthchecks#lb_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/lbaas_network_healthchecks mgc_lbaas_network_healthchecks}
*/
export class DataMgcLbaasNetworkHealthchecks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcLbaasNetworkHealthchecks that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/lbaas_network_healthchecks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/lbaas_network_healthchecks mgc_lbaas_network_healthchecks} Data Source
  *
  * @param scope The scope in which to define this construct
