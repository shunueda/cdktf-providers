// https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_schedule
...
export interface BlockStorageScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_schedule#description BlockStorageSchedule#description}
  */
  readonly description?: string;
  /**
  * The name of the snapshot schedule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_schedule#name BlockStorageSchedule#name}
  */
  readonly name: string;
  /**
  * Start time for daily snapshot creation (HH:MM:SS format).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_schedule#policy_frequency_daily_start_time BlockStorageSchedule#policy_frequency_daily_start_time}
  */
  readonly policyFrequencyDailyStartTime: string;
  /**
  * Number of days to retain snapshots.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_schedule#policy_retention_in_days BlockStorageSchedule#policy_retention_in_days}
  */
  readonly policyRetentionInDays: number;
  /**
  * Type of snapshot to create.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_schedule#snapshot_type BlockStorageSchedule#snapshot_type}
  */
  readonly snapshotType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_schedule mgc_block_storage_schedule}
*/
export class BlockStorageSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BlockStorageSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_schedule mgc_block_storage_schedule} Resource
  *
  * @param scope The scope in which to define this construct
