// https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/availability_zones
...
export interface DataMgcAvailabilityZonesRegionsAvailabilityZones {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/availability_zones#block_type DataMgcAvailabilityZones#block_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/availability_zones mgc_availability_zones}
*/
export class DataMgcAvailabilityZones extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcAvailabilityZones that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/availability_zones#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/availability_zones mgc_availability_zones} Data Source
  *
  * @param scope The scope in which to define this construct
