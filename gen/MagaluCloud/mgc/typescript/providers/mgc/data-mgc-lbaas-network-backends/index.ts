// https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/lbaas_network_backends
...
export interface DataMgcLbaasNetworkBackendsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/lbaas_network_backends#lb_id DataMgcLbaasNetworkBackends#lb_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/lbaas_network_backends mgc_lbaas_network_backends}
*/
export class DataMgcLbaasNetworkBackends extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcLbaasNetworkBackends that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/lbaas_network_backends#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/data-sources/lbaas_network_backends mgc_lbaas_network_backends} Data Source
  *
  * @param scope The scope in which to define this construct
