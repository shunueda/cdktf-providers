// https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_volume_attachment
...
export interface BlockStorageVolumeAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_volume_attachment#block_storage_id BlockStorageVolumeAttachment#block_storage_id}
  */
  readonly blockStorageId: string;
  /**
  * The ID of the virtual machine to attach the volume to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_volume_attachment#virtual_machine_id BlockStorageVolumeAttachment#virtual_machine_id}
  */
  readonly virtualMachineId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_volume_attachment mgc_block_storage_volume_attachment}
*/
export class BlockStorageVolumeAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BlockStorageVolumeAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_volume_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/block_storage_volume_attachment mgc_block_storage_volume_attachment} Resource
  *
  * @param scope The scope in which to define this construct
