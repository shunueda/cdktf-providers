// https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters
...
export interface DbaasClustersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters#backup_retention_days DbaasClusters#backup_retention_days}
  */
  readonly backupRetentionDays?: number;
  /**
  * Time to initiate the daily backup in UTC (format: 'HH:MM:SS'). Default is '04:00:00'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters#backup_start_at DbaasClusters#backup_start_at}
  */
  readonly backupStartAt?: string;
  /**
  * Type of database engine to use (e.g., 'mysql', 'postgresql'). Cannot be changed after creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters#engine_name DbaasClusters#engine_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters#engine_version DbaasClusters#engine_version}
  */
  readonly engineVersion: string;
  /**
  * Compute and memory capacity of the cluster nodes (e.g., 'DP2-16-40'). Can be changed to scale the instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters#instance_type DbaasClusters#instance_type}
  */
  readonly instanceType: string;
  /**
  * Name of the DBaaS cluster. Must be unique. Cannot be changed after creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters#name DbaasClusters#name}
  */
  readonly name: string;
  /**
  * ID of the parameter group to associate with the cluster.  Cannot be changed after creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters#parameter_group DbaasClusters#parameter_group}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters#password DbaasClusters#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters#user DbaasClusters#user}
  */
  readonly user: string;
  /**
  * Size of the storage volume in GB. Can be increased but not decreased after creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters#volume_size DbaasClusters#volume_size}
  */
  readonly volumeSize: number;
  /**
  * Type of the storage volume (e.g., 'CLOUD_NVME15K' or 'CLOUD_NVME20K'). Cannot be changed after creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters#volume_type DbaasClusters#volume_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters mgc_dbaas_clusters}
*/
export class DbaasClusters extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbaasClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_clusters mgc_dbaas_clusters} Resource
  *
  * @param scope The scope in which to define this construct
