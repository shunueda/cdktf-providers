// https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/virtual_machine_instance
...
export interface DataMgcVirtualMachineInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of machine-type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/virtual_machine_instance#id DataMgcVirtualMachineInstance#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/virtual_machine_instance mgc_virtual_machine_instance}
*/
export class DataMgcVirtualMachineInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcVirtualMachineInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/virtual_machine_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/virtual_machine_instance mgc_virtual_machine_instance} Data Source
  *
  * @param scope The scope in which to define this construct
