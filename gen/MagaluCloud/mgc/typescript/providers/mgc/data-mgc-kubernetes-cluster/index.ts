// https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/data-sources/kubernetes_cluster
...
export interface DataMgcKubernetesClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cluster's UUID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/data-sources/kubernetes_cluster#id DataMgcKubernetesCluster#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/data-sources/kubernetes_cluster mgc_kubernetes_cluster}
*/
export class DataMgcKubernetesCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcKubernetesCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/data-sources/kubernetes_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/data-sources/kubernetes_cluster mgc_kubernetes_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
