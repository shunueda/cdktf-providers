// https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/dbaas_instances_snapshots
...
export interface DataMgcDbaasInstancesSnapshotsConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the instance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/dbaas_instances_snapshots#instance_id DataMgcDbaasInstancesSnapshots#instance_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/dbaas_instances_snapshots mgc_dbaas_instances_snapshots}
*/
export class DataMgcDbaasInstancesSnapshots extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcDbaasInstancesSnapshots that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/dbaas_instances_snapshots#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/dbaas_instances_snapshots mgc_dbaas_instances_snapshots} Data Source
  *
  * @param scope The scope in which to define this construct
