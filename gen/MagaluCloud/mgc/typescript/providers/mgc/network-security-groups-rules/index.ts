// https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/network_security_groups_rules
...
export interface NetworkSecurityGroupsRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/network_security_groups_rules#description NetworkSecurityGroupsRules#description}
  */
  readonly description?: string;
  /**
  * Direction of traffic flow. Allowed values: 'ingress' or 'egress'. Example: 'ingress'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/network_security_groups_rules#direction NetworkSecurityGroupsRules#direction}
  */
  readonly direction: string;
  /**
  * Network protocol version. Allowed values: 'IPv4' or 'IPv6'. Example: 'IPv4'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/network_security_groups_rules#ethertype NetworkSecurityGroupsRules#ethertype}
  */
  readonly ethertype: string;
  /**
  * Maximum port number in the range. Valid values: 1-65535. Example: 22
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/network_security_groups_rules#port_range_max NetworkSecurityGroupsRules#port_range_max}
  */
  readonly portRangeMax?: number;
  /**
  * Minimum port number in the range. Valid values: 1-65535. Example: 22
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/network_security_groups_rules#port_range_min NetworkSecurityGroupsRules#port_range_min}
  */
  readonly portRangeMin?: number;
  /**
  * IP protocol. Allowed values: tcp, udp, icmp, icmpv6. Example: 'tcp'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/network_security_groups_rules#protocol NetworkSecurityGroupsRules#protocol}
  */
  readonly protocol?: string;
  /**
  * CIDR notation of remote IPv4 and IPv6 range. Example: '192.168.1.0/24', '0.0.0.0/0', '::/0' or '2001:db8::/32'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/network_security_groups_rules#remote_ip_prefix NetworkSecurityGroupsRules#remote_ip_prefix}
  */
  readonly remoteIpPrefix?: string;
  /**
  * ID of the security group to which this rule will be added. Example: 'sg-0123456789abcdef0'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/network_security_groups_rules#security_group_id NetworkSecurityGroupsRules#security_group_id}
  */
  readonly securityGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/network_security_groups_rules mgc_network_security_groups_rules}
*/
export class NetworkSecurityGroupsRules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkSecurityGroupsRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/network_security_groups_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/network_security_groups_rules mgc_network_security_groups_rules} Resource
  *
  * @param scope The scope in which to define this construct
