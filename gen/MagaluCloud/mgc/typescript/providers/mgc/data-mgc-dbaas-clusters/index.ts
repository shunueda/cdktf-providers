// https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/dbaas_clusters
...
export interface DataMgcDbaasClustersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/dbaas_clusters#engine_id_filter DataMgcDbaasClusters#engine_id_filter}
  */
  readonly engineIdFilter?: string;
  /**
  * Filter clusters by parameter group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/dbaas_clusters#parameter_group_id_filter DataMgcDbaasClusters#parameter_group_id_filter}
  */
  readonly parameterGroupIdFilter?: string;
  /**
  * Filter clusters by status.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/dbaas_clusters#status_filter DataMgcDbaasClusters#status_filter}
  */
...
export interface DataMgcDbaasClustersClusters {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/dbaas_clusters#id DataMgcDbaasClusters#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/dbaas_clusters mgc_dbaas_clusters}
*/
export class DataMgcDbaasClusters extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcDbaasClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/dbaas_clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/dbaas_clusters mgc_dbaas_clusters} Data Source
  *
  * @param scope The scope in which to define this construct
