// https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_vpcs_subnets
...
export interface NetworkVpcsSubnetsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_vpcs_subnets#availability_zone NetworkVpcsSubnets#availability_zone}
  */
  readonly availabilityZone?: string;
  /**
  * The CIDR block of the VPC subnet. Example: '192.168.1.0/24', '0.0.0.0/0', '::/0' or '2001:db8::/32'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_vpcs_subnets#cidr_block NetworkVpcsSubnets#cidr_block}
  */
  readonly cidrBlock: string;
  /**
  * The description of the VPC subnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_vpcs_subnets#description NetworkVpcsSubnets#description}
  */
  readonly description?: string;
  /**
  * The DNS nameservers of the VPC subnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_vpcs_subnets#dns_nameservers NetworkVpcsSubnets#dns_nameservers}
  */
  readonly dnsNameservers?: string[];
  /**
  * Network protocol version. Allowed values: 'IPv4' or 'IPv6'. Example: 'IPv4'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_vpcs_subnets#ip_version NetworkVpcsSubnets#ip_version}
  */
  readonly ipVersion: string;
  /**
  * The name of the VPC subnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_vpcs_subnets#name NetworkVpcsSubnets#name}
  */
  readonly name: string;
  /**
  * The ID of the subnet pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_vpcs_subnets#subnetpool_id NetworkVpcsSubnets#subnetpool_id}
  */
  readonly subnetpoolId: string;
  /**
  * The ID of the VPC
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_vpcs_subnets#vpc_id NetworkVpcsSubnets#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_vpcs_subnets mgc_network_vpcs_subnets}
*/
export class NetworkVpcsSubnets extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkVpcsSubnets that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_vpcs_subnets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_vpcs_subnets mgc_network_vpcs_subnets} Resource
  *
  * @param scope The scope in which to define this construct
