// https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/object_storage_buckets
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/object_storage_buckets mgc_object_storage_buckets}
*/
export class DataMgcObjectStorageBuckets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcObjectStorageBuckets that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/object_storage_buckets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/object_storage_buckets mgc_object_storage_buckets} Data Source
  *
  * @param scope The scope in which to define this construct
