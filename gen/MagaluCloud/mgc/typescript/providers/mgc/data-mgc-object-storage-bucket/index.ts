// https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/object_storage_bucket
...
export interface DataMgcObjectStorageBucketConfig extends cdktf.TerraformMetaArguments {
  ...
  * Name of the bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/object_storage_bucket#bucket DataMgcObjectStorageBucket#bucket}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/object_storage_bucket mgc_object_storage_bucket}
*/
export class DataMgcObjectStorageBucket extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcObjectStorageBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/object_storage_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/object_storage_bucket mgc_object_storage_bucket} Data Source
  *
  * @param scope The scope in which to define this construct
