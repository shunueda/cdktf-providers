// https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances
...
export interface VirtualMachineInstancesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances#allocate_public_ipv4 VirtualMachineInstances#allocate_public_ipv4}
  */
  readonly allocatePublicIpv4?: boolean | cdktf.IResolvable;
  /**
  * The availability zone of the virtual machine instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances#availability_zone VirtualMachineInstances#availability_zone}
  */
  ...
  * This attribute can only be used when "network_interface_id" is not set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances#creation_security_groups VirtualMachineInstances#creation_security_groups}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances#image VirtualMachineInstances#image}
  */
  readonly image?: string;
  /**
  * The machine type name of the virtual machine instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances#machine_type VirtualMachineInstances#machine_type}
  */
  readonly machineType: string;
  /**
  * The name of the virtual machine instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances#name VirtualMachineInstances#name}
  */
  readonly name: string;
  /**
  * The snapshot ID used to create the virtual machine instance. If set, the snapshot will be used instead of an image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances#snapshot_id VirtualMachineInstances#snapshot_id}
  */
  readonly snapshotId?: string;
  /**
  * The name of the SSH key associated with the virtual machine instance. Not required for Windows instances.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances#ssh_key_name VirtualMachineInstances#ssh_key_name}
  */
  readonly sshKeyName?: string;
  /**
  * User data for instance initialization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances#user_data VirtualMachineInstances#user_data}
  */
  readonly userData?: string;
  /**
  * The VPC ID where the primary network interface will be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances#vpc_id VirtualMachineInstances#vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances mgc_virtual_machine_instances}
*/
export class VirtualMachineInstances extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualMachineInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/virtual_machine_instances mgc_virtual_machine_instances} Resource
  *
  * @param scope The scope in which to define this construct
