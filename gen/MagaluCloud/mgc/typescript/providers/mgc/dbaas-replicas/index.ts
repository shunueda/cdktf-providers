// https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/dbaas_replicas
...
export interface DbaasReplicasConfig extends cdktf.TerraformMetaArguments {
  ...
  * Instance type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/dbaas_replicas#instance_type DbaasReplicas#instance_type}
  */
  readonly instanceType?: string;
  /**
  * Replica name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/dbaas_replicas#name DbaasReplicas#name}
  */
  readonly name: string;
  /**
  * ID of the source instance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/dbaas_replicas#source_id DbaasReplicas#source_id}
  */
  readonly sourceId: string;
  /**
  * Size of the storage volume in GB. Can be increased but not decreased after creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/dbaas_replicas#volume_size DbaasReplicas#volume_size}
  */
  readonly volumeSize?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/dbaas_replicas mgc_dbaas_replicas}
*/
export class DbaasReplicas extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbaasReplicas that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/dbaas_replicas#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/resources/dbaas_replicas mgc_dbaas_replicas} Resource
  *
  * @param scope The scope in which to define this construct
