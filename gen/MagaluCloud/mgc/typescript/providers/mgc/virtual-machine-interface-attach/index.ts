// https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/virtual_machine_interface_attach
...
export interface VirtualMachineInterfaceAttachConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/virtual_machine_interface_attach#instance_id VirtualMachineInterfaceAttach#instance_id}
  */
  readonly instanceId: string;
  /**
  * ID of the network interface to attach.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/virtual_machine_interface_attach#interface_id VirtualMachineInterfaceAttach#interface_id}
  */
  readonly interfaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/virtual_machine_interface_attach mgc_virtual_machine_interface_attach}
*/
export class VirtualMachineInterfaceAttach extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualMachineInterfaceAttach that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/virtual_machine_interface_attach#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/resources/virtual_machine_interface_attach mgc_virtual_machine_interface_attach} Resource
  *
  * @param scope The scope in which to define this construct
