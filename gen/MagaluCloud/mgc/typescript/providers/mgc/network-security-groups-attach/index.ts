// https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_security_groups_attach
...
export interface NetworkSecurityGroupsAttachConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_security_groups_attach#interface_id NetworkSecurityGroupsAttach#interface_id}
  */
  readonly interfaceId: string;
  /**
  * The ID of the Security Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_security_groups_attach#security_group_id NetworkSecurityGroupsAttach#security_group_id}
  */
  readonly securityGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_security_groups_attach mgc_network_security_groups_attach}
*/
export class NetworkSecurityGroupsAttach extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkSecurityGroupsAttach that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_security_groups_attach#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/resources/network_security_groups_attach mgc_network_security_groups_attach} Resource
  *
  * @param scope The scope in which to define this construct
