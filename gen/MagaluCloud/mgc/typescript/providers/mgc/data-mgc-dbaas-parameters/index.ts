// https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/dbaas_parameters
...
export interface DataMgcDbaasParametersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/dbaas_parameters#parameter_group_id DataMgcDbaasParameters#parameter_group_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/dbaas_parameters mgc_dbaas_parameters}
*/
export class DataMgcDbaasParameters extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcDbaasParameters that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/dbaas_parameters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/dbaas_parameters mgc_dbaas_parameters} Data Source
  *
  * @param scope The scope in which to define this construct
