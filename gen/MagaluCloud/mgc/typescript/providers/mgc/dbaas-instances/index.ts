// https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances
...
export interface DbaasInstancesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#availability_zone DbaasInstances#availability_zone}
  */
  readonly availabilityZone?: string;
  /**
  * Number of days to retain automated backups (1-35 days). Zero disables automated backups. Default is 7 days.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#backup_retention_days DbaasInstances#backup_retention_days}
  */
  readonly backupRetentionDays?: number;
  /**
  * Time to initiate the daily backup in UTC (format: 'HH:MM:SS'). Default is 04:00:00.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#backup_start_at DbaasInstances#backup_start_at}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#engine_name DbaasInstances#engine_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#engine_version DbaasInstances#engine_version}
  */
  readonly engineVersion?: string;
  /**
  * Compute and memory capacity of the instance (e.g., 'DP2-16-40'). Can be changed to scale the instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#instance_type DbaasInstances#instance_type}
  */
  readonly instanceType: string;
  /**
  * Name of the DBaaS instance. Must be unique within your account. Cannot be changed after creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#name DbaasInstances#name}
  */
  readonly name: string;
  /**
  * ID of the parameter group to use for the instance. Not used when restoring from a snapshot.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#parameter_group DbaasInstances#parameter_group}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#password DbaasInstances#password}
  */
  readonly password?: string;
  /**
  * ID of the snapshot to use for the instance. Not used when creating a new instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#snapshot_id DbaasInstances#snapshot_id}
  */
  readonly snapshotId?: string;
  /**
  * ID of the instance to use for the snapshot. Not used when creating a new instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#snapshot_source_id DbaasInstances#snapshot_source_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#user DbaasInstances#user}
  */
  readonly user?: string;
  /**
  * Size of the storage volume in GB. Can be increased but not decreased after creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#volume_size DbaasInstances#volume_size}
  */
  readonly volumeSize: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances mgc_dbaas_instances}
*/
export class DbaasInstances extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbaasInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_instances mgc_dbaas_instances} Resource
  *
  * @param scope The scope in which to define this construct
