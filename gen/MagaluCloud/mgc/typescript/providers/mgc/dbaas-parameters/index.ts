// https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/resources/dbaas_parameters
...
export interface DbaasParametersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/resources/dbaas_parameters#name DbaasParameters#name}
  */
  readonly name: string;
  /**
  * ID of the parameter group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/resources/dbaas_parameters#parameter_group_id DbaasParameters#parameter_group_id}
  */
  readonly parameterGroupId: string;
  /**
  * Value of the parameter
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/resources/dbaas_parameters#value DbaasParameters#value}
  */
  readonly value: { [key: string]: any };
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/resources/dbaas_parameters mgc_dbaas_parameters}
*/
export class DbaasParameters extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbaasParameters that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/resources/dbaas_parameters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/resources/dbaas_parameters mgc_dbaas_parameters} Resource
  *
  * @param scope The scope in which to define this construct
