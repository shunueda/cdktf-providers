// https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/kubernetes_cluster
...
export interface KubernetesClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/kubernetes_cluster#allowed_cidrs KubernetesCluster#allowed_cidrs}
  */
  readonly allowedCidrs?: string[];
  /**
  * The IP address range of the Kubernetes cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/kubernetes_cluster#cluster_ipv4_cidr KubernetesCluster#cluster_ipv4_cidr}
  */
  readonly clusterIpv4Cidr?: string;
  /**
  * A brief description of the Kubernetes cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/kubernetes_cluster#description KubernetesCluster#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/kubernetes_cluster#enabled_server_group KubernetesCluster#enabled_server_group}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/kubernetes_cluster#name KubernetesCluster#name}
  */
  readonly name: string;
  /**
  * The IP address range of the Kubernetes cluster service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/kubernetes_cluster#services_ipv4_cidr KubernetesCluster#services_ipv4_cidr}
  */
  readonly servicesIpv4Cidr?: string;
  /**
  * The native Kubernetes version of the cluster. Use the standard "vX.Y.Z" format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/kubernetes_cluster#version KubernetesCluster#version}
  */
  readonly version?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/kubernetes_cluster mgc_kubernetes_cluster}
*/
export class KubernetesCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/kubernetes_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/kubernetes_cluster mgc_kubernetes_cluster} Resource
  *
  * @param scope The scope in which to define this construct
