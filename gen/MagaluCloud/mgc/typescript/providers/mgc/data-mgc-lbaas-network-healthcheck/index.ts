// https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/lbaas_network_healthcheck
...
export interface DataMgcLbaasNetworkHealthcheckConfig extends cdktf.TerraformMetaArguments {
  ...
  * The Health Check ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/lbaas_network_healthcheck#id DataMgcLbaasNetworkHealthcheck#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/lbaas_network_healthcheck#lb_id DataMgcLbaasNetworkHealthcheck#lb_id}
  */
  readonly lbId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/lbaas_network_healthcheck mgc_lbaas_network_healthcheck}
*/
export class DataMgcLbaasNetworkHealthcheck extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcLbaasNetworkHealthcheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/lbaas_network_healthcheck#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/lbaas_network_healthcheck mgc_lbaas_network_healthcheck} Data Source
  *
  * @param scope The scope in which to define this construct
