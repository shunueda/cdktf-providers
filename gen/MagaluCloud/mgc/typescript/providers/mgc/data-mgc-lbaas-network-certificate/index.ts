// https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/lbaas_network_certificate
...
export interface DataMgcLbaasNetworkCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/lbaas_network_certificate#id DataMgcLbaasNetworkCertificate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/lbaas_network_certificate#lb_id DataMgcLbaasNetworkCertificate#lb_id}
  */
  readonly lbId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/lbaas_network_certificate mgc_lbaas_network_certificate}
*/
export class DataMgcLbaasNetworkCertificate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcLbaasNetworkCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/lbaas_network_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.1/docs/data-sources/lbaas_network_certificate mgc_lbaas_network_certificate} Data Source
  *
  * @param scope The scope in which to define this construct
