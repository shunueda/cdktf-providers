// https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/network_security_groups
...
export interface NetworkSecurityGroupsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/network_security_groups#description NetworkSecurityGroups#description}
  */
  readonly description?: string;
  /**
  * Disable default rules, when creating the Security Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/network_security_groups#disable_default_rules NetworkSecurityGroups#disable_default_rules}
  */
  readonly disableDefaultRules?: boolean | cdktf.IResolvable;
  /**
  * The name of the Security Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/network_security_groups#name NetworkSecurityGroups#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/network_security_groups mgc_network_security_groups}
*/
export class NetworkSecurityGroups extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkSecurityGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/network_security_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/network_security_groups mgc_network_security_groups} Resource
  *
  * @param scope The scope in which to define this construct
