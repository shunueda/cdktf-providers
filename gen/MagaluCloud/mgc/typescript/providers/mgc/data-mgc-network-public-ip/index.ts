// https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/network_public_ip
...
export interface DataMgcNetworkPublicIpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/network_public_ip#id DataMgcNetworkPublicIp#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/network_public_ip mgc_network_public_ip}
*/
export class DataMgcNetworkPublicIp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcNetworkPublicIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/network_public_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.0/docs/data-sources/network_public_ip mgc_network_public_ip} Data Source
  *
  * @param scope The scope in which to define this construct
