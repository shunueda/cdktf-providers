// https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs
...
export interface MgcProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs#api_key MgcProvider#api_key}
  */
  readonly apiKey: string;
  /**
  * The environment to use. Options: prod / pre-prod / dev-qa. Default is prod
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs#env MgcProvider#env}
  */
  readonly env?: string;
  /**
  * Key Pair ID for Object Storage.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs#key_pair_id MgcProvider#key_pair_id}
  */
  readonly keyPairId?: string;
  /**
  * Key Pair Secret for Object Storage.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs#key_pair_secret MgcProvider#key_pair_secret}
  */
  readonly keyPairSecret?: string;
  /**
  * The region to use for resources. Options: br-ne1 / br-se1. Default is br-se1
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs#region MgcProvider#region}
  */
  readonly region?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs#alias MgcProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs mgc}
*/
export class MgcProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing MgcProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs mgc} Resource
  *
  * @param scope The scope in which to define this construct
