// https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/lbaas_network_listener
...
export interface DataMgcLbaasNetworkListenerConfig extends cdktf.TerraformMetaArguments {
  ...
  * The Listener ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/lbaas_network_listener#id DataMgcLbaasNetworkListener#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/lbaas_network_listener#lb_id DataMgcLbaasNetworkListener#lb_id}
  */
  readonly lbId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/lbaas_network_listener mgc_lbaas_network_listener}
*/
export class DataMgcLbaasNetworkListener extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcLbaasNetworkListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/lbaas_network_listener#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/lbaas_network_listener mgc_lbaas_network_listener} Data Source
  *
  * @param scope The scope in which to define this construct
