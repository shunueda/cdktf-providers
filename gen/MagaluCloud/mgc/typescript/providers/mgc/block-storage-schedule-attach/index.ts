// https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/block_storage_schedule_attach
...
export interface BlockStorageScheduleAttachConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/block_storage_schedule_attach#schedule_id BlockStorageScheduleAttach#schedule_id}
  */
  readonly scheduleId: string;
  /**
  * The ID of the block storage volume to attach to the schedule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/block_storage_schedule_attach#volume_id BlockStorageScheduleAttach#volume_id}
  */
  readonly volumeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/block_storage_schedule_attach mgc_block_storage_schedule_attach}
*/
export class BlockStorageScheduleAttach extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BlockStorageScheduleAttach that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/block_storage_schedule_attach#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.41.1/docs/resources/block_storage_schedule_attach mgc_block_storage_schedule_attach} Resource
  *
  * @param scope The scope in which to define this construct
