// https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/network_public_ips
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/network_public_ips mgc_network_public_ips}
*/
export class DataMgcNetworkPublicIps extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcNetworkPublicIps that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/network_public_ips#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.2/docs/data-sources/network_public_ips mgc_network_public_ips} Data Source
  *
  * @param scope The scope in which to define this construct
