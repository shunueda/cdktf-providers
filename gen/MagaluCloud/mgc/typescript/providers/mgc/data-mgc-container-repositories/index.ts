// https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/data-sources/container_repositories
...
export interface DataMgcContainerRepositoriesConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the registry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/data-sources/container_repositories#registry_id DataMgcContainerRepositories#registry_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/data-sources/container_repositories mgc_container_repositories}
*/
export class DataMgcContainerRepositories extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcContainerRepositories that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/data-sources/container_repositories#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/data-sources/container_repositories mgc_container_repositories} Data Source
  *
  * @param scope The scope in which to define this construct
