// https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_parameter_groups
...
export interface DbaasParameterGroupsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_parameter_groups#description DbaasParameterGroups#description}
  */
  readonly description?: string;
  /**
  * Type of database engine to use (e.g., 'mysql', 'postgresql'). Cannot be changed after creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_parameter_groups#engine_name DbaasParameterGroups#engine_name}
  */
  readonly engineName: string;
  /**
  * Version of the database engine (e.g., '8.0', '13.3'). Must be compatible with the selected engine_name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_parameter_groups#engine_version DbaasParameterGroups#engine_version}
  */
  readonly engineVersion: string;
  /**
  * Name of the parameters group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_parameter_groups#name DbaasParameterGroups#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_parameter_groups mgc_dbaas_parameter_groups}
*/
export class DbaasParameterGroups extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbaasParameterGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_parameter_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.39.0/docs/resources/dbaas_parameter_groups mgc_dbaas_parameter_groups} Resource
  *
  * @param scope The scope in which to define this construct
