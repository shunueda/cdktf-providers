// https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/block_storage_volume_types
...
/**
* Represents a {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/block_storage_volume_types mgc_block_storage_volume_types}
*/
export class DataMgcBlockStorageVolumeTypes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMgcBlockStorageVolumeTypes that should be imported. Refer to the {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/block_storage_volume_types#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/magalucloud/mgc/0.40.0/docs/data-sources/block_storage_volume_types mgc_block_storage_volume_types} Data Source
  *
  * @param scope The scope in which to define this construct
