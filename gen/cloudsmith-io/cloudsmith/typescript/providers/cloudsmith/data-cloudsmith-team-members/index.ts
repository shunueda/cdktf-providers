...
export interface DataCloudsmithTeamMembersMembers {
}

export function dataCloudsmithTeamMembersMembersToTerraform(struct?: DataCloudsmithTeamMembersMembers): any {
...
export function dataCloudsmithTeamMembersMembersToHclTerraform(struct?: DataCloudsmithTeamMembersMembers): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudsmithTeamMembersMembersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudsmithTeamMembersMembers | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudsmithTeamMembersMembers | undefined) {
    if (value === undefined) {
...
export class DataCloudsmithTeamMembersMembersList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataCloudsmithTeamMembersMembersOutputReference {
    return new DataCloudsmithTeamMembersMembersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataCloudsmithTeamMembers extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cloudsmith_team_members";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "cloudsmith_team_members", importId: importFromId, provider });
      }
  ...
  * @param options DataCloudsmithTeamMembersConfig
  */
  public constructor(scope: Construct, id: string, config: DataCloudsmithTeamMembersConfig) {
    super(scope, id, {
  ...
  private _members = new DataCloudsmithTeamMembersMembersList(this, "members", false);
  public get members() {
