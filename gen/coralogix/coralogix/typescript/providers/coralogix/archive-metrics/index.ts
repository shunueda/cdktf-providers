// https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics
...
export interface ArchiveMetricsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics#ibm ArchiveMetrics#ibm}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics#retention_policy ArchiveMetrics#retention_policy}
  */
  readonly retentionPolicy?: ArchiveMetricsRetentionPolicy;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics#s3 ArchiveMetrics#s3}
  */
  readonly s3?: ArchiveMetricsS3;
}
export interface ArchiveMetricsIbm {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics#crn ArchiveMetrics#crn}
  */
  readonly crn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics#endpoint ArchiveMetrics#endpoint}
  */
...
export interface ArchiveMetricsRetentionPolicy {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics#five_minutes_resolution ArchiveMetrics#five_minutes_resolution}
  */
  readonly fiveMinutesResolution: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics#one_hour_resolution ArchiveMetrics#one_hour_resolution}
  */
  readonly oneHourResolution: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics#raw_resolution ArchiveMetrics#raw_resolution}
  */
...
export interface ArchiveMetricsS3 {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics#bucket ArchiveMetrics#bucket}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics#region ArchiveMetrics#region}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics coralogix_archive_metrics}
*/
export class ArchiveMetrics extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ArchiveMetrics that should be imported. Refer to the {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/archive_metrics coralogix_archive_metrics} Resource
  *
  * @param scope The scope in which to define this construct
