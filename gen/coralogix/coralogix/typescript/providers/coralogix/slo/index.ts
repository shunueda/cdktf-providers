// https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo
...
export interface SloConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo#description Slo#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo#filters Slo#filters}
  */
  readonly filters?: SloFilters[] | cdktf.IResolvable;
  /**
  * SLO name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo#name Slo#name}
  */
  readonly name: string;
  /**
  * Period. This is the period of the SLO. Valid values are: ["14_days" "30_days" "7_days" "unspecified"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo#period Slo#period}
  */
  readonly period: string;
  /**
  * Service name. This is the name of the service that the SLO is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo#service_name Slo#service_name}
  */
  readonly serviceName: string;
  /**
  * Target percentage. This is the target percentage of the SLO.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo#target_percentage Slo#target_percentage}
  */
  readonly targetPercentage: number;
  /**
  * Threshold in microseconds. Required when `type` is `latency`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo#threshold_microseconds Slo#threshold_microseconds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo#threshold_symbol_type Slo#threshold_symbol_type}
  */
  readonly thresholdSymbolType?: string;
  /**
  * Type. This is the type of the SLO. Valid values are: "error", "latency".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo#type Slo#type}
  */
...
export interface SloFilters {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo#compare_type Slo#compare_type}
  */
  readonly compareType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo#field Slo#field}
  */
  readonly field: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo#field_values Slo#field_values}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo coralogix_slo}
*/
export class Slo extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Slo that should be imported. Refer to the {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/slo coralogix_slo} Resource
  *
  * @param scope The scope in which to define this construct
