// https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs/data-sources/tco_policies_logs
...
/**
* Represents a {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs/data-sources/tco_policies_logs coralogix_tco_policies_logs}
*/
export class DataCoralogixTcoPoliciesLogs extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCoralogixTcoPoliciesLogs that should be imported. Refer to the {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs/data-sources/tco_policies_logs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs/data-sources/tco_policies_logs coralogix_tco_policies_logs} Data Source
  *
  * @param scope The scope in which to define this construct
