// https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs
...
export interface CoralogixProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs#api_key CoralogixProvider#api_key}
  */
  readonly apiKey?: string;
  /**
  * The Coralogix domain. Conflict With 'env'. environment variable 'CORALOGIX_DOMAIN' can be defined instead.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs#domain CoralogixProvider#domain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs#env CoralogixProvider#env}
  */
  readonly env?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs#alias CoralogixProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs coralogix}
*/
export class CoralogixProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing CoralogixProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs coralogix} Resource
  *
  * @param scope The scope in which to define this construct
