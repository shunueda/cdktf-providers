// https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs/data-sources/events2metric
...
export interface DataCoralogixEvents2MetricConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs/data-sources/events2metric#id DataCoralogixEvents2Metric#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs/data-sources/events2metric coralogix_events2metric}
*/
export class DataCoralogixEvents2Metric extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCoralogixEvents2Metric that should be imported. Refer to the {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs/data-sources/events2metric#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coralogix/coralogix/2.2.3/docs/data-sources/events2metric coralogix_events2metric} Data Source
  *
  * @param scope The scope in which to define this construct
