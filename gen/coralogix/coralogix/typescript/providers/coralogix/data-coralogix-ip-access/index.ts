// https://registry.terraform.io/providers/coralogix/coralogix/3.0.0/docs/data-sources/ip_access
...
export interface DataCoralogixIpAccessConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.0/docs/data-sources/ip_access#id DataCoralogixIpAccess#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.0/docs/data-sources/ip_access coralogix_ip_access}
*/
export class DataCoralogixIpAccess extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCoralogixIpAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.0/docs/data-sources/ip_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.0/docs/data-sources/ip_access coralogix_ip_access} Data Source
  *
  * @param scope The scope in which to define this construct
