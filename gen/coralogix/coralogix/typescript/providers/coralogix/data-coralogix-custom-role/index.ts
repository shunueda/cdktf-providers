// https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/data-sources/custom_role
...
export interface DataCoralogixCustomRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  * Custom Role ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/data-sources/custom_role#id DataCoralogixCustomRole#id}
  *
  ...
  * Custom Role name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/data-sources/custom_role#name DataCoralogixCustomRole#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/data-sources/custom_role coralogix_custom_role}
*/
export class DataCoralogixCustomRole extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCoralogixCustomRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/data-sources/custom_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/data-sources/custom_role coralogix_custom_role} Data Source
  *
  * @param scope The scope in which to define this construct
