// https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/data-sources/tco_policies_traces
...
/**
* Represents a {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/data-sources/tco_policies_traces coralogix_tco_policies_traces}
*/
export class DataCoralogixTcoPoliciesTraces extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCoralogixTcoPoliciesTraces that should be imported. Refer to the {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/data-sources/tco_policies_traces#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/data-sources/tco_policies_traces coralogix_tco_policies_traces} Data Source
  *
  * @param scope The scope in which to define this construct
