...
export interface DataCoralogixDashboardConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.0/docs/data-sources/dashboard#id DataCoralogixDashboard#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.0/docs/data-sources/dashboard coralogix_dashboard}
*/
export class DataCoralogixDashboard extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCoralogixDashboard that should be imported. Refer to the {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.0/docs/data-sources/dashboard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.0/docs/data-sources/dashboard coralogix_dashboard} Data Source
  *
  * @param scope The scope in which to define this construct
