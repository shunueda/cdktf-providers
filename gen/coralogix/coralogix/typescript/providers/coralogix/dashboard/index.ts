...
export interface DashboardConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/dashboard#annotations Dashboard#annotations}
  */
  readonly annotations?: DashboardAnnotations[] | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/dashboard#auto_refresh Dashboard#auto_refresh}
  */
  readonly autoRefresh?: DashboardAutoRefresh;
  /**
  * an option to set the dashboard content from a json file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/dashboard#content_json Dashboard#content_json}
  */
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/dashboard#folder Dashboard#folder}
  */
  readonly folder?: DashboardFolder;
  /**
  * Layout configuration for the dashboard's visual elements.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/dashboard#layout Dashboard#layout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/dashboard#variables Dashboard#variables}
  */
  readonly variables?: DashboardVariables[] | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/dashboard coralogix_dashboard}
*/
export class Dashboard extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Dashboard that should be imported. Refer to the {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/dashboard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/dashboard coralogix_dashboard} Resource
  *
  * @param scope The scope in which to define this construct
