// https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/action
...
export interface ActionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/action#applications Action#applications}
  */
  readonly applications?: string[];
  /**
  * Determines weather the action will be shown at the action menu.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/action#is_hidden Action#is_hidden}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/action#is_private Action#is_private}
  */
  readonly isPrivate?: boolean | cdktf.IResolvable;
  /**
  * Action name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/action#name Action#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/action#source_type Action#source_type}
  */
  readonly sourceType: string;
  /**
  * Applies the action for specific subsystems.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/action#subsystems Action#subsystems}
  */
  readonly subsystems?: string[];
  /**
  * URL for the external tool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/action#url Action#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/action coralogix_action}
*/
export class Action extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Action that should be imported. Refer to the {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coralogix/coralogix/3.0.1/docs/resources/action coralogix_action} Resource
  *
  * @param scope The scope in which to define this construct
