// https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_routing_zone_constraint
...
export interface DataApstraDatacenterRoutingZoneConstraintConfig extends cdktf.TerraformMetaArguments {
  ...
  * Apstra Blueprint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_routing_zone_constraint#blueprint_id DataApstraDatacenterRoutingZoneConstraint#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Apstra graph node ID. Required when `name` is omitted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_routing_zone_constraint#id DataApstraDatacenterRoutingZoneConstraint#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_routing_zone_constraint#name DataApstraDatacenterRoutingZoneConstraint#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_routing_zone_constraint apstra_datacenter_routing_zone_constraint}
*/
export class DataApstraDatacenterRoutingZoneConstraint extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_routing_zone_constraint apstra_datacenter_routing_zone_constraint} Data Source
  *
  * @param scope The scope in which to define this construct
