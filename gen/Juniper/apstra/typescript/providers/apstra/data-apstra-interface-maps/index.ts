// https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/interface_maps
...
export interface DataApstraInterfaceMapsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/interface_maps#device_profile_id DataApstraInterfaceMaps#device_profile_id}
  */
  readonly deviceProfileId?: string;
  /**
  * Optional filter to select only Interface Maps associated with the specified Logical Device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/interface_maps#logical_device_id DataApstraInterfaceMaps#logical_device_id}
  */
  readonly logicalDeviceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/interface_maps apstra_interface_maps}
*/
export class DataApstraInterfaceMaps extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraInterfaceMaps that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/interface_maps#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/interface_maps apstra_interface_maps} Data Source
  *
  * @param scope The scope in which to define this construct
