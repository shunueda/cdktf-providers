// https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/datacenter_ct_static_route
...
export interface DataApstraDatacenterCtStaticRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/datacenter_ct_static_route#name DataApstraDatacenterCtStaticRoute#name}
  */
  readonly name?: string;
  /**
  * IPv4 or IPv6 prefix in CIDR notation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/datacenter_ct_static_route#network DataApstraDatacenterCtStaticRoute#network}
  */
  readonly network: string;
  /**
  * Indicates whether the next-hop IP address is shared across multiple remote systems. Default:  Default: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/datacenter_ct_static_route#share_ip_endpoint DataApstraDatacenterCtStaticRoute#share_ip_endpoint}
  */
  readonly shareIpEndpoint?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/datacenter_ct_static_route apstra_datacenter_ct_static_route}
*/
export class DataApstraDatacenterCtStaticRoute extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraDatacenterCtStaticRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/datacenter_ct_static_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/datacenter_ct_static_route apstra_datacenter_ct_static_route} Data Source
  *
  * @param scope The scope in which to define this construct
