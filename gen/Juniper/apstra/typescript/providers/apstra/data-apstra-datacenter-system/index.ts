// https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_system
...
export interface DataApstraDatacenterSystemConfig extends cdktf.TerraformMetaArguments {
  ...
  * Apstra Blueprint ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_system#blueprint_id DataApstraDatacenterSystem#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Apstra Graph DB node `id` field. Required when `name` is omitted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_system#id DataApstraDatacenterSystem#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_system#name DataApstraDatacenterSystem#name}
  */
  readonly name?: string;
  /**
  * When `true` and the specified object is not found, rather than raising an error, computed values are set to `null`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_system#null_when_not_found DataApstraDatacenterSystem#null_when_not_found}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_system apstra_datacenter_system}
*/
export class DataApstraDatacenterSystem extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraDatacenterSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/datacenter_system apstra_datacenter_system} Data Source
  *
  * @param scope The scope in which to define this construct
