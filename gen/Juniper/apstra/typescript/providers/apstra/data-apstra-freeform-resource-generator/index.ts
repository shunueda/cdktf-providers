// https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource_generator
...
export interface DataApstraFreeformResourceGeneratorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource_generator#blueprint_id DataApstraFreeformResourceGenerator#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Populate this field to look up the Freeform Resource Generator by ID. Required when `name` is omitted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource_generator#id DataApstraFreeformResourceGenerator#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource_generator#name DataApstraFreeformResourceGenerator#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource_generator apstra_freeform_resource_generator}
*/
export class DataApstraFreeformResourceGenerator extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource_generator apstra_freeform_resource_generator} Data Source
  *
  * @param scope The scope in which to define this construct
