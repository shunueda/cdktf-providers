// https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource
...
export interface DataApstraFreeformResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource#blueprint_id DataApstraFreeformResource#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Populate this field to look up the Freeform Resource by ID. Required when `name` is omitted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource#id DataApstraFreeformResource#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource#name DataApstraFreeformResource#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource apstra_freeform_resource}
*/
export class DataApstraFreeformResource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraFreeformResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource apstra_freeform_resource} Data Source
  *
  * @param scope The scope in which to define this construct
