// https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource_group_generator
...
export interface DataApstraFreeformResourceGroupGeneratorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource_group_generator#blueprint_id DataApstraFreeformResourceGroupGenerator#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Populate this field to look up the Freeform Group Generator by ID. Required when `name` is omitted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource_group_generator#id DataApstraFreeformResourceGroupGenerator#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource_group_generator#name DataApstraFreeformResourceGroupGenerator#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource_group_generator apstra_freeform_resource_group_generator}
*/
export class DataApstraFreeformResourceGroupGenerator extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_resource_group_generator apstra_freeform_resource_group_generator} Data Source
  *
  * @param scope The scope in which to define this construct
