// https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/datacenter_ct_routing_zone_constraint
...
export interface DataApstraDatacenterCtRoutingZoneConstraintConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/datacenter_ct_routing_zone_constraint#name DataApstraDatacenterCtRoutingZoneConstraint#name}
  */
  readonly name?: string;
  /**
  * Apstra Object ID of Routing Zone Constraint to be attached.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/datacenter_ct_routing_zone_constraint#routing_zone_constraint_id DataApstraDatacenterCtRoutingZoneConstraint#routing_zone_constraint_id}
  */
  readonly routingZoneConstraintId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/datacenter_ct_routing_zone_constraint apstra_datacenter_ct_routing_zone_constraint}
*/
export class DataApstraDatacenterCtRoutingZoneConstraint extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/datacenter_ct_routing_zone_constraint apstra_datacenter_ct_routing_zone_constraint} Data Source
  *
  * @param scope The scope in which to define this construct
