// https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_property_set
...
export interface DataApstraFreeformPropertySetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_property_set#blueprint_id DataApstraFreeformPropertySet#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Populate this field to look up a Freeform Property Set by ID. Required when `name` is omitted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_property_set#id DataApstraFreeformPropertySet#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_property_set#name DataApstraFreeformPropertySet#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_property_set apstra_freeform_property_set}
*/
export class DataApstraFreeformPropertySet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraFreeformPropertySet that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_property_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.95.1/docs/data-sources/freeform_property_set apstra_freeform_property_set} Data Source
  *
  * @param scope The scope in which to define this construct
