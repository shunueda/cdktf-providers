// https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/blueprint_iba_dashboards
...
export interface DataApstraBlueprintIbaDashboardsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/blueprint_iba_dashboards#blueprint_id DataApstraBlueprintIbaDashboards#blueprint_id}
  */
  readonly blueprintId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/blueprint_iba_dashboards apstra_blueprint_iba_dashboards}
*/
export class DataApstraBlueprintIbaDashboards extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraBlueprintIbaDashboards that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/blueprint_iba_dashboards#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.95.0/docs/data-sources/blueprint_iba_dashboards apstra_blueprint_iba_dashboards} Data Source
  *
  * @param scope The scope in which to define this construct
