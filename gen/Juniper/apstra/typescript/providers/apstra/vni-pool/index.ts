...
export interface VniPoolConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function vniPoolRangesToTerraform(struct?: VniPoolRanges | cdktf.IResolvable): any {
...
export function vniPoolRangesToHclTerraform(struct?: VniPoolRanges | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class VniPoolRangesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): VniPoolRanges | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: VniPoolRanges | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class VniPoolRangesList extends cdktf.ComplexList {
  public internalValue? : VniPoolRanges[] | cdktf.IResolvable
  ...
  */
  public get(index: number): VniPoolRangesOutputReference {
    return new VniPoolRangesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class VniPool extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apstra_vni_pool";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apstra_vni_pool", importId: importFromId, provider });
      }
  ...
  * @param options VniPoolConfig
  */
  public constructor(scope: Construct, id: string, config: VniPoolConfig) {
    super(scope, id, {
  ...
  private _ranges = new VniPoolRangesList(this, "ranges", true);
  public get ranges() {
    return this._ranges;
  }
  public putRanges(value: VniPoolRanges[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ranges: cdktf.listMapper(vniPoolRangesToTerraform, false)(this._ranges.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ranges: {
        value: cdktf.listMapperHcl(vniPoolRangesToHclTerraform, false)(this._ranges.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "VniPoolRangesList",
      },
    };
