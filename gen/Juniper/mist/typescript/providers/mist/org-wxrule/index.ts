// https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule
...
export interface OrgWxruleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule#action OrgWxrule#action}
  */
  readonly action: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule#apply_tags OrgWxrule#apply_tags}
  */
  readonly applyTags?: string[];
  /**
  * Blocked apps (always blocking, ignoring action), the key of Get Application List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule#blocked_apps OrgWxrule#blocked_apps}
  */
  readonly blockedApps?: string[];
  /**
  * List of WxTag UUID to indicate these tags are allowed access
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule#dst_allow_wxtags OrgWxrule#dst_allow_wxtags}
  */
  readonly dstAllowWxtags?: string[];
  /**
  * List of WxTag UUID to indicate these tags are blocked access
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule#dst_deny_wxtags OrgWxrule#dst_deny_wxtags}
  */
  readonly dstDenyWxtags?: string[];
  /**
  * List of WxTag UUID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule#dst_wxtags OrgWxrule#dst_wxtags}
  */
  readonly dstWxtags?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule#enabled OrgWxrule#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Order how rules would be looked up, > 0 and bigger order got matched first, -1 means LAST, uniqueness not checked
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule#order OrgWxrule#order}
  */
  readonly order: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule#org_id OrgWxrule#org_id}
  */
  readonly orgId: string;
  /**
  * List of WxTag UUID to determine if this rule would match
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule#src_wxtags OrgWxrule#src_wxtags}
  */
  readonly srcWxtags?: string[];
  /**
  * Only for Org Level WxRule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule#template_id OrgWxrule#template_id}
  */
  readonly templateId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule mist_org_wxrule}
*/
export class OrgWxrule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgWxrule that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wxrule mist_org_wxrule} Resource
  *
  * @param scope The scope in which to define this construct
