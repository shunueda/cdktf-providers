// https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_deviceprofile_assign
...
export interface OrgDeviceprofileAssignConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_deviceprofile_assign#deviceprofile_id OrgDeviceprofileAssign#deviceprofile_id}
  */
  readonly deviceprofileId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_deviceprofile_assign#macs OrgDeviceprofileAssign#macs}
  */
  readonly macs: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_deviceprofile_assign#org_id OrgDeviceprofileAssign#org_id}
  */
  readonly orgId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_deviceprofile_assign mist_org_deviceprofile_assign}
*/
export class OrgDeviceprofileAssign extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgDeviceprofileAssign that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_deviceprofile_assign#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_deviceprofile_assign mist_org_deviceprofile_assign} Resource
  *
  * @param scope The scope in which to define this construct
