// https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_nacrules
...
export interface DataMistOrgNacrulesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_nacrules#org_id DataMistOrgNacrules#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_nacrules mist_org_nacrules}
*/
export class DataMistOrgNacrules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistOrgNacrules that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_nacrules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_nacrules mist_org_nacrules} Data Source
  *
  * @param scope The scope in which to define this construct
