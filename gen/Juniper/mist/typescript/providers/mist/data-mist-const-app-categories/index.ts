// https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/const_app_categories
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/const_app_categories mist_const_app_categories}
*/
export class DataMistConstAppCategories extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistConstAppCategories that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/const_app_categories#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/const_app_categories mist_const_app_categories} Data Source
  *
  * @param scope The scope in which to define this construct
