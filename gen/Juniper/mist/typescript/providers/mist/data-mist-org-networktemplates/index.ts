// https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/org_networktemplates
...
export interface DataMistOrgNetworktemplatesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/org_networktemplates#org_id DataMistOrgNetworktemplates#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/org_networktemplates mist_org_networktemplates}
*/
export class DataMistOrgNetworktemplates extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistOrgNetworktemplates that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/org_networktemplates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/org_networktemplates mist_org_networktemplates} Data Source
  *
  * @param scope The scope in which to define this construct
