// https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/device_ap_stats
...
export interface DataMistDeviceApStatsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Duration like 7d, 2w
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/device_ap_stats#duration DataMistDeviceApStats#duration}
  */
  readonly duration?: string;
  /**
  * End time (epoch timestamp in seconds, or relative string like "-1d", "-2h", "now")
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/device_ap_stats#end DataMistDeviceApStats#end}
  */
  readonly end?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/device_ap_stats#mac DataMistDeviceApStats#mac}
  */
  readonly mac?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/device_ap_stats#org_id DataMistDeviceApStats#org_id}
  */
  readonly orgId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/device_ap_stats#site_id DataMistDeviceApStats#site_id}
  */
  readonly siteId?: string;
  /**
  * Start time (epoch timestamp in seconds, or relative string like "-1d", "-1w")
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/device_ap_stats#start DataMistDeviceApStats#start}
  */
  readonly start?: string;
  /**
  * enum: `all`, `connected`, `disconnected`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/device_ap_stats#status DataMistDeviceApStats#status}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/device_ap_stats mist_device_ap_stats}
*/
export class DataMistDeviceApStats extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistDeviceApStats that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/device_ap_stats#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/device_ap_stats mist_device_ap_stats} Data Source
  *
  * @param scope The scope in which to define this construct
