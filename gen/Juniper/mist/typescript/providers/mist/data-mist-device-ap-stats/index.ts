// https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/device_ap_stats
...
export interface DataMistDeviceApStatsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Duration like 7d, 2w
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/device_ap_stats#duration DataMistDeviceApStats#duration}
  */
  readonly duration?: string;
  /**
  * End datetime, can be epoch or relative time like -1d, -2h; now if not specified
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/device_ap_stats#end DataMistDeviceApStats#end}
  */
  readonly end?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/device_ap_stats#mac DataMistDeviceApStats#mac}
  */
  readonly mac?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/device_ap_stats#org_id DataMistDeviceApStats#org_id}
  */
  readonly orgId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/device_ap_stats#site_id DataMistDeviceApStats#site_id}
  */
  readonly siteId?: string;
  /**
  * Start datetime, can be epoch or relative time like -1d, -1w; -1d if not specified
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/device_ap_stats#start DataMistDeviceApStats#start}
  */
  readonly start?: number;
  /**
  * enum: `all`, `connected`, `disconnected`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/device_ap_stats#status DataMistDeviceApStats#status}
  */
...
export interface DataMistDeviceApStatsDeviceApStatsGps {
}

export function dataMistDeviceApStatsDeviceApStatsGpsToTerraform(struct?: DataMistDeviceApStatsDeviceApStatsGps): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataMistDeviceApStatsDeviceApStatsGpsToHclTerraform(struct?: DataMistDeviceApStatsDeviceApStatsGps): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataMistDeviceApStatsDeviceApStatsGpsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataMistDeviceApStatsDeviceApStatsGps | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataMistDeviceApStatsDeviceApStatsGps | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataMistDeviceApStatsDeviceApStatsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // gps - computed: true, optional: false, required: false
  private _gps = new DataMistDeviceApStatsDeviceApStatsGpsOutputReference(this, "gps");
  public get gps() {
    return this._gps;
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/device_ap_stats mist_device_ap_stats}
*/
export class DataMistDeviceApStats extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistDeviceApStats that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/device_ap_stats#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/device_ap_stats mist_device_ap_stats} Data Source
  *
  * @param scope The scope in which to define this construct
