// https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_inventory
...
export interface OrgInventoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *     >
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_inventory#inventory OrgInventory#inventory}
  */
  readonly inventory?: { [key: string]: OrgInventoryInventory } | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_inventory#org_id OrgInventory#org_id}
  */
...
export interface OrgInventoryInventory {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_inventory#site_id OrgInventory#site_id}
  */
  readonly siteId?: string;
  /**
  * Unclaim the device from the Mist Organization when removed from the provider inventory. Default is `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_inventory#unclaim_when_destroyed OrgInventory#unclaim_when_destroyed}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_inventory mist_org_inventory}
*/
export class OrgInventory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgInventory that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_inventory#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_inventory mist_org_inventory} Resource
  *
  * @param scope The scope in which to define this construct
