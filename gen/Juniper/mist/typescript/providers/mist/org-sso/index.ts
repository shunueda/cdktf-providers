// https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso
...
export interface OrgSsoConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso#custom_logout_url OrgSso#custom_logout_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso#default_role OrgSso#default_role}
  */
  readonly defaultRole?: string;
  /**
  * IDP Cert (used to verify the signed response)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso#idp_cert OrgSso#idp_cert}
  */
  readonly idpCert: string;
  /**
  * Signing algorithm for SAML Assertion. enum `sha1`, `sha256`, `sha384`, `sha512`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso#idp_sign_algo OrgSso#idp_sign_algo}
  */
  readonly idpSignAlgo: string;
  /**
  * IDP Single-Sign-On URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso#idp_sso_url OrgSso#idp_sso_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso#ignore_unmatched_roles OrgSso#ignore_unmatched_roles}
  */
  readonly ignoreUnmatchedRoles?: boolean | cdktf.IResolvable;
  /**
  * IDP issuer URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso#issuer OrgSso#issuer}
  */
  readonly issuer: string;
  /**
  * Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso#name OrgSso#name}
  */
  readonly name: string;
  /**
  * enum: `email`, `unspecified`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso#nameid_format OrgSso#nameid_format}
  */
  readonly nameidFormat?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso#org_id OrgSso#org_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso#role_attr_extraction OrgSso#role_attr_extraction}
  */
  readonly roleAttrExtraction?: string;
  /**
  * name of the attribute in SAML Assertion to extract role from. Default: `Role`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso#role_attr_from OrgSso#role_attr_from}
  */
  readonly roleAttrFrom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso mist_org_sso}
*/
export class OrgSso extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgSso that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso mist_org_sso} Resource
  *
  * @param scope The scope in which to define this construct
