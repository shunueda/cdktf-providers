// https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/device_gateway_cluster
...
export interface DeviceGatewayClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/device_gateway_cluster#nodes DeviceGatewayCluster#nodes}
  */
  readonly nodes: DeviceGatewayClusterNodes[] | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/device_gateway_cluster#site_id DeviceGatewayCluster#site_id}
  */
...
export interface DeviceGatewayClusterNodes {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/device_gateway_cluster#mac DeviceGatewayCluster#mac}
  */
  readonly mac: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/device_gateway_cluster mist_device_gateway_cluster}
*/
export class DeviceGatewayCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeviceGatewayCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/device_gateway_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/device_gateway_cluster mist_device_gateway_cluster} Resource
  *
  * @param scope The scope in which to define this construct
