// https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_wlan_portal_image
...
export interface OrgWlanPortalImageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_wlan_portal_image#file OrgWlanPortalImage#file}
  */
  readonly file: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_wlan_portal_image#org_id OrgWlanPortalImage#org_id}
  */
  readonly orgId: string;
  /**
  * Org WLAN ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_wlan_portal_image#wlan_id OrgWlanPortalImage#wlan_id}
  */
  readonly wlanId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_wlan_portal_image mist_org_wlan_portal_image}
*/
export class OrgWlanPortalImage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgWlanPortalImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_wlan_portal_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_wlan_portal_image mist_org_wlan_portal_image} Resource
  *
  * @param scope The scope in which to define this construct
