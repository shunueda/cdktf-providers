// https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_sso_roles
...
export interface DataMistOrgSsoRolesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_sso_roles#org_id DataMistOrgSsoRoles#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_sso_roles mist_org_sso_roles}
*/
export class DataMistOrgSsoRoles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistOrgSsoRoles that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_sso_roles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_sso_roles mist_org_sso_roles} Data Source
  *
  * @param scope The scope in which to define this construct
