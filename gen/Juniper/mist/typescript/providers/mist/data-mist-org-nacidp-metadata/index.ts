// https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/org_nacidp_metadata
...
export interface DataMistOrgNacidpMetadataConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/org_nacidp_metadata#nacidp_id DataMistOrgNacidpMetadata#nacidp_id}
  */
  readonly nacidpId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/org_nacidp_metadata#org_id DataMistOrgNacidpMetadata#org_id}
  */
  readonly orgId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/org_nacidp_metadata mist_org_nacidp_metadata}
*/
export class DataMistOrgNacidpMetadata extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistOrgNacidpMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/org_nacidp_metadata#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/org_nacidp_metadata mist_org_nacidp_metadata} Data Source
  *
  * @param scope The scope in which to define this construct
