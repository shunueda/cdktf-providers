// https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_webhooks
...
export interface DataMistOrgWebhooksConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_webhooks#org_id DataMistOrgWebhooks#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_webhooks mist_org_webhooks}
*/
export class DataMistOrgWebhooks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistOrgWebhooks that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_webhooks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_webhooks mist_org_webhooks} Data Source
  *
  * @param scope The scope in which to define this construct
