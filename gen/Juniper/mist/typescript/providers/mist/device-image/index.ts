// https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/device_image
...
export interface DeviceImageConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/device_image#device_id DeviceImage#device_id}
  */
  readonly deviceId: string;
  /**
  * path to the device image file to upload. File must be a `jpeg`, `jpg` or `png` image`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/device_image#file DeviceImage#file}
  */
  readonly file: string;
  /**
  * number of the image, between 1 and 3
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/device_image#image_number DeviceImage#image_number}
  */
  readonly imageNumber: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/device_image#site_id DeviceImage#site_id}
  */
  readonly siteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/device_image mist_device_image}
*/
export class DeviceImage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeviceImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/device_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/device_image mist_device_image} Resource
  *
  * @param scope The scope in which to define this construct
