// https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/const_fingerprints
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/const_fingerprints mist_const_fingerprints}
*/
export class DataMistConstFingerprints extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistConstFingerprints that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/const_fingerprints#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/data-sources/const_fingerprints mist_const_fingerprints} Data Source
  *
  * @param scope The scope in which to define this construct
