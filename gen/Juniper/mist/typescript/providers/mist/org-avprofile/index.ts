// https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_avprofile
...
export interface OrgAvprofileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_avprofile#fallback_action OrgAvprofile#fallback_action}
  */
  readonly fallbackAction?: string;
  /**
  * In KB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_avprofile#max_filesize OrgAvprofile#max_filesize}
  */
  readonly maxFilesize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_avprofile#mime_whitelist OrgAvprofile#mime_whitelist}
  */
  readonly mimeWhitelist?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_avprofile#name OrgAvprofile#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_avprofile#org_id OrgAvprofile#org_id}
  */
  readonly orgId: string;
  /**
  * List of protocols to monitor. enum: `ftp`, `http`, `imap`, `pop3`, `smtp`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_avprofile#protocols OrgAvprofile#protocols}
  */
  readonly protocols: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_avprofile#url_whitelist OrgAvprofile#url_whitelist}
  */
  readonly urlWhitelist?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_avprofile mist_org_avprofile}
*/
export class OrgAvprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgAvprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_avprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_avprofile mist_org_avprofile} Resource
  *
  * @param scope The scope in which to define this construct
