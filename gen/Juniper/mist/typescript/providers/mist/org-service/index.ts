// https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service
...
export interface OrgServiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#addresses OrgService#addresses}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#app_categories OrgService#app_categories}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#app_subcategories OrgService#app_subcategories}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#apps OrgService#apps}
  */
  readonly apps?: string[];
  /**
  * 0 means unlimited, value from 0 to 107374182
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#client_limit_down OrgService#client_limit_down}
  */
  readonly clientLimitDown?: number;
  /**
  * 0 means unlimited, value from 0 to 107374182
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#client_limit_up OrgService#client_limit_up}
  */
  readonly clientLimitUp?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#description OrgService#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#dscp OrgService#dscp}
  */
  readonly dscp?: string;
  /**
  * enum: `non_revertible`, `none`, `revertible`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#failover_policy OrgService#failover_policy}
  */
  readonly failoverPolicy?: string;
  /**
  * If `type`==`custom`, web filtering
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#hostnames OrgService#hostnames}
  */
  readonly hostnames?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#max_jitter OrgService#max_jitter}
  */
  readonly maxJitter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#max_latency OrgService#max_latency}
  */
  readonly maxLatency?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#max_loss OrgService#max_loss}
  */
  readonly maxLoss?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#name OrgService#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#org_id OrgService#org_id}
  */
  readonly orgId: string;
  /**
  * 0 means unlimited, value from 0 to 107374182
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#service_limit_down OrgService#service_limit_down}
  */
  readonly serviceLimitDown?: number;
  /**
  * 0 means unlimited, value from 0 to 107374182
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#service_limit_up OrgService#service_limit_up}
  */
  readonly serviceLimitUp?: number;
  /**
  * Whether to enable measure SLE
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#sle_enabled OrgService#sle_enabled}
  */
  readonly sleEnabled?: boolean | cdktf.IResolvable;
  /**
  * When `type`==`custom`, optional, if it doesn't exist, http and https is assumed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#specs OrgService#specs}
  */
  readonly specs?: OrgServiceSpecs[] | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#ssr_relaxed_tcp_state_enforcement OrgService#ssr_relaxed_tcp_state_enforcement}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#traffic_class OrgService#traffic_class}
  */
  readonly trafficClass?: string;
  /**
  * values from [List Traffic Types]($e/Constants%20Definitions/listTrafficTypes)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#traffic_type OrgService#traffic_type}
  */
  readonly trafficType?: string;
  /**
  * enum: `app_categories`, `apps`, `custom`, `urls`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#type OrgService#type}
  */
  readonly type?: string;
  /**
  * When `type`==`urls`, no need for spec as URL can encode the ports being used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#urls OrgService#urls}
  */
...
export interface OrgServiceSpecs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#port_range OrgService#port_range}
  */
  readonly portRange?: string;
  /**
  * `https`/ `tcp` / `udp` / `icmp` / `gre` / `any` / `:protocol_number`, `protocol_number` is between 1-254
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#protocol OrgService#protocol}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service mist_org_service}
*/
export class OrgService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgService that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_service mist_org_service} Resource
  *
  * @param scope The scope in which to define this construct
