// https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/device_versions
...
export interface DataMistDeviceVersionsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/device_versions#model DataMistDeviceVersions#model}
  */
  readonly model: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/device_versions#org_id DataMistDeviceVersions#org_id}
  */
  readonly orgId: string;
  /**
  * enum: `ap`, `gateway`, `switch`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/device_versions#type DataMistDeviceVersions#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/device_versions mist_device_versions}
*/
export class DataMistDeviceVersions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistDeviceVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/device_versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/device_versions mist_device_versions} Data Source
  *
  * @param scope The scope in which to define this construct
