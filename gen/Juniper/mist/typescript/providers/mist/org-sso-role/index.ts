// https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso_role
...
export interface OrgSsoRoleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso_role#name OrgSsoRole#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso_role#org_id OrgSsoRole#org_id}
  */
  readonly orgId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso_role#privileges OrgSsoRole#privileges}
  */
...
export interface OrgSsoRolePrivileges {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso_role#role OrgSsoRole#role}
  */
  readonly role: string;
  /**
  * enum: `org`, `site`, `sitegroup`, `orgsites`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso_role#scope OrgSsoRole#scope}
  */
  readonly scope: string;
  /**
  * Required if `scope`==`site`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso_role#site_id OrgSsoRole#site_id}
  */
  readonly siteId?: string;
  /**
  * Required if `scope`==`sitegroup`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso_role#sitegroup_id OrgSsoRole#sitegroup_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso_role#views OrgSsoRole#views}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso_role mist_org_sso_role}
*/
export class OrgSsoRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgSsoRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_sso_role mist_org_sso_role} Resource
  *
  * @param scope The scope in which to define this construct
