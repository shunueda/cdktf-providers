// https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_vpns
...
export interface DataMistOrgVpnsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_vpns#org_id DataMistOrgVpns#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_vpns mist_org_vpns}
*/
export class DataMistOrgVpns extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistOrgVpns that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_vpns#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_vpns mist_org_vpns} Data Source
  *
  * @param scope The scope in which to define this construct
