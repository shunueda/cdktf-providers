// https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_networks
...
export interface DataMistOrgNetworksConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_networks#org_id DataMistOrgNetworks#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_networks mist_org_networks}
*/
export class DataMistOrgNetworks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistOrgNetworks that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_networks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_networks mist_org_networks} Data Source
  *
  * @param scope The scope in which to define this construct
