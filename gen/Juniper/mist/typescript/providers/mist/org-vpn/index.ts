// https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn
...
export interface OrgVpnConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#name OrgVpn#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#org_id OrgVpn#org_id}
  */
  readonly orgId?: string;
  /**
  * Only if `type`==`hub_spoke`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#path_selection OrgVpn#path_selection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#paths OrgVpn#paths}
  */
  readonly paths: { [key: string]: OrgVpnPaths } | cdktf.IResolvable;
  /**
  * enum: `hub_spoke`, `mesh`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#type OrgVpn#type}
  */
...
export interface OrgVpnPathSelection {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#strategy OrgVpn#strategy}
  */
...
export interface OrgVpnPathsPeerPaths {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#preference OrgVpn#preference}
  */
...
export interface OrgVpnPathsTrafficShaping {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#class_percentage OrgVpn#class_percentage}
  */
  readonly classPercentage?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#enabled OrgVpn#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#max_tx_kbps OrgVpn#max_tx_kbps}
  */
...
export interface OrgVpnPaths {
  ...
  * enum: `broadband`, `lte`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#bfd_profile OrgVpn#bfd_profile}
  */
  readonly bfdProfile?: string;
  /**
  * If `type`==`mesh` and for SSR only, whether to use tunnel mode
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#bfd_use_tunnel_mode OrgVpn#bfd_use_tunnel_mode}
  */
  readonly bfdUseTunnelMode?: boolean | cdktf.IResolvable;
  /**
  * If different from the wan port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#ip OrgVpn#ip}
  */
  readonly ip?: string;
  /**
  * If `type`==`mesh`, Property key is the Peer Interface name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#peer_paths OrgVpn#peer_paths}
  */
  readonly peerPaths?: { [key: string]: OrgVpnPathsPeerPaths } | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#pod OrgVpn#pod}
  */
  readonly pod?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#traffic_shaping OrgVpn#traffic_shaping}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn mist_org_vpn}
*/
export class OrgVpn extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgVpn that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/resources/org_vpn mist_org_vpn} Resource
  *
  * @param scope The scope in which to define this construct
