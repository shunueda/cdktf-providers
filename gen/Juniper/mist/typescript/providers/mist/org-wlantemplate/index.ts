// https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wlantemplate
...
export interface OrgWlantemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wlantemplate#applies OrgWlantemplate#applies}
  */
  readonly applies?: OrgWlantemplateApplies;
  /**
  * List of Device Profile ids
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wlantemplate#deviceprofile_ids OrgWlantemplate#deviceprofile_ids}
  */
  readonly deviceprofileIds?: string[];
  /**
  * Where this template should not be applied to (takes precedence)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wlantemplate#exceptions OrgWlantemplate#exceptions}
  */
  readonly exceptions?: OrgWlantemplateExceptions;
  /**
  * Whether to further filter by Device Profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wlantemplate#filter_by_deviceprofile OrgWlantemplate#filter_by_deviceprofile}
  */
  readonly filterByDeviceprofile?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wlantemplate#name OrgWlantemplate#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wlantemplate#org_id OrgWlantemplate#org_id}
  */
...
export interface OrgWlantemplateApplies {
  ...
  * List of site ids
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wlantemplate#site_ids OrgWlantemplate#site_ids}
  */
  readonly siteIds?: string[];
  /**
  * List of sitegroup ids
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wlantemplate#sitegroup_ids OrgWlantemplate#sitegroup_ids}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wlantemplate mist_org_wlantemplate}
*/
export class OrgWlantemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgWlantemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wlantemplate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_wlantemplate mist_org_wlantemplate} Resource
  *
  * @param scope The scope in which to define this construct
