// https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_alarmtemplate
...
export interface OrgAlarmtemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_alarmtemplate#delivery OrgAlarmtemplate#delivery}
  */
  readonly delivery: OrgAlarmtemplateDelivery;
  /**
  * Some string to name the alarm template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_alarmtemplate#name OrgAlarmtemplate#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_alarmtemplate#org_id OrgAlarmtemplate#org_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_alarmtemplate#rules OrgAlarmtemplate#rules}
  */
...
export interface OrgAlarmtemplateDelivery {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_alarmtemplate#additional_emails OrgAlarmtemplate#additional_emails}
  */
  readonly additionalEmails?: string[];
  /**
  * Whether to enable the alarm delivery via emails or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_alarmtemplate#enabled OrgAlarmtemplate#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Whether to deliver the alarms via emails to Org admins or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_alarmtemplate#to_org_admins OrgAlarmtemplate#to_org_admins}
  */
  readonly toOrgAdmins?: boolean | cdktf.IResolvable;
  /**
  * Whether to deliver the alarms via emails to Site admins or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_alarmtemplate#to_site_admins OrgAlarmtemplate#to_site_admins}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_alarmtemplate mist_org_alarmtemplate}
*/
export class OrgAlarmtemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgAlarmtemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_alarmtemplate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/resources/org_alarmtemplate mist_org_alarmtemplate} Resource
  *
  * @param scope The scope in which to define this construct
