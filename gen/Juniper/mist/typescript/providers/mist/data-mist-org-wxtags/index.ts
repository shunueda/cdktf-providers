// https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_wxtags
...
export interface DataMistOrgWxtagsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_wxtags#org_id DataMistOrgWxtags#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_wxtags mist_org_wxtags}
*/
export class DataMistOrgWxtags extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistOrgWxtags that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_wxtags#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/data-sources/org_wxtags mist_org_wxtags} Data Source
  *
  * @param scope The scope in which to define this construct
