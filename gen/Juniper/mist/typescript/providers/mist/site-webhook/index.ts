// https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook
...
export interface SiteWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#assetfilter_ids SiteWebhook#assetfilter_ids}
  */
  readonly assetfilterIds?: string[];
  /**
  * Whether webhook is enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#enabled SiteWebhook#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#headers SiteWebhook#headers}
  */
  readonly headers?: { [key: string]: string };
  /**
  * Name of the webhook
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#name SiteWebhook#name}
  */
  readonly name: string;
  /**
  * Required when `oauth2_grant_type`==`client_credentials`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#oauth2_client_id SiteWebhook#oauth2_client_id}
  */
  readonly oauth2ClientId?: string;
  /**
  * Required when `oauth2_grant_type`==`client_credentials`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#oauth2_client_secret SiteWebhook#oauth2_client_secret}
  */
  readonly oauth2ClientSecret?: string;
  /**
  * required when `type`==`oauth2`. enum: `client_credentials`, `password`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#oauth2_grant_type SiteWebhook#oauth2_grant_type}
  */
  readonly oauth2GrantType?: string;
  /**
  * Required when `oauth2_grant_type`==`password`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#oauth2_password SiteWebhook#oauth2_password}
  */
  readonly oauth2Password?: string;
  /**
  * Required when `type`==`oauth2`, if provided, will be used in the token request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#oauth2_scopes SiteWebhook#oauth2_scopes}
  */
  readonly oauth2Scopes?: string[];
  /**
  * Required when `type`==`oauth2`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#oauth2_token_url SiteWebhook#oauth2_token_url}
  */
  readonly oauth2TokenUrl?: string;
  /**
  * Required when `oauth2_grant_type`==`password`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#oauth2_username SiteWebhook#oauth2_username}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#secret SiteWebhook#secret}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#single_event_per_message SiteWebhook#single_event_per_message}
  */
  readonly singleEventPerMessage?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#site_id SiteWebhook#site_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#splunk_token SiteWebhook#splunk_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#topics SiteWebhook#topics}
  */
  readonly topics: string[];
  /**
  * enum: `aws-sns`, `google-pubsub`, `http-post`, `oauth2`, `splunk`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#type SiteWebhook#type}
  */
  readonly type?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#url SiteWebhook#url}
  */
  readonly url: string;
  /**
  * When url uses HTTPS, whether to verify the certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#verify_cert SiteWebhook#verify_cert}
  */
  readonly verifyCert?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook mist_site_webhook}
*/
export class SiteWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SiteWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/site_webhook mist_site_webhook} Resource
  *
  * @param scope The scope in which to define this construct
