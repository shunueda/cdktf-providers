// https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_apitoken
...
export interface OrgApitokenConfig extends cdktf.TerraformMetaArguments {
  ...
  * Name of the token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_apitoken#name OrgApitoken#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_apitoken#org_id OrgApitoken#org_id}
  */
  readonly orgId: string;
  /**
  * List of privileges the token has on the orgs/sites
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_apitoken#privileges OrgApitoken#privileges}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_apitoken#src_ips OrgApitoken#src_ips}
  */
...
export interface OrgApitokenPrivileges {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_apitoken#role OrgApitoken#role}
  */
  readonly role: string;
  /**
  * enum: `org`, `site`, `sitegroup`, `orgsites`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_apitoken#scope OrgApitoken#scope}
  */
  readonly scope: string;
  /**
  * Required if `scope`==`site`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_apitoken#site_id OrgApitoken#site_id}
  */
  readonly siteId?: string;
  /**
  * Required if `scope`==`sitegroup`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_apitoken#sitegroup_id OrgApitoken#sitegroup_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_apitoken mist_org_apitoken}
*/
export class OrgApitoken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgApitoken that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_apitoken#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.1/docs/resources/org_apitoken mist_org_apitoken} Resource
  *
  * @param scope The scope in which to define this construct
