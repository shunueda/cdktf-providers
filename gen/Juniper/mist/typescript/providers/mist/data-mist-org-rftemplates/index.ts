// https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_rftemplates
...
export interface DataMistOrgRftemplatesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_rftemplates#org_id DataMistOrgRftemplates#org_id}
  */
  readonly orgId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_rftemplates#page DataMistOrgRftemplates#page}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_rftemplates mist_org_rftemplates}
*/
export class DataMistOrgRftemplates extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistOrgRftemplates that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_rftemplates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_rftemplates mist_org_rftemplates} Data Source
  *
  * @param scope The scope in which to define this construct
