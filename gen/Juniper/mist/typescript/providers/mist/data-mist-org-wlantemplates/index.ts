// https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_wlantemplates
...
export interface DataMistOrgWlantemplatesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_wlantemplates#org_id DataMistOrgWlantemplates#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_wlantemplates mist_org_wlantemplates}
*/
export class DataMistOrgWlantemplates extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistOrgWlantemplates that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_wlantemplates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_wlantemplates mist_org_wlantemplates} Data Source
  *
  * @param scope The scope in which to define this construct
