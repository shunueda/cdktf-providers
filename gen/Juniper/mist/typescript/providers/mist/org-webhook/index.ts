// https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook
...
export interface OrgWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#enabled OrgWebhook#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#headers OrgWebhook#headers}
  */
  readonly headers?: { [key: string]: string };
  /**
  * Name of the webhook
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#name OrgWebhook#name}
  */
  readonly name: string;
  /**
  * Required when `oauth2_grant_type`==`client_credentials`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#oauth2_client_id OrgWebhook#oauth2_client_id}
  */
  readonly oauth2ClientId?: string;
  /**
  * Required when `oauth2_grant_type`==`client_credentials`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#oauth2_client_secret OrgWebhook#oauth2_client_secret}
  */
  readonly oauth2ClientSecret?: string;
  /**
  * required when `type`==`oauth2`. enum: `client_credentials`, `password`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#oauth2_grant_type OrgWebhook#oauth2_grant_type}
  */
  readonly oauth2GrantType?: string;
  /**
  * Required when `oauth2_grant_type`==`password`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#oauth2_password OrgWebhook#oauth2_password}
  */
  readonly oauth2Password?: string;
  /**
  * Required when `type`==`oauth2`, if provided, will be used in the token request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#oauth2_scopes OrgWebhook#oauth2_scopes}
  */
  readonly oauth2Scopes?: string[];
  /**
  * Required when `type`==`oauth2`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#oauth2_token_url OrgWebhook#oauth2_token_url}
  */
  readonly oauth2TokenUrl?: string;
  /**
  * Required when `oauth2_grant_type`==`password`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#oauth2_username OrgWebhook#oauth2_username}
  */
  readonly oauth2Username?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#org_id OrgWebhook#org_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#secret OrgWebhook#secret}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#single_event_per_message OrgWebhook#single_event_per_message}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#splunk_token OrgWebhook#splunk_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#topics OrgWebhook#topics}
  */
  readonly topics: string[];
  /**
  * enum: `aws-sns`, `google-pubsub`, `http-post`, `oauth2`, `splunk`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#type OrgWebhook#type}
  */
  readonly type?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#url OrgWebhook#url}
  */
  readonly url: string;
  /**
  * When url uses HTTPS, whether to verify the certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#verify_cert OrgWebhook#verify_cert}
  */
  readonly verifyCert?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook mist_org_webhook}
*/
export class OrgWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_webhook mist_org_webhook} Resource
  *
  * @param scope The scope in which to define this construct
