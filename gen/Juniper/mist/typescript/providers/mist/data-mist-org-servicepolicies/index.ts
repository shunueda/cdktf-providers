// https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_servicepolicies
...
export interface DataMistOrgServicepoliciesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_servicepolicies#org_id DataMistOrgServicepolicies#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_servicepolicies mist_org_servicepolicies}
*/
export class DataMistOrgServicepolicies extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistOrgServicepolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_servicepolicies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.3/docs/data-sources/org_servicepolicies mist_org_servicepolicies} Data Source
  *
  * @param scope The scope in which to define this construct
