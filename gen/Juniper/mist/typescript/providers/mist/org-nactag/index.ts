// https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag
...
export interface OrgNactagConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#allow_usermac_override OrgNactag#allow_usermac_override}
  */
  readonly allowUsermacOverride?: boolean | cdktf.IResolvable;
  /**
  * If `type`==`egress_vlan_names`, list of egress vlans to return
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#egress_vlan_names OrgNactag#egress_vlan_names}
  */
  readonly egressVlanNames?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#gbp_tag OrgNactag#gbp_tag}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#match OrgNactag#match}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#match_all OrgNactag#match_all}
  */
  readonly matchAll?: boolean | cdktf.IResolvable;
  /**
  * If `type`==`redirect_nacportal_id`, the ID of the NAC portal to redirect to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#nacportal_id OrgNactag#nacportal_id}
  */
  readonly nacportalId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#name OrgNactag#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#org_id OrgNactag#org_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#radius_attrs OrgNactag#radius_attrs}
  */
  readonly radiusAttrs?: string[];
  /**
  * If `type`==`radius_group`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#radius_group OrgNactag#radius_group}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#radius_vendor_attrs OrgNactag#radius_vendor_attrs}
  */
  readonly radiusVendorAttrs?: string[];
  /**
  * If `type`==`session_timeout, in seconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#session_timeout OrgNactag#session_timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#type OrgNactag#type}
  */
  readonly type: string;
  /**
  * enum: `automatic`, `cn`, `dns`, `email`, `upn`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#username_attr OrgNactag#username_attr}
  */
  readonly usernameAttr?: string;
  /**
  * If `type`==`match`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#values OrgNactag#values}
  */
  readonly values?: string[];
  /**
  * If `type`==`vlan`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#vlan OrgNactag#vlan}
  */
  readonly vlan?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag mist_org_nactag}
*/
export class OrgNactag extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgNactag that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.0/docs/resources/org_nactag mist_org_nactag} Resource
  *
  * @param scope The scope in which to define this construct
