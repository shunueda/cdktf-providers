// https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/data-sources/org_idpprofiles
...
export interface DataMistOrgIdpprofilesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/data-sources/org_idpprofiles#org_id DataMistOrgIdpprofiles#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/data-sources/org_idpprofiles mist_org_idpprofiles}
*/
export class DataMistOrgIdpprofiles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMistOrgIdpprofiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/data-sources/org_idpprofiles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/mist/0.6.2/docs/data-sources/org_idpprofiles mist_org_idpprofiles} Data Source
  *
  * @param scope The scope in which to define this construct
