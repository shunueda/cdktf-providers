// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration
...
export interface MunkiConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration#auto_failed_install_incidents MunkiConfiguration#auto_failed_install_incidents}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration#auto_reinstall_incidents MunkiConfiguration#auto_reinstall_incidents}
  */
  readonly autoReinstallIncidents?: boolean | cdktf.IResolvable;
  /**
  * Set of the condition keys to collect.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration#collected_condition_keys MunkiConfiguration#collected_condition_keys}
  */
  readonly collectedConditionKeys?: string[];
  /**
  * Description of the Munki configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration#description MunkiConfiguration#description}
  */
  readonly description?: string;
  /**
  * Percentage of machines configured to collect the full inventory apps information. Defaults to `100`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration#inventory_apps_full_info_shard MunkiConfiguration#inventory_apps_full_info_shard}
  */
  readonly inventoryAppsFullInfoShard?: number;
  /**
  * Interval in days between full managed installs sync. Defaults to 7 days.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration#managed_installs_sync_interval_days MunkiConfiguration#managed_installs_sync_interval_days}
  */
  readonly managedInstallsSyncIntervalDays?: number;
  /**
  * Name of the Munki configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration#name MunkiConfiguration#name}
  */
  readonly name: string;
  /**
  * Set of principal user detection domains.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration#principal_user_detection_domains MunkiConfiguration#principal_user_detection_domains}
  */
  readonly principalUserDetectionDomains?: string[];
  /**
  * List of principal user detection sources.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration#principal_user_detection_sources MunkiConfiguration#principal_user_detection_sources}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration#script_checks_run_interval_seconds MunkiConfiguration#script_checks_run_interval_seconds}
  */
  readonly scriptChecksRunIntervalSeconds?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration zentral_munki_configuration}
*/
export class MunkiConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MunkiConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/munki_configuration zentral_munki_configuration} Resource
  *
  * @param scope The scope in which to define this construct
