// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/monolith_manifest_catalog
...
export interface MonolithManifestCatalogConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the catalog.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/monolith_manifest_catalog#catalog_id MonolithManifestCatalog#catalog_id}
  */
  readonly catalogId: number;
  /**
  * ID of the manifest.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/monolith_manifest_catalog#manifest_id MonolithManifestCatalog#manifest_id}
  */
  readonly manifestId: number;
  /**
  * The `ID`s of the tags used to scope the catalog.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/monolith_manifest_catalog#tag_ids MonolithManifestCatalog#tag_ids}
  */
  readonly tagIds?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/monolith_manifest_catalog zentral_monolith_manifest_catalog}
*/
export class MonolithManifestCatalog extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonolithManifestCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/monolith_manifest_catalog#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/monolith_manifest_catalog zentral_monolith_manifest_catalog} Resource
  *
  * @param scope The scope in which to define this construct
