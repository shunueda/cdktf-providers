// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/mdm_location
...
export interface DataZentralMdmLocationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/mdm_location#id DataZentralMdmLocation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/mdm_location#mdm_info_id DataZentralMdmLocation#mdm_info_id}
  */
  readonly mdmInfoId?: string;
  /**
  * Name of the location.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/mdm_location#name DataZentralMdmLocation#name}
  */
  readonly name?: string;
  /**
  * Name of the location organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/mdm_location#organization_name DataZentralMdmLocation#organization_name}
  */
  readonly organizationName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/mdm_location zentral_mdm_location}
*/
export class DataZentralMdmLocation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralMdmLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/mdm_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/mdm_location zentral_mdm_location} Data Source
  *
  * @param scope The scope in which to define this construct
