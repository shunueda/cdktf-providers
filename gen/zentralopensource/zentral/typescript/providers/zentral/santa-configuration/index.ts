// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration
...
export interface SantaConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#allow_unknown_shard SantaConfiguration#allow_unknown_shard}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#allowed_path_regex SantaConfiguration#allowed_path_regex}
  */
  readonly allowedPathRegex?: string;
  /**
  * The number of rules to download or events to upload per request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#batch_size SantaConfiguration#batch_size}
  */
  readonly batchSize?: number;
  /**
  * If set to `true` blocking USB Mass storage feature is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#block_usb_mount SantaConfiguration#block_usb_mount}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#blocked_path_regex SantaConfiguration#blocked_path_regex}
  */
  readonly blockedPathRegex?: string;
  /**
  * If `true`, mTLS is required between Santa and Zentral.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#client_certificate_auth SantaConfiguration#client_certificate_auth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#client_mode SantaConfiguration#client_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#enable_all_event_upload_shard SantaConfiguration#enable_all_event_upload_shard}
  */
  readonly enableAllEventUploadShard?: number;
  /**
  * If set to `true` the bundle scanning feature is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#enable_bundles SantaConfiguration#enable_bundles}
  */
  readonly enableBundles?: boolean | cdktf.IResolvable;
  /**
  * If set to `true` the transitive rule feature is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#enable_transitive_rules SantaConfiguration#enable_transitive_rules}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#full_sync_interval SantaConfiguration#full_sync_interval}
  */
  readonly fullSyncInterval?: number;
  /**
  * Name of the Santa configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#name SantaConfiguration#name}
  */
  readonly name: string;
  /**
  * Array of strings for arguments to pass to `mount -o`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#remount_usb_mode SantaConfiguration#remount_usb_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#sync_incident_severity SantaConfiguration#sync_incident_severity}
  */
  readonly syncIncidentSeverity?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration zentral_santa_configuration}
*/
export class SantaConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SantaConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/santa_configuration zentral_santa_configuration} Resource
  *
  * @param scope The scope in which to define this construct
