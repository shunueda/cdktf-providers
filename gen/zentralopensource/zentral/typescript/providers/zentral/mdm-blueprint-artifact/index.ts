// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact
...
export interface MdmBlueprintArtifactConfig extends cdktf.TerraformMetaArguments {
  /**
  * `ID` of the blueprint artifact artifact.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#artifact_id MdmBlueprintArtifact#artifact_id}
  */
  readonly artifactId: string;
  /**
  * `ID` of the blueprint artifact blueprint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#blueprint_id MdmBlueprintArtifact#blueprint_id}
  */
  readonly blueprintId: number;
  /**
  * The default shard value. Defaults to `100`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#default_shard MdmBlueprintArtifact#default_shard}
  */
  readonly defaultShard?: number;
  /**
  * Machines tagged with one of these tags will not receive the blueprint artifact.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#excluded_tag_ids MdmBlueprintArtifact#excluded_tag_ids}
  */
  readonly excludedTagIds?: number[];
  /**
  * Toggles the installation of the blueprint artifact on iOS devices.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#ios MdmBlueprintArtifact#ios}
  */
  readonly ios?: boolean | cdktf.IResolvable;
  /**
  * Devices with this iOS version or higher will **not** receive this blueprint artifact.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#ios_max_version MdmBlueprintArtifact#ios_max_version}
  */
  readonly iosMaxVersion?: string;
  /**
  * Devices with this iOS version or higher will receive this blueprint artifact.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#ios_min_version MdmBlueprintArtifact#ios_min_version}
  */
  readonly iosMinVersion?: string;
  /**
  * Toggles the installation of the blueprint artifact on iPadOS devices.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#ipados MdmBlueprintArtifact#ipados}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#ipados_max_version MdmBlueprintArtifact#ipados_max_version}
  */
  readonly ipadosMaxVersion?: string;
  /**
  * Devices with this iPadOS version or higher will receive this blueprint artifact.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#ipados_min_version MdmBlueprintArtifact#ipados_min_version}
  */
  readonly ipadosMinVersion?: string;
  /**
  * Toggles the installation of the blueprint artifact on macOS devices.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#macos MdmBlueprintArtifact#macos}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#macos_max_version MdmBlueprintArtifact#macos_max_version}
  */
  readonly macosMaxVersion?: string;
  /**
  * Devices with this macOS version or higher will receive this blueprint artifact.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#macos_min_version MdmBlueprintArtifact#macos_min_version}
  */
  readonly macosMinVersion?: string;
  /**
  * The modulo used to calculate the shards. Defaults to `100`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#shard_modulo MdmBlueprintArtifact#shard_modulo}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#tag_shards MdmBlueprintArtifact#tag_shards}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#tvos MdmBlueprintArtifact#tvos}
  */
  readonly tvos?: boolean | cdktf.IResolvable;
  /**
  * Devices with this tvOS version or higher will **not** receive this blueprint artifact.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#tvos_max_version MdmBlueprintArtifact#tvos_max_version}
  */
  readonly tvosMaxVersion?: string;
  /**
  * Devices with this tvOS version or higher will receive this blueprint artifact.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#tvos_min_version MdmBlueprintArtifact#tvos_min_version}
  */
  readonly tvosMinVersion?: string;
}
export interface MdmBlueprintArtifactTagShards {
  /**
  * The shard for the tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#shard MdmBlueprintArtifact#shard}
  */
  readonly shard: number;
  /**
  * The `ID` of the tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#tag_id MdmBlueprintArtifact#tag_id}
  */
  readonly tagId: number;
}

export function mdmBlueprintArtifactTagShardsToTerraform(struct?: MdmBlueprintArtifactTagShards | cdktf.IResolvable): any {
...
export function mdmBlueprintArtifactTagShardsToHclTerraform(struct?: MdmBlueprintArtifactTagShards | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class MdmBlueprintArtifactTagShardsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MdmBlueprintArtifactTagShards | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: MdmBlueprintArtifactTagShards | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class MdmBlueprintArtifactTagShardsList extends cdktf.ComplexList {
  public internalValue? : MdmBlueprintArtifactTagShards[] | cdktf.IResolvable
  ...
  */
  public get(index: number): MdmBlueprintArtifactTagShardsOutputReference {
    return new MdmBlueprintArtifactTagShardsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact zentral_mdm_blueprint_artifact}
*/
export class MdmBlueprintArtifact extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "zentral_mdm_blueprint_artifact";
  ...
  * @param importFromId The id of the existing MdmBlueprintArtifact that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "zentral_mdm_blueprint_artifact", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint_artifact zentral_mdm_blueprint_artifact} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options MdmBlueprintArtifactConfig
  */
  public constructor(scope: Construct, id: string, config: MdmBlueprintArtifactConfig) {
    super(scope, id, {
  ...
  private _tagShards = new MdmBlueprintArtifactTagShardsList(this, "tag_shards", true);
  public get tagShards() {
    return this._tagShards;
  }
  public putTagShards(value: MdmBlueprintArtifactTagShards[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tag_shards: cdktf.listMapper(mdmBlueprintArtifactTagShardsToTerraform, false)(this._tagShards.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tag_shards: {
        value: cdktf.listMapperHcl(mdmBlueprintArtifactTagShardsToHclTerraform, false)(this._tagShards.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "MdmBlueprintArtifactTagShardsList",
      },
      tvos: {
