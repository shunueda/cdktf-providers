// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/probe_action
...
export interface DataZentralProbeActionConfig extends cdktf.TerraformMetaArguments {
  ...
  * `ID` of the action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/probe_action#id DataZentralProbeAction#id}
  *
  ...
  * Name of the action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/probe_action#name DataZentralProbeAction#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/probe_action zentral_probe_action}
*/
export class DataZentralProbeAction extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralProbeAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/probe_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/probe_action zentral_probe_action} Data Source
  *
  * @param scope The scope in which to define this construct
