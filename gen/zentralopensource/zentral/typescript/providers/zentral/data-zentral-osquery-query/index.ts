// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/osquery_query
...
export interface DataZentralOsqueryQueryConfig extends cdktf.TerraformMetaArguments {
  ...
  * `ID` of the query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/osquery_query#id DataZentralOsqueryQuery#id}
  *
  ...
  * Name of the query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/osquery_query#name DataZentralOsqueryQuery#name}
  */
  readonly name?: string;
  /**
  * Attributes to link a query to a pack for scheduling.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/osquery_query#scheduling DataZentralOsqueryQuery#scheduling}
  */
  readonly scheduling?: DataZentralOsqueryQueryScheduling;
  /**
  * `ID` of the machine tag that is updated by this query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/osquery_query#tag_id DataZentralOsqueryQuery#tag_id}
  */
...
export interface DataZentralOsqueryQueryScheduling {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/osquery_query#shard DataZentralOsqueryQuery#shard}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/osquery_query zentral_osquery_query}
*/
export class DataZentralOsqueryQuery extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralOsqueryQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/osquery_query#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/osquery_query zentral_osquery_query} Data Source
  *
  * @param scope The scope in which to define this construct
