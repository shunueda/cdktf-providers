// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query
...
export interface OsqueryQueryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#compliance_check_enabled OsqueryQuery#compliance_check_enabled}
  */
  readonly complianceCheckEnabled?: boolean | cdktf.IResolvable;
  /**
  * Description of the query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#description OsqueryQuery#description}
  */
  readonly description?: string;
  /**
  * Only run on Osquery versions greater than or equal-to this version string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#minimum_osquery_version OsqueryQuery#minimum_osquery_version}
  */
  readonly minimumOsqueryVersion?: string;
  /**
  * Name of the query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#name OsqueryQuery#name}
  */
  readonly name: string;
  /**
  * Restrict the query to some platforms, default is 'all' platforms
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#platforms OsqueryQuery#platforms}
  */
  readonly platforms?: string[];
  /**
  * Attributes to link a query to a pack for scheduling.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#scheduling OsqueryQuery#scheduling}
  */
  readonly scheduling?: OsqueryQueryScheduling;
  /**
  * The SQL query to run.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#sql OsqueryQuery#sql}
  */
  readonly sql: string;
  /**
  * `ID` of the machine tag that is updated by this query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#tag_id OsqueryQuery#tag_id}
  */
  readonly tagId?: number;
  /**
  * Description of the results returned by the query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#value OsqueryQuery#value}
  */
...
export interface OsqueryQueryScheduling {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#can_be_denylisted OsqueryQuery#can_be_denylisted}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#interval OsqueryQuery#interval}
  */
  readonly interval: number;
  /**
  * If `true`, remove actions should be logged. Default to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#log_removed_actions OsqueryQuery#log_removed_actions}
  */
  readonly logRemovedActions?: boolean | cdktf.IResolvable;
  /**
  * The `ID` of the pack.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#pack_id OsqueryQuery#pack_id}
  */
  readonly packId: number;
  /**
  * Restrict this query to a percentage (1-100) of target hosts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#shard OsqueryQuery#shard}
  */
  readonly shard?: number;
  /**
  * If `true`, differentials will not be stored and this query will not emulate an event stream. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#snapshot_mode OsqueryQuery#snapshot_mode}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query zentral_osquery_query}
*/
export class OsqueryQuery extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OsqueryQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_query zentral_osquery_query} Resource
  *
  * @param scope The scope in which to define this construct
