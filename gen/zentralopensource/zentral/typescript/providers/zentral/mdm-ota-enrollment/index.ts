// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment
...
export interface MdmOtaEnrollmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment#acme_issuer_id MdmOtaEnrollment#acme_issuer_id}
  */
  readonly acmeIssuerId?: string;
  /**
  * `ID` of the MDM blueprint linked to the OTA enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment#blueprint_id MdmOtaEnrollment#blueprint_id}
  */
  readonly blueprintId?: number;
  /**
  * Name of the MDM OTA enrollment as displayed on the device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment#display_name MdmOtaEnrollment#display_name}
  */
  readonly displayName?: string;
  /**
  * The `ID` of the meta business unit the machine will be assigned to at enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment#meta_business_unit_id MdmOtaEnrollment#meta_business_unit_id}
  */
  readonly metaBusinessUnitId: number;
  /**
  * Name of the MDM OTA enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment#name MdmOtaEnrollment#name}
  */
  readonly name: string;
  /**
  * `ID` of the MDM push certificate linked to the OTA enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment#push_certificate_id MdmOtaEnrollment#push_certificate_id}
  */
  readonly pushCertificateId: number;
  /**
  * The number of time the enrollment can be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment#quota MdmOtaEnrollment#quota}
  */
  readonly quota?: number;
  /**
  * `UUID` of the identity realm linked to the OTA enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment#realm_uuid MdmOtaEnrollment#realm_uuid}
  */
  readonly realmUuid?: string;
  /**
  * `ID` of the MDM SCEP issuer linked to the OTA enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment#scep_issuer_id MdmOtaEnrollment#scep_issuer_id}
  */
  readonly scepIssuerId: string;
  /**
  * The serial numbers the enrollment is restricted to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment#serial_numbers MdmOtaEnrollment#serial_numbers}
  */
  readonly serialNumbers?: string[];
  /**
  * The `ID`s of the tags that the machine will get at enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment#tag_ids MdmOtaEnrollment#tag_ids}
  */
  readonly tagIds?: number[];
  /**
  * The `UDID`s the enrollment is restricted to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment#udids MdmOtaEnrollment#udids}
  */
  readonly udids?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment zentral_mdm_ota_enrollment}
*/
export class MdmOtaEnrollment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MdmOtaEnrollment that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_ota_enrollment zentral_mdm_ota_enrollment} Resource
  *
  * @param scope The scope in which to define this construct
