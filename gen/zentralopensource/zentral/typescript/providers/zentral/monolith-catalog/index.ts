// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_catalog
...
export interface MonolithCatalogConfig extends cdktf.TerraformMetaArguments {
  ...
  * Name of the catalog.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_catalog#name MonolithCatalog#name}
  */
  readonly name: string;
  /**
  * `ID` of the Monolith repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_catalog#repository_id MonolithCatalog#repository_id}
  */
  readonly repositoryId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_catalog zentral_monolith_catalog}
*/
export class MonolithCatalog extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonolithCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_catalog#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_catalog zentral_monolith_catalog} Resource
  *
  * @param scope The scope in which to define this construct
