// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_configuration
...
export interface OsqueryConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_configuration#atc_ids OsqueryConfiguration#atc_ids}
  */
  readonly atcIds?: number[];
  /**
  * Description of the Osquery configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_configuration#description OsqueryConfiguration#description}
  */
  readonly description?: string;
  /**
  * List of the IDs of the file categories to include in this configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_configuration#file_category_ids OsqueryConfiguration#file_category_ids}
  */
  readonly fileCategoryIds?: number[];
  /**
  * If `true`, Osquery is configured to collect inventory data. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_configuration#inventory OsqueryConfiguration#inventory}
  */
  readonly inventory?: boolean | cdktf.IResolvable;
  /**
  * If `true`, Osquery is configured to collect the applications. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_configuration#inventory_apps OsqueryConfiguration#inventory_apps}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_configuration#inventory_ec2 OsqueryConfiguration#inventory_ec2}
  */
  readonly inventoryEc2?: boolean | cdktf.IResolvable;
  /**
  * Number of seconds to wait between collecting the inventory data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_configuration#inventory_interval OsqueryConfiguration#inventory_interval}
  */
  readonly inventoryInterval?: number;
  /**
  * Name of the Osquery configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_configuration#name OsqueryConfiguration#name}
  */
  readonly name: string;
  /**
  * A map of extra options to pass to Osquery in the flag file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_configuration#options OsqueryConfiguration#options}
  */
  readonly options?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_configuration zentral_osquery_configuration}
*/
export class OsqueryConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OsqueryConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_configuration zentral_osquery_configuration} Resource
  *
  * @param scope The scope in which to define this construct
