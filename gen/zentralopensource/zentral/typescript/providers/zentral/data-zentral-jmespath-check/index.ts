// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/jmespath_check
...
export interface DataZentralJmespathCheckConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/jmespath_check#id DataZentralJmespathCheck#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/jmespath_check#name DataZentralJmespathCheck#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/jmespath_check zentral_jmespath_check}
*/
export class DataZentralJmespathCheck extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralJmespathCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/jmespath_check#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/jmespath_check zentral_jmespath_check} Data Source
  *
  * @param scope The scope in which to define this construct
