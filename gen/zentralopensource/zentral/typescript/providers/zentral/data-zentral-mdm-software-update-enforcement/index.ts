// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/mdm_software_update_enforcement
...
export interface DataZentralMdmSoftwareUpdateEnforcementConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/mdm_software_update_enforcement#id DataZentralMdmSoftwareUpdateEnforcement#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/mdm_software_update_enforcement#name DataZentralMdmSoftwareUpdateEnforcement#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/mdm_software_update_enforcement zentral_mdm_software_update_enforcement}
*/
export class DataZentralMdmSoftwareUpdateEnforcement extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralMdmSoftwareUpdateEnforcement that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/mdm_software_update_enforcement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/mdm_software_update_enforcement zentral_mdm_software_update_enforcement} Data Source
  *
  * @param scope The scope in which to define this construct
