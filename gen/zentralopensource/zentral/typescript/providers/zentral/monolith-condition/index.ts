// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_condition
...
export interface MonolithConditionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_condition#name MonolithCondition#name}
  */
  readonly name: string;
  /**
  * Predicate of the condition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_condition#predicate MonolithCondition#predicate}
  */
  readonly predicate: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_condition zentral_monolith_condition}
*/
export class MonolithCondition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonolithCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_condition zentral_monolith_condition} Resource
  *
  * @param scope The scope in which to define this construct
