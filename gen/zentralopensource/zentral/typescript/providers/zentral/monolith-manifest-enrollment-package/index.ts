// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/monolith_manifest_enrollment_package
...
export interface MonolithManifestEnrollmentPackageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/monolith_manifest_enrollment_package#builder MonolithManifestEnrollmentPackage#builder}
  */
  readonly builder: string;
  /**
  * ID of the enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/monolith_manifest_enrollment_package#enrollment_id MonolithManifestEnrollmentPackage#enrollment_id}
  */
  readonly enrollmentId: number;
  /**
  * ID of the manifest.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/monolith_manifest_enrollment_package#manifest_id MonolithManifestEnrollmentPackage#manifest_id}
  */
  readonly manifestId: number;
  /**
  * The `ID`s of the tags used to scope the enrollment package.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/monolith_manifest_enrollment_package#tag_ids MonolithManifestEnrollmentPackage#tag_ids}
  */
  readonly tagIds?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/monolith_manifest_enrollment_package zentral_monolith_manifest_enrollment_package}
*/
export class MonolithManifestEnrollmentPackage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonolithManifestEnrollmentPackage that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/monolith_manifest_enrollment_package#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/monolith_manifest_enrollment_package zentral_monolith_manifest_enrollment_package} Resource
  *
  * @param scope The scope in which to define this construct
