// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/osquery_enrollment
...
export interface DataZentralOsqueryEnrollmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/osquery_enrollment#id DataZentralOsqueryEnrollment#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/osquery_enrollment zentral_osquery_enrollment}
*/
export class DataZentralOsqueryEnrollment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralOsqueryEnrollment that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/osquery_enrollment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/osquery_enrollment zentral_osquery_enrollment} Data Source
  *
  * @param scope The scope in which to define this construct
