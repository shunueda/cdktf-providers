// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/osquery_pack
...
export interface DataZentralOsqueryPackConfig extends cdktf.TerraformMetaArguments {
  ...
  * `ID` of the pack.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/osquery_pack#id DataZentralOsqueryPack#id}
  *
  ...
  * Name of the pack.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/osquery_pack#name DataZentralOsqueryPack#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/osquery_pack zentral_osquery_pack}
*/
export class DataZentralOsqueryPack extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralOsqueryPack that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/osquery_pack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/osquery_pack zentral_osquery_pack} Data Source
  *
  * @param scope The scope in which to define this construct
