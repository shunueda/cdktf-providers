// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_artifact
...
export interface MdmArtifactConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_artifact#auto_update MdmArtifact#auto_update}
  */
  readonly autoUpdate?: boolean | cdktf.IResolvable;
  /**
  * Channel of the artifact.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_artifact#channel MdmArtifact#channel}
  */
  readonly channel: string;
  /**
  * If `true`, this artifact will be installed during the setup assistant. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_artifact#install_during_setup_assistant MdmArtifact#install_during_setup_assistant}
  */
  readonly installDuringSetupAssistant?: boolean | cdktf.IResolvable;
  /**
  * Name of the artifact.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_artifact#name MdmArtifact#name}
  */
  readonly name: string;
  /**
  * Platforms of the artifact.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_artifact#platforms MdmArtifact#platforms}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_artifact#reinstall_interval MdmArtifact#reinstall_interval}
  */
  readonly reinstallInterval?: number;
  /**
  * Possible values: `No`, `Major`, `Minor`, `Patch`. Defaults to `No`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_artifact#reinstall_on_os_update MdmArtifact#reinstall_on_os_update}
  */
  readonly reinstallOnOsUpdate?: string;
  /**
  * `ID`s of the artifacts required by this artifact.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_artifact#requires MdmArtifact#requires}
  */
  readonly requires?: string[];
  /**
  * Type of the artifact.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_artifact#type MdmArtifact#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_artifact zentral_mdm_artifact}
*/
export class MdmArtifact extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MdmArtifact that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_artifact#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_artifact zentral_mdm_artifact} Resource
  *
  * @param scope The scope in which to define this construct
