// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_pack
...
export interface OsqueryPackConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_pack#description OsqueryPack#description}
  */
  readonly description?: string;
  /**
  * List of osquery queries which control whether or not the pack will execute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_pack#discovery_queries OsqueryPack#discovery_queries}
  */
  readonly discoveryQueries?: string[];
  /**
  * Routing key added to the metadata of the events that the queries of this pack generate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_pack#event_routing_key OsqueryPack#event_routing_key}
  */
  readonly eventRoutingKey?: string;
  /**
  * Name of the pack.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_pack#name OsqueryPack#name}
  */
  readonly name: string;
  /**
  * Restrict the pack to a percentage (1-100) of target hosts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_pack#shard OsqueryPack#shard}
  */
  readonly shard?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_pack zentral_osquery_pack}
*/
export class OsqueryPack extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OsqueryPack that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_pack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_pack zentral_osquery_pack} Resource
  *
  * @param scope The scope in which to define this construct
