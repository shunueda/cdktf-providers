// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/meta_business_unit
...
export interface MetaBusinessUnitConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/meta_business_unit#api_enrollment_enabled MetaBusinessUnit#api_enrollment_enabled}
  */
  readonly apiEnrollmentEnabled?: boolean | cdktf.IResolvable;
  /**
  * Name of the meta business unit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/meta_business_unit#name MetaBusinessUnit#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/meta_business_unit zentral_meta_business_unit}
*/
export class MetaBusinessUnit extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MetaBusinessUnit that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/meta_business_unit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/meta_business_unit zentral_meta_business_unit} Resource
  *
  * @param scope The scope in which to define this construct
