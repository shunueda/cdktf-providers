// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/mdm_filevault_config
...
export interface MdmFilevaultConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/mdm_filevault_config#at_login_only MdmFilevaultConfig#at_login_only}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/mdm_filevault_config#bypass_attempts MdmFilevaultConfig#bypass_attempts}
  */
  readonly bypassAttempts?: number;
  /**
  * Set to `true` to prevent storing the FileVault key across restarts. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/mdm_filevault_config#destroy_key_on_standby MdmFilevaultConfig#destroy_key_on_standby}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/mdm_filevault_config#escrow_location_display_name MdmFilevaultConfig#escrow_location_display_name}
  */
  readonly escrowLocationDisplayName: string;
  /**
  * Name of the FileVault configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/mdm_filevault_config#name MdmFilevaultConfig#name}
  */
  readonly name: string;
  /**
  * The automatic PRK rotation interval in days. It has a maximum value of `365`. Defaults to `0` (no automatic rotation).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/mdm_filevault_config#prk_rotation_interval_days MdmFilevaultConfig#prk_rotation_interval_days}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/mdm_filevault_config#show_recovery_key MdmFilevaultConfig#show_recovery_key}
  */
  readonly showRecoveryKey?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/mdm_filevault_config zentral_mdm_filevault_config}
*/
export class MdmFilevaultConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MdmFilevaultConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/mdm_filevault_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/mdm_filevault_config zentral_mdm_filevault_config} Resource
  *
  * @param scope The scope in which to define this construct
