// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/santa_enrollment
...
export interface DataZentralSantaEnrollmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/santa_enrollment#id DataZentralSantaEnrollment#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/santa_enrollment zentral_santa_enrollment}
*/
export class DataZentralSantaEnrollment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralSantaEnrollment that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/santa_enrollment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/santa_enrollment zentral_santa_enrollment} Data Source
  *
  * @param scope The scope in which to define this construct
