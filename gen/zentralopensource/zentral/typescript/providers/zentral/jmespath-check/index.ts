// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/jmespath_check
...
export interface JmespathCheckConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/jmespath_check#description JmespathCheck#description}
  */
  readonly description?: string;
  /**
  * The JMESPath compliance check expression.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/jmespath_check#jmespath_expression JmespathCheck#jmespath_expression}
  */
  readonly jmespathExpression: string;
  /**
  * Name of the JMESPath compliance check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/jmespath_check#name JmespathCheck#name}
  */
  readonly name: string;
  /**
  * The platforms the JMESPath compliance check is restricted to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/jmespath_check#platforms JmespathCheck#platforms}
  */
  readonly platforms?: string[];
  /**
  * The name of the inventory source the JMESPath compliance check is restricted to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/jmespath_check#source_name JmespathCheck#source_name}
  */
  readonly sourceName: string;
  /**
  * The IDs of the tags the JMESPath compliance check is restricted to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/jmespath_check#tag_ids JmespathCheck#tag_ids}
  */
  readonly tagIds?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/jmespath_check zentral_jmespath_check}
*/
export class JmespathCheck extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing JmespathCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/jmespath_check#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/jmespath_check zentral_jmespath_check} Resource
  *
  * @param scope The scope in which to define this construct
