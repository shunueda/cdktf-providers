// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_configuration_pack
...
export interface OsqueryConfigurationPackConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_configuration_pack#configuration_id OsqueryConfigurationPack#configuration_id}
  */
  readonly configurationId: number;
  /**
  * The `ID`s of the tags used to put the pack out of scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_configuration_pack#excluded_tag_ids OsqueryConfigurationPack#excluded_tag_ids}
  */
  readonly excludedTagIds?: number[];
  /**
  * ID of the pack.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_configuration_pack#pack_id OsqueryConfigurationPack#pack_id}
  */
  readonly packId: number;
  /**
  * The `ID`s of the tags used to scope the pack.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_configuration_pack#tag_ids OsqueryConfigurationPack#tag_ids}
  */
  readonly tagIds?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_configuration_pack zentral_osquery_configuration_pack}
*/
export class OsqueryConfigurationPack extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OsqueryConfigurationPack that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_configuration_pack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/osquery_configuration_pack zentral_osquery_configuration_pack} Resource
  *
  * @param scope The scope in which to define this construct
