// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/monolith_enrollment
...
export interface DataZentralMonolithEnrollmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/monolith_enrollment#id DataZentralMonolithEnrollment#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/monolith_enrollment zentral_monolith_enrollment}
*/
export class DataZentralMonolithEnrollment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralMonolithEnrollment that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/monolith_enrollment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/monolith_enrollment zentral_monolith_enrollment} Data Source
  *
  * @param scope The scope in which to define this construct
