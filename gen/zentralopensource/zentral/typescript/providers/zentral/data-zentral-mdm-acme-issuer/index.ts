// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/mdm_acme_issuer
...
export interface DataZentralMdmAcmeIssuerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/mdm_acme_issuer#id DataZentralMdmAcmeIssuer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/mdm_acme_issuer#name DataZentralMdmAcmeIssuer#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/mdm_acme_issuer zentral_mdm_acme_issuer}
*/
export class DataZentralMdmAcmeIssuer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralMdmAcmeIssuer that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/mdm_acme_issuer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/data-sources/mdm_acme_issuer zentral_mdm_acme_issuer} Data Source
  *
  * @param scope The scope in which to define this construct
