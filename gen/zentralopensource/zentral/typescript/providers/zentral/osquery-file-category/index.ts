// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_file_category
...
export interface OsqueryFileCategoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_file_category#access_monitoring OsqueryFileCategory#access_monitoring}
  */
  readonly accessMonitoring?: boolean | cdktf.IResolvable;
  /**
  * Description of the Osquery file category.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_file_category#description OsqueryFileCategory#description}
  */
  readonly description?: string;
  /**
  * Set of paths to exclude from the Osquery file category.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_file_category#exclude_paths OsqueryFileCategory#exclude_paths}
  */
  readonly excludePaths?: string[];
  /**
  * Set of paths to include in the Osquery file category.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_file_category#file_paths OsqueryFileCategory#file_paths}
  */
  readonly filePaths?: string[];
  /**
  * Set of queries returning paths to monitor as path columns in the results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_file_category#file_paths_queries OsqueryFileCategory#file_paths_queries}
  */
  readonly filePathsQueries?: string[];
  /**
  * Name of the Osquery file category.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_file_category#name OsqueryFileCategory#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_file_category zentral_osquery_file_category}
*/
export class OsqueryFileCategory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OsqueryFileCategory that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_file_category#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/osquery_file_category zentral_osquery_file_category} Resource
  *
  * @param scope The scope in which to define this construct
