// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_recovery_password_config
...
export interface MdmRecoveryPasswordConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_recovery_password_config#dynamic_password MdmRecoveryPasswordConfig#dynamic_password}
  */
  readonly dynamicPassword?: boolean | cdktf.IResolvable;
  /**
  * Name of the recovery password configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_recovery_password_config#name MdmRecoveryPasswordConfig#name}
  */
  readonly name: string;
  /**
  * Set to `true` to rotate the firmware passwords. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_recovery_password_config#rotate_firmware_password MdmRecoveryPasswordConfig#rotate_firmware_password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_recovery_password_config#rotation_interval_days MdmRecoveryPasswordConfig#rotation_interval_days}
  */
  readonly rotationIntervalDays?: number;
  /**
  * The  static password to set for all devices.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_recovery_password_config#static_password MdmRecoveryPasswordConfig#static_password}
  */
  readonly staticPassword?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_recovery_password_config zentral_mdm_recovery_password_config}
*/
export class MdmRecoveryPasswordConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MdmRecoveryPasswordConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_recovery_password_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_recovery_password_config zentral_mdm_recovery_password_config} Resource
  *
  * @param scope The scope in which to define this construct
