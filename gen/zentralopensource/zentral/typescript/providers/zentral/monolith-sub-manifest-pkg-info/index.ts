// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info
...
export interface MonolithSubManifestPkgInfoConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info#condition_id MonolithSubManifestPkgInfo#condition_id}
  */
  readonly conditionId?: number;
  /**
  * The default shard value. Defaults to `100`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info#default_shard MonolithSubManifestPkgInfo#default_shard}
  */
  readonly defaultShard?: number;
  /**
  * Machines tagged with one of these tags will not receive the pkg info.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info#excluded_tag_ids MonolithSubManifestPkgInfo#excluded_tag_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info#featured_item MonolithSubManifestPkgInfo#featured_item}
  */
  readonly featuredItem?: boolean | cdktf.IResolvable;
  /**
  * Sub manifest key under which this pkg info will be included.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info#key MonolithSubManifestPkgInfo#key}
  */
  readonly key: string;
  /**
  * The name of the pkg info to include.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info#pkg_info_name MonolithSubManifestPkgInfo#pkg_info_name}
  */
  readonly pkgInfoName: string;
  /**
  * The modulo used to calculate the shards. Defaults to `100`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info#shard_modulo MonolithSubManifestPkgInfo#shard_modulo}
  */
  readonly shardModulo?: number;
  /**
  * The `ID` of the sub manifest this pkg info is attached to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info#sub_manifest_id MonolithSubManifestPkgInfo#sub_manifest_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info#tag_shards MonolithSubManifestPkgInfo#tag_shards}
  */
...
export interface MonolithSubManifestPkgInfoTagShards {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info#shard MonolithSubManifestPkgInfo#shard}
  */
  readonly shard: number;
  /**
  * The `ID` of the tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info#tag_id MonolithSubManifestPkgInfo#tag_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info zentral_monolith_sub_manifest_pkg_info}
*/
export class MonolithSubManifestPkgInfo extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonolithSubManifestPkgInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/resources/monolith_sub_manifest_pkg_info zentral_monolith_sub_manifest_pkg_info} Resource
  *
  * @param scope The scope in which to define this construct
