// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/monolith_manifest
...
export interface DataZentralMonolithManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/monolith_manifest#id DataZentralMonolithManifest#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/monolith_manifest#name DataZentralMonolithManifest#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/monolith_manifest zentral_monolith_manifest}
*/
export class DataZentralMonolithManifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralMonolithManifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/monolith_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/monolith_manifest zentral_monolith_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
