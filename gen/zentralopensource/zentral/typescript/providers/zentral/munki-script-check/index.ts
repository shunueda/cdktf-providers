// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check
...
export interface MunkiScriptCheckConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check#arch_amd64 MunkiScriptCheck#arch_amd64}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check#arch_arm64 MunkiScriptCheck#arch_arm64}
  */
  readonly archArm64?: boolean | cdktf.IResolvable;
  /**
  * Description of the Munki script check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check#description MunkiScriptCheck#description}
  */
  readonly description?: string;
  /**
  * The IDs of the tags this Munki script check is not scoped to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check#excluded_tag_ids MunkiScriptCheck#excluded_tag_ids}
  */
  readonly excludedTagIds?: number[];
  /**
  * Expected result of the Munki script check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check#expected_result MunkiScriptCheck#expected_result}
  */
  readonly expectedResult: string;
  /**
  * This Munki script check will be scheduled on machines with an OS version lower than this value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check#max_os_version MunkiScriptCheck#max_os_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check#min_os_version MunkiScriptCheck#min_os_version}
  */
  readonly minOsVersion?: string;
  /**
  * Name of the Munki script check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check#name MunkiScriptCheck#name}
  */
  readonly name: string;
  /**
  * Source of the Munki script check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check#source MunkiScriptCheck#source}
  */
  readonly source: string;
  /**
  * The IDs of the tags this Munki script check is restricted to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check#tag_ids MunkiScriptCheck#tag_ids}
  */
  readonly tagIds?: number[];
  /**
  * Type of the script check. Can be `ZSH_STR`, `ZSH_INT` or `ZSH_BOOL`. Defaults to `ZSH_STR`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check#type MunkiScriptCheck#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check zentral_munki_script_check}
*/
export class MunkiScriptCheck extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MunkiScriptCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.68/docs/resources/munki_script_check zentral_munki_script_check} Resource
  *
  * @param scope The scope in which to define this construct
