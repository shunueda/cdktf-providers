// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/osquery_file_category
...
export interface DataZentralOsqueryFileCategoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/osquery_file_category#id DataZentralOsqueryFileCategory#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/osquery_file_category#name DataZentralOsqueryFileCategory#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/osquery_file_category zentral_osquery_file_category}
*/
export class DataZentralOsqueryFileCategory extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralOsqueryFileCategory that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/osquery_file_category#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.64/docs/data-sources/osquery_file_category zentral_osquery_file_category} Data Source
  *
  * @param scope The scope in which to define this construct
