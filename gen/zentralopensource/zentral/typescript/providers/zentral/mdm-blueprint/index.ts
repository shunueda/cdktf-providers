// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint
...
export interface MdmBlueprintConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint#collect_apps MdmBlueprint#collect_apps}
  */
  readonly collectApps?: string;
  /**
  * Possible values: `NO`, `MANAGED_ONLY`, `ALL`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint#collect_certificates MdmBlueprint#collect_certificates}
  */
  readonly collectCertificates?: string;
  /**
  * Possible values: `NO`, `MANAGED_ONLY`, `ALL`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint#collect_profiles MdmBlueprint#collect_profiles}
  */
  readonly collectProfiles?: string;
  /**
  * The `ID` of the default apps & books location.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint#default_location_id MdmBlueprint#default_location_id}
  */
  readonly defaultLocationId?: number;
  /**
  * The `ID` of the attached FileVault configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint#filevault_config_id MdmBlueprint#filevault_config_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint#inventory_interval MdmBlueprint#inventory_interval}
  */
  readonly inventoryInterval?: number;
  /**
  * If `true`, legady profiles are distributed via DDM. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint#legacy_profiles_via_ddm MdmBlueprint#legacy_profiles_via_ddm}
  */
  readonly legacyProfilesViaDdm?: boolean | cdktf.IResolvable;
  /**
  * Name of the blueprint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint#name MdmBlueprint#name}
  */
  readonly name: string;
  /**
  * The `ID` of the attached recovery password configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint#recovery_password_config_id MdmBlueprint#recovery_password_config_id}
  */
  readonly recoveryPasswordConfigId?: number;
  /**
  * The `ID`s of the software update enforcements.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint#software_update_enforcement_ids MdmBlueprint#software_update_enforcement_ids}
  */
  readonly softwareUpdateEnforcementIds?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint zentral_mdm_blueprint}
*/
export class MdmBlueprint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MdmBlueprint that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.65/docs/resources/mdm_blueprint zentral_mdm_blueprint} Resource
  *
  * @param scope The scope in which to define this construct
