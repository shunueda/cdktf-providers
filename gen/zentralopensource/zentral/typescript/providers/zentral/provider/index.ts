// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs
...
export interface ZentralProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs#base_url ZentralProvider#base_url}
  */
  readonly baseUrl?: string;
  /**
  * The Zentral service account or user token. Can also be set using the `ZTL_API_TOKEN` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs#token ZentralProvider#token}
  */
  readonly token?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs#alias ZentralProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs zentral}
*/
export class ZentralProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ZentralProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs zentral} Resource
  *
  * @param scope The scope in which to define this construct
