// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/mdm_scep_issuer
...
export interface DataZentralMdmScepIssuerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/mdm_scep_issuer#id DataZentralMdmScepIssuer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/mdm_scep_issuer#name DataZentralMdmScepIssuer#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/mdm_scep_issuer zentral_mdm_scep_issuer}
*/
export class DataZentralMdmScepIssuer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralMdmScepIssuer that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/mdm_scep_issuer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/mdm_scep_issuer zentral_mdm_scep_issuer} Data Source
  *
  * @param scope The scope in which to define this construct
