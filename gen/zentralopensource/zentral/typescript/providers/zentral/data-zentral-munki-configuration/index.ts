// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/munki_configuration
...
export interface DataZentralMunkiConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/munki_configuration#id DataZentralMunkiConfiguration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/munki_configuration#name DataZentralMunkiConfiguration#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/munki_configuration zentral_munki_configuration}
*/
export class DataZentralMunkiConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralMunkiConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/munki_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.67/docs/data-sources/munki_configuration zentral_munki_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
